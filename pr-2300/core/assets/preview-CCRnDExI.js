...
`;var Ks={};const He=typeof process<"u"&&Ks!==void 0;var Ve,ue,ye,Ze,Le,ms,je,vs;function Ys(){return He?[]:document.adoptedStyleSheets||[]}const Qs=class xs{constructor(){g(this,Le),g(this,je),g(this,Ve,!Xe()),g(this,ue,new Map),g(this,ye,new Map),g(this,Ze,Ys())}static get instance(){var e;return(e=globalThis.__gdsGlobalStylesRegistryScoped)!=null&&e[j]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[j]:new xs}),globalThis.__gdsGlobalStylesRegistryScoped[j]}injectGlobalStyles(e,t){if(a(this,Ve)){const n=Array.isArray(t)?t.map(r=>r.toString()).join(""):t.toString();F(this,Le,ms).call(this,e,n)}else t.styleSheet&&F(this,je,vs).call(this,e,t.styleSheet)}};Ve=new WeakMap;ue=new WeakMap;ye=new WeakMap;Ze=new WeakMap;Le=new WeakSet;ms=function(s,e){if(He)return;let t=a(this,ye).get(s);t||(t=document.createElement("style"),a(this,ye).set(s,t)),t.textContent=e,document.head.appendChild(t)};je=new WeakSet;vs=function(s,e){He||(a(this,ue).set(s,e),document.adoptedStyleSheets=[...a(this,Ze),...Array.from(a(this,ue).values())])};let et=Qs;const D=[U`
    :host {
      ${_(hs)}
      ${_(ys)}
    }
