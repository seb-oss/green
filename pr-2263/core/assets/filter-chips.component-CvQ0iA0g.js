import{n as h,G,h as C,g as b,r as k}from"./gds-element-DKcDvDP5.js";import{a as x}from"./query-p8xgzTDt.js";import{e as w}from"./if-defined-BAXgs-ZI.js";import{r as E}from"./resize-observer-B9k8v2TZ.js";import{w as P}from"./watch-tFciLXSI.js";import{s as W}from"./attribute-converters-CdI0trPX.js";import{G as F,a as V}from"./button.component-BQEAXfVs.js";import{T as z}from"./transitional-styles-BOV6aykc.js";import{I as H}from"./checkmark.component-OUhYvDFq.js";import{i as $}from"./lit-element-Bx14lxc-.js";const T=$`
...
`;var B=Object.defineProperty,D=Object.getOwnPropertyDescriptor,_=(e,t,s,r)=>{for(var l=r>1?void 0:r?D(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(l=(r?n(t,s,l):n(l))||l);return r&&l&&B(t,s,l),l};let p=class extends G{constructor(){super(...arguments),this.selected=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),z.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return C`<gds-button
      class="btn"
      size="small"
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};p.styles=[T];_([h({reflect:!0,type:Boolean})],p.prototype,"selected",2);_([h()],p.prototype,"value",2);p=_([b("gds-filter-chip",{dependsOn:[F,H]})],p);const M=$`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
