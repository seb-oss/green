import{n as m,r as L,G as bt,h as c,g as wt,a as S}from"./gds-element-DKcDvDP5.js";import{m as ct}from"./runtime-BL31MtW8.js";import{l as _t}from"./localized-decorator-DtmrKsyB.js";import{i as xt,E as _}from"./lit-element-Bx14lxc-.js";import{e as dt}from"./if-defined-BAXgs-ZI.js";import{n as At,e as kt}from"./ref-R0wBYijq.js";import{u as Ct,s as E}from"./static-B8S6DEnV.js";import{t as It}from"./tokens.style-BJN0iJ4Z.js";import{G as Dt}from"./button.component-BkcuxinN.js";import{G as Tt}from"./card.component-D4L7sTXJ.js";import{I as $t}from"./circle-check.component-BCxm1que.js";import{a as Lt,I as Mt}from"./triangle-exclamation.component-Bojk6KCv.js";import{I as Pt}from"./cross-small.component-DYGxDGWL.js";import"./card-bskWYiAL.js";import"./button-4VBpoF4Z.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./directive-helpers-BF33kFuJ.js";import"./query-p8xgzTDt.js";import"./when-BR7zwNJC.js";import"./transitional-styles-D1hSHNWN.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-Bw_LIblW.js";import"./watch-tFciLXSI.js";import"./div.component-C2xH1QCG.js";import"./icon-B8lys3o1.js";const St=xt`
  :host {
...
`;var Et=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,mt=t=>{throw TypeError(t)},n=(t,e,r,g)=>{for(var l=g>1?void 0:g?Ht(e,r):e,C=t.length-1,I;C>=0;C--)(I=t[C])&&(l=(g?I(e,r,l):I(l))||l);return g&&l&&Et(e,r,l),l},M=(t,e,r)=>e.has(t)||mt("Cannot "+r),d=(t,e,r)=>(M(t,e,"read from private field"),r?r.call(t):e.get(t)),p=(t,e,r)=>e.has(t)?mt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),x=(t,e,r,g)=>(M(t,e,"write to private field"),e.set(t,r),r),a=(t,e,r)=>(M(t,e,"access private method"),r),b,w,D,T,s,$,A,k,gt,pt,P,ut,ht,ft,vt,yt;const Bt={positive:{icon:"circle-check",card:"positive"},warning:{icon:"triangle-exclamation",card:"warning"},negative:{icon:"triangle-exclamation",card:"negative"},information:{icon:"circle-info",card:"information"},notice:{icon:"circle-info",card:"notice"}},Gt=300,Nt=100;let i=class extends bt{constructor(){super(),p(this,s),this.variant="information",this.label="",this.role="alert",this.dismissible=!1,this.timeout=0,this.buttonLabel="",this._progress=100,this._isClosing=!1,this._cardHidden=!1,p(this,b),p(this,w),p(this,D,kt()),p(this,T,{hostConnected:()=>{this.timeout>0&&a(this,s,$).call(this)},hostDisconnected:()=>a(this,s,A).call(this)}),this.addController(d(this,T))}updated(t){t.has("timeout")&&(a(this,s,A).call(this),this.timeout>0&&a(this,s,$).call(this))}render(){if(this._cardHidden)return _;const t={dismissing:this._isClosing,dismissible:this.dismissible,"has-action":this.buttonLabel,timeout:this.timeout>0};return c`
    ...
    `};vt=function(){return this.dismissible?c`
        ...
        `:_};i.styles=[It,St];n([m({type:String,reflect:!0})],i.prototype,"variant",2);n([m({type:String})],i.prototype,"label",2);n([m({type:String,reflect:!0})],i.prototype,"role",2);n([m({type:Boolean})],i.prototype,"dismissible",2);n([m({type:Number})],i.prototype,"timeout",2);n([m({type:String,attribute:"button-label"})],i.prototype,"buttonLabel",2);n([L()],i.prototype,"_progress",2);n([L()],i.prototype,"_isClosing",2);n([L()],i.prototype,"_cardHidden",2);i=n([wt("gds-alert",{dependsOn:[Dt,Tt,$t,Lt,Mt,Pt]}),_t()],i);i.define();const me={title:"Components/Alert",component:"gds-alert",tags:["autodocs"],argTypes:{variant:{control:"select",options:["information","notice","positive","warning","negative"]},role:{control:"select",options:["alert","status"]}},parameters:{docs:{description:{component:"Alert is a message used to inform or update the user about the state of a system, page or function. Icons and color indicate the type and urgency of the information within the message."}}}},o={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{variant:"information",role:"alert",dismissible:!0,timeout:0,buttonLabel:"",innerHTML:`<strong>Information</strong> Body text starts on the same row as heading.
...
}`,...(ot=(it=y.parameters)==null?void 0:it.docs)==null?void 0:ot.source},description:{story:"Alerts can contain rich content in the main slot.",...(lt=(nt=y.parameters)==null?void 0:nt.docs)==null?void 0:lt.description}}};const ge=["DefaultParams","Variants","WithAction","Dismissible","AutoDismiss","RichContent"];export{v as AutoDismiss,o as DefaultParams,f as Dismissible,y as RichContent,u as Variants,h as WithAction,ge as __namedExportsOrder,me as default};
