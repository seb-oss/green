import{i}from"./lit-element-Bx14lxc-.js";import{t as p}from"./tokens.style-C9n1Y52h.js";import{s as n}from"./declarative-layout-mixins-Bw_LIblW.js";import{h as v,g as b}from"./gds-element-DKcDvDP5.js";import{G as g}from"./div.component-BCJhG5xx.js";var y=Object.defineProperty,m=Object.getOwnPropertyDescriptor,d=(a,e,o,s)=>{for(var r=s>1?void 0:s?m(e,o):e,l=a.length-1,c;l>=0;l--)(c=a[l])&&(r=(s?c(e,o,r):c(r))||r);return s&&r&&y(e,o,r),r};let t=class extends g{constructor(){super(),this.variant="primary",this.padding="s;m{l}",this["border-radius"]="xs;m{s}",this.gap="s;m{l}"}render(){return v`<slot></slot>`}};t.styles=[p,i`
      :host {
