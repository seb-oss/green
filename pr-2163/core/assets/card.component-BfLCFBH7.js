import{i}from"./lit-element-Bx14lxc-.js";import{t as n}from"./tokens.style-BXmqfwyc.js";import{s as c}from"./declarative-layout-mixins-D1Y0gyd7.js";import{h as m,g as v}from"./custom-element-scoping-CNGU1oQ0.js";import{G as b}from"./div.component-CbIAaKIF.js";var g=Object.defineProperty,u=Object.getOwnPropertyDescriptor,p=(s,r,l,t)=>{for(var o=t>1?void 0:t?u(r,l):r,a=s.length-1,d;a>=0;a--)(d=s[a])&&(o=(t?d(r,l,o):d(o))||o);return t&&o&&g(r,l,o),o};let e=class extends b{constructor(){super(),this.variant="primary",this.padding="s;m{l}",this["border-radius"]="xs;m{s}",this.gap="s;m{l}"}render(){return m`<slot></slot>`}};e.styles=[n,i`
    ...
    `];p([c({property:"box-shadow",valueTemplate:s=>`var(--gds-sys-shadow-${s})`})],e.prototype,"shadow",2);p([c({styleTemplate:function(s,r){return`
