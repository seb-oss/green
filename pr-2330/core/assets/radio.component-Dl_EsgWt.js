import{l as $}from"./runtime-CNluP0A8.js";import{n as a,G as k,h as f,g as m,r as W}from"./gds-element-DKcDvDP5.js";import{a as V}from"./query-p8xgzTDt.js";import{e as R}from"./class-map-CXsQwv0r.js";import{G as H,a as K}from"./form-control-header.component-D5DzCq65.js";import{t as T}from"./tokens.style-Bfj-148u.js";import{w as F}from"./watch-tFciLXSI.js";import{d as j,b as q,w as U}from"./declarative-layout-mixins-DHam8wVT.js";import{a as X}from"./button.component-Bs0TOV3g.js";import{i as C}from"./lit-element-Bx14lxc-.js";import{r as J,a as N}from"./rbcb-toggle.template-Cq50h8O1.js";const Q=C`
  @layer base, a11y;
...
`;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,w=(t,e,s,i)=>{for(var o=i>1?void 0:i?Z(e,s):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(o=(i?d(e,s,o):d(o))||o);return i&&o&&Y(e,s,o),o};let v=class extends k{constructor(){super(),this.label="",this.supportingText=""}render(){const t={label:!0,"has-supporting-text":!!this.supportingText};return f`
    ...
    `}};v.styles=[T,Q];w([a()],v.prototype,"label",2);w([a({attribute:"supporting-text"})],v.prototype,"supportingText",2);v=w([m("gds-toggle-control-base"),$()],v);const tt=C`
  :host {
    /* Font Sizes */
...
`;var nt=Object.defineProperty,at=Object.getOwnPropertyDescriptor,I=t=>{throw TypeError(t)},u=(t,e,s,i)=>{for(var o=i>1?void 0:i?at(e,s):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(o=(i?d(e,s,o):d(o))||o);return i&&o&&nt(e,s,o),o},lt=(t,e,s)=>e.has(t)||I("Cannot "+s),b=(t,e,s)=>(lt(t,e,"read from private field"),s?s.call(t):e.get(t)),S=(t,e,s)=>e.has(t)?I("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),g,y;let h=class extends k{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,S(this,g,t=>{this.disabled||!this.value||!this.label||(t.preventDefault(),this.checked=!0,this.focus(),this.dispatchStandardEvent("input",{bubbles:!0}))}),S(this,y,t=>{this.disabled||(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.checked=!0,this.dispatchStandardEvent("input",{bubbles:!0}))}),this.addEventListener("keydown",b(this,y)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",b(this,g))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(t){super.updated(t),(t.has("checked")||t.has("disabled")||t.has("invalid"))&&this._updateAriaState()}render(){return f`
    ...
    `}};g=new WeakMap;y=new WeakMap;h.styles=[J,rt];u([a()],h.prototype,"label",2);u([a({attribute:"supporting-text"})],h.prototype,"supportingText",2);u([a()],h.prototype,"value",2);u([a({type:Boolean,reflect:!0})],h.prototype,"checked",2);u([a({type:Boolean,reflect:!0})],h.prototype,"disabled",2);u([a({type:Boolean})],h.prototype,"invalid",2);u([W()],h.prototype,"_isFocused",2);h=u([m("gds-radio",{dependsOn:[v]})],h);export{h as G,A as a,v as b};
