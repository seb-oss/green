import{n as _,G as C,h as i,g as b,r as P}from"./gds-element-DKcDvDP5.js";import{n as v}from"./when-BR7zwNJC.js";import{G as z}from"./badge.component-Dle24o4i.js";import{I as W,a as B}from"./triangle-exclamation.component-CEo389zf.js";import{w}from"./watch-tFciLXSI.js";import{i as E}from"./lit-element-Bx14lxc-.js";import{l as F,m as I}from"./runtime-CNluP0A8.js";import{a as D}from"./query-p8xgzTDt.js";import{G as H}from"./button.component-Bs0TOV3g.js";import{G as L}from"./card.component-BD3SJk3O.js";const V=E`
...
`;var A=Object.defineProperty,N=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},x=(e,t,s,a)=>{for(var r=a>1?void 0:a?N(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&A(t,s,r),r},R=(e,t,s)=>t.has(e)||S("Cannot "+s),j=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),q=(e,t,s)=>(R(e,t,"access private method"),s),m,T;let d=class extends C{constructor(){super(...arguments),j(this,m)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter)}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return i`<div aria-live="polite">
    ...
    </div>`}};m=new WeakSet;T=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",i`<gds-badge variant="${t}">${e}</gds-badge>`};d.styles=[V];x([_({type:Number})],d.prototype,"charCounter",2);x([_()],d.prototype,"errorMessage",2);x([w("charCounter"),w("errorMessage")],d.prototype,"_handleVisibilityChange",1);d=x([b("gds-form-control-footer",{dependsOn:[z,W]})],d);const J=E`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var K=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,$=e=>{throw TypeError(e)},u=(e,t,s,a)=>{for(var r=a>1?void 0:a?Q(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&K(t,s,r),r},G=(e,t,s)=>t.has(e)||$("Cannot "+s),p=(e,t,s)=>(G(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?$("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),k=(e,t,s)=>(G(e,t,"access private method"),s),c,M,f,y,g,O;let l=class extends C{constructor(){super(...arguments),h(this,c),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,h(this,f,()=>i`
    ...
    `};l.styles=[J];u([_({type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);u([P()],l.prototype,"_hasExtendedSupportingText",2);u([D("#extended-supporting-text")],l.prototype,"_extendedSupportingText",2);l=u([b("gds-form-control-header",{dependsOn:[H,L,B]}),F()],l);export{l as G,d as a};
