...
`,GdsFilterChip=class extends chunk_ZQ4D5K7J.j{constructor(){super(...arguments),this.selected=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),chunk_GBHQTWRJ.nD.instance.apply(this,"gds-filter-chip"),this._button.then((btn=>{chunk_GBHQTWRJ.nD.instance.apply(btn,"gds-button")}))}render(){const btnClasses={"btn-p":!this.selected};return chunk_VOYMQ322.qy`<gds-button
      class="btn"
      size="small"
