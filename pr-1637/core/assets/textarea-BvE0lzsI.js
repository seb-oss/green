import{m as k}from"./runtime-CMQcyTl6.js";import{n as d,r as z,g as I,h as o}from"./custom-element-scoping-CpYtbs9r.js";import{a as X}from"./query-p8xgzTDt.js";import{r as C}from"./query-async-MEroNOeJ.js";import{r as j}from"./choose-Dh3k58u9.js";import{m as U}from"./until-DXcpnd_9.js";import{n as u}from"./when-BR7zwNJC.js";import{i as V,E as g}from"./lit-element-C_s9q329.js";import{t as J}from"./tokens.style-RalixZsd.js";import{w as K}from"./watch-tFciLXSI.js";import{s as Q}from"./style-expression-property-D0nhDdjH.js";import{a as Z,f as tt}from"./button-DhIk8LdE.js";import"./cross-small-Y_gLfaO0.js";import"./flex-Be9anuuV.js";import"./triangle-exclamation-D2VDkIvV.js";import"./container-E3m_XvWh.js";import"./card-B3zB_GNW.js";import"./text-USk8zqij.js";import"./badge-DJWOzsSK.js";const et=V`
    ...
    `};G=function(){return this.clearable&&this.value.length>0?o`
      ...
      `:g};H=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};F=function(){const t=this.maxlength-this.value.length;let e;return t<0?e="negative":t<20?e="warning":e="positive",o`<gds-badge variant="${e}">${t}</gds-badge>`};q=async function(){return this.elExtendedSupportingTextSlot.then(t=>t&&t.assignedElements().length>0?o`
          <gds-button
            size="small"
            rank="tertiary"
            label="${k("Show extended supporting text")}"
            @click=${p(this,E)}
          >
            <gds-icon-circle-info ?solid=${this.showExtendedSupportingText} />
          </gds-button>
        `:g)};a.styles=[J,et];r([d()],a.prototype,"value",2);r([d()],a.prototype,"label",2);r([Q({valueTemplate:t=>t,selector:"textarea",styleTemplate:(t,e)=>`min-height: calc(1lh * ${e[0]});`})],a.prototype,"rows",2);r([z()],a.prototype,"lines",2);r([d({attribute:"supporting-text"})],a.prototype,"supportingText",2);r([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],a.prototype,"showExtendedSupportingText",2);r([d({attribute:"disabled",type:Boolean,reflect:!0})],a.prototype,"disabled",2);r([d({type:Boolean})],a.prototype,"clearable",2);r([d()],a.prototype,"resize",2);r([d({type:Number})],a.prototype,"maxlength",2);r([d({type:String})],a.prototype,"variant",2);r([C("textarea")],a.prototype,"elTextareaAsync",2);r([X("textarea")],a.prototype,"elTextarea",2);r([C('slot[name="extended-supporting-text"]')],a.prototype,"elExtendedSupportingTextSlot",2);r([z()],a.prototype,"trailSlotOccupied",2);r([K("value")],a.prototype,"_setAutoHeight",1);a=r([I("gds-textarea")],a);
