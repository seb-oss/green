import{k as t}from"./lit-element-BoQqPHl6.js";import"./textarea-DZLLuZ5x.js";import"./badge-C4n--NGw.js";import"./flex-HuK12lhR.js";import"./divider-CmoJvVpe.js";import"./credit-card-DfmlSRLD.js";import"./magnifying-glass-CVzq-6y-.js";import"./gds-element-RTlSuh_R.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./query-async-MEroNOeJ.js";import"./until-BfWLtGmt.js";import"./directive-helpers-8zWUTkHM.js";import"./async-directive-DPLqQocF.js";import"./directive-Ctav8iJK.js";import"./when-BxLAFfhK.js";import"./choose-Dh3k58u9.js";import"./runtime-CMQcyTl6.js";import"./watch-tFciLXSI.js";import"./button-3kPB1G4k.js";import"./static-C_6dgFWo.js";import"./if-defined-OiR-h1RO.js";import"./class-map-BBGuaYF3.js";import"./transitional-styles-9whFD-yV.js";import"./tokens.style-Dwr4YKnv.js";import"./style-expression-property-Da3P080T.js";import"./cross-small-BgcbB_fi.js";import"./icon-jzQ8K1tO.js";import"./triangle-exclamation-CZ0g0XuL.js";import"./container-BxFejZmF.js";import"./card-h2h4ZaIW.js";import"./text-DKZiGorS.js";const Me={title:"Docs/Components/Form/Textarea",component:"gds-textarea",parameters:{layout:"centered",docs:{description:{component:"Textareas are used for longer multiline text inputs, such as comments or descriptions.<br>\nThey can be used in forms, dialogs, and data tables.\nThe `gds-textarea` component is a wrapper around the native textarea element and provides a consistent look and feel across browsers. It has 4 rows by default and it resizes vertically to fit the content as the user types.\n\nSome features of the Textarea include:\n- Built-in support for form validation\n- Slots for `lead` and `trail` icons\n- `Supporting` and `Extended` text\n- `Clearable` input fields\n- `Length` validation\n- `Disabled` state\n- Custom number of `Rows`\n\n@status beta"}}},tags:["autodocs"]},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label text"}},c={...a,name:"Default",render:()=>t`
  ...
  \`
}`,...(v=(h=r.parameters)==null?void 0:h.docs)==null?void 0:v.source},description:{story:'**@slot lead** - Slot for an icon or other content to be placed at the beginning of the `gds-textarea` field.\n\n```html\n <gds-textarea label="Lead Icon">\n   <gds-icon-magnifying-glass slot="lead"></gds-icon-magnifying-glass>\n</gds-textarea>```',...(y=(L=r.parameters)==null?void 0:L.docs)==null?void 0:y.description}}};var w,S,T,E,D;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Slot: Trail',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...(T=(S=s.parameters)==null?void 0:S.docs)==null?void 0:T.source},description:{story:'**@slot trail** - Slot for an icon or other content to be placed at the end of the textarea field.\n\n```html\n <gds-textarea label="Trail Icon">\n   <gds-badge variant="information" slot="trail">USD</gds-badge>\n</gds-textarea>```',...(D=(E=s.parameters)==null?void 0:E.docs)==null?void 0:D.description}}};var z,P,R,C,I;n.parameters={...n.parameters,docs:{...(z=n.parameters)==null?void 0:z.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Length',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...(R=(P=n.parameters)==null?void 0:P.docs)==null?void 0:R.source},description:{story:'The `length` property can be set to a number to limit the number of characters that can be entered into the textarea field.<br> A badge will be displayed, updating as the textarea approaches the character limit.\n\n**@property maxLength** - The maximum number of characters that can be entered into the textarea field.\n\n```html\n <gds-textarea maxLength="20"></gds-textarea>\n```',...(I=(C=n.parameters)==null?void 0:C.docs)==null?void 0:I.description}}};var q,N,V,$,k;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Rows',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...(ne=(se=x.parameters)==null?void 0:se.docs)==null?void 0:ne.source},description:{story:`Textarea has built-in support for form validation.<br>The validation feature is built on top of the browsers native validation features, using \`ElementInternals\` and \`Constraint Validation API\`.
...
\`\`\``,...(oe=(le=x.parameters)==null?void 0:le.docs)==null?void 0:oe.description}}};var de,ie,pe,xe,ge;g.parameters={...g.parameters,docs:{...(de=g.parameters)==null?void 0:de.docs,source:{originalSource:`{
  ...
  \`
}`,...(pe=(ie=g.parameters)==null?void 0:ie.docs)==null?void 0:pe.source},description:{story:"The `disabled` property can be set to disable the textarea field.\n\n**@property disabled** - Disables the textarea field.\n\n```html\n <gds-textarea disabled></gds-textarea>\n```",...(ge=(xe=g.parameters)==null?void 0:xe.docs)==null?void 0:ge.description}}};const Oe=["Default","Lead","Trail","Length","Rows","Resize","Clearable","SupportingText","ExtendedSupportingText","Validation","Disabled"];export{d as Clearable,c as Default,g as Disabled,p as ExtendedSupportingText,r as Lead,n as Length,o as Resize,l as Rows,i as SupportingText,s as Trail,x as Validation,Oe as __namedExportsOrder,Me as default};
