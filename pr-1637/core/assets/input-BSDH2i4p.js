import{m as w}from"./runtime-CMQcyTl6.js";import{n as d,r as F,g as R,h as r}from"./custom-element-scoping-CpYtbs9r.js";import{a as P}from"./query-p8xgzTDt.js";import{r as E}from"./query-async-MEroNOeJ.js";import{r as L}from"./choose-Dh3k58u9.js";import{m as X}from"./until-DXcpnd_9.js";import{n as f}from"./when-BR7zwNJC.js";import{i as j,E as g}from"./lit-element-C_s9q329.js";import{t as q}from"./tokens.style-RalixZsd.js";import{a as U,f as V}from"./button-DhIk8LdE.js";import"./flex-BtTjsVG1.js";import"./cross-small-Y_gLfaO0.js";import"./triangle-exclamation-D2VDkIvV.js";import"./container-BIIXSCQx.js";import"./card-Bs1g4zvg.js";import"./text-hysB62Kd.js";import"./badge-DJWOzsSK.js";const H=j`
    ...
    `};B=function(){return this.clearable&&this.value.length>0?r`
      ...
      `:g};W=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};G=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="negative":e<20?t="warning":t="positive",r`<gds-badge variant="${t}">${e}</gds-badge>`};D=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?r`
          <gds-button
            size="small"
            rank="tertiary"
            label="${w("Show extended supporting text")}"
            @click=${c(this,_)}
          >
            <gds-icon-circle-info ?solid=${this.showExtendedSupportingText} />
          </gds-button>
        `:g)};s.styles=[q,H];a([d()],s.prototype,"value",2);a([d()],s.prototype,"label",2);a([d({attribute:"supporting-text"})],s.prototype,"supportingText",2);a([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],s.prototype,"showExtendedSupportingText",2);a([d({attribute:"disabled",type:Boolean,reflect:!0})],s.prototype,"disabled",2);a([d({type:Boolean})],s.prototype,"clearable",2);a([d({type:Number})],s.prototype,"maxlength",2);a([d({type:String})],s.prototype,"variant",2);a([d({type:String})],s.prototype,"size",2);a([E("input")],s.prototype,"elInputAsync",2);a([P("input")],s.prototype,"elInput",2);a([E('slot[name="extended-supporting-text"]')],s.prototype,"elExtendedSupportingTextSlot",2);a([F()],s.prototype,"trailSlotOccupied",2);s=a([R("gds-input")],s);
