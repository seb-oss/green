...
`;var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,k=t=>{throw TypeError(t)},a=(t,e,i,p)=>{for(var o=p>1?void 0:p?K(e,i):e,u=t.length-1,x;u>=0;u--)(x=t[u])&&(o=(p?x(e,i,o):x(o))||o);return p&&o&&J(e,i,o),o},z=(t,e,i)=>e.has(t)||k("Cannot "+i),c=(t,e,i)=>(z(t,e,"read from private field"),i?i.call(t):e.get(t)),h=(t,e,i)=>e.has(t)?k("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),l=(t,e,i)=>(z(t,e,"access private method"),i),n,S,T,m,v,b,y,$,_,C,N,O,M,A,I,B,W,G,D;let s=class extends q{constructor(){super(),h(this,n),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="default",this.trailSlotOccupied=!1,h(this,m,t=>["type","placeholder","required"].includes(t.name)),h(this,v,t=>{const e=t.target;this.value=e.value}),h(this,b,t=>{const e=t.target;this.value=e.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),h(this,y,()=>{this.elInputAsync.then(t=>t.focus())}),h(this,$,()=>{this.value=""}),h(this,_,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))})}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return r`${j(this.variant,[["default",()=>l(this,n,S).call(this)],["floating-label",()=>l(this,n,T).call(this)]])}`}_getValidityAnchor(){return this.elInput}};n=new WeakSet;S=function(){return r`
    ...
    `};B=function(){return this.clearable&&this.value.length>0?r`
      ...
      `:g};W=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};G=function(){const t=this.maxlength-this.value.length;let e;return t<0?e="negative":t<20?e="warning":e="positive",r`<gds-badge variant="${e}">${t}</gds-badge>`};D=async function(){return this.elExtendedSupportingTextSlot.then(t=>t&&t.assignedElements().length>0?r`
          <gds-button
            size="small"
            rank="tertiary"
