import{m as k,s as re}from"./runtime-CMQcyTl6.js";import{n as h,g as H,h as g,G as N}from"./custom-element-scoping-CpYtbs9r.js";import{a as R}from"./query-p8xgzTDt.js";import{r as ae}from"./query-async-MEroNOeJ.js";import{e as Y}from"./class-map-Bz98xO8-.js";import{o as oe}from"./if-defined-Ct9lF4W9.js";import{o as ne}from"./icon-C1rUgQqA.js";import{n as M}from"./when-BR7zwNJC.js";import{t as J}from"./tokens.style-RalixZsd.js";import{T as B}from"./transitional-styles-Cc5JwJ9o.js";import{w as E}from"./watch-tFciLXSI.js";import{a as le}from"./button-DhIk8LdE.js";import{i as Q}from"./lit-element-C_s9q329.js";import"./popover-BsBF3LbE.js";import"./backdrop-DPrfqKFZ.js";import"./chevron-bottom-BqIBnMM1.js";import"./checkmark-D9lROobG.js";import{n as he,e as de}from"./ref-DDJrdyS4.js";import{s as ce,F as pe,L as ue,u as fe}from"./menu-heading-5KjiIomn.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ge{constructor(t){this.__litLocalizeEventHandler=s=>{s.detail.status==="ready"&&this.host.requestUpdate()},this.host=t}hostConnected(){window.addEventListener(I,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(I,this.__litLocalizeEventHandler)}}const ve=e=>e.addController(new ge(e)),be=ve;function me(e={attributes:!0,childList:!0,subtree:!1,characterData:!0}){return(t,s,i)=>{let r;const a=t.connectedCallback,l=t.disconnectedCallback;t.connectedCallback=function(){a==null||a.call(this);const ie=(Se,Ae)=>{var V;(V=i.value)==null||V.call(this)};r=new MutationObserver(ie),r.observe(this,e)},t.disconnectedCallback=function(){l==null||l.call(this),r.disconnect()}}}const ye=Q`
  @layer base, reset;
...
`;var we=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,X=e=>{throw TypeError(e)},m=(e,t,s,i)=>{for(var r=i>1?void 0:i?xe(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&we(t,s,r),r},F=(e,t,s)=>t.has(e)||X("Cannot "+s),Ce=(e,t,s)=>(F(e,t,"read from private field"),s?s.call(e):t.get(e)),U=(e,t,s)=>t.has(e)?X("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w=(e,t,s,i)=>(F(e,t,"write to private field"),t.set(e,s),s),q=(e,t,s)=>(F(e,t,"access private method"),s),f,C,S;let u=class extends pe(N){constructor(){super(),U(this,C),U(this,f,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",q(this,C,S)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),q(this,C,S).call(this,e))})}get hidden(){return Ce(this,f)}set hidden(e){this.isPlaceholder||(w(this,f,e==="true"||e===!0),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(w(this,f,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then(()=>B.instance.apply(this,"gds-option"))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(w(this,f,!0),this.setAttribute("aria-hidden","true")):(w(this,f,!1),this.setAttribute("aria-hidden","false"))}render(){var s;const e=(s=this.parentElement)==null?void 0:s.multiple,t=g`
      <span class="checkbox ${Y({checked:this.selected})}">
        ${this.selected?g`<gds-icon-checkmark stroke="4"></gds-icon-checkmark>`:""}
      </span>
    `;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),g`<div>${M(e,()=>t)} <slot></slot></div>`}};f=new WeakMap;C=new WeakSet;S=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))};u.styles=[J,ce];m([h()],u.prototype,"value",2);m([h({attribute:"aria-hidden",reflect:!0})],u.prototype,"hidden",1);m([h({attribute:"aria-selected",reflect:!0})],u.prototype,"selected",2);m([h({type:Boolean,reflect:!0})],u.prototype,"isPlaceholder",2);m([E("isplaceholder")],u.prototype,"_handlePlaceholderStatusChange",1);u=m([H("gds-option")],u);var Ee=Object.defineProperty,$e=Object.getOwnPropertyDescriptor,Z=e=>{throw TypeError(e)},$=(e,t,s,i)=>{for(var r=i>1?void 0:i?$e(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&Ee(t,s,r),r},Le=(e,t,s)=>t.has(e)||Z("Cannot "+s),x=(e,t,s)=>(Le(e,t,"read from private field"),s?s.call(e):t.get(e)),K=(e,t,s)=>t.has(e)?Z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),y,A;let v=class extends N{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,K(this,y,de()),K(this,A,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))}),new ue(this)}get navigableItems(){return this.visibleOptionElements}get options(){return x(this,y).value?fe(x(this,y).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),B.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",x(this,A))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return g`<slot ${he(x(this,y))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};y=new WeakMap;A=new WeakMap;v.styles=_e;$([h({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);$([h()],v.prototype,"compareWith",2);$([E("multiple")],v.prototype,"_rerenderOptions",1);v=$([H("gds-listbox")],v);var ke=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,j=e=>{throw TypeError(e)},n=(e,t,s,i)=>{for(var r=i>1?void 0:i?Oe(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&ke(t,s,r),r},G=(e,t,s)=>t.has(e)||j("Cannot "+s),d=(e,t,s)=>(G(e,t,"read from private field"),t.get(e)),c=(e,t,s)=>t.has(e)?j("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Me=(e,t,s,i)=>(G(e,t,"write to private field"),t.set(e,s),s),O=(e,t,s)=>(G(e,t,"access private method"),s),p,W,T,D,P,z,_,ee,te,se,b,L;let o=class extends le{constructor(){super(),c(this,_),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,c(this,p),c(this,W,e=>{const t=e.getBoundingClientRect(),i=window.innerHeight-t.bottom,r=t.top;let a=Math.min(r,this.maxHeight);return i>r&&(a=Math.min(i,this.maxHeight)),`${a-16}px`}),c(this,T,e=>{if(!e.currentTarget)return;const t=e.currentTarget;if(this.options.forEach(i=>i.hidden=!1),!t.value)return;this.options.filter(i=>!this.searchFilter(t.value,i)).forEach(i=>i.hidden=!0)}),c(this,D,e=>{var t;(t=this._elListbox)==null||t.then(s=>{if(e.key==="ArrowDown"||e.key==="Tab"){e.preventDefault(),s.focus();return}})}),c(this,P,e=>{var t;if(e.key==="Tab"&&this.searchable){e.preventDefault(),(t=this._elSearchInput)==null||t.focus();return}}),c(this,z,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),c(this,b,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)}),c(this,L,e=>{var t;e.key==="Tab"&&!this.searchable&&(e.preventDefault(),this.open=!1,(t=this._elTriggerBtn)==null||t.focus())}),be(this)}get type(){return"gds-dropdown"}get options(){return d(this,p)?Array.from(d(this,p)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if(d(this,p))return Array.from(d(this,p)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){var t,s;let e;return Array.isArray(this.value)?this.value.length>2?e=k(re`${this.value.length} selected`):e=this.value.reduce((i,r)=>{var a;return i+((a=this.options.find(l=>l.value===r))==null?void 0:a.innerHTML)+", "},"").slice(0,-2):e=(t=this.options.find(i=>i.selected))==null?void 0:t.innerHTML,e||((s=this.placeholder)==null?void 0:s.innerHTML)||""}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-dropdown"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange()})}render(){return g`
