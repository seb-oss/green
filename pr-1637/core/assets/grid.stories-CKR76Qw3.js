...
The \`auto-columns\` attribute is set to \`240\` which will make the columns to be \`240px\` no matter the screen/container size.`,...(O=(j=s.parameters)==null?void 0:j.docs)==null?void 0:O.description}}};const I=["Basic","Usage","AllBreakpoints","AutoColumns"];export{r as AllBreakpoints,s as AutoColumns,t as Basic,e as Usage,I as __namedExportsOrder,D as default};
