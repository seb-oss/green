import{n as d,r as k,g as I,h as o}from"./gds-element-QykLKB9o.js";import{a as X}from"./query-p8xgzTDt.js";import{r as z}from"./query-async-MEroNOeJ.js";import{b as j}from"./until-BfWLtGmt.js";import{i as U,D as g}from"./lit-element-BoQqPHl6.js";import{n as u}from"./when-BxLAFfhK.js";import{r as V}from"./choose-Dh3k58u9.js";import{m as C}from"./runtime-CMQcyTl6.js";import{c as J}from"./constrain-slots-I5VCMCIw.js";import{w as K}from"./watch-tFciLXSI.js";import{a as Q,f as Z}from"./button-CZqIUASK.js";import"./flex-424DpQYt.js";import{t as tt}from"./tokens.style-Dwr4YKnv.js";import{s as et}from"./style-expression-property-BArfVZRo.js";import"./cross-small-CT50TTBm.js";import"./triangle-exclamation-Bg-q5F9C.js";import"./container-DfaAw2Rq.js";import"./card-DmYIuWu1.js";import"./text-BzssjIYC.js";import"./badge-deWuY3uJ.js";const it=U`
...
`;var st=Object.defineProperty,nt=Object.getOwnPropertyDescriptor,M=t=>{throw TypeError(t)},r=(t,e,s,h)=>{for(var l=h>1?void 0:h?nt(e,s):e,x=t.length-1,f;x>=0;x--)(f=t[x])&&(l=(h?f(e,s,l):f(l))||l);return h&&l&&st(e,s,l),l},A=(t,e,s)=>e.has(t)||M("Cannot "+s),p=(t,e,s)=>(A(t,e,"read from private field"),s?s.call(t):e.get(t)),c=(t,e,s)=>e.has(t)?M("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),n=(t,e,s)=>(A(t,e,"access private method"),s),i,D,O,b,y,_,w,$,E,N,W,m,T,S,v,L,R,B,Y,P,G,H,F,q;let a=class extends Q{constructor(){super(),c(this,i),this.value="",this.label="",this.rows=4,this.lines=4,this.isDragging=!1,this.lastMouseY=0,this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.resize="",this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.trailSlotOccupied=!1,c(this,b,t=>["type","placeholder","required"].includes(t.name)),c(this,y,t=>{const e=t.target;this.value=e.value}),c(this,_,t=>{const e=t.target;this.value=e.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),c(this,w,()=>{this.elTextareaAsync.then(t=>t.focus())}),c(this,$,()=>{this.value=""}),c(this,E,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))}),J(this),this.lines=0,this.resize="auto"}connectedCallback(){super.connectedCallback(),this._setAutoHeight(),n(this,i,m).call(this)}disconnectedCallback(){super.disconnectedCallback(),n(this,i,m).call(this)}render(){return o`${V(this.variant,[["default",()=>n(this,i,D).call(this)],["floating-label",()=>n(this,i,O).call(this)]])}`}_getValidityAnchor(){return this.elTextarea}_setAutoHeight(){this.elTextareaAsync.then(t=>{const e=(t.value.split(`
`).length||1).toString();t==null||t.style.setProperty("--_lines",e.toString())})}};i=new WeakSet;D=function(){return o`
      <gds-flex
