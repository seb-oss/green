...
`,GdsFilterChip=class extends chunk_WIZDAKJ5.j{constructor(){super(...arguments),this.selected=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),chunk_2A4RZ526.nD.instance.apply(this,"gds-filter-chip"),this._button.then((btn=>{chunk_2A4RZ526.nD.instance.apply(btn,"gds-button")}))}render(){const btnClasses={"btn-p":!this.selected};return chunk_MLXMQIEV.qy`<gds-button
      class="btn"
      size="small"
