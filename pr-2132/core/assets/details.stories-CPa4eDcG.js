...
`;var ye=Object.defineProperty,fe=Object.getOwnPropertyDescriptor,ne=e=>{throw TypeError(e)},o=(e,t,s,n)=>{for(var a=n>1?void 0:n?fe(t,s):t,l=e.length-1,d;l>=0;l--)(d=e[l])&&(a=(n?d(t,s,a):d(a))||a);return n&&a&&ye(t,s,a),a},xe=(e,t,s)=>t.has(e)||ne("Cannot "+s),r=(e,t,s)=>(xe(e,t,"read from private field"),s?s.call(e):t.get(e)),m=(e,t,s)=>t.has(e)?ne("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),b,C,S,w,z,_,L;let i=class extends le(de(me(se))){constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",m(this,b,()=>{this.open=!this.open,r(this,w).call(this)}),m(this,C,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),r(this,b).call(this))}),m(this,S,()=>{!this.open||!this.name||document.querySelectorAll('[gds-element="gds-details"]').forEach(e=>{var t;if(e!==this&&e.name===this.name){const s=e;s.open=!1,r(t=s,w).call(t)}})}),m(this,w,()=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))}),m(this,z,()=>y`
      <div
        class="summary"
        part="summary"
        role="button"
    ...
    `}};b=new WeakMap;C=new WeakMap;S=new WeakMap;w=new WeakMap;z=new WeakMap;_=new WeakMap;L=new WeakMap;i.styles=[re,ue];o([x({type:String})],i.prototype,"summary",2);o([x({type:String})],i.prototype,"name",2);o([x({type:Boolean,reflect:!0})],i.prototype,"open",2);o([x({type:String})],i.prototype,"size",2);o([k(".content")],i.prototype,"_content",2);o([k('slot[name="summary-icon-open"]')],i.prototype,"_openIconSlot",2);o([k('slot[name="summary-icon-closed"]')],i.prototype,"_closedIconSlot",2);o([oe("open")],i.prototype,"__handleOpenChange",1);i=o([ae("gds-details",{dependsOn:[pe,f]})],i);i.define();const Xe={title:"Components/Details",component:"gds-details",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the details header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups detailss together. Detailss with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}},open:{description:"Controls if the details is expanded",control:"boolean",table:{type:{summary:"boolean"}}},size:{description:"Controls the size of the details",control:{type:"select",options:["large","small"]},table:{type:{summary:'"large" | "small"'},defaultValue:{summary:"large"}}}},parameters:{docs:{description:{component:`
## Overview
...
\`\`\`  
  ...
  `};var $,T,E,O,P;p.parameters={...p.parameters,docs:{...($=p.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    summary: 'Click to expand',
    innerHTML: 'Details content goes here'
  }
}`,...(E=(T=p.parameters)==null?void 0:T.docs)==null?void 0:E.source},description:{story:"Basic example of an details component.",...(P=(O=p.parameters)==null?void 0:O.docs)==null?void 0:P.description}}};var H,G,M,W,R;c.parameters={...c.parameters,docs:{...(H=c.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Grouped',
  parameters: {
    docs: {
...
\`
  ...
  \`
}`,...(M=(G=c.parameters)==null?void 0:G.docs)==null?void 0:M.source},description:{story:"Example of grouped detailss.",...(R=(W=c.parameters)==null?void 0:W.docs)==null?void 0:R.description}}};var B,q,A,F,V;g.parameters={...g.parameters,docs:{...(B=g.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Sizes',
  parameters: {
    docs: {
...
\\\`\\\`\\\`  
  ...
  \`
}`,...(Y=(U=u.parameters)==null?void 0:U.docs)==null?void 0:Y.source},description:{story:"Example of initially open details.",...(ee=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};const Je=["Default","Grouped","Sizes","RichContent","InitiallyOpen"];export{p as Default,c as Grouped,u as InitiallyOpen,h as RichContent,g as Sizes,Je as __namedExportsOrder,Xe as default};
