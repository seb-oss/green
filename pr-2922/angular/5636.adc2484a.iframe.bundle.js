...
`;let Kr=class extends Le.S{constructor(){super(),(0,o.VK)(this,mr),(0,o.VK)(this,_r),(0,o.VK)(this,Lr),(0,o.VK)(this,xr),(0,o.VK)(this,Sr),(0,o.VK)(this,$r),this._defaultRows=4,this.rows=4,this.supportingText="",this.clearable=!1,this.resizable="auto",this.showExtendedSupportingText=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.size="large",this.plain=!1,this.autocapitalize="off",this.autocorrect=!1,this.autofocus=!1,this.spellcheck=!0,this.charCounterCallback=Rr,(0,o.VK)(this,fr,this.charCounterCallback(this)),this._handleSlotChange=()=>{requestAnimationFrame(()=>{this._handleResize()})},(0,o.VK)(this,Vr,e=>{const t=e.target;this.value=t.value}),(0,o.VK)(this,kr,e=>{const t=e.target;this.value=t.value,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),(0,o.VK)(this,vr,e=>{requestAnimationFrame(()=>{this._setAutoHeight()})}),(0,o.VK)(this,yr,()=>{this.elTextareaAsync.then(e=>e.focus())}),(0,o.VK)(this,br,()=>{this.value="",this.elTextareaAsync.then(e=>{if("manual"===this.resizable)e.style.height="";else if("false"===this.resizable){const t=this._initialRows??this._defaultRows;this.rows=t,e.style.setProperty("--_lines",t.toString())}else{const t=this._initialRows??this._defaultRows;this.rows=t,e.style.setProperty("--_lines",t.toString()),e.style.height=""}}),this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),this.value=""}test_getClearButton(){return this.shadowRoot?.querySelector("#clear-button")}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}focus(e){this._getValidityAnchor()?.focus(e)}select(){this._getValidityAnchor()?.select()}setRangeText(...e){this._getValidityAnchor()?.setRangeText(...e),this.value=this._getValidityAnchor()?.value||""}setSelectionRange(...e){this._getValidityAnchor()?.setSelectionRange(...e)}get selectionStart(){return this._getValidityAnchor()?.selectionStart}set selectionStart(e){const t=this._getValidityAnchor();t&&(t.selectionStart=e)}get selectionEnd(){return this._getValidityAnchor()?.selectionEnd}set selectionEnd(e){const t=this._getValidityAnchor();t&&(t.selectionEnd=e)}get selectionDirection(){return this._getValidityAnchor()?.selectionDirection}set selectionDirection(e){const t=this._getValidityAnchor();t&&(t.selectionDirection=e)}_handleResize(){this.fieldBase&&Promise.resolve().then(()=>{const e=this.fieldBase?.shadowRoot;if(!e)return;const t=e.querySelector(".right");if(t){const e=t.getBoundingClientRect();this.elTextarea.style.setProperty("--padding-inline-end",`${e.width}px`)}else this.elTextarea.style.removeProperty("--padding-inline-end")})}connectedCallback(){super.connectedCallback(),this.hasAttribute("rows")&&(this._initialRows=this.rows),this._setAutoHeight(),this.addEventListener("slotchange",this._handleSlotChange)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("slotchange",this._handleSlotChange)}render(){return d.qy`
      ...
      ${(0,fe.z)((0,o.jq)(this,mr,Mr).call(this),()=>d.qy`<gds-form-control-footer
            id="footer"
            class="size-${this.size}"
...
`;let Cs=class extends Le.S{constructor(){super(),(0,o.VK)(this,Dr),(0,o.VK)(this,es),(0,o.VK)(this,rs),(0,o.VK)(this,os),(0,o.VK)(this,is),(0,o.VK)(this,as),this.supportingText="",this.showExtendedSupportingText=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.size="large",this.plain=!1,this.type="text",this.autocapitalize="off",this.autocorrect=!1,this.autofocus=!1,this.spellcheck=!0,this.charCounterCallback=Rr,(0,o.VK)(this,Pr,this.charCounterCallback(this)),(0,o.VK)(this,Fr,e=>{const t=e.target;this.value=t.value}),(0,o.VK)(this,Ur,e=>{const t=e.target;this.value=t.value,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),(0,o.VK)(this,Jr,e=>{if("Enter"!==e.key)return;if(this.disabled)return;if(e.isComposing)return;if(e.repeat)return;const t=this.form??this.closest("form");t&&queueMicrotask(()=>{e.defaultPrevented||this.disabled||t.requestSubmit()})}),(0,o.VK)(this,Qr,()=>{this.elInputAsync.then(e=>e.focus())}),(0,o.VK)(this,Xr,()=>{this.value="",this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),this.value=""}focus(e){this._getValidityAnchor()?.focus(e)}select(){this._getValidityAnchor()?.select()}setRangeText(...e){this._getValidityAnchor()?.setRangeText(...e),this.value=this._getValidityAnchor()?.value||""}setSelectionRange(...e){this._getValidityAnchor()?.setSelectionRange(...e)}showPicker(){this._getValidityAnchor()?.showPicker()}stepDown(e){this._getValidityAnchor()?.stepDown(e)}stepUp(e){this._getValidityAnchor()?.stepUp(e)}get selectionStart(){return this._getValidityAnchor()?.selectionStart}set selectionStart(e){const t=this._getValidityAnchor();t&&(t.selectionStart=e)}get selectionEnd(){return this._getValidityAnchor()?.selectionEnd}set selectionEnd(e){const t=this._getValidityAnchor();t&&(t.selectionEnd=e)}get selectionDirection(){return this._getValidityAnchor()?.selectionDirection}set selectionDirection(e){const t=this._getValidityAnchor();t&&(t.selectionDirection=e)}test_getClearButton(){return this.shadowRoot?.querySelector("#clear-button")}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}render(){return d.qy`
      ...
      ${(0,fe.z)((0,o.jq)(this,Dr,Or).call(this),()=>d.qy` <gds-form-control-footer
            id="message"
            class="size-${this.size}"
...
`;let Zs=class extends((0,u.Q8)((0,u.lt)(c.j))){constructor(){super(),(0,o.VK)(this,_s),(0,o.VK)(this,Ls),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const e={button:!0,selected:this.selected,compact:this.compact},t=(0,o.S7)(this,_s,ws)?Yt.eu`a`:Yt.eu`button`;return Yt.qy`
  ...
  `,(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Is.prototype,"show",2),Is=(0,o.Cc)([(0,d.Y$)("gds-backdrop")],Is);const $s=e=>{Is.define();const t=(0,L.pI)("gds-backdrop"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};$s.displayName="GdsBackdrop";var Ns=r(2144);const Gs=e=>{Ns.E.define();const t=(0,L.pI)("gds-popover"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};Gs.displayName="GdsPopover";var js=r(8714),Es=r(3864),qs=r(6428);let Bs=class extends g.M{};Bs._regularSVG='<path d="M10 16L6 12L10 8M17 16L13 12L17 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Bs._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M10.5303 7.46967C10.8232 7.76256 10.8232 8.23744 10.5303 8.53033L7.06066 12L10.5303 15.4697C10.8232 15.7626 10.8232 16.2374 10.5303 16.5303C10.2374 16.8232 9.76256 16.8232 9.46967 16.5303L5.46967 12.5303C5.17678 12.2374 5.17678 11.7626 5.46967 11.4697L9.46967 7.46967C9.76256 7.17678 10.2374 7.17678 10.5303 7.46967ZM17.5303 7.46967C17.8232 7.76256 17.8232 8.23744 17.5303 8.53033L14.0607 12L17.5303 15.4697C17.8232 15.7626 17.8232 16.2374 17.5303 16.5303C17.2374 16.8232 16.7626 16.8232 16.4697 16.5303L12.4697 12.5303C12.1768 12.2374 12.1768 11.7626 12.4697 11.4697L16.4697 7.46967C16.7626 7.17678 17.2374 7.17678 17.5303 7.46967Z" fill="currentColor"/>',Bs._name="chevron-double-left",Bs._width=24,Bs._height=24,Bs._viewBox="0 0 24 24",Bs=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-double-left")],Bs);let zs=class extends g.M{};zs._regularSVG='<path d="M14 16L18 12L14 8M7 16L11 12L7 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',zs._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M6.46967 7.46967C6.76256 7.17678 7.23744 7.17678 7.53033 7.46967L11.5303 11.4697C11.8232 11.7626 11.8232 12.2374 11.5303 12.5303L7.53033 16.5303C7.23744 16.8232 6.76256 16.8232 6.46967 16.5303C6.17678 16.2374 6.17678 15.7626 6.46967 15.4697L9.93934 12L6.46967 8.53033C6.17678 8.23744 6.17678 7.76256 6.46967 7.46967ZM13.4697 7.46967C13.7626 7.17678 14.2374 7.17678 14.5303 7.46967L18.5303 11.4697C18.8232 11.7626 18.8232 12.2374 18.5303 12.5303L14.5303 16.5303C14.2374 16.8232 13.7626 16.8232 13.4697 16.5303C13.1768 16.2374 13.1768 15.7626 13.4697 15.4697L16.9393 12L13.4697 8.53033C13.1768 8.23744 13.1768 7.76256 13.4697 7.46967Z" fill="currentColor"/>',zs._name="chevron-double-right",zs._width=24,zs._height=24,zs._viewBox="0 0 24 24",zs=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-double-right")],zs);let As=class extends g.M{};As._regularSVG='<path d="M14 16L10 12L14 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',As._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M14.5303 7.46967C14.2374 7.17678 13.7626 7.17678 13.4697 7.46967L9.46967 11.4697C9.17678 11.7626 9.17678 12.2374 9.46967 12.5303L13.4697 16.5303C13.7626 16.8232 14.2374 16.8232 14.5303 16.5303C14.8232 16.2374 14.8232 15.7626 14.5303 15.4697L11.0607 12L14.5303 8.53033C14.8232 8.23744 14.8232 7.76256 14.5303 7.46967Z" fill="currentColor"/>',As._name="chevron-left-small",As._width=24,As._height=24,As._viewBox="0 0 24 24",As=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-left-small")],As);let Ws=class extends g.M{};Ws._regularSVG='<path d="M10 16L14 12L10 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Ws._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M9.46967 7.46967C9.76256 7.17678 10.2374 7.17678 10.5303 7.46967L14.5303 11.4697C14.8232 11.7626 14.8232 12.2374 14.5303 12.5303L10.5303 16.5303C10.2374 16.8232 9.76256 16.8232 9.46967 16.5303C9.17678 16.2374 9.17678 15.7626 9.46967 15.4697L12.9393 12L9.46967 8.53033C9.17678 8.23744 9.17678 7.76256 9.46967 7.46967Z" fill="currentColor"/>',Ws._name="chevron-right-small",Ws._width=24,Ws._height=24,Ws._viewBox="0 0 24 24",Ws=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-right-small")],Ws);var Ys=r(4671);const Ks=b.AH`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var Ts,Rs,Ps,Ds,Os,Fs,Us,Js,Qs,Xs,eo,to,ro,so,oo,no,io,lo,ao,co,Co,ho,po,uo,go,fo,mo,Mo,Vo,ko,vo,yo,bo,_o;const wo={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let Lo=class extends((0,u.TM)((0,u.Q8)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,Ts),(0,o.VK)(this,Ps),(0,o.VK)(this,Os),(0,o.VK)(this,Us),(0,o.VK)(this,Qs),(0,o.VK)(this,eo),(0,o.VK)(this,ro),(0,o.VK)(this,oo),(0,o.VK)(this,io),(0,o.VK)(this,ao),(0,o.VK)(this,Co),(0,o.VK)(this,po),(0,o.VK)(this,go),(0,o.VK)(this,mo),(0,o.VK)(this,Vo),(0,o.VK)(this,vo),(0,o.VK)(this,bo),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(e){this._isMobile=e}render(){const e=(0,o.S7)(this,Ts,Rs)>1,t=(0,o.jq)(this,po,uo).call(this);return e||t?d.qy`
      <nav aria-label="${this.label||(0,N.ab)("Pagination")}">
        ...
        >
          ...
          >
            ${[(0,fe.z)(e,()=>(0,o.jq)(this,ao,co).call(this)),t]}
          </gds-flex>
        </gds-flex>
      </nav>
    `:b.s6}};Ts=new WeakSet,Rs=function(){return Math.ceil(this.total/this.rows)},Ps=new WeakSet,Ds=function(){return wo[this.density]},Os=new WeakSet,Fs=function(e){if(e<=7)return Array.from({length:e},(e,t)=>t+1);const t=e,r=[];return r.push(1),this.page<=4?r.push(2,3,4,5,"...",t):this.page>=e-3?r.push("...",e-4,e-3,e-2,e-1,t):r.push("...",this.page-1,this.page,this.page+1,"...",t),r},Us=new WeakSet,Js=function(e){if("..."===e)return d.qy`
        <gds-popover
          disableMobileStyles
          @gds-ui-state=${(0,o.jq)(this,vo,yo)}
        >
          <gds-button
          ...
          >
            <gds-input
              ...
              @change=${(0,o.jq)(this,bo,_o)}
            >
              <gds-button
                size="xs"
                label="${(0,N.ab)("Go")}"
                rank="secondary"
                @click=${(0,o.jq)(this,bo,_o)}
                slot="trail"
              >
      ...
      <gds-button
        ...
        @click=${()=>(0,o.jq)(this,mo,Mo).call(this,t)}
      >
        ${t}
      </gds-button>
    `},Qs=new WeakSet,Xs=function(){const e=(0,o.S7)(this,Ts,Rs),t=(0,o.jq)(this,Os,Fs).call(this,e);return d.qy`${t.map(e=>(0,o.jq)(this,Us,Js).call(this,e))}`},eo=new WeakSet,to=function(){return d.qy`
      <gds-button
        ...
        @click=${()=>(0,o.jq)(this,mo,Mo).call(this,1)}
      >
    ...
    `},ro=new WeakSet,so=function(){return d.qy`
      <gds-button
        ...
        ?disabled=${1===this.page}
        @click=${()=>(0,o.jq)(this,mo,Mo).call(this,this.page-1)}
      >
    ...
    `},io=new WeakSet,lo=function(){const e=(0,o.S7)(this,Ts,Rs);return d.qy`
      <gds-button
        ...
        ?disabled=${this.page===e}
        @click=${()=>(0,o.jq)(this,mo,Mo).call(this,e)}
      >
    ...
    `},ao=new WeakSet,co=function(){return d.qy`
      <gds-flex
        ...
        flex="1"
      >
        ${[(0,fe.z)(this.jump,()=>(0,o.jq)(this,eo,to).call(this)),(0,o.jq)(this,ro,so).call(this)]}
    ...
    `},Co=new WeakSet,ho=function(e){const t=this.rows===e;return d.qy`
      <gds-menu-item
        data-value=${e}
    ...
    `},po=new WeakSet,uo=function(){if(this._isMobile||this.hideOptions||this.options.length<=1)return null;const e=`${(0,N.ab)("Rows per page")}, ${this.rows} ${(0,N.ab)("selected")}`;return d.qy`
      <gds-flex align-items="center" gap="s">
        ...
        <gds-context-menu @gds-menu-item-click=${(0,o.jq)(this,Vo,ko)}>
          <gds-button
            slot="trigger"
            size="${(0,o.S7)(this,Ps,Ds).button}"
            rank="secondary"
          ...
          ${this.options.map(e=>(0,o.jq)(this,Co,ho).call(this,e))}
        </gds-context-menu>
      </gds-flex>
    `},go=new WeakSet,fo=function(){return this._isMobile||!this.label?null:d.qy`
      <gds-text
        font="${(0,o.S7)(this,Ps,Ds).font}"
        color="neutral-02"
        aria-live="polite"
    ...
    `},mo=new WeakSet,Mo=function(e){this.dispatchCustomEvent("gds-page-change",{detail:{page:e},bubbles:!0})},Vo=new WeakSet,ko=function(e){const t=e.target,r=parseInt(t.dataset.value||"10");r!==this.rows&&this.dispatchCustomEvent("gds-rows-change",{detail:{rows:r},bubbles:!0})},vo=new WeakSet,yo=function(e){if(this._jumpPopoverOpen=e.detail.open,e.detail.open){const t=e.target.querySelector('[gds-element="gds-input"]');t&&requestAnimationFrame(()=>{t.focus()})}},bo=new WeakSet,_o=function(e){const t=e.target.closest('[gds-element="gds-input"]');if(t){const e=parseInt(t.value,10);if(e&&e>=1&&e<=(0,o.S7)(this,Ts,Rs)){(0,o.jq)(this,mo,Mo).call(this,e);const r=t.closest('[gds-element="gds-popover"]');r&&(r.open=!1)}}},Lo.styles=[C.LU,Ks],(0,o.Cc)([(0,i.MZ)({type:Number})],Lo.prototype,"page",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Lo.prototype,"rows",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Lo.prototype,"total",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Lo.prototype,"options",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],Lo.prototype,"jump",2),(0,o.Cc)([(0,i.MZ)({attribute:"hide-options",type:Boolean,reflect:!1})],Lo.prototype,"hideOptions",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],Lo.prototype,"density",2),(0,o.Cc)([(0,i.MZ)()],Lo.prototype,"label",2),(0,o.Cc)([(0,i.P)("#page-input")],Lo.prototype,"_elInput",2),(0,o.Cc)([(0,i.wk)()],Lo.prototype,"_isMobile",2),(0,o.Cc)([(0,i.wk)()],Lo.prototype,"_jumpPopoverOpen",2),(0,o.Cc)([(0,js.M)("(max-width: 768px)")],Lo.prototype,"_handleMobile",1),Lo=(0,o.Cc)([(0,N.cc)(),(0,d.Y$)("gds-pagination",{dependsOn:[z.t,Ns.E,Rt,hs,It.E,ze.Hx,Es.T,qs.o,As,Bs,Ys.V,Ws,zs]}),(0,G.J)({labelledBy:"nav",describedBy:"nav"})],Lo);const Ho=e=>{Lo.define();const t=(0,L.pI)("gds-pagination"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};Ho.displayName="GdsPagination";var xo,Zo,So=b.AH`
  :host {
    cursor: pointer;
  }
...
`;let Io=class extends c.j{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,(0,o.VK)(this,xo,e=>{!this.disabled&&this.label&&(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchStandardEvent("input",{bubbles:!0}))}),(0,o.VK)(this,Zo,e=>{this.disabled||"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this.checked=!0,this.dispatchStandardEvent("input",{bubbles:!0}))}),this.addEventListener("keydown",(0,o.S7)(this,Zo)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",(0,o.S7)(this,xo))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.setAttribute("aria-description",this.errorMessage?this.errorMessage:""),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}render(){return d.qy`
    ...
    `}};xo=new WeakMap,Zo=new WeakMap,Io.styles=[be.A,So],(0,o.Cc)([(0,i.MZ)()],Io.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],Io.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({type:String})],Io.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Io.prototype,"checked",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Io.prototype,"disabled",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],Io.prototype,"invalid",2),(0,o.Cc)([(0,i.MZ)({type:String})],Io.prototype,"errorMessage",2),(0,o.Cc)([(0,i.wk)()],Io.prototype,"_isFocused",2),Io=(0,o.Cc)([(0,d.Y$)("gds-radio",{dependsOn:[ye]}),(0,G.J)({labelledBy:"gds-toggle-control-base",describedBy:"gds-toggle-control-base"})],Io);const $o=e=>{Io.define();const t=(0,L.pI)("gds-radio"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};$o.displayName="GdsRadio";var No=r(685),Go=b.AH`
  :host {
    font: var(--gds-sys-text-body-m-regular);
...
`;let mn=class extends Le.S{constructor(){super(...arguments),(0,o.VK)(this,en),(0,o.VK)(this,sn),(0,o.VK)(this,nn),(0,o.VK)(this,an),(0,o.VK)(this,dn),(0,o.VK)(this,hn),(0,o.VK)(this,un),this.supportingText="",this.showExtendedSupportingText=!1,this.size="large",this.plain=!1,(0,o.VK)(this,Xo,!1),(0,o.VK)(this,rn,e=>{e.stopPropagation(),(0,o.jq)(this,sn,on).call(this),requestAnimationFrame(()=>{this.dispatchCustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0}),this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})})})}get value(){return this._internalValue}set value(e){(0,o.S7)(this,Xo)||(0,o.OV)(this,Xo,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){return this.selectElement?.multiple??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}focus(e){this._getValidityAnchor()?.focus(e)}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),d.qy`
    ...
    `}_captureDOM(){if(!this.shadowRoot||0===this.childNodes.length||!this._elSelectContainer)return;const e=Array.from(this.children).filter(e=>"SELECT"===e.nodeName).map(e=>{const t=e.cloneNode(!0);return t.addEventListener("change",(0,o.S7)(this,rn)),t.addEventListener("input",(0,o.S7)(this,rn)),t.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),t.ariaLabel=this.label,t.setAttribute("id","select"),t.disabled=this.disabled,t.className="native-control",(0,o.S7)(this,Xo)?t.value=this.value:this._internalValue=t.value,t});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};Xo=new WeakMap,en=new WeakSet,tn=function(){return!this.plain&&this.invalid},rn=new WeakMap,sn=new WeakSet,on=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(e=>e.value)}else this.value=this.selectElement.value},nn=new WeakSet,ln=function(){return[(0,o.jq)(this,an,cn).call(this),(0,o.jq)(this,hn,pn).call(this),(0,o.jq)(this,dn,Cn).call(this),(0,o.jq)(this,un,gn).call(this)].map(e=>d.qy`${e}`)},an=new WeakSet,cn=function(){return d.qy`<slot name="lead" slot="lead"></slot>`},dn=new WeakSet,Cn=function(){if(!this.multiple)return d.qy`<label id="placeholder" class="native-control"
      ...
      `},mn.styles=[C.LU,zr.A,fn],(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],mn.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],mn.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:String})],mn.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],mn.prototype,"plain",2),(0,o.Cc)([(0,i.P)("select")],mn.prototype,"selectElement",2),(0,o.Cc)([(0,i.MZ)()],mn.prototype,"value",1),(0,o.Cc)([(0,i.P)(".select-container")],mn.prototype,"_elSelectContainer",2),(0,o.Cc)([(0,No.L)({childList:!0,subtree:!0,attributes:!0,characterData:!0})],mn.prototype,"_captureDOM",1),(0,o.Cc)([(0,we.w)("value")],mn.prototype,"_handleValueChange",1),mn=(0,o.Cc)([(0,G.J)({labelledBy:"select",describedBy:"select",errorMessage:"select"}),(0,N.cc)()],mn);let Mn=class extends((0,u.lt)((0,u.Q8)((0,u.TM)(mn)))){};Mn=(0,o.Cc)([(0,d.Y$)("gds-select",{dependsOn:[Br.$,qr.V,Er.w,qs.o]})],Mn);const Vn=e=>{Mn.define();const t=(0,L.pI)("gds-select"),r=(0,n.useRef)(null),s=e.ref||r;(0,L.j_)(s,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:s};return(0,n.createElement)(t,c)};Vn.displayName="GdsSelect";var kn=b.AH`
  :host {
    display: inline-block;
  }
...
`;let eC=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(R(hr(c.j)))))){constructor(){super(...arguments),(0,o.VK)(this,jd),(0,o.VK)(this,qd),(0,o.VK)(this,zd),(0,o.VK)(this,Wd),(0,o.VK)(this,Kd),(0,o.VK)(this,Rd),(0,o.VK)(this,Dd),(0,o.VK)(this,Fd),(0,o.VK)(this,Jd),this.title="",this.excerpt="",this.label="",this.variant="neutral-01",this.tag="h2",this.ratio="landscape",this.category="",this.date="",this.dateFormat="dateTimeLong",this.locale="en-GB"}render(){return(0,fe.z)(this.href,()=>(0,o.jq)(this,Kd,Td).call(this),()=>(0,o.jq)(this,Dd,Od).call(this))}};jd=new WeakSet,Ed=function(e=!1){return e&&this.label||this.querySelector('[slot="footer"]')},qd=new WeakSet,Bd=function(e){return(0,l.H)({card:!0,[`card-${e}`]:!!e,[`variant-${this.variant}`]:!0,[`ratio-${this.ratio}`]:!0})},zd=new WeakSet,Ad=function(){return!!this.querySelector('[slot="media"]')},Wd=new WeakSet,Yd=function(){return this.src?d.qy`
    ...
    `},Rd=new WeakSet,Pd=function(){return(0,fe.z)((0,o.jq)(this,jd,Ed).call(this,!0),()=>d.qy`
        <gds-flex
          font="detail-m-book"
          align-items="center"
          gap="s"
    ...
    `},Fd=new WeakSet,Ud=function(){return(0,fe.z)((0,o.jq)(this,jd,Ed).call(this),()=>d.qy`
      ...
      <gds-flex flex-direction="column" gap="xl" padding="xl">
        ${(0,fe.z)(!this.src&&!(0,o.jq)(this,zd,Ad).call(this),()=>d.qy`<slot name="header"></slot>`)}
        ${(0,fe.z)(this.title||this.excerpt,()=>d.qy`
          ...
          `)}
        ${(0,fe.z)(this.href,()=>(0,o.jq)(this,Rd,Pd).call(this),()=>(0,o.jq)(this,Fd,Ud).call(this))}
      </gds-flex>
...
`;let yC=class extends(R(kC.s)){constructor(){super(...arguments),(0,o.VK)(this,rC),(0,o.VK)(this,oC),(0,o.VK)(this,iC),(0,o.VK)(this,aC),(0,o.VK)(this,dC),(0,o.VK)(this,hC),(0,o.VK)(this,uC),(0,o.VK)(this,fC),(0,o.VK)(this,MC),this._isWrapped=!1,this._hasLead=!1,this.label="",this.selectable=!1,this.checked=!1,this.indeterminate=!1,this.disabled=!1,this._hasTrailContent=!1}_checkWrap(){const e=this._itemsContainer;if(!e)return;const t=Array.from(e.children);if(t.length<2)return void(this._isWrapped=!1);const r=t[0].getBoundingClientRect().top;this._isWrapped=t.some(e=>e.getBoundingClientRect().top>r)}render(){return d.qy`${(0,o.jq)(this,MC,VC).call(this)}`}};rC=new WeakSet,sC=function(){return!!this.href},oC=new WeakSet,nC=function(){const e=e=>{e.stopPropagation(),this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))};return d.qy`
    ...
    `},dC=new WeakSet,CC=function(e){const t=e.target;this._hasLead=t.assignedElements().length>0},hC=new WeakSet,pC=function(e){const t=e.target;this._hasTrailContent=t.assignedElements().length>0||(0,o.S7)(this,rC,sC)},uC=new WeakSet,gC=function(){if(this.items&&this.items.length>0){const e=this.items.length>=3?"wrap":"nowrap",t=this.items.length>=2&&!this._isWrapped;return d.qy`
      ...
      <slot name="trail" @slotchange=${(0,o.jq)(this,hC,pC)} class=${e}
        >${(0,fe.z)(this.href,()=>d.qy`<gds-icon-chevron-right></gds-icon-chevron-right>`)}</slot
      >
...
//# sourceMappingURL=5636.adc2484a.iframe.bundle.js.map