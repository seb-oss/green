import{u as s,j as e,M as t}from"./iframe-C9vl5CI1.js";import"./preload-helper-PPVm8Dsz.js";function r(o){const n={a:"a",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Guides/Angular"}),`
...
`]}),`
`,e.jsx(n.h2,{id:"types-and-utilities",children:"Types and utilities"}),`
`,e.jsxs(n.p,{children:["The wrapper library re-exports types, utilities and other non-component symbols from ",e.jsx(n.code,{children:"@sebgroup/green-core"}),", so you don't need to add ",e.jsx(n.code,{children:"@sebgroup/green-core"})," as a direct dependency. This avoids version mismatches that can occur when both packages are listed in your ",e.jsx(n.code,{children:"package.json"}),"."]}),`
`,e.jsx(n.h3,{id:"localization",children:"Localization"}),`
`,e.jsxs(n.p,{children:["To set up localization, import ",e.jsx(n.code,{children:"gdsInitLocalization"})," from the ",e.jsx(n.code,{children:"/localization"})," path:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`import { gdsInitLocalization } from '@sebgroup/green-core-ng/localization'

gdsInitLocalization()
`})}),`
`,e.jsx(n.h3,{id:"component-specific-types",children:"Component-specific types"}),`
`,e.jsxs(n.p,{children:["Some components export types and utilities that you may need. For example, the table component exports column definitions, request/response types, and helper functions. These are available under the same component path as in ",e.jsx(n.code,{children:"@sebgroup/green-core"}),":"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// Before
import type { Types } from '@sebgroup/green-core/components/table'

// After — just change the package name
import type { Types } from '@sebgroup/green-core-ng/components/table'
`})}),`
`,e.jsx(n.p,{children:"This works for all components that export types."}),`
`,e.jsx(n.h3,{id:"scoping-utilities",children:"Scoping utilities"}),`
`,e.jsxs(n.p,{children:["Core's scoping utilities are merged with the Angular-specific scoping module, so you get both by importing from the main package or from ",e.jsx(n.code,{children:"/scoping"}),":"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`import { provideCoreRenderer, gdsCustomElement } from '@sebgroup/green-core-ng'
`})})]})}function c(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(r,{...o})}):r(o)}export{c as default};
