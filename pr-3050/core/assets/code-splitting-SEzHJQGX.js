import{u as t,j as e,M as d}from"./iframe-C9vl5CI1.js";import"./preload-helper-PPVm8Dsz.js";function s(o){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Contributing/Code Splitting"}),`
...
export * from './option'
`})}),`
`,e.jsxs(n.p,{children:["Internally, the dropdown also use other components, such as ",e.jsx(n.code,{children:"gds-popover"}),". These are also imported by the component."]}),`
