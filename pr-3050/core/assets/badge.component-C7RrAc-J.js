import{i as b,T as m,C as x,L as z,D as S,e as w,h as l,B as O,n as c,E as y,a as E}from"./iframe-C9vl5CI1.js";import{G as k}from"./flex.component-DhVZE6-t.js";const C=b`
...
`;var T=Object.defineProperty,N=Object.getOwnPropertyDescriptor,h=s=>{throw TypeError(s)},n=(s,e,a,i)=>{for(var t=i>1?void 0:i?N(e,a):e,g=s.length-1,p;g>=0;g--)(p=s[g])&&(t=(i?p(e,a,t):p(t))||t);return i&&t&&T(e,a,t),t},P=(s,e,a)=>e.has(s)||h("Cannot "+a),G=(s,e,a)=>e.has(s)?h("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,a),d=(s,e,a)=>(P(s,e,"access private method"),a),r,v,_,f,u;let o=class extends m(x(z(S))){constructor(){super(...arguments),G(this,r),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const s=w({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return l`
    ...
    ></slot>`};u=function(){return l`<slot name="trail"></slot>`};o.styles=[O,C];n([c()],o.prototype,"variant",2);n([c({type:String})],o.prototype,"size",2);n([c({attribute:"notification",type:Boolean,reflect:!0})],o.prototype,"notification",2);n([c({attribute:"rounded",type:Boolean,reflect:!0})],o.prototype,"rounded",2);n([y()],o.prototype,"mainSlotOccupied",2);n([y()],o.prototype,"leadSlotOccupied",2);o=n([E("gds-badge",{dependsOn:[k]})],o);export{o as G};
