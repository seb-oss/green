import{j as r}from"./jsx-runtime-u17CrQMm.js";import{e as y}from"./iframe-C5Ht9GiP.js";import{o as C}from"./create-component-CVDMTe9T.js";import{i as b,G as $,h as _,_ as l,n as o,g as F,r as j,b as p,c as d,d as g,e as G,a as w}from"./declarative-layout-mixins-RRaBVSCZ.js";import{e as T,w as z,a as E}from"./watch-rsnQmdjn.js";import{e as x}from"./class-map-Dw-lskpk.js";import{r as V}from"./resize-observer-CfkbZofs.js";import{s as W}from"./attribute-converters-CdI0trPX.js";import{G as B,a as H}from"./button.component-D88qyTuS.js";import{T as I,b as O}from"./transitional-styles-D3LAqJWP.js";import{I as M}from"./checkmark.component-CMYf8oPw.js";const D=b`
...
`;let i=class extends ${constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),I.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return _`<gds-button
      class="btn"
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};i.styles=[D];l([o({reflect:!0,type:Boolean})],i.prototype,"selected",2);l([o()],i.prototype,"value",2);l([o({reflect:!0,type:String})],i.prototype,"size",2);i=l([F("gds-filter-chip",{dependsOn:[B,M]})],i);const R=b`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
