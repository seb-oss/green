import{n as h,g as H,G as J,h as w,a as se}from"./gds-element-54cd6e2a.js";import{a as Q}from"./query-b9d3c2af.js";import{r as ie}from"./query-async-1ff18261.js";import{o as re}from"./icon-35869773.js";import{n as A}from"./when-cf7256a5.js";import{o as ae}from"./if-defined-e4b5fcf9.js";import{e as X}from"./class-map-4ef1884f.js";import{m as S,s as oe}from"./lit-localize-87611c26.js";import{c as le}from"./constrain-slots-08d8606c.js";import{w as E}from"./watch-c4961afe.js";import{n as ne,e as he}from"./ref-ff2f01fc.js";import{T as G}from"./transitional-styles-73ecf23d.js";import{x as N,i as Y}from"./lit-element-71e04f06.js";import{s as pe,F as ce,L as de,u as ue}from"./menu-heading-909e4c80.js";import"./popover-6e651eee.js";import"./backdrop-24fc6001.js";import{G as fe}from"./form-control-be1a61da.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ve{constructor(t){this.__litLocalizeEventHandler=s=>{s.detail.status==="ready"&&this.host.requestUpdate()},this.host=t}hostConnected(){window.addEventListener(K,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(K,this.__litLocalizeEventHandler)}}const ge=e=>e.addController(new ve(e)),me=ge;function be(e={attributes:!0,childList:!0,subtree:!1,characterData:!0}){return(t,s,r)=>{let i;const o=t.connectedCallback,n=t.disconnectedCallback;t.connectedCallback=function(){o==null||o.call(this);const te=(ke,We)=>{var I;(I=r.value)==null||I.call(this)};i=new MutationObserver(te),i.observe(this,e)},t.disconnectedCallback=function(){n==null||n.call(this),i.disconnect()}}}var _e=Object.defineProperty,ye=Object.getOwnPropertyDescriptor,m=(e,t,s,r)=>{for(var i=r>1?void 0:r?ye(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&_e(t,s,i),i},z=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)},we=(e,t,s)=>(z(e,t,"read from private field"),s?s.call(e):t.get(e)),U=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},_=(e,t,s,r)=>(z(e,t,"write to private field"),r?r.call(e,s):t.set(e,s),s),q=(e,t,s)=>(z(e,t,"access private method"),s),u,C,O;let d=class extends ce(J){constructor(){super(),U(this,C),U(this,u,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",q(this,C,O)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),q(this,C,O).call(this,e))})}get hidden(){return we(this,u)}set hidden(e){this.isPlaceholder||(_(this,u,e==="true"||e===!0),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(_(this,u,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then(()=>G.instance.apply(this,"gds-option"))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(_(this,u,!0),this.setAttribute("aria-hidden","true")):(_(this,u,!1),this.setAttribute("aria-hidden","false"))}render(){var s;const e=(s=this.parentElement)==null?void 0:s.multiple,t=N` <span
      class="checkbox ${X({checked:this.selected})}"
    ></span>`;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),N`<div>${A(e,()=>t)} <slot></slot></div>`}};u=new WeakMap;C=new WeakSet;O=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))};d.styles=pe;m([h()],d.prototype,"value",2);m([h({attribute:"aria-hidden",reflect:!0})],d.prototype,"hidden",1);m([h({attribute:"aria-selected",reflect:!0})],d.prototype,"selected",2);m([h({type:Boolean,reflect:!0})],d.prototype,"isPlaceholder",2);m([E("isplaceholder")],d.prototype,"_handlePlaceholderStatusChange",1);d=m([H("gds-option")],d);const Ce=Y`
...
`;var Ee=Object.defineProperty,$e=Object.getOwnPropertyDescriptor,$=(e,t,s,r)=>{for(var i=r>1?void 0:r?$e(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&Ee(t,s,i),i},Le=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)},y=(e,t,s)=>(Le(e,t,"read from private field"),s?s.call(e):t.get(e)),R=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},b,k;let v=class extends J{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,R(this,b,he()),R(this,k,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))}),new de(this)}get navigableItems(){return this.visibleOptionElements}get options(){return y(this,b).value?ue(y(this,b).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),G.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",y(this,k))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return w`<slot ${ne(y(this,b))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};b=new WeakMap;k=new WeakMap;v.styles=Ce;$([h({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);$([h()],v.prototype,"compareWith",2);$([E("multiple")],v.prototype,"_rerenderOptions",1);v=$([H("gds-listbox")],v);const Se=Y`
  @layer base, reset, transitional-styles;
