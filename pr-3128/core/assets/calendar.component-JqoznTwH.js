...
`;function ue(t,e){const s=ee(t),a=Q(t),r=Z({start:s,end:a},{weekStartsOn:1});for(;r.length<6;)r.push(k(r[r.length-1],7));return y`${e(r.map(o=>({days:X({start:o,end:k(o,6)})})))}`}var ce=Object.defineProperty,he=Object.getOwnPropertyDescriptor,E=t=>{throw TypeError(t)},c=(t,e,s,a)=>{for(var r=a>1?void 0:a?he(e,s):e,o=t.length-1,i;o>=0;o--)(i=t[o])&&(r=(a?i(e,s,r):i(r))||r);return a&&r&&ce(e,s,r),r},fe=(t,e,s)=>e.has(t)||E("Cannot "+s),ge=(t,e,s)=>e.has(t)?E("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),W=(t,e,s)=>(fe(t,e,"access private method"),s),O,Y,H;let d=class extends G{constructor(){super(...arguments),ge(this,O),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.size="large",this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=t=>t.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(t){const e=oe(new Date(this.focusedYear,t,1)),s=new Date(this.focusedDate);s.setDate(Math.min(this.focusedDate.getDate(),e.getDate())),s.setMonth(t),s.setHours(12,0,0,0),this.focusedDate=s}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(t){this.focusedDate=new Date(this.focusedDate.setFullYear(t))}getDateCell(t){return this.shadowRoot?.querySelector(`#dateCell-${t}`)}connectedCallback(){super.connectedCallback(),K.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",W(this,O,H)),window.addEventListener("lit-localize-status",t=>{t.detail.status==="ready"&&(this._currentLocale=t.detail.readyLocale)})}focus(){super.focus(),this._elFocusedCell?.focus()}render(){const t=new Date;return y`<table
            ...
            ${e.map(s=>y`
                <tr role="row">
                  ...
                  ${s.days.map(a=>{const r=this.customizedDates&&this.customizedDates.find(g=>w(g.date,a)),o={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(g=>w(g,a))),...r},i=!ne(this.focusedDate,a),u=(a<this.min||a>this.max)&&!w(a,this.min)&&!w(a,this.max),l=a.getDay()===0||a.getDay()===6,n=o.disabled||u||this.disabledWeekends&&l;return this.hideExtraneousDays&&i?y`<td inert></td>`:y`
                          <td
                            role="gridcell"
                            class="${F({small:this.size==="small","custom-date":!!r,disabled:!!n,today:w(t,a),"outside-month":i})}"
                            ?disabled=${n}
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=new Date(this.value))}};O=new WeakSet;Y=function(t){const e=ie(t,12);this.value=e,this.dispatchCustomEvent("change",{detail:e,bubbles:!1,composed:!1})};H=function(t){let e=!1,s=new Date(this.focusedDate);t.key==="ArrowLeft"?(s=k(this.focusedDate,-1),e=!0):t.key==="ArrowRight"?(s=k(this.focusedDate,1),e=!0):t.key==="ArrowUp"?(s=k(this.focusedDate,-7),e=!0):t.key==="ArrowDown"?(s=k(this.focusedDate,7),e=!0):t.key==="Enter"||t.key===" "?(this._elFocusedCell?.hasAttribute("disabled")||W(this,O,Y).call(this,this.focusedDate),e=!0):t.key==="Home"?(s=new Date(this.focusedYear,this.focusedMonth,1),e=!0):t.key==="End"?(s=new Date(this.focusedYear,this.focusedMonth+1,0),e=!0):t.key==="PageUp"?(s=le(this.focusedDate,1),e=!0):t.key==="PageDown"&&(s=T(this.focusedDate,1),e=!0),s.getFullYear()>=this.min.getFullYear()&&s.getFullYear()<=this.max.getFullYear()&&this.dispatchCustomEvent("gds-date-focused",{detail:s,bubbles:!1,composed:!1})&&(this.focusedDate=s),e&&(t.preventDefault(),t.stopPropagation(),this.updateComplete.then(()=>{this._elFocusedCell?.focus()}))};d.styles=[z,de];d.shadowRootOptions={mode:"open",delegatesFocus:!0};c([v()],d.prototype,"value",2);c([v({type:Date})],d.prototype,"min",2);c([v({type:Date})],d.prototype,"max",2);c([v()],d.prototype,"focusedDate",2);c([v({type:Boolean,attribute:"disabled-weekends"})],d.prototype,"disabledWeekends",2);c([v({type:Array,attribute:"disabled-dates"})],d.prototype,"disabledDates",2);c([v({type:Number})],d.prototype,"focusedMonth",1);c([v({type:Number})],d.prototype,"focusedYear",1);c([v({reflect:!0})],d.prototype,"size",2);c([v({type:Boolean})],d.prototype,"showWeekNumbers",2);c([v({type:Boolean})],d.prototype,"hideExtraneousDays",2);c([v({type:Boolean})],d.prototype,"hideDayNames",2);c([v({attribute:!1})],d.prototype,"customizedDates",2);c([v()],d.prototype,"label",2);c([v({attribute:!1})],d.prototype,"dateLabelTemplate",2);c([R()],d.prototype,"_currentLocale",2);c([I('td[tabindex="0"]')],d.prototype,"_elFocusedCell",2);c([j("value")],d.prototype,"_valueChanged",1);d=c([A("gds-calendar"),P({labelledBy:"table",describedBy:"table"}),V()],d);export{d as G,w as i,oe as l,ie as s};
