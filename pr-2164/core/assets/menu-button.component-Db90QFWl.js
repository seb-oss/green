import{i as u,r as y}from"./lit-element-Bx14lxc-.js";import{n as i,G as m,g as _}from"./custom-element-scoping-CNGU1oQ0.js";import{e as w}from"./class-map-CXsQwv0r.js";import{o as p}from"./if-defined-CVqwUuaf.js";import{i as v,u as x}from"./static-B8S6DEnV.js";import{t as k}from"./tokens.style-BXmqfwyc.js";import{w as $,d as z}from"./declarative-layout-mixins-D1Y0gyd7.js";const C=u`
...
`;var G=Object.defineProperty,P=Object.getOwnPropertyDescriptor,f=t=>{throw TypeError(t)},s=(t,e,r,c)=>{for(var n=c>1?void 0:c?P(e,r):e,h=t.length-1,g;h>=0;h--)(g=t[h])&&(n=(c?g(e,r,n):g(n))||n);return c&&n&&G(e,r,n),n},B=(t,e,r)=>e.has(t)||f("Cannot "+r),l=(t,e,r)=>(B(t,e,"read from private field"),r?r.call(t):e.get(t)),O=(t,e,r)=>e.has(t)?f("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),a,d,b;let o=class extends $(z(m)){constructor(){super(),O(this,a),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const t={button:!0,selected:this.selected,compact:this.compact},e=l(this,a,d)?v`a`:v`button`;return x`
    ...
    `}};a=new WeakSet;d=function(){return this.href.length>0};b=function(){return this.target==="_blank"?"noreferrer noopener":void 0};o.styles=[k,y(C)];o.shadowRootOptions={mode:"open",delegatesFocus:!0};s([i({type:Boolean,reflect:!0})],o.prototype,"disabled",2);s([i()],o.prototype,"label",2);s([i()],o.prototype,"href",2);s([i()],o.prototype,"target",2);s([i()],o.prototype,"rel",2);s([i()],o.prototype,"download",2);s([i({type:Boolean,reflect:!0})],o.prototype,"compact",2);s([i({type:Boolean,reflect:!0})],o.prototype,"selected",2);o=s([_("gds-menu-button")],o);export{o as G};
