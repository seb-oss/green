import{x as e,E as b}from"./iframe-DJxLo9eK.js";import"./text-CzKW9hYu.js";import"./divider-CsfLikmw.js";import"./flex-Brg4VfdE.js";import"./credit-card-MJH13YVf.js";import"./arrow-left-BMUQ3QTJ.js";import"./chevron-top-BaPz2ETK.js";import"./arrow-up-C8b9p0li.js";import"./arrow-down-CbBDmsDd.js";import"./arrow-right-DRRBIflN.js";import{a as lt}from"./argTableProps-BNmK0mZ4.js";import"./preload-helper-Dp1pzeXC.js";import"./default-typography.styles-DNq_Gw-y.js";import"./flex.component-CFI6nVMW.js";import"./icon.component-DrdUzPcL.js";import"./arrow-up.component-C50Rmdnr.js";const jt={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:"A button can be tapped or clicked to perform an action."}}},tags:["autodocs"],argTypes:{...lt("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","brand","positive","negative"],control:{type:"select"}},size:{options:["xs","small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},u={...n},r={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>e`
