import{i as te,n as f,I as se,h as y,g as ne,N as re,D as oe,H as le,a as I,t as de,d as z,Q as me,V as pe,x as D}from"./iframe-CsVaiW1A.js";import"./text-DBgYUAF_.js";import"./card-S2aFM14q.js";import"./flex-CGuiXXpb.js";import"./link-CnLBLsuh.js";import"./rich-text-fwfdgu5Y.js";import"./chevron-top-CtsR0FKJ.js";import"./chevron-bottom-ChSyh2ky.js";import"./preload-helper-Dp1pzeXC.js";import"./default-typography.styles-Ba6g_FGY.js";import"./card.component-VzQz1eIc.js";import"./flex.component-DFAHA7xJ.js";import"./props-link-x5e3udGr.js";import"./icon.component-CLR_Gk-M.js";import"./chevron-bottom.component-B4AYeIK2.js";const ge=te`
  :host {
    display: contents;
  }
`;var ce=Object.defineProperty,he=Object.getOwnPropertyDescriptor,ae=(e,t,s,i)=>{for(var n=i>1?void 0:i?he(t,s):t,l=e.length-1,d;l>=0;l--)(d=e[l])&&(n=(i?d(t,s,n):d(n))||n);return i&&n&&ce(t,s,n),n};let x=class extends se{constructor(){super(...arguments),this.open=!1}render(){return y`
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
    ...
    `}updated(e){var t;if(e.has("open")){const s=(t=this.shadowRoot)==null?void 0:t.querySelector("svg");if(s){const i=new CustomEvent("toggle",{bubbles:!0,composed:!0});s.dispatchEvent(i)}}}};x.styles=[ge];ae([f({type:Boolean,reflect:!0})],x.prototype,"open",2);x=ae([ne("gds-icon-details")],x);const ue=te`
  @layer base, reset;
  @layer base {
    .details {
...
\`
  ...
  \`
}`,...(M=(G=g.parameters)==null?void 0:G.docs)==null?void 0:M.source},description:{story:"Example of grouped detailss.",...(R=(W=g.parameters)==null?void 0:W.docs)==null?void 0:R.description}}};var B,V,A,F,N;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Sizes',
  parameters: {
    docs: {
...
\\\`\\\`\\\`
  ...
  \`
}`,...(A=(V=c.parameters)==null?void 0:V.docs)==null?void 0:A.source},description:{story:"Example of different size variants.",...(N=(F=c.parameters)==null?void 0:F.docs)==null?void 0:N.description}}};var q,K,j,Q,X;h.parameters={...h.parameters,docs:{...(q=h.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Rich Content',
  parameters: {
    docs: {
  ...
  \`
}`,...(j=(K=h.parameters)==null?void 0:K.docs)==null?void 0:j.source},description:{story:"Example with rich content.",...(X=(Q=h.parameters)==null?void 0:Q.docs)==null?void 0:X.description}}};var J,U,Y,Z,ee;u.parameters={...u.parameters,docs:{...(J=u.parameters)==null?void 0:J.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Initially Open',
  parameters: {
    docs: {
...
\\\`\\\`\\\`
  ...
  \`
}`,...(Y=(U=u.parameters)==null?void 0:U.docs)==null?void 0:Y.source},description:{story:"Example of initially open details.",...(ee=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};const Pe=["Default","Grouped","Sizes","RichContent","InitiallyOpen"];export{p as Default,g as Grouped,u as InitiallyOpen,h as RichContent,c as Sizes,Pe as __namedExportsOrder,Oe as default};
