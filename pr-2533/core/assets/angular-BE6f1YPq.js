import{u as s,j as e,M as t}from"./iframe-BU3bkakm.js";import"./preload-helper-Dp1pzeXC.js";function r(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{title:"Guides/Angular"}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"In your module:"})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`import { GdsCoreScopeModule, SCOPE_RESOLVER } from '@sebgroup/green-core-ng'
import { getScopedTagName } from '@sebgroup/green-core/scoping'
...
`})}),`
`,e.jsxs(n.p,{children:["This should work as expected, with the ",e.jsx(n.code,{children:"href"})," attribute being set automatically based on the ",e.jsx(n.code,{children:"routerLink"})," value, and the ",e.jsx(n.code,{children:"selected"})," property being set based on the active route."]})]})}function c(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(r,{...o})}):r(o)}export{c as default};
