import{x as d,r as w}from"./iframe-B5E_WO1B.js";import"./list-item-C6AtgPAs.js";import"./preload-helper-Dp1pzeXC.js";w();const S={title:"Components/Grouped List",component:"gds-grouped-list",subcomponents:{GdsListItem:"gds-list-item"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grouped-list)
&nbsp;|&nbsp;
...
<gds-list-item>Item 3</gds-list-item>`,label:"Grouped list label"}},i={...n},t={...n,name:"Grouped list with values",render:r=>d`
  ...
  \`
}`,...(k=(K=s.parameters)==null?void 0:K.docs)==null?void 0:k.source},description:{story:"The slotted elements can be styled using inline styles or CSS classes.",...(L=(x=s.parameters)==null?void 0:x.docs)==null?void 0:L.description}}};const G=["Basic","WithValues","WithValuesAndAction","AdjustingAppearance"];export{s as AdjustingAppearance,i as Basic,t as WithValues,e as WithValuesAndAction,G as __namedExportsOrder,S as default};
