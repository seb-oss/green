import{x as e,E as b}from"./iframe-B_7VDQZA.js";import"./text-DlNpezDt.js";import"./divider-C4hWexXG.js";import"./flex-OIDLvq6T.js";import"./credit-card-DHMgA06R.js";import"./arrow-left-CAYh1wo_.js";import"./chevron-top-C65L7sbQ.js";import"./arrow-up-BLPPgXWu.js";import"./arrow-down-DwqtAorg.js";import"./arrow-right-BDzFXZhF.js";import{a as lt}from"./argTableProps-DijzQAUo.js";import"./preload-helper-Dp1pzeXC.js";import"./default-typography.styles-CyeDCQwX.js";import"./flex.component-CW36NNeC.js";import"./icon.component-DgivRYtk.js";import"./arrow-up.component-CT8wC-aL.js";const jt={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:"A button can be tapped or clicked to perform an action."}}},tags:["autodocs"],argTypes:{...lt("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","brand","positive","negative"],control:{type:"select"}},size:{options:["xs","small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},u={...n},r={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>e`
...
\`\`\``,...(gt=(ct=l.parameters)==null?void 0:ct.docs)==null?void 0:gt.description}}};const Tt=["DefaultParams","Basic","RanksAndVariants","Sizes","WithIcon","IconButton","Disabled","Link","Length","Aria","NextPrevious"];export{g as Aria,u as Basic,n as DefaultParams,o as Disabled,d as IconButton,c as Length,i as Link,l as NextPrevious,r as RanksAndVariants,a as Sizes,s as WithIcon,Tt as __namedExportsOrder,jt as default};
