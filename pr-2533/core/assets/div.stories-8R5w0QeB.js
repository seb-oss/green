import{x as j}from"./iframe-B3RQzD1b.js";import"./div-BXbaW80K.js";import"./flex-Z6Ha4TvM.js";import"./card-BUIpE8H_.js";import{a as B}from"./argTableProps-BdynW9gM.js";import"./preload-helper-Dp1pzeXC.js";import"./flex.component-CG0XFz7H.js";import"./card.component-nTacJsON.js";const I={title:"Components/Div",component:"gds-div",tags:["autodocs"],argTypes:{...B("gds-div")},parameters:{docs:{description:{component:"`gds-div` is a base element in the declarative layout system.\n\nDiv accepts all available style expression properties, and is also the base class for `gds-flex`, `gds-grid`, `gds-card` and `gds-text`"}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},s={...t,args:{background:"01",border:"2xs","border-radius":"m","border-color":"subtle-01",width:"4xl",height:"4xl"}},r={...t,render:S=>j`
