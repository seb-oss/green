import{x as e,E as b}from"./iframe-DqlrlUVI.js";import"./text-DIeqyN_u.js";import"./divider-DR_0UetR.js";import"./flex-DyhQeVgR.js";import"./credit-card-OM9dOHZz.js";import"./arrow-left-CsE_thnx.js";import"./chevron-top-CkFcbCEe.js";import"./arrow-up-CPwUiS3N.js";import"./arrow-down-BlaAGbNi.js";import"./arrow-right-Cd2gbjIw.js";import{a as lt}from"./argTableProps-evXgbwHK.js";import"./preload-helper-Dp1pzeXC.js";import"./default-typography.styles-oDJyrGNp.js";import"./flex.component-BBNSMjNL.js";import"./icon.component-h-N3zYmh.js";import"./arrow-up.component-Cjh8qj7R.js";const jt={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:"A button can be tapped or clicked to perform an action."}}},tags:["autodocs"],argTypes:{...lt("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","brand","positive","negative"],control:{type:"select"}},size:{options:["xs","small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},u={...n},r={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>e`
