import{I as c,h as i,g as p,i as b,t as v,n as u,a7 as y,b as m}from"./iframe-B_7VDQZA.js";var h=Object.getOwnPropertyDescriptor,f=(a,e,d,t)=>{for(var s=t>1?void 0:t?h(e,d):e,r=a.length-1,l;r>=0;r--)(l=a[r])&&(s=l(s)||s);return s};let n=class extends c{connectedCallback(){super.connectedCallback(),this.setAttribute("role","listitem")}render(){return i`<slot></slot>`}};n=f([p("gds-list-item")],n);const _=b`
  .gds-list-heading {
