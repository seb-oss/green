import{x as a}from"./lit-element-Bx14lxc-.js";import{a as X}from"./argTableProps-DZgRZWUi.js";import"./badge-Bv9pkpBP.js";import"./grid-Cz0WG0Rc.js";import"./flex-BwgzG5qs.js";import"./divider-s9xm2YVw.js";import"./triangle-exclamation-MMIoisAK.js";import"./circle-check-C6FLkG4Q.js";import"./plus-small-CFvopXwK.js";import"./arrow-rotate-counter-clockwise.component-pL8yB6uD.js";import"./rocket-B-xRZbYJ.js";import"./custom-elements-8_npuhK2.js";import"./badge.component-BXFB5bqX.js";import"./gds-element-DKcDvDP5.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./tokens.style-BxbMzGpH.js";import"./declarative-layout-mixins-mU9_fNeX.js";import"./flex.component-D_vuL4br.js";import"./div.component-CD5LQ9NF.js";import"./grid.component-CzE4BWwN.js";import"./triangle-exclamation.component-wAo88AhN.js";import"./icon-CylpkmXP.js";import"./directive-CF8sV3Lr.js";import"./circle-check.component-BmlSoaqV.js";import"./plus-small.component-BWMa0Qyi.js";import"./rocket.component-C2RdaSui.js";const ye={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...X("gds-badge")}},r={name:"Variants",render:e=>a`
    <gds-flex
  ...
  `};var p,f,v;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: 'Variants',
  render: args => html\`
    <gds-flex
      flex-direction="column"
  ...
  \`
}`,...(v=(f=r.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var x,u,h,z,w;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Lead',
  parameters: {
    controls: {
      include: []
