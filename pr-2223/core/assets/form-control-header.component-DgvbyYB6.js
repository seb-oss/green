import{n as f,G as w,h as i,g as C,r as P}from"./gds-element-DKcDvDP5.js";import{n as x}from"./when-BR7zwNJC.js";import{G as B}from"./badge.component-BXFB5bqX.js";import{a as F,I as W}from"./triangle-exclamation.component-wAo88AhN.js";import{w as y}from"./watch-tFciLXSI.js";import{i as E}from"./lit-element-Bx14lxc-.js";import{m as k}from"./runtime-BL31MtW8.js";import{l as z}from"./localized-decorator-DtmrKsyB.js";import{a as I}from"./query-p8xgzTDt.js";import{G as D}from"./button.component-Dh3buYEG.js";import{G as H}from"./card.component-COqggkVo.js";const V=E`
...
`;var A=Object.defineProperty,N=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},h=(e,t,s,a)=>{for(var r=a>1?void 0:a?N(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&A(t,s,r),r},L=(e,t,s)=>t.has(e)||S("Cannot "+s),R=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),j=(e,t,s)=>(L(e,t,"access private method"),s),u,b;let d=class extends w{constructor(){super(...arguments),R(this,u)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter)}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return i`<div aria-live="polite">
    ...
    </div>`}};u=new WeakSet;b=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",i`<gds-badge variant="${t}">${e}</gds-badge>`};d.styles=[V];h([f({type:Number})],d.prototype,"charCounter",2);h([f()],d.prototype,"errorMessage",2);h([y("charCounter"),y("errorMessage")],d.prototype,"_handleVisibilityChange",1);d=h([C("gds-form-control-footer",{dependsOn:[B,F]})],d);const q=E`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,T=e=>{throw TypeError(e)},g=(e,t,s,a)=>{for(var r=a>1?void 0:a?K(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&J(t,s,r),r},$=(e,t,s)=>t.has(e)||T("Cannot "+s),_=(e,t,s)=>($(e,t,"read from private field"),s?s.call(e):t.get(e)),c=(e,t,s)=>t.has(e)?T("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),G=(e,t,s)=>($(e,t,"access private method"),s),p,O,v,m,M;let l=class extends w{constructor(){super(...arguments),c(this,p),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,c(this,v,()=>i`
    ...
    `};l.styles=[q];g([f({type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);g([P()],l.prototype,"_hasExtendedSupportingText",2);g([I("#extended-supporting-text")],l.prototype,"_extendedSupportingText",2);l=g([C("gds-form-control-header",{dependsOn:[D,H,W]}),z()],l);export{l as G,d as a};
