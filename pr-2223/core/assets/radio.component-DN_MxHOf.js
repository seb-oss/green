import{l as A}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as c,G as T,h as d,g as w,r as V}from"./gds-element-DKcDvDP5.js";import{a as H}from"./query-p8xgzTDt.js";import{e as k}from"./class-map-CXsQwv0r.js";import{G as K,a as q}from"./form-control-header.component-Drk2vaNu.js";import{t as R}from"./tokens.style-Dtt7LJZD.js";import{w as F}from"./watch-tFciLXSI.js";import{w as U,b as X,a as J}from"./declarative-layout-mixins-mU9_fNeX.js";import{a as N}from"./button.component-BStz0xvl.js";import{i as v}from"./lit-element-Bx14lxc-.js";import{n as _}from"./when-BR7zwNJC.js";const Q=v`
  @layer base, a11y;
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,j=e=>{throw TypeError(e)},u=(e,t,s,i)=>{for(var r=i>1?void 0:i?de(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&le(t,s,r),r},ce=(e,t,s)=>t.has(e)||j("Cannot "+s),z=(e,t,s)=>(ce(e,t,"read from private field"),s?s.call(e):t.get(e)),S=(e,t,s)=>t.has(e)?j("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),x,y;let p=class extends T{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,S(this,x,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchStandardEvent("input",{bubbles:!0}))}),S(this,y,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchStandardEvent("input",{bubbles:!0}))}),this.addEventListener("keydown",z(this,y)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",z(this,x))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}render(){return d`
    ...
    `}};x=new WeakMap;y=new WeakMap;p.styles=[ee,ne];u([c()],p.prototype,"label",2);u([c({attribute:"supporting-text"})],p.prototype,"supportingText",2);u([c()],p.prototype,"value",2);u([c({type:Boolean,reflect:!0})],p.prototype,"checked",2);u([c({type:Boolean,reflect:!0})],p.prototype,"disabled",2);u([c({type:Boolean})],p.prototype,"invalid",2);u([V()],p.prototype,"_isFocused",2);p=u([w("gds-radio",{dependsOn:[b]})],p);export{p as G,$ as a,b,ke as c,ee as r};
