import{l as A}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as c,G as T,h as d,g as w,r as V}from"./gds-element-DKcDvDP5.js";import{a as H}from"./query-p8xgzTDt.js";import{e as k}from"./class-map-CXsQwv0r.js";import{G as K,a as q}from"./form-control-header.component-C0X3p_q2.js";import{t as R}from"./tokens.style-BxbMzGpH.js";import{w as F}from"./watch-tFciLXSI.js";import{w as U,b as X,a as J}from"./declarative-layout-mixins-mU9_fNeX.js";import{a as N}from"./button.component-oW2kHBpT.js";import{i as v}from"./lit-element-Bx14lxc-.js";import{n as _}from"./when-BR7zwNJC.js";const Q=v`
  @layer base, a11y;
...
`;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,C=(e,t,s,i)=>{for(var r=i>1?void 0:i?Z(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&Y(t,s,r),r};let b=class extends T{constructor(){super(),this.label="",this.supportingText=""}render(){const e={label:!0,"has-supporting-text":!!this.supportingText};return d`
    ...
    `}};b.styles=[R,Q];C([c()],b.prototype,"label",2);C([c({attribute:"supporting-text"})],b.prototype,"supportingText",2);b=C([w("gds-toggle-control-base"),A()],b);const ee=v`
  .rbcb {
...
`;var ie=Object.defineProperty,re=Object.getOwnPropertyDescriptor,O=e=>{throw TypeError(e)},g=(e,t,s,i)=>{for(var r=i>1?void 0:i?re(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&ie(t,s,r),r},oe=(e,t,s)=>t.has(e)||O("Cannot "+s),ae=(e,t,s)=>t.has(e)?O("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),n=(e,t,s)=>(oe(e,t,"access private method"),s),o,f,D,E,P,L,m,M,B,I,W;let h=class extends N{constructor(){super(...arguments),ae(this,o),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),n(this,o,f).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{n(this,o,f).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return d`<div
    ...
    </div>`}};o=new WeakSet;f=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))};D=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(s=>s.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(s=>s.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};E=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("change",{composed:!0,bubbles:!0})),this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))};P=function(e){e.stopPropagation();const t=e.target;this.value=t.value,this._syncRadioStates(),n(this,o,E).call(this)};L=function(e){if(!this._isConnected)return;const t=this.radios.filter(i=>!i.disabled);if(t.length===0)return;let s=t.findIndex(i=>document.activeElement===i);switch(s===-1&&(s=t.findIndex(i=>i.checked),s===-1&&(s=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const i=(s+1)%t.length;n(this,o,m).call(this,t[i]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const i=(s-1+t.length)%t.length;n(this,o,m).call(this,t[i]);break}default:return}};m=function(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),n(this,o,E).call(this))};M=function(){return[n(this,o,B).call(this),n(this,o,I).call(this),n(this,o,W).call(this)].map(t=>d`${t}`)};B=function(){if(this.label)return d` <gds-form-control-header
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,j=e=>{throw TypeError(e)},u=(e,t,s,i)=>{for(var r=i>1?void 0:i?de(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&le(t,s,r),r},ce=(e,t,s)=>t.has(e)||j("Cannot "+s),S=(e,t,s)=>(ce(e,t,"read from private field"),s?s.call(e):t.get(e)),z=(e,t,s)=>t.has(e)?j("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),y,x;let p=class extends T{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,z(this,y,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchStandardEvent("input",{bubbles:!0}))}),z(this,x,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchStandardEvent("input",{bubbles:!0}))}),this.addEventListener("keydown",S(this,x)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",S(this,y))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}render(){return d`
    ...
    `}};y=new WeakMap;x=new WeakMap;p.styles=[ee,ne];u([c()],p.prototype,"label",2);u([c({attribute:"supporting-text"})],p.prototype,"supportingText",2);u([c()],p.prototype,"value",2);u([c({type:Boolean,reflect:!0})],p.prototype,"checked",2);u([c({type:Boolean,reflect:!0})],p.prototype,"disabled",2);u([c({type:Boolean})],p.prototype,"invalid",2);u([V()],p.prototype,"_isFocused",2);p=u([w("gds-radio",{dependsOn:[b]})],p);export{p as G,$ as a,b,ke as c,ee as r};
