import{i as w,H as y,ac as k,I as _,J as z,P as S,a as x,b as C,h as v,t as P,n as o,K as A,N as u,g as B,L}from"./iframe-Btp_HS2e.js";const R=w`
...
`;var E=Object.defineProperty,$=Object.getOwnPropertyDescriptor,b=e=>{throw TypeError(e)},s=(e,r,t,a)=>{for(var n=a>1?void 0:a?$(r,t):r,p=e.length-1,c;p>=0;p--)(c=e[p])&&(n=(a?c(r,t,n):c(n))||n);return a&&n&&E(r,t,n),n},h=(e,r,t)=>r.has(e)||b("Cannot "+t),m=(e,r,t)=>(h(e,r,"read from private field"),t?t.call(e):r.get(e)),f=(e,r,t)=>r.has(e)?b("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),G=(e,r,t,a)=>(h(e,r,"write to private field"),r.set(e,t),t),M=(e,r,t)=>(h(e,r,"access private method"),t),d,g,l;let i=class extends y(k(_(z))){constructor(){super(...arguments),f(this,d),this.label=S("Loading..."),this.labelPosition="bottom",this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="md",this._isAnimating=!1,f(this,l,{overflow:"visible",overscrollBehavior:"auto"})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchCustomEvent("gds-spinner-connected")}disconnectedCallback(){super.disconnectedCallback(),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1,super.disconnectedCallback()}_updateAriaLabel(){this.setAttribute("aria-label",this.label)}render(){return v`
    ...
    `}_toggleRootStyles(){const{style:e}=document.documentElement;this.fullscreen?(G(this,l,{overflow:e.overflow,overscrollBehavior:e.overscrollBehavior}),e.overflow="hidden",e.overscrollBehavior="none"):(e.overflow=m(this,l).overflow,e.overscrollBehavior=m(this,l).overscrollBehavior)}};d=new WeakSet;g=function(){return{"spinner-wrapper":!0,"spinner-fullscreen":this.fullscreen,"spinner-cover":this.cover,"spinner-backdrop":this.cover||this.fullscreen,"spinner-animating":this._isAnimating,[`spinner-label-${this.labelPosition}`]:this.labelPosition}};l=new WeakMap;i.styles=[P,R];s([o({type:String})],i.prototype,"label",2);s([o({type:String,reflect:!0,attribute:"label-position"})],i.prototype,"labelPosition",2);s([o({type:Boolean,reflect:!0})],i.prototype,"showLabel",2);s([o({type:Boolean,reflect:!0})],i.prototype,"cover",2);s([o({type:Boolean,reflect:!0})],i.prototype,"fullscreen",2);s([o({type:String,reflect:!0})],i.prototype,"size",2);s([A()],i.prototype,"_isAnimating",2);s([u("label")],i.prototype,"_updateAriaLabel",1);s([u("fullscreen")],i.prototype,"_toggleRootStyles",1);i=s([B("gds-spinner"),L()],i);i.define();
