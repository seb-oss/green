      ...
      ${(0,when.z)(!this.hideDayNames,(()=>lit.qy`<thead role="rowgroup">
            <tr role="row">
              ...
              ${(0,when.z)(this.longDayNames,(()=>lit.qy`<th>${(0,lit_localize.ab)("Mon")}</th>
                    ...
                    <th>${(0,lit_localize.ab)("Sun")}</th>`),(()=>lit.qy`<th>${(0,lit_localize.ab)("Mon").substring(0,1)}</th>
...
//# sourceMappingURL=src-lib-datepicker-datepicker-stories.8d8c1466.iframe.bundle.js.map