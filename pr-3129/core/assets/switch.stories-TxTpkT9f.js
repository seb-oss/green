import"./switch-kUlEcui3.js";import"./flex-CWceLl1y.js";import{b as t}from"./iframe-C9QOzovx.js";import"./text-RvR3-qXd.js";import"./divider-B-sdeF6m.js";import{a as x}from"./argTableProps-CSywfb7a.js";import"./switch.component-BHLrlCS7.js";import"./checkmark.component-COSPuMmH.js";import"./icon.component-Bpkqx2ZH.js";import"./flex.component-BR5gTh-Z.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-wbiht8k6.js";import"./default-typography.styles-CX98swAE.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
