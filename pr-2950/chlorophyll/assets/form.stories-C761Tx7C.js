const u={title:"Components/Form",tags:["autodocs"],parameters:{componentIds:["component-form"]},argTypes:{}},a={render:s=>`
   <form class="mw-xs">
  ...
  </form>`,args:{},parameters:{}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: args => \`
   <form class="mw-xs">
      <div class="gds-form-group">
        <label class="gds-label" for="inputValid1">Input group label</label>
  ...
  args: {},
  parameters: {}
}`,...p.parameters?.docs?.source}}};const c=["Disabled","FormInfoBeforeInput","FormInfoAfterInput","FormText","FormLayout","FormHorizontalLayout","SizeSmall","SizeLarge","FormWithValidation","GroupAndFormControl"];export{a as Disabled,t as FormHorizontalLayout,e as FormInfoAfterInput,n as FormInfoBeforeInput,l as FormLayout,r as FormText,i as FormWithValidation,p as GroupAndFormControl,d as SizeLarge,o as SizeSmall,c as __namedExportsOrder,u as default};
