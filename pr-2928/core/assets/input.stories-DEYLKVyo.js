import{b as a}from"./iframe-CqBe2TfV.js";import"./input-LHfmgKOC.js";import"./badge-DVm3EXLr.js";import"./flex-D-tyDyNJ.js";import"./divider-DOCd5EDB.js";import"./credit-card-BLCrymMC.js";import"./magnifying-glass-B5aK9bx8.js";import"./people-profile-Q2wzfhqB.js";import{a as f}from"./argTableProps-M11Ecom4.js";import"./preload-helper-PPVm8Dsz.js";import"./input.component-CqXV1hrr.js";import"./localized-decorator-sPFOApqU.js";import"./query-async-DUOSOpUv.js";import"./form-control-host.style-BQ_w4jNg.js";import"./form-control-header.component-DPFvwWCo.js";import"./badge.component-D7xYrbf4.js";import"./flex.component-DPR4rLzo.js";import"./triangle-exclamation.component-BDCoVJTF.js";import"./icon.component-Cbb-4iW8.js";import"./card.component-BcXpFzxe.js";import"./circle-info.component-6QCokaZX.js";import"./cross-small.component-mySfz73_.js";import"./textarea.component-Da5slGSv.js";import"./resize-observer-CfkbZofs.js";import"./credit-card.component-D7rorodj.js";import"./magnifying-glass.component-B7966Skj.js";import"./people-profile.component-Cs44V-gr.js";const W={title:"Components/Input",component:"gds-input",parameters:{layout:"centered",docs:{description:{component:"An input lets users enter and edit text or numerical values in forms."}}},tags:["autodocs"],argTypes:{...f("gds-input"),value:{control:"text"},variant:{options:["default"],control:{type:"select"}},size:{options:["large","small"],control:{type:"select"}},invalid:{control:"boolean"}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label",variant:"default",size:"large",supportingText:"Label support text.",innerHTML:'<gds-icon-people-profile slot="lead"></gds-icon-people-profile>'}},x={...t,name:"Default"},i={...t,name:"Size",render:()=>a`
  ...
  \`
}`,...o.parameters?.docs?.source},description:{story:'The `length` property can be set to a number to limit the number of characters that can be entered into the input field.<br> A badge will be displayed, updating as the input approaches the character limit.\n\n**@property maxLength** - The maximum number of characters that can be entered into the input field.\n\n```html\n <gds-input maxLength="20"></gds-input>\n```',...o.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Clearable',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
...
differ from the displayed value.`,...c.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...g.parameters?.docs?.source},description:{story:`In some cases it may be necessary to label the input field using elements
...
For inputs, prefer \`gds-aria-*\` attributes over regular \`aria-*\` attributes to
ensure they are only applied to the internal input element.`,...g.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex gap="xl">
  ...
  \`
}`,...b.parameters?.docs?.source},description:{story:"The `charCounterCallback` property can be used to customize the character counter badge.\n\nCheck the [story source](https://github.com/seb-oss/green/blob/main/libs/core/src/components/input/input.stories.ts) to see the full code for this example, as Storybook strips away property assignments in the code examples.",...b.parameters?.docs?.description}}};const _=["Default","Size","Lead","Trail","Length","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","AriaForwarding","Disabled","CustomCounterBadge"];export{g as AriaForwarding,d as Clearable,b as CustomCounterBadge,x as Default,m as Disabled,p as ExtendedSupportingText,r as Lead,o as Length,i as Size,c as StandardAttributes,l as SupportingText,s as Trail,u as Validation,_ as __namedExportsOrder,W as default};
