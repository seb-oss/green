import{i as h,I as _,H as g,z as f,h as c,v as y,g as x,Q as P,a as $,n as d,R as m,a7 as b,o as O}from"./iframe-CqBe2TfV.js";import{I as S}from"./people-profile.component-Cs44V-gr.js";const A=h`
...
`;var G=Object.getOwnPropertyDescriptor,E=(e,t,r,i)=>{for(var s=i>1?void 0:i?G(t,r):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=n(s)||s);return s};let u=class extends _(g(f)){connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","group")}render(){return c`<slot></slot>`}};u.styles=[y,A];u=E([x("gds-avatar-group")],u);const j=h`
  @layer tokens, core, sizes, shapes;
...
`;var D=Object.defineProperty,I=Object.getOwnPropertyDescriptor,z=e=>{throw TypeError(e)},o=(e,t,r,i)=>{for(var s=i>1?void 0:i?I(t,r):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=(i?n(t,r,s):n(s))||s);return i&&s&&D(t,r,s),s},M=(e,t,r)=>t.has(e)||z("Cannot "+r),T=(e,t,r)=>t.has(e)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),v=(e,t,r)=>(M(e,t,"access private method"),r),p,k,w,C;let a=class extends P(_(g(f))){constructor(){super(...arguments),T(this,p),this.src="",this.alt="",this.size="m",this.shape="circular",this.level="2"}render(){const e=$({avatar:!0,[this.size]:!0,[this.shape]:!0,"has-image":!!this.src});return c`
    ...
    `}};p=new WeakSet;k=function(){return c`<gds-icon-people-profile></gds-icon-people-profile>`};w=function(){return this.src?c`
      ...
      `:c`<slot>${v(this,p,k).call(this)}</slot>`};C=function(){return c`<slot name="badge"></slot>`};a.styles=[y,j];o([d({type:String})],a.prototype,"src",2);o([d({type:String})],a.prototype,"alt",2);o([d({type:String,reflect:!0})],a.prototype,"size",2);o([d({type:String,reflect:!0})],a.prototype,"shape",2);o([d()],a.prototype,"level",2);o([m({...b("background"),selector:".avatar"})],a.prototype,"background",2);o([m({...b("content"),selector:".avatar"})],a.prototype,"color",2);a=o([x("gds-avatar",{dependsOn:[S]})],a);export{u as G,a};
