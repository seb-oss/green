import{g,h as n}from"./gds-element-54cd6e2a.js";import{s as l}from"./style-expression-property-89161d08.js";import{G as b}from"./flex-45596286.js";import{i as m}from"./lit-element-71e04f06.js";const i=m`
  :host {
...
`;var c=Object.defineProperty,h=Object.getOwnPropertyDescriptor,a=(p,r,o,s)=>{for(var t=s>1?void 0:s?h(r,o):r,x=p.length-1,d;x>=0;x--)(d=p[x])&&(t=(s?d(r,o,t):d(t))||t);return s&&t&&c(r,o,t),t};let e=class extends b{render(){return n`<slot></slot>`}};e.styles=[i];a([l({property:"box-shadow",valueTemplate:p=>`var(--gds-shadow-${p})`})],e.prototype,"shadow",2);a([l({valueTemplate:p=>{const[r,o]=p.split("/");return`var(--gds-space-${r}) solid ${o?`var(--gds-sys-color-${o})`:"currentColor"}`},styleTemplate:(p,r)=>{const o=r[0],s=r.length>1?r[1]:o,t=r.length>2?r[2]:o,x=r.length>3?r[3]:o;return`border-top: ${o}; border-right: ${s}; border-bottom: ${t}; border-left: ${x};`}})],e.prototype,"border",2);a([l({property:"border-radius",valueTemplate:p=>`var(--gds-space-${p})`})],e.prototype,"radius",2);a([l({property:"backdrop-filter",valueTemplate:p=>`blur(${p})`})],e.prototype,"filter",2);a([l({property:"mask-image",valueTemplate:p=>`linear-gradient(to ${p}, currentColor 40%, transparent)`})],e.prototype,"mask",2);e=a([g("gds-card")],e);
