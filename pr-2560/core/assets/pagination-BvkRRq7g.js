import{i as N,S as L,a0 as D,Q as W,J as A,h,b as $,O as p,t as R,n as g,d as J,I as _,a as T,g as F,P as q}from"./iframe-CqKMOIX5.js";import{l as Q}from"./localized-decorator-CFtgwxVo.js";import{w as V,G as X}from"./popover.component-DZibbuew.js";import{a as Y,G as H}from"./context-menu.component-IKrJXyXc.js";import{a as K}from"./dropdown.component-DLvHkmIz.js";import{I as U}from"./chevron-bottom.component-BAaYnwKx.js";import{I as Z,a as tt,b as et,c as st}from"./chevron-right-small.component-BRJnBQdd.js";import{I as nt}from"./chevron-right.component-CbTIly0t.js";import{G as it}from"./input.component-BNL7d9AB.js";import{G as ot}from"./text-Cxg9YR9j.js";const at=N`
  :host {
    display: flex;
    align-items: center;
...
`;var rt=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,x=t=>{throw TypeError(t)},d=(t,s,n,c)=>{for(var l=c>1?void 0:c?lt(s,n):s,m=t.length-1,b;m>=0;m--)(b=t[m])&&(l=(c?b(s,n,l):b(l))||l);return c&&l&&rt(s,n,l),l},y=(t,s,n)=>s.has(t)||x("Cannot "+n),i=(t,s,n)=>(y(t,s,"read from private field"),n?n.call(t):s.get(t)),pt=(t,s,n)=>s.has(t)?x("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,n),o=(t,s,n)=>(y(t,s,"access private method"),n),e,f,a,P,w,G,C,I,k,z,M,S,O,j,u,B,E,v;const ct={compact:{button:"small",font:"detail-book-s",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-book-s",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-book-m",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let r=class extends L(D(W(A))){constructor(){super(...arguments),pt(this,e),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(t){this._isMobile=t}render(){return h`
      <gds-flex
        align-items="center"
