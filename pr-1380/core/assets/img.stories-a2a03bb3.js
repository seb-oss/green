...
`;var x=Object.defineProperty,T=Object.getOwnPropertyDescriptor,r=(t,s,n,p)=>{for(var a=p>1?void 0:p?T(s,n):s,l=t.length-1,m;l>=0;l--)(m=t[l])&&(a=(p?m(s,n,a):m(a))||a);return p&&a&&x(s,n,a),a};let e=class extends f{render(){return v`<figure><img src="${this.src}" alt="${this.alt}" /></figure>`}};e.styles=[h,b];r([o({property:"--_ratio",valueTemplate:t=>`${t}`})],e.prototype,"ratio",2);r([o({property:"--_position",valueTemplate:t=>t})],e.prototype,"position",2);r([o({property:"--_inset",valueTemplate:t=>t})],e.prototype,"inset",2);r([o({property:"width",valueTemplate:t=>t})],e.prototype,"width",2);r([o({property:"height",valueTemplate:t=>t})],e.prototype,"height",2);r([o({property:"--_opacity",valueTemplate:t=>t})],e.prototype,"opacity",2);r([o({property:"--_fit",valueTemplate:t=>t})],e.prototype,"fit",2);r([u()],e.prototype,"src",2);r([u()],e.prototype,"alt",2);r([o({property:"border-radius",valueTemplate:t=>`var(--gds-sys-radii-${t})`})],e.prototype,"radius",2);e=r([g("gds-img")],e);const G={title:"Components/Layouts/Image",component:"gds-img",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-img`\n\n## Usage"}}}},P={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{ratio:"16/9",fit:"cover",inset:"0",position:"relative",opacity:"1",src:"https://placehold.co/600x400",alt:"Placeholder"}},i={...P};var c,d,y;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  ...DefaultParams
