import{i as V,r as m,x as W,s as N}from"./lit-element-2a5e401f.js";import{n as G,t as _,r as q}from"./Reflect-a49e984a.js";var J=V`
  :host {
...
`,j=J,R=Object.defineProperty,H=Object.getOwnPropertyDescriptor,C=Object.getOwnPropertySymbols,K=Object.prototype.hasOwnProperty,X=Object.prototype.propertyIsEnumerable,S=(s,r,e)=>r in s?R(s,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[r]=e,Q=(s,r)=>{for(var e in r||(r={}))K.call(r,e)&&S(s,e,r[e]);if(C)for(var e of C(r))X.call(r,e)&&S(s,e,r[e]);return s},p=(s,r,e,o)=>{for(var g=o>1?void 0:o?H(r,e):r,d=s.length-1,t;d>=0;d--)(t=s[d])&&(g=(o?t(r,e,g):t(g))||g);return o&&g&&R(r,e,g),g},A=(s,r,e)=>{if(!r.has(s))throw TypeError("Cannot "+e)},a=(s,r,e)=>(A(s,r,"read from private field"),e?e.call(s):r.get(s)),y=(s,r,e)=>{if(r.has(s))throw TypeError("Cannot add the same private member more than once");r instanceof WeakSet?r.add(s):r.set(s,e)},B=(s,r,e,o)=>(A(s,r,"write to private field"),o?o.call(s,e):r.set(s,e),e),T=(s,r,e)=>(A(s,r,"access private method"),e);function Y(s,r){const e=Q({waitUntilFirstUpdate:!1},r);return(o,g,d)=>{const{update:t}=o,F=Array.isArray(s)?s:[s];o.update=function(f){F.forEach(v=>{var l;const i=v;if(f.has(i)){const n=f.get(i),z=this[i];n!==z&&(!e.waitUntilFirstUpdate||this.hasUpdated)&&((l=d.value)==null||l.call(this,n,z))}}),t.call(this,f)}}}var Z={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},ss=/^([<|>]=?)?([0-9a-z]+)/,L=["{","}",";",","],M=[" ","/n"];function es(s){const r=[];let e="";for(let o=0;o<s.length;o++){const g=s[o];if(M.includes(g)||(e+=g),L.includes(g)){r.push(e.slice(0,-1)),r.push(g),e="";continue}if(M.includes(g)||o===s.length-1){r.push(e),e="";continue}}return r.filter(o=>o!=="")}function rs(s){const r=[];let e="bp",o,g=!1;for(const d of s){if(!L.includes(d)){if(e==="val"&&o)d!=="}"&&o.values.push(d);else{if(o&&g){o.breakpoint+=`,${d}`,g=!1;continue}o?(e="val",o.values.push(o.breakpoint),o.values.push(d),o.breakpoint="-"):(o={breakpoint:d,values:[]},r.push(o))}continue}if(d===","){g=!0;continue}if(d==="{"){e="val";continue}if(d==="}"||d===";"){e="bp",o=void 0;continue}}return r.map(d=>(d.values.length===0&&(d.values.push(d.breakpoint),d.breakpoint="-"),d))}function os(s){return s.split(",").map(e=>{const o=e.trim().match(ss);if(!o)throw new Error(`Invalid breakpoint specifier: ${e}`);return{condition:o[1],value:o[2]}})}function ds(s,r,e,o=d=>d,g=(d,t)=>`${d}: ${t.join(" ")};`){let d="";for(const t of e){const v=`@media ${(t.breakpoint==="-"?[{condition:">=",value:"0"}]:os(t.breakpoint)).map(l=>{var i,n;return`(${(i=l.condition)!=null&&i.includes("<")?"max-width":"min-width"}: ${(n=Z[l.value])!=null?n:l.value})`}).join(" and ")} {${s}{${g(r,t.values.map(o))}}}`;d+=v}return d}function w(s){return(r,e)=>{var o,g,d;const t=(o=s==null?void 0:s.selector)!=null?o:":host",F=(g=s==null?void 0:s.property)!=null?g:String(e),f=(d=s==null?void 0:s.valueTemplate)!=null?d:l=>`var(--gds-sys-space-spacer-${l})`,v=s==null?void 0:s.styleTemplate;G({attribute:s==null?void 0:s.attribute})(r,e),Y(e)(r,e,{value:function(l,i){const n=rs(es(i)),z=ds(t,F,n,f,v);this[`__${String(e)}_ast`]=n,console.log(z),this._dynamicStylesController.inject(`sep_${String(e)}`,m(z))}})}}var gs=`/**
 * Do not edit directly
 * Generated on Mon, 17 Jun 2024 23:44:28 GMT
 */
...
`,is=[m(gs),m(ts),m(as),m(ls)],b,u,x,h,k,P,D,U,ns=class{constructor(s){y(this,k),y(this,D),y(this,b,!cs()),y(this,u,[]),y(this,x,new Map),y(this,h,new Map),this.host=s,this.host.addController(this)}hostConnected(){this.host.shadowRoot&&a(this,u).length===0&&B(this,u,[...this.host.shadowRoot.adoptedStyleSheets||[]])}inject(s,r){const e=Array.isArray(r)?r.map(o=>o.toString()).join(""):r.toString();a(this,b)?T(this,k,P).call(this,s,e):T(this,D,U).call(this,s,e)}clearAll(){var s;a(this,b)?(a(this,h).forEach(r=>r.remove()),(s=this.host.shadowRoot)==null||s.querySelectorAll("style").forEach(r=>r.innerHTML=""),a(this,h).clear()):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],a(this,x).clear(),B(this,u,[]))}};b=new WeakMap;u=new WeakMap;x=new WeakMap;h=new WeakMap;k=new WeakSet;P=function(s,r){var e;let o=a(this,h).get(s);o||(o=document.createElement("style"),a(this,h).set(s,o)),o.textContent=r,(e=this.host.shadowRoot)==null||e.appendChild(o)};D=new WeakSet;U=function(s,r){if(!this.host.shadowRoot)return;let e=a(this,x).get(s);e||(e=new CSSStyleSheet,a(this,x).set(s,e)),e.replaceSync(r),this.host.shadowRoot.adoptedStyleSheets=[...a(this,u),...Array.from(a(this,x).values())]};function cs(){try{return new CSSStyleSheet,!0}catch{return!1}}var ps="-363686",E=new Map,fs=s=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return E.set(s,s),_(s);const r=s+ps;return E.set(s,r),customElements.get(r)?e=>!1:_(r)},$=new WeakMap;function ys(s,...r){let e=$.get(s);return e||(e=O(s),e.raw=O(s.raw),$.set(s,e)),[e,...r]}var O=s=>s.map(r=>{for(const[e,o]of E.entries())r=r.replace(new RegExp(`${e}(?![-a-z])`,"mg"),o);return r});function us(s){return(r,...e)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return s(r,...e);const[o,...g]=ys(r,...e);return s(o,...g)}}var xs=us(W);function hs(s){var r;return(r=[...E.entries()].find(([,e])=>e===s))==null?void 0:r[0]}var I=class extends N{constructor(){super(),this.gdsElementName="",this._isUsingTransitionalStyles=!1,this._dynamicStylesController=new ns(this)}connectedCallback(){super.connectedCallback(),this.gdsElementName=hs(this.tagName.toLowerCase())||this.gdsElementName,this.setAttribute("gds-element",this.gdsElementName)}};p([q()],I.prototype,"_isUsingTransitionalStyles",2);var c=class extends I{render(){return xs`<slot></slot>`}};c.styles=[is,j];p([w({property:"overflow",valueTemplate:s=>s})],c.prototype,"overflow",2);p([w({property:"box-shadow",valueTemplate:s=>`var(--gds-shadow-${s})`})],c.prototype,"shadow",2);p([w({property:"border-radius",valueTemplate:s=>`var(--gds-sys-radii-${s})`})],c.prototype,"radius",2);p([w({property:"background",valueTemplate:s=>`var(--gds-sys-color-${s})`})],c.prototype,"background",2);p([G({attribute:"border",type:String})],c.prototype,"border",2);c=p([fs("gds-card")],c);export{I as G,p as _,fs as g,xs as h,w as s,is as t};
