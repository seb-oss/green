import"./chunk.MMFGTQRY-ff2b95cf.js";import{i as _,x as d}from"./lit-element-2a5e401f.js";import{t as G,_ as e,s as c,g as E,G as R,h as $}from"./chunk.ZQ4D5K7J-df0826a6.js";import"./chunk.FBVBLWMJ-b3c185da.js";import{n as M}from"./Reflect-a49e984a.js";import"./unsafe-html-5de64254.js";import"./directive-12249aa5.js";import"./_commonjsHelpers-725317a4.js";var U=_`
  :host {
    display: block;
...
`,A=U,s=class extends R{constructor(){super(...arguments),this.tag="p"}createTag(){const n=document.createElement(this.tag);return n.appendChild(document.createElement("slot")),n}render(){return $`${this.createTag()}`}};s.styles=[G,A];e([M({type:String})],s.prototype,"tag",2);e([c({valueTemplate:n=>`${n}`,styleTemplate:(n,P)=>{const m=P[0];return`font-size: var(--gds-sys-typography-size-${m}); line-height: var(--gds-sys-typography-line-height-${m});`}})],s.prototype,"size",2);e([c()],s.prototype,"margin",2);e([c({property:"text-wrap",valueTemplate:n=>n})],s.prototype,"wrap",2);e([c({property:"max-width",valueTemplate:n=>`${n}ch`})],s.prototype,"length",2);s=e([E("gds-text")],s);const V={title:"Components/Layouts/Card",component:"gds-card",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-card`\n\n## Usage"}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{}},r={...a,name:"Basic Card",render:n=>d` <gds-card shadow="s{xs} m{xs} l{s}" radius="m">
      <gds-container
    ...
    </gds-card>`},t={...a,name:"Border Style",render:n=>d` <gds-grid columns="5" gap="2xl">
      <gds-card
        shadow="s"
    ...
    </gds-grid>`},i={...a,name:"Border Radius",render:n=>d`<gds-grid columns="6" gap="xl">
    ...
    </gds-grid>`},o={...a,name:"Shadow",render:n=>d`<gds-grid columns="5" gap="xl">
    ...
    </gds-grid>`},g={...a,name:"Background",render:n=>d`<gds-grid columns="4" gap="xl">
      <gds-container>
    ...
    </gds-grid>`},l={...a,name:"Using with Grid",render:n=>d` <gds-grid columns="4" gap="xl">
      <gds-container>
...
}`,...(v=(D=l.parameters)==null?void 0:D.docs)==null?void 0:v.source}}};const W=["Card","CardBorder","CardRadius","Cardshadow","CardBackground","CardGrid"];export{r as Card,g as CardBackground,t as CardBorder,l as CardGrid,i as CardRadius,o as Cardshadow,W as __namedExportsOrder,V as default};
