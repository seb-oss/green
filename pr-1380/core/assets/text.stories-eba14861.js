import"./text-cf147be3.js";import"./card-21b25b64.js";import"./container-cc25c4c8.js";import{x as e}from"./lit-element-2a5e401f.js";import"./gds-element-24e794df.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-6bc9b0c8.js";import"./style-expression-property-6dbce61b.js";import"./watch-c4961afe.js";const G={title:"Docs/Content/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-text`\n\n## Usage"}}}},v={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["label-overline","label-input-medium","label-input-large","label-information-medium","label-information-large","label-small","label-medium","label-large","body-small","body-medium","body-large","title-small","title-medium","title-large","headline-small","headline-medium","headline-large","display-small","display-medium","display-large"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...v,name:"Tags",render:t=>e`<gds-container display="flex" direction="column" gap="m">
  ...
  `};var o,g,m,p,c;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Tags',
  ...
  \`
}`,...(y=(x=a.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var b,h,z;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-container display="flex" direction="column" gap="m">
      <gds-text size="body-small">Body: Small</gds-text>
  ...
  \`
}`,...(z=(h=i.parameters)==null?void 0:h.docs)==null?void 0:z.source}}};var L,f,H;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: 'Title',
  render: args => html\`
    <gds-container display="flex" direction="column" gap="m">
      <gds-text size="title-small">Title: Small</gds-text>
  ...
  \`
}`,...(H=(f=d.parameters)==null?void 0:f.docs)==null?void 0:H.source}}};var S,I,T;n.parameters={...n.parameters,docs:{...(S=n.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: 'Headline',
  render: args => html\`
    <gds-container display="flex" direction="column" gap="m">
      <gds-text size="headline-small">Headline: Small</gds-text>
  ...
  \`
}`,...(T=(I=n.parameters)==null?void 0:I.docs)==null?void 0:T.source}}};var M,q,D;r.parameters={...r.parameters,docs:{...(M=r.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: 'Display',
  render: args => html\`
    <gds-container display="flex" direction="column" gap="m">
      <gds-text size="display-small">Display: Small</gds-text>
  ...
  \`
}`,...(D=(q=r.parameters)==null?void 0:q.docs)==null?void 0:D.source}}};var B,w,k;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Line Clamp',
  render: args => html\`
    <gds-container display="flex" direction="column" gap="m">
      <gds-text size="display-small" lines="2">
  ...
  \`
}`,...(k=(w=l.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};const J=["Card","Size","Body","Title","Headline","Display","Lines"];export{i as Body,s as Card,r as Display,n as Headline,l as Lines,a as Size,d as Title,J as __namedExportsOrder,G as default};
