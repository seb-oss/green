import{n as h}from"./Reflect-a49e984a.js";import{a as J}from"./query-b9d3c2af.js";import{r as se}from"./query-async-1ff18261.js";import{o as ie}from"./unsafe-html-5de64254.js";import{n as A}from"./when-cf7256a5.js";import{G as re,o as ae}from"./form-control-db942eba.js";import{e as Q}from"./class-map-43969d56.js";import{m as S,s as oe}from"./lit-localize-87611c26.js";import{c as le}from"./constrain-slots-08d8606c.js";import{w as E}from"./watch-c4961afe.js";import{g as H,G as X,h as w,a as ne}from"./gds-element-4f5906f2.js";import{s as he,F as pe,L as ce,u as de,n as ue,e as fe}from"./menu-heading-7f5f1a1d.js";import{T as G}from"./transitional-styles-b6254951.js";import{x as N,i as Y}from"./lit-element-2a5e401f.js";import"./popover-061dc730.js";function ve(e={attributes:!0,childList:!0,subtree:!1,characterData:!0}){return(t,s,r)=>{let i;const o=t.connectedCallback,n=t.disconnectedCallback;t.connectedCallback=function(){o==null||o.call(this);const te=(ke,We)=>{var I;(I=r.value)==null||I.call(this)};i=new MutationObserver(te),i.observe(this,e)},t.disconnectedCallback=function(){n==null||n.call(this),i.disconnect()}}}/**
 * @license
...
`;var Ee=Object.defineProperty,Le=Object.getOwnPropertyDescriptor,L=(e,t,s,r)=>{for(var i=r>1?void 0:r?Le(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&Ee(t,s,i),i},$e=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)},y=(e,t,s)=>($e(e,t,"read from private field"),s?s.call(e):t.get(e)),R=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},b,k;let v=class extends X{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,R(this,b,fe()),R(this,k,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))}),new ce(this)}get navigableItems(){return this.visibleOptionElements}get options(){return y(this,b).value?de(y(this,b).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),G.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",y(this,k))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return w`<slot ${ue(y(this,b))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};b=new WeakMap;k=new WeakMap;v.styles=Ce;L([h({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);L([h()],v.prototype,"compareWith",2);L([E("multiple")],v.prototype,"_rerenderOptions",1);v=L([H("gds-listbox")],v);const Se=Y`
  @layer base, reset, transitional-styles;
