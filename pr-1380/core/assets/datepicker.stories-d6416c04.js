import{w as ke,x as W,i as At,s as ea,T as Lt}from"./lit-element-2a5e401f.js";import{n as m,r as ve}from"./Reflect-a49e984a.js";import{e as ta,a as Rt}from"./query-b9d3c2af.js";import{r as be}from"./query-async-1ff18261.js";import{n as se}from"./when-cf7256a5.js";import{i as aa,p as sa,v as I,r as K,h as we,m as na}from"./directive-helpers-5872e68c.js";import{f as ra}from"./menu-heading-7f5f1a1d.js";import{e as Vt,i as ia,t as oa}from"./directive-12249aa5.js";import{e as De}from"./class-map-43969d56.js";import{m as c}from"./lit-localize-87611c26.js";import{G as la}from"./form-control-db942eba.js";import{g as je,G as da,h as T}from"./gds-element-4f5906f2.js";import{T as Bt,r as ha}from"./transitional-styles-b6254951.js";import{w as ye}from"./watch-c4961afe.js";import{d as Qe,a as ua}from"./attribute-converters-ae269b4b.js";import"./popover-061dc730.js";import"./dropdown-c1936c40.js";import"./button-1fc1a28f.js";import"./chevron-right-3a61889b.js";import"./_commonjsHelpers-725317a4.js";import"./cross-small-449fb21d.js";import"./icon-a60706f1.js";import"./unsafe-html-5de64254.js";import"./constrain-slots-08d8606c.js";import"./tokens.style-6bc9b0c8.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ca;function pa(e){return(t,a)=>ta(t,a,{get(){return(this.renderRoot??ca??(ca=document.createDocumentFragment())).querySelectorAll(e)}})}/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=e=>!aa(e)&&typeof e.then=="function",it=1073741823;let va=class extends ra{constructor(){super(...arguments),this._$Cwt=it,this._$Cbt=[],this._$CK=new ga(this),this._$CX=new ma}render(...t){return t.find(a=>!rt(a))??ke}update(t,a){const s=this._$Cbt;let n=s.length;this._$Cbt=a;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let l=0;l<a.length&&!(l>this._$Cwt);l++){const i=a[l];if(!rt(i))return this._$Cwt=l,i;l<n&&i===s[l]||(this._$Cwt=it,n=0,Promise.resolve(i).then(async h=>{for(;o.get();)await o.get();const y=r.deref();if(y!==void 0){const d=y._$Cbt.indexOf(i);d>-1&&d<y._$Cwt&&(y._$Cwt=d,y.setValue(h))}}))}return ke}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const ba=Vt(va);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Ba=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,b=(e,t,a,s)=>{for(var n=s>1?void 0:s?Ha(t,a):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(n=(s?o(t,a,n):o(n))||n);return s&&n&&Ba(t,a,n),n},st=(e,t,a)=>{if(!t.has(e))throw TypeError("Cannot "+a)},v=(e,t,a)=>(st(e,t,"read from private field"),a?a.call(e):t.get(e)),f=(e,t,a)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,a)},_e=(e,t,a,s)=>(st(e,t,"write to private field"),s?s.call(e,a):t.set(e,a),a),C=(e,t,a)=>(st(e,t,"access private method"),a),ae,Oe,Kt,ne,ge,Ne,qt,Te,Jt,Ee,Xt,P,H,Ie,Zt,Pe,Ae,Le,Re,Ve,Be,He,ze,Ge,Ue,me,Ke,qe,pe,Je,Xe,O,Ze,jt,nt,Qt;let g=class extends la{constructor(){super(...arguments),f(this,Oe),f(this,ne),f(this,Ne),f(this,Te),f(this,Ee),f(this,P),f(this,Ie),f(this,pe),f(this,Ze),f(this,nt),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.label="",this.showWeekNumbers=!1,this.size="medium",this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=C(this,pe,Je).call(this,"y-m-d"),f(this,ae,void 0),f(this,Pe,e=>{this._elTrigger.then(t=>{var s,n;((s=e.relatedTarget)==null?void 0:s.parentElement)!==e.target&&((n=document.getSelection())==null||n.removeAllRanges())})}),f(this,Ae,e=>{this._elTrigger.then(t=>{var s,n;(s=document.getSelection())==null||s.removeAllRanges();const a=new Range;a.setStart(t.firstChild,0),a.setEnd(t.lastChild,4),(n=document.getSelection())==null||n.addRange(a)})}),f(this,Le,e=>{this._elField.then(t=>{var a;e.currentTarget===t&&(e.preventDefault(),(a=e.clipboardData)==null||a.setData("text/plain",this.displayValue))})}),f(this,Re,e=>{this._elField.then(t=>{var o;if(e.currentTarget!==t)return;e.preventDefault();const a=(o=e.clipboardData)==null?void 0:o.getData("text/plain");if(!a)return;let s=new Date("-");const n="Invalid Date",r=a.split(this._dateFormatLayout.delimiter);if(r.length===3){const l=this._dateFormatLayout.layout,i=parseInt(r[l.findIndex(d=>d.token==="y")]),h=parseInt(r[l.findIndex(d=>d.token==="m")])-1,y=parseInt(r[l.findIndex(d=>d.token==="d")]);!isNaN(i)&&!isNaN(h)&&!isNaN(y)&&(s=new Date(`${i}-${h+1}-${y}`))}s.toString()===n&&(s=new Date(a),s.toString()===n)||(this.value=s,C(this,P,H).call(this))})}),f(this,Ve,e=>{var t;(t=this._elSpinners[0])==null||t.focus()}),f(this,Be,e=>{e.stopPropagation(),this.value=e.detail,this.open=!1,C(this,P,H).call(this)}),f(this,He,e=>{var t;e.stopPropagation(),this._focusedMonth=(t=e.target)==null?void 0:t.value}),f(this,ze,e=>{var t;e.stopPropagation(),this._focusedYear=(t=e.target)==null?void 0:t.value}),f(this,Ge,e=>{this._focusedMonth++,this._focusedMonth>11&&(this._focusedMonth=0,this._focusedYear++)}),f(this,Ue,e=>{this._focusedMonth--,this._focusedMonth<0&&(this._focusedMonth=11,this._focusedYear--)}),f(this,me,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),C(this,Ie,Zt).call(this)}),f(this,Ke,async e=>{if(e.target===e.currentTarget){if(this.open=e.detail.open,e.detail.reason==="close"){const t=(await this._elCalendar).value;!R(t||new Date(0),v(this,ae)||new Date(0))&&(this.value=t,C(this,P,H).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}e.detail.reason==="cancel"&&(this.value=v(this,ae))}}),f(this,qe,e=>{const t=Array.from(this._elSpinners).findIndex(a=>a===e.target);if(e.key==="ArrowRight"){const a=this._elSpinners[t+1];a&&a.focus()}if(e.key==="ArrowLeft"){const a=this._elSpinners[t-1];a&&a.focus()}}),f(this,Xe,(e,t)=>{v(this,O)[t]=e;const a=new Date;a.setFullYear(parseInt(v(this,O).year)),a.setMonth(parseInt(v(this,O).month)-1),a.setDate(parseInt(v(this,O).day)),a.toString()!=="Invalid Date"&&(this.value=a,C(this,P,H).call(this))}),f(this,O,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map(e=>e.token).join(this._dateFormatLayout.delimiter)}set dateformat(e){this._dateFormatLayout=C(this,pe,Je).call(this,e)}async getFocusedDate(){if(this.open)return this._elCalendar.then(e=>e.focusedDate)}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(e){return this._elCalendar.then(t=>t.getDateCell(e))}connectedCallback(){super.connectedCallback(),Bt.instance.apply(this,"gds-datepicker")}render(){return T`${se(this.label&&!this.hideLabel,()=>T`<label for="spinner-0" id="label">${this.label}</label>`)}
      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${wa(v(this,Ze,jt),e=>e,e=>T`<gds-option value=${e}>${e}</gds-option>`)}
          </gds-dropdown>
          <button
            @click=${v(this,Ge)}
        ...
        <div class="footer">
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),this.value=void 0,this.open=!1,C(this,P,H).call(this)}}
          >
            ${c("Clear")}
          </gds-button>
...
Clicking the calendar icon opens a popover with a calendar view where a date can be chosen.`}}},tags:["autodocs"]},U={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Pick a date"}},ie={...U},q={...U,render:e=>W`
  ...
  render: args => html\`
    ...
    ></gds-datepicker>
  \`
}`,...(Et=(Tt=j.parameters)==null?void 0:Tt.docs)==null?void 0:Et.source},description:{story:"The date picker has two sizes: `small` and `medium`. The default size is `medium`.\n\nOptionally, the label can be hidden by using the `hide-label` attribute.",...(Pt=(It=j.parameters)==null?void 0:It.docs)==null?void 0:Pt.description}}};const vs=["Basic","Usage","WeekNumbers","MinMaxDates","Disabled","InputFieldSize"];export{ie as Basic,Z as Disabled,j as InputFieldSize,X as MinMaxDates,q as Usage,J as WeekNumbers,vs as __namedExportsOrder,ms as default};
