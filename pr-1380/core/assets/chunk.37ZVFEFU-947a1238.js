import{i as I,r as m,x as W,s as N}from"./lit-element-71e04f06.js";import{n as D,t as C,r as j}from"./Reflect-8da9b77b.js";var q=I`
...
`,J=q,P=Object.defineProperty,H=Object.defineProperties,K=Object.getOwnPropertyDescriptor,X=Object.getOwnPropertyDescriptors,S=Object.getOwnPropertySymbols,Q=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable,B=(s,e,r)=>e in s?P(s,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[e]=r,Z=(s,e)=>{for(var r in e||(e={}))Q.call(e,r)&&B(s,r,e[r]);if(S)for(var r of S(e))Y.call(e,r)&&B(s,r,e[r]);return s},bs=(s,e)=>H(s,X(e)),p=(s,e,r,o)=>{for(var g=o>1?void 0:o?K(e,r):e,d=s.length-1,a;d>=0;d--)(a=s[d])&&(g=(o?a(e,r,g):a(g))||g);return o&&g&&P(e,r,g),g},A=(s,e,r)=>{if(!e.has(s))throw TypeError("Cannot "+r)},t=(s,e,r)=>(A(s,e,"read from private field"),r?r.call(s):e.get(s)),y=(s,e,r)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,r)},T=(s,e,r,o)=>(A(s,e,"write to private field"),o?o.call(s,r):e.set(s,r),r),O=(s,e,r)=>(A(s,e,"access private method"),r);function ss(s,e){const r=Z({waitUntilFirstUpdate:!1},e);return(o,g,d)=>{const{update:a}=o,F=Array.isArray(s)?s:[s];o.update=function(f){F.forEach(v=>{var l;const c=v;if(f.has(c)){const n=f.get(c),z=this[c];n!==z&&(!r.waitUntilFirstUpdate||this.hasUpdated)&&((l=d.value)==null||l.call(this,n,z))}}),a.call(this,f)}}}var es={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},rs=/^([<|>]=?)?([0-9a-z]+)/,R=["{","}",";",","],M=[" ","/n"];function os(s){const e=[];let r="";for(let o=0;o<s.length;o++){const g=s[o];if(M.includes(g)||(r+=g),R.includes(g)){e.push(r.slice(0,-1)),e.push(g),r="";continue}if(M.includes(g)||o===s.length-1){e.push(r),r="";continue}}return e.filter(o=>o!=="")}function ds(s){const e=[];let r="bp",o,g=!1;for(const d of s){if(!R.includes(d)){if(r==="val"&&o)d!=="}"&&o.values.push(d);else{if(o&&g){o.breakpoint+=`,${d}`,g=!1;continue}o?(r="val",o.values.push(o.breakpoint),o.values.push(d),o.breakpoint="-"):(o={breakpoint:d,values:[]},e.push(o))}continue}if(d===","){g=!0;continue}if(d==="{"){r="val";continue}if(d==="}"||d===";"){r="bp",o=void 0;continue}}return e.map(d=>(d.values.length===0&&(d.values.push(d.breakpoint),d.breakpoint="-"),d))}function gs(s){return s.split(",").map(r=>{const o=r.trim().match(rs);if(!o)throw new Error(`Invalid breakpoint specifier: ${r}`);return{condition:o[1],value:o[2]}})}function as(s,e,r,o=d=>d,g=(d,a)=>`${d}: ${a.join(" ")};`){let d="";for(const a of r){const v=`@media ${(a.breakpoint==="-"?[{condition:">=",value:"0"}]:gs(a.breakpoint)).map(l=>{var c,n;return`(${(c=l.condition)!=null&&c.includes("<")?"max-width":"min-width"}: ${(n=es[l.value])!=null?n:l.value})`}).join(" and ")} {${s}{${g(e,a.values.map(o))}}}`;d+=v}return d}function k(s){return(e,r)=>{var o,g,d;const a=(o=s==null?void 0:s.selector)!=null?o:":host",F=(g=s==null?void 0:s.property)!=null?g:String(r),f=(d=s==null?void 0:s.valueTemplate)!=null?d:l=>`var(--gds-sys-space-spacer-${l})`,v=s==null?void 0:s.styleTemplate;D({attribute:s==null?void 0:s.attribute})(e,r),ss(r)(e,r,{value:function(l,c){const n=ds(os(c)),z=as(a,F,n,f,v);this[`__${String(r)}_ast`]=n,console.log(z),this._dynamicStylesController.inject(`sep_${String(r)}`,m(z))}})}}var ts=`/**
 * Do not edit directly
 * Generated on Thu, 13 Jun 2024 02:16:10 GMT
 */
...
`,ns=[m(ts),m(ls),m(is),m(cs)],b,h,u,x,E,L,_,U,ps=class{constructor(s){y(this,E),y(this,_),y(this,b,!fs()),y(this,h,[]),y(this,u,new Map),y(this,x,new Map),this.host=s,this.host.addController(this)}hostConnected(){this.host.shadowRoot&&t(this,h).length===0&&T(this,h,[...this.host.shadowRoot.adoptedStyleSheets||[]])}inject(s,e){const r=Array.isArray(e)?e.map(o=>o.toString()).join(""):e.toString();t(this,b)?O(this,E,L).call(this,s,r):O(this,_,U).call(this,s,r)}clearAll(){var s;t(this,b)?(t(this,x).forEach(e=>e.remove()),(s=this.host.shadowRoot)==null||s.querySelectorAll("style").forEach(e=>e.innerHTML=""),t(this,x).clear()):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],t(this,u).clear(),T(this,h,[]))}};b=new WeakMap;h=new WeakMap;u=new WeakMap;x=new WeakMap;E=new WeakSet;L=function(s,e){var r;let o=t(this,x).get(s);o||(o=document.createElement("style"),t(this,x).set(s,o)),o.textContent=e,(r=this.host.shadowRoot)==null||r.appendChild(o)};_=new WeakSet;U=function(s,e){if(!this.host.shadowRoot)return;let r=t(this,u).get(s);r||(r=new CSSStyleSheet,t(this,u).set(s,r)),r.replaceSync(e),this.host.shadowRoot.adoptedStyleSheets=[...t(this,h),...Array.from(t(this,u).values())]};function fs(){try{return new CSSStyleSheet,!0}catch{return!1}}var ys="-3a6d7a",w=new Map,hs=s=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return w.set(s,s),C(s);const e=s+ys;return w.set(s,e),customElements.get(e)?r=>!1:C(e)},$=new WeakMap;function us(s,...e){let r=$.get(s);return r||(r=G(s),r.raw=G(s.raw),$.set(s,r)),[r,...e]}var G=s=>s.map(e=>{for(const[r,o]of w.entries())e=e.replace(new RegExp(`${r}(?![-a-z])`,"mg"),o);return e});function xs(s){return(e,...r)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return s(e,...r);const[o,...g]=us(e,...r);return s(o,...g)}}var vs=xs(W);function zs(s){var e;return(e=[...w.entries()].find(([,r])=>r===s))==null?void 0:e[0]}var V=class extends N{constructor(){super(),this.gdsElementName="",this._isUsingTransitionalStyles=!1,this._dynamicStylesController=new ps(this)}connectedCallback(){super.connectedCallback(),this.gdsElementName=zs(this.tagName.toLowerCase())||this.gdsElementName,this.setAttribute("gds-element",this.gdsElementName)}};p([j()],V.prototype,"_isUsingTransitionalStyles",2);var i=class extends V{render(){return vs`<slot></slot>`}};i.styles=[ns,J];p([k({property:"overflow",valueTemplate:s=>s})],i.prototype,"overflow",2);p([k({property:"box-shadow",valueTemplate:s=>`var(--gds-shadow-${s})`})],i.prototype,"shadow",2);p([k({property:"border-radius",valueTemplate:s=>`var(--gds-sys-radii-${s})`})],i.prototype,"radius",2);p([k({property:"background",valueTemplate:s=>s})],i.prototype,"background",2);p([D({attribute:"border",type:String})],i.prototype,"border",2);p([D({attribute:"hovered",type:Boolean})],i.prototype,"hovered",2);i=p([hs("gds-card")],i);export{V as G,ys as V,p as _,y as a,T as b,t as c,fs as d,bs as e,Z as f,hs as g,vs as h,k as s,ns as t,ss as w};
