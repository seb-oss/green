import{w as ke,x as W,i as At,s as ea,T as Lt}from"./lit-element-71e04f06.js";import{n as g,r as ve}from"./Reflect-8da9b77b.js";import{e as ta,a as Rt}from"./query-b9d3c2af.js";import{r as be}from"./query-async-1ff18261.js";import{n as se}from"./when-cf7256a5.js";import{i as aa,p as sa,v as I,r as K,h as we,m as na}from"./directive-helpers-9aabd8ef.js";import{f as ra}from"./menu-heading-c0ee9bbb.js";import{e as Vt,i as ia,t as oa}from"./directive-12249aa5.js";import{e as De}from"./class-map-4ef1884f.js";import{m as c}from"./lit-localize-87611c26.js";import{G as la}from"./form-control-88956c80.js";import{g as je,G as da,h as T}from"./gds-element-d272b33a.js";import{T as Bt,r as ha}from"./transitional-styles-270c55d2.js";import{w as ye}from"./watch-c4961afe.js";import{d as Qe,a as ua}from"./attribute-converters-ae269b4b.js";import"./popover-ed1c1700.js";import"./dropdown-b73a3b66.js";import"./button-55a01839.js";import"./chevron-right-b3d7fa40.js";import"./_commonjsHelpers-725317a4.js";import"./cross-small-857cc48b.js";import"./icon-017be2f6.js";import"./unsafe-html-367b382d.js";import"./if-defined-e4b5fcf9.js";import"./constrain-slots-08d8606c.js";import"./static-c6782857.js";import"./tokens.style-5c270edc.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ma{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class ga{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){this.Z??(this.Z=new Promise(t=>this.q=t))}resume(){var t;(t=this.q)==null||t.call(this),this.Z=this.q=void 0}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=e=>!aa(e)&&typeof e.then=="function",it=1073741823;let va=class extends ra{constructor(){super(...arguments),this._$Cwt=it,this._$Cbt=[],this._$CK=new ma(this),this._$CX=new ga}render(...t){return t.find(a=>!rt(a))??ke}update(t,a){const s=this._$Cbt;let n=s.length;this._$Cbt=a;const r=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let l=0;l<a.length&&!(l>this._$Cwt);l++){const i=a[l];if(!rt(i))return this._$Cwt=l,i;l<n&&i===s[l]||(this._$Cwt=it,n=0,Promise.resolve(i).then(async h=>{for(;o.get();)await o.get();const y=r.deref();if(y!==void 0){const d=y._$Cbt.indexOf(i);d>-1&&d<y._$Cwt&&(y._$Cwt=d,y.setValue(h))}}))}return ke}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};const ba=Vt(va);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
      ...
      >
        ...
        <div class="footer">
          ...
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),C(this,ne,me).call(this,new Date)}}
          >
            ${c("Today")}
          </gds-button>
        </div>
      </gds-popover> `}_handleValueChange(){if(!this.value){_e(this,O,{year:"yyyy",month:"mm",day:"dd"});return}const e=this.value;this._focusedMonth=e.getMonth(),this._focusedYear=e.getFullYear();const t=e.getFullYear().toString(),a=(e.getMonth()+1).toString().padStart(2,"0"),s=e.getDate().toString().padStart(2,"0");_e(this,O,{year:t,month:a,day:s})}_handleOpenChange(){this.open&&(_e(this,ae,this.value),this._elCalendar.then(e=>e.focus()))}};ae=new WeakMap;Oe=new WeakSet;Kt=async function(){const e=await this.getFocusedDate();let t="",a;return e&&e>this.max?(t=c("Last available date"),a=s=>{s.stopPropagation(),C(this,ne,me).call(this,this.max)}):e&&e<this.min&&(t=c("First available date"),a=s=>{s.stopPropagation(),C(this,ne,me).call(this,this.min)}),T`${se(t.length>0,()=>T`<gds-button rank="tertiary" size="small" @click=${a}>
          ${t}
        </gds-button>`,()=>Lt)}`};ne=new WeakSet;me=function(e){const t=new Date(e);this._elCalendar.then(a=>a.focusedDate=t).then(v(this,ge))};Ne=new WeakSet;qt=function(e){return{year:c("Year"),month:c("Month"),day:c("Day")}[e]};Te=new WeakSet;Jt=function(e){return{year:1900,month:1,day:1}[e]};Ee=new WeakSet;Xt=function(e){return{year:9999,month:12,day:31}[e]};P=new WeakSet;H=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value}}))};Ie=new WeakSet;Zt=function(){this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value}}))};Pe=new WeakMap;Ae=new WeakMap;Le=new WeakMap;Re=new WeakMap;Ve=new WeakMap;Be=new WeakMap;He=new WeakMap;ze=new WeakMap;Ge=new WeakMap;Ue=new WeakMap;ge=new WeakMap;Ke=new WeakMap;qe=new WeakMap;pe=new WeakSet;Je=function(e){const t=e.replace(/[a-z0-9]/gi,"")[0],a=e.split(t),s=a.findIndex(i=>i==="y"),n=a.findIndex(i=>i==="m"),r=a.findIndex(i=>i==="d");if(s===-1||n===-1||r===-1)throw new Error("Invalid date format for <gds-datepicker>");const l=[s,n,r].sort((i,h)=>i-h).map(i=>a[i]).map(i=>({token:i,name:i==="y"?"year":i==="m"?"month":"day"}));return{delimiter:t,layout:l}};Xe=new WeakMap;O=new WeakMap;Ze=new WeakSet;jt=function(){var n;const e=this.min.getFullYear(),t=this.max.getFullYear(),a=v(this,nt,Qt),s=(n=this.value)==null?void 0:n.getFullYear();return{*[Symbol.iterator](){a&&(yield s);for(let r=e;r<=t;r++)yield r}}};nt=new WeakSet;Qt=function(){return this.value?this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear():!1};m.styles=[Va];m.shadowRootOptions={mode:"open",delegatesFocus:!0};b([g({converter:Qe})],m.prototype,"value",2);b([g({converter:Qe})],m.prototype,"min",2);b([g({converter:Qe})],m.prototype,"max",2);b([g({type:Boolean})],m.prototype,"open",2);b([g()],m.prototype,"label",2);b([g({type:Boolean,attribute:"show-week-numbers"})],m.prototype,"showWeekNumbers",2);b([g()],m.prototype,"size",2);b([g({type:Boolean,attribute:"hide-label"})],m.prototype,"hideLabel",2);b([g()],m.prototype,"dateformat",1);b([g({type:Boolean,attribute:"disabled-weekends"})],m.prototype,"disabledWeekends",2);b([g({converter:ua,attribute:"disabled-dates"})],m.prototype,"disabledDates",2);b([be("#calendar-button")],m.prototype,"test_calendarButton",2);b([ve()],m.prototype,"_focusedMonth",2);b([ve()],m.prototype,"_focusedYear",2);b([ve()],m.prototype,"_dateFormatLayout",2);b([be("#calendar")],m.prototype,"_elCalendar",2);b([be("#calendar-button")],m.prototype,"_elTrigger",2);b([be("#field")],m.prototype,"_elField",2);b([pa("[role=spinbutton]")],m.prototype,"_elSpinners",2);b([Rt(".input")],m.prototype,"_elInput",2);b([ye("value")],m.prototype,"_handleValueChange",1);b([ye("open")],m.prototype,"_handleOpenChange",1);m=b([je("gds-datepicker")],m);ha();const bs={title:"Components/Datepicker",component:"gds-datepicker",parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/sebgroup/green/tree/main/libs/core/src/components/datepicker)
&nbsp;|&nbsp;
...
Clicking the calendar icon opens a popover with a calendar view where a date can be chosen.`}}},tags:["autodocs"]},U={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Pick a date"}},ie={...U},q={...U,render:e=>W`
  ...
  ...DefaultParams
}`,...(ct=(ut=ie.parameters)==null?void 0:ut.docs)==null?void 0:ct.source}}};var pt,ft,mt,gt,vt;q.parameters={...q.parameters,docs:{...(pt=q.parameters)==null?void 0:pt.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-datepicker label="Using slots" onchange="console.log(this.value)">
      <span slot="sub-label">
  ...
  \`
}`,...(mt=(ft=q.parameters)==null?void 0:ft.docs)==null?void 0:mt.source},description:{story:"The date picker takes a `label` attribute for setting the label text, and has two slots for adding\nadditional information.\n\nThe `sub-label` slot sits between the label and the input, and the `message` slot sits below the\ninput. The `message` slot is used to display instructions and/or validation errors.\n\nWhen the value is changed by a user, a `change` event is fired.",...(vt=(gt=q.parameters)==null?void 0:gt.docs)==null?void 0:vt.description}}};var bt,yt,wt,_t,kt;J.parameters={...J.parameters,docs:{...(bt=J.parameters)==null?void 0:bt.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-datepicker
      label="With week numbers"
