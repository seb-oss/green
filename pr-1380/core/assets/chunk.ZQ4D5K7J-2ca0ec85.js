import{r as u,x as R,s as L}from"./lit-element-2a5e401f.js";import{n as P,t as A,r as U}from"./Reflect-a49e984a.js";var M=Object.defineProperty,I=Object.getOwnPropertyDescriptor,_=Object.getOwnPropertySymbols,V=Object.prototype.hasOwnProperty,W=Object.prototype.propertyIsEnumerable,k=(e,o,s)=>o in e?M(e,o,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[o]=s,N=(e,o)=>{for(var s in o||(o={}))V.call(o,s)&&k(e,s,o[s]);if(_)for(var s of _(o))W.call(o,s)&&k(e,s,o[s]);return e},J=(e,o,s,r)=>{for(var l=r>1?void 0:r?I(o,s):o,t=e.length-1,a;t>=0;t--)(a=e[t])&&(l=(r?a(o,s,l):a(l))||l);return r&&l&&M(o,s,l),l},w=(e,o,s)=>{if(!o.has(e))throw TypeError("Cannot "+s)},n=(e,o,s)=>(w(e,o,"read from private field"),s?s.call(e):o.get(e)),f=(e,o,s)=>{if(o.has(e))throw TypeError("Cannot add the same private member more than once");o instanceof WeakSet?o.add(e):o.set(e,s)},C=(e,o,s,r)=>(w(e,o,"write to private field"),r?r.call(e,s):o.set(e,s),s),S=(e,o,s)=>(w(e,o,"access private method"),s);function q(e,o){const s=N({waitUntilFirstUpdate:!1},o);return(r,l,t)=>{const{update:a}=r,b=Array.isArray(e)?e:[e];r.update=function(i){b.forEach(F=>{var d;const c=F;if(i.has(c)){const g=i.get(c),m=this[c];g!==m&&(!s.waitUntilFirstUpdate||this.hasUpdated)&&((d=t.value)==null||d.call(this,g,m))}}),a.call(this,i)}}}var j={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},H=/^([<|>]=?)?([0-9a-z]+)/,G=["{","}",";",","],B=[" ","/n"];function K(e){const o=[];let s="";for(let r=0;r<e.length;r++){const l=e[r];if(B.includes(l)||(s+=l),G.includes(l)){o.push(s.slice(0,-1)),o.push(l),s="";continue}if(B.includes(l)||r===e.length-1){o.push(s),s="";continue}}return o.filter(r=>r!=="")}function X(e){const o=[];let s="bp",r,l=!1;for(const t of e){if(!G.includes(t)){if(s==="val"&&r)t!=="}"&&r.values.push(t);else{if(r&&l){r.breakpoint+=`,${t}`,l=!1;continue}r?(s="val",r.values.push(r.breakpoint),r.values.push(t),r.breakpoint="-"):(r={breakpoint:t,values:[]},o.push(r))}continue}if(t===","){l=!0;continue}if(t==="{"){s="val";continue}if(t==="}"||t===";"){s="bp",r=void 0;continue}}return o.map(t=>(t.values.length===0&&(t.values.push(t.breakpoint),t.breakpoint="-"),t))}function Q(e){return e.split(",").map(s=>{const r=s.trim().match(H);if(!r)throw new Error(`Invalid breakpoint specifier: ${s}`);return{condition:r[1],value:r[2]}})}function Y(e,o,s,r=t=>t,l=(t,a)=>`${t}: ${a.join(" ")};`){let t="";for(const a of s){const F=`@media ${(a.breakpoint==="-"?[{condition:">=",value:"0"}]:Q(a.breakpoint)).map(d=>{var c,g;return`(${(c=d.condition)!=null&&c.includes("<")?"max-width":"min-width"}: ${(g=j[d.value])!=null?g:d.value})`}).join(" and ")} {${e}{${l(o,a.values.map(r))}}}`;t+=F}return t}function ue(e){return(o,s)=>{var r,l,t;const a=(r=e==null?void 0:e.selector)!=null?r:":host",b=(l=e==null?void 0:e.property)!=null?l:String(s),i=(t=e==null?void 0:e.valueTemplate)!=null?t:d=>`var(--gds-space-${d})`,F=e==null?void 0:e.styleTemplate;P({attribute:e==null?void 0:e.attribute})(o,s),q(s)(o,s,{value:function(d,c){const g=X(K(c)),m=Y(a,b,g,i,F);this[`__${String(s)}_ast`]=g,console.log(m),this._dynamicStylesController.inject(`sep_${String(s)}`,u(m))}})}}var Z=`/**
 * Do not edit directly
 * Generated on Tue, 25 Jun 2024 03:12:02 GMT
 */
...
`,ye=[u(Z),u(ee),u(se),u(oe),u(re)],x,y,p,h,E,O,D,$,te=class{constructor(e){f(this,E),f(this,D),f(this,x,!le()),f(this,y,[]),f(this,p,new Map),f(this,h,new Map),this.host=e,this.host.addController(this)}hostConnected(){this.host.shadowRoot&&n(this,y).length===0&&C(this,y,[...this.host.shadowRoot.adoptedStyleSheets||[]])}inject(e,o){const s=Array.isArray(o)?o.map(r=>r.toString()).join(""):o.toString();n(this,x)?S(this,E,O).call(this,e,s):S(this,D,$).call(this,e,s)}clearAll(){var e;n(this,x)?(n(this,h).forEach(o=>o.remove()),(e=this.host.shadowRoot)==null||e.querySelectorAll("style").forEach(o=>o.innerHTML=""),n(this,h).clear()):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],n(this,p).clear(),C(this,y,[]))}};x=new WeakMap;y=new WeakMap;p=new WeakMap;h=new WeakMap;E=new WeakSet;O=function(e,o){var s;let r=n(this,h).get(e);r||(r=document.createElement("style"),n(this,h).set(e,r)),r.textContent=o,(s=this.host.shadowRoot)==null||s.appendChild(r)};D=new WeakSet;$=function(e,o){if(!this.host.shadowRoot)return;let s=n(this,p).get(e);s||(s=new CSSStyleSheet,n(this,p).set(e,s)),s.replaceSync(o),this.host.shadowRoot.adoptedStyleSheets=[...n(this,y),...Array.from(n(this,p).values())]};function le(){try{return new CSSStyleSheet,!0}catch{return!1}}var ae="-c868d0",v=new Map,pe=e=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return v.set(e,e),A(e);const o=e+ae;return v.set(e,o),customElements.get(o)?s=>!1:A(o)},T=new WeakMap;function ne(e,...o){let s=T.get(e);return s||(s=z(e),s.raw=z(e.raw),T.set(e,s)),[s,...o]}var z=e=>e.map(o=>{for(const[s,r]of v.entries())o=o.replace(new RegExp(`${s}(?![-a-z])`,"mg"),r);return o});function de(e){return(o,...s)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return e(o,...s);const[r,...l]=ne(o,...s);return e(r,...l)}}var he=de(R);function ce(e){var o;return(o=[...v.entries()].find(([,s])=>s===e))==null?void 0:o[0]}var ge=class extends L{constructor(){super(),this.gdsElementName="",this._isUsingTransitionalStyles=!1,this._dynamicStylesController=new te(this)}connectedCallback(){super.connectedCallback(),this.gdsElementName=ce(this.tagName.toLowerCase())||this.gdsElementName,this.setAttribute("gds-element",this.gdsElementName)}};J([U()],ge.prototype,"_isUsingTransitionalStyles",2);export{ge as G,J as _,pe as g,he as h,ue as s,ye as t};
