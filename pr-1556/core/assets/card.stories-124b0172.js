import"./card-d477504c.js";import"./img-8dc4b233.js";import"./video-63ddbb35.js";import"./flex-97e9667a.js";import"./text-2be52b31.js";import"./divider-ea393724.js";import"./arrow-right-23204178.js";import"./circles-three-2a47ea68.js";import{k as s}from"./lit-element-1d72f0ce.js";import"./gds-element-d791ed3d.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-b5b8efd2.js";import"./style-expression-property-731c6e0d.js";import"./watch-c4961afe.js";import"./query-b9d3c2af.js";import"./static-c0094392.js";import"./icon-b442d341.js";import"./directive-dd518ee3.js";const ns={title:"Docs/Layout/Card",component:"gds-card",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-card` is a custom element that provides a flexible card system.\n\nIt can be used to create a card with different styles and configurations.\n\nThe card can be customized with different properties like `shadow`, `border`, `radius`, and `background`.\nIt is designed to be used in different scenarios like displaying content, images, or other elements.\nIt can be used in combination with other elements like `gds-grid`, `gds-container`, `gds-img`, `gds-text` etc.\n\n@status beta\n\n@extends `gds-container`"}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{disable:!0}}},n={...e,render:d=>s`
  ...
  `},t={...e,name:"Border Style",render:d=>s` <gds-grid columns="5" gap="l">
    ...
    </gds-grid>`},a={...e,name:"Border Radius",render:d=>s`<gds-grid columns="8" gap="l">
    ...
    </gds-grid>`},i={...e,name:"Shadow",render:d=>s`<gds-grid columns="5" gap="l">
      <gds-card
        padding="s{xs} m{l} l{l}"
    ...
    </gds-grid>`},r={...e,name:"Background",render:d=>s`<gds-grid columns="4" gap="l">
    ...
    </gds-grid>`},o={...e,name:"Using with Grid",render:d=>s` <gds-grid columns="4" gap="l">
      <gds-container>
    ...
    </gds-grid>`};var g,l,c,m,u;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-grid columns="xs{1} m{3} l{3}" gap="l">
      <gds-card shadow="s{xs} m{xs} l{s}" radius="xs" overflow="hidden">
  ...
  \`
}`,...(c=(l=n.parameters)==null?void 0:l.docs)==null?void 0:c.source},description:{story:"Card",...(u=(m=n.parameters)==null?void 0:m.docs)==null?void 0:u.description}}};var x,p,f,b,h;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Border Style',
