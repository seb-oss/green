import{D as p,R as u,i as d,k as y}from"./lit-element-1d72f0ce.js";import{n,G as g}from"./gds-element-d791ed3d.js";import{i as v,t as b,e as f}from"./directive-dd518ee3.js";/**
 * @license
...
`;var _=Object.defineProperty,$=Object.getOwnPropertyDescriptor,l=(h,t,e,o)=>{for(var s=o>1?void 0:o?$(t,e):t,r=h.length-1,c;r>=0;r--)(c=h[r])&&(s=(o?c(t,e,s):c(s))||s);return o&&s&&_(t,e,s),s};class i extends g{constructor(){super(...arguments),this.solid=!1,this.box=!1,this.label=""}render(){const t=this.constructor._name==="seb",e=t?"55":this.width!==void 0?this.width.toString():void 0,o=t?"24":this.height!==void 0?this.height.toString():"1lh",s=t?"0 0 55 24":this.box||"0 0 24 24";let r=`<svg
      ${e?`width="${e}"`:""}
      height="${o}"
      viewBox="${s}"
      fill="none"
