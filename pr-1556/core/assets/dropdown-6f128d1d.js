import{n as h,g as H,G as Y,h as w,a as ie}from"./gds-element-d791ed3d.js";import{a as J}from"./query-b9d3c2af.js";import{r as re}from"./query-async-1ff18261.js";import{a as ae}from"./icon-b442d341.js";import{n as O}from"./when-748fcf30.js";import{t as oe}from"./if-defined-5f576255.js";import{R as Q}from"./class-map-f04c1558.js";import{m as k,s as le}from"./runtime-c06dc943.js";import{c as ne}from"./constrain-slots-08d8606c.js";import{w as C}from"./watch-c4961afe.js";import"./chevron-bottom-d68c2f0b.js";import"./checkmark-f1b1247c.js";import{K as he,i as de}from"./ref-f16d4147.js";import{T as G}from"./transitional-styles-c75c0fd2.js";import{k as $,i as X}from"./lit-element-1d72f0ce.js";import{s as ce,F as pe,L as ue,u as fe}from"./menu-heading-86615c64.js";import{t as Z}from"./tokens.style-b5b8efd2.js";import"./popover-e94a7434.js";import"./backdrop-c8192df5.js";import"./button-597f9ed1.js";import{G as ge}from"./form-control-c8d4aaee.js";/**
 * @license
...
`;var Se=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,l=(e,t,s,r)=>{for(var i=r>1?void 0:r?Oe(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&Se(t,s,i),i},K=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)},d=(e,t,s)=>(K(e,t,"read from private field"),s?s.call(e):t.get(e)),c=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},Ae=(e,t,s,r)=>(K(e,t,"write to private field"),r?r.call(e,s):t.set(e,s),s),S=(e,t,s)=>(K(e,t,"access private method"),s),f,M,T,D,P,z,j,B,ee,F,te,v,L;let a=class extends ge{constructor(){super(),c(this,z),c(this,B),c(this,F),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,c(this,f,void 0),c(this,M,e=>{const t=this._elSearchInput,s=Array.from(d(this,f));if(s.forEach(i=>i.hidden=!1),!t.value)return;s.filter(i=>!this.searchFilter(t.value,i)).forEach(i=>i.hidden=!0)}),c(this,T,e=>{var t;(t=this._elListbox)==null||t.then(s=>{if(e.key==="ArrowDown"||e.key==="Tab"){e.preventDefault(),s.focus();return}})}),c(this,D,e=>{var t;if(e.key==="Tab"&&this.searchable){e.preventDefault(),(t=this._elSearchInput)==null||t.focus();return}}),c(this,P,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),c(this,v,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)}),c(this,L,e=>{var t;e.key==="Tab"&&!this.searchable&&(e.preventDefault(),this.open=!1,(t=this._elTriggerBtn)==null||t.focus())}),ne(this),me(this),Ae(this,f,this.getElementsByTagName(ie("gds-option")))}get type(){return"gds-dropdown"}get options(){return Array.from(d(this,f)).filter(e=>!e.hasAttribute("isplaceholder"))}get placeholder(){return Array.from(d(this,f)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){var t,s;let e;return Array.isArray(this.value)?this.value.length>2?e=k(le`${this.value.length} selected`):e=this.value.reduce((r,i)=>{var o;return r+((o=this.options.find(n=>n.value===i))==null?void 0:o.innerHTML)+", "},"").slice(0,-2):e=(t=this.options.find(r=>r.selected))==null?void 0:t.innerHTML,e||((s=this.placeholder)==null?void 0:s.innerHTML)||""}connectedCallback(){super.connectedCallback(),G.instance.apply(this,"gds-dropdown"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange()})}render(){return w`
