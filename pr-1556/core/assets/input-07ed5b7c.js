import{i as U,h as V,D as u}from"./lit-element-1d72f0ce.js";import{n as d,g as J,h as o}from"./gds-element-d791ed3d.js";import{a as K}from"./query-b9d3c2af.js";import{r as F}from"./query-async-1ff18261.js";import{b as P}from"./until-27bb1490.js";import{n as c}from"./when-748fcf30.js";import{m as H}from"./runtime-c06dc943.js";import{c as L}from"./constrain-slots-08d8606c.js";import{w as Q}from"./watch-c4961afe.js";import{G as Z,f as Y}from"./form-control-c8d4aaee.js";import{t as ee}from"./tokens.style-711a3a94.js";/**
 * @license
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};C=new WeakSet;X=function(){return o`
    ...
    `};w=new WeakSet;N=function(){return this.clearable&&this.value.length>0?o`
      ...
      `:u};k=new WeakSet;O=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};$=new WeakSet;G=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="error":e<20?t="warning":t="success",o`<gds-badge variant="${t}">${e}</gds-badge>`};S=new WeakSet;D=async function(){return this.elExtendedSupportingTextSlot.then(e=>e.assignedElements().length>0?o`
          <gds-button
            size="small"
            variant="tertiary"
