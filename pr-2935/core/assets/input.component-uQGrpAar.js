import{P,K as R,O as u,N as F,a6 as g,A as v,aa as G,i as M,v as D,n as a,f as W,$ as N,y as q,Q as U,I as L,H,a0 as K,d as A,h as p,o as n,E as X,g as Y,F as Q}from"./iframe-DzY-bVfW.js";import{l as J}from"./localized-decorator-Ck9A2KvA.js";import{r as Z}from"./query-async-XZ-7GLA6.js";import{f as j,G as tt}from"./form-control-host.style-CurVPziq.js";import{G as et,a as st}from"./form-control-header.component-CO1-S-da.js";import{G as it}from"./flex.component-DYDWa_cX.js";import{I as rt}from"./cross-small.component-C-9-3z0r.js";import{c as at}from"./textarea.component-vb-PTNxQ.js";const ot=P(class extends R{constructor(t){if(super(t),t.type!==u.PROPERTY&&t.type!==u.ATTRIBUTE&&t.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!F(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===g||e===v)return e;const r=t.element,o=t.name;if(t.type===u.PROPERTY){if(e===r[o])return g}else if(t.type===u.BOOLEAN_ATTRIBUTE){if(!!e===r.hasAttribute(o))return g}else if(t.type===u.ATTRIBUTE&&r.getAttribute(o)===e+"")return g;return G(t),e}}),nt=M`
