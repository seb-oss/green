import{b as r}from"./iframe-DIuN8nTZ.js";import"./card-BaUl4GLL.js";import"./flex-D7mAkQr3.js";import"./div-Cq798cTh.js";import{a as l}from"./argTableProps-bx3iZUN_.js";import"./preload-helper-PPVm8Dsz.js";import"./card.component-1c4NXcf9.js";import"./flex.component-R-DVnNSW.js";const x={title:"Components/Grid",component:"gds-grid",tags:["autodocs"],parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grid)\n\nThe `gds-grid` is a custom element that provides a flexible grid system. It uses CSS grid layout to arrange its child elements into columns. This component is highly customizable and responsive, allowing you to specify the number of `columns`, `gap`, `padding`, and fluidity for different devices with automated column size based on the content using the `auto-columns` attribute."}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{...l("gds-grid")},args:{gap:"m",padding:"0",columns:"4",innerHTML:`
  ...
  \`
}`,...t.parameters?.docs?.source},description:{story:"This example shows a grid with `4` columns on all breakpoints desktop, tablet, and on mobile. It also has a gap of `2xl` on all breakpoints. The padding is `l` on all breakpoints. As well as `auto-columns` attribute is set to `100` which will make the columns to be `~100px` wide.",...t.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Auto Columns',
  render: args => html\`
    <!-- prettier-ignore -->
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:`Auto Columns, while optional, remove the need for breakpoints, adapting to content for a more flexible and responsive grid.
...
The \`auto-columns\` attribute is set to \`240\` which will make the columns to be \`240px\` no matter the screen/container size.`,...n.parameters?.docs?.description}}};const p=["Basic","Usage","AllBreakpoints","AutoColumns"];export{t as AllBreakpoints,n as AutoColumns,s as Basic,e as Usage,p as __namedExportsOrder,x as default};
