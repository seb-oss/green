...
`;var NC,GC,jC,EC,qC,BC,zC,AC,WC,YC,KC,TC,RC,PC,DC;let OC=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,GC),(0,o.VK)(this,EC),(0,o.VK)(this,BC),(0,o.VK)(this,AC),(0,o.VK)(this,YC),(0,o.VK)(this,TC),(0,o.VK)(this,PC),this.size="large",this.flexDirection="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,(0,o.VK)(this,NC,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){(0,o.S7)(this,NC).call(this)}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",(0,o.S7)(this,NC))}render(){const e={"checkbox-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      role="group"
      id="checkboxgroup"
      class=${(0,l.H)(e)}
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,GC,jC).call(this)}
    </div>`}_syncOnDOMChange(){(0,o.S7)(this,NC).call(this),(0,o.jq)(this,YC,KC).call(this)}};NC=new WeakMap,GC=new WeakSet,jC=function(){return[(0,o.jq)(this,EC,qC).call(this),(0,o.jq)(this,BC,zC).call(this),(0,o.jq)(this,PC,DC).call(this)].map(e=>d.qy`${e}`)},EC=new WeakSet,qC=function(){if(this.label)return d.qy`<gds-form-control-header
        .showExtendedSupportingText=${this.showExtendedSupportingText}
      ...
      >
        ...
        <slot
          ...
          slot="extended-supporting-text"
        ></slot>
      </gds-form-control-header>`},BC=new WeakSet,zC=function(){return d.qy`<div class="content">
      <slot @input=${(0,o.jq)(this,AC,WC)}></slot>
    </div>`},AC=new WeakSet,WC=function(e){e&&e.stopPropagation(),(0,o.jq)(this,YC,KC).call(this),(0,o.jq)(this,TC,RC).call(this)},YC=new WeakSet,KC=function(){const e=this.checkboxes.filter(e=>e.checked).map(e=>e.value);JSON.stringify(e)!==JSON.stringify(this.value)&&(this.value=e)},TC=new WeakSet,RC=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},PC=new WeakSet,DC=function(){return d.qy`<gds-form-control-footer
      id="footer"
      class="size-${this.size}"
      .errorMessage=${this.invalid?this.errorMessage:void 0}
    >
    </gds-form-control-footer>`},OC.styles=[$C],(0,o.Cc)([(0,i.MZ)()],OC.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({attribute:"flex-direction"})],OC.prototype,"flexDirection",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,attribute:"hide-label"})],OC.prototype,"hideLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],OC.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],OC.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Array})],OC.prototype,"value",1),(0,o.Cc)([(0,i.P)("#checkboxgroup")],OC.prototype,"_elCheckboxGroup",2),(0,o.Cc)([(0,ee.w)("value",{waitUntilFirstUpdate:!0})],OC.prototype,"_handleValueChange",1),(0,o.Cc)([(0,ee.w)("invalid"),(0,ee.w)("errorMessage")],OC.prototype,"_handleGroupInvalidChange",1),(0,o.Cc)([(0,Bo.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],OC.prototype,"_syncOnDOMChange",1),OC=(0,o.Cc)([(0,G.J)({labelledBy:"#checkboxgroup",describedBy:"#checkboxgroup",errorMessage:"#checkboxgroup"}),(0,N.cc)()],OC);let FC=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(OC)))){};FC=(0,o.Cc)([(0,d.Y$)("gds-checkbox-group",{dependsOn:[Br.$,qr.V]})],FC);const UC=e=>{FC.define();const t=(0,L.pI)("gds-checkbox-group"),r=(0,n.useRef)(null),s=e.ref||r;(0,L.j_)(s,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:s};return(0,n.createElement)(t,c)};UC.displayName="GdsCheckboxGroup";var JC,QC,XC,eh,th,rh,sh,oh,nh,ih,lh,ah,ch=b.AH`
  @layer base {
    :host {
      display: contents;
    }
...
`;let dh=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,JC),(0,o.VK)(this,XC),(0,o.VK)(this,th),(0,o.VK)(this,sh),(0,o.VK)(this,nh),(0,o.VK)(this,lh),this.href="",this.label="",this.overflow=!1}render(){return d.qy`
      <div role="listitem" class="list-item">${(0,o.jq)(this,XC,eh).call(this)}</div>
    `}};JC=new WeakSet,QC=function(){return"_blank"===this.target?"noreferrer noopener":void 0},XC=new WeakSet,eh=function(){return[(0,o.jq)(this,th,rh).call(this)].map(e=>d.qy`${e}`)},th=new WeakSet,rh=function(){return this.overflow?(0,o.jq)(this,sh,oh).call(this):this.href?(0,o.jq)(this,nh,ih).call(this):(0,o.jq)(this,lh,ah).call(this)},sh=new WeakSet,oh=function(){return d.qy`<slot></slot>`},nh=new WeakSet,ih=function(){return d.qy`
      <gds-link
        href=${(0,a.J)(this.href)}
        target=${(0,a.J)(this.target)}
        rel=${(0,a.J)(this.rel||(0,o.S7)(this,JC,QC))}
        aria-label=${this.label||b.s6}
      >
        <slot name="lead"></slot>
        <slot></slot>
    ...
    `},lh=new WeakSet,ah=function(){return d.qy`
      <gds-text
        color="neutral-02"
        font-weight="regular"
...
//# sourceMappingURL=5636.6a8ee02e.iframe.bundle.js.map