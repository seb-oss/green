import{i as u,r as m}from"./lit-element-C_s9q329.js";import{n as a,g as _,G as y}from"./custom-element-scoping-BEGY3AqQ.js";import{e as w}from"./class-map-Bz98xO8-.js";import{o as p}from"./if-defined-Ct9lF4W9.js";import{i as v,u as x}from"./static-_ukc2i0J.js";import{t as k}from"./tokens.style-CFvqdzpw.js";import{w as $,d as z}from"./declarative-layout-mixins-Cg5fmtre.js";const C=u`
...
`;var P=Object.defineProperty,B=Object.getOwnPropertyDescriptor,f=t=>{throw TypeError(t)},s=(t,e,r,c)=>{for(var n=c>1?void 0:c?B(e,r):e,h=t.length-1,g;h>=0;h--)(g=t[h])&&(n=(c?g(e,r,n):g(n))||n);return c&&n&&P(e,r,n),n},G=(t,e,r)=>e.has(t)||f("Cannot "+r),l=(t,e,r)=>(G(t,e,"read from private field"),r?r.call(t):e.get(t)),O=(t,e,r)=>e.has(t)?f("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),i,d,b;let o=class extends $(z(y)){constructor(){super(),O(this,i),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const t={button:!0,selected:this.selected,compact:this.compact},e=l(this,i,d)?v`a`:v`button`;return x`
      <${e}
        class="${w(t)}"
