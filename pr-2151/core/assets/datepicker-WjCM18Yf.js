import{m as u}from"./runtime-BL31MtW8.js";import{l as Gt}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Ot,E as Dt}from"./lit-element-Bx14lxc-.js";import{n as $,r as H,G as Rt,h as C,g as St}from"./custom-element-scoping-b4c89-hi.js";import{e as Bt,a as qt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as I,r as N,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as z}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-DtF9Ct8d.js";import{G as te}from"./dropdown.component-CI-IKTp2.js";import{G as ee}from"./flex.component-CPPMsy9S.js";import{f as se}from"./form-control-host.style-C4yW1JWW.js";import{t as ae}from"./tokens.style-FJSmZZcv.js";import{T as ie}from"./transitional-styles-CLkQCQV5.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as $t,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as re,b as oe,d as le}from"./declarative-layout-mixins-BgWwoHZ-.js";import{G as he,i as de}from"./calendar.component-BH8M2EJJ.js";import{I as ce,a as pe}from"./calender-add.component-CfgXJ5ZS.js";import{a as ue,I as ge}from"./chevron-right.component-PoZnyick.js";import{G as fe}from"./popover.component-Cdagx_v3.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=t=>!Jt(t)&&typeof t.then=="function",Mt=1073741823;class xe extends Ut{constructor(){super(...arguments),this._$Cwt=Mt,this._$Cbt=[],this._$CK=new be(this),this._$CX=new we}render(...e){return e.find(s=>!kt(s))??Q}update(e,s){const i=this._$Cbt;let a=i.length;this._$Cbt=s;const n=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let c=0;c<s.length&&!(c>this._$Cwt);c++){const r=s[c];if(!kt(r))return this._$Cwt=c,r;c<a&&r===i[c]||(this._$Cwt=Mt,a=0,Promise.resolve(r).then(async k=>{for(;o.get();)await o.get();const M=n.deref();if(M!==void 0){const l=M._$Cbt.indexOf(r);l>-1&&l<M._$Cwt&&(M._$Cwt=l,M.setValue(k))}}))}return Q}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const Ce=Ft(xe);var ke=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,Yt=t=>{throw TypeError(t)},E=(t,e,s,i)=>{for(var a=i>1?void 0:i?Me(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&ke(e,s,a),a},bt=(t,e,s)=>e.has(t)||Yt("Cannot "+s),y=(t,e,s)=>(bt(t,e,"read from private field"),s?s.call(t):e.get(t)),F=(t,e,s)=>e.has(t)?Yt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),Wt=(t,e,s,i)=>(bt(t,e,"write to private field"),e.set(t,s),s),w=(t,e,s)=>(bt(t,e,"access private method"),s),W,G,O,R,B,tt,et,st,_,It,A,at,L,q;let D=class extends Rt{constructor(){super(...arguments),F(this,_),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=w(this,_,at).call(this,this.value,this.length),F(this,W,""),F(this,G,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=w(this,_,L).call(this,t+1),w(this,_,A).call(this)}),F(this,O,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=w(this,_,L).call(this,t-1),w(this,_,A).call(this)}),F(this,R,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),F(this,B,()=>{w(this,_,q).call(this)}),F(this,tt,()=>{y(this,W)!==""&&(w(this,_,q).call(this),this.value=w(this,_,L).call(this,parseInt(this.value.toString())),w(this,_,A).call(this))}),F(this,et,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?y(this,O).call(this):y(this,G).call(this)}),F(this,st,t=>{let e=!1;if(t.key==="ArrowUp")y(this,G).call(this),e=!0;else if(t.key==="ArrowDown")y(this,O).call(this),e=!0;else{const s=parseInt(t.key);isNaN(s)||(y(this,W).length<this.length&&(Wt(this,W,y(this,W)+s.toString()),this.value=parseInt(y(this,W))),y(this,W).length===this.length&&(this.value=w(this,_,L).call(this,this.value),w(this,_,q).call(this),w(this,_,It).call(this),w(this,_,A).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",y(this,et)),this.addEventListener("keydown",y(this,st)),this.addEventListener("blur",y(this,tt)),this.addEventListener("focus",y(this,B)),this.addEventListener("click",y(this,R)),this.addEventListener("mousedown",y(this,R))}focus(t){super.focus(t),y(this,B).call(this)}render(){return C`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=w(this,_,at).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};W=new WeakMap;G=new WeakMap;O=new WeakMap;R=new WeakMap;B=new WeakMap;tt=new WeakMap;et=new WeakMap;st=new WeakMap;_=new WeakSet;It=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof D){t.focus();break}t=t.nextElementSibling}};A=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))};at=function(t,e){return String(t).padStart(e,"0")};L=function(t){return Math.max(this.min,Math.min(this.max,t))};q=function(){Wt(this,W,"")};D.formAssociated=!0;E([$({type:Number})],D.prototype,"value",2);E([$({type:Number})],D.prototype,"length",2);E([$({type:Number,attribute:"aria-valuemin"})],D.prototype,"min",2);E([$({type:Number,attribute:"aria-valuemax"})],D.prototype,"max",2);E([H()],D.prototype,"displayValue",2);E([_t("value")],D.prototype,"_refreshDisplayValue",1);D=E([St("gds-date-part-spinner")],D);const De=Ot`
  @layer base, reset;
