import{i as Ee,x as p}from"./lit-element-Bx14lxc-.js";import{a as Me}from"./argTableProps-D1VEmxlI.js";import{l as Le}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as C,h as a,g as ke}from"./custom-element-scoping-b4c89-hi.js";import{a as ve}from"./query-p8xgzTDt.js";import{e as _e}from"./class-map-CXsQwv0r.js";import{n as A}from"./when-BR7zwNJC.js";import{G as Ae}from"./field-base.component-u2-leZ5O.js";import{G as De,a as ze}from"./form-control-header.component-CS8g-3iX.js";import{t as Oe}from"./tokens.style-BScLRl5F.js";import{o as Ie}from"./observe-light-dom-CmJPHUQ4.js";import{w as qe}from"./watch-tFciLXSI.js";import{d as Te,w as Pe,b as $e}from"./declarative-layout-mixins-BB4ZLY5n.js";import{a as Ve}from"./button.component-Z9yRxVMZ.js";import{I as Ge}from"./chevron-bottom.component-HDbW-OqF.js";import"./flex-BWkMRSVU.js";import"./square-grid-circle-DxbcSVFt.js";import"./rocket-DTu-IYpc.js";import"./sun-BadCf25O.js";import"./brand-green-C2Hf6gyf.js";import"./custom-elements-BktGTu5n.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./transitional-styles-Dj-EwcI7.js";import"./badge.component-DR6UPN8j.js";import"./flex.component-d_gd050y.js";import"./div.component-C28DYOrM.js";import"./triangle-exclamation.component-BC2b4__3.js";import"./icon-TXeUf8MR.js";import"./card.component-BfRmn0Qs.js";import"./if-defined-CVqwUuaf.js";import"./static-B8S6DEnV.js";const Re=Ee`
...
`;var Ne=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,be=e=>{throw TypeError(e)},s=(e,t,o,d)=>{for(var r=d>1?void 0:d?Be(t,o):t,E=e.length-1,M;E>=0;E--)(M=e[E])&&(r=(d?M(t,o,r):M(r))||r);return d&&r&&Ne(t,o,r),r},_=(e,t,o)=>t.has(e)||be("Cannot "+o),S=(e,t,o)=>(_(e,t,"read from private field"),t.get(e)),L=(e,t,o)=>t.has(e)?be("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),He=(e,t,o,d)=>(_(e,t,"write to private field"),t.set(e,o),o),u=(e,t,o)=>(_(e,t,"access private method"),o),y,w,i,fe,xe,ye,Se,we,Ce;let n=class extends Ve{constructor(){super(...arguments),L(this,i),this.supportingText="",this.size="large",this.plain=!1,L(this,y,!1),L(this,w,e=>{e.stopPropagation(),u(this,i,fe).call(this),requestAnimationFrame(()=>{this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})})}get value(){return this._internalValue}set value(e){S(this,y)||He(this,y,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){var e;return((e=this.selectElement)==null?void 0:e.multiple)??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),a`
      ...
      <gds-field-base
        ...
        class=${_e(e)}
      >
        ${u(this,i,xe).call(this)}
      </gds-field-base>

      ${A(!this.plain,()=>a`<gds-form-control-footer
            class="size-${this.size}"
            .validationMessage=${this.invalid&&(this.errorMessage||this.validationMessage)}
          ></gds-form-control-footer>`)}
    `}_captureDOM(){if(!this.shadowRoot||this.childNodes.length===0||!this._elSelectContainer)return;const e=Array.from(this.children).filter(t=>t.nodeName==="SELECT").map(t=>{const o=t.cloneNode(!0);return o.addEventListener("change",S(this,w)),o.addEventListener("input",S(this,w)),o.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),o.ariaLabel=this.label,o.setAttribute("id","select"),o.disabled=this.disabled,S(this,y)?o.value=this.value:this.value=o.value,o});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};y=new WeakMap;w=new WeakMap;i=new WeakSet;fe=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(t=>t.value)}else this.value=this.selectElement.value};xe=function(){return[u(this,i,ye).call(this),u(this,i,we).call(this),u(this,i,Se).call(this),u(this,i,Ce).call(this)].map(t=>a`${t}`)};ye=function(){return a`<slot name="lead" slot="lead"></slot>`};Se=function(){if(!this.multiple)return a`<label id="placeholder">${this.displayValue}</label>`};we=function(){return a`<div class="select-container"></div>`};Ce=function(){if(!this.multiple)return a` <gds-icon-chevron-bottom></gds-icon-chevron-bottom> `};n.styles=[Oe,Re];s([C({attribute:"supporting-text"})],n.prototype,"supportingText",2);s([C({type:String})],n.prototype,"size",2);s([C({type:Boolean})],n.prototype,"plain",2);s([ve("select")],n.prototype,"selectElement",2);s([C()],n.prototype,"value",1);s([ve(".select-container")],n.prototype,"_elSelectContainer",2);s([Ie({childList:!0,subtree:!0,attributes:!0,characterData:!0})],n.prototype,"_captureDOM",1);s([qe("value")],n.prototype,"_handleValueChange",1);n=s([Le()],n);let k=class extends Te(Pe($e(n))){};k=s([ke("gds-select",{dependsOn:[De,ze,Ae,Ge]})],k);k.define();const Ct={title:"Components/Select",component:"gds-select",tags:["autodocs"],argTypes:{...Me("gds-select")},parameters:{docs:{description:{component:`\`gds-select\` is a wrapper component for the native select element.
...
Setting value or selected props on the select element will not work as expected.`}}}},l={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},c={...l,name:"Select",args:{label:"Label text",supportingText:"Supporting text",value:"",innerHTML:`
  ...
  \`
}`,...(B=(N=g.parameters)==null?void 0:N.docs)==null?void 0:B.source},description:{story:`The lead icon is displayed to the left of the select field.
<br>It can be used to provide additional context or to visually represent the select field's purpose.
<br>It is set by adding an icon component to the 'lead' slot.`,...(F=(H=g.parameters)==null?void 0:H.docs)==null?void 0:F.description}}};var W,J,j,U,Q;h.parameters={...h.parameters,docs:{...(W=h.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(me=(ce=x.parameters)==null?void 0:ce.docs)==null?void 0:me.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(he=(ge=x.parameters)==null?void 0:ge.docs)==null?void 0:he.description}}};const Et=["Default","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{c as Default,h as Disabled,g as Lead,f as Multiple,m as Option,x as SelectSize,b as Size,v as Validation,Et as __namedExportsOrder,Ct as default};
