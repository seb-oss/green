...
Ideally you'd create an [issue in github](https://github.com/sebgroup/green/issues) for the component you want or need to use, so that we could help you add it to Green.
...
<main>
  <div class="foo-bar-app">
   <button class="button-critical">Red button without border (affected)</button>
  </div>
  <div>
   <button class="button-critical">Button without styling (not affected)</button>
  </div>
</main>
```
...
<main>
  <div class="foo-bar-app">
   ...
   <button class="btn btn-primary">Primary button from bootstrap (affected)</button>
  </div>
  <div>
   <button class="button-critical">Button without styling (not affected)</button>
   <button class="btn btn-primary">Button without styling (not affected)</button>
  </div>
</main>
```
