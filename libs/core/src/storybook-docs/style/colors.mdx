                        ...
                        {Object.entries(items).map(([item, properties]) => (
                            <gds-flex flex-direction="column" gap="s">
                                  <gds-theme color-scheme="auto">
                                    <gds-card border="4xs/l2-border-primary" background="l2-background-primary" border-radius="s" padding="xs" width="20ch">
                                        <gds-flex gap="xs" align-items="center" >
                                          <gds-card 
                                              height="40px" 
                                              width="40px" 
                                              border-radius="xs" 
                                              border="4xs/l2-border-primary"
