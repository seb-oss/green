...
while the other ones extends this base with specific specilaizations.

Style expression properties allows you to write resonsive styles in a compact and declarative way. Here is an example:
...
Media queries can also be expressed as CSS units and as rangres, for example:
