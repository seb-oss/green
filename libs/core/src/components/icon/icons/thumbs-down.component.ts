...
export class IconThumbsDown extends GdsIcon {
  ...
  /** @private */
  static _solidSVG = `<path fill-rule="evenodd" clip-rule="evenodd" d="M18.0021 4.5V12.5H20.5V4.5H18.0021ZM17.5808 14H21.25C21.6642 14 22 13.6642 22 13.25V3.75C22 3.33579 21.6642 3 21.25 3H6.5856C4.73285 3 3.15843 4.35403 2.87981 6.1859L2.04328 11.6859C1.69814 13.9552 3.45375 16 5.74908 16H10.1133L9.6728 18.8264C9.41302 20.4935 10.7015 22 12.389 22H13.0043C13.2852 22 13.5425 21.8431 13.6711 21.5933L17.5808 14Z" fill="currentColor"/>`
  /** @private */
