...
/**
 * @element gds-icon-emoji-neutral
 */
@gdsCustomElement('gds-icon-emoji-neutral')
export class IconEmojiNeutral extends GdsIcon {
  /** @private */
