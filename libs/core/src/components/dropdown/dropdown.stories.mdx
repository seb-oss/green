...
<gds-story>
  <div style={{ height: '200px', dummy: registerTransitionalStyles() }}>
    <gds-dropdown onchange="document.getElementById('selected-value').innerText = event.target.value" label="Select a starship">
...
<gds-story>
  <div style={{ height: '200px' }}>
    <gds-dropdown multiple label="Pick team members" onchange="document.getElementById('selected-values').innerText = event.target.value.toString()">
