...
export class GdsGrid extends LitElement {
  #dStylesController: DynamicStylesController

  constructor() {
    super()
    this.#dStylesController = new DynamicStylesController(this)
  }
  ...
  private _updateGridCss() {
    ...
    console.log('CSSStyleSheet is supported', this.#dStylesController)

    this.#dStylesController.inject(css`some { styles }`)
    this.#dStylesController.setCSSVar('--CUSTOM', 'red')
  }
