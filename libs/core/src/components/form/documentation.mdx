...
<Meta title="Docs/Form validation/Documentation" />
...
In this case the validation message can be supplied via the `message` slot (usually, but depends on the component), for example:
...
To display a validation summary, you can use the `gds-form-summary` component. This component automatically subscribes to changes in its parent form and displays a list of validation issues.
