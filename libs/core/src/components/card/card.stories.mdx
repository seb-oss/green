...
The `gds-card` is a container component that can be used to display content in a card format. It can be used to display a variety of content types, such as text, images, and buttons. The card component is designed to be flexible and customizable, complementary to the `gds-grid` component.
