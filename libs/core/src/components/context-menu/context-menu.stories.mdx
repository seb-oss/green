...
You can hide the label by setting the `hide-label` attribute on the `<gds-context-menu>` element. You should still provide a `button-label` so the button remains accessibible.

<Canvas>
  <div style={{ height: '200px', dummy: registerTransitionalStyles() }}>
    <gds-context-menu
      popover-label="Select an action"
      button-label="Menu"
      hide-label
    >
...
| --------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `popover-label` | String    | The label for the context menu.                                                                                                                                            |
| `button-label`  | String    | The label for the trigger button.                                                                                                                                          |
| `hide-label`    | Boolean   | Hides the popover label.                                                                                                                                                   |
