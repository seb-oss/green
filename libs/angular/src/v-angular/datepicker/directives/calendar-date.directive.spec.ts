...
@Component({
  selector: 'ngv-directive-host', // eslint-disable-line @angular-eslint/component-selector
  template: /*html*/ `<button [calendarDate]="date" [disabled]="disable"></button>`,
})
...
describe('[NgvDatepicker]', () => {
  ...
  describe('CalendarDateDirective - constructor()', () => {
    ...
    it(`adds class '.today' to host element`, () => {
      ...
      const buttonElementWithClass = fixture.debugElement.query(By.css(`.${DateCss.today}`));
    ...
    it(`adds class '.not-within-month' to host element`, () => {
      ...
      const buttonElementWithClass = fixture.debugElement.query(By.css(`.${DateCss.notWithinMonth}`));
      expect(buttonElementWithClass).toBeTruthy();
    });
    ...
    it(`adds class '.selected' to host element`, () => {
      ...
      const buttonElementWithClass = fixture.debugElement.query(By.css(`.${DateCss.selected}`));
      expect(buttonElementWithClass).toBeTruthy();
    });
    ...
    it('disables host element', () => {
      ...
      const disabledButtonElement = fixture.debugElement.query(By.css('button[disabled]'));
