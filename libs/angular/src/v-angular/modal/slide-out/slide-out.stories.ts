...
const Template: StoryFn<NgvSlideOutComponent & WithExtras> = (args: any) => ({
  template: /* html */ `
  <ngg-slideout-modal #slideOut [initiallyShown]="initiallyShown" [closable]="closable" [content]="content" [title]="title" [buttons]="buttons" [side]="side" [autoWidth]="autoWidth" (ngvCloseEvent)="action($event)">
