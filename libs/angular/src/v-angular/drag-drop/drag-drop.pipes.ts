...
export class ValuePipe implements PipeTransform {
  ...
  transform<V>(input: { [key: string]: V } | Map<string, V> | null): Array<V> | null;
  transform<K, V>(input: Map<K, V>): Array<V>;
  transform<K, V>(input: Map<K, V> | null): Array<V> | null;
  transform<K, V>(input: null | { [key: string]: V; [key: number]: V } | Map<K, V>): Array<V> | null {
...
export class ValueImpurePipe implements PipeTransform {
  ...
  transform<K, V>(input: null | { [key: string]: V; [key: number]: V } | Map<K, V>): Array<V> | null {
    ...
    if (differChanges) {
      this.values = [];
      differChanges.forEachItem(({ currentValue }: KeyValueChangeRecord<K, V>) => {
