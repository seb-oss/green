...
@NgModule({
  declarations: [NgvTypeaheadHighlightComponent, NgvTypeaheadInputComponent, NgvTypeaheadDropdownListComponent],
  imports: [CommonModule, NgvTooltipModule],
  exports: [NgvTypeaheadHighlightComponent, NgvTypeaheadInputComponent, NgvTypeaheadDropdownListComponent]
})
