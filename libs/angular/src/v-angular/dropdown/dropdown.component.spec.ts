...
describe('[NgvCore]', () => {
  ...
  describe('DropdownComponent - constructor()', () => {
    ...
    beforeEach(
      waitForAsync(() => {
        TestBed.configureTestingModule({
          declarations: [DropdownComponent, DropdownListStubComponent],
          providers: [{ provide: NgControl, useValue: { control: new FormControl() } }, {provide: DropdownListComponent, useValue: DropdownListStubComponent}, DropdownUtils],
          imports: [CommonModule, FontAwesomeModule, FormsModule, ReactiveFormsModule, NgvI18nTestModule],
        }).compileComponents();

        fixture = TestBed.createComponent<DropdownComponent>(DropdownComponent);
    ...
    describe('set options', () => {
      const dummyoptions: Option<string | null, string>[] = [{ key: 'dummy', label: 'dummy' }];
      ...
      `('(with or without default option)', ({ description, required, options, expectedLength }) => {
        it(description, () => {
