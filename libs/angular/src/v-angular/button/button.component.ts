import { ChangeDetectorRef, Component, EventEmitter, HostBinding, Inject, InjectionToken, Input, OnChanges, OnInit, Optional, Output, Self, SimpleChanges } from '@angular/core';
...
export class ButtonComponent extends BaseControlValueAccessorComponent implements OnInit, OnChanges {
  ...
  ngOnInit() {
    ...
    this.buttonClasses = ButtonComponent.buttonStyleClasses(this.buttonStyle, this.small);
  }
