...
const columns: TableColumn<MockData>[] = [
  ...
  { property: 'balance', label: 'balance', valueType: 'numeric', sortable: true },
  { property: 'status', label: 'status', valueType: 'numeric', sortable: true },
  { property: 'date', label: 'date', valueType: 'numeric', sortable: true },
];

const data: MockData[] = [
  { id: '0', name: 'Capitalized CPH ODFlex 160209', ccy: 'DKK', status: 'Booked', balance: 80000, date: '2021-03-15' },
  { id: '1', name: 'Capitalized CPH ODFlex 160209', ccy: 'GBP', status: 'Waiting', balance: 5000, date: '2021-03-15' },
  { id: '2', name: 'Capitalized CPH ODFlex 160209', ccy: 'USD', status: 'Declined', balance: 40000, date: '2021-03-15' },
];
...
describe('[NgvTable]', () => {
  ...
  describe('TableComponent - constructor()', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent<TableComponent<MockData>>(TableComponent);
