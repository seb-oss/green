...
export const columns: { primary: TableColumn<ColumnData>[]; alt: TableColumn<ColumnData>[] } = {
  primary: [
    { property: 'name', label: 'header.name', sortable: true },
    { property: 'currency', label: 'header.currency', sortable: true },
    ...
    { property: 'unauthorizedUsage', label: 'header.unauthorizedusage', valueType: 'numeric', order: 'desc', sortable: true },
  ],
  alt: [
