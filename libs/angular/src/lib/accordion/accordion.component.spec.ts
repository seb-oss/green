...
describe(NggAccordionComponent.name, ()=>{
    ...
    it('should call expand all when closeOthers is false', async ()=>{
        ...
        const listItem1 = accordionListItems.find(i=> (i.componentInstance as NggAccordionListItemComponent).listItemHeader === '1')?.componentInstance as NggAccordionListItemComponent;
        const listItem2 = accordionListItems.find(i=> (i.componentInstance as NggAccordionListItemComponent).listItemHeader === '2')?.componentInstance as NggAccordionListItemComponent;
