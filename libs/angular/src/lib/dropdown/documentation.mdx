...
To be able to search in custom properties, you should provide an array of property names to search into "searchableProperties".

```typescript
  const searchableProperties = ['kitchen', 'customProperty2']
```
