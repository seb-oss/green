...
describe('Pagination', () => {
  ...
  describe('actions:', () => {
    it('next', async () => {
      ...
      expect(screen.getByRole('button', { current: 'page' })?.textContent?.trim()).toBe('2')
    })
    ...
    it('last', async () => {
      ...
      expect(screen.getByRole('button', { current: 'page' })?.textContent?.trim()).toBe('10')
    })
    ...
    it('previous', async () => {
      ...
      expect(screen.getByRole('button', { current: 'page' })?.textContent?.trim()).toBe('9')
    })
    ...
    it('first', async () => {
      ...
      expect(screen.getByRole('button', { current: 'page' })?.textContent?.trim()).toBe('1')
    })
    ...
    it('page 5', async () => {
      ...
      expect(screen.getByRole('button', { current: 'page' })?.textContent?.trim()).toBe('5')
    })
  })
})
