...
The `NggCellTableComponent` is primarily used as a mobile alternative to regular tables. All, or prioritized columns, are grouped into one cell that may be spread on multiple lines to summarize the columns of the table.
