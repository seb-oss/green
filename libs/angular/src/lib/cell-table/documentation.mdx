...
The `NggCellTableComponent` is a flexible and feature-rich Angular component designed for displaying tabular data in a stacked format. This component is highly customizable and can be used for various applications such as data dashboards, reports, and more.

## Usage

Use the `NggCellTableComponent` on pages where you need to display tabular data in a stacked format.
...
import { NggCellTableModule } from '@sebgroup/angular-green' // Replace with your actual module path
