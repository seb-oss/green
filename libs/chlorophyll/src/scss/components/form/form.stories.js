  ...
  render: (args) => `
   <form class="mw-xs">
      <div class="gds-form-group">
        <label class="gds-label" for="inputValid">Input group label</label>
      ...
      <div class="gds-form-group">
        ...
        <div class="gds-group">
          <input id="inputValid1" class="gds-input" type="text" required aria-disabled="true" placeholder="Placeholder" />

          <input id="inputValid2" class="gds-input disabled" type="text" required />
      ...
      <div class="gds-form-group">
        ...
        <div class="gds-group group-border disabled">
          <input id="inputValid1" class="gds-input" type="text" required disabled />

          <input id="inputValid2" class="gds-input" type="text" required aria-disabled="true" />
...
export const SizeLarge = {
  ...
  <div class="gds-form-group">
    <label for="smInput" class="gds-label">Input label</label>
    <input type="text" id="smInput" class="gds-input large" placeholder="Small input" />
  </div>
  <button class="gds-button large">Small</button>
