...
We recommend adding just the parts from Bootstrap that you need, you can read more about it in the [@sebgroup/bootstrap wiki](https://github.com/seb-oss/bootstrap/wiki/Don't-want-to-load-all-of-bootstrap%3F).
