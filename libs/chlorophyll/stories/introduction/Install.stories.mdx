...
When installing with a package manager, check your configs for proxies. HTTP_PROXY or HTTPS_PROXY in your npm, yarn or git config can cause the packages not to be found
```
/* yarn */
yarn config list
