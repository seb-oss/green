...
<div role="alert" class="info mb-7 mt-5">
  <main>
    ...
    <p>
      Please note that the examples below just represent the html markup and some features like sorting won't work without JavaScript.
    </p>
  </main>
</div>
...
<Canvas>
  <div class="overflow-auto">
    <table class="table text-nowrap">
      <caption>
        Sortable table example with un-styled caption
      </caption>
      <thead>
        <tr>
          <th scope="col">
...
<Canvas>
  <table class="table-mobile table">
    ...
    <tr>
      ...
      <td class="py-sm-0 align-middle"><button type="button" class="size-sm">Action</button></td>
    </tr>
    <tr>
