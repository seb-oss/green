...
<Story
    ...
    args={{
      type: '',
      heading: 'Heading!',
      content: 'Alert content placed inside a paragraph. Inline <a href="#">links</a> will inherit color from alert to make sure contrast is okay.',
      link: 'Another inline link',
      button: false,
      primaryButton: '',
      closeButton: true
    }}
