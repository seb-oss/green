...
<div>
  ...
  <button aria-role="switch" aria-checked="${checked}" aria-labelledby="slide-toggle-label-1"></button>
</div>
`
...
<div>
  <div class="mb-5">
    ...
    <button aria-role="switch" aria-checked="false" onClick={toggle} aria-labelledby="slide-toggle-label-1"></button>
  </div>
  <div class="mb-5">
    <button class="ms-0" aria-role="switch" aria-checked="false" onClick={toggle} aria-labelledby="slide-toggle-label-1"></button>
  ...
  <div>
    ...
    <button aria-role="switch" aria-checked="false" onClick={toggle} aria-label="Inline toggle"></button>
    like this.
  </div>
</div>
</Canvas>
...
<div class="form-group">
    ...
    <button class="ms-0" aria-role="switch" aria-checked="false" onClick={toggle} aria-labelledby="cookies-label-1"></button>
    <span class="form-info">Hint or error</span>
</div>
</Canvas>

## Accessibility

The slide toggle in Chlorophyll is represented by a button element with `aria-role="switch"` and an `aria-checked` state.
This will prompt most screen readers to announce it as switch and its state as "on" or "off", which should give visually
...
immidiate effect. Checkboxes can also use `aria-role="switch"` to denote them as switches rather than checkboxes, but browser
...
```html
<span id="cookies-label-1">Enable cookies</span>
<button aria-role="switch" aria-checked="false" onClick={toggle} aria-labelledby="cookies-label-1"></button>
```
...
```html
<button aria-role="switch" aria-checked="false" onClick={toggle} aria-label="Enable cookies"></button>
```
