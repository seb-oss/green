...
<div role="alert" class="info mb-7 mt-5">
  ...
  <footer>
    <a target="_blank" href="./../angular/?path=/docs/components-accordion">View Angular component</a>
    <a target="_blank" href="./../react/?path=/docs/components-accordion">View React component</a>
  </footer>
</div>
