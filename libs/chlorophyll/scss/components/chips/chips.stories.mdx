...
<button class="gds-chips" onClick="{handleChipSelection}">Selected</button>
<button class="gds-chips" onClick="{handleChipRemoval}">Removable</button>
```
...
<Canvas>
  <button class="gds-chips" onClick={handleChipRemoval}>
    Label
  </button>
  <button
...
<Canvas>
  ...
  <button class="gds-chips" onClick={handleChipSelection}>
    I am removable
  </button>
  <button class="gds-chips" onClick={handleChipRemoval}>
    I am selectable
...
<Canvas>
  <button class="gds-chips" dir="rtl" onClick={handleChipSelection}>
    Label
  </button>
  <button
    class="gds-chips gds-chips__action gds-chips__action-selected"
...
<script>addClassOnClick("gds-chips", "new-class");</script>
