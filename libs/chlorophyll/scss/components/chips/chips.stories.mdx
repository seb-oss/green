...
```html
<button class="gds-chips gds-ripple">Label</button>
<button class="gds-chips gds-ripple" onClick="{handleChipSelection}">
  Selected
</button>
<button class="gds-chips gds-ripple" onClick="{handleChipRemoval}">
  Removable
</button>
```
...
<Canvas>
  ...
  <button
    class="gds-chips gds-ripple gds-chips__action gds-chips__action-selected"
    onClick={handleChipSelection}
  >
    Selected
  </button>
  <button
    class="gds-chips gds-ripple gds-chips__action gds-chips__action-remove"
...
<Canvas>
  <button class="gds-chips gds-ripple" dir="rtl" onClick={handleChipSelection}>
    Label
  </button>
  <button
    class="gds-chips gds-ripple gds-chips__action gds-chips__action-selected"
