  ...
  <div>
    <div role="alert">
      ...
      <div>
        ...
        <p>
          ...
          ends the message, stand alone or part of the <a href="#"> info sentence.</a>
        </p>
      </div>
      <button class="close">
    ...
    <div role="alert" class="success">
      ...
      <div class="alert-ribbon__content">
        ...
        <p>
          Body text starts on the same row as heading. A link (optional) always
          ends the message, stand alone or part of the <a href="#">success sentence.</a>
        </p>
      </div>
    ...
    <div role="alert" class="warning">
      ...
      <div>
        ...
        <p>
          Body text starts on the same row as heading. A link (optional) always
          ends the message, stand alone or part of the <a href="#">warning sentence.</a>
        </p>
      </div>
      <footer>
    ...
    <div role="alert" class="danger">
      ...
      <div>
        <h3>Danger heading.</h3>
        <p>
          Body text starts on the same row as heading. A link (optional) always
          ends the message, stand alone or part of the <a href="#">danger sentence.</a>
        </p>
      </div>
      <footer>
