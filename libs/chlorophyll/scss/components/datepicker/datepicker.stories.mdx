...
<div role="alert" class="info mb-7 mt-5">
  ...
  <footer>
    <a target="_blank" href="./../angular/?path=/docs/components-datepicker">
      View Angular component
    </a>
    <a target="_blank" href="./../react/?path=/docs/components-datepicker">
...
<Canvas>
  <div>
    ...
    <div
      class="popover popover-datepicker active"
      role="dialog"
      aria-modal="true"
          ...
          <table role="grid">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td tabindex="-1" data-date="2020-02-14">
                  14
                </td>
          ...
          <table role="grid">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="disabled" tabindex="-1" data-date="2020-02-12">
                  12
                </td>
                <td tabindex="-1" data-date="2020-02-13">
                  13
          ...
          <table role="grid">
            ...
            <tbody>
              <tr>
                ...
                <td
                  class="sg-date-holiday disabled"
                  tabindex="-1"
                  data-date="2020-02-01"
                >
                  1
              ...
              <tr>
                ...
                <td class="disabled" tabindex="-1" data-date="2020-02-07">
                  7
                </td>
                <td
                  class="sg-date-holiday disabled"
              ...
              <tr>
                ...
                <td class="disabled" tabindex="-1" data-date="2020-02-14">
                  14
                </td>
                <td
                  class="sg-date-holiday disabled"
              ...
              <tr>
                ...
                <td class="disabled" tabindex="-1" data-date="2020-02-21">
                  21
                </td>
                <td
                  class="sg-date-holiday disabled"
              ...
              <tr>
                ...
                <td class="disabled" tabindex="-1" data-date="2020-02-28">
                  28
                </td>
                <td
                  class="sg-date-holiday disabled"
              ...
              <tr>
                ...
                <td class="sg-date-holiday disabled" tabindex="-1">
                  5
                </td>
              </tr>
            </tbody>
...
<Canvas>
  <div>
    <div class="group group-border  mb-3">
      ...
      <input type="text" placeholder="yyyy-mm-dd" />
      <button type="button" class="primary">
        <i class="sg-icon sg-icon-calendar-range">Select date range</i>
      </button>
    </div>
    <div
      class="popover popover-datepicker active"
      ...
      <div class="sg-date sg-date-range">
        ...
        <main>
          <table role="grid">
            ...
            <tbody>
              <tr>
                <td class="disabled sg-other-month" tabindex="-1">
                  26
                </td>
                <td class="disabled sg-other-month" tabindex="-1">
                  27
