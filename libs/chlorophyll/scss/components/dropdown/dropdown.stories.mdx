...
export const Template = ({ validation, enabled, text }) => {
  ...
  return `
    <div class="form-group" style="height: 300px; display: block;">
      ...
      <ul role="listbox" class="popover" style="visibility:visible;opacity:1;margin-top:4px;" aria-activedescendant="option_2" tabIndex="-1">
