...
<div role="alert" class="info">
  <main>
    ...
    <p>
      Please note that the example below is just a representation of the html
      markup and it won't work without JavaScript. We'll add links to the
      JavaScript implementations for Angular once they've been added.
    </p>
  </main>

  <footer>
    <a target="_blank" href="./../react/?path=/docs/components-tabs">
...
<Canvas>
  <div>
    ...
    <section aria-live="polite">
      <article id="tab-content-1" role="tabpanel" aria-hidden="false">
        <p class="pt-5">
          Content for tab 1, note that padding needs to be added to content, in
          this case we've used <code>pt-5</code> padding top with spacing unit
          5\.
        </p>
      </article>
