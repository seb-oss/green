...
<div role="alert" class="info">
  <main>
    ...
    <p>
      Please note that the example below is just a representation of the html markup and it won't work
      without JavaScript. We'll add links to the JavaScript implementations for Angular once they've been added.
    </p>
  </main>
  <footer>
    <a target="_blank" href="./../react/?path=/docs/components-tabs">View React component</a>
  </footer>
</div>
