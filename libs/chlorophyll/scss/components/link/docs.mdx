...
<div>
  ...
  <br />
  <button type="submit" class="link">Button as a submit link</button>
  <br />
  <button type="button" class="link">Button as a button link</button>
  <br />
  <button type="reset" class="link">Button as a reset link</button>
  <br />
</div>
