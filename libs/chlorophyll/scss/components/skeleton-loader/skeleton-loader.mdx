...
<Canvas>
  <div class="d-flex align-items-center">
    ...
    <div class="ms-5">
      <div class="skeleton-loader skeleton-loader-fill mb-3 rounded" aria-busy="true" style={{ height: '1.125rem', width: '100px' }} />

      <div class="skeleton-loader skeleton-loader-fill mb-3 rounded" aria-busy="true" style={{ height: '1.75rem', width: '160px' }} />

      <div class="skeleton-loader skeleton-loader-fill mb-3 rounded" aria-busy="true" style={{ height: '2.75rem', width: '200px' }}>
        Loading form
      </div>

      <div class="skeleton-loader skeleton-loader-fill mb-4 rounded" aria-busy="true" style={{ height: '1rem', width: '80px' }} />
    </div>

    <div class="ms-5">
      <div class="skeleton-loader skeleton-loader-fill mb-3 rounded-circle" aria-busy="true" style={{ height: '100px', width: '100px' }}>
        Loading circle
      </div>
    </div>
  </div>
