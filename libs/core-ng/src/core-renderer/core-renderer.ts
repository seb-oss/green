...
@Injectable()
export class GdsCoreRendererFactory implements RendererFactory2 {
  ...
  createRenderer(element: any, type: RendererType2 | null): Renderer2 {
    ...
    return new GdsCoreRenderer(renderer, this.scopeResolver)
  }
}
...
export function animationsCoreRendererFactory(
  ...
  const crf = new GdsCoreRendererFactory(delegate)
...
export const provideCoreRenderer = (resolver = getScopedTagName) => [
  {
    ...
    useClass: GdsCoreRendererFactory,
  },
  {
