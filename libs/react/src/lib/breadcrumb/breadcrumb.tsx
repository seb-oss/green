...
export const Breadcrumb: React.FC<PropsWithChildren<BreadcrumbProps>> = ({ children, className }) => {
  return (
    <ul className={classNames('breadcrumb', className)}>
      {React.Children.map(children as ReactElement, (Child: ReactElement, childIndex: number) => {
        return (
