...
[Source code](https://github.com/sebgroup/green/tree/main/libs/react/src/lib/context-menu)
&nbsp;|&nbsp;
[Usage guidelines](https://designlibrary.sebgroup.com/components/component-moremenu)

## Overview

The context menu is a clickable button that opens a menu where you can find the action connected to an area or item. This component is a wrapper and uses the [Green Core Context Menu](https://github.com/sebgroup/green/tree/main/libs/core/src/components/context-menu) component under the hood.
...
```jsx
import { ContextMenu } from '@sebgroup/green-react'
```
...
You can hide the label by setting the `hideLabel` prop to `true`.
...
| hideLabel       | `boolean`                      | Control if the label should be visually shown                                |
