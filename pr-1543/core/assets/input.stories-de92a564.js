...
Input fields allow users to enter text into a UI. They typically appear in forms and dialogs.`}}},tags:["autodocs"]},i={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label text",multiline:!1}},t={...i,name:"All",render:()=>a`
  ...
  `};var l,d,s;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'All',
  render: () => html\`
    <gds-flex flex-direction="column" gap="2xl">
  ...
  \`
}`,...(s=(d=t.parameters)==null?void 0:d.docs)==null?void 0:s.source}}};const U=["All"];export{t as All,U as __namedExportsOrder,P as default};
