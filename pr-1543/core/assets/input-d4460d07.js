...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};E=new WeakSet;U=function(){return n`
    ...
    `};_=new WeakSet;F=function(){return this.clearable&&this.value.length>0?n`
      ...
      `:g};w=new WeakSet;D=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};S=new WeakSet;G=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="negative":e<20?t="warning":t="positive",n`<gds-badge variant="${t}">${e}</gds-badge>`};k=new WeakSet;P=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?n`
          <gds-button
            size="small"
            rank="tertiary"
