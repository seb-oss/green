...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};f=new WeakSet;R=function(){return l`
    ...
    `};W=new WeakSet;q=function(){return this.clearable&&this.value.length>0?l`
      ...
      `:g};A=new WeakSet;j=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};N=new WeakSet;U=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="negative":e<20?t="warning":t="positive",l`<gds-badge variant="${t}">${e}</gds-badge>`};O=new WeakSet;V=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?l`
        ...
        `:g)};i.styles=[ae,re];a([d()],i.prototype,"value",2);a([d()],i.prototype,"label",2);a([d({attribute:"supporting-text"})],i.prototype,"supportingText",2);a([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],i.prototype,"showExtendedSupportingText",2);a([d({attribute:"disabled",type:Boolean,reflect:!0})],i.prototype,"disabled",2);a([d({type:Boolean})],i.prototype,"clearable",2);a([d({type:Number})],i.prototype,"maxlength",2);a([d({type:String})],i.prototype,"variant",2);a([d({type:String})],i.prototype,"size",2);a([B("input")],i.prototype,"elInputAsync",2);a([Q("input")],i.prototype,"elInput",2);a([B('slot[name="extended-supporting-text"]')],i.prototype,"elExtendedSupportingTextSlot",2);a([J()],i.prototype,"trailSlotOccupied",2);a([se("value")],i.prototype,"_setAutoHeight",1);i=a([K("gds-input")],i);
