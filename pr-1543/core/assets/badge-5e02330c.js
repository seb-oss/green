...
`;var u=Object.defineProperty,b=Object.getOwnPropertyDescriptor,i=(s,e,t,a)=>{for(var r=a>1?void 0:a?b(e,t):e,l=s.length-1,n;l>=0;l--)(n=s[l])&&(r=(a?n(e,t,r):n(r))||r);return a&&r&&u(e,t,r),r};let o=class extends p{constructor(){super(...arguments),this.level="l3",this.variant="information"}generateColorStyles(s,e){const t=`background-color: var(--gds-color-${s}-background-${e}-badge);`,a=`color: var(--gds-color-${s}-content-${e});`;return`${t} ${a}`}render(){return c`<div class="badge">
      <slot name="lead"></slot>
      <slot></slot>
