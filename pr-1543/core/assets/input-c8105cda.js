import{i as K,h as Q,D as c}from"./lit-element-1d72f0ce.js";import{n as d,r as Y,g as Z,h as r}from"./gds-element-86064462.js";import{a as ee}from"./query-b9d3c2af.js";import{r as I}from"./query-async-1ff18261.js";import{b as te}from"./until-27bb1490.js";import{n as u}from"./when-748fcf30.js";import{m as M}from"./runtime-c06dc943.js";import{c as ie}from"./constrain-slots-08d8606c.js";import{w as se}from"./watch-c4961afe.js";import{a as ne,f as R}from"./button-f13a8f91.js";import"./flex-e0066de6.js";import{t as ae}from"./tokens.style-d0c8c448.js";import"./cross-small-7e719cb3.js";import"./triangle-exclamation-da39395f.js";import"./container-a3cd0825.js";import"./card-6335216c.js";import"./text-fff8e4d1.js";/**
 * @license
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};b=new WeakSet;F=function(){return r`
      ...
      >
        ...
        >
          ...
          ${te(o(this,O,J).call(this),c)}
        </gds-flex>

        ${u(this.showExtendedSupportingText,()=>o(this,C,X).call(this))}
        ...
        >
          ...
          ${u(this.textarea,()=>r`${o(this,E,H).call(this)}`,()=>r`${o(this,T,L).call(this)}`)}
    ...
    `};y=new WeakSet;D=function(){return c};g=new WeakMap;x=new WeakMap;f=new WeakMap;_=new WeakMap;w=new WeakMap;$=new WeakMap;S=new WeakSet;G=function(){return r` <slot name="lead"></slot> `};k=new WeakSet;P=function(){return r` <slot name="trail" gds-allow="gds-badge"></slot> `};T=new WeakSet;L=function(){return r`
      <input
        @input=${l(this,x)}
        @change=${l(this,f)}
        ...
        ${R(l(this,g))}
      />
    `};E=new WeakSet;H=function(){return r`
      <textarea
        @input=${l(this,x)}
        @change=${l(this,f)}
        .value=${this.value}
    ...
    `};W=new WeakSet;j=function(){return this.clearable&&this.value.length>0?r`
      ...
      `:c};A=new WeakSet;U=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};B=new WeakSet;V=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="negative":e<20?t="warning":t="positive",r`<gds-badge variant="${t}">${e}</gds-badge>`};O=new WeakSet;J=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?r`
          <gds-button
            size="small"
            rank="tertiary"
        ...
        `:c)};i.shadowRootOptions={...Q.shadowRootOptions,delegatesFocus:!0};i.styles=[ae,oe];a([d()],i.prototype,"value",2);a([d()],i.prototype,"label",2);a([d({attribute:"supporting-text"})],i.prototype,"supportingText",2);a([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],i.prototype,"showExtendedSupportingText",2);a([d({attribute:"disabled",type:Boolean,reflect:!0})],i.prototype,"disabled",2);a([d({type:Boolean})],i.prototype,"clearable",2);a([d({type:Number})],i.prototype,"maxlength",2);a([d({type:String})],i.prototype,"variant",2);a([d({type:String})],i.prototype,"size",2);a([d({type:Boolean})],i.prototype,"textarea",2);a([I("input, textarea")],i.prototype,"elInputAsync",2);a([ee("input, textarea")],i.prototype,"elInput",2);a([I('slot[name="extended-supporting-text"]')],i.prototype,"elExtendedSupportingTextSlot",2);a([Y()],i.prototype,"leadSlotOccupied",2);a([se("value")],i.prototype,"_setAutoHeight",1);i=a([Z("gds-input")],i);
