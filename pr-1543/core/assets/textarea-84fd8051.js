import{n as d,r as G,g as re,h as o}from"./gds-element-86064462.js";import{a as oe}from"./query-b9d3c2af.js";import{r as q}from"./query-async-1ff18261.js";import{b as le}from"./until-27bb1490.js";import{i as de,D as c}from"./lit-element-1d72f0ce.js";import{n as g}from"./when-748fcf30.js";import{r as he}from"./choose-473fcf2d.js";import{m as I}from"./runtime-c06dc943.js";import{c as pe}from"./constrain-slots-08d8606c.js";import{w as ce}from"./watch-c4961afe.js";import{a as ge,f as ue}from"./button-7f889fcf.js";import"./flex-bcd919b1.js";import{t as xe}from"./tokens.style-01187a75.js";import{s as fe}from"./style-expression-property-26695edd.js";import"./cross-small-7e719cb3.js";import"./triangle-exclamation-da39395f.js";import"./container-89e950a3.js";import"./card-dcd6ce07.js";import"./text-283a1198.js";import"./badge-f5495a3d.js";const me=de`
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};y=new WeakSet;j=function(){return o`
      ...
      >
        ...
        >
          <gds-flex flex-direction="column">
            ...
            ${g(this.supportingText,()=>n(this,L,ee).call(this))}
          </gds-flex>
          ${le(n(this,F,ae).call(this),c)}
        </gds-flex>
    ...
    `};u=new WeakSet;w=function(){const e=this.querySelector(".resize-handle");e&&e.addEventListener("mousedown",n(this,x,M).bind(this))};x=new WeakSet;M=function(e){e.preventDefault(),this.isDragging=!0,this.lastMouseY=e.clientY,document.addEventListener("mousemove",n(this,f,A).bind(this)),document.addEventListener("mouseup",n(this,m,S).bind(this))};f=new WeakSet;A=function(e){if(!this.isDragging)return;const t=e.clientY-this.lastMouseY;Math.abs(t)>=20&&(t>0?this.lines+=1:this.lines=Math.max(1,this.lines-1),this.elTextareaAsync.then(s=>{s==null||s.style.setProperty("--_lines",this.lines.toString())}),this.lastMouseY=e.clientY)};m=new WeakSet;S=function(){this.isDragging=!1,document.removeEventListener("mousemove",n(this,f,A).bind(this)),document.removeEventListener("mouseup",n(this,m,S).bind(this))};N=new WeakSet;K=function(){return o`
      ...
      ></gds-container>
    `};O=new WeakSet;Q=function(e){const s=e.target.assignedNodes({flatten:!0});this.trailSlotOccupied=s.length>0&&s.some(h=>{var l;return h.nodeType===Node.ELEMENT_NODE||h.nodeType===Node.TEXT_NODE&&((l=h.textContent)==null?void 0:l.trim())!==""})};R=new WeakSet;Z=function(){return o`
      <textarea
        @input=${p(this,$)}
        @change=${p(this,T)}
        .value=${this.value}
    ...
    `};H=new WeakSet;ie=function(){return this.clearable&&this.value.length>0?o`
      ...
      `:c};Y=new WeakSet;se=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};P=new WeakSet;ne=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="negative":e<20?t="warning":t="positive",o`<gds-badge variant="${t}">${e}</gds-badge>`};F=new WeakSet;ae=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?o`
        ...
        `:c)};a.styles=[xe,me];r([d()],a.prototype,"value",2);r([d()],a.prototype,"label",2);r([fe({valueTemplate:e=>e,selector:"textarea",styleTemplate:(e,t)=>`min-height: calc(1lh * ${t[0]});`})],a.prototype,"rows",2);r([G()],a.prototype,"lines",2);r([d({attribute:"supporting-text"})],a.prototype,"supportingText",2);r([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],a.prototype,"showExtendedSupportingText",2);r([d({attribute:"disabled",type:Boolean,reflect:!0})],a.prototype,"disabled",2);r([d({type:Boolean})],a.prototype,"clearable",2);r([d()],a.prototype,"resize",2);r([d({type:Number})],a.prototype,"maxlength",2);r([d({type:String})],a.prototype,"variant",2);r([q("textarea")],a.prototype,"elTextareaAsync",2);r([oe("textarea")],a.prototype,"elTextarea",2);r([q('slot[name="extended-supporting-text"]')],a.prototype,"elExtendedSupportingTextSlot",2);r([G()],a.prototype,"trailSlotOccupied",2);r([ce("value")],a.prototype,"_setAutoHeight",1);a=r([re("gds-textarea")],a);
