import{k as e}from"./lit-element-1d72f0ce.js";import"./card-c378c72d.js";import"./img-21fa1bca.js";import"./video-0e9cbd8d.js";import"./container-5f07f629.js";import"./mask-be5cee4a.js";import"./flex-c7160efd.js";import"./text-751dfda7.js";import"./divider-2629f9bb.js";import"./arrow-right-53f3213e.js";import"./circles-three-8108223d.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-34611a2c.js";import"./style-expression-property-0e3d4d40.js";import"./watch-c4961afe.js";import"./query-b9d3c2af.js";import"./static-c0094392.js";import"./icon-a640baec.js";import"./directive-dd518ee3.js";const re={title:"Docs/Layout/Card",component:"gds-card",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-card` is a custom element that provides a flexible card system.\n\nIt can be used to create a card with different styles and configurations.\n\nThe card can be customized with different properties like `shadow`, `border`, `radius`, and `background`.\nIt is designed to be used in different scenarios like displaying content, images, or other elements.\nIt can be used in combination with other elements like `gds-grid`, `gds-container`, `gds-img`, `gds-text` etc.\n\n@status beta\n\n@extends `gds-container`"}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{disable:!0}}},n={...s,render:d=>e`
  ...
  `},t={...s,name:"Border Style",render:d=>e` <gds-grid columns="5" gap="l">
    ...
    </gds-grid>`},o={...s,name:"Shadow",render:d=>e`<gds-grid columns="5" gap="l">
      <gds-card
        padding="s{xs} m{l} l{l}"
    ...
    </gds-grid>`},a={...s,name:"Background",render:d=>e`<gds-grid columns="4" gap="l">
    ...
    </gds-grid>`},i={...s,name:"Using with Grid",render:d=>e` <gds-grid columns="4" gap="l">
      <gds-container>
