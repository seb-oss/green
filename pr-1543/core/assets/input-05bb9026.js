...
`).length||1).toString();t==null||t.style.setProperty("--_lines",e.toString())})}};W=new WeakSet;j=function(){return a`
      ...
      >
        ...
        <gds-flex class="foot">
          ...
          ${u(l(this,S,z),()=>s(this,k,G).call(this))}
        </gds-flex>
      </gds-flex>
    ...
    `};$=new WeakSet;O=function(){return this.clearable&&this.value.length>0?a`
      ...
      `:B};S=new WeakSet;z=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};k=new WeakSet;G=function(){const t=this.maxlength-this.value.length;let e;return t<0?e="error":t<20?e="warning":e="success",a`<gds-badge variant="${e}">${t}</gds-badge>`};E=new WeakSet;D=async function(){return this.elExtendedSupportingTextSlot.then(t=>a`
        <gds-button
          size="small"
          rank="tertiary"
