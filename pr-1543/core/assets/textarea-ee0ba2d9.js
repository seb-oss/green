...
`;var oe=Object.defineProperty,le=Object.getOwnPropertyDescriptor,s=(e,t,r,p)=>{for(var d=p>1?void 0:p?le(t,r):t,g=e.length-1,u;g>=0;g--)(u=e[g])&&(d=(p?u(t,r,d):u(d))||d);return p&&d&&oe(t,r,d),d},R=(e,t,r)=>{if(!t.has(e))throw TypeError("Cannot "+r)},h=(e,t,r)=>(R(e,t,"read from private field"),r?r.call(e):t.get(e)),i=(e,t,r)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,r)},o=(e,t,r)=>(R(e,t,"access private method"),r),f,I,m,N,v,b,y,_,w,S,k,F,$,P,D,T,G,E,L,C,H,W,q,z,X,A,j,B,U;let n=class extends ie{constructor(){super(),i(this,f),i(this,m),i(this,k),i(this,$),i(this,D),i(this,T),i(this,E),i(this,C),i(this,W),i(this,z),i(this,A),i(this,B),this.value="",this.label="",this.rows=4,this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.leadSlotOccupied=!1,i(this,v,e=>["type","placeholder","required"].includes(e.name)),i(this,b,e=>{const t=e.target;this.value=t.value}),i(this,y,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),i(this,_,()=>{this.elInputAsync.then(e=>e.focus())}),i(this,w,()=>{this.value=""}),i(this,S,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))}),ee(this)}connectedCallback(){super.connectedCallback(),this._setAutoHeight()}disconnectedCallback(){super.disconnectedCallback()}render(){return a`${Z(this.variant,[["default",()=>o(this,f,I).call(this)],["floating-label",()=>o(this,m,N).call(this)]])}`}_getValidityAnchor(){return this.elInput}_setAutoHeight(){this.elInputAsync.then(e=>{const t=(e.value.split(`
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};f=new WeakSet;I=function(){return a`
    ...
    `};m=new WeakSet;N=function(){return c};v=new WeakMap;b=new WeakMap;y=new WeakMap;_=new WeakMap;w=new WeakMap;S=new WeakMap;k=new WeakSet;F=function(){return a` <slot name="lead"></slot> `};$=new WeakSet;P=function(){return a` <slot name="trail" gds-allow="gds-badge"></slot> `};D=new WeakSet;T=new WeakSet;G=function(){return a`
      <textarea
        @input=${h(this,b)}
        @change=${h(this,y)}
        .value=${this.value}
