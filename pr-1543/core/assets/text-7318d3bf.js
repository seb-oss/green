import{k as h,t as p}from"./static-c0094392.js";import{n as d,g as x,G as v}from"./gds-element-86064462.js";import{t as m}from"./tokens.style-01187a75.js";import{s}from"./style-expression-property-0e3d4d40.js";import{i as f}from"./lit-element-1d72f0ce.js";const c=f`
  :host {
    display: contents;
  }
...
`;var y=Object.defineProperty,w=Object.getOwnPropertyDescriptor,r=(t,i,o,n)=>{for(var a=n>1?void 0:n?w(i,o):i,g=t.length-1,l;g>=0;g--)(l=t[g])&&(a=(n?l(i,o,a):l(a))||a);return n&&a&&y(i,o,a),a};let e=class extends v{constructor(){super(...arguments),this.tag="span"}render(){const t=encodeURI(this.tag),i=p(t);return h`<${i} tag><slot></slot></${i}>`}};e.styles=[m,c];r([d({type:String})],e.prototype,"tag",2);r([s({valueTemplate:t=>`${t}`,selector:"[tag]",styleTemplate:(t,i)=>{const o=i[0],n=`font-size: var(--gds-text-size-${o});`,a=`line-height: var(--gds-text-line-height-${o});`;return n+a}})],e.prototype,"font-size",2);r([s({property:"font-weight",selector:"[tag]",valueTemplate:t=>`var(--gds-text-weight-${t})`})],e.prototype,"font-weight",2);r([s({property:"margin",selector:"[tag]",valueTemplate:t=>t})],e.prototype,"margin",2);r([s({selector:"[tag]",valueTemplate:t=>t})],e.prototype,"isolation",2);r([s({property:"text-wrap",selector:"[tag]",valueTemplate:t=>t})],e.prototype,"text-wrap",2);r([s({property:"text-transform",selector:"[tag]",valueTemplate:t=>t})],e.prototype,"text-transform",2);r([s({property:"max-width",selector:"[tag]",valueTemplate:t=>`${t}ch`})],e.prototype,"max-width",2);r([s({property:"min-width",selector:"[tag]",valueTemplate:t=>`${t}ch`})],e.prototype,"min-width",2);r([s({property:"text-align",selector:"[tag]",valueTemplate:t=>t})],e.prototype,"text-align",2);r([s({property:"--_lines",selector:"[tag]",valueTemplate:t=>t})],e.prototype,"lines",2);r([s({property:"color",selector:"[tag]",valueTemplate:t=>{const[i,o]=t.split("/");return o?`color-mix(in srgb, var(--gds-color-${i}) ${parseFloat(o)*100}%, transparent 0%)`:`var(--gds-color-${i})`}})],e.prototype,"color",2);e=r([x("gds-text")],e);
