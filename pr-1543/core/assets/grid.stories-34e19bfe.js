import"./grid-55ec904c.js";import"./card-6335216c.js";import"./flex-e0066de6.js";import"./container-a3cd0825.js";import{k as n}from"./lit-element-1d72f0ce.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-d0c8c448.js";import"./style-expression-property-0e3d4d40.js";import"./watch-c4961afe.js";const I={title:"Docs/Layout/Grid",component:"gds-grid",tags:["autodocs"],parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grid)\n\nThe `gds-grid` is a custom element that provides a flexible grid system. It uses CSS grid layout to arrange its child elements into columns. This component is highly customizable and responsive, allowing you to specify the number of `columns`, `gap`, `padding`, and fluidity for different devices with automated column size based on the content using the `auto-columns` attribute."}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{gap:"m",padding:"0",columns:"4",innerHTML:`
      <gds-card border="4xs/l2-border-primary" border-radius="s">
  ...
  `},r={...t,name:"Breakpoints + Auto Columns",render:i=>n`
    <!-- prettier-ignore -->
  ...
  `},s={...t,name:"Auto Columns",render:i=>n`
    <!-- prettier-ignore -->
  ...
  `};var a,o,c;d.parameters={...d.parameters,docs:{...(a=d.parameters)==null?void 0:a.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(c=(o=d.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var g,l,h,m,x;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <!-- prettier-ignore -->
    <gds-grid
  ...
  \`
}`,...(f=(p=r.parameters)==null?void 0:p.docs)==null?void 0:f.source},description:{story:"This example shows a grid with `4` columns on all breakpoints desktop, tablet, and on mobile. It also has a gap of `2xl` on all breakpoints. The padding is `l` on all breakpoints. As well as `auto-columns` attribute is set to `100` which will make the columns to be `~100px` wide.",...(y=(b=r.parameters)==null?void 0:b.docs)==null?void 0:y.description}}};var v,C,L,j,O;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Auto Columns',
  render: args => html\`
    <!-- prettier-ignore -->
  ...
  \`
}`,...(L=(C=s.parameters)==null?void 0:C.docs)==null?void 0:L.source},description:{story:`Auto Columns, while optional, remove the need for breakpoints, adapting to content for a more flexible and responsive grid.
...
The \`auto-columns\` attribute is set to \`240\` which will make the columns to be \`240px\` no matter the screen/container size.`,...(O=(j=s.parameters)==null?void 0:j.docs)==null?void 0:O.description}}};const B=["Basic","Usage","AllBreakpoints","AutoColumns"];export{r as AllBreakpoints,s as AutoColumns,d as Basic,e as Usage,B as __namedExportsOrder,I as default};
