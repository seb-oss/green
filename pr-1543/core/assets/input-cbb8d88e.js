import{i as Q,h as Y,D as u}from"./lit-element-1d72f0ce.js";import{n as d,r as Z,g as tt,h as a}from"./gds-element-86064462.js";import{a as et}from"./query-b9d3c2af.js";import{r as j}from"./query-async-1ff18261.js";import{b as H}from"./until-27bb1490.js";import{n as c}from"./when-748fcf30.js";import{m as q}from"./runtime-c06dc943.js";import{c as it}from"./constrain-slots-08d8606c.js";import{w as st}from"./watch-c4961afe.js";import{a as nt,f as L}from"./button-ec69b557.js";import"./flex-c7160efd.js";import{t as at}from"./tokens.style-34611a2c.js";import"./cross-small-7e719cb3.js";import"./triangle-exclamation-da39395f.js";import"./container-5f07f629.js";import"./text-751dfda7.js";/**
 * @license
...
`).length||1).toString();t==null||t.style.setProperty("--_lines",e.toString())})}};T=new WeakSet;U=function(){return a`
      ...
      >
        ...
        >
          ...
          ${c(this.multiline,()=>a`${n(this,b,O).call(this)}`,()=>a`${n(this,v,M).call(this)}`)}
    ...
    `};v=new WeakSet;M=function(){return a`
      <input
        ...
        ${L(o(this,g))}
      />
    `};b=new WeakSet;O=function(){return a`
      <textarea
        @input=${o(this,x)}
        @change=${o(this,f)}
        .value=${this.value}
    ...
    `};_=new WeakSet;D=function(){return this.clearable&&this.value.length>0?a`
      ...
      `:u};w=new WeakSet;F=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};S=new WeakSet;G=function(){const t=this.maxlength-this.value.length;let e;return t<0?e="error":t<20?e="warning":e="success",a`<gds-badge variant="${this.invalid?"error":e}"
      >${t}</gds-badge
    >`};k=new WeakSet;P=async function(){return this.elExtendedSupportingTextSlot.then(t=>t&&t.assignedElements().length>0?a`
          <gds-button
            size="small"
            rank="tertiary"
