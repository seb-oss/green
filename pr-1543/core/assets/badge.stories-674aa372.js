import{k as a}from"./lit-element-1d72f0ce.js";import"./badge-cc2a73df.js";import"./grid-9e401f80.js";import"./flex-bcd919b1.js";import"./divider-175a5512.js";import"./triangle-exclamation-da39395f.js";import"./arrow-rotate-counter-clockwise-5b92e734.js";import"./rocket-39575822.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-01187a75.js";import"./container-89e950a3.js";import"./style-expression-property-26695edd.js";import"./watch-c4961afe.js";import"./icon-a640baec.js";import"./directive-dd518ee3.js";const te={title:"Docs/Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A badge is a small status or notification indicator that can be used to display a message or status.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"]},o={name:"Variants",render:e=>a`
  ...
  `},d={name:"Lead",parameters:{controls:{include:[]}},render:e=>a`
    <gds-flex gap="xl">
      <gds-badge variant="positive">
        <gds-icon-rocket slot="lead"></gds-icon-rocket>
        Launch
  ...
  `},i={name:"Trail",parameters:{controls:{include:[]}},render:e=>a`
    <gds-flex gap="xl">
      <gds-badge variant="positive">
  ...
  `},g={name:"Notification",parameters:{actions:{handles:["mouseover","mouseout"]}},play:async()=>{document.querySelectorAll("gds-badge[notification]").forEach(e=>{let n;const U=()=>{var b;const c=((b=e.textContent)==null?void 0:b.trim())||"",r=c.replace(/\D/g,"");if(r&&!isNaN(Number(r))){const F=parseInt(r,10);let l=0;n=window.setInterval(()=>{e.textContent=l.toString()+c.replace(/\d/g,""),l===F?clearInterval(n):l++},50)}},_=()=>{n&&(clearInterval(n),n=void 0)};e.addEventListener("mouseover",U),e.addEventListener("mouseout",_)})},render:e=>a`
    <gds-flex gap="xl" align-items="center">
      <gds-badge variant="positive" notification></gds-badge>
      <gds-badge variant="positive" notification>9</gds-badge>
      <gds-badge variant="positive" notification>999+</gds-badge>
  ...
  \`
}`,...(p=(v=o.parameters)==null?void 0:v.docs)==null?void 0:p.source}}};var f,x,u,h,w;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: 'Lead',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...(u=(x=d.parameters)==null?void 0:x.docs)==null?void 0:u.source},description:{story:`The \`gds-badge\` component includes a \`lead\` slot that allows for the addition of leading content, such as icons.
...
\`\`\``,...(w=(h=d.parameters)==null?void 0:h.docs)==null?void 0:w.description}}};var z,k,y,N,S;i.parameters={...i.parameters,docs:{...(z=i.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: 'Trail',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...(y=(k=i.parameters)==null?void 0:k.docs)==null?void 0:y.source},description:{story:'`gds-badge` has a trail slot that can be used to add additional content to the badge.\n\n```html\n<gds-badge>\n <span slot="trail">...</span>\n</gds-badge>\n```',...(S=(N=i.parameters)==null?void 0:N.docs)==null?void 0:S.description}}};var D,I,E,L,C;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Size',
  render: args => html\`
    <gds-flex gap="4xl">
      <gds-flex flex-direction="column" gap="xl">
  ...
  \`
}`,...(E=(I=s.parameters)==null?void 0:I.docs)==null?void 0:E.source},description:{story:`Defines the size of the badge.
...
\`\`\``,...(C=(L=s.parameters)==null?void 0:L.docs)==null?void 0:C.description}}};var T,V,A,P,W;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: 'Disabled',
  render: args => html\`
    <gds-flex gap="xl">
      <gds-badge variant="positive" disabled>
