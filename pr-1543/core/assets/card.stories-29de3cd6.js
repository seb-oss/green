import{k as e}from"./lit-element-1d72f0ce.js";import"./card-6335216c.js";import"./img-80a0ecdd.js";import"./video-82e65e40.js";import"./container-a3cd0825.js";import"./mask-bed8343b.js";import"./flex-e0066de6.js";import"./text-fff8e4d1.js";import"./divider-bd941458.js";import"./arrow-right-53f3213e.js";import"./circles-three-8108223d.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-d0c8c448.js";import"./style-expression-property-0e3d4d40.js";import"./watch-c4961afe.js";import"./query-b9d3c2af.js";import"./static-c0094392.js";import"./icon-a640baec.js";import"./directive-dd518ee3.js";const re={title:"Docs/Layout/Card",component:"gds-card",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-card` is a custom element that provides a flexible card system.\n\nIt can be used to create a card with different styles and configurations.\n\nThe card can be customized with different properties like `shadow`, `border`, `radius`, and `background`.\nIt is designed to be used in different scenarios like displaying content, images, or other elements.\nIt can be used in combination with other elements like `gds-grid`, `gds-container`, `gds-img`, `gds-text` etc.\n\n@status beta\n\n@extends `gds-container`"}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{disable:!0}}},n={...d,render:s=>e`
  ...
  `},t={...d,name:"Border Style",render:s=>e` <gds-grid columns="5" gap="l">
    ...
    </gds-grid>`},r={...d,name:"Border Radius",render:s=>e`<gds-grid columns="8" gap="l">
      <gds-card
    ...
    </gds-grid>`},o={...d,name:"Shadow",render:s=>e`<gds-grid columns="5" gap="l">
      <gds-card
        padding="s{xs} m{l} l{l}"
    ...
    </gds-grid>`},a={...d,name:"Background",render:s=>e`<gds-grid columns="4" gap="l">
    ...
    </gds-grid>`},i={...d,name:"Using with Grid",render:s=>e` <gds-grid columns="4" gap="l">
      <gds-container>
...
}`,...(S=(B=o.parameters)==null?void 0:B.docs)==null?void 0:S.source},description:{story:`@property shadow
...
The shadow styles are predfied on the tokens file and will be applied automativally based on the token value.`,...(z=(q=o.parameters)==null?void 0:q.docs)==null?void 0:z.description}}};var X,C,D,T,M;a.parameters={...a.parameters,docs:{...(X=a.parameters)==null?void 0:X.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Background',
...
}`,...(D=(C=a.parameters)==null?void 0:C.docs)==null?void 0:D.source},description:{story:`@property background

Controls the background property of the card.
Supports all the color tokens from the design system.`,...(M=(T=a.parameters)==null?void 0:T.docs)==null?void 0:M.description}}};var P,A,R,I,U;i.parameters={...i.parameters,docs:{...(P=i.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...DefaultParams,
...
}`,...(R=(A=i.parameters)==null?void 0:A.docs)==null?void 0:R.source},description:{story:'Using `gds-card` with `gds-grid`\nThe `gds-card` can be used with the `gds-grid` to create a card layout with multiple cards.\nThe `gds-card` and `gds-container` accept properties like `column` and `row` where you can specify the number of columns specified on the grid to span or rows to span in vertical axis like on this example:\n\n```html\n<gds-container grid-column="2 / -1" grid-row="1 / -1"></gds-container>\n```',...(U=(I=i.parameters)==null?void 0:I.docs)==null?void 0:U.description}}};const oe=["Card","CardBorder","CardRadius","Cardshadow","CardBackground","CardGrid"];export{n as Card,a as CardBackground,t as CardBorder,i as CardGrid,r as CardRadius,o as Cardshadow,oe as __namedExportsOrder,re as default};
