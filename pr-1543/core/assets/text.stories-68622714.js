import"./text-fff8e4d1.js";import"./card-6335216c.js";import"./container-a3cd0825.js";import"./flex-e0066de6.js";import"./divider-bd941458.js";import{k as e}from"./lit-element-1d72f0ce.js";import"./static-c0094392.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-d0c8c448.js";import"./style-expression-property-0e3d4d40.js";import"./watch-c4961afe.js";const ae={title:"Docs/Content/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:`The \`gds-text\`
...
## Usage`}}}},G={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["heading-xl","heading-l","heading-m","heading-s","heading-xs","heading-2xs","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...G,name:"Tags",render:t=>e`<gds-flex flex-direction="column" gap="2xl">
...
}`,...(y=(h=i.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};var b,z,L,H,k;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'Heading',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text tag="h6">H6: Heading 2XS</gds-text>
  ...
  \`
}`,...(w=(D=o.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};var P,C,v;r.parameters={...r.parameters,docs:{...(P=r.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text font-size="body-s">Body Small</gds-text>
  ...
  \`
}`,...(v=(C=r.parameters)==null?void 0:C.docs)==null?void 0:v.source}}};var M,q,B;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: 'Display',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text font-size="display-s">Display Small</gds-text>
  ...
  \`
}`,...(B=(q=g.parameters)==null?void 0:q.docs)==null?void 0:B.source}}};var T,X,E;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: 'Preamble',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text font-size="preamble-xs">Preamble Extra Small</gds-text>
  ...
  \`
}`,...(E=(X=l.parameters)==null?void 0:X.docs)==null?void 0:E.source}}};var W,I,j,R,_;n.parameters={...n.parameters,docs:{...(W=n.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: 'Line Clamp',
  render: args => html\`
    <gds-flex flex-direction="column" gap="2xl">
      <gds-flex flex-direction="column" gap="m">
  ...
  \`
}`,...(U=(O=a.parameters)==null?void 0:O.docs)==null?void 0:U.source},description:{story:'The `gds-text` component has a `color` property that will change the text color based on the specified color token.\n\ne.g. `<gds-text color="l1-content-primary"></gds-text>`',...(A=(Y=a.parameters)==null?void 0:Y.docs)==null?void 0:A.description}}};const ie=["Card","Weight","Heading","Detail","Body","Display","Preamble","Lines","Color"];export{r as Body,s as Card,a as Color,o as Detail,g as Display,d as Heading,n as Lines,l as Preamble,i as Weight,ie as __namedExportsOrder,ae as default};
