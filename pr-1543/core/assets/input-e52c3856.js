import{i as Q,h as Y,D as u}from"./lit-element-1d72f0ce.js";import{n as d,r as Z,g as ee,h as a}from"./gds-element-86064462.js";import{a as te}from"./query-b9d3c2af.js";import{r as H}from"./query-async-1ff18261.js";import{b as j}from"./until-27bb1490.js";import{n as c}from"./when-748fcf30.js";import{m as q}from"./runtime-c06dc943.js";import{c as ie}from"./constrain-slots-08d8606c.js";import{w as se}from"./watch-c4961afe.js";import{a as ne,f as L}from"./button-62abad27.js";import"./flex-0e931cf8.js";import{t as ae}from"./tokens.style-dc3ad24e.js";import"./cross-small-7e719cb3.js";import"./triangle-exclamation-da39395f.js";import"./container-b1fc3909.js";import"./card-21efe6d3.js";import"./text-fbd919b7.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const le=(e,t,l)=>{for(const h of t)if(h[0]===e)return(0,h[1])();return l==null?void 0:l()},re=Q`
...
`;var oe=Object.defineProperty,de=Object.getOwnPropertyDescriptor,r=(e,t,l,h)=>{for(var p=h>1?void 0:h?de(t,l):t,z=e.length-1,T;z>=0;z--)(T=e[z])&&(p=(h?T(t,l,p):T(p))||p);return h&&p&&oe(t,l,p),p},X=(e,t,l)=>{if(!t.has(e))throw TypeError("Cannot "+l)},o=(e,t,l)=>(X(e,t,"read from private field"),l?l.call(e):t.get(e)),s=(e,t,l)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,l)},n=(e,t,l)=>(X(e,t,"access private method"),l),E,U,C,V,g,x,f,m,W,A,B,J,O,K,v,I,b,M,y,R,$,N,_,D,w,F,S,G,k,P;let i=class extends ne{constructor(){super(),s(this,E),s(this,C),s(this,B),s(this,O),s(this,v),s(this,b),s(this,y),s(this,$),s(this,_),s(this,w),s(this,S),s(this,k),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="default",this.multiline=!1,this.leadSlotOccupied=!1,s(this,g,e=>["type","placeholder","required"].includes(e.name)),s(this,x,e=>{const t=e.target;this.value=t.value}),s(this,f,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),s(this,m,()=>{this.elInputAsync.then(e=>e.focus())}),s(this,W,()=>{this.value=""}),s(this,A,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))}),ie(this)}connectedCallback(){super.connectedCallback(),this._setAutoHeight()}disconnectedCallback(){super.disconnectedCallback()}render(){return a`${le(this.variant,[["default",()=>n(this,E,U).call(this)],["simplified",()=>n(this,C,V).call(this)]])}`}_getValidityAnchor(){return this.elInput}_setAutoHeight(){this.multiline&&this.elInputAsync.then(e=>{const t=(e.value.split(`
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};E=new WeakSet;U=function(){return a`
      ...
      >
        ...
        >
          ...
          ${c(this.multiline,()=>a`${n(this,b,M).call(this)}`,()=>a`${n(this,v,I).call(this)}`)}
    ...
    `};g=new WeakMap;x=new WeakMap;f=new WeakMap;m=new WeakMap;W=new WeakMap;A=new WeakMap;B=new WeakSet;J=function(){return a` <slot name="lead"></slot> `};O=new WeakSet;K=function(){return a` <slot name="trail" gds-allow="gds-badge"></slot> `};v=new WeakSet;I=function(){return a`
      <input
        @input=${o(this,x)}
        @change=${o(this,f)}
    ...
    >`};k=new WeakSet;P=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?a`
        ...
        `:u)};i.shadowRootOptions={...Y.shadowRootOptions,delegatesFocus:!0};i.styles=[ae,re];r([d()],i.prototype,"value",2);r([d()],i.prototype,"label",2);r([d({attribute:"supporting-text"})],i.prototype,"supportingText",2);r([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],i.prototype,"showExtendedSupportingText",2);r([d({attribute:"disabled",type:Boolean,reflect:!0})],i.prototype,"disabled",2);r([d({type:Boolean})],i.prototype,"clearable",2);r([d({type:Number})],i.prototype,"maxlength",2);r([d({type:String})],i.prototype,"variant",2);r([d({type:String})],i.prototype,"size",2);r([d({type:Boolean})],i.prototype,"multiline",2);r([H("input, textarea")],i.prototype,"elInputAsync",2);r([te("input, textarea")],i.prototype,"elInput",2);r([H('slot[name="extended-supporting-text"]')],i.prototype,"elExtendedSupportingTextSlot",2);r([Z()],i.prototype,"leadSlotOccupied",2);r([se("value")],i.prototype,"_setAutoHeight",1);i=r([ee("gds-input")],i);
