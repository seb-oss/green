import{n as d,r as J,g as K,h as o}from"./gds-element-86064462.js";import{a as Q}from"./query-b9d3c2af.js";import{r as B}from"./query-async-1ff18261.js";import{b as Y}from"./until-27bb1490.js";import{i as Z,D as c}from"./lit-element-1d72f0ce.js";import{n as x}from"./when-748fcf30.js";import{r as ee}from"./choose-473fcf2d.js";import{m as I}from"./runtime-c06dc943.js";import{c as te}from"./constrain-slots-08d8606c.js";import{w as se}from"./watch-c4961afe.js";import{a as ie,f as ne}from"./button-7f889fcf.js";import"./flex-a14d12bd.js";import{t as ae}from"./tokens.style-01187a75.js";import"./cross-small-7e719cb3.js";import"./triangle-exclamation-da39395f.js";import"./container-82e7a89b.js";import"./card-9d673652.js";import"./text-7318d3bf.js";import"./badge-3e2e430d.js";const re=Z`
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};f=new WeakSet;R=function(){return o`
    ...
    `};m=new WeakSet;D=function(){return c};v=new WeakMap;b=new WeakMap;y=new WeakMap;_=new WeakMap;w=new WeakMap;S=new WeakMap;$=new WeakSet;F=function(){return o` <slot name="lead"></slot> `};k=new WeakSet;G=function(){return o`
      ...
      ></slot>
    `};E=new WeakSet;L=function(e){const n=e.target.assignedNodes({flatten:!0});this.trailSlotOccupied=n.length>0&&n.some(h=>{var l;return h.nodeType===Node.ELEMENT_NODE||h.nodeType===Node.TEXT_NODE&&((l=h.textContent)==null?void 0:l.trim())!==""})};T=new WeakSet;P=function(){return o`
      <input
        @input=${p(this,b)}
        @change=${p(this,y)}
