...
`;var oe=Object.defineProperty,de=Object.getOwnPropertyDescriptor,l=(e,t,r,h)=>{for(var p=h>1?void 0:h?de(t,r):t,z=e.length-1,E;z>=0;z--)(E=e[z])&&(p=(h?E(t,r,p):E(p))||p);return h&&p&&oe(t,r,p),p},X=(e,t,r)=>{if(!t.has(e))throw TypeError("Cannot "+r)},o=(e,t,r)=>(X(e,t,"read from private field"),r?r.call(e):t.get(e)),s=(e,t,r)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,r)},n=(e,t,r)=>(X(e,t,"access private method"),r),T,U,C,V,g,x,f,m,W,A,B,J,I,K,b,M,v,O,y,R,$,N,_,D,w,F,S,G,k,P;let i=class extends ne{constructor(){super(),s(this,T),s(this,C),s(this,B),s(this,I),s(this,b),s(this,v),s(this,y),s(this,$),s(this,_),s(this,w),s(this,S),s(this,k),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="default",this.multiline=!1,this.leadSlotOccupied=!1,s(this,g,e=>["type","placeholder","required"].includes(e.name)),s(this,x,e=>{const t=e.target;this.value=t.value}),s(this,f,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),s(this,m,()=>{this.elInputAsync.then(e=>e.focus())}),s(this,W,()=>{this.value=""}),s(this,A,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))}),ie(this)}connectedCallback(){super.connectedCallback(),this._setAutoHeight()}disconnectedCallback(){super.disconnectedCallback()}render(){return a`${re(this.variant,[["default",()=>n(this,T,U).call(this)],["simplified",()=>n(this,C,V).call(this)]])}`}_getValidityAnchor(){return this.elInput}_setAutoHeight(){this.multiline&&this.elInputAsync.then(e=>{const t=(e.value.split(`
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};T=new WeakSet;U=function(){return a`
      <gds-flex
      ...
      >
        ...
        <gds-flex
          ...
          .border=${this.disabled?"":this.invalid?"4xs/l3c-border-negative":"4xs/l3-border-secondary"}
          class="field"
          @click=${o(this,m)}
          cursor="text"
        >
    ...
    `};_=new WeakSet;D=function(){return this.clearable&&this.value.length>0?a`
      ...
      `:u};w=new WeakSet;F=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};S=new WeakSet;G=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="error":e<20?t="warning":t="success",a`<gds-badge variant="${this.invalid?"error":t}"
      >${e}</gds-badge
