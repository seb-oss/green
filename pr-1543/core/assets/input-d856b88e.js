...
`;var it=Object.defineProperty,nt=Object.getOwnPropertyDescriptor,l=(t,e,i,h)=>{for(var p=h>1?void 0:h?nt(e,i):e,E=t.length-1,z;E>=0;E--)(z=t[E])&&(p=(h?z(e,i,p):z(p))||p);return h&&p&&it(e,i,p),p},q=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},o=(t,e,i)=>(q(t,e,"read from private field"),i?i.call(t):e.get(t)),n=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},a=(t,e,i)=>(q(t,e,"access private method"),i),T,X,C,U,g,x,f,m,W,A,b,B,v,I,y,M,$,R,_,N,w,O,k,D,S,F;let s=class extends Z{constructor(){super(),n(this,T),n(this,C),n(this,b),n(this,v),n(this,y),n(this,$),n(this,_),n(this,w),n(this,k),n(this,S),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="default",this.multiline=!1,n(this,g,t=>["type","placeholder","required"].includes(t.name)),n(this,x,t=>{const e=t.target;this.value=e.value}),n(this,f,t=>{const e=t.target;this.value=e.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),n(this,m,()=>{this.elInputAsync.then(t=>t.focus())}),n(this,W,()=>{this.value=""}),n(this,A,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))}),Q(this)}connectedCallback(){super.connectedCallback(),this._setAutoHeight()}disconnectedCallback(){super.disconnectedCallback()}render(){return r`${et(this.variant,[["default",()=>a(this,T,X).call(this)],["simplified",()=>a(this,C,U).call(this)]])}`}_getValidityAnchor(){return this.elInput}_setAutoHeight(){this.multiline&&this.elInputAsync.then(t=>{const e=(t.value.split(`
`).length||1).toString();t==null||t.style.setProperty("--_lines",e.toString())})}};T=new WeakSet;X=function(){return r`
      <gds-flex
    ...
    `};C=new WeakSet;U=function(){return r`
    ...
    `};g=new WeakMap;x=new WeakMap;f=new WeakMap;m=new WeakMap;W=new WeakMap;A=new WeakMap;b=new WeakSet;B=function(){return r`
      <input
        @input=${o(this,x)}
        @change=${o(this,f)}
    ...
    `};$=new WeakSet;R=function(){return r`
      <gds-flex
    ...
    `};_=new WeakSet;N=function(){return this.clearable&&this.value.length>0?r`
        <gds-button
          size="small"
          rank="tertiary"
