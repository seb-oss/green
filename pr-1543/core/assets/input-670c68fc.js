import{n as d,r as J,g as K,h as l}from"./gds-element-86064462.js";import{a as Q}from"./query-b9d3c2af.js";import{r as B}from"./query-async-1ff18261.js";import{b as Y}from"./until-27bb1490.js";import{i as Z,D as c}from"./lit-element-1d72f0ce.js";import{n as x}from"./when-748fcf30.js";import{r as tt}from"./choose-473fcf2d.js";import{m as I}from"./runtime-c06dc943.js";import{c as et}from"./constrain-slots-08d8606c.js";import{w as st}from"./watch-c4961afe.js";import{a as it,f as nt}from"./button-7f889fcf.js";import"./flex-0f40f454.js";import{t as at}from"./tokens.style-01187a75.js";import"./cross-small-7e719cb3.js";import"./triangle-exclamation-da39395f.js";import"./container-faf9edc4.js";import"./card-4cc9dc24.js";import"./text-7318d3bf.js";import"./badge-3e2e430d.js";const rt=Z`
...
`).length||1).toString();t==null||t.style.setProperty("--_lines",e.toString())})}};f=new WeakSet;R=function(){return l`
    ...
    `};m=new WeakSet;D=function(){return c};v=new WeakMap;b=new WeakMap;y=new WeakMap;_=new WeakMap;w=new WeakMap;S=new WeakMap;$=new WeakSet;F=function(){return l` <slot name="lead"></slot> `};k=new WeakSet;G=function(){return l`
      ...
      ></slot>
    `};E=new WeakSet;L=function(t){const n=t.target.assignedNodes({flatten:!0});this.trailSlotOccupied=n.length>0&&n.some(h=>{var o;return h.nodeType===Node.ELEMENT_NODE||h.nodeType===Node.TEXT_NODE&&((o=h.textContent)==null?void 0:o.trim())!==""})};T=new WeakSet;P=function(){return l`
      <input
        @input=${p(this,b)}
        @change=${p(this,y)}
    ...
    `};W=new WeakSet;q=function(){return this.clearable&&this.value.length>0?l`
      ...
      `:c};A=new WeakSet;j=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};N=new WeakSet;U=function(){const t=this.maxlength-this.value.length;let e;return t<0?e="negative":t<20?e="warning":e="positive",l`<gds-badge variant="${e}">${t}</gds-badge>`};O=new WeakSet;V=async function(){return this.elExtendedSupportingTextSlot.then(t=>t&&t.assignedElements().length>0?l`
          <gds-button
            size="small"
            rank="tertiary"
