import{x as ms,a as Ks,i as w,r as m,E as As}from"./lit-element-Bx14lxc-.js";import{r as Ys,n as g}from"./Reflect-DJ7r0WLU.js";import{a as xs}from"./query-p8xgzTDt.js";import{e as Qs,o as H}from"./if-defined-BAXgs-ZI.js";import{n as se}from"./when-BR7zwNJC.js";import{i as Ts,u as Ls,s as ee}from"./static-B8S6DEnV.js";import{e as te,i as oe,t as re}from"./directive-CF8sV3Lr.js";import{ag as O}from"./index-CKj8P9SD.js";import{o as ne}from"./unsafe-html-CYO4avEf.js";var ae=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,Rs=e=>{throw TypeError(e)},r=(e,s,t,o)=>{for(var n=o>1?void 0:o?ie(s,t):s,l=e.length-1,d;l>=0;l--)(d=e[l])&&(n=(o?d(s,t,n):d(n))||n);return o&&n&&ae(s,t,n),n},ws=(e,s,t)=>s.has(e)||Rs("Cannot "+t),a=(e,s,t)=>(ws(e,s,"read from private field"),t?t.call(e):s.get(e)),y=(e,s,t)=>s.has(e)?Rs("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,t),x=(e,s,t,o)=>(ws(e,s,"write to private field"),s.set(e,t),t),j=(e,s,t)=>(ws(e,s,"access private method"),t);const B="-925402";class ks{static get instance(){var s;return(s=globalThis.__gdsElementLookupTable)!=null&&s[B]||(globalThis.__gdsElementLookupTable={...globalThis.__gdsElementLookupTable,[B]:new Map}),globalThis.__gdsElementLookupTable[B]}}const L=(e,s)=>function(t){var o;return o=class extends t{constructor(){super(...arguments),this.gdsElementName=e}static define(){if(o.isDefined)return;const l=globalThis.GDS_DISABLE_VERSIONED_ELEMENTS?e:e+B;customElements.get(l)||(o.isDefined=!0,ks.instance.set(e,l),customElements.define(l,o),s!=null&&s.dependsOn&&s.dependsOn.forEach(d=>d.define()))}},o.isDefined=!1,o},Gs=new WeakMap;function le(e,...s){let t=Gs.get(e);return t||(t=Ms(e),t.raw=Ms(e.raw),Gs.set(e,t)),[t,...s]}const Ms=e=>e.map(s=>{for(const[t,o]of ks.instance.entries())s=s.replace(new RegExp(`${t}(?![-a-z])`,"mg"),o);return s});function ce(e){return(s,...t)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return e(s,...t);const[o,...n]=le(s,...t);return e(o,...n)}}const Q=ce(ms);function de(e){return ks.instance.get(e)??e}function U(e){return de(e)}var C,rs,V,ns,I,$,D,as,R,Ws,X,js;class ge{constructor(s){y(this,R),y(this,C,!Es()),y(this,rs,!1),y(this,V,[]),y(this,ns,[]),y(this,I,new Map),y(this,$,new Map),y(this,D,[]),y(this,as,[]),this.host=s,this.host.addController(this)}hostConnected(){j(this,R,js).call(this)}has(s){return a(this,C)?a(this,$).has(s):a(this,I).has(s)}inject(s,t){j(this,R,Ws).call(this,s,t),j(this,R,X).call(this)}clear(s){a(this,C)?this.host.updateComplete.then(()=>{const t=a(this,$).get(s);t==null||t.remove(),a(this,$).delete(s)}):a(this,I).delete(s),j(this,R,X).call(this)}clearAll(){a(this,C)?this.host.updateComplete.then(()=>{a(this,$).forEach(s=>s.remove()),a(this,D).forEach(s=>s.remove()),a(this,$).clear(),x(this,D,[])}):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],a(this,I).clear(),x(this,V,[]))}clearInitial(){a(this,C)?this.host.updateComplete.then(()=>{a(this,D).forEach(s=>s.remove()),x(this,D,[])}):x(this,V,[]),j(this,R,X).call(this)}restoreInitial(){a(this,C)?a(this,as).forEach(s=>{a(this,D).push(s.cloneNode(!0))}):x(this,V,[...a(this,ns)]),j(this,R,X).call(this)}}C=new WeakMap;rs=new WeakMap;V=new WeakMap;ns=new WeakMap;I=new WeakMap;$=new WeakMap;D=new WeakMap;as=new WeakMap;R=new WeakSet;Ws=function(e,s){if(a(this,C)){let t=a(this,$).get(e);t||(t=document.createElement("style"),a(this,$).set(e,t)),t.textContent=s.cssText}else{if(!this.host.shadowRoot||!s.styleSheet)return;a(this,I).set(e,s.styleSheet)}};X=function(){if(a(this,C))this.host.updateComplete.then(()=>{this.host.shadowRoot&&(this.host.shadowRoot.querySelectorAll("style").forEach(e=>{e.remove()}),a(this,D).forEach(e=>{var s;(s=this.host.shadowRoot)==null||s.appendChild(e)}),a(this,$).forEach(e=>{var s;(s=this.host.shadowRoot)==null||s.appendChild(e)}))});else{if(!this.host.shadowRoot)return;this.host.shadowRoot.adoptedStyleSheets=[...a(this,V),...Array.from(a(this,I).values())]}};js=function(){a(this,rs)||(a(this,C)?this.host.updateComplete.then(()=>{this.host.shadowRoot&&this.host.shadowRoot.querySelectorAll("style").forEach(e=>{a(this,D).push(e),a(this,as).push(e.cloneNode(!0))})}):this.host.shadowRoot&&a(this,V).length===0&&(x(this,V,[...this.host.shadowRoot.adoptedStyleSheets||[]]),x(this,ns,[...a(this,V)])),x(this,rs,!0))};function Es(){try{return new CSSStyleSheet,!0}catch{return!1}}function Ds(e){return e.split("-").map(s=>s.charAt(0).toUpperCase()+s.slice(1)).join("")}class F extends Ks{constructor(){super(),this.semanticVersion="2.5.2",this._isUsingTransitionalStyles=!1,this._dynamicStylesController=new ge(this)}static define(){}connectedCallback(){var s;super.connectedCallback(),this.setAttribute("gds-element",((s=this.gdsElementName)==null?void 0:s.toString())||"")}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new CustomEvent("gds-element-disconnected",{bubbles:!0,composed:!1}))}dispatchStandardEvent(s,t){const o={bubbles:!0,composed:!1,cancelable:!0,...t};return[this.dispatchEvent(new Event(s,o)),this.dispatchEvent(new Event(Ds(s),o))].every(n=>n!==!1)}dispatchCustomEvent(s,t={}){const o={bubbles:!0,composed:!1,cancelable:!0,...t};return[this.dispatchEvent(new CustomEvent(s,o)),this.dispatchEvent(new CustomEvent(Ds(s),o))].every(n=>n!==!1)}}F.isDefined=!1;F.styleExpressionBaseSelector=":host";r([Ys()],F.prototype,"_isUsingTransitionalStyles",2);const Ps=`/**
 ...
 */
  ...
  --gds-sys-radius-4xs: 1px;
  --gds-sys-radius-3xs: 2px;
  --gds-sys-radius-2xs: 4px;
 ...
 */
  ...
  --gds-sys-shadow-xl-02: 0px 0px 0px 0px transparent;`;var pe={};const ds=typeof process<"u"&&pe!==void 0;var hs,is,ls,_s,es,qs,Is;function ye(){return ds?[]:document.adoptedStyleSheets||[]}const fe=class Os{constructor(){y(this,es),y(this,hs,!Es()),y(this,is,new Map),y(this,ls,new Map),y(this,_s,ye())}static get instance(){var s;return(s=globalThis.__gdsGlobalStylesRegistryScoped)!=null&&s[B]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[B]:new Os}),globalThis.__gdsGlobalStylesRegistryScoped[B]}injectGlobalStyles(s,t){if(a(this,hs)){const o=Array.isArray(t)?t.map(n=>n.toString()).join(""):t.toString();j(this,es,qs).call(this,s,o)}else t.styleSheet&&j(this,es,Is).call(this,s,t.styleSheet)}};hs=new WeakMap;is=new WeakMap;ls=new WeakMap;_s=new WeakMap;es=new WeakSet;qs=function(e,s){if(ds)return;let t=a(this,ls).get(e);t||(t=document.createElement("style"),a(this,ls).set(e,t)),t.textContent=s,document.head.appendChild(t)};Is=function(e,s){ds||(a(this,is).set(e,s),document.adoptedStyleSheets=[...a(this,_s),...Array.from(a(this,is).values())])};let he=fe;const q=[w`
    :host {
      ${m(Ps)}
      ${m(Fs)}
    }
...
`;var ve=ue;let K=class extends F{constructor(){super(...arguments),this.onmousedown=e=>{const t=e.target.getBoundingClientRect(),o=this._rippleEl;o&&(o.classList.remove("gds-ripple-effect"),this.style.setProperty("--gds-ripple-top",`${e.clientY-t.top}px`),this.style.setProperty("--gds-ripple-left",`${e.clientX-t.left}px`),setTimeout(()=>{o.classList.add("gds-ripple-effect")},20))}}render(){return ms`<div></div>`}};K.styles=[q,ve];r([xs("div")],K.prototype,"_rippleEl",2);K=r([L("gds-ripple")],K);var ts,os,us;const be=class Us{constructor(){y(this,ts,new Map),y(this,os,new Map),y(this,us,!Es())}static get instance(){var s;return(s=globalThis.__gdsTransitionalStyles)!=null&&s[B]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[B]:new Us}),globalThis.__gdsTransitionalStyles[B]}apply(s,t){if(!s.shadowRoot)return;const o=a(this,ts).get(t);o&&(a(this,os).set(t,s),this.applyToElement(t,o))}applyToElement(s,t){var M,p;const o=a(this,os).get(s);if(!o||!o.shadowRoot)return;const n=()=>{o._dynamicStylesController.clearInitial(),o._dynamicStylesController.inject("t-styles",m(t)),o._isUsingTransitionalStyles=!0},l=()=>{o._isUsingTransitionalStyles=!1,o._dynamicStylesController.clear("t-styles"),o._dynamicStylesController.restoreInitial()},d="[gds-element=gds-theme]";let f=o.getRootNode(),b=o.closest(d);for(;b===null&&f!==document;)b=(M=f.host)==null?void 0:M.closest(d),f=(p=f.host)==null?void 0:p.getRootNode();if(b){const v=b,E=()=>{v.designVersion==="2023"?l():n()};if(v.addEventListener("gds-design-version-changed",E),o.addEventListener("gds-element-disconnected",()=>v.removeEventListener("gds-design-version-changed",E)),v.designVersion==="2023"){l();return}}n()}register(s,t){let o=t;a(this,us)&&(o=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${t}`),a(this,ts).set(s,o),this.applyToElement(s,o)}};ts=new WeakMap;os=new WeakMap;us=new WeakMap;let Ns=be;function Cs(e,s){const t={waitUntilFirstUpdate:!1,...s};return(o,n,l)=>{const{update:d}=o,f=Array.isArray(e)?e:[e];o.update=function(b){f.forEach(M=>{var v;const p=M;if(b.has(p)){const E=b.get(p),N=this[p];E!==N&&(!t.waitUntilFirstUpdate||this.hasUpdated)&&((v=l.value)==null||v.call(this,E,N))}}),d.call(this,b)}}}function Se(e={attributes:!0,childList:!0,subtree:!1,characterData:!0}){return(s,t,o)=>{let n;const l=s.connectedCallback,d=s.disconnectedCallback;s.connectedCallback=function(){l==null||l.call(this);const f=(b,M)=>{var p;(p=o.value)==null||p.call(this)};n=new MutationObserver(f),n.observe(this,e)},s.disconnectedCallback=function(){d==null||d.call(this),n.disconnect()}}}const me={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},xe=/^([<|>]=?)?([0-9a-z]+)/,Hs=["{","}",";",":",","],Vs=[" ","/n"];function we(e=""){const s=[];let t="";for(let o=0;o<e.length;o++){const n=e[o];if(Vs.includes(n)||(t+=n),Hs.includes(n)){s.push(t.slice(0,-1)),s.push(n),t="";continue}if(Vs.includes(n)||o===e.length-1){s.push(t),t="";continue}}return s.filter(o=>o!=="")}function ke(e){const s=[];let t={breakpoint:"-",values:[]};const o=()=>({sel:"",values:[]});let n=o();for(const l of e){if(!Hs.includes(l)){n.values.push(l);continue}if(l==="{"&&(t={breakpoint:n.values.join(","),values:[]},n=o()),l===";"&&(s.length===0&&s.push(t),n.values.length>0&&(t.values.push(n),n=o())),l===":"){const d=n.values.pop()??"";n.sel=d}t&&l==="}"&&(t.values.push(n),n=o(),s.push(t))}return n.values.length>0&&t.values.push(n),s.length===0&&s.push(t),s}function Ee(e){return e.split(",").map(t=>{const o=t.trim().match(xe);if(!o)throw new Error(`Invalid breakpoint specifier: ${t}`);return{condition:o[1],value:o[2]}})}function _e(e,s,t,o=l=>l,n=(l,d)=>`${l}: ${d.join(" ")};`){let l="";for(const d of t){const M=`@media ${(d.breakpoint==="-"?[{condition:">=",value:"0"}]:Ee(d.breakpoint)).map(p=>{var v;return`(${(v=p.condition)!=null&&v.includes("<")?"max-width":"min-width"}: ${me[p.value]??p.value})`}).join(" and ")} {${d.values.map(p=>{let v=e;p.sel.length>0&&(v=e===":host"?`:host(:${p.sel})`:`${e}:${p.sel}`);const E=n(s,p.values.map(o));return p.sel==="hover"?`@media (hover: hover) {${v}{${E}}}`:`${v}{${E}}`}).join("")}}`;l+=M}return l}const ps=new Map;function i(e){return(s,t)=>{const o=(e==null?void 0:e.property)??String(t),n=e==null?void 0:e.valueTemplate,l=e==null?void 0:e.styleTemplate,d=(e==null?void 0:e.cacheOverrideKey)??"0";g({attribute:e==null?void 0:e.attribute,noAccessor:!0})(s,t),Object.defineProperty(s,t,{get:function(){return this["__"+String(t)]},set:async function(f){if(!f)return;this["__"+String(t)]=f,await this.updateComplete;const b=(e==null?void 0:e.selector)??this.constructor.styleExpressionBaseSelector,M=this.level??"0",p=b+o+f+M+d;if(ps.has(p)){this._dynamicStylesController.inject(`sep_${String(t)}`,ps.get(p));return}const v=ke(we(f)),E=_e(b,o,v,n==null?void 0:n.bind(this),l==null?void 0:l.bind(this)),N=m(E);ps.set(p,N),this._dynamicStylesController.inject(`sep_${String(t)}`,N)}})}}class Ce extends oe{constructor(s){if(super(s),s.type!==re.ELEMENT)throw new Error("The `forwardAttributes` directive must be used in element bindings")}render(s){return As}update(s,[t]){var l;const o=s.element,n=(l=s.options)==null?void 0:l.host;Array.from(n.attributes).forEach(d=>{t(d)&&o.setAttribute(d.name.replace("gds-",""),d.value)})}}const $e=te(Ce),zs=new WeakMap;function Be(e){return(s,...t)=>{let o=zs.get(s);return o||(o=s.map(n=>n.replace(/\n[\s]+</gm,"<")),o.raw=s.raw,zs.set(s,o)),e(o,...t)}}function Xs(e,s,t){if(e==="transparent"||e==="currentColor"||e==="inherit")return e;const[o,n]=e.split("/");let l;return t&&s==="background"?l=`var(--gds-sys-color-l${t}-${o})`:l=`var(--gds-sys-color-${s}-${o})`,n?`color-mix(in srgb, ${l} ${parseFloat(n)*100}%, transparent 0%)`:l}function gs(e){return{valueTemplate:function(s){return Xs(s,e,this.level)}}}const Z={valueTemplate:e=>`var(--gds-sys-space-${e}, 0)`},Te={valueTemplate:e=>`var(--gds-sys-radius-${e}, 0)`},S={valueTemplate:e=>`var(--gds-sys-space-${Ge(e)}, ${e})`},ys={valueTemplate:e=>{const t=(e.startsWith("-")?"neg":"pos")=="pos"?`var(--gds-sys-space-${e})`:`calc(var(--gds-sys-space-${e.substring(1)}) * -1)`;return e==="auto"?"auto":t},styleTemplate:(e,s)=>{const t=f=>f==="auto"?"auto":`${f}`,o=t(s[0]),n=s.length>1?t(s[1]):o,l=s.length>2?t(s[2]):o,d=s.length>3?t(s[3]):n;return`${e}: ${o} ${n} ${l} ${d};`}};function Ge(e){return e.replace(/[^a-zA-Z0-9-]/g,"")}function Js(e){class s extends e{}return r([i(S)],s.prototype,"width",2),r([i(S)],s.prototype,"min-width",2),r([i(S)],s.prototype,"max-width",2),r([i(S)],s.prototype,"inline-size",2),r([i(S)],s.prototype,"min-inline-size",2),r([i(S)],s.prototype,"max-inline-size",2),s}function Me(e){class s extends e{}return r([i(S)],s.prototype,"height",2),r([i(S)],s.prototype,"min-height",2),r([i(S)],s.prototype,"max-height",2),r([i(S)],s.prototype,"block-size",2),r([i(S)],s.prototype,"min-block-size",2),r([i(S)],s.prototype,"max-block-size",2),s}function $s(e){class s extends e{}return r([i(ys)],s.prototype,"margin",2),r([i(ys)],s.prototype,"margin-inline",2),r([i(ys)],s.prototype,"margin-block",2),s}function De(e){class s extends e{}return r([i(Z)],s.prototype,"padding",2),r([i(Z)],s.prototype,"padding-inline",2),r([i(Z)],s.prototype,"padding-block",2),s}function Bs(e){class s extends e{}return r([i()],s.prototype,"align-self",2),r([i()],s.prototype,"justify-self",2),r([i()],s.prototype,"place-self",2),r([i()],s.prototype,"grid-column",2),r([i()],s.prototype,"grid-row",2),r([i()],s.prototype,"grid-area",2),r([i()],s.prototype,"flex",2),r([i()],s.prototype,"order",2),s}function Ve(e){class s extends e{}return r([i()],s.prototype,"position",2),r([i()],s.prototype,"transform",2),r([i()],s.prototype,"inset",2),s}ds||function(e){if(typeof e.requestSubmit=="function")return;e.requestSubmit=function(o=null){o?(s(o,this),o.click()):(o=document.createElement("input"),o.type="submit",o.hidden=!0,this.appendChild(o),o.click(),this.removeChild(o))};function s(o,n){o instanceof HTMLElement||t(TypeError,"parameter 1 is not of type 'HTMLElement'"),o.type=="submit"||t(TypeError,"The specified element is not a submit button"),o.form==n||t(DOMException,"The specified element is not owned by this form element","NotFoundError")}function t(o,n,l="Error"){throw new o("Failed to execute 'requestSubmit' on 'HTMLFormElement': "+n+".",l)}}(HTMLFormElement.prototype);var h;class k extends F{constructor(){super(),y(this,h),this.required=!1,this.errorMessage="",this.label="",this.name="",this.disabled=!1;try{x(this,h,this.attachInternals())}catch{x(this,h,{form:this.closest("form"),setFormValue:t=>{this._internalValue=t},setValidity:(t,o)=>{a(this,h).validity=t,this.errorMessage=o||""},validationMessage:"",validity:{badInput:!1,customError:!1,patternMismatch:!1,rangeOverflow:!1,rangeUnderflow:!1,stepMismatch:!1,tooLong:!1,tooShort:!1,typeMismatch:!1,valueMissing:!1,valid:!0},willValidate:!0,checkValidity:this.checkValidity.bind(this),reportValidity:this.reportValidity.bind(this)})}}connectedCallback(){if(super.connectedCallback(),typeof this.attachInternals!="function"){const s=this.closest("form");s&&(s.addEventListener("submit",this._handleFormSubmit.bind(this)),s.addEventListener("reset",this.formResetCallback.bind(this)))}}set invalid(s){const t=this.invalid;a(this,h).setValidity({...a(this,h).validity,customError:s,valid:!s},this.errorMessage||this.validationMessage||"   ",this._getValidityAnchor()||void 0),this.requestUpdate("invalid",t),a(this,h).checkValidity()}get invalid(){return!a(this,h).validity.valid}get value(){return this._internalValue}set value(s){this._internalValue=s,a(this,h).setFormValue(s)}get form(){return a(this,h).form}get validity(){return a(this,h).validity}get validationMessage(){return a(this,h).validationMessage}get willValidate(){return a(this,h).willValidate}checkValidity(){if(!this._getValidityAnchor()||!this.validator)return!0;const t=this.invalid,o=this.validator.validate(this)||[{...this.validity,valid:!0},""];return this.errorMessage=o[1]||this.errorMessage,a(this,h).setValidity(o[0],o[1],this._getValidityAnchor()),t!==this.invalid&&(this.requestUpdate("invalid",t),this.dispatchCustomEvent("gds-validity-state",{detail:{valid:this.validity.valid,message:this.validationMessage},composed:!0})),a(this,h).checkValidity()}reportValidity(){return a(this,h).reportValidity()}__handleValueChange(){this.checkValidity()}formResetCallback(){typeof this.value=="string"?this.value="":Array.isArray(this.value)?this.value=[]:this.value=void 0}formAssociatedCallback(s){s==null||s.addEventListener("submit",this._handleFormSubmit.bind(this))}_handleFormSubmit(s){this.checkValidity(),this.validity.valid||s.preventDefault()}}h=new WeakMap;k.formAssociated=!0;r([g({attribute:!1})],k.prototype,"validator",2);r([g({type:Boolean})],k.prototype,"required",2);r([g({attribute:"error-message"})],k.prototype,"errorMessage",2);r([g({type:Boolean,reflect:!0})],k.prototype,"invalid",1);r([g()],k.prototype,"label",2);r([g()],k.prototype,"value",1);r([g({reflect:!0})],k.prototype,"name",2);r([g({type:Boolean,reflect:!0})],k.prototype,"disabled",2);r([Cs("value",{waitUntilFirstUpdate:!0})],k.prototype,"__handleValueChange",1);const ze=w`
...
`;var Ae=ze,J,_,W,Zs,vs,bs;const Le=["aria-label","aria-haspopup","aria-expanded"],Re=Be(Q);class u extends k{constructor(){super(...arguments),y(this,_),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",y(this,J,!1),y(this,vs,()=>{var t;const s=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];x(this,J,s.length===1&&(s[0].tagName.toLowerCase().startsWith("gds-icon")||s[0].getAttribute("name")==="icon")),this.requestUpdate()}),y(this,bs,s=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:s}),this.form&&!a(this,_,W)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}focus(s){var t;(t=this._getValidityAnchor())==null||t.focus(s)}click(){var s;(s=this._getValidityAnchor())==null||s.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),Ns.instance.apply(this,"gds-button")}render(){const s={button:!0,circle:a(this,J),icon:a(this,J),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,_,W)?Ts`a`:Ts`button`;return Ls`
      <${t}
        class=${Qs(s)}
        type="${H(a(this,_,W)?void 0:this.type)}"
        ?disabled="${this.disabled}"
        aria-label=${this.label||As}
        href=${H(a(this,_,W)?this.href:void 0)}
        target=${H(a(this,_,W)?this.target:void 0)}
        rel=${H(a(this,_,W)?this.rel||a(this,_,Zs):void 0)}
        download=${H(a(this,_,W)?this.download:void 0)}
        part="_button"
        @click="${a(this,bs)}"
        ${$e(o=>o.name.startsWith("gds-aria")||o.name==="gds-role"||Le.includes(o.name))}
      >
        <slot name="lead"></slot>
        <slot @slotchange=${a(this,vs)}></slot>
        <slot name="trail"></slot>
        ${se(!this._isUsingTransitionalStyles,()=>Re`<gds-ripple part="_ripple"></gds-ripple>`)}
        </${t}>
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}J=new WeakMap;_=new WeakSet;W=function(){return this.href.length>0};Zs=function(){return this.target==="_blank"?"noreferrer noopener":void 0};vs=new WeakMap;bs=new WeakMap;u.styles=[q,Ae];u.shadowRootOptions={mode:"open",delegatesFocus:!0};r([g({type:Boolean,reflect:!0})],u.prototype,"disabled",2);r([i({selector:".button"})],u.prototype,"justify-content",2);r([g({reflect:!0})],u.prototype,"type",2);r([g({reflect:!0})],u.prototype,"rank",2);r([g({reflect:!0})],u.prototype,"variant",2);r([g({reflect:!0})],u.prototype,"size",2);r([g()],u.prototype,"label",2);r([g()],u.prototype,"href",2);r([g()],u.prototype,"target",2);r([g()],u.prototype,"rel",2);r([g()],u.prototype,"download",2);r([xs("slot:not([name])")],u.prototype,"_mainSlot",2);r([xs(".button")],u.prototype,"_button",2);r([Se({attributes:!0,childList:!1,subtree:!1,characterData:!1})],u.prototype,"_attributeChanged",1);let Ss=class extends Js($s(Bs(u))){};Ss=r([L("gds-button",{dependsOn:[K]})],Ss);const We=w`
  :host {
    display: block;
    box-sizing: border-box;
    border-style: solid;
...
`;var je=We;let c=class extends Js(Me($s(De(Bs(Ve(F)))))){constructor(){super(...arguments),this.level="2"}render(){return Q`<slot></slot>`}};c.styles=[q,je];r([i()],c.prototype,"display",2);r([g()],c.prototype,"level",2);r([i(gs("content"))],c.prototype,"color",2);r([i(gs("background"))],c.prototype,"background",2);r([i({styleTemplate:function(e,s){const t=this,[o,n=t["border-style"]||"solid",l=t["border-color"]||"subtle-01"]=s,d=`var(--gds-sys-space-${o})`,f=Xs(l,"border",t.level);return`border: ${d} ${n} ${f};`}})],c.prototype,"border",2);r([i(gs("border"))],c.prototype,"border-color",2);r([i(Z)],c.prototype,"border-width",2);r([i()],c.prototype,"border-style",2);r([i(Te)],c.prototype,"border-radius",2);r([i({valueTemplate:e=>`var(--gds-sys-shadow-${e}-01), var(--gds-sys-shadow-${e}-02)`})],c.prototype,"box-shadow",2);r([i()],c.prototype,"opacity",2);r([i()],c.prototype,"overflow",2);r([i()],c.prototype,"box-sizing",2);r([i()],c.prototype,"z-index",2);r([i({styleTemplate:(e,s)=>`font: var(--gds-sys-text-${s[0]});`})],c.prototype,"font",2);r([i({valueTemplate:e=>`var(--gds-sys-text-weight-${e})`})],c.prototype,"font-weight",2);r([i()],c.prototype,"text-align",2);r([i()],c.prototype,"text-wrap",2);r([i()],c.prototype,"overflow-wrap",2);r([i()],c.prototype,"white-space",2);r([i({...Z,styleTemplate:(e,s)=>{const t=s[0],o=s[1]||t;return`gap: ${t} ${o};`},cacheOverrideKey:"flex"})],c.prototype,"gap",2);r([i()],c.prototype,"align-items",2);r([i()],c.prototype,"align-content",2);r([i()],c.prototype,"justify-content",2);r([i()],c.prototype,"justify-items",2);r([i()],c.prototype,"flex-direction",2);r([i()],c.prototype,"flex-wrap",2);r([i()],c.prototype,"place-items",2);r([i()],c.prototype,"place-content",2);c=r([L("gds-div")],c);let Y=class extends c{constructor(){super(),this.variant="primary",this.padding="m;m{l}",this["border-radius"]="s",this.gap="m;m{l}"}render(){return Q`<slot></slot>`}};Y.styles=[q,w`
    ...
    `];r([i({styleTemplate:function(e,s){let t,o,n;switch(s[0]){case"primary":t="transparent",o=`var(--gds-sys-color-l${this.level}-neutral-01)`,n="var(--gds-sys-color-content-neutral-01)";break;case"secondary":t="var(--gds-sys-color-border-subtle-01)",o=`var(--gds-sys-color-l${this.level}-neutral-02)`,n="var(--gds-sys-color-content-neutral-01)";break;case"brand-01":t="transparent",o=`var(--gds-sys-color-l${this.level}-brand-01)`,n="var(--gds-sys-color-content-inversed)";break;case"brand-02":t="transparent",o=`var(--gds-sys-color-l${this.level}-brand-02)`,n="var(--gds-sys-color-content-brand-02)";break;case"positive":case"negative":case"warning":case"information":case"notice":t=`var(--gds-sys-color-border-${s[0]}-02)`,o=`var(--gds-sys-color-l${this.level}-${s[0]}-01)`,n=`var(--gds-sys-color-content-${s[0]}-01)`;break;default:t="transparent",o=`var(--gds-sys-color-l${this.level}-neutral-01)`,n="var(--gds-sys-color-content-neutral-01)";break}return`
      ...
      --_background-color: ${o};
      --_color: ${n};
      `}})],Y.prototype,"variant",2);Y=r([L("gds-card")],Y);const Pe=w`
  @layer icon;
...
`;var Fe=Pe;class G extends $s(Bs(F)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const t={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...t,"aria-label":this.label}:{...t,role:"presentation"}}get svgContent(){const s=this.constructor;return this.solid?s._solidSVG:s._regularSVG}applyStroke(s){return this.stroke?s.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):s}generateAttributesString(s){return Object.entries(s).filter(([t,o])=>o!==void 0).map(([t,o])=>`${t}="${o}"`).join(`
    ...
    `;return ms`${ne(o)}`}}G.styles=[q,Fe];r([i({...S,property:"height",selector:"svg"})],G.prototype,"size",2);r([g({type:Boolean})],G.prototype,"solid",2);r([g({type:Number})],G.prototype,"stroke",2);r([g()],G.prototype,"level",2);r([i(gs("content"))],G.prototype,"color",2);r([g({type:String})],G.prototype,"label",2);G.define();const qe=w`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;var Ne=Ue;let T=class extends c{constructor(){super(...arguments),this.tag="span"}render(){const s=ee(encodeURI(this.tag));return Ls`<${s} tag><slot></slot></${s}>`}};T.styles=[q,Oe,Ne];r([g({type:String})],T.prototype,"tag",2);r([i({selector:"[tag]",styleTemplate:(e,s)=>`font: var(--gds-sys-text-${s[0]});`})],T.prototype,"font",2);r([i({selector:"[tag]",valueTemplate:e=>`var(--gds-sys-text-weight-${e})`})],T.prototype,"font-weight",2);r([i()],T.prototype,"text-transform",2);r([i({selector:"[tag]"})],T.prototype,"text-decoration",2);r([i({selector:"[tag]",styleTemplate:(e,s)=>`overflow: hidden;
      text-overflow: ellipsis;
      display: -webkit-box;
      -webkit-line-clamp: ${s[0]};
      -webkit-box-orient: vertical;`})],T.prototype,"lines",2);T=r([L("gds-text")],T);let P=class extends F{constructor(){super(...arguments),this.colorScheme="light",this.designVersion="2023"}connectedCallback(){super.connectedCallback(),Ns.instance.apply(this,"gds-theme"),this._dynamicStylesController.inject("dark",m(`:host {${ss}}`))}render(){return Q`<slot></slot>`}_onColorSchemeChange(){switch(this.colorScheme){case"dark":this._dynamicStylesController.inject("color-scheme",m(`:host { ${ss}}`));break;case"light":this._dynamicStylesController.inject("color-scheme",m(`:host { ${fs}}`));break;case"auto":default:this._dynamicStylesController.inject("color-scheme",m(`:host { ${fs}} @media (prefers-color-scheme: dark) { :host { ${ss} } }`));break}this.dispatchCustomEvent("gds-color-scheme-changed",{detail:{colorScheme:this.colorScheme}})}_onDesignVersionChange(){this.dispatchCustomEvent("gds-design-version-changed",{detail:{designVersion:this.designVersion}})}};P.styles=[q,w`
      :host {
        display: contents;
        color: var(--gds-sys-color-content-neutral-01);
        font-family: var(--gds-sys-text-family);
      }
    `];r([g({reflect:!0,attribute:"color-scheme"})],P.prototype,"colorScheme",2);r([g({reflect:!0,attribute:"design-version"})],P.prototype,"designVersion",2);r([Cs("colorScheme")],P.prototype,"_onColorSchemeChange",1);r([Cs("designVersion")],P.prototype,"_onDesignVersionChange",1);P=r([L("gds-theme")],P);const gt=e=>{cs.define();const s=U("gds-flex"),t={...e,class:e.className};return O.createElement(s,t)},pt=e=>{T.define();const s=U("gds-text"),t={...e,class:e.className};return O.createElement(s,t)},yt=e=>{P.define();const s=U("gds-theme"),t={...e,class:e.className};return O.createElement(s,t)},ft=e=>{z.define();const s=U("gds-icon-brand-green"),t={...e,class:e.className};return O.createElement(s,t)},ht=e=>{A.define();const s=U("gds-icon-square-arrow-top-right"),t={...e,class:e.className};return O.createElement(s,t)};export{G,ft as I,Ns as T,r as _,Js as a,Bs as b,y as c,a as d,F as e,U as f,L as g,yt as h,gt as i,pt as j,nt as k,at as l,ht as m,Q as n,x as o,j as p,Cs as q,c as r,i as s,q as t,$s as w};
