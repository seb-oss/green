...
`;var Ae=ze,J,_,W,Zs,bs,vs;const Le=["aria-label","aria-haspopup","aria-expanded"],Re=Be(Q);class u extends k{constructor(){super(...arguments),y(this,_),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",y(this,J,!1),y(this,bs,()=>{var t;const s=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];x(this,J,s.length===1&&(s[0].tagName.toLowerCase().startsWith("gds-icon")||s[0].getAttribute("name")==="icon")),this.requestUpdate()}),y(this,vs,s=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:s}),this.form&&!a(this,_,W)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}focus(s){var t;(t=this._getValidityAnchor())==null||t.focus(s)}click(){var s;(s=this._getValidityAnchor())==null||s.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),Ns.instance.apply(this,"gds-button")}render(){const s={button:!0,circle:a(this,J),icon:a(this,J),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,_,W)?Ts`a`:Ts`button`;return Ls`
      <${t}
        class=${Qs(s)}
      ...
      >
        ...
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}J=new WeakMap;_=new WeakSet;W=function(){return this.href.length>0};Zs=function(){return this.target==="_blank"?"noreferrer noopener":void 0};bs=new WeakMap;vs=new WeakMap;u.styles=[q,Ae];u.shadowRootOptions={mode:"open",delegatesFocus:!0};r([g({type:Boolean,reflect:!0})],u.prototype,"disabled",2);r([i({selector:".button"})],u.prototype,"justify-content",2);r([g({reflect:!0})],u.prototype,"type",2);r([g({reflect:!0})],u.prototype,"rank",2);r([g({reflect:!0})],u.prototype,"variant",2);r([g({reflect:!0})],u.prototype,"size",2);r([g()],u.prototype,"label",2);r([g()],u.prototype,"href",2);r([g()],u.prototype,"target",2);r([g()],u.prototype,"rel",2);r([g()],u.prototype,"download",2);r([xs("slot:not([name])")],u.prototype,"_mainSlot",2);r([xs(".button")],u.prototype,"_button",2);r([Se({attributes:!0,childList:!1,subtree:!1,characterData:!1})],u.prototype,"_attributeChanged",1);let Ss=class extends Js($s(Bs(u))){};Ss=r([L("gds-button",{dependsOn:[K]})],Ss);const We=w`
  :host {
    display: block;
    box-sizing: border-box;
    border-style: solid;
