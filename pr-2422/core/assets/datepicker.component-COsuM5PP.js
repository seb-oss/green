import{m as u,l as Ot}from"./runtime-CNluP0A8.js";import{T as Q,i as Vt,E as St}from"./lit-element-Bx14lxc-.js";import{n as v,r as H}from"./Reflect-DJ7r0WLU.js";import{e as Rt,a as yt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as qt,t as Kt}from"./directive-CF8sV3Lr.js";import{p as Xt,v as I,r as N,M as U,m as Ht,i as Zt}from"./directive-helpers-BF33kFuJ.js";import{f as Jt}from"./ref-R0wBYijq.js";import{n as E}from"./when-BR7zwNJC.js";import{a as Ut,G as jt}from"./button.component-WUQ40XM0.js";import{G as Qt}from"./dropdown.component-DJDEjdWL.js";import{G as te}from"./flex.component-DrvIPzOi.js";import{G as ee,h as w,g as Yt}from"./gds-element-DTROifYq.js";import{f as se}from"./form-control-host.style-NwoOc8XE.js";import{t as ae}from"./tokens.style-BbYzqIl5.js";import{T as ie}from"./transitional-styles-aKK79zAz.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as $t,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as oe,b as re,d as le}from"./declarative-layout-mixins-DjJmHTNk.js";import{G as he,i as de}from"./calendar.component-DCiHJHPm.js";import{I as pe,a as ue}from"./calender-add.component-CbYNbfIX.js";import{I as ce,a as ge}from"./chevron-right.component-cYDr_oSL.js";import{G as fe}from"./popover.component-CQ-tuEHH.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends qt{constructor(t){if(super(t),t.type!==Kt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let l=0;for(const c of t)a[l]=i?i(c,l):l,n[l]=s(c,l),l++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Xt(t),{values:n,keys:l}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=l,n;const c=this.ut??(this.ut=[]),o=[];let k,M,d=0,b=a.length-1,m=0,C=n.length-1;for(;d<=b&&m<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(c[d]===l[m])o[m]=I(a[d],n[m]),d++,m++;else if(c[b]===l[C])o[C]=I(a[b],n[C]),b--,C--;else if(c[d]===l[C])o[C]=I(a[d],n[C]),N(t,o[C+1],a[d]),d++,C--;else if(c[b]===l[m])o[m]=I(a[b],n[m]),N(t,a[d],a[b]),b--,m++;else if(k===void 0&&(k=Ct(l,m,C),M=Ct(c,d,b)),k.has(c[d]))if(k.has(c[b])){const S=M.get(l[m]),J=S!==void 0?a[S]:null;if(J===null){const xt=N(t,a[d]);I(xt,n[m]),o[m]=xt}else o[m]=I(J,n[m]),N(t,a[d],J),a[S]=null;m++}else U(a[b]),b--;else U(a[d]),d++;for(;m<=C;){const S=N(t,o[C+1]);I(S,n[m]),o[m++]=S}for(;d<=b;){const S=a[d++];S!==null&&U(S)}return this.ut=l,Ht(t,o),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
