...
`,re=s(4851);let le=class extends ee.S{constructor(){super(),(0,W.VK)(this,o),(0,W.VK)(this,x),(0,W.VK)(this,f),(0,W.VK)(this,_),(0,W.VK)(this,$),(0,W.VK)(this,V),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,(0,W.VK)(this,i,void 0),(0,W.VK)(this,r,()=>P.qy`
    ...
    `),(0,W.VK)(this,n,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),(0,W.VK)(this,d,e=>{if(this.combobox){const t=e.getBoundingClientRect(),s=window.innerHeight-t.bottom,i=t.top;let o=Math.min(i,this.maxHeight);return s>i&&(o=Math.min(s,this.maxHeight)),o-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"}),(0,W.VK)(this,c,(e,t)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:t,open:e},bubbles:!1,composed:!1})),(0,W.VK)(this,h,e=>{this.readonly&&e.detail.open?e.preventDefault():(0,W.S7)(this,c).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),(0,W.VK)(this,p,e=>{e.preventDefault(),e.stopPropagation(),(0,W.jq)(this,_,S).call(this,void 0,{beforeDispatch:()=>this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0})})}),(0,W.VK)(this,g,e=>{if(!e.currentTarget)return;if(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}}))return;const t=e.currentTarget;this.options.forEach(e=>e.hidden=!1),t.value&&this.options.filter(e=>!this.searchFilter(t.value,e)).forEach(e=>e.hidden=!0)}),(0,W.VK)(this,u,e=>{"ArrowDown"!==e.key&&"Tab"!==e.key||(e.preventDefault(),(0,W.S7)(this,w).call(this))}),(0,W.VK)(this,y,e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()}),(0,W.VK)(this,b,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),(0,W.VK)(this,v,e=>{const t=e.target;this.options.includes(t)&&(this.multiple?(0,W.jq)(this,_,S).call(this,(0,W.jq)(this,x,m).call(this,t)):(0,W.jq)(this,_,S).call(this,t.value,{beforeDispatch:()=>{(0,W.S7)(this,c).call(this,!1,"close")&&(this.open=!1,setTimeout(()=>this._elTriggerBtn?.focus(),0))}}))}),(0,W.VK)(this,w,()=>{this.updateComplete.then(()=>{const e=this.navigableItems;(e.find(e=>e.selected)||e[0])?.focus()})}),(0,W.VK)(this,k,!1),(0,W.VK)(this,T,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,W.S7)(this,c).call(this,!1,"close")&&(this.open=!1)}),(0,W.VK)(this,E,e=>{"Tab"===e.key&&!this.searchable&&(0,W.S7)(this,c).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}),new G.y(this)}get type(){return"gds-dropdown"}get options(){return(0,W.S7)(this,i)?Array.from((0,W.S7)(this,i)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if((0,W.S7)(this,i))return Array.from((0,W.S7)(this,i)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){if(void 0===this.value)return this.placeholder?.innerText||"";let e;return e=Array.isArray(this.value)?this.value.slice(0,5).reduce((e,t)=>e+this.options.find(e=>this.compareWith(e.value,t))?.innerText+", ","").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):this.options.find(e=>this.compareWith(e.value,this.value))?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}get navigableItems(){return this.options.filter(e=>!e.hidden)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",(0,W.S7)(this,n)),I.n.instance.applyScoped(this,"gds-dropdown","t-listbox"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",(0,W.S7)(this,n))}render(){return P.qy`
      ...
      <gds-popover
        ...
        .floatingUIMiddleware=${this.combobox?[(0,O.cY)(8),(0,O.UU)()]:oe.E.DefaultMiddleware}
      ...
      >
        ...
        >
          ...
          ${(0,H.z)(this.value&&this.multiple&&this.value.length>0,()=>P.qy`<gds-badge
                rounded
              ...
              >`)}
          ${(0,H.z)(this.clearable&&!this.disabled&&!this.readonly&&(Array.isArray(this.value)?this.value.length>0:Boolean(this.value)),()=>P.qy`<gds-button
                id="clear-btn"
                rank="tertiary"
          ...
          ${(0,H.z)(this.combobox&&!this.multiple,()=>(0,W.S7)(this,r).call(this))}
          ${(0,H.z)(!this.combobox||this.multiple,()=>(0,W.S7)(this,l).call(this))}
        ...
        ${(0,H.z)(this.searchable,()=>P.qy`<input
              id="searchinput"
              type="text"
      ...
      ${(0,H.z)((0,W.jq)(this,o,a).call(this),()=>P.qy`
...
`;let S=class extends f.j{constructor(){super(),(0,u.VK)(this,o),(0,u.VK)(this,r),(0,u.VK)(this,n),(0,u.VK)(this,c),(0,u.VK)(this,p),this.size="large",this.multiline=!1,this.disabled=!1,this.readonly=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,(0,u.VK)(this,i,(e,t)=>{const s=t.target.assignedNodes({flatten:!0}),i=s.length>0&&s.some(e=>e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&""!==e.textContent?.trim());"lead"===e?(this._leadSlotOccupied=i,this._leadHasBadge=i&&s.some(e=>"gds-badge"===e.getAttribute?.("gds-element"))):"trail"===e?this._trailSlotOccupied=i:"action"===e&&(this._actionSlotOccupied=i)})}connectedCallback(){super.connectedCallback(),w.n.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,readonly:this.readonly,"lead-slot-occupied":this._leadSlotOccupied||this.readonly,"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:"small"===this.size};return C.qy`
    ...
    `},n=new WeakSet,d=function(){return C.qy`<div
      class="main-slot-wrap ${(0,v.H)({multiline:this.multiline})}"
    >
      <slot
        @slotchange=${e=>(0,u.S7)(this,i).call(this,"main",e)}
      ></slot>
    </div>`},c=new WeakSet,h=function(){return C.qy`
      <slot
        name="action"
        @slotchange=${e=>(0,u.S7)(this,i).call(this,"action",e)}
      ></slot>
    `},p=new WeakSet,g=function(){return C.qy`
      <slot
        name="trail"
        @slotchange=${e=>(0,u.S7)(this,i).call(this,"trail",e)}
      ></slot>
    `},S.styles=[_],(0,u.Cc)([(0,b.MZ)()],S.prototype,"size",2),(0,u.Cc)([(0,b.MZ)({type:Boolean})],S.prototype,"multiline",2),(0,u.Cc)([(0,b.MZ)({type:Boolean,reflect:!0})],S.prototype,"disabled",2),(0,u.Cc)([(0,b.MZ)({type:Boolean,reflect:!0})],S.prototype,"readonly",2),(0,u.Cc)([(0,b.MZ)({type:Boolean})],S.prototype,"invalid",2),(0,u.Cc)([(0,b.P)("slot:not([name])")],S.prototype,"_mainSlotElement",2),(0,u.Cc)([(0,b.wk)()],S.prototype,"_leadSlotOccupied",2),(0,u.Cc)([(0,b.wk)()],S.prototype,"_leadHasBadge",2),(0,u.Cc)([(0,b.wk)()],S.prototype,"_trailSlotOccupied",2),(0,u.Cc)([(0,b.wk)()],S.prototype,"_actionSlotOccupied",2),(0,u.Cc)([(0,k.w)("disabled")],S.prototype,"_handleDisabledChange",1),S=(0,u.Cc)([(0,C.Y$)("gds-field-base",{dependsOn:[m.X]}),(0,y.cc)()],S)},7708(e,t,s){s.d(t,{V:()=>y});var i,o,a=s(745),r=s(9443),l=s(4367),n=s(505),d=s(801),c=s(8745),h=s(3539),p=s(1374),g=s(7526),u=r.AH`
...
`},8057(e,t,s){s(745);var i=s(3578),o=s(505),a=s(7526);const r=e=>{const{type:t,checked:s,indeterminate:r,disabled:l,readonly:n=!1,invalid:d}=e,c={"rbcb--checkbox":"checkbox"===t,"rbcb--radio":"radio"===t,"--checked":s,"--indeterminate":r,"--disabled":l,"--readonly":n,"--invalid":d};return a.qy`
...
//# sourceMappingURL=7612.b5feac6f.iframe.bundle.js.map