"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[7612],{801(e,t,s){s.d(t,{K:()=>f});var i,o,a,r,l,n,d,c,h=s(745),p=s(4367),g=s(3578),u=s(3539),y=s(7526),b=s(5073),v=s(4987),x=s(6312),m=s(9443).AH`
...
`;let f=class extends((0,v.Q8)((0,v.TM)((0,v.lt)(u.j)))){constructor(){super(...arguments),(0,h.VK)(this,i),(0,h.VK)(this,a),(0,h.VK)(this,l),(0,h.VK)(this,d),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=(0,g.H)({badge:!0,[this.variant]:!0,[this.size]:"small"===this.size,notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return y.qy`
      <div class="${e}">
        ${[(0,h.jq)(this,a,r).call(this),(0,h.jq)(this,l,n).call(this),(0,h.jq)(this,d,c).call(this)]}
      </div>
    `}};i=new WeakSet,o=function(e,t){const s=e.target.assignedNodes({flatten:!0});this[t]=s.length>0&&s.some(e=>e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&""!==e.textContent?.trim())},a=new WeakSet,r=function(){if("small"!==this.size||!this.notification)return y.qy`<slot
        name="lead"
        @slotchange=${e=>(0,h.jq)(this,i,o).call(this,e,"leadSlotOccupied")}
      ></slot>`},l=new WeakSet,n=function(){return y.qy`<slot
      @slotchange=${e=>(0,h.jq)(this,i,o).call(this,e,"mainSlotOccupied")}
    ></slot>`},d=new WeakSet,c=function(){return y.qy`<slot name="trail"></slot>`},f.styles=[b.LU,m],(0,h.Cc)([(0,p.MZ)()],f.prototype,"variant",2),(0,h.Cc)([(0,p.MZ)({type:String})],f.prototype,"size",2),(0,h.Cc)([(0,p.MZ)({attribute:"notification",type:Boolean,reflect:!0})],f.prototype,"notification",2),(0,h.Cc)([(0,p.MZ)({attribute:"rounded",type:Boolean,reflect:!0})],f.prototype,"rounded",2),(0,h.Cc)([(0,p.wk)()],f.prototype,"mainSlotOccupied",2),(0,h.Cc)([(0,p.wk)()],f.prototype,"leadSlotOccupied",2),f=(0,h.Cc)([(0,y.Y$)("gds-badge",{dependsOn:[x.o]})],f)},8609(e,t,s){s.d(t,{z:()=>d});var i=s(745),o=s(4367),a=s(5073),r=s(7526),l=s(8833),n=s(9443).AH`
  :host {
    --_border: transparent;
...
`,ae=s(4851);let re=class extends J.S{constructor(){super(),(0,W.VK)(this,o),(0,W.VK)(this,x),(0,W.VK)(this,f),(0,W.VK)(this,_),(0,W.VK)(this,$),(0,W.VK)(this,V),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,(0,W.VK)(this,i,void 0),(0,W.VK)(this,r,()=>D.qy`
      <input
        ...
        @input=${e=>{this.readonly||((0,W.jq)(this,_,S).call(this,e.target.value,{emitChange:!1}),(0,W.S7)(this,g).call(this,e),(0,W.S7)(this,c).call(this,!0,"show")&&(this.open=!0))}}
        @keydown=${e=>{this.readonly||("ArrowDown"===e.key&&(e.preventDefault(),(0,W.S7)(this,c).call(this,!0,"show")&&(this.open=!0),this.updateComplete.then(()=>(0,W.S7)(this,w).call(this))),"Enter"===e.key&&(0,W.jq)(this,_,S).call(this,this.value,{emitInput:!1}))}}
      />
    `),(0,W.VK)(this,l,()=>D.qy`
      <button
        id="trigger"
      ...
      >
        <slot name="trigger">
          <span>${(0,A._)(this.displayValue)}</span>
        </slot>
      </button>
    `),(0,W.VK)(this,n,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),(0,W.VK)(this,d,e=>{if(this.combobox){const t=e.getBoundingClientRect(),s=window.innerHeight-t.bottom,i=t.top;let o=Math.min(i,this.maxHeight);return s>i&&(o=Math.min(s,this.maxHeight)),o-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"}),(0,W.VK)(this,c,(e,t)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:t,open:e},bubbles:!1,composed:!1})),(0,W.VK)(this,h,e=>{this.readonly&&e.detail.open?e.preventDefault():(0,W.S7)(this,c).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),(0,W.VK)(this,p,e=>{e.preventDefault(),e.stopPropagation(),(0,W.jq)(this,_,S).call(this,void 0,{beforeDispatch:()=>this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0})})}),(0,W.VK)(this,g,e=>{if(!e.currentTarget)return;if(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}}))return;const t=e.currentTarget;this.options.forEach(e=>e.hidden=!1),t.value&&this.options.filter(e=>!this.searchFilter(t.value,e)).forEach(e=>e.hidden=!0)}),(0,W.VK)(this,u,e=>{"ArrowDown"!==e.key&&"Tab"!==e.key||(e.preventDefault(),(0,W.S7)(this,w).call(this))}),(0,W.VK)(this,y,e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()}),(0,W.VK)(this,b,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),(0,W.VK)(this,v,e=>{const t=e.target;this.options.includes(t)&&(this.multiple?(0,W.jq)(this,_,S).call(this,(0,W.jq)(this,x,m).call(this,t)):(0,W.jq)(this,_,S).call(this,t.value,{beforeDispatch:()=>{(0,W.S7)(this,c).call(this,!1,"close")&&(this.open=!1,setTimeout(()=>this._elTriggerBtn?.focus(),0))}}))}),(0,W.VK)(this,w,()=>{this.updateComplete.then(()=>{const e=this.navigableItems;(e.find(e=>e.selected)||e[0])?.focus()})}),(0,W.VK)(this,k,!1),(0,W.VK)(this,T,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,W.S7)(this,c).call(this,!1,"close")&&(this.open=!1)}),(0,W.VK)(this,E,e=>{"Tab"===e.key&&!this.searchable&&(0,W.S7)(this,c).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}),new I.y(this)}get type(){return"gds-dropdown"}get options(){return(0,W.S7)(this,i)?Array.from((0,W.S7)(this,i)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if((0,W.S7)(this,i))return Array.from((0,W.S7)(this,i)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){if(void 0===this.value)return this.placeholder?.innerText||"";let e;return e=Array.isArray(this.value)?this.value.slice(0,5).reduce((e,t)=>e+this.options.find(e=>this.compareWith(e.value,t))?.innerText+", ","").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):this.options.find(e=>this.compareWith(e.value,this.value))?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}get navigableItems(){return this.options.filter(e=>!e.hidden)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",(0,W.S7)(this,n)),U.n.instance.applyScoped(this,"gds-dropdown","t-listbox"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",(0,W.S7)(this,n))}render(){return D.qy`
      ${(0,K.z)(!this.plain&&!this.hideLabel,()=>D.qy`
          <gds-form-control-header
            class="size-${this.size}"
            .showExtendedSupportingText="${this.showExtendedSupportingText}"
          >
            <label id="label" for="trigger" slot="label">${this.label}</label>
            ${(0,K.z)(this.supportingText.length>0,()=>D.qy`<span slot="supporting-text" id="supporting-text">
                  ${this.supportingText}
                </span>`)}
            <slot
      ...
      <gds-popover
        ...
        .floatingUIMiddleware=${this.combobox?[(0,H.cY)(8),(0,H.UU)()]:ie.E.DefaultMiddleware}
      ...
      >
        ...
        >
          ...
          ${(0,K.z)(this.value&&this.multiple&&this.value.length>0,()=>D.qy`<gds-badge
                rounded
              ...
              >`)}
          ${(0,K.z)(this.clearable&&!this.disabled&&!this.readonly&&(Array.isArray(this.value)?this.value.length>0:Boolean(this.value)),()=>D.qy`<gds-button
                id="clear-btn"
                rank="tertiary"
          ...
          ${(0,K.z)(this.combobox&&!this.multiple,()=>(0,W.S7)(this,r).call(this))}
          ${(0,K.z)(!this.combobox||this.multiple,()=>(0,W.S7)(this,l).call(this))}
        ...
        ${(0,K.z)(this.searchable,()=>D.qy`<input
              id="searchinput"
              type="text"
        ...
        <div
          ...
          @gds-focus="${(0,W.S7)(this,b)}"
          @keydown=${(0,W.S7)(this,y)}
        >
          <slot></slot>
        </div>
      </gds-popover>

      ${(0,K.z)((0,W.jq)(this,o,a).call(this),()=>D.qy`
          ...
          >
            ...
            <slot id="message" name="message" slot="message">
              <gds-icon-triangle-exclamation
                solid
              ></gds-icon-triangle-exclamation>
              ${this.invalid?this.errorMessage:Z.s6}
            </slot>
          </gds-form-control-footer>
        `)}
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){this.requestUpdate(),(0,W.OV)(this,i,this.querySelectorAll("[gds-element=gds-option]")),this.multiple||(0!==this.options.length||this.placeholder)&&(void 0===this.value?this.placeholder?this.value=this.placeholder.value:this.value=this.options[0]?.value:this.combobox||this.placeholder||void 0!==this.options.find(e=>this.compareWith(e.value,this.value))||(this.value=this.options[0]?.value))}updated(){(0,W.jq)(this,f,C).call(this)}_handleMultipleChange(){this.options.forEach(e=>e.requestUpdate())}get value(){return super.value}set value(e){(0,W.S7)(this,k)||(super.value=e)}_handleOpenChange(){var e=this;const t=this.open;this.options.forEach(e=>e.hidden=!t),t?(0,W.jq)(this,$,M).call(this):((0,W.jq)(this,V,z).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const s=this.options.find(e=>e.selected);requestAnimationFrame((0,q.A)(function*(){yield e.updateComplete,s?.scrollIntoView({block:"center"})}))}};i=new WeakMap,o=new WeakSet,a=function(){return!this.plain},r=new WeakMap,l=new WeakMap,n=new WeakMap,d=new WeakMap,c=new WeakMap,h=new WeakMap,p=new WeakMap,g=new WeakMap,u=new WeakMap,y=new WeakMap,b=new WeakMap,v=new WeakMap,x=new WeakSet,m=function(e){const t=Array.isArray(this.value)?this.value:[],s=e=>t.some(t=>this.compareWith(t,e)),i=!s(e.value);return this.options.filter(t=>t===e?i:s(t.value)).map(e=>e.value)},f=new WeakSet,C=function(){const e=this.multiple?Array.isArray(this.value)?this.value:[]:[this.value];this.options.forEach(t=>{t.selected=e.some(e=>this.compareWith(e,t.value))})},w=new WeakMap,k=new WeakMap,_=new WeakSet,S=function(e,t={}){const{emitInput:s=!0,emitChange:i=!0,beforeDispatch:o}=t;this.value=e,(0,W.OV)(this,k,!0);try{o?.(),s&&this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}),i&&this.dispatchCustomEvent("change",{detail:{value:e},bubbles:!0,composed:!0})}finally{(0,W.OV)(this,k,!1)}},$=new WeakSet,M=function(){this.addEventListener("blur",(0,W.S7)(this,T)),this.addEventListener("gds-blur",(0,W.S7)(this,T)),this.addEventListener("keydown",(0,W.S7)(this,E))},V=new WeakSet,z=function(){this.removeEventListener("blur",(0,W.S7)(this,T)),this.removeEventListener("gds-blur",(0,W.S7)(this,T)),this.removeEventListener("keydown",(0,W.S7)(this,E))},T=new WeakMap,E=new WeakMap,re.styles=[N.LU,P.A,Y.A,oe],(0,W.Cc)([(0,j.MZ)({attribute:"supporting-text"})],re.prototype,"supportingText",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,reflect:!0})],re.prototype,"open",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,reflect:!0})],re.prototype,"searchable",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,reflect:!0})],re.prototype,"multiple",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,reflect:!0})],re.prototype,"clearable",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,reflect:!0})],re.prototype,"combobox",2),(0,W.Cc)([(0,j.MZ)()],re.prototype,"compareWith",2),(0,W.Cc)([(0,j.MZ)()],re.prototype,"searchFilter",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,attribute:"sync-popover-width"})],re.prototype,"syncPopoverWidth",2),(0,W.Cc)([(0,j.MZ)({type:Number,attribute:"max-height"})],re.prototype,"maxHeight",2),(0,W.Cc)([(0,j.MZ)({reflect:!0})],re.prototype,"size",2),(0,W.Cc)([(0,j.MZ)({type:Boolean,attribute:"hide-label"})],re.prototype,"hideLabel",2),(0,W.Cc)([(0,j.MZ)({type:Boolean})],re.prototype,"plain",2),(0,W.Cc)([(0,j.MZ)({type:Boolean})],re.prototype,"disableMobileStyles",2),(0,W.Cc)([(0,j.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],re.prototype,"showExtendedSupportingText",2),(0,W.Cc)([(0,j.P)("#trigger")],re.prototype,"_elTriggerBtn",2),(0,W.Cc)([(0,j.P)("#searchinput")],re.prototype,"_elSearchInput",2),(0,W.Cc)([(0,X.L)({attributes:!0,attributeFilter:["gds-element","value","isplaceholder"],childList:!0,subtree:!0,characterData:!0})],re.prototype,"_handleLightDOMChange",1),(0,W.Cc)([(0,Q.w)("multiple")],re.prototype,"_handleMultipleChange",1),(0,W.Cc)([(0,Q.w)("open")],re.prototype,"_handleOpenChange",1),re=(0,W.Cc)([(0,G.J)({labelledBy:"#trigger",describedBy:"#trigger",errorMessage:"#trigger"}),(0,L.cc)()],re);let le=class extends((0,R.Q8)((0,R.TM)((0,R.lt)(re)))){};le=(0,W.Cc)([(0,D.Y$)("gds-dropdown",{dependsOn:[B.$,F.V,O.w,ae.Y,ie.E,ee.V,te.o,se.r]})],le)},4851(e,t,s){s.d(t,{Y:()=>m});var i,o,a,r=s(745),l=s(4367),n=s(505),d=s(3539),c=s(7526),h=s(4843),p=s(8146),g=s(8057),u=s(5073),y=s(4457),b=s(1374),v=s(4397),x=s(6290);let m=class extends((0,v.z)(d.j)){constructor(){super(),(0,r.VK)(this,o),(0,r.VK)(this,i,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",(0,r.jq)(this,o,a)),this.addEventListener("keydown",e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),(0,r.jq)(this,o,a).call(this,e))})}get hidden(){return(0,r.S7)(this,i)}set hidden(e){const t=e.toString();(0,r.OV)(this,i,"true"===t),(0,r.S7)(this,i)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),y.n.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){const e=this.parentElement?.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),c.qy`<div class="item">
      ${(0,n.z)(e,()=>(0,g.o)({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};i=new WeakMap,o=new WeakSet,a=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})},m.styles=[u.LU,p.A,h.A],(0,r.Cc)([(0,l.MZ)()],m.prototype,"value",2),(0,r.Cc)([(0,l.MZ)({type:Boolean,reflect:!0})],m.prototype,"hidden",1),(0,r.Cc)([(0,l.MZ)({attribute:"aria-selected",reflect:!0,converter:{fromAttribute:e=>"true"===e,toAttribute:e=>e?"true":"false"}})],m.prototype,"selected",2),(0,r.Cc)([(0,l.MZ)({type:Boolean,reflect:!0})],m.prototype,"isPlaceholder",2),(0,r.Cc)([(0,b.w)("isPlaceholder")],m.prototype,"_handlePlaceholderStatusChange",1),m=(0,r.Cc)([(0,c.Y$)("gds-option",{dependsOn:[x.V]})],m)},6312(e,t,s){s.d(t,{o:()=>n});var i=s(745),o=s(5073),a=s(7526),r=s(8833),l=s(9443).AH`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;let M=class extends w.j{constructor(){super(),(0,b.VK)(this,o),(0,b.VK)(this,r),(0,b.VK)(this,n),(0,b.VK)(this,c),(0,b.VK)(this,p),(0,b.VK)(this,u),this.size="large",this.multiline=!1,this.disabled=!1,this.readonly=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,(0,b.VK)(this,i,(e,t)=>{const s=t.target.assignedNodes({flatten:!0}),i=s.length>0&&s.some(e=>e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&""!==e.textContent?.trim());"lead"===e?(this._leadSlotOccupied=i,this._leadHasBadge=i&&s.some(e=>"gds-badge"===e.getAttribute?.("gds-element"))):"trail"===e?this._trailSlotOccupied=i:"action"===e&&(this._actionSlotOccupied=i)})}connectedCallback(){super.connectedCallback(),_.n.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,readonly:this.readonly,"lead-slot-occupied":this._leadSlotOccupied||(0,b.S7)(this,r,l),"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:"small"===this.size};return k.qy`
      <div class="field ${(0,m.H)(e)}" part="_base">
        ${(0,b.jq)(this,o,a).call(this)}
      </div>
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};i=new WeakMap,o=new WeakSet,a=function(){const e={right:!0,"as-flex":this.multiline&&(this._trailSlotOccupied||this._actionSlotOccupied)};return k.qy`
      ${(0,b.jq)(this,n,d).call(this)} ${(0,b.jq)(this,c,h).call(this)}
      <div class="${(0,m.H)(e)}">
        ${(0,b.jq)(this,p,g).call(this)} ${(0,b.jq)(this,u,y).call(this)}
      </div>
    `},r=new WeakSet,l=function(){return this.readonly&&!this._leadSlotOccupied},n=new WeakSet,d=function(){return k.qy`
      ${(0,f.z)((0,b.S7)(this,r,l),()=>k.qy`<gds-icon-lock solid></gds-icon-lock>`)}
      <slot
        name="lead"
        @slotchange=${e=>(0,b.S7)(this,i).call(this,"lead",e)}
      ></slot>
    `},c=new WeakSet,h=function(){return k.qy`<div
      class="main-slot-wrap ${(0,m.H)({multiline:this.multiline})}"
    >
      <slot
        @slotchange=${e=>(0,b.S7)(this,i).call(this,"main",e)}
      ></slot>
    </div>`},p=new WeakSet,g=function(){return k.qy`
      <slot
        name="action"
        @slotchange=${e=>(0,b.S7)(this,i).call(this,"action",e)}
      ></slot>
    `},u=new WeakSet,y=function(){return k.qy`
      <slot
        name="trail"
        @slotchange=${e=>(0,b.S7)(this,i).call(this,"trail",e)}
      ></slot>
    `},M.styles=[$],(0,b.Cc)([(0,x.MZ)()],M.prototype,"size",2),(0,b.Cc)([(0,x.MZ)({type:Boolean})],M.prototype,"multiline",2),(0,b.Cc)([(0,x.MZ)({type:Boolean,reflect:!0})],M.prototype,"disabled",2),(0,b.Cc)([(0,x.MZ)({type:Boolean,reflect:!0})],M.prototype,"readonly",2),(0,b.Cc)([(0,x.MZ)({type:Boolean})],M.prototype,"invalid",2),(0,b.Cc)([(0,x.P)("slot:not([name])")],M.prototype,"_mainSlotElement",2),(0,b.Cc)([(0,x.wk)()],M.prototype,"_leadSlotOccupied",2),(0,b.Cc)([(0,x.wk)()],M.prototype,"_leadHasBadge",2),(0,b.Cc)([(0,x.wk)()],M.prototype,"_trailSlotOccupied",2),(0,b.Cc)([(0,x.wk)()],M.prototype,"_actionSlotOccupied",2),(0,b.Cc)([(0,S.w)("disabled")],M.prototype,"_handleDisabledChange",1),M=(0,b.Cc)([(0,k.Y$)("gds-field-base",{dependsOn:[C.X]}),(0,v.cc)()],M)},7708(e,t,s){s.d(t,{V:()=>y});var i,o,a=s(745),r=s(9443),l=s(4367),n=s(505),d=s(801),c=s(8745),h=s(3539),p=s(1374),g=s(7526),u=r.AH`
...
`;let y=class extends h.j{constructor(){super(...arguments),(0,a.VK)(this,i)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter?.[1])}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return g.qy`<div aria-live="polite">
    ...
    </div>`}};i=new WeakSet,o=function(){if(!this.charCounter||!1===this.charCounter[1])return r.s6;const[e,t]=this.charCounter;return g.qy`<gds-badge variant="${t}">${e}</gds-badge>`},y.styles=[u],(0,a.Cc)([(0,l.MZ)({type:Array})],y.prototype,"charCounter",2),(0,a.Cc)([(0,l.MZ)()],y.prototype,"errorMessage",2),(0,a.Cc)([(0,p.w)("charCounter"),(0,p.w)("errorMessage")],y.prototype,"_handleVisibilityChange",1),y=(0,a.Cc)([(0,g.Y$)("gds-form-control-footer",{dependsOn:[d.K,c.f]})],y)},2655(e,t,s){s.d(t,{$:()=>f});var i,o,a,r,l,n,d,c=s(745),h=s(6743),p=s(4367),g=s(505),u=s(7595),y=s(8609),b=s(4464),v=s(3539),x=s(7526),m=s(9443).AH`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;let f=class extends v.j{constructor(){super(...arguments),(0,c.VK)(this,i),(0,c.VK)(this,n),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,(0,c.VK)(this,a,()=>x.qy`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `},f.styles=[m],(0,c.Cc)([(0,p.MZ)({type:Boolean,reflect:!0})],f.prototype,"showExtendedSupportingText",2),(0,c.Cc)([(0,p.wk)()],f.prototype,"_hasExtendedSupportingText",2),(0,c.Cc)([(0,p.P)("#extended-supporting-text")],f.prototype,"_extendedSupportingText",2),f=(0,c.Cc)([(0,x.Y$)("gds-form-control-header",{dependsOn:[u.t,y.z,b.w]}),(0,h.cc)()],f)},2606(e,t,s){s.d(t,{A:()=>i}),s(745);var i=s(9443).AH`
  * {
    box-sizing: border-box;
  }
...
`},8057(e,t,s){s.d(t,{U:()=>l,o:()=>r}),s(745);var i=s(3578),o=s(505),a=s(7526);const r=e=>n({...e,type:"checkbox"}),l=e=>n({...e,type:"radio"}),n=e=>{const{type:t,checked:s,indeterminate:r,disabled:l,readonly:n=!1,invalid:d}=e,c={"rbcb--checkbox":"checkbox"===t,"rbcb--radio":"radio"===t,"--checked":s,"--indeterminate":r,"--disabled":l,"--readonly":n,"--invalid":d};return a.qy`
    <div class="rbcb ${(0,i.H)(c)}">
  ...
  `}}}]);
//# sourceMappingURL=7612.1f1aab4a.iframe.bundle.js.map