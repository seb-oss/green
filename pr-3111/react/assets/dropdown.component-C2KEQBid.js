import{i as k,t as V,_ as t,g as S,h as r,f as Ce,w as Ee,m as Te,G as B,b as a,d as n,n as o,r as $,c as s,A as ze,e as P}from"./declarative-layout-mixins-23JwzE5k.js";import{l as fe,m as M,s as Ke}from"./runtime-Cgryh99k.js";import{e as q,w as E,a as Xe}from"./watch-rsnQmdjn.js";import{o as Ye}from"./icon.component-BcLGohTe.js";import{n as g}from"./when-CI7b_ccM.js";import{G as Me,o as Je,f as Qe}from"./popover.component-CbHGIqs9.js";import{e as x}from"./class-map-DmdDGNGZ.js";import{a as Ze,I as et,b as tt}from"./chevron-bottom.component-DvVcCgek.js";import{T as ye,c as st}from"./transitional-styles-BOAe6VxU.js";import{a as it,G as at}from"./card.component-e_OUFXa7.js";import{I as ot}from"./triangle-exclamation.component-BXJjuGo2.js";import{G as rt,o as lt,a as nt}from"./button.component-CIbypHwB.js";import{F as dt,m as ct,a as ht,L as pt}from"./menu-listbox.style-CydPXy2L.js";import{I as We}from"./checkmark.component-DlAHefPK.js";import{I as gt}from"./cross-small.component-DCMira9D.js";const ut=k`
  :host {
    display: flex;
...
`;var bt=ut;let G=class extends it{render(){return r`<slot></slot>`}};G.styles=[V,bt];G=t([S("gds-flex")],G);const ft=k`
...
`;var yt=ft,R,ve,U,Oe,K,Le,X,Be;let b=class extends Ce(Ee(Te(B))){constructor(){super(...arguments),a(this,R),a(this,U),a(this,K),a(this,X),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=x({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return r`
      <div class="${e}">
        ${[n(this,U,Oe).call(this),n(this,K,Le).call(this),n(this,X,Be).call(this)]}
      </div>
    `}};R=new WeakSet;ve=function(e,i){const h=e.target.assignedNodes({flatten:!0});this[i]=h.length>0&&h.some(l=>l.nodeType===Node.ELEMENT_NODE||l.nodeType===Node.TEXT_NODE&&l.textContent?.trim()!=="")};U=new WeakSet;Oe=function(){if(this.size!=="small"||!this.notification)return r`<slot
        name="lead"
        @slotchange=${e=>n(this,R,ve).call(this,e,"leadSlotOccupied")}
      ></slot>`};K=new WeakSet;Le=function(){return r`<slot
      @slotchange=${e=>n(this,R,ve).call(this,e,"mainSlotOccupied")}
    ></slot>`};X=new WeakSet;Be=function(){return r`<slot name="trail"></slot>`};b.styles=[V,yt];t([o()],b.prototype,"variant",2);t([o({type:String})],b.prototype,"size",2);t([o({attribute:"notification",type:Boolean,reflect:!0})],b.prototype,"notification",2);t([o({attribute:"rounded",type:Boolean,reflect:!0})],b.prototype,"rounded",2);t([$()],b.prototype,"mainSlotOccupied",2);t([$()],b.prototype,"leadSlotOccupied",2);b=t([S("gds-badge",{dependsOn:[G]})],b);const vt=e=>mt({...e,type:"checkbox"}),mt=e=>{const{type:i,checked:c,indeterminate:h,disabled:l,readonly:u=!1,invalid:A}=e;return r`
...
`;var _t=xt,z,Y,Ae,N,me,xe,De,_e,Fe,we,Ie,ke,He;let p=class extends B{constructor(){super(),a(this,Y),a(this,N),a(this,xe),a(this,_e),a(this,we),a(this,ke),this.size="large",this.multiline=!1,this.disabled=!1,this.readonly=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,a(this,z,(e,i)=>{const h=i.target.assignedNodes({flatten:!0}),l=h.length>0&&h.some(u=>u.nodeType===Node.ELEMENT_NODE||u.nodeType===Node.TEXT_NODE&&u.textContent?.trim()!=="");e==="lead"?(this._leadSlotOccupied=l,this._leadHasBadge=l&&h.some(u=>u.getAttribute?.("gds-element")==="gds-badge")):e==="trail"?this._trailSlotOccupied=l:e==="action"&&(this._actionSlotOccupied=l)})}connectedCallback(){super.connectedCallback(),ye.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,readonly:this.readonly,"lead-slot-occupied":this._leadSlotOccupied||s(this,N,me),"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return r`
    ...
    `};N=new WeakSet;me=function(){return this.readonly&&!this._leadSlotOccupied};xe=new WeakSet;De=function(){return r`
      ${g(s(this,N,me),()=>r`<gds-icon-lock solid></gds-icon-lock>`)}
      <slot
        name="lead"
    ...
    `};ke=new WeakSet;He=function(){return r`
      ...
      ></slot>
    `};p.styles=[_t];t([o()],p.prototype,"size",2);t([o({type:Boolean})],p.prototype,"multiline",2);t([o({type:Boolean,reflect:!0})],p.prototype,"disabled",2);t([o({type:Boolean,reflect:!0})],p.prototype,"readonly",2);t([o({type:Boolean})],p.prototype,"invalid",2);t([q("slot:not([name])")],p.prototype,"_mainSlotElement",2);t([$()],p.prototype,"_leadSlotOccupied",2);t([$()],p.prototype,"_leadHasBadge",2);t([$()],p.prototype,"_trailSlotOccupied",2);t([$()],p.prototype,"_actionSlotOccupied",2);t([E("disabled")],p.prototype,"_handleDisabledChange",1);p=t([S("gds-field-base",{dependsOn:[Ze]}),fe()],p);const wt=k`
...
`;var $t=St,Se,Ge,Q,Z,D,ee,Ne;let w=class extends B{constructor(){super(...arguments),a(this,Se),a(this,ee),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,a(this,Q,()=>r`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",s(this,D))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",s(this,D))}};Se=new WeakSet;Ge=function(e){this._hasExtendedSupportingText=e.target.assignedElements({flatten:!0}).length>0};Q=new WeakMap;Z=new WeakMap;D=new WeakMap;ee=new WeakSet;Ne=function(){return r`
      <div
    ...
    `};w.styles=[$t];t([o({type:Boolean,reflect:!0})],w.prototype,"showExtendedSupportingText",2);t([$()],w.prototype,"_hasExtendedSupportingText",2);t([q("#extended-supporting-text")],w.prototype,"_extendedSupportingText",2);w=t([S("gds-form-control-header",{dependsOn:[rt,at,et]}),fe()],w);var Ct=k`
  * {
    box-sizing: border-box;
  }
...
`;var Tt=Et,W,F,te;let f=class extends dt(B){constructor(){super(),a(this,F),a(this,W,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",n(this,F,te)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),n(this,F,te).call(this,e))})}get hidden(){return s(this,W)}set hidden(e){const i=e.toString();P(this,W,i==="true"),s(this,W)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),ye.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){const e=this.parentElement?.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),r`<div class="item">
      ${g(e,()=>vt({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};W=new WeakMap;F=new WeakSet;te=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};f.styles=[V,st,ct];t([o()],f.prototype,"value",2);t([o({type:Boolean,reflect:!0})],f.prototype,"hidden",1);t([o({attribute:"aria-selected",reflect:!0,converter:{fromAttribute:e=>e==="true",toAttribute:e=>e?"true":"false"}})],f.prototype,"selected",2);t([o({type:Boolean,reflect:!0})],f.prototype,"isPlaceholder",2);t([E("isPlaceholder")],f.prototype,"_handlePlaceholderStatusChange",1);f=t([S("gds-option",{dependsOn:[We]})],f);var v,se,Ve,ie,ae,I,oe,y,re,le,H,ne,de,ce,he,pe,qe,ge,Re,O,L,m,C,ue,je,be,Ue,T,j;let d=class extends nt{constructor(){super(),a(this,se),a(this,pe),a(this,ge),a(this,m),a(this,ue),a(this,be),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,i)=>e===i,this.searchFilter=(e,i)=>i.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,a(this,v,void 0),a(this,ie,()=>r`
      <input
        id="trigger"
        role="combobox"
    ...
    `),a(this,I,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),a(this,oe,e=>{if(this.combobox){const c=e.getBoundingClientRect(),l=window.innerHeight-c.bottom,u=c.top;let A=Math.min(u,this.maxHeight);return l>u&&(A=Math.min(l,this.maxHeight)),`${A-16}px`}return`${Math.min(window.innerHeight,this.maxHeight)-16}px`}),a(this,y,(e,i)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:i,open:e},bubbles:!1,composed:!1})),a(this,re,e=>{if(this.readonly&&e.detail.open){e.preventDefault();return}s(this,y).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),a(this,le,e=>{e.preventDefault(),e.stopPropagation(),n(this,m,C).call(this,void 0,{beforeDispatch:()=>this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0})})}),a(this,H,e=>{if(!e.currentTarget||(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}})))return;const c=e.currentTarget;if(this.options.forEach(l=>l.hidden=!1),!c.value)return;this.options.filter(l=>!this.searchFilter(c.value,l)).forEach(l=>l.hidden=!0)}),a(this,ne,e=>{(e.key==="ArrowDown"||e.key==="Tab")&&(e.preventDefault(),s(this,O).call(this))}),a(this,de,e=>{if(e.key==="Tab"&&this.searchable){e.preventDefault(),this._elSearchInput?.focus();return}}),a(this,ce,e=>{const i=this._elTriggerBtn;i&&(i.ariaActiveDescendantElement=e.target)}),a(this,he,e=>{const i=e.target;this.options.includes(i)&&(this.multiple?n(this,m,C).call(this,n(this,pe,qe).call(this,i)):n(this,m,C).call(this,i.value,{beforeDispatch:()=>{s(this,y).call(this,!1,"close")&&(this.open=!1,setTimeout(()=>this._elTriggerBtn?.focus(),0))}}))}),a(this,O,()=>{this.updateComplete.then(()=>{const e=this.navigableItems;(e.find(i=>i.selected)||e[0])?.focus()})}),a(this,L,!1),a(this,T,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&s(this,y).call(this,!1,"close")&&(this.open=!1)}),a(this,j,e=>{e.key==="Tab"&&!this.searchable&&s(this,y).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}),new pt(this)}get type(){return"gds-dropdown"}get options(){return s(this,v)?Array.from(s(this,v)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if(s(this,v))return Array.from(s(this,v)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){if(this.value===void 0)return this.placeholder?.innerText||"";let e;return Array.isArray(this.value)?e=this.value.slice(0,5).reduce((i,c)=>i+this.options.find(h=>this.compareWith(h.value,c))?.innerText+", ","").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):e=this.options.find(i=>this.compareWith(i.value,this.value))?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}get navigableItems(){return this.options.filter(e=>!e.hidden)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",s(this,I)),ye.instance.applyScoped(this,"gds-dropdown","t-listbox"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",s(this,I))}render(){return r`
