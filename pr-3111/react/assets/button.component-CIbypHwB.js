import{x as q,A as M,i as R,G as W,t as D,_ as s,g as U,D as O,n,b as h,e as _,c as a,s as P,f as I,w as H,m as j,h as X}from"./declarative-layout-mixins-23JwzE5k.js";import{e as x,w as K,a as Y}from"./watch-rsnQmdjn.js";import{e as J}from"./class-map-DmdDGNGZ.js";import{n as Q}from"./when-CI7b_ccM.js";import{T as Z}from"./transitional-styles-BOAe6VxU.js";import{e as tt,i as et,t as rt}from"./icon.component-BcLGohTe.js";const S=Symbol.for(""),ot=r=>{if(r?.r===S)return r?._$litStatic$},xt=r=>({_$litStatic$:r,r:S}),F=(r,...t)=>({_$litStatic$:t.reduce((o,e,l)=>o+(c=>{if(c._$litStatic$!==void 0)return c._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${c}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(e)+r[l+1],r[0]),r:S}),L=new Map,st=r=>(t,...o)=>{const e=o.length;let l,c;const p=[],k=[];let w,u=0,z=!1;for(;u<e;){for(w=t[u];u<e&&(c=o[u],(l=ot(c))!==void 0);)w+=l+t[++u],z=!0;u!==e&&k.push(c),p.push(w),u++}if(u===e&&p.push(t[e]),z){const A=p.join("$$lit$$");(t=L.get(A))===void 0&&(p.raw=p,L.set(A,t=p)),o=k}return r(t,...o)},at=st(q);const b=r=>r??M,it=R`
  :host {
