import"./switch-Co6apAYs.js";import"./flex-DBKPi_Yr.js";import{b as t}from"./iframe-C23GnPn7.js";import"./text-AlEpXYut.js";import"./divider-Buqfsq6e.js";import{a as x}from"./argTableProps-CwmP72kH.js";import"./switch.component-BDlpXw14.js";import"./checkmark.component-BI_B-5ti.js";import"./icon.component-2JRnj-Cc.js";import"./flex.component-DASmqb-J.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-DG7lk5wS.js";import"./default-typography.styles-ABfOuypi.js";const A={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},d={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
