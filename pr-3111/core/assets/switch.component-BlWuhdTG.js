import{i as E,n as p,U as S,l as k,F as V,L as F,C as L,T as M,a0 as O,e as T,h as n,o as W,a as D}from"./iframe-D9F9vJcX.js";import{I as G}from"./checkmark.component-Bel0vMFw.js";const B=E`
...
`,I=B;var j=Object.defineProperty,A=Object.getOwnPropertyDescriptor,y=t=>{throw TypeError(t)},a=(t,e,s,l)=>{for(var o=l>1?void 0:l?A(e,s):e,h=t.length-1,d;h>=0;h--)(d=t[h])&&(o=(l?d(e,s,o):d(o))||o);return l&&o&&j(e,s,o),o},g=(t,e,s)=>e.has(t)||y("Cannot "+s),w=(t,e,s)=>(g(t,e,"read from private field"),s?s.call(t):e.get(t)),u=(t,e,s)=>e.has(t)?y("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),c=(t,e,s)=>(g(t,e,"access private method"),s),r,f,x,_,z,m,C,b,P,$;let i=class extends O{constructor(){super(...arguments),u(this,r),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",u(this,m,()=>{if(this.readonly){this._input.checked=this.checked;return}this.checked=this._input.checked,c(this,r,$).call(this),c(this,r,C).call(this)}),u(this,b,t=>{this.disabled||this.readonly||t.key==="Enter"&&(t.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(t){this._internalValue=t}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(t){this._input?.focus(t)}render(){const t={switch:!0,checked:this.checked,disabled:this.disabled,readonly:this.readonly,"control-start":this.controlPlacement==="start",small:this.size==="small"};return n`
      <label class=${T(t)} for="switch-input">
        ${[c(this,r,f).call(this),c(this,r,x).call(this),c(this,r,z).call(this)]}
      </label>
    `}};r=new WeakSet;f=function(){return n`
      <input
        id="switch-input"
        type="checkbox"
        role="switch"
        ...
        aria-label=${W(this.label?void 0:"Switch")}
    ...
    `};m=new WeakMap;C=function(){c(this,r,P).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})};b=new WeakMap;P=function(){this.checked?this._setFormValue(this._internalValue||"on"):this._setFormValue(null)};$=function(){const t=this._perimeter;t&&(t.classList.remove("ripple"),t.offsetWidth,t.classList.add("ripple"))};i.styles=[I];a([p({type:Boolean,reflect:!0})],i.prototype,"checked",2);a([p({attribute:"control-placement",reflect:!0})],i.prototype,"controlPlacement",2);a([p({reflect:!0})],i.prototype,"size",2);a([S({selector:".switch",valueTemplate:t=>t})],i.prototype,"justify-content",2);a([k('input[type="checkbox"]')],i.prototype,"_input",2);a([k(".perimeter")],i.prototype,"_perimeter",2);i=a([V({labelledBy:"#switch-input",describedBy:"#switch-input",errorMessage:"#switch-input"})],i);let v=class extends F(L(M(i))){};v=a([D("gds-switch",{dependsOn:[G]})],v);export{v as G};
