import{b as e,o as f}from"./iframe-Bzn41Cqm.js";import{a as x}from"./argTableProps-B9o9sCuj.js";import"./dropdown-CtURvLck.js";import"./option-DSFMUCFF.js";import"./menu-heading-CxFGGb2r.js";import"./flex-DFeDoMmc.js";import"./push-D4vB-PfY.js";import"./preload-helper-PPVm8Dsz.js";import"./dropdown.component-CLwlrW8O.js";import"./localized-decorator-YmWhUyDF.js";import"./icon.component-B0MCotOW.js";import"./floating-ui.dom-DzQH3ivI.js";import"./form-control-host.style-CuoqecY0.js";import"./lock.component-DtcgUQkn.js";import"./form-control-header.component-CPyiXCzm.js";import"./badge.component-Bc8PhlFs.js";import"./flex.component-CIHidJru.js";import"./triangle-exclamation.component-CP9Ih-g2.js";import"./card.component-CzQWSGeW.js";import"./circle-info.component-BvR_aMpu.js";import"./menu-listbox.style-D0d9tisS.js";import"./checkmark.component-RnT8aVmb.js";import"./chevron-bottom.component-DLriWnad.js";import"./cross-small.component-gxUSgMyk.js";import"./popover.component-BF-vML1I.js";import"./rbcb-toggle.template-DwSeW5jU.js";import"./menu-heading.component-QsJ1mkQA.js";import"./push.component-Bqm4l8kj.js";const J={title:"Components/Dropdown",component:"gds-dropdown",subcomponents:{GdsOption:"gds-option"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/dropdown)
&nbsp;|&nbsp;
...
field, and it also supports both single and multiple selection.`}}},tags:["autodocs"],argTypes:{...x("gds-dropdown")}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{options:{control:{type:"array"}}},args:{innerHTML:`
    ...
    `,label:"Select an option",supportingText:"Label support text"}},h={...n},t={...n,render:o=>e`
    <gds-dropdown
  ...
  `},i={...n,name:"Custom trigger content",render:o=>{const m=w=>e` <gds-flex
        slot="${f(w)}"
        gap="xs"
        width="100%"
      ...
      >
        ${m("trigger")}
        <gds-option value="v1">${m()}</gds-option>
        <gds-option value="v2">${m()}</gds-option>
        <gds-option value="v3">${m()}</gds-option>
      </gds-dropdown>
  ...
  `},u={...n,render:o=>e`
    <gds-dropdown label="Select tech" readonly value="warp">
      <gds-option value="warp">Warp Drive</gds-option>
      <gds-option value="cybernetics">Cybernetics</gds-option>
      <gds-option value="nanotechnology">Nanotechnology</gds-option>
    </gds-dropdown>
  `},v={...n,name:"ARIA Forwarding",render:()=>e`
...
screen readers.`,...d.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...u.parameters?.docs?.source},description:{story:"The `readonly` property can be set to make the dropdown read-only. Unlike `disabled`, the value is\nstill submitted with the form and the trigger remains focusable, but the popover can't be opened.",...u.parameters?.docs?.description}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...v.parameters?.docs?.source},description:{story:`In some cases it may be necessary to label the dropdown using elements
...
ensure they are only applied to the internal trigger element.`,...v.parameters?.docs?.description}}};const K=["Basic","OptionHeadings","CustomTrigger","SyncedPopoverWidth","Size","HiddenLabel","PlaceholderOptions","Clearable","Searchable","Multiple","Combobox","Validation","Disabled","Readonly","AriaForwarding"];export{v as AriaForwarding,h as Basic,p as Clearable,c as Combobox,i as CustomTrigger,b as Disabled,d as HiddenLabel,g as Multiple,t as OptionHeadings,r as PlaceholderOptions,u as Readonly,l as Searchable,a as Size,s as SyncedPopoverWidth,y as Validation,K as __namedExportsOrder,J as default};
