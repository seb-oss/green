import"./switch-CvfS39r8.js";import"./flex-ClS-Rak4.js";import{b as t}from"./iframe-CNPadLMU.js";import"./text-I0DUdfb6.js";import"./divider-BAynrcG1.js";import{a as x}from"./argTableProps-COpB81kl.js";import"./switch.component-ZqNPOEwb.js";import"./checkmark.component-DH1ZMrV8.js";import"./icon.component-CXBWmE0H.js";import"./flex.component-CoRjFOls.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-DAbnq5Gg.js";import"./default-typography.styles-BAnDJVcY.js";const A={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},d={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
