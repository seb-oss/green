import{i as E,n as p,U as S,l as k,F as V,L as F,C as L,T as M,a0 as O,e as T,h as n,o as W,a as D}from"./iframe-BpAQ9VZy.js";import{I as G}from"./checkmark.component-DVLHqsa3.js";const B=E`
...
`,I=B;var j=Object.defineProperty,A=Object.getOwnPropertyDescriptor,y=t=>{throw TypeError(t)},a=(t,e,s,h)=>{for(var o=h>1?void 0:h?A(e,s):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(o=(h?d(e,s,o):d(o))||o);return h&&o&&j(e,s,o),o},f=(t,e,s)=>e.has(t)||y("Cannot "+s),v=(t,e,s)=>(f(t,e,"read from private field"),s?s.call(t):e.get(t)),u=(t,e,s)=>e.has(t)?y("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),c=(t,e,s)=>(f(t,e,"access private method"),s),r,g,x,_,z,m,C,w,P,$;let i=class extends O{constructor(){super(...arguments),u(this,r),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",u(this,m,()=>{if(this.readonly){this._input.checked=this.checked;return}this.checked=this._input.checked,c(this,r,$).call(this),c(this,r,C).call(this)}),u(this,w,t=>{this.disabled||this.readonly||t.key==="Enter"&&(t.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(t){this._internalValue=t}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(t){this._input?.focus(t)}render(){const t={switch:!0,checked:this.checked,disabled:this.disabled,readonly:this.readonly,"control-start":this.controlPlacement==="start",small:this.size==="small"};return n`
      <label class=${T(t)} for="switch-input">
        ${[c(this,r,g).call(this),c(this,r,x).call(this),c(this,r,z).call(this)]}
      </label>
    `}};r=new WeakSet;g=function(){return n`
      <input
        id="switch-input"
        type="checkbox"
        role="switch"
