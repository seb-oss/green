import{b as e}from"./iframe-Bzn41Cqm.js";import{a as y}from"./argTableProps-B9o9sCuj.js";import"./textarea-CV_F9L4B.js";import"./badge-BBYXUZ9U.js";import"./flex-DFeDoMmc.js";import"./text-lYSBKqbv.js";import"./divider-C2qZarRU.js";import"./credit-card-MrVfXOHk.js";import"./magnifying-glass-BbDwDYaL.js";import"./preload-helper-PPVm8Dsz.js";import"./textarea.component-DrWruIFW.js";import"./localized-decorator-YmWhUyDF.js";import"./query-async-DUwvIZ05.js";import"./form-control-host.style-CuoqecY0.js";import"./lock.component-DtcgUQkn.js";import"./icon.component-B0MCotOW.js";import"./form-control-header.component-CPyiXCzm.js";import"./badge.component-Bc8PhlFs.js";import"./flex.component-CIHidJru.js";import"./triangle-exclamation.component-CP9Ih-g2.js";import"./card.component-CzQWSGeW.js";import"./circle-info.component-BvR_aMpu.js";import"./resize-observer-CfkbZofs.js";import"./cross-small.component-gxUSgMyk.js";import"./text.component-CaLnjFlb.js";import"./default-typography.styles-PZXqhJ0n.js";import"./credit-card.component-eMY_ISvQ.js";import"./magnifying-glass.component-Lqe955XU.js";const H={title:"Components/Textarea",component:"gds-textarea",parameters:{layout:"centered",docs:{description:{component:"A textarea enables multi-line text input from users."}}},tags:["autodocs"],argTypes:{...y("gds-textarea")}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label text"}},v={...t,name:"Default",render:()=>e`
  ...
  `},u={...t,name:"Standard Attributes",render:()=>e`
    <gds-flex flex-direction="column" gap="xl" width="320px">
      <gds-textarea
        label="Label"
  ...
  `},b={...t,name:"Readonly",render:()=>e`
    <gds-flex gap="xl" width="800px">
      ...
      <gds-textarea
        label="Label"
        readonly
        value="Readonly with custom lead"
        supporting-text="Support text"
      >
        <gds-icon-credit-card slot="lead"></gds-icon-credit-card>
      </gds-textarea>
    </gds-flex>
  `},f={...t,name:"Custom counter badge",render:()=>e`
      <gds-textarea
        label="Label"
        maxlength="100"
        .charCounterCallback=${a=>{let r="positive";if(a.value)switch(a.value.length%5){case 0:r="positive";break;case 1:r="negative";break;case 2:r="notice";break;case 3:r="warning";break;case 4:r="information";break}return[a.value.length,r]}}
      >
        <gds-icon-credit-card slot="lead"></gds-icon-credit-card>
      </gds-textarea>
    </gds-flex>
  `},h={...t,name:"ARIA Forwarding",render:()=>e`
  ...
  \`
}`,...i.parameters?.docs?.source},description:{story:'The `size` property controls the font-size of the text in form control header and footer.\n\nThe `size` property can be set to `small` or `large`.<br>\nThe default size is `large`.\n\n```html\n <gds-textarea size="small"></gds-textarea>\n```',...i.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Clearable',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...p.parameters?.docs?.source},description:{story:'The `supporting-text` property can be set to a string to provide additional information about the textarea field.\n\n**@property supporting-text** - Additional information about the textarea field.\n\n```html\n  <gds-textarea label="Label text" supporting-text="Supporting text"></gds-textarea>\n```',...p.parameters?.docs?.description}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
...
\`\`\``,...c.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...b.parameters?.docs?.source},description:{story:"The `readonly` property can be set to make the textarea field read-only.\n\n**@property readonly** - Makes the textarea field read-only. Unlike `disabled`, the value is\nstill submitted with the form and the field remains focusable. A lock icon is displayed in the\n`lead` slot unless a custom `lead` slot is provided.\n\n```html\n <gds-textarea readonly></gds-textarea>\n```",...b.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...f.parameters?.docs?.source},description:{story:"The `charCounterCallback` property can be used to customize the character counter badge.\n\nCheck the [story source](https://github.com/seb-oss/green/blob/main/libs/core/src/components/textarea/textarea.stories.ts) to see the full code for this example, as Storybook strips away property assignments in the code examples.",...f.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...h.parameters?.docs?.source},description:{story:`In some cases it may be necessary to label the textarea using elements
...
ensure they are only applied to the internal textarea element.`,...h.parameters?.docs?.description}}};const J=["Default","Lead","Trail","Length","Rows","Resize","Size","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","Disabled","Readonly","CustomCounterBadge","AriaForwarding"];export{h as AriaForwarding,g as Clearable,f as CustomCounterBadge,v as Default,m as Disabled,x as ExtendedSupportingText,s as Lead,d as Length,b as Readonly,o as Resize,l as Rows,i as Size,u as StandardAttributes,p as SupportingText,n as Trail,c as Validation,J as __namedExportsOrder,H as default};
