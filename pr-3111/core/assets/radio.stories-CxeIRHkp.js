import{b as a}from"./iframe-C23GnPn7.js";import"./radio-group-D0i-ubC-.js";import"./flex-DBKPi_Yr.js";import"./card-CS_uuCYl.js";import"./text-AlEpXYut.js";import"./divider-Buqfsq6e.js";import"./circle-check-CDkRuJnM.js";import"./cross-small-DF8HEKSl.js";import{a as u}from"./argTableProps-CwmP72kH.js";import"./preload-helper-PPVm8Dsz.js";import"./radio-group.component-BSSanFdn.js";import"./toggle-control-base.component-DMc9CT3n.js";import"./localized-decorator-CYeEJ5u0.js";import"./rbcb-toggle.template-DeFqMOzB.js";import"./form-control-header.component-C_JrsW6P.js";import"./badge.component-ZV8Z8xYL.js";import"./flex.component-DASmqb-J.js";import"./triangle-exclamation.component-oHGkANK4.js";import"./icon.component-2JRnj-Cc.js";import"./card.component-yK5tEQu_.js";import"./circle-info.component-DBWCGRoG.js";import"./text.component-DG7lk5wS.js";import"./default-typography.styles-ABfOuypi.js";import"./circle-check.component-DO-7WVoG.js";import"./cross-small.component-DDq5aWEp.js";const N={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],argTypes:{...u("gds-radio-group")},parameters:{docs:{description:{component:`A radio button is a form element that allows users to select one of the predefined set of choices.<br/>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},t={...e,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
    ...
    <form method="dialog">
      <gds-flex flex-direction="column" align-items="flex-start" gap="m">
        <gds-radio-group
          ...
          .validator=${{validate:g=>{if(!g.value)return[{...g.validity,valid:!1,customError:!0},"This is required"]}}}
        >
  ...
  `},p={...e,name:"Do's and don'ts",render:()=>a`
    <gds-flex gap="xl">
  ...
  `},n={...e,name:"Radio group label",render:()=>a`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...o.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
...
In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...d.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...r.parameters?.docs?.source},description:{story:"The `readonly` property can be set to make a radio button read-only. Unlike `disabled`, the radio\nbutton stays focusable, but its checked state can't be changed by the user.",...r.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...s.parameters?.docs?.source},description:{story:`Radio buttons support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the radio group and applies to all radio buttons within.`,...s.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...i.parameters?.docs?.source},description:{story:`Radio buttons can be arranged in two directions:
...
Choose the direction based on available space and number of options.`,...i.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:`While radio groups can be created without a label, it's recommended to always provide one for clarity and accessibility.
The label helps users understand what the options are for.

In certain cases when space is limited, the group label can be omitted.`,...n.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="500px">
      <gds-flex flex-direction="column" gap="m">
  ...
  \`
}`,...l.parameters?.docs?.source},description:{story:"Demonstrates how `gds-aria-labelledby` and `gds-aria-describedby` are\nforwarded for both `gds-radio` and `gds-radio-group`.",...l.parameters?.docs?.description}}};const F=["RadioButton","Validation","DosAndDonts","Disabled","Readonly","Size","Direction","GroupLabel","ARIAForwarding"];export{l as ARIAForwarding,i as Direction,d as Disabled,p as DosAndDonts,n as GroupLabel,t as RadioButton,r as Readonly,s as Size,o as Validation,F as __namedExportsOrder,N as default};
