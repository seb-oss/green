import{b as n}from"./iframe-Bzn41Cqm.js";import"./input-CG02yMZP.js";import"./badge-BBYXUZ9U.js";import"./flex-DFeDoMmc.js";import"./divider-C2qZarRU.js";import"./credit-card-MrVfXOHk.js";import"./people-profile-CjlANeN6.js";import"./magnifying-glass-BbDwDYaL.js";import{a as v}from"./argTableProps-B9o9sCuj.js";import"./preload-helper-PPVm8Dsz.js";import"./input.component-CkB0ZcKD.js";import"./localized-decorator-YmWhUyDF.js";import"./query-async-DUwvIZ05.js";import"./form-control-host.style-CuoqecY0.js";import"./lock.component-DtcgUQkn.js";import"./icon.component-B0MCotOW.js";import"./form-control-header.component-CPyiXCzm.js";import"./badge.component-Bc8PhlFs.js";import"./flex.component-CIHidJru.js";import"./triangle-exclamation.component-CP9Ih-g2.js";import"./card.component-CzQWSGeW.js";import"./circle-info.component-BvR_aMpu.js";import"./cross-small.component-gxUSgMyk.js";import"./textarea.component-DrWruIFW.js";import"./resize-observer-CfkbZofs.js";import"./credit-card.component-eMY_ISvQ.js";import"./cloud-upload.component-gxZOM2ED.js";import"./people-profile.component-4-_DfoBj.js";import"./magnifying-glass.component-Lqe955XU.js";const K={title:"Components/Input",component:"gds-input",parameters:{layout:"centered",docs:{description:{component:"An input lets users enter and edit text or numerical values in forms."}}},tags:["autodocs"],argTypes:{...v("gds-input"),value:{control:"text"},variant:{options:["default"],control:{type:"select"}},size:{options:["large","small"],control:{type:"select"}},invalid:{control:"boolean"}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label",variant:"default",size:"large",supportingText:"Label support text.",innerHTML:'<gds-icon-people-profile slot="lead"></gds-icon-people-profile>'}},h={...t,name:"Default"},i={...t,name:"Size",render:()=>n`
  ...
  `},o={...t,name:"Supporting Text",render:()=>n`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  `},f={...t,name:"Custom counter badge",render:()=>n`
      <gds-input
        label="Label"
        maxlength="100"
  ...
  \`
}`,...s.parameters?.docs?.source},description:{story:'**@slot lead** - Slot for an icon or other content to be placed at the beginning of the input field.\n\n```html\n <gds-input label="Lead Icon">\n   <gds-icon-magnifying-glass slot="lead"></gds-icon-magnifying-glass>\n</gds-input>```',...s.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Slot: Trail',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...r.parameters?.docs?.source},description:{story:'**@slot trail** - Slot for an icon or other content to be placed at the end of the input field.\n\n```html\n <gds-input label="Trail Icon">\n   <gds-badge variant="information" slot="trail">USD</gds-badge>\n</gds-input>```',...r.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Length',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...o.parameters?.docs?.source},description:{story:'The `supporting-text` property can be set to a string to provide additional information about the input field.\n\n**@property supporting-text** - Additional information about the input field.\n\n```html\n  <gds-input label="Label text" supporting-text="Supporting text"></gds-input>\n```',...o.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
...
For inputs, prefer \`gds-aria-*\` attributes over regular \`aria-*\` attributes to
  ...
  \`
}`,...f.parameters?.docs?.source},description:{story:"The `charCounterCallback` property can be used to customize the character counter badge.\n\nCheck the [story source](https://github.com/seb-oss/green/blob/main/libs/core/src/components/input/input.stories.ts) to see the full code for this example, as Storybook strips away property assignments in the code examples.",...f.parameters?.docs?.description}}};const Q=["Default","Size","Lead","Trail","Length","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","FileUpload","AriaForwarding","Disabled","Readonly","CustomCounterBadge"];export{m as AriaForwarding,d as Clearable,f as CustomCounterBadge,h as Default,x as Disabled,p as ExtendedSupportingText,g as FileUpload,s as Lead,l as Length,b as Readonly,i as Size,c as StandardAttributes,o as SupportingText,r as Trail,u as Validation,Q as __namedExportsOrder,K as default};
