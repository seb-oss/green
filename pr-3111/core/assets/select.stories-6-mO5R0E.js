import{b as t}from"./iframe-Bzn41Cqm.js";import{a as c}from"./argTableProps-B9o9sCuj.js";import"./select-CrouuZT3.js";import"./flex-DFeDoMmc.js";import"./bank-CUmBtSe7.js";import"./rocket-CBb2y7sr.js";import"./sun-DJCQYRYf.js";import"./square-grid-circle-CdEGaMoX.js";import"./preload-helper-PPVm8Dsz.js";import"./select.component-Bb-7nET1.js";import"./localized-decorator-YmWhUyDF.js";import"./form-control-host.style-CuoqecY0.js";import"./lock.component-DtcgUQkn.js";import"./icon.component-B0MCotOW.js";import"./form-control-header.component-CPyiXCzm.js";import"./badge.component-Bc8PhlFs.js";import"./flex.component-CIHidJru.js";import"./triangle-exclamation.component-CP9Ih-g2.js";import"./card.component-CzQWSGeW.js";import"./circle-info.component-BvR_aMpu.js";import"./chevron-bottom.component-DLriWnad.js";import"./bank.component-CmxEudbu.js";import"./rocket.component-Co252UYv.js";import"./sun.component-g7eDqpPH.js";import"./square-grid-circle.component-Dr16HqYN.js";const E={title:"Components/Select",component:"gds-select",tags:["autodocs"],argTypes:{...c("gds-select")},parameters:{docs:{description:{component:`A select enables the user to choose a single option from a list.
...
Setting value or selected props on the select element will not work as expected.`}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},o={...e,name:"Select",args:{label:"Label text",supportingText:"Supporting text",value:"",innerHTML:`
  ...
  `},a={...e,name:"Readonly",render:()=>t`
    <gds-flex>
      <gds-select readonly label="Label text" supporting-text="Supporting text">
        <select>
          <option value="thunder">Thunder</option>
  ...
  `},d={...e,name:"ARIA Forwarding",render:()=>t`
...
<br>It is set by adding an icon component to the 'lead' slot.`,...s.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...a.parameters?.docs?.source},description:{story:"The `readonly` property can be set to make the `gds-select` field read-only. Unlike `disabled`, the\nvalue is still submitted with the form and the field remains focusable. A lock icon is displayed in\nthe `lead` slot unless a custom `lead` slot is provided.\n<br> e.g\n\n```html\n<gds-select readonly> ... </gds-select>\n```",...a.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Invalid',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...p.parameters?.docs?.source},description:{story:"The `size` property can be set to 'small' to reduce the size of the select field.<br>\n**@property size** - The size of the select field.\n\n```html\n <gds-select size=\"small\"></gds-select>\n```",...p.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...d.parameters?.docs?.source},description:{story:`In some cases it may be necessary to label the select using elements
...
ensure they are only applied to the internal select element.`,...d.parameters?.docs?.description}}};const F=["Default","Option","Lead","Disabled","Readonly","Invalid","ExtendedSupportingText","Size","AriaForwarding"];export{d as AriaForwarding,o as Default,i as Disabled,r as ExtendedSupportingText,l as Invalid,s as Lead,n as Option,a as Readonly,p as Size,F as __namedExportsOrder,E as default};
