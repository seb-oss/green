import{m as Y}from"./runtime-CMQcyTl6.js";import{n as l,r as z,g as P,h}from"./custom-element-scoping-CpYtbs9r.js";import{a as R}from"./query-p8xgzTDt.js";import{r as G}from"./query-async-MEroNOeJ.js";import{r as H}from"./form-control-footer-6RztezXJ.js";import{n as B}from"./when-BR7zwNJC.js";import{i as F,E as m}from"./lit-element-C_s9q329.js";import{t as I}from"./tokens.style-RalixZsd.js";import{w as X}from"./watch-tFciLXSI.js";import{s as q}from"./style-expression-property-D0nhDdjH.js";import{a as V,f as J}from"./button-DmeQYB9j.js";import"./cross-small-Y_gLfaO0.js";import"./flex-ByyTZdhL.js";const K=F`
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};i=new WeakSet;C=function(){return h`
      ...
      >
        ...
        ${B(this.resize==="auto",()=>a(this,i,O).call(this),()=>m)}
      </gds-flex>
    ...
    `};L=function(){return this.clearable&&this.value.length>0?h`
      ...
      `:m};W=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};r.styles=[I,K];n([l()],r.prototype,"value",2);n([l()],r.prototype,"label",2);n([q({valueTemplate:e=>e,selector:"textarea",styleTemplate:(e,t)=>`min-height: calc(1lh * ${t[0]});`})],r.prototype,"rows",2);n([z()],r.prototype,"lines",2);n([l({attribute:"supporting-text"})],r.prototype,"supportingText",2);n([l({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],r.prototype,"showExtendedSupportingText",2);n([l({attribute:"disabled",type:Boolean,reflect:!0})],r.prototype,"disabled",2);n([l({type:Boolean})],r.prototype,"clearable",2);n([l()],r.prototype,"resize",2);n([l({type:Number})],r.prototype,"maxlength",2);n([l({type:String})],r.prototype,"variant",2);n([G("textarea")],r.prototype,"elTextareaAsync",2);n([R("textarea")],r.prototype,"elTextarea",2);n([z()],r.prototype,"trailSlotOccupied",2);n([X("value")],r.prototype,"_setAutoHeight",1);r=n([P("gds-textarea")],r);
