...
describe('Inputs', () => {
  describe('Checkbox', () => {
    ...
    it('resets correctly', async () => {
      render(<form role="form"><Checkbox label="Input" /></form>)
  ...
  describe('EmailInput', () => {
    ...
    it('resets correctly', async () => {
      render(<form role="form"><EmailInput label="Input" /></form>)
  ...
  describe('NumberInput', () => {
    ...
    it('resets correctly', async () => {
      render(<form role="form"><NumberInput label="Input" /></form>)
  ...
  describe('TextInput', () => {
    ...
    it('resets correctly', async () => {
      render(<form role="form"><TextInput label="Input" /></form>)
