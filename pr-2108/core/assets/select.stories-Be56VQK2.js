import{i as Ce,x as r}from"./lit-element-Bx14lxc-.js";import{a as Ee}from"./argTableProps-Da4_LVLb.js";import{l as Me}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as k,h as u,g as Le}from"./custom-element-scoping-b4c89-hi.js";import{a as he}from"./query-p8xgzTDt.js";import{e as ke}from"./class-map-CXsQwv0r.js";import{G as _e}from"./field-base.component-u2-leZ5O.js";import{G as Ae,a as De}from"./form-control-header.component-CS8g-3iX.js";import{t as ze}from"./tokens.style-BScLRl5F.js";import{o as Oe}from"./observe-light-dom-CmJPHUQ4.js";import{w as Ie}from"./watch-tFciLXSI.js";import{d as qe,w as Te,b as Pe}from"./declarative-layout-mixins-BB4ZLY5n.js";import{a as Ve}from"./button.component-Z9yRxVMZ.js";import{I as Ge}from"./chevron-bottom.component-HDbW-OqF.js";import"./flex-BWkMRSVU.js";import"./square-grid-circle-DxbcSVFt.js";import"./rocket-DTu-IYpc.js";import"./sun-BadCf25O.js";import"./brand-green-C2Hf6gyf.js";import"./custom-elements-BE4y56kO.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./transitional-styles-Dj-EwcI7.js";import"./when-BR7zwNJC.js";import"./badge.component-DR6UPN8j.js";import"./flex.component-d_gd050y.js";import"./div.component-C28DYOrM.js";import"./triangle-exclamation.component-BC2b4__3.js";import"./icon-TXeUf8MR.js";import"./card.component-BfRmn0Qs.js";import"./if-defined-CVqwUuaf.js";import"./static-B8S6DEnV.js";const $e=Ce`
...
`;var Re=Object.defineProperty,Ne=Object.getOwnPropertyDescriptor,ve=e=>{throw TypeError(e)},s=(e,t,o,d)=>{for(var l=d>1?void 0:d?Ne(t,o):t,C=e.length-1,E;C>=0;C--)(E=e[C])&&(l=(d?E(t,o,l):E(l))||l);return d&&l&&Re(t,o,l),l},_=(e,t,o)=>t.has(e)||ve("Cannot "+o),S=(e,t,o)=>(_(e,t,"read from private field"),t.get(e)),M=(e,t,o)=>t.has(e)?ve("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),He=(e,t,o,d)=>(_(e,t,"write to private field"),t.set(e,o),o),p=(e,t,o)=>(_(e,t,"access private method"),o),y,w,i,be,fe,xe,ye,Se,we;let n=class extends Ve{constructor(){super(...arguments),M(this,i),this.supportingText="",this.size="large",M(this,y,!1),M(this,w,e=>{e.stopPropagation(),p(this,i,be).call(this),requestAnimationFrame(()=>{this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})})}get value(){return this._internalValue}set value(e){S(this,y)||He(this,y,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){var e;return((e=this.selectElement)==null?void 0:e.multiple)??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),u`
      ...
      ></gds-form-control-footer>
    `}_captureDOM(){if(!this.shadowRoot||this.childNodes.length===0||!this._elSelectContainer)return;const e=Array.from(this.children).filter(t=>t.nodeName==="SELECT").map(t=>{const o=t.cloneNode(!0);return o.addEventListener("change",S(this,w)),o.addEventListener("input",S(this,w)),o.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),o.setAttribute("id","select"),o.disabled=this.disabled,S(this,y)?o.value=this.value:this.value=o.value,o});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};y=new WeakMap;w=new WeakMap;i=new WeakSet;be=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(t=>t.value)}else this.value=this.selectElement.value};fe=function(){return[p(this,i,xe).call(this),p(this,i,Se).call(this),p(this,i,ye).call(this),p(this,i,we).call(this)].map(t=>u`${t}`)};xe=function(){return u`<slot name="lead" slot="lead"></slot>`};ye=function(){if(!this.multiple)return u`<label id="placeholder">${this.displayValue}</label>`};Se=function(){return u`<div class="select-container"></div>`};we=function(){if(!this.multiple)return u` <gds-icon-chevron-bottom></gds-icon-chevron-bottom> `};n.styles=[ze,$e];s([k({attribute:"supporting-text"})],n.prototype,"supportingText",2);s([k({type:String})],n.prototype,"size",2);s([he("select")],n.prototype,"selectElement",2);s([k()],n.prototype,"value",1);s([he(".select-container")],n.prototype,"_elSelectContainer",2);s([Oe({childList:!0,subtree:!0,attributes:!0,characterData:!0})],n.prototype,"_captureDOM",1);s([Ie("value")],n.prototype,"_handleValueChange",1);n=s([Me()],n);let L=class extends qe(Te(Pe(n))){};L=s([Le("gds-select",{dependsOn:[Ae,De,_e,Ge]})],L);L.define();const wt={title:"Components/Select",component:"gds-select",tags:["autodocs"],argTypes:{...Ee("gds-select")},parameters:{docs:{description:{component:`\`gds-select\` is a wrapper component for the native select element.
...
Setting value or selected props on the select element will not work as expected.`}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},c={...a,name:"Select",args:{label:"Label text",supportingText:"Supporting text",value:"",innerHTML:`
  ...
  `};var A,D,z,O,I;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
    label: 'Label text',
...
}`,...(z=(D=c.parameters)==null?void 0:D.docs)==null?void 0:z.source},description:{story:"Basic example showing the select component with a label, supporting text and a lead icon.\nThe wrapped `<select>` element is making use of `<optgroup>` elements to group the options.",...(I=(O=c.parameters)==null?void 0:O.docs)==null?void 0:I.description}}};var q,T,P,V,G;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Options',
  render: () => html\`
    <gds-flex>
...
<br>It is set by adding an icon component to the 'lead' slot.`,...(B=(H=g.parameters)==null?void 0:H.docs)==null?void 0:B.description}}};var F,W,J,j,U;h.parameters={...h.parameters,docs:{...(F=h.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...
  \`
}`,...(le=(ae=f.parameters)==null?void 0:ae.docs)==null?void 0:le.source},description:{story:"The `multiple` attribute can be set to allow multiple options to be selected on the native `<select>` element.\n\nHowever, it is not recommended to use the native select element in multi-select mode. The native select element does not provide a good user experience for multi-select, especially when there are many options. Prefer to use checkbox groups or the `<gds-dropdown>` component for multi-select functionality instead.",...(pe=(re=f.parameters)==null?void 0:re.docs)==null?void 0:pe.description}}};var ue,de,ce,me,ge;x.parameters={...x.parameters,docs:{...(ue=x.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select Size',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(ce=(de=x.parameters)==null?void 0:de.docs)==null?void 0:ce.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(ge=(me=x.parameters)==null?void 0:me.docs)==null?void 0:ge.description}}};const Ct=["Default","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{c as Default,h as Disabled,g as Lead,f as Multiple,m as Option,x as SelectSize,b as Size,v as Validation,Ct as __namedExportsOrder,wt as default};
