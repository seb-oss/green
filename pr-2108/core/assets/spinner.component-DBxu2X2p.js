import{m as w}from"./runtime-BL31MtW8.js";import{l as y}from"./localized-decorator-DtmrKsyB.js";import{h as m,n as l,r as k,G as _,g as z}from"./custom-element-scoping-b4c89-hi.js";import{e as S}from"./class-map-CXsQwv0r.js";import{n as C}from"./when-BR7zwNJC.js";import{t as x}from"./tokens.style-OWC-W9l-.js";import{w as u}from"./watch-tFciLXSI.js";import{b as A,e as B,d as L}from"./declarative-layout-mixins-DCzV-Sjo.js";import{i as R}from"./lit-element-Bx14lxc-.js";const P=R`
...
`;var E=Object.defineProperty,G=Object.getOwnPropertyDescriptor,g=e=>{throw TypeError(e)},i=(e,r,s,n)=>{for(var o=n>1?void 0:n?G(r,s):r,c=e.length-1,p;c>=0;c--)(p=e[c])&&(o=(n?p(r,s,o):p(o))||o);return n&&o&&E(r,s,o),o},h=(e,r,s)=>r.has(e)||g("Cannot "+s),v=(e,r,s)=>(h(e,r,"read from private field"),s?s.call(e):r.get(e)),f=(e,r,s)=>r.has(e)?g("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,s),M=(e,r,s,n)=>(h(e,r,"write to private field"),r.set(e,s),s),O=(e,r,s)=>(h(e,r,"access private method"),s),d,b,a;let t=class extends A(B(L(_))){constructor(){super(...arguments),f(this,d),this.label=w("Loading..."),this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="md",this._isAnimating=!1,f(this,a,{overflow:"visible",overscrollBehavior:"auto"})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchEvent(new CustomEvent("gds-spinner-connected"))}disconnectedCallback(){super.disconnectedCallback(),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1,super.disconnectedCallback()}_updateAriaLabel(){this.setAttribute("aria-label",this.label)}render(){return m`
      <div part="wrapper" class=${S(O(this,d,b).call(this))}>
    ...
    `}_toggleRootStyles(){const{style:e}=document.documentElement;this.fullscreen?(M(this,a,{overflow:e.overflow,overscrollBehavior:e.overscrollBehavior}),e.overflow="hidden",e.overscrollBehavior="none"):(e.overflow=v(this,a).overflow,e.overscrollBehavior=v(this,a).overscrollBehavior)}};d=new WeakSet;b=function(){return{"spinner-wrapper":!0,"spinner-fullscreen":this.fullscreen,"spinner-cover":this.cover,"spinner-backdrop":this.cover||this.fullscreen,"spinner-animating":this._isAnimating}};a=new WeakMap;t.styles=[x,P];i([l({type:String})],t.prototype,"label",2);i([l({type:Boolean,reflect:!0})],t.prototype,"showLabel",2);i([l({type:Boolean,reflect:!0})],t.prototype,"cover",2);i([l({type:Boolean,reflect:!0})],t.prototype,"fullscreen",2);i([l({type:String,reflect:!0})],t.prototype,"size",2);i([k()],t.prototype,"_isAnimating",2);i([u("label")],t.prototype,"_updateAriaLabel",1);i([u("fullscreen")],t.prototype,"_toggleRootStyles",1);t=i([z("gds-spinner"),y()],t);export{t as G};
