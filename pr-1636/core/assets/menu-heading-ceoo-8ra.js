...
`;var I=Object.defineProperty,L=Object.getOwnPropertyDescriptor,O=(t,e,o,s)=>{for(var n=s>1?void 0:s?L(e,o):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(n=(s?r(e,o,n):r(n))||n);return s&&n&&I(e,o,n),n};let g=class extends w{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then(()=>C.instance.apply(this,"gds-menu-heading"))}render(){return y`<slot></slot>`}};g.styles=E;g=O([k("gds-menu-heading")],g);export{F,D as L,H as s,P as u};
