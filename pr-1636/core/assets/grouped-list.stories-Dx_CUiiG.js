import{k as d}from"./lit-element-BoQqPHl6.js";import"./grouped-list-BrY7Tif4.js";import{r as x}from"./transitional-styles-DcwXctl9.js";import"./gds-element-QykLKB9o.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./when-BxLAFfhK.js";import"./constrain-slots-I5VCMCIw.js";x();const T={title:"Docs/Components/Grouped List",component:"gds-grouped-list",subcomponents:{ListItem:"gds-list-item"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grouped-list)
&nbsp;|&nbsp;
...
<gds-list-item>Item 3</gds-list-item>`,label:"Grouped list label"}},i={...n},t={...n,name:"Grouped list with values",render:r=>d`
  ...
  \`
}`,...(f=(y=e.parameters)==null?void 0:y.docs)==null?void 0:f.source},description:{story:"Elements such as links or buttons can be slotted into the list items.",...(V=(h=e.parameters)==null?void 0:h.docs)==null?void 0:V.description}}};var b,K,k,L,w;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-grouped-list label="Example of left aligned list">
      <gds-list-item style="justify-content: left">
  ...
  \`
}`,...(k=(K=s.parameters)==null?void 0:K.docs)==null?void 0:k.source},description:{story:"The slotted elements can be styled using inline styles or CSS classes.",...(w=(L=s.parameters)==null?void 0:L.docs)==null?void 0:w.description}}};const I=["Basic","WithValues","WithValuesAndAction","AdjustingAppearance"];export{s as AdjustingAppearance,i as Basic,t as WithValues,e as WithValuesAndAction,I as __namedExportsOrder,T as default};
