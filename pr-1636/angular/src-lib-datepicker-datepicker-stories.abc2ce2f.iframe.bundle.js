      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${(0,repeat.u)((0,chunk_SEHSDSX2.S7)(this,_years,years_get),(year=>year),(year=>chunk_VOYMQ322.qy`<gds-option value=${year}>${year}</gds-option>`))}
          </gds-dropdown>
          <gds-button
