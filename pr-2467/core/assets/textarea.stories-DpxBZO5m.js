...
\`\`\``,...(fe=(me=c.parameters)==null?void 0:me.docs)==null?void 0:fe.description}}};var be,he,ve,ye,Le;u.parameters={...u.parameters,docs:{...(be=u.parameters)==null?void 0:be.docs,source:{originalSource:`{
  ...
  \`
}`,...(ke=(Ce=f.parameters)==null?void 0:Ce.docs)==null?void 0:ke.source},description:{story:"The `charCounterCallback` property can be used to customize the character counter badge.\n\nCheck the [story source](https://github.com/seb-oss/green/blob/main/libs/core/src/components/textarea/textarea.stories.ts) to see the full code for this example, as Storybook strips away property assignments in the code examples.",...(Pe=(Re=f.parameters)==null?void 0:Re.docs)==null?void 0:Pe.description}}};const vt=["Default","Lead","Trail","Length","Rows","Resize","Size","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","Disabled","CustomCounterBadge"];export{g as Clearable,f as CustomCounterBadge,b as Default,m as Disabled,x as ExtendedSupportingText,s as Lead,l as Length,o as Resize,d as Rows,i as Size,u as StandardAttributes,p as SupportingText,n as Trail,c as Validation,vt as __namedExportsOrder,ht as default};
