import"./card-01a3a262.js";import"./img-3375bd0b.js";import"./video-6615bdb4.js";import"./container-4a35ecdc.js";import"./flex-c3b70128.js";import"./text-4850abf0.js";import"./divider-cd9c9ded.js";import"./arrow-right-62764848.js";import"./circles-three-f9e80d0b.js";import{x as s}from"./lit-element-2a5e401f.js";import"./gds-element-24e794df.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-681e2422.js";import"./style-expression-property-45d22dc5.js";import"./watch-c4961afe.js";import"./query-b9d3c2af.js";import"./static-50b4adfb.js";import"./icon-9eb1b5fc.js";import"./directive-12249aa5.js";const ts={title:"Docs/Layout/Card",component:"gds-card",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-card` is a custom element that provides a flexible card system.\n\nIt can be used to create a card with different styles and configurations.\n\nThe card can be customized with different properties like `shadow`, `border`, `radius`, and `background`.\nIt is designed to be used in different scenarios like displaying content, images, or other elements.\nIt can be used in combination with other elements like `gds-grid`, `gds-container`, `gds-img`, `gds-text` etc.\n\n@status beta\n\n@extends `gds-container`"}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{disable:!0}}},n={...e,render:d=>s`
  ...
  `},t={...e,name:"Border Style",render:d=>s` <gds-grid columns="5" gap="l">
    ...
    </gds-grid>`},r={...e,name:"Shadow",render:d=>s`<gds-grid columns="5" gap="l">
      <gds-card
        padding="s{xs} m{l} l{l}"
    ...
    </gds-grid>`},i={...e,name:"Background",render:d=>s`<gds-grid columns="4" gap="l">
