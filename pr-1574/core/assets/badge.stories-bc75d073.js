...
`;var $=Object.defineProperty,z=Object.getOwnPropertyDescriptor,E=(s,a,n,d)=>{for(var e=d>1?void 0:d?z(a,n):a,r=s.length-1,o;r>=0;r--)(o=s[r])&&(e=(d?o(a,n,e):o(e))||e);return d&&e&&$(a,n,e),e};let c=class extends D{render(){return T`<div class="badge">
      <slot name="lead"></slot>
      <slot></slot>
      <slot name="trail"></slot>
    </div>`}};c.styles=[O,L(V)];E([P({valueTemplate:s=>`${s}`,selector:".badge",styleTemplate:(s,a)=>{const n=a[0],e={information:{bg:"information",color:"information"},notice:{bg:"notice",color:"notice"},success:{bg:"positive",color:"positive"},warning:{bg:"warning",color:"warning"},error:{bg:"negative",color:"negative"}}[n]||{bg:"default-bg",color:"default-content"},r=`background-color: var(--gds-color-l3c-background-${e.bg}-secondary);`,o=`color: var(--gds-color-l3c-content-${e.color});`;return`${r} ${o}`}})],c.prototype,"variant",2);c=E([B("gds-badge")],c);const Y={title:"Docs/Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:"A badge is a small status or notification indicator that can be used to display a message or status.\n\nVariants: `information`, `notice`, `success`, `warning`, `error`"}}},tags:["autodocs"]},g={name:"Variants",parameters:{controls:{include:[]}},render:s=>l`
  ...
  `},t={name:"Lead",parameters:{controls:{include:[]}},render:s=>l`
  ...
  `},i={name:"Trail",parameters:{controls:{include:[]}},render:s=>l`
    <gds-flex gap="xl" width="20ch">
      <gds-badge variant="success">
  ...
  `};var m,p,b;g.parameters={...g.parameters,docs:{...(m=g.parameters)==null?void 0:m.docs,source:{originalSource:`{
  name: 'Variants',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...(b=(p=g.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var u,f,v,x,h;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: 'Lead',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...(v=(f=t.parameters)==null?void 0:f.docs)==null?void 0:v.source},description:{story:"`gds-badge` has a lead slot that can be used to add leading content to the badge like `gds-icon`.",...(h=(x=t.parameters)==null?void 0:x.docs)==null?void 0:h.description}}};var w,y,k,I,S;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Trail',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...(k=(y=i.parameters)==null?void 0:y.docs)==null?void 0:k.source},description:{story:"`gds-badge` has a trail slot that can be used to add additional content to the badge.",...(S=(I=i.parameters)==null?void 0:I.docs)==null?void 0:S.description}}};const Z=["Variants","Lead","Trail"];export{t as Lead,i as Trail,g as Variants,Z as __namedExportsOrder,Y as default};
