import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as r}from"./iframe-DsuEptRl.js";function g({children:n,badgeType:s,isCloseable:p,closeText:d,customColor:t,customBackgroundColor:o,...i}){const[c,l]=r.useState(!1),[m,a]=r.useState("");return r.useEffect(()=>{s&&a(s),(t||o)&&a("")},[s,t,o]),c?null:e.jsxs("span",{...i,className:`badge ${m}`,style:{color:t,backgroundColor:o},children:[e.jsx("strong",{children:n}),p&&e.jsxs("button",{type:"button",className:"close",onClick:()=>l(!0),children:[d,e.jsx("i",{})]})]})}g.__docgenInfo={description:`Renders a badge component.
