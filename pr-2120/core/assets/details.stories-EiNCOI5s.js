import{i as te,x as C}from"./lit-element-Bx14lxc-.js";import{n as x,G as se,h as y,g as ae}from"./custom-element-scoping-b4c89-hi.js";import{a as T}from"./query-p8xgzTDt.js";import{e as $}from"./class-map-CXsQwv0r.js";import{t as re}from"./tokens.style-C9bLefPj.js";import{w as oe}from"./watch-tFciLXSI.js";import{w as le,b as de,d as me}from"./declarative-layout-mixins-BB4ZLY5n.js";import{G as pe}from"./button.component-Bdos8zoN.js";import"./text-BhQaTdoS.js";import"./card-VanqcJEE.js";import"./flex-DTBzRj2-.js";import"./rich-text-DRnv2pO8.js";import"./chevron-top-D9El-siS.js";import"./chevron-bottom-BFJjDZZx.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./static-B8S6DEnV.js";import"./transitional-styles-BOwn52Fb.js";import"./observe-light-dom-CmJPHUQ4.js";import"./runtime-BL31MtW8.js";import"./text.component-B4D18gL7.js";import"./div.component-DQzJWx6E.js";import"./card.component-URb5HL5V.js";import"./flex.component-QD4FtwzU.js";import"./icon-B_LYY4uq.js";import"./chevron-bottom.component-RgbWsBYZ.js";const ce=te`
  :host {
    display: contents;
  }
`;var ge=Object.defineProperty,he=Object.getOwnPropertyDescriptor,ne=(e,t,s,i)=>{for(var a=i>1?void 0:i?he(t,s):t,l=e.length-1,d;l>=0;l--)(d=e[l])&&(a=(i?d(t,s,a):d(a))||a);return i&&a&&ge(t,s,a),a};let f=class extends se{constructor(){super(...arguments),this.open=!1}render(){return y`
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
    ...
    `}updated(e){var t;if(e.has("open")){const s=(t=this.shadowRoot)==null?void 0:t.querySelector("svg");if(s){const i=new CustomEvent("toggle",{bubbles:!0,composed:!0});s.dispatchEvent(i)}}}};f.styles=[ce];ne([x({type:Boolean,reflect:!0})],f.prototype,"open",2);f=ne([ae("gds-icon-details")],f);const ue=te`
  @layer base, reset;
  @layer base {
    .details {
...
`;var ye=Object.defineProperty,fe=Object.getOwnPropertyDescriptor,ie=e=>{throw TypeError(e)},o=(e,t,s,i)=>{for(var a=i>1?void 0:i?fe(t,s):t,l=e.length-1,d;l>=0;l--)(d=e[l])&&(a=(i?d(t,s,a):d(a))||a);return i&&a&&ye(t,s,a),a},xe=(e,t,s)=>t.has(e)||ie("Cannot "+s),r=(e,t,s)=>(xe(e,t,"read from private field"),s?s.call(e):t.get(e)),m=(e,t,s)=>t.has(e)?ie("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),b,D,S,w,z,_,L;let n=class extends le(de(me(se))){constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",m(this,b,()=>{this.open=!this.open,r(this,w).call(this)}),m(this,D,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),r(this,b).call(this))}),m(this,S,()=>{!this.open||!this.name||document.querySelectorAll('[gds-element="gds-details"]').forEach(e=>{var t;if(e!==this&&e.name===this.name){const s=e;s.open=!1,r(t=s,w).call(t)}})}),m(this,w,()=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))}),m(this,z,()=>y`
    ...
    `}};b=new WeakMap;D=new WeakMap;S=new WeakMap;w=new WeakMap;z=new WeakMap;_=new WeakMap;L=new WeakMap;n.styles=[re,ue];o([x({type:String})],n.prototype,"summary",2);o([x({type:String})],n.prototype,"name",2);o([x({type:Boolean,reflect:!0})],n.prototype,"open",2);o([x({type:String})],n.prototype,"size",2);o([T(".content")],n.prototype,"_content",2);o([T('slot[name="summary-icon-open"]')],n.prototype,"_openIconSlot",2);o([T('slot[name="summary-icon-closed"]')],n.prototype,"_closedIconSlot",2);o([oe("open")],n.prototype,"__handleOpenChange",1);n=o([ae("gds-details",{dependsOn:[pe,f]})],n);n.define();const je={title:"Components/Details",component:"gds-details",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the details header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups detailss together. Detailss with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}},open:{description:"Controls if the details is expanded",control:"boolean",table:{type:{summary:"boolean"}}},size:{description:"Controls the size of the details",control:{type:"select",options:["large","small"]},table:{type:{summary:'"large" | "small"'},defaultValue:{summary:"large"}}}},parameters:{docs:{description:{component:`
## Overview
