import{x as i}from"./lit-element-Bx14lxc-.js";import{a as $}from"./argTableProps-BDhrbSmu.js";import{n as d,g as h}from"./custom-element-scoping-b4c89-hi.js";import{G as _}from"./formatted-text-XC3ZcYtr.js";import"./flex-B8AQUA7n.js";const D={decimalsAndThousands:(e,r,a)=>{const t={maximumFractionDigits:2,minimumFractionDigits:2};return a?new Intl.NumberFormat(r,{...t,style:"currency",currency:a}).format(Number(e)):new Intl.NumberFormat(r,t).format(Number(e))}};var S=Object.defineProperty,C=Object.getOwnPropertyDescriptor,c=(e,r,a,t)=>{for(var n=t>1?void 0:t?C(r,a):r,u=e.length-1,l;u>=0;u--)(l=e[u])&&(n=(t?l(r,a,n):l(n))||n);return t&&n&&S(r,a,n),n};let s=class extends _{constructor(){super(...arguments),this.format="decimalsAndThousands"}get formattedValue(){return D[this.format](this.value,this.locale,this.currency)}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};c([d({attribute:!1})],s.prototype,"value",2);c([d({type:String})],s.prototype,"locale",2);c([d({type:String})],s.prototype,"currency",2);c([d({type:String})],s.prototype,"format",2);s=c([h("gds-formatted-number")],s);s.define();const F={title:"Components/Formatted Text/Number",component:"gds-formatted-number",tags:["autodocs"],argTypes:{...$("gds-formatted-number"),currency:{type:"string"}},parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/formatted-text/number)\n\n`gds-formatted-number` extends `gds-text` and formats the number to the desired format.\n\n@beta"}}}},v={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{locale:"sv-SE",value:1234.5}},o={...v,name:"Default",render:e=>i`<gds-flex gap="m" flex-direction="column">
      ...
      ></gds-flex
    >`},P=["SEK","EUR"],m={...v,name:"Currencies",render:e=>i`<gds-flex flex-direction="column" gap="m">
...
}`,...(y=(x=m.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};const N=["Default","Currencies"],G=Object.freeze(Object.defineProperty({__proto__:null,Currencies:m,Default:o,__namedExportsOrder:N,default:F},Symbol.toStringTag,{value:"Module"}));export{o as D,s as G,G as f,D as n};
