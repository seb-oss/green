...
`;let GdsDropdown=class extends form_control.S{constructor(){super(...arguments),(0,chunk_QTSIPXV3.VK)(this,_shouldShowFooter),(0,chunk_QTSIPXV3.VK)(this,_handleSelectionChange),(0,chunk_QTSIPXV3.VK)(this,_registerAutoCloseListener),(0,chunk_QTSIPXV3.VK)(this,_unregisterAutoCloseListener),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.combobox=!1,this.compareWith=(a,b)=>a===b,this.searchFilter=(q,o)=>o.innerHTML.toLowerCase().includes(q.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,(0,chunk_QTSIPXV3.VK)(this,_optionElements,void 0),(0,chunk_QTSIPXV3.VK)(this,_renderCombobox,(()=>custom_element_scoping.qy`
      <input
        id="trigger"
        role="combobox"
    ...
    `)),(0,chunk_QTSIPXV3.VK)(this,_calcMaxHeight,(trigger=>{if(this.combobox){const triggerRect=trigger.getBoundingClientRect(),bottomSpace=window.innerHeight-triggerRect.bottom,topSpace=triggerRect.top;let height2=Math.min(topSpace,this.maxHeight);return bottomSpace>topSpace&&(height2=Math.min(bottomSpace,this.maxHeight)),height2-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"})),(0,chunk_QTSIPXV3.VK)(this,_dispatchUISateEvent,((toState,reason)=>this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{reason,open:toState},bubbles:!1,composed:!1,cancelable:!0})))),(0,chunk_QTSIPXV3.VK)(this,_handlePopoverStateChange,(e=>{(0,chunk_QTSIPXV3.S7)(this,_dispatchUISateEvent).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)})),(0,chunk_QTSIPXV3.VK)(this,_handleSearchFieldInput,(e=>{if(!e.currentTarget)return;e.stopPropagation();if(!this.dispatchEvent(new CustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value},cancelable:!0})))return;const input=e.currentTarget;if(this.options.forEach((o=>o.hidden=!1)),!input.value)return;this.options.filter((o=>!this.searchFilter(input.value,o))).forEach((o=>o.hidden=!0))})),(0,chunk_QTSIPXV3.VK)(this,_handleSearchFieldKeyDown,(e=>{this._elListbox?.then((listbox=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void listbox.focus()}))})),(0,chunk_QTSIPXV3.VK)(this,_handleListboxKeyDown,(e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()})),(0,chunk_QTSIPXV3.VK)(this,_handleOptionFocusChange,(e=>{const triggerButton=this._elTriggerBtn;triggerButton&&(triggerButton.ariaActiveDescendantElement=e.target)})),(0,chunk_QTSIPXV3.VK)(this,_dispatchInputEvent,(()=>{this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))})),(0,chunk_QTSIPXV3.VK)(this,_dispatchChangeEvent,(()=>{this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})),(0,chunk_QTSIPXV3.VK)(this,_blurCloseListener,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,chunk_QTSIPXV3.S7)(this,_dispatchUISateEvent).call(this,!1,"close")&&(this.open=!1)})),(0,chunk_QTSIPXV3.VK)(this,_tabCloseListener,(e=>{"Tab"===e.key&&!this.searchable&&(0,chunk_QTSIPXV3.S7)(this,_dispatchUISateEvent).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}))}get type(){return"gds-dropdown"}get options(){return(0,chunk_QTSIPXV3.S7)(this,_optionElements)?Array.from((0,chunk_QTSIPXV3.S7)(this,_optionElements)).filter((o=>!o.hasAttribute("isplaceholder"))):[]}get placeholder(){if((0,chunk_QTSIPXV3.S7)(this,_optionElements))return Array.from((0,chunk_QTSIPXV3.S7)(this,_optionElements)).find((o=>o.hasAttribute("isplaceholder")))}get displayValue(){let displayValue;return displayValue=Array.isArray(this.value)?this.value.length>2?(0,lit_localize.ab)(lit_localize.gx`${this.value.length} selected`):this.value.reduce(((acc,cur)=>acc+this.options.find((v=>v.value===cur))?.innerHTML+", "),"").slice(0,-2):this.options.find((v=>v.selected))?.innerHTML,displayValue||this.placeholder?.innerHTML||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()}))}render(){return custom_element_scoping.qy`
      ...
      ${(0,when.z)((0,chunk_QTSIPXV3.jq)(this,_shouldShowFooter,shouldShowFooter_fn).call(this),(()=>custom_element_scoping.qy`
...
`}}]);
//# sourceMappingURL=1834.6a1557cd.iframe.bundle.js.map