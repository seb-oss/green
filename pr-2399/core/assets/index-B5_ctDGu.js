...
`;var Ae=ze,J,C,W,Zs,bs,vs;const Le=["aria-label","aria-haspopup","aria-expanded"],Re=Te(Q);class u extends k{constructor(){super(...arguments),y(this,C),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",y(this,J,!1),y(this,bs,()=>{var t;const s=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];S(this,J,s.length===1&&(s[0].tagName.toLowerCase().startsWith("gds-icon")||s[0].getAttribute("name")==="icon")),this.requestUpdate()}),y(this,vs,s=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:s}),this.form&&!a(this,C,W)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),Ns.instance.apply(this,"gds-button")}focus(s){var t;(t=this._getValidityAnchor())==null||t.focus(s)}render(){const s={button:!0,circle:a(this,J),icon:a(this,J),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,C,W)?Gs`a`:Gs`button`;return Ls`
      ...
      >
        ...
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}J=new WeakMap;C=new WeakSet;W=function(){return this.href.length>0};Zs=function(){return this.target==="_blank"?"noreferrer noopener":void 0};bs=new WeakMap;vs=new WeakMap;u.styles=[q,Ae];u.shadowRootOptions={mode:"open",delegatesFocus:!0};r([g({type:Boolean,reflect:!0})],u.prototype,"disabled",2);r([i({selector:".button"})],u.prototype,"justify-content",2);r([g({reflect:!0})],u.prototype,"type",2);r([g({reflect:!0})],u.prototype,"rank",2);r([g({reflect:!0})],u.prototype,"variant",2);r([g({reflect:!0})],u.prototype,"size",2);r([g()],u.prototype,"label",2);r([g()],u.prototype,"href",2);r([g()],u.prototype,"target",2);r([g()],u.prototype,"rel",2);r([g()],u.prototype,"download",2);r([Ss("slot:not([name])")],u.prototype,"_mainSlot",2);r([Ss(".button")],u.prototype,"_button",2);r([me({attributes:!0,childList:!1,subtree:!1,characterData:!1})],u.prototype,"_attributeChanged",1);let ms=class extends Js($s(Ts(u))){};ms=r([L("gds-button",{dependsOn:[K]})],ms);const We=w`
  :host {
    display: block;
    box-sizing: border-box;
    border-style: solid;
...
`;var Fe=Pe;class M extends $s(Ts(F)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const t={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...t,"aria-label":this.label}:{...t,role:"presentation"}}get svgContent(){const s=this.constructor;return this.solid?s._solidSVG:s._regularSVG}applyStroke(s){return this.stroke?s.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):s}generateAttributesString(s){return Object.entries(s).filter(([t,o])=>o!==void 0).map(([t,o])=>`${t}="${o}"`).join(`
    ...
    `;return xs`${ne(o)}`}}M.styles=[q,Fe];r([i({...m,property:"height",selector:"svg"})],M.prototype,"size",2);r([g({type:Boolean})],M.prototype,"solid",2);r([g({type:Number})],M.prototype,"stroke",2);r([g()],M.prototype,"level",2);r([i(gs("content"))],M.prototype,"color",2);r([g({type:String})],M.prototype,"label",2);M.define();const qe=w`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;var Ne=Ue;let G=class extends c{constructor(){super(...arguments),this.tag="span"}render(){const s=ee(encodeURI(this.tag));return Ls`<${s} tag><slot></slot></${s}>`}};G.styles=[q,Oe,Ne];r([g({type:String})],G.prototype,"tag",2);r([i({selector:"[tag]",styleTemplate:(e,s)=>`font: var(--gds-sys-text-${s[0]});`})],G.prototype,"font",2);r([i({selector:"[tag]",valueTemplate:e=>`var(--gds-sys-text-weight-${e})`})],G.prototype,"font-weight",2);r([i()],G.prototype,"text-transform",2);r([i({selector:"[tag]"})],G.prototype,"text-decoration",2);r([i({selector:"[tag]",styleTemplate:(e,s)=>`overflow: hidden;
      text-overflow: ellipsis;
      display: -webkit-box;
    ...
    `];r([g({reflect:!0,attribute:"color-scheme"})],P.prototype,"colorScheme",2);r([g({reflect:!0,attribute:"design-version"})],P.prototype,"designVersion",2);r([Es("colorScheme")],P.prototype,"_onColorSchemeChange",1);r([Es("designVersion")],P.prototype,"_onDesignVersionChange",1);P=r([L("gds-theme")],P);const gt=e=>{cs.define();const s=U("gds-flex"),t={...e,class:e.className};return O.createElement(s,t)},pt=e=>{G.define();const s=U("gds-text"),t={...e,class:e.className};return O.createElement(s,t)},yt=e=>{P.define();const s=U("gds-theme"),t={...e,class:e.className};return O.createElement(s,t)},ft=e=>{z.define();const s=U("gds-icon-brand-green"),t={...e,class:e.className};return O.createElement(s,t)},ht=e=>{A.define();const s=U("gds-icon-square-arrow-top-right"),t={...e,class:e.className};return O.createElement(s,t)};export{M as G,ft as I,Ns as T,r as _,Js as a,Ts as b,y as c,a as d,F as e,U as f,L as g,yt as h,gt as i,pt as j,nt as k,at as l,ht as m,Q as n,S as o,j as p,Es as q,c as r,i as s,q as t,$s as w};
