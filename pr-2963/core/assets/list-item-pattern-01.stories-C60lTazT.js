import{b as s}from"./iframe-oKN12R8m.js";import{a as c}from"./argTableProps-C8dEnH4v.js";import{G as p}from"./list-item-pattern-01.component-CTK62wP9.js";import"./cloudy-sun-DMnnLw-B.js";import"./text-BqgjERau.js";import"./link-gSZ37R8s.js";import"./flex-CVMQ3wdb.js";import"./list-item-DhVoylAW.js";import"./card-BmR6cwu7.js";import"./avatar-jB8hTpTl.js";import"./preload-helper-PPVm8Dsz.js";import"./flex.component-VMy8uwuh.js";import"./checkmark.component-DVVsCYvN.js";import"./icon.component-CvvS0zww.js";import"./chevron-right.component-Bzw-8nW7.js";import"./minus-small.component-BijPVJCo.js";import"./text.component-DBo6gfqP.js";import"./default-typography.styles-DZv3zCGx.js";import"./rbcb-toggle.template-Da4vCu-0.js";import"./resize-observer-CfkbZofs.js";import"./props-link-D5JRB0WB.js";import"./cloudy-sun.component-BwGWW-c-.js";import"./card.component-DxioZnFJ.js";import"./avatar.component-EaCYiMEd.js";import"./people-profile.component-XOBUn74A.js";p.define();const t=e=>Array.from({length:e},(u,o)=>({label:`Item ${o+1}`,value:`Value ${o+1}`})),K={title:"Patterns/List Item Pattern 01",component:"gds-list-item-pattern-01",tags:["autodocs"],argTypes:{...c("gds-list-item-pattern-01")},parameters:{docs:{description:{component:"A list container (`gds-list-pattern-01`) holding one or more row items\n(`gds-list-item-pattern-01`). Together they render a semantic `gds-list`\nwith configurable row slots:\n\n- **Lead**: shows a checkbox when `selectable` is set on the item.\n- **Main**: renders columns from `items`, or falls back to the default slot.\n- **Trail**: shows a chevron link when `href` is set on the item, or accepts custom content via the `trail` slot.\n\nThe row supports three main states:\n- **Selectable**: shows a checkbox in the lead and allows toggling the `checked` state.\n- **Navigational**: shows a chevron in the trail and applies a hover state to the entire row.\n- **Default**: no checkbox or chevron, used for simple lists or when custom content is projected in the lead/trail."}}}},n={render:()=>s`
