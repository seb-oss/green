import{i as l,H as c,I as g,z as h,v as u,n as p,J as m,g as b}from"./iframe-DGk7TTdX.js";import{d as y}from"./default-typography.styles-aD51MsRc.js";const f=l`
  :host {
...
`;var x=Object.defineProperty,v=Object.getOwnPropertyDescriptor,d=(r,e,a,o)=>{for(var t=o>1?void 0:o?v(e,a):e,n=r.length-1,i;n>=0;n--)(i=r[n])&&(t=(o?i(e,a,t):i(t))||t);return o&&t&&x(e,a,t),t};let s=class extends c(g(h)){constructor(){super(...arguments),this.captureMode="clone"}querySelectorAll(r){return this.shadowRoot?this.shadowRoot.querySelectorAll(r):new NodeList}querySelector(r){return this.shadowRoot?this.shadowRoot.querySelector(r):null}get innerHTML(){return this.shadowRoot?.innerHTML||""}set innerHTML(r){this.shadowRoot&&(this.shadowRoot.innerHTML=r)}connectedCallback(){super.connectedCallback(),this._captureDOM()}_captureDOM(){if(!this.shadowRoot||this.childNodes.length===0)return;if(this.captureMode==="move"){this.shadowRoot.replaceChildren(...Array.from(this.childNodes));return}const r=Array.from(this.childNodes).map(e=>e.cloneNode(!0));this.shadowRoot.replaceChildren(...r)}};s.styles=[u,y,f];d([p()],s.prototype,"captureMode",2);d([m({childList:!0,subtree:!0,attributes:!0,characterData:!0})],s.prototype,"_captureDOM",1);s=d([b("gds-rich-text")],s);export{s as G};
