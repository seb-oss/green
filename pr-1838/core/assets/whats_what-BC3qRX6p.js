import{j as e}from"./jsx-runtime-xnD4X_Tq.js";import{u as s}from"./index-lBOJPu78.js";import"./chunk-HLWAVYOI-JNQYVCbm.js";import{ae as r}from"./index-CcsXxaI-.js";import{S as i}from"./Mermaid-CkREKs5M.js";import"./iframe-BVX3XlJw.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function t(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"What's what?"}),`
...
`,e.jsxs(n.p,{children:["All the components in Green Core is implemented as ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/API/Web_components",rel:"nofollow",children:"Web Components"})," using the ",e.jsx(n.a,{href:"https://lit.dev/",rel:"nofollow",children:"Lit"})," library. This means that they are framework agnostic and can be used with any framework, or even without a framework. The components makes use of ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/API/Web_components/Using_shadow_DOM",rel:"nofollow",children:"Shadow DOM"})," to encapsulate their styles and behavior, so they won't interfere with the rest of your application."]}),`
`,e.jsx(n.p,{children:"The reason the components use Shadow DOM is twofold:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Provide style encapsulation to protect against conflicts which often occurs in a micro-frontend environment"}),`
`,e.jsx(n.li,{children:"Put constraints on the design itself. When a feature is missing, it is important that it is implemented in the Design System and designed according to brand guidelines following all the principles that are in place. If every team/developer were to add their own tweaks, consistency goes out the window. So while this restriction can be seen as a limitation and be inconvientent at times, it serves an important purpose in the larger context of the Design System."}),`
`]}),`
...
`,e.jsxs(n.p,{children:["The CSS ",e.jsx(n.code,{children:"font-family"})," property is inherited though shadow DOM boundaries, so the components will render whichever font is set by their parent."]})]})}function y(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{y as default};
