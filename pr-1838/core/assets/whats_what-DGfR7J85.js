import{j as e}from"./jsx-runtime-BVC8pOWj.js";import{u as r}from"./index-CCLPdD2s.js";import"./chunk-HLWAVYOI-BgciP4vN.js";import{ae as s}from"./index-C6pex4Xz.js";import{S as i}from"./Mermaid-BRtvVcOX.js";import"./iframe-Da8yt7fY.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function t(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"What's what?"}),`
...
`,e.jsx(n.p,{children:`Green currently has components libraries for React and Angular, underpinned by a library of framework agnostic Web Components called Green Core. There is also a design token package, a fonts package and a CSS package.
...
`,e.jsxs(n.p,{children:["The CSS ",e.jsx(n.code,{children:"font-family"})," property is inherited though shadow DOM boundaries, so the components will render whichever font is used in the parent document."]})]})}function f(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{f as default};
