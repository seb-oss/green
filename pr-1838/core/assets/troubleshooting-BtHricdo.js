import{j as e}from"./jsx-runtime-B_mF051Z.js";import{u as t}from"./index-DfFmxqC-.js";import"./chunk-HLWAVYOI-CxknjFdr.js";import{ae as i}from"./index-5Tq34a0F.js";import"./iframe-Cc4s_Lz-.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function s(o){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guides/Troubleshooting"}),`
...
`,e.jsx(n.p,{children:"I'm trying to get 2016 design"}),`
...
`})})]}),`
`,e.jsx(n.p,{children:"I'm trying to get 2023 design"}),`
`,e.jsxs("details",{children:[e.jsx(n.p,{children:"The 2023 design is the default design for Green Core components, so if you are not seeing the correct styling, there might be a few different reasons:"}),e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Transitional Styles are loaded for the component. This will override the 2023 styles with 2016 styles."}),`
`,e.jsx(n.li,{children:"The component is an older one that has not been updated to the 2023 design yet."}),`
`]}),e.jsx(n.p,{children:"To solve the first problem, and if all instances of a component should use 2023 design in your app, you can simply omit importing and registering the transitional styles. This way, the component will simply use it's built-in 2023 styles."}),e.jsxs(n.p,{children:["If you need granular control over which components should use 2023 design and which should use 2016 design, you can use the ",e.jsx(n.code,{children:"<gds-theme>"})," component to override the transitional styles for specific components."]}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<gds-theme design-version="2023">
  <!-- Green Core components here will use 2023, even if Transitional Styles are loaded -->
</gds-theme>
`})}),e.jsx(n.p,{children:"The second issue is a bit more complex, since the component may need to be updated or a new one written. Reach out to the Green Core team for help with this."})]}),`
