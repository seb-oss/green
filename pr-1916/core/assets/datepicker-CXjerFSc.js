import{m as c}from"./runtime-CMQcyTl6.js";import{l as zt}from"./localized-decorator-iufJoRiP.js";import{T as j,i as Ot,a as Vt,E as Mt}from"./lit-element-C_s9q329.js";import{n as b,r as X,g as Dt,h as W}from"./custom-element-scoping-b4lD3laR.js";import{e as Rt,a as Bt}from"./query-p8xgzTDt.js";import{r as H}from"./query-async-MEroNOeJ.js";import{o as Gt}from"./field-base-BGzCqtn_.js";import{e as St,i as qt,t as Kt}from"./directive-CF8sV3Lr.js";import{p as Xt,v as E,r as P,M as J,m as Ht,i as Zt}from"./directive-helpers-C6DiESt7.js";import{f as Jt}from"./ref-D_ho-JAG.js";import{n as Q}from"./when-BR7zwNJC.js";import{t as Ut}from"./tokens.style-B6Zq2CtY.js";import{T as jt}from"./transitional-styles-TR7inlBc.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as yt,a as Qt}from"./attribute-converters-CdI0trPX.js";import{a as te}from"./button-BbfE8kG9.js";import"./flex-DnAdyWkx.js";import"./dropdown-B_gFr00d.js";import"./menu-heading-BhyRnneE.js";import{i as ee}from"./calendar-Cb3-HSfp.js";import"./calender-add-BZH2uut0.js";import"./chevron-right-BwEVIrUT.js";import"./popover-ClmruqmN.js";import"./backdrop-BGzK9qgd.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},ne=St(class extends qt{constructor(t){if(super(t),t.type!==Kt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let o=0;for(const d of t)a[o]=i?i(d,o):o,n[o]=s(d,o),o++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Xt(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=o,n;const d=this.ut??(this.ut=[]),r=[];let k,C,l=0,$=a.length-1,f=0,x=n.length-1;for(;l<=$&&f<=x;)if(a[l]===null)l++;else if(a[$]===null)$--;else if(d[l]===o[f])r[f]=E(a[l],n[f]),l++,f++;else if(d[$]===o[x])r[x]=E(a[$],n[x]),$--,x--;else if(d[l]===o[x])r[x]=E(a[l],n[x]),P(t,r[x+1],a[l]),l++,x--;else if(d[$]===o[f])r[f]=E(a[$],n[f]),P(t,a[l],a[$]),$--,f++;else if(k===void 0&&(k=xt(o,f,x),C=xt(d,l,$)),k.has(d[l]))if(k.has(d[$])){const D=C.get(o[f]),Z=D!==void 0?a[D]:null;if(Z===null){const wt=P(t,a[l]);E(wt,n[f]),r[f]=wt}else r[f]=E(Z,n[f]),P(t,a[l],Z),a[D]=null;f++}else J(a[$]),$--;else J(a[l]),l++;for(;f<=x;){const D=P(t,r[x+1]);E(D,n[f]),r[f++]=D}for(;l<=$;){const D=a[l++];D!==null&&J(D)}return this.ut=o,Ht(t,r),j}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var ce=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,Ft=t=>{throw TypeError(t)},I=(t,e,s,i)=>{for(var a=i>1?void 0:i?pe(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&ce(e,s,a),a},$t=(t,e,s)=>e.has(t)||Ft("Cannot "+s),_=(t,e,s)=>($t(t,e,"read from private field"),s?s.call(t):e.get(t)),S=(t,e,s)=>e.has(t)?Ft("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),Yt=(t,e,s,i)=>($t(t,e,"write to private field"),e.set(t,s),s),w=(t,e,s)=>($t(t,e,"access private method"),s),Y,O,V,R,B,tt,et,st,y,Wt,A,at,T,G;let M=class extends Vt{constructor(){super(...arguments),S(this,y),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=w(this,y,at).call(this,this.value,this.length),S(this,Y,""),S(this,O,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=w(this,y,T).call(this,t+1),w(this,y,A).call(this)}),S(this,V,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=w(this,y,T).call(this,t-1),w(this,y,A).call(this)}),S(this,R,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),S(this,B,()=>{w(this,y,G).call(this)}),S(this,tt,()=>{_(this,Y)!==""&&(w(this,y,G).call(this),this.value=w(this,y,T).call(this,parseInt(this.value.toString())),w(this,y,A).call(this))}),S(this,et,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?_(this,V).call(this):_(this,O).call(this)}),S(this,st,t=>{let e=!1;if(t.key==="ArrowUp")_(this,O).call(this),e=!0;else if(t.key==="ArrowDown")_(this,V).call(this),e=!0;else{const s=parseInt(t.key);isNaN(s)||(_(this,Y).length<this.length&&(Yt(this,Y,_(this,Y)+s.toString()),this.value=parseInt(_(this,Y))),_(this,Y).length===this.length&&(this.value=w(this,y,T).call(this,this.value),w(this,y,G).call(this),w(this,y,Wt).call(this),w(this,y,A).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",_(this,et)),this.addEventListener("keydown",_(this,st)),this.addEventListener("blur",_(this,tt)),this.addEventListener("focus",_(this,B)),this.addEventListener("click",_(this,R)),this.addEventListener("mousedown",_(this,R))}focus(t){super.focus(t),_(this,B).call(this)}render(){return W`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=w(this,y,at).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};Y=new WeakMap;O=new WeakMap;V=new WeakMap;R=new WeakMap;B=new WeakMap;tt=new WeakMap;et=new WeakMap;st=new WeakMap;y=new WeakSet;Wt=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof M){t.focus();break}t=t.nextElementSibling}};A=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))};at=function(t,e){return String(t).padStart(e,"0")};T=function(t){return Math.max(this.min,Math.min(this.max,t))};G=function(){Yt(this,Y,"")};M.formAssociated=!0;I([b({type:Number})],M.prototype,"value",2);I([b({type:Number})],M.prototype,"length",2);I([b({type:Number,attribute:"aria-valuemin"})],M.prototype,"min",2);I([b({type:Number,attribute:"aria-valuemax"})],M.prototype,"max",2);I([X()],M.prototype,"displayValue",2);I([_t("value")],M.prototype,"_refreshDisplayValue",1);M=I([Dt("gds-date-part-spinner")],M);var ue=Object.defineProperty,ge=Object.getOwnPropertyDescriptor,Et=t=>{throw TypeError(t)},g=(t,e,s,i)=>{for(var a=i>1?void 0:i?ge(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&ue(e,s,a),a},bt=(t,e,s)=>e.has(t)||Et("Cannot "+s),p=(t,e,s)=>(bt(t,e,"read from private field"),s?s.call(t):e.get(t)),v=(t,e,s)=>e.has(t)?Et("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),U=(t,e,s,i)=>(bt(t,e,"write to private field"),e.set(t,s),s),m=(t,e,s)=>(bt(t,e,"access private method"),s),L,u,It,q,Nt,Pt,it,N,z,At,nt,rt,ot,lt,ht,dt,ct,pt,ut,K,gt,ft,mt,vt,F,Tt,Lt;let h=class extends te{constructor(){super(...arguments),v(this,u),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.showWeekNumbers=!1,this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=m(this,u,mt).call(this,"y-m-d"),v(this,L),v(this,At,t=>{this._elTrigger.then(e=>{var i,a;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((a=document.getSelection())==null||a.removeAllRanges())})}),v(this,nt,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),v(this,rt,t=>{this._elField.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),v(this,ot,t=>{this._elField.then(e=>{var o;if(t.currentTarget!==e)return;t.preventDefault();const s=(o=t.clipboardData)==null?void 0:o.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const d=this._dateFormatLayout.layout,r=parseInt(n[d.findIndex(l=>l.token==="y")]),k=parseInt(n[d.findIndex(l=>l.token==="m")])-1,C=parseInt(n[d.findIndex(l=>l.token==="d")]);!isNaN(r)&&!isNaN(k)&&!isNaN(C)&&(i=new Date(`${r}-${k+1}-${C}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,m(this,u,N).call(this))})}),v(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),v(this,ht,t=>{t.stopPropagation(),this.value=t.detail,this.open=!1,m(this,u,N).call(this),m(this,u,z).call(this)}),v(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),v(this,ct,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),v(this,pt,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),v(this,ut,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),v(this,K,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),m(this,u,z).call(this)}),v(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;!ee(e||new Date(0),p(this,L)||new Date(0))&&(this.value=e,m(this,u,N).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=p(this,L),m(this,u,z).call(this))}}),v(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),v(this,vt,(t,e)=>{p(this,F)[e]=t;const s=new Date;s.setFullYear(parseInt(p(this,F).year)),s.setMonth(parseInt(p(this,F).month)-1),s.setDate(parseInt(p(this,F).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,m(this,u,N).call(this),m(this,u,z).call(this))}),v(this,F,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=m(this,u,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),jt.instance.apply(this,"gds-datepicker")}render(){return W`
      ...
      >
        <div class="spinners">
          ${ie(Gt(this._dateFormatLayout.layout,(t,e)=>W`<gds-date-part-spinner
                  ...
                  aria-valuemin=${m(this,u,Pt).call(this,t.name)}
                  aria-valuemax=${m(this,u,it).call(this,t.name)}
                  aria-label=${m(this,u,Nt).call(this,t.name)}
      ...
      >
        ...
        >
          <gds-button
            rank="tertiary"
            size="small"
            @click=${t=>{t.stopPropagation(),this.value=void 0,this.open=!1,m(this,u,N).call(this)}}
          >
            ${c("Clear")}
          </gds-button>
          ${he(m(this,u,It).call(this),Mt)}
          <gds-button
            rank="tertiary"
            size="small"
