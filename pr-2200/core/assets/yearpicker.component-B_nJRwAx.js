      ...
      <table role="grid" aria-label="${M(this.label)}">
        <tbody role="rowgroup">
          ${Array.from({length:this.rows}).map((s,n)=>g`
              <tr role="row">
                ${Array.from({length:this.columns}).map((d,u)=>{const l=t+n*this.columns+u,h=l<this.min.getFullYear()||l>this.max.getFullYear();return this.hideExtraneousYears&&h?g`<td inert></td>`:g`
                    <td
