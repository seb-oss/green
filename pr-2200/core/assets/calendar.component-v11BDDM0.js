        ...
        ${le(this.focusedDate,e=>m`
            ${e.map(a=>m`
                <tr role="row">
                  ...
                  ${a.days.map(s=>{const r=this.customizedDates&&this.customizedDates.find(h=>w(h.date,s)),o={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(h=>w(h,s))),...r},i=!U(this.focusedDate,s),u=(s<this.min||s>this.max)&&!w(s,this.min)&&!w(s,this.max),l=s.getDay()===0||s.getDay()===6,n=o.disabled||i||u||this.disabledWeekends&&l;return this.hideExtraneousDays&&i?m`<td inert></td>`:m`
                          <td
                            role="${M(n?void 0:"gridcell")}"
                            class="${I({"custom-date":!!r,disabled:!!n,today:w(t,s)})}"
                            ?disabled=${n}
