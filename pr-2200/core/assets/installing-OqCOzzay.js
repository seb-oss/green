import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{u as t}from"./index-DaMCjmYu.js";import"./chunk-HLWAVYOI-Dd4jqtzk.js";import{ae as r}from"./index-B5GG3w-w.js";import"./iframe-BU04Yro5.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function o(s){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Get started"}),`
...
`})}),`
`,e.jsx(n.p,{children:"This will automatically register the component in the custom elements registry, and you can use it immediately, but it will not be tree-shakable, so it will be included in your bundle wheter you use it or not."}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`})})]})}function x(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{x as default};
