...
and enter or space to select it.`}}},tags:["autodocs"],argTypes:{...Ae("gds-year-picker")}},l={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{}},D={...l,args:{label:"YearPicker"}},f={...l,name:"No current month",render:e=>o` <gds-year-picker no-current-year></gds-year-picker> `},v={...l,render:e=>o` <gds-year-picker size="small"></gds-year-picker> `},Y={...l,name:"Min and max",render:e=>o`
  ...
  `},_={...l,render:e=>o(I||(I=Ie([`
    ...
    <\/script>
  `])))};var N,A,O;D.parameters={...D.parameters,docs:{...(N=D.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    label: 'YearPicker'
  }
}`,...(O=(A=D.parameters)==null?void 0:A.docs)==null?void 0:O.source}}};var U,W,G,R,H;f.parameters={...f.parameters,docs:{...(U=f.parameters)==null?void 0:U.docs,source:{originalSource:`{
  ...DefaultParams,
