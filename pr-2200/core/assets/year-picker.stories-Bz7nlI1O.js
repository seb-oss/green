...
and enter or space to select it.`}}},tags:["autodocs"],argTypes:{...Ae("gds-year-picker")}},l={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{}},F={...l,args:{label:"YearPicker"}},v={...l,name:"No current month",render:e=>o` <gds-year-picker no-current-year></gds-year-picker> `},Y={...l,render:e=>o` <gds-year-picker size="small"></gds-year-picker> `},b={...l,name:"Min and max",render:e=>o`
  ...
  `},D={...l,render:e=>o(T||(T=Ie([`
    ...
    <\/script>
  `])))};var I,N,A;F.parameters={...F.parameters,docs:{...(I=F.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    label: 'YearPicker'
  }
}`,...(A=(N=F.parameters)==null?void 0:N.docs)==null?void 0:A.source}}};var O,U,W,G,R;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'No current month',
  render: args => html\` <gds-year-picker no-current-year></gds-year-picker> \`
}`,...(W=(U=v.parameters)==null?void 0:U.docs)==null?void 0:W.source},description:{story:"Use the `no-current-year` attribute so the month right\nnow does not have a outer ring around it.",...(R=(G=v.parameters)==null?void 0:G.docs)==null?void 0:R.description}}};var H,j,K,q,J;Y.parameters={...Y.parameters,docs:{...(H=Y.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\` <gds-year-picker size="small"></gds-year-picker> \`
}`,...(K=(j=Y.parameters)==null?void 0:j.docs)==null?void 0:K.source},description:{story:"Use the `small` attribute to use a smaller and condenced styling.",...(J=(q=Y.parameters)==null?void 0:q.docs)==null?void 0:J.description}}};var Q,V,X,Z,ee;b.parameters={...b.parameters,docs:{...(Q=b.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Min and max',
  render: args => html\`
    <gds-year-picker min="2023-01-01" max="2032-01-01"></gds-year-picker>
  ...
  \`
}`,...(we=(ke=_.parameters)==null?void 0:ke.docs)==null?void 0:we.source},description:{story:"Use `change-years-controls` to show controls for selecting previous and next years.",...(_e=(Ce=_.parameters)==null?void 0:Ce.docs)==null?void 0:_e.description}}};var De,Fe,Ee,Pe,Se;D.parameters={...D.parameters,docs:{...(De=D.parameters)==null?void 0:De.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-popover id="popchange">
      <gds-button rank="secondary" slot="trigger">
    ...
    <\/script>
  \`
}`,...(Ee=(Fe=D.parameters)==null?void 0:Fe.docs)==null?void 0:Ee.source},description:{story:"Example of a button that opens up the year-picker.",...(Se=(Pe=D.parameters)==null?void 0:Pe.docs)==null?void 0:Se.description}}};const Tr=["Default","NoCurrentMonth","Small","MinAndMax","Hide","LessCells","BirthYear","Popover","ChangeYear","PopoverChange"];export{w as BirthYear,_ as ChangeYear,F as Default,x as Hide,k as LessCells,b as MinAndMax,v as NoCurrentMonth,C as Popover,D as PopoverChange,Y as Small,Tr as __namedExportsOrder,Lr as default};
