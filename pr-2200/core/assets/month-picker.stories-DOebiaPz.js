import{i as Pe,x as c}from"./lit-element-Bx14lxc-.js";import{a as Ye}from"./argTableProps-BLfyo56U.js";import{m as d}from"./runtime-BL31MtW8.js";import{l as Fe}from"./localized-decorator-DtmrKsyB.js";import{n as h,r as Oe,G as Ee,g as $e}from"./gds-element-KHa0AloG.js";import{a as ze}from"./query-p8xgzTDt.js";import{e as Ae}from"./class-map-CXsQwv0r.js";import{o as Ne}from"./if-defined-CVqwUuaf.js";import{n as Ue}from"./when-BR7zwNJC.js";import{t as Te}from"./tokens.style-DC2Hb-2P.js";import{T as Le}from"./transitional-styles-D9AB5Uac.js";import{w as Be}from"./watch-tFciLXSI.js";import{d as P}from"./attribute-converters-CdI0trPX.js";import{l as Ge,i as C,a as F,s as O}from"./index-C4WLrI9v.js";import"./flex-D2RuIok0.js";import"./dropdown-FwHj4PDN.js";import"./option-BCMsOy3Z.js";import"./menu-heading-Dzq6jeTC.js";import"./custom-elements-B8mxS7yM.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./flex.component-BLop41Mq.js";import"./div.component-BLZX0vzk.js";import"./declarative-layout-mixins-V-x3wfiD.js";import"./dropdown.component-MwbZBwPL.js";import"./query-async-MEroNOeJ.js";import"./icon-BDCl8D0g.js";import"./floating-ui.dom-BmFOYU71.js";import"./form-control-host.style-DPq0AOcs.js";import"./form-control-header.component-D0D6Ly3E.js";import"./badge.component-DZaZX92c.js";import"./triangle-exclamation.component-D-2uW-Eb.js";import"./button.component-BHtocGTN.js";import"./static-B8S6DEnV.js";import"./observe-light-dom-CmJPHUQ4.js";import"./card.component-C21NCPsO.js";import"./ref-R0wBYijq.js";import"./directive-helpers-BF33kFuJ.js";import"./unwrap-slots-C4xryOWd.js";import"./checkmark.component-BgKvBts3.js";import"./chevron-bottom.component-Bl66O3uM.js";import"./popover.component-D2rkjHqc.js";import"./cross-small.component-D1Ljw-03.js";import"./menu-heading.component-0Fty_zMr.js";const He=Pe`
  @layer base, reset;
        ...
        ${Array.from({length:4}).map((r,n)=>c`
            <tr role="row">
              ${E.slice(n*3,n*3+3).map((i,u)=>{const o=n*3+u;if(o>=E.length)return c`<td inert></td>`;const l=new Date(this.focusedYear,o,1),D=(l<this.min||l>this.max)&&!C(l,this.min)&&!C(l,this.max);return Ue(!this.hideExtraneousMonths||!D,()=>c`<td
                        class="${Ae({small:this.size=="small",today:!this.noCurrentMonth&&e==this.focusedYear&&t==o,disabled:!!D})}"
                        ?disabled=${D}
...
and enter or space to select it.`}}},tags:["autodocs"],argTypes:{...Ye("gds-month-picker")}},m={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{}},w={...m,args:{label:"MonthPicker"}},g={...m,name:"No current month",render:e=>c`
  ...
  `},x={...m,name:"Month number",render:e=>c` <gds-month-picker month-number></gds-month-picker> `},M={...m,name:"Min and max",render:e=>c`
...
}`,...(oe=(re=x.parameters)==null?void 0:re.docs)==null?void 0:oe.source},description:{story:"Use the the `month-number` attribute to show parantese\nwith the number of the month in it (1-12).",...(ne=(ae=x.parameters)==null?void 0:ae.docs)==null?void 0:ne.description}}};var ie,ce,de,he,me;M.parameters={...M.parameters,docs:{...(ie=M.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Min and max',
  render: args => html\`
    <gds-month-picker min="2025-03-01" max="2025-09-30"></gds-month-picker>
  \`
}`,...(de=(ce=M.parameters)==null?void 0:ce.docs)==null?void 0:de.source},description:{story:"Use `min` and `max` attributes to limit the months you can choose from.\nThe rest is greyed out. Remember that by default it uses the current year.",...(me=(he=M.parameters)==null?void 0:he.docs)==null?void 0:me.description}}};var le,ue,pe,ge,fe;k.parameters={...k.parameters,docs:{...(le=k.parameters)==null?void 0:le.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-month-picker
      min="2025-03-01"
    ...
    ></gds-month-picker>
  \`
}`,...(pe=(ue=k.parameters)==null?void 0:ue.docs)==null?void 0:pe.source},description:{story:"Use `hide-extraneous-months` in combination with `min` and `max` attributes\nto to fully hide the non-selectable months.",...(fe=(ge=k.parameters)==null?void 0:ge.docs)==null?void 0:fe.description}}};var ye,be,xe,Me,ke;v.parameters={...v.parameters,docs:{...(ye=v.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  ...DefaultParams,
