import{m as c}from"./runtime-BL31MtW8.js";import{l as Ot}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Vt,E as St}from"./lit-element-Bx14lxc-.js";import{n as v,r as H,G as Rt,h as w,g as Ft}from"./gds-element-KHa0AloG.js";import{e as qt,a as yt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Yt,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as E,r as z,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as I}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-BHtocGTN.js";import{G as te}from"./dropdown.component-MwbZBwPL.js";import{G as ee}from"./flex.component-BLop41Mq.js";import{f as se}from"./form-control-host.style-DPq0AOcs.js";import{t as ae}from"./tokens.style-DC2Hb-2P.js";import{T as ie}from"./transitional-styles-D9AB5Uac.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as $t,a as ne}from"./attribute-converters-CdI0trPX.js";import{a as oe,b as re,w as le}from"./declarative-layout-mixins-V-x3wfiD.js";import{G as he,i as de}from"./calendar.component-BEVx42c9.js";import{I as pe}from"./calendar.component-6CTxdUci.js";import{I as ue}from"./calender-add.component-BWcDRL8e.js";import{a as ce,I as ge}from"./chevron-right.component-Bc7NA4S-.js";import{G as fe}from"./popover.component-D2rkjHqc.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Yt(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let l=0;for(const u of t)a[l]=i?i(u,l):l,n[l]=s(u,l),l++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:l}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=l,n;const u=this.ut??(this.ut=[]),o=[];let k,M,d=0,b=a.length-1,m=0,C=n.length-1;for(;d<=b&&m<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(u[d]===l[m])o[m]=E(a[d],n[m]),d++,m++;else if(u[b]===l[C])o[C]=E(a[b],n[C]),b--,C--;else if(u[d]===l[C])o[C]=E(a[d],n[C]),z(t,o[C+1],a[d]),d++,C--;else if(u[b]===l[m])o[m]=E(a[b],n[m]),z(t,a[d],a[b]),b--,m++;else if(k===void 0&&(k=Ct(l,m,C),M=Ct(u,d,b)),k.has(u[d]))if(k.has(u[b])){const S=M.get(l[m]),J=S!==void 0?a[S]:null;if(J===null){const xt=z(t,a[d]);E(xt,n[m]),o[m]=xt}else o[m]=E(J,n[m]),z(t,a[d],J),a[S]=null;m++}else U(a[b]),b--;else U(a[d]),d++;for(;m<=C;){const S=z(t,o[C+1]);E(S,n[m]),o[m++]=S}for(;d<=b;){const S=a[d++];S!==null&&U(S)}return this.ut=l,Zt(t,o),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Se=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,Pt=t=>{throw TypeError(t)},h=(t,e,s,i)=>{for(var a=i>1?void 0:i?Fe(e,s):e,n=t.length-1,l;n>=0;n--)(l=t[n])&&(a=(i?l(e,s,a):l(a))||a);return i&&a&&Se(e,s,a),a},wt=(t,e,s)=>e.has(t)||Pt("Cannot "+s),g=(t,e,s)=>(wt(t,e,"read from private field"),s?s.call(t):e.get(t)),y=(t,e,s)=>e.has(t)?Pt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),j=(t,e,s,i)=>(wt(t,e,"write to private field"),e.set(t,s),s),f=(t,e,s)=>(wt(t,e,"access private method"),s),B,p,Tt,Nt,K,zt,At,it,P,N,Lt,nt,ot,rt,lt,ht,dt,pt,ut,ct,X,gt,ft,mt,vt,Y,Bt,Gt;let r=class extends jt{constructor(){super(),y(this,p),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.clearable=!1,this.hideTodayButton=!1,this.disabledWeekends=!1,this.showExtendedSupportingText=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=f(this,p,mt).call(this,"y-m-d"),y(this,B),y(this,Lt,t=>{this._elTrigger.then(e=>{var i,a;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((a=document.getSelection())==null||a.removeAllRanges())})}),y(this,nt,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),y(this,ot,t=>{this._elFieldAsync.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),y(this,rt,t=>{this._elFieldAsync.then(e=>{var l;if(t.currentTarget!==e)return;t.preventDefault();const s=(l=t.clipboardData)==null?void 0:l.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const u=this._dateFormatLayout.layout,o=parseInt(n[u.findIndex(d=>d.token==="y")]),k=parseInt(n[u.findIndex(d=>d.token==="m")])-1,M=parseInt(n[u.findIndex(d=>d.token==="d")]);!isNaN(o)&&!isNaN(k)&&!isNaN(M)&&(i=new Date(`${o}-${k+1}-${M}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,f(this,p,P).call(this))})}),y(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),y(this,ht,t=>{t.stopPropagation(),this.value=new Date(t.detail),this.open=!1,f(this,p,P).call(this),f(this,p,N).call(this)}),y(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),y(this,pt,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),y(this,ut,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),y(this,ct,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),y(this,X,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=new Date((await this._elCalendar).focusedDate),this.requestUpdate(),f(this,p,N).call(this)}),y(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;if(!e){this.value=void 0,f(this,p,P).call(this);return}!de(e||new Date(0),g(this,B)||new Date(0))&&(this.value=new Date(e),f(this,p,P).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=g(this,B),f(this,p,N).call(this))}}),y(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),y(this,vt,(t,e)=>{g(this,Y)[e]=t;const s=new Date;s.setFullYear(parseInt(g(this,Y).year)),s.setMonth(parseInt(g(this,Y).month)-1),s.setDate(parseInt(g(this,Y).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,f(this,p,P).call(this),f(this,p,N).call(this))}),y(this,Y,{year:"yyyy",month:"mm",day:"dd"}),D.define()}get type(){return"gds-datepicker"}get value(){return super.value}set value(t){super.value=t}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=f(this,p,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),ie.instance.apply(this,"gds-datepicker")}render(){return w`
      ...
      ${I(f(this,p,Tt).call(this),()=>w`<gds-form-control-footer
            class="size-${this.size}"
