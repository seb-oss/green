import{m as c,l as Ot}from"./runtime-CNluP0A8.js";import{T as Q,i as Vt,E as St}from"./lit-element-Bx14lxc-.js";import{n as v,r as H}from"./Reflect-DJ7r0WLU.js";import{e as Rt,a as yt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as qt,t as Kt}from"./directive-CF8sV3Lr.js";import{p as Xt,v as E,r as N,M as U,m as Ht,i as Zt}from"./directive-helpers-BF33kFuJ.js";import{f as Jt}from"./ref-R0wBYijq.js";import{n as I}from"./when-BR7zwNJC.js";import{a as Ut,G as jt}from"./button.component-N5V2wMzn.js";import{G as Qt}from"./dropdown.component-ByauDECI.js";import{G as te}from"./flex.component-DFgQuJpw.js";import{G as ee,h as w,g as Yt}from"./gds-element-DTROifYq.js";import{f as se}from"./form-control-host.style-CHnPGX4b.js";import{t as ae}from"./tokens.style-BAmYQ5hh.js";import{T as ie}from"./transitional-styles-DlCTkooe.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as $t,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as oe,b as re,d as le}from"./declarative-layout-mixins-DjJmHTNk.js";import{G as he,i as de}from"./calendar.component-Cx44apCg.js";import{I as pe}from"./calendar.component-Cauc9msY.js";import{I as ce}from"./calender-add.component-Cir_JkzW.js";import{a as ue,I as ge}from"./chevron-right.component-C_9eZEEK.js";import{G as fe}from"./popover.component-CWjW8C4-.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends qt{constructor(t){if(super(t),t.type!==Kt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let l=0;for(const u of t)a[l]=i?i(u,l):l,n[l]=s(u,l),l++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Xt(t),{values:n,keys:l}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=l,n;const u=this.ut??(this.ut=[]),o=[];let k,M,d=0,b=a.length-1,m=0,C=n.length-1;for(;d<=b&&m<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(u[d]===l[m])o[m]=E(a[d],n[m]),d++,m++;else if(u[b]===l[C])o[C]=E(a[b],n[C]),b--,C--;else if(u[d]===l[C])o[C]=E(a[d],n[C]),N(t,o[C+1],a[d]),d++,C--;else if(u[b]===l[m])o[m]=E(a[b],n[m]),N(t,a[d],a[b]),b--,m++;else if(k===void 0&&(k=Ct(l,m,C),M=Ct(u,d,b)),k.has(u[d]))if(k.has(u[b])){const S=M.get(l[m]),J=S!==void 0?a[S]:null;if(J===null){const xt=N(t,a[d]);E(xt,n[m]),o[m]=xt}else o[m]=E(J,n[m]),N(t,a[d],J),a[S]=null;m++}else U(a[b]),b--;else U(a[d]),d++;for(;m<=C;){const S=N(t,o[C+1]);E(S,n[m]),o[m++]=S}for(;d<=b;){const S=a[d++];S!==null&&U(S)}return this.ut=l,Ht(t,o),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
