...
`;var T=Object.defineProperty,U=Object.getOwnPropertyDescriptor,_=e=>{throw TypeError(e)},a=(e,t,s,n)=>{for(var u=n>1?void 0:n?U(t,s):t,d=e.length-1,l;d>=0;d--)(l=e[d])&&(u=(n?l(t,s,u):l(u))||u);return n&&u&&T(t,s,u),u},F=(e,t,s)=>t.has(e)||_("Cannot "+s),f=(e,t,s)=>(F(e,t,"read from private field"),s?s.call(e):t.get(e)),y=(e,t,s)=>t.has(e)?_("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),c=(e,t,s)=>(F(e,t,"access private method"),s),o,k,C,w,m,Y,b,x,D,p,$,E;let r=class extends A{constructor(){super(...arguments),y(this,o),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.hideExtraneousYears=!1,this.columns=5,this.rows=5,this.noCurrentYear=!1,this.controls="ifneeded",this.focusedDate=new Date,this.size="large",this._currentLocale=navigator.language,y(this,m,e=>{c(this,o,b).call(this),e.preventDefault()}),y(this,Y,e=>{c(this,o,x).call(this),e.preventDefault()}),y(this,p,e=>{this._elFocusedButton=e.target}),y(this,$,()=>{delete this._elFocusedButton})}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(e,0,1,12)}getYearCell(e){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector(`#yearCell-${e}`)}getStartYear(){const e=this.columns*this.rows,t=this.max.getFullYear()-this.min.getFullYear()+1;let s=this.min.getFullYear()-Math.floor((e-t)/2);if(this.focusedYear<s)do s-=e;while(this.focusedYear<s);else if(this.focusedYear>s+e-1)do s+=e;while(this.focusedYear>s+e-1);return s}connectedCallback(){super.connectedCallback(),W.instance.apply(this,"gds-yearpicker"),this.addEventListener("keydown",c(this,o,E)),window.addEventListener("lit-localize-status",e=>{e.detail.status==="ready"&&(this._currentLocale=e.detail.readyLocale)})}focus(){var e;super.focus(),(e=this._elFocusedCell)==null||e.focus()}render(){const e=new Date().getFullYear(),t=this.getStartYear();return g` <gds-div overflow="auto">
      ${c(this,o,k).call(this)?g`<gds-flex
          ...
          >
            ...
            <span id="range">${c(this,o,D).call(this)}</span>
            <gds-button
              id="next"
              rank="tertiary"
              label="Next years"
      ...
      <table role="grid" aria-label="${M(this.label)}">
        <tbody role="rowgroup">
          ${Array.from({length:this.rows}).map((s,n)=>g`
              <tr role="row">
                ${Array.from({length:this.columns}).map((u,d)=>{const l=t+n*this.columns+d,h=l<this.min.getFullYear()||l>this.max.getFullYear();return this.hideExtraneousYears&&h?g`<td inert></td>`:g`
                    <td
                      class="${G({small:this.size=="small",today:!this.noCurrentYear&&e==l,disabled:h})}"
                      ?disabled=${h}
                      tabindex="${this.focusedYear==l&&!h?0:-1}"
                      aria-selected="${c(this,o,C).call(this)==l&&!h?"true":"false"}"
                      @click=${()=>h?null:c(this,o,w).call(this,l)}
                      id="yearCell-${n*this.columns+d}"
                    >
                      ${l}
                    </td>
                  `})}
