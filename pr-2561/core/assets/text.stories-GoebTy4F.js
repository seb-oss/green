import"./text-DSWNST7C.js";import"./card-Do8AxK4z.js";import"./div-DFEgCDRl.js";import"./flex-CB30nh8h.js";import"./divider-Dbjx9rCT.js";import{x as e}from"./iframe-R-UOI5Ct.js";import{a as s}from"./argTableProps-Bw-eVafG.js";import"./default-typography.styles-gzHz-hfz.js";import"./card.component-CWlpHV50.js";import"./flex.component-Dx7fs3aT.js";import"./divider.component-B4KX1Fsf.js";const p={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...s("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified."}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},f={...d,name:"Font",render:t=>e`<gds-flex flex-direction="column" gap="m">
