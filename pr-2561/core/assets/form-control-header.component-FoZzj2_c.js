import{i as w,n as f,a8 as _,J as C,b,h as i,E as M,g as E,I as z,d as W,O as B,P as F}from"./iframe-R-UOI5Ct.js";import{G as I}from"./badge.component-D4pVHao9.js";import{I as D,a as H}from"./triangle-exclamation.component-eNxex7bN.js";import{l as A}from"./localized-decorator-pYJBvnT-.js";import{G as L}from"./card.component-CWlpHV50.js";const V=w`
...
`;var R=Object.defineProperty,J=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},x=(e,t,s,a)=>{for(var r=a>1?void 0:a?J(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&R(t,s,r),r},j=(e,t,s)=>t.has(e)||S("Cannot "+s),q=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),K=(e,t,s)=>(j(e,t,"access private method"),s),v,T;let d=class extends C{constructor(){super(...arguments),q(this,v)}_handleVisibilityChange(){var e;this.classList.toggle("visually-hidden",!this.errorMessage&&!((e=this.charCounter)!=null&&e[1]))}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return i`<div aria-live="polite">
    ...
    </div>`}};v=new WeakSet;T=function(){if(!this.charCounter||this.charCounter[1]===!1)return M;const[e,t]=this.charCounter;return i`<gds-badge variant="${t}">${e}</gds-badge>`};d.styles=[V];x([f({type:Array})],d.prototype,"charCounter",2);x([f()],d.prototype,"errorMessage",2);x([_("charCounter"),_("errorMessage")],d.prototype,"_handleVisibilityChange",1);d=x([E("gds-form-control-footer",{dependsOn:[I,D]})],d);const N=w`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var Q=Object.defineProperty,U=Object.getOwnPropertyDescriptor,$=e=>{throw TypeError(e)},u=(e,t,s,a)=>{for(var r=a>1?void 0:a?U(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&Q(t,s,r),r},G=(e,t,s)=>t.has(e)||$("Cannot "+s),p=(e,t,s)=>(G(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?$("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),k=(e,t,s)=>(G(e,t,"access private method"),s),c,O,m,y,g,P;let l=class extends C{constructor(){super(...arguments),h(this,c),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,h(this,m,()=>i`
    ...
    `};l.styles=[N];u([f({type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);u([z()],l.prototype,"_hasExtendedSupportingText",2);u([W("#extended-supporting-text")],l.prototype,"_extendedSupportingText",2);l=u([E("gds-form-control-header",{dependsOn:[F,L,H]}),A()],l);export{l as G,d as a};
