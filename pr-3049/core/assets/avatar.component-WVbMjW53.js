import{i as _,C as h,L as g,D as f,h as c,B as y,a as x,T as P,e as $,n as d,U as m,a6 as b,o as O}from"./iframe-Dcaup0t1.js";import{I as S}from"./people-profile.component-B4OErUNN.js";const A=_`
...
`;var G=Object.getOwnPropertyDescriptor,D=(e,t,a,i)=>{for(var s=i>1?void 0:i?G(t,a):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=n(s)||s);return s};let v=class extends h(g(f)){connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","group")}render(){return c`<slot></slot>`}};v.styles=[y,A];v=D([x("gds-avatar-group")],v);const E=_`
  @layer tokens, core, sizes, shapes;
...
`;var j=Object.defineProperty,I=Object.getOwnPropertyDescriptor,z=e=>{throw TypeError(e)},o=(e,t,a,i)=>{for(var s=i>1?void 0:i?I(t,a):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&j(t,a,s),s},M=(e,t,a)=>t.has(e)||z("Cannot "+a),T=(e,t,a)=>t.has(e)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),u=(e,t,a)=>(M(e,t,"access private method"),a),p,k,w,C;let r=class extends P(h(g(f))){constructor(){super(...arguments),T(this,p),this.src="",this.alt="",this.size="m",this.shape="circular",this.level="2"}render(){const e=$({avatar:!0,[this.size]:!0,[this.shape]:!0,"has-image":!!this.src});return c`
