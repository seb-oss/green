import"./switch-CVek5IXe.js";import"./flex-DR3h5pID.js";import{b as t}from"./iframe-BTEMi5uh.js";import"./text-CWtwuBvJ.js";import"./divider-aK3ApmoX.js";import{a as x}from"./argTableProps-DhGDpDNW.js";import"./switch.component-Cx7EIGX2.js";import"./checkmark.component-DBHRHVVe.js";import"./icon.component-1khu7vxe.js";import"./flex.component-DarE5pY2.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-BNADgX4E.js";import"./default-typography.styles-BU1f2-fr.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
