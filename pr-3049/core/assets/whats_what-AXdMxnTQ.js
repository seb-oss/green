import{q as h,m as s,u as m,j as t,M as f}from"./iframe-Ckbk1qpL.js";import{aC as i}from"./mermaid.core-DW6SQNRf.js";import"./preload-helper-PPVm8Dsz.js";const x="dark",w="default",j="dark",l="light",C="data-theme";function T(n,e){let r=n.getAttribute(C)??l;r===l||r===j||(r=l);const a=r===l?w:x;return e?.theme?.[r]??e?.mermaid?.theme??a}const A=({chart:n,config:e})=>{if(typeof window>"u")return h.createElement("div",{className:"mermaid","data-mermaid-src":n},n);const r=s.useMemo(()=>typeof e=="string"?JSON.parse(e):e,[e]),a=document.querySelector("html"),[p,g]=s.useState(!1),d=s.useMemo(()=>T(a,r),[r,p]);return s.useEffect(()=>{const o=new MutationObserver(b=>{for(const c of b)if(!(c.type!=="attributes"||c.attributeName!=="data-theme")){g(y=>!y);break}});return o.observe(a,{attributes:!0}),()=>{try{o.disconnect()}catch{}}},[]),s.useEffect(()=>{r&&(r.mermaid?i.initialize({startOnLoad:!0,...r.mermaid,theme:d}):i.initialize({startOnLoad:!0,theme:d}),document.querySelectorAll('div.mermaid[data-processed="true"]').forEach(o=>{o.removeAttribute("data-processed"),o.innerHTML=o.getAttribute("data-mermaid-src")}),i.contentLoaded())},[r,d]),s.useEffect(()=>{setTimeout(i.contentLoaded,0)},[n]),h.createElement("div",{className:"mermaid","data-mermaid-src":n},n)},k=({chart:n})=>n?h.createElement(A,{chart:n,config:{theme:{light:"neutral",dark:"dark"}}}):null;function u(n){const e={a:"a",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...m(),...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(f,{title:"What's what?"}),`
