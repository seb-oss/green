import{a8 as O,i as H,n as r,E as T,l as A,$ as b,a as K,F as I,D as U,V as F,e as G,J as z,h as X}from"./iframe-Ckbk1qpL.js";import{l as Y}from"./localized-decorator-Bhy-9qaC.js";import{o as q,s as Q,a as J,c as Z}from"./floating-ui.dom-DzQH3ivI.js";import{I as j}from"./cross-small.component-BPIVqyLv.js";function tt(t){return(e,o,n)=>{if(O)return;const l=window.matchMedia(t),d=e.connectedCallback,y=e.disconnectedCallback;e.connectedCallback=function(){d?.call(this);const W=N=>{n.value?.call(this,N.matches)};l.addEventListener("change",W),this.disconnectedCallback=function(){y?.call(this),l.removeEventListener("change",W)},n.value?.call(this,l.matches)}}}const et=H`
