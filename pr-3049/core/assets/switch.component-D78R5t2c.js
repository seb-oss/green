import{i as E,n as p,U as S,l as k,F as V,L as F,C as L,T as M,a0 as O,e as T,h as n,o as W,a as D}from"./iframe-Dcaup0t1.js";import{I as G}from"./checkmark.component-BARwX0Qo.js";const B=E`
...
`,I=B;var j=Object.defineProperty,A=Object.getOwnPropertyDescriptor,f=t=>{throw TypeError(t)},a=(t,e,s,h)=>{for(var o=h>1?void 0:h?A(e,s):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(o=(h?d(e,s,o):d(o))||o);return h&&o&&j(e,s,o),o},g=(t,e,s)=>e.has(t)||f("Cannot "+s),v=(t,e,s)=>(g(t,e,"read from private field"),s?s.call(t):e.get(t)),u=(t,e,s)=>e.has(t)?f("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),c=(t,e,s)=>(g(t,e,"access private method"),s),r,y,x,_,z,m,C,w,P,$;let i=class extends O{constructor(){super(...arguments),u(this,r),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",u(this,m,()=>{this.checked=this._input.checked,c(this,r,$).call(this),c(this,r,C).call(this)}),u(this,w,t=>{this.disabled||t.key==="Enter"&&(t.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(t){this._internalValue=t}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(t){this._input?.focus(t)}render(){const t={switch:!0,checked:this.checked,disabled:this.disabled,"control-start":this.controlPlacement==="start",small:this.size==="small"};return n`
