...
`,GdsDatepicker=class extends chunk_2BMJPIND.S{constructor(){var _this;super(...arguments),_this=this,(0,chunk_5VURDMKE.VK)(this,_renderBackToValidRangeButton),(0,chunk_5VURDMKE.VK)(this,_focusDate),(0,chunk_5VURDMKE.VK)(this,_getSpinnerLabel),(0,chunk_5VURDMKE.VK)(this,_getMinSpinnerValue),(0,chunk_5VURDMKE.VK)(this,_getMaxSpinnerValue),(0,chunk_5VURDMKE.VK)(this,_dispatchChangeEvent),(0,chunk_5VURDMKE.VK)(this,_dispatchInputEvent),(0,chunk_5VURDMKE.VK)(this,_parseDateFormat),(0,chunk_5VURDMKE.VK)(this,_years),(0,chunk_5VURDMKE.VK)(this,_isValueOutsideRange),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.open=!1,this.label="",this.showWeekNumbers=!1,this.size="medium",this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=(new Date).getMonth(),this._focusedYear=(new Date).getFullYear(),this._dateFormatLayout=(0,chunk_5VURDMKE.jq)(this,_parseDateFormat,parseDateFormat_fn).call(this,"y-m-d"),(0,chunk_5VURDMKE.VK)(this,_valueOnOpen,void 0),(0,chunk_5VURDMKE.VK)(this,_handleFieldFocusOut,(e=>{this._elTrigger.then((_=>{var _a,_b;(null==(_a=e.relatedTarget)?void 0:_a.parentElement)!==e.target&&(null==(_b=document.getSelection())||_b.removeAllRanges())}))})),(0,chunk_5VURDMKE.VK)(this,_handleSpinnerFocus,(e=>{this._elTrigger.then((field=>{var _a,_b;null==(_a=document.getSelection())||_a.removeAllRanges();const range=new Range;range.setStart(field.firstChild,0),range.setEnd(field.lastChild,4),null==(_b=document.getSelection())||_b.addRange(range)}))})),(0,chunk_5VURDMKE.VK)(this,_handleClipboardCopy,(e=>{this._elField.then((field=>{var _a;e.currentTarget===field&&(e.preventDefault(),null==(_a=e.clipboardData)||_a.setData("text/plain",this.displayValue))}))})),(0,chunk_5VURDMKE.VK)(this,_handleClipboardPaste,(e=>{this._elField.then((field=>{var _a;if(e.currentTarget!==field)return;e.preventDefault();const pasted=null==(_a=e.clipboardData)?void 0:_a.getData("text/plain");if(!pasted)return;let pastedDate=new Date("-");const parts=pasted.split(this._dateFormatLayout.delimiter);if(3===parts.length){const layout=this._dateFormatLayout.layout,year=parseInt(parts[layout.findIndex((f=>"y"===f.token))]),month=parseInt(parts[layout.findIndex((f=>"m"===f.token))])-1,day=parseInt(parts[layout.findIndex((f=>"d"===f.token))]);isNaN(year)||isNaN(month)||isNaN(day)||(pastedDate=new Date(`${year}-${month+1}-${day}`))}"Invalid Date"===pastedDate.toString()&&(pastedDate=new Date(pasted),"Invalid Date"===pastedDate.toString())||(this.value=pastedDate,(0,chunk_5VURDMKE.jq)(this,_dispatchChangeEvent,dispatchChangeEvent_fn).call(this))}))})),(0,chunk_5VURDMKE.VK)(this,_handleFieldClick,(e=>{var _a;null==(_a=this._elSpinners[0])||_a.focus()})),(0,chunk_5VURDMKE.VK)(this,_handleCalendarChange,(e=>{e.stopPropagation(),this.value=e.detail,this.open=!1,(0,chunk_5VURDMKE.jq)(this,_dispatchChangeEvent,dispatchChangeEvent_fn).call(this)})),(0,chunk_5VURDMKE.VK)(this,_handleMonthChange,(e=>{var _a;e.stopPropagation(),this._focusedMonth=null==(_a=e.target)?void 0:_a.value})),(0,chunk_5VURDMKE.VK)(this,_handleYearChange,(e=>{var _a;e.stopPropagation(),this._focusedYear=null==(_a=e.target)?void 0:_a.value})),(0,chunk_5VURDMKE.VK)(this,_handleIncrementFocusedMonth,(_e=>{this._focusedMonth++,this._focusedMonth>11&&(this._focusedMonth=0,this._focusedYear++)})),(0,chunk_5VURDMKE.VK)(this,_handleDecrementFocusedMonth,(_e=>{this._focusedMonth--,this._focusedMonth<0&&(this._focusedMonth=11,this._focusedYear--)})),(0,chunk_5VURDMKE.VK)(this,_handleCalendarFocusChange,(0,asyncToGenerator.A)((function*(){_this._focusedMonth=(yield _this._elCalendar).focusedMonth,_this._focusedYear=(yield _this._elCalendar).focusedYear,_this.value=(yield _this._elCalendar).focusedDate,_this.requestUpdate(),(0,chunk_5VURDMKE.jq)(_this,_dispatchInputEvent,dispatchInputEvent_fn).call(_this)}))),(0,chunk_5VURDMKE.VK)(this,_handlePopoverStateChange,function(){var _ref2=(0,asyncToGenerator.A)((function*(e){if(e.target===e.currentTarget){if(_this.open=e.detail.open,"close"===e.detail.reason){const calValue=(yield _this._elCalendar).value;!(0,isSameDay.A)(calValue||new Date(0),(0,chunk_5VURDMKE.S7)(_this,_valueOnOpen)||new Date(0))&&(_this.value=calValue,(0,chunk_5VURDMKE.jq)(_this,_dispatchChangeEvent,dispatchChangeEvent_fn).call(_this)),_this.value&&(_this._focusedMonth=_this.value.getMonth(),_this._focusedYear=_this.value.getFullYear())}"cancel"===e.detail.reason&&(_this.value=(0,chunk_5VURDMKE.S7)(_this,_valueOnOpen))}}));return function(_x){return _ref2.apply(this,arguments)}}()),(0,chunk_5VURDMKE.VK)(this,_handleSpinnerKeydown,(e=>{const index=Array.from(this._elSpinners).findIndex((spinner=>spinner===e.target));if("ArrowRight"===e.key){const next=this._elSpinners[index+1];next&&next.focus()}if("ArrowLeft"===e.key){const prev=this._elSpinners[index-1];prev&&prev.focus()}})),(0,chunk_5VURDMKE.VK)(this,_handleSpinnerChange,((val,name)=>{(0,chunk_5VURDMKE.S7)(this,_spinnerState)[name]=val;const newDate=new Date;newDate.setFullYear(parseInt((0,chunk_5VURDMKE.S7)(this,_spinnerState).year)),newDate.setMonth(parseInt((0,chunk_5VURDMKE.S7)(this,_spinnerState).month)-1),newDate.setDate(parseInt((0,chunk_5VURDMKE.S7)(this,_spinnerState).day)),"Invalid Date"!==newDate.toString()&&(this.value=newDate,(0,chunk_5VURDMKE.jq)(this,_dispatchChangeEvent,dispatchChangeEvent_fn).call(this))})),(0,chunk_5VURDMKE.VK)(this,_spinnerState,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map((f=>f.token)).join(this._dateFormatLayout.delimiter)}set dateformat(dateformat){this._dateFormatLayout=(0,chunk_5VURDMKE.jq)(this,_parseDateFormat,parseDateFormat_fn).call(this,dateformat)}getFocusedDate(){var _this2=this;return(0,asyncToGenerator.A)((function*(){return _this2.open?_this2._elCalendar.then((el=>el.focusedDate)):void 0}))()}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}test_getDateCell(dayNumber){var _this3=this;return(0,asyncToGenerator.A)((function*(){return _this3._elCalendar.then((el=>el.getDateCell(dayNumber)))}))()}connectedCallback(){super.connectedCallback(),chunk_UZLOEUQK.nD.instance.apply(this,"gds-datepicker")}render(){var _this4=this;return chunk_VOYMQ322.qy`${(0,when.z)(this.label&&!this.hideLabel,(()=>chunk_VOYMQ322.qy`<label for="spinner-0" id="label">${this.label}</label>`))}
      ...
      <div
        ...
        id="field"
        @click=${(0,chunk_5VURDMKE.S7)(this,_handleFieldClick)}
        @copy=${(0,chunk_5VURDMKE.S7)(this,_handleClipboardCopy)}
        @paste=${(0,chunk_5VURDMKE.S7)(this,_handleClipboardPaste)}
      >
        <div
          class=${(0,class_map.H)({input:!0,"is-placeholder":!this.value})}
          @focusout=${(0,chunk_5VURDMKE.S7)(this,_handleFieldFocusOut)}
        >
          ${(0,join.f)((0,map.T)(this._dateFormatLayout.layout,((f,i)=>chunk_VOYMQ322.qy`<gds-date-part-spinner
                  id="spinner-${i}"
                  class="spinner"
                  .length=${"y"===f.token?4:2}
                  .value=${(0,chunk_5VURDMKE.S7)(this,_spinnerState)[f.name]}
                  aria-valuemin=${(0,chunk_5VURDMKE.jq)(this,_getMinSpinnerValue,getMinSpinnerValue_fn).call(this,f.name)}
                  aria-valuemax=${(0,chunk_5VURDMKE.jq)(this,_getMaxSpinnerValue,getMaxSpinnerValue_fn).call(this,f.name)}
                  aria-label=${(0,chunk_5VURDMKE.jq)(this,_getSpinnerLabel,getSpinnerLabel_fn).call(this,f.name)}
                  aria-describedby="label"
                  @keydown=${(0,chunk_5VURDMKE.S7)(this,_handleSpinnerKeydown)}
                  @change=${e=>(0,chunk_5VURDMKE.S7)(this,_handleSpinnerChange).call(this,e.detail.value,f.name)}
                  @focus=${(0,chunk_5VURDMKE.S7)(this,_handleSpinnerFocus)}
                  @touchend=${e=>{this.open=!0,e.preventDefault()}}
                ></gds-date-part-spinner>`)),chunk_VOYMQ322.qy`<span>${this._dateFormatLayout.delimiter}</span>`)}
        </div>
        <gds-button
          id="calendar-button"
      ...
      <gds-popover
        ...
        .open=${this.open}
        @gds-ui-state=${(0,chunk_5VURDMKE.S7)(this,_handlePopoverStateChange)}
        label=${this.label}
        id="calendar-popover"
      ...
      >
        <div class="header">
          <gds-button
            @click=${(0,chunk_5VURDMKE.S7)(this,_handleDecrementFocusedMonth)}
          ...
          <gds-dropdown
            ...
            @change=${(0,chunk_5VURDMKE.S7)(this,_handleMonthChange)}
            .maxHeight=${300}
          ...
          <gds-dropdown
            ...
            @change=${(0,chunk_5VURDMKE.S7)(this,_handleYearChange)}
            .maxHeight=${300}
            label="${(0,lit_localize.ab)("Year")}"
            size="small"
            hide-label
          >
            ${(0,repeat.u)((0,chunk_5VURDMKE.S7)(this,_years,years_get),(year=>year),(year=>chunk_VOYMQ322.qy`<gds-option value=${year}>${year}</gds-option>`))}
          </gds-dropdown>
          <gds-button
            @click=${(0,chunk_5VURDMKE.S7)(this,_handleIncrementFocusedMonth)}
        ...
        <gds-calendar
          id="calendar"
          @change=${(0,chunk_5VURDMKE.S7)(this,_handleCalendarChange)}
          @gds-date-focused=${(0,chunk_5VURDMKE.S7)(this,_handleCalendarFocusChange)}
        ...
        <div class="footer">
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),this.value=void 0,this.open=!1,(0,chunk_5VURDMKE.jq)(this,_dispatchChangeEvent,dispatchChangeEvent_fn).call(this)}}
          >
            ${(0,lit_localize.ab)("Clear")}
          </gds-button>
          ${(0,until.T)((0,chunk_5VURDMKE.jq)(this,_renderBackToValidRangeButton,renderBackToValidRangeButton_fn).call(this),lit.s6)}
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),(0,chunk_5VURDMKE.jq)(this,_focusDate,focusDate_fn).call(this,new Date)}}
          >
            ${(0,lit_localize.ab)("Today")}
          </gds-button>
        </div>
      </gds-popover> `}_getValidityAnchor(){return this._elSpinners[0]}_handleValueChange(){if(!this.value)return void(0,chunk_5VURDMKE.OV)(this,_spinnerState,{year:"yyyy",month:"mm",day:"dd"});const date=this.value;this._focusedMonth=date.getMonth(),this._focusedYear=date.getFullYear();const year=date.getFullYear().toString(),month=(date.getMonth()+1).toString().padStart(2,"0"),day=date.getDate().toString().padStart(2,"0");(0,chunk_5VURDMKE.OV)(this,_spinnerState,{year,month,day})}_handleOpenChange(){this.open&&((0,chunk_5VURDMKE.OV)(this,_valueOnOpen,this.value),this._elCalendar.then((el=>el.focus())))}};_valueOnOpen=new WeakMap,_renderBackToValidRangeButton=new WeakSet,renderBackToValidRangeButton_fn=function(){var _ref4=(0,asyncToGenerator.A)((function*(){const focusedDate=yield this.getFocusedDate();let buttonAction,buttonTxt="";return focusedDate&&focusedDate>this.max?(buttonTxt=(0,lit_localize.ab)("Last available date"),buttonAction=e=>{e.stopPropagation(),(0,chunk_5VURDMKE.jq)(this,_focusDate,focusDate_fn).call(this,this.max)}):focusedDate&&focusedDate<this.min&&(buttonTxt=(0,lit_localize.ab)("First available date"),buttonAction=e=>{e.stopPropagation(),(0,chunk_5VURDMKE.jq)(this,_focusDate,focusDate_fn).call(this,this.min)}),chunk_VOYMQ322.qy`${(0,when.z)(buttonTxt.length>0,(()=>chunk_VOYMQ322.qy`<gds-button rank="tertiary" size="small" @click=${buttonAction}>
          ${buttonTxt}
        </gds-button>`),(()=>lit.s6))}`}));return function renderBackToValidRangeButton_fn(){return _ref4.apply(this,arguments)}}(),_focusDate=new WeakSet,focusDate_fn=function(d){const focusDate=new Date(d);this._elCalendar.then((el=>el.focusedDate=focusDate)).then((0,chunk_5VURDMKE.S7)(this,_handleCalendarFocusChange))},_getSpinnerLabel=new WeakSet,getSpinnerLabel_fn=function(name){return{year:(0,lit_localize.ab)("Year"),month:(0,lit_localize.ab)("Month"),day:(0,lit_localize.ab)("Day")}[name]},_getMinSpinnerValue=new WeakSet,getMinSpinnerValue_fn=function(name){return{year:1900,month:1,day:1}[name]},_getMaxSpinnerValue=new WeakSet,getMaxSpinnerValue_fn=function(name){return{year:9999,month:12,day:31}[name]},_dispatchChangeEvent=new WeakSet,dispatchChangeEvent_fn=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value}}))},_dispatchInputEvent=new WeakSet,dispatchInputEvent_fn=function(){this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value}}))},_handleFieldFocusOut=new WeakMap,_handleSpinnerFocus=new WeakMap,_handleClipboardCopy=new WeakMap,_handleClipboardPaste=new WeakMap,_handleFieldClick=new WeakMap,_handleCalendarChange=new WeakMap,_handleMonthChange=new WeakMap,_handleYearChange=new WeakMap,_handleIncrementFocusedMonth=new WeakMap,_handleDecrementFocusedMonth=new WeakMap,_handleCalendarFocusChange=new WeakMap,_handlePopoverStateChange=new WeakMap,_handleSpinnerKeydown=new WeakMap,_parseDateFormat=new WeakSet,parseDateFormat_fn=function(dateformat){const delimiter=dateformat.replace(/[a-z0-9]/gi,"")[0],format=dateformat.split(delimiter),year=format.findIndex((f=>"y"===f)),month=format.findIndex((f=>"m"===f)),day=format.findIndex((f=>"d"===f));if(-1===year||-1===month||-1===day)throw new Error("Invalid date format for <gds-datepicker>");return{delimiter,layout:[year,month,day].sort(((a,b)=>a-b)).map((i=>format[i])).map((f=>({token:f,name:"y"===f?"year":"m"===f?"month":"day"})))}},_handleSpinnerChange=new WeakMap,_spinnerState=new WeakMap,_years=new WeakSet,years_get=function(){var _a;const minYear=this.min.getFullYear(),maxYear=this.max.getFullYear(),isOutsideRange=(0,chunk_5VURDMKE.S7)(this,_isValueOutsideRange,isValueOutsideRange_get),valueYear=null==(_a=this.value)?void 0:_a.getFullYear();return{*[Symbol.iterator](){isOutsideRange&&(yield valueYear);for(let i=minYear;i<=maxYear;i++)yield i}}},_isValueOutsideRange=new WeakSet,isValueOutsideRange_get=function(){return!!this.value&&(this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear())},GdsDatepicker.styles=[chunk_E7VAXHKC.L,styles],GdsDatepicker.shadowRootOptions={mode:"open",delegatesFocus:!0},(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({converter:chunk_C3ECHGX7.JD})],GdsDatepicker.prototype,"value",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({converter:chunk_C3ECHGX7.JD})],GdsDatepicker.prototype,"min",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({converter:chunk_C3ECHGX7.JD})],GdsDatepicker.prototype,"max",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Boolean})],GdsDatepicker.prototype,"open",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)()],GdsDatepicker.prototype,"label",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Boolean,attribute:"show-week-numbers"})],GdsDatepicker.prototype,"showWeekNumbers",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)()],GdsDatepicker.prototype,"size",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Boolean,attribute:"hide-label"})],GdsDatepicker.prototype,"hideLabel",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)()],GdsDatepicker.prototype,"dateformat",1),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Boolean,attribute:"disabled-weekends"})],GdsDatepicker.prototype,"disabledWeekends",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({converter:chunk_C3ECHGX7._h,attribute:"disabled-dates"})],GdsDatepicker.prototype,"disabledDates",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.nJ)("#calendar-button")],GdsDatepicker.prototype,"test_calendarButton",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.wk)()],GdsDatepicker.prototype,"_focusedMonth",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.wk)()],GdsDatepicker.prototype,"_focusedYear",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.wk)()],GdsDatepicker.prototype,"_dateFormatLayout",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.nJ)("#calendar")],GdsDatepicker.prototype,"_elCalendar",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.nJ)("#calendar-button")],GdsDatepicker.prototype,"_elTrigger",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.nJ)("#field")],GdsDatepicker.prototype,"_elField",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.YG)("[role=spinbutton]")],GdsDatepicker.prototype,"_elSpinners",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.P)(".input")],GdsDatepicker.prototype,"_elInput",2),(0,chunk_5VURDMKE.Cc)([(0,chunk_2WO4NHJ2.w)("value")],GdsDatepicker.prototype,"_handleValueChange",1),(0,chunk_5VURDMKE.Cc)([(0,chunk_2WO4NHJ2.w)("open")],GdsDatepicker.prototype,"_handleOpenChange",1),GdsDatepicker=(0,chunk_5VURDMKE.Cc)([(0,chunk_VOYMQ322.Y$)("gds-datepicker")],GdsDatepicker);var chunk_SKCMYABZ=__webpack_require__("./dist/libs/core/src/chunks/chunk.SKCMYABZ.js"),IconChevronLeft=class extends chunk_SKCMYABZ.M{};IconChevronLeft._regularSVG='<path d="M15 20L7 12L15 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',IconChevronLeft._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.5303 3.46967C15.8232 3.76256 15.8232 4.23744 15.5303 4.53033L8.06066 12L15.5303 19.4697C15.8232 19.7626 15.8232 20.2374 15.5303 20.5303C15.2374 20.8232 14.7626 20.8232 14.4697 20.5303L6.46967 12.5303C6.32902 12.3897 6.25 12.1989 6.25 12C6.25 11.8011 6.32902 11.6103 6.46967 11.4697L14.4697 3.46967C14.7626 3.17678 15.2374 3.17678 15.5303 3.46967Z" fill="currentColor"/>',IconChevronLeft._name="chevron left",IconChevronLeft=(0,chunk_5VURDMKE.Cc)([(0,chunk_VOYMQ322.Y$)("gds-icon-chevron-left")],IconChevronLeft);var IconChevronRight=class extends chunk_SKCMYABZ.M{};IconChevronRight._regularSVG='<path d="M9 4L17 12L9 20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',IconChevronRight._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M8.46967 3.46967C8.76256 3.17678 9.23744 3.17678 9.53033 3.46967L17.5303 11.4697C17.671 11.6103 17.75 11.8011 17.75 12C17.75 12.1989 17.671 12.3897 17.5303 12.5303L9.53033 20.5303C9.23744 20.8232 8.76256 20.8232 8.46967 20.5303C8.17678 20.2374 8.17678 19.7626 8.46967 19.4697L15.9393 12L8.46967 4.53033C8.17678 4.23744 8.17678 3.76256 8.46967 3.46967Z" fill="currentColor"/>',IconChevronRight._name="chevron right",IconChevronRight=(0,chunk_5VURDMKE.Cc)([(0,chunk_VOYMQ322.Y$)("gds-icon-chevron-right")],IconChevronRight);var _inputBuffer,_increment,_decrement,_handleClick,_handleFocus,_handleBlur,_handleWheel,_handleKeyDown,_focusNextSpinner,focusNextSpinner_fn,chunk_WJDR7FTS_dispatchChangeEvent,chunk_WJDR7FTS_dispatchChangeEvent_fn,_formatNumber,formatNumber_fn,_clamp,clamp_fn,_clearInputBuffer,clearInputBuffer_fn,IconCalendar=class extends chunk_SKCMYABZ.M{};IconCalendar._regularSVG='<path d="M3.75 9.75H20.25M7.75 4.75V2.75M16.25 4.75V2.75M3.75 4.75H20.25V20.25H3.75V4.75Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',IconCalendar._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M7.75 2C8.16421 2 8.5 2.33579 8.5 2.75V4H15.5V2.75C15.5 2.33579 15.8358 2 16.25 2C16.6642 2 17 2.33579 17 2.75V4H20.25C20.6642 4 21 4.33579 21 4.75V20.25C21 20.6642 20.6642 21 20.25 21H3.75C3.33579 21 3 20.6642 3 20.25V4.75C3 4.33579 3.33579 4 3.75 4H7V2.75C7 2.33579 7.33579 2 7.75 2ZM4.5 10.5V19.5H19.5V10.5H4.5Z" fill="currentColor"/>',IconCalendar._name="calendar",IconCalendar=(0,chunk_5VURDMKE.Cc)([(0,chunk_VOYMQ322.Y$)("gds-icon-calendar")],IconCalendar);var GdsDatePartSpinner=class extends lit.WF{constructor(){super(...arguments),(0,chunk_5VURDMKE.VK)(this,_focusNextSpinner),(0,chunk_5VURDMKE.VK)(this,chunk_WJDR7FTS_dispatchChangeEvent),(0,chunk_5VURDMKE.VK)(this,_formatNumber),(0,chunk_5VURDMKE.VK)(this,_clamp),(0,chunk_5VURDMKE.VK)(this,_clearInputBuffer),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=(0,chunk_5VURDMKE.jq)(this,_formatNumber,formatNumber_fn).call(this,this.value,this.length),(0,chunk_5VURDMKE.VK)(this,_inputBuffer,""),(0,chunk_5VURDMKE.VK)(this,_increment,(()=>{let current=parseInt(this.value.toString());Number.isNaN(current)&&(current=2===this.length?this.min:(new Date).getFullYear()-1),this.value=(0,chunk_5VURDMKE.jq)(this,_clamp,clamp_fn).call(this,current+1),(0,chunk_5VURDMKE.jq)(this,chunk_WJDR7FTS_dispatchChangeEvent,chunk_WJDR7FTS_dispatchChangeEvent_fn).call(this)})),(0,chunk_5VURDMKE.VK)(this,_decrement,(()=>{let current=parseInt(this.value.toString());Number.isNaN(current)&&(current=2===this.length?this.max:(new Date).getFullYear()+1),this.value=(0,chunk_5VURDMKE.jq)(this,_clamp,clamp_fn).call(this,current-1),(0,chunk_5VURDMKE.jq)(this,chunk_WJDR7FTS_dispatchChangeEvent,chunk_WJDR7FTS_dispatchChangeEvent_fn).call(this)})),(0,chunk_5VURDMKE.VK)(this,_handleClick,(e=>{e.stopPropagation(),e.preventDefault(),this.focus()})),(0,chunk_5VURDMKE.VK)(this,_handleFocus,(()=>{(0,chunk_5VURDMKE.jq)(this,_clearInputBuffer,clearInputBuffer_fn).call(this)})),(0,chunk_5VURDMKE.VK)(this,_handleBlur,(()=>{""!==(0,chunk_5VURDMKE.S7)(this,_inputBuffer)&&((0,chunk_5VURDMKE.jq)(this,_clearInputBuffer,clearInputBuffer_fn).call(this),this.value=(0,chunk_5VURDMKE.jq)(this,_clamp,clamp_fn).call(this,parseInt(this.value.toString())),(0,chunk_5VURDMKE.jq)(this,chunk_WJDR7FTS_dispatchChangeEvent,chunk_WJDR7FTS_dispatchChangeEvent_fn).call(this))})),(0,chunk_5VURDMKE.VK)(this,_handleWheel,(e=>{e.stopPropagation(),e.preventDefault(),e.deltaY>0?(0,chunk_5VURDMKE.S7)(this,_decrement).call(this):(0,chunk_5VURDMKE.S7)(this,_increment).call(this)})),(0,chunk_5VURDMKE.VK)(this,_handleKeyDown,(e=>{let handled=!1;if("ArrowUp"===e.key)(0,chunk_5VURDMKE.S7)(this,_increment).call(this),handled=!0;else if("ArrowDown"===e.key)(0,chunk_5VURDMKE.S7)(this,_decrement).call(this),handled=!0;else{const key=parseInt(e.key);isNaN(key)||((0,chunk_5VURDMKE.S7)(this,_inputBuffer).length<this.length&&((0,chunk_5VURDMKE.OV)(this,_inputBuffer,(0,chunk_5VURDMKE.S7)(this,_inputBuffer)+key.toString()),this.value=parseInt((0,chunk_5VURDMKE.S7)(this,_inputBuffer))),(0,chunk_5VURDMKE.S7)(this,_inputBuffer).length===this.length&&(this.value=(0,chunk_5VURDMKE.jq)(this,_clamp,clamp_fn).call(this,this.value),(0,chunk_5VURDMKE.jq)(this,_clearInputBuffer,clearInputBuffer_fn).call(this),(0,chunk_5VURDMKE.jq)(this,_focusNextSpinner,focusNextSpinner_fn).call(this),(0,chunk_5VURDMKE.jq)(this,chunk_WJDR7FTS_dispatchChangeEvent,chunk_WJDR7FTS_dispatchChangeEvent_fn).call(this)),handled=!0)}handled&&(e.preventDefault(),e.stopPropagation())}))}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",(0,chunk_5VURDMKE.S7)(this,_handleWheel)),this.addEventListener("keydown",(0,chunk_5VURDMKE.S7)(this,_handleKeyDown)),this.addEventListener("blur",(0,chunk_5VURDMKE.S7)(this,_handleBlur)),this.addEventListener("focus",(0,chunk_5VURDMKE.S7)(this,_handleFocus)),this.addEventListener("click",(0,chunk_5VURDMKE.S7)(this,_handleClick)),this.addEventListener("mousedown",(0,chunk_5VURDMKE.S7)(this,_handleClick))}focus(options){super.focus(options),(0,chunk_5VURDMKE.S7)(this,_handleFocus).call(this)}render(){return chunk_VOYMQ322.qy`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=(0,chunk_5VURDMKE.jq)(this,_formatNumber,formatNumber_fn).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};_inputBuffer=new WeakMap,_increment=new WeakMap,_decrement=new WeakMap,_handleClick=new WeakMap,_handleFocus=new WeakMap,_handleBlur=new WeakMap,_handleWheel=new WeakMap,_handleKeyDown=new WeakMap,_focusNextSpinner=new WeakSet,focusNextSpinner_fn=function(){let nextSpinner=this.nextElementSibling;for(;nextSpinner;){if(nextSpinner instanceof GdsDatePartSpinner){nextSpinner.focus();break}nextSpinner=nextSpinner.nextElementSibling}},chunk_WJDR7FTS_dispatchChangeEvent=new WeakSet,chunk_WJDR7FTS_dispatchChangeEvent_fn=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))},_formatNumber=new WeakSet,formatNumber_fn=function(num,padZeros){return String(num).padStart(padZeros,"0")},_clamp=new WeakSet,clamp_fn=function(value){return Math.max(this.min,Math.min(this.max,value))},_clearInputBuffer=new WeakSet,clearInputBuffer_fn=function(){(0,chunk_5VURDMKE.OV)(this,_inputBuffer,"")},GdsDatePartSpinner.formAssociated=!0,(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Number})],GdsDatePartSpinner.prototype,"value",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Number})],GdsDatePartSpinner.prototype,"length",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Number,attribute:"aria-valuemin"})],GdsDatePartSpinner.prototype,"min",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.MZ)({type:Number,attribute:"aria-valuemax"})],GdsDatePartSpinner.prototype,"max",2),(0,chunk_5VURDMKE.Cc)([(0,decorators.wk)()],GdsDatePartSpinner.prototype,"displayValue",2),(0,chunk_5VURDMKE.Cc)([(0,chunk_2WO4NHJ2.w)("value")],GdsDatePartSpinner.prototype,"_refreshDisplayValue",1),GdsDatePartSpinner=(0,chunk_5VURDMKE.Cc)([(0,chunk_VOYMQ322.Y$)("gds-date-part-spinner")],GdsDatePartSpinner);__webpack_require__("./dist/libs/core/src/chunks/chunk.PKFLSME7.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.R47NIJHT.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.BX2ZVTGR.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.VBLUVJDD.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.B3EUXCKZ.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.2X23R32H.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.AUAMUPXI.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.IZ4S7TBG.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.5E3XX4UM.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.PQQQJM5A.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.L7I7KHQL.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.ADPWGOIC.js"),__webpack_require__("./dist/libs/core/src/chunks/chunk.YYNLC3U6.js");var startOfMonth=__webpack_require__("./node_modules/date-fns/esm/startOfMonth/index.js"),endOfMonth=__webpack_require__("./node_modules/date-fns/esm/endOfMonth/index.js"),eachWeekOfInterval=__webpack_require__("./node_modules/date-fns/esm/eachWeekOfInterval/index.js"),eachDayOfInterval=__webpack_require__("./node_modules/date-fns/esm/eachDayOfInterval/index.js"),addDays=__webpack_require__("./node_modules/date-fns/esm/addDays/index.js");var _setSelectedDate,setSelectedDate_fn,chunk_FCBHZPGP_handleKeyDown,handleKeyDown_fn,chunk_ZQ4D5K7J=__webpack_require__("./dist/libs/core/src/chunks/chunk.ZQ4D5K7J.js"),if_defined=__webpack_require__("./node_modules/lit/directives/if-defined.js"),lastDayOfMonth=__webpack_require__("./node_modules/date-fns/esm/lastDayOfMonth/index.js"),getWeek=__webpack_require__("./node_modules/date-fns/esm/getWeek/index.js"),isSameMonth=__webpack_require__("./node_modules/date-fns/esm/isSameMonth/index.js"),subMonths=__webpack_require__("./node_modules/date-fns/esm/subMonths/index.js"),addMonths=__webpack_require__("./node_modules/date-fns/esm/addMonths/index.js"),calendar_styles_default=lit.AH`
  @layer base, reset;
...
`,GdsCalendar=class extends chunk_ZQ4D5K7J.j{constructor(){super(...arguments),(0,chunk_5VURDMKE.VK)(this,_setSelectedDate),(0,chunk_5VURDMKE.VK)(this,chunk_FCBHZPGP_handleKeyDown),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=date=>date.toDateString()}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(month){const lastOfSelectedMonth=(0,lastDayOfMonth.A)(new Date(this.focusedYear,month,1)),newFocusedDate=new Date(this.focusedDate);newFocusedDate.setDate(Math.min(this.focusedDate.getDate(),lastOfSelectedMonth.getDate())),newFocusedDate.setMonth(month),newFocusedDate.setHours(12,0,0,0),this.focusedDate=newFocusedDate}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(year){this.focusedDate=new Date(this.focusedDate.setFullYear(year))}getDateCell(dayNumber){var _a;return null==(_a=this.shadowRoot)?void 0:_a.querySelector(`#dateCell-${dayNumber}`)}connectedCallback(){super.connectedCallback(),chunk_UZLOEUQK.nD.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",(0,chunk_5VURDMKE.jq)(this,chunk_FCBHZPGP_handleKeyDown,handleKeyDown_fn))}focus(){var _a;super.focus(),null==(_a=this._elFocusedCell)||_a.focus()}render(){const currentDate=new Date;return lit.qy`<table role="grid" aria-label="${(0,if_defined.J)(this.label)}">
      ...
      <tbody role="rowgroup">
        ${function renderMonthGridView(date,template){const monthStart=(0,startOfMonth.A)(date),monthEnd=(0,endOfMonth.A)(date),weeks=(0,eachWeekOfInterval.A)({start:monthStart,end:monthEnd},{weekStartsOn:1});return lit.qy`${template(weeks.map((weekStartDay=>({days:(0,eachDayOfInterval.A)({start:weekStartDay,end:(0,addDays.A)(weekStartDay,6)})}))))}`}(this.focusedDate,(weeks=>lit.qy`
            ${weeks.map((week=>lit.qy`
                <tr role="row">
                  ${(0,when.z)(this.showWeekNumbers,(()=>lit.qy`<td class="week-number" scope="row">
                        ${(0,getWeek.A)(week.days[0])}
                      </td>`))}
                  ${week.days.map((day=>{const customization=this.customizedDates&&this.customizedDates.find((d=>(0,isSameDay.A)(d.date,day))),displayOptions=(0,chunk_5VURDMKE.IA)({color:"currentColor",disabled:Boolean(this.disabledDates&&this.disabledDates.some((d=>(0,isSameDay.A)(d,day))))},customization),isOutsideCurrentMonth=!(0,isSameMonth.A)(this.focusedDate,day)||day<this.min||day>this.max,isWeekend=0===day.getDay()||6===day.getDay(),isDisabled=displayOptions.disabled||isOutsideCurrentMonth||this.disabledWeekends&&isWeekend;return this.hideExtraneousDays&&isOutsideCurrentMonth?lit.qy`<td inert></td>`:lit.qy`
                          <td
                            ...
                            @click=${()=>isDisabled?null:(0,chunk_5VURDMKE.jq)(this,_setSelectedDate,setSelectedDate_fn).call(this,day)}
