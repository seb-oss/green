var b=(s,e,t)=>{if(!e.has(s))throw TypeError("Cannot "+t)};var u=(s,e,t)=>(b(s,e,"read from private field"),t?t.call(s):e.get(s)),v=(s,e,t)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,t)},m=(s,e,t,o)=>(b(s,e,"write to private field"),o?o.call(s,t):e.set(s,t),t);import{i as f,x as w}from"./lit-element-2a5e401f.js";import{g as k,G as C}from"./gds-element-24e794df.js";import{T as E}from"./transitional-styles-dbf6e776.js";const P=f`
  @layer base, reset;
...
`;var L=Object.defineProperty,O=Object.getOwnPropertyDescriptor,z=(s,e,t,o)=>{for(var r=o>1?void 0:o?O(e,t):e,a=s.length-1,l;a>=0;a--)(l=s[a])&&(r=(o?l(e,t,r):l(r))||r);return o&&r&&L(e,t,r),r};let g=class extends C{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then(()=>E.instance.apply(this,"gds-menu-heading"))}render(){return w`<slot></slot>`}};g.styles=I;g=z([k("gds-menu-heading")],g);export{F,H as L,P as s,N as u};
