var v=(s,e,t)=>{if(!e.has(s))throw TypeError("Cannot "+t)};var u=(s,e,t)=>(v(s,e,"read from private field"),t?t.call(s):e.get(s)),m=(s,e,t)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,t)},p=(s,e,t,o)=>(v(s,e,"write to private field"),o?o.call(s,t):e.set(s,t),t);import{i as f,x as w}from"./lit-element-2a5e401f.js";import{g as k,G as E}from"./gds-element-24e794df.js";import{T as C}from"./transitional-styles-63f7f7e5.js";const P=f`
