import{i as m,t as P,_ as t,g as y,h as r,w as we,k as ke,m as Se,G as T,b as a,c,n as o,r as $,d as i,A as $e,e as Ce}from"./declarative-layout-mixins-DaSDC2_o.js";import{l as ge,m as M,s as qe}from"./runtime-Cgryh99k.js";import{b as Re,e as G,w as C,a as je}from"./aria-forwarding-D9KxWeew.js";import{G as Ue,o as Ke,a as Xe,b as Ye}from"./button.component-B33etm88.js";import{o as Je}from"./icon.component-CoOz3qlV.js";import{n as g}from"./when-CI7b_ccM.js";import{G as Ee,o as Qe,f as Ze}from"./popover.component-CV_AZ20O.js";import{e as _}from"./class-map-BUkXxAbu.js";import{T as ue,c as et}from"./transitional-styles-5cSpMNNX.js";import{a as tt,G as st}from"./card.component-ViCKTjFU.js";import{I as it}from"./triangle-exclamation.component-Bdi_mw3O.js";import{I as at,a as ot}from"./chevron-bottom.component-DCuzVHyX.js";import{e as rt,n as lt}from"./ref-DWhAHj7r.js";import{F as nt,o as dt,L as ct,u as ht}from"./unwrap-slots-DR0FFXcj.js";import{I as Te}from"./checkmark.component-DdnYyAbX.js";import{I as pt}from"./cross-small.component-CDRn-fLR.js";function gt(e){return(s,n)=>Re(s,n,{async get(){return await this.updateComplete,this.renderRoot?.querySelector(e)??null}})}const ut=m`
  :host {
    display: flex;
...
`;var yt=mt,N,be,R,ze,j,Me,U,We;let b=class extends we(ke(Se(T))){constructor(){super(...arguments),a(this,N),a(this,R),a(this,j),a(this,U),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=_({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return r`
      <div class="${e}">
    ...
    ></slot>`};U=new WeakSet;We=function(){return r`<slot name="trail"></slot>`};b.styles=[P,yt];t([o()],b.prototype,"variant",2);t([o({type:String})],b.prototype,"size",2);t([o({attribute:"notification",type:Boolean,reflect:!0})],b.prototype,"notification",2);t([o({attribute:"rounded",type:Boolean,reflect:!0})],b.prototype,"rounded",2);t([$()],b.prototype,"mainSlotOccupied",2);t([$()],b.prototype,"leadSlotOccupied",2);b=t([y("gds-badge",{dependsOn:[I]})],b);const xt=m`
  @layer base, a11y;
