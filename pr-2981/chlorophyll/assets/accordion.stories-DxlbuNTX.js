const e={title:"Components/Accordion",tags:["autodocs"],parameters:{componentIds:["component-accordion"]}},n={render:()=>`
...
}`,...n.parameters?.docs?.source},description:{story:`[Source code](https://github.com/seb-oss/green/tree/main/libs/chlorophyll/scss/components/accordion)
&nbsp;|&nbsp;
...
Use the accordions to "hide" information that users doesn't necessarily need to read or only need to read occasionally. If the majority of users will read it, it should be visible.`,...n.parameters?.docs?.description}}};const i=["Accordion"];export{n as Accordion,i as __namedExportsOrder,e as default};
