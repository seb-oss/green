import{i as z,a0 as $,J as P,a3 as V,h as W,t as B,n as g,g as I,Q as T,S as G,O,d as S,I as M,a8 as D}from"./iframe-ByV2Hk15.js";import{l as N}from"./localized-decorator-rFdNAhQz.js";import{r as R}from"./resize-observer-B9k8v2TZ.js";import{I as X}from"./chevron-left.component-DQpq8LWe.js";import{I as A}from"./chevron-right.component-C85UXogr.js";const F=z`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var J=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,f=(e,t,s,i)=>{for(var r=i>1?void 0:i?Q(t,s):t,a=e.length-1,h;a>=0;a--)(h=e[a])&&(r=(i?h(t,s,r):h(r))||r);return i&&r&&J(t,s,r),r};let p=class extends $(P){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),V.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return W`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};p.styles=[...B,F];f([g({type:Boolean,reflect:!0})],p.prototype,"selected",2);f([g()],p.prototype,"value",2);f([g({type:Boolean,reflect:!0})],p.prototype,"disabled",2);p=f([I("gds-segment")],p);const j=z`
  @layer base {
    :host {
