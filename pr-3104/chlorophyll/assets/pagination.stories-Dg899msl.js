const s={title:"Components/Pagination",tags:["autodocs"],parameters:{componentIds:["component-pagination"]},argTypes:{size:{control:"select",options:["","small"]}}},a={render:e=>`
    <nav class="gds-pagination ${e.size}" role="navigation" aria-label="Pagination">
    <ul class="gds-reset">
      <li>
...
}`,...a.parameters?.docs?.source}}};const l=["Pagination"];export{a as Pagination,l as __namedExportsOrder,s as default};
