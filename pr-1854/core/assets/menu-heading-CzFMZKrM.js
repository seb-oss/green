...
`;var I=Object.defineProperty,L=Object.getOwnPropertyDescriptor,O=(t,e,o,s)=>{for(var i=s>1?void 0:s?L(e,o):e,a=t.length-1,r;a>=0;a--)(r=t[a])&&(i=(s?r(e,o,i):r(i))||i);return s&&i&&I(e,o,i),i};let h=class extends w{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then(()=>C.instance.apply(this,"gds-menu-heading"))}render(){return y`<slot></slot>`}};h.styles=E;h=O([k("gds-menu-heading")],h);export{F,D as L,H as s,P as u};
