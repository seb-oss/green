import{j as tt}from"./jsx-runtime-u17CrQMm.js";import{r as te,e as Ct}from"./iframe-Bg4vm2Zo.js";import{o as Wt}from"./create-component-CVDMTe9T.js";import{i as ot,x as F,t as lt,_ as i,n as f,r as V,g as je,G as dt,b as l,d as o,E as Ft,c as u,e as L,h as k,f as Tt,w as Yt,m as Ot,A as Nt,a as At}from"./declarative-layout-mixins-BcTTFP85.js";import{l as ht,m as p}from"./runtime-Cgryh99k.js";import{b as ut,e as Q,w as Z,a as ct}from"./watch-rsnQmdjn.js";import{e as Rt,i as It,t as zt}from"./icon.component-8uyxerC-.js";import{M as Bt,u as z,v as j,h as be,p as Et}from"./ref-DxMNaT1n.js";import{n as M}from"./when-CI7b_ccM.js";import{b as st,a as Lt,G as Ht}from"./button.component-B0EPp0kO.js";import{f as Vt,b as qt,G as Pt}from"./dropdown.component-DmumUCjM.js";import{d as Ue,a as Gt}from"./attribute-converters-CdI0trPX.js";import{e as at}from"./class-map-CYSAQGor.js";import{T as pt,r as jt}from"./transitional-styles-Ds070E38.js";import{I as Ut,a as Kt}from"./calender-add.component-DbiiIcQt.js";import{I as Jt,a as Xt}from"./chevron-right.component-DyjsIOaN.js";import{G as Qt}from"./popover.component-CD_IwG6x.js";let Zt;function es(t){return(e,s)=>ut(e,s,{get(){return(this.renderRoot??(Zt??=document.createDocumentFragment())).querySelectorAll(t)}})}function me(t){return(e,s)=>ut(e,s,{async get(){return await this.updateComplete,this.renderRoot?.querySelector(t)??null}})}const ts=6048e5,nt=Symbol.for("constructDateFrom");function T(t,e){return typeof t=="function"?t(e):t&&typeof t=="object"&&nt in t?t[nt](e):t instanceof Date?new t.constructor(e):new Date(e)}function C(t,e){return T(e||t,t)}function H(t,e,s){const a=C(t,s?.in);return isNaN(e)?T(t,NaN):(e&&a.setDate(a.getDate()+e),a)}function ft(t,e,s){const a=C(t,s?.in);if(isNaN(e))return T(t,NaN);if(!e)return a;const n=a.getDate(),r=T(t,a.getTime());r.setMonth(a.getMonth()+e+1,0);const h=r.getDate();return n>=h?r:(a.setFullYear(r.getFullYear(),r.getMonth(),n),a)}let ss={};function Ke(){return ss}function I(t,e){const s=Ke(),a=e?.weekStartsOn??e?.locale?.options?.weekStartsOn??s.weekStartsOn??s.locale?.options?.weekStartsOn??0,n=C(t,e?.in),r=n.getDay(),h=(r<a?7:0)+r-a;return n.setDate(n.getDate()-h),n.setHours(0,0,0,0),n}function Je(t,...e){const s=T.bind(null,t||e.find(a=>typeof a=="object"));return e.map(s)}function it(t,e){const s=C(t,e?.in);return s.setHours(0,0,0,0),s}function as(t,e,s){return H(t,e*7,s)}function x(t,e,s){const[a,n]=Je(s?.in,t,e);return+it(a)==+it(n)}function ns(t,e){const s=C(t,e?.in),a=s.getMonth();return s.setFullYear(s.getFullYear(),a+1,0),s.setHours(23,59,59,999),s}function gt(t,e){const[s,a]=Je(t,e.start,e.end);return{start:s,end:a}}function is(t,e){const{start:s,end:a}=gt(e?.in,t);let n=+s>+a;const r=n?+s:+a,h=n?a:s;h.setHours(0,0,0,0);let m=1;const d=[];for(;+h<=r;)d.push(T(s,h)),h.setDate(h.getDate()+m),h.setHours(0,0,0,0);return n?d.reverse():d}function rs(t,e){const{start:s,end:a}=gt(e?.in,t);let n=+s>+a;const r=I(n?a:s,e),h=I(n?s:a,e);r.setHours(15),h.setHours(15);const m=+h.getTime();let d=r,y=e?.step??1;if(!y)return[];y<0&&(y=-y,n=!n);const D=[];for(;+d<=m;)d.setHours(0),D.push(T(s,d)),d=as(d,y),d.setHours(15);return n?D.reverse():D}function os(t,e){const s=C(t,e?.in);return s.setDate(1),s.setHours(0,0,0,0),s}function ls(t,e){const s=C(t,e?.in),a=s.getFullYear(),n=Ke(),r=n.firstWeekContainsDate??n.locale?.options?.firstWeekContainsDate??1,h=T(t,0);h.setFullYear(a+1,0,r),h.setHours(0,0,0,0);const m=I(h,e),d=T(t,0);d.setFullYear(a,0,r),d.setHours(0,0,0,0);const y=I(d,e);return+s>=+m?a+1:+s>=+y?a:a-1}function ds(t,e){const s=Ke(),a=s.firstWeekContainsDate??s.locale?.options?.firstWeekContainsDate??1,n=ls(t,e),r=T(t,0);return r.setFullYear(n,0,a),r.setHours(0,0,0,0),I(r,e)}function hs(t,e){const s=C(t,e?.in),a=+I(s,e)-+ds(s,e);return Math.round(a/ts)+1}function mt(t,e){const s=C(t,e?.in),a=s.getMonth();return s.setFullYear(s.getFullYear(),a+1,0),s.setHours(0,0,0,0),C(s,e?.in)}function us(t,e,s){const[a,n]=Je(s?.in,t,e);return a.getFullYear()===n.getFullYear()&&a.getMonth()===n.getMonth()}function yt(t,e,s){const a=C(t,s?.in);return a.setHours(e),a}function cs(t,e,s){return ft(t,-1,s)}const ps=ot`
  @layer base, reset;
...
`;var fs=ps;function gs(t,e){const s=os(t),a=ns(t),n=rs({start:s,end:a},{weekStartsOn:1});for(;n.length<6;)n.push(H(n[n.length-1],7));return F`${e(n.map(r=>({days:is({start:r,end:H(r,6)})})))}`}var ce,Xe,ve,bt;let b=class extends dt{constructor(){super(...arguments),l(this,ce),l(this,ve),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.size="large",this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=t=>t.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(t){const e=mt(new Date(this.focusedYear,t,1)),s=new Date(this.focusedDate);s.setDate(Math.min(this.focusedDate.getDate(),e.getDate())),s.setMonth(t),s.setHours(12,0,0,0),this.focusedDate=s}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(t){this.focusedDate=new Date(this.focusedDate.setFullYear(t))}getDateCell(t){return this.shadowRoot?.querySelector(`#dateCell-${t}`)}connectedCallback(){super.connectedCallback(),pt.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",o(this,ve,bt)),window.addEventListener("lit-localize-status",t=>{t.detail.status==="ready"&&(this._currentLocale=t.detail.readyLocale)})}focus(){super.focus(),this._elFocusedCell?.focus()}render(){const t=new Date;return F`<table
      role="grid"
      aria-label="${st(this.label)}"
      class="${at({small:this.size==="small",indicators:!!this.customizedDates,"show-week-numbers":!!this.showWeekNumbers})}"
    >
            ...
            ${e.map(s=>F`
                <tr role="row">
                  ...
                  ${s.days.map(a=>{const n=this.customizedDates&&this.customizedDates.find(g=>x(g.date,a)),r={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(g=>x(g,a))),...n},h=!us(this.focusedDate,a),m=(a<this.min||a>this.max)&&!x(a,this.min)&&!x(a,this.max),d=a.getDay()===0||a.getDay()===6,y=r.disabled||m||this.disabledWeekends&&d;return this.hideExtraneousDays&&h?F`<td inert></td>`:F`
                          <td
                            role="${st(y?void 0:"gridcell")}"
                            class="${at({small:this.size==="small","custom-date":!!n,disabled:!!y,today:x(t,a),"outside-month":h})}"
                            ?disabled=${y}
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=new Date(this.value))}};ce=new WeakSet;Xe=function(t){const e=yt(t,12);this.value=e,this.dispatchCustomEvent("change",{detail:e,bubbles:!1,composed:!1})};ve=new WeakSet;bt=function(t){let e=!1,s=new Date(this.focusedDate);t.key==="ArrowLeft"?(s=H(this.focusedDate,-1),e=!0):t.key==="ArrowRight"?(s=H(this.focusedDate,1),e=!0):t.key==="ArrowUp"?(s=H(this.focusedDate,-7),e=!0):t.key==="ArrowDown"?(s=H(this.focusedDate,7),e=!0):t.key==="Enter"||t.key===" "?(this._elFocusedCell?.hasAttribute("disabled")||o(this,ce,Xe).call(this,this.focusedDate),e=!0):t.key==="Home"?(s=new Date(this.focusedYear,this.focusedMonth,1),e=!0):t.key==="End"?(s=new Date(this.focusedYear,this.focusedMonth+1,0),e=!0):t.key==="PageUp"?(s=cs(this.focusedDate),e=!0):t.key==="PageDown"&&(s=ft(this.focusedDate,1),e=!0),s.getFullYear()>=this.min.getFullYear()&&s.getFullYear()<=this.max.getFullYear()&&this.dispatchCustomEvent("gds-date-focused",{detail:s,bubbles:!1,composed:!1})&&(this.focusedDate=s),e&&(t.preventDefault(),t.stopPropagation(),this.updateComplete.then(()=>{this._elFocusedCell?.focus()}))};b.styles=[lt,fs];b.shadowRootOptions={mode:"open",delegatesFocus:!0};i([f()],b.prototype,"value",2);i([f({type:Date})],b.prototype,"min",2);i([f({type:Date})],b.prototype,"max",2);i([f()],b.prototype,"focusedDate",2);i([f({type:Boolean,attribute:"disabled-weekends"})],b.prototype,"disabledWeekends",2);i([f({type:Array,attribute:"disabled-dates"})],b.prototype,"disabledDates",2);i([f({type:Number})],b.prototype,"focusedMonth",1);i([f({type:Number})],b.prototype,"focusedYear",1);i([f({reflect:!0})],b.prototype,"size",2);i([f({type:Boolean})],b.prototype,"showWeekNumbers",2);i([f({type:Boolean})],b.prototype,"hideExtraneousDays",2);i([f({type:Boolean})],b.prototype,"hideDayNames",2);i([f({attribute:!1})],b.prototype,"customizedDates",2);i([f()],b.prototype,"label",2);i([f({attribute:!1})],b.prototype,"dateLabelTemplate",2);i([V()],b.prototype,"_currentLocale",2);i([Q('td[tabindex="0"]')],b.prototype,"_elFocusedCell",2);i([Z("value")],b.prototype,"_valueChanged",1);b=i([je("gds-calendar"),ct({labelledBy:"table",describedBy:"table"}),ht()],b);function*ms(t,e){const s=typeof e=="function";if(t!==void 0){let a=-1;for(const n of t)a>-1&&(yield s?e(a):e),a++,yield n}}function*ys(t,e){if(t!==void 0){let s=0;for(const a of t)yield e(a,s++)}}const rt=(t,e,s)=>{const a=new Map;for(let n=e;n<=s;n++)a.set(t[n],n);return a},bs=Rt(class extends It{constructor(t){if(super(t),t.type!==zt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let a;s===void 0?s=e:e!==void 0&&(a=e);const n=[],r=[];let h=0;for(const m of t)n[h]=a?a(m,h):h,r[h]=s(m,h),h++;return{values:r,keys:n}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,a]){const n=Bt(t),{values:r,keys:h}=this.dt(e,s,a);if(!Array.isArray(n))return this.ut=h,r;const m=this.ut??=[],d=[];let y,D,g=0,w=n.length-1,v=0,_=r.length-1;for(;g<=w&&v<=_;)if(n[g]===null)g++;else if(n[w]===null)w--;else if(m[g]===h[v])d[v]=z(n[g],r[v]),g++,v++;else if(m[w]===h[_])d[_]=z(n[w],r[_]),w--,_--;else if(m[g]===h[_])d[_]=z(n[g],r[_]),j(t,d[_+1],n[g]),g++,_--;else if(m[w]===h[v])d[v]=z(n[w],r[v]),j(t,n[g],n[w]),w--,v++;else if(y===void 0&&(y=rt(h,v,_),D=rt(m,g,w)),y.has(m[g]))if(y.has(m[w])){const $=D.get(h[v]),Y=$!==void 0?n[$]:null;if(Y===null){const ee=j(t,n[g]);z(ee,r[v]),d[v]=ee}else d[v]=z(Y,r[v]),j(t,n[g],Y),n[$]=null;v++}else be(n[w]),w--;else be(n[g]),g++;for(;v<=_;){const $=j(t,d[_+1]);z($,r[v]),d[v++]=$}for(;g<=w;){const $=n[g++];$!==null&&be($)}return this.ut=h,Et(t,d),Ft}});var O,se,ae,ne,ie,we,_e,ke,De,vt,q,U,re,xe,P,K,J,oe;let W=class extends dt{constructor(){super(...arguments),l(this,De),l(this,q),l(this,re),l(this,P),l(this,J),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=o(this,re,xe).call(this,this.value,this.length),l(this,O,""),l(this,se,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=o(this,P,K).call(this,t+1),o(this,q,U).call(this)}),l(this,ae,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=o(this,P,K).call(this,t-1),o(this,q,U).call(this)}),l(this,ne,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),l(this,ie,()=>{o(this,J,oe).call(this)}),l(this,we,()=>{u(this,O)!==""&&(o(this,J,oe).call(this),this.value=o(this,P,K).call(this,parseInt(this.value.toString())),o(this,q,U).call(this))}),l(this,_e,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?u(this,ae).call(this):u(this,se).call(this)}),l(this,ke,t=>{let e=!1;if(t.key==="ArrowUp")u(this,se).call(this),e=!0;else if(t.key==="ArrowDown")u(this,ae).call(this),e=!0;else{const s=parseInt(t.key);isNaN(s)||(u(this,O).length<this.length&&(L(this,O,u(this,O)+s.toString()),this.value=parseInt(u(this,O))),u(this,O).length===this.length&&(this.value=o(this,P,K).call(this,this.value),o(this,J,oe).call(this),o(this,De,vt).call(this),o(this,q,U).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",u(this,_e)),this.addEventListener("keydown",u(this,ke)),this.addEventListener("blur",u(this,we)),this.addEventListener("focus",u(this,ie)),this.addEventListener("click",u(this,ne)),this.addEventListener("mousedown",u(this,ne))}focus(t){super.focus(t),u(this,ie).call(this)}render(){return k`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=o(this,re,xe).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};O=new WeakMap;se=new WeakMap;ae=new WeakMap;ne=new WeakMap;ie=new WeakMap;we=new WeakMap;_e=new WeakMap;ke=new WeakMap;De=new WeakSet;vt=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof W){t.focus();break}t=t.nextElementSibling}};q=new WeakSet;U=function(){this.dispatchCustomEvent("change",{detail:{value:this.value.toString()}})};re=new WeakSet;xe=function(t,e){return String(t).padStart(e,"0")};P=new WeakSet;K=function(t){return Math.max(this.min,Math.min(this.max,t))};J=new WeakSet;oe=function(){L(this,O,"")};W.formAssociated=!0;i([f({type:Number})],W.prototype,"value",2);i([f({type:Number})],W.prototype,"length",2);i([f({type:Number,attribute:"aria-valuemin"})],W.prototype,"min",2);i([f({type:Number,attribute:"aria-valuemax"})],W.prototype,"max",2);i([V()],W.prototype,"displayValue",2);i([Z("value")],W.prototype,"_refreshDisplayValue",1);W=i([je("gds-date-part-spinner")],W);const vs=ot`
  @layer base, reset;
...
`;var ws=vs,le,X,$e,wt,Se,_t,Me,kt,ye,Qe,pe,Ze,de,Ce,We,Dt,Fe,xt,he,Te,N,R,Ye,$t,A,B,E,G,Oe,Ne,Ae,Re,Ie,ze,Be,Ee,Le,fe,He,Ve,ue,qe,Pe,S,Ge,St,et,Mt;let c=class extends Lt{constructor(){super(),l(this,$e),l(this,Se),l(this,Me),l(this,ye),l(this,pe),l(this,de),l(this,We),l(this,Fe),l(this,he),l(this,N),l(this,Ye),l(this,A),l(this,E),l(this,ue),l(this,Ge),l(this,et),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,11,31),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.clearable=!1,this.hideTodayButton=!1,l(this,le,12),this.disabledWeekends=!1,this.showExtendedSupportingText=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=o(this,ue,qe).call(this,"y-m-d"),this._currentLocale=navigator.language,l(this,X,void 0),l(this,Oe,e=>{this._elTrigger.then(s=>{document.getSelection()?.removeAllRanges();const a=new Range;a.setStart(s.firstChild,0),a.setEnd(s.lastChild,4),document.getSelection()?.addRange(a)})}),l(this,Ne,e=>{this._elFieldAsync.then(s=>{e.currentTarget===s&&(e.preventDefault(),e.clipboardData?.setData("text/plain",this.displayValue))})}),l(this,Ae,e=>{this._elFieldAsync.then(s=>{if(e.currentTarget!==s)return;e.preventDefault();const a=e.clipboardData?.getData("text/plain");if(!a)return;let n=new Date("-");const r="Invalid Date",h=a.split(this._dateFormatLayout.delimiter);if(h.length===3){const m=this._dateFormatLayout.layout,d=parseInt(h[m.findIndex(g=>g.token==="y")]),y=parseInt(h[m.findIndex(g=>g.token==="m")])-1,D=parseInt(h[m.findIndex(g=>g.token==="d")]);!isNaN(d)&&!isNaN(y)&&!isNaN(D)&&(n=new Date(`${d}-${y+1}-${D}`))}n.toString()===r&&(n=new Date(a),n.toString()===r)||(this.value=n,o(this,A,B).call(this))})}),l(this,Re,e=>{this._elSpinners[0]?.focus()}),l(this,Ie,e=>{e.stopPropagation();const s=new Date(e.detail);s.setUTCHours(this.utcHours,0,0,0),this.value=s,this.open=!1,o(this,A,B).call(this),o(this,E,G).call(this)}),l(this,ze,e=>{e.stopPropagation(),this._focusedMonth=e.target?.value}),l(this,Be,e=>{e.stopPropagation(),this._focusedYear=e.target?.value}),l(this,Ee,e=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),l(this,Le,e=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),l(this,fe,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=new Date((await this._elCalendar).focusedDate),this.requestUpdate(),o(this,E,G).call(this)}),l(this,He,async e=>{if(e.target===e.currentTarget){if(this.open=e.detail.open,e.detail.reason==="close"){const s=(await this._elCalendar).value;if(!s){this.value=void 0,o(this,A,B).call(this);return}!x(s||new Date(0),u(this,X)||new Date(0))&&(this.value=new Date(s),o(this,A,B).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}e.detail.reason==="cancel"&&(this.value=u(this,X),o(this,E,G).call(this))}}),l(this,Ve,e=>{const s=Array.from(this._elSpinners).findIndex(a=>a===e.target);if(e.key==="ArrowRight"){const a=this._elSpinners[s+1];a&&a.focus()}if(e.key==="ArrowLeft"){const a=this._elSpinners[s-1];a&&a.focus()}}),l(this,Pe,(e,s)=>{u(this,S)[s]=e;const a=new Date("0000-01-01");a.setUTCHours(this.utcHours,0,0,0),a.setUTCFullYear(parseInt(u(this,S).year)),a.setUTCMonth(parseInt(u(this,S).month)-1);const n=mt(a).getDate(),r=n<parseInt(u(this,S).day)?n:parseInt(u(this,S).day);a.setUTCDate(isNaN(r)?1:r),a.toString()!=="Invalid Date"&&(this.value=a,o(this,A,B).call(this),o(this,E,G).call(this))}),l(this,S,{year:"yyyy",month:"mm",day:"dd"}),W.define()}get type(){return"gds-datepicker"}get value(){return super.value}set value(e){super.value=e}get utcHours(){return u(this,le)}set utcHours(e){L(this,le,e),this._internalValue?.setUTCHours(e,0,0,0)}get dateformat(){return this._dateFormatLayout.layout.map(e=>e.token).join(this._dateFormatLayout.delimiter)}set dateformat(e){this._dateFormatLayout=o(this,ue,qe).call(this,e)}async getFocusedDate(){if(this.open)return this._elCalendar.then(e=>e.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(e){return this._elCalendar.then(s=>s.getDateCell(e))}connectedCallback(){super.connectedCallback(),pt.instance.apply(this,"gds-datepicker"),window.addEventListener("lit-localize-status",e=>{e.detail.status==="ready"&&(this._currentLocale=e.detail.readyLocale,this.value||L(this,S,{year:o(this,N,R).call(this,"year"),month:o(this,N,R).call(this,"month"),day:o(this,N,R).call(this,"day")}),this.requestUpdate())})}focus(e){this._getValidityAnchor()?.focus(e)}render(){return k`
      ...
      >
        <div class="spinners">
          ${ms(ys(this._dateFormatLayout.layout,(e,s)=>k`<gds-date-part-spinner
                  ...
                  .value=${o(this,Ye,$t).call(this,e.name)}
                  aria-valuemin=${o(this,Fe,xt).call(this,e.name)}
                  aria-valuemax=${o(this,he,Te).call(this,e.name)}
                  aria-label=${o(this,We,Dt).call(this,e.name)}
      ...
      ${M(o(this,$e,wt).call(this),()=>k`<gds-form-control-footer
            class="size-${this.size}"
        ...
        <gds-div overflow="auto">
          ...
          >
            ...
            <gds-dropdown
              ...
              hide-label
            >
              ${bs(u(this,Ge,St),e=>e,e=>k`<gds-option value=${e}>${e}</gds-option>`)}
            </gds-dropdown>
            <gds-button
              @click=${u(this,Ee)}
    ...
    `}_getValidityAnchor(){return this._elSpinners[0]}_handleOutOfRangeChange(){o(this,Me,kt).call(this)}_handleValueChange(){if(this.value===""&&(this.value=void 0),!this.value){L(this,S,{year:o(this,N,R).call(this,"year"),month:o(this,N,R).call(this,"month"),day:o(this,N,R).call(this,"day")});return}const e=this.value;this._focusedMonth=e.getMonth(),this._focusedYear=e.getFullYear();const s=e.getFullYear().toString(),a=(e.getMonth()+1).toString().padStart(2,"0"),n=e.getDate().toString().padStart(2,"0");L(this,S,{year:s,month:a,day:n})}_handleOpenChange(){this.open&&(L(this,X,this.value),this._elCalendar.then(e=>e.focus()))}};le=new WeakMap;X=new WeakMap;$e=new WeakSet;wt=function(){return!this.plain};Se=new WeakSet;_t=function(){if(!this._outOfRangeAction)return Nt;const t=this._outOfRangeAction==="max";return k`<gds-button
