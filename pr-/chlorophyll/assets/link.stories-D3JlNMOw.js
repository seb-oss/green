const e={title:"Components/Links",tags:["autodocs"],parameters:{componentIds:["component-inlinelinks"]}},a={render:n=>`
    <a href="#" class="gds-link">Normal link</a>    
    <a href="https://www.seb.se" class="gds-link">
      Go to seb.se
    </a>
    <a>Disabled link</a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},i={render:n=>`
  ...
  </a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},t={render:()=>`
  <a href="#" class="gds-link link-arrow" aria-label="External link">
  ...
  </a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},r={render:()=>`
    ...
    <a href="#" class="gds-button ghost-dark">Ghost link button</a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},l=["Links","Link","LinkWithIcon","LinkWithArrow","LinkAsButton"];export{i as Link,r as LinkAsButton,t as LinkWithArrow,s as LinkWithIcon,a as Links,l as __namedExportsOrder,e as default};
