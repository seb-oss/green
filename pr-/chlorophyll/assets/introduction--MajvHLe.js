import{j as e,M as i}from"./blocks-CE68UyOU.js";import{useMDXComponents as s}from"./index-CnwaiPns.js";import"./iframe-BIHXMNuE.js";function o(t){const n={a:"a",code:"code",h1:"h1",h3:"h3",p:"p",pre:"pre",strong:"strong",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Use cases/Mixing frameworks/Introduction"}),`
...
`,e.jsxs(n.p,{children:["Read more and view examples on how to ",e.jsx(n.a,{href:"/docs/use-cases-mixing-frameworks-use-green-with-bootstrap--page",children:"use Green with Bootstrap"})]})]})}function d(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{d as default};
