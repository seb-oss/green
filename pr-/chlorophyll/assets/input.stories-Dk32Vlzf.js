...
<div class="gds-form-group">
  <label for="inputInvalid" class="gds-label">${t.text}</label>
  ${t.formInfo?'<span class="gds-form-info">'+t.formInfo+"</span>":""}
  <input id="inputInvalid" type="text" class="gds-input ${t.validation}" ${t.disabled?"disabled":""} />
  <span class="gds-form-info">${t.validation?t.validation:""}</span>
