...
`;var te=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,J=(e,o,t,s)=>{for(var n=s>1?void 0:s?ne(o,t):o,r=e.length-1,a;r>=0;r--)(a=e[r])&&(n=(s?a(o,t,n):a(n))||n);return s&&n&&te(o,t,n),n};let x=class extends R{constructor(){super(...arguments),this.open=!1}render(){return d`
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
    ...
    `}updated(e){var o;if(e.has("open")){const t=(o=this.shadowRoot)==null?void 0:o.querySelector("svg");if(t){const s=new CustomEvent("toggle",{bubbles:!0,composed:!0});t.dispatchEvent(s)}}}};x.styles=[oe];J([h({type:Boolean,reflect:!0})],x.prototype,"open",2);x=J([H("gds-icon-accordion")],x);var se=Object.defineProperty,re=Object.getOwnPropertyDescriptor,F=e=>{throw TypeError(e)},l=(e,o,t,s)=>{for(var n=s>1?void 0:s?re(o,t):o,r=e.length-1,a;r>=0;r--)(a=e[r])&&(n=(s?a(o,t,n):a(n))||n);return s&&n&&se(o,t,n),n},V=(e,o,t)=>o.has(e)||F("Cannot "+t),_=(e,o,t)=>(V(e,o,"read from private field"),t?t.call(e):o.get(e)),E=(e,o,t)=>o.has(e)?F("Cannot add the same private member more than once"):o instanceof WeakSet?o.add(e):o.set(e,t),u=(e,o,t)=>(V(e,o,"access private method"),t),c,v,b,K,U,j,X;let i=class extends R{constructor(){super(...arguments),E(this,c),this.summary="",this.name="",this.open=!1,this._summarySlotIconOpenOccupied=!1,this._summarySlotIconClosedOccupied=!1,this.size="large",E(this,b,(e,o)=>{const s=o.target.assignedNodes({flatten:!0}),n=s.length>0&&s.some(r=>{var a;return r.nodeType===Node.ELEMENT_NODE||r.nodeType===Node.TEXT_NODE&&((a=r.textContent)==null?void 0:a.trim())!==""});e==="summary-icon-open"?this._summarySlotIconOpenOccupied=n:e==="summary-icon-closed"&&(this._summarySlotIconClosedOccupied=n)})}handleOpenChange(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("gds-icon-accordion");e&&(e.open=this.open)}render(){const e={details:!0,open:this.open,small:this.size==="small"};return d`<div class=${Q(e)}>
      ${u(this,c,K).call(this)}
    </div> `}};c=new WeakSet;v=function(){var o;this.open=!this.open,this.open&&this.name&&document.querySelectorAll("gds-accordion").forEach(s=>{var n;if(s!==this&&s.name===this.name){s.open=!1;const r=(n=s.shadowRoot)==null?void 0:n.querySelector(".content");r&&r.style.setProperty("--_max-height","0"),s.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:!1}))}});const e=(o=this.shadowRoot)==null?void 0:o.querySelector(".content");e&&e.style.setProperty("--_max-height",this.open?`${e.scrollHeight}px`:"0"),this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))};b=new WeakMap;K=function(){return[u(this,c,j).call(this),u(this,c,U).call(this)].map(o=>d`${o}`)};U=function(){return d`<div class="content" aria-hidden="${!this.open}">
      <slot></slot>
    </div>`};j=function(){return d`<div class="summary">
      <div
        class="summary-label"
        @click=${u(this,c,v)}
        role="button"
    ...
    </div>`};X=function(){return!this._summarySlotIconOpenOccupied&&!this._summarySlotIconClosedOccupied?d`<gds-icon-accordion></gds-icon-accordion>`:d`
      ${this.open&&this._summarySlotIconClosedOccupied?d`<slot
          ...
          ></slot>`:d`<slot
            ...
            @slotchange=${e=>_(this,b).call(this,"summary-icon-open",e)}
          ></slot>`}
    `};i.styles=[Y,ee];l([h()],i.prototype,"summary",2);l([h()],i.prototype,"name",2);l([h({type:Boolean,reflect:!0})],i.prototype,"open",2);l([Z("open")],i.prototype,"handleOpenChange",1);l([B()],i.prototype,"_summarySlotIconOpenOccupied",2);l([B()],i.prototype,"_summarySlotIconClosedOccupied",2);l([h({type:String})],i.prototype,"size",2);i=l([H("gds-accordion")],i);const $e={title:"Components/Accordion",component:"gds-accordion",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the accordion header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups accordions together. Accordions with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}}},parameters:{docs:{description:{component:`
## Overview
...
Just as in the native select if you set the open attribute to true the accordion will be open by default.
  ...
  `};var O,S,q,C,L;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Accordion',
  args: {
    innerHTML: \`<p>Content</p>\`
  }
}`,...(q=(S=p.parameters)==null?void 0:S.docs)==null?void 0:q.source},description:{story:`Basic example of an accordion component.
This story demonstrates the default usage with simple content.`,...(L=(C=p.parameters)==null?void 0:C.docs)==null?void 0:L.description}}};var $,A,P,z,I;g.parameters={...g.parameters,docs:{...($=g.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Name',
  parameters: {
  ...
  \`
}`,...(P=(A=g.parameters)==null?void 0:A.docs)==null?void 0:P.source},description:{story:`This story demonstrates how accordions with the same name interact with each other.<br/>
...
- The behavior works across Shadow DOM boundaries`,...(I=(z=g.parameters)==null?void 0:z.docs)==null?void 0:I.description}}};var D,T,N;y.parameters={...y.parameters,docs:{...(D=y.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Open',
  parameters: {
    ...DefaultParams.parameters,
