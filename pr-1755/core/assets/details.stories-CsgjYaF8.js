...
\`\`\`  
  ...
  `};var T,I,P,k,G;p.parameters={...p.parameters,docs:{...(T=p.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    summary: 'Click to expand',
    innerHTML: 'Details content goes here'
  }
}`,...(P=(I=p.parameters)==null?void 0:I.docs)==null?void 0:P.source},description:{story:"Basic example of an details component.",...(G=(k=p.parameters)==null?void 0:k.docs)==null?void 0:G.description}}};var M,W,L,H,R;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Grouped',
  parameters: {
    docs: {
...
\`
  ...
  \`
}`,...(L=(W=c.parameters)==null?void 0:W.docs)==null?void 0:L.source},description:{story:"Example of grouped detailss.",...(R=(H=c.parameters)==null?void 0:H.docs)==null?void 0:R.description}}};var q,B,A,F,V;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Sizes',
  parameters: {
    docs: {
...
\\\`\\\`\\\`        
  ...
  \`
}`,...(A=(B=g.parameters)==null?void 0:B.docs)==null?void 0:A.source},description:{story:"Example of different size variants.",...(V=(F=g.parameters)==null?void 0:F.docs)==null?void 0:V.description}}};var N,j,K,U,J;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Rich Content',
  parameters: {
    docs: {
...
\\\`\\\`\\\`  
  ...
  \`
}`,...(Y=(X=u.parameters)==null?void 0:X.docs)==null?void 0:Y.source},description:{story:"Example of initially open details.",...(ee=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};const qe=["Default","Grouped","Sizes","RichContent","InitiallyOpen"];export{p as Default,c as Grouped,u as InitiallyOpen,h as RichContent,g as Sizes,qe as __namedExportsOrder,Re as default};
