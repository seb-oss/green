...
`;var pe=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,re=(e,t,s,a)=>{for(var n=a>1?void 0:a?ce(t,s):t,d=e.length-1,m;d>=0;d--)(m=e[d])&&(n=(a?m(t,s,n):m(n))||n);return a&&n&&pe(t,s,n),n};let x=class extends ae{constructor(){super(...arguments),this.open=!1}render(){return y`
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
    ...
    `}updated(e){var t;if(e.has("open")){const s=(t=this.shadowRoot)==null?void 0:t.querySelector("svg");if(s){const a=new CustomEvent("toggle",{bubbles:!0,composed:!0});s.dispatchEvent(a)}}}};x.styles=[me];re([v({type:Boolean,reflect:!0})],x.prototype,"open",2);x=re([ne("gds-icon-details")],x);x.define();var ge=Object.defineProperty,he=Object.getOwnPropertyDescriptor,ie=e=>{throw TypeError(e)},l=(e,t,s,a)=>{for(var n=a>1?void 0:a?he(t,s):t,d=e.length-1,m;d>=0;d--)(m=e[d])&&(n=(a?m(t,s,n):m(n))||n);return a&&n&&ge(t,s,n),n},ue=(e,t,s)=>t.has(e)||ie("Cannot "+s),r=(e,t,s)=>(ue(e,t,"read from private field"),s?s.call(e):t.get(e)),o=(e,t,s)=>t.has(e)?ie("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),S,f,w,z,D,C,$,k,E;let i=class extends ae{constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",o(this,S,()=>{this._content&&r(this,f).call(this)}),o(this,f,()=>{this._content&&requestAnimationFrame(()=>{var e;(e=this._content)==null||e.style.setProperty("--_max-height",this.open?`${this._content.scrollHeight}px`:"0")})}),o(this,w,()=>{this.open=!this.open,r(this,f).call(this),r(this,D).call(this),r(this,C).call(this)}),o(this,z,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),r(this,w).call(this))}),o(this,D,()=>{!this.open||!this.name||document.querySelectorAll('[gds-element="gds-details"]').forEach(e=>{var t,s;if(e!==this&&e.name===this.name){const a=e;a.open=!1,r(t=a,f).call(t),r(s=a,C).call(s)}})}),o(this,C,()=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))}),o(this,$,()=>y`
      <div
        class="summary"
        part="summary"
        role="button"
...
\`\`\`  
  ...
  `};var T,I,P,G,M;p.parameters={...p.parameters,docs:{...(T=p.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    summary: 'Click to expand',
    innerHTML: 'Details content goes here'
  }
}`,...(P=(I=p.parameters)==null?void 0:I.docs)==null?void 0:P.source},description:{story:"Basic example of an details component.",...(M=(G=p.parameters)==null?void 0:G.docs)==null?void 0:M.description}}};var W,L,H,R,B;c.parameters={...c.parameters,docs:{...(W=c.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Grouped',
  parameters: {
    docs: {
...
\\\`\\\`\\\`        
  ...
  \`
}`,...(F=(A=g.parameters)==null?void 0:A.docs)==null?void 0:F.source},description:{story:"Example of different size variants.",...(K=(V=g.parameters)==null?void 0:V.docs)==null?void 0:K.description}}};var N,j,U,J,Q;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Rich Content',
  parameters: {
    docs: {
  ...
  \`
}`,...(U=(j=h.parameters)==null?void 0:j.docs)==null?void 0:U.source},description:{story:"Example with rich content.",...(Q=(J=h.parameters)==null?void 0:J.docs)==null?void 0:Q.description}}};var X,Y,Z,ee,te;u.parameters={...u.parameters,docs:{...(X=u.parameters)==null?void 0:X.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Initially Open',
  parameters: {
    docs: {
...
\\\`\\\`\\\`  
  ...
  \`
}`,...(Z=(Y=u.parameters)==null?void 0:Y.docs)==null?void 0:Z.source},description:{story:"Example of initially open details.",...(te=(ee=u.parameters)==null?void 0:ee.docs)==null?void 0:te.description}}};const Ne=["Default","Grouped","Sizes","RichContent","InitiallyOpen"];export{p as Default,c as Grouped,u as InitiallyOpen,h as RichContent,g as Sizes,Ne as __namedExportsOrder,Ke as default};
