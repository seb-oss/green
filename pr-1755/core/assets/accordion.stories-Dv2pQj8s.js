...
\`\`\`
        `}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...d,name:"Accordion",args:{innerHTML:"<p>Content</p>"}},r={...d,name:"Name",parameters:{...d.parameters,controls:{include:[]}},render:e=>q`
...
Just as in the native select if you set the open attribute to true the accordion will be open by default.
  ...
  `};var h,y,b,x,f;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Accordion',
  args: {
...
This story demonstrates the default usage with simple content.`,...(f=(x=i.parameters)==null?void 0:x.docs)==null?void 0:f.description}}};var v,w,O,E,L;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Name',
  parameters: {
...
- The behavior works across Shadow DOM boundaries`,...(L=(E=r.parameters)==null?void 0:E.docs)==null?void 0:L.description}}};var C,N,A;m.parameters={...m.parameters,docs:{...(C=m.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Open',
  parameters: {
    ...DefaultParams.parameters,
...
Just as in the native select if you set the open attribute to true the accordion will be open by default.
  ...
  \`
}`,...(A=(N=m.parameters)==null?void 0:N.docs)==null?void 0:A.source}}};const ne=["accordion","Name","Open"];export{r as Name,m as Open,ne as __namedExportsOrder,i as accordion,se as default};
