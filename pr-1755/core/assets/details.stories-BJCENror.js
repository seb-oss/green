...
`;var me=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,ne=(e,t,s,a)=>{for(var n=a>1?void 0:a?pe(t,s):t,d=e.length-1,m;d>=0;d--)(m=e[d])&&(n=(a?m(t,s,n):m(n))||n);return a&&n&&me(t,s,n),n};let x=class extends se{constructor(){super(...arguments),this.open=!1}render(){return y`
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
    ...
    `}updated(e){var t;if(e.has("open")){const s=(t=this.shadowRoot)==null?void 0:t.querySelector("svg");if(s){const a=new CustomEvent("toggle",{bubbles:!0,composed:!0});s.dispatchEvent(a)}}}};x.styles=[de];ne([v({type:Boolean,reflect:!0})],x.prototype,"open",2);x=ne([ae("gds-icon-details")],x);x.define();var ce=Object.defineProperty,ge=Object.getOwnPropertyDescriptor,re=e=>{throw TypeError(e)},l=(e,t,s,a)=>{for(var n=a>1?void 0:a?ge(t,s):t,d=e.length-1,m;d>=0;d--)(m=e[d])&&(n=(a?m(t,s,n):m(n))||n);return a&&n&&ce(t,s,n),n},he=(e,t,s)=>t.has(e)||re("Cannot "+s),r=(e,t,s)=>(he(e,t,"read from private field"),s?s.call(e):t.get(e)),o=(e,t,s)=>t.has(e)?re("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),S,f,C,z,w,D,$,E;let i=class extends se{constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",o(this,S,()=>{this._content&&r(this,f).call(this)}),o(this,f,()=>{this._content&&requestAnimationFrame(()=>{var e;(e=this._content)==null||e.style.setProperty("--_max-height",this.open?`${this._content.scrollHeight}px`:"0")})}),o(this,C,()=>{this.open=!this.open,r(this,f).call(this),r(this,z).call(this),r(this,w).call(this)}),o(this,z,()=>{!this.open||!this.name||document.querySelectorAll('[gds-element="gds-details"]').forEach(e=>{var t,s;if(e!==this&&e.name===this.name){const a=e;a.open=!1,r(t=a,f).call(t),r(s=a,w).call(s)}})}),o(this,w,()=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))}),o(this,D,()=>y`
    ...
    `}};S=new WeakMap;f=new WeakMap;C=new WeakMap;z=new WeakMap;w=new WeakMap;D=new WeakMap;$=new WeakMap;E=new WeakMap;i.styles=[oe,le];l([v({type:String})],i.prototype,"summary",2);l([v({type:String})],i.prototype,"name",2);l([v({type:Boolean,reflect:!0})],i.prototype,"open",2);l([v({type:String})],i.prototype,"size",2);l([k(".content")],i.prototype,"_content",2);l([k('slot[name="summary-icon-open"]')],i.prototype,"_openIconSlot",2);l([k('slot[name="summary-icon-closed"]')],i.prototype,"_closedIconSlot",2);i=l([ae("gds-details")],i);i.define();const Ve={title:"Components/Details",component:"gds-details",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the details header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups detailss together. Detailss with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}},open:{description:"Controls if the details is expanded",control:"boolean",table:{type:{summary:"boolean"}}},size:{description:"Controls the size of the details",control:{type:"select",options:["large","small"]},table:{type:{summary:'"large" | "small"'},defaultValue:{summary:"large"}}}},parameters:{docs:{description:{component:`
## Overview
