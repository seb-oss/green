...
`;var I=Object.defineProperty,H=Object.getOwnPropertyDescriptor,i=(o,n,c,s)=>{for(var e=s>1?void 0:s?H(n,c):n,p=o.length-1,g;p>=0;p--)(g=o[p])&&(e=(s?g(n,c,e):g(e))||e);return s&&e&&I(n,c,e),e};let t=class extends ${constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",this.isOpen=!1,this.handleToggle=o=>{const n=o.target;this.isOpen=n.open,this.open=n.open,this.isOpen&&this.name&&document.querySelectorAll("gds-accordion").forEach(s=>{const e=s;e!==this&&e.name===this.name&&(e.open=!1)})}}connectedCallback(){super.connectedCallback(),this.addEventListener("toggle",this.handleToggle),this.isOpen=this.open}disconnectedCallback(){this.removeEventListener("toggle",this.handleToggle),super.disconnectedCallback()}updated(o){o.has("open")&&(this.isOpen=this.open)}render(){return G`<details
      ?open=${this.open}
      ?name=${this.name||""}
    ...
    </details> `}};t.styles=[M,N];i([u()],t.prototype,"summary",2);i([u()],t.prototype,"name",2);i([u({type:Boolean,reflect:!0})],t.prototype,"open",2);i([u({type:String})],t.prototype,"size",2);i([k()],t.prototype,"isOpen",2);t=i([_("gds-accordion")],t);const Z={title:"Components/Accordion",component:"gds-accordion",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the accordion header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups accordions together. Accordions with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}}},parameters:{docs:{description:{component:`
## Overview
...
\`\`\`
        `}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},r={...a,name:"Accordion",args:{innerHTML:"<p>Content</p>"}},d={...a,name:"Name",parameters:{...a.parameters,controls:{include:[]}},render:o=>h`
  ...
  `},m={...a,name:"Open",parameters:{...a.parameters,controls:{include:[]},docs:{description:{story:`
### Open Accordion
Just as in the native select if you set the open attribute to true the accordion will be open by default.
  ...
  `},l={...a,name:"Size",parameters:{...a.parameters,controls:{include:[]},docs:{description:{story:`
### Open Accordion
Just as in the native select if you set the open attribute to true the accordion will be open by default.
        `}}},render:o=>h`
    <gds-accordion open name="default-open" summary="I'm open by default">
...
Just as in the native select if you set the open attribute to true the accordion will be open by default.
  ...
  \`
}`,...(D=(T=l.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};const ee=["accordion","Name","Open","Size"];export{d as Name,m as Open,l as Size,ee as __namedExportsOrder,r as accordion,Z as default};
