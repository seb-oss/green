import{m as O}from"./runtime-BL31MtW8.js";import{l as G}from"./localized-decorator-DtmrKsyB.js";import{n as m,r as M,g as y,G as w,h as o}from"./custom-element-scoping-BEGY3AqQ.js";import{a as F}from"./query-p8xgzTDt.js";import{n as c}from"./when-BR7zwNJC.js";import{i as E}from"./lit-element-C_s9q329.js";import"./button-CYVJ_aNX.js";import"./triangle-exclamation-BVOOPWQa.js";import"./card-Ba2-oykd.js";import"./badge-fSe2_Saj.js";const W=E`
...
`;var k=Object.defineProperty,B=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},h=(e,t,s,a)=>{for(var r=a>1?void 0:a?B(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&k(t,s,r),r},$=(e,t,s)=>t.has(e)||S("Cannot "+s),_=(e,t,s)=>($(e,t,"read from private field"),s?s.call(e):t.get(e)),g=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),b=(e,t,s)=>($(e,t,"access private method"),s),p,T,x,v,C;let d=class extends w{constructor(){super(...arguments),g(this,p),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,g(this,x,()=>o`
    ...
    `}};p=new WeakSet;T=function(e){this._hasExtendedSupportingText=e.target.assignedElements({flatten:!0}).length>0};x=new WeakMap;v=new WeakMap;C=function(){return o`
      <div
...
`;var H=Object.defineProperty,A=Object.getOwnPropertyDescriptor,z=e=>{throw TypeError(e)},f=(e,t,s,a)=>{for(var r=a>1?void 0:a?A(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&H(t,s,r),r},N=(e,t,s)=>t.has(e)||z("Cannot "+s),I=(e,t,s)=>t.has(e)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),R=(e,t,s)=>(N(e,t,"access private method"),s),u,P;let l=class extends w{constructor(){super(...arguments),I(this,u)}render(){return o`<div aria-live="polite">
    ...
    </div>`}};u=new WeakSet;P=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",o`<gds-badge variant="${t}">${e}</gds-badge>`};l.styles=[D];f([m({type:Number})],l.prototype,"charCounter",2);f([m()],l.prototype,"validationMessage",2);l=f([y("gds-form-control-footer")],l);
