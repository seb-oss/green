...
`;var I=Object.defineProperty,H=Object.getOwnPropertyDescriptor,a=(t,n,c,i)=>{for(var e=i>1?void 0:i?H(n,c):n,p=t.length-1,g;p>=0;p--)(g=t[p])&&(e=(i?g(n,c,e):g(e))||e);return i&&e&&I(n,c,e),e};let o=class extends ${constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",this.isOpen=!1,this.handleToggle=t=>{const n=t.target;this.isOpen=n.open,this.open=n.open,this.isOpen&&this.name&&document.querySelectorAll("gds-accordion").forEach(i=>{const e=i;e!==this&&e.name===this.name&&(e.open=!1)})}}connectedCallback(){super.connectedCallback(),this.addEventListener("toggle",this.handleToggle),this.isOpen=this.open}disconnectedCallback(){this.removeEventListener("toggle",this.handleToggle),super.disconnectedCallback()}updated(t){t.has("open")&&(this.isOpen=this.open)}render(){return G`<details
      ?open=${this.open}
      ?name=${this.name||""}
    ...
    </details>`}};o.styles=[M,N];a([u()],o.prototype,"summary",2);a([u()],o.prototype,"name",2);a([u({type:Boolean,reflect:!0})],o.prototype,"open",2);a([u({type:String})],o.prototype,"size",2);a([k()],o.prototype,"isOpen",2);o=a([_("gds-accordion")],o);const Y={title:"Components/Accordion",component:"gds-accordion",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the accordion header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups accordions together. Accordions with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}}},parameters:{docs:{description:{component:`
## Overview
...
- The behavior works across Shadow DOM boundaries`,...(q=(O=d.parameters)==null?void 0:O.docs)==null?void 0:q.description}}};var S,z,A;m.parameters={...m.parameters,docs:{...(S=m.parameters)==null?void 0:S.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Open',
  parameters: {
    ...DefaultParams.parameters,
...
Just as in the native select if you set the open attribute to true the accordion will be open by default.
  ...
  \`
}`,...(A=(z=m.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var C,T,D;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  parameters: {
    ...DefaultParams.parameters,
