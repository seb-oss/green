...
`;var re=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,C=(t,e,r,n)=>{for(var o=n>1?void 0:n?ae(e,r):e,c=t.length-1,d;c>=0;c--)(d=t[c])&&(o=(n?d(e,r,o):d(o))||o);return n&&o&&re(e,r,o),o};let x=class extends ee{constructor(){super(...arguments),this.open=!1,this.customIcon=!1}render(){return this.customIcon?i`<slot></slot>`:i`
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
    ...
    `}updated(t){var e;if(t.has("open")){const r=(e=this.shadowRoot)==null?void 0:e.querySelector("svg");if(r){const n=new CustomEvent("toggle",{bubbles:!0,composed:!0});r.dispatchEvent(n)}}}};x.styles=[se];C([m({type:Boolean,reflect:!0})],x.prototype,"open",2);C([m({type:Boolean,attribute:"custom-icon"})],x.prototype,"customIcon",2);x=C([Z("gds-icon-accordion")],x);var ie=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,a=(t,e,r,n)=>{for(var o=n>1?void 0:n?ce(e,r):e,c=t.length-1,d;c>=0;c--)(d=t[c])&&(o=(n?d(e,r,o):d(o))||o);return n&&o&&ie(e,r,o),o};let s=class extends ee{constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",this.customIcon=!1,this._handleToggle=()=>{this.open=!this.open,this._updateContentHeight(),this._syncGroupState(),this._dispatchStateEvent()}}firstUpdated(){this._initializeContentHeight()}_initializeContentHeight(){this._content&&this._updateContentHeight()}_updateContentHeight(){this._content&&requestAnimationFrame(()=>{var t;(t=this._content)==null||t.style.setProperty("--_max-height",this.open?`${this._content.scrollHeight}px`:"0")})}_syncGroupState(){!this.open||!this.name||document.querySelectorAll("gds-accordion").forEach(t=>{if(t!==this&&t.name===this.name){const e=t;e.open=!1,e._updateContentHeight(),e._dispatchStateEvent()}})}_dispatchStateEvent(){this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))}render(){return i`
      <div
...
\`\`\`  
  ...
  `};var _,S,w,z,I;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    summary: 'Click to expand',
    innerHTML: 'Accordion content goes here'
  }
}`,...(w=(S=p.parameters)==null?void 0:S.docs)==null?void 0:w.source},description:{story:"Basic example of an accordion component.",...(I=(z=p.parameters)==null?void 0:z.docs)==null?void 0:I.description}}};var $,A,T,E,D;u.parameters={...u.parameters,docs:{...($=u.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Custom Icons',
  parameters: {
    docs: {
...
\\\`\\\`\\\`        
  ...
  \`
}`,...(j=(R=h.parameters)==null?void 0:R.docs)==null?void 0:j.source},description:{story:"Example of different size variants.",...(F=(q=h.parameters)==null?void 0:q.docs)==null?void 0:F.description}}};var V,W,k,M,N;y.parameters={...y.parameters,docs:{...(V=y.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Rich Content',
  parameters: {
    docs: {
  ...
  \`
}`,...(k=(W=y.parameters)==null?void 0:W.docs)==null?void 0:k.source},description:{story:"Example with rich content.",...(N=(M=y.parameters)==null?void 0:M.docs)==null?void 0:N.description}}};var K,U,Y,J,Q;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Initially Open',
  parameters: {
    docs: {
