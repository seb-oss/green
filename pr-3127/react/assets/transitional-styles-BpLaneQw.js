import{i as M,t as N,b as l,F as z,V as b,c as t,d as y,z as k}from"./declarative-layout-mixins-BS4dSwRN.js";const B=`/* stylelint-disable max-nesting-depth */
/**
...
}`;function c(){o.instance.register("gds-button",B.toString())}const _=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  :host {
...
}`;function $(){o.instance.register("gds-menu-heading",_.toString())}const G=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
