import{i as m,t as P,_ as t,g as y,h as r,w as we,k as ke,m as Se,G as T,b as a,c,n as o,r as C,d as i,A as $e,e as Ce}from"./declarative-layout-mixins-CpmMrYPB.js";import{l as ge,m as M,s as qe}from"./runtime-Cgryh99k.js";import{b as Re,e as G,w,a as je}from"./aria-forwarding-D9KxWeew.js";import{G as Ue,o as Ke,a as Xe,b as Ye}from"./button.component-CloqlVxA.js";import{o as Je}from"./icon.component-NYRR2RQ1.js";import{n as g}from"./when-CI7b_ccM.js";import{G as Ee,o as Qe,f as Ze}from"./popover.component-B1WNymDc.js";import{e as _}from"./class-map-CvRqZQxX.js";import{T as ue,c as et}from"./transitional-styles-CKj5Gxpz.js";import{a as tt,G as st}from"./card.component-C3wRS26b.js";import{I as it}from"./triangle-exclamation.component-CxGw3-EX.js";import{I as at,a as ot}from"./chevron-bottom.component-BPiv0jTa.js";import{e as rt,n as lt}from"./ref-Rr0EbE3A.js";import{F as nt,o as dt,L as ct,u as ht}from"./unwrap-slots-BSD_70Mo.js";import{I as Te}from"./checkmark.component-DNsVbwJX.js";import{I as pt}from"./cross-small.component-Cbq9XNvM.js";function gt(e){return(s,n)=>Re(s,n,{async get(){return await this.updateComplete,this.renderRoot?.querySelector(e)??null}})}const ut=m`
  :host {
    display: flex;
...
`;var bt=ut;let I=class extends tt{render(){return r`<slot></slot>`}};I.styles=[P,bt];I=t([y("gds-flex")],I);const ft=e=>vt({...e,type:"checkbox"}),vt=e=>{const{type:s,checked:n,indeterminate:p,disabled:d,invalid:u}=e;return r`
...
`;var yt=mt,V,be,R,ze,j,Me,U,We;let b=class extends we(ke(Se(T))){constructor(){super(...arguments),a(this,V),a(this,R),a(this,j),a(this,U),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=_({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return r`
      <div class="${e}">
        ${[c(this,R,ze).call(this),c(this,j,Me).call(this),c(this,U,We).call(this)]}
      </div>
    `}};V=new WeakSet;be=function(e,s){const p=e.target.assignedNodes({flatten:!0});this[s]=p.length>0&&p.some(d=>d.nodeType===Node.ELEMENT_NODE||d.nodeType===Node.TEXT_NODE&&d.textContent?.trim()!=="")};R=new WeakSet;ze=function(){if(this.size!=="small"||!this.notification)return r`<slot
        name="lead"
        @slotchange=${e=>c(this,V,be).call(this,e,"leadSlotOccupied")}
      ></slot>`};j=new WeakSet;Me=function(){return r`<slot
      @slotchange=${e=>c(this,V,be).call(this,e,"mainSlotOccupied")}
    ></slot>`};U=new WeakSet;We=function(){return r`<slot name="trail"></slot>`};b.styles=[P,yt];t([o()],b.prototype,"variant",2);t([o({type:String})],b.prototype,"size",2);t([o({attribute:"notification",type:Boolean,reflect:!0})],b.prototype,"notification",2);t([o({attribute:"rounded",type:Boolean,reflect:!0})],b.prototype,"rounded",2);t([C()],b.prototype,"mainSlotOccupied",2);t([C()],b.prototype,"leadSlotOccupied",2);b=t([y("gds-badge",{dependsOn:[I]})],b);const xt=m`
  @layer base, a11y;
...
`;var _t=xt,z,K,Oe,fe,Le,ve,Be,me,Ae,ye,De;let h=class extends T{constructor(){super(),a(this,K),a(this,fe),a(this,ve),a(this,me),a(this,ye),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,a(this,z,(e,s)=>{const p=s.target.assignedNodes({flatten:!0}),d=p.length>0&&p.some(u=>u.nodeType===Node.ELEMENT_NODE||u.nodeType===Node.TEXT_NODE&&u.textContent?.trim()!=="");e==="lead"?(this._leadSlotOccupied=d,this._leadHasBadge=d&&p.some(u=>u.getAttribute?.("gds-element")==="gds-badge")):e==="trail"?this._trailSlotOccupied=d:e==="action"&&(this._actionSlotOccupied=d)})}connectedCallback(){super.connectedCallback(),ue.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return r`
    ...
    `};ye=new WeakSet;De=function(){return r`
      ...
      ></slot>
    `};h.styles=[_t];t([o()],h.prototype,"size",2);t([o({type:Boolean})],h.prototype,"multiline",2);t([o({type:Boolean,reflect:!0})],h.prototype,"disabled",2);t([o({type:Boolean})],h.prototype,"invalid",2);t([G("slot:not([name])")],h.prototype,"_mainSlotElement",2);t([C()],h.prototype,"_leadSlotOccupied",2);t([C()],h.prototype,"_leadHasBadge",2);t([C()],h.prototype,"_trailSlotOccupied",2);t([C()],h.prototype,"_actionSlotOccupied",2);t([w("disabled")],h.prototype,"_handleDisabledChange",1);h=t([y("gds-field-base"),ge()],h);const wt=m`
...
`;var kt=wt,X,Fe;let k=class extends T{constructor(){super(...arguments),a(this,X)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter?.[1])}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return r`<div aria-live="polite">
    ...
    </div>`}};X=new WeakSet;Fe=function(){if(!this.charCounter||this.charCounter[1]===!1)return $e;const[e,s]=this.charCounter;return r`<gds-badge variant="${s}">${e}</gds-badge>`};k.styles=[kt];t([o({type:Array})],k.prototype,"charCounter",2);t([o()],k.prototype,"errorMessage",2);t([w("charCounter"),w("errorMessage")],k.prototype,"_handleVisibilityChange",1);k=t([y("gds-form-control-footer",{dependsOn:[b,it]})],k);const St=m`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var $t=St,xe,He,Y,J,A,Q,Ie;let S=class extends T{constructor(){super(...arguments),a(this,xe),a(this,Q),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,a(this,Y,()=>r`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `};S.styles=[$t];t([o({type:Boolean,reflect:!0})],S.prototype,"showExtendedSupportingText",2);t([C()],S.prototype,"_hasExtendedSupportingText",2);t([G("#extended-supporting-text")],S.prototype,"_extendedSupportingText",2);S=t([y("gds-form-control-header",{dependsOn:[Ue,st,at]}),ge()],S);const Ct=m`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`;var Mt=zt,x,te,Pe,se,ie,F,ae,v,oe,re,H,le,ne,de,ce,Ge,L,B,he,Ve,pe,Ne,E,N;let l=class extends Xe{constructor(){super(...arguments),a(this,te),a(this,ce),a(this,he),a(this,pe),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,s)=>e===s,this.searchFilter=(e,s)=>s.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,a(this,x,void 0),a(this,se,()=>r`
    ...
    `),a(this,F,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),a(this,ae,e=>{if(this.combobox){const n=e.getBoundingClientRect(),d=window.innerHeight-n.bottom,u=n.top;let q=Math.min(u,this.maxHeight);return d>u&&(q=Math.min(d,this.maxHeight)),`${q-16}px`}return`${Math.min(window.innerHeight,this.maxHeight)-16}px`}),a(this,v,(e,s)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:s,open:e},bubbles:!1,composed:!1})),a(this,oe,e=>{i(this,v).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),a(this,re,e=>{e.preventDefault(),e.stopPropagation(),this.value=void 0,this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),i(this,L).call(this),i(this,B).call(this)}),a(this,H,e=>{if(!e.currentTarget||(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}})))return;const n=e.currentTarget;if(this.options.forEach(d=>d.hidden=!1),!n.value)return;this.options.filter(d=>!this.searchFilter(n.value,d)).forEach(d=>d.hidden=!0)}),a(this,le,e=>{this._elListbox?.then(s=>{if(e.key==="ArrowDown"||e.key==="Tab"){e.preventDefault(),s.focus();return}})}),a(this,ne,e=>{if(e.key==="Tab"&&this.searchable){e.preventDefault(),this._elSearchInput?.focus();return}}),a(this,de,e=>{const s=this._elTriggerBtn;s&&(s.ariaActiveDescendantElement=e.target)}),a(this,L,()=>{this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))}),a(this,B,()=>{this.updateComplete.then(()=>this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}),a(this,E,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&i(this,v).call(this,!1,"close")&&(this.open=!1)}),a(this,N,e=>{e.key==="Tab"&&!this.searchable&&i(this,v).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())})}get type(){return"gds-dropdown"}get options(){return i(this,x)?Array.from(i(this,x)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if(i(this,x))return Array.from(i(this,x)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){let e;return Array.isArray(this.value)?e=this.value.slice(0,5).reduce((s,n)=>s+this.options.find(p=>p.value===n)?.innerText+", ","").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):e=this.options.find(s=>s.selected)?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",i(this,F)),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",i(this,F))}render(){return r`
      ...
      ${g(c(this,te,Pe).call(this),()=>r`
        ...
        `)}
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){if(this.requestUpdate(),Ce(this,x,this.querySelectorAll("[gds-element=gds-option]")),this.multiple){this._handleValueChange();return}this.value===void 0?this.placeholder?this.value=this.placeholder.value:this.value=this.options[0]?.value:!this.combobox&&!this.placeholder&&this.options.find(e=>this.compareWith(e.value,this.value))===void 0&&(this.options[0]&&(this.options[0].selected=!0),this.value=this.options[0]?.value),this._handleValueChange()}_handleValueChange(){this._elListbox.then(e=>{e&&(Array.isArray(this.value)?e.selection=this.value:e.selection=[this.value])})}_handleOpenChange(){const e=this.open;this.options.forEach(n=>n.hidden=!e),e?c(this,he,Ve).call(this):(c(this,pe,Ne).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const s=this.options.find(n=>n.selected);requestAnimationFrame(async()=>{await this.updateComplete,s?.scrollIntoView({block:"center"})})}};x=new WeakMap;te=new WeakSet;Pe=function(){return!this.plain};se=new WeakMap;ie=new WeakMap;F=new WeakMap;ae=new WeakMap;v=new WeakMap;oe=new WeakMap;re=new WeakMap;H=new WeakMap;le=new WeakMap;ne=new WeakMap;de=new WeakMap;ce=new WeakSet;Ge=function(){this._elListbox.then(e=>{this.multiple?this.value=e.selection.map(s=>s.value):(this.value=e.selection[0]?.value,i(this,v).call(this,!1,"close")&&(this.open=!1,setTimeout(()=>this._elTriggerBtn?.focus(),0))),i(this,L).call(this),i(this,B).call(this)})};L=new WeakMap;B=new WeakMap;he=new WeakSet;Ve=function(){this.addEventListener("blur",i(this,E)),this.addEventListener("gds-blur",i(this,E)),this.addEventListener("keydown",i(this,N))};pe=new WeakSet;Ne=function(){this.removeEventListener("blur",i(this,E)),this.removeEventListener("gds-blur",i(this,E)),this.removeEventListener("keydown",i(this,N))};E=new WeakMap;N=new WeakMap;l.styles=[P,Tt,Mt];t([o({attribute:"supporting-text"})],l.prototype,"supportingText",2);t([o({type:Boolean,reflect:!0})],l.prototype,"open",2);t([o({type:Boolean,reflect:!0})],l.prototype,"searchable",2);t([o({type:Boolean,reflect:!0})],l.prototype,"multiple",2);t([o({type:Boolean,reflect:!0})],l.prototype,"clearable",2);t([o({type:Boolean,reflect:!0})],l.prototype,"combobox",2);t([o()],l.prototype,"compareWith",2);t([o()],l.prototype,"searchFilter",2);t([o({type:Boolean,attribute:"sync-popover-width"})],l.prototype,"syncPopoverWidth",2);t([o({type:Number,attribute:"max-height"})],l.prototype,"maxHeight",2);t([o({reflect:!0})],l.prototype,"size",2);t([o({type:Boolean,attribute:"hide-label"})],l.prototype,"hideLabel",2);t([o({type:Boolean})],l.prototype,"plain",2);t([o({type:Boolean})],l.prototype,"disableMobileStyles",2);t([o({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);t([G("#trigger")],l.prototype,"_elTriggerBtn",2);t([gt("#listbox")],l.prototype,"_elListbox",2);t([G("#searchinput")],l.prototype,"_elSearchInput",2);t([Ke({attributes:!0,childList:!0,subtree:!0,characterData:!0})],l.prototype,"_handleLightDOMChange",1);t([w("value")],l.prototype,"_handleValueChange",1);t([w("open")],l.prototype,"_handleOpenChange",1);l=t([je({labelledBy:"#trigger",describedBy:"#trigger",errorMessage:"#trigger"}),ge()],l);let _e=class extends we(ke(Se(l))){};_e=t([y("gds-dropdown",{dependsOn:[S,k,h,$,Ee,Te,ot,pt]})],_e);export{_e as G,f as a,I as b,Tt as f,gt as r};
