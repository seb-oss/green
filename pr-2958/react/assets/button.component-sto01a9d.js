import{A as M,x as q,i as R,G as W,t as D,_ as s,g as U,D as O,n,b as h,e as _,d as a,s as P,w as I,k as H,m as j,h as X}from"./declarative-layout-mixins-CCbkTKho.js";import{e as x,w as K,a as Y}from"./aria-forwarding-D9KxWeew.js";import{e as J}from"./class-map-BrJKJGxu.js";import{n as Q}from"./when-CI7b_ccM.js";import{T as Z}from"./transitional-styles-SI9PQOk5.js";import{e as tt,i as et,t as rt}from"./icon.component-BuBZfvCf.js";const b=r=>r??M;const S=Symbol.for(""),ot=r=>{if(r?.r===S)return r?._$litStatic$},xt=r=>({_$litStatic$:r,r:S}),F=(r,...t)=>({_$litStatic$:t.reduce((o,e,l)=>o+(c=>{if(c._$litStatic$!==void 0)return c._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${c}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(e)+r[l+1],r[0]),r:S}),L=new Map,st=r=>(t,...o)=>{const e=o.length;let l,c;const g=[],k=[];let w,u=0,z=!1;for(;u<e;){for(w=t[u];u<e&&(c=o[u],(l=ot(c))!==void 0);)w+=l+t[++u],z=!0;u!==e&&k.push(c),g.push(w),u++}if(u===e&&g.push(t[e]),z){const A=g.join("$$lit$$");(t=L.get(A))===void 0&&(g.raw=g,L.set(A,t=g)),o=k}return r(t,...o)},at=st(q),it=R`
  :host {
