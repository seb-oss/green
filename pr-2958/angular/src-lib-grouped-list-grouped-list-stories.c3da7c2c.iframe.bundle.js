/*! For license information please see src-lib-grouped-list-grouped-list-stories.c3da7c2c.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[861],{8833(e,t,s){s.d(t,{o:()=>g});var r=s(745),o=s(4367),n=s(3539),l=s(5073),i=s(9399),d=s(4508),a=s(7526),c=s(4987),p=s(9443).AH`
  :host {
    display: block;
...
`;let d=class extends l.o{render(){return n.qy`<slot></slot>`}};d.styles=[o.LU,i],d=(0,r.Cc)([(0,n.Y$)("gds-flex")],d)},8585(e,t,s){s.d(t,{d:()=>g});var r=s(745),o=s(4367),n=s(505),l=s(3539),i=s(5073),d=s(4457),a=s(7526),c=s(9443).AH`
  .gds-list-heading {
...
`;s(2737).j.define();var p=s(5248);p.s.define();let g=class extends l.j{constructor(){super(...arguments),this.label=""}connectedCallback(){super.connectedCallback(),d.n.instance.apply(this,"gds-grouped-list")}render(){return a.qy`${(0,n.z)(this.label,()=>a.qy`<div class="gds-list-heading" aria-hidden="true" id="label">
      ...
      <div role="list" aria-labelledby="label">
        <slot></slot>
      </div>`}};g.styles=[i.LU,c],(0,r.Cc)([(0,o.MZ)()],g.prototype,"label",2),g=(0,r.Cc)([(0,a.Y$)("gds-grouped-list",{dependsOn:[p.s]})],g)},5248(e,t,s){s.d(t,{s:()=>d});var r=s(745),o=s(3539),n=s(7526),l=s(5073),i=s(4987);let d=class extends((0,i.lt)(o.j)){connectedCallback(){super.connectedCallback(),this.setAttribute("role","listitem")}render(){return n.qy`<slot></slot>`}};d.styles=l.LU,d=(0,r.Cc)([(0,n.Y$)("gds-list-item")],d)},2737(e,t,s){s.d(t,{j:()=>c});var r,o=s(745),n=s(4367),l=s(7526),i=s(5073),d=s(6312),a=s(9443).AH`
  :host {
    display: flex;
