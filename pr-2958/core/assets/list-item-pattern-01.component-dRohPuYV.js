import{i as S,h as l,v as W,a2 as B,w as _,f as x,n as h,o,a as $,g as P,F as O,d as k}from"./iframe-DOT61pU6.js";import{G as A}from"./flex.component-BP9ANZYa.js";import{I as R}from"./checkmark.component-hpKXzo3A.js";import{I as D}from"./chevron-right.component-CjrMTF6U.js";import{I as M}from"./minus-small.component-CYlXjpc_.js";import{G as z}from"./list-item-CcvdXsqG.js";import{G as F}from"./text.component-DqEDHE6I.js";import{c as j}from"./rbcb-toggle.template-k2rXR0Qw.js";import{r as K}from"./resize-observer-CfkbZofs.js";import{w as N}from"./props-link-CaYfuWmG.js";const q=S`
  :host {
    display: flex;
    align-items: center;
...
`;var H=Object.defineProperty,J=Object.getOwnPropertyDescriptor,w=e=>{throw TypeError(e)},r=(e,t,s,c)=>{for(var d=c>1?void 0:c?J(t,s):t,m=e.length-1,y;m>=0;m--)(y=e[m])&&(d=(c?y(t,s,d):y(d))||d);return c&&d&&H(t,s,d),d},C=(e,t,s)=>t.has(e)||w("Cannot "+s),u=(e,t,s)=>(C(e,t,"read from private field"),s?s.call(e):t.get(e)),Q=(e,t,s)=>t.has(e)?w("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),i=(e,t,s)=>(C(e,t,"access private method"),s),a,p,L,E,g,T,v,G,f,b,I;let n=class extends N(z){constructor(){super(...arguments),Q(this,a),this._isWrapped=!1,this._hasLead=!1,this.label="",this.selectable=!1,this.checked=!1,this.indeterminate=!1,this.disabled=!1,this._hasTrailContent=!1}_checkWrap(){const e=this._itemsContainer;if(!e)return;const t=Array.from(e.children);if(t.length<2){this._isWrapped=!1;return}const s=t[0].getBoundingClientRect().top;this._isWrapped=t.some(c=>c.getBoundingClientRect().top>s)}updated(e){super.updated(e),e.has("href")&&i(this,a,L).call(this)}render(){return l`${i(this,a,I).call(this)}`}};a=new WeakSet;p=function(){return!!this.href};L=function(){this._hasTrailContent=u(this,a,p)||!!this._trailSlot?.assignedElements().length};E=function(){const e=s=>{s.stopPropagation(),!this.disabled&&(this.checked=!this.checked,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))},t=s=>{(s.key===" "||s.key==="Enter")&&(s.preventDefault(),e(s))};return l`
    ...
    `};v=function(e){const t=e.target;this._hasLead=t.assignedElements().length>0};G=function(e){const t=e.target;this._hasTrailContent=t.assignedElements().length>0||u(this,a,p)};f=function(){if(this.items&&this.items.length>0){const e=this.items.length>=3?"wrap":"nowrap",t=this.items.length>=2&&!this._isWrapped;return l`
        ...
        <gds-flex
          ...
          flex-wrap=${e}
        >
          ${this.items.map((s,c)=>{const d=c===this.items.length-1;return i(this,a,T).call(this,c===0&&this.label&&!s.label?{...s,label:this.label}:s,t&&d)})}
        </gds-flex>
        <slot></slot>
    ...
    ${i(this,a,b).call(this)}`};n.styles=[...W,B,q];r([_()],n.prototype,"_isWrapped",2);r([_()],n.prototype,"_hasLead",2);r([x(".items-container")],n.prototype,"_itemsContainer",2);r([x('slot[name="trail"]')],n.prototype,"_trailSlot",2);r([K()],n.prototype,"_checkWrap",1);r([h({type:Array})],n.prototype,"items",2);r([h({reflect:!0})],n.prototype,"label",2);r([h({type:Boolean,reflect:!0})],n.prototype,"selectable",2);r([h({type:Boolean,reflect:!0})],n.prototype,"checked",2);r([h({type:Boolean,reflect:!0})],n.prototype,"indeterminate",2);r([h({type:Boolean,reflect:!0})],n.prototype,"disabled",2);r([_()],n.prototype,"_hasTrailContent",2);n=r([P("gds-list-item-pattern-01",{dependsOn:[A,F,O,R,M,D]})],n);export{n as G};
