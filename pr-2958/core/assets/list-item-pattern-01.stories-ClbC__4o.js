import{b as s}from"./iframe-DOT61pU6.js";import{a as c}from"./argTableProps-CS6f9cAl.js";import{G as p}from"./list-item-pattern-01.component-dRohPuYV.js";import"./cloudy-sun-CBg9h30a.js";import"./text-Dgxi5WWf.js";import"./link-Cl8us_X6.js";import"./flex-2Toe02uE.js";import"./list-item-CcvdXsqG.js";import"./card-DnB8DXCP.js";import"./avatar-D-NAgfI4.js";import"./preload-helper-PPVm8Dsz.js";import"./flex.component-BP9ANZYa.js";import"./checkmark.component-hpKXzo3A.js";import"./icon.component-BrjRVFjq.js";import"./chevron-right.component-CjrMTF6U.js";import"./minus-small.component-CYlXjpc_.js";import"./text.component-DqEDHE6I.js";import"./default-typography.styles-DSEyIK3k.js";import"./rbcb-toggle.template-k2rXR0Qw.js";import"./resize-observer-CfkbZofs.js";import"./props-link-CaYfuWmG.js";import"./cloudy-sun.component-BzDaDpEs.js";import"./card.component-B3RceDkr.js";import"./avatar.component-C86LI0CU.js";import"./people-profile.component-pCz9mG2R.js";p.define();const t=e=>Array.from({length:e},(u,o)=>({label:`Item ${o+1}`,value:`Value ${o+1}`})),K={title:"Patterns/List Item Pattern 01",component:"gds-list-item-pattern-01",tags:["autodocs"],argTypes:{...c("gds-list-item-pattern-01")},parameters:{docs:{description:{component:"A list container (`gds-list-pattern-01`) holding one or more row items\n(`gds-list-item-pattern-01`). Together they render a semantic `gds-list`\nwith configurable row slots:\n\n- **Lead**: shows a checkbox when `selectable` is set on the item.\n- **Main**: renders columns from `items`, or falls back to the default slot.\n- **Trail**: shows a chevron link when `href` is set on the item, or accepts custom content via the `trail` slot.\n\nThe row supports three main states:\n- **Selectable**: shows a checkbox in the lead and allows toggling the `checked` state.\n- **Navigational**: shows a chevron in the trail and applies a hover state to the entire row.\n- **Default**: no checkbox or chevron, used for simple lists or when custom content is projected in the lead/trail."}}}},n={render:()=>s`
  ...
  \`
}`,...l.parameters?.docs?.source},description:{story:"When `dividers` is set on `gds-list`, borders are rendered between list items\nand the default gap is removed.",...l.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  name: 'Lead slot',
  render: () => html\`
    <gds-grid gap="s" columns="1; m{2}">
      <gds-card variant="neutral-02-outlined">
