import{l as O}from"./localized-decorator-MNa_wDRO.js";import{i as z,v as V,n as d,f as y,J as F,S as L,y as G,H as T,Q as P,I as D,a0 as B,d as _,h as r,a as k,g as I}from"./iframe-BjfT8dE4.js";import{G as N}from"./field-base.component-BWnzP9qa.js";import{G as W,a as H}from"./form-control-header.component-DMzsICW7.js";import{f as q}from"./form-control-host.style-CwSLAPTK.js";import{I as R}from"./chevron-bottom.component-DunMaMJh.js";const J=z`
...
`;var Q=Object.defineProperty,U=Object.getOwnPropertyDescriptor,E=e=>{throw TypeError(e)},i=(e,t,s,h)=>{for(var n=h>1?void 0:h?U(t,s):t,m=e.length-1,f;m>=0;m--)(f=e[m])&&(n=(h?f(t,s,n):f(n))||n);return h&&n&&Q(t,s,n),n},g=(e,t,s)=>t.has(e)||E("Cannot "+s),p=(e,t,s)=>(g(e,t,"read from private field"),t.get(e)),v=(e,t,s)=>t.has(e)?E("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),X=(e,t,s,h)=>(g(e,t,"write to private field"),t.set(e,s),s),o=(e,t,s)=>(g(e,t,"access private method"),s),c,a,x,u,C,S,w,$,A,M;let l=class extends B{constructor(){super(...arguments),v(this,a),this.supportingText="",this.showExtendedSupportingText=!1,this.size="large",this.plain=!1,v(this,c,!1),v(this,u,e=>{e.stopPropagation(),o(this,a,C).call(this),requestAnimationFrame(()=>{this.dispatchCustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0}),this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})})})}get value(){return this._internalValue}set value(e){p(this,c)||X(this,c,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){return this.selectElement?.multiple??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}focus(e){this._getValidityAnchor()?.focus(e)}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),r`
    ...
    `}_captureDOM(){if(!this.shadowRoot||this.childNodes.length===0||!this._elSelectContainer)return;const e=Array.from(this.children).filter(t=>t.nodeName==="SELECT").map(t=>{const s=t.cloneNode(!0);return s.addEventListener("change",p(this,u)),s.addEventListener("input",p(this,u)),s.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),s.ariaLabel=this.label,s.setAttribute("id","select"),s.disabled=this.disabled,s.className="native-control",p(this,c)?s.value=this.value:this._internalValue=s.value,s});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};c=new WeakMap;a=new WeakSet;x=function(){return!this.plain&&this.invalid};u=new WeakMap;C=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(t=>t.value)}else this.value=this.selectElement.value};S=function(){return[o(this,a,w).call(this),o(this,a,A).call(this),o(this,a,$).call(this),o(this,a,M).call(this)].map(t=>r`${t}`)};w=function(){return r`<slot name="lead" slot="lead"></slot>`};$=function(){if(!this.multiple)return r`<label id="placeholder" class="native-control"
      ...
      `};l.styles=[V,q,J];i([d({attribute:"supporting-text"})],l.prototype,"supportingText",2);i([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);i([d({type:String})],l.prototype,"size",2);i([d({type:Boolean})],l.prototype,"plain",2);i([y("select")],l.prototype,"selectElement",2);i([d()],l.prototype,"value",1);i([y(".select-container")],l.prototype,"_elSelectContainer",2);i([F({childList:!0,subtree:!0,attributes:!0,characterData:!0})],l.prototype,"_captureDOM",1);i([L("value")],l.prototype,"_handleValueChange",1);l=i([G({labelledBy:"select",describedBy:"select",errorMessage:"select"}),O()],l);let b=class extends T(P(D(l))){};b=i([I("gds-select",{dependsOn:[W,H,N,R]})],b);export{b as G};
