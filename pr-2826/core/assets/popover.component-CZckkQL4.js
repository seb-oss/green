import{a8 as V,i as $,n,C as D,l as A,U as b,a as H,D as K,B as U,T as I,e as G,H as F,h as z}from"./iframe-CGsDBcID.js";import{l as X}from"./localized-decorator-Dsmw4sCN.js";import{o as Y,s as q,a as Q,c as J}from"./floating-ui.dom-DPpwG6Py.js";import{I as Z}from"./cross-small.component-CTqIHZPz.js";function j(e){return(t,o,r)=>{if(V)return;const l=window.matchMedia(e),d=t.connectedCallback,y=t.disconnectedCallback;t.connectedCallback=function(){d?.call(this);const P=O=>{r.value?.call(this,O.matches)};l.addEventListener("change",P),this.disconnectedCallback=function(){y?.call(this),l.removeEventListener("change",P)},r.value?.call(this,l.matches)}}}const ee=$`
