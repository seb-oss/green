import{i as S,n as p,S as E,l as k,D as V,J as D,z as F,R as M,a0 as O,e as W,h as n,o as G,a as L}from"./iframe-wighnWuJ.js";import{I as T}from"./checkmark.component-DqnxJuLh.js";const B=S`
...
`,I=B;var R=Object.defineProperty,j=Object.getOwnPropertyDescriptor,f=t=>{throw TypeError(t)},a=(t,e,s,h)=>{for(var o=h>1?void 0:h?j(e,s):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(o=(h?d(e,s,o):d(o))||o);return h&&o&&R(e,s,o),o},g=(t,e,s)=>e.has(t)||f("Cannot "+s),v=(t,e,s)=>(g(t,e,"read from private field"),s?s.call(t):e.get(t)),u=(t,e,s)=>e.has(t)?f("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),c=(t,e,s)=>(g(t,e,"access private method"),s),r,y,x,_,z,m,P,w,C,$;let i=class extends O{constructor(){super(...arguments),u(this,r),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",u(this,m,()=>{this.checked=this._input.checked,c(this,r,$).call(this),c(this,r,P).call(this)}),u(this,w,t=>{this.disabled||t.key==="Enter"&&(t.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(t){this._internalValue=t}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(t){this._input?.focus(t)}render(){const t={switch:!0,checked:this.checked,disabled:this.disabled,"control-start":this.controlPlacement==="start",small:this.size==="small"};return n`
    ...
    `};m=new WeakMap;P=function(){c(this,r,C).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})};w=new WeakMap;C=function(){this.checked?this._setFormValue(this._internalValue||"on"):this._setFormValue(null)};$=function(){const t=this._perimeter;t&&(t.classList.remove("ripple"),t.offsetWidth,t.classList.add("ripple"))};i.styles=[I];a([p({type:Boolean,reflect:!0})],i.prototype,"checked",2);a([p({attribute:"control-placement",reflect:!0})],i.prototype,"controlPlacement",2);a([p({reflect:!0})],i.prototype,"size",2);a([E({selector:".switch",valueTemplate:t=>t})],i.prototype,"justify-content",2);a([k('input[type="checkbox"]')],i.prototype,"_input",2);a([k(".perimeter")],i.prototype,"_perimeter",2);i=a([V({labelledBy:"#switch-input",describedBy:"#switch-input",errorMessage:"#switch-input"})],i);let b=class extends D(F(M(i))){};b=a([L("gds-switch",{dependsOn:[T]})],b);export{b as G};
