import{i as u,z as f,R as g,J as v,A as y,o,F as _,y as w,a7 as m,n as x,S as k,a as C,D as P,B as b}from"./iframe-C01hbSNl.js";import{w as $}from"./props-link-D-LWKnmy.js";const E=u`
  @layer core, link;
...
`;var G=Object.defineProperty,O=Object.getOwnPropertyDescriptor,p=e=>{throw TypeError(e)},c=(e,t,r,n)=>{for(var s=n>1?void 0:n?O(t,r):t,i=e.length-1,l;i>=0;i--)(l=e[i])&&(s=(n?l(t,r,s):l(s))||s);return n&&s&&G(t,r,s),s},L=(e,t,r)=>t.has(e)||p("Cannot "+r),S=(e,t,r)=>(L(e,t,"read from private field"),r?r.call(e):t.get(e)),A=(e,t,r)=>t.has(e)?p("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),d,h;let a=class extends f(g(v($(b)))){constructor(){super(...arguments),A(this,d),this.label=""}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none")}render(){return _`
      <a
        href=${o(this.href)}
        target=${o(this.target)}
        rel=${o(this.rel||S(this,d,h))}
