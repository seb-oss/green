import{l as Q}from"./localized-decorator-BP7q_Fg8.js";import{i as J,v as Z,n as d,f as q,w as g,S as x,Q as tt,I as et,H as st,a0 as it,d as v,h as m,o as D,g as at}from"./iframe-DHb17V61.js";import{G as rt,a as nt}from"./form-control-header.component-Bb7wVutU.js";import{f as ot}from"./form-control-host.style-DchCQD4E.js";const lt=J`
  :host {
      ...
      <div id="control-row">
        ...
        <div id="control" style=${t}>
          ...
          <input
            ...
            aria-label=${D(i(this,s,R).call(this))}
    ...
    `};f=function(){this.range?this._setFormValue(`${this.value},${this.endValue}`):this._setFormValue(`${this.value}`)};R=function(){return this.range?`${this.label} start`:this.plain?this.label:void 0};U=function(){return this.label?`${this.label} end`:void 0};k=new WeakMap;M=new WeakMap;z=new WeakMap;V=new WeakMap;T=new WeakMap;E=new WeakMap;p=new WeakMap;S=new WeakMap;C=new WeakMap;N=new WeakMap;L=new WeakMap;B=function(t){const e=t==="min"?this._editingMin:this._editingMax,a=t==="min"?this._draftMin:this._draftMax,l=t==="min"?this.min:this.max,h=t==="min"?"Min":"Max";return m`
      <span class="bound-editor ${e?"editing":""}">
        ...
        <input
          ...
          tabindex=${e?"0":"-1"}
          ?disabled=${this.disabled}
          @input=${c=>i(this,s,Y).call(this,t,c)}
          @blur=${()=>i(this,s,F).call(this,t)}
          @keydown=${c=>i(this,s,K).call(this,t,c)}
        />
      </span>
    `};X=function(t){t==="min"?(this._draftMin=`${this.min}`,this._editingMin=!0):(this._draftMax=`${this.max}`,this._editingMax=!0),setTimeout(()=>{const e=this.shadowRoot?.querySelector(`#${t}-range-editor`);e?.focus(),e?.select()},80)};Y=function(t,e){const a=e.target.value;t==="min"?this._draftMin=a:this._draftMax=a;const l=Number(a);!a||Number.isNaN(l)||(t==="min"?this.min=l:this.max=l)};K=function(t,e){if(e.key==="Enter"){i(this,s,F).call(this,t);return}e.key==="Escape"&&(e.preventDefault(),i(this,s,I).call(this,t))};F=function(t){const e=Number(t==="min"?this._draftMin:this._draftMax);Number.isNaN(e)||(t==="min"?this.min=e:this.max=e),i(this,s,I).call(this,t)};I=function(t){if(t==="min"){this._editingMin=!1,this._draftMin=`${this.min}`;return}this._editingMax=!1,this._draftMax=`${this.max}`};r.styles=[Z,ot,lt];n([d({attribute:"supporting-text"})],r.prototype,"supportingText",2);n([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],r.prototype,"showExtendedSupportingText",2);n([d({type:Boolean})],r.prototype,"plain",2);n([d({reflect:!0})],r.prototype,"size",2);n([d({type:Number})],r.prototype,"min",2);n([d({type:Number})],r.prototype,"max",2);n([d({type:Number})],r.prototype,"step",2);n([d({type:Boolean,reflect:!0,attribute:"show-ticks"})],r.prototype,"showTicks",2);n([d({type:Boolean,reflect:!0,attribute:"show-value-label"})],r.prototype,"showValueLabel",2);n([d({type:Boolean,reflect:!0})],r.prototype,"range",2);n([d({type:Number})],r.prototype,"value",1);n([d({type:Number,attribute:"end-value"})],r.prototype,"endValue",2);n([d({attribute:"min-label"})],r.prototype,"minLabel",2);n([d({attribute:"max-label"})],r.prototype,"maxLabel",2);n([q("#slider-start")],r.prototype,"_startInput",2);n([q("#slider-end")],r.prototype,"_endInput",2);n([g()],r.prototype,"_activeThumb",2);n([g()],r.prototype,"_focusedThumb",2);n([g()],r.prototype,"_editingMin",2);n([g()],r.prototype,"_editingMax",2);n([g()],r.prototype,"_draftMin",2);n([g()],r.prototype,"_draftMax",2);n([x("min"),x("max"),x("step"),x("range")],r.prototype,"_handleConstraintsUpdate",1);r=n([Q()],r);let G=class extends tt(et(st(r))){};G=n([at("gds-slider",{dependsOn:[rt,nt]})],G);export{G};
