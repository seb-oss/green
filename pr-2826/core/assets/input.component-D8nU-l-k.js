import{Q as F,N as G,P as f,O as D,a4 as y,A as w,ac as N,i as W,y as q,n as r,l as U,U as L,D as H,R as X,z as Y,J,a0 as K,d as S,h,o as a,H as Q,a as Z,I as j}from"./iframe-Db8hCJ7u.js";import{l as tt}from"./localized-decorator-xPenioRn.js";import{r as et}from"./query-async-CF6dJ6Um.js";import{G as st}from"./field-base.component-CroLydHq.js";import{G as it,a as rt}from"./form-control-header.component-DP8c5-PQ.js";import{f as ot}from"./form-control-host.style-CdbpMMET.js";import{G as at}from"./flex.component-m6iZ_CDd.js";import{I as nt}from"./cross-small.component-Dg-d6pui.js";import{c as lt}from"./textarea.component-BRLS8R4r.js";const pt=F(class extends G{constructor(t){if(super(t),t.type!==f.PROPERTY&&t.type!==f.ATTRIBUTE&&t.type!==f.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!D(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===y||e===w)return e;const o=t.element,l=t.name;if(t.type===f.PROPERTY){if(e===o[l])return y}else if(t.type===f.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(l))return y}else if(t.type===f.ATTRIBUTE&&o.getAttribute(l)===e+"")return y;return N(t),e}}),ct=W`
