import"./switch-CYH_2Dhg.js";import"./flex-CbM3Ze6n.js";import{b as t}from"./iframe-Cf5uhdy8.js";import"./text-C8oLKSvP.js";import"./divider-BD2_aZHB.js";import{a as x}from"./argTableProps-D--bPTDb.js";import"./switch.component-qMPlAtLZ.js";import"./checkmark.component-BZX3Zt8p.js";import"./icon.component-DYP80All.js";import"./flex.component-DfE-1wAo.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-85NreoQL.js";import"./default-typography.styles--wdxVXkk.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
