import{i as z,b as y,B as R,n as v,E as I,l as j,W as A,a as P,F as G,D as K,V as U,o as F,e as N,d as M,J as D}from"./iframe-BEqwETOt.js";import{l as V}from"./localized-decorator-B3uh7JF3.js";function W(t){"@babel/helpers - typeof";return W=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},W(t)}function b(t){if(t===null||t===!0||t===!1)return NaN;var e=Number(t);return isNaN(e)?e:e<0?Math.ceil(e):Math.floor(e)}function f(t,e){if(e.length<t)throw new TypeError(t+" argument"+(t>1?"s":"")+" required, but only "+e.length+" present")}function h(t){f(1,arguments);var e=Object.prototype.toString.call(t);return t instanceof Date||W(t)==="object"&&e==="[object Date]"?new Date(t.getTime()):typeof t=="number"||e==="[object Number]"?new Date(t):((typeof t=="string"||e==="[object String]")&&typeof console<"u"&&(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn(new Error().stack)),new Date(NaN))}function k(t,e){f(2,arguments);var s=h(t),a=b(e);return isNaN(a)?new Date(NaN):(a&&s.setDate(s.getDate()+a),s)}function E(t,e){f(2,arguments);var s=h(t),a=b(e);if(isNaN(a))return new Date(NaN);if(!a)return s;var r=s.getDate(),o=new Date(s.getTime());o.setMonth(s.getMonth()+a+1,0);var i=o.getDate();return r>=i?o:(s.setFullYear(o.getFullYear(),o.getMonth(),r),s)}var q={};function C(){return q}function x(t,e){var s,a,r,o,i,u,l,n;f(1,arguments);var m=C(),g=b((s=(a=(r=(o=e?.weekStartsOn)!==null&&o!==void 0?o:e==null||(i=e.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.weekStartsOn)!==null&&r!==void 0?r:m.weekStartsOn)!==null&&a!==void 0?a:(l=m.locale)===null||l===void 0||(n=l.options)===null||n===void 0?void 0:n.weekStartsOn)!==null&&s!==void 0?s:0);if(!(g>=0&&g<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var p=h(t),$=p.getDay(),_=($<g?7:0)+$-g;return p.setDate(p.getDate()-_),p.setHours(0,0,0,0),p}function T(t){f(1,arguments);var e=h(t);return e.setHours(0,0,0,0),e}function J(t,e){f(2,arguments);var s=b(e),a=s*7;return k(t,a)}function w(t,e){f(2,arguments);var s=T(t),a=T(e);return s.getTime()===a.getTime()}function Q(t){f(1,arguments);var e=h(t),s=e.getMonth();return e.setFullYear(e.getFullYear(),s+1,0),e.setHours(23,59,59,999),e}function X(t,e){var s;f(1,arguments);var a=t||{},r=h(a.start),o=h(a.end),i=o.getTime();if(!(r.getTime()<=i))throw new RangeError("Invalid interval");var u=[],l=r;l.setHours(0,0,0,0);var n=Number((s=void 0)!==null&&s!==void 0?s:1);if(n<1||isNaN(n))throw new RangeError("`options.step` must be a number greater than 1");for(;l.getTime()<=i;)u.push(h(l)),l.setDate(l.getDate()+n),l.setHours(0,0,0,0);return u}function Z(t,e){f(1,arguments);var s=t||{},a=h(s.start),r=h(s.end),o=r.getTime();if(!(a.getTime()<=o))throw new RangeError("Invalid interval");var i=x(a,e),u=x(r,e);i.setHours(15),u.setHours(15),o=u.getTime();for(var l=[],n=i;n.getTime()<=o;)n.setHours(0),l.push(h(n)),n=J(n,1),n.setHours(15);return l}function ee(t){f(1,arguments);var e=h(t);return e.setDate(1),e.setHours(0,0,0,0),e}function te(t,e){var s,a,r,o,i,u;f(1,arguments);var l=h(t),n=l.getFullYear(),m=C(),g=b((s=(a=(r=(o=void 0)!==null&&o!==void 0?o:void 0)!==null&&r!==void 0?r:m.firstWeekContainsDate)!==null&&a!==void 0?a:(i=m.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&s!==void 0?s:1);if(!(g>=1&&g<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var p=new Date(0);p.setFullYear(n+1,0,g),p.setHours(0,0,0,0);var $=x(p,e),_=new Date(0);_.setFullYear(n,0,g),_.setHours(0,0,0,0);var L=x(_,e);return l.getTime()>=$.getTime()?n+1:l.getTime()>=L.getTime()?n:n-1}function se(t,e){var s,a,r,o,i,u;f(1,arguments);var l=C(),n=b((s=(a=(r=(o=void 0)!==null&&o!==void 0?o:void 0)!==null&&r!==void 0?r:l.firstWeekContainsDate)!==null&&a!==void 0?a:(i=l.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&s!==void 0?s:1),m=te(t,e),g=new Date(0);g.setFullYear(m,0,n),g.setHours(0,0,0,0);var p=x(g,e);return p}var ae=6048e5;function re(t,e){f(1,arguments);var s=h(t),a=x(s,e).getTime()-se(s,e).getTime();return Math.round(a/ae)+1}function oe(t){f(1,arguments);var e=h(t),s=e.getMonth();return e.setFullYear(e.getFullYear(),s+1,0),e.setHours(0,0,0,0),e}function ne(t,e){f(2,arguments);var s=h(t),a=h(e);return s.getFullYear()===a.getFullYear()&&s.getMonth()===a.getMonth()}function ie(t,e){f(2,arguments);var s=h(t),a=b(e);return s.setHours(a),s}function le(t,e){f(2,arguments);var s=b(e);return E(t,-s)}const de=z`
  @layer base, reset;
