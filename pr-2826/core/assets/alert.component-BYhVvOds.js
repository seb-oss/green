import{i as J,z as Q,B as X,A as v,e as B,h as u,y as Z,n as p,C as O,a as j,D as tt,E as T,g as D,F as st,H as R,I as et}from"./iframe-wighnWuJ.js";import{l as it}from"./localized-decorator-Bn0_3Mdy.js";import{n as rt,e as at}from"./ref-D6_5y6yL.js";import{G as ot}from"./card.component-IEpm34zf.js";import{I as nt}from"./circle-check.component-C7gwmSrl.js";import{I as lt}from"./circle-info.component-zrgMXRbP.js";import{I as ct}from"./cross-small.component-BIfuyJ-J.js";import{I as dt}from"./triangle-exclamation.component-DT_f5zRw.js";const ht=J`
  :host {
...
`;var pt=Object.defineProperty,gt=Object.getOwnPropertyDescriptor,G=t=>{throw TypeError(t)},n=(t,i,a,f)=>{for(var g=f>1?void 0:f?gt(i,a):i,C=t.length-1,$;C>=0;C--)($=t[C])&&(g=(f?$(i,a,g):$(g))||g);return f&&g&&pt(i,a,g),g},S=(t,i,a)=>i.has(t)||G("Cannot "+a),r=(t,i,a)=>(S(t,i,"read from private field"),a?a.call(t):i.get(t)),d=(t,i,a)=>i.has(t)?G("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(t):i.set(t,a),l=(t,i,a,f)=>(S(t,i,"write to private field"),i.set(t,a),a),e=(t,i,a)=>(S(t,i,"access private method"),a),x,y,I,h,c,_,A,s,E,w,W,P,z,b,k,L,M,N,F,m,V,H,U,Y,K,q;const mt={positive:{icon:"circle-check",button:"positive",border:"positive-01",background:"positive-01",color:"positive-01"},warning:{icon:"circle-info",button:"warning",border:"warning-01",background:"warning-01",color:"warning-01"},negative:{icon:"triangle-exclamation",button:"negative",border:"negative-01",background:"negative-01",color:"negative-01"},information:{icon:"circle-info",button:"neutral",border:"information-01",background:"information-01",color:"information-01"},notice:{icon:"circle-info",button:"notice",border:"notice-01",background:"notice-01",color:"notice-01"}},ut=300,ft=100;let o=class extends Q(X){constructor(){super(),d(this,s),this.variant="information",this.label="",this.role="alert",this.closed=!1,this.dismissible=!1,this.timeout=0,this.buttonLabel="",this._progress=100,this._isClosing=!1,d(this,x),d(this,y),d(this,I,at()),d(this,h),d(this,c,0),d(this,_,0),d(this,A,{hostConnected:()=>{!this.closed&&this.timeout>0&&e(this,s,E).call(this)},hostDisconnected:()=>{e(this,s,w).call(this),e(this,s,b).call(this)}}),this.addController(r(this,A))}connectedCallback(){super.connectedCallback(),e(this,s,M).call(this)}updated(t){this.hasAttribute("role")&&e(this,s,M).call(this),t.has("closed")&&this.closed&&(e(this,s,w).call(this),e(this,s,b).call(this)),(t.has("timeout")||t.has("closed")&&!this.closed)&&(e(this,s,w).call(this),e(this,s,b).call(this),l(this,c,Math.max(0,this.timeout)),this._progress=100,!this.closed&&this.timeout>0&&e(this,s,E).call(this))}render(){const t={dismissing:this._isClosing,dismissible:this.dismissible,"has-action":this.buttonLabel,timeout:this.timeout>0};return u`
      ...
      >
        ${!this.closed||this._isClosing?u`
              ...
              >
                <div class="wrapper">
                  ${e(this,s,H).call(this)} ${e(this,s,U).call(this)}
                </div>
                ${!this.timeout&&this.buttonLabel?e(this,s,Y).call(this,this.buttonLabel):v}
                ${e(this,s,K).call(this)} ${e(this,s,q).call(this)}
              </gds-card>
            `:v}
      </div>
    `}};x=new WeakMap;y=new WeakMap;I=new WeakMap;h=new WeakMap;c=new WeakMap;_=new WeakMap;A=new WeakMap;s=new WeakSet;E=function(){r(this,h)||(r(this,c)||l(this,c,Math.max(0,this.timeout)),l(this,h,new IntersectionObserver(t=>{(t[0]?.intersectionRatio??0)>=.1?e(this,s,P).call(this):e(this,s,z).call(this)},{root:null,threshold:[0,.1,1]})),r(this,h).observe(this))};w=function(){r(this,h)&&(r(this,h).disconnect(),l(this,h,void 0))};W=function(){l(this,_,Date.now()),l(this,y,window.setInterval(()=>{const t=Date.now(),i=t-r(this,_);l(this,_,t),l(this,c,Math.max(0,r(this,c)-i)),this._progress=this.timeout>0?Math.max(0,r(this,c)/this.timeout*100):0,r(this,c)<=0&&e(this,s,k).call(this,"timeout")},ft))};P=function(){r(this,c)<=0||r(this,x)||r(this,y)||e(this,s,W).call(this)};z=function(){e(this,s,b).call(this)};b=function(){clearTimeout(r(this,x)),clearInterval(r(this,y)),l(this,x,l(this,y,void 0))};k=async function(t){this.closed||this._isClosing||(this._isClosing=!0,this.closed=!0,e(this,s,L).call(this,t),e(this,s,w).call(this),e(this,s,b).call(this),await this.updateComplete,this.dispatchCustomEvent("gds-close",{detail:{source:t},bubbles:!0,composed:!0}),await new Promise(i=>setTimeout(i,ut)),this._isClosing=!1)};L=function(t){this.dispatchCustomEvent("gds-ui-state",{detail:{closed:this.closed,open:!this.closed,reason:t},bubbles:!1,composed:!1})};M=function(){const t=this.getAttribute("role");(t==="alert"||t==="status")&&(this.removeAttribute("role"),this.role=t)};N=function(t){this.dispatchCustomEvent("gds-action",{detail:{source:"button",event:t},bubbles:!0,composed:!0})};F=function(t){t.key==="Escape"&&this.dismissible&&(t.preventDefault(),e(this,s,k).call(this,"escape"))};m=function(){return mt[this.variant]};V=function(){return this.alertRole??this.role??"alert"};H=function(){const t=`gds-icon-${r(this,s,m).icon}`;return u`${st`<${T(D(t))} class="icon" solid aria-hidden="true" size="24px"></${T(D(t))}>`}`};U=function(){return u`<div class="message">
      <span class="message-text">
        <slot></slot>
      </span>
    </div>`};Y=function(t){return u`
      <gds-button
        class="action"
    ...
    `};K=function(){return this.dismissible?u`
          <gds-button
            class="close"
            .variant=${r(this,s,m).button}
            rank="secondary"
        ...
        `:v};q=function(){return this.timeout>0?u`
          <div
