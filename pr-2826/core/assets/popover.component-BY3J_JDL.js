import{a8 as $,i as H,n as r,E as T,l as W,W as b,a as K,F as I,D as U,V as F,e as G,J as z,h as X}from"./iframe-B5Cc-pXz.js";import{l as Y}from"./localized-decorator-CQC93ZTT.js";import{o as q,s as Q,a as J,c as Z}from"./floating-ui.dom-DzQH3ivI.js";import{I as j}from"./cross-small.component-U47q8Q4m.js";function tt(t){return(e,o,n)=>{if($)return;const l=window.matchMedia(t),d=e.connectedCallback,y=e.disconnectedCallback;e.connectedCallback=function(){d?.call(this);const P=O=>{n.value?.call(this,O.matches)};l.addEventListener("change",P),this.disconnectedCallback=function(){y?.call(this),l.removeEventListener("change",P)},n.value?.call(this,l.matches)}}}const et=H`
