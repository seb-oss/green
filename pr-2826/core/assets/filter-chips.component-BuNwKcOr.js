import{i as b,n as p,D as O,V as k,e as C,h as w,a as $,K as E,E as F,l as V,W as z,F as G,a0 as P}from"./iframe-B5Cc-pXz.js";import{r as W}from"./resize-observer-CfkbZofs.js";import{s as B}from"./attribute-converters-CdI0trPX.js";import{I as D}from"./checkmark.component-DUGUGRzb.js";const H=b`
...
`;var M=Object.defineProperty,T=Object.getOwnPropertyDescriptor,v=(e,t,s,i)=>{for(var l=i>1?void 0:i?T(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(l=(i?n(t,s,l):n(l))||l);return i&&l&&M(t,s,l),l};let h=class extends O{constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),k.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return w`<gds-button
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};h.styles=[H];v([p({reflect:!0,type:Boolean})],h.prototype,"selected",2);v([p()],h.prototype,"value",2);v([p({reflect:!0,type:String})],h.prototype,"size",2);h=v([$("gds-filter-chip",{dependsOn:[E,D]})],h);const R=b`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
