import{i as z,C as S,Y as C,L as x,D as A,J as L,e as P,d as B,h as v,B as E,n as l,E as G,W as g,a as R}from"./iframe-BJon1Ubb.js";import{l as W}from"./localized-decorator-BbJ9OoJx.js";import{r as $,l as D,u as F}from"./scroll-lock-BP8paoQk.js";const M=z`
...
`;var O=Object.defineProperty,H=Object.getOwnPropertyDescriptor,w=r=>{throw TypeError(r)},s=(r,e,i,p)=>{for(var n=p>1?void 0:p?H(e,i):e,d=r.length-1,h;d>=0;d--)(h=r[d])&&(n=(p?h(e,i,n):h(n))||n);return p&&n&&O(e,i,n),n},f=(r,e,i)=>e.has(r)||w("Cannot "+i),k=(r,e,i)=>(f(r,e,"read from private field"),e.get(r)),b=(r,e,i)=>e.has(r)?w("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(r):e.set(r,i),y=(r,e,i,p)=>(f(r,e,"write to private field"),e.set(r,i),i),c=(r,e,i)=>(f(r,e,"access private method"),i),a,_,o,m,u;$();let t=class extends S(C(x(A))){constructor(){super(...arguments),b(this,a),this.label=L("Loading..."),this.labelPosition="bottom",this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="md",this._isAnimating=!1,b(this,o,!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.fullscreen&&c(this,a,m).call(this),this.dispatchCustomEvent("gds-spinner-connected")}disconnectedCallback(){super.disconnectedCallback(),this._isAnimating=!1,c(this,a,u).call(this)}_handleFullscreenChange(){this.fullscreen?c(this,a,m).call(this):c(this,a,u).call(this)}_updateAriaLabel(){this.setAttribute("aria-label",this.label)}render(){return v`
    ...
    `}};a=new WeakSet;_=function(){return{"spinner-wrapper":!0,"spinner-fullscreen":this.fullscreen,"spinner-cover":this.cover,"spinner-backdrop":this.cover||this.fullscreen,"spinner-animating":this._isAnimating,[`spinner-label-${this.labelPosition}`]:this.labelPosition}};o=new WeakMap;m=function(){k(this,o)||(D(this),y(this,o,!0))};u=function(){k(this,o)&&(F(this),y(this,o,!1))};t.styles=[E,M];s([l({type:String})],t.prototype,"label",2);s([l({type:String,reflect:!0,attribute:"label-position"})],t.prototype,"labelPosition",2);s([l({type:Boolean,reflect:!0})],t.prototype,"showLabel",2);s([l({type:Boolean,reflect:!0})],t.prototype,"cover",2);s([l({type:Boolean,reflect:!0})],t.prototype,"fullscreen",2);s([l({type:String,reflect:!0})],t.prototype,"size",2);s([G()],t.prototype,"_isAnimating",2);s([g("fullscreen")],t.prototype,"_handleFullscreenChange",1);s([g("label")],t.prototype,"_updateAriaLabel",1);t=s([R("gds-spinner"),W()],t);export{t as G};
