import{u as o,j as e,M as a}from"./iframe-BtRz1KRF.js";import"./preload-helper-PPVm8Dsz.js";function s(n){const t={code:"code",em:"em",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Concepts/Scoping"}),`
...
`,e.jsxs(t.p,{children:[`Shadow DOM encapsulation guards against style leaks in and out of components and custom element scoping ensures
...
This means that conflicts `,e.jsx(t.em,{children:"can"})," still occur here."]}),`
`,e.jsxs(t.p,{children:["But Green provides a way to guard against this type of conflict as well: ",e.jsx(t.code,{children:"<gds-theme>"}),"."]}),`
`,e.jsxs(t.p,{children:[e.jsx(t.code,{children:"<gds-theme>"})," defines a copy of all the CSS variables on its ",e.jsx(t.code,{children:":host"}),` selector. This means that
it will override any same-name variables defined on `,e.jsx(t.code,{children:":root"})," or inherited from outside."]}),`
`,e.jsxs(t.p,{children:["So by using ",e.jsx(t.code,{children:"<gds-theme>"}),` at the root of your application, you can ensure that all components get
their variables from the version you expect.`]})]})}function l(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{l as default};
