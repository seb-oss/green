import{a9 as O,i as V,n,w as D,f as A,$ as b,g as H,y as K,z as I,T as U,a as G,E as z,h as F}from"./iframe-CNBLKHAI.js";import{l as X}from"./localized-decorator-DncZGlXD.js";import{o as Y,s as q,a as Q,c as J}from"./floating-ui.dom-DPpwG6Py.js";import{I as Z}from"./cross-small.component-CVOiJZCG.js";function j(e){return(t,o,r)=>{if(O)return;const l=window.matchMedia(e),d=t.connectedCallback,y=t.disconnectedCallback;t.connectedCallback=function(){d?.call(this);const P=N=>{r.value?.call(this,N.matches)};l.addEventListener("change",P),this.disconnectedCallback=function(){y?.call(this),l.removeEventListener("change",P)},r.value?.call(this,l.matches)}}}const ee=V`
