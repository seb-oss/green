import{Q as F,N as G,P as f,O as D,a4 as y,A as w,ac as N,i as W,y as q,n as r,l as U,U as L,D as H,R as X,z as Y,J,a0 as K,d as S,h,o as a,H as Q,a as Z,I as j}from"./iframe-CAXRNL5R.js";import{l as tt}from"./localized-decorator-DK5RIkPW.js";import{r as et}from"./query-async-KfVuVGCT.js";import{G as st}from"./field-base.component-C7MgFukf.js";import{G as it,a as rt}from"./form-control-header.component-D5b1JzDd.js";import{f as ot}from"./form-control-host.style-CH4gic-9.js";import{G as at}from"./flex.component-C6l2MwzK.js";import{I as nt}from"./cross-small.component-0bRZZPT2.js";import{c as lt}from"./textarea.component-DNAqbYoe.js";const pt=F(class extends G{constructor(t){if(super(t),t.type!==f.PROPERTY&&t.type!==f.ATTRIBUTE&&t.type!==f.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!D(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===y||e===w)return e;const o=t.element,l=t.name;if(t.type===f.PROPERTY){if(e===o[l])return y}else if(t.type===f.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(l))return y}else if(t.type===f.ATTRIBUTE&&o.getAttribute(l)===e+"")return y;return N(t),e}}),ct=W`
