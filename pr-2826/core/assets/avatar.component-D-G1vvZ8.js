import{i as _,z as h,J as g,B as f,h as c,y,a as x,R as P,e as S,n as d,S as m,a6 as b,o as $}from"./iframe-BOo9vEbG.js";import{I as O}from"./people-profile.component-Bbk1sohf.js";const A=_`
...
`;var G=Object.getOwnPropertyDescriptor,E=(e,t,a,i)=>{for(var s=i>1?void 0:i?G(t,a):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=n(s)||s);return s};let v=class extends h(g(f)){connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","group")}render(){return c`<slot></slot>`}};v.styles=[y,A];v=E([x("gds-avatar-group")],v);const j=_`
  @layer tokens, core, sizes, shapes;
...
`;var D=Object.defineProperty,I=Object.getOwnPropertyDescriptor,z=e=>{throw TypeError(e)},o=(e,t,a,i)=>{for(var s=i>1?void 0:i?I(t,a):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&D(t,a,s),s},M=(e,t,a)=>t.has(e)||z("Cannot "+a),B=(e,t,a)=>t.has(e)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),u=(e,t,a)=>(M(e,t,"access private method"),a),p,k,w,C;let r=class extends P(h(g(f))){constructor(){super(...arguments),B(this,p),this.src="",this.alt="",this.size="m",this.shape="circular",this.level="2"}render(){const e=S({avatar:!0,[this.size]:!0,[this.shape]:!0,"has-image":!!this.src});return c`
