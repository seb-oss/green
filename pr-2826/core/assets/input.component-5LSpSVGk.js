import{Q as F,N as G,P as f,O as D,a4 as y,A as w,ac as N,i as W,y as q,n as r,l as U,U as L,D as H,R as X,z as Y,J,a0 as K,d as S,h,o as a,H as Q,a as Z,I as j}from"./iframe-Bs4J-K7K.js";import{l as tt}from"./localized-decorator-BLhXNS5k.js";import{r as et}from"./query-async-DM82d4rp.js";import{G as st}from"./field-base.component-DcjANTnd.js";import{G as it,a as rt}from"./form-control-header.component-Bu3AdLKI.js";import{f as ot}from"./form-control-host.style-D3YVbzCk.js";import{G as at}from"./flex.component-Cw8Ck61a.js";import{I as nt}from"./cross-small.component-D7tGRUMl.js";import{c as lt}from"./textarea.component-63rI-LR_.js";const pt=F(class extends G{constructor(t){if(super(t),t.type!==f.PROPERTY&&t.type!==f.ATTRIBUTE&&t.type!==f.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!D(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===y||e===w)return e;const o=t.element,l=t.name;if(t.type===f.PROPERTY){if(e===o[l])return y}else if(t.type===f.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(l))return y}else if(t.type===f.ATTRIBUTE&&o.getAttribute(l)===e+"")return y;return N(t),e}}),ct=W`
