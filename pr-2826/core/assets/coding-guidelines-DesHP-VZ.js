import{u as i,j as e,M as o}from"./iframe-C8ehJ7Np.js";import"./preload-helper-PPVm8Dsz.js";function s(n){const t={br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",strong:"strong",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Contributing/Coding Guidelines"}),`
...
`,e.jsx(t.p,{children:"Tests run in headless browsers using Vitest in browser mode."})]})}function h(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{h as default};
