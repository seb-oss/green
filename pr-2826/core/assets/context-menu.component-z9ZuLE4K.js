import{V as C,h as c,D as E,a as L,ad as P,C as G,L as D,J as W,d as B,B as I,n as u,l as H,W as N,K as F,F as R}from"./iframe-BHL6rpgH.js";import{l as z}from"./localized-decorator-C4LOLK1b.js";import{s as K,F as U,L as q,m as Y}from"./menu-listbox.style-CTzIS5J_.js";import{n as J,e as V}from"./ref-Czrp2C5n.js";import{I as X}from"./dot-grid-one-horizontal-emhLzK3G.js";import{G as Q,a as Z}from"./popover.component-BUYKngUb.js";import"./menu-heading.component-CTR0h-ne.js";var j=Object.getOwnPropertyDescriptor,M=e=>{throw TypeError(e)},ee=(e,t,s,r)=>{for(var a=r>1?void 0:r?j(t,s):t,i=e.length-1,l;i>=0;i--)(l=e[i])&&(a=l(a)||a);return a},te=(e,t,s)=>t.has(e)||M("Cannot "+s),se=(e,t,s)=>(te(e,t,"read from private field"),s?s.call(e):t.get(e)),ae=(e,t,s)=>t.has(e)?M("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),f;let m=class extends U(E){constructor(){super(...arguments),ae(this,f,()=>{this.dispatchCustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0})})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this.click())}),this.addEventListener("click",se(this,f)),C.instance.apply(this,"gds-option")}render(){return c`<div class="item"><slot></slot></div>`}};f=new WeakMap;m.styles=[K];m=ee([L("gds-menu-item")],m);function ne(e){let t=e;for(;t.assignedElements().length>0&&t.assignedElements()[0].nodeName==="SLOT";)t=t.assignedElements()[0];return t}var re=Object.getOwnPropertyDescriptor,T=e=>{throw TypeError(e)},ie=(e,t,s,r)=>{for(var a=r>1?void 0:r?re(t,s):t,i=e.length-1,l;i>=0;i--)(l=e[i])&&(a=l(a)||a);return a},oe=(e,t,s)=>t.has(e)||T("Cannot "+s),_=(e,t,s)=>(oe(e,t,"read from private field"),s?s.call(e):t.get(e)),le=(e,t,s)=>t.has(e)?T("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),g;let y=class extends E{constructor(){super(),le(this,g,V()),new q(this)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),C.instance.apply(this,P)}get navigableItems(){return _(this,g).value?ne(_(this,g).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-menu-item")||[]:[]}focus(){this.navigableItems[0]?.focus()}render(){return c`<slot ${J(_(this,g))}></slot>`}};g=new WeakMap;y=ie([L("gds-menu",{dependsOn:[m]})],y);var he=Object.defineProperty,de=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},d=(e,t,s,r)=>{for(var a=r>1?void 0:r?de(t,s):t,i=e.length-1,l;i>=0;i--)(l=e[i])&&(a=(r?l(t,s,a):l(a))||a);return r&&a&&he(t,s,a),a},x=(e,t,s)=>t.has(e)||S("Cannot "+s),o=(e,t,s)=>(x(e,t,"read from private field"),s?s.call(e):t.get(e)),p=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),O=(e,t,s,r)=>(x(e,t,"write to private field"),t.set(e,s),s),pe=(e,t,s)=>(x(e,t,"access private method"),s),h,w,v,b,$,A,k;let n=class extends G(D(E)){constructor(){super(...arguments),p(this,$),this.open=!1,this.buttonLabel=W("Open context menu"),this.showLabel=!1,this.label="",this.maxHeight=500,this.placement="bottom-start",p(this,h),p(this,w,()=>{o(this,h)||O(this,h,this.shadowRoot?.querySelector("#trigger")??void 0);const e=o(this,h);e&&!e.hasAttribute("data-gds-context-menu-trigger")&&(e.setAttribute("data-gds-context-menu-trigger","true"),e.addEventListener("click",()=>{this.open=!this.open}),e.addEventListener("keydown",t=>{(t.key==="ArrowDown"||t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.open=!0)}),Z(e,this.open,"menu"))}),p(this,v,()=>{const e=this._elTriggerSlot.assignedNodes({flatten:!0}).find(t=>t instanceof HTMLElement);e&&O(this,h,e),o(this,w).call(this)}),p(this,b,()=>c`<gds-popover
      id="menu"
      autofocus
      .open=${this.open}
