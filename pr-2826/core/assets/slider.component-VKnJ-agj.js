import{l as J}from"./localized-decorator-KYOSjjf2.js";import{i as Z,v as tt,n as d,f as q,w as v,$ as y,Q as et,I as st,H as it,a0 as at,d as _,h as p,o as D,g as rt}from"./iframe-BtRz1KRF.js";import{G as nt,a as ot}from"./form-control-header.component-CH90WHxW.js";import{f as lt}from"./form-control-host.style-DhqqTItW.js";const dt=Z`
  :host {
...
`;var ht=Object.defineProperty,ut=Object.getOwnPropertyDescriptor,O=t=>{throw TypeError(t)},n=(t,e,a,l)=>{for(var h=l>1?void 0:l?ut(e,a):e,m=t.length-1,f;m>=0;m--)(f=t[m])&&(h=(l?f(e,a,h):f(h))||h);return l&&h&&ht(e,a,h),h},R=(t,e,a)=>e.has(t)||O("Cannot "+a),o=(t,e,a)=>(R(t,e,"read from private field"),e.get(t)),u=(t,e,a)=>e.has(t)?O("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),i=(t,e,a)=>(R(t,e,"access private method"),a),s,w,g,$,b,W,A,H,P,j,x,U,X,k,M,z,V,T,E,c,S,C,N,L,B,Y,K,Q,F,I;let r=class extends at{constructor(){super(),u(this,s),this.supportingText="",this.showExtendedSupportingText=!1,this.plain=!1,this.size="large",this.min=0,this.max=100,this.step=1,this.showTicks=!1,this.showValueLabel=!0,this.range=!1,this.endValue=100,this.minLabel="",this.maxLabel="",this._activeThumb=null,this._focusedThumb=null,this._editingMin=!1,this._editingMax=!1,this._draftMin="0",this._draftMax="100",u(this,k,t=>{const e=t.target.valueAsNumber;this.value=e,this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),u(this,M,t=>{const e=t.target.valueAsNumber;this.value=e,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),u(this,z,t=>{const e=i(this,s,g).call(this,t.target.valueAsNumber);this.endValue=Math.max(this.value,e),i(this,s,x).call(this),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),u(this,V,t=>{const e=i(this,s,g).call(this,t.target.valueAsNumber);this.endValue=Math.max(this.value,e),i(this,s,x).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),u(this,T,()=>{this._activeThumb="start"}),u(this,E,()=>{this._activeThumb="end"}),u(this,c,()=>{this._activeThumb=null}),u(this,S,()=>{this._focusedThumb="start"}),u(this,C,()=>{this._focusedThumb="end"}),u(this,N,()=>{o(this,c).call(this),this._focusedThumb==="start"&&(this._focusedThumb=null)}),u(this,L,()=>{o(this,c).call(this),this._focusedThumb==="end"&&(this._focusedThumb=null)}),this._internalValue=this.min,this.endValue=this.max,this._draftMin=`${this.min}`,this._draftMax=`${this.max}`}get value(){return this._internalValue??this.min}set value(t){const e=i(this,s,g).call(this,t);this._internalValue=this.range?Math.min(e,this.endValue):e,i(this,s,x).call(this)}connectedCallback(){super.connectedCallback(),i(this,s,w).call(this),window.addEventListener("pointerup",o(this,c))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",o(this,c))}focus(t){this._getValidityAnchor()?.focus(t)}render(){const t=this.range?i(this,s,b).call(this,this.value):0,e=this.range?i(this,s,b).call(this,this.endValue):i(this,s,b).call(this,this.value),a=`--_range-start: ${i(this,s,W).call(this)}%; --_range-end: ${i(this,s,A).call(this)}%; --_value-start-ratio: ${i(this,s,b).call(this,this.value)}; --_value-end-ratio: ${i(this,s,b).call(this,this.endValue)}; --_fill-start-ratio: ${t}; --_fill-end-ratio: ${e}; --_tick-interval: ${i(this,s,P).call(this)}%;`;return p`
    ...
    `}_handleConstraintsUpdate(){i(this,s,w).call(this)}_getValidityAnchor(){return this._startInput}_isThumbVisible(t){return this._activeThumb===t||this._focusedThumb===t}};s=new WeakSet;w=function(){if(this.max<this.min){const t=this.min;this.min=this.max,this.max=t}this._internalValue=i(this,s,g).call(this,this.value),this.endValue=i(this,s,g).call(this,this.endValue),this.range&&this._internalValue>this.endValue&&(this._internalValue=this.endValue),i(this,s,x).call(this)};g=function(t){const e=this.step>0?this.step:1,a=this.min+Math.round((t-this.min)/e)*e;return Math.max(this.min,Math.min(this.max,a))};$=function(t){return this.max===this.min?0:(t-this.min)/(this.max-this.min)*100};b=function(t){return this.max===this.min?0:(t-this.min)/(this.max-this.min)};W=function(){return this.range?i(this,s,$).call(this,this.value):i(this,s,$).call(this,this.min)};A=function(){return i(this,s,$).call(this,this.range?this.endValue:this.value)};H=function(t,e=0){const a=e>0?"+":"-",l=e!==0?` ${a} ${Math.abs(e)}px`:"";return`calc(var(--_slider-thumb-size) / 2 + ${t} * (100% - var(--_slider-thumb-size))${l})`};P=function(){const t=this.max-this.min,e=this.step>0?this.step:1;return t<=0?100:Math.max(e/t*100,1)};j=function(){if(!this.showTicks)return p``;const t=[],e=i(this,s,P).call(this);for(let a=0;a<=100;a+=e){const l=this.min+(this.max-this.min)*a/100;t.push({position:a,value:l})}return p`
      ${t.map((a,l)=>{const h=a.position>=i(this,s,W).call(this)&&a.position<=i(this,s,A).call(this),m=a.position/100,f=l===0?2:l===t.length-1?-2:0;return p`
          <div
            class="tick ${h?"tick-filled":"tick-unfilled"}"
            style="left: ${i(this,s,H).call(this,m,f)}"
          ></div>
        `})}
    `};x=function(){this.range?this._setFormValue(`${this.value},${this.endValue}`):this._setFormValue(`${this.value}`)};U=function(){return this.range?`${this.label} start`:this.plain?this.label:void 0};X=function(){return this.label?`${this.label} end`:void 0};k=new WeakMap;M=new WeakMap;z=new WeakMap;V=new WeakMap;T=new WeakMap;E=new WeakMap;c=new WeakMap;S=new WeakMap;C=new WeakMap;N=new WeakMap;L=new WeakMap;B=function(t){const e=t==="min"?this._editingMin:this._editingMax,a=t==="min"?this._draftMin:this._draftMax,l=t==="min"?this.min:this.max,h=t==="min"?"Min":"Max";return p`
      <span class="bound-editor ${e?"editing":""}">
        ...
        <input
          ...
          tabindex=${e?"0":"-1"}
          ?disabled=${this.disabled}
          @input=${m=>i(this,s,K).call(this,t,m)}
          @blur=${()=>i(this,s,F).call(this,t)}
          @keydown=${m=>i(this,s,Q).call(this,t,m)}
        />
      </span>
    `};Y=function(t){t==="min"?(this._draftMin=`${this.min}`,this._editingMin=!0):(this._draftMax=`${this.max}`,this._editingMax=!0),setTimeout(()=>{const e=this.shadowRoot?.querySelector(`#${t}-range-editor`);e?.focus(),e?.select()},80)};K=function(t,e){const a=e.target.value;t==="min"?this._draftMin=a:this._draftMax=a;const l=Number(a);!a||Number.isNaN(l)||(t==="min"?this.min=l:this.max=l)};Q=function(t,e){if(e.key==="Enter"){i(this,s,F).call(this,t);return}e.key==="Escape"&&(e.preventDefault(),i(this,s,I).call(this,t))};F=function(t){const e=Number(t==="min"?this._draftMin:this._draftMax);Number.isNaN(e)||(t==="min"?this.min=e:this.max=e),i(this,s,I).call(this,t)};I=function(t){if(t==="min"){this._editingMin=!1,this._draftMin=`${this.min}`;return}this._editingMax=!1,this._draftMax=`${this.max}`};r.styles=[tt,lt,dt];n([d({attribute:"supporting-text"})],r.prototype,"supportingText",2);n([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],r.prototype,"showExtendedSupportingText",2);n([d({type:Boolean})],r.prototype,"plain",2);n([d({reflect:!0})],r.prototype,"size",2);n([d({type:Number})],r.prototype,"min",2);n([d({type:Number})],r.prototype,"max",2);n([d({type:Number})],r.prototype,"step",2);n([d({type:Boolean,reflect:!0,attribute:"show-ticks"})],r.prototype,"showTicks",2);n([d({type:Boolean,reflect:!0,attribute:"show-value-label"})],r.prototype,"showValueLabel",2);n([d({type:Boolean,reflect:!0})],r.prototype,"range",2);n([d({type:Number})],r.prototype,"value",1);n([d({type:Number,attribute:"end-value"})],r.prototype,"endValue",2);n([d({attribute:"min-label"})],r.prototype,"minLabel",2);n([d({attribute:"max-label"})],r.prototype,"maxLabel",2);n([q("#slider-start")],r.prototype,"_startInput",2);n([q("#slider-end")],r.prototype,"_endInput",2);n([v()],r.prototype,"_activeThumb",2);n([v()],r.prototype,"_focusedThumb",2);n([v()],r.prototype,"_editingMin",2);n([v()],r.prototype,"_editingMax",2);n([v()],r.prototype,"_draftMin",2);n([v()],r.prototype,"_draftMax",2);n([y("min"),y("max"),y("step"),y("range")],r.prototype,"_handleConstraintsUpdate",1);r=n([J()],r);let G=class extends et(st(it(r))){};G=n([rt("gds-slider",{dependsOn:[nt,ot]})],G);export{G};
