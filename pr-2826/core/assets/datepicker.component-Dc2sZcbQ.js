import{f as Bt,S as Lt,P as Vt,R as Gt,af as Ht,ag as A,ah as P,ai as et,a5 as Ut,ac as Jt,n as g,E as L,W as j,D as Kt,h as w,a as Ft,i as qt,B as Xt,l as Q,F as jt,T as Qt,C as Zt,L as te,a0 as ee,V as ae,d as I,J as p,A as se,K as ie}from"./iframe-BHL6rpgH.js";import{l as ne}from"./localized-decorator-C4LOLK1b.js";import{r as Z}from"./query-async-eLKe-64X.js";import{a as oe}from"./dropdown.component-BLO6CDd7.js";import{G as re}from"./flex.component-ocxNAtYp.js";import{f as le}from"./form-control-host.style-CH_gu6gB.js";import{d as $t,a as he}from"./attribute-converters-CdI0trPX.js";import{i as N,l as de,G as ue,s as pe}from"./calendar.component-Bfj6WVc6.js";import{I as ce,a as ge}from"./calender-add.component-CdgEQr4B.js";import{I as fe}from"./chevron-left.component-DqPS3Dxz.js";import{I as me}from"./chevron-right.component-p9mM60Ms.js";import{G as ye}from"./popover.component-BUYKngUb.js";let ve;function _e(t){return(e,a)=>Bt(e,a,{get(){return(this.renderRoot??(ve??=document.createDocumentFragment())).querySelectorAll(t)}})}function*be(t,e){const a=typeof e=="function";if(t!==void 0){let i=-1;for(const s of t)i>-1&&(yield a?e(i):e),i++,yield s}}function*$e(t,e){if(t!==void 0){let a=0;for(const i of t)yield e(i,a++)}}const Ct=(t,e,a)=>{const i=new Map;for(let s=e;s<=a;s++)i.set(t[s],s);return i},xe=Lt(class extends Vt{constructor(t){if(super(t),t.type!==Gt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,a){let i;a===void 0?a=e:e!==void 0&&(i=e);const s=[],l=[];let h=0;for(const b of t)s[h]=i?i(b,h):h,l[h]=a(b,h),h++;return{values:l,keys:s}}render(t,e,a){return this.dt(t,e,a).values}update(t,[e,a,i]){const s=Ht(t),{values:l,keys:h}=this.dt(e,a,i);if(!Array.isArray(s))return this.ut=h,l;const b=this.ut??=[],d=[];let C,Y,f=0,$=s.length-1,m=0,k=l.length-1;for(;f<=$&&m<=k;)if(s[f]===null)f++;else if(s[$]===null)$--;else if(b[f]===h[m])d[m]=A(s[f],l[m]),f++,m++;else if(b[$]===h[k])d[k]=A(s[$],l[k]),$--,k--;else if(b[f]===h[k])d[k]=A(s[f],l[k]),P(t,d[k+1],s[f]),f++,k--;else if(b[$]===h[m])d[m]=A(s[$],l[m]),P(t,s[f],s[$]),$--,m++;else if(C===void 0&&(C=Ct(h,m,k),Y=Ct(b,f,$)),C.has(b[f]))if(C.has(b[$])){const S=Y.get(h[m]),tt=S!==void 0?s[S]:null;if(tt===null){const Dt=P(t,s[f]);A(Dt,l[m]),d[m]=Dt}else d[m]=A(tt,l[m]),P(t,s[f],tt),s[S]=null;m++}else et(s[$]),$--;else et(s[f]),f++;for(;m<=k;){const S=P(t,d[k+1]);A(S,l[m]),d[m++]=S}for(;f<=$;){const S=s[f++];S!==null&&et(S)}return this.ut=h,Jt(t,d),Ut}});var we=Object.defineProperty,ke=Object.getOwnPropertyDescriptor,Wt=t=>{throw TypeError(t)},T=(t,e,a,i)=>{for(var s=i>1?void 0:i?ke(e,a):e,l=t.length-1,h;l>=0;l--)(h=t[l])&&(s=(i?h(e,a,s):h(s))||s);return i&&s&&we(e,a,s),s},xt=(t,e,a)=>e.has(t)||Wt("Cannot "+a),v=(t,e,a)=>(xt(t,e,"read from private field"),a?a.call(t):e.get(t)),F=(t,e,a)=>e.has(t)?Wt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),Yt=(t,e,a,i)=>(xt(t,e,"write to private field"),e.set(t,a),a),x=(t,e,a)=>(xt(t,e,"access private method"),a),W,G,H,U,J,at,st,it,_,At,R,nt,z,K;let M=class extends Kt{constructor(){super(...arguments),F(this,_),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=x(this,_,nt).call(this,this.value,this.length),F(this,W,""),F(this,G,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=x(this,_,z).call(this,t+1),x(this,_,R).call(this)}),F(this,H,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=x(this,_,z).call(this,t-1),x(this,_,R).call(this)}),F(this,U,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),F(this,J,()=>{x(this,_,K).call(this)}),F(this,at,()=>{v(this,W)!==""&&(x(this,_,K).call(this),this.value=x(this,_,z).call(this,parseInt(this.value.toString())),x(this,_,R).call(this))}),F(this,st,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?v(this,H).call(this):v(this,G).call(this)}),F(this,it,t=>{let e=!1;if(t.key==="ArrowUp")v(this,G).call(this),e=!0;else if(t.key==="ArrowDown")v(this,H).call(this),e=!0;else{const a=parseInt(t.key);isNaN(a)||(v(this,W).length<this.length&&(Yt(this,W,v(this,W)+a.toString()),this.value=parseInt(v(this,W))),v(this,W).length===this.length&&(this.value=x(this,_,z).call(this,this.value),x(this,_,K).call(this),x(this,_,At).call(this),x(this,_,R).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",v(this,st)),this.addEventListener("keydown",v(this,it)),this.addEventListener("blur",v(this,at)),this.addEventListener("focus",v(this,J)),this.addEventListener("click",v(this,U)),this.addEventListener("mousedown",v(this,U))}focus(t){super.focus(t),v(this,J).call(this)}render(){return w`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=x(this,_,nt).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};W=new WeakMap;G=new WeakMap;H=new WeakMap;U=new WeakMap;J=new WeakMap;at=new WeakMap;st=new WeakMap;it=new WeakMap;_=new WeakSet;At=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof M){t.focus();break}t=t.nextElementSibling}};R=function(){this.dispatchCustomEvent("change",{detail:{value:this.value.toString()}})};nt=function(t,e){return String(t).padStart(e,"0")};z=function(t){return Math.max(this.min,Math.min(this.max,t))};K=function(){Yt(this,W,"")};M.formAssociated=!0;T([g({type:Number})],M.prototype,"value",2);T([g({type:Number})],M.prototype,"length",2);T([g({type:Number,attribute:"aria-valuemin"})],M.prototype,"min",2);T([g({type:Number,attribute:"aria-valuemax"})],M.prototype,"max",2);T([L()],M.prototype,"displayValue",2);T([j("value")],M.prototype,"_refreshDisplayValue",1);M=T([Ft("gds-date-part-spinner")],M);const Me=qt`
  @layer base, reset;
