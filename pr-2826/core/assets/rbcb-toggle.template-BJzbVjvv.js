import{a as i,d as t,h as r}from"./iframe-C3aS2Lld.js";const m=c=>b({...c,type:"checkbox"}),k=c=>b({...c,type:"radio"}),b=c=>{const{type:e,checked:s,indeterminate:o,disabled:d,invalid:a}=c;return r`
