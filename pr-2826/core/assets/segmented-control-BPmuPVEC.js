import{i as W,T as z,D as $,V as B,h as L,B as P,n as g,a as V,L as M,C as D,J as O,l as S,E as T,W as G,F as N}from"./iframe-B5Cc-pXz.js";import{l as R}from"./localized-decorator-CQC93ZTT.js";import{r as F}from"./resize-observer-CfkbZofs.js";import{I as X}from"./chevron-left.component-CPrREDBO.js";import{I as A}from"./chevron-right.component-DThl_w7O.js";const J=W`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var j=Object.defineProperty,q=Object.getOwnPropertyDescriptor,m=(t,e,s,r)=>{for(var i=r>1?void 0:r?q(e,s):e,a=t.length-1,h;a>=0;a--)(h=t[a])&&(i=(r?h(e,s,i):h(i))||i);return r&&i&&j(e,s,i),i};let p=class extends z($){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return L`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};p.styles=[...P,J];m([g({type:Boolean,reflect:!0})],p.prototype,"selected",2);m([g()],p.prototype,"value",2);m([g({type:Boolean,reflect:!0})],p.prototype,"disabled",2);p=m([V("gds-segment")],p);const H=W`
  @layer base {
    :host {
...
`;var K=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,E=t=>{throw TypeError(t)},c=(t,e,s,r)=>{for(var i=r>1?void 0:r?Q(e,s):e,a=t.length-1,h;a>=0;a--)(h=t[a])&&(i=(r?h(e,s,i):h(i))||i);return r&&i&&K(e,s,i),i},C=(t,e,s)=>e.has(t)||E("Cannot "+s),o=(t,e,s)=>(C(t,e,"read from private field"),s?s.call(t):e.get(t)),l=(t,e,s)=>e.has(t)?E("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),v=(t,e,s,r)=>(C(t,e,"write to private field"),e.set(t,s),s),U=(t,e,s)=>(C(t,e,"access private method"),s),d,b,I,_,y,w,u,f,x,k;const Y=(t,e)=>{let s;return()=>{clearTimeout(s),s=setTimeout(t,e)}};let n=class extends M(z(D($))){constructor(){super(...arguments),l(this,b),this.size="medium",l(this,d),this._showPrevButton=!1,this._showNextButton=!1,this.intersectionObserver=null,l(this,_,()=>{const t=this.segments.filter((e,s,r)=>r[s+1]?.isVisible&&!e.isVisible)[0];t&&(this._elTrack.scrollLeft-=t.offsetWidth)}),l(this,y,()=>{const t=this.segments.filter((e,s,r)=>r[s-1]?.isVisible&&!e.isVisible).reverse()[0];t&&(this._elTrack.scrollLeft+=t.offsetWidth)}),l(this,w,()=>{this.segments.every(t=>!t.isVisible)||(this._showPrevButton=!this.segments[0].isVisible,this._showNextButton=!this.segments[this.segments.length-1].isVisible)}),l(this,u,Y(o(this,w),50)),l(this,f,()=>{const t=this.segments.find(e=>e.selected);if(t){const e=t.offsetWidth,s=t.offsetLeft;this._elIndicator.style.transform=`translateX(${s}px)`,this._elIndicator.style.width=`${e}px`}else this._elIndicator.style.transform="translateX(-100%)",this._elIndicator.style.width="0px"}),l(this,x,t=>{const e=this.segments.find(s=>s===t.target||s.contains(t.target));e&&(this.segments.forEach(s=>s.selected=!1),e.selected=!0,v(this,d,e.value),o(this,f).call(this),this.dispatchCustomEvent("change",{detail:{segment:e},bubbles:!0,composed:!0}))}),l(this,k,()=>{o(this,d)&&this.updateComplete.then(()=>{const t=this.segments.find(e=>e.value===o(this,d));if(t){this.segments.forEach(a=>a.selected=!1),t.selected=!0;const e=t.offsetLeft,s=e+t.offsetWidth,r=this._elTrack.scrollLeft,i=this._elTrack.offsetWidth;e<r?this._elTrack.scrollLeft=e:s>r+i&&(this._elTrack.scrollLeft=s-i)}})})}get value(){return o(this,d)}set value(t){v(this,d,t),o(this,k).call(this)}get segments(){return this._elSlot?this._elSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented-control"),this.updateComplete.then(()=>{this._elTrack.addEventListener("scroll",()=>{o(this,u).call(this)})})}render(){return L`<button
      ...
      </button>`}_recalculateMinWidth(){this.updateComplete.then(()=>{o(this,u).call(this),o(this,f).call(this)})}};d=new WeakMap;b=new WeakSet;I=function(){const t=this.segments.find(e=>e.selected)?.value;t&&v(this,d,t),this.intersectionObserver?.disconnect(),this.intersectionObserver=new IntersectionObserver(e=>{e.forEach(s=>{const r=s.target;r._isVisible=s.intersectionRatio>.99,o(this,u).call(this)})},{root:this._elTrack,threshold:[0,.01,.5,.99,1]}),this.segments.forEach(e=>{this.intersectionObserver?.observe(e)})};_=new WeakMap;y=new WeakMap;w=new WeakMap;u=new WeakMap;f=new WeakMap;x=new WeakMap;k=new WeakMap;n.styles=[P,H];c([g({reflect:!0})],n.prototype,"size",2);c([g()],n.prototype,"value",1);c([S("slot")],n.prototype,"_elSlot",2);c([S("#indicator")],n.prototype,"_elIndicator",2);c([S("#track")],n.prototype,"_elTrack",2);c([T()],n.prototype,"_showPrevButton",2);c([T()],n.prototype,"_showNextButton",2);c([F(),G("value")],n.prototype,"_recalculateMinWidth",1);n=c([V("gds-segmented-control",{dependsOn:[p,X,A]}),N({labelledBy:'[role="list"]',describedBy:'[role="list"]'}),R()],n);n.define();export{p as G};
