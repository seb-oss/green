import{l as it}from"./localized-decorator-BLhXNS5k.js";import{i as st,y as at,n as h,l as rt,C as f,U as k,R as nt,z as ot,J as lt,a0 as ut,d as m,h as g,o as O,a as ht}from"./iframe-Bs4J-K7K.js";import{G as dt,a as ct}from"./form-control-header.component-Bu3AdLKI.js";import{f as pt}from"./form-control-host.style-D3YVbzCk.js";const bt=st`
  :host {
...
`;var gt=Object.defineProperty,vt=Object.getOwnPropertyDescriptor,q=t=>{throw TypeError(t)},o=(t,e,i,r)=>{for(var u=r>1?void 0:r?vt(e,i):e,c=t.length-1,p;c>=0;c--)(p=t[c])&&(u=(r?p(e,i,u):p(u))||u);return r&&u&&gt(e,i,u),u},D=(t,e,i)=>e.has(t)||q("Cannot "+i),l=(t,e,i)=>(D(t,e,"read from private field"),e.get(t)),d=(t,e,i)=>e.has(t)?q("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),z=(t,e,i,r)=>(D(t,e,"write to private field"),e.set(t,i),i),a=(t,e,i)=>(D(t,e,"access private method"),i),_,s,V,v,w,y,U,X,Y,H,J,K,$,Q,Z,E,S,T,N,I,B,b,C,A,P,W,F,j,tt,et,L,G;let n=class extends ut{constructor(){super(),d(this,s),this.supportingText="",this.showExtendedSupportingText=!1,this.plain=!1,this.size="large",this.min=0,this.max=100,this.step=1,this.ticks=!1,this.bubble=!0,this.range=!1,this.endValue=100,this.hideBoundEditors=!1,this.readonly=!1,this._activeThumb=null,this._focusedThumb=null,this._editingMin=!1,this._editingMax=!1,this._draftMin="",this._draftMax="",this._draftMinInvalid=!1,this._draftMaxInvalid=!1,d(this,_,!1),d(this,E,t=>{if(this.readonly){t.target.valueAsNumber=this.value;return}const e=t.target,i=e.valueAsNumber,r=this.range?Math.min(i,this.endValue):i;r!==i&&(e.value=String(r)),this.value=r,this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),d(this,S,t=>{if(this.readonly){t.target.valueAsNumber=this.value;return}const e=t.target,i=e.valueAsNumber,r=this.range?Math.min(i,this.endValue):i;r!==i&&(e.value=String(r)),this.value=r,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),d(this,T,t=>{if(this.readonly){t.target.valueAsNumber=this.endValue;return}const e=t.target,i=a(this,s,v).call(this,e.valueAsNumber),r=Math.max(this.value,i);r!==i&&(e.value=String(r)),this.endValue=r,a(this,s,$).call(this),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),d(this,N,t=>{if(this.readonly){t.target.valueAsNumber=this.endValue;return}const e=t.target,i=a(this,s,v).call(this,e.valueAsNumber),r=Math.max(this.value,i);r!==i&&(e.value=String(r)),this.endValue=r,a(this,s,$).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),d(this,I,()=>{this._activeThumb="start"}),d(this,B,()=>{this._activeThumb="end"}),d(this,b,()=>{this._activeThumb=null}),d(this,C,()=>{this._focusedThumb="start"}),d(this,A,()=>{this._focusedThumb="end"}),d(this,P,()=>{l(this,b).call(this),this._focusedThumb==="start"&&(this._focusedThumb=null)}),d(this,W,()=>{l(this,b).call(this),this._focusedThumb==="end"&&(this._focusedThumb=null)}),this._internalValue=this.min,this.endValue=this.max}get value(){return this._internalValue??this.min}set value(t){const e=!Number.isNaN(t)&&(t>this.max||t<this.min),i=a(this,s,v).call(this,t);this._internalValue=this.range?Math.min(i,this.endValue):i,e?(z(this,_,!0),this.errorMessage=`Value must be between ${this.min} and ${this.max}`,this.invalid=!0):l(this,_)&&(z(this,_,!1),this.errorMessage="",this.invalid=!1),a(this,s,$).call(this)}connectedCallback(){super.connectedCallback(),a(this,s,V).call(this),window.addEventListener("pointerup",l(this,b))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",l(this,b))}focus(t){this._getValidityAnchor()?.focus(t)}render(){const t=a(this,s,K).call(this);return g`
    ...
    `}_handleConstraintsUpdate(){l(this,_)&&(z(this,_,!1),this.errorMessage="",this.invalid=!1),a(this,s,V).call(this)}_getValidityAnchor(){return this._startInput}_isThumbVisible(t){return this._activeThumb===t||this._focusedThumb===t}};_=new WeakMap;s=new WeakSet;V=function(){if(this.max<this.min){const t=this.min;this.min=this.max,this.max=t}this._internalValue=a(this,s,v).call(this,this.value),this.endValue=a(this,s,v).call(this,this.endValue),this.range&&this._internalValue>this.endValue&&(this._internalValue=this.endValue),a(this,s,$).call(this)};v=function(t){const e=this.step>0?this.step:1,i=this.min+Math.round((t-this.min)/e)*e;return Math.max(this.min,Math.min(this.max,i))};w=function(t){return this.max===this.min?0:(t-this.min)/(this.max-this.min)*100};y=function(t){return this.max===this.min?0:(t-this.min)/(this.max-this.min)};U=function(){return this.range?a(this,s,w).call(this,this.value):a(this,s,w).call(this,this.min)};X=function(){return a(this,s,w).call(this,this.range?this.endValue:this.value)};Y=function(t,e,i){return e?"left: 1px; transform: none":i?"left: calc(100% - 1px); transform: translateX(-100%)":`left: calc(var(--_thumb-size) / 2 + ${t} * (100% - var(--_thumb-size)))`};H=function(){const t=this.max-this.min,e=this.step>0?this.step:1;return t<=0?100:Math.max(e/t*100,1)};J=function(){if(!this.ticks)return g``;const t=[],e=a(this,s,H).call(this);for(let i=0;i<=100;i+=e){const r=this.min+(this.max-this.min)*i/100;t.push({position:i,value:r})}return g`
      ${t.map((i,r)=>{const u=i.position>=a(this,s,U).call(this)&&i.position<=a(this,s,X).call(this),c=i.position/100,p=r===0,x=r===t.length-1;return g`
          <div
            class="tick ${u?"tick-filled":"tick-unfilled"}"
            style="${a(this,s,Y).call(this,c,p,x)}"
          ></div>
        `})}
    `};K=function(){const t=x=>`calc((100% - var(--_thumb-size)) * ${x} + (var(--_thumb-size) / 2))`,e=this.range?a(this,s,y).call(this,this.value):0,i=this.range?a(this,s,y).call(this,this.endValue):a(this,s,y).call(this,this.value),r=this.range?`calc(${t(e)} + var(--_fill-gap))`:"0%",u=`calc(${t(i)} - var(--_fill-gap))`,c=`calc(${t(i)} + var(--_fill-gap))`,p=this.range?`calc(${t(e)} - var(--_fill-gap))`:"0%";return[`--_value-start-ratio: ${a(this,s,y).call(this,this.value)}`,`--_value-end-ratio: ${a(this,s,y).call(this,this.endValue)}`,`--_fill-start-pos: ${r}`,`--_fill-end-pos: ${u}`,`--_track-after-start: ${c}`,`--_track-before-end: ${p}`].join("; ")};$=function(){this.range?this._setFormValue(`${this.value},${this.endValue}`):this._setFormValue(`${this.value}`)};Q=function(){return this.range?`${this.label} start`:this.plain?this.label:void 0};Z=function(){return this.label?`${this.label} end`:void 0};E=new WeakMap;S=new WeakMap;T=new WeakMap;N=new WeakMap;I=new WeakMap;B=new WeakMap;b=new WeakMap;C=new WeakMap;A=new WeakMap;P=new WeakMap;W=new WeakMap;F=function(t){const e=t==="min"?this._editingMin:this._editingMax,i=t==="min"?this.value:this.range?this.endValue:this.value,r=t==="min"?this._draftMin:this._draftMax,u=t==="min"?this._draftMinInvalid:this._draftMaxInvalid,c=e?r:String(i),p=t==="min"?"Start value":"End value",x=this.label?`${this.label} ${p.toLowerCase()}`:p;return g`<input
    ...
    />`};j=function(t){if(this.readonly)return;t==="min"?(this._draftMin=`${this.value}`,this._editingMin=!0):(this._draftMax=`${this.range?this.endValue:this.value}`,this._editingMax=!0),this.shadowRoot?.querySelector(`#${t}-range-editor`)?.select()};tt=function(t,e){const i=e.target.value;t==="min"?this._draftMin=i:this._draftMax=i;const r=Number(i);if(!i||Number.isNaN(r))return;const u=r<this.min||r>this.max;t==="min"?(this._draftMinInvalid=u,u||(this.value=a(this,s,v).call(this,r))):(this._draftMaxInvalid=u,u||(this.range?this.endValue=Math.max(this.value,a(this,s,v).call(this,r)):this.value=a(this,s,v).call(this,r)))};et=function(t,e){if(e.key==="Enter"){a(this,s,L).call(this,t);return}e.key==="Escape"&&(e.preventDefault(),a(this,s,G).call(this,t))};L=function(t){if(this.readonly)return;const e=Number(t==="min"?this._draftMin:this._draftMax);if(!Number.isNaN(e)){const i=a(this,s,v).call(this,e);t==="min"?this.value=i:this.range?this.endValue=Math.max(this.value,i):this.value=i}a(this,s,G).call(this,t)};G=function(t){if(t==="min"){this._editingMin=!1,this._draftMin="",this._draftMinInvalid=!1;return}this._editingMax=!1,this._draftMax="",this._draftMaxInvalid=!1};n.styles=[at,pt,bt];o([h({attribute:"supporting-text"})],n.prototype,"supportingText",2);o([h({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],n.prototype,"showExtendedSupportingText",2);o([h({type:Boolean})],n.prototype,"plain",2);o([h({reflect:!0})],n.prototype,"size",2);o([h({type:Number,reflect:!0})],n.prototype,"min",2);o([h({type:Number,reflect:!0})],n.prototype,"max",2);o([h({type:Number})],n.prototype,"step",2);o([h({type:Boolean,reflect:!0,attribute:"ticks"})],n.prototype,"ticks",2);o([h({type:Boolean,reflect:!0,attribute:"bubble"})],n.prototype,"bubble",2);o([h({type:Boolean,reflect:!0})],n.prototype,"range",2);o([h({type:Number})],n.prototype,"value",1);o([h({type:Number,attribute:"end-value"})],n.prototype,"endValue",2);o([h({type:Boolean,attribute:"hide-bound-editors"})],n.prototype,"hideBoundEditors",2);o([h({type:Boolean,reflect:!0})],n.prototype,"readonly",2);o([rt("#slider-start")],n.prototype,"_startInput",2);o([f()],n.prototype,"_activeThumb",2);o([f()],n.prototype,"_focusedThumb",2);o([f()],n.prototype,"_editingMin",2);o([f()],n.prototype,"_editingMax",2);o([f()],n.prototype,"_draftMin",2);o([f()],n.prototype,"_draftMax",2);o([f()],n.prototype,"_draftMinInvalid",2);o([f()],n.prototype,"_draftMaxInvalid",2);o([k("min"),k("max"),k("step"),k("range")],n.prototype,"_handleConstraintsUpdate",1);n=o([it()],n);let R=class extends nt(ot(lt(n))){};R=o([ht("gds-slider",{dependsOn:[dt,ct]})],R);export{R as G};
