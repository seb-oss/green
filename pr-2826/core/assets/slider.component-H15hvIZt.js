import{l as at}from"./localized-decorator-DEYOVTWz.js";import{i as st,v as rt,n as d,f as Y,w as v,$,Q as nt,I as ot,H as lt,a0 as dt,d as p,h,a as ut,o as R,g as ht}from"./iframe-BCI2c7Bh.js";import{G as ct,a as pt}from"./form-control-header.component-DJAS_uNH.js";import{f as mt}from"./form-control-host.style-6QHCZg3B.js";import{G as gt}from"./input.component-BRATBH8G.js";const bt=st`
  :host {
...
`;var vt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,j=t=>{throw TypeError(t)},n=(t,i,e,l)=>{for(var c=l>1?void 0:l?ft(i,e):i,b=t.length-1,y;b>=0;b--)(y=t[b])&&(c=(l?y(i,e,c):y(c))||c);return l&&c&&vt(i,e,c),c},D=(t,i,e)=>i.has(t)||j("Cannot "+e),o=(t,i,e)=>(D(t,i,"read from private field"),i.get(t)),u=(t,i,e)=>i.has(t)?j("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(t):i.set(t,e),x=(t,i,e,l)=>(D(t,i,"write to private field"),i.set(t,e),e),s=(t,i,e)=>(D(t,i,"access private method"),e),m,a,M,f,k,_,P,F,U,G,X,K,Q,z,w,J,Z,V,E,T,N,S,I,g,B,C,L,W,A,tt,it,et,q,O;let r=class extends dt{constructor(){super(),u(this,a),this.supportingText="",this.showExtendedSupportingText=!1,this.plain=!1,this.size="large",this.min=0,this.max=100,this.step=1,this.showTicks=!1,this.showTrailInput=!1,this.showValueLabel=!0,this.range=!1,this.endValue=100,this.leadLabel="",this.trailLabel="",this.hideBoundEditors=!1,this._activeThumb=null,this._focusedThumb=null,this._editingMin=!1,this._editingMax=!1,this._draftMin="0",this._draftMax="100",this._trailDisplayValue="",this._trailInvalid=!1,u(this,m,!1),u(this,z,t=>{const i=t.target;this._trailDisplayValue=String(i.value);const e=Number(i.value),l=this._trailInvalid;this._trailInvalid=!Number.isNaN(e)&&(e>this.max||e<this.min),this._trailInvalid&&!l?(x(this,m,!0),this.errorMessage=`Value must be between ${this.min} and ${this.max}`,this.invalid=!0):!this._trailInvalid&&o(this,m)&&(x(this,m,!1),this.errorMessage="",this.invalid=!1),!Number.isNaN(e)&&!this._trailInvalid&&(this.value=s(this,a,f).call(this,e))}),u(this,V,t=>{const i=t.target.valueAsNumber;this.value=i,this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),u(this,E,t=>{const i=t.target.valueAsNumber;this.value=i,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),u(this,T,t=>{const i=s(this,a,f).call(this,t.target.valueAsNumber);this.endValue=Math.max(this.value,i),s(this,a,w).call(this),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),u(this,N,t=>{const i=s(this,a,f).call(this,t.target.valueAsNumber);this.endValue=Math.max(this.value,i),s(this,a,w).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),u(this,S,()=>{this._activeThumb="start"}),u(this,I,()=>{this._activeThumb="end"}),u(this,g,()=>{this._activeThumb=null}),u(this,B,()=>{this._focusedThumb="start"}),u(this,C,()=>{this._focusedThumb="end"}),u(this,L,()=>{o(this,g).call(this),this._focusedThumb==="start"&&(this._focusedThumb=null)}),u(this,W,()=>{o(this,g).call(this),this._focusedThumb==="end"&&(this._focusedThumb=null)}),this._internalValue=this.min,this.endValue=this.max,this._draftMin=`${this.min}`,this._draftMax=`${this.max}`}get value(){return this._internalValue??this.min}set value(t){const i=!Number.isNaN(t)&&(t>this.max||t<this.min),e=s(this,a,f).call(this,t);this._internalValue=this.range?Math.min(e,this.endValue):e,this._trailDisplayValue=String(e),this._trailInvalid=!1,i?(x(this,m,!0),this.errorMessage=`Value must be between ${this.min} and ${this.max}`,this.invalid=!0):o(this,m)&&(x(this,m,!1),this.errorMessage="",this.invalid=!1),s(this,a,w).call(this)}connectedCallback(){super.connectedCallback(),s(this,a,M).call(this),window.addEventListener("pointerup",o(this,g))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",o(this,g))}focus(t){this._getValidityAnchor()?.focus(t)}render(){const t=s(this,a,K).call(this);return h`
    ...
    `};tt=function(t){t==="min"?(this._draftMin=`${this.min}`,this._editingMin=!0):(this._draftMax=`${this.max}`,this._editingMax=!0),setTimeout(()=>{const i=this.shadowRoot?.querySelector(`#${t}-range-editor`);i?.focus(),i?.select()},80)};it=function(t,i){const e=i.target.value;t==="min"?this._draftMin=e:this._draftMax=e;const l=Number(e);!e||Number.isNaN(l)||(t==="min"?this.min=l:this.max=l)};et=function(t,i){if(i.key==="Enter"){s(this,a,q).call(this,t);return}i.key==="Escape"&&(i.preventDefault(),s(this,a,O).call(this,t))};q=function(t){const i=Number(t==="min"?this._draftMin:this._draftMax);Number.isNaN(i)||(t==="min"?this.min=i:this.max=i),s(this,a,O).call(this,t)};O=function(t){if(t==="min"){this._editingMin=!1,this._draftMin=`${this.min}`;return}this._editingMax=!1,this._draftMax=`${this.max}`};r.styles=[rt,mt,bt];n([d({attribute:"supporting-text"})],r.prototype,"supportingText",2);n([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],r.prototype,"showExtendedSupportingText",2);n([d({type:Boolean})],r.prototype,"plain",2);n([d({reflect:!0})],r.prototype,"size",2);n([d({type:Number,reflect:!0})],r.prototype,"min",2);n([d({type:Number,reflect:!0})],r.prototype,"max",2);n([d({type:Number})],r.prototype,"step",2);n([d({type:Boolean,reflect:!0,attribute:"show-ticks"})],r.prototype,"showTicks",2);n([d({type:Boolean,reflect:!0,attribute:"show-trail-input"})],r.prototype,"showTrailInput",2);n([d({type:Boolean,reflect:!0,attribute:"show-value-label"})],r.prototype,"showValueLabel",2);n([d({type:Boolean,reflect:!0})],r.prototype,"range",2);n([d({type:Number})],r.prototype,"value",1);n([d({type:Number,attribute:"end-value"})],r.prototype,"endValue",2);n([d({attribute:"lead-label"})],r.prototype,"leadLabel",2);n([d({attribute:"trail-label"})],r.prototype,"trailLabel",2);n([d({type:Boolean,attribute:"hide-bound-editors"})],r.prototype,"hideBoundEditors",2);n([Y("#slider-start")],r.prototype,"_startInput",2);n([Y("#slider-end")],r.prototype,"_endInput",2);n([v()],r.prototype,"_activeThumb",2);n([v()],r.prototype,"_focusedThumb",2);n([v()],r.prototype,"_editingMin",2);n([v()],r.prototype,"_editingMax",2);n([v()],r.prototype,"_draftMin",2);n([v()],r.prototype,"_draftMax",2);n([v()],r.prototype,"_trailDisplayValue",2);n([v()],r.prototype,"_trailInvalid",2);n([$("min"),$("max"),$("step"),$("range")],r.prototype,"_handleConstraintsUpdate",1);r=n([at()],r);let H=class extends nt(ot(lt(r))){};H=n([ht("gds-slider",{dependsOn:[ct,pt,gt]})],H);export{H as G};
