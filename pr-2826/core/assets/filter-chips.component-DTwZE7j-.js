import{i as b,n as p,z as O,T as k,a as C,h as w,g as S,F as z,w as F,f as E,S as G,y as P,a0 as V}from"./iframe-Ddc77rkg.js";import{r as W}from"./resize-observer-CfkbZofs.js";import{s as B}from"./attribute-converters-CdI0trPX.js";import{I as H}from"./checkmark.component-CVkhmHZx.js";const T=b`
...
`;var D=Object.defineProperty,M=Object.getOwnPropertyDescriptor,v=(e,t,s,i)=>{for(var l=i>1?void 0:i?M(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(l=(i?n(t,s,l):n(l))||l);return i&&l&&D(t,s,l),l};let h=class extends O{constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),k.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return w`<gds-button
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};h.styles=[T];v([p({reflect:!0,type:Boolean})],h.prototype,"selected",2);v([p()],h.prototype,"value",2);v([p({reflect:!0,type:String})],h.prototype,"size",2);h=v([S("gds-filter-chip",{dependsOn:[z,H]})],h);const R=b`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
