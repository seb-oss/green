import"./rich-text-Buy5auXa.js";import"./divider-DV88Tkka.js";import"./card-PQSgAoDd.js";import"./text-CdQJa47J.js";import{a as m}from"./argTableProps-DqXuebLo.js";import{h as e}from"./iframe-GGkrsogq.js";import"./rich-text.component-zgufF6pn.js";import"./default-typography.styles-v2gvzg-2.js";import"./card.component-CrSxGHA6.js";import"./text.component-CYMo-4LT.js";import"./preload-helper-PPVm8Dsz.js";const E={title:"Components/Rich Text",component:"gds-rich-text",tags:["autodocs"],argTypes:{...m("gds-rich-text")},parameters:{docs:{description:{component:`\`gds-rich-text\` can be used to wrap generic HTML content and apply typography styles.
...
It supports out of the box all heading styles, paragraphs, lists, blockquotes, figures, tables, and more.`}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},p={...t,name:"Card",render:i=>e`
  ...
  \`
}`,...a.parameters?.docs?.source},description:{story:"`gds-rich-text` can be used to wrap generic HTML content and apply typography styles.\nIt supports out of the box all heading styles from h1 to h6 based on the green design system typography styles.",...a.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Pairings',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:"`gds-rich-text` has built-in support for typography pairings.\nApply classes to the heading and preamble elements to create consistent typography pairings based on the green design typography system.",...n.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lists',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...o.parameters?.docs?.source},description:{story:"`gds-rich-text` has built-in support for ordered and unordered lists.\nIt applies consistent spacing and typography styles to list items.",...o.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Details',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...s.parameters?.docs?.source},description:{story:"`gds-rich-text` has built-in support for details html element.\n\nThe details element is a disclosure widget from HTML5 that can be used to hide or show additional content.",...s.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Blockquote',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...r.parameters?.docs?.source},description:{story:"`gds-rich-text` has built-in support blockquote element.",...r.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Formatting',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...l.parameters?.docs?.source},description:{story:"`gds-rich-text` has built-in support for inline formatting tags such as `s`, `mark`, `strong`,`small` and `em`.",...l.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Table',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...d.parameters?.docs?.source},description:{story:"`gds-rich-text` has built-in support for tables.",...d.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Theme',
  render: args => html\`
    <gds-card variant="neutral-02">
  ...
  \`
}`,...c.parameters?.docs?.source},description:{story:`Rich text can be used with other components to create engaging content.
...
\`\`\``,...c.parameters?.docs?.description}}};const T=["Card","Headings","Pairings","Lists","Details","Blockquote","Formatting","Table","Basic"];export{c as Basic,r as Blockquote,p as Card,s as Details,l as Formatting,a as Headings,o as Lists,n as Pairings,d as Table,T as __namedExportsOrder,E as default};
