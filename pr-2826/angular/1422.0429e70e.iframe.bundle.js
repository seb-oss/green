...
`;let d=class extends a.o{constructor(){super(...arguments),this.dividers=!1,(0,o.VK)(this,r,e=>{if(!this.dividers)return;const t=e.target.closest?.("[href]:not([selectable])");t?.parentElement===this&&t.previousElementSibling?.toggleAttribute("hide-prev-border","pointerover"===e.type)})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","list"),this.addEventListener("pointerover",(0,o.S7)(this,r)),this.addEventListener("pointerout",(0,o.S7)(this,r))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("pointerover",(0,o.S7)(this,r)),this.removeEventListener("pointerout",(0,o.S7)(this,r))}render(){return i.qy`<slot></slot>`}};r=new WeakMap,d.styles=[l.LU,c],(0,o.Cc)([(0,n.MZ)({type:Boolean,reflect:!0})],d.prototype,"dividers",2),d=(0,o.Cc)([(0,i.Y$)("gds-list")],d)},3095(e,t,s){"use strict";s.d(t,{F:()=>i}),s(745);var r=s(6506),o=s(7593),n=s(9633);const i=e=>{o.F.define();const t=(0,n.pI)("gds-alert"),s={...e,class:e.className,ref:e.ref};return(0,r.createElement)(t,s)};i.displayName="GdsAlert"},2022(e,t,s){"use strict";s.d(t,{o:()=>i}),s(745);var r=s(6506),o=s(8833),n=s(9633);const i=e=>{o.o.define();const t=(0,n.pI)("gds-div"),s={...e,class:e.className,ref:e.ref};return(0,r.createElement)(t,s)};i.displayName="GdsDiv"},1083(e,t,s){"use strict";s.r(t),s.d(t,{GdsAlert:()=>r.F,GdsAvatar:()=>x,GdsAvatarGroup:()=>Gh,GdsBackdrop:()=>Gr,GdsBadge:()=>Z,GdsBlur:()=>I,GdsBreadcrumb:()=>Uh,GdsBreadcrumbs:()=>B,GdsButton:()=>W,GdsCalendar:()=>K,GdsCard:()=>T,GdsCardLinked:()=>O,GdsCardPattern01:()=>ah,GdsCheckbox:()=>pe,GdsCheckboxGroup:()=>gp,GdsCoachmark:()=>Be,GdsContextMenu:()=>We,GdsDatepicker:()=>Ke,GdsDetails:()=>tt,GdsDialog:()=>Lt,GdsDiv:()=>xt.o,GdsDivider:()=>St,GdsDropdown:()=>It,GdsFab:()=>Gt,GdsFilterChip:()=>vp,GdsFilterChips:()=>qt,GdsFlex:()=>Bt,GdsFormSummary:()=>is,GdsFormattedAccount:()=>kp,GdsFormattedDate:()=>Vp,GdsFormattedNumber:()=>wp,GdsGrid:()=>cs,GdsGroupedList:()=>Cs,GdsIconDetails:()=>fp,GdsImg:()=>gs,GdsInput:()=>fr,GdsLink:()=>kr,GdsList:()=>yr,GdsListItem:()=>Lp,GdsListItemPattern01:()=>Ih,GdsMask:()=>Lr,GdsMenuButton:()=>Nr,GdsMenuHeading:()=>gw,GdsMenuItem:()=>hw,GdsOption:()=>mw,GdsPagination:()=>Io,GdsPopover:()=>qr,GdsRadio:()=>qo,GdsRadioGroup:()=>Up,GdsRichText:()=>Ao,GdsSegment:()=>Jp,GdsSegmentedControl:()=>rn,GdsSelect:()=>_n,GdsSensitiveAccount:()=>Xp,GdsSensitiveDate:()=>tu,GdsSensitiveNumber:()=>ru,GdsSignal:()=>xn,GdsSlider:()=>bi,GdsSpinner:()=>Li,GdsSwitch:()=>Pi,GdsTab:()=>dw,GdsTabPanel:()=>Cw,GdsTable:()=>qd,GdsTabs:()=>IC,GdsText:()=>Bd,GdsTextarea:()=>zd,GdsTheme:()=>NC.G,GdsVideo:()=>EC,IconAi:()=>nu,IconAirplaneUp:()=>lu,IconArchive:()=>cu,IconArrow:()=>ig,IconArrowBottomTop:()=>Cu,IconArrowBoxLeft:()=>gu,IconArrowBoxLeftAlt:()=>pu,IconArrowBoxRight:()=>mu,IconArrowDown:()=>Mu,IconArrowInbox:()=>ku,IconArrowLeft:()=>wu,IconArrowLeftRight:()=>yu,IconArrowOutOfBox:()=>xu,IconArrowRight:()=>Gu,IconArrowRightCircle:()=>Zu,IconArrowRightDownCircle:()=>$u,IconArrowRightUpCircle:()=>Nu,IconArrowRotateClockwise:()=>qu,IconArrowRotateCounterClockwise:()=>zu,IconArrowRotateLeftRight:()=>Au,IconArrowRotateRightLeft:()=>Yu,IconArrowShareLeft:()=>Ru,IconArrowShareRight:()=>Du,IconArrowSplit:()=>Fu,IconArrowUp:()=>Uu,IconArrowWallDown:()=>Qu,IconArrowWallLeft:()=>eg,IconArrowWallRight:()=>sg,IconArrowWallUp:()=>og,IconArrowsRepeatRight:()=>ag,IconAsterisk:()=>dg,IconAt:()=>hg,IconBack:()=>ug,IconBackward:()=>fg,IconBag:()=>vg,IconBank:()=>bg,IconBanknote:()=>_g,IconBanknote2:()=>Vg,IconBarcode:()=>Lg,IconBarsThree:()=>Hg,IconBarsTwo:()=>Sg,IconBasket:()=>Ig,IconBatteryLoading:()=>jg,IconBell:()=>Eg,IconBlock:()=>Bg,IconBook:()=>Wg,IconBookmark:()=>Ug,IconBookmarkCheck:()=>Kg,IconBookmarkDelete:()=>Tg,IconBookmarkPlus:()=>Pg,IconBookmarkRemove:()=>Og,IconBooks:()=>Qg,IconBrandAppStore:()=>ef,IconBrandAppleMusic:()=>sf,IconBrandBankid:()=>of,IconBrandChrome:()=>lf,IconBrandFacebook:()=>cf,IconBrandFigma:()=>Cf,IconBrandFirefox:()=>pf,IconBrandGithub:()=>gf,IconBrandGreen:()=>mf,IconBrandInstagram:()=>Mf,IconBrandLinkedin:()=>kf,IconBrandPlayStore:()=>yf,IconBrandRssFeed:()=>wf,IconBrandSeb:()=>xf,IconBrandSpotify:()=>Zf,IconBrandStorybook:()=>$f,IconBrandSwishWord:()=>Nf,IconBrandX:()=>Gf,IconBrush:()=>qf,IconBubbleAnnotation:()=>zf,IconBubbles:()=>Af,IconBuildings:()=>Yf,IconBulletList:()=>Rf,IconCalculator:()=>Df,IconCalendar:()=>Xf,IconCalendarCheck:()=>Ff,IconCalendarRepeat:()=>Jf,IconCalenderAdd:()=>tm,IconCall:()=>rm,IconCar:()=>nm,IconCarussel:()=>lm,IconChainLink:()=>dm,IconChainLinkBroken:()=>cm,IconChartTwo:()=>hm,IconChecklist:()=>um,IconCheckmark:()=>gm,IconChevronBottom:()=>fm,IconChevronDoubleDown:()=>vm,IconChevronDoubleLeft:()=>Mm,IconChevronDoubleRight:()=>bm,IconChevronDoubleUp:()=>Vm,IconChevronDownSmall:()=>_m,IconChevronGrabberVertical:()=>Lm,IconChevronGrabberVerticalReversed:()=>wm,IconChevronLeft:()=>Hm,IconChevronLeftSmall:()=>xm,IconChevronRight:()=>Sm,IconChevronRightSmall:()=>Zm,IconChevronTop:()=>Nm,IconChevronTopSmall:()=>Im,IconCircleBan:()=>Gm,IconCircleCheck:()=>qm,IconCircleDots:()=>zm,IconCircleInfo:()=>Am,IconCircleMinus:()=>Ym,IconCirclePlaceholderOn:()=>Rm,IconCirclePlus:()=>Dm,IconCircleQuestionmark:()=>Fm,IconCircleX:()=>Jm,IconCirclesThree:()=>Xm,IconClock:()=>tv,IconCloudDownload:()=>rv,IconCloudUpload:()=>nv,IconCloudySun:()=>lv,IconCode:()=>Cv,IconCodeBrackets:()=>cv,IconCompassRound:()=>pv,IconCookies:()=>gv,IconCopy:()=>fv,IconCreditCard:()=>bv,IconCreditCardAdd:()=>vv,IconCrossLarge:()=>kv,IconCrossSmall:()=>Vv,IconCupHot:()=>_v,IconCursor:()=>Lv,IconDevices:()=>Hv,IconDirection:()=>Sv,IconDollar:()=>Iv,IconDotGridOneHorizontal:()=>Nv,IconDotGridOneVertical:()=>Gv,IconDotGridThree:()=>qv,IconDotGridTwo:()=>zv,IconEmail:()=>Av,IconEmojiAngry:()=>Yv,IconEmojiNeutral:()=>Rv,IconEmojiSad:()=>Dv,IconEmojiSmile:()=>Fv,IconEmojiSmiley:()=>Jv,IconEuro:()=>Xv,IconExpand:()=>tM,IconEyeOpen:()=>rM,IconEyeSlash:()=>nM,IconFashion:()=>lM,IconFastForward:()=>cM,IconFileBend:()=>CM,IconFileChart:()=>pM,IconFileText:()=>gM,IconFiles:()=>mM,IconFilter:()=>MM,IconFlag:()=>kM,IconFloppyDisk:()=>yM,IconFocus:()=>wM,IconFolder:()=>ZM,IconFolderAddRight:()=>xM,IconFullscreen:()=>$M,IconGift:()=>NM,IconGlobus:()=>GM,IconGraduateCap:()=>qM,IconGreenPower:()=>zM,IconGroup:()=>AM,IconGrowth:()=>YM,IconHeadphones:()=>RM,IconHeart:()=>FM,IconHeartBeat:()=>DM,IconHistory:()=>JM,IconHomeEnergyOne:()=>XM,IconHomeEnergyTwo:()=>tb,IconHomeOpen:()=>rb,IconHomeRoof:()=>nb,IconHorizontalAlignmentBottom:()=>lb,IconHourglass:()=>cb,IconImages:()=>Cb,IconInboxEmpty:()=>pb,IconIndustry:()=>gb,IconJpg:()=>mb,IconKey:()=>Mb,IconKnifeSpoon:()=>kb,IconLab:()=>yb,IconLaw:()=>wb,IconLeisure:()=>xb,IconLightBulbSimple:()=>Zb,IconLightning:()=>$b,IconLineChartFour:()=>Nb,IconLineChartOne:()=>Gb,IconLineChartThree:()=>qb,IconLineChartTwo:()=>zb,IconLock:()=>Ab,IconMacbookAir:()=>Yb,IconMagnifyingGlass:()=>Tb,IconMapPin:()=>Pb,IconMegaphone:()=>Ob,IconMenuSidebar:()=>Ub,IconMicOff:()=>Qb,IconMicOn:()=>ek,IconMinimize:()=>sk,IconMinusLarge:()=>ok,IconMinusSmall:()=>nk,IconMoneyHand:()=>lk,IconMoneybag:()=>ck,IconMoon:()=>Ck,IconMute:()=>pk,IconNewspaper:()=>gk,IconOffice:()=>mk,IconPageAdd:()=>Mk,IconPaperPlaneTopRight:()=>kk,IconPaperclip:()=>yk,IconPause:()=>wk,IconPdf:()=>xk,IconPencilSign:()=>Zk,IconPencilSparkle:()=>$k,IconPencilWave:()=>Nk,IconPension:()=>Gk,IconPeople:()=>Uk,IconPeopleA11y:()=>qk,IconPeopleAdd:()=>zk,IconPeopleAdded:()=>Ak,IconPeopleCircle:()=>Yk,IconPeopleCopy:()=>Rk,IconPeopleProfile:()=>Pk,IconPeopleRemove:()=>Ok,IconPercent:()=>Qk,IconPhone:()=>eV,IconPieChart:()=>sV,IconPiggyBank:()=>oV,IconPin:()=>iV,IconPinch:()=>aV,IconPlay:()=>hV,IconPlayCircle:()=>dV,IconPlusLarge:()=>uV,IconPlusSmall:()=>fV,IconPng:()=>vV,IconPoop:()=>bV,IconPostcard:()=>VV,IconPound:()=>_V,IconPower:()=>HV,IconPowerPlant:()=>LV,IconPrinter:()=>SV,IconPush:()=>IV,IconQrCode:()=>jV,IconRainy:()=>EV,IconRaisingHand:()=>BV,IconReadingList:()=>WV,IconReceiptBill:()=>KV,IconReceiptionBell:()=>TV,IconRecord:()=>PV,IconRefund:()=>OV,IconRobot:()=>UV,IconRocket:()=>QV,IconRunShortcut:()=>ey,IconSafari:()=>sy,IconSchool:()=>oy,IconScissors:()=>iy,IconSearchMenu:()=>ay,IconSettingsGear:()=>dy,IconSettingsSliderHor:()=>hy,IconSettingsSliderVer:()=>uy,IconShapes:()=>fy,IconShare:()=>vy,IconShield:()=>_y,IconShieldChecked:()=>by,IconShieldCrossed:()=>Vy,IconShoppingBag:()=>Ly,IconSignature:()=>Hy,IconSmartwatch:()=>Sy,IconSolar:()=>Iy,IconSort:()=>zy,IconSortAscending:()=>jy,IconSortDescending:()=>Ey,IconSortDown:()=>qy,IconSortUp:()=>By,IconSquareArrowTopRight:()=>Ay,IconSquareBehindSquare:()=>Yy,IconSquareGridCircle:()=>Ry,IconSquarePlaceholder:()=>Dy,IconStar:()=>Fy,IconStore:()=>Jy,IconSun:()=>Xy,IconSunsetArrowDown:()=>t_,IconTag:()=>r_,IconTargetArrow:()=>n_,IconTelevision:()=>l_,IconTennis:()=>c_,IconTextEdit:()=>C_,IconThermostat:()=>p_,IconThumbsDown:()=>g_,IconThumbsUp:()=>m_,IconTicket:()=>M_,IconTradingViewCandles:()=>k_,IconTrashCan:()=>y_,IconTree:()=>w_,IconTrendingFive:()=>x_,IconTrendingFour:()=>Z_,IconTrendingOne:()=>$_,IconTrendingThree:()=>N_,IconTrendingTwo:()=>G_,IconTriangleExclamation:()=>q_,IconTruck:()=>z_,IconUmbrellaSecurity:()=>A_,IconUnlocked:()=>Y_,IconVolumeFull:()=>R_,IconVolumeHalf:()=>D_,IconVolumeOff:()=>F_,IconWallet:()=>J_,IconWarningSign:()=>X_,IconWifiFull:()=>tw,IconYoutube:()=>rw,IconZap:()=>nw,IconZoomIn:()=>lw,IconZoomOut:()=>cw});var r=s(3095),o=s(745),n=s(6506),i=s(4367),l=s(3578),a=s(4652),c=s(3539),d=s(7526),C=s(5073),h=s(9399),p=s(4508),u=s(4987),g=s(3832);let f=class extends g.M{};f._regularSVG='<path d="M15.75 6.5C15.75 8.57107 14.0711 10.25 12 10.25C9.92893 10.25 8.25 8.57107 8.25 6.5C8.25 4.42893 9.92893 2.75 12 2.75C14.0711 2.75 15.75 4.42893 15.75 6.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 13.25C7.8098 13.25 4.86894 16.3254 4.5 20.25H19.5C19.1311 16.3254 16.1902 13.25 12 13.25Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>',f._solidSVG='<path d="M12 2C9.51472 2 7.5 4.01472 7.5 6.5C7.5 8.98528 9.51472 11 12 11C14.4853 11 16.5 8.98528 16.5 6.5C16.5 4.01472 14.4853 2 12 2Z" fill="currentColor"/><path d="M12 12.5C7.38412 12.5 4.15473 15.9097 3.7533 20.1798C3.73354 20.39 3.80328 20.5988 3.94541 20.7549C4.08754 20.911 4.28888 21 4.5 21H19.5C19.7111 21 19.9125 20.911 20.0546 20.7549C20.1967 20.5988 20.2665 20.39 20.2467 20.1798C19.8453 15.9097 16.6159 12.5 12 12.5Z" fill="currentColor"/>',f._name="people-profile",f._width=24,f._height=24,f._viewBox="0 0 24 24",f=(0,o.Cc)([(0,d.Y$)("gds-icon-people-profile")],f);var m,v,M,b,k,V,y=s(9443),_=y.AH`
...
`;var Dr,Or,Fr,Ur,Jr,Qr,Xr,eo,to,so,ro,oo,no,io,lo,ao,co,Co,ho,po,uo,go,fo,mo,vo,Mo,bo,ko,Vo,yo,_o,wo,Lo,xo,Ho,Zo;const So={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let $o=class extends((0,u.TM)((0,u.Q8)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,Dr),(0,o.VK)(this,Fr),(0,o.VK)(this,Jr),(0,o.VK)(this,Xr),(0,o.VK)(this,to),(0,o.VK)(this,ro),(0,o.VK)(this,no),(0,o.VK)(this,lo),(0,o.VK)(this,co),(0,o.VK)(this,ho),(0,o.VK)(this,uo),(0,o.VK)(this,fo),(0,o.VK)(this,vo),(0,o.VK)(this,bo),(0,o.VK)(this,Vo),(0,o.VK)(this,_o),(0,o.VK)(this,Lo),(0,o.VK)(this,Ho),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.simple=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(e){this._isMobile=e}render(){const e=(0,o.S7)(this,Dr,Or)>1,t=(0,o.jq)(this,vo,Mo).call(this);return e||t?d.qy`
      <nav aria-label="${this.label||(0,N.ab)("Pagination")}">
        <gds-flex
          align-items="center"
          justify-content="space-between"
          width="100%"
          gap="${(0,o.S7)(this,Fr,Ur).gap}"
        >
          ${(0,o.jq)(this,bo,ko).call(this)}
          <gds-flex
            aling-items="center"
            gap="${(0,o.S7)(this,Fr,Ur).gap}"
            flex="1"
          ...
          >
            ${[(0,F.z)(e,()=>this.simple?(0,o.jq)(this,uo,go).call(this):(0,o.jq)(this,ho,po).call(this)),t]}
          </gds-flex>
        </gds-flex>
      </nav>
    `:y.s6}};Dr=new WeakSet,Or=function(){return Math.ceil(this.total/this.rows)},Fr=new WeakSet,Ur=function(){return So[this.density]},Jr=new WeakSet,Qr=function(e){if(e<=7)return Array.from({length:e},(e,t)=>t+1);const t=e,s=[];return s.push(1),this.page<=4?s.push(2,3,4,5,"...",t):this.page>=e-3?s.push("...",e-4,e-3,e-2,e-1,t):s.push("...",this.page-1,this.page,this.page+1,"...",t),s},Xr=new WeakSet,eo=function(e){if("..."===e)return d.qy`
        <gds-popover
          disableMobileStyles
          @gds-ui-state=${(0,o.jq)(this,Lo,xo)}
        >
          <gds-button
            size="${(0,o.S7)(this,Fr,Ur).button}"
            rank="tertiary"
            slot="trigger"
          ...
          <gds-flex
            flex-direction="column"
            padding="${(0,o.S7)(this,Fr,Ur).inputPadding}"
            width="${(0,o.S7)(this,Fr,Ur).inputWidth}"
            max-height="280px"
          >
            <gds-input
              size="${(0,o.S7)(this,Fr,Ur).input}"
              label="${(0,N.ab)("Go to page")}"
              type="number"
              min="1"
              max="${(0,o.S7)(this,Dr,Or)}"
              @change=${(0,o.jq)(this,Ho,Zo)}
            >
              <gds-button
                size="xs"
                label="${(0,N.ab)("Go")}"
                rank="secondary"
                @click=${(0,o.jq)(this,Ho,Zo)}
                slot="trail"
              >
      ...
      <gds-button
        ...
        @click=${()=>(0,o.jq)(this,Vo,yo).call(this,t)}
      >
        ${t}
      </gds-button>
    `},to=new WeakSet,so=function(){const e=(0,o.S7)(this,Dr,Or),t=(0,o.jq)(this,Jr,Qr).call(this,e);return d.qy`${t.map(e=>(0,o.jq)(this,Xr,eo).call(this,e))}`},ro=new WeakSet,oo=function(){return d.qy`
      <gds-button
        size="${(0,o.S7)(this,Fr,Ur).button}"
        rank="secondary"
        label="${(0,N.ab)("Go to first page")}"
        ?disabled=${1===this.page}
        @click=${()=>(0,o.jq)(this,Vo,yo).call(this,1)}
      >
    ...
    `},no=new WeakSet,io=function(){return d.qy`
      <gds-button
        ...
        ?disabled=${1===this.page}
        @click=${()=>(0,o.jq)(this,Vo,yo).call(this,this.page-1)}
      >
        <gds-icon-chevron-left-small size="l"></gds-icon-chevron-left-small>
      </gds-button>
    `},lo=new WeakSet,ao=function(){const e=(0,o.S7)(this,Dr,Or);return d.qy`
      <gds-button
        size="${(0,o.S7)(this,Fr,Ur).button}"
        rank="secondary"
    ...
    `},co=new WeakSet,Co=function(){const e=(0,o.S7)(this,Dr,Or);return d.qy`
      <gds-button
        size="${(0,o.S7)(this,Fr,Ur).button}"
        rank="secondary"
        label="${(0,N.ab)("Go to last page")}"
        ?disabled=${this.page===e}
        @click=${()=>(0,o.jq)(this,Vo,yo).call(this,e)}
      >
        <gds-icon-chevron-double-right size="l"></gds-icon-chevron-double-right>
      </gds-button>
    `},ho=new WeakSet,po=function(){return d.qy`
      <gds-flex
        gap="${(0,o.S7)(this,Fr,Ur).navGap}"
        align-items="center"
        class="navigation-controls"
        justify-content="center; m{flex-end}"
        flex="1"
      >
        ${[(0,F.z)(this.jump,()=>(0,o.jq)(this,ro,oo).call(this)),(0,o.jq)(this,no,io).call(this)]}
        <gds-flex gap="4xs" align-items="center">
          ${(0,o.jq)(this,to,so).call(this)}
        </gds-flex>
        ${[(0,o.jq)(this,lo,ao).call(this),(0,F.z)(this.jump,()=>(0,o.jq)(this,co,Co).call(this))]}
      </gds-flex>
    `},uo=new WeakSet,go=function(){return d.qy`
      <gds-flex
        gap="${(0,o.S7)(this,Fr,Ur).navGap}"
        align-items="center"
        ...
        flex="1"
      >
        ${(0,o.jq)(this,no,io).call(this)}
        <gds-text
          font="${(0,o.S7)(this,Fr,Ur).font}"
          color="neutral-01"
          aria-live="polite"
          aria-atomic="true"
        >
        ...
        ${(0,o.jq)(this,lo,ao).call(this)}
      </gds-flex>
    `},fo=new WeakSet,mo=function(e){const t=this.rows===e;return d.qy`
      <gds-menu-item
        data-value=${e}
    ...
    `},vo=new WeakSet,Mo=function(){if(this._isMobile||this.hideOptions||this.options.length<=1)return null;const e=`${(0,N.ab)("Rows per page")}, ${this.rows} ${(0,N.ab)("selected")}`;return d.qy`
      <gds-flex align-items="center" gap="s">
        ...
        <gds-context-menu @gds-menu-item-click=${(0,o.jq)(this,_o,wo)}>
          <gds-button
            slot="trigger"
            size="${(0,o.S7)(this,Fr,Ur).button}"
            rank="secondary"
          ...
          ${this.options.map(e=>(0,o.jq)(this,fo,mo).call(this,e))}
        </gds-context-menu>
      </gds-flex>
    `},bo=new WeakSet,ko=function(){return this._isMobile||!this.label?null:d.qy`
      <gds-text
        font="${(0,o.S7)(this,Fr,Ur).font}"
        color="neutral-02"
        aria-live="polite"
    ...
    `},Vo=new WeakSet,yo=function(e){this.dispatchCustomEvent("gds-page-change",{detail:{page:e},bubbles:!0})},_o=new WeakSet,wo=function(e){const t=e.target,s=parseInt(t.dataset.value||"10");s!==this.rows&&this.dispatchCustomEvent("gds-rows-change",{detail:{rows:s},bubbles:!0})},Lo=new WeakSet,xo=function(e){if(this._jumpPopoverOpen=e.detail.open,e.detail.open){const t=e.target.querySelector('[gds-element="gds-input"]');t&&requestAnimationFrame(()=>{t.focus()})}},Ho=new WeakSet,Zo=function(e){const t=e.target.closest('[gds-element="gds-input"]');if(t){const e=parseInt(t.value,10);if(e&&e>=1&&e<=(0,o.S7)(this,Dr,Or)){(0,o.jq)(this,Vo,yo).call(this,e);const s=t.closest('[gds-element="gds-popover"]');s&&(s.open=!1)}}},$o.styles=[C.LU,Pr],(0,o.Cc)([(0,i.MZ)({type:Number})],$o.prototype,"page",2),(0,o.Cc)([(0,i.MZ)({type:Number})],$o.prototype,"rows",2),(0,o.Cc)([(0,i.MZ)({type:Number})],$o.prototype,"total",2),(0,o.Cc)([(0,i.MZ)({type:Array})],$o.prototype,"options",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],$o.prototype,"jump",2),(0,o.Cc)([(0,i.MZ)({attribute:"hide-options",type:Boolean,reflect:!1})],$o.prototype,"hideOptions",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],$o.prototype,"simple",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],$o.prototype,"density",2),(0,o.Cc)([(0,i.MZ)()],$o.prototype,"label",2),(0,o.Cc)([(0,i.P)("#page-input")],$o.prototype,"_elInput",2),(0,o.Cc)([(0,i.wk)()],$o.prototype,"_isMobile",2),(0,o.Cc)([(0,i.wk)()],$o.prototype,"_jumpPopoverOpen",2),(0,o.Cc)([(0,Br.M)("(max-width: 768px)")],$o.prototype,"_handleMobile",1),$o=(0,o.Cc)([(0,N.cc)(),(0,d.Y$)("gds-pagination",{dependsOn:[z.t,Er.E,Rt,gr,$t.E,ze.Hx,zr.T,Wr.o,Yr,Ar,Rr.V,Tr,Kr]}),(0,j.J)({labelledBy:"nav",describedBy:"nav"})],$o);const Io=e=>{$o.define();const t=(0,L.pI)("gds-pagination"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Io.displayName="GdsPagination";var No,jo,Go=y.AH`
  :host {
    cursor: pointer;
  }
...
`;let Vn=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,nn),(0,o.VK)(this,cn),(0,o.VK)(this,Cn),(0,o.VK)(this,pn),(0,o.VK)(this,gn),(0,o.VK)(this,mn),(0,o.VK)(this,Mn),this.supportingText="",this.showExtendedSupportingText=!1,this.size="large",this.plain=!1,(0,o.VK)(this,on,!1),(0,o.VK)(this,an,e=>{e.stopPropagation(),(0,o.jq)(this,cn,dn).call(this),requestAnimationFrame(()=>{this.dispatchCustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0}),this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})})})}get value(){return this._internalValue}set value(e){(0,o.S7)(this,on)||(0,o.OV)(this,on,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){return this.selectElement?.multiple??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}focus(e){this._getValidityAnchor()?.focus(e)}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),d.qy`
    ...
    `}_captureDOM(){if(!this.shadowRoot||0===this.childNodes.length||!this._elSelectContainer)return;const e=Array.from(this.children).filter(e=>"SELECT"===e.nodeName).map(e=>{const t=e.cloneNode(!0);return t.addEventListener("change",(0,o.S7)(this,an)),t.addEventListener("input",(0,o.S7)(this,an)),t.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),t.ariaLabel=this.label,t.setAttribute("id","select"),t.disabled=this.disabled,t.className="native-control",(0,o.S7)(this,on)?t.value=this.value:this._internalValue=t.value,t});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};on=new WeakMap,nn=new WeakSet,ln=function(){return!this.plain&&this.invalid},an=new WeakMap,cn=new WeakSet,dn=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(e=>e.value)}else this.value=this.selectElement.value},Cn=new WeakSet,hn=function(){return[(0,o.jq)(this,pn,un).call(this),(0,o.jq)(this,mn,vn).call(this),(0,o.jq)(this,gn,fn).call(this),(0,o.jq)(this,Mn,bn).call(this)].map(e=>d.qy`${e}`)},pn=new WeakSet,un=function(){return d.qy`<slot name="lead" slot="lead"></slot>`},gn=new WeakSet,fn=function(){if(!this.multiple)return d.qy`<label id="placeholder" class="native-control"
      ...
      `},Vn.styles=[C.LU,zs.A,kn],(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],Vn.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],Vn.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:String})],Vn.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],Vn.prototype,"plain",2),(0,o.Cc)([(0,i.P)("select")],Vn.prototype,"selectElement",2),(0,o.Cc)([(0,i.MZ)()],Vn.prototype,"value",1),(0,o.Cc)([(0,i.P)(".select-container")],Vn.prototype,"_elSelectContainer",2),(0,o.Cc)([(0,Bo.L)({childList:!0,subtree:!0,attributes:!0,characterData:!0})],Vn.prototype,"_captureDOM",1),(0,o.Cc)([(0,ee.w)("value")],Vn.prototype,"_handleValueChange",1),Vn=(0,o.Cc)([(0,j.J)({labelledBy:"select",describedBy:"select",errorMessage:"select"}),(0,N.cc)()],Vn);let yn=class extends((0,u.lt)((0,u.Q8)((0,u.TM)(Vn)))){};yn=(0,o.Cc)([(0,d.Y$)("gds-select",{dependsOn:[Bs.$,qs.V,Es.w,Wr.o]})],yn);const _n=e=>{yn.define();const t=(0,L.pI)("gds-select"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};_n.displayName="GdsSelect";var wn=y.AH`
  :host {
    display: inline-block;
  }
...
`;let vi=class extends te.S{constructor(){super(),(0,o.VK)(this,Hn),(0,o.VK)(this,Sn),(0,o.VK)(this,In),(0,o.VK)(this,jn),(0,o.VK)(this,En),(0,o.VK)(this,Bn),(0,o.VK)(this,Wn),(0,o.VK)(this,Kn),(0,o.VK)(this,Tn),(0,o.VK)(this,Pn),(0,o.VK)(this,ni),(0,o.VK)(this,li),(0,o.VK)(this,ci),(0,o.VK)(this,Ci),(0,o.VK)(this,pi),(0,o.VK)(this,gi),this.supportingText="",this.showExtendedSupportingText=!1,this.plain=!1,this.size="large",this.min=0,this.max=100,this.step=1,this.showTicks=!1,this.ticksPosition="bottom",this.showValueLabel=!0,this.range=!1,this.endValue=100,this.minLabel="L",this.maxLabel="R",this._activeThumb=null,this._focusedThumb=null,this._editingMin=!1,this._editingMax=!1,this._draftMin="0",this._draftMax="100",(0,o.VK)(this,On,e=>{const t=e.target.valueAsNumber;this.value=t,this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),(0,o.VK)(this,Fn,e=>{const t=e.target.valueAsNumber;this.value=t,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),(0,o.VK)(this,Un,e=>{const t=(0,o.jq)(this,Sn,$n).call(this,e.target.valueAsNumber);this.endValue=Math.max(this.value,t),(0,o.jq)(this,Kn,Yn).call(this),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),(0,o.VK)(this,Jn,e=>{const t=(0,o.jq)(this,Sn,$n).call(this,e.target.valueAsNumber);this.endValue=Math.max(this.value,t),(0,o.jq)(this,Kn,Yn).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),(0,o.VK)(this,Qn,()=>{this._activeThumb="start"}),(0,o.VK)(this,Xn,()=>{this._activeThumb="end"}),(0,o.VK)(this,ei,()=>{this._activeThumb=null}),(0,o.VK)(this,ti,()=>{this._focusedThumb="start"}),(0,o.VK)(this,si,()=>{this._focusedThumb="end"}),(0,o.VK)(this,ri,()=>{(0,o.S7)(this,ei).call(this),"start"===this._focusedThumb&&(this._focusedThumb=null)}),(0,o.VK)(this,oi,()=>{(0,o.S7)(this,ei).call(this),"end"===this._focusedThumb&&(this._focusedThumb=null)}),this._internalValue=this.min,this.endValue=this.max,this._draftMin=`${this.min}`,this._draftMax=`${this.max}`}get value(){return this._internalValue??this.min}set value(e){const t=(0,o.jq)(this,Sn,$n).call(this,e);this._internalValue=this.range?Math.min(t,this.endValue):t,(0,o.jq)(this,Kn,Yn).call(this)}connectedCallback(){super.connectedCallback(),(0,o.jq)(this,Hn,Zn).call(this),window.addEventListener("pointerup",(0,o.S7)(this,ei))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",(0,o.S7)(this,ei))}focus(e){this._getValidityAnchor()?.focus(e)}render(){const e=`--_range-start: ${(0,o.jq)(this,En,qn).call(this)}%; --_range-end: ${(0,o.jq)(this,Bn,zn).call(this)}%; --_value-start-ratio: ${(0,o.jq)(this,jn,Gn).call(this,this.value)}; --_value-end-ratio: ${(0,o.jq)(this,jn,Gn).call(this,this.endValue)}; --_tick-interval: ${(0,o.jq)(this,Wn,An).call(this)}%;`;return d.qy`
      ${(0,F.z)(!this.plain,()=>d.qy`<gds-form-control-header
            class="size-${this.size}"
            .showExtendedSupportingText=${this.showExtendedSupportingText}
          >
      ...
      <div id="control-row">
        <div id="range-min" aria-label="Minimum range limit">
          ${(0,o.jq)(this,ni,ii).call(this,"min")}
        ...
        <div id="control" style=${e}>
          ...
          <input
            ...
            aria-invalid=${this.invalid}
            aria-errormessage="message"
            aria-label=${(0,a.J)((0,o.jq)(this,Tn,Rn).call(this))}
            ?disabled=${this.disabled}
            ?required=${this.required}
            @pointerdown=${(0,o.S7)(this,Qn)}
            @pointerup=${(0,o.S7)(this,ei)}
            @pointercancel=${(0,o.S7)(this,ei)}
            @focus=${(0,o.S7)(this,ti)}
            @blur=${(0,o.S7)(this,ri)}
            @input=${(0,o.S7)(this,On)}
            @change=${(0,o.S7)(this,Fn)}
          />
          ...
          ${(0,F.z)(this.range,()=>d.qy`<input
                ...
                ?disabled=${this.disabled}
                ?required=${this.required}
                @pointerdown=${(0,o.S7)(this,Xn)}
                @pointerup=${(0,o.S7)(this,ei)}
                @pointercancel=${(0,o.S7)(this,ei)}
                @focus=${(0,o.S7)(this,si)}
                @blur=${(0,o.S7)(this,oi)}
        ...
        <div id="range-max" aria-label="Maximum range limit">
          <span class="range-side-label" aria-hidden="true"
            >${this.maxLabel}</span
          >
          ${(0,o.jq)(this,ni,ii).call(this,"max")}
        </div>
      </div>
      ...
      ${(0,F.z)(!this.plain,()=>d.qy`<gds-form-control-footer
            ...
            .errorMessage=${this.invalid?this.errorMessage:void 0}
          ></gds-form-control-footer>`)}
    `}_handleConstraintsUpdate(){(0,o.jq)(this,Hn,Zn).call(this)}_getValidityAnchor(){return this._startInput}_isThumbVisible(e){return this._activeThumb===e||this._focusedThumb===e}};Hn=new WeakSet,Zn=function(){if(this.max<this.min){const e=this.min;this.min=this.max,this.max=e}this._internalValue=(0,o.jq)(this,Sn,$n).call(this,this.value),this.endValue=(0,o.jq)(this,Sn,$n).call(this,this.endValue),this.range&&this._internalValue>this.endValue&&(this._internalValue=this.endValue),(0,o.jq)(this,Kn,Yn).call(this)},Sn=new WeakSet,$n=function(e){const t=this.step>0?this.step:1,s=this.min+Math.round((e-this.min)/t)*t;return Math.max(this.min,Math.min(this.max,s))},In=new WeakSet,Nn=function(e){return this.max===this.min?0:(e-this.min)/(this.max-this.min)*100},jn=new WeakSet,Gn=function(e){return this.max===this.min?0:(e-this.min)/(this.max-this.min)},En=new WeakSet,qn=function(){return this.range?(0,o.jq)(this,In,Nn).call(this,this.value):(0,o.jq)(this,In,Nn).call(this,this.min)},Bn=new WeakSet,zn=function(){return(0,o.jq)(this,In,Nn).call(this,this.range?this.endValue:this.value)},Wn=new WeakSet,An=function(){const e=this.max-this.min,t=this.step>0?this.step:1;return e<=0?100:Math.max(t/e*100,1)},Kn=new WeakSet,Yn=function(){this.range?this._setFormValue(`${this.value},${this.endValue}`):this._setFormValue(`${this.value}`)},Tn=new WeakSet,Rn=function(){return this.range?`${this.label} start`:this.plain?this.label:void 0},Pn=new WeakSet,Dn=function(){return this.label?`${this.label} end`:void 0},On=new WeakMap,Fn=new WeakMap,Un=new WeakMap,Jn=new WeakMap,Qn=new WeakMap,Xn=new WeakMap,ei=new WeakMap,ti=new WeakMap,si=new WeakMap,ri=new WeakMap,oi=new WeakMap,ni=new WeakSet,ii=function(e){const t="min"===e?this._editingMin:this._editingMax,s="min"===e?this._draftMin:this._draftMax,r="min"===e?this.min:this.max,n="min"===e?"Min":"Max";return d.qy`
      <span class="bound-editor ${t?"editing":""}">
        <button
          ...
          tabindex=${t?"-1":"0"}
          ?disabled=${this.disabled}
          @click=${()=>(0,o.jq)(this,li,ai).call(this,e)}
        >
          ${r}
        </button>
        <input
          ...
          tabindex=${t?"0":"-1"}
          ?disabled=${this.disabled}
          @input=${t=>(0,o.jq)(this,ci,di).call(this,e,t)}
          @blur=${()=>(0,o.jq)(this,pi,ui).call(this,e)}
          @keydown=${t=>(0,o.jq)(this,Ci,hi).call(this,e,t)}
        />
      </span>
    `},li=new WeakSet,ai=function(e){"min"===e?(this._draftMin=`${this.min}`,this._editingMin=!0):(this._draftMax=`${this.max}`,this._editingMax=!0),setTimeout(()=>{const t=this.shadowRoot?.querySelector(`#${e}-range-editor`);t?.focus(),t?.select()},80)},ci=new WeakSet,di=function(e,t){const s=t.target.value;"min"===e?this._draftMin=s:this._draftMax=s;const r=Number(s);s&&!Number.isNaN(r)&&("min"===e?this.min=r:this.max=r)},Ci=new WeakSet,hi=function(e,t){"Enter"!==t.key?"Escape"===t.key&&(t.preventDefault(),(0,o.jq)(this,gi,fi).call(this,e)):(0,o.jq)(this,pi,ui).call(this,e)},pi=new WeakSet,ui=function(e){const t=Number("min"===e?this._draftMin:this._draftMax);Number.isNaN(t)||("min"===e?this.min=t:this.max=t),(0,o.jq)(this,gi,fi).call(this,e)},gi=new WeakSet,fi=function(e){if("min"===e)return this._editingMin=!1,void(this._draftMin=`${this.min}`);this._editingMax=!1,this._draftMax=`${this.max}`},vi.styles=[C.LU,zs.A,mi],(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],vi.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],vi.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],vi.prototype,"plain",2),(0,o.Cc)([(0,i.MZ)({reflect:!0})],vi.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({type:Number})],vi.prototype,"min",2),(0,o.Cc)([(0,i.MZ)({type:Number})],vi.prototype,"max",2),(0,o.Cc)([(0,i.MZ)({type:Number})],vi.prototype,"step",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0,attribute:"show-ticks"})],vi.prototype,"showTicks",2),(0,o.Cc)([(0,i.MZ)({reflect:!0,attribute:"ticks-position"})],vi.prototype,"ticksPosition",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0,attribute:"show-value-label"})],vi.prototype,"showValueLabel",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],vi.prototype,"range",2),(0,o.Cc)([(0,i.MZ)({type:Number})],vi.prototype,"value",1),(0,o.Cc)([(0,i.MZ)({type:Number,attribute:"end-value"})],vi.prototype,"endValue",2),(0,o.Cc)([(0,i.MZ)({attribute:"min-label"})],vi.prototype,"minLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"max-label"})],vi.prototype,"maxLabel",2),(0,o.Cc)([(0,i.P)("#slider-start")],vi.prototype,"_startInput",2),(0,o.Cc)([(0,i.wk)()],vi.prototype,"_activeThumb",2),(0,o.Cc)([(0,i.wk)()],vi.prototype,"_focusedThumb",2),(0,o.Cc)([(0,i.wk)()],vi.prototype,"_editingMin",2),(0,o.Cc)([(0,i.wk)()],vi.prototype,"_editingMax",2),(0,o.Cc)([(0,i.wk)()],vi.prototype,"_draftMin",2),(0,o.Cc)([(0,i.wk)()],vi.prototype,"_draftMax",2),(0,o.Cc)([(0,ee.w)("min"),(0,ee.w)("max"),(0,ee.w)("step"),(0,ee.w)("range")],vi.prototype,"_handleConstraintsUpdate",1),vi=(0,o.Cc)([(0,N.cc)()],vi);let Mi=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(vi)))){};Mi=(0,o.Cc)([(0,d.Y$)("gds-slider",{dependsOn:[Bs.$,qs.V]})],Mi);const bi=e=>{Mi.define();const t=(0,L.pI)("gds-slider"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};bi.displayName="GdsSlider";var ki,Vi,yi,_i=y.AH`
...
`;let wi=class extends((0,u.TM)((0,u.qC)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,Vi),(0,o.VK)(this,ki,y.AH`
    html {
      overflow: hidden !important;
  ...
  `),this.label=(0,N.ab)("Loading..."),this.labelPosition="bottom",this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="md",this._isAnimating=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchCustomEvent("gds-spinner-connected")}disconnectedCallback(){super.disconnectedCallback(),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1}_updateAriaLabel(){this.setAttribute("aria-label",this.label)}render(){return d.qy`
      <div part="wrapper" class=${(0,l.H)((0,o.jq)(this,Vi,yi).call(this))}>
        <span part="spinner" class="spinner"></span>
        ${(0,F.z)(this.showLabel,()=>d.qy`<span part="label" class="spinner-label">${this.label}</span>`)}
      </div>
    `}_toggleRootStyles(){const e=lt.J.instance,t=`gds-spinner-fullscreen-${this.id||"default"}`;this.fullscreen?e.injectGlobalStyles(t,(0,o.S7)(this,ki)):e.clearGlobalStyles(t)}};ki=new WeakMap,Vi=new WeakSet,yi=function(){return{"spinner-wrapper":!0,"spinner-fullscreen":this.fullscreen,"spinner-cover":this.cover,"spinner-backdrop":this.cover||this.fullscreen,"spinner-animating":this._isAnimating,[`spinner-label-${this.labelPosition}`]:this.labelPosition}},wi.styles=[C.LU,_i],(0,o.Cc)([(0,i.MZ)({type:String})],wi.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:String,reflect:!0,attribute:"label-position"})],wi.prototype,"labelPosition",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],wi.prototype,"showLabel",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],wi.prototype,"cover",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],wi.prototype,"fullscreen",2),(0,o.Cc)([(0,i.MZ)({type:String,reflect:!0})],wi.prototype,"size",2),(0,o.Cc)([(0,i.wk)()],wi.prototype,"_isAnimating",2),(0,o.Cc)([(0,ee.w)("label")],wi.prototype,"_updateAriaLabel",1),(0,o.Cc)([(0,ee.w)("fullscreen")],wi.prototype,"_toggleRootStyles",1),wi=(0,o.Cc)([(0,d.Y$)("gds-spinner"),(0,N.cc)()],wi);const Li=e=>{wi.define();const t=(0,L.pI)("gds-spinner"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Li.displayName="GdsSpinner";const xi=y.AH`
  @media (prefers-reduced-motion: reduce) {
...
`;var Hi,Zi,Si,$i,Ii,Ni,ji,Gi,Ei,qi,Bi,zi,Wi,Ai,Ki,Yi;let Ti=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Hi),(0,o.VK)(this,Si),(0,o.VK)(this,Ii),(0,o.VK)(this,ji),(0,o.VK)(this,qi),(0,o.VK)(this,Wi),(0,o.VK)(this,Ki),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",(0,o.VK)(this,Ei,()=>{this.checked=this._input.checked,(0,o.jq)(this,Ki,Yi).call(this),(0,o.jq)(this,qi,Bi).call(this)}),(0,o.VK)(this,zi,e=>{this.disabled||"Enter"===e.key&&(e.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(e){this._internalValue=e}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(e){this._input?.focus(e)}render(){const e={switch:!0,checked:this.checked,disabled:this.disabled,"control-start":"start"===this.controlPlacement,small:"small"===this.size};return d.qy`
      <label class=${(0,l.H)(e)} for="switch-input">
        ${[(0,o.jq)(this,Hi,Zi).call(this),(0,o.jq)(this,Si,$i).call(this),(0,o.jq)(this,ji,Gi).call(this)]}
      </label>
    `}};Hi=new WeakSet,Zi=function(){return d.qy`
      <input
        id="switch-input"
        type="checkbox"
        role="switch"
        ...
        @keydown=${(0,o.S7)(this,zi)}
        @change=${(0,o.S7)(this,Ei)}
      />
    `},Si=new WeakSet,$i=function(){return this.label?d.qy`<span id="label" class="label">${this.label}</span>`:null},Ii=new WeakSet,Ni=function(){return d.qy`<span class="thumb">
...
`,il=[C.LU,Q.A,nl],ll=[z.t,Y.z,Zt,us,ze.Hx,zr.T,$t.E,gr,$o,Rt,H.K,br,ot.o,Xi,Wr.o,Qi,Ji,Ui,Ws.r,re,tl,ol,sl,rl,el.z],al={compact:{input:"small",dropdown:"small"},comfortable:{input:"small",dropdown:"small"},spacious:{input:"large",dropdown:"medium"}};var cl,dl,Cl,hl,pl,ul,gl,fl,ml,vl,Ml,bl,kl,Vl,yl,_l,wl,Ll,xl,Hl,Zl,Sl,$l,Il,Nl,jl,Gl,El,ql,Bl,zl,Wl,Al,Kl,Yl,Tl,Rl,Pl,Dl,Ol,Fl,Ul,Jl,Ql,Xl,ea,ta,sa,ra,oa,na,ia,la,aa,ca,da,Ca,ha,pa,ua,ga,fa,ma,va,Ma,ba,ka,Va,ya,_a,wa,La,xa,Ha,Za,Sa,$a,Ia,Na,ja,Ga,Ea,qa,Ba,za,Wa,Aa,Ka,Ya,Ta,Ra,Pa,Da,Oa,Fa,Ua,Ja,Qa,Xa,ec,tc,sc,rc,oc,nc,ic,lc,ac,cc,dc,Cc,hc,pc,uc,gc,fc,mc,vc,Mc,bc,kc,Vc,yc,_c,wc,Lc,xc,Hc,Zc,Sc,$c,Ic,Nc,jc,Gc,Ec,qc,Bc,zc,Wc,Ac,Kc,Yc,Tc,Rc,Pc,Dc,Oc,Fc,Uc,Jc,Qc,Xc,ed,td,sd,rd,od,nd,id,ld,ad,cd,dd,Cd,hd,pd,ud,gd,fd,md,vd,Md,bd,kd,Vd,yd,_d,wd,Ld,xd,Hd,Zd,Sd,$d,Id,Nd,jd,Gd;Symbol.toPrimitive;let Ed=class extends((0,u.Q8)((0,u.TM)((0,u.Md)((0,u.lt)(c.j))))){constructor(){super(...arguments),(0,o.VK)(this,Cl),(0,o.VK)(this,pl),(0,o.VK)(this,gl),(0,o.VK)(this,ml),(0,o.VK)(this,_l),(0,o.VK)(this,Ll),(0,o.VK)(this,Hl),(0,o.VK)(this,Sl),(0,o.VK)(this,Il),(0,o.VK)(this,jl),(0,o.VK)(this,El),(0,o.VK)(this,Bl),(0,o.VK)(this,Wl),(0,o.VK)(this,Kl),(0,o.VK)(this,Tl),(0,o.VK)(this,Pl),(0,o.VK)(this,Ol),(0,o.VK)(this,Ul),(0,o.VK)(this,Ql),(0,o.VK)(this,ea),(0,o.VK)(this,sa),(0,o.VK)(this,oa),(0,o.VK)(this,ia),(0,o.VK)(this,aa),(0,o.VK)(this,da),(0,o.VK)(this,ha),(0,o.VK)(this,ua),(0,o.VK)(this,fa),(0,o.VK)(this,va),(0,o.VK)(this,ba),(0,o.VK)(this,Va),(0,o.VK)(this,_a),(0,o.VK)(this,La),(0,o.VK)(this,Ha),(0,o.VK)(this,Sa),(0,o.VK)(this,Ia),(0,o.VK)(this,ja),(0,o.VK)(this,Ea),(0,o.VK)(this,Ba),(0,o.VK)(this,Wa),(0,o.VK)(this,Ka),(0,o.VK)(this,Ta),(0,o.VK)(this,Pa),(0,o.VK)(this,Oa),(0,o.VK)(this,Ua),(0,o.VK)(this,Qa),(0,o.VK)(this,ec),(0,o.VK)(this,sc),(0,o.VK)(this,oc),(0,o.VK)(this,ic),(0,o.VK)(this,ac),(0,o.VK)(this,dc),(0,o.VK)(this,hc),(0,o.VK)(this,uc),(0,o.VK)(this,fc),(0,o.VK)(this,vc),(0,o.VK)(this,bc),(0,o.VK)(this,Vc),(0,o.VK)(this,_c),(0,o.VK)(this,Lc),(0,o.VK)(this,Hc),(0,o.VK)(this,Sc),(0,o.VK)(this,Ic),(0,o.VK)(this,jc),(0,o.VK)(this,Ec),(0,o.VK)(this,Bc),(0,o.VK)(this,Wc),(0,o.VK)(this,Kc),(0,o.VK)(this,Tc),(0,o.VK)(this,Pc),(0,o.VK)(this,Oc),(0,o.VK)(this,Uc),(0,o.VK)(this,Qc),(0,o.VK)(this,ed),(0,o.VK)(this,sd),(0,o.VK)(this,od),(0,o.VK)(this,id),(0,o.VK)(this,ad),(0,o.VK)(this,dd),(0,o.VK)(this,hd),(0,o.VK)(this,ud),(0,o.VK)(this,fd),(0,o.VK)(this,vd),(0,o.VK)(this,bd),(0,o.VK)(this,Vd),(0,o.VK)(this,_d),(0,o.VK)(this,Ld),(0,o.VK)(this,Hd),(0,o.VK)(this,Sd),(0,o.VK)(this,Id),(0,o.VK)(this,jd),(0,o.VK)(this,cl,{}),(0,o.VK)(this,dl,3e5),this.headlineTag="h2",this.options=[5,10,20,50,100],this.page=1,this.rows=10,this.columns=[],this.density="comfortable",this.selectable=!1,this.disableSelectAll=!1,this.responsive=!1,this.plain=!1,this.searchable=!1,this.settings=!1,this.striped=!1,this.nocache=!1,this.variant="neutral-02-outlined",this._isMobile=!1,this._view={page:this.page,rows:this.rows,searchQuery:"",visibleColumns:new Set},this._loaded=!0,this._loading=!1,this._rowsState=[],this._total=0,this._selected=new Set,this._expanded=new Set,this._expanding=new Set,this._completingExpansion=new Set,this._expandedRowsCache=new Map,this._expandedFullContentResolved=new Set,this._error=null,(0,o.VK)(this,Ml,new Map),(0,o.VK)(this,bl,140),(0,o.VK)(this,kl,100),(0,o.VK)(this,Vl,new Set),(0,o.VK)(this,yl,!1)}_handleMobile(e){this._isMobile=e}_onDataChange(){(0,o.OV)(this,cl,{}),(0,o.jq)(this,Ol,Fl).call(this)}_onPageChange(){this._view={...this._view,page:Number(this.page??1)},(0,o.jq)(this,Ol,Fl).call(this)}_onRowsChange(){this._view={...this._view,rows:Number(this.rows??10),page:1},(0,o.jq)(this,Ol,Fl).call(this)}_onColumnsChange(){(0,o.OV)(this,cl,{});const e=(0,o.jq)(this,Pl,Dl).call(this),t=this._view.sortColumn,s=this._view.sortDirection;this._view={...this._view,page:e?1:Number(this.page??1),rows:Number(this.rows??10),sortColumn:e?.column??this._view.sortColumn,sortDirection:e?.direction??this._view.sortDirection,visibleColumns:new Set(this.columns.filter(e=>!1!==e.visible).map(e=>e.key))},e&&(e.column!==t||e.direction!==s)&&(0,o.jq)(this,Ol,Fl).call(this)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{(0,o.jq)(this,Sd,$d).call(this),(0,o.jq)(this,ea,ta).call(this),(0,o.jq)(this,Wa,Aa).call(this)})}_handleLightDOMSlotsChange(){(0,o.jq)(this,Ul,Jl).call(this)}updated(e){super.updated(e),(0,o.jq)(this,ea,ta).call(this)}render(){const e={table:!0,plain:this.plain,striped:this.striped,[this.density]:this.density};return d.qy`
      <div class="${(0,l.H)(e)}">
        ${[(0,o.jq)(this,Uc,Jc).call(this),(0,o.jq)(this,fa,ma).call(this),(0,F.z)(this._error,()=>(0,o.jq)(this,Tc,Rc).call(this),()=>(0,F.z)(0===this._rowsState.length&&!this._loading,()=>(0,o.jq)(this,Pc,Dc).call(this),()=>(0,o.jq)(this,Kc,Yc).call(this))),(0,o.jq)(this,Oc,Fc).call(this)]}
      </div>
    `}clearSelection(){(0,o.jq)(this,Ld,xd).call(this),(0,o.jq)(this,Hd,Zd).call(this)}selectAll(){(0,o.jq)(this,_d,wd).call(this),(0,o.jq)(this,Hd,Zd).call(this)}setSelection(e){const t=e.filter(e=>e>=0&&e<this._rowsState.length);this._selected=new Set(t),(0,o.jq)(this,Hd,Zd).call(this),this.requestUpdate()}getSelection(){const e=Array.from(this._selected);return{indices:e,data:e.map(e=>this._rowsState[e])}}expandRow(e){var t=this;return(0,Ne.A)(function*(){return(0,o.jq)(t,Vd,yd).call(t,e,!0)})()}collapseRow(e){return(0,o.jq)(this,Vd,yd).call(this,e,!1),!0}toggleRowExpansion(e,t){var s=this;return(0,Ne.A)(function*(){if(e<0||e>=s._rowsState.length)return!1;const r=!s._expanded.has(e);return(0,o.jq)(s,Vd,yd).call(s,e,r,t)})()}getExpandedIndices(){return Array.from(this._expanded)}};cl=new WeakMap,dl=new WeakMap,Cl=new WeakSet,hl=function(){return this.responsive&&this._isMobile},pl=new WeakSet,ul=function(){return!(0,o.S7)(this,Cl,hl)&&(0,o.S7)(this,Sl,$l).length>0},gl=new WeakSet,fl=function(){return this.selectable&&!(0,o.S7)(this,Cl,hl)},ml=new WeakSet,vl=function(){return al[this.density]},Ml=new WeakMap,bl=new WeakMap,kl=new WeakMap,Vl=new WeakMap,yl=new WeakMap,_l=new WeakSet,wl=function(){return this._selected.size>0},Ll=new WeakSet,xl=function(){return this._rowsState.length>0&&this._selected.size===this._rowsState.length},Hl=new WeakSet,Zl=function(){return(0,o.S7)(this,_l,wl)&&!(0,o.S7)(this,Ll,xl)},Sl=new WeakSet,$l=function(){return this._rowsState.map((e,t)=>(0,o.jq)(this,Ka,Ya).call(this,e,t)?t:-1).filter(e=>-1!==e)},Il=new WeakSet,Nl=function(){const e=(0,o.S7)(this,Sl,$l);return e.length>0&&e.every(e=>this._expanded.has(e))},jl=new WeakSet,Gl=function(){return JSON.stringify({page:this._view.page,rows:this._view.rows,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection,searchQuery:this._view.searchQuery})},El=new WeakSet,ql=function(e){const t=(0,o.S7)(this,Ml).get(e);void 0!==t&&(window.clearTimeout(t),(0,o.S7)(this,Ml).delete(e))},Bl=new WeakSet,zl=function(e){if((0,o.jq)(this,El,ql).call(this,e),this._expanding.has(e)){const t=new Set(this._expanding);t.delete(e),this._expanding=t}if(this._completingExpansion.has(e)){const t=new Set(this._completingExpansion);t.delete(e),this._completingExpansion=t}},Wl=new WeakSet,Al=function(){(0,o.S7)(this,Ml).forEach(e=>window.clearTimeout(e)),(0,o.S7)(this,Ml).clear(),this._expanding.clear(),this._completingExpansion.clear()},Kl=new WeakSet,Yl=function(e){(0,o.jq)(this,El,ql).call(this,e);const t=new Set(this._completingExpansion);t.add(e),this._completingExpansion=t,this.requestUpdate();const s=window.setTimeout(()=>{(0,o.jq)(this,Bl,zl).call(this,e),this.requestUpdate()},(0,o.S7)(this,bl));(0,o.S7)(this,Ml).set(e,s)},Tl=new WeakSet,Rl=function(e){return Date.now()-e.timestamp<(0,o.S7)(this,dl)},Pl=new WeakSet,Dl=function(){const e=this.columns.find(e=>"asc"===e.sorting||"desc"===e.sorting);return e?.sorting?{column:e.key,direction:e.sorting}:null},Ol=new WeakSet,Fl=function(){var e=(0,Ne.A)(function*(){if(this.data){if(!this.nocache){const e=(0,o.jq)(this,jl,Gl).call(this),t=(0,o.S7)(this,cl)[e];if(t&&(0,o.jq)(this,Tl,Rl).call(this,t))return this._rowsState=t.rows,this._total=t.total,this._expanded.clear(),(0,o.jq)(this,Wl,Al).call(this),this._expandedRowsCache.clear(),this._expandedFullContentResolved.clear(),this._loaded=!1,void this.dispatchCustomEvent("gds-table-data-loaded",{detail:{rows:t.rows,total:t.total,page:this._view.page,rowsPerPage:this._view.rows,searchQuery:this._view.searchQuery,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection},bubbles:!0})}this._loading=!0,this._error=null;try{const e=yield this.data({page:this._view.page,rows:this._view.rows,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection,searchQuery:this._view.searchQuery});if(!this.nocache){const t=(0,o.jq)(this,jl,Gl).call(this);(0,o.S7)(this,cl)[t]={rows:e.rows,total:e.total,timestamp:Date.now()}}this._rowsState=e.rows,this._total=e.total,this._selected.clear(),this._expanded.clear(),(0,o.jq)(this,Wl,Al).call(this),this._expandedRowsCache.clear(),this._expandedFullContentResolved.clear(),this._loaded=!1,this.dispatchCustomEvent("gds-table-data-loaded",{detail:{...e,page:this._view.page,rowsPerPage:this._view.rows,searchQuery:this._view.searchQuery,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection},bubbles:!0})}catch(e){this._error=e,this.dispatchCustomEvent("gds-table-data-error",{detail:e,bubbles:!0})}finally{this._loading=!1}}});return function(){return e.apply(this,arguments)}}(),Ul=new WeakSet,Jl=function(){(0,o.S7)(this,yl)||((0,o.OV)(this,yl,!0),queueMicrotask(()=>{(0,o.OV)(this,yl,!1),(0,o.jq)(this,Wa,Aa).call(this)}))},Ql=new WeakSet,Xl=function(){const e=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),t=e.filter(e=>"left"===e.sticky),s=e.filter(e=>"right"===e.sticky);return{lastLeft:t.length?t[t.length-1].key:null,lastRight:s.length?s[0].key:null}},ea=new WeakSet,ta=function(){const e=this.shadowRoot;if(!e)return;const t=Array.from(e.querySelectorAll("thead th.sticky-left")),s=Array.from(e.querySelectorAll("thead th.sticky-right")),r=e.querySelector("thead th.expander-cell"),o=e.querySelector("thead th.checkbox-cell");if(!t.length&&!s.length)return;e.querySelectorAll("[data-col-key]").forEach(e=>{e.style.left="",e.style.right=""});let n=(r?.offsetWidth??0)+(o?.offsetWidth??0);for(const s of t){const t=s.dataset.colKey,r=`${n}px`;s.style.left=r,n+=s.offsetWidth,t&&e.querySelectorAll(`[data-col-key="${t}"]`).forEach(e=>e.style.left=r)}let i=0;for(const t of[...s].reverse()){const s=t.dataset.colKey,r=`${i}px`;t.style.right=r,i+=t.offsetWidth,s&&e.querySelectorAll(`[data-col-key="${s}"]`).forEach(e=>e.style.right=r)}},sa=new WeakSet,ra=function(e,t,s){if("string"==typeof s||"number"==typeof s)return s;const r=e?.id;return"string"==typeof r||"number"==typeof r?r:t+1},oa=new WeakSet,na=function(e){return d.qy`<span class="cell-wrapped-content">${e}</span>`},ia=new WeakSet,la=function(e){return d.qy`<span class="column-label" aria-hidden="true">
      ${e.label}:
    </span>`},aa=new WeakSet,ca=function(e,t,s){const r=`${e}:${t}:${s}`;return d.qy`<slot name="${r}"></slot>`},da=new WeakSet,Ca=function(e,t,s){const r=t.value?t.value(e):e[t.key],n=this._isMobile&&this.responsive,i=!!t.justify;let l;if("object"==typeof(c=r)&&null!==c&&Array.isArray(c.slots)){const n=(0,o.jq)(this,sa,ra).call(this,e,s,r.key);l=r.slots.map(e=>"value"===e?void 0===r.value?null:i?(0,o.jq)(this,oa,na).call(this,r.value):r.value:(0,o.jq)(this,aa,ca).call(this,t.key,n,e))}else l=i?(0,o.jq)(this,oa,na).call(this,r):r;var c;return d.qy`
      <div
        class="cell-content"
        aria-label=${(0,a.J)(n?t.label:void 0)}
      >
        ${n?(0,o.jq)(this,ia,la).call(this,t):null} ${l}
      </div>
    `},ha=new WeakSet,pa=function(e){const t=this._view.sortColumn===e.key,s=this._view.sortDirection;return t?"asc"===s?d.qy`<gds-icon-sort-up size="m"></gds-icon-sort-up>`:d.qy`<gds-icon-sort-down size="m"></gds-icon-sort-down>`:d.qy`<gds-icon-sort-up size="m"></gds-icon-sort-up>`},ua=new WeakSet,ga=function(){return this.searchable||this.settings||this.querySelector('[slot="header-lead"]')||this.querySelector('[slot="header-trail"]')},fa=new WeakSet,ma=function(){return this.plain||!(0,o.jq)(this,ua,ga).call(this)?null:d.qy`
      <div class="header">
        <div class="lead">
          ${(0,F.z)(this.searchable,()=>d.qy`
              <gds-input
                type="text"
                size="${(0,o.S7)(this,ml,vl).input}"
                plain
                clearable
                label="${this.searchLabel||(0,N.ab)("Search table")}"
                .value=${this._view.searchQuery}
                @input=${(0,o.jq)(this,Qc,Xc)}
                @gds-input-cleared=${(0,o.jq)(this,ed,td)}
                width="100%; l{240px}"
                min-width="240px"
              >
    ...
    `},va=new WeakSet,Ma=function(e){const t=this._view.sortColumn===e.key,s=this._view.sortDirection,{lastLeft:r,lastRight:n}=(0,o.jq)(this,Ql,Xl).call(this);let i=e.label;if(e.sortable)if(t){const t="asc"===s?(0,N.ab)("ascending"):(0,N.ab)("descending");i=`${e.label}, ${(0,N.ab)("sorted")} ${t}`}else i=`${e.label}, ${(0,N.ab)("sortable")}`;const c=(0,l.H)({sortable:!!e.sortable,sorted:t,"sort-asc":t&&"asc"===s,"sort-desc":t&&"desc"===s,[`align-${e.align}`]:!!e.align,[`justify-${e.justify}`]:!!e.justify,wrap:Boolean(e.width),"sticky-left":"left"===e.sticky,"sticky-right":"right"===e.sticky,"sticky-left-last":"left"===e.sticky&&e.key===r,"sticky-right-last":"right"===e.sticky&&e.key===n}),C=(0,Fi.W)({"--cell-width":e.width});return d.qy`
      <th
        class=${c}
        style=${C}
      ...
      >
        ${(0,F.z)(e.sortable,()=>d.qy`
            <button
              ...
              aria-label="${i}"
              aria-pressed=${t}
              @click=${()=>(0,o.jq)(this,sd,rd).call(this,e.key)}
            >
              <span class="column-label">${e.label}</span>
              <span class="sort-icon">${(0,o.jq)(this,ha,pa).call(this,e)}</span>
            </button>
          `,()=>d.qy`
    ...
    `},ba=new WeakSet,ka=function(){return(0,o.S7)(this,gl,fl)?d.qy`
      <th class="checkbox-cell">
        <div class="cell-center">
          ${(0,o.jq)(this,Ic,Nc).call(this,{checked:(0,o.S7)(this,Ll,xl),indeterminate:(0,o.S7)(this,Hl,Zl),ariaLabel:(0,N.ab)("Select all rows"),onToggle:()=>(0,o.jq)(this,dd,Cd).call(this,{}),skip:this.disableSelectAll})}
        </div>
      </th>
    `:null},Va=new WeakSet,ya=function(){if(!(0,o.S7)(this,pl,ul))return null;const e=(0,o.S7)(this,Il,Nl),t=e?(0,N.ab)("Collapse all rows"):(0,N.ab)("Expand all rows");return d.qy`
      <th class="expander-cell expander-header">
        <div class="cell-center">
          <gds-button
            ...
            size="small"
            label="${t}"
            @click=${()=>(0,o.jq)(this,fd,md).call(this)}
          >
    ...
    `},_a=new WeakSet,wa=function(e){return"subRows"in e?e.subRows:e?.children},La=new WeakSet,xa=function(e){if("fullContent"in e)return e.fullContent},Ha=new WeakSet,Za=function(e,t){return this._expandedRowsCache.get(t)??[]},Sa=new WeakSet,$a=function(e){return"function"==typeof(0,o.jq)(this,_a,wa).call(this,e)},Ia=new WeakSet,Na=function(e){return"function"==typeof(0,o.jq)(this,La,xa).call(this,e)},ja=new WeakSet,Ga=function(e,t){const s=(0,o.jq)(this,Ha,Za).call(this,e,t).length||1,r=Number(e.subRowCount);return!Number.isFinite(r)||r<=0?s:Math.floor(r)},Ea=new WeakSet,qa=function(e,t){const s=String((0,o.jq)(this,sa,ra).call(this,e,t));return(0,o.S7)(this,Vl).has(s)},Ba=new WeakSet,za=function(e,t){return(0,o.jq)(this,Ea,qa).call(this,e,t)},Wa=new WeakSet,Aa=function(){const e=new Set;this.querySelectorAll('[slot^="expand:"][slot$=":full"]').forEach(t=>{const s=t.getAttribute("slot");if(!s)return;if(!s.startsWith("expand:")||!s.endsWith(":full"))return;const r=s.slice(7,-5);r&&e.add(r)}),(e.size!==(0,o.S7)(this,Vl).size||[...e].some(e=>!(0,o.S7)(this,Vl).has(e)))&&((0,o.OV)(this,Vl,e),this.requestUpdate())},Ka=new WeakSet,Ya=function(e,t){return!(0,o.S7)(this,Cl,hl)&&("boolean"==typeof e.isExpandable?e.isExpandable:!!(0,o.jq)(this,Sa,$a).call(this,e)||!!(0,o.jq)(this,Ia,Na).call(this,e)||(0,o.jq)(this,Ha,Za).call(this,e,t).length>0||(0,o.jq)(this,Ba,za).call(this,e,t))},Ta=new WeakSet,Ra=function(e,t){return`row-expand-group-${String((0,o.jq)(this,sa,ra).call(this,e,t)).replace(/[^a-zA-Z0-9_-]/g,"-")}`},Pa=new WeakSet,Da=function(){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).length+((0,o.S7)(this,pl,ul)?1:0)+((0,o.S7)(this,gl,fl)?1:0)},Oa=new WeakSet,Fa=function(){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(e=>(0,o.jq)(this,va,Ma).call(this,e))},Ua=new WeakSet,Ja=function(){return d.qy`
      <thead>
        <tr>
          ${[(0,o.jq)(this,Va,ya).call(this),(0,o.jq)(this,ba,ka).call(this),(0,o.jq)(this,Oa,Fa).call(this)]}
        </tr>
      </thead>
    `},Qa=new WeakSet,Xa=function(e,t,s){const{lastLeft:r,lastRight:n}=(0,o.jq)(this,Ql,Xl).call(this),i=(0,l.H)({[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify,wrap:Boolean(t.width),"sticky-left":"left"===t.sticky,"sticky-right":"right"===t.sticky,"sticky-left-last":"left"===t.sticky&&t.key===r,"sticky-right-last":"right"===t.sticky&&t.key===n}),c=(0,Fi.W)({"--cell-width":t.width});return d.qy`
      <td
        style=${c}
        class=${i}
        data-col-key=${(0,a.J)(t.sticky?t.key:void 0)}
      >
        ${(0,o.jq)(this,da,Ca).call(this,e,t,s)}
      </td>
    `},ec=new WeakSet,tc=function(e,t){if(!(0,o.S7)(this,pl,ul))return null;if(!(0,o.jq)(this,Ka,Ya).call(this,e,t))return d.qy`<td class="expander-cell"></td>`;const s=this._expanded.has(t),r=(0,o.jq)(this,Ta,Ra).call(this,e,t),n=s?e.collapseLabel||(0,N.ab)("Collapse row"):e.expandLabel||(0,N.ab)("Expand row");return d.qy`
      <td class="expander-cell">
        <gds-button
          ...
          aria-controls=${r}
          @click=${()=>(0,o.jq)(this,ud,gd).call(this,e,t)}
        >
    ...
    `},sc=new WeakSet,rc=function(e){if(!(0,o.S7)(this,gl,fl))return null;const t=`${(0,N.ab)("Select row")} ${e+1}`;return d.qy`
      <td class="checkbox-cell">
        <div class="cell-center">
          ${(0,o.jq)(this,Ic,Nc).call(this,{checked:this._selected.has(e),indeterminate:!1,ariaLabel:t,onToggle:()=>(0,o.jq)(this,hd,pd).call(this,e,{detail:{checked:!this._selected.has(e)}})})}
        </div>
      </td>
    `},oc=new WeakSet,nc=function(e,t){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(s=>(0,o.jq)(this,Qa,Xa).call(this,e,s,t))},ic=new WeakSet,lc=function(e,t,s){const r=(0,o.jq)(this,sa,ra).call(this,e,t);return d.qy`
      <tr
      ...
      >
        <td
          ...
          colspan=${(0,o.jq)(this,Pa,Da).call(this)}
        >
          ${d.qy`<slot name="expand:${r}:full"></slot>`}
        </td>
      </tr>
    `},ac=new WeakSet,cc=function(e,t,s,r,n,i=!1){const c=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),C=(0,l.H)({"expanded-row":!0,aligned:!0,"skeleton-leave":i,"expanded-group-end":r===n-1});return d.qy`
      <tr
        class=${C}
        ...
        aria-busy="true"
      >
        ${(0,o.S7)(this,pl,ul)?d.qy`<td class="expander-cell"></td>`:null}
        ${(0,o.S7)(this,gl,fl)?d.qy`<td class="checkbox-cell"></td>`:null}
        ${c.map(e=>{const t=(0,l.H)({[`align-${e.align}`]:!!e.align,[`justify-${e.justify}`]:!!e.justify,wrap:Boolean(e.width)}),s=(0,Fi.W)({"--cell-width":e.width}),r="actions"===String(e.key);return d.qy`
            <td class=${t} style=${s}>
    ...
    `},dc=new WeakSet,Cc=function(e,t,s,r=!1){const n=(0,o.jq)(this,ja,Ga).call(this,e,t);return Array.from({length:n},(i,l)=>(0,o.jq)(this,ac,cc).call(this,e,t,s,l,n,r))},hc=new WeakSet,pc=function(e,t=!1){const s=(0,l.H)({"expanded-row":!0,full:!0,"expanded-group-end":!0,"skeleton-leave":t});return d.qy`
    ...
    `},uc=new WeakSet,gc=function(e){return{"expanded-row":!0,child:!0,"expanded-group-end":e}},fc=new WeakSet,mc=function(e,t,s){return{selected:this._selected.has(e),loading:this._loading,"expanded-parent":s,"has-expandable-rows":t}},vc=new WeakSet,Mc=function(e,t){return e?t?"true":"false":void 0},bc=new WeakSet,kc=function(e,t,s){return{classes:(0,o.jq)(this,fc,mc).call(this,e,t,s),ariaExpanded:(0,o.jq)(this,vc,Mc).call(this,t,s)}},Vc=new WeakSet,yc=function(e,t,s,r,n){const i=this._rowsState.length+1e3*t+s;return d.qy`
      <tr
        class=${(0,l.H)((0,o.jq)(this,uc,gc).call(this,r))}
        id=${(0,a.J)(0===s?n:void 0)}
        aria-level="2"
      >
        ${(0,o.S7)(this,pl,ul)?d.qy`<td class="expander-cell"></td>`:null}
        ${(0,o.S7)(this,gl,fl)?d.qy`<td class="checkbox-cell"></td>`:null}
        ${(0,o.jq)(this,oc,nc).call(this,e,i)}
      </tr>
    `},_c=new WeakSet,wc=function(e){return(0,o.jq)(this,Sa,$a).call(this,e)?"rows":"full"},Lc=new WeakSet,xc=function(e,t){const s=(0,o.jq)(this,Ka,Ya).call(this,e,t),r=s&&this._expanded.has(t),n=this._expanding.has(t),i=this._completingExpansion.has(t),l=(0,o.jq)(this,Ta,Ra).call(this,e,t),a=(0,o.jq)(this,Ha,Za).call(this,e,t),c=(0,o.jq)(this,_c,wc).call(this,e);return{isExpandable:s,isExpanded:r,isExpanding:n,isCompleting:i,groupId:l,expandedRows:a,hasExpandedRows:a.length>0,loadingKind:c}},Hc=new WeakSet,Zc=function(e,t,s){return s.isExpanding?"full"===s.loadingKind?(0,o.jq)(this,hc,pc).call(this,s.groupId,s.isCompleting):(0,o.jq)(this,dc,Cc).call(this,e,t,s.groupId,s.isCompleting):s.hasExpandedRows?s.expandedRows.map((e,r)=>(0,o.jq)(this,Vc,yc).call(this,e,t,r,r===s.expandedRows.length-1,0===r?s.groupId:void 0)):(0,o.jq)(this,ic,lc).call(this,e,t,s.groupId)},Sc=new WeakSet,$c=function(e,t){const s=(0,o.jq)(this,Lc,xc).call(this,e,t),r=(0,o.jq)(this,bc,kc).call(this,t,s.isExpandable,s.isExpanded);return d.qy`
      <tr
        class=${(0,l.H)(r.classes)}
        aria-level=${(0,a.J)((0,o.S7)(this,pl,ul)?"1":void 0)}
        aria-expanded=${(0,a.J)(r.ariaExpanded)}
      >
        ${[(0,o.jq)(this,ec,tc).call(this,e,t),(0,o.jq)(this,sc,rc).call(this,t),(0,o.jq)(this,oc,nc).call(this,e,t)]}
      </tr>
      ${(0,F.z)(s.isExpanded,()=>(0,o.jq)(this,Hc,Zc).call(this,e,t,s))}
    `},Ic=new WeakSet,Nc=function({checked:e,indeterminate:t=!1,disabled:s=!1,ariaLabel:r,onToggle:o,skip:n=!1}){if(n)return null;const i=e=>{e.stopPropagation(),s||o()};return d.qy`
      <div
        class="rbcb-wrapper"
        role="checkbox"
    ...
    `},jc=new WeakSet,Gc=function(e){const t=this._isMobile&&this.responsive?d.qy`<span class="skeleton skeleton-text"></span>`:null;return d.qy`
      <div class="cell-content">
        ${t}
        <span class="skeleton skeleton-text"></span>
      </div>
    `},Ec=new WeakSet,qc=function(e){return d.qy`
      <tr class="skeleton-row">
        ${(0,F.z)((0,o.S7)(this,pl,ul),()=>d.qy`
            <td class="expander-cell">
        ...
        ${(0,F.z)((0,o.S7)(this,gl,fl),()=>d.qy`
          ...
          `)}
        ${this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(e=>d.qy`<td>${(0,o.jq)(this,jc,Gc).call(this,e)}</td>`)}
      </tr>
    `},Bc=new WeakSet,zc=function(){if(this._loading&&this._loaded){const e=Array.from({length:this._view.rows},(e,t)=>(0,o.jq)(this,Ec,qc).call(this,t));return d.qy`<tbody aria-busy="true" aria-live="polite">
        ${e}
      </tbody>`}return d.qy`
      <tbody aria-live="polite">
        ${(0,Oi.u)(this._rowsState,(e,t)=>(0,o.jq)(this,sa,ra).call(this,e,t),(e,t)=>(0,Di.a)([e,this._view.visibleColumns,this._selected.has(t),this._expanded.has(t),this._expanding.has(t),this._completingExpansion.has(t),this._expandedRowsCache.get(t),this._expandedFullContentResolved.has(t)],()=>(0,o.jq)(this,Sc,$c).call(this,e,t)))}
      </tbody>
    `},Wc=new WeakSet,Ac=function(){if(!this.tfoot||(0,o.S7)(this,Cl,hl))return null;const e=this.tfoot.label,t=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),s=(0,l.H)({tablefoot:!0,sticky:Boolean(this.tfoot.sticky)});return d.qy`
      <tfoot class=${s}>
        <tr>
          ${(0,F.z)((0,o.S7)(this,pl,ul),()=>d.qy`<td class="expander-cell"></td>`)}
          ${(0,F.z)((0,o.S7)(this,gl,fl),()=>d.qy`<td class="checkbox-cell"></td>`)}
          ${t.map((t,s)=>{const{lastLeft:r,lastRight:n}=(0,o.jq)(this,Ql,Xl).call(this),i=(0,l.H)({"tablefoot-cell":!0,"tablefoot-label-cell":0===s,[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify,wrap:Boolean(t.width),"sticky-left":"left"===t.sticky,"sticky-right":"right"===t.sticky,"sticky-left-last":"left"===t.sticky&&t.key===r,"sticky-right-last":"right"===t.sticky&&t.key===n}),c=(0,Fi.W)({"--cell-width":t.width});return 0===s&&e?d.qy`
                <th
                  scope="row"
                  class=${i}
                  style=${c}
    ...
    `},Kc=new WeakSet,Yc=function(){const e=(0,l.H)({responsive:this.responsive,data:!0,"is-expandable":(0,o.S7)(this,pl,ul),"is-selectable":(0,o.S7)(this,gl,fl),"has-tfoot":Boolean(this.tfoot)&&!(0,o.S7)(this,Cl,hl),"has-sticky-left":this.columns.some(e=>"left"===e.sticky),"has-sticky-right":this.columns.some(e=>"right"===e.sticky),"has-sticky":this.columns.some(e=>"left"===e.sticky||"right"===e.sticky),"no-mask":(0,o.S7)(this,pl,ul)||(0,o.S7)(this,gl,fl)||this.columns.some(e=>"left"===e.sticky||"right"===e.sticky),[`variant-${this.variant}`]:!0,loading:this._loading,loaded:!this._loading&&!this._loaded}),t=`${this.summary?this.summary+", ":""}${(0,N.ab)("Data table with")} ${this._total} ${(0,N.ab)("rows")}`;return d.qy`
      <gds-card
      ...
      >
        <div class=${e} tabindex="0">
          <table
            aria-label="${t}"
            role=${(0,a.J)((0,o.S7)(this,pl,ul)?"treegrid":void 0)}
          >
            <caption class="visually-hidden">
              ${t}
            </caption>
            ${(0,o.jq)(this,Ua,Ja).call(this)} ${(0,o.jq)(this,Bc,zc).call(this)}
            ${(0,o.jq)(this,Wc,Ac).call(this)}
          </table>
        </div>
      </gds-card>
      ...
      <gds-card variant="neutral-02-outlined" border-radius="m">
        <slot name="error">
          ...
          <gds-button
            ...
            @click=${()=>(0,o.jq)(this,Ol,Fl).call(this)}
          >
            ${(0,N.ab)("Retry")}
          </gds-button>
        </slot>
      </gds-card>
    `},Pc=new WeakSet,Dc=function(){return this._view.searchQuery.length>0?d.qy`
        <gds-card variant="neutral-02-outlined" border-radius="m">
    ...
    `},Oc=new WeakSet,Fc=function(){if(this.plain||this._total<1)return null;const e=`${(this._view.page-1)*this._view.rows+1}–${Math.min(this._view.page*this._view.rows,this._total)} ${(0,N.ab)("of")} ${this._total}`;return d.qy`
      <slot name="footer">
        <gds-pagination
          ...
          .label=${e}
          @gds-page-change=${(0,o.jq)(this,od,nd)}
          @gds-rows-change=${(0,o.jq)(this,id,ld)}
          width="100%"
        >
        </gds-pagination>
      </slot>
    `},Uc=new WeakSet,Jc=function(){if(this.headline||this.summary)return d.qy`
      ...
      `},Qc=new WeakSet,Xc=function(){var e=(0,Ne.A)(function*(e){const t=e.target;this._view={...this._view,searchQuery:t.value,page:1},yield(0,o.jq)(this,Ol,Fl).call(this)});return function(t){return e.apply(this,arguments)}}(),ed=new WeakSet,td=function(){var e=(0,Ne.A)(function*(){this._view={...this._view,searchQuery:"",page:1},yield(0,o.jq)(this,Ol,Fl).call(this)});return function(){return e.apply(this,arguments)}}(),sd=new WeakSet,rd=function(){var e=(0,Ne.A)(function*(e){const t=this._view.sortColumn===e&&"asc"===this._view.sortDirection?"desc":"asc";this._view={...this._view,sortColumn:e,sortDirection:t,page:1},this.dispatchCustomEvent("gds-sort-change",{detail:{sortColumn:e,sortDirection:t},bubbles:!0}),yield(0,o.jq)(this,Ol,Fl).call(this)});return function(t){return e.apply(this,arguments)}}(),od=new WeakSet,nd=function(){var e=(0,Ne.A)(function*(e){this._view={...this._view,page:e.detail.page},this.dispatchCustomEvent("gds-page-change",{detail:e.detail,bubbles:!0}),yield(0,o.jq)(this,Ol,Fl).call(this)});return function(t){return e.apply(this,arguments)}}(),id=new WeakSet,ld=function(){var e=(0,Ne.A)(function*(e){this._view={...this._view,rows:e.detail.rows,page:1},this.dispatchCustomEvent("gds-rows-change",{detail:e.detail,bubbles:!0}),yield(0,o.jq)(this,Ol,Fl).call(this)});return function(t){return e.apply(this,arguments)}}(),ad=new WeakSet,cd=function(e){const t=e.detail.value;this._view={...this._view,visibleColumns:new Set(t)},this.requestUpdate()},dd=new WeakSet,Cd=function(e){(0,o.S7)(this,Ll,xl)?(0,o.jq)(this,Ld,xd).call(this):(0,o.jq)(this,_d,wd).call(this),(0,o.jq)(this,Hd,Zd).call(this)},hd=new WeakSet,pd=function(e,t){t.detail.checked?this._selected.add(e):this._selected.delete(e),(0,o.jq)(this,Hd,Zd).call(this),this.requestUpdate()},ud=new WeakSet,gd=function(e,t){this.toggleRowExpansion(t,e)},fd=new WeakSet,md=function(){var e=(0,Ne.A)(function*(){const e=(0,o.S7)(this,Sl,$l);(0,o.S7)(this,Il,Nl)?(e.forEach(e=>this._expanded.delete(e)),this.requestUpdate()):yield Promise.all(e.map(e=>(0,o.jq)(this,Vd,yd).call(this,e,!0)))});return function(){return e.apply(this,arguments)}}(),vd=new WeakSet,Md=function(e,t,s){this.dispatchCustomEvent("gds-table-expand-change",{detail:{index:t,row:e,expanded:s,expandedIndices:Array.from(this._expanded)},bubbles:!0})},bd=new WeakSet,kd=function(){var e=(0,Ne.A)(function*(e,t){const s=(0,o.jq)(this,_a,wa).call(this,e),r=(0,o.jq)(this,La,xa).call(this,e),n="function"==typeof s,i="function"==typeof r;if(!n&&!i)return;const l=n?s():void 0,a=i?r():void 0,c=Boolean(l||a);let d,C=!1,h=!1;c&&(d=window.setTimeout(()=>{if(!this._expanded.has(t))return;const e=new Set(this._expanding);e.add(t),this._expanding=e,h=!0,this.requestUpdate()},(0,o.S7)(this,kl)));try{if(l){const e=yield l,s=Array.isArray(e)?e:[],r=new Map(this._expandedRowsCache);r.set(t,s),this._expandedRowsCache=r}if(a){yield a;const e=new Set(this._expandedFullContentResolved);e.add(t),this._expandedFullContentResolved=e}C=!0}catch{if(l){const e=new Map(this._expandedRowsCache);e.set(t,[]),this._expandedRowsCache=e}}finally{void 0!==d&&window.clearTimeout(d),c&&C&&h?(0,o.jq)(this,Kl,Yl).call(this,t):(0,o.jq)(this,Bl,zl).call(this,t),this.requestUpdate()}});return function(t,s){return e.apply(this,arguments)}}(),Vd=new WeakSet,yd=function(){var e=(0,Ne.A)(function*(e,t,s){if(e<0||e>=this._rowsState.length)return!1;const r=s??this._rowsState[e];if(!r)return!1;const n=(0,o.jq)(this,Ka,Ya).call(this,r,e);return!(t&&!n)&&(t===this._expanded.has(e)||(t?(this._expanded.add(e),(0,o.jq)(this,vd,Md).call(this,r,e,!0),this.requestUpdate(),yield(0,o.jq)(this,bd,kd).call(this,r,e)):((0,o.jq)(this,Bl,zl).call(this,e),this._expanded.delete(e),(0,o.jq)(this,vd,Md).call(this,r,e,!1)),this.requestUpdate()),!0)});return function(t,s,r){return e.apply(this,arguments)}}(),_d=new WeakSet,wd=function(){this._selected=new Set(this._rowsState.map((e,t)=>t)),this.requestUpdate()},Ld=new WeakSet,xd=function(){this._selected.clear(),this.requestUpdate()},Hd=new WeakSet,Zd=function(){this.dispatchCustomEvent("gds-table-selection",{detail:{selectedIndices:Array.from(this._selected),selectedData:Array.from(this._selected).map(e=>this._rowsState[e]),count:this._selected.size},bubbles:!0})},Sd=new WeakSet,$d=function(){const e=this.shadowRoot?.querySelector(".data");if(!e)return;const t=()=>{(0,o.jq)(this,Id,Nd).call(this,e),(0,o.jq)(this,jd,Gd).call(this,e)};e.addEventListener("scroll",t);const s=new ResizeObserver(()=>t());s.observe(e);const r=e.querySelector("table");r&&s.observe(r),t()},Id=new WeakSet,Nd=function(e){const{scrollTop:t,scrollHeight:s,clientHeight:r}=e,o=s-r;t>0?e.classList.add("scrolled"):e.classList.remove("scrolled"),t<o-1?e.classList.add("scrolled-bottom"):e.classList.remove("scrolled-bottom")},jd=new WeakSet,Gd=function(e){const{scrollLeft:t,scrollWidth:s,clientWidth:r}=e,o=s-r;s>r?e.classList.add("overflows-x"):e.classList.remove("overflows-x"),t<=0?(e.classList.add("scrolled-x-start"),e.classList.remove("scrolled-x-middle","scrolled-x-end")):t>=o-1?(e.classList.add("scrolled-x-end"),e.classList.remove("scrolled-x-start","scrolled-x-middle")):(e.classList.add("scrolled-x-middle"),e.classList.remove("scrolled-x-start","scrolled-x-end"))},Ed.styles=il,(0,o.Cc)([(0,i.MZ)()],Ed.prototype,"headline",2),(0,o.Cc)([(0,i.MZ)({attribute:"headline-tag",type:String,reflect:!0})],Ed.prototype,"headlineTag",2),(0,o.Cc)([(0,i.MZ)()],Ed.prototype,"summary",2),(0,o.Cc)([(0,i.MZ)({attribute:"search-label",type:String})],Ed.prototype,"searchLabel",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Ed.prototype,"options",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Ed.prototype,"page",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Ed.prototype,"rows",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Ed.prototype,"columns",2),(0,o.Cc)([(0,i.MZ)()],Ed.prototype,"data",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],Ed.prototype,"density",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"selectable",2),(0,o.Cc)([(0,i.MZ)({attribute:"disable-select-all",type:Boolean,reflect:!1})],Ed.prototype,"disableSelectAll",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"responsive",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"plain",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"searchable",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"settings",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"striped",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Ed.prototype,"nocache",2),(0,o.Cc)([(0,i.MZ)({type:Object})],Ed.prototype,"tfoot",2),(0,o.Cc)([(0,i.MZ)()],Ed.prototype,"dataLoadKey",2),(0,o.Cc)([(0,h.F)({...p.Sc,property:"--_table-height",selector:".data"})],Ed.prototype,"height",2),(0,o.Cc)([(0,i.MZ)()],Ed.prototype,"variant",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_isMobile",2),(0,o.Cc)([(0,Br.M)("(max-width: 768px)")],Ed.prototype,"_handleMobile",1),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_view",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_loaded",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_loading",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_rowsState",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_total",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_selected",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_expanded",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_expanding",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_completingExpansion",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_expandedRowsCache",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_expandedFullContentResolved",2),(0,o.Cc)([(0,i.wk)()],Ed.prototype,"_error",2),(0,o.Cc)([(0,ee.w)("dataLoadKey"),(0,ee.w)("data")],Ed.prototype,"_onDataChange",1),(0,o.Cc)([(0,ee.w)("page",{waitUntilFirstUpdate:!0})],Ed.prototype,"_onPageChange",1),(0,o.Cc)([(0,ee.w)("rows",{waitUntilFirstUpdate:!0})],Ed.prototype,"_onRowsChange",1),(0,o.Cc)([(0,ee.w)("columns")],Ed.prototype,"_onColumnsChange",1),(0,o.Cc)([(0,Bo.L)({childList:!0,attributes:!0,attributeFilter:["slot"],attributeOldValue:!0})],Ed.prototype,"_handleLightDOMSlotsChange",1),Ed=(0,o.Cc)([(0,N.cc)(),(0,d.Y$)("gds-table",{dependsOn:ll}),(0,j.J)({labelledBy:"table",describedBy:"table"})],Ed);const qd=e=>{Ed.define();const t=(0,L.pI)("gds-table"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};qd.displayName="GdsTable";const Bd=e=>{Rt.define();const t=(0,L.pI)("gds-text"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Bd.displayName="GdsText";const zd=e=>{Ts.define();const t=(0,L.pI)("gds-textarea"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};zd.displayName="GdsTextarea";var Wd,Ad,Kd,Yd,Td,Rd=y.AH`
  @layer base {
    :host {
      display: block;
      outline: none;
...
`;let GC=class extends((0,u.Q8)((0,u.vi)((0,u.TM)((0,u.lt)((0,u.qC)(c.j)))))){applyVideoSettings(){this.videoElement&&(this.videoElement.src=this.src||"",this.videoElement.poster=this.poster||"",this.videoElement.muted=this.muted||!1,this.videoElement.autoplay=this.autoplay||!1,this.videoElement.loop=this.loop||!1,this.videoElement.playsInline=this.playsinline||!1)}render(){return d.qy`<video></video>`}firstUpdated(){this.applyVideoSettings()}};GC.styles=[C.LU,jC],(0,o.Cc)([(0,h.F)()],GC.prototype,"aspect-ratio",2),(0,o.Cc)([(0,h.F)({selector:"video"})],GC.prototype,"object-position",2),(0,o.Cc)([(0,h.F)()],GC.prototype,"opacity",2),(0,o.Cc)([(0,h.F)({selector:"video"})],GC.prototype,"object-fit",2),(0,o.Cc)([(0,h.F)({selector:"video"})],GC.prototype,"pointer-events",2),(0,o.Cc)([(0,h.F)({valueTemplate:e=>`var(--gds-sys-space-${e})`})],GC.prototype,"border-radius",2),(0,o.Cc)([(0,i.MZ)()],GC.prototype,"src",2),(0,o.Cc)([(0,i.MZ)()],GC.prototype,"poster",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],GC.prototype,"muted",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],GC.prototype,"playsinline",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],GC.prototype,"autoplay",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],GC.prototype,"loop",2),(0,o.Cc)([(0,i.P)("video")],GC.prototype,"videoElement",2),GC=(0,o.Cc)([(0,d.Y$)("gds-video")],GC);const EC=e=>{GC.define();const t=(0,L.pI)("gds-video"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};EC.displayName="GdsVideo",Rt.define();class qC extends Rt{updated(e){super.updated(e),this.element&&(this.element.innerHTML=this.formattedValue)}}(0,o.Cc)([(0,i.P)("[tag]")],qC.prototype,"element",2);const BC=e=>"string"==typeof e?new Date(e):e,zC={dateOnlyNumbers:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"short"}).format(BC(e)),dateLong:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"long"}).format(BC(e)),dateLongWithWeekday:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"full"}).format(BC(e)).replace(",",""),dateShort:(e,t)=>{const s=new Intl.DateTimeFormat(t,{dateStyle:"medium"});return"sv-se"===t?.toLowerCase()?s.format(BC(e)).replace(".",""):s.format(BC(e))},dateShortWithWeekday:(e,t)=>{const s=new Intl.DateTimeFormat(t,{weekday:"short",year:"numeric",month:"short",day:"numeric"}).format(BC(e));return"sv-se"===t?.toLowerCase()?s.replace(".",""):"en-gb"===t?.toLowerCase()?s.replace(",",""):s},timeShort:(e,t)=>new Intl.DateTimeFormat(t,{timeStyle:"short"}).format(BC(e)),timeLong:(e,t)=>new Intl.DateTimeFormat(t,{timeStyle:"medium"}).format(BC(e)),dateTimeLong:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"long",timeStyle:"short"}).format(BC(e)),dateTimeLongWithWeekday:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"full",timeStyle:"short"}).format(BC(e)),dateTimeShort:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"medium",timeStyle:"short"}).format(BC(e))};let WC=class extends qC{constructor(){super(...arguments),this.format="dateOnlyNumbers"}get formattedValue(){return this.format&&this.format in zC?zC[this.format](this.value??this.element?.textContent??void 0,this.locale):this.value?.toString()??""}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};(0,o.Cc)([(0,i.MZ)({attribute:!1})],WC.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:String})],WC.prototype,"format",2),(0,o.Cc)([(0,i.MZ)({type:String})],WC.prototype,"locale",2),WC=(0,o.Cc)([(0,d.Y$)("gds-formatted-date")],WC);let AC=class extends g.M{};AC._regularSVG='<path d="M9.75027 5.52371L10.7168 4.55722C13.1264 2.14759 17.0332 2.14759 19.4428 4.55722C21.8524 6.96684 21.8524 10.8736 19.4428 13.2832L18.4742 14.2519M5.52886 9.74513L4.55722 10.7168C2.14759 13.1264 2.1476 17.0332 4.55722 19.4428C6.96684 21.8524 10.8736 21.8524 13.2832 19.4428L14.2478 18.4782M9.5 14.5L14.5 9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>',AC._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M18.9125 5.08755C16.7957 2.97082 13.3638 2.97082 11.2471 5.08755L9.75027 6.58437L8.68961 5.52371L10.1864 4.02689C12.889 1.32437 17.2706 1.32437 19.9731 4.02689C22.6756 6.7294 22.6756 11.111 19.9731 13.8136L18.4742 15.3125L17.4135 14.2519L18.9125 12.7529C21.0292 10.6362 21.0292 7.20428 18.9125 5.08755ZM15.5607 9.5L9.5 15.5607L8.43934 14.5L14.5 8.43934L15.5607 9.5ZM6.58952 9.74513L5.08755 11.2471C2.97082 13.3638 2.97082 16.7957 5.08755 18.9125C7.20428 21.0292 10.6362 21.0292 12.7529 18.9125L14.2478 17.4176L15.3084 18.4782L13.8136 19.9731C11.1111 22.6756 6.72941 22.6756 4.02689 19.9731C1.32437 17.2706 1.32437 12.889 4.02689 10.1864L5.52886 8.68446L6.58952 9.74513Z" fill="currentColor"/>',AC._name="chain-link",AC._width=24,AC._height=24,AC._viewBox="0 0 24 24",AC=(0,o.Cc)([(0,d.Y$)("gds-icon-chain-link")],AC),AC.define();var KC,YC,TC,RC,PC,DC,OC,FC,UC,JC,QC,XC,eh,th,sh,rh,oh,nh,ih=y.AH`
  :host {
    display: inline-block;
    height: max-content;
    text-align: left;
...
`;let lh=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(R(hs(c.j)))))){constructor(){super(...arguments),(0,o.VK)(this,KC),(0,o.VK)(this,TC),(0,o.VK)(this,PC),(0,o.VK)(this,OC),(0,o.VK)(this,UC),(0,o.VK)(this,QC),(0,o.VK)(this,eh),(0,o.VK)(this,sh),(0,o.VK)(this,oh),this.title="",this.excerpt="",this.label="",this.variant="neutral-01",this.tag="h2",this.ratio="landscape",this.category="",this.date="",this.dateFormat="dateTimeLong",this.locale="en-GB"}render(){return(0,F.z)(this.href,()=>(0,o.jq)(this,UC,JC).call(this),()=>(0,o.jq)(this,eh,th).call(this))}};KC=new WeakSet,YC=function(e=!1){return e&&this.label||this.querySelector('[slot="footer"]')},TC=new WeakSet,RC=function(e){return(0,l.H)({card:!0,[`card-${e}`]:!!e,[`variant-${this.variant}`]:!0,[`ratio-${this.ratio}`]:!0})},PC=new WeakSet,DC=function(){return!!this.querySelector('[slot="media"]')},OC=new WeakSet,FC=function(){return this.src?d.qy`
      ...
      `:(0,o.jq)(this,PC,DC).call(this)?d.qy`
        <gds-flex
          padding="xs xs 0 xs"
          flex="1"
          aspect-ratio=${"square"===this.ratio?"1/1":"16/9"}
      ...
      `:null},UC=new WeakSet,JC=function(){return d.qy`
      <gds-card-linked
        padding="0"
        gap="0"
        href=${(0,a.J)(this.href)}
        ...
        rel=${(0,a.J)(this.rel)}
        variant=${this.variant}
        class=${(0,o.jq)(this,TC,RC).call(this,"linked")}
      >
        ${(0,o.jq)(this,oh,nh).call(this)}
      </gds-card-linked>
    `},QC=new WeakSet,XC=function(){return(0,F.z)((0,o.jq)(this,KC,YC).call(this,!0),()=>d.qy`
        <gds-flex
          font="detail-m-book"
          align-items="center"
          gap="s"
      ...
      `)},eh=new WeakSet,th=function(){return d.qy`
      <gds-card
        padding="0"
        gap="0"
        variant=${this.variant}
        class=${(0,o.jq)(this,TC,RC).call(this,"static")}
      >
        ${(0,o.jq)(this,oh,nh).call(this)}
      </gds-card>
    `},sh=new WeakSet,rh=function(){return(0,F.z)((0,o.jq)(this,KC,YC).call(this),()=>d.qy`
        <gds-flex font="detail-m-book" align-items="center" gap="s">
          <slot name="footer"></slot>
        </gds-flex>
      `)},oh=new WeakSet,nh=function(){return d.qy`
      ${(0,o.jq)(this,OC,FC).call(this)}
      <gds-flex flex-direction="column" gap="xl" padding="xl">
        ${(0,F.z)(!this.src&&!(0,o.jq)(this,PC,DC).call(this),()=>d.qy`<slot name="header"></slot>`)}
        ${(0,F.z)(this.title||this.excerpt,()=>d.qy`
          ...
          `)}
        ${(0,F.z)(this.href,()=>(0,o.jq)(this,QC,XC).call(this),()=>(0,o.jq)(this,sh,rh).call(this))}
      </gds-flex>
    `},lh.styles=[C.LU,ih],(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"title",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"excerpt",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"variant",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"tag",2),(0,o.Cc)([(0,i.MZ)({reflect:!1,attribute:"aspect-ratio"})],lh.prototype,"ratio",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"category",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"date",2),(0,o.Cc)([(0,i.MZ)({reflect:!1,attribute:"date-format"})],lh.prototype,"dateFormat",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],lh.prototype,"locale",2),lh=(0,o.Cc)([(0,d.Y$)("gds-card-pattern-01",{dependsOn:[Y.z,D,us,Rt,ot.o,WC,AC]})],lh);const ah=e=>{lh.define();const t=(0,L.pI)("gds-card-pattern-01"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};ah.displayName="GdsCardPattern01";var ch,dh,Ch,hh,ph,uh,gh,fh,mh,vh,Mh,bh,kh,Vh,yh,_h,wh,Lh,xh,Hh,Zh=s(5248),Sh=y.AH`
  :host {
    display: flex;
    align-items: center;
    gap: var(--gds-sys-space-s);
...
`;let $h=class extends(R(Zh.s)){constructor(){super(...arguments),(0,o.VK)(this,ch),(0,o.VK)(this,Ch),(0,o.VK)(this,ph),(0,o.VK)(this,gh),(0,o.VK)(this,mh),(0,o.VK)(this,Mh),(0,o.VK)(this,kh),(0,o.VK)(this,yh),(0,o.VK)(this,wh),(0,o.VK)(this,xh),this._isWrapped=!1,this._hasLead=!1,this.label="",this.selectable=!1,this.checked=!1,this.indeterminate=!1,this.disabled=!1,this._hasTrailContent=!1}_checkWrap(){const e=this._itemsContainer;if(!e)return;const t=Array.from(e.children);if(t.length<2)return void(this._isWrapped=!1);const s=t[0].getBoundingClientRect().top;this._isWrapped=t.some(e=>e.getBoundingClientRect().top>s)}updated(e){super.updated(e),e.has("href")&&(0,o.jq)(this,Ch,hh).call(this)}render(){return d.qy`${(0,o.jq)(this,xh,Hh).call(this)}`}};ch=new WeakSet,dh=function(){return!!this.href},Ch=new WeakSet,hh=function(){this._hasTrailContent=(0,o.S7)(this,ch,dh)||!!this._trailSlot?.assignedElements().length},ph=new WeakSet,uh=function(){const e=e=>{e.stopPropagation(),this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))};return d.qy`
      <div
        class="rbcb-wrapper"
        role="checkbox"
    ...
    `},gh=new WeakSet,fh=function(){return this.selectable?(0,o.jq)(this,ph,uh).call(this):d.qy``},mh=new WeakSet,vh=function(e,t=!1){return d.qy`
    ...
    `},Mh=new WeakSet,bh=function(e){const t=e.target;this._hasLead=t.assignedElements().length>0},kh=new WeakSet,Vh=function(e){const t=e.target;this._hasTrailContent=t.assignedElements().length>0||(0,o.S7)(this,ch,dh)},yh=new WeakSet,_h=function(){if(this.items&&this.items.length>0){const e=this.items.length>=3?"wrap":"nowrap",t=this.items.length>=2&&!this._isWrapped;return d.qy`
        <slot name="lead" @slotchange=${(0,o.jq)(this,Mh,bh)}></slot>
        <gds-flex
          ...
          flex-wrap=${e}
        >
          ${this.items.map((e,s)=>{const r=s===this.items.length-1;return(0,o.jq)(this,mh,vh).call(this,0===s&&this.label&&!e.label?{...e,label:this.label}:e,t&&r)})}
        </gds-flex>
        <slot></slot>
      `}return d.qy`<slot name="lead" @slotchange=${(0,o.jq)(this,Mh,bh)}></slot
      ><slot></slot>`},wh=new WeakSet,Lh=function(){const e=(0,l.H)({"has-content":this._hasTrailContent});return d.qy`
      <slot name="trail" @slotchange=${(0,o.jq)(this,kh,Vh)} class=${e}
        >${(0,F.z)(this.href,()=>d.qy`<gds-icon-chevron-right
              class="nav-chevron"
            ></gds-icon-chevron-right>`)}</slot
      >
    `},xh=new WeakSet,Hh=function(){if((0,o.S7)(this,ch,dh)&&this.selectable)return d.qy`
        ${(0,o.jq)(this,gh,fh).call(this)} ${(0,o.jq)(this,yh,_h).call(this)}
        <gds-button
          slot="trail"
          href=${(0,a.J)(this.href)}
          target=${(0,a.J)(this.target)}
          ...
          ><gds-icon-chevron-right></gds-icon-chevron-right
        ></gds-button>
      `;if((0,o.S7)(this,ch,dh)){const e=(0,l.H)({"has-lead":this._hasLead});return d.qy`
        ${(0,o.jq)(this,gh,fh).call(this)}
        <a
          class="linked-area ${e}"
          href=${(0,a.J)(this.href)}
          target=${(0,a.J)(this.target)}
          ...
          ping=${(0,a.J)(this.ping)}
        >
          ${(0,o.jq)(this,yh,_h).call(this)} ${(0,o.jq)(this,wh,Lh).call(this)}
        </a>
      `}return d.qy`${(0,o.jq)(this,gh,fh).call(this)} ${(0,o.jq)(this,yh,_h).call(this)}
    ${(0,o.jq)(this,wh,Lh).call(this)}`},$h.styles=[...C.LU,Q.A,Sh],(0,o.Cc)([(0,i.wk)()],$h.prototype,"_isWrapped",2),(0,o.Cc)([(0,i.wk)()],$h.prototype,"_hasLead",2),(0,o.Cc)([(0,i.P)(".items-container")],$h.prototype,"_itemsContainer",2),(0,o.Cc)([(0,i.P)('slot[name="trail"]')],$h.prototype,"_trailSlot",2),(0,o.Cc)([(0,As.b)()],$h.prototype,"_checkWrap",1),(0,o.Cc)([(0,i.MZ)({type:Array})],$h.prototype,"items",2),(0,o.Cc)([(0,i.MZ)({reflect:!0})],$h.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],$h.prototype,"selectable",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],$h.prototype,"checked",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],$h.prototype,"indeterminate",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],$h.prototype,"disabled",2),(0,o.Cc)([(0,i.wk)()],$h.prototype,"_hasTrailContent",2),$h=(0,o.Cc)([(0,d.Y$)("gds-list-item-pattern-01",{dependsOn:[ot.o,Rt,z.t,se.V,re,Rr.V]})],$h);const Ih=e=>{$h.define();const t=(0,L.pI)("gds-list-item-pattern-01"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Ih.displayName="GdsListItemPattern01";var Nh=y.AH`
  @layer tokens, core, sizes, shapes;
...
`;let jh=class extends((0,u.TM)((0,u.lt)(c.j))){connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","group")}render(){return d.qy`<slot></slot>`}};jh.styles=[C.LU,Nh],jh=(0,o.Cc)([(0,d.Y$)("gds-avatar-group")],jh);const Gh=e=>{jh.define();const t=(0,L.pI)("gds-avatar-group"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Gh.displayName="GdsAvatarGroup";var Eh,qh,Bh,zh,Wh,Ah,Kh,Yh,Th,Rh,Ph,Dh,Oh=y.AH`
  @layer base {
    :host {
      display: contents;
    }
...
`;let Fh=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,Eh),(0,o.VK)(this,Bh),(0,o.VK)(this,Wh),(0,o.VK)(this,Kh),(0,o.VK)(this,Th),(0,o.VK)(this,Ph),this.href="",this.label="",this.overflow=!1}render(){return d.qy`
      <div role="listitem" class="list-item">${(0,o.jq)(this,Bh,zh).call(this)}</div>
    `}};Eh=new WeakSet,qh=function(){return"_blank"===this.target?"noreferrer noopener":void 0},Bh=new WeakSet,zh=function(){return[(0,o.jq)(this,Wh,Ah).call(this)].map(e=>d.qy`${e}`)},Wh=new WeakSet,Ah=function(){return this.overflow?(0,o.jq)(this,Kh,Yh).call(this):this.href?(0,o.jq)(this,Th,Rh).call(this):(0,o.jq)(this,Ph,Dh).call(this)},Kh=new WeakSet,Yh=function(){return d.qy`<slot></slot>`},Th=new WeakSet,Rh=function(){return d.qy`
      <gds-link
        href=${(0,a.J)(this.href)}
        target=${(0,a.J)(this.target)}
        rel=${(0,a.J)(this.rel||(0,o.S7)(this,Eh,qh))}
        aria-label=${this.label||y.s6}
      >
        <slot name="lead"></slot>
        <slot></slot>
    ...
    `},Ph=new WeakSet,Dh=function(){return d.qy`
      <gds-text
        color="neutral-02"
        font-weight="regular"
    ...
    `},Fh.styles=[Oh],(0,o.Cc)([(0,i.MZ)()],Fh.prototype,"href",2),(0,o.Cc)([(0,i.MZ)()],Fh.prototype,"target",2),(0,o.Cc)([(0,i.MZ)()],Fh.prototype,"rel",2),(0,o.Cc)([(0,i.MZ)()],Fh.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Fh.prototype,"overflow",2),Fh=(0,o.Cc)([(0,d.Y$)("gds-breadcrumb",{dependsOn:[br,Rt]})],Fh);const Uh=e=>{Fh.define();const t=(0,L.pI)("gds-breadcrumb"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Uh.displayName="GdsBreadcrumb";const Jh=y.AH`
  :host {
    /* Font Sizes */
...
`;var Qh,Xh,ep,tp,sp,rp,op,np,ip,lp,ap,cp,dp,Cp,hp;let pp=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Xh),(0,o.VK)(this,tp),(0,o.VK)(this,rp),(0,o.VK)(this,np),(0,o.VK)(this,lp),(0,o.VK)(this,cp),(0,o.VK)(this,Cp),this.size="large",this.flexDirection="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,(0,o.VK)(this,Qh,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){(0,o.S7)(this,Qh).call(this)}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",(0,o.S7)(this,Qh))}render(){const e={"checkbox-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      role="group"
      id="checkboxgroup"
      class=${(0,l.H)(e)}
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,Xh,ep).call(this)}
    </div>`}_syncOnDOMChange(){(0,o.S7)(this,Qh).call(this),(0,o.jq)(this,lp,ap).call(this)}};Qh=new WeakMap,Xh=new WeakSet,ep=function(){return[(0,o.jq)(this,tp,sp).call(this),(0,o.jq)(this,rp,op).call(this),(0,o.jq)(this,Cp,hp).call(this)].map(e=>d.qy`${e}`)},tp=new WeakSet,sp=function(){if(this.label)return d.qy`<gds-form-control-header
        .showExtendedSupportingText=${this.showExtendedSupportingText}
      ...
      >
        ...
        <slot
          ...
          slot="extended-supporting-text"
        ></slot>
      </gds-form-control-header>`},rp=new WeakSet,op=function(){return d.qy`<div class="content">
      <slot @input=${(0,o.jq)(this,np,ip)}></slot>
    </div>`},np=new WeakSet,ip=function(e){e&&e.stopPropagation(),(0,o.jq)(this,lp,ap).call(this),(0,o.jq)(this,cp,dp).call(this)},lp=new WeakSet,ap=function(){const e=this.checkboxes.filter(e=>e.checked).map(e=>e.value);JSON.stringify(e)!==JSON.stringify(this.value)&&(this.value=e)},cp=new WeakSet,dp=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},Cp=new WeakSet,hp=function(){return d.qy`<gds-form-control-footer
      id="footer"
      class="size-${this.size}"
      .errorMessage=${this.invalid?this.errorMessage:void 0}
    >
    </gds-form-control-footer>`},pp.styles=[Jh],(0,o.Cc)([(0,i.MZ)()],pp.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({attribute:"flex-direction"})],pp.prototype,"flexDirection",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,attribute:"hide-label"})],pp.prototype,"hideLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],pp.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],pp.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Array})],pp.prototype,"value",1),(0,o.Cc)([(0,i.P)("#checkboxgroup")],pp.prototype,"_elCheckboxGroup",2),(0,o.Cc)([(0,ee.w)("value",{waitUntilFirstUpdate:!0})],pp.prototype,"_handleValueChange",1),(0,o.Cc)([(0,ee.w)("invalid"),(0,ee.w)("errorMessage")],pp.prototype,"_handleGroupInvalidChange",1),(0,o.Cc)([(0,Bo.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],pp.prototype,"_syncOnDOMChange",1),pp=(0,o.Cc)([(0,j.J)({labelledBy:"#checkboxgroup",describedBy:"#checkboxgroup",errorMessage:"#checkboxgroup"}),(0,N.cc)()],pp);let up=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(pp)))){};up=(0,o.Cc)([(0,d.Y$)("gds-checkbox-group",{dependsOn:[Bs.$,qs.V]})],up);const gp=e=>{up.define();const t=(0,L.pI)("gds-checkbox-group"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};gp.displayName="GdsCheckboxGroup";const fp=e=>{Te.define();const t=(0,L.pI)("gds-icon-details"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};fp.displayName="GdsIconDetails";var mp=s(1912);const vp=e=>{mp.x.define();const t=(0,L.pI)("gds-filter-chip"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};vp.displayName="GdsFilterChip";const Mp={"seb-account":e=>{const t="string"==typeof e?e.replace(" ",""):e?.toString()??"";return 11!==t.length?t:`${t.slice(0,4)} ${t.slice(4,6)} ${t.slice(6,9)} ${t.slice(9,11)}`}};let bp=class extends qC{constructor(){super(...arguments),this.format="seb-account"}get formattedValue(){return Mp[this.format](this.account)}firstUpdated(e){super.firstUpdated(e),!this.account&&this.textContent&&(this.account=this.textContent)}};(0,o.Cc)([(0,i.MZ)()],bp.prototype,"account",2),(0,o.Cc)([(0,i.MZ)({type:String})],bp.prototype,"format",2),bp=(0,o.Cc)([(0,d.Y$)("gds-formatted-account")],bp);const kp=e=>{bp.define();const t=(0,L.pI)("gds-formatted-account"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};kp.displayName="GdsFormattedAccount";const Vp=e=>{WC.define();const t=(0,L.pI)("gds-formatted-date"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Vp.displayName="GdsFormattedDate";const yp={decimalsAndThousands:(e,t,s,r)=>{const o={maximumFractionDigits:r??2,minimumFractionDigits:r??2};return s?new Intl.NumberFormat(t,{...o,style:"currency",currency:s}).format(Number(e)):new Intl.NumberFormat(t,o).format(Number(e))}};let _p=class extends qC{constructor(){super(...arguments),this.format="decimalsAndThousands"}get formattedValue(){return yp[this.format](this.value,this.locale,this.currency,this.decimals)}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};(0,o.Cc)([(0,i.MZ)({attribute:!1})],_p.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:String})],_p.prototype,"locale",2),(0,o.Cc)([(0,i.MZ)({type:String})],_p.prototype,"currency",2),(0,o.Cc)([(0,i.MZ)({type:Number})],_p.prototype,"decimals",2),(0,o.Cc)([(0,i.MZ)({type:String})],_p.prototype,"format",2),_p=(0,o.Cc)([(0,d.Y$)("gds-formatted-number")],_p);const wp=e=>{_p.define();const t=(0,L.pI)("gds-formatted-number"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};wp.displayName="GdsFormattedNumber";const Lp=e=>{Zh.s.define();const t=(0,L.pI)("gds-list-item"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Lp.displayName="GdsListItem";const xp=y.AH`
  :host {
    /* Font Sizes */
    --_font-label: var(--gds-sys-text-detail-m-book);
    --_font-supporting-text: var(--gds-sys-text-detail-s-regular);
...
`;var Hp,Zp,Sp,$p,Ip,Np,jp,Gp,Ep,qp,Bp,zp,Wp,Ap,Kp,Yp,Tp,Rp,Pp,Dp;let Op=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Hp),(0,o.VK)(this,Sp),(0,o.VK)(this,Ip),(0,o.VK)(this,jp),(0,o.VK)(this,Ep),(0,o.VK)(this,Bp),(0,o.VK)(this,Wp),(0,o.VK)(this,Kp),(0,o.VK)(this,Tp),(0,o.VK)(this,Pp),this.size="large",this.flexDirection="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),(0,o.jq)(this,Hp,Zp).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}focus(e){this._getValidityAnchor()?.focus(e)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{(0,o.jq)(this,Hp,Zp).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid,e.errorMessage=this.errorMessage})}render(){const e={"radio-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      role="radiogroup"
      id="radiogroup"
      class=${(0,l.H)(e)}
      aria-labelledby="group-label"
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,Wp,Ap).call(this)}
    </div>`}};Hp=new WeakSet,Zp=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(e=>e.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(e=>!e.checked).forEach(e=>e.setAttribute("tabindex","-1"))},Sp=new WeakSet,$p=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(e=>e.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))},Ip=new WeakSet,Np=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("change",{composed:!0,bubbles:!0})),this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},jp=new WeakSet,Gp=function(e){e.stopPropagation();const t=e.target;this.value=t.value,this._syncRadioStates(),(0,o.jq)(this,Ip,Np).call(this)},Ep=new WeakSet,qp=function(e){if(!this._isConnected)return;const t=this.radios.filter(e=>!e.disabled);if(0===t.length)return;let s=t.findIndex(e=>document.activeElement===e);switch(-1===s&&(s=t.findIndex(e=>e.checked),-1===s&&(s=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const r=(s+1)%t.length;(0,o.jq)(this,Bp,zp).call(this,t[r]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const r=(s-1+t.length)%t.length;(0,o.jq)(this,Bp,zp).call(this,t[r]);break}default:return}},Bp=new WeakSet,zp=function(e){this._contentElement&&this._isConnected&&(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),(0,o.jq)(this,Ip,Np).call(this))},Wp=new WeakSet,Ap=function(){return[(0,o.jq)(this,Kp,Yp).call(this),(0,o.jq)(this,Tp,Rp).call(this),(0,o.jq)(this,Pp,Dp).call(this)].map(e=>d.qy`${e}`)},Kp=new WeakSet,Yp=function(){if(this.label)return d.qy` <gds-form-control-header
        class="size-${this.size}"
        .showExtendedSupportingText="${this.showExtendedSupportingText}"
      >
        <label id="group-label" slot="label">${this.label}</label>
...
//# sourceMappingURL=1422.0429e70e.iframe.bundle.js.map