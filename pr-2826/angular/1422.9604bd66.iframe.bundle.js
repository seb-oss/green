...
`;var zh,Wh,Ah,Kh,Yh,Th,Rh,Ph,Dh,Oh,Fh,Uh,Jh,Qh,Xh;let ep=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Wh),(0,o.VK)(this,Kh),(0,o.VK)(this,Th),(0,o.VK)(this,Ph),(0,o.VK)(this,Oh),(0,o.VK)(this,Uh),(0,o.VK)(this,Qh),this.size="large",this.flexDirection="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,(0,o.VK)(this,zh,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){(0,o.S7)(this,zh).call(this)}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",(0,o.S7)(this,zh))}render(){const e={"checkbox-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      role="group"
      id="checkboxgroup"
      class=${(0,l.H)(e)}
    ...
    >
    ...
    </div>`}_syncOnDOMChange(){(0,o.S7)(this,zh).call(this),(0,o.jq)(this,Oh,Fh).call(this)}};zh=new WeakMap,Wh=new WeakSet,Ah=function(){return[(0,o.jq)(this,Kh,Yh).call(this),(0,o.jq)(this,Th,Rh).call(this),(0,o.jq)(this,Qh,Xh).call(this)].map(e=>d.qy`${e}`)},Kh=new WeakSet,Yh=function(){if(this.label)return d.qy`<gds-form-control-header
        .showExtendedSupportingText=${this.showExtendedSupportingText}
      ...
      <slot @input=${(0,o.jq)(this,Ph,Dh)}></slot>
    </div>`},Ph=new WeakSet,Dh=function(e){e&&e.stopPropagation(),(0,o.jq)(this,Oh,Fh).call(this),(0,o.jq)(this,Uh,Jh).call(this)},Oh=new WeakSet,Fh=function(){const e=this.checkboxes.filter(e=>e.checked).map(e=>e.value);JSON.stringify(e)!==JSON.stringify(this.value)&&(this.value=e)},Uh=new WeakSet,Jh=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},Qh=new WeakSet,Xh=function(){return d.qy`<gds-form-control-footer
      id="footer"
      class="size-${this.size}"
      .errorMessage=${this.invalid?this.errorMessage:void 0}
    >
    </gds-form-control-footer>`},ep.styles=[Bh],(0,o.Cc)([(0,i.MZ)()],ep.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({attribute:"flex-direction"})],ep.prototype,"flexDirection",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,attribute:"hide-label"})],ep.prototype,"hideLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],ep.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],ep.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Array})],ep.prototype,"value",1),(0,o.Cc)([(0,i.P)("#checkboxgroup")],ep.prototype,"_elCheckboxGroup",2),(0,o.Cc)([(0,ee.w)("value",{waitUntilFirstUpdate:!0})],ep.prototype,"_handleValueChange",1),(0,o.Cc)([(0,ee.w)("invalid"),(0,ee.w)("errorMessage")],ep.prototype,"_handleGroupInvalidChange",1),(0,o.Cc)([(0,Bo.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],ep.prototype,"_syncOnDOMChange",1),ep=(0,o.Cc)([(0,j.J)({labelledBy:"#checkboxgroup",describedBy:"#checkboxgroup",errorMessage:"#checkboxgroup"}),(0,N.cc)()],ep);let tp=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(ep)))){};tp=(0,o.Cc)([(0,d.Y$)("gds-checkbox-group",{dependsOn:[Bs.$,qs.V]})],tp);const sp=e=>{tp.define();const t=(0,L.pI)("gds-checkbox-group"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};sp.displayName="GdsCheckboxGroup";var rp,op,np,ip,lp,ap,cp,dp,Cp,hp,pp,up,gp=y.AH`
  @layer base {
    :host {
      display: contents;
    }
...
`;let fp=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,rp),(0,o.VK)(this,np),(0,o.VK)(this,lp),(0,o.VK)(this,cp),(0,o.VK)(this,Cp),(0,o.VK)(this,pp),this.href="",this.label="",this.overflow=!1}render(){return d.qy`
      <div role="listitem" class="list-item">${(0,o.jq)(this,np,ip).call(this)}</div>
    `}};rp=new WeakSet,op=function(){return"_blank"===this.target?"noreferrer noopener":void 0},np=new WeakSet,ip=function(){return[(0,o.jq)(this,lp,ap).call(this)].map(e=>d.qy`${e}`)},lp=new WeakSet,ap=function(){return this.overflow?(0,o.jq)(this,cp,dp).call(this):this.href?(0,o.jq)(this,Cp,hp).call(this):(0,o.jq)(this,pp,up).call(this)},cp=new WeakSet,dp=function(){return d.qy`<slot></slot>`},Cp=new WeakSet,hp=function(){return d.qy`
      <gds-link
        href=${(0,a.J)(this.href)}
        target=${(0,a.J)(this.target)}
        rel=${(0,a.J)(this.rel||(0,o.S7)(this,rp,op))}
        aria-label=${this.label||y.s6}
      >
        <slot name="lead"></slot>
        <slot></slot>
    ...
    `},pp=new WeakSet,up=function(){return d.qy`
      <gds-text
        color="neutral-02"
        font-weight="regular"
...
//# sourceMappingURL=1422.9604bd66.iframe.bundle.js.map