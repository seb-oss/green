...
`;var Ah,Kh,Yh,Th,Rh,Ph,Dh,Oh,Fh,Uh,Jh,Qh,Xh,ep,tp;let sp=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Kh),(0,o.VK)(this,Th),(0,o.VK)(this,Ph),(0,o.VK)(this,Oh),(0,o.VK)(this,Uh),(0,o.VK)(this,Qh),(0,o.VK)(this,ep),this.size="large",this.flexDirection="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,(0,o.VK)(this,Ah,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){(0,o.S7)(this,Ah).call(this)}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",(0,o.S7)(this,Ah))}render(){const e={"checkbox-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,Kh,Yh).call(this)}
    </div>`}_syncOnDOMChange(){(0,o.S7)(this,Ah).call(this),(0,o.jq)(this,Uh,Jh).call(this)}};Ah=new WeakMap,Kh=new WeakSet,Yh=function(){return[(0,o.jq)(this,Th,Rh).call(this),(0,o.jq)(this,Ph,Dh).call(this),(0,o.jq)(this,ep,tp).call(this)].map(e=>d.qy`${e}`)},Th=new WeakSet,Rh=function(){if(this.label)return d.qy`<gds-form-control-header
        .showExtendedSupportingText=${this.showExtendedSupportingText}
      ...
      >
        ...
        <slot
          ...
          slot="extended-supporting-text"
        ></slot>
      </gds-form-control-header>`},Ph=new WeakSet,Dh=function(){return d.qy`<div class="content">
      <slot @input=${(0,o.jq)(this,Oh,Fh)}></slot>
    </div>`},Oh=new WeakSet,Fh=function(e){e&&e.stopPropagation(),(0,o.jq)(this,Uh,Jh).call(this),(0,o.jq)(this,Qh,Xh).call(this)},Uh=new WeakSet,Jh=function(){const e=this.checkboxes.filter(e=>e.checked).map(e=>e.value);JSON.stringify(e)!==JSON.stringify(this.value)&&(this.value=e)},Qh=new WeakSet,Xh=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},ep=new WeakSet,tp=function(){return d.qy`<gds-form-control-footer
      id="footer"
      class="size-${this.size}"
      .errorMessage=${this.invalid?this.errorMessage:void 0}
    >
    </gds-form-control-footer>`},sp.styles=[Wh],(0,o.Cc)([(0,i.MZ)()],sp.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({attribute:"flex-direction"})],sp.prototype,"flexDirection",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,attribute:"hide-label"})],sp.prototype,"hideLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],sp.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],sp.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Array})],sp.prototype,"value",1),(0,o.Cc)([(0,i.P)("#checkboxgroup")],sp.prototype,"_elCheckboxGroup",2),(0,o.Cc)([(0,ee.w)("value",{waitUntilFirstUpdate:!0})],sp.prototype,"_handleValueChange",1),(0,o.Cc)([(0,ee.w)("invalid"),(0,ee.w)("errorMessage")],sp.prototype,"_handleGroupInvalidChange",1),(0,o.Cc)([(0,Bo.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],sp.prototype,"_syncOnDOMChange",1),sp=(0,o.Cc)([(0,j.J)({labelledBy:"#checkboxgroup",describedBy:"#checkboxgroup",errorMessage:"#checkboxgroup"}),(0,N.cc)()],sp);let rp=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(sp)))){};rp=(0,o.Cc)([(0,d.Y$)("gds-checkbox-group",{dependsOn:[Bs.$,qs.V]})],rp);const op=e=>{rp.define();const t=(0,L.pI)("gds-checkbox-group"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};op.displayName="GdsCheckboxGroup";var np,ip,lp,ap,cp,dp,Cp,hp,pp,up,gp,fp,mp=y.AH`
  @layer base {
    :host {
      display: contents;
    }
...
`;let vp=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,np),(0,o.VK)(this,lp),(0,o.VK)(this,cp),(0,o.VK)(this,Cp),(0,o.VK)(this,pp),(0,o.VK)(this,gp),this.href="",this.label="",this.overflow=!1}render(){return d.qy`
      <div role="listitem" class="list-item">${(0,o.jq)(this,lp,ap).call(this)}</div>
    `}};np=new WeakSet,ip=function(){return"_blank"===this.target?"noreferrer noopener":void 0},lp=new WeakSet,ap=function(){return[(0,o.jq)(this,cp,dp).call(this)].map(e=>d.qy`${e}`)},cp=new WeakSet,dp=function(){return this.overflow?(0,o.jq)(this,Cp,hp).call(this):this.href?(0,o.jq)(this,pp,up).call(this):(0,o.jq)(this,gp,fp).call(this)},Cp=new WeakSet,hp=function(){return d.qy`<slot></slot>`},pp=new WeakSet,up=function(){return d.qy`
      <gds-link
        href=${(0,a.J)(this.href)}
        target=${(0,a.J)(this.target)}
        rel=${(0,a.J)(this.rel||(0,o.S7)(this,np,ip))}
        aria-label=${this.label||y.s6}
      >
        <slot name="lead"></slot>
        <slot></slot>
    ...
    `},gp=new WeakSet,fp=function(){return d.qy`
      <gds-text
        color="neutral-02"
        font-weight="regular"
    ...
    `},vp.styles=[mp],(0,o.Cc)([(0,i.MZ)()],vp.prototype,"href",2),(0,o.Cc)([(0,i.MZ)()],vp.prototype,"target",2),(0,o.Cc)([(0,i.MZ)()],vp.prototype,"rel",2),(0,o.Cc)([(0,i.MZ)()],vp.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],vp.prototype,"overflow",2),vp=(0,o.Cc)([(0,d.Y$)("gds-breadcrumb",{dependsOn:[br,Rt]})],vp);const Mp=e=>{vp.define();const t=(0,L.pI)("gds-breadcrumb"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Mp.displayName="GdsBreadcrumb";var bp=s(1912);const kp=e=>{bp.x.define();const t=(0,L.pI)("gds-filter-chip"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};kp.displayName="GdsFilterChip";const Vp={"seb-account":e=>{const t="string"==typeof e?e.replace(" ",""):e?.toString()??"";return 11!==t.length?t:`${t.slice(0,4)} ${t.slice(4,6)} ${t.slice(6,9)} ${t.slice(9,11)}`}};let yp=class extends AC{constructor(){super(...arguments),this.format="seb-account"}get formattedValue(){return Vp[this.format](this.account)}firstUpdated(e){super.firstUpdated(e),!this.account&&this.textContent&&(this.account=this.textContent)}};(0,o.Cc)([(0,i.MZ)()],yp.prototype,"account",2),(0,o.Cc)([(0,i.MZ)({type:String})],yp.prototype,"format",2),yp=(0,o.Cc)([(0,d.Y$)("gds-formatted-account")],yp);const _p=e=>{yp.define();const t=(0,L.pI)("gds-formatted-account"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};_p.displayName="GdsFormattedAccount";const wp=e=>{Te.define();const t=(0,L.pI)("gds-icon-details"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};wp.displayName="GdsIconDetails";const Lp=e=>{TC.define();const t=(0,L.pI)("gds-formatted-date"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Lp.displayName="GdsFormattedDate";const xp={decimalsAndThousands:(e,t,s,r)=>{const o={maximumFractionDigits:r??2,minimumFractionDigits:r??2};return s?new Intl.NumberFormat(t,{...o,style:"currency",currency:s}).format(Number(e)):new Intl.NumberFormat(t,o).format(Number(e))}};let Hp=class extends AC{constructor(){super(...arguments),this.format="decimalsAndThousands"}get formattedValue(){return xp[this.format](this.value,this.locale,this.currency,this.decimals)}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};(0,o.Cc)([(0,i.MZ)({attribute:!1})],Hp.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:String})],Hp.prototype,"locale",2),(0,o.Cc)([(0,i.MZ)({type:String})],Hp.prototype,"currency",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Hp.prototype,"decimals",2),(0,o.Cc)([(0,i.MZ)({type:String})],Hp.prototype,"format",2),Hp=(0,o.Cc)([(0,d.Y$)("gds-formatted-number")],Hp);const Zp=e=>{Hp.define();const t=(0,L.pI)("gds-formatted-number"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Zp.displayName="GdsFormattedNumber";const Sp=e=>{Nh.s.define();const t=(0,L.pI)("gds-list-item"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Sp.displayName="GdsListItem";const $p=y.AH`
  :host {
    /* Font Sizes */
    --_font-label: var(--gds-sys-text-detail-m-book);
    --_font-supporting-text: var(--gds-sys-text-detail-s-regular);
...
//# sourceMappingURL=1422.deb44c5a.iframe.bundle.js.map