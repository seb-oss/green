...
`;let d=class extends a.o{constructor(){super(...arguments),this.dividers=!1,(0,o.VK)(this,r,e=>{if(!this.dividers)return;const t=e.target.closest?.("[href]:not([selectable])");t?.parentElement===this&&t.previousElementSibling?.toggleAttribute("hide-prev-border","pointerover"===e.type)})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","list"),this.addEventListener("pointerover",(0,o.S7)(this,r)),this.addEventListener("pointerout",(0,o.S7)(this,r))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("pointerover",(0,o.S7)(this,r)),this.removeEventListener("pointerout",(0,o.S7)(this,r))}render(){return i.qy`<slot></slot>`}};r=new WeakMap,d.styles=[l.LU,c],(0,o.Cc)([(0,n.MZ)({type:Boolean,reflect:!0})],d.prototype,"dividers",2),d=(0,o.Cc)([(0,i.Y$)("gds-list")],d)},3095(e,t,s){"use strict";s.d(t,{F:()=>i}),s(745);var r=s(6506),o=s(7593),n=s(9633);const i=e=>{o.F.define();const t=(0,n.pI)("gds-alert"),s={...e,class:e.className,ref:e.ref};return(0,r.createElement)(t,s)};i.displayName="GdsAlert"},2022(e,t,s){"use strict";s.d(t,{o:()=>i}),s(745);var r=s(6506),o=s(8833),n=s(9633);const i=e=>{o.o.define();const t=(0,n.pI)("gds-div"),s={...e,class:e.className,ref:e.ref};return(0,r.createElement)(t,s)};i.displayName="GdsDiv"},1083(e,t,s){"use strict";s.r(t),s.d(t,{GdsAlert:()=>r.F,GdsAvatar:()=>x,GdsAvatarGroup:()=>qh,GdsBackdrop:()=>$o,GdsBadge:()=>Z,GdsBlur:()=>I,GdsBreadcrumb:()=>Qh,GdsBreadcrumbs:()=>B,GdsButton:()=>W,GdsCalendar:()=>O,GdsCard:()=>K,GdsCardLinked:()=>P,GdsCardPattern01:()=>dh,GdsCheckbox:()=>pe,GdsCheckboxGroup:()=>mp,GdsCoachmark:()=>Be,GdsContextMenu:()=>We,GdsDatepicker:()=>Ke,GdsDetails:()=>tt,GdsDialog:()=>Lt,GdsDiv:()=>xt.o,GdsDivider:()=>St,GdsDropdown:()=>It,GdsFab:()=>Gt,GdsFilterChip:()=>bp,GdsFilterChips:()=>qt,GdsFlex:()=>Bt,GdsFormSummary:()=>is,GdsFormattedAccount:()=>yp,GdsFormattedDate:()=>_p,GdsFormattedNumber:()=>xp,GdsGrid:()=>Cs,GdsGroupedList:()=>as,GdsIconDetails:()=>vp,GdsImg:()=>gs,GdsInput:()=>fr,GdsLink:()=>kr,GdsList:()=>yr,GdsListItem:()=>Hp,GdsListItemPattern01:()=>jh,GdsMask:()=>Lr,GdsMenuButton:()=>Zo,GdsMenuHeading:()=>mw,GdsMenuItem:()=>uw,GdsOption:()=>Mw,GdsPagination:()=>Vo,GdsPopover:()=>Io,GdsRadio:()=>qo,GdsRadioGroup:()=>Qp,GdsRichText:()=>Ao,GdsSegment:()=>Xp,GdsSegmentedControl:()=>rn,GdsSelect:()=>_n,GdsSensitiveAccount:()=>tu,GdsSensitiveDate:()=>ru,GdsSensitiveNumber:()=>nu,GdsSignal:()=>xn,GdsSlider:()=>Vi,GdsSpinner:()=>Hi,GdsSwitch:()=>Oi,GdsTab:()=>iu,GdsTabPanel:()=>lu,GdsTable:()=>zd,GdsTabs:()=>IC,GdsText:()=>NC,GdsTextarea:()=>jC,GdsTheme:()=>GC.G,GdsVideo:()=>BC,IconAi:()=>cu,IconAirplaneUp:()=>Cu,IconArchive:()=>pu,IconArrow:()=>dg,IconArrowBottomTop:()=>gu,IconArrowBoxLeft:()=>Mu,IconArrowBoxLeftAlt:()=>mu,IconArrowBoxRight:()=>ku,IconArrowDown:()=>yu,IconArrowInbox:()=>wu,IconArrowLeft:()=>Zu,IconArrowLeftRight:()=>xu,IconArrowOutOfBox:()=>$u,IconArrowRight:()=>zu,IconArrowRightCircle:()=>Nu,IconArrowRightDownCircle:()=>Gu,IconArrowRightUpCircle:()=>qu,IconArrowRotateClockwise:()=>Au,IconArrowRotateCounterClockwise:()=>Yu,IconArrowRotateLeftRight:()=>Ru,IconArrowRotateRightLeft:()=>Du,IconArrowShareLeft:()=>Fu,IconArrowShareRight:()=>Ju,IconArrowSplit:()=>Xu,IconArrowUp:()=>eg,IconArrowWallDown:()=>sg,IconArrowWallLeft:()=>og,IconArrowWallRight:()=>ig,IconArrowWallUp:()=>ag,IconArrowsRepeatRight:()=>hg,IconAsterisk:()=>ug,IconAt:()=>fg,IconBack:()=>vg,IconBackward:()=>bg,IconBag:()=>Vg,IconBank:()=>_g,IconBanknote:()=>Hg,IconBanknote2:()=>Lg,IconBarcode:()=>Sg,IconBarsThree:()=>Ig,IconBarsTwo:()=>jg,IconBasket:()=>Eg,IconBatteryLoading:()=>Bg,IconBell:()=>Wg,IconBlock:()=>Kg,IconBook:()=>Tg,IconBookmark:()=>ef,IconBookmarkCheck:()=>Pg,IconBookmarkDelete:()=>Og,IconBookmarkPlus:()=>Ug,IconBookmarkRemove:()=>Qg,IconBooks:()=>sf,IconBrandAppStore:()=>of,IconBrandAppleMusic:()=>lf,IconBrandBankid:()=>cf,IconBrandChrome:()=>Cf,IconBrandFacebook:()=>pf,IconBrandFigma:()=>gf,IconBrandFirefox:()=>mf,IconBrandGithub:()=>Mf,IconBrandGreen:()=>kf,IconBrandInstagram:()=>yf,IconBrandLinkedin:()=>wf,IconBrandPlayStore:()=>xf,IconBrandRssFeed:()=>Zf,IconBrandSeb:()=>$f,IconBrandSpotify:()=>Nf,IconBrandStorybook:()=>Gf,IconBrandSwishWord:()=>qf,IconBrandX:()=>zf,IconBrush:()=>Af,IconBubbleAnnotation:()=>Yf,IconBubbles:()=>Rf,IconBuildings:()=>Df,IconBulletList:()=>Ff,IconCalculator:()=>Jf,IconCalendar:()=>rm,IconCalendarCheck:()=>Xf,IconCalendarRepeat:()=>tm,IconCalenderAdd:()=>nm,IconCall:()=>lm,IconCar:()=>cm,IconCarussel:()=>Cm,IconChainLink:()=>um,IconChainLinkBroken:()=>pm,IconChartTwo:()=>fm,IconChecklist:()=>vm,IconCheckmark:()=>Mm,IconChevronBottom:()=>bm,IconChevronDoubleDown:()=>Vm,IconChevronDoubleLeft:()=>ym,IconChevronDoubleRight:()=>_m,IconChevronDoubleUp:()=>Lm,IconChevronDownSmall:()=>Hm,IconChevronGrabberVertical:()=>Sm,IconChevronGrabberVerticalReversed:()=>Zm,IconChevronLeft:()=>Im,IconChevronLeftSmall:()=>$m,IconChevronRight:()=>jm,IconChevronRightSmall:()=>Nm,IconChevronTop:()=>qm,IconChevronTopSmall:()=>Em,IconCircleBan:()=>zm,IconCircleCheck:()=>Am,IconCircleDots:()=>Ym,IconCircleInfo:()=>Rm,IconCircleMinus:()=>Dm,IconCirclePlaceholderOn:()=>Fm,IconCirclePlus:()=>Jm,IconCircleQuestionmark:()=>Xm,IconCircleX:()=>tv,IconCirclesThree:()=>rv,IconClock:()=>nv,IconCloudDownload:()=>lv,IconCloudUpload:()=>cv,IconCloudySun:()=>Cv,IconCode:()=>gv,IconCodeBrackets:()=>pv,IconCompassRound:()=>mv,IconCookies:()=>Mv,IconCopy:()=>bv,IconCreditCard:()=>_v,IconCreditCardAdd:()=>Vv,IconCrossLarge:()=>wv,IconCrossSmall:()=>Lv,IconCupHot:()=>Hv,IconCursor:()=>Sv,IconDevices:()=>Iv,IconDirection:()=>jv,IconDollar:()=>Ev,IconDotGridOneHorizontal:()=>qv,IconDotGridOneVertical:()=>zv,IconDotGridThree:()=>Av,IconDotGridTwo:()=>Yv,IconEmail:()=>Rv,IconEmojiAngry:()=>Dv,IconEmojiNeutral:()=>Fv,IconEmojiSad:()=>Jv,IconEmojiSmile:()=>Xv,IconEmojiSmiley:()=>tM,IconEuro:()=>rM,IconExpand:()=>nM,IconEyeOpen:()=>lM,IconEyeSlash:()=>cM,IconFashion:()=>CM,IconFastForward:()=>pM,IconFileBend:()=>gM,IconFileChart:()=>mM,IconFileText:()=>MM,IconFiles:()=>kM,IconFilter:()=>yM,IconFlag:()=>wM,IconFloppyDisk:()=>xM,IconFocus:()=>ZM,IconFolder:()=>NM,IconFolderAddRight:()=>$M,IconFullscreen:()=>GM,IconGift:()=>qM,IconGlobus:()=>zM,IconGraduateCap:()=>AM,IconGreenPower:()=>YM,IconGroup:()=>RM,IconGrowth:()=>DM,IconHeadphones:()=>FM,IconHeart:()=>XM,IconHeartBeat:()=>JM,IconHistory:()=>tb,IconHomeEnergyOne:()=>rb,IconHomeEnergyTwo:()=>nb,IconHomeOpen:()=>lb,IconHomeRoof:()=>cb,IconHorizontalAlignmentBottom:()=>Cb,IconHourglass:()=>pb,IconImages:()=>gb,IconInboxEmpty:()=>mb,IconIndustry:()=>Mb,IconJpg:()=>kb,IconKey:()=>yb,IconKnifeSpoon:()=>wb,IconLab:()=>xb,IconLaw:()=>Zb,IconLeisure:()=>$b,IconLightBulbSimple:()=>Nb,IconLightning:()=>Gb,IconLineChartFour:()=>qb,IconLineChartOne:()=>zb,IconLineChartThree:()=>Ab,IconLineChartTwo:()=>Yb,IconLock:()=>Rb,IconMacbookAir:()=>Db,IconMagnifyingGlass:()=>Ob,IconMapPin:()=>Ub,IconMegaphone:()=>Qb,IconMenuSidebar:()=>ek,IconMicOff:()=>sk,IconMicOn:()=>ok,IconMinimize:()=>ik,IconMinusLarge:()=>ak,IconMinusSmall:()=>ck,IconMoneyHand:()=>Ck,IconMoneybag:()=>pk,IconMoon:()=>gk,IconMute:()=>mk,IconNewspaper:()=>Mk,IconOffice:()=>kk,IconPageAdd:()=>yk,IconPaperPlaneTopRight:()=>wk,IconPaperclip:()=>xk,IconPause:()=>Zk,IconPdf:()=>$k,IconPencilSign:()=>Nk,IconPencilSparkle:()=>Gk,IconPencilWave:()=>qk,IconPension:()=>zk,IconPeople:()=>eV,IconPeopleA11y:()=>Ak,IconPeopleAdd:()=>Yk,IconPeopleAdded:()=>Rk,IconPeopleCircle:()=>Dk,IconPeopleCopy:()=>Fk,IconPeopleProfile:()=>Uk,IconPeopleRemove:()=>Qk,IconPercent:()=>sV,IconPhone:()=>oV,IconPieChart:()=>iV,IconPiggyBank:()=>aV,IconPin:()=>dV,IconPinch:()=>hV,IconPlay:()=>fV,IconPlayCircle:()=>uV,IconPlusLarge:()=>vV,IconPlusSmall:()=>bV,IconPng:()=>VV,IconPoop:()=>_V,IconPostcard:()=>LV,IconPound:()=>HV,IconPower:()=>IV,IconPowerPlant:()=>SV,IconPrinter:()=>jV,IconPush:()=>EV,IconQrCode:()=>BV,IconRainy:()=>WV,IconRaisingHand:()=>KV,IconReadingList:()=>TV,IconReceiptBill:()=>PV,IconReceiptionBell:()=>OV,IconRecord:()=>UV,IconRefund:()=>QV,IconRobot:()=>ey,IconRocket:()=>sy,IconRunShortcut:()=>oy,IconSafari:()=>iy,IconSchool:()=>ay,IconScissors:()=>dy,IconSearchMenu:()=>hy,IconSettingsGear:()=>uy,IconSettingsSliderHor:()=>fy,IconSettingsSliderVer:()=>vy,IconShapes:()=>by,IconShare:()=>Vy,IconShield:()=>Hy,IconShieldChecked:()=>_y,IconShieldCrossed:()=>Ly,IconShoppingBag:()=>Sy,IconSignature:()=>Iy,IconSmartwatch:()=>jy,IconSolar:()=>Ey,IconSort:()=>Yy,IconSortAscending:()=>By,IconSortDescending:()=>Wy,IconSortDown:()=>Ay,IconSortUp:()=>Ky,IconSquareArrowTopRight:()=>Ry,IconSquareBehindSquare:()=>Dy,IconSquareGridCircle:()=>Fy,IconSquarePlaceholder:()=>Jy,IconStar:()=>Xy,IconStore:()=>t_,IconSun:()=>r_,IconSunsetArrowDown:()=>n_,IconTag:()=>l_,IconTargetArrow:()=>c_,IconTelevision:()=>C_,IconTennis:()=>p_,IconTextEdit:()=>g_,IconThermostat:()=>m_,IconThumbsDown:()=>M_,IconThumbsUp:()=>k_,IconTicket:()=>y_,IconTradingViewCandles:()=>w_,IconTrashCan:()=>x_,IconTree:()=>Z_,IconTrendingFive:()=>$_,IconTrendingFour:()=>N_,IconTrendingOne:()=>G_,IconTrendingThree:()=>q_,IconTrendingTwo:()=>z_,IconTriangleExclamation:()=>A_,IconTruck:()=>Y_,IconUmbrellaSecurity:()=>R_,IconUnlocked:()=>D_,IconVolumeFull:()=>F_,IconVolumeHalf:()=>J_,IconVolumeOff:()=>X_,IconWallet:()=>tw,IconWarningSign:()=>rw,IconWifiFull:()=>nw,IconYoutube:()=>lw,IconZap:()=>cw,IconZoomIn:()=>Cw,IconZoomOut:()=>pw});var r=s(3095),o=s(745),n=s(6506),i=s(4367),l=s(3578),a=s(4652),c=s(3539),d=s(7526),C=s(5073),h=s(9399),p=s(4508),u=s(4987),g=s(3832);let f=class extends g.M{};f._regularSVG='<path d="M15.75 6.5C15.75 8.57107 14.0711 10.25 12 10.25C9.92893 10.25 8.25 8.57107 8.25 6.5C8.25 4.42893 9.92893 2.75 12 2.75C14.0711 2.75 15.75 4.42893 15.75 6.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 13.25C7.8098 13.25 4.86894 16.3254 4.5 20.25H19.5C19.1311 16.3254 16.1902 13.25 12 13.25Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>',f._solidSVG='<path d="M12 2C9.51472 2 7.5 4.01472 7.5 6.5C7.5 8.98528 9.51472 11 12 11C14.4853 11 16.5 8.98528 16.5 6.5C16.5 4.01472 14.4853 2 12 2Z" fill="currentColor"/><path d="M12 12.5C7.38412 12.5 4.15473 15.9097 3.7533 20.1798C3.73354 20.39 3.80328 20.5988 3.94541 20.7549C4.08754 20.911 4.28888 21 4.5 21H19.5C19.7111 21 19.9125 20.911 20.0546 20.7549C20.1967 20.5988 20.2665 20.39 20.2467 20.1798C19.8453 15.9097 16.6159 12.5 12 12.5Z" fill="currentColor"/>',f._name="people-profile",f._width=24,f._height=24,f._viewBox="0 0 24 24",f=(0,o.Cc)([(0,d.Y$)("gds-icon-people-profile")],f);var m,v,M,b,k,V,y=s(9443),_=y.AH`
...
`;let R=class extends(Y(A.z)){render(){return d.qy`<a
    ...
    >
      <slot></slot>
    </a>`}};R.styles=[C.LU,T],R.styleExpressionBaseSelector="a",R=(0,o.Cc)([(0,d.Y$)("gds-card-linked")],R);const P=e=>{R.define();const t=(0,L.pI)("gds-card-linked"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};P.displayName="GdsCardLinked";var D=s(5495);const O=e=>{D.x.define();const t=(0,L.pI)("gds-calendar"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};O.displayName="GdsCalendar";var F=s(505),U=y.AH`
  @layer base, a11y;
...
`;let br=class extends((0,u.TM)((0,u.Q8)((0,u.lt)(Y(c.j))))){constructor(){super(...arguments),(0,o.VK)(this,mr),this.label=""}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none")}render(){return Kt.qy`
      <a
        href=${(0,a.J)(this.href)}
        target=${(0,a.J)(this.target)}
...
`;var qr,Br,zr,Wr,Ar,Kr,Yr,Tr,Rr,Pr,Dr,Or,Fr,Ur,Jr,Qr,Xr,eo,to,so,ro,oo,no,io,lo,ao,co,Co,ho,po,uo,go,fo,mo,vo,Mo;const bo={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let ko=class extends((0,u.TM)((0,u.Q8)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,qr),(0,o.VK)(this,zr),(0,o.VK)(this,Ar),(0,o.VK)(this,Yr),(0,o.VK)(this,Rr),(0,o.VK)(this,Dr),(0,o.VK)(this,Fr),(0,o.VK)(this,Jr),(0,o.VK)(this,Xr),(0,o.VK)(this,to),(0,o.VK)(this,ro),(0,o.VK)(this,no),(0,o.VK)(this,lo),(0,o.VK)(this,co),(0,o.VK)(this,ho),(0,o.VK)(this,uo),(0,o.VK)(this,fo),(0,o.VK)(this,vo),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.simple=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(e){this._isMobile=e}render(){const e=(0,o.S7)(this,qr,Br)>1,t=(0,o.jq)(this,lo,ao).call(this);return e||t?d.qy`
      <nav aria-label="${this.label||(0,N.ab)("Pagination")}">
        <gds-flex
          align-items="center"
          justify-content="space-between"
          width="100%"
          gap="${(0,o.S7)(this,zr,Wr).gap}"
        >
          ...
          >
            ${[(0,F.z)(e,()=>this.simple?(0,o.jq)(this,ro,oo).call(this):(0,o.jq)(this,to,so).call(this)),t]}
          </gds-flex>
        </gds-flex>
      </nav>
    `:y.s6}};qr=new WeakSet,Br=function(){return Math.ceil(this.total/this.rows)},zr=new WeakSet,Wr=function(){return bo[this.density]},Ar=new WeakSet,Kr=function(e){if(e<=7)return Array.from({length:e},(e,t)=>t+1);const t=e,s=[];return s.push(1),this.page<=4?s.push(2,3,4,5,"...",t):this.page>=e-3?s.push("...",e-4,e-3,e-2,e-1,t):s.push("...",this.page-1,this.page,this.page+1,"...",t),s},Yr=new WeakSet,Tr=function(e){if("..."===e)return d.qy`
        <gds-popover
          disableMobileStyles
          @gds-ui-state=${(0,o.jq)(this,fo,mo)}
        >
          <gds-button
            size="${(0,o.S7)(this,zr,Wr).button}"
            rank="tertiary"
            slot="trigger"
          ...
          <gds-flex
            flex-direction="column"
            padding="${(0,o.S7)(this,zr,Wr).inputPadding}"
            width="${(0,o.S7)(this,zr,Wr).inputWidth}"
            max-height="280px"
          >
            <gds-input
              size="${(0,o.S7)(this,zr,Wr).input}"
              label="${(0,N.ab)("Go to page")}"
              type="number"
              min="1"
              max="${(0,o.S7)(this,qr,Br)}"
              @change=${(0,o.jq)(this,vo,Mo)}
            >
              <gds-button
                size="xs"
                label="${(0,N.ab)("Go")}"
                rank="secondary"
                @click=${(0,o.jq)(this,vo,Mo)}
                slot="trail"
              >
    ...
    `},Rr=new WeakSet,Pr=function(){const e=(0,o.S7)(this,qr,Br),t=(0,o.jq)(this,Ar,Kr).call(this,e);return d.qy`${t.map(e=>(0,o.jq)(this,Yr,Tr).call(this,e))}`},Dr=new WeakSet,Or=function(){return d.qy`
      <gds-button
        size="${(0,o.S7)(this,zr,Wr).button}"
        rank="secondary"
    ...
    `},Fr=new WeakSet,Ur=function(){return d.qy`
      <gds-button
        size="${(0,o.S7)(this,zr,Wr).button}"
        rank="secondary"
    ...
    `},Jr=new WeakSet,Qr=function(){const e=(0,o.S7)(this,qr,Br);return d.qy`
      <gds-button
        size="${(0,o.S7)(this,zr,Wr).button}"
        rank="secondary"
    ...
    `},Xr=new WeakSet,eo=function(){const e=(0,o.S7)(this,qr,Br);return d.qy`
      <gds-button
        size="${(0,o.S7)(this,zr,Wr).button}"
        rank="secondary"
    ...
    `},to=new WeakSet,so=function(){return d.qy`
      <gds-flex
        gap="${(0,o.S7)(this,zr,Wr).navGap}"
        align-items="center"
        class="navigation-controls"
        justify-content="center; m{flex-end}"
        flex="1"
      >
        ${[(0,F.z)(this.jump,()=>(0,o.jq)(this,Dr,Or).call(this)),(0,o.jq)(this,Fr,Ur).call(this)]}
        <gds-flex gap="4xs" align-items="center">
          ${(0,o.jq)(this,Rr,Pr).call(this)}
        </gds-flex>
        ${[(0,o.jq)(this,Jr,Qr).call(this),(0,F.z)(this.jump,()=>(0,o.jq)(this,Xr,eo).call(this))]}
      </gds-flex>
    `},ro=new WeakSet,oo=function(){return d.qy`
      <gds-flex
        gap="${(0,o.S7)(this,zr,Wr).navGap}"
        align-items="center"
        ...
        flex="1"
      >
        ${(0,o.jq)(this,Fr,Ur).call(this)}
        <gds-text
          font="${(0,o.S7)(this,zr,Wr).font}"
          color="neutral-01"
          aria-live="polite"
          aria-atomic="true"
        >
        ...
        ${(0,o.jq)(this,Jr,Qr).call(this)}
      </gds-flex>
    `},no=new WeakSet,io=function(e){const t=this.rows===e;return d.qy`
      <gds-menu-item
        data-value=${e}
    ...
    `},lo=new WeakSet,ao=function(){if(this._isMobile||this.hideOptions||this.options.length<=1)return null;const e=`${(0,N.ab)("Rows per page")}, ${this.rows} ${(0,N.ab)("selected")}`;return d.qy`
      <gds-flex align-items="center" gap="s">
        ...
        <gds-context-menu @gds-menu-item-click=${(0,o.jq)(this,uo,go)}>
          ...
          ${this.options.map(e=>(0,o.jq)(this,no,io).call(this,e))}
        </gds-context-menu>
      </gds-flex>
    ...
    `},ho=new WeakSet,po=function(e){this.dispatchCustomEvent("gds-page-change",{detail:{page:e},bubbles:!0})},uo=new WeakSet,go=function(e){const t=e.target,s=parseInt(t.dataset.value||"10");s!==this.rows&&this.dispatchCustomEvent("gds-rows-change",{detail:{rows:s},bubbles:!0})},fo=new WeakSet,mo=function(e){if(this._jumpPopoverOpen=e.detail.open,e.detail.open){const t=e.target.querySelector('[gds-element="gds-input"]');t&&requestAnimationFrame(()=>{t.focus()})}},vo=new WeakSet,Mo=function(e){const t=e.target.closest('[gds-element="gds-input"]');if(t){const e=parseInt(t.value,10);if(e&&e>=1&&e<=(0,o.S7)(this,qr,Br)){(0,o.jq)(this,ho,po).call(this,e);const s=t.closest('[gds-element="gds-popover"]');s&&(s.open=!1)}}},ko.styles=[C.LU,Er],(0,o.Cc)([(0,i.MZ)({type:Number})],ko.prototype,"page",2),(0,o.Cc)([(0,i.MZ)({type:Number})],ko.prototype,"rows",2),(0,o.Cc)([(0,i.MZ)({type:Number})],ko.prototype,"total",2),(0,o.Cc)([(0,i.MZ)({type:Array})],ko.prototype,"options",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],ko.prototype,"jump",2),(0,o.Cc)([(0,i.MZ)({attribute:"hide-options",type:Boolean,reflect:!1})],ko.prototype,"hideOptions",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],ko.prototype,"simple",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],ko.prototype,"density",2),(0,o.Cc)([(0,i.MZ)()],ko.prototype,"label",2),(0,o.Cc)([(0,i.P)("#page-input")],ko.prototype,"_elInput",2),(0,o.Cc)([(0,i.wk)()],ko.prototype,"_isMobile",2),(0,o.Cc)([(0,i.wk)()],ko.prototype,"_jumpPopoverOpen",2),(0,o.Cc)([(0,xr.M)("(max-width: 768px)")],ko.prototype,"_handleMobile",1),ko=(0,o.Cc)([(0,N.cc)(),(0,d.Y$)("gds-pagination",{dependsOn:[z.t,Gr.E,Rt,gr,$t.E,ze.Hx,Hr.T,Zr.o,Ir,Sr,jr.V,Nr,$r]}),(0,j.J)({labelledBy:"nav",describedBy:"nav"})],ko);const Vo=e=>{ko.define();const t=(0,L.pI)("gds-pagination"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Vo.displayName="GdsPagination";var yo,_o,wo,Lo,xo=y.AH`
...
`;let Ho=class extends((0,u.Q8)((0,u.lt)(c.j))){constructor(){super(),(0,o.VK)(this,yo),(0,o.VK)(this,wo),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const e={button:!0,selected:this.selected,compact:this.compact},t=(0,o.S7)(this,yo,_o)?Kt.eu`a`:Kt.eu`button`;return Kt.qy`
      <${t}
        class="${(0,l.H)(e)}"
        ?disabled="${this.disabled}"
        aria-label="${this.label}"
        href=${(0,a.J)((0,o.S7)(this,yo,_o)?this.href:void 0)}
        target=${(0,a.J)((0,o.S7)(this,yo,_o)?this.target:void 0)}
        rel=${(0,a.J)((0,o.S7)(this,yo,_o)?this.rel||(0,o.S7)(this,wo,Lo):void 0)}
        download=${(0,a.J)((0,o.S7)(this,yo,_o)?this.download:void 0)}
      >
        <slot name="lead"></slot>
        <slot part="main-slot"></slot>
        <slot name="trail"></slot>
      </${t}>
    `}};yo=new WeakSet,_o=function(){return this.href.length>0},wo=new WeakSet,Lo=function(){return"_blank"===this.target?"noreferrer noopener":void 0},Ho.styles=[C.LU,xo],Ho.shadowRootOptions={mode:"open",delegatesFocus:!0},(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Ho.prototype,"disabled",2),(0,o.Cc)([(0,i.MZ)()],Ho.prototype,"label",2),(0,o.Cc)([(0,i.MZ)()],Ho.prototype,"href",2),(0,o.Cc)([(0,i.MZ)()],Ho.prototype,"target",2),(0,o.Cc)([(0,i.MZ)()],Ho.prototype,"rel",2),(0,o.Cc)([(0,i.MZ)()],Ho.prototype,"download",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Ho.prototype,"compact",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Ho.prototype,"selected",2),Ho=(0,o.Cc)([(0,d.Y$)("gds-menu-button"),(0,j.J)({labelledBy:"button",describedBy:"button",controls:"button"})],Ho);const Zo=e=>{Ho.define();const t=(0,L.pI)("gds-menu-button"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Zo.displayName="GdsMenuButton";let So=class extends c.j{constructor(){super(...arguments),this.show=!1}render(){return d.qy``}};So.styles=y.AH`
    :host {
      display: none;
      position: fixed;
      inset: 0;
...
`;let Vn=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,nn),(0,o.VK)(this,cn),(0,o.VK)(this,Cn),(0,o.VK)(this,pn),(0,o.VK)(this,gn),(0,o.VK)(this,mn),(0,o.VK)(this,Mn),this.supportingText="",this.showExtendedSupportingText=!1,this.size="large",this.plain=!1,(0,o.VK)(this,on,!1),(0,o.VK)(this,an,e=>{e.stopPropagation(),(0,o.jq)(this,cn,dn).call(this),requestAnimationFrame(()=>{this.dispatchCustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0}),this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})})})}get value(){return this._internalValue}set value(e){(0,o.S7)(this,on)||(0,o.OV)(this,on,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){return this.selectElement?.multiple??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}focus(e){this._getValidityAnchor()?.focus(e)}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),d.qy`
    ...
    `}_captureDOM(){if(!this.shadowRoot||0===this.childNodes.length||!this._elSelectContainer)return;const e=Array.from(this.children).filter(e=>"SELECT"===e.nodeName).map(e=>{const t=e.cloneNode(!0);return t.addEventListener("change",(0,o.S7)(this,an)),t.addEventListener("input",(0,o.S7)(this,an)),t.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),t.ariaLabel=this.label,t.setAttribute("id","select"),t.disabled=this.disabled,t.className="native-control",(0,o.S7)(this,on)?t.value=this.value:this._internalValue=t.value,t});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};on=new WeakMap,nn=new WeakSet,ln=function(){return!this.plain&&this.invalid},an=new WeakMap,cn=new WeakSet,dn=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(e=>e.value)}else this.value=this.selectElement.value},Cn=new WeakSet,hn=function(){return[(0,o.jq)(this,pn,un).call(this),(0,o.jq)(this,mn,vn).call(this),(0,o.jq)(this,gn,fn).call(this),(0,o.jq)(this,Mn,bn).call(this)].map(e=>d.qy`${e}`)},pn=new WeakSet,un=function(){return d.qy`<slot name="lead" slot="lead"></slot>`},gn=new WeakSet,fn=function(){if(!this.multiple)return d.qy`<label id="placeholder" class="native-control"
      ...
      `},Vn.styles=[C.LU,zs.A,kn],(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],Vn.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],Vn.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:String})],Vn.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],Vn.prototype,"plain",2),(0,o.Cc)([(0,i.P)("select")],Vn.prototype,"selectElement",2),(0,o.Cc)([(0,i.MZ)()],Vn.prototype,"value",1),(0,o.Cc)([(0,i.P)(".select-container")],Vn.prototype,"_elSelectContainer",2),(0,o.Cc)([(0,Bo.L)({childList:!0,subtree:!0,attributes:!0,characterData:!0})],Vn.prototype,"_captureDOM",1),(0,o.Cc)([(0,ee.w)("value")],Vn.prototype,"_handleValueChange",1),Vn=(0,o.Cc)([(0,j.J)({labelledBy:"select",describedBy:"select",errorMessage:"select"}),(0,N.cc)()],Vn);let yn=class extends((0,u.lt)((0,u.Q8)((0,u.TM)(Vn)))){};yn=(0,o.Cc)([(0,d.Y$)("gds-select",{dependsOn:[Bs.$,qs.V,Es.w,Zr.o]})],yn);const _n=e=>{yn.define();const t=(0,L.pI)("gds-select"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};_n.displayName="GdsSelect";var wn=y.AH`
  :host {
    display: inline-block;
  }
...
//# sourceMappingURL=1422.3a67398e.iframe.bundle.js.map