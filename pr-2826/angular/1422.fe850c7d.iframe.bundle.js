...
`;let d=class extends a.o{constructor(){super(...arguments),this.dividers=!1,(0,o.VK)(this,r,e=>{if(!this.dividers)return;const t=e.target.closest?.("[href]:not([selectable])");t?.parentElement===this&&t.previousElementSibling?.toggleAttribute("hide-prev-border","pointerover"===e.type)})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","list"),this.addEventListener("pointerover",(0,o.S7)(this,r)),this.addEventListener("pointerout",(0,o.S7)(this,r))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("pointerover",(0,o.S7)(this,r)),this.removeEventListener("pointerout",(0,o.S7)(this,r))}render(){return i.qy`<slot></slot>`}};r=new WeakMap,d.styles=[l.LU,c],(0,o.Cc)([(0,n.MZ)({type:Boolean,reflect:!0})],d.prototype,"dividers",2),d=(0,o.Cc)([(0,i.Y$)("gds-list")],d)},3095(e,t,s){"use strict";s.d(t,{F:()=>i}),s(745);var r=s(6506),o=s(7593),n=s(9633);const i=e=>{o.F.define();const t=(0,n.pI)("gds-alert"),s={...e,class:e.className,ref:e.ref};return(0,r.createElement)(t,s)};i.displayName="GdsAlert"},2022(e,t,s){"use strict";s.d(t,{o:()=>i}),s(745);var r=s(6506),o=s(8833),n=s(9633);const i=e=>{o.o.define();const t=(0,n.pI)("gds-div"),s={...e,class:e.className,ref:e.ref};return(0,r.createElement)(t,s)};i.displayName="GdsDiv"},1083(e,t,s){"use strict";s.r(t),s.d(t,{GdsAlert:()=>r.F,GdsAvatar:()=>x,GdsAvatarGroup:()=>zh,GdsBackdrop:()=>$o,GdsBadge:()=>Z,GdsBlur:()=>I,GdsBreadcrumb:()=>ep,GdsBreadcrumbs:()=>B,GdsButton:()=>W,GdsCalendar:()=>K,GdsCard:()=>T,GdsCardLinked:()=>O,GdsCardPattern01:()=>hh,GdsCheckbox:()=>pe,GdsCheckboxGroup:()=>Mp,GdsCoachmark:()=>Be,GdsContextMenu:()=>We,GdsDatepicker:()=>Ke,GdsDetails:()=>tt,GdsDialog:()=>Lt,GdsDiv:()=>xt.o,GdsDivider:()=>St,GdsDropdown:()=>It,GdsFab:()=>Gt,GdsFilterChip:()=>Vp,GdsFilterChips:()=>qt,GdsFlex:()=>Bt,GdsFormSummary:()=>is,GdsFormattedAccount:()=>wp,GdsFormattedDate:()=>Lp,GdsFormattedNumber:()=>Zp,GdsGrid:()=>cs,GdsGroupedList:()=>Cs,GdsIconDetails:()=>bp,GdsImg:()=>gs,GdsInput:()=>fr,GdsLink:()=>kr,GdsList:()=>yr,GdsListItem:()=>Sp,GdsListItemPattern01:()=>Eh,GdsMask:()=>Lr,GdsMenuButton:()=>Nr,GdsMenuHeading:()=>Mw,GdsMenuItem:()=>fw,GdsOption:()=>kw,GdsPagination:()=>Zo,GdsPopover:()=>Io,GdsRadio:()=>qo,GdsRadioGroup:()=>eu,GdsRichText:()=>Ao,GdsSegment:()=>tu,GdsSegmentedControl:()=>rn,GdsSelect:()=>_n,GdsSensitiveAccount:()=>ru,GdsSensitiveDate:()=>nu,GdsSensitiveNumber:()=>lu,GdsSignal:()=>xn,GdsSlider:()=>_i,GdsSpinner:()=>Si,GdsSwitch:()=>Ui,GdsTab:()=>au,GdsTabPanel:()=>cu,GdsTable:()=>Ad,GdsTabs:()=>jC,GdsText:()=>GC,GdsTextarea:()=>EC,GdsTheme:()=>qC.G,GdsVideo:()=>WC,IconAi:()=>Cu,IconAirplaneUp:()=>pu,IconArchive:()=>gu,IconArrow:()=>hg,IconArrowBottomTop:()=>mu,IconArrowBoxLeft:()=>ku,IconArrowBoxLeftAlt:()=>Mu,IconArrowBoxRight:()=>yu,IconArrowDown:()=>wu,IconArrowInbox:()=>xu,IconArrowLeft:()=>$u,IconArrowLeftRight:()=>Zu,IconArrowOutOfBox:()=>Nu,IconArrowRight:()=>Au,IconArrowRightCircle:()=>Gu,IconArrowRightDownCircle:()=>qu,IconArrowRightUpCircle:()=>zu,IconArrowRotateClockwise:()=>Yu,IconArrowRotateCounterClockwise:()=>Ru,IconArrowRotateLeftRight:()=>Du,IconArrowRotateRightLeft:()=>Fu,IconArrowShareLeft:()=>Ju,IconArrowShareRight:()=>Xu,IconArrowSplit:()=>tg,IconArrowUp:()=>sg,IconArrowWallDown:()=>og,IconArrowWallLeft:()=>ig,IconArrowWallRight:()=>ag,IconArrowWallUp:()=>dg,IconArrowsRepeatRight:()=>ug,IconAsterisk:()=>fg,IconAt:()=>vg,IconBack:()=>bg,IconBackward:()=>Vg,IconBag:()=>_g,IconBank:()=>Lg,IconBanknote:()=>Sg,IconBanknote2:()=>Hg,IconBarcode:()=>Ig,IconBarsThree:()=>jg,IconBarsTwo:()=>Eg,IconBasket:()=>Bg,IconBatteryLoading:()=>Wg,IconBell:()=>Kg,IconBlock:()=>Tg,IconBook:()=>Pg,IconBookmark:()=>sf,IconBookmarkCheck:()=>Og,IconBookmarkDelete:()=>Ug,IconBookmarkPlus:()=>Qg,IconBookmarkRemove:()=>ef,IconBooks:()=>of,IconBrandAppStore:()=>lf,IconBrandAppleMusic:()=>cf,IconBrandBankid:()=>Cf,IconBrandChrome:()=>pf,IconBrandFacebook:()=>gf,IconBrandFigma:()=>mf,IconBrandFirefox:()=>Mf,IconBrandGithub:()=>kf,IconBrandGreen:()=>yf,IconBrandInstagram:()=>wf,IconBrandLinkedin:()=>xf,IconBrandPlayStore:()=>Zf,IconBrandRssFeed:()=>$f,IconBrandSeb:()=>Nf,IconBrandSpotify:()=>Gf,IconBrandStorybook:()=>qf,IconBrandSwishWord:()=>zf,IconBrandX:()=>Af,IconBrush:()=>Yf,IconBubbleAnnotation:()=>Rf,IconBubbles:()=>Df,IconBuildings:()=>Ff,IconBulletList:()=>Jf,IconCalculator:()=>Xf,IconCalendar:()=>nm,IconCalendarCheck:()=>tm,IconCalendarRepeat:()=>rm,IconCalenderAdd:()=>lm,IconCall:()=>cm,IconCar:()=>Cm,IconCarussel:()=>pm,IconChainLink:()=>fm,IconChainLinkBroken:()=>gm,IconChartTwo:()=>vm,IconChecklist:()=>bm,IconCheckmark:()=>km,IconChevronBottom:()=>Vm,IconChevronDoubleDown:()=>_m,IconChevronDoubleLeft:()=>wm,IconChevronDoubleRight:()=>Lm,IconChevronDoubleUp:()=>Hm,IconChevronDownSmall:()=>Sm,IconChevronGrabberVertical:()=>Im,IconChevronGrabberVerticalReversed:()=>$m,IconChevronLeft:()=>jm,IconChevronLeftSmall:()=>Nm,IconChevronRight:()=>Em,IconChevronRightSmall:()=>Gm,IconChevronTop:()=>zm,IconChevronTopSmall:()=>Bm,IconCircleBan:()=>Am,IconCircleCheck:()=>Ym,IconCircleDots:()=>Rm,IconCircleInfo:()=>Dm,IconCircleMinus:()=>Fm,IconCirclePlaceholderOn:()=>Jm,IconCirclePlus:()=>Xm,IconCircleQuestionmark:()=>tv,IconCircleX:()=>rv,IconCirclesThree:()=>nv,IconClock:()=>lv,IconCloudDownload:()=>cv,IconCloudUpload:()=>Cv,IconCloudySun:()=>pv,IconCode:()=>mv,IconCodeBrackets:()=>gv,IconCompassRound:()=>Mv,IconCookies:()=>kv,IconCopy:()=>Vv,IconCreditCard:()=>Lv,IconCreditCardAdd:()=>_v,IconCrossLarge:()=>xv,IconCrossSmall:()=>Hv,IconCupHot:()=>Sv,IconCursor:()=>Iv,IconDevices:()=>jv,IconDirection:()=>Ev,IconDollar:()=>Bv,IconDotGridOneHorizontal:()=>zv,IconDotGridOneVertical:()=>Av,IconDotGridThree:()=>Yv,IconDotGridTwo:()=>Rv,IconEmail:()=>Dv,IconEmojiAngry:()=>Fv,IconEmojiNeutral:()=>Jv,IconEmojiSad:()=>Xv,IconEmojiSmile:()=>tM,IconEmojiSmiley:()=>rM,IconEuro:()=>nM,IconExpand:()=>lM,IconEyeOpen:()=>cM,IconEyeSlash:()=>CM,IconFashion:()=>pM,IconFastForward:()=>gM,IconFileBend:()=>mM,IconFileChart:()=>MM,IconFileText:()=>kM,IconFiles:()=>yM,IconFilter:()=>wM,IconFlag:()=>xM,IconFloppyDisk:()=>ZM,IconFocus:()=>$M,IconFolder:()=>GM,IconFolderAddRight:()=>NM,IconFullscreen:()=>qM,IconGift:()=>zM,IconGlobus:()=>AM,IconGraduateCap:()=>YM,IconGreenPower:()=>RM,IconGroup:()=>DM,IconGrowth:()=>FM,IconHeadphones:()=>JM,IconHeart:()=>tb,IconHeartBeat:()=>XM,IconHistory:()=>rb,IconHomeEnergyOne:()=>nb,IconHomeEnergyTwo:()=>lb,IconHomeOpen:()=>cb,IconHomeRoof:()=>Cb,IconHorizontalAlignmentBottom:()=>pb,IconHourglass:()=>gb,IconImages:()=>mb,IconInboxEmpty:()=>Mb,IconIndustry:()=>kb,IconJpg:()=>yb,IconKey:()=>wb,IconKnifeSpoon:()=>xb,IconLab:()=>Zb,IconLaw:()=>$b,IconLeisure:()=>Nb,IconLightBulbSimple:()=>Gb,IconLightning:()=>qb,IconLineChartFour:()=>zb,IconLineChartOne:()=>Ab,IconLineChartThree:()=>Yb,IconLineChartTwo:()=>Rb,IconLock:()=>Db,IconMacbookAir:()=>Fb,IconMagnifyingGlass:()=>Ub,IconMapPin:()=>Qb,IconMegaphone:()=>ek,IconMenuSidebar:()=>sk,IconMicOff:()=>ok,IconMicOn:()=>ik,IconMinimize:()=>ak,IconMinusLarge:()=>dk,IconMinusSmall:()=>Ck,IconMoneyHand:()=>pk,IconMoneybag:()=>gk,IconMoon:()=>mk,IconMute:()=>Mk,IconNewspaper:()=>kk,IconOffice:()=>yk,IconPageAdd:()=>wk,IconPaperPlaneTopRight:()=>xk,IconPaperclip:()=>Zk,IconPause:()=>$k,IconPdf:()=>Nk,IconPencilSign:()=>Gk,IconPencilSparkle:()=>qk,IconPencilWave:()=>zk,IconPension:()=>Ak,IconPeople:()=>sV,IconPeopleA11y:()=>Yk,IconPeopleAdd:()=>Rk,IconPeopleAdded:()=>Dk,IconPeopleCircle:()=>Fk,IconPeopleCopy:()=>Jk,IconPeopleProfile:()=>Qk,IconPeopleRemove:()=>eV,IconPercent:()=>oV,IconPhone:()=>iV,IconPieChart:()=>aV,IconPiggyBank:()=>dV,IconPin:()=>hV,IconPinch:()=>uV,IconPlay:()=>vV,IconPlayCircle:()=>fV,IconPlusLarge:()=>bV,IconPlusSmall:()=>VV,IconPng:()=>_V,IconPoop:()=>LV,IconPostcard:()=>HV,IconPound:()=>SV,IconPower:()=>jV,IconPowerPlant:()=>IV,IconPrinter:()=>EV,IconPush:()=>BV,IconQrCode:()=>WV,IconRainy:()=>KV,IconRaisingHand:()=>TV,IconReadingList:()=>PV,IconReceiptBill:()=>OV,IconReceiptionBell:()=>UV,IconRecord:()=>QV,IconRefund:()=>ey,IconRobot:()=>sy,IconRocket:()=>oy,IconRunShortcut:()=>iy,IconSafari:()=>ay,IconSchool:()=>dy,IconScissors:()=>hy,IconSearchMenu:()=>uy,IconSettingsGear:()=>fy,IconSettingsSliderHor:()=>vy,IconSettingsSliderVer:()=>by,IconShapes:()=>Vy,IconShare:()=>_y,IconShield:()=>Sy,IconShieldChecked:()=>Ly,IconShieldCrossed:()=>Hy,IconShoppingBag:()=>Iy,IconSignature:()=>jy,IconSmartwatch:()=>Ey,IconSolar:()=>By,IconSort:()=>Ry,IconSortAscending:()=>Wy,IconSortDescending:()=>Ky,IconSortDown:()=>Yy,IconSortUp:()=>Ty,IconSquareArrowTopRight:()=>Dy,IconSquareBehindSquare:()=>Fy,IconSquareGridCircle:()=>Jy,IconSquarePlaceholder:()=>Xy,IconStar:()=>t_,IconStore:()=>r_,IconSun:()=>n_,IconSunsetArrowDown:()=>l_,IconTag:()=>c_,IconTargetArrow:()=>C_,IconTelevision:()=>p_,IconTennis:()=>g_,IconTextEdit:()=>m_,IconThermostat:()=>M_,IconThumbsDown:()=>k_,IconThumbsUp:()=>y_,IconTicket:()=>w_,IconTradingViewCandles:()=>x_,IconTrashCan:()=>Z_,IconTree:()=>$_,IconTrendingFive:()=>N_,IconTrendingFour:()=>G_,IconTrendingOne:()=>q_,IconTrendingThree:()=>z_,IconTrendingTwo:()=>A_,IconTriangleExclamation:()=>Y_,IconTruck:()=>R_,IconUmbrellaSecurity:()=>D_,IconUnlocked:()=>F_,IconVolumeFull:()=>J_,IconVolumeHalf:()=>X_,IconVolumeOff:()=>tw,IconWallet:()=>rw,IconWarningSign:()=>nw,IconWifiFull:()=>lw,IconYoutube:()=>cw,IconZap:()=>Cw,IconZoomIn:()=>pw,IconZoomOut:()=>gw});var r=s(3095),o=s(745),n=s(6506),i=s(4367),l=s(3578),a=s(4652),c=s(3539),d=s(7526),C=s(5073),h=s(9399),p=s(4508),u=s(4987),g=s(3832);let f=class extends g.M{};f._regularSVG='<path d="M15.75 6.5C15.75 8.57107 14.0711 10.25 12 10.25C9.92893 10.25 8.25 8.57107 8.25 6.5C8.25 4.42893 9.92893 2.75 12 2.75C14.0711 2.75 15.75 4.42893 15.75 6.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 13.25C7.8098 13.25 4.86894 16.3254 4.5 20.25H19.5C19.1311 16.3254 16.1902 13.25 12 13.25Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>',f._solidSVG='<path d="M12 2C9.51472 2 7.5 4.01472 7.5 6.5C7.5 8.98528 9.51472 11 12 11C14.4853 11 16.5 8.98528 16.5 6.5C16.5 4.01472 14.4853 2 12 2Z" fill="currentColor"/><path d="M12 12.5C7.38412 12.5 4.15473 15.9097 3.7533 20.1798C3.73354 20.39 3.80328 20.5988 3.94541 20.7549C4.08754 20.911 4.28888 21 4.5 21H19.5C19.7111 21 19.9125 20.911 20.0546 20.7549C20.1967 20.5988 20.2665 20.39 20.2467 20.1798C19.8453 15.9097 16.6159 12.5 12 12.5Z" fill="currentColor"/>',f._name="people-profile",f._width=24,f._height=24,f._viewBox="0 0 24 24",f=(0,o.Cc)([(0,d.Y$)("gds-icon-people-profile")],f);var m,v,M,b,k,V,y=s(9443),_=y.AH`
...
`;let Vi=class extends te.S{constructor(){super(),(0,o.VK)(this,Hn),(0,o.VK)(this,Sn),(0,o.VK)(this,In),(0,o.VK)(this,jn),(0,o.VK)(this,En),(0,o.VK)(this,Bn),(0,o.VK)(this,Wn),(0,o.VK)(this,Kn),(0,o.VK)(this,Tn),(0,o.VK)(this,Pn),(0,o.VK)(this,On),(0,o.VK)(this,Un),(0,o.VK)(this,ci),(0,o.VK)(this,Ci),(0,o.VK)(this,pi),(0,o.VK)(this,gi),(0,o.VK)(this,mi),(0,o.VK)(this,Mi),this.supportingText="",this.showExtendedSupportingText=!1,this.plain=!1,this.size="large",this.min=0,this.max=100,this.step=1,this.showTicks=!1,this.showValueLabel=!0,this.range=!1,this.endValue=100,this.minLabel="",this.maxLabel="",this._activeThumb=null,this._focusedThumb=null,this._editingMin=!1,this._editingMax=!1,this._draftMin="0",this._draftMax="100",(0,o.VK)(this,Qn,e=>{const t=e.target.valueAsNumber;this.value=t,this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),(0,o.VK)(this,Xn,e=>{const t=e.target.valueAsNumber;this.value=t,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),(0,o.VK)(this,ei,e=>{const t=(0,o.jq)(this,Sn,$n).call(this,e.target.valueAsNumber);this.endValue=Math.max(this.value,t),(0,o.jq)(this,Pn,Dn).call(this),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),(0,o.VK)(this,ti,e=>{const t=(0,o.jq)(this,Sn,$n).call(this,e.target.valueAsNumber);this.endValue=Math.max(this.value,t),(0,o.jq)(this,Pn,Dn).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),(0,o.VK)(this,si,()=>{this._activeThumb="start"}),(0,o.VK)(this,ri,()=>{this._activeThumb="end"}),(0,o.VK)(this,oi,()=>{this._activeThumb=null}),(0,o.VK)(this,ni,()=>{this._focusedThumb="start"}),(0,o.VK)(this,ii,()=>{this._focusedThumb="end"}),(0,o.VK)(this,li,()=>{(0,o.S7)(this,oi).call(this),"start"===this._focusedThumb&&(this._focusedThumb=null)}),(0,o.VK)(this,ai,()=>{(0,o.S7)(this,oi).call(this),"end"===this._focusedThumb&&(this._focusedThumb=null)}),this._internalValue=this.min,this.endValue=this.max,this._draftMin=`${this.min}`,this._draftMax=`${this.max}`}get value(){return this._internalValue??this.min}set value(e){const t=(0,o.jq)(this,Sn,$n).call(this,e);this._internalValue=this.range?Math.min(t,this.endValue):t,(0,o.jq)(this,Pn,Dn).call(this)}connectedCallback(){super.connectedCallback(),(0,o.jq)(this,Hn,Zn).call(this),window.addEventListener("pointerup",(0,o.S7)(this,oi))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointerup",(0,o.S7)(this,oi))}focus(e){this._getValidityAnchor()?.focus(e)}render(){const e=this.range?(0,o.jq)(this,jn,Gn).call(this,this.value):0,t=this.range?(0,o.jq)(this,jn,Gn).call(this,this.endValue):(0,o.jq)(this,jn,Gn).call(this,this.value),s=`--_range-start: ${(0,o.jq)(this,En,qn).call(this)}%; --_range-end: ${(0,o.jq)(this,Bn,zn).call(this)}%; --_value-start-ratio: ${(0,o.jq)(this,jn,Gn).call(this,this.value)}; --_value-end-ratio: ${(0,o.jq)(this,jn,Gn).call(this,this.endValue)}; --_fill-start-ratio: ${e}; --_fill-end-ratio: ${t}; --_tick-interval: ${(0,o.jq)(this,Kn,Yn).call(this)}%;`;return d.qy`
      ${(0,F.z)(!this.plain,()=>d.qy`<gds-form-control-header
            class="size-${this.size}"
            .showExtendedSupportingText=${this.showExtendedSupportingText}
          >
      ...
      <div id="control-row">
        <div id="range-min" aria-label="Minimum range limit">
          ${(0,o.jq)(this,ci,di).call(this,"min")}
        ...
        <div id="control" style=${s}>
          ...
          <input
            ...
            ?disabled=${this.disabled}
            ?required=${this.required}
            @pointerdown=${(0,o.S7)(this,si)}
            @pointerup=${(0,o.S7)(this,oi)}
            @pointercancel=${(0,o.S7)(this,oi)}
            @focus=${(0,o.S7)(this,ni)}
            @blur=${(0,o.S7)(this,li)}
          ...
          ${(0,F.z)(this.range,()=>d.qy`<input
                ...
                aria-invalid=${this.invalid}
                aria-errormessage="message"
                aria-label=${(0,a.J)((0,o.jq)(this,Un,Jn).call(this))}
                ?disabled=${this.disabled}
                ?required=${this.required}
                @pointerdown=${(0,o.S7)(this,ri)}
                @pointerup=${(0,o.S7)(this,oi)}
                @pointercancel=${(0,o.S7)(this,oi)}
                @focus=${(0,o.S7)(this,ii)}
                @blur=${(0,o.S7)(this,ai)}
                @input=${(0,o.S7)(this,ei)}
                @change=${(0,o.S7)(this,ti)}
              />`)}
        ...
        <div id="range-max" aria-label="Maximum range limit">
          <span class="range-side-label" aria-hidden="true"
            >${this.maxLabel}</span
          >
          ${(0,o.jq)(this,ci,di).call(this,"max")}
        </div>
      </div>
      ...
      ${(0,F.z)(!this.plain,()=>d.qy`<gds-form-control-footer
            ...
            .errorMessage=${this.invalid?this.errorMessage:void 0}
          ></gds-form-control-footer>`)}
    `}_handleConstraintsUpdate(){(0,o.jq)(this,Hn,Zn).call(this)}_getValidityAnchor(){return this._startInput}_isThumbVisible(e){return this._activeThumb===e||this._focusedThumb===e}};Hn=new WeakSet,Zn=function(){if(this.max<this.min){const e=this.min;this.min=this.max,this.max=e}this._internalValue=(0,o.jq)(this,Sn,$n).call(this,this.value),this.endValue=(0,o.jq)(this,Sn,$n).call(this,this.endValue),this.range&&this._internalValue>this.endValue&&(this._internalValue=this.endValue),(0,o.jq)(this,Pn,Dn).call(this)},Sn=new WeakSet,$n=function(e){const t=this.step>0?this.step:1,s=this.min+Math.round((e-this.min)/t)*t;return Math.max(this.min,Math.min(this.max,s))},In=new WeakSet,Nn=function(e){return this.max===this.min?0:(e-this.min)/(this.max-this.min)*100},jn=new WeakSet,Gn=function(e){return this.max===this.min?0:(e-this.min)/(this.max-this.min)},En=new WeakSet,qn=function(){return this.range?(0,o.jq)(this,In,Nn).call(this,this.value):(0,o.jq)(this,In,Nn).call(this,this.min)},Bn=new WeakSet,zn=function(){return(0,o.jq)(this,In,Nn).call(this,this.range?this.endValue:this.value)},Wn=new WeakSet,An=function(e,t=0){return`calc(var(--_slider-thumb-size) / 2 + ${e} * (100% - var(--_slider-thumb-size))${0!==t?` ${t>0?"+":"-"} ${Math.abs(t)}px`:""})`},Kn=new WeakSet,Yn=function(){const e=this.max-this.min,t=this.step>0?this.step:1;return e<=0?100:Math.max(t/e*100,1)},Tn=new WeakSet,Rn=function(){if(!this.showTicks)return d.qy``;const e=[],t=(0,o.jq)(this,Kn,Yn).call(this);for(let s=0;s<=100;s+=t){const t=this.min+(this.max-this.min)*s/100;e.push({position:s,value:t})}return d.qy`
      ${e.map((t,s)=>{const r=t.position>=(0,o.jq)(this,En,qn).call(this)&&t.position<=(0,o.jq)(this,Bn,zn).call(this),n=t.position/100,i=0===s?2:s===e.length-1?-2:0;return d.qy`
          <div
            class="tick ${r?"tick-filled":"tick-unfilled"}"
            style="left: ${(0,o.jq)(this,Wn,An).call(this,n,i)}"
          ></div>
        `})}
    `},Pn=new WeakSet,Dn=function(){this.range?this._setFormValue(`${this.value},${this.endValue}`):this._setFormValue(`${this.value}`)},On=new WeakSet,Fn=function(){return this.range?`${this.label} start`:this.plain?this.label:void 0},Un=new WeakSet,Jn=function(){return this.label?`${this.label} end`:void 0},Qn=new WeakMap,Xn=new WeakMap,ei=new WeakMap,ti=new WeakMap,si=new WeakMap,ri=new WeakMap,oi=new WeakMap,ni=new WeakMap,ii=new WeakMap,li=new WeakMap,ai=new WeakMap,ci=new WeakSet,di=function(e){const t="min"===e?this._editingMin:this._editingMax,s="min"===e?this._draftMin:this._draftMax,r="min"===e?this.min:this.max,n="min"===e?"Min":"Max";return d.qy`
      <span class="bound-editor ${t?"editing":""}">
        <button
          ...
          tabindex=${t?"-1":"0"}
          ?disabled=${this.disabled}
          @click=${()=>(0,o.jq)(this,Ci,hi).call(this,e)}
        >
          ${r}
        </button>
        <input
          ...
          tabindex=${t?"0":"-1"}
          ?disabled=${this.disabled}
          @input=${t=>(0,o.jq)(this,pi,ui).call(this,e,t)}
          @blur=${()=>(0,o.jq)(this,mi,vi).call(this,e)}
          @keydown=${t=>(0,o.jq)(this,gi,fi).call(this,e,t)}
        />
      </span>
    `},Ci=new WeakSet,hi=function(e){"min"===e?(this._draftMin=`${this.min}`,this._editingMin=!0):(this._draftMax=`${this.max}`,this._editingMax=!0),setTimeout(()=>{const t=this.shadowRoot?.querySelector(`#${e}-range-editor`);t?.focus(),t?.select()},80)},pi=new WeakSet,ui=function(e,t){const s=t.target.value;"min"===e?this._draftMin=s:this._draftMax=s;const r=Number(s);s&&!Number.isNaN(r)&&("min"===e?this.min=r:this.max=r)},gi=new WeakSet,fi=function(e,t){"Enter"!==t.key?"Escape"===t.key&&(t.preventDefault(),(0,o.jq)(this,Mi,bi).call(this,e)):(0,o.jq)(this,mi,vi).call(this,e)},mi=new WeakSet,vi=function(e){const t=Number("min"===e?this._draftMin:this._draftMax);Number.isNaN(t)||("min"===e?this.min=t:this.max=t),(0,o.jq)(this,Mi,bi).call(this,e)},Mi=new WeakSet,bi=function(e){if("min"===e)return this._editingMin=!1,void(this._draftMin=`${this.min}`);this._editingMax=!1,this._draftMax=`${this.max}`},Vi.styles=[C.LU,zs.A,ki],(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],Vi.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],Vi.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],Vi.prototype,"plain",2),(0,o.Cc)([(0,i.MZ)({reflect:!0})],Vi.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Vi.prototype,"min",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Vi.prototype,"max",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Vi.prototype,"step",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0,attribute:"show-ticks"})],Vi.prototype,"showTicks",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0,attribute:"show-value-label"})],Vi.prototype,"showValueLabel",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Vi.prototype,"range",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Vi.prototype,"value",1),(0,o.Cc)([(0,i.MZ)({type:Number,attribute:"end-value"})],Vi.prototype,"endValue",2),(0,o.Cc)([(0,i.MZ)({attribute:"min-label"})],Vi.prototype,"minLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"max-label"})],Vi.prototype,"maxLabel",2),(0,o.Cc)([(0,i.P)("#slider-start")],Vi.prototype,"_startInput",2),(0,o.Cc)([(0,i.P)("#slider-end")],Vi.prototype,"_endInput",2),(0,o.Cc)([(0,i.wk)()],Vi.prototype,"_activeThumb",2),(0,o.Cc)([(0,i.wk)()],Vi.prototype,"_focusedThumb",2),(0,o.Cc)([(0,i.wk)()],Vi.prototype,"_editingMin",2),(0,o.Cc)([(0,i.wk)()],Vi.prototype,"_editingMax",2),(0,o.Cc)([(0,i.wk)()],Vi.prototype,"_draftMin",2),(0,o.Cc)([(0,i.wk)()],Vi.prototype,"_draftMax",2),(0,o.Cc)([(0,ee.w)("min"),(0,ee.w)("max"),(0,ee.w)("step"),(0,ee.w)("range")],Vi.prototype,"_handleConstraintsUpdate",1),Vi=(0,o.Cc)([(0,N.cc)()],Vi);let yi=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(Vi)))){};yi=(0,o.Cc)([(0,d.Y$)("gds-slider",{dependsOn:[Bs.$,qs.V]})],yi);const _i=e=>{yi.define();const t=(0,L.pI)("gds-slider"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};_i.displayName="GdsSlider";var wi,Li,xi,Hi=y.AH`
...
`;let Zi=class extends((0,u.TM)((0,u.qC)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,Li),(0,o.VK)(this,wi,y.AH`
    html {
      overflow: hidden !important;
  ...
  `),this.label=(0,N.ab)("Loading..."),this.labelPosition="bottom",this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="md",this._isAnimating=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchCustomEvent("gds-spinner-connected")}disconnectedCallback(){super.disconnectedCallback(),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1}_updateAriaLabel(){this.setAttribute("aria-label",this.label)}render(){return d.qy`
      <div part="wrapper" class=${(0,l.H)((0,o.jq)(this,Li,xi).call(this))}>
        <span part="spinner" class="spinner"></span>
        ${(0,F.z)(this.showLabel,()=>d.qy`<span part="label" class="spinner-label">${this.label}</span>`)}
      </div>
    `}_toggleRootStyles(){const e=lt.J.instance,t=`gds-spinner-fullscreen-${this.id||"default"}`;this.fullscreen?e.injectGlobalStyles(t,(0,o.S7)(this,wi)):e.clearGlobalStyles(t)}};wi=new WeakMap,Li=new WeakSet,xi=function(){return{"spinner-wrapper":!0,"spinner-fullscreen":this.fullscreen,"spinner-cover":this.cover,"spinner-backdrop":this.cover||this.fullscreen,"spinner-animating":this._isAnimating,[`spinner-label-${this.labelPosition}`]:this.labelPosition}},Zi.styles=[C.LU,Hi],(0,o.Cc)([(0,i.MZ)({type:String})],Zi.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:String,reflect:!0,attribute:"label-position"})],Zi.prototype,"labelPosition",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Zi.prototype,"showLabel",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Zi.prototype,"cover",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Zi.prototype,"fullscreen",2),(0,o.Cc)([(0,i.MZ)({type:String,reflect:!0})],Zi.prototype,"size",2),(0,o.Cc)([(0,i.wk)()],Zi.prototype,"_isAnimating",2),(0,o.Cc)([(0,ee.w)("label")],Zi.prototype,"_updateAriaLabel",1),(0,o.Cc)([(0,ee.w)("fullscreen")],Zi.prototype,"_toggleRootStyles",1),Zi=(0,o.Cc)([(0,d.Y$)("gds-spinner"),(0,N.cc)()],Zi);const Si=e=>{Zi.define();const t=(0,L.pI)("gds-spinner"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Si.displayName="GdsSpinner";const $i=y.AH`
  @media (prefers-reduced-motion: reduce) {
...
`;var Ii,Ni,ji,Gi,Ei,qi,Bi,zi,Wi,Ai,Ki,Yi,Ti,Ri,Pi,Di;let Oi=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Ii),(0,o.VK)(this,ji),(0,o.VK)(this,Ei),(0,o.VK)(this,Bi),(0,o.VK)(this,Ai),(0,o.VK)(this,Ti),(0,o.VK)(this,Pi),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",(0,o.VK)(this,Wi,()=>{this.checked=this._input.checked,(0,o.jq)(this,Pi,Di).call(this),(0,o.jq)(this,Ai,Ki).call(this)}),(0,o.VK)(this,Yi,e=>{this.disabled||"Enter"===e.key&&(e.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(e){this._internalValue=e}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(e){this._input?.focus(e)}render(){const e={switch:!0,checked:this.checked,disabled:this.disabled,"control-start":"start"===this.controlPlacement,small:"small"===this.size};return d.qy`
      <label class=${(0,l.H)(e)} for="switch-input">
        ${[(0,o.jq)(this,Ii,Ni).call(this),(0,o.jq)(this,ji,Gi).call(this),(0,o.jq)(this,Bi,zi).call(this)]}
      </label>
    `}};Ii=new WeakSet,Ni=function(){return d.qy`
      <input
        id="switch-input"
        type="checkbox"
        role="switch"
        ...
        @keydown=${(0,o.S7)(this,Yi)}
        @change=${(0,o.S7)(this,Wi)}
      />
    `},ji=new WeakSet,Gi=function(){return this.label?d.qy`<span id="label" class="label">${this.label}</span>`:null},Ei=new WeakSet,qi=function(){return d.qy`<span class="thumb">
      ...
      <gds-icon-checkmark
        ...
        class="checkmark"
      ></gds-icon-checkmark>
    </span>`},Bi=new WeakSet,zi=function(){return d.qy`
      <span class="track" aria-hidden="true"> ${(0,o.jq)(this,Ei,qi).call(this)} </span>
    `},Wi=new WeakMap,Ai=new WeakSet,Ki=function(){(0,o.jq)(this,Ti,Ri).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})},Yi=new WeakMap,Ti=new WeakSet,Ri=function(){this.checked?this._setFormValue(this._internalValue||"on"):this._setFormValue(null)},Pi=new WeakSet,Di=function(){const e=this._perimeter;e&&(e.classList.remove("ripple"),e.offsetWidth,e.classList.add("ripple"))},Oi.styles=[$i],(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Oi.prototype,"checked",2),(0,o.Cc)([(0,i.MZ)({attribute:"control-placement",reflect:!0})],Oi.prototype,"controlPlacement",2),(0,o.Cc)([(0,i.MZ)({reflect:!0})],Oi.prototype,"size",2),(0,o.Cc)([(0,h.F)({selector:".switch",valueTemplate:e=>e})],Oi.prototype,"justify-content",2),(0,o.Cc)([(0,i.P)('input[type="checkbox"]')],Oi.prototype,"_input",2),(0,o.Cc)([(0,i.P)(".perimeter")],Oi.prototype,"_perimeter",2),Oi=(0,o.Cc)([(0,j.J)({labelledBy:"#switch-input",describedBy:"#switch-input",errorMessage:"#switch-input"})],Oi);let Fi=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(Oi)))){};Fi=(0,o.Cc)([(0,d.Y$)("gds-switch",{dependsOn:[se.V]})],Fi);const Ui=e=>{Fi.define();const t=(0,L.pI)("gds-switch"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.Dy)(r,e.checked,e.defaultChecked,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};Ui.displayName="GdsSwitch";var Ji=s(9475),Qi=s(4382),Xi=s(8696);let el=class extends g.M{};el._regularSVG='<path d="M16 5L12 9L8 5M8 19L12 15L16 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',el._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12.5303 9.53033C12.2374 9.82322 11.7626 9.82322 11.4697 9.53033L7.46967 5.53033C7.17678 5.23744 7.17678 4.76256 7.46967 4.46967C7.76256 4.17678 8.23744 4.17678 8.53033 4.46967L12 7.93934L15.4697 4.46967C15.7626 4.17678 16.2374 4.17678 16.5303 4.46967C16.8232 4.76256 16.8232 5.23744 16.5303 5.53033L12.5303 9.53033ZM16.5303 19.5303C16.2374 19.8232 15.7626 19.8232 15.4697 19.5303L12 16.0607L8.53033 19.5303C8.23744 19.8232 7.76256 19.8232 7.46967 19.5303C7.17678 19.2374 7.17678 18.7626 7.46967 18.4697L11.4697 14.4697C11.7626 14.1768 12.2374 14.1768 12.5303 14.4697L16.5303 18.4697C16.8232 18.7626 16.8232 19.2374 16.5303 19.5303Z" fill="currentColor"/>',el._name="chevron-grabber-vertical-reversed",el._width=24,el._height=24,el._viewBox="0 0 24 24",el=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-grabber-vertical-reversed")],el);let tl=class extends g.M{};tl._regularSVG='<path d="M8 9L12 5L16 9M16 15L12 19L8 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',tl._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M11.4697 4.46967C11.7626 4.17678 12.2374 4.17678 12.5303 4.46967L16.5303 8.46967C16.8232 8.76256 16.8232 9.23744 16.5303 9.53033C16.2374 9.82322 15.7626 9.82322 15.4697 9.53033L12 6.06066L8.53033 9.53033C8.23744 9.82322 7.76256 9.82322 7.46967 9.53033C7.17678 9.23744 7.17678 8.76256 7.46967 8.46967L11.4697 4.46967ZM7.46967 14.4697C7.76256 14.1768 8.23744 14.1768 8.53033 14.4697L12 17.9393L15.4697 14.4697C15.7626 14.1768 16.2374 14.1768 16.5303 14.4697C16.8232 14.7626 16.8232 15.2374 16.5303 15.5303L12.5303 19.5303C12.2374 19.8232 11.7626 19.8232 11.4697 19.5303L7.46967 15.5303C7.17678 15.2374 7.17678 14.7626 7.46967 14.4697Z" fill="currentColor"/>',tl._name="chevron-grabber-vertical",tl._width=24,tl._height=24,tl._viewBox="0 0 24 24",tl=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-grabber-vertical")],tl);let sl=class extends g.M{};sl._regularSVG='<path d="M4 15L12 7L20 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',sl._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.25C12.1989 6.25 12.3897 6.32902 12.5303 6.46967L20.5303 14.4697C20.8232 14.7626 20.8232 15.2374 20.5303 15.5303C20.2374 15.8232 19.7626 15.8232 19.4697 15.5303L12 8.06066L4.53033 15.5303C4.23744 15.8232 3.76256 15.8232 3.46967 15.5303C3.17678 15.2374 3.17678 14.7626 3.46967 14.4697L11.4697 6.46967C11.6103 6.32902 11.8011 6.25 12 6.25Z" fill="currentColor"/>',sl._name="chevron-top",sl._width=24,sl._height=24,sl._viewBox="0 0 24 24",sl=(0,o.Cc)([(0,d.Y$)("gds-icon-chevron-top")],sl);let rl=class extends g.M{};rl._regularSVG='<path d="M7.75 7.75V3.75H20.25V16.26H16.25M16.25 7.75V20.25H3.75V7.75H16.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',rl._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M7 3.75C7 3.33579 7.33579 3 7.75 3H20.25C20.6642 3 21 3.33579 21 3.75V16.26C21 16.6742 20.6642 17.01 20.25 17.01H17V20.25C17 20.6642 16.6642 21 16.25 21H3.75C3.33579 21 3 20.6642 3 20.25V7.75C3 7.33579 3.33579 7 3.75 7H7V3.75ZM17 15.51V7.75C17 7.33579 16.6642 7 16.25 7H8.5V4.5H19.5V15.51H17Z" fill="currentColor"/>',rl._name="copy",rl._width=24,rl._height=24,rl._viewBox="0 0 24 24",rl=(0,o.Cc)([(0,d.Y$)("gds-icon-copy")],rl);var ol=s(8157);let nl=class extends g.M{};nl._regularSVG='<path d="M20 20L16.1265 16.1265M16.1265 16.1265C17.4385 14.8145 18.25 13.002 18.25 11C18.25 6.99594 15.0041 3.75 11 3.75C6.99594 3.75 3.75 6.99594 3.75 11C3.75 15.0041 6.99594 18.25 11 18.25C13.002 18.25 14.8145 17.4385 16.1265 16.1265Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',nl._solidSVG='<path d="M11 16C13.7614 16 16 13.7614 16 11C16 8.23858 13.7614 6 11 6C8.23858 6 6 8.23858 6 11C6 13.7614 8.23858 16 11 16Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M11 4.5C7.41015 4.5 4.5 7.41015 4.5 11C4.5 14.5899 7.41015 17.5 11 17.5C12.7951 17.5 14.4191 16.7733 15.5962 15.5962C16.7733 14.4191 17.5 12.7951 17.5 11C17.5 7.41015 14.5899 4.5 11 4.5ZM3 11C3 6.58172 6.58172 3 11 3C15.4183 3 19 6.58172 19 11C19 12.9388 18.3096 14.7174 17.1624 16.1017L20.7803 19.7197C21.0732 20.0126 21.0732 20.4874 20.7803 20.7803C20.4874 21.0732 20.0126 21.0732 19.7197 20.7803L16.1017 17.1624C14.7174 18.3096 12.9388 19 11 19C6.58172 19 3 15.4183 3 11Z" fill="currentColor"/>',nl._name="magnifying-glass",nl._width=24,nl._height=24,nl._viewBox="0 0 24 24",nl=(0,o.Cc)([(0,d.Y$)("gds-icon-magnifying-glass")],nl);let il=class extends g.M{};il._regularSVG='<path d="M3.75 5.75H18.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 12H11.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 18.25H9.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 10.75V18.5M14.75 15.75L18 19L21.25 15.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',il._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3 5.75C3 5.33579 3.33579 5 3.75 5H18.25C18.6642 5 19 5.33579 19 5.75C19 6.16421 18.6642 6.5 18.25 6.5H3.75C3.33579 6.5 3 6.16421 3 5.75Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3 12C3 11.5858 3.33579 11.25 3.75 11.25H11.25C11.6642 11.25 12 11.5858 12 12C12 12.4142 11.6642 12.75 11.25 12.75H3.75C3.33579 12.75 3 12.4142 3 12Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3 18.25C3 17.8358 3.33579 17.5 3.75 17.5H9.25C9.66421 17.5 10 17.8358 10 18.25C10 18.6642 9.66421 19 9.25 19H3.75C3.33579 19 3 18.6642 3 18.25Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M18 10C18.4142 10 18.75 10.3358 18.75 10.75V17.1893L20.7197 15.2197C21.0126 14.9268 21.4874 14.9268 21.7803 15.2197C22.0732 15.5126 22.0732 15.9874 21.7803 16.2803L18.5303 19.5303C18.2374 19.8232 17.7626 19.8232 17.4697 19.5303L14.2197 16.2803C13.9268 15.9874 13.9268 15.5126 14.2197 15.2197C14.5126 14.9268 14.9874 14.9268 15.2803 15.2197L17.25 17.1893V10.75C17.25 10.3358 17.5858 10 18 10Z" fill="currentColor"/>',il._name="sort-down",il._width=24,il._height=24,il._viewBox="0 0 24 24",il=(0,o.Cc)([(0,d.Y$)("gds-icon-sort-down")],il);let ll=class extends g.M{};ll._regularSVG='<path d="M3.75 18.25H18.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 12H11.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 5.75H9.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 13.25V5.25M14.75 8L18 4.75L21.25 8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',ll._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3 18.25C3 17.8358 3.33579 17.5 3.75 17.5H18.25C18.6642 17.5 19 17.8358 19 18.25C19 18.6642 18.6642 19 18.25 19H3.75C3.33579 19 3 18.6642 3 18.25Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3 12C3 11.5858 3.33579 11.25 3.75 11.25H11.25C11.6642 11.25 12 11.5858 12 12C12 12.4142 11.6642 12.75 11.25 12.75H3.75C3.33579 12.75 3 12.4142 3 12Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3 5.75C3 5.33579 3.33579 5 3.75 5H9.25C9.66421 5 10 5.33579 10 5.75C10 6.16421 9.66421 6.5 9.25 6.5H3.75C3.33579 6.5 3 6.16421 3 5.75Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M18 14C18.4142 14 18.75 13.6642 18.75 13.25V6.56066L20.7197 8.53033C21.0126 8.82322 21.4874 8.82322 21.7803 8.53033C22.0732 8.23744 22.0732 7.76256 21.7803 7.46967L18.5303 4.21967C18.2374 3.92678 17.7626 3.92678 17.4697 4.21967L14.2197 7.46967C13.9268 7.76256 13.9268 8.23744 14.2197 8.53033C14.5126 8.82322 14.9874 8.82322 15.2803 8.53033L17.25 6.56066V13.25C17.25 13.6642 17.5858 14 18 14Z" fill="currentColor"/>',ll._name="sort-up",ll._width=24,ll._height=24,ll._viewBox="0 0 24 24",ll=(0,o.Cc)([(0,d.Y$)("gds-icon-sort-up")],ll);let al=class extends g.M{};al._regularSVG='<path d="M2.75 4.75H21.25M8.75 19.25H15.25M5.75 12H18.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>',al._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M2 4.75C2 4.33579 2.33579 4 2.75 4H21.25C21.6642 4 22 4.33579 22 4.75C22 5.16421 21.6642 5.5 21.25 5.5H2.75C2.33579 5.5 2 5.16421 2 4.75ZM5 12C5 11.5858 5.33579 11.25 5.75 11.25H18.25C18.6642 11.25 19 11.5858 19 12C19 12.4142 18.6642 12.75 18.25 12.75H5.75C5.33579 12.75 5 12.4142 5 12ZM8 19.25C8 18.8358 8.33579 18.5 8.75 18.5H15.25C15.6642 18.5 16 18.8358 16 19.25C16 19.6642 15.6642 20 15.25 20H8.75C8.33579 20 8 19.6642 8 19.25Z" fill="currentColor"/>',al._name="sort",al._width=24,al._height=24,al._viewBox="0 0 24 24",al=(0,o.Cc)([(0,d.Y$)("gds-icon-sort")],al);const cl=y.AH`
  /* Host & Container */
  :host {
    display: block;
    min-width: 0;
...
`,dl=[C.LU,Q.A,cl],Cl=[z.t,Y.z,Zt,us,ze.Hx,Gr.T,$t.E,gr,Ho,Rt,H.K,br,ot.o,rl,Er.o,sl,tl,el,Ws.r,re,nl,al,il,ll,ol.z],hl={compact:{input:"small",dropdown:"small"},comfortable:{input:"small",dropdown:"small"},spacious:{input:"large",dropdown:"medium"}};var pl,ul,gl,fl,ml,vl,Ml,bl,kl,Vl,yl,_l,wl,Ll,xl,Hl,Zl,Sl,$l,Il,Nl,jl,Gl,El,ql,Bl,zl,Wl,Al,Kl,Yl,Tl,Rl,Pl,Dl,Ol,Fl,Ul,Jl,Ql,Xl,ea,ta,sa,ra,oa,na,ia,la,aa,ca,da,Ca,ha,pa,ua,ga,fa,ma,va,Ma,ba,ka,Va,ya,_a,wa,La,xa,Ha,Za,Sa,$a,Ia,Na,ja,Ga,Ea,qa,Ba,za,Wa,Aa,Ka,Ya,Ta,Ra,Pa,Da,Oa,Fa,Ua,Ja,Qa,Xa,ec,tc,sc,rc,oc,nc,ic,lc,ac,cc,dc,Cc,hc,pc,uc,gc,fc,mc,vc,Mc,bc,kc,Vc,yc,_c,wc,Lc,xc,Hc,Zc,Sc,$c,Ic,Nc,jc,Gc,Ec,qc,Bc,zc,Wc,Ac,Kc,Yc,Tc,Rc,Pc,Dc,Oc,Fc,Uc,Jc,Qc,Xc,ed,td,sd,rd,od,nd,id,ld,ad,cd,dd,Cd,hd,pd,ud,gd,fd,md,vd,Md,bd,kd,Vd,yd,_d,wd,Ld,xd,Hd,Zd,Sd,$d,Id,Nd,jd,Gd,Ed,qd,Bd,zd;Symbol.toPrimitive;let Wd=class extends((0,u.Q8)((0,u.TM)((0,u.Md)((0,u.lt)(c.j))))){constructor(){super(...arguments),(0,o.VK)(this,gl),(0,o.VK)(this,ml),(0,o.VK)(this,Ml),(0,o.VK)(this,kl),(0,o.VK)(this,Hl),(0,o.VK)(this,Sl),(0,o.VK)(this,Il),(0,o.VK)(this,jl),(0,o.VK)(this,El),(0,o.VK)(this,Bl),(0,o.VK)(this,Wl),(0,o.VK)(this,Kl),(0,o.VK)(this,Tl),(0,o.VK)(this,Pl),(0,o.VK)(this,Ol),(0,o.VK)(this,Ul),(0,o.VK)(this,Ql),(0,o.VK)(this,ea),(0,o.VK)(this,sa),(0,o.VK)(this,oa),(0,o.VK)(this,ia),(0,o.VK)(this,aa),(0,o.VK)(this,da),(0,o.VK)(this,ha),(0,o.VK)(this,ua),(0,o.VK)(this,fa),(0,o.VK)(this,va),(0,o.VK)(this,ba),(0,o.VK)(this,Va),(0,o.VK)(this,_a),(0,o.VK)(this,La),(0,o.VK)(this,Ha),(0,o.VK)(this,Sa),(0,o.VK)(this,Ia),(0,o.VK)(this,ja),(0,o.VK)(this,Ea),(0,o.VK)(this,Ba),(0,o.VK)(this,Wa),(0,o.VK)(this,Ka),(0,o.VK)(this,Ta),(0,o.VK)(this,Pa),(0,o.VK)(this,Oa),(0,o.VK)(this,Ua),(0,o.VK)(this,Qa),(0,o.VK)(this,ec),(0,o.VK)(this,sc),(0,o.VK)(this,oc),(0,o.VK)(this,ic),(0,o.VK)(this,ac),(0,o.VK)(this,dc),(0,o.VK)(this,hc),(0,o.VK)(this,uc),(0,o.VK)(this,fc),(0,o.VK)(this,vc),(0,o.VK)(this,bc),(0,o.VK)(this,Vc),(0,o.VK)(this,_c),(0,o.VK)(this,Lc),(0,o.VK)(this,Hc),(0,o.VK)(this,Sc),(0,o.VK)(this,Ic),(0,o.VK)(this,jc),(0,o.VK)(this,Ec),(0,o.VK)(this,Bc),(0,o.VK)(this,Wc),(0,o.VK)(this,Kc),(0,o.VK)(this,Tc),(0,o.VK)(this,Pc),(0,o.VK)(this,Oc),(0,o.VK)(this,Uc),(0,o.VK)(this,Qc),(0,o.VK)(this,ed),(0,o.VK)(this,sd),(0,o.VK)(this,od),(0,o.VK)(this,id),(0,o.VK)(this,ad),(0,o.VK)(this,dd),(0,o.VK)(this,hd),(0,o.VK)(this,ud),(0,o.VK)(this,fd),(0,o.VK)(this,vd),(0,o.VK)(this,bd),(0,o.VK)(this,Vd),(0,o.VK)(this,_d),(0,o.VK)(this,Ld),(0,o.VK)(this,Hd),(0,o.VK)(this,Sd),(0,o.VK)(this,Id),(0,o.VK)(this,jd),(0,o.VK)(this,Ed),(0,o.VK)(this,Bd),(0,o.VK)(this,pl,{}),(0,o.VK)(this,ul,3e5),this.headlineTag="h2",this.options=[5,10,20,50,100],this.page=1,this.rows=10,this.columns=[],this.density="comfortable",this.selectable=!1,this.disableSelectAll=!1,this.responsive=!1,this.plain=!1,this.searchable=!1,this.settings=!1,this.striped=!1,this.nocache=!1,this.variant="neutral-02-outlined",this._isMobile=!1,this._view={page:this.page,rows:this.rows,searchQuery:"",visibleColumns:new Set},this._loaded=!0,this._loading=!1,this._rowsState=[],this._total=0,this._selected=new Set,this._expanded=new Set,this._expanding=new Set,this._completingExpansion=new Set,this._expandedRowsCache=new Map,this._expandedFullContentResolved=new Set,this._error=null,(0,o.VK)(this,yl,new Map),(0,o.VK)(this,_l,140),(0,o.VK)(this,wl,100),(0,o.VK)(this,Ll,new Set),(0,o.VK)(this,xl,!1)}_handleMobile(e){this._isMobile=e}_onDataChange(){(0,o.OV)(this,pl,{}),(0,o.jq)(this,Ql,Xl).call(this)}_onPageChange(){this._view={...this._view,page:Number(this.page??1)},(0,o.jq)(this,Ql,Xl).call(this)}_onRowsChange(){this._view={...this._view,rows:Number(this.rows??10),page:1},(0,o.jq)(this,Ql,Xl).call(this)}_onColumnsChange(){(0,o.OV)(this,pl,{});const e=(0,o.jq)(this,Ul,Jl).call(this),t=this._view.sortColumn,s=this._view.sortDirection;this._view={...this._view,page:e?1:Number(this.page??1),rows:Number(this.rows??10),sortColumn:e?.column??this._view.sortColumn,sortDirection:e?.direction??this._view.sortDirection,visibleColumns:new Set(this.columns.filter(e=>!1!==e.visible).map(e=>e.key))},e&&(e.column!==t||e.direction!==s)&&(0,o.jq)(this,Ql,Xl).call(this)}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{(0,o.jq)(this,jd,Gd).call(this),(0,o.jq)(this,oa,na).call(this),(0,o.jq)(this,Ta,Ra).call(this)})}_handleLightDOMSlotsChange(){(0,o.jq)(this,ea,ta).call(this)}updated(e){super.updated(e),(0,o.jq)(this,oa,na).call(this)}render(){const e={table:!0,plain:this.plain,striped:this.striped,[this.density]:this.density};return d.qy`
      <div class="${(0,l.H)(e)}">
        ${[(0,o.jq)(this,ed,td).call(this),(0,o.jq)(this,ba,ka).call(this),(0,F.z)(this._error,()=>(0,o.jq)(this,Oc,Fc).call(this),()=>(0,F.z)(0===this._rowsState.length&&!this._loading,()=>(0,o.jq)(this,Uc,Jc).call(this),()=>(0,o.jq)(this,Pc,Dc).call(this))),(0,o.jq)(this,Qc,Xc).call(this)]}
      </div>
    `}clearSelection(){(0,o.jq)(this,Sd,$d).call(this),(0,o.jq)(this,Id,Nd).call(this)}selectAll(){(0,o.jq)(this,Hd,Zd).call(this),(0,o.jq)(this,Id,Nd).call(this)}setSelection(e){const t=e.filter(e=>e>=0&&e<this._rowsState.length);this._selected=new Set(t),(0,o.jq)(this,Id,Nd).call(this),this.requestUpdate()}getSelection(){const e=Array.from(this._selected);return{indices:e,data:e.map(e=>this._rowsState[e])}}expandRow(e){var t=this;return(0,Ne.A)(function*(){return(0,o.jq)(t,Ld,xd).call(t,e,!0)})()}collapseRow(e){return(0,o.jq)(this,Ld,xd).call(this,e,!1),!0}toggleRowExpansion(e,t){var s=this;return(0,Ne.A)(function*(){if(e<0||e>=s._rowsState.length)return!1;const r=!s._expanded.has(e);return(0,o.jq)(s,Ld,xd).call(s,e,r,t)})()}getExpandedIndices(){return Array.from(this._expanded)}};pl=new WeakMap,ul=new WeakMap,gl=new WeakSet,fl=function(){return this.responsive&&this._isMobile},ml=new WeakSet,vl=function(){return!(0,o.S7)(this,gl,fl)&&(0,o.S7)(this,jl,Gl).length>0},Ml=new WeakSet,bl=function(){return this.selectable&&!(0,o.S7)(this,gl,fl)},kl=new WeakSet,Vl=function(){return hl[this.density]},yl=new WeakMap,_l=new WeakMap,wl=new WeakMap,Ll=new WeakMap,xl=new WeakMap,Hl=new WeakSet,Zl=function(){return this._selected.size>0},Sl=new WeakSet,$l=function(){return this._rowsState.length>0&&this._selected.size===this._rowsState.length},Il=new WeakSet,Nl=function(){return(0,o.S7)(this,Hl,Zl)&&!(0,o.S7)(this,Sl,$l)},jl=new WeakSet,Gl=function(){return this._rowsState.map((e,t)=>(0,o.jq)(this,Pa,Da).call(this,e,t)?t:-1).filter(e=>-1!==e)},El=new WeakSet,ql=function(){const e=(0,o.S7)(this,jl,Gl);return e.length>0&&e.every(e=>this._expanded.has(e))},Bl=new WeakSet,zl=function(){return JSON.stringify({page:this._view.page,rows:this._view.rows,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection,searchQuery:this._view.searchQuery})},Wl=new WeakSet,Al=function(e){const t=(0,o.S7)(this,yl).get(e);void 0!==t&&(window.clearTimeout(t),(0,o.S7)(this,yl).delete(e))},Kl=new WeakSet,Yl=function(e){if((0,o.jq)(this,Wl,Al).call(this,e),this._expanding.has(e)){const t=new Set(this._expanding);t.delete(e),this._expanding=t}if(this._completingExpansion.has(e)){const t=new Set(this._completingExpansion);t.delete(e),this._completingExpansion=t}},Tl=new WeakSet,Rl=function(){(0,o.S7)(this,yl).forEach(e=>window.clearTimeout(e)),(0,o.S7)(this,yl).clear(),this._expanding.clear(),this._completingExpansion.clear()},Pl=new WeakSet,Dl=function(e){(0,o.jq)(this,Wl,Al).call(this,e);const t=new Set(this._completingExpansion);t.add(e),this._completingExpansion=t,this.requestUpdate();const s=window.setTimeout(()=>{(0,o.jq)(this,Kl,Yl).call(this,e),this.requestUpdate()},(0,o.S7)(this,_l));(0,o.S7)(this,yl).set(e,s)},Ol=new WeakSet,Fl=function(e){return Date.now()-e.timestamp<(0,o.S7)(this,ul)},Ul=new WeakSet,Jl=function(){const e=this.columns.find(e=>"asc"===e.sorting||"desc"===e.sorting);return e?.sorting?{column:e.key,direction:e.sorting}:null},Ql=new WeakSet,Xl=function(){var e=(0,Ne.A)(function*(){if(this.data){if(!this.nocache){const e=(0,o.jq)(this,Bl,zl).call(this),t=(0,o.S7)(this,pl)[e];if(t&&(0,o.jq)(this,Ol,Fl).call(this,t))return this._rowsState=t.rows,this._total=t.total,this._expanded.clear(),(0,o.jq)(this,Tl,Rl).call(this),this._expandedRowsCache.clear(),this._expandedFullContentResolved.clear(),this._loaded=!1,void this.dispatchCustomEvent("gds-table-data-loaded",{detail:{rows:t.rows,total:t.total,page:this._view.page,rowsPerPage:this._view.rows,searchQuery:this._view.searchQuery,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection},bubbles:!0})}this._loading=!0,this._error=null;try{const e=yield this.data({page:this._view.page,rows:this._view.rows,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection,searchQuery:this._view.searchQuery});if(!this.nocache){const t=(0,o.jq)(this,Bl,zl).call(this);(0,o.S7)(this,pl)[t]={rows:e.rows,total:e.total,timestamp:Date.now()}}this._rowsState=e.rows,this._total=e.total,this._selected.clear(),this._expanded.clear(),(0,o.jq)(this,Tl,Rl).call(this),this._expandedRowsCache.clear(),this._expandedFullContentResolved.clear(),this._loaded=!1,this.dispatchCustomEvent("gds-table-data-loaded",{detail:{...e,page:this._view.page,rowsPerPage:this._view.rows,searchQuery:this._view.searchQuery,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection},bubbles:!0})}catch(e){this._error=e,this.dispatchCustomEvent("gds-table-data-error",{detail:e,bubbles:!0})}finally{this._loading=!1}}});return function(){return e.apply(this,arguments)}}(),ea=new WeakSet,ta=function(){(0,o.S7)(this,xl)||((0,o.OV)(this,xl,!0),queueMicrotask(()=>{(0,o.OV)(this,xl,!1),(0,o.jq)(this,Ta,Ra).call(this)}))},sa=new WeakSet,ra=function(){const e=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),t=e.filter(e=>"left"===e.sticky),s=e.filter(e=>"right"===e.sticky);return{lastLeft:t.length?t[t.length-1].key:null,lastRight:s.length?s[0].key:null}},oa=new WeakSet,na=function(){const e=this.shadowRoot;if(!e)return;const t=Array.from(e.querySelectorAll("thead th.sticky-left")),s=Array.from(e.querySelectorAll("thead th.sticky-right")),r=e.querySelector("thead th.expander-cell"),o=e.querySelector("thead th.checkbox-cell");if(!t.length&&!s.length)return;e.querySelectorAll("[data-col-key]").forEach(e=>{e.style.left="",e.style.right=""});let n=(r?.offsetWidth??0)+(o?.offsetWidth??0);for(const s of t){const t=s.dataset.colKey,r=`${n}px`;s.style.left=r,n+=s.offsetWidth,t&&e.querySelectorAll(`[data-col-key="${t}"]`).forEach(e=>e.style.left=r)}let i=0;for(const t of[...s].reverse()){const s=t.dataset.colKey,r=`${i}px`;t.style.right=r,i+=t.offsetWidth,s&&e.querySelectorAll(`[data-col-key="${s}"]`).forEach(e=>e.style.right=r)}},ia=new WeakSet,la=function(e,t,s){if("string"==typeof s||"number"==typeof s)return s;const r=e?.id;return"string"==typeof r||"number"==typeof r?r:t+1},aa=new WeakSet,ca=function(e){return d.qy`<span class="cell-wrapped-content">${e}</span>`},da=new WeakSet,Ca=function(e){return d.qy`<span class="column-label" aria-hidden="true">
      ${e.label}:
    </span>`},ha=new WeakSet,pa=function(e,t,s){const r=`${e}:${t}:${s}`;return d.qy`<slot name="${r}"></slot>`},ua=new WeakSet,ga=function(e,t,s){const r=t.value?t.value(e):e[t.key],n=this._isMobile&&this.responsive,i=!!t.justify;let l;if("object"==typeof(c=r)&&null!==c&&Array.isArray(c.slots)){const n=(0,o.jq)(this,ia,la).call(this,e,s,r.key);l=r.slots.map(e=>"value"===e?void 0===r.value?null:i?(0,o.jq)(this,aa,ca).call(this,r.value):r.value:(0,o.jq)(this,ha,pa).call(this,t.key,n,e))}else l=i?(0,o.jq)(this,aa,ca).call(this,r):r;var c;return d.qy`
      <div
        class="cell-content"
        aria-label=${(0,a.J)(n?t.label:void 0)}
      >
        ${n?(0,o.jq)(this,da,Ca).call(this,t):null} ${l}
      </div>
    `},fa=new WeakSet,ma=function(e){const t=this._view.sortColumn===e.key,s=this._view.sortDirection;return t?"asc"===s?d.qy`<gds-icon-sort-up size="m"></gds-icon-sort-up>`:d.qy`<gds-icon-sort-down size="m"></gds-icon-sort-down>`:d.qy`<gds-icon-sort-up size="m"></gds-icon-sort-up>`},va=new WeakSet,Ma=function(){return this.searchable||this.settings||this.querySelector('[slot="header-lead"]')||this.querySelector('[slot="header-trail"]')},ba=new WeakSet,ka=function(){return this.plain||!(0,o.jq)(this,va,Ma).call(this)?null:d.qy`
      <div class="header">
        <div class="lead">
          ${(0,F.z)(this.searchable,()=>d.qy`
              <gds-input
                ...
                @input=${(0,o.jq)(this,sd,rd)}
                @gds-input-cleared=${(0,o.jq)(this,od,nd)}
                width="100%; l{240px}"
                min-width="240px"
              >
    ...
    `},Va=new WeakSet,ya=function(e){const t=this._view.sortColumn===e.key,s=this._view.sortDirection,{lastLeft:r,lastRight:n}=(0,o.jq)(this,sa,ra).call(this);let i=e.label;if(e.sortable)if(t){const t="asc"===s?(0,N.ab)("ascending"):(0,N.ab)("descending");i=`${e.label}, ${(0,N.ab)("sorted")} ${t}`}else i=`${e.label}, ${(0,N.ab)("sortable")}`;const c=(0,l.H)({sortable:!!e.sortable,sorted:t,"sort-asc":t&&"asc"===s,"sort-desc":t&&"desc"===s,[`align-${e.align}`]:!!e.align,[`justify-${e.justify}`]:!!e.justify,wrap:Boolean(e.width),"sticky-left":"left"===e.sticky,"sticky-right":"right"===e.sticky,"sticky-left-last":"left"===e.sticky&&e.key===r,"sticky-right-last":"right"===e.sticky&&e.key===n}),C=(0,Xi.W)({"--cell-width":e.width});return d.qy`
      <th
        class=${c}
        style=${C}
      ...
      >
        ${(0,F.z)(e.sortable,()=>d.qy`
            <button
              ...
              aria-label="${i}"
              aria-pressed=${t}
              @click=${()=>(0,o.jq)(this,id,ld).call(this,e.key)}
            >
              <span class="column-label">${e.label}</span>
              <span class="sort-icon">${(0,o.jq)(this,fa,ma).call(this,e)}</span>
            </button>
          `,()=>d.qy`
    ...
    `},_a=new WeakSet,wa=function(){return(0,o.S7)(this,Ml,bl)?d.qy`
      <th class="checkbox-cell">
        <div class="cell-center">
          ${(0,o.jq)(this,Ec,qc).call(this,{checked:(0,o.S7)(this,Sl,$l),indeterminate:(0,o.S7)(this,Il,Nl),ariaLabel:(0,N.ab)("Select all rows"),onToggle:()=>(0,o.jq)(this,ud,gd).call(this,{}),skip:this.disableSelectAll})}
        </div>
      </th>
    `:null},La=new WeakSet,xa=function(){if(!(0,o.S7)(this,ml,vl))return null;const e=(0,o.S7)(this,El,ql),t=e?(0,N.ab)("Collapse all rows"):(0,N.ab)("Expand all rows");return d.qy`
      <th class="expander-cell expander-header">
        <div class="cell-center">
          <gds-button
            ...
            size="small"
            label="${t}"
            @click=${()=>(0,o.jq)(this,bd,kd).call(this)}
          >
    ...
    `},Ha=new WeakSet,Za=function(e){return"subRows"in e?e.subRows:e?.children},Sa=new WeakSet,$a=function(e){if("fullContent"in e)return e.fullContent},Ia=new WeakSet,Na=function(e,t){return this._expandedRowsCache.get(t)??[]},ja=new WeakSet,Ga=function(e){return"function"==typeof(0,o.jq)(this,Ha,Za).call(this,e)},Ea=new WeakSet,qa=function(e){return"function"==typeof(0,o.jq)(this,Sa,$a).call(this,e)},Ba=new WeakSet,za=function(e,t){const s=(0,o.jq)(this,Ia,Na).call(this,e,t).length||1,r=Number(e.subRowCount);return!Number.isFinite(r)||r<=0?s:Math.floor(r)},Wa=new WeakSet,Aa=function(e,t){const s=String((0,o.jq)(this,ia,la).call(this,e,t));return(0,o.S7)(this,Ll).has(s)},Ka=new WeakSet,Ya=function(e,t){return(0,o.jq)(this,Wa,Aa).call(this,e,t)},Ta=new WeakSet,Ra=function(){const e=new Set;this.querySelectorAll('[slot^="expand:"][slot$=":full"]').forEach(t=>{const s=t.getAttribute("slot");if(!s)return;if(!s.startsWith("expand:")||!s.endsWith(":full"))return;const r=s.slice(7,-5);r&&e.add(r)}),(e.size!==(0,o.S7)(this,Ll).size||[...e].some(e=>!(0,o.S7)(this,Ll).has(e)))&&((0,o.OV)(this,Ll,e),this.requestUpdate())},Pa=new WeakSet,Da=function(e,t){return!(0,o.S7)(this,gl,fl)&&("boolean"==typeof e.isExpandable?e.isExpandable:!!(0,o.jq)(this,ja,Ga).call(this,e)||!!(0,o.jq)(this,Ea,qa).call(this,e)||(0,o.jq)(this,Ia,Na).call(this,e,t).length>0||(0,o.jq)(this,Ka,Ya).call(this,e,t))},Oa=new WeakSet,Fa=function(e,t){return`row-expand-group-${String((0,o.jq)(this,ia,la).call(this,e,t)).replace(/[^a-zA-Z0-9_-]/g,"-")}`},Ua=new WeakSet,Ja=function(){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).length+((0,o.S7)(this,ml,vl)?1:0)+((0,o.S7)(this,Ml,bl)?1:0)},Qa=new WeakSet,Xa=function(){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(e=>(0,o.jq)(this,Va,ya).call(this,e))},ec=new WeakSet,tc=function(){return d.qy`
      <thead>
        <tr>
          ${[(0,o.jq)(this,La,xa).call(this),(0,o.jq)(this,_a,wa).call(this),(0,o.jq)(this,Qa,Xa).call(this)]}
        </tr>
      </thead>
    `},sc=new WeakSet,rc=function(e,t,s){const{lastLeft:r,lastRight:n}=(0,o.jq)(this,sa,ra).call(this),i=(0,l.H)({[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify,wrap:Boolean(t.width),"sticky-left":"left"===t.sticky,"sticky-right":"right"===t.sticky,"sticky-left-last":"left"===t.sticky&&t.key===r,"sticky-right-last":"right"===t.sticky&&t.key===n}),c=(0,Xi.W)({"--cell-width":t.width});return d.qy`
      <td
        style=${c}
        class=${i}
        data-col-key=${(0,a.J)(t.sticky?t.key:void 0)}
      >
        ${(0,o.jq)(this,ua,ga).call(this,e,t,s)}
      </td>
    `},oc=new WeakSet,nc=function(e,t){if(!(0,o.S7)(this,ml,vl))return null;if(!(0,o.jq)(this,Pa,Da).call(this,e,t))return d.qy`<td class="expander-cell"></td>`;const s=this._expanded.has(t),r=(0,o.jq)(this,Oa,Fa).call(this,e,t),n=s?e.collapseLabel||(0,N.ab)("Collapse row"):e.expandLabel||(0,N.ab)("Expand row");return d.qy`
      <td class="expander-cell">
        <gds-button
          ...
          aria-controls=${r}
          @click=${()=>(0,o.jq)(this,vd,Md).call(this,e,t)}
        >
    ...
    `},ic=new WeakSet,lc=function(e){if(!(0,o.S7)(this,Ml,bl))return null;const t=`${(0,N.ab)("Select row")} ${e+1}`;return d.qy`
      <td class="checkbox-cell">
        <div class="cell-center">
          ${(0,o.jq)(this,Ec,qc).call(this,{checked:this._selected.has(e),indeterminate:!1,ariaLabel:t,onToggle:()=>(0,o.jq)(this,fd,md).call(this,e,{detail:{checked:!this._selected.has(e)}})})}
        </div>
      </td>
    `},ac=new WeakSet,cc=function(e,t){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(s=>(0,o.jq)(this,sc,rc).call(this,e,s,t))},dc=new WeakSet,Cc=function(e,t,s){const r=(0,o.jq)(this,ia,la).call(this,e,t);return d.qy`
      <tr
      ...
      >
        <td
          ...
          colspan=${(0,o.jq)(this,Ua,Ja).call(this)}
        >
          ${d.qy`<slot name="expand:${r}:full"></slot>`}
        </td>
      </tr>
    `},hc=new WeakSet,pc=function(e,t,s,r,n,i=!1){const c=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),C=(0,l.H)({"expanded-row":!0,aligned:!0,"skeleton-leave":i,"expanded-group-end":r===n-1});return d.qy`
      <tr
        class=${C}
        ...
        aria-busy="true"
      >
        ${(0,o.S7)(this,ml,vl)?d.qy`<td class="expander-cell"></td>`:null}
        ${(0,o.S7)(this,Ml,bl)?d.qy`<td class="checkbox-cell"></td>`:null}
        ${c.map(e=>{const t=(0,l.H)({[`align-${e.align}`]:!!e.align,[`justify-${e.justify}`]:!!e.justify,wrap:Boolean(e.width)}),s=(0,Xi.W)({"--cell-width":e.width}),r="actions"===String(e.key);return d.qy`
            <td class=${t} style=${s}>
    ...
    `},uc=new WeakSet,gc=function(e,t,s,r=!1){const n=(0,o.jq)(this,Ba,za).call(this,e,t);return Array.from({length:n},(i,l)=>(0,o.jq)(this,hc,pc).call(this,e,t,s,l,n,r))},fc=new WeakSet,mc=function(e,t=!1){const s=(0,l.H)({"expanded-row":!0,full:!0,"expanded-group-end":!0,"skeleton-leave":t});return d.qy`
    ...
    `},vc=new WeakSet,Mc=function(e){return{"expanded-row":!0,child:!0,"expanded-group-end":e}},bc=new WeakSet,kc=function(e,t,s){return{selected:this._selected.has(e),loading:this._loading,"expanded-parent":s,"has-expandable-rows":t}},Vc=new WeakSet,yc=function(e,t){return e?t?"true":"false":void 0},_c=new WeakSet,wc=function(e,t,s){return{classes:(0,o.jq)(this,bc,kc).call(this,e,t,s),ariaExpanded:(0,o.jq)(this,Vc,yc).call(this,t,s)}},Lc=new WeakSet,xc=function(e,t,s,r,n){const i=this._rowsState.length+1e3*t+s;return d.qy`
      <tr
        class=${(0,l.H)((0,o.jq)(this,vc,Mc).call(this,r))}
        id=${(0,a.J)(0===s?n:void 0)}
        aria-level="2"
      >
        ${(0,o.S7)(this,ml,vl)?d.qy`<td class="expander-cell"></td>`:null}
        ${(0,o.S7)(this,Ml,bl)?d.qy`<td class="checkbox-cell"></td>`:null}
        ${(0,o.jq)(this,ac,cc).call(this,e,i)}
      </tr>
    `},Hc=new WeakSet,Zc=function(e){return(0,o.jq)(this,ja,Ga).call(this,e)?"rows":"full"},Sc=new WeakSet,$c=function(e,t){const s=(0,o.jq)(this,Pa,Da).call(this,e,t),r=s&&this._expanded.has(t),n=this._expanding.has(t),i=this._completingExpansion.has(t),l=(0,o.jq)(this,Oa,Fa).call(this,e,t),a=(0,o.jq)(this,Ia,Na).call(this,e,t),c=(0,o.jq)(this,Hc,Zc).call(this,e);return{isExpandable:s,isExpanded:r,isExpanding:n,isCompleting:i,groupId:l,expandedRows:a,hasExpandedRows:a.length>0,loadingKind:c}},Ic=new WeakSet,Nc=function(e,t,s){return s.isExpanding?"full"===s.loadingKind?(0,o.jq)(this,fc,mc).call(this,s.groupId,s.isCompleting):(0,o.jq)(this,uc,gc).call(this,e,t,s.groupId,s.isCompleting):s.hasExpandedRows?s.expandedRows.map((e,r)=>(0,o.jq)(this,Lc,xc).call(this,e,t,r,r===s.expandedRows.length-1,0===r?s.groupId:void 0)):(0,o.jq)(this,dc,Cc).call(this,e,t,s.groupId)},jc=new WeakSet,Gc=function(e,t){const s=(0,o.jq)(this,Sc,$c).call(this,e,t),r=(0,o.jq)(this,_c,wc).call(this,t,s.isExpandable,s.isExpanded);return d.qy`
      <tr
        class=${(0,l.H)(r.classes)}
        aria-level=${(0,a.J)((0,o.S7)(this,ml,vl)?"1":void 0)}
        aria-expanded=${(0,a.J)(r.ariaExpanded)}
      >
        ${[(0,o.jq)(this,oc,nc).call(this,e,t),(0,o.jq)(this,ic,lc).call(this,t),(0,o.jq)(this,ac,cc).call(this,e,t)]}
      </tr>
      ${(0,F.z)(s.isExpanded,()=>(0,o.jq)(this,Ic,Nc).call(this,e,t,s))}
    `},Ec=new WeakSet,qc=function({checked:e,indeterminate:t=!1,disabled:s=!1,ariaLabel:r,onToggle:o,skip:n=!1}){if(n)return null;const i=e=>{e.stopPropagation(),s||o()};return d.qy`
      <div
        class="rbcb-wrapper"
        role="checkbox"
    ...
    `},Bc=new WeakSet,zc=function(e){const t=this._isMobile&&this.responsive?d.qy`<span class="skeleton skeleton-text"></span>`:null;return d.qy`
      <div class="cell-content">
        ${t}
        <span class="skeleton skeleton-text"></span>
      </div>
    `},Wc=new WeakSet,Ac=function(e){return d.qy`
      <tr class="skeleton-row">
        ${(0,F.z)((0,o.S7)(this,ml,vl),()=>d.qy`
          ...
          `)}
        ${(0,F.z)((0,o.S7)(this,Ml,bl),()=>d.qy`
            <td class="checkbox-cell">
              <span class="skeleton skeleton-checkbox"></span>
            </td>
          `)}
        ${this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(e=>d.qy`<td>${(0,o.jq)(this,Bc,zc).call(this,e)}</td>`)}
      </tr>
    `},Kc=new WeakSet,Yc=function(){if(this._loading&&this._loaded){const e=Array.from({length:this._view.rows},(e,t)=>(0,o.jq)(this,Wc,Ac).call(this,t));return d.qy`<tbody aria-busy="true" aria-live="polite">
        ${e}
      </tbody>`}return d.qy`
      <tbody aria-live="polite">
        ${(0,Qi.u)(this._rowsState,(e,t)=>(0,o.jq)(this,ia,la).call(this,e,t),(e,t)=>(0,Ji.a)([e,this._view.visibleColumns,this._selected.has(t),this._expanded.has(t),this._expanding.has(t),this._completingExpansion.has(t),this._expandedRowsCache.get(t),this._expandedFullContentResolved.has(t)],()=>(0,o.jq)(this,jc,Gc).call(this,e,t)))}
      </tbody>
    `},Tc=new WeakSet,Rc=function(){if(!this.tfoot||(0,o.S7)(this,gl,fl))return null;const e=this.tfoot.label,t=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),s=(0,l.H)({tablefoot:!0,sticky:Boolean(this.tfoot.sticky)});return d.qy`
      <tfoot class=${s}>
        <tr>
          ${(0,F.z)((0,o.S7)(this,ml,vl),()=>d.qy`<td class="expander-cell"></td>`)}
          ${(0,F.z)((0,o.S7)(this,Ml,bl),()=>d.qy`<td class="checkbox-cell"></td>`)}
          ${t.map((t,s)=>{const{lastLeft:r,lastRight:n}=(0,o.jq)(this,sa,ra).call(this),i=(0,l.H)({"tablefoot-cell":!0,"tablefoot-label-cell":0===s,[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify,wrap:Boolean(t.width),"sticky-left":"left"===t.sticky,"sticky-right":"right"===t.sticky,"sticky-left-last":"left"===t.sticky&&t.key===r,"sticky-right-last":"right"===t.sticky&&t.key===n}),c=(0,Xi.W)({"--cell-width":t.width});return 0===s&&e?d.qy`
                <th
                  scope="row"
                  class=${i}
                  style=${c}
    ...
    `},Pc=new WeakSet,Dc=function(){const e=(0,l.H)({responsive:this.responsive,data:!0,"is-expandable":(0,o.S7)(this,ml,vl),"is-selectable":(0,o.S7)(this,Ml,bl),"has-tfoot":Boolean(this.tfoot)&&!(0,o.S7)(this,gl,fl),"has-sticky-left":this.columns.some(e=>"left"===e.sticky),"has-sticky-right":this.columns.some(e=>"right"===e.sticky),"has-sticky":this.columns.some(e=>"left"===e.sticky||"right"===e.sticky),"no-mask":(0,o.S7)(this,ml,vl)||(0,o.S7)(this,Ml,bl)||this.columns.some(e=>"left"===e.sticky||"right"===e.sticky),[`variant-${this.variant}`]:!0,loading:this._loading,loaded:!this._loading&&!this._loaded}),t=`${this.summary?this.summary+", ":""}${(0,N.ab)("Data table with")} ${this._total} ${(0,N.ab)("rows")}`;return d.qy`
      <gds-card
      ...
      >
        <div class=${e} tabindex="0">
          <table
            aria-label="${t}"
            role=${(0,a.J)((0,o.S7)(this,ml,vl)?"treegrid":void 0)}
          >
            <caption class="visually-hidden">
              ${t}
            </caption>
            ${(0,o.jq)(this,ec,tc).call(this)} ${(0,o.jq)(this,Kc,Yc).call(this)}
            ${(0,o.jq)(this,Tc,Rc).call(this)}
          </table>
        </div>
      </gds-card>
    `},Oc=new WeakSet,Fc=function(){return d.qy`
      <gds-card variant="neutral-02-outlined" border-radius="m">
        <slot name="error">
          ...
          <gds-button
            ...
            @click=${()=>(0,o.jq)(this,Ql,Xl).call(this)}
          >
            ${(0,N.ab)("Retry")}
          </gds-button>
        </slot>
      </gds-card>
    `},Uc=new WeakSet,Jc=function(){return this._view.searchQuery.length>0?d.qy`
        <gds-card variant="neutral-02-outlined" border-radius="m">
    ...
    `},Qc=new WeakSet,Xc=function(){if(this.plain||this._total<1)return null;const e=`${(this._view.page-1)*this._view.rows+1}–${Math.min(this._view.page*this._view.rows,this._total)} ${(0,N.ab)("of")} ${this._total}`;return d.qy`
      <slot name="footer">
        <gds-pagination
          ...
          .label=${e}
          @gds-page-change=${(0,o.jq)(this,ad,cd)}
          @gds-rows-change=${(0,o.jq)(this,dd,Cd)}
          width="100%"
        >
        </gds-pagination>
      </slot>
    `},ed=new WeakSet,td=function(){if(this.headline||this.summary)return d.qy`
      ...
      `},sd=new WeakSet,rd=function(){var e=(0,Ne.A)(function*(e){const t=e.target;this._view={...this._view,searchQuery:t.value,page:1},yield(0,o.jq)(this,Ql,Xl).call(this)});return function(t){return e.apply(this,arguments)}}(),od=new WeakSet,nd=function(){var e=(0,Ne.A)(function*(){this._view={...this._view,searchQuery:"",page:1},yield(0,o.jq)(this,Ql,Xl).call(this)});return function(){return e.apply(this,arguments)}}(),id=new WeakSet,ld=function(){var e=(0,Ne.A)(function*(e){const t=this._view.sortColumn===e&&"asc"===this._view.sortDirection?"desc":"asc";this._view={...this._view,sortColumn:e,sortDirection:t,page:1},this.dispatchCustomEvent("gds-sort-change",{detail:{sortColumn:e,sortDirection:t},bubbles:!0}),yield(0,o.jq)(this,Ql,Xl).call(this)});return function(t){return e.apply(this,arguments)}}(),ad=new WeakSet,cd=function(){var e=(0,Ne.A)(function*(e){this._view={...this._view,page:e.detail.page},this.dispatchCustomEvent("gds-page-change",{detail:e.detail,bubbles:!0}),yield(0,o.jq)(this,Ql,Xl).call(this)});return function(t){return e.apply(this,arguments)}}(),dd=new WeakSet,Cd=function(){var e=(0,Ne.A)(function*(e){this._view={...this._view,rows:e.detail.rows,page:1},this.dispatchCustomEvent("gds-rows-change",{detail:e.detail,bubbles:!0}),yield(0,o.jq)(this,Ql,Xl).call(this)});return function(t){return e.apply(this,arguments)}}(),hd=new WeakSet,pd=function(e){const t=e.detail.value;this._view={...this._view,visibleColumns:new Set(t)},this.requestUpdate()},ud=new WeakSet,gd=function(e){(0,o.S7)(this,Sl,$l)?(0,o.jq)(this,Sd,$d).call(this):(0,o.jq)(this,Hd,Zd).call(this),(0,o.jq)(this,Id,Nd).call(this)},fd=new WeakSet,md=function(e,t){t.detail.checked?this._selected.add(e):this._selected.delete(e),(0,o.jq)(this,Id,Nd).call(this),this.requestUpdate()},vd=new WeakSet,Md=function(e,t){this.toggleRowExpansion(t,e)},bd=new WeakSet,kd=function(){var e=(0,Ne.A)(function*(){const e=(0,o.S7)(this,jl,Gl);(0,o.S7)(this,El,ql)?(e.forEach(e=>this._expanded.delete(e)),this.requestUpdate()):yield Promise.all(e.map(e=>(0,o.jq)(this,Ld,xd).call(this,e,!0)))});return function(){return e.apply(this,arguments)}}(),Vd=new WeakSet,yd=function(e,t,s){this.dispatchCustomEvent("gds-table-expand-change",{detail:{index:t,row:e,expanded:s,expandedIndices:Array.from(this._expanded)},bubbles:!0})},_d=new WeakSet,wd=function(){var e=(0,Ne.A)(function*(e,t){const s=(0,o.jq)(this,Ha,Za).call(this,e),r=(0,o.jq)(this,Sa,$a).call(this,e),n="function"==typeof s,i="function"==typeof r;if(!n&&!i)return;const l=n?s():void 0,a=i?r():void 0,c=Boolean(l||a);let d,C=!1,h=!1;c&&(d=window.setTimeout(()=>{if(!this._expanded.has(t))return;const e=new Set(this._expanding);e.add(t),this._expanding=e,h=!0,this.requestUpdate()},(0,o.S7)(this,wl)));try{if(l){const e=yield l,s=Array.isArray(e)?e:[],r=new Map(this._expandedRowsCache);r.set(t,s),this._expandedRowsCache=r}if(a){yield a;const e=new Set(this._expandedFullContentResolved);e.add(t),this._expandedFullContentResolved=e}C=!0}catch{if(l){const e=new Map(this._expandedRowsCache);e.set(t,[]),this._expandedRowsCache=e}}finally{void 0!==d&&window.clearTimeout(d),c&&C&&h?(0,o.jq)(this,Pl,Dl).call(this,t):(0,o.jq)(this,Kl,Yl).call(this,t),this.requestUpdate()}});return function(t,s){return e.apply(this,arguments)}}(),Ld=new WeakSet,xd=function(){var e=(0,Ne.A)(function*(e,t,s){if(e<0||e>=this._rowsState.length)return!1;const r=s??this._rowsState[e];if(!r)return!1;const n=(0,o.jq)(this,Pa,Da).call(this,r,e);return!(t&&!n)&&(t===this._expanded.has(e)||(t?(this._expanded.add(e),(0,o.jq)(this,Vd,yd).call(this,r,e,!0),this.requestUpdate(),yield(0,o.jq)(this,_d,wd).call(this,r,e)):((0,o.jq)(this,Kl,Yl).call(this,e),this._expanded.delete(e),(0,o.jq)(this,Vd,yd).call(this,r,e,!1)),this.requestUpdate()),!0)});return function(t,s,r){return e.apply(this,arguments)}}(),Hd=new WeakSet,Zd=function(){this._selected=new Set(this._rowsState.map((e,t)=>t)),this.requestUpdate()},Sd=new WeakSet,$d=function(){this._selected.clear(),this.requestUpdate()},Id=new WeakSet,Nd=function(){this.dispatchCustomEvent("gds-table-selection",{detail:{selectedIndices:Array.from(this._selected),selectedData:Array.from(this._selected).map(e=>this._rowsState[e]),count:this._selected.size},bubbles:!0})},jd=new WeakSet,Gd=function(){const e=this.shadowRoot?.querySelector(".data");if(!e)return;const t=()=>{(0,o.jq)(this,Ed,qd).call(this,e),(0,o.jq)(this,Bd,zd).call(this,e)};e.addEventListener("scroll",t);const s=new ResizeObserver(()=>t());s.observe(e);const r=e.querySelector("table");r&&s.observe(r),t()},Ed=new WeakSet,qd=function(e){const{scrollTop:t,scrollHeight:s,clientHeight:r}=e,o=s-r;t>0?e.classList.add("scrolled"):e.classList.remove("scrolled"),t<o-1?e.classList.add("scrolled-bottom"):e.classList.remove("scrolled-bottom")},Bd=new WeakSet,zd=function(e){const{scrollLeft:t,scrollWidth:s,clientWidth:r}=e,o=s-r;s>r?e.classList.add("overflows-x"):e.classList.remove("overflows-x"),t<=0?(e.classList.add("scrolled-x-start"),e.classList.remove("scrolled-x-middle","scrolled-x-end")):t>=o-1?(e.classList.add("scrolled-x-end"),e.classList.remove("scrolled-x-start","scrolled-x-middle")):(e.classList.add("scrolled-x-middle"),e.classList.remove("scrolled-x-start","scrolled-x-end"))},Wd.styles=dl,(0,o.Cc)([(0,i.MZ)()],Wd.prototype,"headline",2),(0,o.Cc)([(0,i.MZ)({attribute:"headline-tag",type:String,reflect:!0})],Wd.prototype,"headlineTag",2),(0,o.Cc)([(0,i.MZ)()],Wd.prototype,"summary",2),(0,o.Cc)([(0,i.MZ)({attribute:"search-label",type:String})],Wd.prototype,"searchLabel",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Wd.prototype,"options",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Wd.prototype,"page",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Wd.prototype,"rows",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Wd.prototype,"columns",2),(0,o.Cc)([(0,i.MZ)()],Wd.prototype,"data",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],Wd.prototype,"density",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"selectable",2),(0,o.Cc)([(0,i.MZ)({attribute:"disable-select-all",type:Boolean,reflect:!1})],Wd.prototype,"disableSelectAll",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"responsive",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"plain",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"searchable",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"settings",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"striped",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Wd.prototype,"nocache",2),(0,o.Cc)([(0,i.MZ)({type:Object})],Wd.prototype,"tfoot",2),(0,o.Cc)([(0,i.MZ)()],Wd.prototype,"dataLoadKey",2),(0,o.Cc)([(0,h.F)({...p.Sc,property:"--_table-height",selector:".data"})],Wd.prototype,"height",2),(0,o.Cc)([(0,i.MZ)()],Wd.prototype,"variant",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_isMobile",2),(0,o.Cc)([(0,jr.M)("(max-width: 768px)")],Wd.prototype,"_handleMobile",1),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_view",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_loaded",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_loading",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_rowsState",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_total",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_selected",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_expanded",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_expanding",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_completingExpansion",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_expandedRowsCache",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_expandedFullContentResolved",2),(0,o.Cc)([(0,i.wk)()],Wd.prototype,"_error",2),(0,o.Cc)([(0,ee.w)("dataLoadKey"),(0,ee.w)("data")],Wd.prototype,"_onDataChange",1),(0,o.Cc)([(0,ee.w)("page",{waitUntilFirstUpdate:!0})],Wd.prototype,"_onPageChange",1),(0,o.Cc)([(0,ee.w)("rows",{waitUntilFirstUpdate:!0})],Wd.prototype,"_onRowsChange",1),(0,o.Cc)([(0,ee.w)("columns")],Wd.prototype,"_onColumnsChange",1),(0,o.Cc)([(0,Bo.L)({childList:!0,attributes:!0,attributeFilter:["slot"],attributeOldValue:!0})],Wd.prototype,"_handleLightDOMSlotsChange",1),Wd=(0,o.Cc)([(0,N.cc)(),(0,d.Y$)("gds-table",{dependsOn:Cl}),(0,j.J)({labelledBy:"table",describedBy:"table"})],Wd);const Ad=e=>{Wd.define();const t=(0,L.pI)("gds-table"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Ad.displayName="GdsTable";var Kd,Yd,Td,Rd,Pd,Dd=y.AH`
  @layer base {
    :host {
      display: block;
      outline: none;
...
`;let Od=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,Rd),(0,o.VK)(this,Kd,this.attachInternals()),(0,o.VK)(this,Yd,void 0),(0,o.VK)(this,Td,!1),this.name=""}get tabEl(){return(0,o.S7)(this,Yd)}connectedCallback(){super.connectedCallback(),this.tabIndex=-1,(0,o.jq)(this,Rd,Pd).call(this)}_setTabEl(e){(0,o.OV)(this,Yd,e),(0,o.jq)(this,Rd,Pd).call(this)}_setSelected(e){(0,o.OV)(this,Td,e),e?this.removeAttribute("hidden"):this.setAttribute("hidden",""),(0,o.jq)(this,Rd,Pd).call(this)}render(){return d.qy`<slot></slot>`}};Kd=new WeakMap,Yd=new WeakMap,Td=new WeakMap,Rd=new WeakSet,Pd=function(){this.setAttribute("role","tabpanel"),(0,o.S7)(this,Kd).ariaLabelledByElements=(0,o.S7)(this,Yd)?[(0,o.S7)(this,Yd)]:[]},Od.styles=[Dd],(0,o.Cc)([(0,i.MZ)({reflect:!0})],Od.prototype,"name",2),Od=(0,o.Cc)([(0,d.Y$)("gds-tab-panel")],Od);var Fd,Ud,Jd,Qd,Xd,eC,tC,sC=y.AH`
  @layer base {
    :host {
      display: inline-flex;
    }
...
`;let rC=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,Qd),(0,o.VK)(this,eC),(0,o.VK)(this,Fd,this.attachInternals()),(0,o.VK)(this,Ud,void 0),this.size="medium",this.disabled=!1,this.selected=!1,this.panel="",(0,o.VK)(this,Jd,()=>{(0,o.jq)(this,Qd,Xd).call(this)})}get panelEl(){return(0,o.S7)(this,Ud)}connectedCallback(){super.connectedCallback(),(0,o.jq)(this,eC,tC).call(this),this.addEventListener("click",()=>{}),this.addEventListener("keydown",e=>{"Tab"===e.key&&(e.preventDefault(),(0,o.S7)(this,Ud)?.focus())})}_handleSelectedChange(){(0,o.jq)(this,Qd,Xd).call(this),(0,o.jq)(this,eC,tC).call(this)}_handleDisabledChange(){(0,o.jq)(this,eC,tC).call(this)}_setPanelEl(e){(0,o.OV)(this,Ud,e),(0,o.jq)(this,eC,tC).call(this)}render(){return d.qy`<div class=${(0,l.H)({small:"small"===this.size})}>
      <slot name="lead" @slotchange=${(0,o.S7)(this,Jd)}></slot>
      <slot></slot>
      <slot name="trail" @slotchange=${(0,o.S7)(this,Jd)}></slot>
    </div>`}};Fd=new WeakMap,Ud=new WeakMap,Jd=new WeakMap,Qd=new WeakSet,Xd=function(){const e=["lead","trail"];for(const t of e){const e=this.renderRoot.querySelector(`slot[name="${t}"]`);for(const t of e?.assignedElements({flatten:!0})??[])"solid"in t&&(t.solid=this.selected)}},eC=new WeakSet,tC=function(){this.setAttribute("role","tab"),(0,o.S7)(this,Fd).ariaSelected=this.selected?"true":"false",this.tabIndex=this.selected&&!this.disabled?0:-1,(0,o.S7)(this,Fd).ariaControlsElements=(0,o.S7)(this,Ud)?[(0,o.S7)(this,Ud)]:[]},rC.styles=[C.LU,sC],(0,o.Cc)([(0,i.MZ)({reflect:!0})],rC.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],rC.prototype,"disabled",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],rC.prototype,"selected",2),(0,o.Cc)([(0,i.MZ)()],rC.prototype,"panel",2),(0,o.Cc)([(0,ee.w)("selected")],rC.prototype,"_handleSelectedChange",1),(0,o.Cc)([(0,ee.w)("disabled")],rC.prototype,"_handleDisabledChange",1),rC=(0,o.Cc)([(0,d.Y$)("gds-tab")],rC);var oC,nC,iC,lC,aC,cC,dC,CC,hC,pC,uC,gC,fC,mC,vC,MC,bC,kC,VC,yC,_C,wC,LC,xC,HC,ZC,SC,$C=y.AH`
  @layer base {
    :host {
      display: flex;
      flex-direction: column;
...
`;const IC=(e,t)=>{let s;return()=>{clearTimeout(s),s=setTimeout(e,t)}};let NC=class extends((0,u.lt)((0,u.Q8)((0,u.TM)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,oC),(0,o.VK)(this,cC),(0,o.VK)(this,uC),(0,o.VK)(this,kC),(0,o.VK)(this,yC),(0,o.VK)(this,wC),(0,o.VK)(this,xC),(0,o.VK)(this,ZC),this.selected=0,this.label="",this._showPrevButton=!1,this._showNextButton=!1,this._hasResolvedInitialSelection=!1,this._isScrollListenerBound=!1,(0,o.VK)(this,iC,()=>{(0,o.jq)(this,yC,_C).call(this),(0,o.jq)(this,wC,LC).call(this),this.requestUpdate(),this.updateComplete.then(()=>{(0,o.jq)(this,uC,gC).call(this),(0,o.jq)(this,kC,VC).call(this),(0,o.S7)(this,mC).call(this),(0,o.S7)(this,pC).call(this)})}),(0,o.VK)(this,lC,e=>{const t=this.tabs.find(t=>t===e.target||t.contains(e.target));if(!t||t.disabled)return;e.preventDefault();const s=this.tabs.indexOf(t);-1!==s&&(0,o.jq)(this,cC,dC).call(this,s)}),(0,o.VK)(this,aC,e=>{if(!["ArrowRight","ArrowLeft","Right","Left","Home","End"].includes(e.key))return;const t=e.target;if(!(t instanceof rC))return;e.preventDefault();const s=this.tabs.indexOf(t);if(s<0||s>=this.tabs.length)return;const r=(0,o.jq)(this,ZC,SC).call(this,s,e.key);void 0!==r&&((0,o.jq)(this,cC,dC).call(this,r),this.tabs[r]?.focus())}),(0,o.VK)(this,CC,IC(()=>{this._elMarker?.removeAttribute("data-scrolling")},150)),(0,o.VK)(this,hC,()=>{this._elMarker?.setAttribute("data-scrolling",""),(0,o.S7)(this,pC).call(this),(0,o.S7)(this,CC).call(this)}),(0,o.VK)(this,pC,()=>{if(!this._elMarker||!this._elTabsContainer)return;const e=(0,o.S7)(this,oC,nC)[this.selected];if(!e)return void this._elMarker.style.setProperty("--_marker-width","0px");const t=this._elTabsContainer.getBoundingClientRect(),s=e.getBoundingClientRect();this._elMarker.style.setProperty("--_marker-left",s.left-t.left+"px"),this._elMarker.style.setProperty("--_marker-width",`${s.width}px`)}),(0,o.VK)(this,fC,()=>{if(!this._elTrack)return;const e=this._elTrack.getBoundingClientRect();(0,o.S7)(this,oC,nC).forEach(t=>{const s=t.getBoundingClientRect(),r=s.left>=e.left-1&&s.right<=e.right+1;t.dataset.isVisible=String(r)}),(0,o.S7)(this,vC).call(this)}),(0,o.VK)(this,mC,IC((0,o.S7)(this,fC),50)),(0,o.VK)(this,vC,()=>{const e=(0,o.S7)(this,oC,nC);if(0===e.length)return this._showPrevButton=!1,void(this._showNextButton=!1);if(e.some(e=>"true"===e.dataset.isVisible))return this._showPrevButton="true"!==e[0].dataset.isVisible,void(this._showNextButton="true"!==e[e.length-1].dataset.isVisible);const t=Math.max(0,this._elTrack.scrollWidth-this._elTrack.clientWidth);this._showPrevButton=this._elTrack.scrollLeft>1,this._showNextButton=this._elTrack.scrollLeft<t-1}),(0,o.VK)(this,MC,()=>{const e=(0,o.S7)(this,oC,nC).filter((e,t,s)=>"true"===s[t+1]?.dataset.isVisible&&"true"!==e.dataset.isVisible)[0];this._elTrack.scrollLeft-=e?e.getBoundingClientRect().width:.8*this._elTrack.clientWidth}),(0,o.VK)(this,bC,()=>{const e=(0,o.S7)(this,oC,nC).filter((e,t,s)=>"true"===s[t-1]?.dataset.isVisible&&"true"!==e.dataset.isVisible).reverse()[0];this._elTrack.scrollLeft+=e?e.getBoundingClientRect().width:.8*this._elTrack.clientWidth})}get tabs(){return this._elTabSlot?this._elTabSlot.assignedElements():[]}get panels(){return this._elPanelSlot?this._elPanelSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",(0,o.S7)(this,aC)),this.updateComplete.then(()=>{(0,o.jq)(this,uC,gC).call(this)})}firstUpdated(){(0,o.jq)(this,yC,_C).call(this),(0,o.jq)(this,wC,LC).call(this),(0,o.jq)(this,uC,gC).call(this),(0,o.S7)(this,pC).call(this),Promise.resolve().then(()=>{this._elMarker?.setAttribute("data-ready","")})}disconnectedCallback(){this.removeEventListener("keydown",(0,o.S7)(this,aC)),this._elTrack?.removeEventListener("scroll",(0,o.S7)(this,mC)),this._elTrack?.removeEventListener("scroll",(0,o.S7)(this,hC)),super.disconnectedCallback()}_handleResize(){(0,o.S7)(this,mC).call(this),(0,o.S7)(this,pC).call(this)}_handleSelectedChange(){(0,o.jq)(this,yC,_C).call(this),(0,o.jq)(this,wC,LC).call(this),this.updateComplete.then(()=>{(0,o.jq)(this,kC,VC).call(this),(0,o.S7)(this,mC).call(this),(0,o.S7)(this,pC).call(this)})}render(){return d.qy`
      <div class="tabs-container">
        ...
        <div id="track" role="tablist" aria-label=${this.label}>
          <slot
            name="tab"
            @click=${(0,o.S7)(this,lC)}
            @slotchange=${(0,o.S7)(this,iC)}
            role="none"
          ></slot>
        </div>
      ...
      <slot
        ...
        role="none"
      ></slot>
    `}};oC=new WeakSet,nC=function(){const e=this.renderRoot.querySelector('slot[name="tab"]');return e?.assignedElements()??[]},iC=new WeakMap,lC=new WeakMap,aC=new WeakMap,cC=new WeakSet,dC=function(e){if(this.selected===e)return;this.selected=e;const t=this.tabs[e];t&&this.dispatchCustomEvent("gds-tab-change",{detail:{index:e,tab:t},bubbles:!0,composed:!0})},CC=new WeakMap,hC=new WeakMap,pC=new WeakMap,uC=new WeakSet,gC=function(){!this._isScrollListenerBound&&this._elTrack&&(this._elTrack.addEventListener("scroll",(0,o.S7)(this,mC)),this._elTrack.addEventListener("scroll",(0,o.S7)(this,hC)),this._isScrollListenerBound=!0),(0,o.S7)(this,mC).call(this)},fC=new WeakMap,mC=new WeakMap,vC=new WeakMap,MC=new WeakMap,bC=new WeakMap,kC=new WeakSet,VC=function(){(0,o.S7)(this,oC,nC)[this.selected]?.scrollIntoView({block:"nearest",inline:"nearest"})},yC=new WeakSet,_C=function(){const e=this.tabs;if(0!==e.length){if(!this._hasResolvedInitialSelection){const t=e.findIndex(e=>e.selected||e.hasAttribute("selected"));t>=0&&0===this.selected&&(this.selected=t),this._hasResolvedInitialSelection=!0}(this.selected<0||this.selected>=e.length||e[this.selected]?.disabled)&&(this.selected=(0,o.jq)(this,xC,HC).call(this))}},wC=new WeakSet,LC=function(){this.tabs.forEach((e,t)=>{const s=t===this.selected,r=e.panel?this.panels.find(t=>t.name===e.panel):this.panels[t];e._setPanelEl(r),e.selected=s}),this.panels.forEach(e=>{const t=this.tabs.find(t=>t.panel?t.panel===e.name:this.tabs.indexOf(t)===this.panels.indexOf(e)),s=(t?this.tabs.indexOf(t):this.panels.indexOf(e))===this.selected;e._setTabEl(t),e._setSelected(s)})},xC=new WeakSet,HC=function(){const e=this.tabs.findIndex(e=>!e.disabled);return-1===e?-1:e},ZC=new WeakSet,SC=function(e,t){const s=this.tabs,r=s.length;if(0===r)return;if("Home"===t)return(0,o.jq)(this,xC,HC).call(this);if("End"===t){for(let e=r-1;e>=0;e-=1)if(!s[e].disabled)return e;return}const n="ArrowRight"===t||"Right"===t?1:-1;for(let t=1;t<=r;t+=1){const o=(e+t*n+r)%r;if(!s[o].disabled)return o}},NC.styles=[C.LU,$C],(0,o.Cc)([(0,i.MZ)({type:Number})],NC.prototype,"selected",2),(0,o.Cc)([(0,i.MZ)()],NC.prototype,"label",2),(0,o.Cc)([(0,i.P)("#track")],NC.prototype,"_elTrack",2),(0,o.Cc)([(0,i.P)("#marker")],NC.prototype,"_elMarker",2),(0,o.Cc)([(0,i.P)(".tabs-container")],NC.prototype,"_elTabsContainer",2),(0,o.Cc)([(0,i.P)('slot[name="tab"]')],NC.prototype,"_elTabSlot",2),(0,o.Cc)([(0,i.P)("#panelslot")],NC.prototype,"_elPanelSlot",2),(0,o.Cc)([(0,i.wk)()],NC.prototype,"_showPrevButton",2),(0,o.Cc)([(0,i.wk)()],NC.prototype,"_showNextButton",2),(0,o.Cc)([(0,As.b)()],NC.prototype,"_handleResize",1),(0,o.Cc)([(0,ee.w)("selected")],NC.prototype,"_handleSelectedChange",1),NC=(0,o.Cc)([(0,d.Y$)("gds-tabs",{dependsOn:[rC,Od,G.g,Ar.V]}),(0,N.cc)(),(0,j.J)({labelledBy:"#track",describedBy:"#track"})],NC);const jC=e=>{NC.define();const t=(0,L.pI)("gds-tabs"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};jC.displayName="GdsTabs";const GC=e=>{Rt.define();const t=(0,L.pI)("gds-text"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};GC.displayName="GdsText";const EC=e=>{Ts.define();const t=(0,L.pI)("gds-textarea"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};EC.displayName="GdsTextarea";var qC=s(7247),BC=y.AH`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`;let zC=class extends((0,u.Q8)((0,u.vi)((0,u.TM)((0,u.lt)((0,u.qC)(c.j)))))){applyVideoSettings(){this.videoElement&&(this.videoElement.src=this.src||"",this.videoElement.poster=this.poster||"",this.videoElement.muted=this.muted||!1,this.videoElement.autoplay=this.autoplay||!1,this.videoElement.loop=this.loop||!1,this.videoElement.playsInline=this.playsinline||!1)}render(){return d.qy`<video></video>`}firstUpdated(){this.applyVideoSettings()}};zC.styles=[C.LU,BC],(0,o.Cc)([(0,h.F)()],zC.prototype,"aspect-ratio",2),(0,o.Cc)([(0,h.F)({selector:"video"})],zC.prototype,"object-position",2),(0,o.Cc)([(0,h.F)()],zC.prototype,"opacity",2),(0,o.Cc)([(0,h.F)({selector:"video"})],zC.prototype,"object-fit",2),(0,o.Cc)([(0,h.F)({selector:"video"})],zC.prototype,"pointer-events",2),(0,o.Cc)([(0,h.F)({valueTemplate:e=>`var(--gds-sys-space-${e})`})],zC.prototype,"border-radius",2),(0,o.Cc)([(0,i.MZ)()],zC.prototype,"src",2),(0,o.Cc)([(0,i.MZ)()],zC.prototype,"poster",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],zC.prototype,"muted",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],zC.prototype,"playsinline",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],zC.prototype,"autoplay",2),(0,o.Cc)([(0,i.MZ)({type:Boolean})],zC.prototype,"loop",2),(0,o.Cc)([(0,i.P)("video")],zC.prototype,"videoElement",2),zC=(0,o.Cc)([(0,d.Y$)("gds-video")],zC);const WC=e=>{zC.define();const t=(0,L.pI)("gds-video"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};WC.displayName="GdsVideo",Rt.define();class AC extends Rt{updated(e){super.updated(e),this.element&&(this.element.innerHTML=this.formattedValue)}}(0,o.Cc)([(0,i.P)("[tag]")],AC.prototype,"element",2);const KC=e=>"string"==typeof e?new Date(e):e,YC={dateOnlyNumbers:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"short"}).format(KC(e)),dateLong:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"long"}).format(KC(e)),dateLongWithWeekday:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"full"}).format(KC(e)).replace(",",""),dateShort:(e,t)=>{const s=new Intl.DateTimeFormat(t,{dateStyle:"medium"});return"sv-se"===t?.toLowerCase()?s.format(KC(e)).replace(".",""):s.format(KC(e))},dateShortWithWeekday:(e,t)=>{const s=new Intl.DateTimeFormat(t,{weekday:"short",year:"numeric",month:"short",day:"numeric"}).format(KC(e));return"sv-se"===t?.toLowerCase()?s.replace(".",""):"en-gb"===t?.toLowerCase()?s.replace(",",""):s},timeShort:(e,t)=>new Intl.DateTimeFormat(t,{timeStyle:"short"}).format(KC(e)),timeLong:(e,t)=>new Intl.DateTimeFormat(t,{timeStyle:"medium"}).format(KC(e)),dateTimeLong:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"long",timeStyle:"short"}).format(KC(e)),dateTimeLongWithWeekday:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"full",timeStyle:"short"}).format(KC(e)),dateTimeShort:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"medium",timeStyle:"short"}).format(KC(e))};let TC=class extends AC{constructor(){super(...arguments),this.format="dateOnlyNumbers"}get formattedValue(){return this.format&&this.format in YC?YC[this.format](this.value??this.element?.textContent??void 0,this.locale):this.value?.toString()??""}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};(0,o.Cc)([(0,i.MZ)({attribute:!1})],TC.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:String})],TC.prototype,"format",2),(0,o.Cc)([(0,i.MZ)({type:String})],TC.prototype,"locale",2),TC=(0,o.Cc)([(0,d.Y$)("gds-formatted-date")],TC);let RC=class extends g.M{};RC._regularSVG='<path d="M9.75027 5.52371L10.7168 4.55722C13.1264 2.14759 17.0332 2.14759 19.4428 4.55722C21.8524 6.96684 21.8524 10.8736 19.4428 13.2832L18.4742 14.2519M5.52886 9.74513L4.55722 10.7168C2.14759 13.1264 2.1476 17.0332 4.55722 19.4428C6.96684 21.8524 10.8736 21.8524 13.2832 19.4428L14.2478 18.4782M9.5 14.5L14.5 9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>',RC._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M18.9125 5.08755C16.7957 2.97082 13.3638 2.97082 11.2471 5.08755L9.75027 6.58437L8.68961 5.52371L10.1864 4.02689C12.889 1.32437 17.2706 1.32437 19.9731 4.02689C22.6756 6.7294 22.6756 11.111 19.9731 13.8136L18.4742 15.3125L17.4135 14.2519L18.9125 12.7529C21.0292 10.6362 21.0292 7.20428 18.9125 5.08755ZM15.5607 9.5L9.5 15.5607L8.43934 14.5L14.5 8.43934L15.5607 9.5ZM6.58952 9.74513L5.08755 11.2471C2.97082 13.3638 2.97082 16.7957 5.08755 18.9125C7.20428 21.0292 10.6362 21.0292 12.7529 18.9125L14.2478 17.4176L15.3084 18.4782L13.8136 19.9731C11.1111 22.6756 6.72941 22.6756 4.02689 19.9731C1.32437 17.2706 1.32437 12.889 4.02689 10.1864L5.52886 8.68446L6.58952 9.74513Z" fill="currentColor"/>',RC._name="chain-link",RC._width=24,RC._height=24,RC._viewBox="0 0 24 24",RC=(0,o.Cc)([(0,d.Y$)("gds-icon-chain-link")],RC),RC.define();var PC,DC,OC,FC,UC,JC,QC,XC,eh,th,sh,rh,oh,nh,ih,lh,ah,ch,dh=y.AH`
  :host {
    display: inline-block;
    height: max-content;
    text-align: left;
...
`;let Ch=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(R(hs(c.j)))))){constructor(){super(...arguments),(0,o.VK)(this,PC),(0,o.VK)(this,OC),(0,o.VK)(this,UC),(0,o.VK)(this,QC),(0,o.VK)(this,eh),(0,o.VK)(this,sh),(0,o.VK)(this,oh),(0,o.VK)(this,ih),(0,o.VK)(this,ah),this.title="",this.excerpt="",this.label="",this.variant="neutral-01",this.tag="h2",this.ratio="landscape",this.category="",this.date="",this.dateFormat="dateTimeLong",this.locale="en-GB"}render(){return(0,F.z)(this.href,()=>(0,o.jq)(this,eh,th).call(this),()=>(0,o.jq)(this,oh,nh).call(this))}};PC=new WeakSet,DC=function(e=!1){return e&&this.label||this.querySelector('[slot="footer"]')},OC=new WeakSet,FC=function(e){return(0,l.H)({card:!0,[`card-${e}`]:!!e,[`variant-${this.variant}`]:!0,[`ratio-${this.ratio}`]:!0})},UC=new WeakSet,JC=function(){return!!this.querySelector('[slot="media"]')},QC=new WeakSet,XC=function(){return this.src?d.qy`
      ...
      `:(0,o.jq)(this,UC,JC).call(this)?d.qy`
        <gds-flex
          padding="xs xs 0 xs"
          flex="1"
          aspect-ratio=${"square"===this.ratio?"1/1":"16/9"}
      ...
      `:null},eh=new WeakSet,th=function(){return d.qy`
      <gds-card-linked
        padding="0"
        gap="0"
        href=${(0,a.J)(this.href)}
        ...
        rel=${(0,a.J)(this.rel)}
        variant=${this.variant}
        class=${(0,o.jq)(this,OC,FC).call(this,"linked")}
      >
        ${(0,o.jq)(this,ah,ch).call(this)}
      </gds-card-linked>
    `},sh=new WeakSet,rh=function(){return(0,F.z)((0,o.jq)(this,PC,DC).call(this,!0),()=>d.qy`
        <gds-flex
          font="detail-m-book"
          align-items="center"
          gap="s"
      ...
      <gds-card
        ...
        gap="0"
        variant=${this.variant}
        class=${(0,o.jq)(this,OC,FC).call(this,"static")}
      >
        ${(0,o.jq)(this,ah,ch).call(this)}
      </gds-card>
    `},ih=new WeakSet,lh=function(){return(0,F.z)((0,o.jq)(this,PC,DC).call(this),()=>d.qy`
        <gds-flex font="detail-m-book" align-items="center" gap="s">
          <slot name="footer"></slot>
        </gds-flex>
      `)},ah=new WeakSet,ch=function(){return d.qy`
      ${(0,o.jq)(this,QC,XC).call(this)}
      <gds-flex flex-direction="column" gap="xl" padding="xl">
        ${(0,F.z)(!this.src&&!(0,o.jq)(this,UC,JC).call(this),()=>d.qy`<slot name="header"></slot>`)}
...
`;let Gh=class extends(R(Nh.s)){constructor(){super(...arguments),(0,o.VK)(this,ph),(0,o.VK)(this,gh),(0,o.VK)(this,mh),(0,o.VK)(this,Mh),(0,o.VK)(this,kh),(0,o.VK)(this,yh),(0,o.VK)(this,wh),(0,o.VK)(this,xh),(0,o.VK)(this,Zh),(0,o.VK)(this,$h),this._isWrapped=!1,this._hasLead=!1,this.label="",this.selectable=!1,this.checked=!1,this.indeterminate=!1,this.disabled=!1,this._hasTrailContent=!1}_checkWrap(){const e=this._itemsContainer;if(!e)return;const t=Array.from(e.children);if(t.length<2)return void(this._isWrapped=!1);const s=t[0].getBoundingClientRect().top;this._isWrapped=t.some(e=>e.getBoundingClientRect().top>s)}updated(e){super.updated(e),e.has("href")&&(0,o.jq)(this,gh,fh).call(this)}render(){return d.qy`${(0,o.jq)(this,$h,Ih).call(this)}`}};ph=new WeakSet,uh=function(){return!!this.href},gh=new WeakSet,fh=function(){this._hasTrailContent=(0,o.S7)(this,ph,uh)||!!this._trailSlot?.assignedElements().length},mh=new WeakSet,vh=function(){const e=e=>{e.stopPropagation(),this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))};return d.qy`
      <div
        class="rbcb-wrapper"
        role="checkbox"
    ...
    `},Mh=new WeakSet,bh=function(){return this.selectable?(0,o.jq)(this,mh,vh).call(this):d.qy``},kh=new WeakSet,Vh=function(e,t=!1){return d.qy`
    ...
    `},yh=new WeakSet,_h=function(e){const t=e.target;this._hasLead=t.assignedElements().length>0},wh=new WeakSet,Lh=function(e){const t=e.target;this._hasTrailContent=t.assignedElements().length>0||(0,o.S7)(this,ph,uh)},xh=new WeakSet,Hh=function(){if(this.items&&this.items.length>0){const e=this.items.length>=3?"wrap":"nowrap",t=this.items.length>=2&&!this._isWrapped;return d.qy`
        <slot name="lead" @slotchange=${(0,o.jq)(this,yh,_h)}></slot>
        <gds-flex
          ...
          flex-wrap=${e}
        >
          ${this.items.map((e,s)=>{const r=s===this.items.length-1;return(0,o.jq)(this,kh,Vh).call(this,0===s&&this.label&&!e.label?{...e,label:this.label}:e,t&&r)})}
        </gds-flex>
        <slot></slot>
      `}return d.qy`<slot name="lead" @slotchange=${(0,o.jq)(this,yh,_h)}></slot
      ><slot></slot>`},Zh=new WeakSet,Sh=function(){const e=(0,l.H)({"has-content":this._hasTrailContent});return d.qy`
      <slot name="trail" @slotchange=${(0,o.jq)(this,wh,Lh)} class=${e}
        >${(0,F.z)(this.href,()=>d.qy`<gds-icon-chevron-right
              class="nav-chevron"
            ></gds-icon-chevron-right>`)}</slot
      >
    `},$h=new WeakSet,Ih=function(){if((0,o.S7)(this,ph,uh)&&this.selectable)return d.qy`
        ${(0,o.jq)(this,Mh,bh).call(this)} ${(0,o.jq)(this,xh,Hh).call(this)}
        <gds-button
          slot="trail"
          href=${(0,a.J)(this.href)}
          target=${(0,a.J)(this.target)}
          ...
          ><gds-icon-chevron-right></gds-icon-chevron-right
        ></gds-button>
      `;if((0,o.S7)(this,ph,uh)){const e=(0,l.H)({"has-lead":this._hasLead});return d.qy`
        ${(0,o.jq)(this,Mh,bh).call(this)}
        <a
          class="linked-area ${e}"
          href=${(0,a.J)(this.href)}
          target=${(0,a.J)(this.target)}
          ...
          ping=${(0,a.J)(this.ping)}
        >
          ${(0,o.jq)(this,xh,Hh).call(this)} ${(0,o.jq)(this,Zh,Sh).call(this)}
        </a>
      `}return d.qy`${(0,o.jq)(this,Mh,bh).call(this)} ${(0,o.jq)(this,xh,Hh).call(this)}
    ${(0,o.jq)(this,Zh,Sh).call(this)}`},Gh.styles=[...C.LU,Q.A,jh],(0,o.Cc)([(0,i.wk)()],Gh.prototype,"_isWrapped",2),(0,o.Cc)([(0,i.wk)()],Gh.prototype,"_hasLead",2),(0,o.Cc)([(0,i.P)(".items-container")],Gh.prototype,"_itemsContainer",2),(0,o.Cc)([(0,i.P)('slot[name="trail"]')],Gh.prototype,"_trailSlot",2),(0,o.Cc)([(0,As.b)()],Gh.prototype,"_checkWrap",1),(0,o.Cc)([(0,i.MZ)({type:Array})],Gh.prototype,"items",2),(0,o.Cc)([(0,i.MZ)({reflect:!0})],Gh.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Gh.prototype,"selectable",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Gh.prototype,"checked",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Gh.prototype,"indeterminate",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Gh.prototype,"disabled",2),(0,o.Cc)([(0,i.wk)()],Gh.prototype,"_hasTrailContent",2),Gh=(0,o.Cc)([(0,d.Y$)("gds-list-item-pattern-01",{dependsOn:[ot.o,Rt,z.t,se.V,re,Ar.V]})],Gh);const Eh=e=>{Gh.define();const t=(0,L.pI)("gds-list-item-pattern-01"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Eh.displayName="GdsListItemPattern01";var qh=y.AH`
  @layer tokens, core, sizes, shapes;
...
`;let Bh=class extends((0,u.TM)((0,u.lt)(c.j))){connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","group")}render(){return d.qy`<slot></slot>`}};Bh.styles=[C.LU,qh],Bh=(0,o.Cc)([(0,d.Y$)("gds-avatar-group")],Bh);const zh=e=>{Bh.define();const t=(0,L.pI)("gds-avatar-group"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};zh.displayName="GdsAvatarGroup";var Wh,Ah,Kh,Yh,Th,Rh,Ph,Dh,Oh,Fh,Uh,Jh,Qh=y.AH`
  @layer base {
    :host {
      display: contents;
    }
...
`;let Xh=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,Wh),(0,o.VK)(this,Kh),(0,o.VK)(this,Th),(0,o.VK)(this,Ph),(0,o.VK)(this,Oh),(0,o.VK)(this,Uh),this.href="",this.label="",this.overflow=!1}render(){return d.qy`
      <div role="listitem" class="list-item">${(0,o.jq)(this,Kh,Yh).call(this)}</div>
    `}};Wh=new WeakSet,Ah=function(){return"_blank"===this.target?"noreferrer noopener":void 0},Kh=new WeakSet,Yh=function(){return[(0,o.jq)(this,Th,Rh).call(this)].map(e=>d.qy`${e}`)},Th=new WeakSet,Rh=function(){return this.overflow?(0,o.jq)(this,Ph,Dh).call(this):this.href?(0,o.jq)(this,Oh,Fh).call(this):(0,o.jq)(this,Uh,Jh).call(this)},Ph=new WeakSet,Dh=function(){return d.qy`<slot></slot>`},Oh=new WeakSet,Fh=function(){return d.qy`
      <gds-link
        href=${(0,a.J)(this.href)}
        target=${(0,a.J)(this.target)}
        rel=${(0,a.J)(this.rel||(0,o.S7)(this,Wh,Ah))}
        aria-label=${this.label||y.s6}
      >
        <slot name="lead"></slot>
        <slot></slot>
    ...
    `},Uh=new WeakSet,Jh=function(){return d.qy`
      <gds-text
        color="neutral-02"
        font-weight="regular"
    ...
    `},Xh.styles=[Qh],(0,o.Cc)([(0,i.MZ)()],Xh.prototype,"href",2),(0,o.Cc)([(0,i.MZ)()],Xh.prototype,"target",2),(0,o.Cc)([(0,i.MZ)()],Xh.prototype,"rel",2),(0,o.Cc)([(0,i.MZ)()],Xh.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Xh.prototype,"overflow",2),Xh=(0,o.Cc)([(0,d.Y$)("gds-breadcrumb",{dependsOn:[br,Rt]})],Xh);const ep=e=>{Xh.define();const t=(0,L.pI)("gds-breadcrumb"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};ep.displayName="GdsBreadcrumb";const tp=y.AH`
  :host {
    /* Font Sizes */
...
`;var sp,rp,op,np,ip,lp,ap,cp,dp,Cp,hp,pp,up,gp,fp;let mp=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,rp),(0,o.VK)(this,np),(0,o.VK)(this,lp),(0,o.VK)(this,cp),(0,o.VK)(this,Cp),(0,o.VK)(this,pp),(0,o.VK)(this,gp),this.size="large",this.flexDirection="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,(0,o.VK)(this,sp,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){(0,o.S7)(this,sp).call(this)}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",(0,o.S7)(this,sp))}render(){const e={"checkbox-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      role="group"
      id="checkboxgroup"
      class=${(0,l.H)(e)}
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,rp,op).call(this)}
    </div>`}_syncOnDOMChange(){(0,o.S7)(this,sp).call(this),(0,o.jq)(this,Cp,hp).call(this)}};sp=new WeakMap,rp=new WeakSet,op=function(){return[(0,o.jq)(this,np,ip).call(this),(0,o.jq)(this,lp,ap).call(this),(0,o.jq)(this,gp,fp).call(this)].map(e=>d.qy`${e}`)},np=new WeakSet,ip=function(){if(this.label)return d.qy`<gds-form-control-header
        .showExtendedSupportingText=${this.showExtendedSupportingText}
      ...
      >
        ...
        <slot
          ...
          slot="extended-supporting-text"
        ></slot>
      </gds-form-control-header>`},lp=new WeakSet,ap=function(){return d.qy`<div class="content">
      <slot @input=${(0,o.jq)(this,cp,dp)}></slot>
    </div>`},cp=new WeakSet,dp=function(e){e&&e.stopPropagation(),(0,o.jq)(this,Cp,hp).call(this),(0,o.jq)(this,pp,up).call(this)},Cp=new WeakSet,hp=function(){const e=this.checkboxes.filter(e=>e.checked).map(e=>e.value);JSON.stringify(e)!==JSON.stringify(this.value)&&(this.value=e)},pp=new WeakSet,up=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},gp=new WeakSet,fp=function(){return d.qy`<gds-form-control-footer
      id="footer"
      class="size-${this.size}"
      .errorMessage=${this.invalid?this.errorMessage:void 0}
    >
    </gds-form-control-footer>`},mp.styles=[tp],(0,o.Cc)([(0,i.MZ)()],mp.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({attribute:"flex-direction"})],mp.prototype,"flexDirection",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,attribute:"hide-label"})],mp.prototype,"hideLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],mp.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],mp.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Array})],mp.prototype,"value",1),(0,o.Cc)([(0,i.P)("#checkboxgroup")],mp.prototype,"_elCheckboxGroup",2),(0,o.Cc)([(0,ee.w)("value",{waitUntilFirstUpdate:!0})],mp.prototype,"_handleValueChange",1),(0,o.Cc)([(0,ee.w)("invalid"),(0,ee.w)("errorMessage")],mp.prototype,"_handleGroupInvalidChange",1),(0,o.Cc)([(0,Bo.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],mp.prototype,"_syncOnDOMChange",1),mp=(0,o.Cc)([(0,j.J)({labelledBy:"#checkboxgroup",describedBy:"#checkboxgroup",errorMessage:"#checkboxgroup"}),(0,N.cc)()],mp);let vp=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(mp)))){};vp=(0,o.Cc)([(0,d.Y$)("gds-checkbox-group",{dependsOn:[Bs.$,qs.V]})],vp);const Mp=e=>{vp.define();const t=(0,L.pI)("gds-checkbox-group"),s=(0,n.useRef)(null),r=e.ref||s;(0,L.j_)(r,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:r};return(0,n.createElement)(t,c)};Mp.displayName="GdsCheckboxGroup";const bp=e=>{Te.define();const t=(0,L.pI)("gds-icon-details"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};bp.displayName="GdsIconDetails";var kp=s(1912);const Vp=e=>{kp.x.define();const t=(0,L.pI)("gds-filter-chip"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Vp.displayName="GdsFilterChip";const yp={"seb-account":e=>{const t="string"==typeof e?e.replace(" ",""):e?.toString()??"";return 11!==t.length?t:`${t.slice(0,4)} ${t.slice(4,6)} ${t.slice(6,9)} ${t.slice(9,11)}`}};let _p=class extends AC{constructor(){super(...arguments),this.format="seb-account"}get formattedValue(){return yp[this.format](this.account)}firstUpdated(e){super.firstUpdated(e),!this.account&&this.textContent&&(this.account=this.textContent)}};(0,o.Cc)([(0,i.MZ)()],_p.prototype,"account",2),(0,o.Cc)([(0,i.MZ)({type:String})],_p.prototype,"format",2),_p=(0,o.Cc)([(0,d.Y$)("gds-formatted-account")],_p);const wp=e=>{_p.define();const t=(0,L.pI)("gds-formatted-account"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};wp.displayName="GdsFormattedAccount";const Lp=e=>{TC.define();const t=(0,L.pI)("gds-formatted-date"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Lp.displayName="GdsFormattedDate";const xp={decimalsAndThousands:(e,t,s,r)=>{const o={maximumFractionDigits:r??2,minimumFractionDigits:r??2};return s?new Intl.NumberFormat(t,{...o,style:"currency",currency:s}).format(Number(e)):new Intl.NumberFormat(t,o).format(Number(e))}};let Hp=class extends AC{constructor(){super(...arguments),this.format="decimalsAndThousands"}get formattedValue(){return xp[this.format](this.value,this.locale,this.currency,this.decimals)}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};(0,o.Cc)([(0,i.MZ)({attribute:!1})],Hp.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:String})],Hp.prototype,"locale",2),(0,o.Cc)([(0,i.MZ)({type:String})],Hp.prototype,"currency",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Hp.prototype,"decimals",2),(0,o.Cc)([(0,i.MZ)({type:String})],Hp.prototype,"format",2),Hp=(0,o.Cc)([(0,d.Y$)("gds-formatted-number")],Hp);const Zp=e=>{Hp.define();const t=(0,L.pI)("gds-formatted-number"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Zp.displayName="GdsFormattedNumber";const Sp=e=>{Nh.s.define();const t=(0,L.pI)("gds-list-item"),s={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,s)};Sp.displayName="GdsListItem";const $p=y.AH`
  :host {
    /* Font Sizes */
    --_font-label: var(--gds-sys-text-detail-m-book);
    --_font-supporting-text: var(--gds-sys-text-detail-s-regular);
...
`;var Ip,Np,jp,Gp,Ep,qp,Bp,zp,Wp,Ap,Kp,Yp,Tp,Rp,Pp,Dp,Op,Fp,Up,Jp;let Qp=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,Ip),(0,o.VK)(this,jp),(0,o.VK)(this,Ep),(0,o.VK)(this,Bp),(0,o.VK)(this,Wp),(0,o.VK)(this,Kp),(0,o.VK)(this,Tp),(0,o.VK)(this,Pp),(0,o.VK)(this,Op),(0,o.VK)(this,Up),this.size="large",this.flexDirection="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),(0,o.jq)(this,Ip,Np).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}focus(e){this._getValidityAnchor()?.focus(e)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{(0,o.jq)(this,Ip,Np).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid,e.errorMessage=this.errorMessage})}render(){const e={"radio-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,Tp,Rp).call(this)}
    </div>`}};Ip=new WeakSet,Np=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(e=>e.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(e=>!e.checked).forEach(e=>e.setAttribute("tabindex","-1"))},jp=new WeakSet,Gp=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(e=>e.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))},Ep=new WeakSet,qp=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("change",{composed:!0,bubbles:!0})),this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},Bp=new WeakSet,zp=function(e){e.stopPropagation();const t=e.target;this.value=t.value,this._syncRadioStates(),(0,o.jq)(this,Ep,qp).call(this)},Wp=new WeakSet,Ap=function(e){if(!this._isConnected)return;const t=this.radios.filter(e=>!e.disabled);if(0===t.length)return;let s=t.findIndex(e=>document.activeElement===e);switch(-1===s&&(s=t.findIndex(e=>e.checked),-1===s&&(s=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const r=(s+1)%t.length;(0,o.jq)(this,Kp,Yp).call(this,t[r]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const r=(s-1+t.length)%t.length;(0,o.jq)(this,Kp,Yp).call(this,t[r]);break}default:return}},Kp=new WeakSet,Yp=function(e){this._contentElement&&this._isConnected&&(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),(0,o.jq)(this,Ep,qp).call(this))},Tp=new WeakSet,Rp=function(){return[(0,o.jq)(this,Pp,Dp).call(this),(0,o.jq)(this,Op,Fp).call(this),(0,o.jq)(this,Up,Jp).call(this)].map(e=>d.qy`${e}`)},Pp=new WeakSet,Dp=function(){if(this.label)return d.qy` <gds-form-control-header
        class="size-${this.size}"
        .showExtendedSupportingText="${this.showExtendedSupportingText}"
      >
        <label id="group-label" slot="label">${this.label}</label>
...
//# sourceMappingURL=1422.fe850c7d.iframe.bundle.js.map