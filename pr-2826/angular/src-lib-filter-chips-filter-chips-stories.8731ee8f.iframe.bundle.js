/*! For license information please see src-lib-filter-chips-filter-chips-stories.8731ee8f.iframe.bundle.js.LICENSE.txt */
...
`;let u=class extends n.j{constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),a.n.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return o.qy`<gds-button
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};u.styles=[d],(0,i.Cc)([(0,r.MZ)({reflect:!0,type:Boolean})],u.prototype,"selected",2),(0,i.Cc)([(0,r.MZ)()],u.prototype,"value",2),(0,i.Cc)([(0,r.MZ)({reflect:!0,type:String})],u.prototype,"size",2),u=(0,i.Cc)([(0,o.Y$)("gds-filter-chip",{dependsOn:[c.t,h.V]})],u)},9830(e,t,s){s.d(t,{A:()=>C});var i,r,l,n,a,o,c,h=s(745),d=s(4367),u=s(3578),p=s(1239),g=s(4324),v=s(1374),f=s(6472),m=s(7526),b=s(8558),_=s(1912),y=s(9443).AH`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
...
//# sourceMappingURL=src-lib-filter-chips-filter-chips-stories.8731ee8f.iframe.bundle.js.map