import{i as S,n as p,a0 as E,f as k,I as V,S as F,T as M,$ as O,a8 as T,a as W,h as n,o as D,g as G}from"./iframe-CL7Bfxf7.js";import{I}from"./checkmark.component-XebMgf-Y.js";const L=S`
...
`,B=L;var j=Object.defineProperty,A=Object.getOwnPropertyDescriptor,f=t=>{throw TypeError(t)},a=(t,e,s,h)=>{for(var o=h>1?void 0:h?A(e,s):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(o=(h?d(e,s,o):d(o))||o);return h&&o&&j(e,s,o),o},g=(t,e,s)=>e.has(t)||f("Cannot "+s),v=(t,e,s)=>(g(t,e,"read from private field"),s?s.call(t):e.get(t)),u=(t,e,s)=>e.has(t)?f("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),c=(t,e,s)=>(g(t,e,"access private method"),s),r,y,x,_,z,m,P,w,$,C;let i=class extends T{constructor(){super(...arguments),u(this,r),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",u(this,m,()=>{this.checked=this._input.checked,c(this,r,C).call(this),c(this,r,P).call(this)}),u(this,w,t=>{this.disabled||t.key==="Enter"&&(t.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(t){this._internalValue=t}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(t){var e;(e=this._input)==null||e.focus(t)}render(){const t={switch:!0,checked:this.checked,disabled:this.disabled,"control-start":this.controlPlacement==="start",small:this.size==="small"};return n`
      <label class=${W(t)} for="switch-input">
    ...
    `}};r=new WeakSet;y=function(){return n`
      <input
        ...
        aria-label=${D(this.label?void 0:"Switch")}
        @keydown=${v(this,w)}
        @change=${v(this,m)}
      />
    ...
    `};m=new WeakMap;P=function(){c(this,r,$).call(this),this.dispatchStandardEvent("change",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})};w=new WeakMap;$=function(){this.checked?this._setFormValue(this._internalValue||"on"):this._setFormValue(null)};C=function(){const t=this._perimeter;t&&(t.classList.remove("ripple"),t.offsetWidth,t.classList.add("ripple"))};i.styles=[B];a([p({type:Boolean,reflect:!0})],i.prototype,"checked",2);a([p({attribute:"control-placement",reflect:!0})],i.prototype,"controlPlacement",2);a([p({reflect:!0})],i.prototype,"size",2);a([E({selector:".switch",valueTemplate:t=>t})],i.prototype,"justify-content",2);a([k('input[type="checkbox"]')],i.prototype,"_input",2);a([k(".perimeter")],i.prototype,"_perimeter",2);i=a([V({labelledBy:"#switch-input",describedBy:"#switch-input",errorMessage:"#switch-input"})],i);let b=class extends F(M(O(i))){};b=a([G("gds-switch",{dependsOn:[I]})],b);export{b as G};
