import{i as m,S as P,$ as G,T as S,J as v,O as A,a as B,h,E,n as d,g as y,I,A as D,o as g}from"./iframe-yTRwv3_g.js";import{l as M}from"./localized-decorator-ruIXfqxP.js";import{I as k}from"./chevron-left.component-uX8A3ZDf.js";import{G as L}from"./link-9_nEKtkc.js";import{G as T}from"./text.component-C1TtARAB.js";const j=m`
...
`;var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,u=(t,e,s,n)=>{for(var r=n>1?void 0:n?q(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&W(e,s,r),r};let f=class extends P(G(S(v))){constructor(){super(...arguments),this.size="large",this.label=A("Breadcrumbs")}get breadcrumbItems(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumb]"))}handleSlotChange(){const t=this.breadcrumbItems;t.forEach((e,s)=>{s===t.length-2?e.setAttribute("return",""):e.removeAttribute("return")})}render(){return h`
    ...
    `}};f.styles=[E,j];u([d({type:String})],f.prototype,"size",2);u([d({type:String})],f.prototype,"label",2);f=u([y("gds-breadcrumbs",{dependsOn:[k]}),I({labelledBy:"nav"}),M()],f);const F=m`
  @layer base {
    :host {
      display: contents;
    }
...
`;var J=Object.defineProperty,R=Object.getOwnPropertyDescriptor,_=t=>{throw TypeError(t)},c=(t,e,s,n)=>{for(var r=n>1?void 0:n?R(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&J(e,s,r),r},b=(t,e,s)=>e.has(t)||_("Cannot "+s),X=(t,e,s)=>(b(t,e,"read from private field"),s?s.call(t):e.get(t)),H=(t,e,s)=>e.has(t)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),p=(t,e,s)=>(b(t,e,"access private method"),s),a,x,w,$,C,O,z;let i=class extends v{constructor(){super(...arguments),H(this,a),this.href="",this.label="",this.overflow=!1}render(){return h`
    ...
    `};i.styles=[F];c([d()],i.prototype,"href",2);c([d()],i.prototype,"target",2);c([d()],i.prototype,"rel",2);c([d()],i.prototype,"label",2);c([d({type:Boolean,reflect:!0})],i.prototype,"overflow",2);i=c([y("gds-breadcrumb",{dependsOn:[L,T]})],i);export{f as G,i as a};
