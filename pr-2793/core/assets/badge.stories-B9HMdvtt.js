import{b as a}from"./iframe-BM_8FZB_.js";import{a as O}from"./argTableProps-CFE3P9bW.js";import"./badge-D7gd43rZ.js";import"./flex-Cdhh7wWv.js";import"./divider-HpZz22l8.js";import"./circle-info-DX96m-7k.js";import"./circle-check-0KsOWhye.js";import"./arrow-rotate-counter-clockwise.component-J4ixZ-H3.js";import"./minus-small-BTQyXWwX.js";import"./rocket-DJ20CaBN.js";import"./triangle-exclamation-DzVETe4A.js";import"./preload-helper-Dp1pzeXC.js";import"./badge.component-zHQJst7h.js";import"./flex.component-Bja9guhD.js";import"./divider.component-CbvkfoyB.js";import"./circle-info.component-Q0sanyXw.js";import"./icon.component-uA6lywTJ.js";import"./circle-check.component-5dO9cetu.js";import"./minus-small.component-BswRs1b9.js";import"./rocket.component-C5lKCM_p.js";import"./triangle-exclamation.component-Dv8KKcZM.js";const me={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...O("gds-badge")}},o={name:"Variants",render:e=>a`
    <gds-flex
...
\`\`\``,...(D=(C=g.parameters)==null?void 0:C.docs)==null?void 0:D.description}}};var V,L,R,A,P;i.parameters={...i.parameters,docs:{...(V=i.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...
  \`
}`,...(B=(j=t.parameters)==null?void 0:j.docs)==null?void 0:B.source},description:{story:'The `Rounded` story demonstrates the use of the `gds-badge` component with the `rounded` property.\n\nWhen set to `true`, the badge will have fully rounded corners.\n\nExample usage:\n\n```html\n<gds-badge rounded variant="information"> 01 </gds-badge>\n```\n\n@property {boolean} rounded - Controls the border radius of the badge.',...(F=(q=t.parameters)==null?void 0:q.docs)==null?void 0:F.description}}};const be=["Variants","Lead","Trail","Size","Notification","Rounded"];export{n as Lead,i as Notification,t as Rounded,g as Size,s as Trail,o as Variants,be as __namedExportsOrder,me as default};
