import{b as j}from"./iframe-pTSexOyH.js";import"./div-BnJk2GK2.js";import"./flex-CvI6xnho.js";import"./card-CshjdGZ0.js";import{a as B}from"./argTableProps-ChRIsf-L.js";import"./preload-helper-Dp1pzeXC.js";import"./flex.component-CilBrwEk.js";import"./card.component-BruH2qXD.js";const I={title:"Components/Div",component:"gds-div",tags:["autodocs"],argTypes:{...B("gds-div")},parameters:{docs:{description:{component:"`gds-div` is a base element in the declarative layout system.\n\nDiv accepts all available style expression properties, and is also the base class for `gds-flex`, `gds-grid`, `gds-card` and `gds-text`"}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},s={...t,args:{background:"01",border:"2xs","border-radius":"m","border-color":"neutral-02",width:"4xl",height:"4xl"}},r={...t,render:S=>j`
...
}`,...(a=(n=s.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};var i,l,g,c,u;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <!-- This is equivalent to 'gds-flex' -->
    <gds-div
  ...
  \`
}`,...(g=(l=r.parameters)==null?void 0:l.docs)==null?void 0:g.source},description:{story:"Here is an example of a simple layout structure using `gds-div`:",...(u=(c=r.parameters)==null?void 0:c.docs)==null?void 0:u.description}}};var p,m,b,x,h;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Border Style',
