import"./switch-BPF8GzvC.js";import"./flex-Cq2nUOUE.js";import{b as t}from"./iframe-yTRwv3_g.js";import"./text-CKk33hlv.js";import"./divider-D2JJkw67.js";import{a as U}from"./argTableProps-BlomErtr.js";import"./switch.component-CQAg477g.js";import"./checkmark.component-C2Nu5IAs.js";import"./icon.component-Dlf2DeO8.js";import"./flex.component-BQRfLWEE.js";import"./preload-helper-Dp1pzeXC.js";import"./text.component-C1TtARAB.js";import"./default-typography.styles-DhF4OhWu.js";const Z={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...U("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
