import{b as r}from"./iframe-DeOIKC_g.js";import"./card-DFNkjFEY.js";import"./flex-D8BmS7bA.js";import"./div-TbnBbLpV.js";import{a as w}from"./argTableProps-BnOVaxed.js";import"./preload-helper-Dp1pzeXC.js";import"./card.component-sLucDxGv.js";import"./flex.component-BS1lVn8F.js";const I={title:"Components/Grid",component:"gds-grid",tags:["autodocs"],parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grid)\n\nThe `gds-grid` is a custom element that provides a flexible grid system. It uses CSS grid layout to arrange its child elements into columns. This component is highly customizable and responsive, allowing you to specify the number of `columns`, `gap`, `padding`, and fluidity for different devices with automated column size based on the content using the `auto-columns` attribute."}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{...w("gds-grid")},args:{gap:"m",padding:"0",columns:"4",innerHTML:`
  ...
  `},t={...a,name:"Breakpoints + Auto Columns",render:i=>r`
    <!-- prettier-ignore -->
  ...
  `},n={...a,name:"Auto Columns",render:i=>r`
    <!-- prettier-ignore -->
  ...
  `};var l,d,c;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(c=(d=s.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};var g,o,h,u,m;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <!-- prettier-ignore -->
    <gds-grid
  ...
  \`
}`,...(p=(x=t.parameters)==null?void 0:x.docs)==null?void 0:p.source},description:{story:"This example shows a grid with `4` columns on all breakpoints desktop, tablet, and on mobile. It also has a gap of `2xl` on all breakpoints. The padding is `l` on all breakpoints. As well as `auto-columns` attribute is set to `100` which will make the columns to be `~100px` wide.",...(C=(v=t.parameters)==null?void 0:v.docs)==null?void 0:C.description}}};var y,L,j,O,b;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Auto Columns',
  render: args => html\`
    <!-- prettier-ignore -->
  ...
  \`
}`,...(j=(L=n.parameters)==null?void 0:L.docs)==null?void 0:j.source},description:{story:`Auto Columns, while optional, remove the need for breakpoints, adapting to content for a more flexible and responsive grid.
...
The \`auto-columns\` attribute is set to \`240\` which will make the columns to be \`240px\` no matter the screen/container size.`,...(b=(O=n.parameters)==null?void 0:O.docs)==null?void 0:b.description}}};const B=["Basic","Usage","AllBreakpoints","AutoColumns"];export{t as AllBreakpoints,n as AutoColumns,s as Basic,e as Usage,B as __namedExportsOrder,I as default};
