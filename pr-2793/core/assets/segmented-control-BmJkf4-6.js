import{i as W,$,J as z,a1 as B,h as P,E as L,n as g,g as V,S as M,T as G,O as C,f as S,H as T,a7 as D,I as N}from"./iframe-BOWV0qpc.js";import{l as R}from"./localized-decorator-BpW4MtTU.js";import{r as X}from"./resize-observer-B9k8v2TZ.js";import{I as A}from"./chevron-left.component-BfJ8ghSi.js";import{I as F}from"./chevron-right.component-BRh_VDv4.js";const H=W`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var J=Object.defineProperty,j=Object.getOwnPropertyDescriptor,m=(e,t,s,i)=>{for(var r=i>1?void 0:i?j(t,s):t,a=e.length-1,h;a>=0;a--)(h=e[a])&&(r=(i?h(t,s,r):h(r))||r);return i&&r&&J(t,s,r),r};let p=class extends $(z){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return P`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};p.styles=[...L,H];m([g({type:Boolean,reflect:!0})],p.prototype,"selected",2);m([g()],p.prototype,"value",2);m([g({type:Boolean,reflect:!0})],p.prototype,"disabled",2);p=m([V("gds-segment")],p);const q=W`
  @layer base {
    :host {
