import{b as e,A as b}from"./iframe-DNybJ50c.js";import"./text-CVjzQ6R3.js";import"./divider-u4zxxJ4a.js";import"./flex-TG2_Fjr_.js";import"./credit-card-DJ8slSbG.js";import"./arrow-left-Bw1Kma7i.js";import"./chevron-top-DfQPtaxp.js";import"./arrow-up-CUxySLVJ.js";import"./arrow-down-BQY3tyAC.js";import"./arrow-right-C_dORzEL.js";import{a as x}from"./argTableProps-CuvC6GT3.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-nxPXvugj.js";import"./default-typography.styles-CHbkP-Ka.js";import"./flex.component-BdKeRGh3.js";import"./credit-card.component-kvgYVakv.js";import"./icon.component-B2P0L8k1.js";import"./arrow-left.component-B2Z6JINp.js";import"./chevron-top.component-D-rdUrjC.js";import"./arrow-up.component-Cgv9IsxR.js";import"./arrow-down.component-BdhPnzSS.js";import"./arrow-right.component-K-YIpgqE.js";const _={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:"A button can be tapped or clicked to perform an action."}}},tags:["autodocs"],argTypes:{...x("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","brand","positive","negative"],control:{type:"select"}},size:{options:["xs","small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},p={...n},r={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>e`
  ...
  `},i={...n,parameters:{...n.parameters,controls:{include:["href","target","rel","download"]}},args:{href:"https://github.com/seb-oss/green"},render:t=>e`
    <gds-button
      ...
      target=${t.target||b}
      rel=${t.rel||b}
      download=${t?.hasOwnProperty("download")?t.download:b}
    >
      Link
    </gds-button>
...
Icons</a> that can be used.`,...d.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...o.parameters?.docs?.source},description:{story:`The buttons support a disabled state, but in general, it should not be used. It can be
hard for the user to understand why the button is disabled, so it is often better to
keep the button clickable and then show an error message instead.`,...o.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...i.parameters?.docs?.source},description:{story:"A link styled as a button.",...i.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...g.parameters?.docs?.source},description:{story:"Button label will be wrapped if it does not fit.",...g.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...c.parameters?.docs?.source},description:{story:"Some attributes are forwarded to the inner button element by default.\n\nAria attributes such as `label`, `aria-haspopup`, and `aria-expanded` are forwarded to the inner button.\nIf you need to force a certain aria attribute on the inner button, use the `gds-aria-*` attributes on the\n`gds-button` element.\n\nThe `gds-tabindex` attribute can be used to control the inner button tabindex.",...c.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Next & Previous',
  parameters: {
    ...DefaultParams.parameters,
  ...
  \`
}`,...l.parameters?.docs?.source},description:{story:`The \`justify-content\` property allows control over how content is distributed within buttons.<br/>
...
\`\`\``,...l.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...u.parameters?.docs?.source},description:{story:"`gds-aria-*` attributes can be used to assign aria to the inner button or anchor element.",...u.parameters?.docs?.description}}};const F=["DefaultParams","Basic","RanksAndVariants","Sizes","WithIcon","IconButton","Disabled","Link","Wrapping","ForwardedAttributes","NextPrevious","AriaControls"];export{u as AriaControls,p as Basic,n as DefaultParams,o as Disabled,c as ForwardedAttributes,d as IconButton,i as Link,l as NextPrevious,r as RanksAndVariants,a as Sizes,s as WithIcon,g as Wrapping,F as __namedExportsOrder,_ as default};
