import{J as c,h as n,g as p,i as b,E as v,n as u,a1 as y,d as m}from"./iframe-BOWV0qpc.js";var h=Object.getOwnPropertyDescriptor,f=(l,e,d,t)=>{for(var s=t>1?void 0:t?h(e,d):e,r=l.length-1,a;r>=0;r--)(a=l[r])&&(s=a(s)||s);return s};let i=class extends c{connectedCallback(){super.connectedCallback(),this.setAttribute("role","listitem")}render(){return n`<slot></slot>`}};i=f([p("gds-list-item")],i);const _=b`
  .gds-list-heading {
