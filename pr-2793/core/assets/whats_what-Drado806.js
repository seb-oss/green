import{R as u,m as s,u as g,j as t,M as f}from"./iframe-DeOIKC_g.js";import{aH as d}from"./mermaid.core-BSIGeMEA.js";import"./preload-helper-Dp1pzeXC.js";const x="dark",w="default",j="dark",h="light",T="data-theme";function A(n,e){var i,l;let r=n.getAttribute(T)??h;r===h||r===j||(r=h);const a=r===h?w:x;return((i=e==null?void 0:e.theme)==null?void 0:i[r])??((l=e==null?void 0:e.mermaid)==null?void 0:l.theme)??a}const C=({chart:n,config:e})=>{if(typeof window>"u")return u.createElement("div",{className:"mermaid","data-mermaid-src":n},n);const r=s.useMemo(()=>typeof e=="string"?JSON.parse(e):e,[e]),a=document.querySelector("html"),[i,l]=s.useState(!1),c=s.useMemo(()=>A(a,r),[r,i]);return s.useEffect(()=>{const o=new MutationObserver(b=>{for(const m of b)if(!(m.type!=="attributes"||m.attributeName!=="data-theme")){l(y=>!y);break}});return o.observe(a,{attributes:!0}),()=>{try{o.disconnect()}catch{}}},[]),s.useEffect(()=>{r&&(r.mermaid?d.initialize({startOnLoad:!0,...r.mermaid,theme:c}):d.initialize({startOnLoad:!0,theme:c}),document.querySelectorAll('div.mermaid[data-processed="true"]').forEach(o=>{o.removeAttribute("data-processed"),o.innerHTML=o.getAttribute("data-mermaid-src")}),d.contentLoaded())},[r,c]),s.useEffect(()=>{setTimeout(d.contentLoaded,0)},[n]),u.createElement("div",{className:"mermaid","data-mermaid-src":n},n)},k=({chart:n})=>n?u.createElement(C,{chart:n,config:{theme:{light:"neutral",dark:"dark"}}}):null;function p(n){const e={a:"a",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...g(),...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(f,{title:"What's what?"}),`
