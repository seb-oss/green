import"./rich-text-BlROqgOe.js";import"./divider-BJE5VIaB.js";import"./card-BhtpjOp6.js";import"./text-CFGZV6Vb.js";import{a as te}from"./argTableProps-DKKQpteZ.js";import{h as e}from"./iframe-DK0RITXN.js";import"./rich-text.component-B36GI5b2.js";import"./default-typography.styles-DA0MYNa-.js";import"./card.component-CUp0wnzS.js";import"./text.component-cCX79pHX.js";import"./preload-helper-Dp1pzeXC.js";const he={title:"Components/Rich Text",component:"gds-rich-text",tags:["autodocs"],argTypes:{...te("gds-rich-text")},parameters:{docs:{description:{component:`\`gds-rich-text\` can be used to wrap generic HTML content and apply typography styles.
...
It supports out of the box all heading styles, paragraphs, lists, blockquotes, figures, tables, and more.`}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},p={...t,name:"Card",render:i=>e`
    <gds-card>
      <gds-rich-text>
        <h1>
  ...
  `},n={...t,name:"Pairings",render:i=>e`
    <gds-rich-text>
      <gds-flex gap="xl" flex-direction="column">
        <gds-flex flex-direction="column">
          <h1 class="text-heading-xl">Text Heading XL</h1>
          <h2 class="text-preamble-m">Text Preamble M</h2>
          <p>
        ...
        <gds-flex flex-direction="column">
          <h2 class="text-heading-l">Text Heading L</h2>
          <h3 class="text-preamble-s">Text Preamble S</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
        ...
        <gds-divider></gds-divider>
        <gds-flex flex-direction="column">
          <h3 class="text-heading-m">Text Heading M</h3>
          <h4 class="text-preamble-s">Text Preamble S</h4>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
        ...
        <gds-divider></gds-divider>
        <gds-flex flex-direction="column">
          <h2 class="text-heading-m">Text Heading M</h2>
          <h3 class="text-preamble-s">
            Text Preamble S with an <a href="#">inline link</a>.
          </h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
        ...
        <gds-divider></gds-divider>
        <gds-flex flex-direction="column">
          <h3 class="text-heading-m">Text Heading M without preamble</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
  ...
  `},r={...t,name:"Blockquote",render:i=>e`
    <gds-rich-text>
  ...
  `},l={...t,name:"Formatting",render:i=>e`
    <gds-rich-text>
  ...
  `};var m,h,u;p.parameters={...p.parameters,docs:{...(m=p.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Card',
  render: args => html\`
    <gds-card>
  ...
  \`
}`,...(u=(h=p.parameters)==null?void 0:h.docs)==null?void 0:u.source}}};var g,f,y,v,b;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Headings',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(y=(f=a.parameters)==null?void 0:f.docs)==null?void 0:y.source},description:{story:"`gds-rich-text` can be used to wrap generic HTML content and apply typography styles.\nIt supports out of the box all heading styles from h1 to h6 based on the green design system typography styles.",...(b=(v=a.parameters)==null?void 0:v.docs)==null?void 0:b.description}}};var x,S,w,k,E;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Pairings',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(w=(S=n.parameters)==null?void 0:S.docs)==null?void 0:w.source},description:{story:"`gds-rich-text` has built-in support for typography pairings.\nApply classes to the heading and preamble elements to create consistent typography pairings based on the green design typography system.",...(E=(k=n.parameters)==null?void 0:k.docs)==null?void 0:E.description}}};var T,q,A,L,C;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lists',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(A=(q=o.parameters)==null?void 0:q.docs)==null?void 0:A.source},description:{story:"`gds-rich-text` has built-in support for ordered and unordered lists.\nIt applies consistent spacing and typography styles to list items.",...(C=(L=o.parameters)==null?void 0:L.docs)==null?void 0:C.description}}};var I,M,H,P,D;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Details',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(H=(M=s.parameters)==null?void 0:M.docs)==null?void 0:H.source},description:{story:"`gds-rich-text` has built-in support for details html element.\n\nThe details element is a disclosure widget from HTML5 that can be used to hide or show additional content.",...(D=(P=s.parameters)==null?void 0:P.docs)==null?void 0:D.description}}};var F,j,R,z,N;r.parameters={...r.parameters,docs:{...(F=r.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Blockquote',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(R=(j=r.parameters)==null?void 0:j.docs)==null?void 0:R.source},description:{story:"`gds-rich-text` has built-in support blockquote element.",...(N=(z=r.parameters)==null?void 0:z.docs)==null?void 0:N.description}}};var O,W,G,J,Q;l.parameters={...l.parameters,docs:{...(O=l.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Formatting',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(G=(W=l.parameters)==null?void 0:W.docs)==null?void 0:G.source},description:{story:"`gds-rich-text` has built-in support for inline formatting tags such as `s`, `mark`, `strong`,`small` and `em`.",...(Q=(J=l.parameters)==null?void 0:J.docs)==null?void 0:Q.description}}};var B,K,U,V,X;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Table',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(U=(K=d.parameters)==null?void 0:K.docs)==null?void 0:U.source},description:{story:"`gds-rich-text` has built-in support for tables.",...(X=(V=d.parameters)==null?void 0:V.docs)==null?void 0:X.description}}};var Y,_,Z,$,ee;c.parameters={...c.parameters,docs:{...(Y=c.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Theme',
  render: args => html\`
    <gds-card variant="neutral-02">
  ...
  \`
}`,...(Z=(_=c.parameters)==null?void 0:_.docs)==null?void 0:Z.source},description:{story:`Rich text can be used with other components to create engaging content.
...
\`\`\``,...(ee=($=c.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};const ue=["Card","Headings","Pairings","Lists","Details","Blockquote","Formatting","Table","Basic"];export{c as Basic,r as Blockquote,p as Card,s as Details,l as Formatting,a as Headings,o as Lists,n as Pairings,d as Table,ue as __namedExportsOrder,he as default};
