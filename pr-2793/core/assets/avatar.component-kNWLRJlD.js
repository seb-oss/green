import{i as _,T as h,S as g,J as f,h as c,E as y,g as x,$ as P,a as $,n as d,a0 as m,ah as b,o as S}from"./iframe-BOWV0qpc.js";import{I as O}from"./people-profile.component-CGZbWvTt.js";const A=_`
...
`;var E=Object.getOwnPropertyDescriptor,G=(e,t,a,i)=>{for(var s=i>1?void 0:i?E(t,a):t,l=e.length-1,n;l>=0;l--)(n=e[l])&&(s=n(s)||s);return s};let v=class extends h(g(f)){connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","group")}render(){return c`<slot></slot>`}};v.styles=[y,A];v=G([x("gds-avatar-group")],v);const j=_`
  @layer tokens, core, sizes, shapes;
