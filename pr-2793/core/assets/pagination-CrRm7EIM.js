import{i as E,S as L,Z as A,Q as D,I as W,A as R,d as v,h as d,E as T,n as g,f as F,H as _,N as p,g as J,O as q,a as Q}from"./iframe-BM_8FZB_.js";import{l as H}from"./localized-decorator-DJXQ3ino.js";import{w as V,G as X}from"./popover.component-C-WM60_t.js";import{a as Y,G as Z}from"./context-menu.component-DNOn2sgC.js";import{a as K}from"./dropdown.component-CeMyeJbB.js";import{I as U}from"./chevron-bottom.component-BPgl7l7L.js";import{I as tt,a as et,b as st,c as nt}from"./chevron-right-small.component-BfUhsAE5.js";import{I as it}from"./chevron-right.component-kaVWQt0H.js";import{G as ot}from"./input.component-CGwEEP_n.js";import{G as at}from"./text.component-RXqz04sn.js";const rt=E`
  :host {
    display: flex;
    align-items: center;
...
`;var lt=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,y=t=>{throw TypeError(t)},h=(t,s,n,c)=>{for(var l=c>1?void 0:c?pt(s,n):s,m=t.length-1,b;m>=0;m--)(b=t[m])&&(l=(c?b(s,n,l):b(l))||l);return c&&l&&lt(s,n,l),l},x=(t,s,n)=>s.has(t)||y("Cannot "+n),i=(t,s,n)=>(x(t,s,"read from private field"),n?n.call(t):s.get(t)),ht=(t,s,n)=>s.has(t)?y("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,n),o=(t,s,n)=>(x(t,s,"access private method"),n),e,u,a,P,w,G,C,z,I,k,M,S,O,N,f,j,B,$;const ct={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let r=class extends L(A(D(W))){constructor(){super(...arguments),ht(this,e),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(t){this._isMobile=t}render(){const s=i(this,e,u)>1,n=o(this,e,O).call(this);return!s&&!n?R:d`
      <gds-flex
        align-items="center"
    ...
    `};N=function(){return this._isMobile||!this.label?null:d`
      <gds-text
        font="${i(this,e,a).font}"
        color="neutral-02"
        aria-live="polite"
