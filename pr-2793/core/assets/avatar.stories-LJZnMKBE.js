...
Useful for chat, inbox, or activity scenarios where an avatar needs supplementary context.
  ...
  `};var o,c,v;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`{
  name: 'Default',
  parameters: {
    docs: {
      description: {
...
}`,...(v=(c=s.parameters)==null?void 0:c.docs)==null?void 0:v.source}}};var l,p,m;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  name: 'Text',
  parameters: {
    docs: {
      description: {
...
Use this pattern when profile images are unavailable.
  ...
  \`
}`,...(m=(p=r.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var u,h,f;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: 'Sizes',
  parameters: {
    docs: {
      description: {
...
Useful for validating layout spacing and hierarchy in different UI contexts.
  ...
  \`
}`,...(f=(h=t.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var z,x,b;e.parameters={...e.parameters,docs:{...(z=e.parameters)==null?void 0:z.docs,source:{originalSource:`{
...
Useful for quickly previewing positive, notice, and negative states.
  ...
  \`
}`,...(b=(x=e.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var P,y,A;n.parameters={...n.parameters,docs:{...(P=n.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'Image',
  parameters: {
    docs: {
      description: {
...
Includes both \\\`circular\\\` and \\\`square\\\` shapes for profile and utility use cases.
  ...
  \`
}`,...(A=(y=n.parameters)==null?void 0:y.docs)==null?void 0:A.source}}};var B,S,w;i.parameters={...i.parameters,docs:{...(B=i.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Shapes',
  parameters: {
    docs: {
      description: {
...
Choose a shape that aligns with the surrounding design language.
  ...
  \`
}`,...(w=(S=i.parameters)==null?void 0:S.docs)==null?void 0:w.source}}};var k,D,C;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Badge',
  parameters: {
    docs: {
      description: {
...
Useful for chat, inbox, or activity scenarios where an avatar needs supplementary context.
  ...
  \`
}`,...(C=(D=g.parameters)==null?void 0:D.docs)==null?void 0:C.source}}};var I,U,q;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'Group',
  parameters: {
    docs: {
      description: {
...
For accessibility, provide an \\\`aria-label\\\` on each group (for example, \\\`aria-label="Authors"\\\`).
  ...
  \`
}`,...(q=(U=d.parameters)==null?void 0:U.docs)==null?void 0:q.source}}};const N=["Default","WithText","Sizes","ColorAndBackground","WithImage","Shapes","WithBadge","Group"];export{e as ColorAndBackground,s as Default,d as Group,i as Shapes,t as Sizes,g as WithBadge,n as WithImage,r as WithText,N as __namedExportsOrder,M as default};
