import{b as i}from"./iframe-DLBS5KYo.js";import"./pagination-eOS7eaPi.js";import"./card-9hd9eUV0.js";import"./text-BCaCzryj.js";import"./flex-qtVQM3ca.js";import"./preload-helper-Dp1pzeXC.js";import"./localized-decorator-mDoEP3ph.js";import"./popover.component-D683RYKu.js";import"./floating-ui.dom-Ceeo7fpE.js";import"./cross-small.component-_SGTWcXf.js";import"./icon.component-BCe4BYHY.js";import"./context-menu.component-DwBJX25s.js";import"./unwrap-slots-AxFqI3g8.js";import"./ref-vjl6_V6-.js";import"./dot-grid-one-horizontal-CKbpObKG.js";import"./menu-heading.component-BwScAbaP.js";import"./dropdown.component-Cl9iKRqD.js";import"./query-async-DteKX9iD.js";import"./form-control-host.style-C2AfpjaI.js";import"./form-control-header.component-N1dZZpaY.js";import"./badge.component-9EyEklZm.js";import"./flex.component-JaFpVQ3G.js";import"./triangle-exclamation.component-DE9loRcE.js";import"./card.component-B0nggotg.js";import"./circle-info.component-BgKPoNne.js";import"./checkmark.component-DkC1oEGH.js";import"./rbcb-toggle.template-CdKAZLC-.js";import"./chevron-bottom.component-DXfYLJBc.js";import"./chevron-right-small.component-CoK8jN6B.js";import"./chevron-right.component-BFskwRD6.js";import"./input.component-CJvf7QKV.js";import"./textarea.component-c66fe24q.js";import"./resize-observer-B9k8v2TZ.js";import"./text.component-PkQwDr0-.js";import"./default-typography.styles-BK7XCmVZ.js";const ne={title:"Components/Pagination",component:"gds-pagination",tags:["autodocs"]},n={args:{page:1,rows:10,total:2e3,options:[5,10,20,50,100],hideOptions:!1},render:e=>{const a=t=>{e.page=t.detail.page,document.querySelector("[data-page]").innerHTML=String(e.page),document.querySelector("[data-pagination]").setAttribute("page",String(e.page))},s=t=>{e.rows=t.detail.rows,e.page=1,document.querySelector("[data-rows]").innerHTML=String(e.rows),document.querySelector("[data-page]").innerHTML="1",document.querySelector("[data-pagination]").setAttribute("page","1"),document.querySelector("[data-pagination]").setAttribute("rows",String(e.rows))};return i`
 ...
 If there are multiple page-size options, the rows-per-page selector remains visible so users can still switch to a smaller page size.
  ...
  `};var d,l,p;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    page: 1,
    rows: 10,
    total: 2000,
...
}`,...(p=(l=n.parameters)==null?void 0:l.docs)==null?void 0:p.source}}};var c,x,u,m,w;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    page: 1,
    rows: 8,
    total: 100,
...
}`,...(u=(x=o.parameters)==null?void 0:x.docs)==null?void 0:u.source},description:{story:`When the options array contains only a single value, the page size selector
is automatically hidden since there's no choice to make. This is useful when
you want a fixed page size without showing the selector UI.`,...(w=(m=o.parameters)==null?void 0:m.docs)==null?void 0:w.description}}};var h,f,$;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    page: 1,
    rows: 10,
    total: 8,
 ...
 If there are multiple page-size options, the rows-per-page selector remains visible so users can still switch to a smaller page size.
...
}`,...($=(f=r.parameters)==null?void 0:f.docs)==null?void 0:$.source}}};var S,b,y,q,C;g.parameters={...g.parameters,docs:{...(S=g.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text id="pagination-label" tag="label">Results navigation</gds-text>
      <gds-text id="pagination-desc" font-size="detail-s">
  ...
  \`
}`,...(y=(b=g.parameters)==null?void 0:b.docs)==null?void 0:y.source},description:{story:"Demonstrates how `gds-aria-labelledby` and `gds-aria-describedby` forward\nARIA element references to the internal `<nav>` element.",...(C=(q=g.parameters)==null?void 0:q.docs)==null?void 0:C.description}}};const re=["Default","SingleOption","OnePage","ARIAForwarding"];export{g as ARIAForwarding,n as Default,r as OnePage,o as SingleOption,re as __namedExportsOrder,ne as default};
