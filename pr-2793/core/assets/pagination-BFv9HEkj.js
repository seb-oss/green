import{i as E,T as L,$ as A,S as D,J as W,A as R,O as p,d as v,h as c,E as T,n as g,f as F,H as _,g as J,Q as q,I as Q,a as H}from"./iframe-CL7Bfxf7.js";import{l as V}from"./localized-decorator-VhPkI65L.js";import{w as X,G as Y}from"./popover.component-B3X5AUZg.js";import{a as K,G as U}from"./context-menu.component-BI1GYGrh.js";import{a as Z}from"./dropdown.component-CUlTR8QX.js";import{I as tt}from"./chevron-bottom.component-1CnJTZdt.js";import{I as et,a as st,b as nt,c as it}from"./chevron-right-small.component-C0ZW78ko.js";import{I as ot}from"./chevron-right.component-4ftXW-90.js";import{G as at}from"./input.component-BWLIcLxy.js";import{G as rt}from"./text.component-vzGgBPLb.js";const lt=E`
  :host {
    display: flex;
    align-items: center;
...
`;var pt=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,y=t=>{throw TypeError(t)},h=(t,s,n,d)=>{for(var l=d>1?void 0:d?ht(s,n):s,m=t.length-1,b;m>=0;m--)(b=t[m])&&(l=(d?b(s,n,l):b(l))||l);return d&&l&&pt(s,n,l),l},x=(t,s,n)=>s.has(t)||y("Cannot "+n),i=(t,s,n)=>(x(t,s,"read from private field"),n?n.call(t):s.get(t)),dt=(t,s,n)=>s.has(t)?y("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,n),o=(t,s,n)=>(x(t,s,"access private method"),n),e,u,a,P,w,G,C,z,I,k,M,S,O,B,f,j,N,$;const ct={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let r=class extends L(A(D(W))){constructor(){super(...arguments),dt(this,e),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(t){this._isMobile=t}render(){const s=i(this,e,u)>1,n=o(this,e,O).call(this);return!s&&!n?R:c`
    ...
    `};f=function(t){this.dispatchCustomEvent("gds-page-change",{detail:{page:t},bubbles:!0})};j=function(t){const s=t.target,n=parseInt(s.dataset.value||"10");n!==this.rows&&this.dispatchCustomEvent("gds-rows-change",{detail:{rows:n},bubbles:!0})};N=function(t){if(this._jumpPopoverOpen=t.detail.open,t.detail.open){const n=t.target.querySelector('[gds-element="gds-input"]');n&&requestAnimationFrame(()=>{n.focus()})}};$=function(t){const n=t.target.closest('[gds-element="gds-input"]');if(n){const d=parseInt(n.value,10);if(d&&d>=1&&d<=i(this,e,u)){o(this,e,f).call(this,d);const l=n.closest('[gds-element="gds-popover"]');l&&(l.open=!1)}}};r.styles=[T,lt];h([g({type:Number})],r.prototype,"page",2);h([g({type:Number})],r.prototype,"rows",2);h([g({type:Number})],r.prototype,"total",2);h([g({type:Array})],r.prototype,"options",2);h([g({type:Boolean})],r.prototype,"jump",2);h([g({attribute:"hide-options",type:Boolean,reflect:!1})],r.prototype,"hideOptions",2);h([g({reflect:!1})],r.prototype,"density",2);h([g()],r.prototype,"label",2);h([F("#page-input")],r.prototype,"_elInput",2);h([_()],r.prototype,"_isMobile",2);h([_()],r.prototype,"_jumpPopoverOpen",2);h([X("(max-width: 768px)")],r.prototype,"_handleMobile",1);r=h([V(),J("gds-pagination",{dependsOn:[q,Y,rt,at,Z,K,U,tt,et,st,ot,nt,it]}),Q({labelledBy:"nav",describedBy:"nav"})],r);r.define();export{r as G};
