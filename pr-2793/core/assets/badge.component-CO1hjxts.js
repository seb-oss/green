import{i as b,$ as m,T as x,S as z,J as S,a as w,h as c,E as O,n as g,H as y,g as E}from"./iframe-CL7Bfxf7.js";import{G as k}from"./flex.component-C4sihmBH.js";const C=b`
...
`;var T=Object.defineProperty,N=Object.getOwnPropertyDescriptor,h=s=>{throw TypeError(s)},n=(s,e,a,i)=>{for(var t=i>1?void 0:i?N(e,a):e,d=s.length-1,p;d>=0;d--)(p=s[d])&&(t=(i?p(e,a,t):p(t))||t);return i&&t&&T(e,a,t),t},P=(s,e,a)=>e.has(s)||h("Cannot "+a),G=(s,e,a)=>e.has(s)?h("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,a),l=(s,e,a)=>(P(s,e,"access private method"),a),r,v,_,f,u;let o=class extends m(x(z(S))){constructor(){super(...arguments),G(this,r),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const s=w({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return c`
    ...
    ></slot>`};u=function(){return c`<slot name="trail"></slot>`};o.styles=[O,C];n([g()],o.prototype,"variant",2);n([g({type:String})],o.prototype,"size",2);n([g({attribute:"notification",type:Boolean,reflect:!0})],o.prototype,"notification",2);n([g({attribute:"rounded",type:Boolean,reflect:!0})],o.prototype,"rounded",2);n([y()],o.prototype,"mainSlotOccupied",2);n([y()],o.prototype,"leadSlotOccupied",2);o=n([E("gds-badge",{dependsOn:[k]})],o);export{o as G};
