import{i as $,n as v,I as L,h as T,g as R,E as D,ar as F,o as N,Q as U,Z as K,S as Q,N as z,f as V,H as A}from"./iframe-BM_8FZB_.js";import{l as X}from"./localized-decorator-DJXQ3ino.js";import{r as Z}from"./resize-observer-B9k8v2TZ.js";import{I as J}from"./chevron-left.component-DUUre0Ij.js";import{I as Y}from"./chevron-right.component-kaVWQt0H.js";const tt=$`
  @layer base {
    :host {
      display: block;
      outline: none;
...
`;var et=Object.defineProperty,st=Object.getOwnPropertyDescriptor,G=(t,e,s,i)=>{for(var r=i>1?void 0:i?st(e,s):e,n=t.length-1,a;n>=0;n--)(a=t[n])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&et(e,s,r),r};let g=class extends L{constructor(){super(...arguments),this.internals=this.attachInternals(),this.name=""}render(){return T`<slot></slot>`}};g.styles=[tt];G([v({reflect:!0})],g.prototype,"name",2);g=G([R("gds-tab-panel")],g);const it=$`
  @layer base {
    :host {
      display: inline-flex;
    }
...
`;var rt=Object.defineProperty,nt=Object.getOwnPropertyDescriptor,_=(t,e,s,i)=>{for(var r=i>1?void 0:i?nt(e,s):e,n=t.length-1,a;n>=0;n--)(a=t[n])&&(r=(i?a(e,s,r):a(r))||r);return i&&r&&rt(e,s,r),r};let h=class extends L{constructor(){super(...arguments),this.internals=this.attachInternals(),this.href="",this.disabled=!1,this.selected=!1,this.panel=""}connectedCallback(){super.connectedCallback()}render(){return this.href?T`<a
      ...
      <slot></slot>
      <slot name="trail"></slot>
    </button>`}};h.styles=[D,it];h.shadowRootOptions={...F.shadowRootOptions,delegatesFocus:!0};_([v()],h.prototype,"href",2);_([v({type:Boolean,reflect:!0})],h.prototype,"disabled",2);_([v({type:Boolean,reflect:!0})],h.prototype,"selected",2);_([v()],h.prototype,"panel",2);h=_([R("gds-tab")],h);const at=$`
  @layer base {
    :host {
      display: block;
