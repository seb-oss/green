import{aj as H,i as I,n as r,H as D,f as A,a7 as y,g as K,I as U,J as G,a1 as F,a as z,O as X,h as Y}from"./iframe-CPRCDjfR.js";import{l as q}from"./localized-decorator-BGUdOJjD.js";import{o as Q,s as J,a as j,c as Z}from"./floating-ui.dom-Ceeo7fpE.js";import{I as ee}from"./cross-small.component-Cc1LMIlN.js";function te(e){return(t,s,n)=>{if(H)return;const l=window.matchMedia(e),h=t.connectedCallback,f=t.disconnectedCallback;t.connectedCallback=function(){var R;h==null||h.call(this);const P=$=>{var L;(L=n.value)==null||L.call(this,$.matches)};l.addEventListener("change",P),this.disconnectedCallback=function(){f==null||f.call(this),l.removeEventListener("change",P)},(R=n.value)==null||R.call(this,l.matches)}}}const ie=I`
