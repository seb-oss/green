import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{B as T}from"./button-C5tuGfon.js";import{G as x,T as s}from"./buttonGroup-BxRrm-82.js";const a=({children:f,...h})=>r.jsx(x,{...h,children:f}),b={title:"Components/Form/Group",component:x},e={render:a.bind({}),name:"Basic Group",parameters:{componentIds:["component-form-group"]},args:{children:[r.jsx(s,{placeholder:"Input field"}),r.jsx(T,{children:"Normal button"})]}},o={render:a.bind({}),name:"Static text and input field",args:{groupBorder:!0,groupFocus:!0,children:[r.jsx(s,{placeholder:"First input field"}),r.jsx("span",{className:"gds-form-text",children:"kr"})]}},t={render:a.bind({}),name:"Group error",args:{groupBorder:!0,groupFocus:!0,error:"Error message",children:[r.jsx(s,{placeholder:"First input field"}),r.jsx("span",{className:"gds-form-text",children:"kr"})]}};var n,p,u;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
