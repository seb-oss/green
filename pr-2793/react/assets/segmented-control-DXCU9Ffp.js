import{j as S}from"./jsx-runtime-D_zvdyIk.js";import{R as T}from"./iframe-39MKjz71.js";import{o as N}from"./create-component-CPRSibq9.js";import{c as C}from"./index-WQdicYTM.js";import{i as W,h as z,G as R,t as $,_ as a,n as g,g as L,b as l,d as n,e as u,c as O,r as V,a as B}from"./tokens.style-DxVdNCZa.js";import{w as q,d as E,b as G}from"./icon.component-CnxzhO6D.js";import{T as I,r as P}from"./transitional-styles-DN7pQLG_.js";import{m as k,l as j}from"./runtime-nRyYmvPb.js";import{e as x,w as A}from"./watch-Bh1rs_BK.js";import{r as X}from"./resize-observer-B9k8v2TZ.js";import{I as U,a as D}from"./chevron-right.component-Dg9qpDUn.js";const F=W`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var H=F;let c=class extends q(R){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),I.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return z`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};c.styles=[...$,H];a([g({type:Boolean,reflect:!0})],c.prototype,"selected",2);a([g()],c.prototype,"value",2);a([g({type:Boolean,reflect:!0})],c.prototype,"disabled",2);c=a([L("gds-segment")],c);const J=W`
  @layer base {
    :host {
