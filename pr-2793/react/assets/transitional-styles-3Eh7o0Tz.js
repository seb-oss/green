import{i as S,t as M,b as m,o as N,V as p,d as a,f as z}from"./tokens.style-_hO-0dwC.js";const _=`/* stylelint-disable max-nesting-depth */
/**
...
}`;function t(){r.instance.register("gds-button",_.toString())}var B=S`
  .rbcb {
...
`;const G=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  :host {
...
}`,R=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`,F=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function k(){r.instance.register("gds-listbox",R.toString()),r.instance.register("gds-option",F.toString()+B.cssText),r.instance.register("gds-menu-heading",G.toString())}const q=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function g(){r.instance.register("gds-popover",q.toString())}const L=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function I(){r.instance.register("gds-context-menu",L.toString()),g(),k(),t()}const A=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function W(){r.instance.register("gds-calendar",A.toString())}const U=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function w(){r.instance.register("gds-field-base",U.toString())}function $(){k(),g(),t(),w()}const H=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function O(){const T=H.toString()+M.reduce((e,o)=>e+o.cssText,"");r.instance.register("gds-datepicker",T.toString()),$(),g(),W()}const V=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {
    .btn-p {
...
}`;function D(){r.instance.register("gds-filter-chip",V.toString()),t()}const j=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {}
  @layer _overrides {}
}`;function E(){r.instance.register("gds-filter-chips",j.toString()),D()}const X=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  :host {
    display: block;
...
}`;function J(){r.instance.register("gds-grouped-list",X.toString())}function P(){t(),w()}const Q=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function Y(){r.instance.register("gds-segmented",Q.toString())}const Z=`@layer base, reset, transitional-styles;
...
`;function K(){r.instance.register("gds-segmented-control",Z.toString()),Y()}const nn=`/**
...
}`;function rn(){r.instance.register("gds-theme",nn.toString())}var d,c,u;const an=()=>{rn(),$(),I(),O(),J(),K(),E(),t(),P()},en=class C{constructor(){m(this,d,new Map),m(this,c,new Map),m(this,u,!N())}static get instance(){var e;return(e=globalThis.__gdsTransitionalStyles)!=null&&e[p]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[p]:new C}),globalThis.__gdsTransitionalStyles[p]}apply(e,o){if(!e.shadowRoot)return;const n=a(this,d).get(o);n&&(a(this,c).set(o,e),this.applyToElement(o,n))}applyToElement(e,o){var v,x;const n=a(this,c).get(e);if(!n||!n.shadowRoot)return;const b=()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",z(o)),n._isUsingTransitionalStyles=!0},h=()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()},f="[gds-element=gds-theme]";let s=n.getRootNode(),i=n.closest(f);for(;i===null&&s!==document;)i=(v=s.host)==null?void 0:v.closest(f),s=(x=s.host)==null?void 0:x.getRootNode();if(i){const l=i,y=()=>{l.designVersion==="2023"?h():b()};if(l.addEventListener("gds-design-version-changed",y),n.addEventListener("gds-element-disconnected",()=>l.removeEventListener("gds-design-version-changed",y)),l.designVersion==="2023"){h();return}}b()}register(e,o){let n=o;a(this,u)&&(n=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${o}`),a(this,d).set(e,n),this.applyToElement(e,n)}};d=new WeakMap;c=new WeakMap;u=new WeakMap;let r=en;export{r as T,g as a,E as b,B as c,an as r};
