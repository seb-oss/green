import{i as y,t as G,_ as s,g as x,h as l,G as z,b as a,c,n as r,r as E,d as i,A as we,e as ke}from"./tokens.style-CvxoHPxY.js";import{l as ge,m as W,s as qe}from"./runtime-nRyYmvPb.js";import{b as Re,e as V,w as k,a as je}from"./watch-2OEWzoh-.js";import{G as Ue,o as Ke,a as Xe,b as Ye}from"./button.component-BakwRC9T.js";import{w as Se,b as $e,d as Ce,o as Je}from"./icon.component-BrBjHKPq.js";import{n as u}from"./when-BR7zwNJC.js";import{G as Ee,o as Qe,f as Ze}from"./popover.component-B3mmDfNc.js";import{e as w}from"./class-map-COa5npvs.js";import{T as ue,c as et}from"./transitional-styles-B4zNEBEB.js";import{a as tt,G as st}from"./card.component-DMnCIEIL.js";import{I as it}from"./triangle-exclamation.component-D9dtzjQ9.js";import{I as at,a as ot}from"./chevron-bottom.component-DI9NBx0p.js";import{e as rt,n as lt}from"./ref-ZPps8Xj0.js";import{F as nt,o as dt,L as ct,u as ht}from"./option.styles-DlTtOIVA.js";import{I as Te}from"./checkmark.component-CwrgnoZd.js";import{I as pt}from"./cross-small.component-BY9xNiNT.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function gt(e){return(t,o)=>Re(t,o,{async get(){var h;return await this.updateComplete,((h=this.renderRoot)==null?void 0:h.querySelector(e))??null}})}const ut=y`
  :host {
    display: flex;
...
`;var bt=ut;let P=class extends tt{render(){return l`<slot></slot>`}};P.styles=[G,bt];P=s([x("gds-flex")],P);const ft=y`
...
`;var vt=ft,N,be,R,ze,j,Me,U,We;let f=class extends Se($e(Ce(z))){constructor(){super(...arguments),a(this,N),a(this,R),a(this,j),a(this,U),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=w({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return l`
      <div class="${e}">
    ...
    ></slot>`};U=new WeakSet;We=function(){return l`<slot name="trail"></slot>`};f.styles=[G,vt];s([r()],f.prototype,"variant",2);s([r({type:String})],f.prototype,"size",2);s([r({attribute:"notification",type:Boolean,reflect:!0})],f.prototype,"notification",2);s([r({attribute:"rounded",type:Boolean,reflect:!0})],f.prototype,"rounded",2);s([E()],f.prototype,"mainSlotOccupied",2);s([E()],f.prototype,"leadSlotOccupied",2);f=s([x("gds-badge",{dependsOn:[P]})],f);const mt=e=>yt({...e,type:"checkbox"}),yt=e=>{const{type:t,checked:o,indeterminate:h,disabled:d,invalid:p}=e;return l`
...
`;var _t=xt,M,K,Oe,fe,Le,ve,Be,me,Ae,ye,De;let g=class extends z{constructor(){super(),a(this,K),a(this,fe),a(this,ve),a(this,me),a(this,ye),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,a(this,M,(e,t)=>{const h=t.target.assignedNodes({flatten:!0}),d=h.length>0&&h.some(p=>{var b;return p.nodeType===Node.ELEMENT_NODE||p.nodeType===Node.TEXT_NODE&&((b=p.textContent)==null?void 0:b.trim())!==""});e==="lead"?(this._leadSlotOccupied=d,this._leadHasBadge=d&&h.some(p=>{var b;return((b=p.getAttribute)==null?void 0:b.call(p,"gds-element"))==="gds-badge"})):e==="trail"?this._trailSlotOccupied=d:e==="action"&&(this._actionSlotOccupied=d)})}connectedCallback(){super.connectedCallback(),ue.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return l`
    ...
    `};ye=new WeakSet;De=function(){return l`
      ...
      ></slot>
    `};g.styles=[_t];s([r()],g.prototype,"size",2);s([r({type:Boolean})],g.prototype,"multiline",2);s([r({type:Boolean,reflect:!0})],g.prototype,"disabled",2);s([r({type:Boolean})],g.prototype,"invalid",2);s([V("slot:not([name])")],g.prototype,"_mainSlotElement",2);s([E()],g.prototype,"_leadSlotOccupied",2);s([E()],g.prototype,"_leadHasBadge",2);s([E()],g.prototype,"_trailSlotOccupied",2);s([E()],g.prototype,"_actionSlotOccupied",2);s([k("disabled")],g.prototype,"_handleDisabledChange",1);g=s([x("gds-field-base"),ge()],g);const wt=y`
...
`;var kt=wt,X,Fe;let S=class extends z{constructor(){super(...arguments),a(this,X)}_handleVisibilityChange(){var e;this.classList.toggle("visually-hidden",!this.errorMessage&&!((e=this.charCounter)!=null&&e[1]))}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return l`<div aria-live="polite">
    ...
    </div>`}};X=new WeakSet;Fe=function(){if(!this.charCounter||this.charCounter[1]===!1)return we;const[e,t]=this.charCounter;return l`<gds-badge variant="${t}">${e}</gds-badge>`};S.styles=[kt];s([r({type:Array})],S.prototype,"charCounter",2);s([r()],S.prototype,"errorMessage",2);s([k("charCounter"),k("errorMessage")],S.prototype,"_handleVisibilityChange",1);S=s([x("gds-form-control-footer",{dependsOn:[f,it]})],S);const St=y`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var $t=St,xe,He,Y,J,D,Q,Ie;let $=class extends z{constructor(){super(...arguments),a(this,xe),a(this,Q),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,a(this,Y,()=>l`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `};$.styles=[$t];s([r({type:Boolean,reflect:!0})],$.prototype,"showExtendedSupportingText",2);s([E()],$.prototype,"_hasExtendedSupportingText",2);s([V("#extended-supporting-text")],$.prototype,"_extendedSupportingText",2);$=s([x("gds-form-control-header",{dependsOn:[Ue,st,at]}),ge()],$);const Ct=y`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`;var Et=Ct,O,F,Z;let v=class extends nt(z){constructor(){super(),a(this,F),a(this,O,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",c(this,F,Z)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),c(this,F,Z).call(this,e))})}get hidden(){return i(this,O)}set hidden(e){const t=e.toString();ke(this,O,t==="true"),i(this,O)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),ue.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){var t;const e=(t=this.parentElement)==null?void 0:t.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),l`<div class="item">
      ${u(e,()=>mt({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};O=new WeakMap;F=new WeakSet;Z=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};v.styles=[G,et,dt];s([r()],v.prototype,"value",2);s([r({type:Boolean,reflect:!0})],v.prototype,"hidden",1);s([r({attribute:"aria-selected",reflect:!0})],v.prototype,"selected",2);s([r({type:Boolean,reflect:!0})],v.prototype,"isPlaceholder",2);s([k("isPlaceholder")],v.prototype,"_handlePlaceholderStatusChange",1);v=s([x("gds-option",{dependsOn:[Te]})],v);var L,ee;let C=class extends z{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,a(this,L,rt()),a(this,ee,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(o=>{o!==t&&(o.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new ct(this)}get navigableItems(){return this.visibleOptionElements}get options(){return i(this,L).value?ht(i(this,L).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(o=>this.compareWith(o,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),ue.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",i(this,ee))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return l`<slot ${lt(i(this,L))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};L=new WeakMap;ee=new WeakMap;C.styles=Et;s([r({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],C.prototype,"multiple",2);s([r()],C.prototype,"compareWith",2);s([k("multiple")],C.prototype,"_rerenderOptions",1);C=s([x("gds-listbox",{dependsOn:[v]})],C);var Tt=y`
  * {
    box-sizing: border-box;
  }
