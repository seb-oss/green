...
`)),GdsCalendar=function(_GdsElement){function GdsCalendar(){var _this;return(0,classCallCheck.A)(this,GdsCalendar),_this=function chunk_M4J2LVHQ_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,chunk_M4J2LVHQ_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCalendar,arguments),(0,chunk_SEHSDSX2.VK)(_this,_setSelectedDate),(0,chunk_SEHSDSX2.VK)(_this,chunk_M4J2LVHQ_handleKeyDown),_this.min=new Date((new Date).getFullYear()-10,0,1),_this.max=new Date((new Date).getFullYear()+10,0,1),_this.focusedDate=new Date,_this.disabledWeekends=!1,_this.showWeekNumbers=!1,_this.hideExtraneousDays=!1,_this.hideDayNames=!1,_this.dateLabelTemplate=function(date){return date.toLocaleDateString(_this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"})},_this._currentLocale=navigator.language,_this}return(0,inherits.A)(GdsCalendar,_GdsElement),(0,createClass.A)(GdsCalendar,[{key:"focusedMonth",get:function get(){return this.focusedDate.getMonth()},set:function set(month){var lastOfSelectedMonth=(0,lastDayOfMonth.A)(new Date(this.focusedYear,month,1)),newFocusedDate=new Date(this.focusedDate);newFocusedDate.setDate(Math.min(this.focusedDate.getDate(),lastOfSelectedMonth.getDate())),newFocusedDate.setMonth(month),newFocusedDate.setHours(12,0,0,0),this.focusedDate=newFocusedDate}},{key:"focusedYear",get:function get(){return this.focusedDate.getFullYear()},set:function set(year){this.focusedDate=new Date(this.focusedDate.setFullYear(year))}},{key:"getDateCell",value:function getDateCell(dayNumber){var _a;return null==(_a=this.shadowRoot)?void 0:_a.querySelector("#dateCell-".concat(dayNumber))}},{key:"connectedCallback",value:function connectedCallback(){var _this2=this;chunk_M4J2LVHQ_superPropGet(GdsCalendar,"connectedCallback",this,3)([]),chunk_VYHUZMZD.nD.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",(0,chunk_SEHSDSX2.jq)(this,chunk_M4J2LVHQ_handleKeyDown,handleKeyDown_fn)),window.addEventListener("lit-localize-status",(function(e){"ready"===e.detail.status&&(_this2._currentLocale=e.detail.readyLocale)}))}},{key:"focus",value:function focus(){var _a;chunk_M4J2LVHQ_superPropGet(GdsCalendar,"focus",this,3)([]),null==(_a=this._elFocusedCell)||_a.focus()}},{key:"render",value:function render(){var _this3=this,currentDate=new Date;return(0,lit.qy)(chunk_M4J2LVHQ_t2||(chunk_M4J2LVHQ_t2=chunk_M4J2LVHQ_`<table role="grid" aria-label="${0}">
      ${0}
      <tbody role="rowgroup">
        ${0}
      </tbody>
    </table>`),(0,if_defined.J)(this.label),(0,when.z)(!this.hideDayNames,(function(){return(0,lit.qy)(chunk_M4J2LVHQ_t3||(chunk_M4J2LVHQ_t3=chunk_M4J2LVHQ_`<thead role="rowgroup">
            <tr role="row">
              ${0}
              <th>${0}</th>
              <th>${0}</th>
