"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[2704],{227:(e,t,s)=>{s.d(t,{w:()=>x});var i,o,a,r,l,n,d,c=s(6861),h=s(6743),p=s(4367),u=s(3578),g=s(3539),b=s(7526),y=s(4457),v=s(1374),m=s(9443).AH`
  @layer base, a11y;
...
`;let x=class extends g.j{constructor(){super(),(0,c.VK)(this,o),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,(0,c.VK)(this,i,(e,t)=>{const s=t.target.assignedNodes({flatten:!0}),i=s.length>0&&s.some(e=>e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&""!==e.textContent?.trim());"lead"===e?this._leadSlotOccupied=i:"trail"===e?this._trailSlotOccupied=i:"action"===e&&(this._actionSlotOccupied=i)})}connectedCallback(){super.connectedCallback(),y.n.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:"small"===this.size};return b.qy`
      <div class="field ${(0,u.H)(e)}" part="_base">
        ${(0,c.jq)(this,o,a).call(this)}
      </div>
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};i=new WeakMap,o=new WeakSet,a=function(){const e={right:!0,"as-flex":this.multiline&&(this._trailSlotOccupied||this._actionSlotOccupied)};return b.qy`
      ${(0,c.jq)(this,o,r).call(this)} ${(0,c.jq)(this,o,l).call(this)}
      <div class="${(0,u.H)(e)}">
        ${(0,c.jq)(this,o,n).call(this)} ${(0,c.jq)(this,o,d).call(this)}
      </div>
    `},r=function(){return b.qy` <slot
      name="lead"
      @slotchange=${e=>(0,c.S7)(this,i).call(this,"lead",e)}
    ></slot>`},l=function(){return b.qy`<div
      class="main-slot-wrap ${(0,u.H)({multiline:this.multiline})}"
    >
      <slot
        @slotchange=${e=>(0,c.S7)(this,i).call(this,"main",e)}
      ></slot>
    </div>`},n=function(){return b.qy`
      <slot
        name="action"
        @slotchange=${e=>(0,c.S7)(this,i).call(this,"action",e)}
      ></slot>
    `},d=function(){return b.qy`
      <slot
        name="trail"
        @slotchange=${e=>(0,c.S7)(this,i).call(this,"trail",e)}
      ></slot>
    `},x.styles=[m],(0,c.Cc)([(0,p.MZ)()],x.prototype,"size",2),(0,c.Cc)([(0,p.MZ)({type:Boolean})],x.prototype,"multiline",2),(0,c.Cc)([(0,p.MZ)({type:Boolean,reflect:!0})],x.prototype,"disabled",2),(0,c.Cc)([(0,p.MZ)({type:Boolean})],x.prototype,"invalid",2),(0,c.Cc)([(0,p.P)("slot:not([name])")],x.prototype,"_mainSlotElement",2),(0,c.Cc)([(0,p.wk)()],x.prototype,"_leadSlotOccupied",2),(0,c.Cc)([(0,p.wk)()],x.prototype,"_trailSlotOccupied",2),(0,c.Cc)([(0,p.wk)()],x.prototype,"_actionSlotOccupied",2),(0,c.Cc)([(0,v.w)("disabled")],x.prototype,"_handleDisabledChange",1),x=(0,c.Cc)([(0,b.Y$)("gds-field-base"),(0,h.cc)()],x)},801:(e,t,s)=>{s.d(t,{K:()=>y});var i,o,a,r,l,n=s(6861),d=s(4367),c=s(3539),h=s(7526),p=s(5073),u=s(4987),g=s(6312),b=s(9443).AH`
  :host {
...
`;let y=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,n.VK)(this,i),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){let e,t;if(this.notification)e="negative-01",t="inversed";else switch(this.variant){case"information":default:e="information-03",t="information-01";break;case"notice":e="notice-03",t="notice-01";break;case"positive":e="positive-03",t="positive-03";break;case"warning":e="warning-03",t="warning-01";break;case"negative":e="negative-03",t="negative-01";break;case"disabled":e="disabled-03",t="disabled-01"}const s=(()=>{const e={notification:{occupied:"4xs 2xs",default:"3xs"},small:{occupied:"4xs 3xs",default:"4xs 3xs"},default:{occupied:"3xs xs 3xs 2xs",default:"4xs xs"}};return this.notification?e.notification[this.mainSlotOccupied?"occupied":"default"]:e["small"===this.size?"small":"default"][this.leadSlotOccupied?"occupied":"default"]})(),o=(()=>{const e={occupied:{small:"m",default:"l"},default:"xs"};return this.mainSlotOccupied?e.occupied["small"===this.size||this.notification?"small":"default"]:e.default})(),d=(()=>{const e={notification:{occupied:"l",default:"0"},default:"l"};return this.notification?e.notification[this.mainSlotOccupied?"occupied":"default"]:e.default})(),c=(()=>this.rounded||this.notification?"max":"small"===this.size?"3xs":"2xs")();return h.qy`<gds-flex
      level="3"
      background=${e}
      color=${t}
    ...
    >
      ${(0,n.jq)(this,i,a).call(this)} ${(0,n.jq)(this,i,r).call(this)}
      ${(0,n.jq)(this,i,l).call(this)}
    </gds-flex>`}};i=new WeakSet,o=function(e,t){const s=e.target.assignedNodes({flatten:!0});this[t]=s.length>0&&s.some(e=>e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&""!==e.textContent?.trim())},a=function(){if("small"!==this.size||!this.notification)return h.qy`<slot
        name="lead"
    ...
    ></slot>`},l=function(){return h.qy`<slot name="trail"></slot>`},y.styles=[p.LU,b],(0,n.Cc)([(0,d.MZ)()],y.prototype,"variant",2),(0,n.Cc)([(0,d.MZ)({type:String})],y.prototype,"size",2),(0,n.Cc)([(0,d.MZ)({attribute:"notification",type:Boolean,reflect:!0})],y.prototype,"notification",2),(0,n.Cc)([(0,d.MZ)({attribute:"rounded",type:Boolean,reflect:!0})],y.prototype,"rounded",2),(0,n.Cc)([(0,d.wk)()],y.prototype,"mainSlotOccupied",2),(0,n.Cc)([(0,d.wk)()],y.prototype,"leadSlotOccupied",2),y=(0,n.Cc)([(0,h.Y$)("gds-badge",{dependsOn:[g.o]})],y)},2606:(e,t,s)=>{s.d(t,{A:()=>i}),s(6861);var i=s(9443).AH`
  * {
    box-sizing: border-box;
  }
...
`},2655:(e,t,s)=>{s.d(t,{$:()=>x});var i,o,a,r,l,n,d=s(6861),c=s(6743),h=s(4367),p=s(505),u=s(7595),g=s(7617),b=s(4464),y=s(3539),v=s(7526),m=s(9443).AH`
...
`;let x=class extends y.j{constructor(){super(...arguments),(0,d.VK)(this,i),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,(0,d.VK)(this,a,()=>v.qy`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `),(0,d.VK)(this,r,()=>{this.showExtendedSupportingText=!this.showExtendedSupportingText,this._extendedSupportingText?.style.setProperty("--_max-height",this.showExtendedSupportingText?`${this._extendedSupportingText.scrollHeight}px`:"0"),this.dispatchCustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText})}),(0,d.VK)(this,l,()=>{this.showExtendedSupportingText&&this._extendedSupportingText?.style.setProperty("--_max-height",`${this._extendedSupportingText.scrollHeight}px`)})}render(){return v.qy`
      <div id="label-row">
        ...
        ${(0,p.z)(this._hasExtendedSupportingText,(0,d.S7)(this,a))}
      </div>
    ...
    `},x.styles=[m],(0,d.Cc)([(0,h.MZ)({type:Boolean,reflect:!0})],x.prototype,"showExtendedSupportingText",2),(0,d.Cc)([(0,h.wk)()],x.prototype,"_hasExtendedSupportingText",2),(0,d.Cc)([(0,h.P)("#extended-supporting-text")],x.prototype,"_extendedSupportingText",2),x=(0,d.Cc)([(0,v.Y$)("gds-form-control-header",{dependsOn:[u.t,g.z,b.w]}),(0,c.cc)()],x)},2704:(e,t,s)=>{s.d(t,{E:()=>ae});var i,o,a=s(7198),r=s(6861),l=s(6743),n=s(9443),d=s(4367),c=s(4652),h=s(7639),p=s(505),u=s(7956),g=s(227),b=s(7708),y=s(2655),v=s(3104),m=s(3539),x=s(7526),f=s(4457),C=s(5552),w=s(1374),k=s(825),$=n.AH`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`,S=s(5017);let _=class extends m.j{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,(0,r.VK)(this,i,(0,v._)()),(0,r.VK)(this,o,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(e=>{e!==t&&(e.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new C.y(this)}get navigableItems(){return this.visibleOptionElements}get options(){return(0,r.S7)(this,i).value&&(0,k.o)((0,r.S7)(this,i).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&"gds-option"===e.gdsElementName)||[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(e=>this.compareWith(e,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),f.n.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",(0,r.S7)(this,o))}focus(){(this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])?.focus()}render(){return x.qy`<slot ${(0,v.K)((0,r.S7)(this,i))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};i=new WeakMap,o=new WeakMap,_.styles=$,(0,r.Cc)([(0,d.MZ)({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],_.prototype,"multiple",2),(0,r.Cc)([(0,d.MZ)()],_.prototype,"compareWith",2),(0,r.Cc)([(0,w.w)("multiple")],_.prototype,"_rerenderOptions",1),_=(0,r.Cc)([(0,x.Y$)("gds-listbox",{dependsOn:[S.Y]})],_);var M,E,T,z,q,V,L,O,Z,A,W,F,j,K,H,B,D,P,Y,N,U,G=s(2606),I=s(5073),Q=s(685),R=s(4987),J=s(8558),X=s(6290),ee=s(6428),te=s(2581),se=s(2138),ie=n.AH`
  @layer base, reset;
...
`;let oe=class extends J.S{constructor(){super(...arguments),(0,r.VK)(this,E),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,(0,r.VK)(this,M),(0,r.VK)(this,z,()=>x.qy`
      <input
        ...
        @input=${e=>{this.value=e.target.value,(0,r.S7)(this,B).call(this),(0,r.S7)(this,W).call(this,e),(0,r.S7)(this,O).call(this,!0,"show")&&(this.open=!0)}}
    ...
    `),(0,r.VK)(this,V,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),(0,r.VK)(this,L,e=>{if(this.combobox){const t=e.getBoundingClientRect(),s=window.innerHeight-t.bottom,i=t.top;let o=Math.min(i,this.maxHeight);return s>i&&(o=Math.min(s,this.maxHeight)),o-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"}),(0,r.VK)(this,O,(e,t)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:t,open:e},bubbles:!1,composed:!1})),(0,r.VK)(this,Z,e=>{(0,r.S7)(this,O).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),(0,r.VK)(this,A,e=>{e.preventDefault(),e.stopPropagation(),this.value=void 0,this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),(0,r.S7)(this,B).call(this),(0,r.S7)(this,D).call(this)}),(0,r.VK)(this,W,e=>{if(!e.currentTarget)return;if(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}}))return;const t=e.currentTarget;this.options.forEach(e=>e.hidden=!1),t.value&&this.options.filter(e=>!this.searchFilter(t.value,e)).forEach(e=>e.hidden=!0)}),(0,r.VK)(this,F,e=>{this._elListbox?.then(t=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void t.focus()})}),(0,r.VK)(this,j,e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()}),(0,r.VK)(this,K,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),(0,r.VK)(this,B,()=>{this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))}),(0,r.VK)(this,D,()=>{this.updateComplete.then(()=>this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}),(0,r.VK)(this,N,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,r.S7)(this,O).call(this,!1,"close")&&(this.open=!1)}),(0,r.VK)(this,U,e=>{"Tab"===e.key&&!this.searchable&&(0,r.S7)(this,O).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())})}get type(){return"gds-dropdown"}get options(){return(0,r.S7)(this,M)?Array.from((0,r.S7)(this,M)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if((0,r.S7)(this,M))return Array.from((0,r.S7)(this,M)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){let e;return e=Array.isArray(this.value)?this.value.slice(0,5).reduce((e,t)=>e+this.options.find(e=>e.value===t)?.innerText+", ","").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):this.options.find(e=>e.selected)?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",(0,r.S7)(this,V)),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",(0,r.S7)(this,V))}render(){return x.qy`
      ...
      <gds-popover
        ...
        .floatingUIMiddleware=${this.combobox?[(0,u.cY)(8),(0,u.UU)()]:se.E.DefaultMiddleware}
        @gds-ui-state=${(0,r.S7)(this,Z)}
      >
        <gds-field-base
          .size=${this.size}
        ...
        >
          ...
          ${(0,p.z)(this.value&&this.multiple&&this.value.length>0,()=>x.qy`<gds-badge
                rounded
              ...
              >`)}
          ${(0,p.z)(this.clearable&&this.value&&!this.disabled,()=>x.qy`<gds-button
                id="clear-btn"
                rank="tertiary"
          ...
          ${(0,p.z)(this.combobox&&!this.multiple,()=>(0,r.S7)(this,z).call(this))}
          ${(0,p.z)(!this.combobox||this.multiple,()=>(0,r.S7)(this,q).call(this))}
          <gds-icon-chevron-bottom slot="action"></gds-icon-chevron-bottom>
        </gds-field-base>

        ${(0,p.z)(this.searchable,()=>x.qy`<input
              id="searchinput"
              type="text"
        ...
        <gds-listbox
          ...
          @change="${(0,r.jq)(this,E,H)}"
          @gds-focus="${(0,r.S7)(this,K)}"
      ...
      ${(0,p.z)((0,r.jq)(this,E,T).call(this),()=>x.qy`
...
`;let b=class extends h.j{constructor(){super(...arguments),(0,a.VK)(this,i)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter?.[1])}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return u.qy`<div aria-live="polite">
      <div class="error-message">
        <slot name="message"
          >${(0,n.z)(this.errorMessage,()=>u.qy`
              <gds-icon-triangle-exclamation
                solid
              ></gds-icon-triangle-exclamation>
              ${this.errorMessage}
    ...
    </div>`}};i=new WeakSet,o=function(){if(!this.charCounter||!1===this.charCounter[1])return r.s6;const[e,t]=this.charCounter;return u.qy`<gds-badge variant="${t}">${e}</gds-badge>`},b.styles=[g],(0,a.Cc)([(0,l.MZ)({type:Array})],b.prototype,"charCounter",2),(0,a.Cc)([(0,l.MZ)()],b.prototype,"errorMessage",2),(0,a.Cc)([(0,p.w)("charCounter"),(0,p.w)("errorMessage")],b.prototype,"_handleVisibilityChange",1),b=(0,a.Cc)([(0,u.Y$)("gds-form-control-footer",{dependsOn:[d.K,c.f]})],b)},8057:(e,t,s)=>{s.d(t,{U:()=>l,o:()=>r}),s(6861);var i=s(3578),o=s(505),a=s(7526);const r=e=>n({...e,type:"checkbox"}),l=e=>n({...e,type:"radio"}),n=e=>{const{type:t,checked:s,indeterminate:r,disabled:l,invalid:n}=e,d={"rbcb--checkbox":"checkbox"===t,"rbcb--radio":"radio"===t,"--checked":s,"--indeterminate":r,"--disabled":l,"--invalid":n};return a.qy`
