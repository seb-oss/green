    ...
    <section class="gds-in-page-wizard-step-card card${t.isCompleted?" completed":""}${t.isStarted?" active":""}">
      ...
      ${t.isStarted?`<div class="gds-in-page-wizard-step-card__content">${t.content}</div>
          ...
          `:t.isCompleted?`<div class="gds-in-page-wizard-step-card__content">${t.content}</div>
            ...
            `:""}
    </section>`,d={title:"Components/In-page Wizard",tags:["autodocs"],parameters:{componentIds:["component-inpagewizard"]},argTypes:{isCompleted:{control:"boolean"},isStarted:{control:"boolean"},stepText:{control:"text"},title:{control:"text"},content:{control:"text"}}},s={render:t=>e(t),name:"In-page Wizard Step Card",args:{isCompleted:!0,isStarted:!1,stepText:"Step 1 of 6",title:"Title",content:'<dl class="gds-list"><dt>Sub title</dt><dd>Sub section text</dd><dt>Sub title</dt><dd>Sub section text</dd><dt>Sub title</dt><dd>Sub section text</dd></dl>'}},a={render:t=>e(t),name:"Completed step",args:{isCompleted:!0,isStarted:!1,stepText:"Step 1 of 6",title:"Title",content:'<dl class="gds-list"><dt>Sub title</dt><dd>Sub section text</dd><dt>Sub title</dt><dd>Sub section text</dd></dl>'}},i={render:t=>e(t),name:"Current step (active)",args:{isCompleted:!1,isStarted:!0,stepText:"Step 2 of 6",title:"Title",content:`<div class="form-group">
        ...
        <div class="form-group">
          ...
          <span class="form-info">Lorem ipsum very long description of input and what should be entered</span>
          <input id="inputInvalid" type="text" />
        </div>`}},o={render:t=>e(t),name:"Not started step",args:{isCompleted:!1,isStarted:!1,stepText:"Step 3 of 6",title:"Title",content:'<dl class="gds-list"><dt>Sub title</dt><dd>Sub section text</dd><dt>Sub title</dt><dd>Sub section text</dd></dl>'}},n=["InPageWizardStepCard","CompletedStep","CurrentStep","NotStartedStep"];export{a as CompletedStep,i as CurrentStep,s as InPageWizardStepCard,o as NotStartedStep,n as __namedExportsOrder,d as default};
