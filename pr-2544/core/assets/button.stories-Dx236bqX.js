import{x as e,E as b}from"./iframe-CdPrjy8Z.js";import"./text-9Gblfypc.js";import"./divider-bJ7Ghsbg.js";import"./flex-BuIFGyj9.js";import"./credit-card-En5YY_ID.js";import"./arrow-left-CPqx52ML.js";import"./chevron-top-D4H4_ucK.js";import"./arrow-up-CCONmrz3.js";import"./arrow-down-D-JoAKEP.js";import"./arrow-right-BAqCno91.js";import{a as lt}from"./argTableProps-DySw3caf.js";import"./preload-helper-Dp1pzeXC.js";import"./default-typography.styles-BIWLqD2L.js";import"./flex.component-LPFNk1ur.js";import"./icon.component-D01EWdCe.js";import"./arrow-up.component-YAR-7N-m.js";const jt={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:"A button can be tapped or clicked to perform an action."}}},tags:["autodocs"],argTypes:{...lt("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","brand","positive","negative"],control:{type:"select"}},size:{options:["xs","small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},u={...n},r={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>e`
