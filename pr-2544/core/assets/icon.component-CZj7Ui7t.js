...
`;var A=Object.defineProperty,o=(l,t,e,r)=>{for(var i=void 0,a=l.length-1,h;a>=0;a--)(h=l[a])&&(i=h(t,e,i)||i);return i&&A(t,e,i),i};const p=class p extends w(k($)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const e={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...e,"aria-label":this.label}:{...e,role:"presentation"}}get svgContent(){const t=this.constructor;return this.solid?t._solidSVG:t._regularSVG}applyStroke(t){return this.stroke?t.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):t}generateAttributesString(t){return Object.entries(t).filter(([e,r])=>r!==void 0).map(([e,r])=>`${e}="${r}"`).join(`
    ...
    `;return _`${C(r)}`}};p.styles=[m,T];let s=p;o([g({...S,property:"height",selector:"svg"})],s.prototype,"size");o([n({type:Boolean})],s.prototype,"solid");o([n({type:Number})],s.prototype,"stroke");o([n()],s.prototype,"level");o([g(x("content"))],s.prototype,"color");o([n({type:String})],s.prototype,"label");export{s as G,C as o};
