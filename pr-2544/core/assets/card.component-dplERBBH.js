import{t as d,i,s as v,G as b,h as g,g as y}from"./iframe-C-vSePkR.js";var p=Object.defineProperty,u=Object.getOwnPropertyDescriptor,c=(t,o,e,s)=>{for(var r=s>1?void 0:s?u(o,e):o,l=t.length-1,n;l>=0;l--)(n=t[l])&&(r=(s?n(o,e,r):n(r))||r);return s&&r&&p(o,e,r),r};let a=class extends b{constructor(){super(),this.variant="primary",this.padding="m;m{xl}",this["border-radius"]="s",this.gap="m;m{l}"}render(){return g`<slot></slot>`}};a.styles=[d,i`
      :host {
