import{i as m,J as P,U as G,K as S,A as v,H as A,a as E,h,t as B,n as d,g as y,o as g,E as I}from"./iframe-BBaqs3eY.js";import{l as D}from"./localized-decorator-rnJJRWaL.js";import{I as M}from"./chevron-left.component-boQfgehd.js";import{G as k}from"./link.component-BXRKMKDJ.js";import{G as L}from"./text-AkNkFFpg.js";const j=m`
...
`;var H=Object.defineProperty,J=Object.getOwnPropertyDescriptor,_=t=>{throw TypeError(t)},c=(t,e,s,n)=>{for(var r=n>1?void 0:n?J(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&H(e,s,r),r},b=(t,e,s)=>e.has(t)||_("Cannot "+s),K=(t,e,s)=>(b(t,e,"read from private field"),s?s.call(t):e.get(t)),R=(t,e,s)=>e.has(t)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),p=(t,e,s)=>(b(t,e,"access private method"),s),a,x,w,$,C,z,O;let i=class extends v{constructor(){super(...arguments),R(this,a),this.href="",this.label="",this.overflow=!1}render(){return h`
