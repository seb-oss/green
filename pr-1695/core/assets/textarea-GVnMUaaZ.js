import{m as k}from"./runtime-CMQcyTl6.js";import{n as d,r as z,g as I,h as o}from"./custom-element-scoping-CpYtbs9r.js";import{a as X}from"./query-p8xgzTDt.js";import{r as C}from"./query-async-MEroNOeJ.js";import{r as j}from"./choose-Dh3k58u9.js";import{m as U}from"./until-DXcpnd_9.js";import{n as u}from"./when-BR7zwNJC.js";import{i as V,E as g}from"./lit-element-C_s9q329.js";import{w as J}from"./watch-tFciLXSI.js";import{a as K,f as Q}from"./button-DU3o-g20.js";import"./flex-DxhSlQcn.js";import{t as Z}from"./tokens.style-RalixZsd.js";import{s as tt}from"./style-expression-property-D0nhDdjH.js";import"./cross-small-Y_gLfaO0.js";import"./triangle-exclamation-D2VDkIvV.js";import"./container-Ch1CaHdc.js";import"./card-xMofMTeE.js";import"./text-LNG_RezI.js";import"./badge-DJWOzsSK.js";const et=V`
...
`).length||1).toString();t==null||t.style.setProperty("--_lines",e.toString())})}};i=new WeakSet;O=function(){return o`
    ...
    `};G=function(){return this.clearable&&this.value.length>0?o`
      ...
      `:g};H=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};F=function(){const t=this.maxlength-this.value.length;let e;return t<0?e="negative":t<20?e="warning":e="positive",o`<gds-badge variant="${e}">${t}</gds-badge>`};q=async function(){return this.elExtendedSupportingTextSlot.then(t=>t&&t.assignedElements().length>0?o`
        ...
        `:g)};a.styles=[Z,et];r([d()],a.prototype,"value",2);r([d()],a.prototype,"label",2);r([tt({valueTemplate:t=>t,selector:"textarea",styleTemplate:(t,e)=>`min-height: calc(1lh * ${e[0]});`})],a.prototype,"rows",2);r([z()],a.prototype,"lines",2);r([d({attribute:"supporting-text"})],a.prototype,"supportingText",2);r([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],a.prototype,"showExtendedSupportingText",2);r([d({attribute:"disabled",type:Boolean,reflect:!0})],a.prototype,"disabled",2);r([d({type:Boolean})],a.prototype,"clearable",2);r([d()],a.prototype,"resize",2);r([d({type:Number})],a.prototype,"maxlength",2);r([d({type:String})],a.prototype,"variant",2);r([C("textarea")],a.prototype,"elTextareaAsync",2);r([X("textarea")],a.prototype,"elTextarea",2);r([C('slot[name="extended-supporting-text"]')],a.prototype,"elExtendedSupportingTextSlot",2);r([z()],a.prototype,"trailSlotOccupied",2);r([J("value")],a.prototype,"_setAutoHeight",1);a=r([I("gds-textarea")],a);
