...
`;var Ss={};const Me=typeof process<"u"&&Ss!==void 0;var be,se,te,ze,ge,Ze,fe,Ke;function _s(){return Me?[]:document.adoptedStyleSheets||[]}const ws=class Ye{constructor(){b(this,ge),b(this,fe),b(this,be,!$e()),b(this,se,new Map),b(this,te,new Map),b(this,ze,_s())}static get instance(){return globalThis.__gdsGlobalStylesRegistry||(globalThis.__gdsGlobalStylesRegistry=new Ye),globalThis.__gdsGlobalStylesRegistry}injectGlobalStyles(e,t){if(i(this,be)){const n=Array.isArray(t)?t.map(r=>r.toString()).join(""):t.toString();z(this,ge,Ze).call(this,e,n)}else t.styleSheet&&z(this,fe,Ke).call(this,e,t.styleSheet)}};be=new WeakMap;se=new WeakMap;te=new WeakMap;ze=new WeakMap;ge=new WeakSet;Ze=function(s,e){if(Me)return;let t=i(this,te).get(s);t||(t=document.createElement("style"),i(this,te).set(s,t)),t.textContent=e,document.head.appendChild(t)};fe=new WeakSet;Ke=function(s,e){Me||(i(this,se).set(s,e),document.adoptedStyleSheets=[...i(this,ze),...Array.from(i(this,se).values())])};let Cs=ws;const X=[q`
  ...
  `);var H,Z,pe;const $s=class Qe{constructor(){b(this,H,new Map),b(this,Z,new Map),b(this,pe,!$e())}static get instance(){var e;return(e=globalThis.__gdsTransitionalStyles)!=null&&e[P]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[P]:new Qe}),globalThis.__gdsTransitionalStyles[P]}apply(e,t){if(!e.shadowRoot)return;const n=i(this,H).get(t);n&&(i(this,Z).set(t,e),this.applyToElement(t,n))}applyToElement(e,t){var O,f;const n=i(this,Z).get(e);if(!n||!n.shadowRoot)return;const r=()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",v(t)),n._isUsingTransitionalStyles=!0},l=()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()},g="[gds-element=gds-theme]";let c=n.getRootNode(),m=n.closest(g);for(;m===null&&c!==document;)m=(O=c.host)==null?void 0:O.closest(g),c=(f=c.host)==null?void 0:f.getRootNode();if(m){const h=m,w=()=>{h.designVersion==="2023"?l():r()};if(h.addEventListener("gds-design-version-changed",w),n.addEventListener("gds-element-disconnected",()=>h.removeEventListener("gds-design-version-changed",w)),h.designVersion==="2023"){l();return}}r()}register(e,t){let n=t;i(this,pe)&&(n=`@layer reset {
      ...
      ${t}`),i(this,H).set(e,n),this.applyToElement(e,n)}};H=new WeakMap;Z=new WeakMap;pe=new WeakMap;let Te=$s;function Ee(s,e){const t={waitUntilFirstUpdate:!1,...e};return(n,r,l)=>{const{update:g}=n,c=Array.isArray(s)?s:[s];n.update=function(m){c.forEach(O=>{var h;const f=O;if(m.has(f)){const w=m.get(f),I=this[f];w!==I&&(!t.waitUntilFirstUpdate||this.hasUpdated)&&((h=l.value)==null||h.call(this,w,I))}}),g.call(this,m)}}}const Ms={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},zs=/^([<|>]=?)?([0-9a-z]+)/,es=["{","}",";",":",","],Pe=[" ","/n"];function Ts(s=""){const e=[];let t="";for(let n=0;n<s.length;n++){const r=s[n];if(Pe.includes(r)||(t+=r),es.includes(r)){e.push(t.slice(0,-1)),e.push(r),t="";continue}if(Pe.includes(r)||n===s.length-1){e.push(t),t="";continue}}return e.filter(n=>n!=="")}function Es(s){const e=[];let t={breakpoint:"-",values:[]};const n=()=>({sel:"",values:[]});let r=n();for(const l of s){if(!es.includes(l)){r.values.push(l);continue}if(l==="{"&&(t={breakpoint:r.values.join(","),values:[]},r=n()),l===";"&&(e.length===0&&e.push(t),r.values.length>0&&(t.values.push(r),r=n())),l===":"){const g=r.values.pop()??"";r.sel=g}t&&l==="}"&&(t.values.push(r),r=n(),e.push(t))}return r.values.length>0&&t.values.push(r),e.length===0&&e.push(t),e}function js(s){return s.split(",").map(t=>{const n=t.trim().match(zs);if(!n)throw new Error(`Invalid breakpoint specifier: ${t}`);return{condition:n[1],value:n[2]}})}function Ls(s,e,t,n=l=>l,r=(l,g)=>`${l}: ${g.join(" ")};`){let l="";for(const g of t){const O=`@media ${(g.breakpoint==="-"?[{condition:">=",value:"0"}]:js(g.breakpoint)).map(f=>{var h;return`(${(h=f.condition)!=null&&h.includes("<")?"max-width":"min-width"}: ${Ms[f.value]??f.value})`}).join(" and ")} {${g.values.map(f=>{let h=s;f.sel.length>0&&(h=s===":host"?`:host(:${f.sel})`:`${s}:${f.sel}`);const w=r(e,f.values.map(n));return f.sel==="hover"?`@media (hover: hover) {${h}{${w}}}`:`${h}{${w}}`}).join("")}}`;l+=O}return l}const ae=new Map;function a(s){return(e,t)=>{const n=(s==null?void 0:s.property)??String(t),r=s==null?void 0:s.valueTemplate,l=s==null?void 0:s.styleTemplate,g=(s==null?void 0:s.cacheOverrideKey)??"0";y({attribute:s==null?void 0:s.attribute,noAccessor:!0})(e,t),Object.defineProperty(e,t,{get:function(){return this["__"+String(t)]},set:async function(c){if(!c)return;this["__"+String(t)]=c,await this.updateComplete;const m=(s==null?void 0:s.selector)??this.constructor.styleExpressionBaseSelector,O=this.level??"0",f=m+n+c+O+g;if(ae.has(f)){this._dynamicStylesController.inject(`sep_${String(t)}`,ae.get(f));return}const h=Es(Ts(c)),w=Ls(m,n,h,r==null?void 0:r.bind(this),l==null?void 0:l.bind(this)),I=v(w);ae.set(f,I),this._dynamicStylesController.inject(`sep_${String(t)}`,I)}})}}function ss(s,e,t){if(s==="transparent"||s==="currentColor"||s==="inherit")return s;const[n,r]=s.split("/"),l=`var(--gds-sys-color-l${t}-${e}-${n})`;return r?`color-mix(in srgb, ${l} ${parseFloat(r)*100}%, transparent 0%)`:l}function re(s){return{valueTemplate:function(e){return ss(e,s,this.level)}}}const F={valueTemplate:s=>`var(--gds-sys-space-${s}, 0)`},x={valueTemplate:s=>`var(--gds-sys-space-${Os(s)}, ${s})`},ie={valueTemplate:s=>{const t=(s.startsWith("-")?"neg":"pos")=="pos"?`var(--gds-sys-space-${s})`:`calc(var(--gds-sys-space-${s.substring(1)}) * -1)`;return s==="auto"?"auto":t},styleTemplate:(s,e)=>{const t=c=>c==="auto"?"auto":`${c}`,n=t(e[0]),r=e.length>1?t(e[1]):n,l=e.length>2?t(e[2]):n,g=e.length>3?t(e[3]):r;return`${s}: ${n} ${r} ${l} ${g};`}};function Os(s){return s.replace(/[^a-zA-Z0-9-]/g,"")}function je(s){class e extends s{}return o([a(x)],e.prototype,"width",2),o([a(x)],e.prototype,"min-width",2),o([a(x)],e.prototype,"max-width",2),o([a(x)],e.prototype,"inline-size",2),o([a(x)],e.prototype,"min-inline-size",2),o([a(x)],e.prototype,"max-inline-size",2),e}function As(s){class e extends s{}return o([a(x)],e.prototype,"height",2),o([a(x)],e.prototype,"min-height",2),o([a(x)],e.prototype,"max-height",2),o([a(x)],e.prototype,"block-size",2),o([a(x)],e.prototype,"min-block-size",2),o([a(x)],e.prototype,"max-block-size",2),e}function Le(s){class e extends s{}return o([a(ie)],e.prototype,"margin",2),o([a(ie)],e.prototype,"margin-inline",2),o([a(ie)],e.prototype,"margin-block",2),e}function Ds(s){class e extends s{}return o([a(F)],e.prototype,"padding",2),o([a(F)],e.prototype,"padding-inline",2),o([a(F)],e.prototype,"padding-block",2),e}function Oe(s){class e extends s{}return o([a()],e.prototype,"align-self",2),o([a()],e.prototype,"justify-self",2),o([a()],e.prototype,"place-self",2),o([a()],e.prototype,"grid-column",2),o([a()],e.prototype,"grid-row",2),o([a()],e.prototype,"grid-area",2),o([a()],e.prototype,"flex",2),o([a()],e.prototype,"order",2),e}function Vs(s){class e extends s{}return o([a()],e.prototype,"position",2),o([a()],e.prototype,"transform",2),o([a()],e.prototype,"inset",2),e}const Rs=q`
  :host {
    display: block;
