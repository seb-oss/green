import{m as Y}from"./runtime-CMQcyTl6.js";import{l as P}from"./localized-decorator-B8fm5KIw.js";import{n as l,r as z,g as R,h}from"./custom-element-scoping-b4lD3laR.js";import{a as G}from"./query-p8xgzTDt.js";import{r as H}from"./query-async-MEroNOeJ.js";import{r as B}from"./form-control-footer-D3mjcF3t.js";import{n as F}from"./when-BR7zwNJC.js";import{i as I,E as m}from"./lit-element-C_s9q329.js";import{t as X}from"./tokens.style-B6Zq2CtY.js";import{w as q}from"./watch-tFciLXSI.js";import{s as V}from"./style-expression-property-CYg4CGI6.js";import{a as J,f as K}from"./button-JbY0W8yK.js";import"./cross-small-CgIxxlLH.js";import"./flex-DnAdyWkx.js";const Q=I`
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};i=new WeakSet;C=function(){var e;return h`
      ...
      <gds-form-control-footer
        .charCounter=${p(this,i,W)&&this.maxlength-(((e=this.value)==null?void 0:e.length)||0)}
        .validationMessage=${this.invalid&&(this.errorMessage||this.validationMessage)}
      ></gds-form-control-footer>
    `};S=function(){return m};b=new WeakMap;x=new WeakMap;y=new WeakMap;_=new WeakMap;w=new WeakMap;M=function(){return h` <slot name="lead"></slot> `};A=function(){return h`
      <slot name="trail" @slotchange=${a(this,i,D)}></slot>
    `};v=function(){const e=this.querySelector(".resize-handle");e&&e.addEventListener("mousedown",a(this,i,E).bind(this))};E=function(e){e.preventDefault(),this.isDragging=!0,this.lastMouseY=e.clientY,document.addEventListener("mousemove",a(this,i,$).bind(this)),document.addEventListener("mouseup",a(this,i,f).bind(this))};$=function(e){if(!this.isDragging)return;const t=e.clientY-this.lastMouseY;Math.abs(t)>=20&&(t>0?this.lines+=1:this.lines=Math.max(1,this.lines-1),this.elTextareaAsync.then(s=>{s==null||s.style.setProperty("--_lines",this.lines.toString())}),this.lastMouseY=e.clientY)};f=function(){this.isDragging=!1,document.removeEventListener("mousemove",a(this,i,$).bind(this)),document.removeEventListener("mouseup",a(this,i,f).bind(this))};O=function(){return h`
      <gds-container
        class="resize-handle"
        position="absolute"
    ...
    `};D=function(e){const s=e.target.assignedNodes({flatten:!0});this.trailSlotOccupied=s.length>0&&s.some(d=>{var o;return d.nodeType===Node.ELEMENT_NODE||d.nodeType===Node.TEXT_NODE&&((o=d.textContent)==null?void 0:o.trim())!==""})};N=function(){return h`
      <textarea
        ...
        ${K(p(this,b))}
      ></textarea>
    `};L=function(){var e;return this.clearable&&(((e=this.value)==null?void 0:e.length)||0)>0?h`
        <gds-button
          size="small"
          rank="tertiary"
