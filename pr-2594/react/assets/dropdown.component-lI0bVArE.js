import{i as m,h as r,G as M,t as W,_ as t,n as l,g as x,b as p,c as u,r as O,d as o,E as fe,e as me}from"./tokens.style-n_Ikd8zH.js";import{l as ce,m as D,s as He}from"./runtime-nRyYmvPb.js";import{a as Ie,e as X,w as C}from"./watch-Bh1rs_BK.js";import{G as Ve,o as Ne,a as je,b as qe}from"./button.component-Dyw0M6mj.js";import{w as pe,c as Re,b as he,d as Ke,a as ge,f as Ue,s as d,g as ue,p as Xe,h as xe,j as Ye,o as Je}from"./icon.component-B3HGONt2.js";import{n as b}from"./when-BR7zwNJC.js";import{G as _e,o as Qe,f as Ze}from"./popover.component-wg8dj6SC.js";import{e as V}from"./class-map-CzAtIG01.js";import{T as be,c as et}from"./transitional-styles-BpJvfNHi.js";import{I as tt}from"./triangle-exclamation.component-Bk7_H2S3.js";import{I as st,a as it}from"./chevron-bottom.component-Dw3BUclP.js";import{F as ot,o as at,e as rt,L as lt,u as nt,n as dt}from"./unwrap-slots-CyvqC4QN.js";import{I as we}from"./checkmark.component-HLzrxYLD.js";import{I as ct}from"./cross-small.component-DgjC6PlQ.js";/**
 * @license
...
`;var Ct=St,F,j,ee;let _=class extends ot(M){constructor(){super(),p(this,j),p(this,F,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",u(this,j,ee)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),u(this,j,ee).call(this,e))})}get hidden(){return o(this,F)}set hidden(e){const s=e.toString();me(this,F,s==="true"),o(this,F)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),be.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){var s;const e=(s=this.parentElement)==null?void 0:s.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),r`<div class="item">
      ${b(e,()=>ft({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};F=new WeakMap;j=new WeakSet;ee=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};_.styles=[W,et,at];t([l()],_.prototype,"value",2);t([l({type:Boolean,reflect:!0})],_.prototype,"hidden",1);t([l({attribute:"aria-selected",reflect:!0})],_.prototype,"selected",2);t([l({type:Boolean,reflect:!0})],_.prototype,"isPlaceholder",2);t([C("isPlaceholder")],_.prototype,"_handlePlaceholderStatusChange",1);_=t([x("gds-option",{dependsOn:[we]})],_);var P,te;let z=class extends M{constructor(){super(),this.multiple=!1,this.compareWith=(e,s)=>e===s,p(this,P,rt()),p(this,te,e=>{const s=e.target;this.multiple?s.selected=!s.selected:(s.selected=!0,Array.from(this.options).forEach(i=>{i!==s&&(i.selected=!1)})),this.ariaActiveDescendantElement=s,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new lt(this)}get navigableItems(){return this.visibleOptionElements}get options(){return o(this,P).value?nt(o(this,P).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(s=>{s.selected=e.some(i=>this.compareWith(i,s.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),be.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",o(this,te))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return r`<slot ${dt(o(this,P))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};P=new WeakMap;te=new WeakMap;z.styles=Ct;t([l({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],z.prototype,"multiple",2);t([l()],z.prototype,"compareWith",2);t([C("multiple")],z.prototype,"_rerenderOptions",1);z=t([x("gds-listbox",{dependsOn:[_]})],z);var Et=m`
  * {
    box-sizing: border-box;
  }
