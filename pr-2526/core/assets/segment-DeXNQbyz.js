...
`;var j=Object.defineProperty,q=Object.getOwnPropertyDescriptor,m=(e,t,s,i)=>{for(var r=i>1?void 0:i?q(t,s):t,a=e.length-1,p;a>=0;a--)(p=e[a])&&(r=(i?p(t,s,r):p(r))||r);return i&&r&&j(t,s,r),r};let h=class extends I(P){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return $`<button
    ...
    >
      <slot></slot>
    </button>`}};h.styles=[...V,F];m([g({type:Boolean,reflect:!0})],h.prototype,"selected",2);m([g()],h.prototype,"value",2);m([g({type:Boolean,reflect:!0})],h.prototype,"disabled",2);h=m([W("gds-segment")],h);const H=M`
  @layer base {
    :host {
...
`;var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,E=e=>{throw TypeError(e)},d=(e,t,s,i)=>{for(var r=i>1?void 0:i?K(t,s):t,a=e.length-1,p;a>=0;a--)(p=e[a])&&(r=(i?p(t,s,r):p(r))||r);return i&&r&&J(t,s,r),r},C=(e,t,s)=>t.has(e)||E("Cannot "+s),o=(e,t,s)=>(C(e,t,"read from private field"),s?s.call(e):t.get(e)),l=(e,t,s)=>t.has(e)?E("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),v=(e,t,s,i)=>(C(e,t,"write to private field"),t.set(e,s),s),Q=(e,t,s)=>(C(e,t,"access private method"),s),c,b,L,_,y,w,u,f,x,k;const U=(e,t)=>{let s;return()=>{clearTimeout(s),s=setTimeout(e,t)}};let n=class extends N(I(R(P))){constructor(){super(...arguments),l(this,b),this.size="medium",l(this,c),this._showPrevButton=!1,this._showNextButton=!1,this.intersectionObserver=null,l(this,_,()=>{const e=this.segments.filter((t,s,i)=>{var r;return((r=i[s+1])==null?void 0:r.isVisible)&&!t.isVisible})[0];e&&(this._elTrack.scrollLeft-=e.offsetWidth)}),l(this,y,()=>{const e=this.segments.filter((t,s,i)=>{var r;return((r=i[s-1])==null?void 0:r.isVisible)&&!t.isVisible}).reverse()[0];e&&(this._elTrack.scrollLeft+=e.offsetWidth)}),l(this,w,()=>{this.segments.every(e=>!e.isVisible)||(this._showPrevButton=!this.segments[0].isVisible,this._showNextButton=!this.segments[this.segments.length-1].isVisible)}),l(this,u,U(o(this,w),50)),l(this,f,()=>{const e=this.segments.find(t=>t.selected);if(e){const t=e.offsetWidth,s=e.offsetLeft;this._elIndicator.style.transform=`translateX(${s}px)`,this._elIndicator.style.width=`${t}px`}else this._elIndicator.style.transform="translateX(-100%)",this._elIndicator.style.width="0px"}),l(this,x,e=>{const t=this.segments.find(s=>s===e.target||s.contains(e.target));t&&(this.segments.forEach(s=>s.selected=!1),t.selected=!0,v(this,c,t.value),o(this,f).call(this),this.dispatchCustomEvent("change",{detail:{segment:t},bubbles:!0,composed:!0}))}),l(this,k,()=>{o(this,c)&&this.updateComplete.then(()=>{const e=this.segments.find(t=>t.value===o(this,c));e&&(this.segments.forEach(t=>t.selected=!1),e.selected=!0,this._elTrack.scrollLeft=e.offsetLeft)})})}get value(){return o(this,c)}set value(e){v(this,c,e),o(this,k).call(this)}get segments(){return this._elSlot?this._elSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented-control"),this.updateComplete.then(()=>{this._elTrack.addEventListener("scroll",()=>{o(this,u).call(this)})})}render(){return $`<button
      ...
      </button>`}_recalculateMinWidth(){this.updateComplete.then(()=>{o(this,u).call(this),o(this,f).call(this)})}};c=new WeakMap;b=new WeakSet;L=function(){var t,s;const e=(t=this.segments.find(i=>i.selected))==null?void 0:t.value;e&&v(this,c,e),(s=this.intersectionObserver)==null||s.disconnect(),this.intersectionObserver=new IntersectionObserver(i=>{i.forEach(r=>{const a=r.target;a._isVisible=r.intersectionRatio>.99,o(this,u).call(this)})},{root:this._elTrack,threshold:[0,.01,.5,.99,1]}),this.segments.forEach(i=>{var r;(r=this.intersectionObserver)==null||r.observe(i)})};_=new WeakMap;y=new WeakMap;w=new WeakMap;u=new WeakMap;f=new WeakMap;x=new WeakMap;k=new WeakMap;n.styles=[V,H];d([g({reflect:!0})],n.prototype,"size",2);d([g()],n.prototype,"value",1);d([S("slot")],n.prototype,"_elSlot",2);d([S("#indicator")],n.prototype,"_elIndicator",2);d([S("#track")],n.prototype,"_elTrack",2);d([z()],n.prototype,"_showPrevButton",2);d([z()],n.prototype,"_showNextButton",2);d([G(),D("value")],n.prototype,"_recalculateMinWidth",1);n=d([W("gds-segmented-control",{dependsOn:[h,X,A]}),T()],n);n.define();h.define();
