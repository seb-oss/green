import{x as r}from"./lit-element-Bx14lxc-.js";import{a as P}from"./argTableProps-B4fQI1IP.js";import"./filter-chips-C54MsqSX.js";import"./filter-chip-DWnlNRML.js";import"./custom-elements-pW7Gm7tH.js";import"./filter-chips.component-B4_kOOTe.js";import"./custom-element-scoping-CNGU1oQ0.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./class-map-CXsQwv0r.js";import"./directive-CF8sV3Lr.js";import"./resize-observer-B9k8v2TZ.js";import"./watch-tFciLXSI.js";import"./attribute-converters-CdI0trPX.js";import"./button.component-6nvmO9qk.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./static-B8S6DEnV.js";import"./tokens.style-vQBwQv71.js";import"./transitional-styles-CD1mMrWO.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-dHcexrGz.js";import"./checkmark.component-BCrUGdY2.js";import"./icon-CMjDogij.js";const X={title:"Components/Filter chips",component:"gds-filter-chips",subcomponents:{FilterChip:"gds-filter-chip"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/filter-chips)
&nbsp;|&nbsp;
...
will be used to set \`aria-label\` for the appropriate element.`,...(u=(g=e.parameters)==null?void 0:g.docs)==null?void 0:u.description}}};var f,m,v,w,b;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...
  \`
}`,...(v=(m=i.parameters)==null?void 0:m.docs)==null?void 0:v.source},description:{story:"Setting the `multiple` attribute will allow users to select multiple filter chips. The value of the\ncomponent will be an array of the selected chip values.",...(b=(w=i.parameters)==null?void 0:w.docs)==null?void 0:b.description}}};var y,T,C,I,S;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-filter-chips value="top-news" label="Pick news channel" row-collapse>
      <gds-filter-chip value="all">All</gds-filter-chip>
  ...
  \`
}`,...(C=(T=t.parameters)==null?void 0:T.docs)==null?void 0:C.source},description:{story:"In some cases, layout constraints may require the filter chips to collapse into a single row.\n\nSetting the `row-collapse` attribute will enable this behavior when the chips require more than two rows. Instead, scrolling overflow will be used to accommodate the chips.",...(S=(I=t.parameters)==null?void 0:I.docs)==null?void 0:S.description}}};const Y=["Basic","Usage","MultiSelect","RowCollapse"];export{l as Basic,i as MultiSelect,t as RowCollapse,e as Usage,Y as __namedExportsOrder,X as default};
