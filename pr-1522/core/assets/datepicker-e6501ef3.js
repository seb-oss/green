 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ae=(e,t,a)=>{const i=new Map;for(let s=t;s<=a;s++)i.set(e[s],s);return i},bt=Ve(class extends nt{constructor(e){if(super(e),e.type!==rt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,a){let i;a===void 0?a=t:t!==void 0&&(i=t);const s=[],n=[];let o=0;for(const c of e)s[o]=i?i(c,o):o,n[o]=a(c,o),o++;return{values:n,keys:s}}render(e,t,a){return this.dt(e,t,a).values}update(e,[t,a,i]){const s=at(e),{values:n,keys:o}=this.dt(t,a,i);if(!Array.isArray(s))return this.ut=o,n;const c=this.ut??(this.ut=[]),r=[];let x,k,l=0,v=s.length-1,g=0,w=n.length-1;for(;l<=v&&g<=w;)if(s[l]===null)l++;else if(s[v]===null)v--;else if(c[l]===o[g])r[g]=F(s[l],n[g]),l++,g++;else if(c[v]===o[w])r[w]=F(s[v],n[w]),v--,w--;else if(c[l]===o[w])r[w]=F(s[l],n[w]),z(e,r[w+1],s[l]),l++,w--;else if(c[v]===o[g])r[g]=F(s[v],n[g]),z(e,s[l],s[v]),v--,g++;else if(x===void 0&&(x=Ae(o,g,w),k=Ae(c,l,v)),x.has(c[l]))if(x.has(c[v])){const S=k.get(o[g]),j=S!==void 0?s[S]:null;if(j===null){const Ie=z(e,s[l]);F(Ie,n[g]),r[g]=Ie}else r[g]=F(j,n[g]),z(e,s[l],j),s[S]=null;g++}else ee(s[v]),v--;else ee(s[l]),l++;for(;g<=w;){const S=z(e,r[w+1]);F(S,n[g]),r[g++]=S}for(;l<=v;){const S=s[l++];S!==null&&ee(S)}return this.ut=o,st(e,r),ae}});var wt=Object.defineProperty,$t=Object.getOwnPropertyDescriptor,E=(e,t,a,i)=>{for(var s=i>1?void 0:i?$t(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(s=(i?o(t,a,s):o(s))||s);return i&&s&&wt(t,a,s),s},Fe=(e,t,a)=>{if(!t.has(e))throw TypeError("Cannot "+a)},m=(e,t,a)=>(Fe(e,t,"read from private field"),a?a.call(e):t.get(e)),$=(e,t,a)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,a)},Re=(e,t,a,i)=>(Fe(e,t,"write to private field"),i?i.call(e,a):t.set(e,a),a),b=(e,t,a)=>(Fe(e,t,"access private method"),a),D,R,B,G,q,se,ie,ne,re,Be,I,A,K,oe,N,L,O,X;let C=class extends je{constructor(){super(...arguments),$(this,re),$(this,I),$(this,K),$(this,N),$(this,O),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=b(this,K,oe).call(this,this.value,this.length),$(this,D,""),$(this,R,()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=this.length===2?this.min:new Date().getFullYear()-1),this.value=b(this,N,L).call(this,e+1),b(this,I,A).call(this)}),$(this,B,()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=this.length===2?this.max:new Date().getFullYear()+1),this.value=b(this,N,L).call(this,e-1),b(this,I,A).call(this)}),$(this,G,e=>{e.stopPropagation(),e.preventDefault(),this.focus()}),$(this,q,()=>{b(this,O,X).call(this)}),$(this,se,()=>{m(this,D)!==""&&(b(this,O,X).call(this),this.value=b(this,N,L).call(this,parseInt(this.value.toString())),b(this,I,A).call(this))}),$(this,ie,e=>{e.stopPropagation(),e.preventDefault(),e.deltaY>0?m(this,B).call(this):m(this,R).call(this)}),$(this,ne,e=>{let t=!1;if(e.key==="ArrowUp")m(this,R).call(this),t=!0;else if(e.key==="ArrowDown")m(this,B).call(this),t=!0;else{const a=parseInt(e.key);isNaN(a)||(m(this,D).length<this.length&&(Re(this,D,m(this,D)+a.toString()),this.value=parseInt(m(this,D))),m(this,D).length===this.length&&(this.value=b(this,N,L).call(this,this.value),b(this,O,X).call(this),b(this,re,Be).call(this),b(this,I,A).call(this)),t=!0)}t&&(e.preventDefault(),e.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",m(this,ie)),this.addEventListener("keydown",m(this,ne)),this.addEventListener("blur",m(this,se)),this.addEventListener("focus",m(this,q)),this.addEventListener("click",m(this,G)),this.addEventListener("mousedown",m(this,G))}focus(e){super.focus(e),m(this,q).call(this)}render(){return W`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=b(this,K,oe).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};D=new WeakMap;R=new WeakMap;B=new WeakMap;G=new WeakMap;q=new WeakMap;se=new WeakMap;ie=new WeakMap;ne=new WeakMap;re=new WeakSet;Be=function(){let e=this.nextElementSibling;for(;e;){if(e instanceof C){e.focus();break}e=e.nextElementSibling}};I=new WeakSet;A=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))};K=new WeakSet;oe=function(e,t){return String(e).padStart(t,"0")};N=new WeakSet;L=function(e){return Math.max(this.min,Math.min(this.max,e))};O=new WeakSet;X=function(){Re(this,D,"")};C.formAssociated=!0;E([y({type:Number})],C.prototype,"value",2);E([y({type:Number})],C.prototype,"length",2);E([y({type:Number,attribute:"aria-valuemin"})],C.prototype,"min",2);E([y({type:Number,attribute:"aria-valuemax"})],C.prototype,"max",2);E([U()],C.prototype,"displayValue",2);E([De("value")],C.prototype,"_refreshDisplayValue",1);C=E([Le("gds-date-part-spinner")],C);const xt=et`
  @layer base, reset;
      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${bt(u(this,Me,He),e=>e,e=>W`<gds-option value=${e}>${e}</gds-option>`)}
          </gds-dropdown>
          <gds-button
            @click=${u(this,we)}
