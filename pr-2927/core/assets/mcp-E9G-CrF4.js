import{u as o,j as e,M as i}from"./iframe-l1vqnyNy.js";import"./preload-helper-PPVm8Dsz.js";function s(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guides/MCP for coding agents"}),`
`,e.jsx(n.h1,{id:"green-mcp-server-for-coding-agents",children:"Green MCP Server for Coding Agents"}),`
...
`,e.jsx(n.p,{children:"You can also try asking the agent itself if it can access the Green MCP server or if it has trouble finding necessary documentation."}),`
`,e.jsx(n.h3,{id:"mcp-unavailable",children:"MCP unavailable"}),`
`,e.jsxs(n.p,{children:["If the MCP server is unavailable for some reason, you can also access the same context via the ",e.jsx(n.a,{href:"/docs/guides-green-context-cli--docs",children:"Green Context CLI"}),". The CLI provides the same information but without the need for an active MCP server connection."]}),`
`,e.jsx(n.p,{children:"To use it, update the copilot instructions to refer to the CLI instead:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-markdown",children:`# Green Design System Components

This app is built in Angular using Green Design System components.

When using Green components, ALWAYS refer to the Green Context CLI for component documentation, guidelines, and instructions.

ALWAYS start by reading the main instructions by running \`npx green-core-context instructions\` in the terminal.
