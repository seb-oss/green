import"./switch-cCYblswv.js";import"./flex-BTZg0uBO.js";import{b as t}from"./iframe-BSZXZYIs.js";import"./text-D6ppvjvL.js";import"./divider-BYMTqAng.js";import{a as x}from"./argTableProps-CxV3XV9a.js";import"./switch.component-CbgMcmGG.js";import"./checkmark.component-DN8a5_RF.js";import"./icon.component-C4Rz_KwB.js";import"./flex.component-CLYsO7Fp.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-DBe5kr_I.js";import"./default-typography.styles-C-Jt-k6g.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
