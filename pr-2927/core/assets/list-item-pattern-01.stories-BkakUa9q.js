import{b as s}from"./iframe-DpOvTZOc.js";import{a as c}from"./argTableProps-UemZjZyz.js";import{G as p}from"./list-item-pattern-01.component-BGcLPaUe.js";import"./cloudy-sun-CfNDFI60.js";import"./text-BpE1OqHk.js";import"./link-s6YFW7Iy.js";import"./flex-Cx986cRb.js";import"./list-item-m4ZQvoyH.js";import"./divider-337JEp7e.js";import"./preload-helper-PPVm8Dsz.js";import"./flex.component-CCQUbWHB.js";import"./checkmark.component-Bldswts_.js";import"./icon.component-8Bk1Ohgq.js";import"./chevron-right.component-Dkpmge4i.js";import"./minus-small.component-Bc4ou1Z8.js";import"./text.component-DwraOWhR.js";import"./default-typography.styles-gezwWmbo.js";import"./rbcb-toggle.template-CsFFwYO6.js";import"./resize-observer-CfkbZofs.js";import"./props-link-o4n_rSro.js";import"./cloudy-sun.component-Bva9w_VL.js";p.define();const t=e=>Array.from({length:e},(u,g)=>({label:`Item ${g+1}`,value:`Value ${g+1}`})),E={title:"Patterns/List Item Pattern 01",component:"gds-list-item-pattern-01",tags:["autodocs"],argTypes:{...c("gds-list-item-pattern-01")},parameters:{docs:{description:{component:"A list container (`gds-list-pattern-01`) holding one or more row items\n(`gds-list-item-pattern-01`). Together they render a semantic `gds-list`\nwith configurable row slots:\n\n- **Lead**: shows a checkbox when `selectable` is set on the item.\n- **Main**: renders columns from `items`, or falls back to the default slot.\n- **Trail**: shows a chevron link when `href` is set on the item, or accepts custom content via the `trail` slot.\n\nThe row supports three main states:\n- **Selectable**: shows a checkbox in the lead and allows toggling the `checked` state.\n- **Linked**: shows a chevron in the trail and applies a hover state to the entire row.\n- **Default**: no checkbox or chevron, used for simple lists or when custom content is projected in the lead/trail."}}}},n={render:()=>s`
