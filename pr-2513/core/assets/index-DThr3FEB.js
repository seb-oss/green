 ...
 */
  ...
  --gds-sys-shadow-2xl-02: 0px 0px 0px 0px transparent;`;var fe={};const ps=typeof process<"u"&&fe!==void 0;var us,ls,cs,Cs,es,Os,Ns;function he(){return ps?[]:document.adoptedStyleSheets||[]}const ue=class Us{constructor(){p(this,es),p(this,us,!_s()),p(this,ls,new Map),p(this,cs,new Map),p(this,Cs,he())}static get instance(){var s;return(s=globalThis.__gdsGlobalStylesRegistryScoped)!=null&&s[T]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[T]:new Us}),globalThis.__gdsGlobalStylesRegistryScoped[T]}injectGlobalStyles(s,t){if(a(this,us)){const o=Array.isArray(t)?t.map(n=>n.toString()).join(""):t.toString();j(this,es,Os).call(this,s,o)}else t.styleSheet&&j(this,es,Ns).call(this,s,t.styleSheet)}};us=new WeakMap;ls=new WeakMap;cs=new WeakMap;Cs=new WeakMap;es=new WeakSet;Os=function(e,s){if(ps)return;let t=a(this,cs).get(e);t||(t=document.createElement("style"),a(this,cs).set(e,t)),t.textContent=s,document.head.appendChild(t)};Ns=function(e,s){ps||(a(this,ls).set(e,s),document.adoptedStyleSheets=[...a(this,Cs),...Array.from(a(this,ls).values())])};let ve=ue;const q=[w`
    :host {
      ${m(qs)}
      ${m(Is)}
    }
...
`;var Le=Ae,X,C,W,Ys,bs,ms,Ss;const We=["aria-label","aria-haspopup","aria-expanded"],je=Ge(Q);class v extends k{constructor(){super(...arguments),p(this,C),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",p(this,X,!1),p(this,bs,()=>{var t;const s=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];x(this,X,s.length===1&&(s[0].tagName.toLowerCase().startsWith("gds-icon")||s[0].getAttribute("name")==="icon")),this.requestUpdate()}),p(this,ms,s=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:s}),this.form&&!a(this,C,W)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())}),p(this,Ss,s=>{if(!this.disabled&&(s.code==="Space"||s.key==="Enter")&&!s.repeat){const t=this._ripple;t&&t.triggerRipple()}})}focus(s){var t;(t=this._getValidityAnchor())==null||t.focus(s)}click(){var s;(s=this._getValidityAnchor())==null||s.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),Xs.instance.apply(this,"gds-button")}render(){const s={button:!0,circle:a(this,X),icon:a(this,X),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,C,W)?Ms`a`:Ms`button`;return Ws`
      <${t}
        class=${ee(s)}
...
`;var Ie=qe;class M extends Bs(Ts(F)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const t={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...t,"aria-label":this.label}:{...t,role:"presentation"}}get svgContent(){const s=this.constructor;return this.solid?s._solidSVG:s._regularSVG}applyStroke(s){return this.stroke?s.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):s}generateAttributesString(s){return Object.entries(s).filter(([t,o])=>o!==void 0).map(([t,o])=>`${t}="${o}"`).join(`
    ...
    `;return ws`${ie(o)}`}}M.styles=[q,Ie];r([i({...S,property:"height",selector:"svg"})],M.prototype,"size",2);r([g({type:Boolean})],M.prototype,"solid",2);r([g({type:Number})],M.prototype,"stroke",2);r([g()],M.prototype,"level",2);r([i(ys("content"))],M.prototype,"color",2);r([g({type:String})],M.prototype,"label",2);M.define();const Oe=w`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
