...
`;let GdsBadge=class extends((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(gds_element.j)))){constructor(){super(...arguments),(0,chunk_QU3DSPNU.VK)(this,_GdsBadge_instances),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){let background,color;if(this.notification)background="negative-01",color="inversed";else switch(this.variant){case"information":default:background="information-03",color="information-01";break;case"notice":background="notice-03",color="notice-01";break;case"positive":background="positive-03",color="positive-03";break;case"warning":background="warning-03",color="warning-01";break;case"negative":background="negative-03",color="negative-01";break;case"disabled":background="disabled-03",color="disabled-01"}const padding=(()=>{const paddings={notification:{occupied:"4xs 2xs",default:"3xs"},small:{occupied:"4xs 3xs",default:"4xs 3xs"},default:{occupied:"3xs xs 3xs 2xs",default:"4xs xs"}};if(this.notification)return paddings.notification[this.mainSlotOccupied?"occupied":"default"];return paddings["small"===this.size?"small":"default"][this.leadSlotOccupied?"occupied":"default"]})(),blockSize=(()=>{const sizes={occupied:{small:"m",default:"l"},default:"xs"};return this.mainSlotOccupied?sizes.occupied["small"===this.size||this.notification?"small":"default"]:sizes.default})(),inlineSize=(()=>{const sizes={notification:{occupied:"l",default:"0"},default:"l"};return this.notification?sizes.notification[this.mainSlotOccupied?"occupied":"default"]:sizes.default})(),borderRadius=(()=>{const radiuses_small="3xs",radiuses_notification="max",radiuses_default="2xs";return this.rounded?"max":this.notification?radiuses_notification:"small"===this.size?radiuses_small:radiuses_default})();return custom_element_scoping.qy`<gds-flex
      level="3"
      ...
      font="${"small"===this.size||this.notification?"detail-book-xs":"detail-book-s"}"
    >
    ...
    </gds-flex>`}};_GdsBadge_instances=new WeakSet,handleSlotChange_fn=function(event,stateProperty){const assignedNodes=event.target.assignedNodes({flatten:!0});this[stateProperty]=assignedNodes.length>0&&assignedNodes.some((node=>node.nodeType===Node.ELEMENT_NODE||node.nodeType===Node.TEXT_NODE&&""!==node.textContent?.trim()))},renderLeadSlot_fn=function(){if("small"!==this.size||!this.notification)return custom_element_scoping.qy`<slot
        name="lead"
...
`},"./dist/libs/core/src/shared-styles/rbcb-toggle.template.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{U:()=>radioToggle,o:()=>checkboxToggle});__webpack_require__("./dist/libs/core/src/chunks/chunk.QU3DSPNU.js");var lit_directives_class_map_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/lit/directives/class-map.js"),lit_directives_when_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("./node_modules/lit-html/directives/when.js"),_scoping_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./dist/libs/core/src/utils/helpers/custom-element-scoping.js");const checkboxToggle=props=>template({...props,type:"checkbox"}),radioToggle=props=>template({...props,type:"radio"}),template=props=>{const{type,checked,indeterminate,disabled,invalid}=props,modifiers={"rbcb--checkbox":"checkbox"===type,"rbcb--radio":"radio"===type,"--checked":checked,"--indeterminate":indeterminate,"--disabled":disabled,"--invalid":invalid};return _scoping_js__WEBPACK_IMPORTED_MODULE_2__.qy`
  ...
  `}}}]);
//# sourceMappingURL=2704.15d990c8.iframe.bundle.js.map