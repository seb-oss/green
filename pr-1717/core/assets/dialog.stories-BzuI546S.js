var L=t=>{throw TypeError(t)};var z=(t,e,o)=>e.has(t)||L("Cannot "+o);var l=(t,e,o)=>(z(t,e,"read from private field"),o?o.call(t):e.get(t)),g=(t,e,o)=>e.has(t)?L("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,o);var C=(t,e,o)=>(z(t,e,"access private method"),o);import{s as mt,n as W,g as ft,G as yt,h as A}from"./custom-element-scoping-CpYtbs9r.js";import{a as rt}from"./query-p8xgzTDt.js";import{n as bt}from"./when-BR7zwNJC.js";import{w as vt}from"./watch-tFciLXSI.js";import{i as dt,x as ct}from"./lit-element-C_s9q329.js";import"./button-CDW85ISG.js";import"./card-DaWIu-qR.js";import"./flex-DRZA5e5f.js";import"./cross-large-DoZOb4GU.js";import{m as j}from"./runtime-CMQcyTl6.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./class-map-Bz98xO8-.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./static-_ukc2i0J.js";import"./tokens.style-RalixZsd.js";import"./transitional-styles-Cc5JwJ9o.js";import"./style-expression-property-C6V8xdlu.js";import"./container-BCJYnPkU.js";import"./icon-C1rUgQqA.js";const wt=dt`
...
dismissed, or a required action has been taken.`}}}},y={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{heading:"Dialog heading",innerHTML:`<gds-button slot="trigger">Open Dialog</gds-button>

This is the content of the dialog.`}},p={...y},u={...y,args:{...y.args,variant:"slide-out"}},m={...y,render:()=>ct`<gds-button onclick="document.getElementById('my-dialog').show()"
...
automatically open the dialog when the button is clicked.`,...(U=(q=p.parameters)==null?void 0:q.docs)==null?void 0:U.description}}};var H,X,F,J,K;u.parameters={...u.parameters,docs:{...(H=u.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...
  ...DefaultParams,
  render: () => html\`<gds-button onclick="document.getElementById('my-dialog').show()"
        >Open dialog</gds-button
      >
      <gds-dialog heading="Dialog heading" id="my-dialog">
        This is the content of the dialog.
