import{x as t}from"./lit-element-C_s9q329.js";import"./textarea-BbsNtlw3.js";import"./badge-DJWOzsSK.js";import"./flex-DRZA5e5f.js";import"./divider-DkqSgEb0.js";import"./credit-card-DGDJRfCy.js";import"./magnifying-glass-CKr7Csfw.js";import"./runtime-CMQcyTl6.js";import"./custom-element-scoping-CpYtbs9r.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./query-async-MEroNOeJ.js";import"./form-control-footer-D1zWjDuh.js";import"./when-BR7zwNJC.js";import"./button-CDW85ISG.js";import"./class-map-Bz98xO8-.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./static-_ukc2i0J.js";import"./tokens.style-RalixZsd.js";import"./transitional-styles-Cc5JwJ9o.js";import"./watch-tFciLXSI.js";import"./triangle-exclamation-D2VDkIvV.js";import"./icon-C1rUgQqA.js";import"./card-DaWIu-qR.js";import"./style-expression-property-C6V8xdlu.js";import"./container-BCJYnPkU.js";import"./cross-small-Y_gLfaO0.js";const We={title:"Components/Textarea",component:"gds-textarea",parameters:{layout:"centered",docs:{description:{component:"Textareas are used for longer multiline text inputs, such as comments or descriptions.<br>\nThey can be used in forms, dialogs, and data tables.\nThe `gds-textarea` component is a wrapper around the native textarea element and provides a consistent look and feel across browsers. It has 4 rows by default and it resizes vertically to fit the content as the user types.\n\nSome features of the Textarea include:\n- Built-in support for form validation\n- Slots for `lead` and `trail` icons\n- `Supporting` and `Extended` text\n- `Clearable` input fields\n- `Length` validation\n- `Disabled` state\n- Custom number of `Rows`\n\n@status beta"}}},tags:["autodocs"]},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label text"}},c={...a,name:"Default",render:()=>t`
...
\`\`\``,...(oe=(le=x.parameters)==null?void 0:le.docs)==null?void 0:oe.description}}};var de,ie,pe,xe,ge;g.parameters={...g.parameters,docs:{...(de=g.parameters)==null?void 0:de.docs,source:{originalSource:`{
  ...
  \`
}`,...(pe=(ie=g.parameters)==null?void 0:ie.docs)==null?void 0:pe.source},description:{story:"The `disabled` property can be set to disable the textarea field.\n\n**@property disabled** - Disables the textarea field.\n\n```html\n <gds-textarea disabled></gds-textarea>\n```",...(ge=(xe=g.parameters)==null?void 0:xe.docs)==null?void 0:ge.description}}};const _e=["Default","Lead","Trail","Length","Rows","Resize","Clearable","SupportingText","ExtendedSupportingText","Validation","Disabled"];export{d as Clearable,c as Default,g as Disabled,p as ExtendedSupportingText,r as Lead,s as Length,o as Resize,l as Rows,i as SupportingText,n as Trail,x as Validation,_e as __namedExportsOrder,We as default};
