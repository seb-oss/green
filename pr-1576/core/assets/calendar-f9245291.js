import{x as b,i as A}from"./lit-element-2a5e401f.js";import{e as P}from"./class-map-43969d56.js";import{o as F}from"./if-defined-39fa3d49.js";import{n as O}from"./when-cf7256a5.js";import{n as v,g as j,G as z}from"./gds-element-24e794df.js";import{a as G}from"./query-b9d3c2af.js";import{m as y}from"./lit-localize-87611c26.js";import{T as K}from"./transitional-styles-3f5f5b40.js";import{w as U}from"./watch-c4961afe.js";import{t as q}from"./tokens.style-681e2422.js";function S(t){"@babel/helpers - typeof";return S=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},S(t)}function k(t){if(t===null||t===!0||t===!1)return NaN;var e=Number(t);return isNaN(e)?e:e<0?Math.ceil(e):Math.floor(e)}function f(t,e){if(e.length<t)throw new TypeError(t+" argument"+(t>1?"s":"")+" required, but only "+e.length+" present")}function c(t){f(1,arguments);var e=Object.prototype.toString.call(t);return t instanceof Date||S(t)==="object"&&e==="[object Date]"?new Date(t.getTime()):typeof t=="number"||e==="[object Number]"?new Date(t):((typeof t=="string"||e==="[object String]")&&typeof console<"u"&&(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn(new Error().stack)),new Date(NaN))}function _(t,e){f(2,arguments);var a=c(t),r=k(e);return isNaN(r)?new Date(NaN):(r&&a.setDate(a.getDate()+r),a)}function R(t,e){f(2,arguments);var a=c(t),r=k(e);if(isNaN(r))return new Date(NaN);if(!r)return a;var o=a.getDate(),s=new Date(a.getTime());s.setMonth(a.getMonth()+r+1,0);var n=s.getDate();return o>=n?s:(a.setFullYear(s.getFullYear(),s.getMonth(),o),a)}var V={};function T(){return V}function $(t,e){var a,r,o,s,n,u,i,l;f(1,arguments);var g=T(),p=k((a=(r=(o=(s=e==null?void 0:e.weekStartsOn)!==null&&s!==void 0?s:e==null||(n=e.locale)===null||n===void 0||(u=n.options)===null||u===void 0?void 0:u.weekStartsOn)!==null&&o!==void 0?o:g.weekStartsOn)!==null&&r!==void 0?r:(i=g.locale)===null||i===void 0||(l=i.options)===null||l===void 0?void 0:l.weekStartsOn)!==null&&a!==void 0?a:0);if(!(p>=0&&p<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var D=c(t),m=D.getDay(),w=(m<p?7:0)+m-p;return D.setDate(D.getDate()-w),D.setHours(0,0,0,0),D}function E(t){f(1,arguments);var e=c(t);return e.setHours(0,0,0,0),e}function J(t,e){f(2,arguments);var a=k(e),r=a*7;return _(t,r)}function x(t,e){f(2,arguments);var a=E(t),r=E(e);return a.getTime()===r.getTime()}function Q(t){f(1,arguments);var e=c(t),a=e.getMonth();return e.setFullYear(e.getFullYear(),a+1,0),e.setHours(23,59,59,999),e}function X(t,e){var a;f(1,arguments);var r=t||{},o=c(r.start),s=c(r.end),n=s.getTime();if(!(o.getTime()<=n))throw new RangeError("Invalid interval");var u=[],i=o;i.setHours(0,0,0,0);var l=Number((a=e==null?void 0:e.step)!==null&&a!==void 0?a:1);if(l<1||isNaN(l))throw new RangeError("`options.step` must be a number greater than 1");for(;i.getTime()<=n;)u.push(c(i)),i.setDate(i.getDate()+l),i.setHours(0,0,0,0);return u}function Z(t,e){f(1,arguments);var a=t||{},r=c(a.start),o=c(a.end),s=o.getTime();if(!(r.getTime()<=s))throw new RangeError("Invalid interval");var n=$(r,e),u=$(o,e);n.setHours(15),u.setHours(15),s=u.getTime();for(var i=[],l=n;l.getTime()<=s;)l.setHours(0),i.push(c(l)),l=J(l,1),l.setHours(15);return i}function ee(t){f(1,arguments);var e=c(t);return e.setDate(1),e.setHours(0,0,0,0),e}function te(t,e){var a,r,o,s,n,u,i,l;f(1,arguments);var g=c(t),p=g.getFullYear(),D=T(),m=k((a=(r=(o=(s=e==null?void 0:e.firstWeekContainsDate)!==null&&s!==void 0?s:e==null||(n=e.locale)===null||n===void 0||(u=n.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&o!==void 0?o:D.firstWeekContainsDate)!==null&&r!==void 0?r:(i=D.locale)===null||i===void 0||(l=i.options)===null||l===void 0?void 0:l.firstWeekContainsDate)!==null&&a!==void 0?a:1);if(!(m>=1&&m<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var w=new Date(0);w.setFullYear(p+1,0,m),w.setHours(0,0,0,0);var B=$(w,e),W=new Date(0);W.setFullYear(p,0,m),W.setHours(0,0,0,0);var L=$(W,e);return g.getTime()>=B.getTime()?p+1:g.getTime()>=L.getTime()?p:p-1}function ae(t,e){var a,r,o,s,n,u,i,l;f(1,arguments);var g=T(),p=k((a=(r=(o=(s=e==null?void 0:e.firstWeekContainsDate)!==null&&s!==void 0?s:e==null||(n=e.locale)===null||n===void 0||(u=n.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&o!==void 0?o:g.firstWeekContainsDate)!==null&&r!==void 0?r:(i=g.locale)===null||i===void 0||(l=i.options)===null||l===void 0?void 0:l.firstWeekContainsDate)!==null&&a!==void 0?a:1),D=te(t,e),m=new Date(0);m.setFullYear(D,0,p),m.setHours(0,0,0,0);var w=$(m,e);return w}var re=6048e5;function se(t,e){f(1,arguments);var a=c(t),r=$(a,e).getTime()-ae(a,e).getTime();return Math.round(r/re)+1}function oe(t){f(1,arguments);var e=c(t),a=e.getMonth();return e.setFullYear(e.getFullYear(),a+1,0),e.setHours(0,0,0,0),e}function ne(t,e){f(2,arguments);var a=c(t),r=c(e);return a.getFullYear()===r.getFullYear()&&a.getMonth()===r.getMonth()}function ie(t,e){f(2,arguments);var a=k(e);return R(t,-a)}function le(t,e){const a=ee(t),r=Q(t),o=Z({start:a,end:r},{weekStartsOn:1});return b`${e(o.map(s=>({days:X({start:s,end:_(s,6)})})))}`}const de=A`
  @layer base, reset;
...
`;var ue=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,h=(t,e,a,r)=>{for(var o=r>1?void 0:r?ce(e,a):e,s=t.length-1,n;s>=0;s--)(n=t[s])&&(o=(r?n(e,a,o):n(o))||o);return r&&o&&ue(e,a,o),o},fe=(t,e,a)=>{if(!e.has(t))throw TypeError("Cannot "+a)},H=(t,e,a)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,a)},M=(t,e,a)=>(fe(t,e,"access private method"),a),C,N,Y,I;let d=class extends z{constructor(){super(...arguments),H(this,C),H(this,Y),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=t=>t.toDateString()}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(t){const e=oe(new Date(this.focusedYear,t,1)),a=new Date(this.focusedDate);a.setDate(Math.min(this.focusedDate.getDate(),e.getDate())),a.setMonth(t),a.setHours(12,0,0,0),this.focusedDate=a}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(t){this.focusedDate=new Date(this.focusedDate.setFullYear(t))}getDateCell(t){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector(`#dateCell-${t}`)}connectedCallback(){super.connectedCallback(),K.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",M(this,Y,I))}focus(){var t;super.focus(),(t=this._elFocusedCell)==null||t.focus()}render(){const t=new Date;return b`<table role="grid" aria-label="${F(this.label)}">
      ${O(!this.hideDayNames,()=>b`<thead role="rowgroup">
            <tr role="row">
              ${O(this.showWeekNumbers,()=>b`<th></th>`)}
              <th>${y("Mon")}</th>
              <th>${y("Tue")}</th>
              <th>${y("Wed")}</th>
              <th>${y("Thu")}</th>
      ...
      <tbody role="rowgroup">
        ${le(this.focusedDate,e=>b`
            ${e.map(a=>b`
                <tr role="row">
                  ${O(this.showWeekNumbers,()=>b`<td class="week-number" scope="row">
                        ${se(a.days[0])}
                      </td>`)}
                  ${a.days.map(r=>{const o=this.customizedDates&&this.customizedDates.find(g=>x(g.date,r)),s={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(g=>x(g,r))),...o},n=!ne(this.focusedDate,r)||r<this.min||r>this.max,u=r.getDay()===0||r.getDay()===6,i=s.disabled||n||this.disabledWeekends&&u;return this.hideExtraneousDays&&n?b`<td inert></td>`:b`
                          <td
                            role="${F(i?void 0:"gridcell")}"
                            class="${P({"custom-date":!!o,disabled:!!i,today:x(t,r)})}"
                            ?disabled=${i}
                            tabindex="${x(this.focusedDate,r)?0:-1}"
                            aria-selected="${this.value&&x(this.value,r)?"true":"false"}"
