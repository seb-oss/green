import{b as i,r as a}from"./iframe-DAdgaLKT.js";import"./context-menu-D9jXxrVi.js";import"./menu-item-Cdrr6YTh.js";import"./menu-heading-DjyKTrMt.js";import{a as c}from"./argTableProps-DNJPfIHy.js";import"./arrow-up-BXXKBhGv.js";import"./dot-grid-one-horizontal-RoeGUvtK.js";import"./flex-YMPL1mJ4.js";import"./preload-helper-PPVm8Dsz.js";import"./context-menu.component-CIz1sTYu.js";import"./localized-decorator-BZQ_0h1M.js";import"./unwrap-slots-CaQtTGNM.js";import"./ref-DdLAhmjV.js";import"./popover.component-fgQVxTdc.js";import"./floating-ui.dom-DPpwG6Py.js";import"./cross-small.component-JLSGySzb.js";import"./icon.component-B6CXmiBz.js";import"./menu-heading.component-BEbNiLlq.js";import"./arrow-up.component-DRGa6L3i.js";import"./flex.component-BaKKDkug.js";a();const S={title:"Components/Context menu",component:"gds-context-menu",subcomponents:{GdsMenuItem:"gds-menu-item"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/context-menu)
&nbsp;|&nbsp;
...
<gds-menu-item>Action 3</gds-menu-item>`}},d={...r},e={...r,render:m=>i`
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:"You can provide a custom trigger for the context menu by adding an element to the `trigger` slot.\nThe trigger element should be focusable, preferably a `gds-button` element. Appropriate ARIA attributes will be added\nto the trigger element automatically, but misuse of this slot can still result in an inaccessible component.",...n.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-context-menu
      label="Select an action"
  ...
  \`
}`,...t.parameters?.docs?.source},description:{story:"You can show the label by setting the `show-label` attribute on the `<gds-context-menu>` element.",...t.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-context-menu>
      <gds-icon-arrow-up slot="icon"></gds-icon-arrow-up>
  ...
  \`
}`,...o.parameters?.docs?.source},description:{story:"You can provide a custom icon for the context menu trigger by using the `icon` slot.",...o.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
