import"./switch-BwgFGulW.js";import"./flex-CO9lfU8X.js";import{b as t}from"./iframe-DGN3rWLd.js";import"./text-BY-HMTZU.js";import"./divider-83PQtLfG.js";import{a as x}from"./argTableProps-DghJexTW.js";import"./switch.component-CbvEAFof.js";import"./checkmark.component-DxjTxdHM.js";import"./icon.component-CTqJgJRN.js";import"./flex.component-V9gqo_dk.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-Qy1AxcqM.js";import"./default-typography.styles-DoSy3_Vg.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
