...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(z=(A=g.parameters)==null?void 0:A.docs)==null?void 0:z.description}}};var O,T,V,q,D;m.parameters={...m.parameters,docs:{...(O=m.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(V=(T=m.parameters)==null?void 0:T.docs)==null?void 0:V.source},description:{story:`The select component can have options, and grouping is also possible, with support for all native select attributes.
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(D=(q=m.parameters)==null?void 0:q.docs)==null?void 0:D.description}}};var I,_,P,$,R;h.parameters={...h.parameters,docs:{...(I=h.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
