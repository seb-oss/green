...
`;var we=Object.defineProperty,ke=Object.getOwnPropertyDescriptor,ue=e=>{throw TypeError(e)},s=(e,o,t,l)=>{for(var n=l>1?void 0:l?ke(o,t):o,c=e.length-1,d;c>=0;c--)(d=e[c])&&(n=(l?d(o,t,n):d(n))||n);return l&&n&&we(o,t,n),n},Te=(e,o,t)=>o.has(e)||ue("Cannot "+t),ze=(e,o,t)=>o.has(e)?ue("Cannot add the same private member more than once"):o instanceof WeakSet?o.add(e):o.set(e,t),C=(e,o,t)=>(Te(e,o,"access private method"),t),r,ge,me,he,be,ve;let i=class extends Ce{constructor(){super(),ze(this,r),this.placeholder="",this.supportingText="",this.size="large",this.disabled=!1,this.multiple=!1,this.selectId=`select-${Math.random().toString(36).substring(2,11)}`,this.value=""}firstUpdated(){var l,n,c,d;const e=(l=this.shadowRoot)==null?void 0:l.querySelector("label#placeholder"),o=(n=this.shadowRoot)==null?void 0:n.querySelector("slot:not([name])");if(o){const u=o.assignedNodes({flatten:!0}),h=(c=this.shadowRoot)==null?void 0:c.querySelector(".select-container");u.forEach(E=>{E.nodeType===Node.ELEMENT_NODE&&E.nodeName==="SELECT"&&(h==null||h.appendChild(E))})}const t=((d=this.shadowRoot)==null?void 0:d.querySelector(".select-container select"))||null;t&&(this.multiple=t.multiple,t.id=this.selectId,t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),this.value=t.value,t.addEventListener("change",()=>{const u=Array.from(t.selectedOptions).map(h=>h.value);this.value=this.multiple?u.join(","):u[0],this.checkValidity()}),t.value=this.value),e&&t&&t.addEventListener("change",()=>{const u=t.selectedOptions[0];e.textContent=u.textContent})}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}render(){const e={multiple:this.multiple};return m`
    ...
    `};ve=function(){if(!this.multiple)return m`
      ...
      `};i.styles=[Le,Ee];s([g()],i.prototype,"placeholder",2);s([g({attribute:"supporting-text"})],i.prototype,"supportingText",2);s([g({type:String})],i.prototype,"size",2);s([g({attribute:"disabled",type:Boolean,reflect:!0})],i.prototype,"disabled",2);s([g({type:Boolean})],i.prototype,"multiple",2);s([g({type:Number})],i.prototype,"selectElementSize",2);s([Se("select")],i.prototype,"selectElement",2);i=s([fe("gds-select"),ye()],i);const st={title:"Components/Select",component:"gds-select",tags:["autodocs"],parameters:{docs:{description:{component:"The `Select` story demonstrates a default selection component with a placeholder and supporting text.\n<br>The component can be customized with a label, supporting text, and additional content."}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},b={...a,name:"Select",args:{placeholder:"Science Themes",label:"Label text",supportingText:"Supporting text",innerHTML:`
  ...
  `};var w,k,T,z,A;b.parameters={...b.parameters,docs:{...(w=b.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
...
}`,...(T=(k=b.parameters)==null?void 0:k.docs)==null?void 0:T.source},description:{story:`### Parameters
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...(G=(N=x.parameters)==null?void 0:N.docs)==null?void 0:G.description}}};var V,H,B,j,F;y.parameters={...y.parameters,docs:{...(V=y.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...
  \`
}`,...(pe=(re=L.parameters)==null?void 0:re.docs)==null?void 0:pe.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(de=(ce=L.parameters)==null?void 0:ce.docs)==null?void 0:de.description}}};const at=["select","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{y as Disabled,x as Lead,M as Multiple,v as Option,L as SelectSize,S as Size,f as Validation,at as __namedExportsOrder,st as default,b as select};
