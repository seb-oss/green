...
`;var Ve=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,ge=e=>{throw TypeError(e)},c=(e,t,o,i)=>{for(var n=i>1?void 0:i?Te(t,o):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(n=(i?r(t,o,n):r(n))||n);return i&&n&&Ve(t,o,n),n},Oe=(e,t,o)=>t.has(e)||ge("Cannot "+o),_e=(e,t,o)=>t.has(e)?ge("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),S=(e,t,o)=>(Oe(e,t,"access private method"),o),p,me,he,ve,be,xe;let s=class extends Ae{constructor(){super(),_e(this,p),this.supportingText="",this.size="large",this.multiline=!1,this.selectedValue="",this._isValueUnset=!0,this.value=""}getInitialSelectValue(e){return e.multiple?Array.from(e.selectedOptions).map(o=>o.value).join(","):e.value}firstUpdated(){var o,i,n;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot:not([name])");if(e){const a=e.assignedNodes({flatten:!0}),r=(i=this.shadowRoot)==null?void 0:i.querySelector(".select-container");a.forEach(E=>{if(E.nodeType===Node.ELEMENT_NODE&&E.nodeName==="SELECT"){const M=E;if(this.multiline=M.multiple,r==null||r.appendChild(E),this._isValueUnset){const fe=this.getInitialSelectValue(M);this.value=fe;const L=Array.from(M.selectedOptions).map(ye=>ye.value);this.multiline?this.selectedValue=L:this.selectedValue=L.slice(0,1),this._isValueUnset=!1}}})}const t=((n=this.shadowRoot)==null?void 0:n.querySelector(".select-container select"))||null;t&&(t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),t.addEventListener("change",this.handleSelectChange.bind(this)),t.addEventListener("input",a=>a.stopPropagation()))}willUpdate(e){if(super.willUpdate(e),e.has("value")){const t=this.getSelectElement();if(t&&t.multiple){const o=this.value?this.value.split(","):[];Array.from(t.options).forEach(i=>{i.selected=o.includes(i.value)}),this.selectedValue=o}else t&&(t.value=this.value||"",this.selectedValue=this.value?[this.value]:[])}}handleSelectChange(e){e.stopPropagation(),this._isValueUnset=!1;const t=e.target,o=Array.from(t.selectedOptions).map(i=>i.value).filter(i=>i!=="");this.multiline?(this.selectedValue=o,this.value=o.length>0?o.join(","):""):(this.selectedValue=[o[0]],this.value=o[0]),this.checkValidity(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}formResetCallback(){const e=this.getSelectElement();if(e){if(e.multiple)Array.from(e.options).forEach(t=>{t.selected=!1}),this.selectedValue=[],this.value="";else{const t=e.options[0];t&&(this.value=t.value,e.value=t.value,this.selectedValue=[t.value])}this._isValueUnset=!0}}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){return this.selectElement}render(){const e={multiple:this.multiline};return d`
      ...
      ></gds-form-control-footer>
    `}};p=new WeakSet;me=function(){return[S(this,p,he).call(this),S(this,p,be).call(this),S(this,p,ve).call(this),S(this,p,xe).call(this)].map(t=>d`${t}`)};he=function(){return d` <slot name="lead" slot="lead"></slot> `};ve=function(){if(!this.multiline){const e=this.getSelectElement();let t=this.value;if(e){const o=Array.from(e.selectedOptions);o.length>0&&(t=o[0].text)}return d`<label id="placeholder">${t}</label>`}};be=function(){return d`
      <slot></slot>
...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(z=(A=g.parameters)==null?void 0:A.docs)==null?void 0:z.description}}};var V,T,O,_,q;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(O=(T=m.parameters)==null?void 0:T.docs)==null?void 0:O.source},description:{story:`The select component can have options, and grouping is also possible, with support for all native select attributes.
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(q=(_=m.parameters)==null?void 0:_.docs)==null?void 0:q.description}}};var D,I,P,$,R;h.parameters={...h.parameters,docs:{...(D=h.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(P=(I=h.parameters)==null?void 0:I.docs)==null?void 0:P.source},description:{story:`The lead icon is displayed to the left of the select field.
<br>It can be used to provide additional context or to visually represent the select field's purpose.
<br>It can be set by adding an icon component to the 'lead' slot.`,...(R=($=h.parameters)==null?void 0:$.docs)==null?void 0:R.description}}};var N,G,H,U,B;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(ie=(oe=f.parameters)==null?void 0:oe.docs)==null?void 0:ie.source},description:{story:"Multiple\nThe `multiple` attribute can be set to allow multiple options to be selected on the native `<select>` element.",...(se=(ne=f.parameters)==null?void 0:ne.docs)==null?void 0:se.description}}};var le,ae,re,pe,ue;y.parameters={...y.parameters,docs:{...(le=y.parameters)==null?void 0:le.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select Size',
  render: () => html\`
    <gds-flex>
