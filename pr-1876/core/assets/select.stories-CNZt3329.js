import{i as ye,x as d}from"./lit-element-C_s9q329.js";import{l as Se}from"./localized-decorator-iufJoRiP.js";import"./runtime-CMQcyTl6.js";import{n as ue,r as ce,g as Ee,h as c}from"./custom-element-scoping-BRwcB39g.js";import{a as Me}from"./query-p8xgzTDt.js";import{e as Le}from"./class-map-Bz98xO8-.js";import{t as Ce}from"./tokens.style-SarioPsh.js";import{w as we}from"./watch-tFciLXSI.js";import{a as ke}from"./button-Ck5JCMxE.js";import"./field-base-DipKZHhv.js";import"./chevron-bottom-bIUUPBrH.js";import"./flex-DYJ5h7D3.js";import"./square-grid-circle-BxZXT1pg.js";import"./rocket-By36vGMQ.js";import"./sun-B6-q3uuw.js";import"./brand-green-B0sSgmTm.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./transitional-styles-CXWlQDsX.js";import"./observe-light-dom-CmJPHUQ4.js";import"./triangle-exclamation-B-wIpajX.js";import"./icon-B0MZHPzy.js";import"./card-aIEaOFVy.js";import"./style-expression-property-Dbto4vYM.js";import"./container-CQV8FXoH.js";import"./badge-Bk0Oy8yr.js";const Ae=ye`
...
`;var ze=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,ge=e=>{throw TypeError(e)},u=(e,t,o,n)=>{for(var i=n>1?void 0:n?Te(t,o):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&ze(t,o,i),i},Oe=(e,t,o)=>t.has(e)||ge("Cannot "+o),qe=(e,t,o)=>t.has(e)?ge("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),S=(e,t,o)=>(Oe(e,t,"access private method"),o),p,me,he,ve,be,xe;let s=class extends ke{constructor(){super(),qe(this,p),this.supportingText="",this.size="large",this.multiline=!1,this.selectedValue="",this.value=""}getInitialSelectValue(e){return e.multiple?Array.from(e.selectedOptions).map(o=>o.value).join(","):e.value}firstUpdated(){var o,n,i;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot:not([name])");if(e){const a=e.assignedNodes({flatten:!0}),r=(n=this.shadowRoot)==null?void 0:n.querySelector(".select-container");a.forEach(E=>{if(E.nodeType===Node.ELEMENT_NODE&&E.nodeName==="SELECT"){const L=E;this.multiline=L.multiple,r==null||r.appendChild(E);const M=Array.from(L.selectedOptions).map(fe=>fe.value);this.multiline?(this.selectedValue=M,this.value=M.join(",")):(this.selectedValue=M.slice(0,1),this.value=M[0]||"")}})}const t=((i=this.shadowRoot)==null?void 0:i.querySelector(".select-container select"))||null;t&&(t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),t.addEventListener("change",this.handleSelectChange.bind(this)),t.addEventListener("input",a=>a.stopPropagation()))}willUpdate(e){if(super.willUpdate(e),e.has("value")){const t=this.getSelectElement();if(t&&t.multiple){const o=this.value?this.value.split(","):[];Array.from(t.options).forEach(n=>{n.selected=o.includes(n.value)}),this.selectedValue=o}else t&&(t.value=this.value||"",this.selectedValue=this.value?[this.value]:[])}}handleSelectChange(e){e.stopPropagation();const t=e.target,o=Array.from(t.selectedOptions).map(n=>n.value).filter(n=>n!=="");this.multiline?(this.selectedValue=o,this.value=o.length>0?o.join(","):""):(this.selectedValue=[o[0]],this.value=o[0]),this.checkValidity(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}formResetCallback(){const e=this.getSelectElement();if(e)if(e.multiple)Array.from(e.options).forEach(t=>{t.selected=!1}),this.selectedValue=[],this.value="";else{const t=e.options[0];t&&(this.value=t.value,e.value=t.value,this.selectedValue=[t.value])}}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){return this.selectElement}render(){const e={multiple:this.multiline};return c`
      ...
      ></gds-form-control-footer>
    `}};p=new WeakSet;me=function(){return[S(this,p,he).call(this),S(this,p,be).call(this),S(this,p,ve).call(this),S(this,p,xe).call(this)].map(t=>c`${t}`)};he=function(){return c` <slot name="lead" slot="lead"></slot> `};ve=function(){if(!this.multiline){const e=this.getSelectElement();let t=this.value;if(e){const o=Array.from(e.selectedOptions);o.length>0&&(t=o[0].text)}return c`<label id="placeholder">${t}</label>`}};be=function(){return c`
      <slot></slot>
      <div class="select-container"></div>
    `};xe=function(){if(!this.multiline)return c`
        <gds-button
          tabindex="-1"
          size="small"
          rank="tertiary"
      ...
      `};s.styles=[Ce,Ae];u([ue({attribute:"supporting-text"})],s.prototype,"supportingText",2);u([ue({type:String})],s.prototype,"size",2);u([ce()],s.prototype,"multiline",2);u([ce()],s.prototype,"selectedValue",2);u([Me("select")],s.prototype,"selectElement",2);u([we("value")],s.prototype,"firstUpdated",1);s=u([Ee("gds-select"),Se()],s);const rt={title:"Components/Select",component:"gds-select",tags:["autodocs"],parameters:{docs:{description:{component:"The `Select` story demonstrates a default selection component with a label and supporting text.\n<br>The component can be customized with a label, supporting text, lead icon and additional content."}}}},l={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},g={...l,name:"Select",args:{label:"Label text",supportingText:"Supporting text",innerHTML:`
...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(z=(A=g.parameters)==null?void 0:A.docs)==null?void 0:z.description}}};var T,O,q,D,I;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(q=(O=m.parameters)==null?void 0:O.docs)==null?void 0:q.source},description:{story:`The select component can have options, and grouping is also possible, with support for all native select attributes.
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...(R=($=h.parameters)==null?void 0:$.docs)==null?void 0:R.description}}};var N,G,H,B,j;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...
  \`
}`,...(ne=(oe=f.parameters)==null?void 0:oe.docs)==null?void 0:ne.source},description:{story:"Multiple\nThe `multiple` attribute can be set to allow multiple options to be selected on the native `<select>` element.",...(se=(ie=f.parameters)==null?void 0:ie.docs)==null?void 0:se.description}}};var le,ae,re,pe,de;y.parameters={...y.parameters,docs:{...(le=y.parameters)==null?void 0:le.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select Size',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(re=(ae=y.parameters)==null?void 0:ae.docs)==null?void 0:re.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(de=(pe=y.parameters)==null?void 0:pe.docs)==null?void 0:de.description}}};const pt=["select","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{v as Disabled,h as Lead,f as Multiple,m as Option,y as SelectSize,x as Size,b as Validation,pt as __namedExportsOrder,rt as default,g as select};
