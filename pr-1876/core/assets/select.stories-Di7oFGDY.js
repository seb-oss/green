...
`;var fe=Object.defineProperty,Se=Object.getOwnPropertyDescriptor,pe=e=>{throw TypeError(e)},a=(e,t,o,n)=>{for(var i=n>1?void 0:n?Se(t,o):t,d=e.length-1,c;d>=0;d--)(c=e[d])&&(i=(n?c(t,o,i):c(i))||i);return n&&i&&fe(t,o,i),i},Me=(e,t,o)=>t.has(e)||pe("Cannot "+o),Le=(e,t,o)=>t.has(e)?pe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),M=(e,t,o)=>(Me(e,t,"access private method"),o),u,de,ce,ue,ge;let s=class extends xe{constructor(){super(...arguments),Le(this,u),this.placeholder="",this.label="",this.supportingText="",this.size="large",this.disabled=!1,this.multiple=!1,this.fieldBaseElement=null,this.selectId=`select-${Math.random().toString(36).substring(2,11)}`}firstUpdated(){var n,i;const e=(n=this.shadowRoot)==null?void 0:n.querySelector("label#placeholder"),t=(i=this.shadowRoot)==null?void 0:i.querySelector("slot:not([name])");let o=null;t&&(o=t.assignedNodes({flatten:!0}).find(c=>c.nodeType===Node.ELEMENT_NODE&&c.nodeName==="SELECT"),o&&(o.id=this.selectId,o.setAttribute("aria-describedby","supporting-text"),o.setAttribute("aria-label",this.label),this.multiple=o.multiple,this.selectElementSize=o.size||void 0,this.addEventListener("click",()=>{o==null||o.focus()}))),e&&o&&t&&t.addEventListener("change",()=>{const d=o.selectedOptions[0];e.textContent=d.textContent})}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}getSelectElement(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot:not([name])");return e?e.assignedNodes({flatten:!0}).find(n=>n.nodeType===Node.ELEMENT_NODE&&n.nodeName==="SELECT"):null}render(){const e={multiple:this.multiple};return g`
      ...
      ></gds-form-control-footer>
    `}};u=new WeakSet;de=function(){return[M(this,u,ce).call(this),M(this,u,ue).call(this),M(this,u,ge).call(this)].map(t=>g`${t}`)};ce=function(){return g` <slot name="lead" slot="lead"></slot> `};ue=function(){return this.multiple?g` <slot></slot> `:g`
  ...
  `},x={...l,name:"Validation",render:()=>r`
    <gds-flex>
      ...
      <gds-select
        ...
        label="Label text"
        supporting-text="Supporting text"
        .validator=${{validate:e=>{if(e.value==="")return[{...e.validity,valid:!1,customError:!0},"Please select an option."]}}}
      >
        <span slot="extended-supporting-text"
          >Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua.
  ...
  `};var L,E,C,T,k;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(k=(T=m.parameters)==null?void 0:T.docs)==null?void 0:k.description}}};var w,z,A,D,I;h.parameters={...h.parameters,docs:{...(w=h.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(I=(D=h.parameters)==null?void 0:D.docs)==null?void 0:I.description}}};var q,N,P,_,O;b.parameters={...b.parameters,docs:{...(q=b.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...(O=(_=b.parameters)==null?void 0:_.docs)==null?void 0:O.description}}};var $,G,R,V,B;v.parameters={...v.parameters,docs:{...($=v.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
