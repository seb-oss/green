...
`;var we=Object.defineProperty,ke=Object.getOwnPropertyDescriptor,ge=e=>{throw TypeError(e)},S=(e,t,o,n)=>{for(var i=n>1?void 0:n?ke(t,o):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(i=(n?l(t,o,i):l(i))||i);return n&&i&&we(t,o,i),i},ze=(e,t,o)=>t.has(e)||ge("Cannot "+o),Ae=(e,t,o)=>t.has(e)?ge("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),f=(e,t,o)=>(ze(e,t,"access private method"),o),r,me,he,be,ve,xe;let p=class extends Ce{constructor(){super(),Ae(this,r),this.supportingText="",this.size="large",this.multiline=!1,this.selectedValue="",this.value=""}getInitialSelectValue(e){return e.multiple?Array.from(e.selectedOptions).map(o=>o.value).join(","):e.value}firstUpdated(){var o,n,i;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot:not([name])");if(e){const a=e.assignedNodes({flatten:!0}),l=(n=this.shadowRoot)==null?void 0:n.querySelector(".select-container");a.forEach(L=>{if(L.nodeType===Node.ELEMENT_NODE&&L.nodeName==="SELECT"){const C=L,M=this.getInitialSelectValue(C);l==null||l.appendChild(L),this.value=M,this.selectedValue=C.multiple?M.split(","):M}})}const t=((i=this.shadowRoot)==null?void 0:i.querySelector(".select-container select"))||null;t&&(this.multiline=t.multiple,t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),this.selectedValue=t.value,t.addEventListener("change",this.handleSelectChange.bind(this)),t.addEventListener("input",a=>a.stopPropagation()),t.value=this.value||"")}handleSelectChange(e){e.stopPropagation();const t=e.target,o=Array.from(t.selectedOptions).map(n=>n.value);this.selectedValue=this.multiline?o:o[0],this.value=this.multiline?o.join(","):this.selectedValue,this.checkValidity(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}render(){const e={multiple:this.multiline};return u`
      ...
      ></gds-form-control-footer>
    `}};r=new WeakSet;me=function(){return[f(this,r,he).call(this),f(this,r,ve).call(this),f(this,r,be).call(this),f(this,r,xe).call(this)].map(t=>u`${t}`)};he=function(){return u` <slot name="lead" slot="lead"></slot> `};be=function(){var e;if(!this.multiline){const t=Array.from(((e=this.getSelectElement())==null?void 0:e.selectedOptions)||[]).map(n=>n.text),o=this.multiline?t.join(", "):t.length>0?t[0]:"Select";return u` <label id="placeholder">${o}</label> `}};ve=function(){return u`
      <slot></slot>
  ...
  `};var E,w,k,z,A;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
    label: 'Label text',
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(O=(I=g.parameters)==null?void 0:I.docs)==null?void 0:O.description}}};var _,P,V,$,R;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(V=(P=m.parameters)==null?void 0:P.docs)==null?void 0:V.source},description:{story:`The lead icon is displayed to the left of the select field.
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...(R=($=m.parameters)==null?void 0:$.docs)==null?void 0:R.description}}};var N,G,H,B,j;h.parameters={...h.parameters,docs:{...(N=h.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...
  \`
}`,...(F=(W=b.parameters)==null?void 0:W.docs)==null?void 0:F.source},description:{story:"Select has built-in support for form validation.<br>The validation feature is built on top of the browsers native validation features, using `ElementInternals` and `Constraint Validation API`.\n\nValidation is configured by adding a validator to a form element.<br> A validator is an object that implements the `GdsValidator` interface:\n\n```html\n<gds-select invalid></gds-select>\n```\n**@property invalid** - Indicates that the select field contains an error.",...(U=(Q=b.parameters)==null?void 0:Q.docs)==null?void 0:U.description}}};var K,X,Y,Z,ee;v.parameters={...v.parameters,docs:{...(K=v.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(ne=(oe=x.parameters)==null?void 0:oe.docs)==null?void 0:ne.source},description:{story:"Multiple\nThe `multiple` attribute can be set to allow multiple options to be selected on the native `<select>` element.",...(se=(ie=x.parameters)==null?void 0:ie.docs)==null?void 0:se.description}}};var ae,le,re,pe,de;y.parameters={...y.parameters,docs:{...(ae=y.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select Size',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(re=(le=y.parameters)==null?void 0:le.docs)==null?void 0:re.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(de=(pe=y.parameters)==null?void 0:pe.docs)==null?void 0:de.description}}};const at=["select","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{h as Disabled,m as Lead,x as Multiple,g as Option,y as SelectSize,v as Size,b as Validation,at as __namedExportsOrder,st as default,c as select};
