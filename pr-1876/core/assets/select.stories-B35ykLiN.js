...
`;var Ce=Object.defineProperty,Ee=Object.getOwnPropertyDescriptor,de=e=>{throw TypeError(e)},S=(e,t,o,i)=>{for(var n=i>1?void 0:i?Ee(t,o):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,o,n):a(n))||n);return i&&n&&Ce(t,o,n),n},we=(e,t,o)=>t.has(e)||de("Cannot "+o),Te=(e,t,o)=>t.has(e)?de("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),f=(e,t,o)=>(we(e,t,"access private method"),o),r,ue,ge,me,he,be;let p=class extends Me{constructor(){super(),Te(this,r),this.supportingText="",this.size="large",this.multiline=!1,this.selectedValue="",this.value=""}firstUpdated(){var o,i,n;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot:not([name])");if(e){const s=e.assignedNodes({flatten:!0}),a=(i=this.shadowRoot)==null?void 0:i.querySelector(".select-container");s.forEach(M=>{M.nodeType===Node.ELEMENT_NODE&&M.nodeName==="SELECT"&&(a==null||a.appendChild(M))})}const t=((n=this.shadowRoot)==null?void 0:n.querySelector(".select-container select"))||null;t&&(this.multiline=t.multiple,t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),this.selectedValue=t.value,t.addEventListener("change",()=>{const s=Array.from(t.selectedOptions).map(a=>a.value);this.selectedValue=this.multiline?s:s[0],this.value=this.multiline?s.join(","):this.selectedValue,this.checkValidity()}),t.value=this.value||"")}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}render(){const e={multiple:this.multiline};return d`
      ...
      ></gds-form-control-footer>
    `}};r=new WeakSet;ue=function(){return[f(this,r,ge).call(this),f(this,r,he).call(this),f(this,r,me).call(this),f(this,r,be).call(this)].map(t=>d`${t}`)};ge=function(){return d` <slot name="lead" slot="lead"></slot> `};me=function(){var e;if(!this.multiline){const t=Array.from(((e=this.getSelectElement())==null?void 0:e.selectedOptions)||[]).map(i=>i.text),o=this.multiline?t.join(", "):t.length>0?t[0]:"Select";return d` <label id="placeholder">${o}</label> `}};he=function(){return d`
      <slot></slot>
      <div class="select-container"></div>
    `};be=function(){if(!this.multiline)return d`
        <gds-button
          tabindex="-1"
          size="small"
          rank="tertiary"
      ...
      `};p.styles=[Se,Le];S([pe({attribute:"supporting-text"})],p.prototype,"supportingText",2);S([pe({type:String})],p.prototype,"size",2);S([ce()],p.prototype,"multiline",2);S([ce()],p.prototype,"selectedValue",2);p=S([ye("gds-select"),xe()],p);const nt={title:"Components/Select",component:"gds-select",tags:["autodocs"],parameters:{docs:{description:{component:"The `Select` story demonstrates a default selection component with a placeholder and supporting text.\n<br>The component can be customized with a label, supporting text, and additional content."}}}},l={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},u={...l,name:"Select",args:{placeholder:"Science Themes",label:"Label text",supportingText:"Supporting text",innerHTML:`
  ...
  `};var L,C,E,w,T;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(T=(w=u.parameters)==null?void 0:w.docs)==null?void 0:T.description}}};var k,A,z,D,q;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(z=(A=g.parameters)==null?void 0:A.docs)==null?void 0:z.source},description:{story:`The select component can have options, and grouping is also possible, with support for all native select attributes.
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(q=(D=g.parameters)==null?void 0:D.docs)==null?void 0:q.description}}};var I,_,O,P,$;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...($=(P=m.parameters)==null?void 0:P.docs)==null?void 0:$.description}}};var V,R,G,N,H;h.parameters={...h.parameters,docs:{...(V=h.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(G=(R=h.parameters)==null?void 0:R.docs)==null?void 0:G.source},description:{story:"The `disabled` property can be set to disable the `gds-select` field.\n<br> e.g\n\n```html\n<gds-select disabled> ... </gds-select>\n```",...(H=(N=h.parameters)==null?void 0:N.docs)==null?void 0:H.description}}};var B,j,F,J,W;b.parameters={...b.parameters,docs:{...(B=b.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Validation',
  render: () => html\`
    <gds-flex>
