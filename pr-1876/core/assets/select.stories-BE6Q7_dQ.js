...
`;var Ae=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,ge=e=>{throw TypeError(e)},c=(e,t,o,n)=>{for(var i=n>1?void 0:n?ze(t,o):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(i=(n?r(t,o,i):r(i))||i);return n&&i&&Ae(t,o,i),i},Te=(e,t,o)=>t.has(e)||ge("Cannot "+o),Oe=(e,t,o)=>t.has(e)?ge("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),S=(e,t,o)=>(Te(e,t,"access private method"),o),p,me,he,ve,be,xe;let s=class extends we{constructor(){super(),Oe(this,p),this.supportingText="",this.size="large",this.multiline=!1,this.selectedValue="",this.value=""}getInitialSelectValue(e){return e.multiple?Array.from(e.selectedOptions).map(o=>o.value).join(","):e.value}firstUpdated(){var o,n,i;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot:not([name])");if(e){const a=e.assignedNodes({flatten:!0}),r=(n=this.shadowRoot)==null?void 0:n.querySelector(".select-container");a.forEach(E=>{if(E.nodeType===Node.ELEMENT_NODE&&E.nodeName==="SELECT"){const L=E;this.multiline=L.multiple,r==null||r.appendChild(E);const M=Array.from(L.selectedOptions).map(fe=>fe.value);this.multiline?(this.selectedValue=M,this.value=M.join(",")):(this.selectedValue=M.slice(0,1),this.value=M[0]||"")}})}const t=((i=this.shadowRoot)==null?void 0:i.querySelector(".select-container select"))||null;t&&(t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),t.addEventListener("change",this.handleSelectChange.bind(this)),t.addEventListener("input",a=>a.stopPropagation()))}willUpdate(e){if(super.willUpdate(e),e.has("value")){const t=this.getSelectElement();if(t&&t.multiple){const o=this.value?this.value.split(","):[];Array.from(t.options).forEach(n=>{n.selected=o.includes(n.value)}),this.selectedValue=o}else t&&(t.value=this.value||"",this.selectedValue=this.value?[this.value]:[])}}handleSelectChange(e){e.stopPropagation();const t=e.target,o=Array.from(t.selectedOptions).map(n=>n.value).filter(n=>n!=="");this.multiline?(this.selectedValue=o,this.value=o.length>0?o.join(","):""):(this.selectedValue=[o[0]],this.value=o[0]),this.checkValidity(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}formResetCallback(){const e=this.getSelectElement();if(e)if(e.multiple)Array.from(e.options).forEach(t=>{t.selected=!1}),this.selectedValue=[],this.value="";else{const t=e.options[0];t&&(this.value=t.value,e.value=t.value,this.selectedValue=[t.value])}}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}render(){const e={multiple:this.multiline};return u`
      ...
      ></gds-form-control-footer>
    `}};p=new WeakSet;me=function(){return[S(this,p,he).call(this),S(this,p,be).call(this),S(this,p,ve).call(this),S(this,p,xe).call(this)].map(t=>u`${t}`)};he=function(){return u` <slot name="lead" slot="lead"></slot> `};ve=function(){if(!this.multiline){const e=this.getSelectElement();let t=this.value;if(e){const o=Array.from(e.selectedOptions);o.length>0&&(t=o[0].text)}return u`<label id="placeholder">${t}</label>`}};be=function(){return u`
      <slot></slot>
      <div class="select-container"></div>
    `};xe=function(){if(!this.multiline)return u`
        <gds-button
          tabindex="-1"
          size="small"
          rank="tertiary"
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...(R=($=h.parameters)==null?void 0:$.docs)==null?void 0:R.description}}};var N,G,H,B,j;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...
  \`
}`,...(re=(ae=y.parameters)==null?void 0:ae.docs)==null?void 0:re.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(de=(pe=y.parameters)==null?void 0:pe.docs)==null?void 0:de.description}}};const rt=["select","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{v as Disabled,h as Lead,f as Multiple,m as Option,y as SelectSize,x as Size,b as Validation,rt as __namedExportsOrder,at as default,g as select};
