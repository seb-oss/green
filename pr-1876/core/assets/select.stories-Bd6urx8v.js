...
`;var fe=Object.defineProperty,Se=Object.getOwnPropertyDescriptor,re=e=>{throw TypeError(e)},s=(e,t,o,l)=>{for(var n=l>1?void 0:l?Se(t,o):t,d=e.length-1,c;d>=0;d--)(c=e[d])&&(n=(l?c(t,o,n):c(n))||n);return l&&n&&fe(t,o,n),n},Me=(e,t,o)=>t.has(e)||re("Cannot "+o),Le=(e,t,o)=>t.has(e)?re("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),M=(e,t,o)=>(Me(e,t,"access private method"),o),u,de,ce,ue,ge;let i=class extends xe{constructor(){super(...arguments),Le(this,u),this.placeholder="",this.label="",this.supportingText="",this.size="large",this.disabled=!1,this.multiple=!1,this.selectId=`select-${Math.random().toString(36).substring(2,11)}`}firstUpdated(){var l,n;const e=(l=this.shadowRoot)==null?void 0:l.querySelector("label#placeholder"),t=(n=this.shadowRoot)==null?void 0:n.querySelector("slot:not([name])");let o=null;t&&(o=t.assignedNodes({flatten:!0}).find(c=>c.nodeType===Node.ELEMENT_NODE&&c.nodeName==="SELECT"),o&&(o.id=this.selectId,o.setAttribute("aria-describedby","supporting-text"),o.setAttribute("aria-label",this.label),this.multiple=o.multiple,this.selectElementSize=o.size||void 0)),e&&o&&t&&t.addEventListener("change",()=>{const d=o.selectedOptions[0];e.textContent=d.textContent})}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}render(){const e={multiple:this.multiple};return g`
    ...
    `}};u=new WeakSet;de=function(){return[M(this,u,ce).call(this),M(this,u,ue).call(this),M(this,u,ge).call(this)].map(t=>g`${t}`)};ce=function(){return g` <slot name="lead" slot="lead"></slot> `};ue=function(){return this.multiple?g` <slot></slot> `:g`
      ...
      `};i.styles=[ye];s([r()],i.prototype,"placeholder",2);s([r()],i.prototype,"label",2);s([r({attribute:"supporting-text"})],i.prototype,"supportingText",2);s([r({type:String})],i.prototype,"size",2);s([r({attribute:"disabled",type:Boolean,reflect:!0})],i.prototype,"disabled",2);s([r({type:Boolean})],i.prototype,"multiple",2);s([r({type:Number})],i.prototype,"selectElementSize",2);i=s([be("gds-select"),he()],i);const Ye={title:"Components/Select",component:"gds-select",tags:["autodocs"],parameters:{docs:{description:{component:"The `Select` story demonstrates a default selection component with a placeholder and supporting text.\n<br>The component can be customized with a label, supporting text, and additional content."}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},m={...a,name:"Select",args:{placeholder:"Science Themes",label:"Label text",supportingText:"Supporting text",innerHTML:`
  ...
  `};var L,C,E,T,z;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
...
}`,...(E=(C=m.parameters)==null?void 0:C.docs)==null?void 0:E.source},description:{story:`### Parameters
...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(z=(T=m.parameters)==null?void 0:T.docs)==null?void 0:z.description}}};var k,w,A,D,I;h.parameters={...h.parameters,docs:{...(k=h.parameters)==null?void 0:k.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(A=(w=h.parameters)==null?void 0:w.docs)==null?void 0:A.source},description:{story:`The select component can have options, and grouping is also possible, with support for all native select attributes.
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(I=(D=h.parameters)==null?void 0:D.docs)==null?void 0:I.description}}};var q,P,_,O,$;b.parameters={...b.parameters,docs:{...(q=b.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(_=(P=b.parameters)==null?void 0:P.docs)==null?void 0:_.source},description:{story:`The lead icon is displayed to the left of the select field.
<br>It can be used to provide additional context or to visually represent the select field's purpose.
<br>It can be set by adding an icon component to the 'lead' slot.`,...($=(O=b.parameters)==null?void 0:O.docs)==null?void 0:$.description}}};var N,G,R,V,H;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(te=(ee=f.parameters)==null?void 0:ee.docs)==null?void 0:te.source},description:{story:"Multiple\nThe `multiple` attribute can be set to allow multiple options to be selected on the native `<select>` element.",...(ne=(oe=f.parameters)==null?void 0:oe.docs)==null?void 0:ne.description}}};var ie,se,ae,le,pe;S.parameters={...S.parameters,docs:{...(ie=S.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select Size',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(ae=(se=S.parameters)==null?void 0:se.docs)==null?void 0:ae.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(pe=(le=S.parameters)==null?void 0:le.docs)==null?void 0:pe.description}}};const Ze=["select","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{v as Disabled,b as Lead,f as Multiple,h as Option,S as SelectSize,y as Size,x as Validation,Ze as __namedExportsOrder,Ye as default,m as select};
