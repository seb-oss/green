...
`;var ke=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,ge=e=>{throw TypeError(e)},c=(e,t,o,i)=>{for(var n=i>1?void 0:i?ze(t,o):t,l=e.length-1,r;l>=0;l--)(r=e[l])&&(n=(i?r(t,o,n):r(n))||n);return i&&n&&ke(t,o,n),n},Ae=(e,t,o)=>t.has(e)||ge("Cannot "+o),Te=(e,t,o)=>t.has(e)?ge("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),S=(e,t,o)=>(Ae(e,t,"access private method"),o),p,me,he,ve,be,xe;let s=class extends Ce{constructor(){super(),Te(this,p),this.supportingText="",this.size="large",this.multiline=!1,this.selectedValue="",this.value=""}getInitialSelectValue(e){return e.multiple?Array.from(e.selectedOptions).map(o=>o.value).join(","):e.value}firstUpdated(){var o,i,n;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot:not([name])");if(e){const l=e.assignedNodes({flatten:!0}),r=(i=this.shadowRoot)==null?void 0:i.querySelector(".select-container");l.forEach(M=>{if(M.nodeType===Node.ELEMENT_NODE&&M.nodeName==="SELECT"){const E=M,L=this.getInitialSelectValue(E);r==null||r.appendChild(M),this.value=L,this.selectedValue=E.multiple?L.split(","):L}})}const t=((n=this.shadowRoot)==null?void 0:n.querySelector(".select-container select"))||null;t&&(this.multiline=t.multiple,t.setAttribute("aria-describedby","supporting-text"),t.setAttribute("aria-label",this.label),this.selectedValue=t.value,t.addEventListener("change",this.handleSelectChange.bind(this)),t.addEventListener("input",l=>l.stopPropagation()),t.value=this.value||"")}willUpdate(e){if(super.willUpdate(e),e.has("value")){const t=this.value,o=this.getSelectElement();o&&o.value!==t&&(o.value=t||"",this.selectedValue=o.multiple?(t==null?void 0:t.split(","))||[]:t||"")}}handleSelectChange(e){e.stopPropagation();const t=e.target,o=Array.from(t.selectedOptions).map(i=>i.value);this.selectedValue=this.multiline?o:o[0],this.value=this.multiline?o.join(","):this.selectedValue,this.checkValidity(),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}formResetCallback(){const e=this.getSelectElement();if(e){const t=e.options[0];t&&(this.value=t.value,e.value=t.value,this.selectedValue=e.multiple?[t.value]:t.value)}}getSelectElement(){var e;return((e=this.shadowRoot)==null?void 0:e.querySelector(".select-container select"))??null}_getValidityAnchor(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("SELECT")}render(){const e={multiple:this.multiline};return d`
  ...
  `};var C,w,k,z,A;g.parameters={...g.parameters,docs:{...(C=g.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
    label: 'Label text',
...
- Multiple option groups (e.g., Physics, Chemistry, Biology) with specific options.`,...(A=(z=g.parameters)==null?void 0:z.docs)==null?void 0:A.description}}};var T,q,D,I,O;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Option',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(D=(q=m.parameters)==null?void 0:q.docs)==null?void 0:D.source},description:{story:`The select component can have options, and grouping is also possible, with support for all native select attributes.
...
\`\`\`
> In web components using Shadow DOM, options cannot be placed directly within a slot of a custom element. The native \`select\` element requires its options to be part of its own DOM structure . If placed in a slot, options will not render due to Shadow DOM encapsulation.`,...(O=(I=m.parameters)==null?void 0:I.docs)==null?void 0:O.description}}};var V,_,P,$,R;h.parameters={...h.parameters,docs:{...(V=h.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lead Icon',
  render: () => html\`
    <gds-flex>
...
<br>It can be set by adding an icon component to the 'lead' slot.`,...(R=($=h.parameters)==null?void 0:$.docs)==null?void 0:R.description}}};var N,G,H,B,j;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...
  \`
}`,...(ne=(oe=f.parameters)==null?void 0:oe.docs)==null?void 0:ne.source},description:{story:"Multiple\nThe `multiple` attribute can be set to allow multiple options to be selected on the native `<select>` element.",...(se=(ie=f.parameters)==null?void 0:ie.docs)==null?void 0:se.description}}};var ae,le,re,pe,ue;y.parameters={...y.parameters,docs:{...(ae=y.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select Size',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(re=(le=y.parameters)==null?void 0:le.docs)==null?void 0:re.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(ue=(pe=y.parameters)==null?void 0:pe.docs)==null?void 0:ue.description}}};const lt=["select","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{v as Disabled,h as Lead,f as Multiple,m as Option,y as SelectSize,x as Size,b as Validation,lt as __namedExportsOrder,at as default,g as select};
