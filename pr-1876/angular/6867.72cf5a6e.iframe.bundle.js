...
`,GdsDropdown=class extends _chunk_V56VPSWH_js__WEBPACK_IMPORTED_MODULE_0__.S{constructor(){super(...arguments),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_handleSelectionChange),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_registerAutoCloseListener),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_unregisterAutoCloseListener),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(a,b)=>a===b,this.searchFilter=(q,o)=>o.innerHTML.toLowerCase().includes(q.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_optionElements,void 0),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_calcMaxHeight,(trigger=>{const triggerRect=trigger.getBoundingClientRect(),bottomSpace=window.innerHeight-triggerRect.bottom,topSpace=triggerRect.top;let height=Math.min(topSpace,this.maxHeight);return bottomSpace>topSpace&&(height=Math.min(bottomSpace,this.maxHeight)),height-16+"px"})),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_handleSearchFieldInput,(e=>{if(!e.currentTarget)return;e.stopPropagation();const input=e.currentTarget;if(this.options.forEach((o=>o.hidden=!1)),!input.value)return;this.options.filter((o=>!this.searchFilter(input.value,o))).forEach((o=>o.hidden=!0))})),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_handleSearchFieldKeyDown,(e=>{var _a;null==(_a=this._elListbox)||_a.then((listbox=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void listbox.focus()}))})),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_handleListboxKeyDown,(e=>{var _a;if("Tab"===e.key&&this.searchable)return e.preventDefault(),void(null==(_a=this._elSearchInput)||_a.focus())})),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_handleOptionFocusChange,(e=>{const triggerButton=this._elTriggerBtn;triggerButton&&(triggerButton.ariaActiveDescendantElement=e.target)})),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_blurCloseListener,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)})),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_tabCloseListener,(e=>{var _a;"Tab"!==e.key||this.searchable||(e.preventDefault(),this.open=!1,null==(_a=this._elTriggerBtn)||_a.focus())}))}get type(){return"gds-dropdown"}get options(){return(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.S7)(this,_optionElements)?Array.from((0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.S7)(this,_optionElements)).filter((o=>!o.hasAttribute("isplaceholder"))):[]}get placeholder(){if((0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.S7)(this,_optionElements))return Array.from((0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.S7)(this,_optionElements)).find((o=>o.hasAttribute("isplaceholder")))}get displayValue(){var _a,_b;let displayValue;return displayValue=Array.isArray(this.value)?this.value.length>2?(0,_lit_localize__WEBPACK_IMPORTED_MODULE_5__.ab)(_lit_localize__WEBPACK_IMPORTED_MODULE_5__.gx`${this.value.length} selected`):this.value.reduce(((acc,cur)=>{var _a2;return acc+(null==(_a2=this.options.find((v=>v.value===cur)))?void 0:_a2.innerHTML)+", "}),"").slice(0,-2):null==(_a=this.options.find((v=>v.selected)))?void 0:_a.innerHTML,displayValue||(null==(_b=this.placeholder)?void 0:_b.innerHTML)||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){var _a;return null==(_a=this.shadowRoot)?void 0:_a.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange()}))}render(){return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`
      ...
      >
        ...
        ${(0,lit_directives_when_js__WEBPACK_IMPORTED_MODULE_10__.z)(this.searchable,(()=>_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`<input
              id="searchinput"
              type="text"
      ...
      ${(0,lit_directives_when_js__WEBPACK_IMPORTED_MODULE_10__.z)(!this.hideLabel,(()=>_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`
          <gds-form-control-footer class="size-${this.size}">
            ${(0,lit_directives_when_js__WEBPACK_IMPORTED_MODULE_10__.z)(this.invalid,(()=>_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`
...
`,GdsFieldBase=class extends _chunk_LQSWYCMZ_js__WEBPACK_IMPORTED_MODULE_2__.j{constructor(){super(),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_renderFieldContents),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_renderSlotLead),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_renderSlotMain),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_renderSlotAction),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_renderSlotTrail),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.VK)(this,_handleSlotChange,((slotName,event)=>{const assignedNodes=event.target.assignedNodes({flatten:!0}),slotOccupied=assignedNodes.length>0&&assignedNodes.some((node=>{var _a;return node.nodeType===Node.ELEMENT_NODE||node.nodeType===Node.TEXT_NODE&&""!==(null==(_a=node.textContent)?void 0:_a.trim())}));"lead"===slotName?this._leadSlotOccupied=slotOccupied:"trail"===slotName?this._trailSlotOccupied=slotOccupied:"action"===slotName&&(this._actionSlotOccupied=slotOccupied)}))}connectedCallback(){super.connectedCallback(),_chunk_GUOAHGEV_js__WEBPACK_IMPORTED_MODULE_0__.nD.instance.apply(this,"gds-field-base")}render(){var _a;const classes={invalid:null!=(_a=this.invalid)&&_a,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:"small"===this.size};return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`
    ...
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};_handleSlotChange=new WeakMap,_renderFieldContents=new WeakSet,renderFieldContents_fn=function(){const elements=[(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.jq)(this,_renderSlotLead,renderSlotLead_fn).call(this),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.jq)(this,_renderSlotMain,renderSlotMain_fn).call(this),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.jq)(this,_renderSlotAction,renderSlotAction_fn).call(this),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.jq)(this,_renderSlotTrail,renderSlotTrail_fn).call(this)];return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`${(0,lit_directives_map_js__WEBPACK_IMPORTED_MODULE_9__.T)(elements,(el=>el))}
      ...
      </div>  --> `},_renderSlotLead=new WeakSet,renderSlotLead_fn=function(){return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy` <slot
      name="lead"
      @slotchange=${e=>(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.S7)(this,_handleSlotChange).call(this,"lead",e)}
    ></slot>`},_renderSlotMain=new WeakSet,renderSlotMain_fn=function(){return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`<div
    ...
    `;return isMultiple||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_5__.qy`<div>${(0,lit_directives_when_js__WEBPACK_IMPORTED_MODULE_9__.z)(isMultiple,(()=>checkbox))} <slot></slot></div>`}};_hidden=new WeakMap,_emitSelect=new WeakSet,emitSelect_fn=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))},GdsOption.styles=[_chunk_ZAPYKJQN_js__WEBPACK_IMPORTED_MODULE_3__.LU,_chunk_ZRKILGXZ_js__WEBPACK_IMPORTED_MODULE_0__.l],(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_6__.Cc)([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_7__.MZ)()],GdsOption.prototype,"value",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_6__.Cc)([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_7__.MZ)({attribute:"aria-hidden",reflect:!0})],GdsOption.prototype,"hidden",1),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_6__.Cc)([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_7__.MZ)({attribute:"aria-selected",reflect:!0})],GdsOption.prototype,"selected",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_6__.Cc)([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_7__.MZ)({type:Boolean,reflect:!0})],GdsOption.prototype,"isPlaceholder",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_6__.Cc)([(0,_chunk_TYGMNHNO_js__WEBPACK_IMPORTED_MODULE_2__.w)("isplaceholder")],GdsOption.prototype,"_handlePlaceholderStatusChange",1),GdsOption=(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_6__.Cc)([(0,_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_5__.Y$)("gds-option")],GdsOption)},"./dist/libs/core/src/chunks/chunk.7QFY757K.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{var _renderLeadSlot,renderLeadSlot_fn,_renderMainSlot,renderMainSlot_fn,_handleSlotChange,handleSlotChange_fn,_renderTrailSlot,renderTrailSlot_fn,_chunk_ZAPYKJQN_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./dist/libs/core/src/chunks/chunk.ZAPYKJQN.js"),_chunk_LQSWYCMZ_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./dist/libs/core/src/chunks/chunk.LQSWYCMZ.js"),_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./dist/libs/core/src/chunks/chunk.MLXMQIEV.js"),_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("./dist/libs/core/src/chunks/chunk.SEHSDSX2.js"),lit_decorators_js__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__("./node_modules/lit/decorators.js"),badge_style_default=__webpack_require__("./node_modules/lit/index.js").AH`
  :host {
...
`,GdsFormControlFooter=class extends _chunk_LQSWYCMZ_js__WEBPACK_IMPORTED_MODULE_0__.j{constructor(){super(...arguments),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_2__.VK)(this,_renderRemainingCharsBadge)}render(){return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_1__.qy`<div aria-live="polite">
      <div class="error-message">
        <slot name="message"
          >${(0,lit_directives_when_js__WEBPACK_IMPORTED_MODULE_5__.z)(this.validationMessage,(()=>_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_1__.qy`
              <gds-icon-triangle-exclamation
                solid
              ></gds-icon-triangle-exclamation>
...
`,GdsFormControlHeader=class extends _chunk_LQSWYCMZ_js__WEBPACK_IMPORTED_MODULE_0__.j{constructor(){super(...arguments),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_2__.VK)(this,_handleExtSupTxtSlotChange),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_2__.VK)(this,_renderExtSupTxt),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_2__.VK)(this,_renderExtSupTxtButton,(()=>_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_1__.qy`
      <gds-button
        size="small"
        rank="tertiary"
...
`,GdsContainer=class extends _chunk_LQSWYCMZ_js__WEBPACK_IMPORTED_MODULE_2__.j{constructor(){super(...arguments),this.display="block",this.level="2"}render(){return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`<slot></slot>`}};GdsContainer.styles=[_chunk_ZAPYKJQN_js__WEBPACK_IMPORTED_MODULE_1__.LU,container_style_default],(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"display",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_5__.MZ)()],GdsContainer.prototype,"level",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"place-items",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"place-content",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:function(v){const[colorInput,transparency]=v.split("/");return((color,transparency2)=>(color=>{const trimmedColor=color.trim();return trimmedColor.startsWith("#")||trimmedColor.startsWith("rgb(")||trimmedColor.startsWith("rgba(")||trimmedColor.startsWith("hsl(")||trimmedColor.startsWith("hsla(")})(color)?transparency2?`color-mix(in srgb, ${color} ${100*parseFloat(transparency2)}%, transparent 0%)`:color:`var(--gds-color-l${this.level}-content-${color})`)(colorInput,transparency)}})],GdsContainer.prototype,"color",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:function(v){const[colorInput,transparency]=v.split("/");return((color,transparency2)=>(color=>{const trimmedColor=color.trim();return trimmedColor.startsWith("#")||trimmedColor.startsWith("rgb(")||trimmedColor.startsWith("rgba(")||trimmedColor.startsWith("hsl(")||trimmedColor.startsWith("hsla(")})(color)?transparency2?`color-mix(in srgb, ${color} ${100*parseFloat(transparency2)}%, transparent 0%)`:color:((level,color)=>`var(--gds-color-l${level}-background-${color})`)(this.level,color))(colorInput,transparency)}})],GdsContainer.prototype,"background",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:function(v){const[size,color]=v.split("/");return`var(--gds-space-${size}) solid ${color?(color2=>(color2=>{const trimmedColor=color2.trim();return trimmedColor.startsWith("#")||trimmedColor.startsWith("rgb(")||trimmedColor.startsWith("rgba(")||trimmedColor.startsWith("hsl(")||trimmedColor.startsWith("hsla(")})(color2)?color2:((level,color2)=>`var(--gds-color-l${level}-border-${color2})`)(this.level,color2))(color):"currentColor"}`},styleTemplate:(_prop,values)=>{const top=values[0];return`\n        border-top: ${top};\n        border-right: ${values.length>1?values[1]:top};\n        border-bottom: ${values.length>2?values[2]:top};\n        border-left: ${values.length>3?values[3]:top};\n      `}})],GdsContainer.prototype,"border",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:function(v){const[color]=v.split("/");return color?(color2=>(color2=>{const trimmedColor=color2.trim();return trimmedColor.startsWith("#")||trimmedColor.startsWith("rgb(")||trimmedColor.startsWith("rgba(")||trimmedColor.startsWith("hsl(")||trimmedColor.startsWith("hsla(")})(color2)?color2:((level,color2)=>`var(--gds-color-l${level}-border-${color2})`)(this.level,color2))(color):"currentColor"},styleTemplate:(_prop,values)=>{const top=values[0];return`\n        border-top-color: ${top};\n        border-right-color: ${values.length>1?values[1]:top};\n        border-bottom-color: ${values.length>2?values[2]:top};\n        border-left-color: ${values.length>3?values[3]:top};\n      `}})],GdsContainer.prototype,"border-color",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({styleTemplate:(_prop,values)=>{const top=values[0];return`\n        border-top-width: ${top};\n        border-right-width: ${values.length>1?values[1]:top};\n        border-bottom-width: ${values.length>2?values[2]:top};\n        border-left-width: ${values.length>3?values[3]:top};\n        border-style: solid;\n      `}})],GdsContainer.prototype,"border-width",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>`var(--gds-space-${v})`})],GdsContainer.prototype,"border-radius",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"opacity",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)()],GdsContainer.prototype,"padding",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)()],GdsContainer.prototype,"padding-inline",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)()],GdsContainer.prototype,"padding-block",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>{const val="pos"==(v.startsWith("-")?"neg":"pos")?`var(--gds-space-${v})`:`calc(var(--gds-space-${v.substring(1)}) * -1)`;return"auto"===v?"auto":val},styleTemplate:(_prop,values)=>{const transformValue=v=>"auto"===v?"auto":`${v}`,top=transformValue(values[0]),right=values.length>1?transformValue(values[1]):top;return`margin: ${top} ${right} ${values.length>2?transformValue(values[2]):top} ${values.length>3?transformValue(values[3]):right};`}})],GdsContainer.prototype,"margin",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"position",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"inset",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"overflow",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"height",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"max-height",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"min-height",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)()],GdsContainer.prototype,"block-size",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)()],GdsContainer.prototype,"min-block-size",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"width",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"max-width",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"min-width",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)()],GdsContainer.prototype,"inline-size",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"box-sizing",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"cursor",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"pointer-events",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"user-select",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"z-index",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"transform",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"transform-style",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"transition",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"transition-behavior",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>v})],GdsContainer.prototype,"animation",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>`${v}`,styleTemplate:(prop,values)=>{const size=values[0];return`font-size: var(--gds-text-size-${size});`+`line-height: var(--gds-text-line-height-${size});`}})],GdsContainer.prototype,"font-size",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({property:"font-weight",valueTemplate:v=>`var(--gds-text-weight-${v})`})],GdsContainer.prototype,"font-weight",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>`${v}`})],GdsContainer.prototype,"grid-column",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>`${v}`})],GdsContainer.prototype,"grid-row",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_0__.F)({valueTemplate:v=>`${v}`})],GdsContainer.prototype,"flex",2),GdsContainer=(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.Y$)("gds-container")],GdsContainer)},"./dist/libs/core/src/chunks/chunk.VI5RE5WM.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{var _chunk_UKO22ZVQ_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./dist/libs/core/src/chunks/chunk.UKO22ZVQ.js"),_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./dist/libs/core/src/chunks/chunk.H2KG3F2S.js"),_chunk_ZAPYKJQN_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./dist/libs/core/src/chunks/chunk.ZAPYKJQN.js"),_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("./dist/libs/core/src/chunks/chunk.MLXMQIEV.js"),_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__("./dist/libs/core/src/chunks/chunk.SEHSDSX2.js"),flex_styles_default=__webpack_require__("./node_modules/lit/index.js").AH`
  :host {
    box-sizing: border-box;
  }
`,GdsFlex=class extends _chunk_UKO22ZVQ_js__WEBPACK_IMPORTED_MODULE_0__.i{connectedCallback(){super.connectedCallback(),this.display="flex"}render(){return _chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.qy`<slot></slot>`}};GdsFlex.styles=[_chunk_ZAPYKJQN_js__WEBPACK_IMPORTED_MODULE_2__.LU,flex_styles_default],(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({styleTemplate:(_prop,values)=>{const colGap=values[0];return`gap: ${colGap} ${values[1]||colGap};`},cacheOverrideKey:"flex"})],GdsFlex.prototype,"gap",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"flex",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"align-self",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"align-items",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"align-content",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"justify-content",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"place-content",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"justify-items",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({valueTemplate:v=>v})],GdsFlex.prototype,"justify-self",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({property:"flex-direction",valueTemplate:v=>v})],GdsFlex.prototype,"flex-direction",2),(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_H2KG3F2S_js__WEBPACK_IMPORTED_MODULE_1__.F)({property:"flex-wrap",valueTemplate:v=>v})],GdsFlex.prototype,"flex-wrap",2),GdsFlex=(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_4__.Cc)([(0,_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_3__.Y$)("gds-flex")],GdsFlex)},"./dist/libs/core/src/chunks/chunk.WTSBCGGH.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{var _chunk_K6WND5FJ_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./dist/libs/core/src/chunks/chunk.K6WND5FJ.js"),_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./dist/libs/core/src/chunks/chunk.MLXMQIEV.js"),_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./dist/libs/core/src/chunks/chunk.SEHSDSX2.js"),IconChevronBottom=class extends _chunk_K6WND5FJ_js__WEBPACK_IMPORTED_MODULE_0__.M{};IconChevronBottom._regularSVG='<path d="M20 9L12 17L4 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',IconChevronBottom._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3.46967 8.46967C3.76256 8.17678 4.23744 8.17678 4.53033 8.46967L12 15.9393L19.4697 8.46967C19.7626 8.17678 20.2374 8.17678 20.5303 8.46967C20.8232 8.76256 20.8232 9.23744 20.5303 9.53033L12.5303 17.5303C12.3897 17.671 12.1989 17.75 12 17.75C11.8011 17.75 11.6103 17.671 11.4697 17.5303L3.46967 9.53033C3.17678 9.23744 3.17678 8.76256 3.46967 8.46967Z" fill="currentColor"/>',IconChevronBottom._name="chevron-bottom",IconChevronBottom=(0,_chunk_SEHSDSX2_js__WEBPACK_IMPORTED_MODULE_2__.Cc)([(0,_chunk_MLXMQIEV_js__WEBPACK_IMPORTED_MODULE_1__.Y$)("gds-icon-chevron-bottom")],IconChevronBottom)}}]);
//# sourceMappingURL=6867.72cf5a6e.iframe.bundle.js.map