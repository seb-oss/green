import{m as M}from"./runtime-CMQcyTl6.js";import{l as O}from"./localized-decorator-B8fm5KIw.js";import{n as l,r as A,g as I,h as c}from"./custom-element-scoping-b4lD3laR.js";import{a as W}from"./query-p8xgzTDt.js";import{r as G}from"./query-async-MEroNOeJ.js";import{r as B}from"./form-control-footer-CpU6jekn.js";import{i as D,E as y}from"./lit-element-C_s9q329.js";import{t as F}from"./tokens.style-B6Zq2CtY.js";import{a as P,f as L}from"./button-JbY0W8yK.js";import"./cross-small-CgIxxlLH.js";import"./flex-DnAdyWkx.js";const R=D`
...
`;var X=Object.defineProperty,q=Object.getOwnPropertyDescriptor,_=e=>{throw TypeError(e)},a=(e,t,s,o)=>{for(var r=o>1?void 0:o?q(t,s):t,u=e.length-1,g;u>=0;u--)(g=e[u])&&(r=(o?g(t,s,r):g(r))||r);return o&&r&&X(t,s,r),r},$=(e,t,s)=>t.has(e)||_("Cannot "+s),p=(e,t,s)=>($(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?_("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),d=(e,t,s)=>($(e,t,"access private method"),s),n,z,E,v,m,f,b,x,w,k,C,S,T,N;let i=class extends P{constructor(){super(),h(this,n),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",this.trailSlotOccupied=!1,h(this,v,e=>["type","placeholder","required"].includes(e.name)),h(this,m,e=>{const t=e.target;this.value=t.value}),h(this,f,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),h(this,b,()=>{this.elInputAsync.then(e=>e.focus())}),h(this,x,()=>{this.value="",this.dispatchEvent(new Event("gds-input-cleared",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))})}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return c`${B(this.variant,[["default",()=>d(this,n,z).call(this)],["floating-label",()=>d(this,n,E).call(this)]])}`}_getValidityAnchor(){return this.elInput}};n=new WeakSet;z=function(){var e;return c`
      ...
      <gds-form-control-footer
        ...
        .charCounter=${p(this,n,N)&&this.maxlength-(((e=this.value)==null?void 0:e.length)||0)}
    ...
    `};C=function(e){const s=e.target.assignedNodes({flatten:!0});this.trailSlotOccupied=s.length>0&&s.some(o=>{var r;return o.nodeType===Node.ELEMENT_NODE||o.nodeType===Node.TEXT_NODE&&((r=o.textContent)==null?void 0:r.trim())!==""})};S=function(){return c`
      <input
        ...
        ${L(p(this,v))}
      />
    `};T=function(){var e;return this.clearable&&(((e=this.value)==null?void 0:e.length)||0)>0?c`
        <gds-button
      ...
      `:y};N=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};i.styles=[F,R];a([l()],i.prototype,"value",2);a([l()],i.prototype,"label",2);a([l({attribute:"supporting-text"})],i.prototype,"supportingText",2);a([l({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],i.prototype,"showExtendedSupportingText",2);a([l({attribute:"disabled",type:Boolean,reflect:!0})],i.prototype,"disabled",2);a([l({type:Boolean})],i.prototype,"clearable",2);a([l({type:Number})],i.prototype,"maxlength",2);a([l({type:String})],i.prototype,"variant",2);a([l({type:String})],i.prototype,"size",2);a([G("input")],i.prototype,"elInputAsync",2);a([W("input")],i.prototype,"elInput",2);a([A()],i.prototype,"trailSlotOccupied",2);i=a([I("gds-input"),O()],i);
