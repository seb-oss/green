import{i as J,t as Q,n as f,K as E,J as U,E as w,a as W,h as v,a0 as S,a1 as D,a2 as q,P as G,g as X,L as Z,Q as j}from"./iframe-BIS5g5CB.js";import{n as ss,e as ts}from"./ref-C8KFcSOg.js";import{G as es}from"./card.component-DclH6DiE.js";import{I as is}from"./circle-check.component-BN69elLu.js";import{I as as,a as rs}from"./triangle-exclamation.component-C0xZSJ_R.js";import{I as os}from"./cross-small.component-B4BgoRC5.js";const ns=J`
  :host {
...
`;var ls=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,L=s=>{throw TypeError(s)},c=(s,t,r,h)=>{for(var m=h>1?void 0:h?cs(t,r):t,k=s.length-1,C;k>=0;k--)(C=s[k])&&(m=(h?C(t,r,m):C(m))||m);return h&&m&&ls(t,r,m),m},A=(s,t,r)=>t.has(s)||L("Cannot "+r),a=(s,t,r)=>(A(s,t,"read from private field"),r?r.call(s):t.get(s)),d=(s,t,r)=>t.has(s)?L("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(s):t.set(s,r),o=(s,t,r,h)=>(A(s,t,"write to private field"),t.set(s,r),r),i=(s,t,r)=>(A(s,t,"access private method"),r),y,u,I,p,g,l,_,M,e,T,x,P,R,z,b,$,B,N,O,H,V,F,K,Y;const ds={positive:{icon:"circle-check",card:"positive"},warning:{icon:"circle-info",card:"warning"},negative:{icon:"triangle-exclamation",card:"negative"},information:{icon:"circle-info",card:"information"},notice:{icon:"circle-info",card:"notice"}},hs=300,ps=100;let n=class extends U{constructor(){super(),d(this,e),this.variant="information",this.label="",this.role="alert",this.dismissible=!1,this.timeout=0,this.buttonLabel="",this._progress=100,this._isClosing=!1,this._cardHidden=!1,d(this,y),d(this,u),d(this,I,ts()),d(this,p),d(this,g,!1),d(this,l,0),d(this,_,0),d(this,M,{hostConnected:()=>{this.timeout>0&&i(this,e,T).call(this)},hostDisconnected:()=>{i(this,e,x).call(this),i(this,e,b).call(this)}}),this.addController(a(this,M))}updated(s){s.has("timeout")&&(i(this,e,x).call(this),i(this,e,b).call(this),o(this,l,Math.max(0,this.timeout)),this._progress=100,this.timeout>0&&i(this,e,T).call(this))}render(){if(this._cardHidden)return w;const s={dismissing:this._isClosing,dismissible:this.dismissible,"has-action":this.buttonLabel,timeout:this.timeout>0};return v`
    ...
    `}};y=new WeakMap;u=new WeakMap;I=new WeakMap;p=new WeakMap;g=new WeakMap;l=new WeakMap;_=new WeakMap;M=new WeakMap;e=new WeakSet;T=function(){a(this,p)||(a(this,l)||o(this,l,Math.max(0,this.timeout)),o(this,p,new IntersectionObserver(s=>{const t=s[0],h=((t==null?void 0:t.intersectionRatio)??0)>=.1;h&&!a(this,g)?(o(this,g,!0),i(this,e,R).call(this)):!h&&a(this,g)&&(o(this,g,!1),i(this,e,z).call(this))},{root:null,threshold:[0,.1,1]})),a(this,p).observe(this))};x=function(){a(this,p)&&(a(this,p).disconnect(),o(this,p,void 0)),o(this,g,!1)};P=function(){o(this,_,Date.now()),o(this,u,window.setInterval(()=>{const s=Date.now(),t=s-a(this,_);o(this,_,s),o(this,l,Math.max(0,a(this,l)-t)),this._progress=this.timeout>0?Math.max(0,a(this,l)/this.timeout*100):0,a(this,l)<=0&&i(this,e,$).call(this,"timeout")},ps))};R=function(){a(this,l)<=0||a(this,y)||a(this,u)||i(this,e,P).call(this)};z=function(){i(this,e,b).call(this)};b=function(){clearTimeout(a(this,y)),clearInterval(a(this,u)),o(this,y,o(this,u,void 0))};$=async function(s){this._isClosing=!0,i(this,e,x).call(this),i(this,e,b).call(this),await this.updateComplete,this.dispatchCustomEvent("gds-close",{detail:{source:s},bubbles:!0,composed:!0}),await new Promise(t=>setTimeout(t,hs)),this._cardHidden=!0};B=function(s){this.dispatchCustomEvent("gds-action",{detail:{source:"button",event:s},bubbles:!0,composed:!0})};N=function(s){s.key==="Escape"&&this.dismissible&&(s.preventDefault(),i(this,e,$).call(this,"escape"))};O=function(){return ds[this.variant]};H=function(){const s=`gds-icon-${a(this,e,O).icon}`;return v`${q`<${S(D(s))} class="icon" solid aria-hidden="true" size="24px"></${S(D(s))}>`}`};V=function(){return v`<div class="message">
