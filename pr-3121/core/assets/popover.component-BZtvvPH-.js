import{a8 as I,i as U,n,E as A,l as P,$ as y,a as F,F as G,D as z,V as X,e as Y,J as q,h as Q}from"./iframe-C0qG-sy5.js";import{l as J}from"./localized-decorator-CjJ0RL6f.js";import{o as Z,s as j,a as tt,c as et}from"./floating-ui.dom-DzQH3ivI.js";import{I as it}from"./cross-small.component-DpU7rLvl.js";function st(t){return(e,o,r)=>{if(I)return;const l=window.matchMedia(t),p=e.connectedCallback,_=e.disconnectedCallback;e.connectedCallback=function(){p?.call(this);const L=K=>{r.value?.call(this,K.matches)};l.addEventListener("change",L),this.disconnectedCallback=function(){_?.call(this),l.removeEventListener("change",L)},r.value?.call(this,l.matches)}}}const at=U`
