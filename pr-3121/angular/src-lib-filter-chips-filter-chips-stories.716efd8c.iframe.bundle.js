/*! For license information please see src-lib-filter-chips-filter-chips-stories.716efd8c.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[8743],{1912(e,t,s){s.d(t,{x:()=>u});var i=s(6861),r=s(4367),l=s(3578),n=s(3539),a=s(4457),o=s(7526),c=s(7595),h=s(6290);const d=s(9443).AH`
...
`;let u=class extends n.j{constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),a.n.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return o.qy`<gds-button
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};u.styles=[d],(0,i.Cc)([(0,r.MZ)({reflect:!0,type:Boolean})],u.prototype,"selected",2),(0,i.Cc)([(0,r.MZ)()],u.prototype,"value",2),(0,i.Cc)([(0,r.MZ)({reflect:!0,type:String})],u.prototype,"size",2),u=(0,i.Cc)([(0,o.Y$)("gds-filter-chip",{dependsOn:[c.t,h.V]})],u)},9830(e,t,s){s.d(t,{A:()=>y});var i,r,l,n,a,o,c=s(6861),h=s(4367),d=s(3578),u=s(1239),p=s(4324),g=s(1374),v=s(6472),f=s(7526),m=s(8558),b=s(1912),_=s(9443).AH`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
...
`;let y=class extends m.S{constructor(){super(...arguments),(0,c.VK)(this,n),this.multiple=!1,this.label="",this.rowCollapse=!1,this._collapsed=!1,(0,c.VK)(this,i,e=>{const t=this.chips.find(t=>t===e.target||t.contains(e.target));t&&(this.multiple&&Array.isArray(this.value)?t.selected?this.value=this.value.filter(e=>e!==t.value):this.value=[...this.value,t.value]:this.value=t.value===this.value?void 0:t.value,this.dispatchCustomEvent("change",{detail:{clickedChip:t,value:this.value},bubbles:!0,composed:!0}))}),(0,c.VK)(this,r,3),(0,c.VK)(this,l,0)}get value(){return this._internalValue}set value(e){this._internalValue=e}get chips(){return this._elSlot?this._elSlot.assignedElements():[]}render(){const e={collapse:this._collapsed};return f.qy`<div
      class="chips ${(0,d.H)(e)}"
      role="listbox"
