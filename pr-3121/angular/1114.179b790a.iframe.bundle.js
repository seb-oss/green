"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[1114],{7595(t,e,o){o.d(e,{t:()=>q});var r=o(6861),s=o(9443),i=o(4367),a=o(3578),n=o(4652),l=o(505),c=o(911),d=o(3539),g=o(7526),p=o(5073),u=s.AH`
  :host {
...
`;const j=["aria-label","aria-haspopup","aria-expanded","gds-tabindex","gds-aria-selected"],L=(Z=g.qy,(t,...e)=>{let o=S.get(t);return o||(o=t.map(t=>t.replace(/\n[\s]+</gm,"<")),o.raw=t.raw,S.set(t,o)),Z(o,...e)});var Z;let F=class extends z.S{constructor(){super(...arguments),(0,r.VK)(this,M),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.wrapped=!1,this.href="",(0,r.VK)(this,C,!1),(0,r.VK)(this,V,()=>{const t=this._mainSlot?.assignedElements()??[];(0,r.OV)(this,C,1===t.length&&(t[0].tagName.toLowerCase().startsWith("gds-icon")||"icon"===t[0].getAttribute("name"))),this.requestUpdate()}),(0,r.VK)(this,E,t=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:t}),this.form&&!(0,r.S7)(this,M,_)&&("submit"===this.type?this.form.requestSubmit():"reset"===this.type&&this.form.reset())}),(0,r.VK)(this,$,t=>{if(!(this.disabled||"Space"!==t.code&&"Enter"!==t.key||t.repeat)){const t=this._ripple;t&&t.triggerRipple()}})}focus(t){this._getValidityAnchor()?.focus(t)}click(){this._getValidityAnchor()?.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),h.n.instance.apply(this,"gds-button")}render(){const t={button:!0,circle:(0,r.S7)(this,C),icon:(0,r.S7)(this,C),xs:"xs"===this.size,small:"small"===this.size,large:"large"===this.size,brand:"brand"===this.variant,positive:"positive"===this.variant,negative:"negative"===this.variant,notice:"notice"===this.variant,warning:"warning"===this.variant,primary:"primary"===this.rank,secondary:"secondary"===this.rank,tertiary:"tertiary"===this.rank,wrapped:this.wrapped},e=(0,r.S7)(this,M,_)?c.eu`a`:c.eu`button`;return c.qy`
      <${e}
        class=${(0,a.H)(t)}
