"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[7612],{801(e,t,s){s.d(t,{K:()=>v});var i,o,a,r,l,n=s(6861),d=s(4367),c=s(3578),p=s(3539),h=s(7526),g=s(5073),u=s(4987),b=s(6312),y=s(9443).AH`
...
`;let v=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(p.j)))){constructor(){super(...arguments),(0,n.VK)(this,i),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=(0,c.H)({badge:!0,[this.variant]:!0,[this.size]:"small"===this.size,notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return h.qy`
    ...
    ></slot>`},l=function(){return h.qy`<slot name="trail"></slot>`},v.styles=[g.LU,y],(0,n.Cc)([(0,d.MZ)()],v.prototype,"variant",2),(0,n.Cc)([(0,d.MZ)({type:String})],v.prototype,"size",2),(0,n.Cc)([(0,d.MZ)({attribute:"notification",type:Boolean,reflect:!0})],v.prototype,"notification",2),(0,n.Cc)([(0,d.MZ)({attribute:"rounded",type:Boolean,reflect:!0})],v.prototype,"rounded",2),(0,n.Cc)([(0,d.wk)()],v.prototype,"mainSlotOccupied",2),(0,n.Cc)([(0,d.wk)()],v.prototype,"leadSlotOccupied",2),v=(0,n.Cc)([(0,h.Y$)("gds-badge",{dependsOn:[b.o]})],v)},8609(e,t,s){s.d(t,{z:()=>d});var i=s(6861),o=s(4367),a=s(5073),r=s(7526),l=s(8833),n=s(9443).AH`
  :host {
    --_border: transparent;
...
`,ee=s(4851);let te=class extends I.S{constructor(){super(),(0,z.VK)(this,o),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,(0,z.VK)(this,i),(0,z.VK)(this,r,()=>O.qy`
      <input
        ...
        @input=${e=>{(0,z.jq)(this,o,_).call(this,e.target.value,{emitChange:!1}),(0,z.S7)(this,g).call(this,e),(0,z.S7)(this,c).call(this,!0,"show")&&(this.open=!0)}}
        @keydown=${e=>{"ArrowDown"===e.key&&(e.preventDefault(),(0,z.S7)(this,c).call(this,!0,"show")&&(this.open=!0),this.updateComplete.then(()=>(0,z.S7)(this,f).call(this))),"Enter"===e.key&&(0,z.jq)(this,o,_).call(this,this.value,{emitInput:!1})}}
      />
    `),(0,z.VK)(this,l,()=>O.qy`
      <button
        id="trigger"
      ...
      >
        <slot name="trigger">
          <span>${(0,V._)(this.displayValue)}</span>
        </slot>
      </button>
    `),(0,z.VK)(this,n,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),(0,z.VK)(this,d,e=>{if(this.combobox){const t=e.getBoundingClientRect(),s=window.innerHeight-t.bottom,i=t.top;let o=Math.min(i,this.maxHeight);return s>i&&(o=Math.min(s,this.maxHeight)),o-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"}),(0,z.VK)(this,c,(e,t)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:t,open:e},bubbles:!1,composed:!1})),(0,z.VK)(this,p,e=>{(0,z.S7)(this,c).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),(0,z.VK)(this,h,e=>{e.preventDefault(),e.stopPropagation(),(0,z.jq)(this,o,_).call(this,void 0,{beforeDispatch:()=>this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0})})}),(0,z.VK)(this,g,e=>{if(!e.currentTarget)return;if(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}}))return;const t=e.currentTarget;this.options.forEach(e=>e.hidden=!1),t.value&&this.options.filter(e=>!this.searchFilter(t.value,e)).forEach(e=>e.hidden=!0)}),(0,z.VK)(this,u,e=>{"ArrowDown"!==e.key&&"Tab"!==e.key||(e.preventDefault(),(0,z.S7)(this,f).call(this))}),(0,z.VK)(this,b,e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()}),(0,z.VK)(this,y,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),(0,z.VK)(this,v,e=>{const t=e.target;this.options.includes(t)&&(this.multiple?(0,z.jq)(this,o,_).call(this,(0,z.jq)(this,o,m).call(this,t)):(0,z.jq)(this,o,_).call(this,t.value,{beforeDispatch:()=>{(0,z.S7)(this,c).call(this,!1,"close")&&(this.open=!1,setTimeout(()=>this._elTriggerBtn?.focus(),0))}}))}),(0,z.VK)(this,f,()=>{this.updateComplete.then(()=>{const e=this.navigableItems;(e.find(e=>e.selected)||e[0])?.focus()})}),(0,z.VK)(this,C,!1),(0,z.VK)(this,$,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,z.S7)(this,c).call(this,!1,"close")&&(this.open=!1)}),(0,z.VK)(this,S,e=>{"Tab"===e.key&&!this.searchable&&(0,z.S7)(this,c).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}),new D.y(this)}get type(){return"gds-dropdown"}get options(){return(0,z.S7)(this,i)?Array.from((0,z.S7)(this,i)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if((0,z.S7)(this,i))return Array.from((0,z.S7)(this,i)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){if(void 0===this.value)return this.placeholder?.innerText||"";let e;return e=Array.isArray(this.value)?this.value.slice(0,5).reduce((e,t)=>e+this.options.find(e=>this.compareWith(e.value,t))?.innerText+", ","").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):this.options.find(e=>this.compareWith(e.value,this.value))?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}get navigableItems(){return this.options.filter(e=>!e.hidden)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",(0,z.S7)(this,n)),K.n.instance.applyScoped(this,"gds-dropdown","t-listbox"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",(0,z.S7)(this,n))}render(){return O.qy`
      ${(0,L.z)(!this.plain&&!this.hideLabel,()=>O.qy`
          <gds-form-control-header
            class="size-${this.size}"
            .showExtendedSupportingText="${this.showExtendedSupportingText}"
          >
            <label id="label" for="trigger" slot="label">${this.label}</label>
            ${(0,L.z)(this.supportingText.length>0,()=>O.qy`<span slot="supporting-text" id="supporting-text">
                  ${this.supportingText}
                </span>`)}
            <slot
      ...
      <gds-popover
        ...
        .calcMaxHeight=${(0,z.S7)(this,d)}
        .disableMobileStyles=${this.disableMobileStyles||this.combobox}
        .nonmodal=${this.combobox}
        .floatingUIMiddleware=${this.combobox?[(0,A.cY)(8),(0,A.UU)()]:X.E.DefaultMiddleware}
        @gds-ui-state=${(0,z.S7)(this,p)}
      >
        <gds-field-base
          .size=${this.size}
        ...
        >
          ...
          ${(0,L.z)(this.value&&this.multiple&&this.value.length>0,()=>O.qy`<gds-badge
                rounded
                size=${"small"===this.size?"small":"default"}
                slot="lead"
                aria-label=${(0,T.ab)(T.gx`${this.value.length} options selected`)}
              >
                ${this.value.length}</gds-badge
              >`)}
          ${(0,L.z)(this.clearable&&!this.disabled&&(Array.isArray(this.value)?this.value.length>0:Boolean(this.value)),()=>O.qy`<gds-button
                id="clear-btn"
                rank="tertiary"
                size=${"small"===this.size?"xs":"small"}
                label="${(0,T.ab)("Clear selection")}"
                @click=${(0,z.S7)(this,h)}
                slot="action"
              >
                <gds-icon-cross-small></gds-icon-cross-small>
              </gds-button>`)}
          ${(0,L.z)(this.combobox&&!this.multiple,()=>(0,z.S7)(this,r).call(this))}
          ${(0,L.z)(!this.combobox||this.multiple,()=>(0,z.S7)(this,l).call(this))}
        ...
        ${(0,L.z)(this.searchable,()=>O.qy`<input
              id="searchinput"
              type="text"
              aria-label="${(0,T.ab)("Filter available options")}"
              placeholder="${(0,T.ab)("Search")}"
              @keydown=${(0,z.S7)(this,u)}
              @input=${(0,z.S7)(this,g)}
            />`)}
        <div
          id="listbox"
          ...
          tabindex="-1"
          @focus="${(0,z.S7)(this,f)}"
          @gds-select="${(0,z.S7)(this,v)}"
          @gds-focus="${(0,z.S7)(this,y)}"
          @keydown=${(0,z.S7)(this,b)}
        >
          <slot></slot>
        </div>
      </gds-popover>

      ${(0,L.z)((0,z.jq)(this,o,a).call(this),()=>O.qy`
          ...
          >
            ...
            <slot id="message" name="message" slot="message">
              <gds-icon-triangle-exclamation
                solid
              ></gds-icon-triangle-exclamation>
              ${this.invalid?this.errorMessage:E.s6}
            </slot>
          </gds-form-control-footer>
        `)}
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){this.requestUpdate(),(0,z.OV)(this,i,this.querySelectorAll("[gds-element=gds-option]")),this.multiple||(0!==this.options.length||this.placeholder)&&(void 0===this.value?this.placeholder?this.value=this.placeholder.value:this.value=this.options[0]?.value:this.combobox||this.placeholder||void 0!==this.options.find(e=>this.compareWith(e.value,this.value))||(this.value=this.options[0]?.value))}updated(){(0,z.jq)(this,o,x).call(this)}_handleMultipleChange(){this.options.forEach(e=>e.requestUpdate())}get value(){return super.value}set value(e){(0,z.S7)(this,C)||(super.value=e)}_handleOpenChange(){var e=this;const t=this.open;this.options.forEach(e=>e.hidden=!t),t?(0,z.jq)(this,o,w).call(this):((0,z.jq)(this,o,k).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const s=this.options.find(e=>e.selected);requestAnimationFrame((0,M.A)(function*(){yield e.updateComplete,s?.scrollIntoView({block:"center"})}))}};i=new WeakMap,o=new WeakSet,a=function(){return!this.plain},r=new WeakMap,l=new WeakMap,n=new WeakMap,d=new WeakMap,c=new WeakMap,p=new WeakMap,h=new WeakMap,g=new WeakMap,u=new WeakMap,b=new WeakMap,y=new WeakMap,v=new WeakMap,m=function(e){const t=Array.isArray(this.value)?this.value:[],s=e=>t.some(t=>this.compareWith(t,e)),i=!s(e.value);return this.options.filter(t=>t===e?i:s(t.value)).map(e=>e.value)},x=function(){const e=this.multiple?Array.isArray(this.value)?this.value:[]:[this.value];this.options.forEach(t=>{t.selected=e.some(e=>this.compareWith(e,t.value))})},f=new WeakMap,C=new WeakMap,_=function(e,t={}){const{emitInput:s=!0,emitChange:i=!0,beforeDispatch:o}=t;this.value=e,(0,z.OV)(this,C,!0);try{o?.(),s&&this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}),i&&this.dispatchCustomEvent("change",{detail:{value:e},bubbles:!0,composed:!0})}finally{(0,z.OV)(this,C,!1)}},w=function(){this.addEventListener("blur",(0,z.S7)(this,$)),this.addEventListener("gds-blur",(0,z.S7)(this,$)),this.addEventListener("keydown",(0,z.S7)(this,S))},k=function(){this.removeEventListener("blur",(0,z.S7)(this,$)),this.removeEventListener("gds-blur",(0,z.S7)(this,$)),this.removeEventListener("keydown",(0,z.S7)(this,S))},$=new WeakMap,S=new WeakMap,te.styles=[B.LU,W.A,H.A,J],(0,z.Cc)([(0,q.MZ)({attribute:"supporting-text"})],te.prototype,"supportingText",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,reflect:!0})],te.prototype,"open",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,reflect:!0})],te.prototype,"searchable",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,reflect:!0})],te.prototype,"multiple",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,reflect:!0})],te.prototype,"clearable",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,reflect:!0})],te.prototype,"combobox",2),(0,z.Cc)([(0,q.MZ)()],te.prototype,"compareWith",2),(0,z.Cc)([(0,q.MZ)()],te.prototype,"searchFilter",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,attribute:"sync-popover-width"})],te.prototype,"syncPopoverWidth",2),(0,z.Cc)([(0,q.MZ)({type:Number,attribute:"max-height"})],te.prototype,"maxHeight",2),(0,z.Cc)([(0,q.MZ)({reflect:!0})],te.prototype,"size",2),(0,z.Cc)([(0,q.MZ)({type:Boolean,attribute:"hide-label"})],te.prototype,"hideLabel",2),(0,z.Cc)([(0,q.MZ)({type:Boolean})],te.prototype,"plain",2),(0,z.Cc)([(0,q.MZ)({type:Boolean})],te.prototype,"disableMobileStyles",2),(0,z.Cc)([(0,q.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],te.prototype,"showExtendedSupportingText",2),(0,z.Cc)([(0,q.P)("#trigger")],te.prototype,"_elTriggerBtn",2),(0,z.Cc)([(0,q.P)("#searchinput")],te.prototype,"_elSearchInput",2),(0,z.Cc)([(0,Y.L)({attributes:!0,attributeFilter:["gds-element","value","isplaceholder"],childList:!0,subtree:!0,characterData:!0})],te.prototype,"_handleLightDOMChange",1),(0,z.Cc)([(0,N.w)("multiple")],te.prototype,"_handleMultipleChange",1),(0,z.Cc)([(0,N.w)("open")],te.prototype,"_handleOpenChange",1),te=(0,z.Cc)([(0,P.J)({labelledBy:"#trigger",describedBy:"#trigger",errorMessage:"#trigger"}),(0,T.cc)()],te);let se=class extends((0,U.Q8)((0,U.TM)((0,U.lt)(te)))){};se=(0,z.Cc)([(0,O.Y$)("gds-dropdown",{dependsOn:[F.$,j.V,Z.w,ee.Y,X.E,G.V,Q.o,R.r]})],se)},4851(e,t,s){s.d(t,{Y:()=>x});var i,o,a,r=s(6861),l=s(4367),n=s(505),d=s(3539),c=s(7526),p=s(4843),h=s(8146),g=s(8057),u=s(5073),b=s(4457),y=s(1374),v=s(4397),m=s(6290);let x=class extends((0,v.z)(d.j)){constructor(){super(),(0,r.VK)(this,o),(0,r.VK)(this,i,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",(0,r.jq)(this,o,a)),this.addEventListener("keydown",e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),(0,r.jq)(this,o,a).call(this,e))})}get hidden(){return(0,r.S7)(this,i)}set hidden(e){const t=e.toString();(0,r.OV)(this,i,"true"===t),(0,r.S7)(this,i)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),b.n.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){const e=this.parentElement?.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),c.qy`<div class="item">
      ${(0,n.z)(e,()=>(0,g.o)({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};i=new WeakMap,o=new WeakSet,a=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})},x.styles=[u.LU,h.A,p.A],(0,r.Cc)([(0,l.MZ)()],x.prototype,"value",2),(0,r.Cc)([(0,l.MZ)({type:Boolean,reflect:!0})],x.prototype,"hidden",1),(0,r.Cc)([(0,l.MZ)({attribute:"aria-selected",reflect:!0,converter:{fromAttribute:e=>"true"===e,toAttribute:e=>e?"true":"false"}})],x.prototype,"selected",2),(0,r.Cc)([(0,l.MZ)({type:Boolean,reflect:!0})],x.prototype,"isPlaceholder",2),(0,r.Cc)([(0,y.w)("isPlaceholder")],x.prototype,"_handlePlaceholderStatusChange",1),x=(0,r.Cc)([(0,c.Y$)("gds-option",{dependsOn:[m.V]})],x)},6312(e,t,s){s.d(t,{o:()=>n});var i=s(6861),o=s(5073),a=s(7526),r=s(8833),l=s(9443).AH`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;let b=class extends p.j{constructor(){super(...arguments),(0,a.VK)(this,i)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter?.[1])}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return g.qy`<div aria-live="polite">
    ...
    </div>`}};i=new WeakSet,o=function(){if(!this.charCounter||!1===this.charCounter[1])return r.s6;const[e,t]=this.charCounter;return g.qy`<gds-badge variant="${t}">${e}</gds-badge>`},b.styles=[u],(0,a.Cc)([(0,l.MZ)({type:Array})],b.prototype,"charCounter",2),(0,a.Cc)([(0,l.MZ)()],b.prototype,"errorMessage",2),(0,a.Cc)([(0,h.w)("charCounter"),(0,h.w)("errorMessage")],b.prototype,"_handleVisibilityChange",1),b=(0,a.Cc)([(0,g.Y$)("gds-form-control-footer",{dependsOn:[d.K,c.f]})],b)},2655(e,t,s){s.d(t,{$:()=>x});var i,o,a,r,l,n,d=s(6861),c=s(6743),p=s(4367),h=s(505),g=s(7595),u=s(8609),b=s(4464),y=s(3539),v=s(7526),m=s(9443).AH`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;let x=class extends y.j{constructor(){super(...arguments),(0,d.VK)(this,i),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,(0,d.VK)(this,a,()=>v.qy`
    ...
    `},x.styles=[m],(0,d.Cc)([(0,p.MZ)({type:Boolean,reflect:!0})],x.prototype,"showExtendedSupportingText",2),(0,d.Cc)([(0,p.wk)()],x.prototype,"_hasExtendedSupportingText",2),(0,d.Cc)([(0,p.P)("#extended-supporting-text")],x.prototype,"_extendedSupportingText",2),x=(0,d.Cc)([(0,v.Y$)("gds-form-control-header",{dependsOn:[g.t,u.z,b.w]}),(0,c.cc)()],x)},2606(e,t,s){s.d(t,{A:()=>i}),s(6861);var i=s(9443).AH`
  * {
    box-sizing: border-box;
  }
...
`},8057(e,t,s){s(6861);var i=s(3578),o=s(505),a=s(7526);const r=e=>{const{type:t,checked:s,indeterminate:r,disabled:l,invalid:n}=e,d={"rbcb--checkbox":"checkbox"===t,"rbcb--radio":"radio"===t,"--checked":s,"--indeterminate":r,"--disabled":l,"--invalid":n};return a.qy`
...
//# sourceMappingURL=7612.562f6adc.iframe.bundle.js.map