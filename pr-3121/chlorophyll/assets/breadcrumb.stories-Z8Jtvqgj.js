const s={title:"Components/Breadcrumb",tags:["autodocs"],parameters:{componentIds:["component-Breadcrumb"]}},n={render:()=>`
  ...
  render: () => \`
    ...
    \`
}`,...n.parameters?.docs?.source},description:{story:`[Source code](https://github.com/seb-oss/green/tree/main/libs/chlorophyll/scss/components/breadcrumb)
&nbsp;|&nbsp;
[Usage guidelines](https://designlibrary.sebgroup.com/components/component-breadcrumbs)

Displays the path to the current resource using a hierarchy of links.`,...n.parameters?.docs?.description}}};const l=["Breadcrumb"];export{n as Breadcrumb,l as __namedExportsOrder,s as default};
