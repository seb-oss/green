import{i as M,t as N,b as l,F as z,V as b,c as t,d as y,z as k}from"./declarative-layout-mixins-CHDou_T4.js";const B=`/* stylelint-disable max-nesting-depth */
/**
...
}`;function T(){o.instance.register("gds-dropdown",V.toString()),w(),$(),v(),c(),C()}const E=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function D(){const i=E.toString()+N.reduce((e,r)=>e+r.cssText,"");o.instance.register("gds-datepicker",i.toString()),T(),v(),H()}const j=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {
    .btn-p {
