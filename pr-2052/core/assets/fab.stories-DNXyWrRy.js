import{a as V}from"./argTableProps-BOQIcpJQ.js";import{DefaultParams as Z}from"./button.stories-B693MxL-.js";import{h as r}from"./custom-element-scoping-VoPGhQfY.js";import"./custom-elements-y0QWBBgU.js";import"./lit-element-BTGJPccZ.js";const Y={title:"Components/FAB",component:"gds-fab",tags:["autodocs"],argTypes:{...V("gds-fab")},parameters:{docs:{description:{component:`The Floating Action Button is used for functions central to the user experience, such as
...
corner. This button can be used with an icon only.`}}}},a={...Z,parameters:{docs:{source:{format:!0,type:"dynamic"},story:{height:"200px",position:"relative"}},controls:{expanded:!0}},args:{innerHTML:`See what's new! <gds-signal slot="trail"></gds-signal>`}},d={...a},s={...a,name:"Signal ",parameters:{...a.parameters,controls:{include:[]}},render:o=>r`
  ...
  ...DefaultParams
}`,...(c=(l=d.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};var u,p,b,m,x;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Signal ',
  parameters: {
  ...
  \`
}`,...(b=(p=s.parameters)==null?void 0:p.docs)==null?void 0:b.source},description:{story:`The FAB can be used with a signal to indicate that there is something new or updated.
...
If you want to change the z-index, that should be done in the CSS or wrap FAB in a container with a higher z-index value.`,...(U=(R=i.parameters)==null?void 0:R.docs)==null?void 0:U.description}}};const $=["Usage","RanksAndVariants","IconButton","Color","Position","ZIndex"];export{n as Color,e as IconButton,t as Position,s as RanksAndVariants,d as Usage,i as ZIndex,$ as __namedExportsOrder,Y as default};
