import{x as i}from"./lit-element-BTGJPccZ.js";import{a as M}from"./argTableProps-DJ3osy8N.js";import{r as L}from"./transitional-styles-CfQrpWYl.js";import"./custom-elements-WCmTfZl-.js";import"./dynamic-styles-controller-CgAnfzec.js";import"./custom-element-scoping-VoPGhQfY.js";L();const I={title:"Components/Context Menu",component:"gds-context-menu",subcomponents:{MenuItem:"gds-menu-item"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/context-menu)
&nbsp;|&nbsp;
...
displays a list of choices, one choice per line.`}}},tags:["autodocs"],argTypes:{...M("gds-context-menu")}},o={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{items:{control:{type:"array"}}},args:{innerHTML:`<gds-menu-item>Action 1</gds-menu-item>
...
<gds-menu-item>Action 3</gds-menu-item>`}},s={...o},e={...o,render:r=>i`
  ...
  ...DefaultParams
}`,...(c=(m=s.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};var d,l,C,u,g;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    Activated action: <span id="display-action"></span>
    <br />
  ...
  \`
}`,...(H=(h=n.parameters)==null?void 0:h.docs)==null?void 0:H.source},description:{story:"You can show the label by setting the `show-label` attribute on the `<gds-context-menu>` element.",...(x=(b=n.parameters)==null?void 0:b.docs)==null?void 0:x.description}}};var w,y,v,V,f;t.parameters={...t.parameters,docs:{...(w=t.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-context-menu>
      <div
  ...
  \`
}`,...(v=(y=t.parameters)==null?void 0:y.docs)==null?void 0:v.source},description:{story:"You can show the label by setting the `show-label` attribute on the `<gds-context-menu>` element.",...(f=(V=t.parameters)==null?void 0:V.docs)==null?void 0:f.description}}};const D=["Basic","Usage","ShowLabel","Slots"];export{s as Basic,n as ShowLabel,t as Slots,e as Usage,D as __namedExportsOrder,I as default};
