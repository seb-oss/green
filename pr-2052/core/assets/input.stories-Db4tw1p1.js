import{x as a}from"./lit-element-BTGJPccZ.js";import{a as le}from"./argTableProps-Cat1BhaE.js";import"./custom-elements-D30eliN0.js";const ue={title:"Components/Input",component:"gds-input",parameters:{layout:"centered",docs:{description:{component:`Input are used to let the user enter text or numbers in a form.
...
@status beta`}}},tags:["autodocs"],argTypes:{...le("gds-input"),value:{control:"text"},variant:{options:["default"],control:{type:"select"}},size:{options:["large","small"],control:{type:"select"}},invalid:{control:"boolean"}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label",variant:"default",size:"large",supportingText:"Label support text.",innerHTML:'<gds-icon-people-profile slot="lead"></gds-icon-people-profile>'}},c={...t,name:"Default"},n={...t,name:"Size",render:()=>a`
  ...
  `},o={...t,name:"Extended Supporting Text",render:()=>a`
  ...
  \`
}`,...(H=(G=d.parameters)==null?void 0:G.docs)==null?void 0:H.source},description:{story:'The `supporting-text` property can be set to a string to provide additional information about the input field.\n\n**@property supporting-text** - Additional information about the input field.\n\n```html\n  <gds-input label="Label text" supporting-text="Supporting text"></gds-input>\n```',...(O=(M=d.parameters)==null?void 0:M.docs)==null?void 0:O.description}}};var W,B,J,K,Q;o.parameters={...o.parameters,docs:{...(W=o.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
...
\`\`\``,...(te=(ee=p.parameters)==null?void 0:ee.docs)==null?void 0:te.description}}};var ae,ne,re,ie,se;u.parameters={...u.parameters,docs:{...(ae=u.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  ...
  \`
}`,...(re=(ne=u.parameters)==null?void 0:ne.docs)==null?void 0:re.source},description:{story:"The `disabled` property can be set to disable the input field.\n\n**@property disabled** - Disables the input field.\n\n```html\n <gds-input disabled></gds-input>\n```",...(se=(ie=u.parameters)==null?void 0:ie.docs)==null?void 0:se.description}}};const ce=["Default","Size","Lead","Trail","Length","Clearable","SupportingText","ExtendedSupportingText","Validation","Disabled"];export{l as Clearable,c as Default,u as Disabled,o as ExtendedSupportingText,r as Lead,s as Length,n as Size,d as SupportingText,i as Trail,p as Validation,ce as __namedExportsOrder,ue as default};
