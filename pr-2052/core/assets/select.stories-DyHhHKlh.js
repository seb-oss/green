import{x as o}from"./lit-element-BTGJPccZ.js";import{a as X}from"./argTableProps-BOQIcpJQ.js";import"./custom-elements-y0QWBBgU.js";const oe={title:"Components/Select",component:"gds-select",tags:["autodocs"],argTypes:{...X("gds-select")},parameters:{docs:{description:{component:`\`gds-select\` is a wrapper component for the native select element.
...
<br>It is set by adding an icon component to the 'lead' slot.`,...(k=(w=i.parameters)==null?void 0:w.docs)==null?void 0:k.description}}};var C,D,q,I,A;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...
  \`
}`,...(F=(_=r.parameters)==null?void 0:_.docs)==null?void 0:F.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(K=(W=r.parameters)==null?void 0:W.docs)==null?void 0:K.description}}};const te=["Default","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{t as Default,s as Disabled,i as Lead,p as Multiple,n as Option,r as SelectSize,l as Size,a as Validation,te as __namedExportsOrder,oe as default};
