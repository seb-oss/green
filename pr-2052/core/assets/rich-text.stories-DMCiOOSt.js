import{a as Y}from"./argTableProps-BOQIcpJQ.js";import{h as e}from"./custom-element-scoping-VoPGhQfY.js";import"./custom-elements-y0QWBBgU.js";import"./lit-element-BTGJPccZ.js";const ee={title:"Components/Rich Text",component:"gds-rich-text",tags:["autodocs"],argTypes:{...Y("gds-rich-text")},parameters:{docs:{description:{component:`\`gds-rich-text\` can be used to wrap generic HTML content and apply typography styles.
...
\`\`\``,...(V=(U=d.parameters)==null?void 0:U.docs)==null?void 0:V.description}}};const te=["Card","Headings","Lists","Details","Blockquote","Formatting","Table","Basic"];export{d as Basic,s as Blockquote,c as Card,o as Details,r as Formatting,a as Headings,n as Lists,l as Table,te as __namedExportsOrder,ee as default};
