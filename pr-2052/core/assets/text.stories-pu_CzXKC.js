import{x as e}from"./lit-element-BTGJPccZ.js";import{a as xe}from"./argTableProps-Cat1BhaE.js";import"./custom-elements-D30eliN0.js";const ue={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...xe("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified.\n\n@beta"}}}},p={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},s={...p,name:"Tags",render:t=>e`<gds-flex flex-direction="column" gap="2xl">
  ...
  `},o={...p,name:"Decoration",render:t=>e`<gds-flex flex-direction="column" gap="m">
  ...
  \`
}`,...(R=(E=c.parameters)==null?void 0:E.docs)==null?void 0:R.source}}};var F,I,N,_,j;n.parameters={...n.parameters,docs:{...(F=n.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: 'Color',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-theme color-scheme="dark">
  ...
  \`
}`,...(N=(I=n.parameters)==null?void 0:I.docs)==null?void 0:N.source},description:{story:'The `color` property that will change the text color based on the specified color token.\n\ne.g. `<gds-text level="1" color="primary"></gds-text>`',...(j=(_=n.parameters)==null?void 0:_.docs)==null?void 0:j.description}}};var G,J,K,Q,V;o.parameters={...o.parameters,docs:{...(G=o.parameters)==null?void 0:G.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Decoration',
  render: args => html\`<gds-flex flex-direction="column" gap="m">
      <gds-text text-decoration="underline"> Underline </gds-text>
...
}`,...(K=(J=o.parameters)==null?void 0:J.docs)==null?void 0:K.source},description:{story:'The `text-decoration` property will change the text decoration based on the css values such as `underline`, `overline`, `line-through`, `underline dotted`, `{COLOR} wavy underline` etc.\n\n\ne.g.\n\n```html\n<gds-text\n   text-decoration="currentcolor wavy underline"\n >\n   Wavy Underline\n </gds-text>\n```',...(V=(Q=o.parameters)==null?void 0:Q.docs)==null?void 0:V.description}}};var X,Y,Z,$,ee;r.parameters={...r.parameters,docs:{...(X=r.parameters)==null?void 0:X.docs,source:{originalSource:`{
  name: 'Line Clamp',
  render: args => html\`
    <gds-flex flex-direction="column" gap="2xl">
      <gds-flex flex-direction="column" gap="m">
  ...
  \`
}`,...(de=(se=a.parameters)==null?void 0:se.docs)==null?void 0:de.source},description:{story:'Check the documentation on `text-wrap` property [here](https://developer.mozilla.org/en-US/docs/Web/CSS/text-wrap)\n\nThe `text-wrap` property will change the text wrapping behavior based on the css values such as `wrap`, `nowrap`, `pretty`, `balance`, `stable`.\n\ne.g.\n\n```html\n<gds-text text-wrap="pretty">\n   ...\n</gds-text>\n```',...(oe=(ne=a.parameters)==null?void 0:ne.docs)==null?void 0:oe.description}}};var re,ae,ie,le,ge;i.parameters={...i.parameters,docs:{...(re=i.parameters)==null?void 0:re.docs,source:{originalSource:`{
  name: 'overflow-wrap',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-flex flex-direction="column">
  ...
  \`
}`,...(ie=(ae=i.parameters)==null?void 0:ae.docs)==null?void 0:ie.source},description:{story:'Check the documentation on `text-overflow` property [here](https://developer.mozilla.org/en-US/docs/Web/CSS/text-overflow)\n\nThe `text-overflow` property will change the text overflow behavior based on the css values such as `clip`, `ellipsis`, `string`.\n\ne.g.\n\n```html\n<gds-text overflow-wrap="break-word">\n   ...\n</gds-text>\n```',...(ge=(le=i.parameters)==null?void 0:le.docs)==null?void 0:ge.description}}};const fe=["Tags","Weight","Heading","Detail","Body","Display","Preamble","Color","Decoration","Lines","TextWrap","OverflowWrap"];export{x as Body,n as Color,o as Decoration,g as Detail,m as Display,d as Heading,r as Lines,i as OverflowWrap,c as Preamble,s as Tags,a as TextWrap,l as Weight,fe as __namedExportsOrder,ue as default};
