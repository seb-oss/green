import{x as a,E as u}from"./lit-element-BTGJPccZ.js";import{a as st}from"./argTableProps-Cat1BhaE.js";import"./custom-elements-D30eliN0.js";const ct={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:`A button serve as an interactive element that enables users to perform an action or make
...
A good rule of thumb is to use only one primary action in each context.`}}},tags:["autodocs"],argTypes:{...st("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","positive","negative"],control:{type:"select"}},size:{options:["small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},l={...n},r={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>a`
  ...
  `},e={...n,parameters:{...n.parameters,controls:{include:["rank","variant"]}},render:t=>a`
  ...
  `},s={...n,name:"Using icons in button",parameters:{...n.parameters,controls:{include:["rank","variant","size"]}},render:t=>a`
    <gds-flex gap="l">
      <gds-button
        .rank=${t.rank}
        .variant=${t.variant}
  ...
  `},d={...n,name:"Icon button",parameters:{...n.parameters,controls:{include:["rank","variant"]}},render:t=>a`
    <gds-flex gap="l" align-items="center">
      <gds-button .rank=${t.rank} .variant=${t.variant} size="xs">
  ...
  `},o={...n,parameters:{...n.parameters,controls:{include:[]}},render:()=>a`
    <gds-flex gap="l">
  ...
  `},i={...n,parameters:{...n.parameters,controls:{include:["href","target","rel","download"]}},args:{href:"https://github.com/seb-oss/green"},render:t=>a`
    <gds-button
      href=${t.href}
      target=${t.target||u}
      rel=${t.rel||u}
  ...
  `},c={...n,parameters:{...n.parameters,controls:{include:[]}},render:t=>a`
  ...
  `},g={...n,parameters:{...n.parameters,controls:{include:[]}},render:()=>a`
    <gds-button
  ...
  ...DefaultParams
}`,...(h=(v=l.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var x,k,y,$,w;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(y=(k=r.parameters)==null?void 0:k.docs)==null?void 0:y.source},description:{story:`Buttons can have different ranks and variants. The rank defines the visual importance of the button,
while the variant defines the intent of the button.`,...(w=($=r.parameters)==null?void 0:$.docs)==null?void 0:w.description}}};var P,z,T,S,D;e.parameters={...e.parameters,docs:{...(P=e.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...(L=(B=s.parameters)==null?void 0:B.docs)==null?void 0:L.source},description:{story:"Buttons can have an icon on the left or right side of the text. These are called leading or trailing icons,\nand are added by placing a `gds-icon` component in either the `lead` or `trail` slot.",...(_=(I=s.parameters)==null?void 0:I.docs)==null?void 0:_.description}}};var N,R,O,E,M;d.parameters={...d.parameters,docs:{...(N=d.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Icon button',
  parameters: {
    ...DefaultParams.parameters,
  ...
  \`
}`,...(O=(R=d.parameters)==null?void 0:R.docs)==null?void 0:O.source},description:{story:"If a single `gds-icon` is the only child of a button, it will render as a circular icon button.",...(M=(E=d.parameters)==null?void 0:E.docs)==null?void 0:M.description}}};var U,V,W,X,C;o.parameters={...o.parameters,docs:{...(U=o.parameters)==null?void 0:U.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
...
keep the button clickable and then show an error message instead.`,...(C=(X=o.parameters)==null?void 0:X.docs)==null?void 0:C.description}}};var F,j,q,G,H;i.parameters={...i.parameters,docs:{...(F=i.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...(Q=(K=c.parameters)==null?void 0:K.docs)==null?void 0:Q.source},description:{story:"Text content will get truncated if it does not fit.",...(Z=(Y=c.parameters)==null?void 0:Y.docs)==null?void 0:Z.description}}};var tt,nt,at,rt,et;g.parameters={...g.parameters,docs:{...(tt=g.parameters)==null?void 0:tt.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...(at=(nt=g.parameters)==null?void 0:nt.docs)==null?void 0:at.source},description:{story:"Some aria attributes are forwarded to the inner button element by default, but if you want to force a certain\naria-attribute on the inner button, you can use the `gds-aria-*` attributes on the `gds-button` element.\n\nAlso note that `label` will render as `aria-label` on the inner button element.",...(et=(rt=g.parameters)==null?void 0:rt.docs)==null?void 0:et.description}}};const gt=["DefaultParams","Basic","RanksAndVariants","Sizes","WithIcon","IconButton","Disabled","Link","Length","Aria"];export{g as Aria,l as Basic,n as DefaultParams,o as Disabled,d as IconButton,c as Length,i as Link,r as RanksAndVariants,e as Sizes,s as WithIcon,gt as __namedExportsOrder,ct as default};
