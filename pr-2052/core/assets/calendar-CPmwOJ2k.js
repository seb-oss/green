import{m as w}from"./runtime-BL31MtW8.js";import{l as R}from"./localized-decorator-DtmrKsyB.js";import{i as I,x as m}from"./lit-element-Bx14lxc-.js";import{n as p,r as B,G as z,g as A}from"./custom-element-scoping-BOlwUH_F.js";import{a as P}from"./query-p8xgzTDt.js";import{e as j}from"./class-map-CXsQwv0r.js";import{o as T}from"./if-defined-CVqwUuaf.js";import{n as M}from"./when-BR7zwNJC.js";import{t as G}from"./tokens.style-Db3B8yEB.js";import{T as K}from"./transitional-styles-D9IvMC4x.js";import{w as U}from"./watch-tFciLXSI.js";function C(t){"@babel/helpers - typeof";return C=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},C(t)}function b(t){if(t===null||t===!0||t===!1)return NaN;var e=Number(t);return isNaN(e)?e:e<0?Math.ceil(e):Math.floor(e)}function f(t,e){if(e.length<t)throw new TypeError(t+" argument"+(t>1?"s":"")+" required, but only "+e.length+" present")}function c(t){f(1,arguments);var e=Object.prototype.toString.call(t);return t instanceof Date||C(t)==="object"&&e==="[object Date]"?new Date(t.getTime()):typeof t=="number"||e==="[object Number]"?new Date(t):((typeof t=="string"||e==="[object String]")&&typeof console<"u"&&(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn(new Error().stack)),new Date(NaN))}function k(t,e){f(2,arguments);var a=c(t),r=b(e);return isNaN(r)?new Date(NaN):(r&&a.setDate(a.getDate()+r),a)}function F(t,e){f(2,arguments);var a=c(t),r=b(e);if(isNaN(r))return new Date(NaN);if(!r)return a;var o=a.getDate(),s=new Date(a.getTime());s.setMonth(a.getMonth()+r+1,0);var i=s.getDate();return o>=i?s:(a.setFullYear(s.getFullYear(),s.getMonth(),o),a)}var q={};function W(){return q}function _(t,e){var a,r,o,s,i,u,l,n;f(1,arguments);var D=W(),v=b((a=(r=(o=(s=e==null?void 0:e.weekStartsOn)!==null&&s!==void 0?s:e==null||(i=e.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.weekStartsOn)!==null&&o!==void 0?o:D.weekStartsOn)!==null&&r!==void 0?r:(l=D.locale)===null||l===void 0||(n=l.options)===null||n===void 0?void 0:n.weekStartsOn)!==null&&a!==void 0?a:0);if(!(v>=0&&v<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var g=c(t),O=g.getDay(),$=(O<v?7:0)+O-v;return g.setDate(g.getDate()-$),g.setHours(0,0,0,0),g}function N(t){f(1,arguments);var e=c(t);return e.setHours(0,0,0,0),e}function V(t,e){f(2,arguments);var a=b(e),r=a*7;return k(t,r)}function y(t,e){f(2,arguments);var a=N(t),r=N(e);return a.getTime()===r.getTime()}function J(t){f(1,arguments);var e=c(t),a=e.getMonth();return e.setFullYear(e.getFullYear(),a+1,0),e.setHours(23,59,59,999),e}function Q(t,e){var a;f(1,arguments);var r=t||{},o=c(r.start),s=c(r.end),i=s.getTime();if(!(o.getTime()<=i))throw new RangeError("Invalid interval");var u=[],l=o;l.setHours(0,0,0,0);var n=Number((a=void 0)!==null&&a!==void 0?a:1);if(n<1||isNaN(n))throw new RangeError("`options.step` must be a number greater than 1");for(;l.getTime()<=i;)u.push(c(l)),l.setDate(l.getDate()+n),l.setHours(0,0,0,0);return u}function X(t,e){f(1,arguments);var a=t||{},r=c(a.start),o=c(a.end),s=o.getTime();if(!(r.getTime()<=s))throw new RangeError("Invalid interval");var i=_(r,e),u=_(o,e);i.setHours(15),u.setHours(15),s=u.getTime();for(var l=[],n=i;n.getTime()<=s;)n.setHours(0),l.push(c(n)),n=V(n,1),n.setHours(15);return l}function Z(t){f(1,arguments);var e=c(t);return e.setDate(1),e.setHours(0,0,0,0),e}function ee(t,e){var a,r,o,s,i,u;f(1,arguments);var l=c(t),n=l.getFullYear(),D=W(),v=b((a=(r=(o=(s=void 0)!==null&&s!==void 0?s:void 0)!==null&&o!==void 0?o:D.firstWeekContainsDate)!==null&&r!==void 0?r:(i=D.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&a!==void 0?a:1);if(!(v>=1&&v<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var g=new Date(0);g.setFullYear(n+1,0,v),g.setHours(0,0,0,0);var O=_(g,e),$=new Date(0);$.setFullYear(n,0,v),$.setHours(0,0,0,0);var L=_($,e);return l.getTime()>=O.getTime()?n+1:l.getTime()>=L.getTime()?n:n-1}function te(t,e){var a,r,o,s,i,u;f(1,arguments);var l=W(),n=b((a=(r=(o=(s=void 0)!==null&&s!==void 0?s:void 0)!==null&&o!==void 0?o:l.firstWeekContainsDate)!==null&&r!==void 0?r:(i=l.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&a!==void 0?a:1),D=ee(t,e),v=new Date(0);v.setFullYear(D,0,n),v.setHours(0,0,0,0);var g=_(v,e);return g}var ae=6048e5;function re(t,e){f(1,arguments);var a=c(t),r=_(a,e).getTime()-te(a,e).getTime();return Math.round(r/ae)+1}function se(t){f(1,arguments);var e=c(t),a=e.getMonth();return e.setFullYear(e.getFullYear(),a+1,0),e.setHours(0,0,0,0),e}function oe(t,e){f(2,arguments);var a=c(t),r=c(e);return a.getFullYear()===r.getFullYear()&&a.getMonth()===r.getMonth()}function ne(t,e){f(2,arguments);var a=c(t),r=b(e);return a.setHours(r),a}function ie(t,e){f(2,arguments);var a=b(e);return F(t,-a)}const le=I`
  @layer base, reset;
        ...
        ${de(this.focusedDate,e=>m`
            ${e.map(a=>m`
                <tr role="row">
                  ...
                  ${a.days.map(r=>{const o=this.customizedDates&&this.customizedDates.find(v=>y(v.date,r)),s={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(v=>y(v,r))),...o},i=!oe(this.focusedDate,r),u=(r<this.min||r>this.max)&&!y(r,this.min)&&!y(r,this.max),l=r.getDay()===0||r.getDay()===6,n=s.disabled||i||u||this.disabledWeekends&&l;return this.hideExtraneousDays&&i?m`<td inert></td>`:m`
                          <td
                            role="${T(n?void 0:"gridcell")}"
                            class="${j({"custom-date":!!o,disabled:!!n,today:y(t,r)})}"
                            ?disabled=${n}
