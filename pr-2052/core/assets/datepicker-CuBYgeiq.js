import{m as c}from"./runtime-BL31MtW8.js";import{l as Vt}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Ot,E as Dt}from"./lit-element-Bx14lxc-.js";import{n as b,r as H,G as Rt,h as M,g as St}from"./custom-element-scoping-BOlwUH_F.js";import{e as Bt,a as Gt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{o as qt}from"./field-base-0clmOCSV.js";import{e as Ft,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as E,r as A,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as V}from"./when-BR7zwNJC.js";import{t as jt}from"./tokens.style-Db3B8yEB.js";import{T as Qt}from"./transitional-styles-D9IvMC4x.js";import{w as yt}from"./watch-tFciLXSI.js";import{d as $t,a as te}from"./attribute-converters-CdI0trPX.js";import{w as ee,b as se,d as ae}from"./declarative-layout-mixins-CvhbdVQ9.js";import{a as ie}from"./button-DC9S9tme.js";import"./flex-COKa8ndQ.js";import"./option-BERNrmk2.js";import"./menu-heading-DQK3Mkeh.js";import{i as ne}from"./calendar-CPmwOJ2k.js";import"./calender-add-DC5_q3rF.js";import"./chevron-right-DWqOHJ5_.js";import"./popover-CpyhYS8Q.js";import"./backdrop-zpEJm7mF.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},he=Ft(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let o=0;for(const d of t)a[o]=i?i(d,o):o,n[o]=s(d,o),o++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=o,n;const d=this.ut??(this.ut=[]),r=[];let k,C,l=0,$=a.length-1,f=0,x=n.length-1;for(;l<=$&&f<=x;)if(a[l]===null)l++;else if(a[$]===null)$--;else if(d[l]===o[f])r[f]=E(a[l],n[f]),l++,f++;else if(d[$]===o[x])r[x]=E(a[$],n[x]),$--,x--;else if(d[l]===o[x])r[x]=E(a[l],n[x]),A(t,r[x+1],a[l]),l++,x--;else if(d[$]===o[f])r[f]=E(a[$],n[f]),A(t,a[l],a[$]),$--,f++;else if(k===void 0&&(k=kt(o,f,x),C=kt(d,l,$)),k.has(d[l]))if(k.has(d[$])){const S=C.get(o[f]),J=S!==void 0?a[S]:null;if(J===null){const xt=A(t,a[l]);E(xt,n[f]),r[f]=xt}else r[f]=E(J,n[f]),A(t,a[l],J),a[S]=null;f++}else U(a[$]),$--;else U(a[l]),l++;for(;f<=x;){const S=A(t,r[x+1]);E(S,n[f]),r[f++]=S}for(;l<=$;){const S=a[l++];S!==null&&U(S)}return this.ut=o,Zt(t,r),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
