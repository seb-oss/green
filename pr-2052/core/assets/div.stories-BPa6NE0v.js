import{x as f}from"./lit-element-BTGJPccZ.js";import{a as h}from"./argTableProps-DJ3osy8N.js";import"./custom-elements-WCmTfZl-.js";const j={title:"Components/Div",component:"gds-div",tags:["autodocs"],argTypes:{...h("gds-div")},parameters:{docs:{description:{component:"@status beta\n\n`gds-div` is a base element in the declarative layout system. It accepts all available style expression properties, and is also the base class for `gds-flex`, `gds-grid`, `gds-card` and `gds-text`"}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},d={...s},r={...s,render:y=>f`
  ...
  `},e={...s,name:"Border Style",render:y=>f`<gds-grid columns="5" gap="l">
    ...
    </gds-grid>`};var t,a,o;d.parameters={...d.parameters,docs:{...(t=d.parameters)==null?void 0:t.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(o=(a=d.parameters)==null?void 0:a.docs)==null?void 0:o.source}}};var n,i,c,l,g;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <!-- This is equivalent to 'gds-flex' -->
    <gds-div
