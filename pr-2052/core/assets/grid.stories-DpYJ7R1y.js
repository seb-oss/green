import{x as n}from"./lit-element-BTGJPccZ.js";import{a as w}from"./argTableProps-BOQIcpJQ.js";import"./custom-elements-y0QWBBgU.js";const V={title:"Components/Grid",component:"gds-grid",tags:["autodocs"],parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grid)\n\nThe `gds-grid` is a custom element that provides a flexible grid system. It uses CSS grid layout to arrange its child elements into columns. This component is highly customizable and responsive, allowing you to specify the number of `columns`, `gap`, `padding`, and fluidity for different devices with automated column size based on the content using the `auto-columns` attribute."}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{...w("gds-grid")},args:{gap:"m",padding:"0",columns:"4",innerHTML:`
  ...
  `},s={...t,name:"Breakpoints + Auto Columns",render:i=>n`
    <!-- prettier-ignore -->
  ...
  `},r={...t,name:"Auto Columns",render:i=>n`
    <!-- prettier-ignore -->
  ...
  `};var a,c,g;d.parameters={...d.parameters,docs:{...(a=d.parameters)==null?void 0:a.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(g=(c=d.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var o,l,h,x,m;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <!-- prettier-ignore -->
    <gds-grid
...
The \`auto-columns\` attribute is set to \`240\` which will make the columns to be \`240px\` no matter the screen/container size.`,...(O=(j=r.parameters)==null?void 0:j.docs)==null?void 0:O.description}}};const z=["Basic","Usage","AllBreakpoints","AutoColumns"];export{s as AllBreakpoints,r as AutoColumns,d as Basic,e as Usage,z as __namedExportsOrder,V as default};
