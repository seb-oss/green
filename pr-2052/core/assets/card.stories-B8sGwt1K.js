...
@extends \`gds-div\``}}}},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{disable:!0}}},a={...n,args:{innerHTML:"Card content",style:"max-width: 200px"}},d={...n,render:i=>t`
...
}`,...(c=(g=a.parameters)==null?void 0:g.docs)==null?void 0:c.source}}};var l,m,u,p,x;d.parameters={...d.parameters,docs:{...(l=d.parameters)==null?void 0:l.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-flex gap="l" flex-direction="column">
      <gds-card variant="secondary" border-color="primary">
  ...
  \`
}`,...(u=(m=d.parameters)==null?void 0:m.docs)==null?void 0:u.source},description:{story:"Examples of different color variants",...(x=(p=d.parameters)==null?void 0:p.docs)==null?void 0:x.description}}};var f,v,b,h,y;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-grid columns="xs{1} m{3} l{3}" gap="l">
      <gds-card
