import{i as D,x as m}from"./lit-element-Bx14lxc-.js";import{n,G as be,h as x,g as A,r as Ce}from"./custom-element-scoping-BOlwUH_F.js";import{w as G}from"./watch-tFciLXSI.js";import{l as me}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{e as ve}from"./class-map-CXsQwv0r.js";import{t as fe}from"./tokens.style-Db3B8yEB.js";import{T as De}from"./transitional-styles-D9IvMC4x.js";import{a as Ae}from"./query-p8xgzTDt.js";import{d as Ge,b as $e,w as Te}from"./declarative-layout-mixins-CvhbdVQ9.js";import{a as Pe}from"./button-DC9S9tme.js";import"./form-control-footer-CmSOcy4e.js";import"./flex-COKa8ndQ.js";import"./card-qmuy8_pa.js";import"./text-Ddpzuayr.js";import"./divider-CxcwHycs.js";import"./circle-check-BaSmYSap.js";import"./cross-small-B7-HgGqq.js";import{a as Oe}from"./argTableProps-TPHCbZ2t.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./static-B8S6DEnV.js";import"./observe-light-dom-CmJPHUQ4.js";import"./triangle-exclamation-Dt6bLdUK.js";import"./icon-BqRznh8Y.js";import"./badge-Brdw-L5K.js";import"./div-D-66otxp.js";import"./custom-elements-DSJaHGoJ.js";const Fe=D`
...
`;var qe=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,$=(e,t,a,o)=>{for(var r=o>1?void 0:o?Ve(t,a):t,l=e.length-1,p;l>=0;l--)(p=e[l])&&(r=(o?p(t,a,r):p(r))||r);return o&&r&&qe(t,a,r),r};let b=class extends be{constructor(){super(),this.label="",this.supportingText=""}connectedCallback(){super.connectedCallback(),De.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,"has-supporting-text":!!this.supportingText};return x`
    ...
    `}};R=new WeakMap;S=new WeakMap;d.styles=[Fe];u([n()],d.prototype,"label",2);u([n({attribute:"supporting-text"})],d.prototype,"supportingText",2);u([n()],d.prototype,"value",2);u([n({type:Boolean,reflect:!0})],d.prototype,"checked",2);u([n({type:Boolean,reflect:!0})],d.prototype,"disabled",2);u([n({type:Boolean})],d.prototype,"invalid",2);u([Ce()],d.prototype,"_isFocused",2);u([G("disabled")],d.prototype,"_handleDisabledChange",1);d=u([A("gds-radio")],d);d.define();const He=D`
  :host {
...
`;var Ne=Object.defineProperty,je=Object.getOwnPropertyDescriptor,_e=e=>{throw TypeError(e)},c=(e,t,a,o)=>{for(var r=o>1?void 0:o?je(t,a):t,l=e.length-1,p;l>=0;l--)(p=e[l])&&(r=(o?p(t,a,r):p(r))||r);return o&&r&&Ne(t,a,r),r},Ke=(e,t,a)=>t.has(e)||_e("Cannot "+a),Ue=(e,t,a)=>t.has(e)?_e("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),i=(e,t,a)=>(Ke(e,t,"access private method"),a),s,z,we,T,Le,Ee,k,Re,Se,ze,ke;let g=class extends Pe{constructor(){super(...arguments),Ue(this,s),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),i(this,s,z).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{i(this,s,z).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return x`<div
    ...
    </div>`}};s=new WeakSet;z=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))};we=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(a=>a.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(a=>a.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};T=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))};Le=function(e){const t=e.target;t.hasAttribute("value")&&(this.value=t.value,this._syncRadioStates(),i(this,s,T).call(this))};Ee=function(e){if(!this._isConnected)return;const t=this.radios.filter(o=>!o.hasAttribute("disabled"));if(t.length===0)return;let a=t.findIndex(o=>document.activeElement===o);switch(a===-1&&(a=t.findIndex(o=>o.checked),a===-1&&(a=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const o=(a+1)%t.length;i(this,s,k).call(this,t[o]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const o=(a-1+t.length)%t.length;i(this,s,k).call(this,t[o]);break}default:return}};k=function(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),i(this,s,T).call(this))};Re=function(){return[i(this,s,Se).call(this),i(this,s,ze).call(this),i(this,s,ke).call(this)].map(t=>x`${t}`)};Se=function(){if(this.label)return x` <gds-form-control-header class="size-${this.size}">
    ...
    >
    </gds-form-control-footer>`};g.styles=[fe,He];c([n()],g.prototype,"size",2);c([n()],g.prototype,"direction",2);c([n({attribute:"supporting-text"})],g.prototype,"supportingText",2);c([n({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],g.prototype,"showExtendedSupportingText",2);c([Ae(".content")],g.prototype,"_contentElement",2);c([G("value")],g.prototype,"_handleValueChange",1);c([G("invalid")],g.prototype,"_syncRadioStates",1);g=c([me()],g);let C=class extends Ge($e(Te(g))){};C=c([A("gds-radio-group")],C);C.define();const Rt={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],argTypes:{...Oe("gds-radio-group")},parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},h={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},v={...h,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},f={...h,name:"Validation",render:()=>m`
    <form method="dialog">
  ...
  `},E={...h,name:"Do's and dont's",render:()=>m`
    <gds-flex gap="xl">
  ...
  `},L={...h,name:"Radio group label",render:()=>m`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
...
In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};var te,ae,oe,re,se;_.parameters={..._.parameters,docs:{...(te=_.parameters)==null?void 0:te.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
...
The size can be set on the radio group and applies to all radio buttons within.`,...(se=(re=_.parameters)==null?void 0:re.docs)==null?void 0:se.description}}};var ie,de,ne,le,pe;w.parameters={...w.parameters,docs:{...(ie=w.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
...
In certain cases when space is limited, the group label can be omitted.`,...(he=(xe=L.parameters)==null?void 0:xe.docs)==null?void 0:he.description}}};const St=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{w as Direction,y as Disabled,E as DosAndDonts,L as GroupLabel,v as RadioButton,_ as Size,f as Validation,St as __namedExportsOrder,Rt as default};
