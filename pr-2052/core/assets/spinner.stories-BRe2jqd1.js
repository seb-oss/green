import{i as Y,x as a}from"./lit-element-Bx14lxc-.js";import{o as Z}from"./if-defined-CVqwUuaf.js";import{m as ee}from"./runtime-BL31MtW8.js";import{l as te}from"./localized-decorator-DtmrKsyB.js";import{h as w,n as m,r as se,G as ne,g as re}from"./custom-element-scoping-BOlwUH_F.js";import{e as ie}from"./class-map-CXsQwv0r.js";import{n as oe}from"./when-BR7zwNJC.js";import{t as ae}from"./tokens.style-Db3B8yEB.js";import{w as N}from"./watch-tFciLXSI.js";import{b as de,e as le,d as ce}from"./declarative-layout-mixins-CvhbdVQ9.js";import"./div-D-66otxp.js";import"./flex-COKa8ndQ.js";import"./text-Ddpzuayr.js";import"./card-qmuy8_pa.js";import"./theme-BCPwF-1y.js";import"./button-DC9S9tme.js";import"./divider-CxcwHycs.js";import{a as ge}from"./argTableProps-TPHCbZ2t.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./static-B8S6DEnV.js";import"./transitional-styles-D9IvMC4x.js";import"./query-p8xgzTDt.js";import"./observe-light-dom-CmJPHUQ4.js";import"./custom-elements-DSJaHGoJ.js";const pe=Y`
...
`;var me=Object.defineProperty,he=Object.getOwnPropertyDescriptor,Q=e=>{throw TypeError(e)},i=(e,t,s,o)=>{for(var n=o>1?void 0:o?he(t,s):t,h=e.length-1,f;h>=0;h--)(f=e[h])&&(n=(o?f(t,s,n):f(n))||n);return o&&n&&me(t,s,n),n},b=(e,t,s)=>t.has(e)||Q("Cannot "+s),y=(e,t,s)=>(b(e,t,"read from private field"),s?s.call(e):t.get(e)),k=(e,t,s)=>t.has(e)?Q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),ue=(e,t,s,o)=>(b(e,t,"write to private field"),t.set(e,s),s),xe=(e,t,s)=>(b(e,t,"access private method"),s),v,X,p;let r=class extends de(le(ce(ne))){constructor(){super(...arguments),k(this,v),this.label=ee("Loading..."),this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="md",this._isAnimating=!1,k(this,p,{overflow:"visible",overscrollBehavior:"auto"})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchEvent(new CustomEvent("gds-spinner-connected"))}disconnectedCallback(){super.disconnectedCallback(),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1,super.disconnectedCallback()}_updateAriaLabel(){this.setAttribute("aria-label",this.label)}render(){return w`
    ...
    `}_toggleRootStyles(){const{style:e}=document.documentElement;this.fullscreen?(ue(this,p,{overflow:e.overflow,overscrollBehavior:e.overscrollBehavior}),e.overflow="hidden",e.overscrollBehavior="none"):(e.overflow=y(this,p).overflow,e.overscrollBehavior=y(this,p).overscrollBehavior)}};v=new WeakSet;X=function(){return{"spinner-wrapper":!0,"spinner-fullscreen":this.fullscreen,"spinner-cover":this.cover,"spinner-backdrop":this.cover||this.fullscreen,"spinner-animating":this._isAnimating}};p=new WeakMap;r.styles=[ae,pe];i([m({type:String})],r.prototype,"label",2);i([m({type:Boolean,reflect:!0})],r.prototype,"showLabel",2);i([m({type:Boolean,reflect:!0})],r.prototype,"cover",2);i([m({type:Boolean,reflect:!0})],r.prototype,"fullscreen",2);i([m({type:String,reflect:!0})],r.prototype,"size",2);i([se()],r.prototype,"_isAnimating",2);i([N("label")],r.prototype,"_updateAriaLabel",1);i([N("fullscreen")],r.prototype,"_toggleRootStyles",1);r=i([re("gds-spinner"),te()],r);r.define();const He={title:"Components/Spinner",component:"gds-spinner",tags:["autodocs"],argTypes:{...ge("gds-textarea")},parameters:{docs:{description:{component:`A loading indicator component that supports various sizes and display modes.
...
to inherit the text color.`,...(K=(J=g.parameters)==null?void 0:J.docs)==null?void 0:K.description}}};const je=["Playground","Sizes","LabelOptions","Cover","Fullscreen","ThemeModes"];export{l as Cover,c as Fullscreen,d as LabelOptions,u as Playground,x as Sizes,g as ThemeModes,je as __namedExportsOrder,He as default};
