import{x as r}from"./lit-element-BTGJPccZ.js";import{a as P}from"./argTableProps-Cat1BhaE.js";import"./custom-elements-D30eliN0.js";const A={title:"Components/Filter Chips",component:"gds-filter-chips",subcomponents:{FilterChip:"gds-filter-chip"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/filter-chips)
&nbsp;|&nbsp;
...
<gds-filter-chip value="3">Item 3</gds-filter-chip>`}},l={...s},e={...s,render:a=>r`
  ...
  `};var n,c,o;l.parameters={...l.parameters,docs:{...(n=l.parameters)==null?void 0:n.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(o=(c=l.parameters)==null?void 0:c.docs)==null?void 0:o.source}}};var p,d,h,g,u;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-filter-chips
      value="top-news"
...
will be used to set \`aria-label\` for the appropriate element.`,...(u=(g=e.parameters)==null?void 0:g.docs)==null?void 0:u.description}}};var f,m,v,w,b;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...
  \`
}`,...(T=(C=t.parameters)==null?void 0:C.docs)==null?void 0:T.source},description:{story:"In some cases, layout constraints may require the filter chips to collapse into a single row.\n\nSetting the `row-collapse` attribute will enable this behavior when the chips require more than two rows. Instead, scrolling overflow will be used to accommodate the chips.",...(S=(I=t.parameters)==null?void 0:I.docs)==null?void 0:S.description}}};const L=["Basic","Usage","MultiSelect","RowCollapse"];export{l as Basic,i as MultiSelect,t as RowCollapse,e as Usage,L as __namedExportsOrder,A as default};
