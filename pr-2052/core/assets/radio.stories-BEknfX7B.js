import{x as t}from"./lit-element-BTGJPccZ.js";import{a as _}from"./argTableProps-Cat1BhaE.js";import"./custom-elements-D30eliN0.js";const j={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],argTypes:{..._("gds-radio-group")},parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},a={...e,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
  ...
  `};var p,g,u,x,c;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Radio',
  args: {
...
Interactive example with supporting texts:`,...(c=(x=a.parameters)==null?void 0:x.docs)==null?void 0:c.description}}};var m,b,f,v,h;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Validation',
  render: () => html\`
    <form method="dialog">
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...(h=(v=o.parameters)==null?void 0:v.docs)==null?void 0:h.description}}};var L,R,E;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...
  \`
}`,...(E=(R=i.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};var w,S,y,D,G;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(y=(S=d.parameters)==null?void 0:S.docs)==null?void 0:y.source},description:{story:`Disabled radio buttons cannot be interacted with and appear visually muted.

In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(G=(D=d.parameters)==null?void 0:D.docs)==null?void 0:G.description}}};var z,P,T,k,q;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(T=(P=r.parameters)==null?void 0:P.docs)==null?void 0:T.source},description:{story:`Radio buttons support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the radio group and applies to all radio buttons within.`,...(q=(k=r.parameters)==null?void 0:k.docs)==null?void 0:q.description}}};var O,I,C,V,A;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
...
In certain cases when space is limited, the group label can be omitted.`,...(M=(B=n.parameters)==null?void 0:B.docs)==null?void 0:M.description}}};const J=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{s as Direction,d as Disabled,i as DosAndDonts,n as GroupLabel,a as RadioButton,r as Size,o as Validation,J as __namedExportsOrder,j as default};
