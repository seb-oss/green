        ...
        <gds-div overflow="auto">
          ...
          >
            <gds-button
              rank="tertiary"
              size="small"
              @click=${e=>{e.stopPropagation(),this.value=void 0,this.open=!1,(0,chunk_SEHSDSX2.jq)(this,chunk_HJ4EUFPL_dispatchChangeEvent,chunk_HJ4EUFPL_dispatchChangeEvent_fn).call(this)}}
            >
