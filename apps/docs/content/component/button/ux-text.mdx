...
<Grid columns="3">
<Figma id="standard-next" caption="Next <SE>(Nästa)</SE>" />
<Figma id="standard-back" caption="Back <SE>(Tillbaka)</SE>" />
<Figma id="standard-cancel" caption="Cancel <SE>(Avbryt)</SE>" />
<Figma id="standard-delete" caption="Delete <SE>(Ta bort)</SE>" />
<Figma id="standard-change" caption="Change <SE>(Ändra)</SE> – takes the user to edit mode." />
<Figma id="standard-save" caption="Save <SE>(Spara)</SE>" />
<Figma id="standard-close" caption="Close <SE>(Stäng)</SE> – closing a dialog, modal, slide-out etc." />
<Figma id="standard-sign" caption="Sign <SE>(Signera)</SE> – signing with BankID." />
<Figma id="standard-identify" caption="Identify yourself <SE>(Identifiera dig)</SE> – identifying with BankID." />
</Grid>
