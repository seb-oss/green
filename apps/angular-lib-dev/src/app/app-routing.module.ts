...
const routes: Routes = [
  { path: '', redirectTo: 'segmented-control', pathMatch: 'full' },
  {
    ...
    loadChildren: () => import('./segmented-control/segmented-control.module').then(m => m.SegmentedControlModule)
  },
  {
    path: 'pagination',
  ...
  },
  {
    ...
    loadChildren: () => import('./sortable-list/sortable-list.module').then(m => m.SortableListModule)
  },
