  ...
  render() {
    return html`
      <gds-flex flex-direction="column">
        ...
        >
          <tp-steps
            @click=${() => (this.hasExternalAccounts = true)}
          ></tp-steps>
        </tp-page-section>
        ...
        <tp-page-section .show=${this.hasExternalAccounts}>
          <gds-grid
            ...
            margin="0 auto"
            gap="l"
            padding="m; s{2xl 2xl l 2xl}; m{2xl}"
          >
            <tp-empty-konton
        ...
        <gds-flex
          padding="m; s{0 2xl 2xl 2xl}; m{2xl}"
          gap="l; m{4xl}"
        ...
        >
          ...
          <tp-page-section .show=${this.hasAccounts}>
            ...
            <gds-grid display="contents; m{grid}" columns="1; m{12}" gap="l">
              <gds-flex
