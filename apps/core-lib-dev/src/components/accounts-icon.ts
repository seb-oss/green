...
@customElement('tp-accounts-icon')
        ...
        <gds-flex flex-direction="column" gap="l" padding="0 0 l 0">
          <div class="car" gap="s">
            <tp-accounts-card @click=${this.handleCardClick} name="negative">
              ...
              <gds-text font-size="heading-xs">Livsmedel</gds-text>
              <gds-text font-size="heading-xs">ICA</gds-text>
              <gds-text font-size="heading-xs">- 1000 kr</gds-text>
            </tp-accounts-card>
