...
@customElement('gds-carousel-v2')
export class GdsCarouselv2 extends LitElement {
  connectedCallback() {
    ...
    return html` <style>
      ...
      <gds-card variant="primary" padding="0 0 m 0"
        ><gds-flex padding="m m 0 m" justify-content="space-between"
          ><gds-text font-size="preamble-s" tag="h3">Transaktioner v2</gds-text
        ...
        >
          ...
          >
            <gds-flex place-items="center" flex-direction="column">
              <gds-card background="inherit" padding="0 0 m 0">${this.renderIca()}</gds-card>
              <gds-text font-size="detail-s" tag="p">Livsmedel</gds-text
              ><gds-card background="inherit" padding="0" margin="3xs 0 2xs 0"
            ...
            ></gds-card
          ></gds-button>
          <gds-card class="item" padding="0" min-width="80%">
            <gds-flex place-items="center" flex-direction="column">
