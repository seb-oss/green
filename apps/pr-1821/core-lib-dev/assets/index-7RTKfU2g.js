var Al=e=>{throw TypeError(e)};var Ol=(e,t,s)=>t.has(e)||Al("Cannot "+s);var $t=(e,t,s)=>(Ol(e,t,"read from private field"),s?s.call(e):t.get(e)),Qt=(e,t,s)=>t.has(e)?Al("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s);var An=(e,t,s)=>(Ol(e,t,"access private method"),s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ur=globalThis,La=ur.ShadowRoot&&(ur.ShadyCSS===void 0||ur.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Id=Symbol(),Ll=new WeakMap;let hg=class{constructor(t,s,o){if(this._$cssResult$=!0,o!==Id)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(La&&t===void 0){const o=s!==void 0&&s.length===1;o&&(t=Ll.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&Ll.set(s,t))}return t}toString(){return this.cssText}};const pg=e=>new hg(typeof e=="string"?e:e+"",void 0,Id),ug=(e,t)=>{if(La)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const o=document.createElement("style"),r=ur.litNonce;r!==void 0&&o.setAttribute("nonce",r),o.textContent=s.cssText,e.appendChild(o)}},Dl=La?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const o of t.cssRules)s+=o.cssText;return pg(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:fg,defineProperty:mg,getOwnPropertyDescriptor:vg,getOwnPropertyNames:bg,getOwnPropertySymbols:xg,getPrototypeOf:yg}=Object,ht=globalThis,Vl=ht.trustedTypes,wg=Vl?Vl.emptyScript:"",On=ht.reactiveElementPolyfillSupport,Ns=(e,t)=>e,Hr={toAttribute(e,t){switch(t){case Boolean:e=e?wg:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},Da=(e,t)=>!fg(e,t),Pl={attribute:!0,type:String,converter:Hr,reflect:!1,hasChanged:Da};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ht.litPropertyMetadata??(ht.litPropertyMetadata=new WeakMap);let Ts=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Pl){if(s.state&&(s.attribute=!1),this._$Ei(),this.elementProperties.set(t,s),!s.noAccessor){const o=Symbol(),r=this.getPropertyDescriptor(t,o,s);r!==void 0&&mg(this.prototype,t,r)}}static getPropertyDescriptor(t,s,o){const{get:r,set:n}=vg(this.prototype,t)??{get(){return this[s]},set(i){this[s]=i}};return{get(){return r==null?void 0:r.call(this)},set(i){const l=r==null?void 0:r.call(this);n.call(this,i),this.requestUpdate(t,l,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Pl}static _$Ei(){if(this.hasOwnProperty(Ns("elementProperties")))return;const t=yg(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Ns("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ns("properties"))){const s=this.properties,o=[...bg(s),...xg(s)];for(const r of o)this.createProperty(r,s[r])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[o,r]of s)this.elementProperties.set(o,r)}this._$Eh=new Map;for(const[s,o]of this.elementProperties){const r=this._$Eu(s,o);r!==void 0&&this._$Eh.set(r,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const o=new Set(t.flat(1/0).reverse());for(const r of o)s.unshift(Dl(r))}else t!==void 0&&s.push(Dl(t));return s}static _$Eu(t,s){const o=s.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(s=>s(this))}addController(t){var s;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((s=t.hostConnected)==null||s.call(t))}removeController(t){var s;(s=this._$EO)==null||s.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const o of s.keys())this.hasOwnProperty(o)&&(t.set(o,this[o]),delete this[o]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ug(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(s=>{var o;return(o=s.hostConnected)==null?void 0:o.call(s)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(s=>{var o;return(o=s.hostDisconnected)==null?void 0:o.call(s)})}attributeChangedCallback(t,s,o){this._$AK(t,o)}_$EC(t,s){var n;const o=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,o);if(r!==void 0&&o.reflect===!0){const i=(((n=o.converter)==null?void 0:n.toAttribute)!==void 0?o.converter:Hr).toAttribute(s,o.type);this._$Em=t,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$Em=null}}_$AK(t,s){var n;const o=this.constructor,r=o._$Eh.get(t);if(r!==void 0&&this._$Em!==r){const i=o.getPropertyOptions(r),l=typeof i.converter=="function"?{fromAttribute:i.converter}:((n=i.converter)==null?void 0:n.fromAttribute)!==void 0?i.converter:Hr;this._$Em=r,this[r]=l.fromAttribute(s,i.type),this._$Em=null}}requestUpdate(t,s,o){if(t!==void 0){if(o??(o=this.constructor.getPropertyOptions(t)),!(o.hasChanged??Da)(this[t],s))return;this.P(t,s,o)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,s,o){this._$AL.has(t)||this._$AL.set(t,s),o.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var o;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[n,i]of this._$Ep)this[n]=i;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[n,i]of r)i.wrapped!==!0||this._$AL.has(n)||this[n]===void 0||this.P(n,this[n],i)}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(o=this._$EO)==null||o.forEach(r=>{var n;return(n=r.hostUpdate)==null?void 0:n.call(r)}),this.update(s)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(s)}willUpdate(t){}_$AE(t){var s;(s=this._$EO)==null||s.forEach(o=>{var r;return(r=o.hostUpdated)==null?void 0:r.call(o)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(s=>this._$EC(s,this[s]))),this._$EU()}updated(t){}firstUpdated(t){}};Ts.elementStyles=[],Ts.shadowRootOptions={mode:"open"},Ts[Ns("elementProperties")]=new Map,Ts[Ns("finalized")]=new Map,On==null||On({ReactiveElement:Ts}),(ht.reactiveElementVersions??(ht.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gs=globalThis,Fr=Gs.trustedTypes,Hl=Fr?Fr.createPolicy("lit-html",{createHTML:e=>e}):void 0,Va="$lit$",Je=`lit$${Math.random().toFixed(9).slice(2)}$`,Pa="?"+Je,_g=`<${Pa}>`,jt=document,Ys=()=>jt.createComment(""),qs=e=>e===null||typeof e!="object"&&typeof e!="function",Ha=Array.isArray,Nd=e=>Ha(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",Ln=`[ 	
\f\r]`,zs=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Fl=/-->/g,jl=/>/g,St=RegExp(`>|${Ln}(?:([^\\s"'>=/]+)(${Ln}*=${Ln}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Wl=/'/g,Rl=/"/g,Gd=/^(?:script|style|textarea|title)$/i,Cg=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),ge=Cg(1),ze=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),Bl=new WeakMap,Lt=jt.createTreeWalker(jt,129);function Zd(e,t){if(!Ha(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Hl!==void 0?Hl.createHTML(t):t}const Ud=(e,t)=>{const s=e.length-1,o=[];let r,n=t===2?"<svg>":t===3?"<math>":"",i=zs;for(let l=0;l<s;l++){const d=e[l];let h,v,p=-1,x=0;for(;x<d.length&&(i.lastIndex=x,v=i.exec(d),v!==null);)x=i.lastIndex,i===zs?v[1]==="!--"?i=Fl:v[1]!==void 0?i=jl:v[2]!==void 0?(Gd.test(v[2])&&(r=RegExp("</"+v[2],"g")),i=St):v[3]!==void 0&&(i=St):i===St?v[0]===">"?(i=r??zs,p=-1):v[1]===void 0?p=-2:(p=i.lastIndex-v[2].length,h=v[1],i=v[3]===void 0?St:v[3]==='"'?Rl:Wl):i===Rl||i===Wl?i=St:i===Fl||i===jl?i=zs:(i=St,r=void 0);const w=i===St&&e[l+1].startsWith("/>")?" ":"";n+=i===zs?d+_g:p>=0?(o.push(h),d.slice(0,p)+Va+d.slice(p)+Je+w):d+Je+(p===-2?l:w)}return[Zd(e,n+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),o]};class Ks{constructor({strings:t,_$litType$:s},o){let r;this.parts=[];let n=0,i=0;const l=t.length-1,d=this.parts,[h,v]=Ud(t,s);if(this.el=Ks.createElement(h,o),Lt.currentNode=this.el.content,s===2||s===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=Lt.nextNode())!==null&&d.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(const p of r.getAttributeNames())if(p.endsWith(Va)){const x=v[i++],w=r.getAttribute(p).split(Je),$=/([.?@])?(.*)/.exec(x);d.push({type:1,index:n,name:$[2],strings:w,ctor:$[1]==="."?qd:$[1]==="?"?Kd:$[1]==="@"?Xd:Qo}),r.removeAttribute(p)}else p.startsWith(Je)&&(d.push({type:6,index:n}),r.removeAttribute(p));if(Gd.test(r.tagName)){const p=r.textContent.split(Je),x=p.length-1;if(x>0){r.textContent=Fr?Fr.emptyScript:"";for(let w=0;w<x;w++)r.append(p[w],Ys()),Lt.nextNode(),d.push({type:2,index:++n});r.append(p[x],Ys())}}}else if(r.nodeType===8)if(r.data===Pa)d.push({type:2,index:n});else{let p=-1;for(;(p=r.data.indexOf(Je,p+1))!==-1;)d.push({type:7,index:n}),p+=Je.length-1}n++}}static createElement(t,s){const o=jt.createElement("template");return o.innerHTML=t,o}}function Wt(e,t,s=e,o){var i,l;if(t===ze)return t;let r=o!==void 0?(i=s._$Co)==null?void 0:i[o]:s._$Cl;const n=qs(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==n&&((l=r==null?void 0:r._$AO)==null||l.call(r,!1),n===void 0?r=void 0:(r=new n(e),r._$AT(e,s,o)),o!==void 0?(s._$Co??(s._$Co=[]))[o]=r:s._$Cl=r),r!==void 0&&(t=Wt(e,r._$AS(e,t.values),r,o)),t}let Yd=class{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:o}=this._$AD,r=((t==null?void 0:t.creationScope)??jt).importNode(s,!0);Lt.currentNode=r;let n=Lt.nextNode(),i=0,l=0,d=o[0];for(;d!==void 0;){if(i===d.index){let h;d.type===2?h=new Cs(n,n.nextSibling,this,t):d.type===1?h=new d.ctor(n,d.name,d.strings,this,t):d.type===6&&(h=new Jd(n,this,t)),this._$AV.push(h),d=o[++l]}i!==(d==null?void 0:d.index)&&(n=Lt.nextNode(),i++)}return Lt.currentNode=jt,r}p(t){let s=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,s),s+=o.strings.length-2):o._$AI(t[s])),s++}};class Cs{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,s,o,r){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=o,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=Wt(this,t,s),qs(t)?t===N||t==null||t===""?(this._$AH!==N&&this._$AR(),this._$AH=N):t!==this._$AH&&t!==ze&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Nd(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==N&&qs(this._$AH)?this._$AA.nextSibling.data=t:this.T(jt.createTextNode(t)),this._$AH=t}$(t){var n;const{values:s,_$litType$:o}=t,r=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Ks.createElement(Zd(o.h,o.h[0]),this.options)),o);if(((n=this._$AH)==null?void 0:n._$AD)===r)this._$AH.p(s);else{const i=new Yd(r,this),l=i.u(this.options);i.p(s),this.T(l),this._$AH=i}}_$AC(t){let s=Bl.get(t.strings);return s===void 0&&Bl.set(t.strings,s=new Ks(t)),s}k(t){Ha(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let o,r=0;for(const n of t)r===s.length?s.push(o=new Cs(this.O(Ys()),this.O(Ys()),this,this.options)):o=s[r],o._$AI(n),r++;r<s.length&&(this._$AR(o&&o._$AB.nextSibling,r),s.length=r)}_$AR(t=this._$AA.nextSibling,s){var o;for((o=this._$AP)==null?void 0:o.call(this,!1,!0,s);t&&t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){var s;this._$AM===void 0&&(this._$Cv=t,(s=this._$AP)==null||s.call(this,t))}}class Qo{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,o,r,n){this.type=1,this._$AH=N,this._$AN=void 0,this.element=t,this.name=s,this._$AM=r,this.options=n,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=N}_$AI(t,s=this,o,r){const n=this.strings;let i=!1;if(n===void 0)t=Wt(this,t,s,0),i=!qs(t)||t!==this._$AH&&t!==ze,i&&(this._$AH=t);else{const l=t;let d,h;for(t=n[0],d=0;d<n.length-1;d++)h=Wt(this,l[o+d],s,d),h===ze&&(h=this._$AH[d]),i||(i=!qs(h)||h!==this._$AH[d]),h===N?t=N:t!==N&&(t+=(h??"")+n[d+1]),this._$AH[d]=h}i&&!r&&this.j(t)}j(t){t===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class qd extends Qo{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===N?void 0:t}}class Kd extends Qo{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==N)}}class Xd extends Qo{constructor(t,s,o,r,n){super(t,s,o,r,n),this.type=5}_$AI(t,s=this){if((t=Wt(this,t,s,0)??N)===ze)return;const o=this._$AH,r=t===N&&o!==N||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,n=t!==N&&(o===N||r);r&&this.element.removeEventListener(this.name,this,o),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,t):this._$AH.handleEvent(t)}}class Jd{constructor(t,s,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){Wt(this,t)}}const kg={M:Va,P:Je,A:Pa,C:1,L:Ud,R:Yd,D:Nd,V:Wt,I:Cs,H:Qo,N:Kd,U:Xd,B:qd,F:Jd},Dn=Gs.litHtmlPolyfillSupport;Dn==null||Dn(Ks,Cs),(Gs.litHtmlVersions??(Gs.litHtmlVersions=[])).push("3.2.1");const $g=(e,t,s)=>{const o=(s==null?void 0:s.renderBefore)??t;let r=o._$litPart$;if(r===void 0){const n=(s==null?void 0:s.renderBefore)??null;o._$litPart$=r=new Cs(t.insertBefore(Ys(),n),n,void 0,s??{})}return r._$AI(e),r};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fr=globalThis,Fa=fr.ShadowRoot&&(fr.ShadyCSS===void 0||fr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ja=Symbol(),Il=new WeakMap;let Qd=class{constructor(t,s,o){if(this._$cssResult$=!0,o!==ja)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(Fa&&t===void 0){const o=s!==void 0&&s.length===1;o&&(t=Il.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&Il.set(s,t))}return t}toString(){return this.cssText}};const G=e=>new Qd(typeof e=="string"?e:e+"",void 0,ja),D=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((o,r,n)=>o+(i=>{if(i._$cssResult$===!0)return i.cssText;if(typeof i=="number")return i;throw Error("Value passed to 'css' function must be a 'css' function result: "+i+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+e[n+1],e[0]);return new Qd(s,e,ja)},Sg=(e,t)=>{if(Fa)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const o=document.createElement("style"),r=fr.litNonce;r!==void 0&&o.setAttribute("nonce",r),o.textContent=s.cssText,e.appendChild(o)}},Nl=Fa?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const o of t.cssRules)s+=o.cssText;return G(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Mg,defineProperty:Eg,getOwnPropertyDescriptor:Tg,getOwnPropertyNames:zg,getOwnPropertySymbols:Ag,getPrototypeOf:Og}=Object,pt=globalThis,Gl=pt.trustedTypes,Lg=Gl?Gl.emptyScript:"",Vn=pt.reactiveElementPolyfillSupport,Zs=(e,t)=>e,Gn={toAttribute(e,t){switch(t){case Boolean:e=e?Lg:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},ec=(e,t)=>!Mg(e,t),Zl={attribute:!0,type:String,converter:Gn,reflect:!1,hasChanged:ec};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),pt.litPropertyMetadata??(pt.litPropertyMetadata=new WeakMap);class es extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Zl){if(s.state&&(s.attribute=!1),this._$Ei(),this.elementProperties.set(t,s),!s.noAccessor){const o=Symbol(),r=this.getPropertyDescriptor(t,o,s);r!==void 0&&Eg(this.prototype,t,r)}}static getPropertyDescriptor(t,s,o){const{get:r,set:n}=Tg(this.prototype,t)??{get(){return this[s]},set(i){this[s]=i}};return{get(){return r==null?void 0:r.call(this)},set(i){const l=r==null?void 0:r.call(this);n.call(this,i),this.requestUpdate(t,l,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Zl}static _$Ei(){if(this.hasOwnProperty(Zs("elementProperties")))return;const t=Og(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Zs("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Zs("properties"))){const s=this.properties,o=[...zg(s),...Ag(s)];for(const r of o)this.createProperty(r,s[r])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[o,r]of s)this.elementProperties.set(o,r)}this._$Eh=new Map;for(const[s,o]of this.elementProperties){const r=this._$Eu(s,o);r!==void 0&&this._$Eh.set(r,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const o=new Set(t.flat(1/0).reverse());for(const r of o)s.unshift(Nl(r))}else t!==void 0&&s.push(Nl(t));return s}static _$Eu(t,s){const o=s.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(s=>s(this))}addController(t){var s;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((s=t.hostConnected)==null||s.call(t))}removeController(t){var s;(s=this._$EO)==null||s.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const o of s.keys())this.hasOwnProperty(o)&&(t.set(o,this[o]),delete this[o]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Sg(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(s=>{var o;return(o=s.hostConnected)==null?void 0:o.call(s)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(s=>{var o;return(o=s.hostDisconnected)==null?void 0:o.call(s)})}attributeChangedCallback(t,s,o){this._$AK(t,o)}_$EC(t,s){var n;const o=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,o);if(r!==void 0&&o.reflect===!0){const i=(((n=o.converter)==null?void 0:n.toAttribute)!==void 0?o.converter:Gn).toAttribute(s,o.type);this._$Em=t,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$Em=null}}_$AK(t,s){var n;const o=this.constructor,r=o._$Eh.get(t);if(r!==void 0&&this._$Em!==r){const i=o.getPropertyOptions(r),l=typeof i.converter=="function"?{fromAttribute:i.converter}:((n=i.converter)==null?void 0:n.fromAttribute)!==void 0?i.converter:Gn;this._$Em=r,this[r]=l.fromAttribute(s,i.type),this._$Em=null}}requestUpdate(t,s,o){if(t!==void 0){if(o??(o=this.constructor.getPropertyOptions(t)),!(o.hasChanged??ec)(this[t],s))return;this.P(t,s,o)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,s,o){this._$AL.has(t)||this._$AL.set(t,s),o.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var o;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[n,i]of this._$Ep)this[n]=i;this._$Ep=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[n,i]of r)i.wrapped!==!0||this._$AL.has(n)||this[n]===void 0||this.P(n,this[n],i)}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(o=this._$EO)==null||o.forEach(r=>{var n;return(n=r.hostUpdate)==null?void 0:n.call(r)}),this.update(s)):this._$EU()}catch(r){throw t=!1,this._$EU(),r}t&&this._$AE(s)}willUpdate(t){}_$AE(t){var s;(s=this._$EO)==null||s.forEach(o=>{var r;return(r=o.hostUpdated)==null?void 0:r.call(o)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(s=>this._$EC(s,this[s]))),this._$EU()}updated(t){}firstUpdated(t){}}es.elementStyles=[],es.shadowRootOptions={mode:"open"},es[Zs("elementProperties")]=new Map,es[Zs("finalized")]=new Map,Vn==null||Vn({ReactiveElement:es}),(pt.reactiveElementVersions??(pt.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let E=class extends es{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var s;const t=super.createRenderRoot();return(s=this.renderOptions).renderBefore??(s.renderBefore=t.firstChild),t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=$g(s,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return ze}};var Bd;E._$litElement$=!0,E.finalized=!0,(Bd=globalThis.litElementHydrateSupport)==null||Bd.call(globalThis,{LitElement:E});const Pn=globalThis.litElementPolyfillSupport;Pn==null||Pn({LitElement:E});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wa=(e,t,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,s),s);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function te(e,t){return(s,o,r)=>{const n=i=>{var l;return((l=i.renderRoot)==null?void 0:l.querySelector(e))??null};return Wa(s,o,{get(){return n(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let Pg;function Hg(e){return(t,s)=>Wa(t,s,{get(){return(this.renderRoot??Pg??(Pg=document.createDocumentFragment())).querySelectorAll(e)}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function xt(e){return(t,s)=>Wa(t,s,{async get(){var o;return await this.updateComplete,((o=this.renderRoot)==null?void 0:o.querySelector(e))??null}})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tc=(e,t,s)=>{for(const o of t)if(o[0]===e)return(0,o[1])();return s==null?void 0:s()};var Ra=Object.defineProperty,Fg=Object.defineProperties,jg=Object.getOwnPropertyDescriptor,Wg=Object.getOwnPropertyDescriptors,Ul=Object.getOwnPropertySymbols,Rg=Object.prototype.hasOwnProperty,Bg=Object.prototype.propertyIsEnumerable,Yl=(e,t,s)=>t in e?Ra(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,ds=(e,t)=>{for(var s in t||(t={}))Rg.call(t,s)&&Yl(e,s,t[s]);if(Ul)for(var s of Ul(t))Bg.call(t,s)&&Yl(e,s,t[s]);return e},jr=(e,t)=>Fg(e,Wg(t)),Ig=(e,t)=>{for(var s in t)Ra(e,s,{get:t[s],enumerable:!0})},a=(e,t,s,o)=>{for(var r=o>1?void 0:o?jg(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Ra(t,s,r),r},Ba=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)},c=(e,t,s)=>(Ba(e,t,"read from private field"),s?s.call(e):t.get(e)),f=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},U=(e,t,s,o)=>(Ba(e,t,"write to private field"),t.set(e,s),s),C=(e,t,s)=>(Ba(e,t,"access private method"),s),Pt="-7d8ebe",Ia=class{static get instance(){var t;return(t=globalThis.__gdsElementLookupTable)!=null&&t[Pt]||(globalThis.__gdsElementLookupTable=jr(ds({},globalThis.__gdsElementLookupTable),{[Pt]:new Map})),globalThis.__gdsElementLookupTable[Pt]}};function Ng(e){const t=e+Pt;return Ia.instance.set(e,t),function(s){return s.prototype.gdsElementName=e,customElements.get(t)?o=>!1:O(t)(s)}}function Gg(e){return Ia.instance.set(e,e),function(t){return t.prototype.gdsElementName=e,O(e)(t)}}var k=e=>globalThis.GDS_DISABLE_VERSIONED_ELEMENTS?Gg(e):Ng(e),ql=new WeakMap;function Zg(e,...t){let s=ql.get(e);return s||(s=Kl(e),s.raw=Kl(e.raw),ql.set(e,s)),[s,...t]}var Kl=e=>e.map(t=>{for(const[s,o]of Ia.instance.entries())t=t.replace(new RegExp(`${s}(?![-a-z])`,"mg"),o);return t});function Ug(e){return(t,...s)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return e(t,...s);const[o,...r]=Zg(t,...s);return e(o,...r)}}var m=Ug(ge),sc=D`
  @layer defaults {
    a:link {
      color: currentColor;
...
`,Yg={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},qg=/^([<|>]=?)?([0-9a-z]+)/,oc=["{","}",";",":",","],Xl=[" ","/n"];function Kg(e){const t=[];let s="";for(let o=0;o<e.length;o++){const r=e[o];if(Xl.includes(r)||(s+=r),oc.includes(r)){t.push(s.slice(0,-1)),t.push(r),s="";continue}if(Xl.includes(r)||o===e.length-1){t.push(s),s="";continue}}return t.filter(o=>o!=="")}function Xg(e){var t;const s=[];let o={breakpoint:"-",values:[]};const r=()=>({sel:"",values:[]});let n=r();for(const i of e){if(!oc.includes(i)){n.values.push(i);continue}if(i==="{"&&(o={breakpoint:n.values.join(","),values:[]},n=r()),i===";"&&(s.length===0&&s.push(o),n.values.length>0&&(o.values.push(n),n=r())),i===":"){const l=(t=n.values.pop())!=null?t:"";n.sel=l}o&&i==="}"&&(o.values.push(n),n=r(),s.push(o))}return n.values.length>0&&o.values.push(n),s.length===0&&s.push(o),s}function Jg(e){return e.split(",").map(s=>{const o=s.trim().match(qg);if(!o)throw new Error(`Invalid breakpoint specifier: ${s}`);return{condition:o[1],value:o[2]}})}function Qg(e,t,s,o=n=>n,r=(n,i)=>`${n}: ${i.join(" ")};`){let n="";for(const i of s){const h=`@media ${(i.breakpoint==="-"?[{condition:">=",value:"0"}]:Jg(i.breakpoint)).map(v=>{var p,x;return`(${(p=v.condition)!=null&&p.includes("<")?"max-width":"min-width"}: ${(x=Yg[v.value])!=null?x:v.value})`}).join(" and ")} {${i.values.map(v=>{let p=e;v.sel.length>0&&(p=e===":host"?`:host(:${v.sel})`:`${e}:${v.sel}`);const x=r(t,v.values.map(o));return v.sel==="hover"?`@media (hover: hover) {${p}{${x}}}`:`${p}{${x}}`}).join("")}}`;n+=h}return n}var Hn=new Map;function y(e){return(t,s)=>{var o,r,n,i;const l=(o=e==null?void 0:e.selector)!=null?o:":host",d=(r=e==null?void 0:e.property)!=null?r:String(s),h=(n=e==null?void 0:e.valueTemplate)!=null?n:x=>`var(--gds-space-${x}, 0)`,v=e==null?void 0:e.styleTemplate,p=(i=e==null?void 0:e.cacheOverrideKey)!=null?i:"0";g({attribute:e==null?void 0:e.attribute,noAccessor:!0})(t,s),Object.defineProperty(t,s,{get:function(){return this["__"+String(s)]},set:async function(x){var w;this["__"+String(s)]=x,await this.updateComplete;const $=(w=this.level)!=null?w:"0",M=l+d+x+$+p;if(Hn.has(M)){this._dynamicStylesController.inject(`sep_${String(s)}`,Hn.get(M));return}const j=Xg(Kg(x)),H=Qg(l,d,j,h.bind(this),v==null?void 0:v.bind(this)),R=G(H);Hn.set(M,R),this._dynamicStylesController.inject(`sep_${String(s)}`,R)}})}}var Ve,Wr,Qe,Rr,Dt,Pe,ct,Br,Zn,rc,ts,Os,Un,nc,eh=class{constructor(e){f(this,Zn),f(this,ts),f(this,Un),f(this,Ve,!Na()),f(this,Wr,!1),f(this,Qe,[]),f(this,Rr,[]),f(this,Dt,new Map),f(this,Pe,new Map),f(this,ct,[]),f(this,Br,[]),this.host=e,this.host.addController(this)}hostConnected(){C(this,Un,nc).call(this)}has(e){return c(this,Ve)?c(this,Pe).has(e):c(this,Dt).has(e)}inject(e,t){C(this,Zn,rc).call(this,e,t),C(this,ts,Os).call(this)}clear(e){if(c(this,Ve)){const t=c(this,Pe).get(e);t==null||t.remove(),c(this,Pe).delete(e)}else c(this,Dt).delete(e);C(this,ts,Os).call(this)}clearAll(){c(this,Ve)?(c(this,Pe).forEach(e=>e.remove()),c(this,ct).forEach(e=>e.remove()),c(this,Pe).clear(),U(this,ct,[])):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],c(this,Dt).clear(),U(this,Qe,[]))}clearInitial(){c(this,Ve)?(c(this,ct).forEach(e=>e.remove()),U(this,ct,[])):U(this,Qe,[]),C(this,ts,Os).call(this)}restoreInitial(){c(this,Ve)?c(this,Br).forEach(e=>{c(this,ct).push(e.cloneNode(!0))}):U(this,Qe,[...c(this,Rr)]),C(this,ts,Os).call(this)}};Ve=new WeakMap;Wr=new WeakMap;Qe=new WeakMap;Rr=new WeakMap;Dt=new WeakMap;Pe=new WeakMap;ct=new WeakMap;Br=new WeakMap;Zn=new WeakSet;rc=function(e,t){if(c(this,Ve)){let s=c(this,Pe).get(e);s||(s=document.createElement("style"),c(this,Pe).set(e,s)),s.textContent=t.cssText}else{if(!this.host.shadowRoot||!t.styleSheet)return;c(this,Dt).set(e,t.styleSheet)}};ts=new WeakSet;Os=function(){if(c(this,Ve)){if(!this.host.shadowRoot)return;this.host.shadowRoot.querySelectorAll("style").forEach(e=>{e.remove()}),c(this,Pe).forEach(e=>{var t;(t=this.host.shadowRoot)==null||t.appendChild(e)})}else{if(!this.host.shadowRoot)return;this.host.shadowRoot.adoptedStyleSheets=[...c(this,Qe),...Array.from(c(this,Dt).values())]}};Un=new WeakSet;nc=function(){if(!c(this,Wr)){if(c(this,Ve)){if(!this.host.shadowRoot)return;this.host.shadowRoot.querySelectorAll("style").forEach(e=>{c(this,ct).push(e),c(this,Br).push(e.cloneNode(!0))})}else this.host.shadowRoot&&c(this,Qe).length===0&&(U(this,Qe,[...this.host.shadowRoot.adoptedStyleSheets||[]]),U(this,Rr,[...c(this,Qe)]));U(this,Wr,!0)}};function Na(){try{return new CSSStyleSheet,!0}catch{return!1}}var Yn,Ir,Nr,Ga,qn,ic,Kn,ac,th=class lc{constructor(){f(this,qn),f(this,Kn),f(this,Yn,!Na()),f(this,Ir,new Map),f(this,Nr,new Map),f(this,Ga,document.adoptedStyleSheets||[])}static get instance(){return globalThis.__gdsGlobalStylesRegistry||(globalThis.__gdsGlobalStylesRegistry=new lc),globalThis.__gdsGlobalStylesRegistry}injectGlobalStyles(t,s){if(c(this,Yn)){const o=Array.isArray(s)?s.map(r=>r.toString()).join(""):s.toString();C(this,qn,ic).call(this,t,o)}else s.styleSheet&&C(this,Kn,ac).call(this,t,s.styleSheet)}};Yn=new WeakMap;Ir=new WeakMap;Nr=new WeakMap;Ga=new WeakMap;qn=new WeakSet;ic=function(e,t){let s=c(this,Nr).get(e);s||(s=document.createElement("style"),c(this,Nr).set(e,s)),s.textContent=t,document.head.appendChild(s)};Kn=new WeakSet;ac=function(e,t){c(this,Ir).set(e,t),document.adoptedStyleSheets=[...c(this,Ga),...Array.from(c(this,Ir).values())]};var sh=th,Xn=`/**
 * Do not edit directly
 * Generated on Tue, 26 Nov 2024 15:01:40 GMT
 */
...
`,J=[G(rh),G(ih),G(lh),G(ah),G(oh),G(nh)];sh.instance.injectGlobalStyles("root-tokens",D`
    :root,
...
***************************************************************************** */var Ql;(function(e){(function(t){var s=typeof Jl=="object"?Jl:typeof self=="object"?self:typeof this=="object"?this:Function("return this;")(),o=r(e);typeof s.Reflect>"u"?s.Reflect=e:o=r(s.Reflect,o),t(o);function r(n,i){return function(l,d){typeof n[l]!="function"&&Object.defineProperty(n,l,{configurable:!0,writable:!0,value:d}),i&&i(l,d)}}})(function(t){var s=Object.prototype.hasOwnProperty,o=typeof Symbol=="function",r=o&&typeof Symbol.toPrimitive<"u"?Symbol.toPrimitive:"@@toPrimitive",n=o&&typeof Symbol.iterator<"u"?Symbol.iterator:"@@iterator",i=typeof Object.create=="function",l={__proto__:[]}instanceof Array,d=!i&&!l,h={create:i?function(){return zn(Object.create(null))}:l?function(){return zn({__proto__:null})}:function(){return zn({})},has:d?function(u,b){return s.call(u,b)}:function(u,b){return b in u},get:d?function(u,b){return s.call(u,b)?u[b]:void 0}:function(u,b){return u[b]}},v=Object.getPrototypeOf(Function),p=typeof process=="object"&&process.env&&process.env.REFLECT_METADATA_USE_MAP_POLYFILL==="true",x=!p&&typeof Map=="function"&&typeof Map.prototype.entries=="function"?Map:dg(),w=!p&&typeof Set=="function"&&typeof Set.prototype.entries=="function"?Set:cg(),$=!p&&typeof WeakMap=="function"?WeakMap:gg(),M=new $;function j(u,b,_,S){if(oe(_)){if(!Ml(u))throw new TypeError;if(!El(b))throw new TypeError;return De(u,b)}else{if(!Ml(u))throw new TypeError;if(!he(b))throw new TypeError;if(!he(S)&&!oe(S)&&!Jt(S))throw new TypeError;return Jt(S)&&(S=void 0),_=Ue(_),kt(u,b,_,S)}}t("decorate",j);function H(u,b){function _(S,T){if(!he(S))throw new TypeError;if(!oe(T)&&!rg(T))throw new TypeError;we(u,b,S,T)}return _}t("metadata",H);function R(u,b,_,S){if(!he(_))throw new TypeError;return oe(S)||(S=Ue(S)),we(u,b,_,S)}t("defineMetadata",R);function K(u,b,_){if(!he(b))throw new TypeError;return oe(_)||(_=Ue(_)),rt(u,b,_)}t("hasMetadata",K);function ie(u,b,_){if(!he(b))throw new TypeError;return oe(_)||(_=Ue(_)),se(u,b,_)}t("hasOwnMetadata",ie);function X(u,b,_){if(!he(b))throw new TypeError;return oe(_)||(_=Ue(_)),Ze(u,b,_)}t("getMetadata",X);function ke(u,b,_){if(!he(b))throw new TypeError;return oe(_)||(_=Ue(_)),$e(u,b,_)}t("getOwnMetadata",ke);function Ne(u,b){if(!he(u))throw new TypeError;return oe(b)||(b=Ue(b)),Ee(u,b)}t("getMetadataKeys",Ne);function Ct(u,b){if(!he(u))throw new TypeError;return oe(b)||(b=Ue(b)),Te(u,b)}t("getOwnMetadataKeys",Ct);function Ge(u,b,_){if(!he(b))throw new TypeError;oe(_)||(_=Ue(_));var S=ye(b,_,!1);if(oe(S)||!S.delete(u))return!1;if(S.size>0)return!0;var T=M.get(b);return T.delete(_),T.size>0||M.delete(b),!0}t("deleteMetadata",Ge);function De(u,b){for(var _=u.length-1;_>=0;--_){var S=u[_],T=S(b);if(!oe(T)&&!Jt(T)){if(!El(T))throw new TypeError;b=T}}return b}function kt(u,b,_,S){for(var T=u.length-1;T>=0;--T){var be=u[T],F=be(b,_,S);if(!oe(F)&&!Jt(F)){if(!he(F))throw new TypeError;S=F}}return S}function ye(u,b,_){var S=M.get(u);if(oe(S)){if(!_)return;S=new x,M.set(u,S)}var T=S.get(b);if(oe(T)){if(!_)return;T=new x,S.set(b,T)}return T}function rt(u,b,_){var S=se(u,b,_);if(S)return!0;var T=Tn(b);return Jt(T)?!1:rt(u,T,_)}function se(u,b,_){var S=ye(b,_,!1);return oe(S)?!1:sg(S.has(u))}function Ze(u,b,_){var S=se(u,b,_);if(S)return $e(u,b,_);var T=Tn(b);if(!Jt(T))return Ze(u,T,_)}function $e(u,b,_){var S=ye(b,_,!1);if(!oe(S))return S.get(u)}function we(u,b,_,S){var T=ye(_,S,!0);T.set(u,b)}function Ee(u,b){var _=Te(u,b),S=Tn(u);if(S===null)return _;var T=Ee(S,b);if(T.length<=0)return _;if(_.length<=0)return T;for(var be=new w,F=[],W=0,z=_;W<z.length;W++){var B=z[W],I=be.has(B);I||(be.add(B),F.push(B))}for(var nt=0,zl=T;nt<zl.length;nt++){var B=zl[nt],I=be.has(B);I||(be.add(B),F.push(B))}return F}function Te(u,b){var _=[],S=ye(u,b,!1);if(oe(S))return _;for(var T=S.keys(),be=ng(T),F=0;;){var W=ag(be);if(!W)return _.length=F,_;var z=ig(W);try{_[F]=z}catch(B){try{lg(be)}finally{throw B}}F++}}function lr(u){if(u===null)return 1;switch(typeof u){case"undefined":return 0;case"boolean":return 2;case"string":return 3;case"symbol":return 4;case"number":return 5;case"object":return u===null?1:6;default:return 6}}function oe(u){return u===void 0}function Jt(u){return u===null}function Q1(u){return typeof u=="symbol"}function he(u){return typeof u=="object"?u!==null:typeof u=="function"}function eg(u,b){switch(lr(u)){case 0:return u;case 1:return u;case 2:return u;case 3:return u;case 4:return u;case 5:return u}var _="string",S=Tl(u,r);if(S!==void 0){var T=S.call(u,_);if(he(T))throw new TypeError;return T}return tg(u)}function tg(u,b){var _,S;{var T=u.toString;if(dr(T)){var S=T.call(u);if(!he(S))return S}var _=u.valueOf;if(dr(_)){var S=_.call(u);if(!he(S))return S}}throw new TypeError}function sg(u){return!!u}function og(u){return""+u}function Ue(u){var b=eg(u);return Q1(b)?b:og(b)}function Ml(u){return Array.isArray?Array.isArray(u):u instanceof Object?u instanceof Array:Object.prototype.toString.call(u)==="[object Array]"}function dr(u){return typeof u=="function"}function El(u){return typeof u=="function"}function rg(u){switch(lr(u)){case 3:return!0;case 4:return!0;default:return!1}}function Tl(u,b){var _=u[b];if(_!=null){if(!dr(_))throw new TypeError;return _}}function ng(u){var b=Tl(u,n);if(!dr(b))throw new TypeError;var _=b.call(u);if(!he(_))throw new TypeError;return _}function ig(u){return u.value}function ag(u){var b=u.next();return b.done?!1:b}function lg(u){var b=u.return;b&&b.call(u)}function Tn(u){var b=Object.getPrototypeOf(u);if(typeof u!="function"||u===v||b!==v)return b;var _=u.prototype,S=_&&Object.getPrototypeOf(_);if(S==null||S===Object.prototype)return b;var T=S.constructor;return typeof T!="function"||T===u?b:T}function dg(){var u={},b=[],_=function(){function F(W,z,B){this._index=0,this._keys=W,this._values=z,this._selector=B}return F.prototype["@@iterator"]=function(){return this},F.prototype[n]=function(){return this},F.prototype.next=function(){var W=this._index;if(W>=0&&W<this._keys.length){var z=this._selector(this._keys[W],this._values[W]);return W+1>=this._keys.length?(this._index=-1,this._keys=b,this._values=b):this._index++,{value:z,done:!1}}return{value:void 0,done:!0}},F.prototype.throw=function(W){throw this._index>=0&&(this._index=-1,this._keys=b,this._values=b),W},F.prototype.return=function(W){return this._index>=0&&(this._index=-1,this._keys=b,this._values=b),{value:W,done:!0}},F}();return function(){function F(){this._keys=[],this._values=[],this._cacheKey=u,this._cacheIndex=-2}return Object.defineProperty(F.prototype,"size",{get:function(){return this._keys.length},enumerable:!0,configurable:!0}),F.prototype.has=function(W){return this._find(W,!1)>=0},F.prototype.get=function(W){var z=this._find(W,!1);return z>=0?this._values[z]:void 0},F.prototype.set=function(W,z){var B=this._find(W,!0);return this._values[B]=z,this},F.prototype.delete=function(W){var z=this._find(W,!1);if(z>=0){for(var B=this._keys.length,I=z+1;I<B;I++)this._keys[I-1]=this._keys[I],this._values[I-1]=this._values[I];return this._keys.length--,this._values.length--,W===this._cacheKey&&(this._cacheKey=u,this._cacheIndex=-2),!0}return!1},F.prototype.clear=function(){this._keys.length=0,this._values.length=0,this._cacheKey=u,this._cacheIndex=-2},F.prototype.keys=function(){return new _(this._keys,this._values,S)},F.prototype.values=function(){return new _(this._keys,this._values,T)},F.prototype.entries=function(){return new _(this._keys,this._values,be)},F.prototype["@@iterator"]=function(){return this.entries()},F.prototype[n]=function(){return this.entries()},F.prototype._find=function(W,z){return this._cacheKey!==W&&(this._cacheIndex=this._keys.indexOf(this._cacheKey=W)),this._cacheIndex<0&&z&&(this._cacheIndex=this._keys.length,this._keys.push(W),this._values.push(void 0)),this._cacheIndex},F}();function S(F,W){return F}function T(F,W){return W}function be(F,W){return[F,W]}}function cg(){return function(){function u(){this._map=new x}return Object.defineProperty(u.prototype,"size",{get:function(){return this._map.size},enumerable:!0,configurable:!0}),u.prototype.has=function(b){return this._map.has(b)},u.prototype.add=function(b){return this._map.set(b,b),this},u.prototype.delete=function(b){return this._map.delete(b)},u.prototype.clear=function(){this._map.clear()},u.prototype.keys=function(){return this._map.keys()},u.prototype.values=function(){return this._map.values()},u.prototype.entries=function(){return this._map.entries()},u.prototype["@@iterator"]=function(){return this.keys()},u.prototype[n]=function(){return this.keys()},u}()}function gg(){var u=16,b=h.create(),_=S();return function(){function z(){this._key=S()}return z.prototype.has=function(B){var I=T(B,!1);return I!==void 0?h.has(I,this._key):!1},z.prototype.get=function(B){var I=T(B,!1);return I!==void 0?h.get(I,this._key):void 0},z.prototype.set=function(B,I){var nt=T(B,!0);return nt[this._key]=I,this},z.prototype.delete=function(B){var I=T(B,!1);return I!==void 0?delete I[this._key]:!1},z.prototype.clear=function(){this._key=S()},z}();function S(){var z;do z="@@WeakMap@@"+W();while(h.has(b,z));return b[z]=!0,z}function T(z,B){if(!s.call(z,_)){if(!B)return;Object.defineProperty(z,_,{value:h.create()})}return z[_]}function be(z,B){for(var I=0;I<B;++I)z[I]=Math.random()*255|0;return z}function F(z){return typeof Uint8Array=="function"?typeof crypto<"u"?crypto.getRandomValues(new Uint8Array(z)):typeof msCrypto<"u"?msCrypto.getRandomValues(new Uint8Array(z)):be(new Uint8Array(z),z):be(new Array(z),z)}function W(){var z=F(u);z[6]=z[6]&79|64,z[8]=z[8]&191|128;for(var B="",I=0;I<u;++I){var nt=z[I];(I===4||I===6||I===8)&&(B+="-"),nt<16&&(B+="0"),B+=nt.toString(16).toLowerCase()}return B}}function zn(u){return u.__=void 0,delete u.__,u}})})(Ql||(Ql={}));var Y=class extends E{constructor(){super(),this._isUsingTransitionalStyles=!1,this._dynamicStylesController=new eh(this)}connectedCallback(){var e;super.connectedCallback(),this.setAttribute("gds-element",((e=this.gdsElementName)==null?void 0:e.toString())||"")}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new CustomEvent("gds-element-disconnected",{bubbles:!0,composed:!1}))}};a([P()],Y.prototype,"_isUsingTransitionalStyles",2);var dh=D`
  :host {
...
`,ch=dh,A=class extends Y{constructor(){super(...arguments),this.display="block",this.level="2"}render(){return m`<slot></slot>`}};A.styles=[J,ch];a([y({valueTemplate:e=>e})],A.prototype,"display",2);a([g()],A.prototype,"level",2);a([y({valueTemplate:e=>e})],A.prototype,"place-items",2);a([y({valueTemplate:e=>e})],A.prototype,"place-content",2);a([y({valueTemplate:function(e){const[t,s]=e.split("/"),o=i=>{const l=i.trim();return l.startsWith("#")||l.startsWith("rgb(")||l.startsWith("rgba(")||l.startsWith("hsl(")||l.startsWith("hsla(")},r=(i,l)=>`var(--gds-color-l${i}-content-${l})`;return((i,l)=>o(i)?l?`color-mix(in srgb, ${i} ${parseFloat(l)*100}%, transparent 0%)`:i:r(this.level,i))(t,s)}})],A.prototype,"color",2);a([y({valueTemplate:function(e){const[t,s]=e.split("/"),o=i=>{const l=i.trim();return l.startsWith("#")||l.startsWith("rgb(")||l.startsWith("rgba(")||l.startsWith("hsl(")||l.startsWith("hsla(")},r=(i,l)=>`var(--gds-color-l${i}-background-${l})`;return((i,l)=>o(i)?l?`color-mix(in srgb, ${i} ${parseFloat(l)*100}%, transparent 0%)`:i:r(this.level,i))(t,s)}})],A.prototype,"background",2);a([y({valueTemplate:function(e){const[t,s]=e.split("/"),o=i=>{const l=i.trim();return l.startsWith("#")||l.startsWith("rgb(")||l.startsWith("rgba(")||l.startsWith("hsl(")||l.startsWith("hsla(")},r=(i,l)=>`var(--gds-color-l${i}-border-${l})`;return`var(--gds-space-${t}) solid ${s?(i=>o(i)?i:r(this.level,i))(s):"currentColor"}`},styleTemplate:(e,t)=>{const s=t[0],o=t.length>1?t[1]:s,r=t.length>2?t[2]:s,n=t.length>3?t[3]:s;return`
        border-top: ${s};
        border-right: ${o};
        border-bottom: ${r};
        border-left: ${n};
      `}})],A.prototype,"border",2);a([y({valueTemplate:function(e){const[t]=e.split("/"),s=n=>{const i=n.trim();return i.startsWith("#")||i.startsWith("rgb(")||i.startsWith("rgba(")||i.startsWith("hsl(")||i.startsWith("hsla(")},o=(n,i)=>`var(--gds-color-l${n}-border-${i})`;return t?(n=>s(n)?n:o(this.level,n))(t):"currentColor"},styleTemplate:(e,t)=>{const s=t[0],o=t.length>1?t[1]:s,r=t.length>2?t[2]:s,n=t.length>3?t[3]:s;return`
        border-top-color: ${s};
        border-right-color: ${o};
        border-bottom-color: ${r};
        border-left-color: ${n};
      `}})],A.prototype,"border-color",2);a([y({styleTemplate:(e,t)=>{const s=t[0],o=t.length>1?t[1]:s,r=t.length>2?t[2]:s,n=t.length>3?t[3]:s;return`
        border-top-width: ${s};
        border-right-width: ${o};
        border-bottom-width: ${r};
        border-left-width: ${n};
        border-style: solid;
      `}})],A.prototype,"border-width",2);a([y({valueTemplate:e=>`var(--gds-space-${e})`})],A.prototype,"border-radius",2);a([y({valueTemplate:e=>e})],A.prototype,"opacity",2);a([y()],A.prototype,"padding",2);a([y()],A.prototype,"padding-inline",2);a([y()],A.prototype,"padding-block",2);a([y({valueTemplate:e=>{const s=(e.startsWith("-")?"neg":"pos")=="pos"?`var(--gds-space-${e})`:`calc(var(--gds-space-${e.substring(1)}) * -1)`;return e==="auto"?"auto":s},styleTemplate:(e,t)=>{const s=l=>l==="auto"?"auto":`${l}`,o=s(t[0]),r=t.length>1?s(t[1]):o,n=t.length>2?s(t[2]):o,i=t.length>3?s(t[3]):r;return`margin: ${o} ${r} ${n} ${i};`}})],A.prototype,"margin",2);a([y({valueTemplate:e=>e})],A.prototype,"position",2);a([y({valueTemplate:e=>e})],A.prototype,"inset",2);a([y({valueTemplate:e=>e})],A.prototype,"overflow",2);a([y({valueTemplate:e=>e})],A.prototype,"height",2);a([y({valueTemplate:e=>e})],A.prototype,"max-height",2);a([y({valueTemplate:e=>e})],A.prototype,"min-height",2);a([y()],A.prototype,"block-size",2);a([y()],A.prototype,"min-block-size",2);a([y({valueTemplate:e=>e})],A.prototype,"width",2);a([y({valueTemplate:e=>e})],A.prototype,"max-width",2);a([y({valueTemplate:e=>e})],A.prototype,"min-width",2);a([y()],A.prototype,"inline-size",2);a([y({valueTemplate:e=>e})],A.prototype,"box-sizing",2);a([y({valueTemplate:e=>e})],A.prototype,"cursor",2);a([y({valueTemplate:e=>e})],A.prototype,"pointer-events",2);a([y({valueTemplate:e=>e})],A.prototype,"user-select",2);a([y({valueTemplate:e=>e})],A.prototype,"z-index",2);a([y({valueTemplate:e=>e})],A.prototype,"transform",2);a([y({valueTemplate:e=>e})],A.prototype,"transform-style",2);a([y({valueTemplate:e=>e})],A.prototype,"transition",2);a([y({valueTemplate:e=>e})],A.prototype,"transition-behavior",2);a([y({valueTemplate:e=>e})],A.prototype,"animation",2);a([y({valueTemplate:e=>`${e}`,styleTemplate:(e,t)=>{const s=t[0],o=`font-size: var(--gds-text-size-${s});`,r=`line-height: var(--gds-text-line-height-${s});`;return o+r}})],A.prototype,"font-size",2);a([y({property:"font-weight",valueTemplate:e=>`var(--gds-text-weight-${e})`})],A.prototype,"font-weight",2);a([y({valueTemplate:e=>`${e}`})],A.prototype,"grid-column",2);a([y({valueTemplate:e=>`${e}`})],A.prototype,"grid-row",2);a([y({valueTemplate:e=>`${e}`})],A.prototype,"flex",2);A=a([k("gds-container")],A);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Za=Symbol.for(""),gh=e=>{if((e==null?void 0:e.r)===Za)return e==null?void 0:e._$litStatic$},hh=e=>({_$litStatic$:e,r:Za}),Gr=(e,...t)=>({_$litStatic$:t.reduce((s,o,r)=>s+(n=>{if(n._$litStatic$!==void 0)return n._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${n}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+e[r+1],e[0]),r:Za}),ed=new Map,ph=e=>(t,...s)=>{const o=s.length;let r,n;const i=[],l=[];let d,h=0,v=!1;for(;h<o;){for(d=t[h];h<o&&(n=s[h],(r=gh(n))!==void 0);)d+=r+t[++h],v=!0;h!==o&&l.push(n),i.push(d),h++}if(h===o&&i.push(t[o]),v){const p=i.join("$$lit$$");(t=ed.get(p))===void 0&&(i.raw=i,ed.set(p,t=i)),s=l}return e(t,...s)},er=ph(ge);var uh=D`
  [tag] {
    margin: 0;
    padding: 0;
    text-underline-offset: 0.2lh;
  }
`,fh=uh,fe=class extends A{constructor(){super(...arguments),this.level="2",this.tag="span"}render(){const e=hh(encodeURI(this.tag));return er`<${e} tag><slot></slot></${e}>`}};fe.styles=[J,sc,fh];a([g()],fe.prototype,"level",2);a([g({type:String})],fe.prototype,"tag",2);a([y({valueTemplate:e=>`${e}`,selector:"[tag]",styleTemplate:(e,t)=>{const s=t[0],o=`font-size: var(--gds-text-size-${s});`,r=`line-height: var(--gds-text-line-height-${s});`;return o+r}})],fe.prototype,"font-size",2);a([y({property:"font-weight",selector:"[tag]",valueTemplate:e=>`var(--gds-text-weight-${e})`})],fe.prototype,"font-weight",2);a([y({property:"text-wrap",valueTemplate:e=>e})],fe.prototype,"text-wrap",2);a([y({property:"text-transform",valueTemplate:e=>e})],fe.prototype,"text-transform",2);a([y({property:"max-width",valueTemplate:e=>`${e}ch`})],fe.prototype,"max-width",2);a([y({property:"min-width",valueTemplate:e=>`${e}ch`})],fe.prototype,"min-width",2);a([y({property:"text-align",valueTemplate:e=>e})],fe.prototype,"text-align",2);a([y({valueTemplate:e=>e,selector:"[tag]"})],fe.prototype,"text-decoration",2);a([y({valueTemplate:e=>e,styleTemplate:(e,t)=>`overflow: hidden;
      text-overflow: ellipsis;
      display: -webkit-box;
      -webkit-line-clamp: ${t[0]};
      -webkit-box-orient: vertical;`})],fe.prototype,"lines",2);a([y({property:"color",valueTemplate:function(e){const[t,s]=e.split("/");return s?`color-mix(in srgb, var(--gds-color-${"l"+this.level}-content-${t}) ${parseFloat(s)*100}%, transparent 0%)`:`var(--gds-color-${"l"+this.level}-content-${t})`}})],fe.prototype,"color",2);fe=a([k("gds-text")],fe);var mr,vr,Jn,mh=class cc{constructor(){f(this,mr,new Map),f(this,vr,new Map),f(this,Jn,!Na())}static get instance(){var t;return(t=globalThis.__gdsTransitionalStyles)!=null&&t[Pt]||(globalThis.__gdsTransitionalStyles=jr(ds({},globalThis.__gdsTransitionalStyles),{[Pt]:new cc})),globalThis.__gdsTransitionalStyles[Pt]}apply(t,s){if(!t.shadowRoot)return;const o=c(this,mr).get(s);o&&(c(this,vr).set(s,t),this.applyToElement(s,o))}applyToElement(t,s){var o,r;const n=c(this,vr).get(t);if(!n||!n.shadowRoot)return;const i=()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",G(s)),n._isUsingTransitionalStyles=!0},l=()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()},d="[gds-element=gds-theme]";let h=n.getRootNode(),v=n.closest(d);for(;v===null&&h!==document;)v=(o=h.host)==null?void 0:o.closest(d),h=(r=h.host)==null?void 0:r.getRootNode();if(v){const p=v,x=()=>{p.designVersion==="2023"?l():i()};if(p.addEventListener("gds-design-version-changed",x),n.addEventListener("gds-element-disconnected",()=>p.removeEventListener("gds-design-version-changed",x)),p.designVersion==="2023"){l();return}}i()}register(t,s){let o=s;c(this,Jn)&&(o=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${s}`),c(this,mr).set(t,o),this.applyToElement(t,o)}};mr=new WeakMap;vr=new WeakMap;Jn=new WeakMap;var xe=mh,vh=D`
...
`,bh=vh,Qn=class extends Y{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then(()=>xe.instance.apply(this,"gds-menu-heading"))}render(){return ge`<slot></slot>`}};Qn.styles=bh;Qn=a([k("gds-menu-heading")],Qn);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ei="lit-localize-status";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xh=(e,...t)=>({strTag:!0,strings:e,values:t}),Zr=xh,yh=e=>typeof e!="string"&&"strTag"in e,gc=(e,t,s)=>{let o=e[0];for(let r=1;r<e.length;r++)o+=t[s?s[r-1]:r-1],o+=e[r];return o};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hc=e=>yh(e)?gc(e.strings,e.values):e;let V=hc,td=!1;function wh(e){if(td)throw new Error("lit-localize can only be configured once");V=e,td=!0}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class _h{constructor(t){this.__litLocalizeEventHandler=s=>{s.detail.status==="ready"&&this.host.requestUpdate()},this.host=t}hostConnected(){window.addEventListener(ei,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(ei,this.__litLocalizeEventHandler)}}const Ch=e=>e.addController(new _h(e)),pc=Ch;/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qt=()=>(e,t)=>(e.addInitializer(pc),e);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class uc{constructor(){this.settled=!1,this.promise=new Promise((t,s)=>{this._resolve=t,this._reject=s})}resolve(t){this.settled=!0,this._resolve(t)}reject(t){this.settled=!0,this._reject(t)}}/**
 * @license
 * Copyright 2014 Travis Webb
 * SPDX-License-Identifier: MIT
 */const Ye=[];for(let e=0;e<256;e++)Ye[e]=(e>>4&15).toString(16)+(e&15).toString(16);function kh(e){let t=0,s=8997,o=0,r=33826,n=0,i=40164,l=0,d=52210;for(let h=0;h<e.length;h++)s^=e.charCodeAt(h),t=s*435,o=r*435,n=i*435,l=d*435,n+=s<<8,l+=r<<8,o+=t>>>16,s=t&65535,n+=o>>>16,r=o&65535,d=l+(n>>>16)&65535,i=n&65535;return Ye[d>>8]+Ye[d&255]+Ye[i>>8]+Ye[i&255]+Ye[r>>8]+Ye[r&255]+Ye[s>>8]+Ye[s&255]}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $h="",Sh="h",Mh="s";function Eh(e,t){return(t?Sh:Mh)+kh(typeof e=="string"?e:e.join($h))}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const sd=new WeakMap,od=new Map;function Th(e,t,s){if(e){const o=(s==null?void 0:s.id)??zh(t),r=e[o];if(r){if(typeof r=="string")return r;if("strTag"in r)return gc(r.strings,t.values,r.values);{let n=sd.get(r);return n===void 0&&(n=r.values,sd.set(r,n)),{...r,values:n.map(i=>t.values[i])}}}}return hc(t)}function zh(e){const t=typeof e=="string"?e:e.strings;let s=od.get(t);return s===void 0&&(s=Eh(t,typeof e!="string"&&!("strTag"in e)),od.set(t,s)),s}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Fn(e){window.dispatchEvent(new CustomEvent(ei,{detail:e}))}let Ur="",jn,fc,Yr,ti,mc,Et=new uc;Et.resolve();let cr=0;const Ah=e=>(wh((t,s)=>Th(mc,t,s)),Ur=fc=e.sourceLocale,Yr=new Set(e.targetLocales),Yr.add(e.sourceLocale),ti=e.loadLocale,{getLocale:Oh,setLocale:Lh}),Oh=()=>Ur,Lh=e=>{if(e===(jn??Ur))return Et.promise;if(!Yr||!ti)throw new Error("Internal error");if(!Yr.has(e))throw new Error("Invalid locale code");cr++;const t=cr;return jn=e,Et.settled&&(Et=new uc),Fn({status:"loading",loadingLocale:e}),(e===fc?Promise.resolve({templates:void 0}):ti(e)).then(o=>{cr===t&&(Ur=e,jn=void 0,mc=o.templates,Fn({status:"ready",readyLocale:e}),Et.resolve())},o=>{cr===t&&(Fn({status:"error",errorLocale:e,errorMessage:o.toString()}),Et.reject(o))}),Et.promise};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ks=e=>(...t)=>({_$litDirective$:e,values:t});let sr=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,o){this._$Ct=t,this._$AM=s,this._$Ci=o}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fe=ks(class extends sr{constructor(e){var t;if(super(e),e.type!==tr.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var o,r;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(n=>n!=="")));for(const n in t)t[n]&&!((o=this.nt)!=null&&o.has(n))&&this.st.add(n);return this.render(t)}const s=e.element.classList;for(const n of this.st)n in t||(s.remove(n),this.st.delete(n));for(const n in t){const i=!!t[n];i===this.st.has(n)||(r=this.nt)!=null&&r.has(n)||(i?(s.add(n),this.st.add(n)):(s.remove(n),this.st.delete(n)))}return ze}});var Dh=D`
  @layer base, reset, transitional-styles;
  @layer base {
    button {
      display: flex;
...
`,Vh=Dh,si,vc,je=class extends Y{constructor(){super(),f(this,si),this.open=!1,this.buttonLabel=V("Open context menu"),this.showLabel=!1,this.label="",this.placement="bottom-start"}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-context-menu"),this.addEventListener("keydown",e=>{this.open&&e.key=="Tab"&&(e.preventDefault(),this.open=!1,this.elTriggerBtn.then(t=>t.focus()))})}render(){var e,t,s;return m`<button
      ...
      >
        <gds-menu
          ...
          @gds-menu-item-click=${C(this,si,vc)}
        >
          <slot></slot>
        </gds-menu>
      </gds-popover>`}};si=new WeakSet;vc=function(){this.open=!1};je.styles=[Vh];je.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g({type:Boolean,reflect:!0})],je.prototype,"open",2);a([g({attribute:"button-label"})],je.prototype,"buttonLabel",2);a([g({attribute:"show-label",type:Boolean})],je.prototype,"showLabel",2);a([g()],je.prototype,"label",2);a([g()],je.prototype,"placement",2);a([xt("#trigger")],je.prototype,"elTriggerBtn",2);je=a([k("gds-context-menu"),qt()],je);var br,bc=class{constructor(e){f(this,br,t=>{var s,o;const r=t.target;if(!this.host.navigableItems.includes(r))return;let n=!1;if(t.key==="ArrowDown"){const i=this.host.navigableItems.indexOf(r)+1,l=this.host.navigableItems[i];l==null||l.focus(),n=!0}else if(t.key==="ArrowUp"){const i=this.host.navigableItems.indexOf(r)-1,l=this.host.navigableItems[i];l==null||l.focus(),n=!0}else if(t.key==="Home")(s=this.host.navigableItems[0])==null||s.focus(),n=!0;else if(t.key==="End")(o=this.host.navigableItems[this.host.navigableItems.length-1])==null||o.focus(),n=!0;else{const i=t.key.toLowerCase();if(i.length!==1)return;const l=i>="a"&&i<="z",d=i>="0"&&i<="9";if(l||d){const h=this.host.navigableItems.find(v=>{var p;const x=(p=v.textContent)==null?void 0:p.trim().toLowerCase();return x==null?void 0:x.startsWith(i)});h==null||h.focus(),n=!0}}n&&(t.preventDefault(),t.stopPropagation())}),(this.host=e).addController(this)}hostConnected(){this.host.addEventListener("keydown",c(this,br))}hostDisconnected(){this.host.removeEventListener("keydown",c(this,br))}};br=new WeakMap;function xc(e){let t=e;for(;t.assignedElements().length>0&&t.assignedElements()[0].nodeName==="SLOT";)t=t.assignedElements()[0];return t}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Ph}=kg,Hh=e=>e===null||typeof e!="object"&&typeof e!="function",Fh=e=>e.strings===void 0,rd=()=>document.createComment(""),As=(e,t,s)=>{var n;const o=e._$AA.parentNode,r=t===void 0?e._$AB:t._$AA;if(s===void 0){const i=o.insertBefore(rd(),r),l=o.insertBefore(rd(),r);s=new Ph(i,l,e,e.options)}else{const i=s._$AB.nextSibling,l=s._$AM,d=l!==e;if(d){let h;(n=s._$AQ)==null||n.call(s,e),s._$AM=e,s._$AP!==void 0&&(h=e._$AU)!==l._$AU&&s._$AP(h)}if(i!==r||d){let h=s._$AA;for(;h!==i;){const v=h.nextSibling;o.insertBefore(h,r),h=v}}}return s},Mt=(e,t,s=e)=>(e._$AI(t,s),e),jh={},Wh=(e,t=jh)=>e._$AH=t,Rh=e=>e._$AH,Wn=e=>{var o;(o=e._$AP)==null||o.call(e,!1,!0);let t=e._$AA;const s=e._$AB.nextSibling;for(;t!==s;){const r=t.nextSibling;t.remove(),t=r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Us=(e,t)=>{var o;const s=e._$AN;if(s===void 0)return!1;for(const r of s)(o=r._$AO)==null||o.call(r,t,!1),Us(r,t);return!0},qr=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},yc=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),Nh(t)}};function Bh(e){this._$AN!==void 0?(qr(this),this._$AM=e,yc(this)):this._$AM=e}function Ih(e,t=!1,s=0){const o=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(o))for(let n=s;n<o.length;n++)Us(o[n],!1),qr(o[n]);else o!=null&&(Us(o,!1),qr(o));else Us(this,e)}const Nh=e=>{e.type==tr.CHILD&&(e._$AP??(e._$AP=Ih),e._$AQ??(e._$AQ=Bh))};class wc extends sr{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,o){super._$AT(t,s,o),yc(this),this.isConnected=t._$AU}_$AO(t,s=!0){var o,r;t!==this.isConnected&&(this.isConnected=t,t?(o=this.reconnected)==null||o.call(this):(r=this.disconnected)==null||r.call(this)),s&&(Us(this,t),qr(this))}setValue(t){if(Fh(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Kr=()=>new Gh;let Gh=class{};const Rn=new WeakMap,Xs=ks(class extends wc{render(e){return N}update(e,[t]){var o;const s=t!==this.Y;return s&&this.Y!==void 0&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.Y=t,this.ht=(o=e.options)==null?void 0:o.host,this.rt(this.ct=e.element)),N}rt(e){if(this.isConnected||(e=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let s=Rn.get(t);s===void 0&&(s=new WeakMap,Rn.set(t,s)),s.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),s.set(this.Y,e),e!==void 0&&this.Y.call(this.ht,e)}else this.Y.value=e}get lt(){var e,t;return typeof this.Y=="function"?(e=Rn.get(this.ht??globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var Ls,nd=class extends Y{constructor(){super(),f(this,Ls,Kr()),new bc(this)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),xe.instance.apply(this,"gds-listbox")}get navigableItems(){return c(this,Ls).value?xc(c(this,Ls).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-menu-item")||[]:[]}focus(){var e;(e=this.navigableItems[0])==null||e.focus()}render(){return m`<slot ${Xs(c(this,Ls))}></slot>`}};Ls=new WeakMap;nd=a([k("gds-menu")],nd);var _c=e=>{class t extends e{constructor(){super(...arguments),this.onblur=o=>{this.setAttribute("tabindex","-1"),this.dispatchEvent(new FocusEvent("gds-blur",{bubbles:!0,composed:!0,relatedTarget:o.relatedTarget}))},this.onfocus=o=>{this.dispatchEvent(new FocusEvent("gds-focus",{bubbles:!0,composed:!0,relatedTarget:o.relatedTarget}))}}focus(o){this.setAttribute("tabindex","0"),super.focus(o)}}return t},Zh=D`
  @layer base, reset;
...
`,Cc=Zh,oi,ri=class extends _c(Y){constructor(){super(...arguments),f(this,oi,()=>{this.dispatchEvent(new CustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0}))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this.click())}),this.addEventListener("click",c(this,oi)),xe.instance.apply(this,"gds-option")}render(){return m`<div><slot></slot></div>`}};oi=new WeakMap;ri.styles=[Cc];ri=a([k("gds-menu-item")],ri);var Xr=class extends Y{constructor(){super(...arguments),this.show=!1}render(){return m``}};Xr.styles=D`
    :host {
      display: none;
      position: fixed;
      inset: 0;
  ...
  `;a([g({type:Boolean,reflect:!0})],Xr.prototype,"show",2);Xr=a([k("gds-backdrop")],Xr);function Ua(e={attributes:!0,childList:!0,subtree:!1,characterData:!0}){return(t,s,o)=>{let r;const n=t.connectedCallback,i=t.disconnectedCallback;t.connectedCallback=function(){n==null||n.call(this);const l=(d,h)=>{var v;(v=o.value)==null||v.call(this)};r=new MutationObserver(l),r.observe(this,e)},t.disconnectedCallback=function(){i==null||i.call(this),r.disconnect()}}}function Uh(e){return(t,s,o)=>{const r=window.matchMedia(e),n=t.connectedCallback,i=t.disconnectedCallback;t.connectedCallback=function(){var l;n==null||n.call(this);const d=h=>{var v;(v=o.value)==null||v.call(this,h.matches)};r.addEventListener("change",d),this.disconnectedCallback=function(){i==null||i.call(this),r.removeEventListener("change",d)},(l=o.value)==null||l.call(this,r.matches)}}}function ne(e,t){const s=ds({waitUntilFirstUpdate:!1},t);return(o,r,n)=>{const{update:i}=o,l=Array.isArray(e)?e:[e];o.update=function(d){l.forEach(h=>{var v;const p=h;if(d.has(p)){const x=d.get(p),w=this[p];x!==w&&(!s.waitUntilFirstUpdate||this.hasUpdated)&&((v=n.value)==null||v.call(this,x,w))}}),i.call(this,d)}}}const Yh=["top","right","bottom","left"],cs=Math.min,Ht=Math.max,Jr=Math.round,gr=Math.floor,He=e=>({x:e,y:e}),qh={left:"right",right:"left",bottom:"top",top:"bottom"},Kh={start:"end",end:"start"};function ni(e,t,s){return Ht(e,cs(t,s))}function $s(e,t){return typeof e=="function"?e(t):e}function Rt(e){return e.split("-")[0]}function or(e){return e.split("-")[1]}function kc(e){return e==="x"?"y":"x"}function Ya(e){return e==="y"?"height":"width"}function gs(e){return["top","bottom"].includes(Rt(e))?"y":"x"}function qa(e){return kc(gs(e))}function Xh(e,t,s){s===void 0&&(s=!1);const o=or(e),r=qa(e),n=Ya(r);let i=r==="x"?o===(s?"end":"start")?"right":"left":o==="start"?"bottom":"top";return t.reference[n]>t.floating[n]&&(i=Qr(i)),[i,Qr(i)]}function Jh(e){const t=Qr(e);return[ii(e),t,ii(t)]}function ii(e){return e.replace(/start|end/g,t=>Kh[t])}function Qh(e,t,s){const o=["left","right"],r=["right","left"],n=["top","bottom"],i=["bottom","top"];switch(e){case"top":case"bottom":return s?t?r:o:t?o:r;case"left":case"right":return t?n:i;default:return[]}}function ep(e,t,s,o){const r=or(e);let n=Qh(Rt(e),s==="start",o);return r&&(n=n.map(i=>i+"-"+r),t&&(n=n.concat(n.map(ii)))),n}function Qr(e){return e.replace(/left|right|bottom|top/g,t=>qh[t])}function tp(e){return{top:0,right:0,bottom:0,left:0,...e}}function $c(e){return typeof e!="number"?tp(e):{top:e,right:e,bottom:e,left:e}}function en(e){const{x:t,y:s,width:o,height:r}=e;return{width:o,height:r,top:s,left:t,right:t+o,bottom:s+r,x:t,y:s}}function id(e,t,s){let{reference:o,floating:r}=e;const n=gs(t),i=qa(t),l=Ya(i),d=Rt(t),h=n==="y",v=o.x+o.width/2-r.width/2,p=o.y+o.height/2-r.height/2,x=o[l]/2-r[l]/2;let w;switch(d){case"top":w={x:v,y:o.y-r.height};break;case"bottom":w={x:v,y:o.y+o.height};break;case"right":w={x:o.x+o.width,y:p};break;case"left":w={x:o.x-r.width,y:p};break;default:w={x:o.x,y:o.y}}switch(or(t)){case"start":w[i]-=x*(s&&h?-1:1);break;case"end":w[i]+=x*(s&&h?-1:1);break}return w}const sp=async(e,t,s)=>{const{placement:o="bottom",strategy:r="absolute",middleware:n=[],platform:i}=s,l=n.filter(Boolean),d=await(i.isRTL==null?void 0:i.isRTL(t));let h=await i.getElementRects({reference:e,floating:t,strategy:r}),{x:v,y:p}=id(h,o,d),x=o,w={},$=0;for(let M=0;M<l.length;M++){const{name:j,fn:H}=l[M],{x:R,y:K,data:ie,reset:X}=await H({x:v,y:p,initialPlacement:o,placement:x,strategy:r,middlewareData:w,rects:h,platform:i,elements:{reference:e,floating:t}});v=R??v,p=K??p,w={...w,[j]:{...w[j],...ie}},X&&$<=50&&($++,typeof X=="object"&&(X.placement&&(x=X.placement),X.rects&&(h=X.rects===!0?await i.getElementRects({reference:e,floating:t,strategy:r}):X.rects),{x:v,y:p}=id(h,x,d)),M=-1)}return{x:v,y:p,placement:x,strategy:r,middlewareData:w}};async function Js(e,t){var s;t===void 0&&(t={});const{x:o,y:r,platform:n,rects:i,elements:l,strategy:d}=e,{boundary:h="clippingAncestors",rootBoundary:v="viewport",elementContext:p="floating",altBoundary:x=!1,padding:w=0}=$s(t,e),$=$c(w),j=l[x?p==="floating"?"reference":"floating":p],H=en(await n.getClippingRect({element:(s=await(n.isElement==null?void 0:n.isElement(j)))==null||s?j:j.contextElement||await(n.getDocumentElement==null?void 0:n.getDocumentElement(l.floating)),boundary:h,rootBoundary:v,strategy:d})),R=p==="floating"?{x:o,y:r,width:i.floating.width,height:i.floating.height}:i.reference,K=await(n.getOffsetParent==null?void 0:n.getOffsetParent(l.floating)),ie=await(n.isElement==null?void 0:n.isElement(K))?await(n.getScale==null?void 0:n.getScale(K))||{x:1,y:1}:{x:1,y:1},X=en(n.convertOffsetParentRelativeRectToViewportRelativeRect?await n.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:R,offsetParent:K,strategy:d}):R);return{top:(H.top-X.top+$.top)/ie.y,bottom:(X.bottom-H.bottom+$.bottom)/ie.y,left:(H.left-X.left+$.left)/ie.x,right:(X.right-H.right+$.right)/ie.x}}const op=e=>({name:"arrow",options:e,async fn(t){const{x:s,y:o,placement:r,rects:n,platform:i,elements:l,middlewareData:d}=t,{element:h,padding:v=0}=$s(e,t)||{};if(h==null)return{};const p=$c(v),x={x:s,y:o},w=qa(r),$=Ya(w),M=await i.getDimensions(h),j=w==="y",H=j?"top":"left",R=j?"bottom":"right",K=j?"clientHeight":"clientWidth",ie=n.reference[$]+n.reference[w]-x[w]-n.floating[$],X=x[w]-n.reference[w],ke=await(i.getOffsetParent==null?void 0:i.getOffsetParent(h));let Ne=ke?ke[K]:0;(!Ne||!await(i.isElement==null?void 0:i.isElement(ke)))&&(Ne=l.floating[K]||n.floating[$]);const Ct=ie/2-X/2,Ge=Ne/2-M[$]/2-1,De=cs(p[H],Ge),kt=cs(p[R],Ge),ye=De,rt=Ne-M[$]-kt,se=Ne/2-M[$]/2+Ct,Ze=ni(ye,se,rt),$e=!d.arrow&&or(r)!=null&&se!==Ze&&n.reference[$]/2-(se<ye?De:kt)-M[$]/2<0,we=$e?se<ye?se-ye:se-rt:0;return{[w]:x[w]+we,data:{[w]:Ze,centerOffset:se-Ze-we,...$e&&{alignmentOffset:we}},reset:$e}}}),rp=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var s,o;const{placement:r,middlewareData:n,rects:i,initialPlacement:l,platform:d,elements:h}=t,{mainAxis:v=!0,crossAxis:p=!0,fallbackPlacements:x,fallbackStrategy:w="bestFit",fallbackAxisSideDirection:$="none",flipAlignment:M=!0,...j}=$s(e,t);if((s=n.arrow)!=null&&s.alignmentOffset)return{};const H=Rt(r),R=gs(l),K=Rt(l)===l,ie=await(d.isRTL==null?void 0:d.isRTL(h.floating)),X=x||(K||!M?[Qr(l)]:Jh(l)),ke=$!=="none";!x&&ke&&X.push(...ep(l,M,$,ie));const Ne=[l,...X],Ct=await Js(t,j),Ge=[];let De=((o=n.flip)==null?void 0:o.overflows)||[];if(v&&Ge.push(Ct[H]),p){const se=Xh(r,i,ie);Ge.push(Ct[se[0]],Ct[se[1]])}if(De=[...De,{placement:r,overflows:Ge}],!Ge.every(se=>se<=0)){var kt,ye;const se=(((kt=n.flip)==null?void 0:kt.index)||0)+1,Ze=Ne[se];if(Ze)return{data:{index:se,overflows:De},reset:{placement:Ze}};let $e=(ye=De.filter(we=>we.overflows[0]<=0).sort((we,Ee)=>we.overflows[1]-Ee.overflows[1])[0])==null?void 0:ye.placement;if(!$e)switch(w){case"bestFit":{var rt;const we=(rt=De.filter(Ee=>{if(ke){const Te=gs(Ee.placement);return Te===R||Te==="y"}return!0}).map(Ee=>[Ee.placement,Ee.overflows.filter(Te=>Te>0).reduce((Te,lr)=>Te+lr,0)]).sort((Ee,Te)=>Ee[1]-Te[1])[0])==null?void 0:rt[0];we&&($e=we);break}case"initialPlacement":$e=l;break}if(r!==$e)return{reset:{placement:$e}}}return{}}}};function ad(e,t){return{top:e.top-t.height,right:e.right-t.width,bottom:e.bottom-t.height,left:e.left-t.width}}function ld(e){return Yh.some(t=>e[t]>=0)}const np=function(e){return e===void 0&&(e={}),{name:"hide",options:e,async fn(t){const{rects:s}=t,{strategy:o="referenceHidden",...r}=$s(e,t);switch(o){case"referenceHidden":{const n=await Js(t,{...r,elementContext:"reference"}),i=ad(n,s.reference);return{data:{referenceHiddenOffsets:i,referenceHidden:ld(i)}}}case"escaped":{const n=await Js(t,{...r,altBoundary:!0}),i=ad(n,s.floating);return{data:{escapedOffsets:i,escaped:ld(i)}}}default:return{}}}}};async function ip(e,t){const{placement:s,platform:o,elements:r}=e,n=await(o.isRTL==null?void 0:o.isRTL(r.floating)),i=Rt(s),l=or(s),d=gs(s)==="y",h=["left","top"].includes(i)?-1:1,v=n&&d?-1:1,p=$s(t,e);let{mainAxis:x,crossAxis:w,alignmentAxis:$}=typeof p=="number"?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return l&&typeof $=="number"&&(w=l==="end"?$*-1:$),d?{x:w*v,y:x*h}:{x:x*h,y:w*v}}const ap=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var s,o;const{x:r,y:n,placement:i,middlewareData:l}=t,d=await ip(t,e);return i===((s=l.offset)==null?void 0:s.placement)&&(o=l.arrow)!=null&&o.alignmentOffset?{}:{x:r+d.x,y:n+d.y,data:{...d,placement:i}}}}},lp=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:s,y:o,placement:r}=t,{mainAxis:n=!0,crossAxis:i=!1,limiter:l={fn:j=>{let{x:H,y:R}=j;return{x:H,y:R}}},...d}=$s(e,t),h={x:s,y:o},v=await Js(t,d),p=gs(Rt(r)),x=kc(p);let w=h[x],$=h[p];if(n){const j=x==="y"?"top":"left",H=x==="y"?"bottom":"right",R=w+v[j],K=w-v[H];w=ni(R,w,K)}if(i){const j=p==="y"?"top":"left",H=p==="y"?"bottom":"right",R=$+v[j],K=$-v[H];$=ni(R,$,K)}const M=l.fn({...t,[x]:w,[p]:$});return{...M,data:{x:M.x-s,y:M.y-o,enabled:{[x]:n,[p]:i}}}}}};function yn(){return typeof window<"u"}function Ss(e){return Sc(e)?(e.nodeName||"").toLowerCase():"#document"}function _e(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Ie(e){var t;return(t=(Sc(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Sc(e){return yn()?e instanceof Node||e instanceof _e(e).Node:!1}function Ae(e){return yn()?e instanceof Element||e instanceof _e(e).Element:!1}function We(e){return yn()?e instanceof HTMLElement||e instanceof _e(e).HTMLElement:!1}function dd(e){return!yn()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof _e(e).ShadowRoot}function rr(e){const{overflow:t,overflowX:s,overflowY:o,display:r}=Oe(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+s)&&!["inline","contents"].includes(r)}function dp(e){return["table","td","th"].includes(Ss(e))}function wn(e){return[":popover-open",":modal"].some(t=>{try{return e.matches(t)}catch{return!1}})}function Ka(e){const t=Xa(),s=Ae(e)?Oe(e):e;return s.transform!=="none"||s.perspective!=="none"||(s.containerType?s.containerType!=="normal":!1)||!t&&(s.backdropFilter?s.backdropFilter!=="none":!1)||!t&&(s.filter?s.filter!=="none":!1)||["transform","perspective","filter"].some(o=>(s.willChange||"").includes(o))||["paint","layout","strict","content"].some(o=>(s.contain||"").includes(o))}function cp(e){let t=ut(e);for(;We(t)&&!hs(t);){if(Ka(t))return t;if(wn(t))return null;t=ut(t)}return null}function Xa(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function hs(e){return["html","body","#document"].includes(Ss(e))}function Oe(e){return _e(e).getComputedStyle(e)}function _n(e){return Ae(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function ut(e){if(Ss(e)==="html")return e;const t=e.assignedSlot||e.parentNode||dd(e)&&e.host||Ie(e);return dd(t)?t.host:t}function Mc(e){const t=ut(e);return hs(t)?e.ownerDocument?e.ownerDocument.body:e.body:We(t)&&rr(t)?t:Mc(t)}function Qs(e,t,s){var o;t===void 0&&(t=[]),s===void 0&&(s=!0);const r=Mc(e),n=r===((o=e.ownerDocument)==null?void 0:o.body),i=_e(r);if(n){const l=ai(i);return t.concat(i,i.visualViewport||[],rr(r)?r:[],l&&s?Qs(l):[])}return t.concat(r,Qs(r,[],s))}function ai(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Ec(e){const t=Oe(e);let s=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const r=We(e),n=r?e.offsetWidth:s,i=r?e.offsetHeight:o,l=Jr(s)!==n||Jr(o)!==i;return l&&(s=n,o=i),{width:s,height:o,$:l}}function Ja(e){return Ae(e)?e:e.contextElement}function as(e){const t=Ja(e);if(!We(t))return He(1);const s=t.getBoundingClientRect(),{width:o,height:r,$:n}=Ec(t);let i=(n?Jr(s.width):s.width)/o,l=(n?Jr(s.height):s.height)/r;return(!i||!Number.isFinite(i))&&(i=1),(!l||!Number.isFinite(l))&&(l=1),{x:i,y:l}}const gp=He(0);function Tc(e){const t=_e(e);return!Xa()||!t.visualViewport?gp:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function hp(e,t,s){return t===void 0&&(t=!1),!s||t&&s!==_e(e)?!1:t}function Bt(e,t,s,o){t===void 0&&(t=!1),s===void 0&&(s=!1);const r=e.getBoundingClientRect(),n=Ja(e);let i=He(1);t&&(o?Ae(o)&&(i=as(o)):i=as(e));const l=hp(n,s,o)?Tc(n):He(0);let d=(r.left+l.x)/i.x,h=(r.top+l.y)/i.y,v=r.width/i.x,p=r.height/i.y;if(n){const x=_e(n),w=o&&Ae(o)?_e(o):o;let $=x,M=ai($);for(;M&&o&&w!==$;){const j=as(M),H=M.getBoundingClientRect(),R=Oe(M),K=H.left+(M.clientLeft+parseFloat(R.paddingLeft))*j.x,ie=H.top+(M.clientTop+parseFloat(R.paddingTop))*j.y;d*=j.x,h*=j.y,v*=j.x,p*=j.y,d+=K,h+=ie,$=_e(M),M=ai($)}}return en({width:v,height:p,x:d,y:h})}function Qa(e,t){const s=_n(e).scrollLeft;return t?t.left+s:Bt(Ie(e)).left+s}function zc(e,t,s){s===void 0&&(s=!1);const o=e.getBoundingClientRect(),r=o.left+t.scrollLeft-(s?0:Qa(e,o)),n=o.top+t.scrollTop;return{x:r,y:n}}function pp(e){let{elements:t,rect:s,offsetParent:o,strategy:r}=e;const n=r==="fixed",i=Ie(o),l=t?wn(t.floating):!1;if(o===i||l&&n)return s;let d={scrollLeft:0,scrollTop:0},h=He(1);const v=He(0),p=We(o);if((p||!p&&!n)&&((Ss(o)!=="body"||rr(i))&&(d=_n(o)),We(o))){const w=Bt(o);h=as(o),v.x=w.x+o.clientLeft,v.y=w.y+o.clientTop}const x=i&&!p&&!n?zc(i,d,!0):He(0);return{width:s.width*h.x,height:s.height*h.y,x:s.x*h.x-d.scrollLeft*h.x+v.x+x.x,y:s.y*h.y-d.scrollTop*h.y+v.y+x.y}}function up(e){return Array.from(e.getClientRects())}function fp(e){const t=Ie(e),s=_n(e),o=e.ownerDocument.body,r=Ht(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),n=Ht(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let i=-s.scrollLeft+Qa(e);const l=-s.scrollTop;return Oe(o).direction==="rtl"&&(i+=Ht(t.clientWidth,o.clientWidth)-r),{width:r,height:n,x:i,y:l}}function mp(e,t){const s=_e(e),o=Ie(e),r=s.visualViewport;let n=o.clientWidth,i=o.clientHeight,l=0,d=0;if(r){n=r.width,i=r.height;const h=Xa();(!h||h&&t==="fixed")&&(l=r.offsetLeft,d=r.offsetTop)}return{width:n,height:i,x:l,y:d}}function vp(e,t){const s=Bt(e,!0,t==="fixed"),o=s.top+e.clientTop,r=s.left+e.clientLeft,n=We(e)?as(e):He(1),i=e.clientWidth*n.x,l=e.clientHeight*n.y,d=r*n.x,h=o*n.y;return{width:i,height:l,x:d,y:h}}function cd(e,t,s){let o;if(t==="viewport")o=mp(e,s);else if(t==="document")o=fp(Ie(e));else if(Ae(t))o=vp(t,s);else{const r=Tc(e);o={x:t.x-r.x,y:t.y-r.y,width:t.width,height:t.height}}return en(o)}function Ac(e,t){const s=ut(e);return s===t||!Ae(s)||hs(s)?!1:Oe(s).position==="fixed"||Ac(s,t)}function bp(e,t){const s=t.get(e);if(s)return s;let o=Qs(e,[],!1).filter(l=>Ae(l)&&Ss(l)!=="body"),r=null;const n=Oe(e).position==="fixed";let i=n?ut(e):e;for(;Ae(i)&&!hs(i);){const l=Oe(i),d=Ka(i);!d&&l.position==="fixed"&&(r=null),(n?!d&&!r:!d&&l.position==="static"&&!!r&&["absolute","fixed"].includes(r.position)||rr(i)&&!d&&Ac(e,i))?o=o.filter(v=>v!==i):r=l,i=ut(i)}return t.set(e,o),o}function xp(e){let{element:t,boundary:s,rootBoundary:o,strategy:r}=e;const i=[...s==="clippingAncestors"?wn(t)?[]:bp(t,this._c):[].concat(s),o],l=i[0],d=i.reduce((h,v)=>{const p=cd(t,v,r);return h.top=Ht(p.top,h.top),h.right=cs(p.right,h.right),h.bottom=cs(p.bottom,h.bottom),h.left=Ht(p.left,h.left),h},cd(t,l,r));return{width:d.right-d.left,height:d.bottom-d.top,x:d.left,y:d.top}}function yp(e){const{width:t,height:s}=Ec(e);return{width:t,height:s}}function wp(e,t,s){const o=We(t),r=Ie(t),n=s==="fixed",i=Bt(e,!0,n,t);let l={scrollLeft:0,scrollTop:0};const d=He(0);if(o||!o&&!n)if((Ss(t)!=="body"||rr(r))&&(l=_n(t)),o){const x=Bt(t,!0,n,t);d.x=x.x+t.clientLeft,d.y=x.y+t.clientTop}else r&&(d.x=Qa(r));const h=r&&!o&&!n?zc(r,l):He(0),v=i.left+l.scrollLeft-d.x-h.x,p=i.top+l.scrollTop-d.y-h.y;return{x:v,y:p,width:i.width,height:i.height}}function Bn(e){return Oe(e).position==="static"}function gd(e,t){if(!We(e)||Oe(e).position==="fixed")return null;if(t)return t(e);let s=e.offsetParent;return Ie(e)===s&&(s=s.ownerDocument.body),s}function Oc(e,t){const s=_e(e);if(wn(e))return s;if(!We(e)){let r=ut(e);for(;r&&!hs(r);){if(Ae(r)&&!Bn(r))return r;r=ut(r)}return s}let o=gd(e,t);for(;o&&dp(o)&&Bn(o);)o=gd(o,t);return o&&hs(o)&&Bn(o)&&!Ka(o)?s:o||cp(e)||s}const _p=async function(e){const t=this.getOffsetParent||Oc,s=this.getDimensions,o=await s(e.floating);return{reference:wp(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function Cp(e){return Oe(e).direction==="rtl"}const kp={convertOffsetParentRelativeRectToViewportRelativeRect:pp,getDocumentElement:Ie,getClippingRect:xp,getOffsetParent:Oc,getElementRects:_p,getClientRects:up,getDimensions:yp,getScale:as,isElement:Ae,isRTL:Cp};function $p(e,t){let s=null,o;const r=Ie(e);function n(){var l;clearTimeout(o),(l=s)==null||l.disconnect(),s=null}function i(l,d){l===void 0&&(l=!1),d===void 0&&(d=1),n();const{left:h,top:v,width:p,height:x}=e.getBoundingClientRect();if(l||t(),!p||!x)return;const w=gr(v),$=gr(r.clientWidth-(h+p)),M=gr(r.clientHeight-(v+x)),j=gr(h),R={rootMargin:-w+"px "+-$+"px "+-M+"px "+-j+"px",threshold:Ht(0,cs(1,d))||1};let K=!0;function ie(X){const ke=X[0].intersectionRatio;if(ke!==d){if(!K)return i();ke?i(!1,ke):o=setTimeout(()=>{i(!1,1e-7)},1e3)}K=!1}try{s=new IntersectionObserver(ie,{...R,root:r.ownerDocument})}catch{s=new IntersectionObserver(ie,R)}s.observe(e)}return i(!0),n}function Lc(e,t,s,o){o===void 0&&(o={});const{ancestorScroll:r=!0,ancestorResize:n=!0,elementResize:i=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:d=!1}=o,h=Ja(e),v=r||n?[...h?Qs(h):[],...Qs(t)]:[];v.forEach(H=>{r&&H.addEventListener("scroll",s,{passive:!0}),n&&H.addEventListener("resize",s)});const p=h&&l?$p(h,s):null;let x=-1,w=null;i&&(w=new ResizeObserver(H=>{let[R]=H;R&&R.target===h&&w&&(w.unobserve(t),cancelAnimationFrame(x),x=requestAnimationFrame(()=>{var K;(K=w)==null||K.observe(t)})),s()}),h&&!d&&w.observe(h),w.observe(t));let $,M=d?Bt(e):null;d&&j();function j(){const H=Bt(e);M&&(H.x!==M.x||H.y!==M.y||H.width!==M.width||H.height!==M.height)&&s(),M=H,$=requestAnimationFrame(j)}return s(),()=>{var H;v.forEach(R=>{r&&R.removeEventListener("scroll",s),n&&R.removeEventListener("resize",s)}),p==null||p(),(H=w)==null||H.disconnect(),w=null,d&&cancelAnimationFrame($)}}const Sp=Js,Dc=ap,Mp=lp,Vc=rp,Ep=np,Tp=op,Pc=(e,t,s)=>{const o=new Map,r={platform:kp,...s},n={...r.platform,_c:o};return sp(e,t,{...r,platform:n})};var zp=D`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: contents;
...
`,Ap=zp,li,Hc,Ft,tn,it,Ds,Tt,di,xr,ci,gi,Fc,hi,jc,yr,pi,Cn,kn,wr,_r,Z=class extends Y{constructor(){super(...arguments),f(this,li),f(this,xr),f(this,gi),f(this,hi),f(this,yr),this.open=!1,this.popupRole="dialog",this.label=void 0,this.placement="bottom-start",this.disableMobileStyles=!1,this.calcMinWidth=e=>`${e.offsetWidth}px`,this.calcMaxWidth=e=>"auto",this.calcMinHeight=e=>"auto",this.calcMaxHeight=e=>"500px",this.nonmodal=!1,this.floatingUIMiddleware=[Dc(8),Vc()],this._trigger=void 0,this._anchor=void 0,this._isVirtKbVisible=!1,f(this,Ft,void 0),f(this,tn,!1),f(this,it,void 0),f(this,Ds,()=>{this.open=!1,c(this,Tt).call(this,"cancel")}),f(this,Tt,e=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:this.open,reason:e},bubbles:!1,composed:!1}))}),f(this,di,e=>{e.stopPropagation(),e.preventDefault(),this.open=!1,c(this,Tt).call(this,"close"),setTimeout(()=>{var t;return(t=this._trigger)==null?void 0:t.focus()},250)}),f(this,Cn,e=>{(e.key==="ArrowDown"||e.key==="ArrowUp")&&(e.preventDefault(),this.open=!0,c(this,Tt).call(this,"show")),e.key==="Escape"&&this.open&&c(this,Ds).call(this)}),f(this,kn,e=>{e.preventDefault(),this.open=!this.open,c(this,Tt).call(this,this.open?"show":"close")}),f(this,wr,()=>{var e;const t=(e=this._elDefaultSlot)==null?void 0:e.assignedElements()[0];this.updateComplete.then(()=>{t==null||t.focus()})}),f(this,_r,e=>{const t=e,s=this._elDialog;if((t.clientX>0||t.clientY>0)&&s&&this.open){const r=s.getBoundingClientRect();r.top<=t.clientY&&t.clientY<=r.top+r.height&&r.left<=t.clientX&&t.clientX<=r.left+r.width||(this.open=!1,c(this,Tt).call(this,"close"))}})}_handleTriggerRefChanged(){var e;(e=this.triggerRef)==null||e.then(t=>{t&&(this._trigger=t)})}_handleAnchorRefChanged(){var e;(e=this.anchorRef)==null||e.then(t=>{t&&(this._anchor=t)})}_handleTriggerChanged(){C(this,xr,ci).call(this),C(this,hi,jc).call(this)}_handleAnchorChanged(){C(this,yr,pi).call(this)}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-popover"),C(this,xr,ci).call(this),this._handleOpenChange(),this.addEventListener("keydown",e=>{e.key==="Escape"&&this.open&&(c(this,Ds).call(this),e.stopPropagation(),e.preventDefault())}),this.addEventListener("focusin",e=>{const t=e.target;t.tagName==="INPUT"||t.tagName==="TEXTAREA"?this._isVirtKbVisible=!0:this._isVirtKbVisible=!1}),this.addEventListener("blurin",e=>{this._isVirtKbVisible=!1})}disconnectedCallback(){super.disconnectedCallback(),C(this,gi,Fc).call(this)}render(){return m`<slot
        name="trigger"
        @slotchange=${C(this,li,Hc)}
      ></slot>
      ...
      </div>`}_handleOpenChange(){const e=(this.nonmodal?c(this,it):this._elDialog)||document;this.updateComplete.then(()=>{var t,s,o,r;(t=this._trigger)==null||t.setAttribute("aria-expanded",String(this.open)),this.open?(this.nonmodal?(o=this._elDialog)==null||o.setAttribute("open","true"):(s=this._elDialog)==null||s.showModal(),c(this,wr).call(this),requestAnimationFrame(()=>{c(this,it)&&(c(this,it).show=!0)}),setTimeout(()=>c(this,wr).call(this),250),setTimeout(()=>e.addEventListener("click",c(this,_r)),0)):((r=this._elDialog)==null||r.close(),e.removeEventListener("click",c(this,_r)),c(this,it)&&(c(this,it).show=!1))})}_handleBackdropChange(){var e;const t=(e=this.parentElement)==null?void 0:e.getRootNode();!this.backdrop||!t||U(this,it,t.querySelector(this.backdrop))}_handleMobileLayout(e){var t,s,o,r;U(this,tn,e),e&&!this.disableMobileStyles?((t=c(this,Ft))==null||t.call(this),(s=this._elDialog)==null||s.style.removeProperty("left"),(o=this._elDialog)==null||o.style.removeProperty("top"),(r=this._elDialog)==null||r.style.removeProperty("minWidth"),this.updateComplete.then(()=>{var n;this.open&&((n=this._elDialog)==null||n.showModal())})):this.updateComplete.then(()=>{C(this,yr,pi).call(this)})}};li=new WeakSet;Hc=function(){this._elTriggerSlot&&this._elTriggerSlot.assignedElements()[0]&&(this._trigger=this._elTriggerSlot.assignedElements()[0],this._anchor=this._elTriggerSlot.assignedElements()[0])};Ft=new WeakMap;tn=new WeakMap;it=new WeakMap;Ds=new WeakMap;Tt=new WeakMap;di=new WeakMap;xr=new WeakSet;ci=function(){var e,t;(e=this._trigger)==null||e.addEventListener("keydown",c(this,Cn)),(t=this._trigger)==null||t.addEventListener("click",c(this,kn))};gi=new WeakSet;Fc=function(){var e,t,s;(e=this._trigger)==null||e.removeEventListener("keydown",c(this,Cn)),(t=this._trigger)==null||t.removeEventListener("click",c(this,kn)),(s=c(this,Ft))==null||s.call(this)};hi=new WeakSet;jc=function(){var e;if(this._trigger){(e=this._trigger)==null||e.setAttribute("aria-expanded",String(this.open));const t=["A","BUTTON","INPUT","TEXTAREA"];this._trigger.nodeName.startsWith("GDS-")||t.includes(this._trigger.nodeName)||(this._trigger.setAttribute("tabindex","0"),this._trigger.setAttribute("role","button"));const o=this._trigger.nodeName.startsWith("GDS-")?"gds-aria-haspopup":"aria-haspopup";this._trigger.getAttribute(o)===null&&this._trigger.setAttribute(o,this.popupRole)}};yr=new WeakSet;pi=function(){if(!this._anchor||!this._elDialog)return;const e=this._anchor,t=this._elDialog;!e||!t||c(this,tn)&&!this.disableMobileStyles||(c(this,Ft)&&c(this,Ft).call(this),U(this,Ft,Lc(e,t,()=>{Object.assign(t.style,{minWidth:this.calcMinWidth(e),maxWidth:this.calcMaxWidth(e),minHeight:this.calcMinHeight(e),maxHeight:this.calcMaxHeight(e)}),Pc(e,t,{placement:this.placement,middleware:this.floatingUIMiddleware,strategy:"fixed"}).then(({x:s,y:o})=>Object.assign(t.style,{left:`${s}px`,top:`${o}px`}))})))};Cn=new WeakMap;kn=new WeakMap;wr=new WeakMap;_r=new WeakMap;Z.styles=G(Ap);a([g({type:Boolean,reflect:!0})],Z.prototype,"open",2);a([g({attribute:"popup-role"})],Z.prototype,"popupRole",2);a([g({attribute:!1})],Z.prototype,"triggerRef",2);a([g({attribute:!1})],Z.prototype,"anchorRef",2);a([g()],Z.prototype,"label",2);a([g()],Z.prototype,"placement",2);a([g({type:Boolean})],Z.prototype,"disableMobileStyles",2);a([g({attribute:!1})],Z.prototype,"calcMinWidth",2);a([g({attribute:!1})],Z.prototype,"calcMaxWidth",2);a([g({attribute:!1})],Z.prototype,"calcMinHeight",2);a([g({attribute:!1})],Z.prototype,"calcMaxHeight",2);a([g({type:Boolean})],Z.prototype,"nonmodal",2);a([g()],Z.prototype,"backdrop",2);a([g({attribute:!1})],Z.prototype,"floatingUIMiddleware",2);a([P()],Z.prototype,"_trigger",2);a([P()],Z.prototype,"_anchor",2);a([P()],Z.prototype,"_isVirtKbVisible",2);a([te("slot:not([name])")],Z.prototype,"_elDefaultSlot",2);a([te('slot[name="trigger"]')],Z.prototype,"_elTriggerSlot",2);a([te("dialog")],Z.prototype,"_elDialog",2);a([ne("triggerRef")],Z.prototype,"_handleTriggerRefChanged",1);a([ne("anchorRef")],Z.prototype,"_handleAnchorRefChanged",1);a([ne("_trigger")],Z.prototype,"_handleTriggerChanged",1);a([ne("_anchor")],Z.prototype,"_handleAnchorChanged",1);a([ne("open")],Z.prototype,"_handleOpenChange",1);a([ne("backdrop")],Z.prototype,"_handleBackdropChange",1);a([Uh("(max-width: 576px)")],Z.prototype,"_handleMobileLayout",1);Z=a([k("gds-popover"),qt()],Z);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ui extends sr{constructor(t){if(super(t),this.it=N,t.type!==tr.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===N||t==null)return this._t=void 0,this.it=t;if(t===ze)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const s=[t];return s.raw=s,this._t={_$litType$:this.constructor.resultType,strings:s,values:[]}}}ui.directiveName="unsafeHTML",ui.resultType=1;const Wc=ks(ui);var Op=D`
  @layer icon;
...
`,Lp=Op,L=class extends Y{constructor(){super(...arguments),this.solid=!1,this.box=!1,this.label=""}render(){const e=this.constructor._name==="brand-seb",t=e?"55":this.width!==void 0?this.width.toString():void 0,s=e?"24":this.height!==void 0?this.height.toString():"1lh",o=e?"0 0 55 24":this.box||"0 0 24 24";let r=`<svg
      ${t?`width="${t}"`:""}
      height="${s}"
      viewBox="${o}"
      fill="none"
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ae(e,t,s){return e?t(e):s==null?void 0:s(e)}var Dp=class extends sr{constructor(e){if(super(e),e.type!==tr.ELEMENT)throw new Error("The `forwardAttributes` directive must be used in element bindings")}render(e){return N}update(e,[t]){var s;const o=e.element,r=(s=e.options)==null?void 0:s.host;Array.from(r.attributes).forEach(n=>{t(n)&&o.setAttribute(n.name.replace("gds-",""),n.value)})}},Rc=ks(Dp),hd=new WeakMap;function Vp(e){return(t,...s)=>{let o=hd.get(t);return o||(o=t.map(r=>r.replace(/\n[\s]+</gm,"<")),o.raw=t.raw,hd.set(t,o)),e(o,...s)}}var Pp=`@layer tokens, core, a11y, ranks, sizes, variants, disabled;
...
`,Hp=["aria-label","aria-haspopup","aria-expanded"],Fp=Vp(m),Vs,qe,at,fi,Bc,mi,vi,de=class extends Me{constructor(){super(),f(this,qe),f(this,fi),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",f(this,Vs,!1),f(this,mi,()=>{var e,t;const s=(t=(e=this._mainSlot)==null?void 0:e.assignedElements())!=null?t:[];U(this,Vs,s.length===1&&s.some(o=>o.tagName.toLowerCase().startsWith("gds-icon"))),this.requestUpdate()}),f(this,vi,e=>{this.dispatchEvent(new CustomEvent("gds-click",{bubbles:!0,composed:!0,detail:e})),this.form&&!c(this,qe,at)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),xe.instance.apply(this,"gds-button")}render(){const e={button:!0,circle:c(this,Vs),icon:c(this,Vs),small:this.size==="small",large:this.size==="large",positive:this.variant==="positive",negative:this.variant==="negative",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=c(this,qe,at)?Gr`a`:Gr`button`;return er`
      <${t}
        class=${Fe(e)}
        ...
        rel=${ue(c(this,qe,at)?this.rel||c(this,fi,Bc):void 0)}
        download=${ue(c(this,qe,at)?this.download:void 0)}
        part="_button"
        @click="${c(this,vi)}"
        ${Rc(s=>s.name.startsWith("gds-aria")||s.name==="gds-role"||Hp.includes(s.name))}
      >
        <slot name="lead"></slot>
        <slot @slotchange=${c(this,mi)}></slot>
        <slot name="trail"></slot>
        ${ae(!this._isUsingTransitionalStyles,()=>Fp`<gds-ripple part="_ripple"></gds-ripple>`)}
        </${t}>
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}};Vs=new WeakMap;qe=new WeakSet;at=function(){return this.href.length>0};fi=new WeakSet;Bc=function(){return this.target==="_blank"?"noreferrer noopener":void 0};mi=new WeakMap;vi=new WeakMap;de.styles=[J,G(Pp)];de.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g({type:Boolean,reflect:!0})],de.prototype,"disabled",2);a([g({reflect:!0})],de.prototype,"type",2);a([g({reflect:!0})],de.prototype,"rank",2);a([g({reflect:!0})],de.prototype,"variant",2);a([g({reflect:!0})],de.prototype,"size",2);a([g()],de.prototype,"label",2);a([g()],de.prototype,"href",2);a([g()],de.prototype,"target",2);a([g()],de.prototype,"rel",2);a([g()],de.prototype,"download",2);a([te("slot:not([name])")],de.prototype,"_mainSlot",2);a([te(".button")],de.prototype,"_button",2);a([Ua({attributes:!0,childList:!1,subtree:!1,characterData:!1})],de.prototype,"_attributeChanged",1);de=a([k("gds-button")],de);var jp=D`
...
`,bi,Ic,xi,Nc,el,tl,sl,ol,rl,nl,Gc,il,Zc,al,Uc,ll,Yc,dl,qc,cl,Kc,me=class extends Me{constructor(){super(),f(this,bi),f(this,xi),f(this,nl),f(this,il),f(this,al),f(this,ll),f(this,dl),f(this,cl),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",this.trailSlotOccupied=!1,f(this,el,e=>["type","placeholder","required"].includes(e.name)),f(this,tl,e=>{const t=e.target;this.value=t.value}),f(this,sl,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),f(this,ol,()=>{this.elInputAsync.then(e=>e.focus())}),f(this,rl,()=>{this.value="",this.dispatchEvent(new Event("gds-input-cleared",{bubbles:!0,composed:!0}))})}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return m`${tc(this.variant,[["default",()=>C(this,bi,Ic).call(this)],["floating-label",()=>C(this,xi,Nc).call(this)]])}`}_getValidityAnchor(){return this.elInput}};bi=new WeakSet;Ic=function(){return m`
      ...
      >
        ${C(this,nl,Gc).call(this)} ${C(this,ll,Yc).call(this)}
        <gds-flex gap="xs" align-items="center">
          ${C(this,dl,qc).call(this)} ${C(this,il,Zc).call(this)}
        </gds-flex>
      </gds-flex>

      <gds-form-control-footer
        class="size-${this.size}"
        .charCounter=${c(this,cl,Kc)&&this.maxlength-this.value.length}
        .validationMessage=${this.invalid&&this.validationMessage}
      ></gds-form-control-footer>
    `};xi=new WeakSet;Nc=function(){return N};el=new WeakMap;tl=new WeakMap;sl=new WeakMap;ol=new WeakMap;rl=new WeakMap;nl=new WeakSet;Gc=function(){return m` <slot name="lead"></slot> `};il=new WeakSet;Zc=function(){return m`
      <slot name="trail" @slotchange=${C(this,al,Uc)}></slot>
    `};al=new WeakSet;Uc=function(e){const s=e.target.assignedNodes({flatten:!0});this.trailSlotOccupied=s.length>0&&s.some(o=>{var r;return o.nodeType===Node.ELEMENT_NODE||o.nodeType===Node.TEXT_NODE&&((r=o.textContent)==null?void 0:r.trim())!==""})};ll=new WeakSet;Yc=function(){return m`
      <input
        @input=${c(this,tl)}
        @change=${c(this,sl)}
        ...
        ${Rc(c(this,el))}
      />
    `};dl=new WeakSet;qc=function(){return this.clearable&&this.value.length>0?m`
        <gds-button
      ...
      `:N};cl=new WeakSet;Kc=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};me.styles=[J,jp];a([g()],me.prototype,"value",2);a([g()],me.prototype,"label",2);a([g({attribute:"supporting-text"})],me.prototype,"supportingText",2);a([g({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],me.prototype,"showExtendedSupportingText",2);a([g({attribute:"disabled",type:Boolean,reflect:!0})],me.prototype,"disabled",2);a([g({type:Boolean})],me.prototype,"clearable",2);a([g({type:Number})],me.prototype,"maxlength",2);a([g({type:String})],me.prototype,"variant",2);a([g({type:String})],me.prototype,"size",2);a([xt("input")],me.prototype,"elInputAsync",2);a([te("input")],me.prototype,"elInput",2);a([P()],me.prototype,"trailSlotOccupied",2);me=a([k("gds-input"),qt()],me);var Wp=D`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`,gl,Xc,yi,wi,_i,Jc,ps=class extends Y{constructor(){super(...arguments),f(this,gl),f(this,_i),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,f(this,yi,()=>m`
      <gds-button
        size="small"
        rank="tertiary"
    ...
    `),f(this,wi,()=>{var e;this.showExtendedSupportingText=!this.showExtendedSupportingText,(e=this._extendedSupportingText)==null||e.style.setProperty("--_max-height",this.showExtendedSupportingText?`${this._extendedSupportingText.scrollHeight}px`:"0"),this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))})}render(){return m`
      <div id="label-row">
        <div>
          <slot name="label"></slot>
          <slot name="supporting-text"></slot>
        </div>
        ${ae(this._hasExtendedSupportingText,c(this,yi))}
      </div>

      ${C(this,_i,Jc).call(this)}
    `}};gl=new WeakSet;Xc=function(e){this._hasExtendedSupportingText=e.target.assignedElements({flatten:!0}).length>0};yi=new WeakMap;wi=new WeakMap;_i=new WeakSet;Jc=function(){return m`
      <div
      ...
      >
        <slot
          name="extended-supporting-text"
          @slotchange=${C(this,gl,Xc)}
        ></slot>
      </div>
    `};ps.styles=[Wp];a([g({type:Boolean,reflect:!0})],ps.prototype,"showExtendedSupportingText",2);a([P()],ps.prototype,"_hasExtendedSupportingText",2);a([te("#extended-supporting-text")],ps.prototype,"_extendedSupportingText",2);ps=a([k("gds-form-control-header"),qt()],ps);var Rp=D`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`,Ci,Qc,uo=class extends Y{constructor(){super(...arguments),f(this,Ci)}render(){return m`<div aria-live="polite">
...
`,Ip=Bp,ve=class extends A{constructor(){super(),this.display="flex"}render(){return m`<slot></slot>`}};ve.styles=[J,Ip];a([y({styleTemplate:(e,t)=>{const s=t[0],o=t[1]||s;return`gap: ${s} ${o};`},cacheOverrideKey:"flex"})],ve.prototype,"gap",2);a([y({valueTemplate:e=>e})],ve.prototype,"flex",2);a([y({valueTemplate:e=>e})],ve.prototype,"align-self",2);a([y({valueTemplate:e=>e})],ve.prototype,"align-items",2);a([y({valueTemplate:e=>e})],ve.prototype,"align-content",2);a([y({valueTemplate:e=>e})],ve.prototype,"justify-content",2);a([y({valueTemplate:e=>e})],ve.prototype,"place-content",2);a([y({valueTemplate:e=>e})],ve.prototype,"justify-items",2);a([y({valueTemplate:e=>e})],ve.prototype,"justify-self",2);a([y({property:"flex-direction",valueTemplate:e=>e})],ve.prototype,"flex-direction",2);a([y({property:"flex-wrap",valueTemplate:e=>e})],ve.prototype,"flex-wrap",2);ve=a([k("gds-flex")],ve);var vo=class extends A{constructor(){super(),this.variant="primary",this.padding="s; m{l}",this["border-radius"]="xs; m{s}",this["border-width"]="4xs"}render(){return m`<slot></slot>`}};vo.styles=[J,D`
    ...
    `];a([y({property:"box-shadow",valueTemplate:e=>`var(--gds-shadow-${e})`})],vo.prototype,"shadow",2);a([y({valueTemplate:e=>e,styleTemplate:function(e,t){return`
      ...
      `}})],vo.prototype,"variant",2);vo=a([k("gds-card")],vo);var Np=D`
  :host {
    display: inline-block;
  }
...
`,Gp=Np,ki,e1,$i,t1,hl,s1,Si,o1,ft=class extends Y{constructor(){super(),f(this,ki),f(this,$i),f(this,hl),f(this,Si),this.variant="information",this.size="default",this.disabled=!1,this.notification=!1,this.mainSlotOccupied=!1}render(){const e=this.disabled?"disabled":this.notification?this.variant:this.variant+"-badge",t=this.disabled?"disabled":this.notification?"primary":this.variant,s=this.size==="small"||this.notification?"2xs":"xs",o=this.mainSlotOccupied?this.size==="small"||this.notification?"m":"l":"xs";return m`<gds-flex
    ...
    >
      ${C(this,ki,e1).call(this)} ${C(this,$i,t1).call(this)}
      ${C(this,Si,o1).call(this)}
    </gds-flex>`}};ki=new WeakSet;e1=function(){if(this.size!=="small"||!this.notification)return m`<slot name="lead"></slot>`};$i=new WeakSet;t1=function(){return m`<slot @slotchange=${C(this,hl,s1)}></slot>`};hl=new WeakSet;s1=function(e){const s=e.target.assignedNodes({flatten:!0});this.mainSlotOccupied=s.length>0&&s.some(o=>{var r;return o.nodeType===Node.ELEMENT_NODE||o.nodeType===Node.TEXT_NODE&&((r=o.textContent)==null?void 0:r.trim())!==""})};Si=new WeakSet;o1=function(){return m`<slot name="trail"></slot>`};ft.styles=[J,Gp];a([g()],ft.prototype,"variant",2);a([g({type:String})],ft.prototype,"size",2);a([g({attribute:"disabled",type:Boolean,reflect:!0})],ft.prototype,"disabled",2);a([g({attribute:"notification",type:Boolean,reflect:!0})],ft.prototype,"notification",2);a([P()],ft.prototype,"mainSlotOccupied",2);ft=a([k("gds-badge")],ft);var Zp=`:host {
...
}`,sn=class extends E{constructor(){super(...arguments),this.onmousedown=t=>{const o=t.target.getBoundingClientRect(),r=this._rippleEl;r&&(r.classList.remove("gds-ripple-effect"),this.style.setProperty("--gds-ripple-top",`${t.clientY-o.top}px`),this.style.setProperty("--gds-ripple-left",`${t.clientX-o.left}px`),setTimeout(()=>{r.classList.add("gds-ripple-effect")},20))}}render(){return ge`<div></div>`}};sn.styles=[J,G(Zp)];a([te("div")],sn.prototype,"_rippleEl",2);sn=a([k("gds-ripple")],sn);var It=class extends Y{constructor(){super(...arguments),this.colorScheme="light",this.designVersion="2016"}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-theme"),this._dynamicStylesController.inject("dark",G(`:host {${Xn}}`))}render(){return m`<slot></slot>`}_onColorSchemeChange(){this.colorScheme==="dark"?this._dynamicStylesController.inject("dark",G(`:host { ${Xn}}`)):this._dynamicStylesController.inject("light",G(`:host { ${dc}}`)),this.dispatchEvent(new CustomEvent("gds-color-scheme-changed",{detail:{colorScheme:this.colorScheme}}))}_onDesignVersionChange(){this.dispatchEvent(new CustomEvent("gds-design-version-changed",{detail:{designVersion:this.designVersion}}))}};It.styles=D`
    :host {
      display: contents;
    }
  `;a([g({reflect:!0,attribute:"color-scheme"})],It.prototype,"colorScheme",2);a([g({reflect:!0,attribute:"design-version"})],It.prototype,"designVersion",2);a([ne("colorScheme")],It.prototype,"_onColorSchemeChange",1);a([ne("designVersion")],It.prototype,"_onDesignVersionChange",1);It=a([k("gds-theme")],It);var Up=D`
  :host {
    --_c: 12;
...
`,Yp=Up,us=class extends A{constructor(){super(),this.display="grid",this.width="100%"}render(){return m`<slot></slot>`}};us.styles=[J,Yp];a([y({property:"--_c",valueTemplate:e=>e})],us.prototype,"columns",2);a([y({styleTemplate:(e,t)=>{const s=t[0];return`--_gap-column: ${t[1]||s}; --_gap-row: ${s};`}})],us.prototype,"gap",2);a([y({property:"--_col-width",valueTemplate:e=>`${e}px`})],us.prototype,"auto-columns",2);us=a([k("gds-grid")],us);var qp=D`
  @layer core, link;
...
`,Kp=qp,Mi,r1,et=class extends Y{constructor(){super(),f(this,Mi),this.href="",this.variant="default"}render(){const e={secondary:this.variant==="secondary",hidden:this.variant==="hidden"};return er`
      <a
        href=${ue(this.href)}
        target=${ue(this.target)}
        rel=${ue(this.rel||c(this,Mi,r1))}
    ...
    `}};Mi=new WeakSet;r1=function(){return this.target==="_blank"?"noreferrer noopener":void 0};et.styles=[J,G(Kp)];et.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g()],et.prototype,"href",2);a([g()],et.prototype,"target",2);a([g()],et.prototype,"rel",2);a([g()],et.prototype,"download",2);a([g()],et.prototype,"variant",2);et=a([k("gds-link")],et);var Xp=D`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`,s2=t2,zt,ss,Ei,n1,Se=class extends Y{constructor(){super(),f(this,zt),f(this,Ei),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const e={button:!0,selected:this.selected,compact:this.compact},t=c(this,zt,ss)?Gr`a`:Gr`button`;return er`
      <${t}
        class="${Fe(e)}"
        ?disabled="${this.disabled}"
        aria-label="${this.label}"
        href=${ue(c(this,zt,ss)?this.href:void 0)}
        target=${ue(c(this,zt,ss)?this.target:void 0)}
        rel=${ue(c(this,zt,ss)?this.rel||c(this,Ei,n1):void 0)}
        download=${ue(c(this,zt,ss)?this.download:void 0)}
      >
        <slot name="lead"></slot>
        <slot part="main-slot"></slot>
        <slot name="trail"></slot>
      </${t}>
    `}};zt=new WeakSet;ss=function(){return this.href.length>0};Ei=new WeakSet;n1=function(){return this.target==="_blank"?"noreferrer noopener":void 0};Se.styles=[J,G(s2)];Se.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g({type:Boolean,reflect:!0})],Se.prototype,"disabled",2);a([g()],Se.prototype,"label",2);a([g()],Se.prototype,"href",2);a([g()],Se.prototype,"target",2);a([g()],Se.prototype,"rel",2);a([g()],Se.prototype,"download",2);a([g({type:Boolean,reflect:!0})],Se.prototype,"compact",2);a([g({type:Boolean,reflect:!0})],Se.prototype,"selected",2);Se=a([k("gds-menu-button")],Se);function i1(){return(e,t,s)=>{const o=e.connectedCallback,r=e.disconnectedCallback;e.connectedCallback=function(){o==null||o.call(this),this.__resizeObservers=this.__resizeObservers||{},this.__resizeObserver_tids=this.__resizeObserver_tids||{},this.__resizeObservers[t]=new ResizeObserver(()=>{this.__resizeObserver_tids[t]&&clearTimeout(this.__resizeObserver_tids[t]),this.__resizeObserver_tids[t]=setTimeout(()=>{var n;(n=s.value)==null||n.call(this)},20)}),this.__resizeObservers[t].observe(this)},e.disconnectedCallback=function(){r==null||r.call(this),this.__resizeObservers[t].disconnect()}}}var o2=`@layer base {
  :host {
    background-color: var(--gds-sys-color-container-container-dim1);
...
`,r2=(e,t)=>{let s;return()=>{clearTimeout(s),s=setTimeout(e,t)}},gt,Ti,a1,zi,Ai,Oi,Cr,kr,Li,Di,Le=class extends Y{constructor(){super(...arguments),f(this,Ti),this.size="medium",f(this,gt,void 0),this._showPrevButton=!1,this._showNextButton=!1,this.intersectionObserver=null,f(this,zi,()=>{const e=this.segments.filter((t,s,o)=>{var r;return((r=o[s+1])==null?void 0:r.isVisible)&&!t.isVisible})[0];this._elTrack.scrollLeft=e.offsetLeft}),f(this,Ai,()=>{const e=this.segments.filter((t,s,o)=>{var r;return((r=o[s-1])==null?void 0:r.isVisible)&&!t.isVisible}).reverse()[0];this._elTrack.scrollLeft=e.offsetLeft}),f(this,Oi,()=>{this.segments.every(e=>!e.isVisible)||(this._showPrevButton=!this.segments[0].isVisible,this._showNextButton=!this.segments[this.segments.length-1].isVisible)}),f(this,Cr,r2(c(this,Oi),50)),f(this,kr,()=>{const e=this.segments.find(t=>t.selected);if(e){const t=e.offsetWidth,s=e.offsetLeft;this._elIndicator.style.transform=`translateX(${s}px)`,this._elIndicator.style.width=`${t}px`}else this._elIndicator.style.transform="translateX(-100%)",this._elIndicator.style.width="0px"}),f(this,Li,e=>{const t=this.segments.find(s=>s===e.target||s.contains(e.target));t&&(this.segments.forEach(s=>s.selected=!1),t.selected=!0,U(this,gt,t.value),c(this,kr).call(this),this.dispatchEvent(new CustomEvent("change",{detail:{segment:t},bubbles:!0,composed:!0})))}),f(this,Di,()=>{c(this,gt)&&this.updateComplete.then(()=>{const e=this.segments.find(t=>t.value===c(this,gt));e&&(this.segments.forEach(t=>t.selected=!1),e.selected=!0,this._elTrack.scrollLeft=e.offsetLeft)})})}get value(){return c(this,gt)}set value(e){U(this,gt,e),c(this,Di).call(this)}get segments(){return this._elSlot?this._elSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-segmented-control"),this.updateComplete.then(()=>{this._elTrack.addEventListener("scroll",()=>{c(this,Cr).call(this)})})}render(){return m`<button
      ...
      </button>`}_recalculateMinWidth(){this.updateComplete.then(()=>{c(this,Cr).call(this),c(this,kr).call(this)})}};gt=new WeakMap;Ti=new WeakSet;a1=function(){var e,t;const s=(e=this.segments.find(o=>o.selected))==null?void 0:e.value;s&&U(this,gt,s),(t=this.intersectionObserver)==null||t.disconnect(),this.intersectionObserver=new IntersectionObserver(o=>{o.forEach(r=>{const n=r.target;n._isVisible=r.intersectionRatio>.99})},{root:this._elTrack,threshold:[0,.01,.5,.99,1]}),this.segments.forEach(o=>{var r;(r=this.intersectionObserver)==null||r.observe(o)})};zi=new WeakMap;Ai=new WeakMap;Oi=new WeakMap;Cr=new WeakMap;kr=new WeakMap;Li=new WeakMap;Di=new WeakMap;Le.styles=[J,G(o2)];a([g({reflect:!0})],Le.prototype,"size",2);a([g()],Le.prototype,"value",1);a([te("slot")],Le.prototype,"_elSlot",2);a([te("#indicator")],Le.prototype,"_elIndicator",2);a([te("#track")],Le.prototype,"_elTrack",2);a([P()],Le.prototype,"_showPrevButton",2);a([P()],Le.prototype,"_showNextButton",2);a([i1(),ne("segMinWidth")],Le.prototype,"_recalculateMinWidth",1);Le=a([k("gds-segmented-control"),qt()],Le);var n2=`@layer base {
  :host {
    display: flex;
    z-index: 1;
  }
...
`,tt=class extends Y{constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return m`<button
    ...
    >
      <slot></slot>
    </button>`}};tt.styles=[...J,G(n2)];a([g({type:Boolean,reflect:!0})],tt.prototype,"selected",2);a([g()],tt.prototype,"value",2);a([g({type:Boolean,reflect:!0})],tt.prototype,"disabled",2);a([y({valueTemplate:e=>e})],tt.prototype,"min-width",2);a([y({valueTemplate:e=>e})],tt.prototype,"max-width",2);a([y()],tt.prototype,"width",2);tt=a([k("gds-segment")],tt);var bo=class extends L{};bo._regularSVG='<path d="M15 20L7 12L15 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';bo._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.5303 3.46967C15.8232 3.76256 15.8232 4.23744 15.5303 4.53033L8.06066 12L15.5303 19.4697C15.8232 19.7626 15.8232 20.2374 15.5303 20.5303C15.2374 20.8232 14.7626 20.8232 14.4697 20.5303L6.46967 12.5303C6.32902 12.3897 6.25 12.1989 6.25 12C6.25 11.8011 6.32902 11.6103 6.46967 11.4697L14.4697 3.46967C14.7626 3.17678 15.2374 3.17678 15.5303 3.46967Z" fill="currentColor"/>';bo._name="chevron-left";bo=a([k("gds-icon-chevron-left")],bo);var xo=class extends L{};xo._regularSVG='<path d="M9 4L17 12L9 20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';xo._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M8.46967 3.46967C8.76256 3.17678 9.23744 3.17678 9.53033 3.46967L17.5303 11.4697C17.671 11.6103 17.75 11.8011 17.75 12C17.75 12.1989 17.671 12.3897 17.5303 12.5303L9.53033 20.5303C9.23744 20.8232 8.76256 20.8232 8.46967 20.5303C8.17678 20.2374 8.17678 19.7626 8.46967 19.4697L15.9393 12L8.46967 4.53033C8.17678 4.23744 8.17678 3.76256 8.46967 3.46967Z" fill="currentColor"/>';xo._name="chevron-right";xo=a([k("gds-icon-chevron-right")],xo);var i2="en",a2=["sv"],l1={};Ig(l1,{templates:()=>l2});var l2={s15a16ae9f99f19bf:"Juli",s15a852e9f9a50fa5:"Juni",s17e3edbe032f79ec:"Öppna kalender",s1a2dda8f763a68bd:"Januari",s1e118319b5202c41:"Mån",s1e187019b5262aa6:"Maj",s281846ef0421c71f:"November",s2ceb11be2290bb1b:"Avbryt",s39938ecdae568740:"September",s407a88a592a0987c:"Augusti",s46d6587089bd0356:"Nästa månad",s5052d10b539eabf0:"Mars",s58bfb494feb8eb02:Zr`${0} valda`,s5d929ff1619ac0c9:"Sök",s5e8250fb85d64c23:"Stäng",s5febcd9b311c16fe:"Scrolla höger",s62931b2a50168976:"Föregående månad",s63d040e37887f17e:"Idag",s6cfed919e21ac6ac:"Tor",s6d24cd19e23b8185:"Tis",s74aa0319e62b2eb7:"Ons",s7793b811d20184fe:"December",s7fd3469f78111589:"Öppna meny",s83c436ed1bc16dfb:"Visa mer information",s8ade4e9d5e804d6a:"Första tillgängliga datum",s9836b719fa8ef857:"Lör",s987ac119fac8d621:"Sön",s9af3c72c33088826:Zr`Det finns ${0} fel att åtgärda innan du kan fortsätta:`,sa6f2645578b2d2bc:"År",sa7cd5c2ff6d266e7:"Oktober",sb47daaf9e1c4a905:"Månad",sb4f1dffbb6be6302:"Rensa",sb77f4dce69a005ac:"Felmeddelande.",sbc083a1dbee9af73:"Februari",scb6b9cb49cf93277:"April",sd898d99fd9c13de6:"Sök i listan av val",sdc42f1da42d6411a:"Rensa text",se0955919920ee87d:"Dag",se4129fd6b9d7b4c2:"Sista tillgängliga datum",sf295af199c723ec8:"Fre"},pd=new Map([["sv",l1]]),d2=({extraLocales:e,extraTemplates:t}={extraLocales:[],extraTemplates:new Map})=>{const s=[...a2];for(const[o,r]of t)pd.set(o,r);for(const o of e)s.push(o);return Ah({sourceLocale:i2,targetLocales:s,loadLocale:async o=>{const r=pd.get(o);return r||Promise.reject(new Error(`Locale ${o} not found`))}})},c2=Object.defineProperty,g2=Object.getOwnPropertyDescriptor,h2=(e,t,s,o)=>{for(var r=o>1?void 0:o?g2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&c2(t,s,r),r};const{setLocale:ud}=d2();let fd=class extends E{connectedCallback(){super.connectedCallback()}handleButtonClick(e){this.dispatchEvent(new CustomEvent("view-change",{detail:{view:e},bubbles:!0,composed:!0}))}render(){return m`
      <style>
        :host {
          position: sticky;
          top: 0;
        ...
        <gds-flex justify-content="space-between" width="100%">
          ...
          <gds-flex align-items="center" gap="l" margin="0 m 0 " display="none">
            ...
            <!-- <gds-context-menu>
              ...
              <gds-menu-item @click=${()=>ud("en")}>EN</gds-menu-item>
              <gds-menu-item @click=${()=>ud("sv")}>SV</gds-menu-item>
            </gds-context-menu> -->
          </gds-flex>
        </gds-flex>
      </gds-flex>
    `}};fd=h2([O("gds-header")],fd);var pl={fromAttribute(e){return new Date(e)},toAttribute(e){return e.toISOString()}},p2={fromAttribute(e){return e.split(",").map(t=>new Date(t.trim()))},toAttribute(e){return JSON.stringify(e.map(t=>t.toISOString()))}};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*u2(e,t){const s=typeof t=="function";if(e!==void 0){let o=-1;for(const r of e)o>-1&&(yield s?t(o):t),o++,yield r}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*f2(e,t){if(e!==void 0){let s=0;for(const o of e)yield t(o,s++)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const md=(e,t,s)=>{const o=new Map;for(let r=t;r<=s;r++)o.set(e[r],r);return o},m2=ks(class extends sr{constructor(e){if(super(e),e.type!==tr.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,s){let o;s===void 0?s=t:t!==void 0&&(o=t);const r=[],n=[];let i=0;for(const l of e)r[i]=o?o(l,i):i,n[i]=s(l,i),i++;return{values:n,keys:r}}render(e,t,s){return this.dt(e,t,s).values}update(e,[t,s,o]){const r=Rh(e),{values:n,keys:i}=this.dt(t,s,o);if(!Array.isArray(r))return this.ut=i,n;const l=this.ut??(this.ut=[]),d=[];let h,v,p=0,x=r.length-1,w=0,$=n.length-1;for(;p<=x&&w<=$;)if(r[p]===null)p++;else if(r[x]===null)x--;else if(l[p]===i[w])d[w]=Mt(r[p],n[w]),p++,w++;else if(l[x]===i[$])d[$]=Mt(r[x],n[$]),x--,$--;else if(l[p]===i[$])d[$]=Mt(r[p],n[$]),As(e,d[$+1],r[p]),p++,$--;else if(l[x]===i[w])d[w]=Mt(r[x],n[w]),As(e,r[p],r[x]),x--,w++;else if(h===void 0&&(h=md(i,w,$),v=md(l,p,x)),h.has(l[p]))if(h.has(l[x])){const M=v.get(i[w]),j=M!==void 0?r[M]:null;if(j===null){const H=As(e,r[p]);Mt(H,n[w]),d[w]=H}else d[w]=Mt(j,n[w]),As(e,r[p],j),r[M]=null;w++}else Wn(r[x]),x--;else Wn(r[p]),p++;for(;w<=$;){const M=As(e,d[$+1]);Mt(M,n[w]),d[w++]=M}for(;p<=x;){const M=r[p++];M!==null&&Wn(M)}return this.ut=i,Wh(e,d),ze}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class v2{constructor(t){this.Y=t}disconnect(){this.Y=void 0}reconnect(t){this.Y=t}deref(){return this.Y}}class b2{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){this.Z??(this.Z=new Promise(t=>this.q=t))}resume(){var t;(t=this.q)==null||t.call(this),this.Z=this.q=void 0}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vd=e=>!Hh(e)&&typeof e.then=="function",bd=1073741823;class x2 extends wc{constructor(){super(...arguments),this._$Cwt=bd,this._$Cbt=[],this._$CK=new v2(this),this._$CX=new b2}render(...t){return t.find(s=>!vd(s))??ze}update(t,s){const o=this._$Cbt;let r=o.length;this._$Cbt=s;const n=this._$CK,i=this._$CX;this.isConnected||this.disconnected();for(let l=0;l<s.length&&!(l>this._$Cwt);l++){const d=s[l];if(!vd(d))return this._$Cwt=l,d;l<r&&d===o[l]||(this._$Cwt=bd,r=0,Promise.resolve(d).then(async h=>{for(;i.get();)await i.get();const v=n.deref();if(v!==void 0){const p=v._$Cbt.indexOf(d);p>-1&&p<v._$Cwt&&(v._$Cwt=p,v.setValue(h))}}))}return ze}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const y2=ks(x2);function Vi(e){"@babel/helpers - typeof";return Vi=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},Vi(e)}function yt(e){if(e===null||e===!0||e===!1)return NaN;var t=Number(e);return isNaN(t)?t:t<0?Math.ceil(t):Math.floor(t)}function ce(e,t){if(t.length<e)throw new TypeError(e+" argument"+(e>1?"s":"")+" required, but only "+t.length+" present")}function le(e){ce(1,arguments);var t=Object.prototype.toString.call(e);return e instanceof Date||Vi(e)==="object"&&t==="[object Date]"?new Date(e.getTime()):typeof e=="number"||t==="[object Number]"?new Date(e):((typeof e=="string"||t==="[object String]")&&typeof console<"u"&&(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn(new Error().stack)),new Date(NaN))}function Vt(e,t){ce(2,arguments);var s=le(e),o=yt(t);return isNaN(o)?new Date(NaN):(o&&s.setDate(s.getDate()+o),s)}function d1(e,t){ce(2,arguments);var s=le(e),o=yt(t);if(isNaN(o))return new Date(NaN);if(!o)return s;var r=s.getDate(),n=new Date(s.getTime());n.setMonth(s.getMonth()+o+1,0);var i=n.getDate();return r>=i?n:(s.setFullYear(n.getFullYear(),n.getMonth(),r),s)}var w2={};function ul(){return w2}function fs(e,t){var s,o,r,n,i,l,d,h;ce(1,arguments);var v=ul(),p=yt((s=(o=(r=(n=t==null?void 0:t.weekStartsOn)!==null&&n!==void 0?n:t==null||(i=t.locale)===null||i===void 0||(l=i.options)===null||l===void 0?void 0:l.weekStartsOn)!==null&&r!==void 0?r:v.weekStartsOn)!==null&&o!==void 0?o:(d=v.locale)===null||d===void 0||(h=d.options)===null||h===void 0?void 0:h.weekStartsOn)!==null&&s!==void 0?s:0);if(!(p>=0&&p<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var x=le(e),w=x.getDay(),$=(w<p?7:0)+w-p;return x.setDate(x.getDate()-$),x.setHours(0,0,0,0),x}function xd(e){ce(1,arguments);var t=le(e);return t.setHours(0,0,0,0),t}function _2(e,t){ce(2,arguments);var s=yt(t),o=s*7;return Vt(e,o)}function lt(e,t){ce(2,arguments);var s=xd(e),o=xd(t);return s.getTime()===o.getTime()}function C2(e){ce(1,arguments);var t=le(e),s=t.getMonth();return t.setFullYear(t.getFullYear(),s+1,0),t.setHours(23,59,59,999),t}function k2(e,t){var s;ce(1,arguments);var o=e||{},r=le(o.start),n=le(o.end),i=n.getTime();if(!(r.getTime()<=i))throw new RangeError("Invalid interval");var l=[],d=r;d.setHours(0,0,0,0);var h=Number((s=void 0)!==null&&s!==void 0?s:1);if(h<1||isNaN(h))throw new RangeError("`options.step` must be a number greater than 1");for(;d.getTime()<=i;)l.push(le(d)),d.setDate(d.getDate()+h),d.setHours(0,0,0,0);return l}function $2(e,t){ce(1,arguments);var s=e||{},o=le(s.start),r=le(s.end),n=r.getTime();if(!(o.getTime()<=n))throw new RangeError("Invalid interval");var i=fs(o,t),l=fs(r,t);i.setHours(15),l.setHours(15),n=l.getTime();for(var d=[],h=i;h.getTime()<=n;)h.setHours(0),d.push(le(h)),h=_2(h,1),h.setHours(15);return d}function S2(e){ce(1,arguments);var t=le(e);return t.setDate(1),t.setHours(0,0,0,0),t}function M2(e,t){var s,o,r,n,i,l;ce(1,arguments);var d=le(e),h=d.getFullYear(),v=ul(),p=yt((s=(o=(r=(n=void 0)!==null&&n!==void 0?n:void 0)!==null&&r!==void 0?r:v.firstWeekContainsDate)!==null&&o!==void 0?o:(i=v.locale)===null||i===void 0||(l=i.options)===null||l===void 0?void 0:l.firstWeekContainsDate)!==null&&s!==void 0?s:1);if(!(p>=1&&p<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var x=new Date(0);x.setFullYear(h+1,0,p),x.setHours(0,0,0,0);var w=fs(x,t),$=new Date(0);$.setFullYear(h,0,p),$.setHours(0,0,0,0);var M=fs($,t);return d.getTime()>=w.getTime()?h+1:d.getTime()>=M.getTime()?h:h-1}function E2(e,t){var s,o,r,n,i,l;ce(1,arguments);var d=ul(),h=yt((s=(o=(r=(n=void 0)!==null&&n!==void 0?n:void 0)!==null&&r!==void 0?r:d.firstWeekContainsDate)!==null&&o!==void 0?o:(i=d.locale)===null||i===void 0||(l=i.options)===null||l===void 0?void 0:l.firstWeekContainsDate)!==null&&s!==void 0?s:1),v=M2(e,t),p=new Date(0);p.setFullYear(v,0,h),p.setHours(0,0,0,0);var x=fs(p,t);return x}var T2=6048e5;function z2(e,t){ce(1,arguments);var s=le(e),o=fs(s,t).getTime()-E2(s,t).getTime();return Math.round(o/T2)+1}function A2(e){ce(1,arguments);var t=le(e),s=t.getMonth();return t.setFullYear(t.getFullYear(),s+1,0),t.setHours(0,0,0,0),t}function O2(e,t){ce(2,arguments);var s=le(e),o=le(t);return s.getFullYear()===o.getFullYear()&&s.getMonth()===o.getMonth()}function L2(e,t){ce(2,arguments);var s=le(e),o=yt(t);return s.setHours(o),s}function D2(e,t){ce(2,arguments);var s=yt(t);return d1(e,-s)}var V2=D`
  @layer base, reset;
...
`,Ps,Pi,c1,yo,on,Hi,g1,Fi,h1,ji,p1,At,os,Wi,u1,Ri,Bi,Ii,Ni,Gi,Zi,Ui,Yi,qi,Ki,rn,Xi,Ji,$r,Qi,ea,Ke,ta,f1,fl,m1,q=class extends Me{constructor(){super(...arguments),f(this,Pi),f(this,yo),f(this,Hi),f(this,Fi),f(this,ji),f(this,At),f(this,Wi),f(this,$r),f(this,ta),f(this,fl),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.label="",this.showWeekNumbers=!1,this.size="medium",this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=C(this,$r,Qi).call(this,"y-m-d"),f(this,Ps,void 0),f(this,Ri,e=>{this._elTrigger.then(t=>{var s,o;((s=e.relatedTarget)==null?void 0:s.parentElement)!==e.target&&((o=document.getSelection())==null||o.removeAllRanges())})}),f(this,Bi,e=>{this._elTrigger.then(t=>{var s,o;(s=document.getSelection())==null||s.removeAllRanges();const r=new Range;r.setStart(t.firstChild,0),r.setEnd(t.lastChild,4),(o=document.getSelection())==null||o.addRange(r)})}),f(this,Ii,e=>{this._elField.then(t=>{var s;e.currentTarget===t&&(e.preventDefault(),(s=e.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),f(this,Ni,e=>{this._elField.then(t=>{var s;if(e.currentTarget!==t)return;e.preventDefault();const o=(s=e.clipboardData)==null?void 0:s.getData("text/plain");if(!o)return;let r=new Date("-");const n="Invalid Date",i=o.split(this._dateFormatLayout.delimiter);if(i.length===3){const l=this._dateFormatLayout.layout,d=parseInt(i[l.findIndex(p=>p.token==="y")]),h=parseInt(i[l.findIndex(p=>p.token==="m")])-1,v=parseInt(i[l.findIndex(p=>p.token==="d")]);!isNaN(d)&&!isNaN(h)&&!isNaN(v)&&(r=new Date(`${d}-${h+1}-${v}`))}r.toString()===n&&(r=new Date(o),r.toString()===n)||(this.value=r,C(this,At,os).call(this))})}),f(this,Gi,e=>{var t;(t=this._elSpinners[0])==null||t.focus()}),f(this,Zi,e=>{e.stopPropagation(),this.value=e.detail,this.open=!1,C(this,At,os).call(this)}),f(this,Ui,e=>{var t;e.stopPropagation(),this._focusedMonth=(t=e.target)==null?void 0:t.value}),f(this,Yi,e=>{var t;e.stopPropagation(),this._focusedYear=(t=e.target)==null?void 0:t.value}),f(this,qi,e=>{this._focusedMonth++,this._focusedMonth>11&&(this._focusedMonth=0,this._focusedYear++)}),f(this,Ki,e=>{this._focusedMonth--,this._focusedMonth<0&&(this._focusedMonth=11,this._focusedYear--)}),f(this,rn,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),C(this,Wi,u1).call(this)}),f(this,Xi,async e=>{if(e.target===e.currentTarget){if(this.open=e.detail.open,e.detail.reason==="close"){const t=(await this._elCalendar).value;!lt(t||new Date(0),c(this,Ps)||new Date(0))&&(this.value=t,C(this,At,os).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}e.detail.reason==="cancel"&&(this.value=c(this,Ps))}}),f(this,Ji,e=>{const t=Array.from(this._elSpinners).findIndex(s=>s===e.target);if(e.key==="ArrowRight"){const s=this._elSpinners[t+1];s&&s.focus()}if(e.key==="ArrowLeft"){const s=this._elSpinners[t-1];s&&s.focus()}}),f(this,ea,(e,t)=>{c(this,Ke)[t]=e;const s=new Date;s.setFullYear(parseInt(c(this,Ke).year)),s.setMonth(parseInt(c(this,Ke).month)-1),s.setDate(parseInt(c(this,Ke).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,C(this,At,os).call(this))}),f(this,Ke,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map(e=>e.token).join(this._dateFormatLayout.delimiter)}set dateformat(e){this._dateFormatLayout=C(this,$r,Qi).call(this,e)}async getFocusedDate(){if(this.open)return this._elCalendar.then(e=>e.focusedDate)}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(e){return this._elCalendar.then(t=>t.getDateCell(e))}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-datepicker")}render(){return m`${ae(this.label&&!this.hideLabel,()=>m`<label for="spinner-0" id="label">${this.label}</label>`)}
      ...
      >
        <div
          ...
          @focusout=${c(this,Ri)}
        >
          ${u2(f2(this._dateFormatLayout.layout,(e,t)=>m`<gds-date-part-spinner
                  id="spinner-${t}"
                  class="spinner"
                  .length=${e.token==="y"?4:2}
                  .value=${c(this,Ke)[e.name]}
                  aria-valuemin=${C(this,Fi,h1).call(this,e.name)}
                  aria-valuemax=${C(this,ji,p1).call(this,e.name)}
                  aria-label=${C(this,Hi,g1).call(this,e.name)}
                  aria-describedby="label sub-label message"
                  @keydown=${c(this,Ji)}
                  @change=${s=>c(this,ea).call(this,s.detail.value,e.name)}
                  @focus=${c(this,Bi)}
      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${m2(c(this,ta,f1),e=>e,e=>m`<gds-option value=${e}>${e}</gds-option>`)}
          </gds-dropdown>
          <gds-button
            @click=${c(this,qi)}
        ...
        <div class="footer">
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),this.value=void 0,this.open=!1,C(this,At,os).call(this)}}
          >
            ${V("Clear")}
          </gds-button>
          ${y2(C(this,Pi,c1).call(this),N)}
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),C(this,yo,on).call(this,new Date)}}
          >
            ${V("Today")}
          </gds-button>
        </div>
      </gds-popover> `}_getValidityAnchor(){return this._elSpinners[0]}_handleValueChange(){if(!this.value){U(this,Ke,{year:"yyyy",month:"mm",day:"dd"});return}const e=this.value;this._focusedMonth=e.getMonth(),this._focusedYear=e.getFullYear();const t=e.getFullYear().toString(),s=(e.getMonth()+1).toString().padStart(2,"0"),o=e.getDate().toString().padStart(2,"0");U(this,Ke,{year:t,month:s,day:o})}_handleOpenChange(){this.open&&(U(this,Ps,this.value),this._elCalendar.then(e=>e.focus()))}};Ps=new WeakMap;Pi=new WeakSet;c1=async function(){const e=await this.getFocusedDate();let t="",s;return e&&e>this.max?(t=V("Last available date"),s=o=>{o.stopPropagation(),C(this,yo,on).call(this,this.max)}):e&&e<this.min&&(t=V("First available date"),s=o=>{o.stopPropagation(),C(this,yo,on).call(this,this.min)}),m`${ae(t.length>0,()=>m`<gds-button rank="tertiary" size="small" @click=${s}>
          ${t}
        </gds-button>`,()=>N)}`};yo=new WeakSet;on=function(e){const t=new Date(e);this._elCalendar.then(s=>s.focusedDate=t).then(c(this,rn))};Hi=new WeakSet;g1=function(e){return{year:V("Year"),month:V("Month"),day:V("Day")}[e]};Fi=new WeakSet;h1=function(e){return{year:1900,month:1,day:1}[e]};ji=new WeakSet;p1=function(e){return{year:9999,month:12,day:31}[e]};At=new WeakSet;os=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value}}))};Wi=new WeakSet;u1=function(){this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value}}))};Ri=new WeakMap;Bi=new WeakMap;Ii=new WeakMap;Ni=new WeakMap;Gi=new WeakMap;Zi=new WeakMap;Ui=new WeakMap;Yi=new WeakMap;qi=new WeakMap;Ki=new WeakMap;rn=new WeakMap;Xi=new WeakMap;Ji=new WeakMap;$r=new WeakSet;Qi=function(e){const t=e.replace(/[a-z0-9]/gi,"")[0],s=e.split(t),o=s.findIndex(d=>d==="y"),r=s.findIndex(d=>d==="m"),n=s.findIndex(d=>d==="d");if(o===-1||r===-1||n===-1)throw new Error("Invalid date format for <gds-datepicker>");const l=[o,r,n].sort((d,h)=>d-h).map(d=>s[d]).map(d=>({token:d,name:d==="y"?"year":d==="m"?"month":"day"}));return{delimiter:t,layout:l}};ea=new WeakMap;Ke=new WeakMap;ta=new WeakSet;f1=function(){var e;const t=this.min.getFullYear(),s=this.max.getFullYear(),o=c(this,fl,m1),r=(e=this.value)==null?void 0:e.getFullYear();return{*[Symbol.iterator](){o&&(yield r);for(let n=t;n<=s;n++)yield n}}};fl=new WeakSet;m1=function(){return this.value?this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear():!1};q.styles=[J,V2];q.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g({converter:pl})],q.prototype,"value",2);a([g({converter:pl})],q.prototype,"min",2);a([g({converter:pl})],q.prototype,"max",2);a([g({type:Boolean})],q.prototype,"open",2);a([g()],q.prototype,"label",2);a([g({type:Boolean,attribute:"show-week-numbers"})],q.prototype,"showWeekNumbers",2);a([g()],q.prototype,"size",2);a([g({type:Boolean,attribute:"hide-label"})],q.prototype,"hideLabel",2);a([g()],q.prototype,"dateformat",1);a([g({type:Boolean,attribute:"disabled-weekends"})],q.prototype,"disabledWeekends",2);a([g({converter:p2,attribute:"disabled-dates"})],q.prototype,"disabledDates",2);a([xt("#calendar-button")],q.prototype,"test_calendarButton",2);a([P()],q.prototype,"_focusedMonth",2);a([P()],q.prototype,"_focusedYear",2);a([P()],q.prototype,"_dateFormatLayout",2);a([xt("#calendar")],q.prototype,"_elCalendar",2);a([xt("#calendar-button")],q.prototype,"_elTrigger",2);a([xt("#field")],q.prototype,"_elField",2);a([Hg("[role=spinbutton]")],q.prototype,"_elSpinners",2);a([te(".input")],q.prototype,"_elInput",2);a([ne("value")],q.prototype,"_handleValueChange",1);a([ne("open")],q.prototype,"_handleOpenChange",1);q=a([k("gds-datepicker"),qt()],q);var P2=D`
  @layer base, reset;
...
`,H2=P2,dt,sa,oa,ra,na,ia,aa,v1,la,b1,da,x1,ms,$n,Q=class extends Me{constructor(){super(),f(this,aa),f(this,la),f(this,da),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,f(this,dt,void 0),f(this,sa,e=>{const t=e.getBoundingClientRect(),o=window.innerHeight-t.bottom,r=t.top;let n=Math.min(r,this.maxHeight);return o>r&&(n=Math.min(o,this.maxHeight)),`${n-16}px`}),f(this,oa,e=>{if(!e.currentTarget)return;const t=e.currentTarget;if(this.options.forEach(o=>o.hidden=!1),!t.value)return;this.options.filter(o=>!this.searchFilter(t.value,o)).forEach(o=>o.hidden=!0)}),f(this,ra,e=>{var t;(t=this._elListbox)==null||t.then(s=>{if(e.key==="ArrowDown"||e.key==="Tab"){e.preventDefault(),s.focus();return}})}),f(this,na,e=>{var t;if(e.key==="Tab"&&this.searchable){e.preventDefault(),(t=this._elSearchInput)==null||t.focus();return}}),f(this,ia,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),f(this,ms,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)}),f(this,$n,e=>{var t;e.key==="Tab"&&!this.searchable&&(e.preventDefault(),this.open=!1,(t=this._elTriggerBtn)==null||t.focus())}),pc(this)}get type(){return"gds-dropdown"}get options(){return c(this,dt)?Array.from(c(this,dt)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if(c(this,dt))return Array.from(c(this,dt)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){var e,t;let s;return Array.isArray(this.value)?this.value.length>2?s=V(Zr`${this.value.length} selected`):s=this.value.reduce((o,r)=>{var n;return o+((n=this.options.find(i=>i.value===r))==null?void 0:n.innerHTML)+", "},"").slice(0,-2):s=(e=this.options.find(o=>o.selected))==null?void 0:e.innerHTML,s||((t=this.placeholder)==null?void 0:t.innerHTML)||""}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-dropdown"),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange()})}render(){return m`
      ...
      >
        ...
        >
          <slot name="trigger">
            <span>${Wc(this.displayValue)}</span>
          </slot>
          <div class="icon">
      ...
      >
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){var e,t;if(this.requestUpdate(),U(this,dt,this.querySelectorAll("[gds-element=gds-option]")),this.multiple){this._handleValueChange();return}this.value===void 0?this.placeholder?this.value=this.placeholder.value:this.value=(e=this.options[0])==null?void 0:e.value:!this.placeholder&&this.options.find(s=>this.compareWith(s.value,this.value))===void 0&&(this.options[0]&&(this.options[0].selected=!0),this.value=(t=this.options[0])==null?void 0:t.value)}_handleValueChange(){this._elListbox.then(e=>{e&&(Array.isArray(this.value)?e.selection=this.value:e.selection=[this.value])})}_onOpenChange(){var e;const t=this.open;(e=c(this,dt))==null||e.forEach(o=>o.hidden=!t),t?C(this,la,b1).call(this):(C(this,da,x1).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const s=this.options.find(o=>o.selected);this.updateComplete.then(()=>s==null?void 0:s.scrollIntoView()),this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:t},bubbles:!0,composed:!0}))}};dt=new WeakMap;sa=new WeakMap;oa=new WeakMap;ra=new WeakMap;na=new WeakMap;ia=new WeakMap;aa=new WeakSet;v1=function(){this._elListbox.then(e=>{var t;this.multiple?this.value=e.selection.map(s=>s.value):(this.value=(t=e.selection[0])==null?void 0:t.value,this.open=!1,setTimeout(()=>{var s;return(s=this._elTriggerBtn)==null?void 0:s.focus()},0)),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})};la=new WeakSet;b1=function(){this.addEventListener("blur",c(this,ms)),this.addEventListener("gds-blur",c(this,ms)),this.addEventListener("keydown",c(this,$n))};da=new WeakSet;x1=function(){this.removeEventListener("blur",c(this,ms)),this.removeEventListener("gds-blur",c(this,ms)),this.removeEventListener("keydown",c(this,$n))};ms=new WeakMap;$n=new WeakMap;Q.styles=[J,H2];Q.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g()],Q.prototype,"label",2);a([g({type:Boolean,reflect:!0})],Q.prototype,"open",2);a([g({type:Boolean,reflect:!0})],Q.prototype,"searchable",2);a([g({type:Boolean,reflect:!0})],Q.prototype,"multiple",2);a([g()],Q.prototype,"compareWith",2);a([g()],Q.prototype,"searchFilter",2);a([g({type:Boolean,attribute:"sync-popover-width"})],Q.prototype,"syncPopoverWidth",2);a([g({type:Number,attribute:"max-height"})],Q.prototype,"maxHeight",2);a([g()],Q.prototype,"size",2);a([g({type:Boolean,attribute:"hide-label"})],Q.prototype,"hideLabel",2);a([g()],Q.prototype,"disableMobileStyles",2);a([te("#trigger")],Q.prototype,"_elTriggerBtn",2);a([xt("#listbox")],Q.prototype,"_elListbox",2);a([te("#searchinput")],Q.prototype,"_elSearchInput",2);a([Ua({attributes:!0,childList:!0,subtree:!0,characterData:!0})],Q.prototype,"_handleLightDOMChange",1);a([ne("value")],Q.prototype,"_handleValueChange",1);a([ne("open")],Q.prototype,"_onOpenChange",1);Q=a([k("gds-dropdown")],Q);var F2=D`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`,j2=F2,Hs,ca,vs=class extends Y{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,f(this,Hs,Kr()),f(this,ca,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))}),new bc(this)}get navigableItems(){return this.visibleOptionElements}get options(){return c(this,Hs).value?xc(c(this,Hs).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),xe.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",c(this,ca))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return m`<slot ${Xs(c(this,Hs))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};Hs=new WeakMap;ca=new WeakMap;vs.styles=j2;a([g({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],vs.prototype,"multiple",2);a([g()],vs.prototype,"compareWith",2);a([ne("multiple")],vs.prototype,"_rerenderOptions",1);vs=a([k("gds-listbox")],vs);var Ot,Sr,ga,mt=class extends _c(Y){constructor(){super(),f(this,Sr),f(this,Ot,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",C(this,Sr,ga)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),C(this,Sr,ga).call(this,e))})}get hidden(){return c(this,Ot)}set hidden(e){this.isPlaceholder||(U(this,Ot,e==="true"||e===!0),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(U(this,Ot,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then(()=>xe.instance.apply(this,"gds-option"))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(U(this,Ot,!0),this.setAttribute("aria-hidden","true")):(U(this,Ot,!1),this.setAttribute("aria-hidden","false"))}render(){var e;const t=(e=this.parentElement)==null?void 0:e.multiple,s=m`
      <span class="checkbox ${Fe({checked:this.selected})}">
        ${this.selected?m`<gds-icon-checkmark stroke="4"></gds-icon-checkmark>`:""}
      </span>
    `;return t||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),m`<div>${ae(t,()=>s)} <slot></slot></div>`}};Ot=new WeakMap;Sr=new WeakSet;ga=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))};mt.styles=[J,Cc];a([g()],mt.prototype,"value",2);a([g({attribute:"aria-hidden",reflect:!0})],mt.prototype,"hidden",1);a([g({attribute:"aria-selected",reflect:!0})],mt.prototype,"selected",2);a([g({type:Boolean,reflect:!0})],mt.prototype,"isPlaceholder",2);a([ne("isplaceholder")],mt.prototype,"_handlePlaceholderStatusChange",1);mt=a([k("gds-option")],mt);var wo=class extends L{};wo._regularSVG='<path d="M20 9L12 17L4 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';wo._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3.46967 8.46967C3.76256 8.17678 4.23744 8.17678 4.53033 8.46967L12 15.9393L19.4697 8.46967C19.7626 8.17678 20.2374 8.17678 20.5303 8.46967C20.8232 8.76256 20.8232 9.23744 20.5303 9.53033L12.5303 17.5303C12.3897 17.671 12.1989 17.75 12 17.75C11.8011 17.75 11.6103 17.671 11.4697 17.5303L3.46967 9.53033C3.17678 9.23744 3.17678 8.76256 3.46967 8.46967Z" fill="currentColor"/>';wo._name="chevron-bottom";wo=a([k("gds-icon-chevron-bottom")],wo);var _o=class extends L{};_o._regularSVG='<path d="M2.75 15.0938L9 20.25L21.25 3.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';_o._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M21.7426 2.99454C22.2979 3.40464 22.4157 4.18729 22.0056 4.74263L10.0056 20.9926C9.80433 21.2652 9.50107 21.4443 9.16524 21.4891C8.82942 21.5339 8.4898 21.4404 8.22417 21.2301L2.22417 16.4801C1.6829 16.0516 1.59149 15.2655 2.01999 14.7242C2.4485 14.1829 3.23466 14.0915 3.77593 14.52L8.76241 18.4677L19.9945 3.25753C20.4046 2.70218 21.1873 2.58444 21.7426 2.99454Z" fill="currentColor"/>';_o._name="checkmark";_o=a([k("gds-icon-checkmark")],_o);var Xe,Mr,Er,Tr,zr,ha,pa,ua,fa,y1,rs,Fs,Ar,ma,ns,js,Ws,Or,Re=class extends E{constructor(){super(...arguments),f(this,fa),f(this,rs),f(this,Ar),f(this,ns),f(this,Ws),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=C(this,Ar,ma).call(this,this.value,this.length),f(this,Xe,""),f(this,Mr,()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=this.length===2?this.min:new Date().getFullYear()-1),this.value=C(this,ns,js).call(this,e+1),C(this,rs,Fs).call(this)}),f(this,Er,()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=this.length===2?this.max:new Date().getFullYear()+1),this.value=C(this,ns,js).call(this,e-1),C(this,rs,Fs).call(this)}),f(this,Tr,e=>{e.stopPropagation(),e.preventDefault(),this.focus()}),f(this,zr,()=>{C(this,Ws,Or).call(this)}),f(this,ha,()=>{c(this,Xe)!==""&&(C(this,Ws,Or).call(this),this.value=C(this,ns,js).call(this,parseInt(this.value.toString())),C(this,rs,Fs).call(this))}),f(this,pa,e=>{e.stopPropagation(),e.preventDefault(),e.deltaY>0?c(this,Er).call(this):c(this,Mr).call(this)}),f(this,ua,e=>{let t=!1;if(e.key==="ArrowUp")c(this,Mr).call(this),t=!0;else if(e.key==="ArrowDown")c(this,Er).call(this),t=!0;else{const s=parseInt(e.key);isNaN(s)||(c(this,Xe).length<this.length&&(U(this,Xe,c(this,Xe)+s.toString()),this.value=parseInt(c(this,Xe))),c(this,Xe).length===this.length&&(this.value=C(this,ns,js).call(this,this.value),C(this,Ws,Or).call(this),C(this,fa,y1).call(this),C(this,rs,Fs).call(this)),t=!0)}t&&(e.preventDefault(),e.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",c(this,pa)),this.addEventListener("keydown",c(this,ua)),this.addEventListener("blur",c(this,ha)),this.addEventListener("focus",c(this,zr)),this.addEventListener("click",c(this,Tr)),this.addEventListener("mousedown",c(this,Tr))}focus(e){super.focus(e),c(this,zr).call(this)}render(){return m`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=C(this,Ar,ma).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};Xe=new WeakMap;Mr=new WeakMap;Er=new WeakMap;Tr=new WeakMap;zr=new WeakMap;ha=new WeakMap;pa=new WeakMap;ua=new WeakMap;fa=new WeakSet;y1=function(){let e=this.nextElementSibling;for(;e;){if(e instanceof Re){e.focus();break}e=e.nextElementSibling}};rs=new WeakSet;Fs=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))};Ar=new WeakSet;ma=function(e,t){return String(e).padStart(t,"0")};ns=new WeakSet;js=function(e){return Math.max(this.min,Math.min(this.max,e))};Ws=new WeakSet;Or=function(){U(this,Xe,"")};Re.formAssociated=!0;a([g({type:Number})],Re.prototype,"value",2);a([g({type:Number})],Re.prototype,"length",2);a([g({type:Number,attribute:"aria-valuemin"})],Re.prototype,"min",2);a([g({type:Number,attribute:"aria-valuemax"})],Re.prototype,"max",2);a([P()],Re.prototype,"displayValue",2);a([ne("value")],Re.prototype,"_refreshDisplayValue",1);Re=a([k("gds-date-part-spinner")],Re);function W2(e,t){const s=S2(e),o=C2(e),r=$2({start:s,end:o},{weekStartsOn:1});for(;r.length<6;)r.push(Vt(r[r.length-1],7));return ge`${t(r.map(n=>({days:k2({start:n,end:Vt(n,6)})})))}`}var R2=D`
  @layer base, reset;
...
`,B2=R2,nn,ml,va,w1,ee=class extends Y{constructor(){super(...arguments),f(this,nn),f(this,va),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=e=>e.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(e){const t=A2(new Date(this.focusedYear,e,1)),s=new Date(this.focusedDate);s.setDate(Math.min(this.focusedDate.getDate(),t.getDate())),s.setMonth(e),s.setHours(12,0,0,0),this.focusedDate=s}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(this.focusedDate.setFullYear(e))}getDateCell(e){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector(`#dateCell-${e}`)}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",C(this,va,w1)),window.addEventListener("lit-localize-status",e=>{e.detail.status==="ready"&&(this._currentLocale=e.detail.readyLocale)})}focus(){var e;super.focus(),(e=this._elFocusedCell)==null||e.focus()}render(){const e=new Date;return ge`<table role="grid" aria-label="${ue(this.label)}">
      ...
      <tbody role="rowgroup">
        ${W2(this.focusedDate,t=>ge`
            ${t.map(s=>ge`
                <tr role="row">
                  ${ae(this.showWeekNumbers,()=>ge`<td class="week-number" scope="row">
                        ${z2(s.days[0])}
                      </td>`)}
                  ${s.days.map(o=>{const r=this.customizedDates&&this.customizedDates.find(p=>lt(p.date,o)),n=ds({color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(p=>lt(p,o)))},r),i=!O2(this.focusedDate,o),l=(o<this.min||o>this.max)&&!lt(o,this.min)&&!lt(o,this.max),d=o.getDay()===0||o.getDay()===6,h=n.disabled||i||l||this.disabledWeekends&&d;return this.hideExtraneousDays&&i?ge`<td inert></td>`:ge`
                          <td
                            ...
                            @click=${()=>h?null:C(this,nn,ml).call(this,o)}
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=this.value)}};nn=new WeakSet;ml=function(e){const t=L2(e,12);this.value=t,this.dispatchEvent(new CustomEvent("change",{detail:t,bubbles:!1,composed:!1}))};va=new WeakSet;w1=function(e){var t;let s=!1,o=new Date(this.focusedDate);e.key==="ArrowLeft"?(o=Vt(this.focusedDate,-1),s=!0):e.key==="ArrowRight"?(o=Vt(this.focusedDate,1),s=!0):e.key==="ArrowUp"?(o=Vt(this.focusedDate,-7),s=!0):e.key==="ArrowDown"?(o=Vt(this.focusedDate,7),s=!0):e.key==="Enter"||e.key===" "?((t=this._elFocusedCell)!=null&&t.hasAttribute("disabled")||C(this,nn,ml).call(this,this.focusedDate),s=!0):e.key==="Home"?(o=new Date(this.focusedYear,this.focusedMonth,1),s=!0):e.key==="End"?(o=new Date(this.focusedYear,this.focusedMonth+1,0),s=!0):e.key==="PageUp"?(o=D2(this.focusedDate,1),s=!0):e.key==="PageDown"&&(o=d1(this.focusedDate,1),s=!0),o.getFullYear()>=this.min.getFullYear()&&o.getFullYear()<=this.max.getFullYear()&&this.dispatchEvent(new CustomEvent("gds-date-focused",{detail:o,bubbles:!1,composed:!1,cancelable:!0}))&&(this.focusedDate=o),s&&(e.preventDefault(),e.stopPropagation(),this.updateComplete.then(()=>{var r;(r=this._elFocusedCell)==null||r.focus()}))};ee.styles=[J,B2];ee.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g()],ee.prototype,"value",2);a([g({type:Date})],ee.prototype,"min",2);a([g({type:Date})],ee.prototype,"max",2);a([g()],ee.prototype,"focusedDate",2);a([g({type:Boolean,attribute:"disabled-weekends"})],ee.prototype,"disabledWeekends",2);a([g({type:Array,attribute:"disabled-dates"})],ee.prototype,"disabledDates",2);a([g({type:Number})],ee.prototype,"focusedMonth",1);a([g({type:Number})],ee.prototype,"focusedYear",1);a([g({type:Boolean})],ee.prototype,"showWeekNumbers",2);a([g({type:Boolean})],ee.prototype,"hideExtraneousDays",2);a([g({type:Boolean})],ee.prototype,"hideDayNames",2);a([g({attribute:!1})],ee.prototype,"customizedDates",2);a([g()],ee.prototype,"label",2);a([g({attribute:!1})],ee.prototype,"dateLabelTemplate",2);a([P()],ee.prototype,"_currentLocale",2);a([te('td[tabindex="0"]')],ee.prototype,"_elFocusedCell",2);a([ne("value")],ee.prototype,"_valueChanged",1);ee=a([k("gds-calendar"),qt()],ee);var ba=class extends Y{connectedCallback(){super.connectedCallback(),this.form=this.closest("form")||void 0,this.form&&(this.formObserver=new MutationObserver(()=>{this.requestUpdate()}),this.formObserver.observe(this.form,{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.formObserver)==null||e.disconnect()}render(){var e;const s=Array.from(((e=this.form)==null?void 0:e.elements)||[]).filter(o=>o.invalid);return ae(s.length>0,()=>m`<gds-card level="3" border="4xs/negative" border-radius="2xs" padding="m" color="error-text">
          <gds-flex gap="s" level=="3" color="negative">
            <gds-container>
              <gds-icon-triangle-exclamation></gds-icon-triangle-exclamation>
            </gds-container>
            <gds-container >
            ${V(Zr`There are ${s.length} errors to correct before you can continue:`)}
            <ul>
              ${s.map(o=>m`<li><a href @click=${r=>{r.preventDefault(),o.focus()}}>${o.label}</li>`)}
            </ul>
          </gds-container>
        <gds-flex>
      </gds-card>`)}};ba.styles=D`
    :host {
      font-weight: 500;
    }
    ul {
  ...
  `;ba=a([k("gds-form-summary")],ba);var I2=D`
  #body {
    visibility: hidden;
    position: absolute;
    z-index: 1060;
...
`,N2=I2,Co,an,Sn,is,Rs,xa,_1,vl,C1,bl,k1,xl,$1,yl,S1,wl,M1,Lr,ya,Be=class extends Y{constructor(){super(...arguments),f(this,is),f(this,xa),f(this,vl),f(this,bl),f(this,xl),f(this,yl),f(this,wl),f(this,Lr),this.placement="bottom",this.overlappedBy=[],this.target=[],this.label="Coachmark",this.computeVisibility=(e,t,s)=>s,this.targetElement=void 0,this._isVisible=!1,this._preventClose=!1,f(this,Co,Kr()),f(this,an,Kr()),f(this,Sn,void 0)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",()=>{setTimeout(()=>{C(this,Lr,ya).call(this),C(this,is,Rs).call(this)},400)}),document.addEventListener("keydown",e=>{e.key==="Escape"&&this._isVisible&&C(this,is,Rs).call(this)})}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",C(this,is,Rs)),document.removeEventListener("keydown",e=>{e.key==="Escape"&&this._isVisible&&C(this,is,Rs).call(this)})}firstUpdated(){this.target.length>0&&(this.targetElement=C(this,xa,_1).call(this,this.target),C(this,Lr,ya).call(this))}setPreventClose(e){this._preventClose=e}render(){return m`${ae(this.target.length>0,()=>m`
        <div
          role="dialog"
          id="body"
          aria-label=${this.label}
        ...
        >
          <slot></slot>
          <div id="arrow" ${Xs(c(this,an))}></div>
        </div>
      `,()=>m``)}`}};Co=new WeakMap;an=new WeakMap;Sn=new WeakMap;is=new WeakSet;Rs=function(){var e,t;this._isVisible&&(this._isVisible=!1,(e=c(this,Co).value)==null||e.remove(),(t=c(this,Sn))==null||t.call(this),this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:this._isVisible,reason:"closed"},bubbles:!1,composed:!1})))};xa=new WeakSet;_1=function(e){let t=!1,s;for(const o of e){if(o==="shadowRoot"){t=!0;continue}s?t&&s.shadowRoot?(s=s.shadowRoot.querySelector(o),t=!1):s=s.querySelector(o):s=document.querySelector(o)}return s};vl=new WeakSet;C1=function(e,t){if(e==t)return;const s=e.getBoundingClientRect(),o=t.getBoundingClientRect();return s.top<o.bottom&&s.bottom>o.top&&s.left<o.right&&s.right>o.left};bl=new WeakSet;k1=function(e){if(!e)return!1;for(const t of e){const s=document.querySelector(t);if(!(!s||getComputedStyle(s).visibility==="hidden")&&C(this,vl,C1).call(this,this.targetElement,s))return!0}return!1};xl=new WeakSet;$1=function(e){const t=e.getBoundingClientRect(),s=window.innerHeight||document.documentElement.clientHeight,o=window.innerWidth||document.documentElement.clientWidth;return t.top+t.height<0||t.top>s||t.left+t.width<0||t.left>o};yl=new WeakSet;S1=async function(e,t,s){return Pc(e,t,{placement:this.placement,middleware:[Dc(()=>({mainAxis:16,alignmentAxis:16})),{name:"detectOverflow",async fn(o){return{data:await Sp(o,{boundary:document.body,rootBoundary:"document",altBoundary:!0,padding:{top:167,left:20}})}}},Mp({padding:16}),Vc(),Ep(),Tp({padding:16,element:s})]})};wl=new WeakSet;M1=function(){if(!this.targetElement)return!1;const e=C(this,xl,$1).call(this,this.targetElement),t=this.targetElement.checkVisibility(),s=this.overlappedBy.length===0?!1:C(this,bl,k1).call(this,this.overlappedBy);return this.computeVisibility(this,this.targetElement,!s&&!e&&t)};Lr=new WeakSet;ya=async function(){const e=this.targetElement,t=c(this,Co).value,s=c(this,an).value;if(!(!e||!t||!s))try{U(this,Sn,Lc(e,t,()=>{C(this,yl,S1).call(this,e,t,s).then(({x:o,y:r,middlewareData:n,placement:i})=>{if(C(this,wl,M1).call(this)){if(this._isVisible=!0,Object.assign(t.style,{visibility:"visible",opacity:1,left:`${o}px`,top:`${r}px`}),n.arrow){const{x:l,y:d}=n.arrow;s.removeAttribute("class"),s.classList.add("arrow-"+i),Object.assign(s.style,{left:l!=null?`${l}px`:"",top:d!=null?`${d}px`:""})}}else this._isVisible=!1,Object.assign(t.style,{visibility:"hidden",opacity:0})})}))}catch{console.warn("failed to render tooltips")}};Be.styles=N2;a([g()],Be.prototype,"placement",2);a([g({attribute:!1})],Be.prototype,"overlappedBy",2);a([g({attribute:!1})],Be.prototype,"target",2);a([g()],Be.prototype,"label",2);a([g({attribute:!1})],Be.prototype,"computeVisibility",2);a([P()],Be.prototype,"_isVisible",2);a([P()],Be.prototype,"_preventClose",2);Be=a([k("gds-coachmark")],Be);var G2=D`
  :host {
    display: flex;
  }
  .button {
...
`,Z2=G2,ko=class extends de{connectedCallback(){super.connectedCallback(),this._dynamicStylesController.inject("FAB_styles",Z2)}};a([y({valueTemplate:e=>e,selector:'[part="_button"]'})],ko.prototype,"position",2);a([y({valueTemplate:e=>e})],ko.prototype,"transform",2);a([y({valueTemplate:e=>e,selector:'[part="_button"]'})],ko.prototype,"inset",2);ko=a([k("gds-fab")],ko);var U2=Object.defineProperty,Y2=Object.getOwnPropertyDescriptor,q2=(e,t,s,o)=>{for(var r=o>1?void 0:o?Y2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&U2(t,s,r),r};let yd=class extends E{createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m`<gds-card border="4xs/base300" padding="m" border-radius="s">
      <form>
        <gds-input
          required
          label="Name"
    ...
    </gds-card>`}};yd=q2([O("form-validation")],yd);var K2=Object.defineProperty,X2=Object.getOwnPropertyDescriptor,_l=(e,t,s,o)=>{for(var r=o>1?void 0:o?X2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&K2(t,s,r),r};let ln=class extends E{constructor(){super(...arguments),this.disabledWeekends=!1,this.showWeekNumbers=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m` <div style="width:320px; margin: 8rem auto;">
      ...
      <fieldset class="form-group" style="margin-top: 2rem">
        ...
        <label class="form-control"
          ...
          ><i
        ></i></label>
    </div>`}};_l([P()],ln.prototype,"disabledWeekends",2);_l([P()],ln.prototype,"showWeekNumbers",2);ln=_l([O("datepicker-example")],ln);var J2=Object.defineProperty,Q2=Object.getOwnPropertyDescriptor,E1=e=>{throw TypeError(e)},Mn=(e,t,s,o)=>{for(var r=o>1?void 0:o?Q2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&J2(t,s,r),r},eu=(e,t,s)=>t.has(e)||E1("Cannot "+s),tu=(e,t,s)=>(eu(e,t,"read from private field"),s?s.call(e):t.get(e)),su=(e,t,s)=>t.has(e)?E1("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),wa;const hr=`${new Date().getFullYear()}-${new Date().getMonth()+1}`;let $o=class extends E{constructor(){super(...arguments),this.disabledWeekends=!1,this.showWeekNumbers=!1,this.showCustomizedDates=!1,su(this,wa,[{date:new Date(`${hr}-07`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${hr}-12`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${hr}-24`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${hr}-21`),indicator:"dot",disabled:!0}])}createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m` <div style="width:320px; margin: 8rem auto;">
      <h3 style="margin-bottom: 2rem;">Standalone calendar</h3>
      <div class="card" style="padding: 0">
        <gds-calendar
          .disabledWeekends=${this.disabledWeekends}
          .showWeekNumbers=${this.showWeekNumbers}
          .customizedDates=${this.showCustomizedDates?tu(this,wa):[]}
        ></gds-calendar>
      </div>
      <fieldset class="form-group" style="margin-top: 2rem">
        <legend>Example controls</legend>
    ...
    </div>`}};wa=new WeakMap;Mn([P()],$o.prototype,"disabledWeekends",2);Mn([P()],$o.prototype,"showWeekNumbers",2);Mn([P()],$o.prototype,"showCustomizedDates",2);$o=Mn([O("calendar-example")],$o);var ou=Object.defineProperty,ru=Object.getOwnPropertyDescriptor,nu=(e,t,s,o)=>{for(var r=o>1?void 0:o?ru(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&ou(t,s,r),r};const iu="https://github.com/user-attachments/assets/1c038c0b-b468-48d2-b171-092534b3a0e2";let wd=class extends E{createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m`
    ...
    `}};wd=nu([O("gds-login")],wd);var au=Object.defineProperty,lu=Object.getOwnPropertyDescriptor,du=(e,t,s,o)=>{for(var r=o>1?void 0:o?lu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&au(t,s,r),r};let _d=class extends E{render(){return m`
    <gds-card variant="copper-01" padding="s">
        ...
        `}};_d=du([O("tp-card-carousel")],_d);var cu=Object.defineProperty,gu=Object.getOwnPropertyDescriptor,hu=(e,t,s,o)=>{for(var r=o>1?void 0:o?gu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&cu(t,s,r),r};let Cd=class extends E{createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m`<tp-card-carousel></tp-card-carousel>`}};Cd=hu([O("gds-onboarding")],Cd);var pu=D`
  :host {
    display: block;
  }
...
`,mu=fu,st=class extends ve{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return er`<div part="mask"></div>
  ...
  `;nr([g({type:Number})],Gt.prototype,"value",2);nr([g({type:Number})],Gt.prototype,"min",2);nr([g({type:Number})],Gt.prototype,"max",2);nr([g({type:Number})],Gt.prototype,"step",2);Gt=nr([O("tp-slider")],Gt);var Fu=Object.defineProperty,ju=Object.getOwnPropertyDescriptor,Kt=(e,t,s,o)=>{for(var r=o>1?void 0:o?ju(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Fu(t,s,r),r};let vt=class extends E{constructor(){super(),this.heading="",this.step=1,this.min=0,this.max=100,this.value=Math.max(this.min,this.max/2)}render(){return m`<gds-flex flex-direction="column" gap="xs"
      ><gds-flex flex-direction="column" gap="2xs">
      ...
      ></tp-slider
    ></gds-flex>`}};Kt([g({type:String})],vt.prototype,"heading",2);Kt([g({type:Number})],vt.prototype,"step",2);Kt([g({type:Number})],vt.prototype,"min",2);Kt([g({type:Number})],vt.prototype,"max",2);Kt([g({type:Number})],vt.prototype,"value",2);Kt([g({type:Object})],vt.prototype,"formatter",2);vt=Kt([O("tp-slider-input")],vt);var Wu=Object.defineProperty,Ru=Object.getOwnPropertyDescriptor,ot=(e,t,s,o)=>{for(var r=o>1?void 0:o?Ru(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Wu(t,s,r),r};let bs=class extends E{constructor(){super(...arguments),this.amount=175e3,this.year=5,this.rate=6.95,this.tab="house",this.currencyFormatter=new Intl.NumberFormat("sv-SE",{style:"currency",currency:"SEK",maximumFractionDigits:0}),this.percentageFormatter=new Intl.NumberFormat("sv-SE",{style:"percent",maximumFractionDigits:2})}render(){const e=Bu(this.amount,this.year,this.rate),t=this.currencyFormatter.format(e),s=this.currencyFormatter.format(e+135);return m`<gds-card>
  ...
  `;ot([g({type:String})],xs.prototype,"label",2);ot([g({type:String})],xs.prototype,"icon",2);ot([g({type:Boolean})],xs.prototype,"selected",2);xs=ot([O("tp-calculator-icon-button")],xs);var Iu=Object.defineProperty,Nu=Object.getOwnPropertyDescriptor,L1=e=>{throw TypeError(e)},D1=(e,t,s,o)=>{for(var r=o>1?void 0:o?Nu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Iu(t,s,r),r},Gu=(e,t,s)=>t.has(e)||L1("Cannot "+s),$d=(e,t,s)=>(Gu(e,t,"read from private field"),s?s.call(e):t.get(e)),Sd=(e,t,s)=>t.has(e)?L1("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),_a,Ca;let gn=class extends E{constructor(){super(...arguments),this.value="",Sd(this,_a,e=>{const t=e.target;this.value=t.value}),Sd(this,Ca,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}render(){return ge`
      <div>
        <input
          @input=${$d(this,_a)}
          @change=${$d(this,Ca)}
    ...
    `}};_a=new WeakMap;Ca=new WeakMap;gn.styles=D`
    div {
      width: fit-content;
    }
    input {
  ...
  `;D1([g({type:String})],gn.prototype,"value",2);gn=D1([O("tp-pill-input")],gn);var Zu=Object.defineProperty,Uu=Object.getOwnPropertyDescriptor,Ms=(e,t,s,o)=>{for(var r=o>1?void 0:o?Uu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Zu(t,s,r),r};let hn=class extends E{constructor(){super(...arguments),this.heading="",this.detail=""}render(){return m`<gds-flex flex-direction="column" gap="l">
    ...
    </gds-flex>`}};Ms([g({type:String})],hn.prototype,"heading",2);Ms([g({type:String})],hn.prototype,"detail",2);hn=Ms([O("tp-rates")],hn);let pn=class extends E{constructor(){super(...arguments),this.heading="",this.detail=""}render(){return m`<gds-flex
      flex-direction="column"
      justify-content="center"
      align-items="center"
      gap="xs"
  ...
  `;ir([g({type:String})],Zt.prototype,"name",2);ir([g({type:String})],Zt.prototype,"title",2);ir([g({type:String})],Zt.prototype,"description",2);ir([g({type:String})],Zt.prototype,"label",2);Zt=ir([O("tp-step")],Zt);var Ku=Object.defineProperty,Xu=Object.getOwnPropertyDescriptor,V1=(e,t,s,o)=>{for(var r=o>1?void 0:o?Xu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Ku(t,s,r),r};let ka=class extends E{constructor(){super(...arguments),this.active=!1}render(){return m`
      <gds-container
        border-radius="max"
  ...
  `;wt([g({type:String})],Ut.prototype,"heading",2);wt([g({type:String})],Ut.prototype,"img",2);wt([g({type:String})],Ut.prototype,"body",2);wt([g({type:String})],Ut.prototype,"link",2);Ut=wt([O("tp-content-card")],Ut);const $a=new Set;function o0(){dn.instance.injectGlobalStyles("dialog-scroll-lock",D`
      .gds-scroll-lock body {
        padding-right: var(--gds-scroll-lock-size) !important;
        overflow: hidden !important;
      }
    `)}function r0(e){if($a.add(e),!document.documentElement.classList.contains("gds-scroll-lock")){const t=i0()+a0();let s=getComputedStyle(document.documentElement).scrollbarGutter;(!s||s==="auto")&&(s="stable"),t<2&&(s=""),document.documentElement.style.setProperty("--gds-scroll-lock-gutter",s),document.documentElement.classList.add("gds-scroll-lock"),document.documentElement.style.setProperty("--gds-scroll-lock-size",`${t}px`)}}function n0(e){$a.delete(e),$a.size===0&&(document.documentElement.classList.remove("gds-scroll-lock"),document.documentElement.style.removeProperty("--gds-scroll-lock-size"))}function i0(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function a0(){const e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}const Md=""+new URL("forest-CySO3eH8.mp4",import.meta.url).href;var l0=Object.defineProperty,d0=Object.getOwnPropertyDescriptor,P1=e=>{throw TypeError(e)},_t=(e,t,s,o)=>{for(var r=o>1?void 0:o?d0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&l0(t,s,r),r},c0=(e,t,s)=>t.has(e)||P1("Cannot "+s),g0=(e,t,s)=>t.has(e)?P1("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),In=(e,t,s)=>(c0(e,t,"access private method"),s),Bs,H1,Sa;o0();let un=class extends E{constructor(){super(...arguments),g0(this,Bs)}connectedCallback(){super.connectedCallback()}render(){return m` <dialog
        @click=${async e=>{const t=await this.dialogElement;t!=null&&t.contains(e.target)&&t!==e.target||In(this,Bs,Sa).call(this)}}
      >
        <gds-theme color-scheme="dark">
          <gds-card
            level="1"
      ...
      </gds-card>`}};Bs=new WeakSet;H1=async function(){const e=await this.dialogElement;e&&document.startViewTransition(()=>{e.showModal(),r0(e)})};Sa=async function(){const e=await this.dialogElement;e&&document.startViewTransition(()=>{e.close(),n0(e)})};un.styles=D`
  ...
  `;_t([xt("dialog")],un.prototype,"dialogElement",2);un=_t([O("tp-news")],un);let Ed=class extends E{render(){return m`<gds-card>
      <gds-flex flex-direction="column" gap="l" padding="l">
    ...
    </gds-card>`}};Ed=_t([O("tp-interaction-stuff")],Ed);let ys=class extends E{constructor(){super(...arguments),this.min=0,this.max=100,this.value=this.max/2}render(){return m`<gds-flex flex-direction="column" gap="xs">
    ...
    >
      <gds-flex gap="m" align-items="center">
        ...
        .stack[aria-expanded='true'] {
          ...
          pointer-events: none;
          max-height: calc(
            calc(var(--gds-space-m, 0) * ${pr.length-1}) +
              calc(var(--todo-height, 0) * ${pr.length})
          );
        }
        ...
        .todo {
          height: 100%;
          width: 100%;
          z-index: calc(${pr.length} - var(--todo-index));
          pointer-events: none;
      ...
      <gds-flex flex-direction="column" gap="m">
        <gds-flex justify-content="space-between">
          ...
          <button class="expand-button" @click="${Td(this,Vr,W1)}">
        ...
        >
      </gds-flex>`}};Vr=new WeakSet;j1=function(){this.expanded||(this.expanded=!0)};W1=function(){this.expanded=!this.expanded};Cl([g({type:Boolean})],fn.prototype,"expanded",2);Cl([te(".todo")],fn.prototype,"todo",2);fn=Cl([O("tp-todos")],fn);var v0=Object.defineProperty,b0=Object.getOwnPropertyDescriptor,x0=(e,t,s,o)=>{for(var r=o>1?void 0:o?b0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&v0(t,s,r),r};let zd=class extends E{connectedCallback(){super.connectedCallback()}render(){return m` <gds-card variant="secondary" shadow="s" padding="l">
      <gds-flex flex-direction="column" gap="m">
    ...
    </gds-card>`}};zd=x0([O("tp-savings-outside")],zd);var y0=Object.defineProperty,w0=Object.getOwnPropertyDescriptor,R1=e=>{throw TypeError(e)},ar=(e,t,s,o)=>{for(var r=o>1?void 0:o?w0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&y0(t,s,r),r},_0=(e,t,s)=>t.has(e)||R1("Cannot "+s),C0=(e,t,s)=>t.has(e)?R1("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),mn=(e,t,s)=>(_0(e,t,"access private method"),s),ls,B1,I1,N1,G1;let ws=class extends E{constructor(){super(),C0(this,ls),this.hideFooter=!1,this.wide=!1,this.footerSlotOccupied=!1,this.mainSlotOccupied=!1}connectedCallback(){super.connectedCallback()}render(){return m`
      <style>
        .main-slot {
      ...
      <gds-card background="secondary" padding="0" shadow="s" border="none">
        ...
        >
          ...
          ${mn(this,ls,N1).call(this)}
        </gds-flex>
        ${mn(this,ls,B1).call(this)}
      </gds-card>
    `}};ls=new WeakSet;B1=function(){return m`<div style="display: ${this.footerSlotOccupied?"":"none"}">
      <gds-flex
        border="4xs/primary 0 0 0"
        flex-direction="column"
        padding="m l m m"
      >
        <slot name="footer" @slotchange=${mn(this,ls,I1)}></slot>
      </gds-flex>
    </div>`};I1=function(e){const s=e.target.assignedNodes({flatten:!0});this.footerSlotOccupied=s.length>0&&s.some(o=>{var r;return o.nodeType===Node.ELEMENT_NODE||o.nodeType===Node.TEXT_NODE&&((r=o.textContent)==null?void 0:r.trim())!==""})};N1=function(){return m`<gds-flex class="main-slot" flex-direction="column" gap="l">
      <slot @slotchange=${mn(this,ls,G1)}></slot>
    </gds-flex>`};G1=function(e){const s=e.target.assignedNodes({flatten:!0});this.mainSlotOccupied=s.length>0&&s.some(o=>{var r;return o.nodeType===Node.ELEMENT_NODE||o.nodeType===Node.TEXT_NODE&&((r=o.textContent)==null?void 0:r.trim())!==""})};ar([P()],ws.prototype,"hideFooter",2);ar([g({type:Boolean})],ws.prototype,"wide",2);ar([P()],ws.prototype,"footerSlotOccupied",2);ar([P()],ws.prototype,"mainSlotOccupied",2);ws=ar([O("tp-card")],ws);var k0=Object.defineProperty,$0=Object.getOwnPropertyDescriptor,S0=(e,t,s,o)=>{for(var r=o>1?void 0:o?$0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&k0(t,s,r),r};let Ad=class extends E{connectedCallback(){super.connectedCallback()}render(){return m`<tp-card>
    ...
    </tp-card>`}};Ad=S0([O("tp-savings-goal")],Ad);var M0=Object.defineProperty,E0=Object.getOwnPropertyDescriptor,T0=(e,t,s,o)=>{for(var r=o>1?void 0:o?E0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&M0(t,s,r),r};let Od=class extends E{constructor(){super(...arguments),this.isCollapsed=!1}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}toggleCollapse(){this.isCollapsed=!this.isCollapsed,this.requestUpdate()}render(){return m` <tp-card gap=${this.isCollapsed?"0":"xl"}>
      <!-- Header -->
      ...
      ${ae(!this.isCollapsed,()=>m`
        ...
        `,()=>m``)}
      <!-- body end -->
    </tp-card>`}};Od=T0([O("tp-savings")],Od);var z0=Object.defineProperty,A0=Object.getOwnPropertyDescriptor,O0=(e,t,s,o)=>{for(var r=o>1?void 0:o?A0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&z0(t,s,r),r};let Ld=class extends E{render(){return m`
      <tp-card>
        <!-- Header -->
    ...
    `}};Ld=O0([O("tp-accounts")],Ld);const L0=""+new URL("acne-CDrPujUB.svg",import.meta.url).href,D0=""+new URL("ica-DL3rRfwZ.svg",import.meta.url).href,V0=""+new URL("swish-B-td8wCi.svg",import.meta.url).href;var P0=Object.defineProperty,H0=Object.getOwnPropertyDescriptor,F0=(e,t,s,o)=>{for(var r=o>1?void 0:o?H0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&P0(t,s,r),r};let Dd=class extends E{connectedCallback(){super.connectedCallback()}renderIca(){return m`<img src="${D0}" alt="ICA Logo" />`}renderSwish(){return m`<img src="${V0}" alt="Swish Logo" />`}renderAcne(){return m`<img src="${L0}" alt="Acne Logo" />`}render(){return m` <style>
        /* ::-webkit-scrollbar {
          display: none;
        } */
        .item-wrapper {
      ...
      </gds-card>`}};Dd=F0([O("gds-carousel-trans")],Dd);var j0=Object.defineProperty,W0=Object.getOwnPropertyDescriptor,R0=(e,t,s,o)=>{for(var r=o>1?void 0:o?W0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&j0(t,s,r),r};let Vd=class extends E{render(){return m`
      <tp-card>
        <!-- Header -->
    ...
    `}};Vd=R0([O("tp-cards")],Vd);var B0=Object.defineProperty,I0=Object.getOwnPropertyDescriptor,N0=(e,t,s,o)=>{for(var r=o>1?void 0:o?I0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&B0(t,s,r),r};let Pd=class extends E{render(){return m`
      <tp-card>
        <!-- Header -->
    ...
    `}};Pd=N0([O("tp-transactions")],Pd);var G0=Object.defineProperty,Z0=Object.getOwnPropertyDescriptor,U0=(e,t,s,o)=>{for(var r=o>1?void 0:o?Z0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&G0(t,s,r),r};let Hd=class extends E{connectedCallback(){super.connectedCallback()}render(){return m`
      <gds-flex gap="s">
        <gds-flex>
          <slot name="icon"></slot>
        </gds-flex>
    ...
    `}};Hd=U0([O("tp-list-item")],Hd);var Y0=Object.defineProperty,q0=Object.getOwnPropertyDescriptor,K0=(e,t,s,o)=>{for(var r=o>1?void 0:o?q0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Y0(t,s,r),r};let Fd=class extends E{createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m`
    ...
    `}};Fd=K0([O("gds-dashboard")],Fd);var X0=D`
  :host {
    font-size: var(--gds-text-size-body-m);
    line-height: var(--gds-text-line-height-body-m);
...
`,vn=class extends Y{querySelectorAll(e){return this.shadowRoot?this.shadowRoot.querySelectorAll(e):new NodeList}querySelector(e){return this.shadowRoot?this.shadowRoot.querySelector(e):null}get innerHTML(){var e;return((e=this.shadowRoot)==null?void 0:e.innerHTML)||""}set innerHTML(e){this.shadowRoot&&(this.shadowRoot.innerHTML=e)}connectedCallback(){super.connectedCallback(),this._captureDOM()}_captureDOM(){!this.shadowRoot||this.childNodes.length===0||this.shadowRoot.replaceChildren(...Array.from(this.childNodes))}};vn.styles=[J,sc,X0];a([Ua()],vn.prototype,"_captureDOM",1);vn=a([k("gds-rich-text")],vn);var J0=Object.defineProperty,Q0=Object.getOwnPropertyDescriptor,Z1=e=>{throw TypeError(e)},U1=(e,t,s,o)=>{for(var r=o>1?void 0:o?Q0(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&J0(t,s,r),r},ef=(e,t,s)=>t.has(e)||Z1("Cannot "+s),tf=(e,t,s)=>t.has(e)?Z1("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Nn=(e,t,s)=>(ef(e,t,"access private method"),s),Is,Pr;let Ma=class extends E{constructor(){super(...arguments),tf(this,Is),this.viewOptions={hasAccounts:!1,hasSavings:!1,hasCards:!1}}createRenderRoot(){return this}render(){return m`
              ...
              <gds-popover>
                ...
                <gds-menu-item>
                  <label class="form-control"
                    ...
                    <input
                      type="checkbox"
                      @change=${e=>Nn(this,Is,Pr).call(this,{...this.viewOptions,hasAccounts:e.target.checked})}
                    />
                    <i></i>
                  </label>
                </gds-menu-item>
                <gds-menu-item>
                  <label class="form-control"
                    ...
                    <input
                      type="checkbox"
                      @change=${e=>Nn(this,Is,Pr).call(this,{...this.viewOptions,hasSavings:e.target.checked})}
                    />
                    <i></i>
                  </label>
                </gds-menu-item>
                <gds-menu-item>
                  <label class="form-control">
                    ...
                    <input
                      type="checkbox"
                      @change=${e=>Nn(this,Is,Pr).call(this,{...this.viewOptions,hasCards:e.target.checked})}
                    />
                    <i></i>
                  </label>
                </gds-menu-item>
    ...
    `}};Is=new WeakSet;Pr=function(e){this.viewOptions=e,this.dispatchEvent(new CustomEvent("view-options-change",{detail:{view:e},bubbles:!0,composed:!0}))};U1([P()],Ma.prototype,"viewOptions",2);Ma=U1([O("tp-page-header")],Ma);var Bo=class extends L{};Bo._regularSVG='<path d="M17 13.75V3.75M17 13.75C18.7956 13.75 20.25 15.2044 20.25 17C20.25 18.7956 18.7956 20.25 17 20.25C15.2044 20.25 13.75 18.7956 13.75 17C13.75 15.2044 15.2044 13.75 17 13.75ZM7 20.25V12.25M7 12.25C5.20438 12.25 3.75 10.7956 3.75 9C3.75 7.20438 5.20438 5.75 7 5.75M7 12.25C8.79562 12.25 10.25 10.7956 10.25 9C10.25 7.20438 8.79562 5.75 7 5.75M7 5.75V3.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';Bo._solidSVG='<path d="M17.75 13.0701C19.6011 13.421 21 15.0465 21 17C21 19.2098 19.2098 21 17 21C14.7902 21 13 19.2098 13 17C13 15.0465 14.3989 13.421 16.25 13.0701V3.75C16.25 3.33579 16.5858 3 17 3C17.4142 3 17.75 3.33579 17.75 3.75V13.0701Z" fill="currentColor"/><path d="M7 21C6.58579 21 6.25 20.6642 6.25 20.25V12.9299C4.3989 12.579 3 10.9535 3 9C3 7.04652 4.3989 5.421 6.25 5.07014V3.75C6.25 3.33579 6.58579 3 7 3C7.41421 3 7.75 3.33579 7.75 3.75V5.07014C9.6011 5.421 11 7.04652 11 9C11 10.9535 9.6011 12.579 7.75 12.9299V20.25C7.75 20.6642 7.41421 21 7 21Z" fill="currentColor"/>';Bo._name="settings-slider-ver";Bo=a([k("gds-icon-settings-slider-ver")],Bo);var Io=class extends L{};Io._regularSVG='<path d="M8.75 15.25L14.5694 9.43056M15.25 14.25V8.75H9.75M21.25 12C21.25 6.89137 17.1086 2.75 12 2.75C6.89137 2.75 2.75 6.89137 2.75 12C2.75 17.1086 6.89137 21.25 12 21.25C17.1086 21.25 21.25 17.1086 21.25 12Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';Io._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12ZM16 8.75C16 8.33579 15.6642 8 15.25 8H9.75C9.33579 8 9 8.33579 9 8.75C9 9.16421 9.33579 9.5 9.75 9.5H13.4393L8.21967 14.7197C7.92678 15.0126 7.92678 15.4874 8.21967 15.7803C8.51256 16.0732 8.98744 16.0732 9.28033 15.7803L14.5 10.5607V14.25C14.5 14.6642 14.8358 15 15.25 15C15.6642 15 16 14.6642 16 14.25V8.75Z" fill="currentColor"/>';Io._name="arrow-right-up-circle";Io=a([k("gds-icon-arrow-right-up-circle")],Io);var sf=Object.defineProperty,of=Object.getOwnPropertyDescriptor,Y1=(e,t,s,o)=>{for(var r=o>1?void 0:o?of(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&sf(t,s,r),r};let Ea=class extends E{render(){return m`
      <style>
        :host {
          display: contents;
        }
    ...
    `}};Y1([g({type:String})],Ea.prototype,"name",2);Ea=Y1([O("tp-accounts-card")],Ea);var rf=Object.defineProperty,nf=Object.getOwnPropertyDescriptor,q1=(e,t,s,o)=>{for(var r=o>1?void 0:o?nf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&rf(t,s,r),r};let Ta=class extends E{constructor(){super(...arguments),this.isModalOpen=!1}handleCardClick(){this.isModalOpen=!0}closeModal(){this.isModalOpen=!1}handleKeyDown(e){e.key==="Escape"&&(this.isModalOpen=!1)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.handleKeyDown.bind(this))}disconnectedCallback(){window.removeEventListener("keydown",this.handleKeyDown.bind(this)),super.disconnectedCallback()}render(){return m`
      <style>
        .car {
          display: flex;
          overflow-x: scroll;
  ...
  `;za=df([O("tp-quicklinks")],za);var cf=Object.defineProperty,gf=Object.getOwnPropertyDescriptor,K1=(e,t,s,o)=>{for(var r=o>1?void 0:o?gf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&cf(t,s,r),r};let Aa=class extends E{firstUpdated(){this.addEventListeners()}addEventListeners(){this.shadowRoot.querySelectorAll("tp-step-bullet").forEach(t=>{t.addEventListener("click",this.handleBulletClick.bind(this))})}handleBulletClick(e){const t=e.currentTarget,s=t.getAttribute("step"),o=this.shadowRoot.querySelector(`tp-step[name="${s}"]::part(step)`);o&&o.scrollIntoView({behavior:"smooth",block:"center"}),this.shadowRoot.querySelectorAll("tp-step-bullet").forEach(n=>n.removeAttribute("active")),t.setAttribute("active","")}render(){return m`
    ...
    `}};K1([te(".steps")],Aa.prototype,"stepsContainer",2);Aa=K1([O("tp-steps")],Aa);var hf=Object.defineProperty,pf=Object.getOwnPropertyDescriptor,uf=(e,t,s,o)=>{for(var r=o>1?void 0:o?pf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&hf(t,s,r),r};let jd=class extends E{render(){return m`
      <style>
        .carousel {
          display: flex;
          overflow-x: scroll;
    ...
    `}};jd=uf([O("tp-carousel-pink")],jd);var ff=Object.defineProperty,mf=Object.getOwnPropertyDescriptor,En=(e,t,s,o)=>{for(var r=o>1?void 0:o?mf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&ff(t,s,r),r};let Go=class extends E{constructor(){super(...arguments),this.amountPerMonth=500,this.years=5,this.total="26 325"}connectedCallback(){super.connectedCallback()}render(){return m`<gds-card variant="secondary" border-color="primary">
    ...
    </gds-card>`}};En([P()],Go.prototype,"amountPerMonth",2);En([P()],Go.prototype,"years",2);En([P()],Go.prototype,"total",2);Go=En([O("tp-savings-calc")],Go);const Wd=m` <svg
  width="100%"
  height="32"
  viewBox="0 0 368 32"
  fill="none"
...
>
  ...
  <defs>
...
</svg>`;var vf=Object.defineProperty,bf=Object.getOwnPropertyDescriptor,xf=(e,t,s,o)=>{for(var r=o>1?void 0:o?bf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&vf(t,s,r),r};let Rd=class extends E{render(){return m`
      <tp-card>
        <!-- Header -->
        <gds-text slot="header" font-size="heading-s">
          Konton och kort
    ...
    `}};Rd=xf([O("tp-empty-konton")],Rd);var yf=Object.defineProperty,wf=Object.getOwnPropertyDescriptor,X1=(e,t,s,o)=>{for(var r=o>1?void 0:o?wf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&yf(t,s,r),r};let Oa=class extends E{constructor(){super(...arguments),this.isVisible=!0}handleCloseClick(){this.isVisible=!1}render(){return m` <style>
        :host {
      ...
      ${this.isVisible?m`
          ...
          `:N}`}};X1([P()],Oa.prototype,"isVisible",2);Oa=X1([O("tp-empty-card")],Oa);var Zo=class extends L{};Zo._regularSVG='<path d="M8.75 8.75L14.5694 14.5694M15.25 9.75V15.25H9.75M21.25 12C21.25 17.1086 17.1086 21.25 12 21.25C6.89137 21.25 2.75 17.1086 2.75 12C2.75 6.89137 6.89137 2.75 12 2.75C17.1086 2.75 21.25 6.89137 21.25 12Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';Zo._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16 15.25C16 15.6642 15.6642 16 15.25 16H9.75C9.33579 16 9 15.6642 9 15.25C9 14.8358 9.33579 14.5 9.75 14.5H13.4393L8.21967 9.28033C7.92678 8.98744 7.92678 8.51256 8.21967 8.21967C8.51256 7.92678 8.98744 7.92678 9.28033 8.21967L14.5 13.4393V9.75C14.5 9.33579 14.8358 9 15.25 9C15.6642 9 16 9.33579 16 9.75V15.25Z" fill="currentColor"/>';Zo._name="arrow-right-down-circle";Zo=a([k("gds-icon-arrow-right-down-circle")],Zo);var Uo=class extends L{};Uo._regularSVG='<path d="M4 15L12 7L20 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>';Uo._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.25C12.1989 6.25 12.3897 6.32902 12.5303 6.46967L20.5303 14.4697C20.8232 14.7626 20.8232 15.2374 20.5303 15.5303C20.2374 15.8232 19.7626 15.8232 19.4697 15.5303L12 8.06066L4.53033 15.5303C4.23744 15.8232 3.76256 15.8232 3.46967 15.5303C3.17678 15.2374 3.17678 14.7626 3.46967 14.4697L11.4697 6.46967C11.6103 6.32902 11.8011 6.25 12 6.25Z" fill="currentColor"/>';Uo._name="chevron-top";Uo=a([k("gds-icon-chevron-top")],Uo);var Yo=class extends L{};Yo._regularSVG='<path d="M6.86111 13.25H3.25L6.25 7.75H11.2292M6.86111 13.25L10.75 17.1389M6.86111 13.25L11.2292 7.75M10.75 17.1389V20.75L16.25 17.75V12.7708M10.75 17.1389L16.25 12.7708M16.25 12.7708C19.3333 9.94444 21.25 6.86111 21.25 2.75C17.1389 2.75 14.0556 4.66667 11.2292 7.75M4.80556 21.25H2.75V19.1944C2.75 18.0592 3.6703 17.1389 4.80556 17.1389C5.94081 17.1389 6.86111 18.0592 6.86111 19.1944C6.86111 20.3297 5.94081 21.25 4.80556 21.25Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>';Yo._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.5 14.3242L11.5 17.501V19.4866L15.5 17.3048V14.3242ZM10 17.4495L6.55045 14H3.25C2.9853 14 2.7402 13.8605 2.60508 13.6328C2.46995 13.4052 2.46482 13.1232 2.59158 12.8909L5.59158 7.39086C5.723 7.14992 5.97554 7 6.25 7H10.902C13.7571 3.96176 16.9703 2 21.25 2C21.6642 2 22 2.33579 22 2.75C22 7.02966 20.0382 10.2429 17 13.098V17.75C17 18.0245 16.8501 18.277 16.6091 18.4084L11.1091 21.4084C10.8768 21.5352 10.5948 21.53 10.3672 21.3949C10.1395 21.2598 10 21.0147 10 20.75V17.4495ZM6.499 12.5L9.67577 8.5H6.69522L4.51341 12.5H6.499ZM2 19.1944C2 17.645 3.25609 16.3889 4.80556 16.3889C6.35502 16.3889 7.61111 17.645 7.61111 19.1944C7.61111 20.7439 6.35502 22 4.80556 22H2.75C2.33579 22 2 21.6642 2 21.25V19.1944Z" fill="currentColor"/>';Yo._name="rocket";Yo=a([k("gds-icon-rocket")],Yo);var _f=Object.defineProperty,Cf=Object.getOwnPropertyDescriptor,Xt=(e,t,s,o)=>{for(var r=o>1?void 0:o?Cf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&_f(t,s,r),r};let bt=class extends E{constructor(){super(...arguments),this.activeCategory="Nöje",this.isExpanded=!1,this.label="Nöje",this.amount="13 523,00",this.amountDiff="Ökat",this.status="+3 567,00"}connectedCallback(){super.connectedCallback()}expand(){this.isExpanded=!this.isExpanded}renderIcon(){return this.isExpanded?m`<gds-icon-chevron-top></gds-icon-chevron-top>`:m`<gds-icon-chevron-bottom></gds-icon-chevron-bottom>`}renderCategory(e,t,s,o){this.activeCategory=e,this.label=e,this.amount=t,this.amountDiff=s,this.status=o}render(){return m`<tp-card>
  ...
  height: 100%;
    ...
    </tp-card>`}};Xt([P()],bt.prototype,"activeCategory",2);Xt([P()],bt.prototype,"isExpanded",2);Xt([P()],bt.prototype,"label",2);Xt([P()],bt.prototype,"amount",2);Xt([P()],bt.prototype,"amountDiff",2);Xt([P()],bt.prototype,"status",2);bt=Xt([O("tp-expenses")],bt);var kf=Object.defineProperty,$f=Object.getOwnPropertyDescriptor,kl=(e,t,s,o)=>{for(var r=o>1?void 0:o?$f(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&kf(t,s,r),r};let qo=class extends E{constructor(){super(...arguments),this.show=!1}render(){return m`<slot
      @slotchange=${()=>{setTimeout(()=>this.onShowChange(),0)}}
    ></slot>`}onShowChange(){console.log("show",this.show);const e=this.scrollHeight;this.show?(this.style.height=`${e}px`,this.style.opacity="1",this.style.marginBottom="var(--gds-space-3xl)",setTimeout(()=>{this.style.height="auto"},500)):(this.style.height="0",this.style.opacity="0",this.style.marginBottom="0")}};qo.styles=D`
    :host {
      display: block;
      transition: all 0.5s;
      overflow: hidden;
  ...
  `;kl([g()],qo.prototype,"show",2);kl([ne("show",{waitUntilFirstUpdate:!0}),i1()],qo.prototype,"onShowChange",1);qo=kl([O("tp-page-section")],qo);var Sf=Object.defineProperty,Mf=Object.getOwnPropertyDescriptor,Es=(e,t,s,o)=>{for(var r=o>1?void 0:o?Mf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(r=(o?i(t,s,r):i(r))||r);return o&&r&&Sf(t,s,r),r};let Yt=class extends E{constructor(){super(...arguments),this.hasExternalAccounts=!1,this.hasAccounts=!1,this.hasCards=!1,this.hasSavings=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){var e,t,s;return m`
      <gds-flex flex-direction="column">
  ...
  `;let Ko=Sl;J1([g()],Ko.prototype,"popoverOpen");J1([P()],Ko.prototype,"currentView");customElements.define("sebgroup-root",Ko);
