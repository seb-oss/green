...
`,hr=class extends qt{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then((()=>dr.instance.apply(this,"gds-menu-heading")))}render(){return ee`<slot></slot>`}};hr.styles=cr,hr=et([lt("gds-menu-heading")],hr);const ur=(e,...t)=>({strTag:!0,strings:e,values:t}),pr=(e,t,r)=>{let o=e[0];for(let s=1;s<e.length;s++)o+=t[r?r[s-1]:s-1],o+=e[s];return o},gr=e=>{return"string"!=typeof(t=e)&&"strTag"in t?pr(e.strings,e.values):e;var t};let fr=gr,br=!1;const mr="lit-localize-status";class LocalizeController{constructor(e){this.__litLocalizeEventHandler=e=>{"ready"===e.detail.status&&this.host.requestUpdate()},this.host=e}hostConnected(){window.addEventListener(mr,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(mr,this.__litLocalizeEventHandler)}}const vr=e=>e.addController(new LocalizeController(e)),yr=()=>(e,t)=>(e.addInitializer(vr),e);class Deferred{constructor(){this.settled=!1,this.promise=new Promise(((e,t)=>{this._resolve=e,this._reject=t}))}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}const xr=[];for(let pu=0;pu<256;pu++)xr[pu]=(pu>>4&15).toString(16)+(15&pu).toString(16);function wr(e,t){return(t?"h":"s")+function(e){let t=0,r=8997,o=0,s=33826,i=0,a=40164,l=0,d=52210;for(let c=0;c<e.length;c++)r^=e.charCodeAt(c),t=435*r,o=435*s,i=435*a,l=435*d,i+=r<<8,l+=s<<8,o+=t>>>16,r=65535&t,i+=o>>>16,s=65535&o,d=l+(i>>>16)&65535,a=65535&i;return xr[d>>8]+xr[255&d]+xr[a>>8]+xr[255&a]+xr[s>>8]+xr[255&s]+xr[r>>8]+xr[255&r]}("string"==typeof e?e:e.join("\x1e"))}const kr=new WeakMap,_r=new Map;function Cr(e,t,r){if(e){const o=r?.id??function(e){const t="string"==typeof e?e:e.strings;let r=_r.get(t);void 0===r&&(r=wr(t,"string"!=typeof e&&!("strTag"in e)),_r.set(t,r));return r}(t),s=e[o];if(s){if("string"==typeof s)return s;if("strTag"in s)return pr(s.strings,t.values,s.values);{let e=kr.get(s);return void 0===e&&(e=s.values,kr.set(s,e)),{...s,values:e.map((e=>t.values[e]))}}}}return gr(t)}function $r(e){window.dispatchEvent(new CustomEvent(mr,{detail:e}))}let Sr,Er,Ar,Tr,Mr,zr="",Lr=new Deferred;Lr.resolve();let jr=0;const Dr=e=>(function(e){if(br)throw new Error("lit-localize can only be configured once");fr=e,br=!0}(((e,t)=>Cr(Mr,e,t))),zr=Er=e.sourceLocale,Ar=new Set(e.targetLocales),Ar.add(e.sourceLocale),Tr=e.loadLocale,{getLocale:Or,setLocale:Pr}),Or=()=>zr,Pr=e=>{if(e===(Sr??zr))return Lr.promise;if(!Ar||!Tr)throw new Error("Internal error");if(!Ar.has(e))throw new Error("Invalid locale code");jr++;const t=jr;Sr=e,Lr.settled&&(Lr=new Deferred),$r({status:"loading",loadingLocale:e});return(e===Er?Promise.resolve({templates:void 0}):Tr(e)).then((r=>{jr===t&&(zr=e,Sr=void 0,Mr=r.templates,$r({status:"ready",readyLocale:e}),Lr.resolve())}),(r=>{jr===t&&($r({status:"error",errorLocale:e,errorMessage:r.toString()}),Lr.reject(r))})),Lr.promise},Vr=1,Wr=2,Hr=6,Nr=e=>(...t)=>({_$litDirective$:e,values:t});class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Rr=Nr(class extends directive_i{constructor(e){if(super(e),e.type!==Vr||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const r=e.element.classList;for(const o of this.st)o in t||(r.remove(o),this.st.delete(o));for(const o in t){const e=!!t[o];e===this.st.has(o)||this.nt?.has(o)||(e?(r.add(o),this.st.add(o)):(r.remove(o),this.st.delete(o)))}return ne}});var Fr,Br,Ir,Ur=me`
  @layer base, reset, transitional-styles;
  @layer base {
    button {
      display: flex;
...
`,ri=class extends ys{constructor(){super(),nt(this,Ds),nt(this,Ps),nt(this,Bs),nt(this,Us),nt(this,Gs),nt(this,qs),nt(this,Xs),nt(this,Qs),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",this.trailSlotOccupied=!1,nt(this,Ws,(e=>["type","placeholder","required"].includes(e.name))),nt(this,Hs,(e=>{const t=e.target;this.value=t.value})),nt(this,Ns,(e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})),nt(this,Rs,(()=>{this.elInputAsync.then((e=>e.focus()))})),nt(this,Fs,(()=>{this.value=""}))}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return ut`${Be(this.variant,[["default",()=>st(this,Ds,Os).call(this)],["floating-label",()=>st(this,Ps,Vs).call(this)]])}`}_getValidityAnchor(){return this.elInput}};Ds=new WeakSet,Os=function(){return ut`
      ...
      ></gds-form-control-footer>
    `},Ps=new WeakSet,Vs=function(){return oe},Ws=new WeakMap,Hs=new WeakMap,Ns=new WeakMap,Rs=new WeakMap,Fs=new WeakMap,Bs=new WeakSet,Is=function(){return ut` <slot name="lead"></slot> `},Us=new WeakSet,Zs=function(){return ut`
    ...
    `},Xs=new WeakSet,Js=function(){return this.clearable&&this.value.length>0?ut`
      ...
      `:oe},Qs=new WeakSet,ei=function(){return this.maxlength<Number.MAX_SAFE_INTEGER},ri.styles=[Yt,ti],et([Ve()],ri.prototype,"value",2),et([Ve()],ri.prototype,"label",2),et([Ve({attribute:"supporting-text"})],ri.prototype,"supportingText",2),et([Ve({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],ri.prototype,"showExtendedSupportingText",2),et([Ve({attribute:"disabled",type:Boolean,reflect:!0})],ri.prototype,"disabled",2),et([Ve({type:Boolean})],ri.prototype,"clearable",2),et([Ve({type:Number})],ri.prototype,"maxlength",2),et([Ve({type:String})],ri.prototype,"variant",2),et([Ve({type:String})],ri.prototype,"size",2),et([Fe("input")],ri.prototype,"elInputAsync",2),et([Ne("input")],ri.prototype,"elInput",2),et([We()],ri.prototype,"trailSlotOccupied",2),ri=et([lt("gds-input"),yr()],ri);var ni,oi,si,ii,ai,li,di=me`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`,ci=class extends qt{constructor(){super(...arguments),nt(this,ni),nt(this,ai),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,nt(this,si,(()=>ut`
    ...
    `},ci.styles=[di],et([Ve({type:Boolean,reflect:!0})],ci.prototype,"showExtendedSupportingText",2),et([We()],ci.prototype,"_hasExtendedSupportingText",2),et([Ne("#extended-supporting-text")],ci.prototype,"_extendedSupportingText",2),ci=et([lt("gds-form-control-header"),yr()],ci);var hi,ui,pi=me`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`,ji=class extends Xt{constructor(){super(),this.display="grid",this.width="100%"}render(){return ut`<slot></slot>`}};ji.styles=[Yt,Li],et([Dt({property:"--_c",valueTemplate:e=>e})],ji.prototype,"columns",2),et([Dt({styleTemplate:(e,t)=>{const r=t[0];return`--_gap-column: ${t[1]||r}; --_gap-row: ${r};`}})],ji.prototype,"gap",2),et([Dt({property:"--_col-width",valueTemplate:e=>`${e}px`})],ji.prototype,"auto-columns",2),ji=et([lt("gds-grid")],ji);var Di,Oi,Pi=me`
  @layer core, link;
...
`,Vi=class extends qt{constructor(){super(),nt(this,Di),this.href="",this.variant="default"}render(){const e={secondary:"secondary"===this.variant};return nr`
      <a
        href=${xs(this.href)}
        target=${xs(this.target)}
        rel=${xs(this.rel||rt(this,Di,Oi))}
    ...
    `}};Di=new WeakSet,Oi=function(){return"_blank"===this.target?"noreferrer noopener":void 0},Vi.styles=[Yt,be(Pi)],Vi.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Ve()],Vi.prototype,"href",2),et([Ve()],Vi.prototype,"target",2),et([Ve()],Vi.prototype,"rel",2),et([Ve()],Vi.prototype,"download",2),et([Ve()],Vi.prototype,"variant",2),Vi=et([lt("gds-link")],Vi);var Wi=me`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`,Hi=class extends qt{render(){return ut`<img src="${this.src}" alt="${this.alt}" />`}};Hi.styles=[Yt,Wi],et([Dt({property:"aspect-ratio",valueTemplate:e=>e})],Hi.prototype,"aspect-ratio",2),et([Dt({property:"object-position",selector:"img",valueTemplate:e=>e})],Hi.prototype,"position",2),et([Dt({property:"inset",valueTemplate:e=>e})],Hi.prototype,"inset",2),et([Dt({property:"width",valueTemplate:e=>e})],Hi.prototype,"width",2),et([Dt({property:"height",valueTemplate:e=>e})],Hi.prototype,"height",2),et([Dt({property:"opacity",valueTemplate:e=>e})],Hi.prototype,"opacity",2),et([Dt({property:"object-fit",selector:"img",valueTemplate:e=>e})],Hi.prototype,"object-fit",2),et([Ve()],Hi.prototype,"src",2),et([Ve()],Hi.prototype,"alt",2),et([Dt({property:"border-radius",valueTemplate:e=>`var(--gds-space-${e})`})],Hi.prototype,"border-radius",2),Hi=et([lt("gds-img")],Hi);var Ni=me`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`,Ri=class extends qt{applyVideoSettings(){this.videoElement&&(this.videoElement.src=this.src||"",this.videoElement.poster=this.poster||"",this.videoElement.muted=this.muted||!1,this.videoElement.autoplay=this.autoplay||!1,this.videoElement.loop=this.loop||!1,this.videoElement.playsInline=this.playsinline||!1)}render(){return ut`<video></video>`}firstUpdated(){this.applyVideoSettings()}};Ri.styles=[Yt,Ni],et([Dt({property:"aspect-ratio",valueTemplate:e=>e})],Ri.prototype,"aspect-ratio",2),et([Dt({property:"object-position",selector:"video",valueTemplate:e=>e})],Ri.prototype,"object-position",2),et([Dt({property:"inset",valueTemplate:e=>e})],Ri.prototype,"inset",2),et([Dt({property:"width",valueTemplate:e=>e})],Ri.prototype,"width",2),et([Dt({property:"height",valueTemplate:e=>e})],Ri.prototype,"height",2),et([Dt({property:"opacity",valueTemplate:e=>e})],Ri.prototype,"opacity",2),et([Dt({property:"object-fit",selector:"video",valueTemplate:e=>e})],Ri.prototype,"object-fit",2),et([Dt({property:"pointer-events",selector:"video",valueTemplate:e=>e})],Ri.prototype,"pointer-events",2),et([Dt({property:"border-radius",valueTemplate:e=>`var(--gds-space-${e})`})],Ri.prototype,"border-radius",2),et([Ve()],Ri.prototype,"src",2),et([Ve()],Ri.prototype,"poster",2),et([Ve({type:Boolean})],Ri.prototype,"muted",2),et([Ve({type:Boolean})],Ri.prototype,"playsinline",2),et([Ve({type:Boolean})],Ri.prototype,"autoplay",2),et([Ve({type:Boolean})],Ri.prototype,"loop",2),et([Ne("video")],Ri.prototype,"videoElement",2),Ri=et([lt("gds-video")],Ri);var Fi,Bi,Ii,Ui,Zi=me`
...
`,Ta=class extends vi{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return nr`<div part="mask"></div>
      <div part="content"><slot></slot></div>`}};Ta.styles=[Yt,Aa],et([Dt({selector:'[part="mask"]',valueTemplate:e=>{const[t]=e.split("/");return`linear-gradient(to ${t}, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0) 100%)`}})],Ta.prototype,"mask-image",2),et([Dt({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"mask-size",2),et([Dt({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"mask-repeat",2),et([Dt({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"mask-position",2),et([Dt({selector:'[part="mask"]',valueTemplate:function(e){const[t,r]=e.split("/");return r?`color-mix(in srgb, var(--gds-color-${"l"+this.level}-background-${t}) ${100*parseFloat(r)}%, transparent 0%)`:`var(--gds-color-${"l"+this.level}-background-${t})`}})],Ta.prototype,"background-color",2),et([Dt({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"backdrop-filter",2),Ta=et([lt("gds-mask")],Ta);const Ma=r.p+"image 23.295f27d8244d5f11.png";let za,La;function ja(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Oa((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Oa(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Da(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Da(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Oa(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}const Pa=[{img:Ma,heading:"Nu s\xe4nker vi bol\xe5ner\xe4ntan!",body:"Den 8 november s\xe4nker vi v\xe5ra bol\xe5ne\xad\xadr\xe4ntor f\xf6r flera bindnings\xad\xadtider. Den r\xf6rliga 3-m\xe5naders\xad\xadr\xe4ntan s\xe4nks med 0,50 procent\xadenheter.",button:"Read article"},{img:Ma,heading:"Nu s\xe4nker vi bol\xe5ner\xe4ntan!",body:"Den 8 november s\xe4nker vi v\xe5ra bol\xe5ne\xad\xadr\xe4ntor f\xf6r flera bindnings\xad\xadtider. Den r\xf6rliga 3-m\xe5naders\xad\xadr\xe4ntan s\xe4nks med 0,50 procent\xadenheter.",button:"Read article"},{img:Ma,heading:"Nu s\xe4nker vi bol\xe5ner\xe4ntan!",body:"Den 8 november s\xe4nker vi v\xe5ra bol\xe5ne\xad\xadr\xe4ntor f\xf6r flera bindnings\xad\xadtider. Den r\xf6rliga 3-m\xe5naders\xad\xadr\xe4ntan s\xe4nks med 0,50 procent\xadenheter.",button:"Read article"}];let Va;La=[De("tp-news-widget")];class TpNewsWidget extends lit_element_r{static#e=(()=>[Va,za]=ja(this,[],La,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut` <gds-theme>
...
`,ql=class extends ys{constructor(){super(),nt(this,Nl),nt(this,Fl),nt(this,Il),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,nt(this,Dl,void 0),nt(this,Ol,(e=>{const t=e.getBoundingClientRect(),r=window.innerHeight-t.bottom,o=t.top;let s=Math.min(o,this.maxHeight);return r>o&&(s=Math.min(r,this.maxHeight)),s-16+"px"})),nt(this,Pl,(e=>{if(!e.currentTarget)return;const t=e.currentTarget;if(this.options.forEach((e=>e.hidden=!1)),!t.value)return;const r=this.options.filter((e=>!this.searchFilter(t.value,e)));r.forEach((e=>e.hidden=!0))})),nt(this,Vl,(e=>{var t;null==(t=this._elListbox)||t.then((t=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void t.focus()}))})),nt(this,Wl,(e=>{var t;if("Tab"===e.key&&this.searchable)return e.preventDefault(),void(null==(t=this._elSearchInput)||t.focus())})),nt(this,Hl,(e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)})),nt(this,Zl,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)})),nt(this,Gl,(e=>{var t;"Tab"!==e.key||this.searchable||(e.preventDefault(),this.open=!1,null==(t=this._elTriggerBtn)||t.focus())})),vr(this)}get type(){return"gds-dropdown"}get options(){return rt(this,Dl)?Array.from(rt(this,Dl)).filter((e=>!e.hasAttribute("isplaceholder"))):[]}get placeholder(){if(rt(this,Dl))return Array.from(rt(this,Dl)).find((e=>e.hasAttribute("isplaceholder")))}get displayValue(){var e,t;let r;return r=Array.isArray(this.value)?this.value.length>2?fr(ur`${this.value.length} selected`):this.value.reduce(((e,t)=>{var r;return e+(null==(r=this.options.find((e=>e.value===t)))?void 0:r.innerHTML)+", "}),"").slice(0,-2):null==(e=this.options.find((e=>e.selected)))?void 0:e.innerHTML,r||(null==(t=this.placeholder)?void 0:t.innerHTML)||""}connectedCallback(){super.connectedCallback(),dr.instance.apply(this,"gds-dropdown"),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange()}))}render(){return ut`
      ...
      >
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){var e,t;this.requestUpdate(),ot(this,Dl,this.querySelectorAll("[gds-element=gds-option]")),this.multiple?this._handleValueChange():void 0===this.value?this.placeholder?this.value=this.placeholder.value:this.value=null==(e=this.options[0])?void 0:e.value:this.placeholder||void 0!==this.options.find((e=>this.compareWith(e.value,this.value)))||(this.options[0]&&(this.options[0].selected=!0),this.value=null==(t=this.options[0])?void 0:t.value)}_handleValueChange(){this._elListbox.then((e=>{e&&(Array.isArray(this.value)?e.selection=this.value:e.selection=[this.value])}))}_onOpenChange(){var e;const t=this.open;null==(e=rt(this,Dl))||e.forEach((e=>e.hidden=!t)),t?st(this,Fl,Bl).call(this):(st(this,Il,Ul).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const r=this.options.find((e=>e.selected));this.updateComplete.then((()=>null==r?void 0:r.scrollIntoView())),this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:t},bubbles:!0,composed:!0}))}};Dl=new WeakMap,Ol=new WeakMap,Pl=new WeakMap,Vl=new WeakMap,Wl=new WeakMap,Hl=new WeakMap,Nl=new WeakSet,Rl=function(){this._elListbox.then((e=>{var t;this.multiple?this.value=e.selection.map((e=>e.value)):(this.value=null==(t=e.selection[0])?void 0:t.value,this.open=!1,setTimeout((()=>{var e;return null==(e=this._elTriggerBtn)?void 0:e.focus()}),0)),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}))},Fl=new WeakSet,Bl=function(){this.addEventListener("blur",rt(this,Zl)),this.addEventListener("gds-blur",rt(this,Zl)),this.addEventListener("keydown",rt(this,Gl))},Il=new WeakSet,Ul=function(){this.removeEventListener("blur",rt(this,Zl)),this.removeEventListener("gds-blur",rt(this,Zl)),this.removeEventListener("keydown",rt(this,Gl))},Zl=new WeakMap,Gl=new WeakMap,ql.styles=[Yt,Yl],ql.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Ve()],ql.prototype,"label",2),et([Ve({type:Boolean,reflect:!0})],ql.prototype,"open",2),et([Ve({type:Boolean,reflect:!0})],ql.prototype,"searchable",2),et([Ve({type:Boolean,reflect:!0})],ql.prototype,"multiple",2),et([Ve()],ql.prototype,"compareWith",2),et([Ve()],ql.prototype,"searchFilter",2),et([Ve({type:Boolean,attribute:"sync-popover-width"})],ql.prototype,"syncPopoverWidth",2),et([Ve({type:Number,attribute:"max-height"})],ql.prototype,"maxHeight",2),et([Ve()],ql.prototype,"size",2),et([Ve({type:Boolean,attribute:"hide-label"})],ql.prototype,"hideLabel",2),et([Ve()],ql.prototype,"disableMobileStyles",2),et([Ne("#trigger")],ql.prototype,"_elTriggerBtn",2),et([Fe("#listbox")],ql.prototype,"_elListbox",2),et([Ne("#searchinput")],ql.prototype,"_elSearchInput",2),et([vn({attributes:!0,childList:!0,subtree:!0,characterData:!0})],ql.prototype,"_handleLightDOMChange",1),et([yn("value")],ql.prototype,"_handleValueChange",1),et([yn("open")],ql.prototype,"_onOpenChange",1),ql=et([lt("gds-dropdown")],ql);var Kl,Xl,Jl,Ql,ed,td=me`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`,Nd=class extends qt{constructor(){super(...arguments),nt(this,Od),nt(this,Vd),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=e=>e.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(e){const t=function(e){Za(1,arguments);var t=Ga(e),r=t.getMonth();return t.setFullYear(t.getFullYear(),r+1,0),t.setHours(0,0,0,0),t}(new Date(this.focusedYear,e,1)),r=new Date(this.focusedDate);r.setDate(Math.min(this.focusedDate.getDate(),t.getDate())),r.setMonth(e),r.setHours(12,0,0,0),this.focusedDate=r}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(this.focusedDate.setFullYear(e))}getDateCell(e){var t;return null==(t=this.shadowRoot)?void 0:t.querySelector(`#dateCell-${e}`)}connectedCallback(){super.connectedCallback(),dr.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",st(this,Vd,Wd)),window.addEventListener("lit-localize-status",(e=>{"ready"===e.detail.status&&(this._currentLocale=e.detail.readyLocale)}))}focus(){var e;super.focus(),null==(e=this._elFocusedCell)||e.focus()}render(){const e=new Date;return ee`<table role="grid" aria-label="${xs(this.label)}">
                ...
                <tr role="row">
                  ...
                  ${t.days.map((t=>{const r=this.customizedDates&&this.customizedDates.find((e=>qa(e.date,t))),o=Je({color:"currentColor",disabled:Boolean(this.disabledDates&&this.disabledDates.some((e=>qa(e,t))))},r),s=!function(e,t){Za(2,arguments);var r=Ga(e),o=Ga(t);return r.getFullYear()===o.getFullYear()&&r.getMonth()===o.getMonth()}(this.focusedDate,t),i=(t<this.min||t>this.max)&&!qa(t,this.min)&&!qa(t,this.max),a=0===t.getDay()||6===t.getDay(),l=o.disabled||s||i||this.disabledWeekends&&a;return this.hideExtraneousDays&&s?ee`<td inert></td>`:ee`
                          <td
                            ...
                            @click=${()=>l?null:st(this,Od,Pd).call(this,t)}
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=this.value)}};Od=new WeakSet,Pd=function(e){const t=function(e,t){Za(2,arguments);var r=Ga(e),o=$d(t);return r.setHours(o),r}(e,12);this.value=t,this.dispatchEvent(new CustomEvent("change",{detail:t,bubbles:!1,composed:!1}))},Vd=new WeakSet,Wd=function(e){var t;let r=!1,o=new Date(this.focusedDate);if("ArrowLeft"===e.key?(o=Sd(this.focusedDate,-1),r=!0):"ArrowRight"===e.key?(o=Sd(this.focusedDate,1),r=!0):"ArrowUp"===e.key?(o=Sd(this.focusedDate,-7),r=!0):"ArrowDown"===e.key?(o=Sd(this.focusedDate,7),r=!0):"Enter"===e.key||" "===e.key?((null==(t=this._elFocusedCell)?void 0:t.hasAttribute("disabled"))||st(this,Od,Pd).call(this,this.focusedDate),r=!0):"Home"===e.key?(o=new Date(this.focusedYear,this.focusedMonth,1),r=!0):"End"===e.key?(o=new Date(this.focusedYear,this.focusedMonth+1,0),r=!0):"PageUp"===e.key?(o=function(e,t){return Za(2,arguments),Dd(e,-$d(t))}(this.focusedDate,1),r=!0):"PageDown"===e.key&&(o=Dd(this.focusedDate,1),r=!0),o.getFullYear()>=this.min.getFullYear()&&o.getFullYear()<=this.max.getFullYear()){this.dispatchEvent(new CustomEvent("gds-date-focused",{detail:o,bubbles:!1,composed:!1,cancelable:!0}))&&(this.focusedDate=o)}r&&(e.preventDefault(),e.stopPropagation(),this.updateComplete.then((()=>{var e;null==(e=this._elFocusedCell)||e.focus()})))},Nd.styles=[Yt,Hd],Nd.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Ve()],Nd.prototype,"value",2),et([Ve({type:Date})],Nd.prototype,"min",2),et([Ve({type:Date})],Nd.prototype,"max",2),et([Ve()],Nd.prototype,"focusedDate",2),et([Ve({type:Boolean,attribute:"disabled-weekends"})],Nd.prototype,"disabledWeekends",2),et([Ve({type:Array,attribute:"disabled-dates"})],Nd.prototype,"disabledDates",2),et([Ve({type:Number})],Nd.prototype,"focusedMonth",1),et([Ve({type:Number})],Nd.prototype,"focusedYear",1),et([Ve({type:Boolean})],Nd.prototype,"showWeekNumbers",2),et([Ve({type:Boolean})],Nd.prototype,"hideExtraneousDays",2),et([Ve({type:Boolean})],Nd.prototype,"hideDayNames",2),et([Ve({attribute:!1})],Nd.prototype,"customizedDates",2),et([Ve()],Nd.prototype,"label",2),et([Ve({attribute:!1})],Nd.prototype,"dateLabelTemplate",2),et([We()],Nd.prototype,"_currentLocale",2),et([Ne('td[tabindex="0"]')],Nd.prototype,"_elFocusedCell",2),et([yn("value")],Nd.prototype,"_valueChanged",1),Nd=et([lt("gds-calendar"),yr()],Nd);var Rd=class extends qt{connectedCallback(){super.connectedCallback(),this.form=this.closest("form")||void 0,this.form&&(this.formObserver=new MutationObserver((()=>{this.requestUpdate()})),this.formObserver.observe(this.form,{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.formObserver)||e.disconnect()}render(){var e;const t=Array.from((null==(e=this.form)?void 0:e.elements)||[]).filter((e=>e.invalid));return ws(t.length>0,(()=>ut`<gds-card level="3" border="4xs/negative" border-radius="2xs" padding="m" color="error-text">
...
`,cc=class extends js{connectedCallback(){super.connectedCallback(),this._dynamicStylesController.inject("FAB_styles",dc)}};let hc,uc,pc,gc,fc,bc,mc,vc,yc,xc,wc,kc,_c,Cc,$c,Sc,Ec,Ac,Tc,Mc;function zc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:jc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||jc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Lc(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Lc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function jc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}et([Dt({valueTemplate:e=>e,selector:'[part="_button"]'})],cc.prototype,"position",2),et([Dt({valueTemplate:e=>e})],cc.prototype,"transform",2),et([Dt({valueTemplate:e=>e,selector:'[part="_button"]'})],cc.prototype,"inset",2),cc=et([lt("gds-fab")],cc),uc=[De("form-validation")];class FormValidationExample extends lit_element_r{static#e=(()=>[pc,hc]=zc(this,[],uc,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`<gds-card border="4xs/base300" padding="m" border-radius="s">
      <form>
        <gds-input
          required
          label="Name"
    ...
    </gds-card>`}static#t=(()=>hc())()}function Dc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Pc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Pc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Oc(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Oc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Pc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}bc=[De("datepicker-example")];class CalendarExample extends lit_element_r{static#e=(()=>({e:[vc,xc,gc],c:[wc,fc]}=Dc(this,[[mc,1,"disabledWeekends"],[yc,1,"showWeekNumbers"]],bc,0,void 0,lit_element_r)))();[(mc=We(),yc=We(),"createRenderRoot")](){return this}connectedCallback(){super.connectedCallback()}#r=(()=>(gc(this),vc(this,!1)))();get disabledWeekends(){return this.#r}set disabledWeekends(e){this.#r=e}#n=(()=>xc(this,!1))();get showWeekNumbers(){return this.#n}set showWeekNumbers(e){this.#n=e}render(){return ut` <div style="width:320px; margin: 8rem auto;">
    ...
    </div>`}static#t=(()=>_c())()}function Ic(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Zc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Zc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Uc(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Uc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Zc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}let Gc,Yc,qc,Kc;Bc=[De("gds-login")];class CardExample extends lit_element_r{static#e=(()=>[Gc,Fc]=Ic(this,[],Bc,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`
    ...
    `}static#t=(()=>Fc())()}function Xc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Qc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Qc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Jc(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Jc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Qc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}qc=[De("gds-onboarding")];class onboarding_onboarding_element_CardExample extends lit_element_r{static#e=(()=>[Kc,Yc]=Xc(this,[],qc,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut` <gds-flex gap="lg">
...
`,th=class extends qt{constructor(){super(...arguments),this.level="2"}render(){return ut`<hr />`}};th.styles=[Yt,eh],et([Ve()],th.prototype,"level",2),et([Dt({valueTemplate:function(e){const[t,r]=e.split("/");return((e,t)=>(e=>{const t=e.trim();return t.startsWith("#")||t.startsWith("rgb(")||t.startsWith("rgba(")||t.startsWith("hsl(")||t.startsWith("hsla(")})(e)?t?`color-mix(in srgb, ${e} ${100*parseFloat(t)}%, transparent 0%)`:e:`var(--gds-color-l${this.level}-border-${e})`)(t,r)}})],th.prototype,"color",2),et([Dt({property:"--_size",valueTemplate:e=>`var(--gds-space-${e})`})],th.prototype,"size",2),et([Dt({property:"opacity",valueTemplate:e=>e})],th.prototype,"opacity",2),th=et([lt("gds-divider")],th);var rh=class extends ss{};rh._regularSVG='<path d="M7.75 20.75L3.75 16.75L7.75 12.75M16.25 11.25L20.25 7.25L16.25 3.25M5 16.75H20.25M3.75 7.25H19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',rh._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.7197 2.71967C16.0126 2.42678 16.4874 2.42678 16.7803 2.71967L20.7803 6.71967C21.0732 7.01256 21.0732 7.48744 20.7803 7.78033L16.7803 11.7803C16.4874 12.0732 16.0126 12.0732 15.7197 11.7803C15.4268 11.4874 15.4268 11.0126 15.7197 10.7197L18.4393 8H3.75C3.33579 8 3 7.66421 3 7.25C3 6.83579 3.33579 6.5 3.75 6.5H18.4393L15.7197 3.78033C15.4268 3.48744 15.4268 3.01256 15.7197 2.71967ZM8.28033 12.2197C8.57322 12.5126 8.57322 12.9874 8.28033 13.2803L5.56066 16H20.25C20.6642 16 21 16.3358 21 16.75C21 17.1642 20.6642 17.5 20.25 17.5H5.56066L8.28033 20.2197C8.57322 20.5126 8.57322 20.9874 8.28033 21.2803C7.98744 21.5732 7.51256 21.5732 7.21967 21.2803L3.21967 17.2803C2.92678 16.9874 2.92678 16.5126 3.21967 16.2197L7.21967 12.2197C7.51256 11.9268 7.98744 11.9268 8.28033 12.2197Z" fill="currentColor"/>',rh._name="arrow-left-right",rh=et([lt("gds-icon-arrow-left-right")],rh);var nh=class extends ss{};nh._regularSVG='<path d="M12 3.75V12M12 12V20.25M12 12H3.75M12 12H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',nh._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C12.4142 3 12.75 3.33579 12.75 3.75V11.25H20.25C20.6642 11.25 21 11.5858 21 12C21 12.4142 20.6642 12.75 20.25 12.75H12.75V20.25C12.75 20.6642 12.4142 21 12 21C11.5858 21 11.25 20.6642 11.25 20.25V12.75H3.75C3.33579 12.75 3 12.4142 3 12C3 11.5858 3.33579 11.25 3.75 11.25H11.25V3.75C11.25 3.33579 11.5858 3 12 3Z" fill="currentColor"/>',nh._name="plus-large",nh=et([lt("gds-icon-plus-large")],nh);var oh=class extends ss{};oh._regularSVG='<path d="M20.7125 11.5768L22.25 7.25L15.075 3.75C14.0732 7.01444 9.92685 7.01444 8.925 3.75L1.75 7.25L3.2875 11.5768L5.75 10.45V20.25H18.25V10.45L20.7125 11.5768Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="round"/>',oh._solidSVG='<path d="M9.642 3.52996C9.57767 3.32033 9.42482 3.14936 9.22368 3.06204C9.02254 2.97471 8.79327 2.97979 8.59619 3.07592L1.42119 6.57592C1.07817 6.74325 0.915507 7.1415 1.0433 7.50112L2.5808 10.8279C2.65123 11.0261 2.80164 11.1856 2.99536 11.2676C3.18908 11.3495 3.40831 11.3463 3.59957 11.2588L5.00001 10.618V20.25C5.00001 20.6642 5.33579 21 5.75001 21H18.25C18.6642 21 19 20.6642 19 20.25V10.618L20.4004 11.2588C20.5917 11.3463 20.8109 11.3495 21.0047 11.2676C21.1984 11.1856 21.3488 11.0261 21.4192 10.8279L22.9567 7.50112C23.0845 7.1415 22.9218 6.74325 22.5788 6.57592L15.4038 3.07592C15.2067 2.97979 14.9775 2.97471 14.7763 3.06204C14.5752 3.14936 14.4223 3.32033 14.358 3.52996C13.9516 4.85432 12.9502 5.44833 12 5.44833C11.0498 5.44833 10.0484 4.85432 9.642 3.52996Z" fill="currentColor"/>',oh._name="fashion",oh=et([lt("gds-icon-fashion")],oh);var sh=class extends ss{};sh._regularSVG='<path d="M7.75 6.75H2.75V20.25H21.25V6.75H16.25M7.75 6.75V2.75H16.25V6.75M7.75 6.75H16.25" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>',sh._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M7 2.75C7 2.33579 7.33579 2 7.75 2H16.25C16.6642 2 17 2.33579 17 2.75V6H21.25C21.6642 6 22 6.33579 22 6.75V20.25C22 20.6642 21.6642 21 21.25 21H2.75C2.33579 21 2 20.6642 2 20.25V6.75C2 6.33579 2.33579 6 2.75 6H7V2.75ZM8.5 6H15.5V3.5H8.5V6Z" fill="currentColor"/>',sh._name="suitcase-work",sh=et([lt("gds-icon-suitcase-work")],sh);var ih=class extends ss{};ih._regularSVG='<path d="M20.25 12V20.25H3.75002V12M9.50002 3.75H14.5001M9.50002 3.75L8.90899 8.77398C8.69131 10.6243 10.137 12.25 12.0001 12.25C13.8631 12.25 15.3088 10.6243 15.0911 8.77397L14.5001 3.75M9.50002 3.75H4.41668L2.97236 8.35377C2.36638 10.2853 3.8091 12.25 5.83349 12.25C7.35405 12.25 8.63391 11.1119 8.81158 9.60174L9.50002 3.75ZM14.5001 3.75H19.5833L21.0277 8.35377C21.6337 10.2853 20.1909 12.25 18.1665 12.25C16.646 12.25 15.3661 11.1119 15.1885 9.60174L14.5001 3.75Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',ih._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3.70108 3.52549C3.79918 3.21279 4.08896 3 4.41669 3H19.5834C19.9111 3 20.2009 3.21279 20.299 3.52549L21.7433 8.12926C22.1626 9.4657 21.7973 10.8148 20.9585 11.7532C20.9854 11.8305 21 11.9135 21 12V20.25C21 20.6642 20.6642 21 20.25 21H3.75002C3.33581 21 3.00002 20.6642 3.00002 20.25V12C3.00002 11.9135 3.01466 11.8305 3.04158 11.7532C2.20273 10.8148 1.83749 9.4657 2.25676 8.12926L3.70108 3.52549ZM10.167 4.5L9.65386 8.86161C9.48864 10.266 10.586 11.5 12.0001 11.5C13.4097 11.5 14.5046 10.2738 14.3478 8.87488L13.8331 4.5H10.167ZM15.8379 8.70317C15.8373 8.69756 15.8366 8.69195 15.836 8.68634L15.3435 4.5H19.0326L20.3121 8.57827C20.7665 10.0267 19.6846 11.5 18.1665 11.5C17.0263 11.5 16.0666 10.6465 15.9333 9.51411L15.8379 8.70317ZM8.65662 4.5L8.06672 9.51411C7.93349 10.6465 6.97374 11.5 5.8335 11.5C4.31543 11.5 3.23356 10.0267 3.68798 8.57827L4.96744 4.5H8.65662Z" fill="currentColor"/>',ih._name="store",ih=et([lt("gds-icon-store")],ih);var ah=class extends ss{};ah._regularSVG='<path d="M3.75 3.75V9C3.75 10.7949 5.20507 12.25 7 12.25C8.79493 12.25 10.25 10.7949 10.25 9V3.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="square"/><path d="M7 12.25V20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="square"/><path d="M17 12.5V20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="square"/><path d="M20.5 8.00758C20.5 10.4238 18.933 12.25 17 12.25C15.067 12.25 13.5 10.4238 13.5 8.00758C13.5 5.59133 15.067 3.5 17 3.5C18.933 3.5 20.5 5.59133 20.5 8.00758Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 3.75V9.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="square"/>',ah._solidSVG='<path d="M17 2.75C15.7463 2.75 14.669 3.42888 13.9303 4.39093C13.1911 5.35359 12.75 6.64303 12.75 8.00758C12.75 10.4237 14.1789 12.5161 16.25 12.927V21H17.75V12.927C19.8211 12.5161 21.25 10.4237 21.25 8.00758C21.25 6.64303 20.8089 5.35359 20.0697 4.39093C19.331 3.42888 18.2537 2.75 17 2.75Z" fill="currentColor"/><path d="M4.5 3H3V9C3 10.9528 4.39935 12.5787 6.25 12.9298V21H7.75V12.9298C9.60065 12.5787 11 10.9528 11 9V3H9.5V9C9.5 10.3807 8.38071 11.5 7 11.5C5.61929 11.5 4.5 10.3807 4.5 9V3Z" fill="currentColor"/><path d="M7.75 3H6.25V10H7.75V3Z" fill="currentColor"/>',ah._name="knife-spoon",ah=et([lt("gds-icon-knife-spoon")],ah);var lh=class extends ss{};lh._regularSVG='<path d="M12 3.75V15M12 3.75L16.5 8.25M12 3.75L7.5 8.25M20.25 12.75V20.25H3.75V12.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',lh._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C12.1989 3 12.3897 3.07902 12.5303 3.21967L17.0303 7.71967C17.3232 8.01256 17.3232 8.48744 17.0303 8.78033C16.7374 9.07322 16.2626 9.07322 15.9697 8.78033L12.75 5.56066V15C12.75 15.4142 12.4142 15.75 12 15.75C11.5858 15.75 11.25 15.4142 11.25 15V5.56066L8.03033 8.78033C7.73744 9.07322 7.26256 9.07322 6.96967 8.78033C6.67678 8.48744 6.67678 8.01256 6.96967 7.71967L11.4697 3.21967C11.6103 3.07902 11.8011 3 12 3Z" fill="currentColor"/><path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 12C4.16421 12 4.5 12.3358 4.5 12.75V19.5H19.5V12.75C19.5 12.3358 19.8358 12 20.25 12C20.6642 12 21 12.3358 21 12.75V20.25C21 20.6642 20.6642 21 20.25 21H3.75C3.33579 21 3 20.6642 3 20.25V12.75C3 12.3358 3.33579 12 3.75 12Z" fill="currentColor"/>',lh._name="arrow-out-of-box",lh=et([lt("gds-icon-arrow-out-of-box")],lh);var dh=class extends ss{};let ch,hh,uh,ph,gh,fh,bh,mh,vh,yh,xh,wh,kh,_h,Ch;function $h(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Eh((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Eh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Sh(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Sh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Eh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}dh._regularSVG='<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" fill="currentColor"/><path d="M20.25 13C20.8023 13 21.25 12.5523 21.25 12C21.25 11.4477 20.8023 11 20.25 11C19.6977 11 19.25 11.4477 19.25 12C19.25 12.5523 19.6977 13 20.25 13Z" fill="currentColor"/><path d="M3.75 13C4.30228 13 4.75 12.5523 4.75 12C4.75 11.4477 4.30228 11 3.75 11C3.19772 11 2.75 11.4477 2.75 12C2.75 12.5523 3.19772 13 3.75 13Z" fill="currentColor"/><path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.25 13C20.8023 13 21.25 12.5523 21.25 12C21.25 11.4477 20.8023 11 20.25 11C19.6977 11 19.25 11.4477 19.25 12C19.25 12.5523 19.6977 13 20.25 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 13C4.30228 13 4.75 12.5523 4.75 12C4.75 11.4477 4.30228 11 3.75 11C3.19772 11 2.75 11.4477 2.75 12C2.75 12.5523 3.19772 13 3.75 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',dh._solidSVG='<path d="M3.75 10.25C2.7835 10.25 2 11.0335 2 12C2 12.9665 2.7835 13.75 3.75 13.75C4.7165 13.75 5.5 12.9665 5.5 12C5.5 11.0335 4.7165 10.25 3.75 10.25Z" fill="currentColor"/><path d="M12 10.25C11.0335 10.25 10.25 11.0335 10.25 12C10.25 12.9665 11.0335 13.75 12 13.75C12.9665 13.75 13.75 12.9665 13.75 12C13.75 11.0335 12.9665 10.25 12 10.25Z" fill="currentColor"/><path d="M20.25 10.25C19.2835 10.25 18.5 11.0335 18.5 12C18.5 12.9665 19.2835 13.75 20.25 13.75C21.2165 13.75 22 12.9665 22 12C22 11.0335 21.2165 10.25 20.25 10.25Z" fill="currentColor"/>',dh._name="dot-grid-one-horizontal",dh=et([lt("gds-icon-dot-grid-one-horizontal")],dh),hh=[De("gds-jit")];class GdsJit extends lit_element_r{static#e=(()=>[uh,ch]=$h(this,[],hh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-card variant="tertiary" padding="l"
        ><gds-flex
          ...
          ></gds-card> </gds-flex
      ></gds-card>
    `}static#t=(()=>ch())()}function Ah(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Mh((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Mh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Th(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Th(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Mh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}gh=[De("gds-accounts")];class GdsAccounts extends lit_element_r{static#e=(()=>[fh,ph]=Ah(this,[],gh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-card>
    ...
    `}static#t=(()=>ph())()}function zh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:jh((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||jh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Lh(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Lh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function jh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}mh=[De("tp-card")];class TPCard extends lit_element_r{static#e=(()=>[vh,bh]=zh(this,[],mh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
    ...
    `}static#t=(()=>bh())()}function Dh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Ph((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Ph(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Oh(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Oh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Ph(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}xh=[De("tp-list-item")];class common_list_item_TPCard extends lit_element_r{static#e=(()=>[wh,yh]=Dh(this,[],xh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-flex gap="s">
        <gds-flex>
          <slot name="icon"></slot>
        </gds-flex>
    ...
    `}static#t=(()=>yh())()}function Vh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Hh((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Hh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:Wh(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Wh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Hh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}_h=[De("gds-dashboard")];class dashboard_dashboard_element_CardExample extends lit_element_r{static#e=(()=>[Ch,kh]=Vh(this,[],_h,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`
...
`,Rh=class extends qt{querySelectorAll(e){return this.shadowRoot?this.shadowRoot.querySelectorAll(e):new NodeList}querySelector(e){return this.shadowRoot?this.shadowRoot.querySelector(e):null}get innerHTML(){var e;return(null==(e=this.shadowRoot)?void 0:e.innerHTML)||""}set innerHTML(e){this.shadowRoot&&(this.shadowRoot.innerHTML=e)}connectedCallback(){super.connectedCallback(),this._captureDOM()}_captureDOM(){this.shadowRoot&&0!==this.childNodes.length&&this.shadowRoot.replaceChildren(...Array.from(this.childNodes))}};let Fh,Bh,Ih,Uh,Zh,Gh,Yh,qh,Kh,Xh,Jh,Qh,eu,tu,ru,nu;function ou(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:iu((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||iu(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:su(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function su(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function iu(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}Rh.styles=[Yt,pt,Nh],et([vn()],Rh.prototype,"_captureDOM",1),Rh=et([lt("gds-rich-text")],Rh),Bh=[De("tp-page-header")];class PageHeader extends lit_element_r{static#e=(()=>[Ih,Fh]=ou(this,[],Bh,0,void 0,lit_element_r).c)();createRenderRoot(){return this}render(){return ut`
    ...
    `}static#t=(()=>Fh())()}function au(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:du((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||du(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:lu(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function lu(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function du(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}Gh=[De("tp-theme-page")];class ThemePage extends lit_element_r{static#e=(()=>({e:[qh,Xh,Uh],c:[Jh,Zh]}=au(this,[[Yh,1,"hasAccounts"],[Kh,1,"hasSavings"]],Gh,0,void 0,lit_element_r)))();[(Yh=Ve({type:Boolean}),Kh=Ve({type:Boolean}),"createRenderRoot")](){return this}#r=(()=>(Uh(this),qh(this,!0)))();get hasAccounts(){return this.#r}set hasAccounts(e){this.#r=e}#n=(()=>Xh(this,!0))();get hasSavings(){return this.#n}set hasSavings(e){this.#n=e}connectedCallback(){super.connectedCallback()}render(){return ut`
    ...
    `}static#t=(()=>Zh())()}function cu(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function m(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var v,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:uu((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||uu(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(v=d(A.call(T,S,D),"class decorators","return"))&&(S=v);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return m(e),_.value}:(s<4&&(O=a(_,"get",m)),3!==s&&(P=a(_,"set",m))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var V=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(V.get=O),P&&(V.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(v=d(S.get,"accessor.get"))&&(_.get=v),(v=d(S.set,"accessor.set"))&&(_.set=v),(v=d(S.init,"accessor.init"))&&C.push(v);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],m=g[2],v=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=m+"/"+x;if(!w&&!v){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,v?"#"+m:hu(m),f,o,x?i=i||[]:s=s||[],a,x,v,w,1===f,x&&v?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function hu(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function uu(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}class AppElement extends lit_element_r{static#e=(()=>[tu,nu,Qh]=cu(this,[[eu,1,"popoverOpen"],[ru,1,"currentView"]],[],0,void 0,lit_element_r).e)();static[(eu=Ve(),ru=We(),"styles")]=(()=>me`
    :host {
      --gds-test-color: red;
    }
  `)();createRenderRoot(){return this}#r=(()=>(Qh(this),tu(this,!1)))();get popoverOpen(){return this.#r}set popoverOpen(e){this.#r=e}#n=(()=>nu(this,"dashboard"))();get currentView(){return this.#n}set currentView(e){this.#n=e}connectedCallback(){super.connectedCallback(),this.addEventListener("view-change",this.handleViewChange),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){this.removeEventListener("view-change",this.handleViewChange),document.removeEventListener("keydown",this.handleKeyDown),super.disconnectedCallback()}handleViewChange(e){this.currentView=e.detail.view}handleKeyDown=e=>{if("\\"===e.key){const e=this.querySelector("html");if(e){const t=e.getAttribute("gds-theme");e.setAttribute("color-scheme","light"===t?"dark":"light")}}};render(){return ut`
