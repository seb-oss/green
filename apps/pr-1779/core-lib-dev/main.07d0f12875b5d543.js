...
`,ei=class extends vs{constructor(){super(),rt(this,zs),rt(this,Fs),rt(this,Hs),rt(this,Bs),rt(this,Us),rt(this,Gs),rt(this,qs),rt(this,Xs),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",this.trailSlotOccupied=!1,rt(this,Os,(e=>["type","placeholder","required"].includes(e.name))),rt(this,Ps,(e=>{const t=e.target;this.value=t.value})),rt(this,js,(e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})),rt(this,Vs,(()=>{this.elInputAsync.then((e=>e.focus()))})),rt(this,Ns,(()=>{this.value=""}))}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return ut`${Be(this.variant,[["default",()=>st(this,zs,Ls).call(this)],["floating-label",()=>st(this,Fs,Ws).call(this)]])}`}_getValidityAnchor(){return this.elInput}};zs=new WeakSet,Ls=function(){return ut`
      ...
      >
        ${st(this,Hs,Rs).call(this)} ${st(this,Gs,Ys).call(this)}
      ...
      ></gds-form-control-footer>
    `},Fs=new WeakSet,Ws=function(){return oe},Os=new WeakMap,Ps=new WeakMap,js=new WeakMap,Vs=new WeakMap,Ns=new WeakMap,Hs=new WeakSet,Rs=function(){return ut` <slot name="lead"></slot> `},Bs=new WeakSet,Is=function(){return ut`
    ...
    `},qs=new WeakSet,Ks=function(){return this.clearable&&this.value.length>0?ut`
      ...
      `:oe},Xs=new WeakSet,Js=function(){return this.maxlength<Number.MAX_SAFE_INTEGER},ei.styles=[Yt,Qs],et([Pe()],ei.prototype,"value",2),et([Pe()],ei.prototype,"label",2),et([Pe({attribute:"supporting-text"})],ei.prototype,"supportingText",2),et([Pe({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],ei.prototype,"showExtendedSupportingText",2),et([Pe({attribute:"disabled",type:Boolean,reflect:!0})],ei.prototype,"disabled",2),et([Pe({type:Boolean})],ei.prototype,"clearable",2),et([Pe({type:Number})],ei.prototype,"maxlength",2),et([Pe({type:String})],ei.prototype,"variant",2),et([Pe({type:String})],ei.prototype,"size",2),et([Re("input")],ei.prototype,"elInputAsync",2),et([Ne("input")],ei.prototype,"elInput",2),et([je()],ei.prototype,"trailSlotOccupied",2),ei=et([lt("gds-input"),mn()],ei);var ti,ni,ri,oi,si,ii,ai=ve`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`,li=class extends qt{constructor(){super(...arguments),rt(this,ti),rt(this,si),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,rt(this,ri,(()=>ut`
    ...
    `)),rt(this,oi,(()=>{var e;this.showExtendedSupportingText=!this.showExtendedSupportingText,null==(e=this._extendedSupportingText)||e.style.setProperty("--_max-height",this.showExtendedSupportingText?`${this._extendedSupportingText.scrollHeight}px`:"0"),this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))}))}render(){return ut`
      <div id="label-row">
        ...
        ${ys(this._hasExtendedSupportingText,nt(this,ri))}
      </div>
    ...
    `},li.styles=[ai],et([Pe({type:Boolean,reflect:!0})],li.prototype,"showExtendedSupportingText",2),et([je()],li.prototype,"_hasExtendedSupportingText",2),et([Ne("#extended-supporting-text")],li.prototype,"_extendedSupportingText",2),li=et([lt("gds-form-control-header"),mn()],li);var ci,di,hi=ve`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`,ui=class extends qt{constructor(){super(...arguments),rt(this,ci)}render(){return ut`<div aria-live="polite">
      ...
      <div class="char-counter">
        ${ys(Number.isInteger(this.charCounter),(()=>st(this,ci,di).call(this,this.charCounter)))}
      </div>
...
`,mi=class extends bi{connectedCallback(){super.connectedCallback(),this.display="flex"}render(){return ut`<slot></slot>`}};mi.styles=[Yt,vi],et([Ft({styleTemplate:(e,t)=>{const r=t[0];return`gap: ${r} ${t[1]||r};`},cacheOverrideKey:"flex"})],mi.prototype,"gap",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"flex",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"align-self",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"align-items",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"align-content",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"justify-content",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"place-content",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"justify-items",2),et([Ft({valueTemplate:e=>e})],mi.prototype,"justify-self",2),et([Ft({property:"flex-direction",valueTemplate:e=>e})],mi.prototype,"flex-direction",2),et([Ft({property:"flex-wrap",valueTemplate:e=>e})],mi.prototype,"flex-wrap",2),mi=et([lt("gds-flex")],mi);var yi=class extends bi{constructor(){super(),this.variant="primary",this.padding="s; m{l}",this["border-radius"]="xs; m{s}",this["border-width"]="4xs"}render(){return ut`<slot></slot>`}};yi.styles=[Yt,ve`
      :host {
        border-color: var(--_border-color);
        background-color: var(--_background-color);
        color: var(--_color);
      }
    `],et([Ft({property:"box-shadow",valueTemplate:e=>`var(--gds-shadow-${e})`})],yi.prototype,"shadow",2),et([Ft({valueTemplate:e=>e,styleTemplate:function(e,t){return`\n      --_border-color: var(--gds-color-l${this.level}-background-${t});\n      --_background-color: var(--gds-color-l${this.level}-background-${t});\n      --_color: var(--gds-color-l${this.level}-content-${t});\n      `}})],yi.prototype,"variant",2),yi=et([lt("gds-card")],yi);var wi,xi,ki,_i,Ci,$i,Ei,Si,Ai=ve`
  :host {
    display: inline-block;
  }
...
`,Ti=class extends qt{constructor(){super(),rt(this,wi),rt(this,ki),rt(this,Ci),rt(this,Ei),this.variant="information",this.size="default",this.disabled=!1,this.notification=!1,this.mainSlotOccupied=!1}render(){const e=this.disabled?"disabled":this.notification?this.variant:this.variant+"-badge",t=this.disabled?"disabled":this.notification?"primary":this.variant,r="small"===this.size||this.notification?"2xs":"xs",o=this.mainSlotOccupied?"small"===this.size||this.notification?"m":"l":"xs";return ut`<gds-flex
  ...
  `,et([Pe({reflect:!0,attribute:"color-scheme"})],Di.prototype,"colorScheme",2),et([Pe({reflect:!0,attribute:"design-version"})],Di.prototype,"designVersion",2),et([vr("colorScheme")],Di.prototype,"_onColorSchemeChange",1),et([vr("designVersion")],Di.prototype,"_onDesignVersionChange",1),Di=et([lt("gds-theme")],Di);var zi=ve`
  :host {
    --_c: 12;
...
`,va=class extends mi{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return tn`<div part="mask"></div>
    ...
    </gds-theme>`}static#t=(()=>ya())()}var Ea={fromAttribute:e=>new Date(e),toAttribute:e=>e.toISOString()},Sa={fromAttribute:e=>e.split(",").map((e=>new Date(e.trim()))),toAttribute:e=>JSON.stringify(e.map((e=>e.toISOString())))};const Aa=(e,t,r)=>{const o=new Map;for(let s=t;s<=r;s++)o.set(e[s],s);return o},Ta=Vn(class extends directive_i{constructor(e){if(super(e),e.type!==Pn)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let o;void 0===r?r=t:void 0!==t&&(o=t);const s=[],i=[];let a=0;for(const l of e)s[a]=o?o(l,a):a,i[a]=r(l,a),a++;return{values:i,keys:s}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,o]){const s=(e=>e._$AH)(e),{values:i,keys:a}=this.dt(t,r,o);if(!Array.isArray(s))return this.ut=a,i;const l=this.ut??=[],c=[];let d,h,u=0,p=s.length-1,g=0,f=i.length-1;for(;u<=p&&g<=f;)if(null===s[u])u++;else if(null===s[p])p--;else if(l[u]===a[g])c[g]=Xn(s[u],i[g]),u++,g++;else if(l[p]===a[f])c[f]=Xn(s[p],i[f]),p--,f--;else if(l[u]===a[f])c[f]=Xn(s[u],i[f]),Kn(e,c[f+1],s[u]),u++,f--;else if(l[p]===a[g])c[g]=Xn(s[p],i[g]),Kn(e,s[u],s[p]),p--,g++;else if(void 0===d&&(d=Aa(a,g,f),h=Aa(l,u,p)),d.has(l[u]))if(d.has(l[p])){const t=h.get(a[g]),r=void 0!==t?s[t]:null;if(null===r){const t=Kn(e,s[u]);Xn(t,i[g]),c[g]=t}else c[g]=Xn(r,i[g]),Kn(e,s[u],r),s[t]=null;g++}else Qn(s[p]),p--;else Qn(s[u]),u++;for(;g<=f;){const t=Kn(e,c[f+1]);Xn(t,i[g]),c[g++]=t}for(;u<=p;){const e=s[u++];null!==e&&Qn(e)}return this.ut=a,((e,t=Jn)=>{e._$AH=t})(e,c),re}});class private_async_helpers_s{constructor(e){this.Y=e}disconnect(){this.Y=void 0}reconnect(e){this.Y=e}deref(){return this.Y}}class private_async_helpers_i{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){this.Z??=new Promise((e=>this.q=e))}resume(){this.q?.(),this.Z=this.q=void 0}}const Ma=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,Da=1073741823;const za=Vn(class until_c extends async_directive_f{constructor(){super(...arguments),this._$Cwt=Da,this._$Cbt=[],this._$CK=new private_async_helpers_s(this),this._$CX=new private_async_helpers_i}render(...e){return e.find((e=>!Ma(e)))??re}update(e,t){const r=this._$Cbt;let o=r.length;this._$Cbt=t;const s=this._$CK,i=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<t.length&&!(a>this._$Cwt);a++){const e=t[a];if(!Ma(e))return this._$Cwt=a,e;a<o&&e===r[a]||(this._$Cwt=Da,o=0,Promise.resolve(e).then((async t=>{for(;i.get();)await i.get();const r=s.deref();if(void 0!==r){const o=r._$Cbt.indexOf(e);o>-1&&o<r._$Cwt&&(r._$Cwt=o,r.setValue(t))}})))}return re}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});function La(e){return La="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},La(e)}function Fa(e,t){if(t.length<e)throw new TypeError(e+" argument"+(e>1?"s":"")+" required, but only "+t.length+" present")}function Wa(e){Fa(1,arguments);var t=Object.prototype.toString.call(e);return e instanceof Date||"object"===La(e)&&"[object Date]"===t?new Date(e.getTime()):"number"==typeof e||"[object Number]"===t?new Date(e):("string"!=typeof e&&"[object String]"!==t||"undefined"==typeof console||(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn((new Error).stack)),new Date(NaN))}function Oa(e){Fa(1,arguments);var t=Wa(e);return t.setHours(0,0,0,0),t}function Pa(e,t){Fa(2,arguments);var r=Oa(e),o=Oa(t);return r.getTime()===o.getTime()}var ja,Va,Na,Ha,Ra,Ba,Ia,Ua,Za,Ga,Ya,qa,Ka,Xa,Ja,Qa,el,tl,nl,rl,ol,sl,il,al,ll,cl,dl,hl,ul,pl,gl,fl,bl,vl,ml,yl,wl=ve`
  @layer base, reset;
...
`,xl=class extends vs{constructor(){super(...arguments),rt(this,Va),rt(this,Ha),rt(this,Ba),rt(this,Ua),rt(this,Ga),rt(this,qa),rt(this,Xa),rt(this,ul),rt(this,bl),rt(this,ml),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.open=!1,this.label="",this.showWeekNumbers=!1,this.size="medium",this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=(new Date).getMonth(),this._focusedYear=(new Date).getFullYear(),this._dateFormatLayout=st(this,ul,pl).call(this,"y-m-d"),rt(this,ja,void 0),rt(this,Qa,(e=>{this._elTrigger.then((t=>{var r,o;(null==(r=e.relatedTarget)?void 0:r.parentElement)!==e.target&&(null==(o=document.getSelection())||o.removeAllRanges())}))})),rt(this,el,(e=>{this._elTrigger.then((e=>{var t,r;null==(t=document.getSelection())||t.removeAllRanges();const o=new Range;o.setStart(e.firstChild,0),o.setEnd(e.lastChild,4),null==(r=document.getSelection())||r.addRange(o)}))})),rt(this,tl,(e=>{this._elField.then((t=>{var r;e.currentTarget===t&&(e.preventDefault(),null==(r=e.clipboardData)||r.setData("text/plain",this.displayValue))}))})),rt(this,nl,(e=>{this._elField.then((t=>{var r;if(e.currentTarget!==t)return;e.preventDefault();const o=null==(r=e.clipboardData)?void 0:r.getData("text/plain");if(!o)return;let s=new Date("-");const i="Invalid Date",a=o.split(this._dateFormatLayout.delimiter);if(3===a.length){const e=this._dateFormatLayout.layout,t=parseInt(a[e.findIndex((e=>"y"===e.token))]),r=parseInt(a[e.findIndex((e=>"m"===e.token))])-1,o=parseInt(a[e.findIndex((e=>"d"===e.token))]);isNaN(t)||isNaN(r)||isNaN(o)||(s=new Date(`${t}-${r+1}-${o}`))}s.toString()===i&&(s=new Date(o),s.toString()===i)||(this.value=s,st(this,qa,Ka).call(this))}))})),rt(this,rl,(e=>{var t;null==(t=this._elSpinners[0])||t.focus()})),rt(this,ol,(e=>{e.stopPropagation(),this.value=e.detail,this.open=!1,st(this,qa,Ka).call(this)})),rt(this,sl,(e=>{var t;e.stopPropagation(),this._focusedMonth=null==(t=e.target)?void 0:t.value})),rt(this,il,(e=>{var t;e.stopPropagation(),this._focusedYear=null==(t=e.target)?void 0:t.value})),rt(this,al,(e=>{this._focusedMonth++,this._focusedMonth>11&&(this._focusedMonth=0,this._focusedYear++)})),rt(this,ll,(e=>{this._focusedMonth--,this._focusedMonth<0&&(this._focusedMonth=11,this._focusedYear--)})),rt(this,cl,(async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),st(this,Xa,Ja).call(this)})),rt(this,dl,(async e=>{if(e.target===e.currentTarget){if(this.open=e.detail.open,"close"===e.detail.reason){const e=(await this._elCalendar).value;!Pa(e||new Date(0),nt(this,ja)||new Date(0))&&(this.value=e,st(this,qa,Ka).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}"cancel"===e.detail.reason&&(this.value=nt(this,ja))}})),rt(this,hl,(e=>{const t=Array.from(this._elSpinners).findIndex((t=>t===e.target));if("ArrowRight"===e.key){const e=this._elSpinners[t+1];e&&e.focus()}if("ArrowLeft"===e.key){const e=this._elSpinners[t-1];e&&e.focus()}})),rt(this,gl,((e,t)=>{nt(this,fl)[t]=e;const r=new Date;r.setFullYear(parseInt(nt(this,fl).year)),r.setMonth(parseInt(nt(this,fl).month)-1),r.setDate(parseInt(nt(this,fl).day)),r.setHours(12,0,0,0),"Invalid Date"!==r.toString()&&(this.value=r,st(this,qa,Ka).call(this))})),rt(this,fl,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map((e=>e.token)).join(this._dateFormatLayout.delimiter)}set dateformat(e){this._dateFormatLayout=st(this,ul,pl).call(this,e)}async getFocusedDate(){return this.open?this._elCalendar.then((e=>e.focusedDate)):void 0}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(e){return this._elCalendar.then((t=>t.getDateCell(e)))}connectedCallback(){super.connectedCallback(),ln.instance.apply(this,"gds-datepicker")}render(){return ut`${ys(this.label&&!this.hideLabel,(()=>ut`<label for="spinner-0" id="label">${this.label}</label>`))}
      ...
      >
        ...
        >
          ${function*(e,t){const r="function"==typeof t;if(void 0!==e){let o=-1;for(const s of e)o>-1&&(yield r?t(o):t),o++,yield s}}(function*(e,t){if(void 0!==e){let r=0;for(const o of e)yield t(o,r++)}}(this._dateFormatLayout.layout,((e,t)=>ut`<gds-date-part-spinner
                  ...
                  @keydown=${nt(this,hl)}
                  @change=${t=>nt(this,gl).call(this,t.detail.value,e.name)}
                  @focus=${nt(this,el)}
      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${Ta(nt(this,bl,vl),(e=>e),(e=>ut`<gds-option value=${e}>${e}</gds-option>`))}
          </gds-dropdown>
          <gds-button
            @click=${nt(this,al)}
      ...
      </gds-popover> `}_getValidityAnchor(){return this._elSpinners[0]}_handleValueChange(){if(!this.value)return void ot(this,fl,{year:"yyyy",month:"mm",day:"dd"});const e=this.value;this._focusedMonth=e.getMonth(),this._focusedYear=e.getFullYear();const t=e.getFullYear().toString(),r=(e.getMonth()+1).toString().padStart(2,"0"),o=e.getDate().toString().padStart(2,"0");ot(this,fl,{year:t,month:r,day:o})}_handleOpenChange(){this.open&&(ot(this,ja,this.value),this._elCalendar.then((e=>e.focus())))}};ja=new WeakMap,Va=new WeakSet,Na=async function(){const e=await this.getFocusedDate();let t,r="";return e&&e>this.max?(r=gn("Last available date"),t=e=>{e.stopPropagation(),st(this,Ha,Ra).call(this,this.max)}):e&&e<this.min&&(r=gn("First available date"),t=e=>{e.stopPropagation(),st(this,Ha,Ra).call(this,this.min)}),ut`${ys(r.length>0,(()=>ut`<gds-button rank="tertiary" size="small" @click=${t}>
          ${r}
        </gds-button>`),(()=>oe))}`},Ha=new WeakSet,Ra=function(e){const t=new Date(e);this._elCalendar.then((e=>e.focusedDate=t)).then(nt(this,cl))},Ba=new WeakSet,Ia=function(e){return{year:gn("Year"),month:gn("Month"),day:gn("Day")}[e]},Ua=new WeakSet,Za=function(e){return{year:1900,month:1,day:1}[e]},Ga=new WeakSet,Ya=function(e){return{year:9999,month:12,day:31}[e]},qa=new WeakSet,Ka=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value}}))},Xa=new WeakSet,Ja=function(){this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value}}))},Qa=new WeakMap,el=new WeakMap,tl=new WeakMap,nl=new WeakMap,rl=new WeakMap,ol=new WeakMap,sl=new WeakMap,il=new WeakMap,al=new WeakMap,ll=new WeakMap,cl=new WeakMap,dl=new WeakMap,hl=new WeakMap,ul=new WeakSet,pl=function(e){const t=e.replace(/[a-z0-9]/gi,"")[0],r=e.split(t),o=r.findIndex((e=>"y"===e)),s=r.findIndex((e=>"m"===e)),i=r.findIndex((e=>"d"===e));if(-1===o||-1===s||-1===i)throw new Error("Invalid date format for <gds-datepicker>");const a=[o,s,i].sort(((e,t)=>e-t)),l=a.map((e=>r[e])).map((e=>({token:e,name:"y"===e?"year":"m"===e?"month":"day"})));return{delimiter:t,layout:l}},gl=new WeakMap,fl=new WeakMap,bl=new WeakSet,vl=function(){var e;const t=this.min.getFullYear(),r=this.max.getFullYear(),o=nt(this,ml,yl),s=null==(e=this.value)?void 0:e.getFullYear();return{*[Symbol.iterator](){o&&(yield s);for(let e=t;e<=r;e++)yield e}}},ml=new WeakSet,yl=function(){return!!this.value&&(this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear())},xl.styles=[Yt,wl],xl.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Pe({converter:Ea})],xl.prototype,"value",2),et([Pe({converter:Ea})],xl.prototype,"min",2),et([Pe({converter:Ea})],xl.prototype,"max",2),et([Pe({type:Boolean})],xl.prototype,"open",2),et([Pe()],xl.prototype,"label",2),et([Pe({type:Boolean,attribute:"show-week-numbers"})],xl.prototype,"showWeekNumbers",2),et([Pe()],xl.prototype,"size",2),et([Pe({type:Boolean,attribute:"hide-label"})],xl.prototype,"hideLabel",2),et([Pe()],xl.prototype,"dateformat",1),et([Pe({type:Boolean,attribute:"disabled-weekends"})],xl.prototype,"disabledWeekends",2),et([Pe({converter:Sa,attribute:"disabled-dates"})],xl.prototype,"disabledDates",2),et([Re("#calendar-button")],xl.prototype,"test_calendarButton",2),et([je()],xl.prototype,"_focusedMonth",2),et([je()],xl.prototype,"_focusedYear",2),et([je()],xl.prototype,"_dateFormatLayout",2),et([Re("#calendar")],xl.prototype,"_elCalendar",2),et([Re("#calendar-button")],xl.prototype,"_elTrigger",2),et([Re("#field")],xl.prototype,"_elField",2),et([function(e){return(t,r)=>Ve(t,r,{get(){return(this.renderRoot??(He??=document.createDocumentFragment())).querySelectorAll(e)}})}("[role=spinbutton]")],xl.prototype,"_elSpinners",2),et([Ne(".input")],xl.prototype,"_elInput",2),et([vr("value")],xl.prototype,"_handleValueChange",1),et([vr("open")],xl.prototype,"_handleOpenChange",1),xl=et([lt("gds-datepicker"),mn()],xl);var kl,_l,Cl,$l,El,Sl,Al,Tl,Ml,Dl,zl,Ll,Fl,Wl,Ol=ve`
  @layer base, reset;
...
`,Pl=class extends vs{constructor(){super(),rt(this,Al),rt(this,Ml),rt(this,zl),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,rt(this,kl,void 0),rt(this,_l,(e=>{const t=e.getBoundingClientRect(),r=window.innerHeight-t.bottom,o=t.top;let s=Math.min(o,this.maxHeight);return r>o&&(s=Math.min(r,this.maxHeight)),s-16+"px"})),rt(this,Cl,(e=>{if(!e.currentTarget)return;const t=e.currentTarget;if(this.options.forEach((e=>e.hidden=!1)),!t.value)return;const r=this.options.filter((e=>!this.searchFilter(t.value,e)));r.forEach((e=>e.hidden=!0))})),rt(this,$l,(e=>{var t;null==(t=this._elListbox)||t.then((t=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void t.focus()}))})),rt(this,El,(e=>{var t;if("Tab"===e.key&&this.searchable)return e.preventDefault(),void(null==(t=this._elSearchInput)||t.focus())})),rt(this,Sl,(e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)})),rt(this,Fl,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)})),rt(this,Wl,(e=>{var t;"Tab"!==e.key||this.searchable||(e.preventDefault(),this.open=!1,null==(t=this._elTriggerBtn)||t.focus())})),vn(this)}get type(){return"gds-dropdown"}get options(){return nt(this,kl)?Array.from(nt(this,kl)).filter((e=>!e.hasAttribute("isplaceholder"))):[]}get placeholder(){if(nt(this,kl))return Array.from(nt(this,kl)).find((e=>e.hasAttribute("isplaceholder")))}get displayValue(){var e,t;let r;return r=Array.isArray(this.value)?this.value.length>2?gn(hn`${this.value.length} selected`):this.value.reduce(((e,t)=>{var r;return e+(null==(r=this.options.find((e=>e.value===t)))?void 0:r.innerHTML)+", "}),"").slice(0,-2):null==(e=this.options.find((e=>e.selected)))?void 0:e.innerHTML,r||(null==(t=this.placeholder)?void 0:t.innerHTML)||""}connectedCallback(){super.connectedCallback(),ln.instance.apply(this,"gds-dropdown"),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange()}))}render(){return ut`
      ${ys(this.label&&!this.hideLabel,(()=>ut`<label for="trigger">${this.label}</label>`))}
      ...
      >
        ...
        <gds-listbox
          id="listbox"
          .multiple="${ms(this.multiple)}"
          .compareWith="${this.compareWith}"
          @change="${st(this,Al,Tl)}"
          @gds-focus="${nt(this,Sl)}"
          @keydown=${nt(this,El)}
        >
          <slot></slot>
        </gds-listbox>
...
`,Il=class extends qt{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,rt(this,jl,ir()),rt(this,Vl,(e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach((e=>{e!==t&&(e.selected=!1)}))),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))})),new Zn(this)}get navigableItems(){return this.visibleOptionElements}get options(){return nt(this,jl).value&&Gn(nt(this,jl).value).assignedElements().filter((e=>!e.hasAttribute("isplaceholder")&&"gds-option"===e.gdsElementName))||[]}get visibleOptionElements(){return this.options.filter((e=>!e.hidden))}get visibleSelectedOptionElements(){return this.options.filter((e=>e.selected&&!e.hidden))}get selection(){return this.options.filter((e=>e.selected))}set selection(e){this.options.forEach((t=>{t.selected=e.some((e=>this.compareWith(e,t.value)))}))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),ln.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",nt(this,Vl))}focus(){var e;null==(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])||e.focus()}render(){return ut`<slot ${lr(nt(this,jl))}></slot>`}_rerenderOptions(){this.options.forEach((e=>{e.requestUpdate()}))}};jl=new WeakMap,Vl=new WeakMap,Il.styles=Bl,et([Pe({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],Il.prototype,"multiple",2),et([Pe()],Il.prototype,"compareWith",2),et([vr("multiple")],Il.prototype,"_rerenderOptions",1),Il=et([lt("gds-listbox")],Il);var Ul=class extends(ur(qt)){constructor(){super(),rt(this,Hl),rt(this,Nl,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",st(this,Hl,Rl)),this.addEventListener("keydown",(e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),st(this,Hl,Rl).call(this,e))}))}get hidden(){return nt(this,Nl)}set hidden(e){this.isPlaceholder||(ot(this,Nl,"true"===e||!0===e),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(ot(this,Nl,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then((()=>ln.instance.apply(this,"gds-option")))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(ot(this,Nl,!0),this.setAttribute("aria-hidden","true")):(ot(this,Nl,!1),this.setAttribute("aria-hidden","false"))}render(){var e;const t=null==(e=this.parentElement)?void 0:e.multiple,r=ut`
      <span class="checkbox ${Nn({checked:this.selected})}">
        ${this.selected?ut`<gds-icon-checkmark stroke="4"></gds-icon-checkmark>`:""}
      </span>
    `;return t||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),ut`<div>${ys(t,(()=>r))} <slot></slot></div>`}};Nl=new WeakMap,Hl=new WeakSet,Rl=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))},Ul.styles=[Yt,pr],et([Pe()],Ul.prototype,"value",2),et([Pe({attribute:"aria-hidden",reflect:!0})],Ul.prototype,"hidden",1),et([Pe({attribute:"aria-selected",reflect:!0})],Ul.prototype,"selected",2),et([Pe({type:Boolean,reflect:!0})],Ul.prototype,"isPlaceholder",2),et([vr("isplaceholder")],Ul.prototype,"_handlePlaceholderStatusChange",1),Ul=et([lt("gds-option")],Ul);var Zl=class extends rs{};Zl._regularSVG='<path d="M20 9L12 17L4 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Zl._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3.46967 8.46967C3.76256 8.17678 4.23744 8.17678 4.53033 8.46967L12 15.9393L19.4697 8.46967C19.7626 8.17678 20.2374 8.17678 20.5303 8.46967C20.8232 8.76256 20.8232 9.23744 20.5303 9.53033L12.5303 17.5303C12.3897 17.671 12.1989 17.75 12 17.75C11.8011 17.75 11.6103 17.671 11.4697 17.5303L3.46967 9.53033C3.17678 9.23744 3.17678 8.76256 3.46967 8.46967Z" fill="currentColor"/>',Zl._name="chevron-bottom",Zl=et([lt("gds-icon-chevron-bottom")],Zl);var Gl,Yl,ql,Kl,Xl,Jl,Ql,ec,tc,nc,rc,oc,sc,ic,ac,lc,cc,dc,hc=class extends rs{};hc._regularSVG='<path d="M2.75 15.0938L9 20.25L21.25 3.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',hc._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M21.7426 2.99454C22.2979 3.40464 22.4157 4.18729 22.0056 4.74263L10.0056 20.9926C9.80433 21.2652 9.50107 21.4443 9.16524 21.4891C8.82942 21.5339 8.4898 21.4404 8.22417 21.2301L2.22417 16.4801C1.6829 16.0516 1.59149 15.2655 2.01999 14.7242C2.4485 14.1829 3.23466 14.0915 3.77593 14.52L8.76241 18.4677L19.9945 3.25753C20.4046 2.70218 21.1873 2.58444 21.7426 2.99454Z" fill="currentColor"/>',hc._name="checkmark",hc=et([lt("gds-icon-checkmark")],hc);var uc=class extends lit_element_r{constructor(){super(...arguments),rt(this,tc),rt(this,rc),rt(this,sc),rt(this,ac),rt(this,cc),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=st(this,sc,ic).call(this,this.value,this.length),rt(this,Gl,""),rt(this,Yl,(()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=2===this.length?this.min:(new Date).getFullYear()-1),this.value=st(this,ac,lc).call(this,e+1),st(this,rc,oc).call(this)})),rt(this,ql,(()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=2===this.length?this.max:(new Date).getFullYear()+1),this.value=st(this,ac,lc).call(this,e-1),st(this,rc,oc).call(this)})),rt(this,Kl,(e=>{e.stopPropagation(),e.preventDefault(),this.focus()})),rt(this,Xl,(()=>{st(this,cc,dc).call(this)})),rt(this,Jl,(()=>{""!==nt(this,Gl)&&(st(this,cc,dc).call(this),this.value=st(this,ac,lc).call(this,parseInt(this.value.toString())),st(this,rc,oc).call(this))})),rt(this,Ql,(e=>{e.stopPropagation(),e.preventDefault(),e.deltaY>0?nt(this,ql).call(this):nt(this,Yl).call(this)})),rt(this,ec,(e=>{let t=!1;if("ArrowUp"===e.key)nt(this,Yl).call(this),t=!0;else if("ArrowDown"===e.key)nt(this,ql).call(this),t=!0;else{const r=parseInt(e.key);isNaN(r)||(nt(this,Gl).length<this.length&&(ot(this,Gl,nt(this,Gl)+r.toString()),this.value=parseInt(nt(this,Gl))),nt(this,Gl).length===this.length&&(this.value=st(this,ac,lc).call(this,this.value),st(this,cc,dc).call(this),st(this,tc,nc).call(this),st(this,rc,oc).call(this)),t=!0)}t&&(e.preventDefault(),e.stopPropagation())}))}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",nt(this,Ql)),this.addEventListener("keydown",nt(this,ec)),this.addEventListener("blur",nt(this,Jl)),this.addEventListener("focus",nt(this,Xl)),this.addEventListener("click",nt(this,Kl)),this.addEventListener("mousedown",nt(this,Kl))}focus(e){super.focus(e),nt(this,Xl).call(this)}render(){return ut`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=st(this,sc,ic).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};function pc(e){if(null===e||!0===e||!1===e)return NaN;var t=Number(e);return isNaN(t)?t:t<0?Math.ceil(t):Math.floor(t)}function gc(e,t){Fa(2,arguments);var r=Wa(e),o=pc(t);return isNaN(o)?new Date(NaN):o?(r.setDate(r.getDate()+o),r):r}function fc(e,t){return Fa(2,arguments),gc(e,7*pc(t))}Gl=new WeakMap,Yl=new WeakMap,ql=new WeakMap,Kl=new WeakMap,Xl=new WeakMap,Jl=new WeakMap,Ql=new WeakMap,ec=new WeakMap,tc=new WeakSet,nc=function(){let e=this.nextElementSibling;for(;e;){if(e instanceof uc){e.focus();break}e=e.nextElementSibling}},rc=new WeakSet,oc=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))},sc=new WeakSet,ic=function(e,t){return String(e).padStart(t,"0")},ac=new WeakSet,lc=function(e){return Math.max(this.min,Math.min(this.max,e))},cc=new WeakSet,dc=function(){ot(this,Gl,"")},uc.formAssociated=!0,et([Pe({type:Number})],uc.prototype,"value",2),et([Pe({type:Number})],uc.prototype,"length",2),et([Pe({type:Number,attribute:"aria-valuemin"})],uc.prototype,"min",2),et([Pe({type:Number,attribute:"aria-valuemax"})],uc.prototype,"max",2),et([je()],uc.prototype,"displayValue",2),et([vr("value")],uc.prototype,"_refreshDisplayValue",1),uc=et([lt("gds-date-part-spinner")],uc);var bc={};function vc(){return bc}function mc(e,t){var r,o,s,i,a,l,c,d;Fa(1,arguments);var h=vc(),u=pc(null!==(r=null!==(o=null!==(s=null!==(i=null==t?void 0:t.weekStartsOn)&&void 0!==i?i:null==t||null===(a=t.locale)||void 0===a||null===(l=a.options)||void 0===l?void 0:l.weekStartsOn)&&void 0!==s?s:h.weekStartsOn)&&void 0!==o?o:null===(c=h.locale)||void 0===c||null===(d=c.options)||void 0===d?void 0:d.weekStartsOn)&&void 0!==r?r:0);if(!(u>=0&&u<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var p=Wa(e),g=p.getDay(),f=(g<u?7:0)+g-u;return p.setDate(p.getDate()-f),p.setHours(0,0,0,0),p}function yc(e,t){var r;Fa(1,arguments);var o=e||{},s=Wa(o.start),i=Wa(o.end).getTime();if(!(s.getTime()<=i))throw new RangeError("Invalid interval");var a=[],l=s;l.setHours(0,0,0,0);var c=Number(null!==(r=null==t?void 0:t.step)&&void 0!==r?r:1);if(c<1||isNaN(c))throw new RangeError("`options.step` must be a number greater than 1");for(;l.getTime()<=i;)a.push(Wa(l)),l.setDate(l.getDate()+c),l.setHours(0,0,0,0);return a}function wc(e,t){const r=function(e){Fa(1,arguments);var t=Wa(e);return t.setDate(1),t.setHours(0,0,0,0),t}(e),o=function(e){Fa(1,arguments);var t=Wa(e),r=t.getMonth();return t.setFullYear(t.getFullYear(),r+1,0),t.setHours(23,59,59,999),t}(e),s=function(e,t){Fa(1,arguments);var r=e||{},o=Wa(r.start),s=Wa(r.end),i=s.getTime();if(!(o.getTime()<=i))throw new RangeError("Invalid interval");var a=mc(o,t),l=mc(s,t);a.setHours(15),l.setHours(15),i=l.getTime();for(var c=[],d=a;d.getTime()<=i;)d.setHours(0),c.push(Wa(d)),(d=fc(d,1)).setHours(15);return c}({start:r,end:o},{weekStartsOn:1});for(;s.length<6;)s.push(gc(s[s.length-1],7));return ee`${t(s.map((e=>({days:yc({start:e,end:gc(e,6)})}))))}`}function xc(e,t){var r,o,s,i,a,l,c,d;Fa(1,arguments);var h=vc(),u=pc(null!==(r=null!==(o=null!==(s=null!==(i=null==t?void 0:t.firstWeekContainsDate)&&void 0!==i?i:null==t||null===(a=t.locale)||void 0===a||null===(l=a.options)||void 0===l?void 0:l.firstWeekContainsDate)&&void 0!==s?s:h.firstWeekContainsDate)&&void 0!==o?o:null===(c=h.locale)||void 0===c||null===(d=c.options)||void 0===d?void 0:d.firstWeekContainsDate)&&void 0!==r?r:1),p=function(e,t){var r,o,s,i,a,l,c,d;Fa(1,arguments);var h=Wa(e),u=h.getFullYear(),p=vc(),g=pc(null!==(r=null!==(o=null!==(s=null!==(i=null==t?void 0:t.firstWeekContainsDate)&&void 0!==i?i:null==t||null===(a=t.locale)||void 0===a||null===(l=a.options)||void 0===l?void 0:l.firstWeekContainsDate)&&void 0!==s?s:p.firstWeekContainsDate)&&void 0!==o?o:null===(c=p.locale)||void 0===c||null===(d=c.options)||void 0===d?void 0:d.firstWeekContainsDate)&&void 0!==r?r:1);if(!(g>=1&&g<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var f=new Date(0);f.setFullYear(u+1,0,g),f.setHours(0,0,0,0);var v=mc(f,t),m=new Date(0);m.setFullYear(u,0,g),m.setHours(0,0,0,0);var y=mc(m,t);return h.getTime()>=v.getTime()?u+1:h.getTime()>=y.getTime()?u:u-1}(e,t),g=new Date(0);return g.setFullYear(p,0,u),g.setHours(0,0,0,0),mc(g,t)}function kc(e,t){Fa(2,arguments);var r=Wa(e),o=pc(t);if(isNaN(o))return new Date(NaN);if(!o)return r;var s=r.getDate(),i=new Date(r.getTime());return i.setMonth(r.getMonth()+o+1,0),s>=i.getDate()?i:(r.setFullYear(i.getFullYear(),i.getMonth(),s),r)}var _c,Cc,$c,Ec,Sc=ve`
  @layer base, reset;
...
`,Ac=class extends qt{constructor(){super(...arguments),rt(this,_c),rt(this,$c),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=e=>e.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(e){const t=function(e){Fa(1,arguments);var t=Wa(e),r=t.getMonth();return t.setFullYear(t.getFullYear(),r+1,0),t.setHours(0,0,0,0),t}(new Date(this.focusedYear,e,1)),r=new Date(this.focusedDate);r.setDate(Math.min(this.focusedDate.getDate(),t.getDate())),r.setMonth(e),r.setHours(12,0,0,0),this.focusedDate=r}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(this.focusedDate.setFullYear(e))}getDateCell(e){var t;return null==(t=this.shadowRoot)?void 0:t.querySelector(`#dateCell-${e}`)}connectedCallback(){super.connectedCallback(),ln.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",st(this,$c,Ec)),window.addEventListener("lit-localize-status",(e=>{"ready"===e.detail.status&&(this._currentLocale=e.detail.readyLocale)}))}focus(){var e;super.focus(),null==(e=this._elFocusedCell)||e.focus()}render(){const e=new Date;return ee`<table role="grid" aria-label="${ms(this.label)}">
      ${ys(!this.hideDayNames,(()=>ee`<thead role="rowgroup">
            <tr role="row">
              ${ys(this.showWeekNumbers,(()=>ee`<th></th>`))}
              <th>${gn("Mon")}</th>
              <th>${gn("Tue")}</th>
              <th>${gn("Wed")}</th>
              <th>${gn("Thu")}</th>
      ...
      <tbody role="rowgroup">
        ${wc(this.focusedDate,(t=>ee`
            ${t.map((t=>ee`
                <tr role="row">
                  ${ys(this.showWeekNumbers,(()=>ee`<td class="week-number" scope="row">
                        ${function(e,t){Fa(1,arguments);var r=Wa(e),o=mc(r,t).getTime()-xc(r,t).getTime();return Math.round(o/6048e5)+1}(t.days[0])}
                      </td>`))}
                  ${t.days.map((t=>{const r=this.customizedDates&&this.customizedDates.find((e=>Pa(e.date,t))),o=Je({color:"currentColor",disabled:Boolean(this.disabledDates&&this.disabledDates.some((e=>Pa(e,t))))},r),s=!function(e,t){Fa(2,arguments);var r=Wa(e),o=Wa(t);return r.getFullYear()===o.getFullYear()&&r.getMonth()===o.getMonth()}(this.focusedDate,t),i=(t<this.min||t>this.max)&&!Pa(t,this.min)&&!Pa(t,this.max),a=0===t.getDay()||6===t.getDay(),l=o.disabled||s||i||this.disabledWeekends&&a;return this.hideExtraneousDays&&s?ee`<td inert></td>`:ee`
                          <td
                            role="${ms(l?void 0:"gridcell")}"
                            class="${Nn({"custom-date":Boolean(r),disabled:Boolean(l),today:Pa(e,t)})}"
                            ?disabled=${l}
                            tabindex="${Pa(this.focusedDate,t)?0:-1}"
                            aria-selected="${this.value&&Pa(this.value,t)?"true":"false"}"
                            aria-label="${this.dateLabelTemplate(t)}"
                            @click=${()=>l?null:st(this,_c,Cc).call(this,t)}
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=this.value)}};_c=new WeakSet,Cc=function(e){const t=function(e,t){Fa(2,arguments);var r=Wa(e),o=pc(t);return r.setHours(o),r}(e,12);this.value=t,this.dispatchEvent(new CustomEvent("change",{detail:t,bubbles:!1,composed:!1}))},$c=new WeakSet,Ec=function(e){var t;let r=!1,o=new Date(this.focusedDate);if("ArrowLeft"===e.key?(o=gc(this.focusedDate,-1),r=!0):"ArrowRight"===e.key?(o=gc(this.focusedDate,1),r=!0):"ArrowUp"===e.key?(o=gc(this.focusedDate,-7),r=!0):"ArrowDown"===e.key?(o=gc(this.focusedDate,7),r=!0):"Enter"===e.key||" "===e.key?((null==(t=this._elFocusedCell)?void 0:t.hasAttribute("disabled"))||st(this,_c,Cc).call(this,this.focusedDate),r=!0):"Home"===e.key?(o=new Date(this.focusedYear,this.focusedMonth,1),r=!0):"End"===e.key?(o=new Date(this.focusedYear,this.focusedMonth+1,0),r=!0):"PageUp"===e.key?(o=function(e,t){return Fa(2,arguments),kc(e,-pc(t))}(this.focusedDate,1),r=!0):"PageDown"===e.key&&(o=kc(this.focusedDate,1),r=!0),o.getFullYear()>=this.min.getFullYear()&&o.getFullYear()<=this.max.getFullYear()){this.dispatchEvent(new CustomEvent("gds-date-focused",{detail:o,bubbles:!1,composed:!1,cancelable:!0}))&&(this.focusedDate=o)}r&&(e.preventDefault(),e.stopPropagation(),this.updateComplete.then((()=>{var e;null==(e=this._elFocusedCell)||e.focus()})))},Ac.styles=[Yt,Sc],Ac.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Pe()],Ac.prototype,"value",2),et([Pe({type:Date})],Ac.prototype,"min",2),et([Pe({type:Date})],Ac.prototype,"max",2),et([Pe()],Ac.prototype,"focusedDate",2),et([Pe({type:Boolean,attribute:"disabled-weekends"})],Ac.prototype,"disabledWeekends",2),et([Pe({type:Array,attribute:"disabled-dates"})],Ac.prototype,"disabledDates",2),et([Pe({type:Number})],Ac.prototype,"focusedMonth",1),et([Pe({type:Number})],Ac.prototype,"focusedYear",1),et([Pe({type:Boolean})],Ac.prototype,"showWeekNumbers",2),et([Pe({type:Boolean})],Ac.prototype,"hideExtraneousDays",2),et([Pe({type:Boolean})],Ac.prototype,"hideDayNames",2),et([Pe({attribute:!1})],Ac.prototype,"customizedDates",2),et([Pe()],Ac.prototype,"label",2),et([Pe({attribute:!1})],Ac.prototype,"dateLabelTemplate",2),et([je()],Ac.prototype,"_currentLocale",2),et([Ne('td[tabindex="0"]')],Ac.prototype,"_elFocusedCell",2),et([vr("value")],Ac.prototype,"_valueChanged",1),Ac=et([lt("gds-calendar"),mn()],Ac);var Tc=class extends qt{connectedCallback(){super.connectedCallback(),this.form=this.closest("form")||void 0,this.form&&(this.formObserver=new MutationObserver((()=>{this.requestUpdate()})),this.formObserver.observe(this.form,{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.formObserver)||e.disconnect()}render(){var e;const t=Array.from((null==(e=this.form)?void 0:e.elements)||[]).filter((e=>e.invalid));return ys(t.length>0,(()=>ut`<gds-card level="3" border="4xs/negative" border-radius="2xs" padding="m" color="error-text">
  ...
  `,Tc=et([lt("gds-form-summary")],Tc);var Mc,Dc,zc,Lc,Fc,Wc,Oc,Pc,jc,Vc,Nc,Hc,Rc,Bc,Ic,Uc,Zc,Gc,Yc,qc=ve`
  #body {
    visibility: hidden;
    position: absolute;
    z-index: 1060;
...
`,Kc=class extends qt{constructor(){super(...arguments),rt(this,Lc),rt(this,Wc),rt(this,Pc),rt(this,Vc),rt(this,Hc),rt(this,Bc),rt(this,Uc),rt(this,Gc),this.placement="bottom",this.overlappedBy=[],this.target=[],this.label="Coachmark",this.computeVisibility=(e,t,r)=>r,this.targetElement=void 0,this._isVisible=!1,this._preventClose=!1,rt(this,Mc,ir()),rt(this,Dc,ir()),rt(this,zc,void 0)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",(()=>{setTimeout((()=>{st(this,Gc,Yc).call(this),st(this,Lc,Fc).call(this)}),400)})),document.addEventListener("keydown",(e=>{"Escape"===e.key&&this._isVisible&&st(this,Lc,Fc).call(this)}))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",st(this,Lc,Fc)),document.removeEventListener("keydown",(e=>{"Escape"===e.key&&this._isVisible&&st(this,Lc,Fc).call(this)}))}firstUpdated(){this.target.length>0&&(this.targetElement=st(this,Wc,Oc).call(this,this.target),st(this,Gc,Yc).call(this))}setPreventClose(e){this._preventClose=e}render(){return ut`${ys(this.target.length>0,(()=>ut`
        <div
          role="dialog"
          id="body"
          aria-label=${this.label}
        ...
        >
          <slot></slot>
          <div id="arrow" ${lr(nt(this,Dc))}></div>
        </div>
      `),(()=>ut``))}`}};Mc=new WeakMap,Dc=new WeakMap,zc=new WeakMap,Lc=new WeakSet,Fc=function(){var e,t;this._isVisible&&(this._isVisible=!1,null==(e=nt(this,Mc).value)||e.remove(),null==(t=nt(this,zc))||t.call(this),this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:this._isVisible,reason:"closed"},bubbles:!1,composed:!1})))},Wc=new WeakSet,Oc=function(e){let t,r=!1;for(const o of e)"shadowRoot"!==o?t?r&&t.shadowRoot?(t=t.shadowRoot.querySelector(o),r=!1):t=t.querySelector(o):t=document.querySelector(o):r=!0;return t},Pc=new WeakSet,jc=function(e,t){if(e==t)return;const r=e.getBoundingClientRect(),o=t.getBoundingClientRect();return r.top<o.bottom&&r.bottom>o.top&&r.left<o.right&&r.right>o.left},Vc=new WeakSet,Nc=function(e){if(!e)return!1;for(const t of e){const e=document.querySelector(t);if(e&&"hidden"!==getComputedStyle(e).visibility&&st(this,Pc,jc).call(this,this.targetElement,e))return!0}return!1},Hc=new WeakSet,Rc=function(e){const t=e.getBoundingClientRect(),r=window.innerHeight||document.documentElement.clientHeight,o=window.innerWidth||document.documentElement.clientWidth;return t.top+t.height<0||t.top>r||t.left+t.width<0||t.left>o},Bc=new WeakSet,Ic=async function(e,t,r){return Do(e,t,{placement:this.placement,middleware:[Eo((()=>({mainAxis:16,alignmentAxis:16}))),{name:"detectOverflow",fn:async e=>({data:await $o(e,{boundary:document.body,rootBoundary:"document",altBoundary:!0,padding:{top:167,left:20}})})},So({padding:16}),Ao(),To(),Mo({padding:16,element:r})]})},Uc=new WeakSet,Zc=function(){if(!this.targetElement)return!1;const e=st(this,Hc,Rc).call(this,this.targetElement),t=this.targetElement.checkVisibility(),r=0!==this.overlappedBy.length&&st(this,Vc,Nc).call(this,this.overlappedBy);return this.computeVisibility(this,this.targetElement,!r&&!e&&t)},Gc=new WeakSet,Yc=async function(){const e=this.targetElement,t=nt(this,Mc).value,r=nt(this,Dc).value;if(e&&t&&r)try{ot(this,zc,Co(e,t,(()=>{st(this,Bc,Ic).call(this,e,t,r).then((e=>{let{x:o,y:s,middlewareData:i,placement:a}=e;if(st(this,Uc,Zc).call(this)){if(this._isVisible=!0,Object.assign(t.style,{visibility:"visible",opacity:1,left:`${o}px`,top:`${s}px`}),i.arrow){const{x:e,y:t}=i.arrow;r.removeAttribute("class"),r.classList.add("arrow-"+a),Object.assign(r.style,{left:null!=e?`${e}px`:"",top:null!=t?`${t}px`:""})}}else this._isVisible=!1,Object.assign(t.style,{visibility:"hidden",opacity:0})}))})))}catch(o){console.warn("failed to render tooltips")}},Kc.styles=qc,et([Pe()],Kc.prototype,"placement",2),et([Pe({attribute:!1})],Kc.prototype,"overlappedBy",2),et([Pe({attribute:!1})],Kc.prototype,"target",2),et([Pe()],Kc.prototype,"label",2),et([Pe({attribute:!1})],Kc.prototype,"computeVisibility",2),et([je()],Kc.prototype,"_isVisible",2),et([je()],Kc.prototype,"_preventClose",2),Kc=et([lt("gds-coachmark")],Kc);var Xc=ve`
  .button {
...
`,Jc=class extends Ds{connectedCallback(){super.connectedCallback(),this._dynamicStylesController.inject("FAB_styles",Xc)}};let Qc,ed,td,nd,rd,od,sd,id,ad,ld,cd,dd,hd,ud,pd,gd,fd,bd,vd,md;function yd(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:xd((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||xd(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:wd(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function wd(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function xd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}et([Ft({valueTemplate:e=>e,selector:'[part="_button"]'})],Jc.prototype,"position",2),et([Ft({valueTemplate:e=>e})],Jc.prototype,"transform",2),et([Ft({valueTemplate:e=>e,selector:'[part="_button"]'})],Jc.prototype,"inset",2),Jc=et([lt("gds-fab")],Jc),ed=[Fe("form-validation")];class FormValidationExample extends lit_element_r{static#e=(()=>[td,Qc]=yd(this,[],ed,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`<gds-card border="4xs/base300" padding="m" border-radius="s">
      <form>
        <gds-input
          required
          label="Name"
    ...
    </gds-card>`}static#t=(()=>Qc())()}function kd(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Cd((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||Cd(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:_d(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function _d(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Cd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}od=[Fe("datepicker-example")];class CalendarExample extends lit_element_r{static#e=(()=>({e:[id,ld,nd],c:[cd,rd]}=kd(this,[[sd,1,"disabledWeekends"],[ad,1,"showWeekNumbers"]],od,0,void 0,lit_element_r)))();[(sd=je(),ad=je(),"createRenderRoot")](){return this}connectedCallback(){super.connectedCallback()}#n=(()=>(nd(this),id(this,!1)))();get disabledWeekends(){return this.#n}set disabledWeekends(e){this.#n=e}#r=(()=>ld(this,!1))();get showWeekNumbers(){return this.#r}set showWeekNumbers(e){this.#r=e}render(){return ut` <div style="width:320px; margin: 8rem auto;">
      ...
      <fieldset class="form-group" style="margin-top: 2rem">
        ...
        <label class="form-control"
          ...
          ><i
        ></i></label>
    </div>`}static#t=(()=>rd())()}function $d(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Sd((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||Sd(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:Ed(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Ed(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Sd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}const Ad=`${(new Date).getFullYear()}-${(new Date).getMonth()+1}`;let Td,Md,Dd;ud=[Fe("calendar-example")];class app_calendar_element_CalendarExample extends lit_element_r{static#e=(()=>({e:[gd,bd,md,dd],c:[Td,hd]}=$d(this,[[pd,1,"disabledWeekends"],[fd,1,"showWeekNumbers"],[vd,1,"showCustomizedDates"]],ud,0,void 0,lit_element_r)))();[(pd=je(),fd=je(),vd=je(),"createRenderRoot")](){return this}connectedCallback(){super.connectedCallback()}#n=(()=>(dd(this),gd(this,!1)))();get disabledWeekends(){return this.#n}set disabledWeekends(e){this.#n=e}#r=(()=>bd(this,!1))();get showWeekNumbers(){return this.#r}set showWeekNumbers(e){this.#r=e}#o=(()=>md(this,!1))();get showCustomizedDates(){return this.#o}set showCustomizedDates(e){this.#o=e}#s=(()=>[{date:new Date(`${Ad}-07`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${Ad}-12`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${Ad}-24`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${Ad}-21`),indicator:"dot",disabled:!0}])();render(){return ut` <div style="width:320px; margin: 8rem auto;">
    ...
    </div>`}static#t=(()=>hd())()}function zd(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Fd((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||Fd(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:Ld(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Ld(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Fd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}let Wd,Od,Pd,jd;Dd=[Fe("gds-login")];class CardExample extends lit_element_r{static#e=(()=>[Wd,Md]=zd(this,[],Dd,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`
    ...
    `}static#t=(()=>Md())()}function Vd(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Hd((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||Hd(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:Nd(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Nd(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Hd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}Pd=[Fe("gds-onboarding")];class onboarding_onboarding_element_CardExample extends lit_element_r{static#e=(()=>[jd,Od]=Vd(this,[],Pd,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut` <gds-flex gap="lg">
    ...
    </gds-flex>`}static#t=(()=>Od())()}var Rd=class extends rs{};Rd._regularSVG='<path d="M7.75 20.75L3.75 16.75L7.75 12.75M16.25 11.25L20.25 7.25L16.25 3.25M5 16.75H20.25M3.75 7.25H19.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Rd._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.7197 2.71967C16.0126 2.42678 16.4874 2.42678 16.7803 2.71967L20.7803 6.71967C21.0732 7.01256 21.0732 7.48744 20.7803 7.78033L16.7803 11.7803C16.4874 12.0732 16.0126 12.0732 15.7197 11.7803C15.4268 11.4874 15.4268 11.0126 15.7197 10.7197L18.4393 8H3.75C3.33579 8 3 7.66421 3 7.25C3 6.83579 3.33579 6.5 3.75 6.5H18.4393L15.7197 3.78033C15.4268 3.48744 15.4268 3.01256 15.7197 2.71967ZM8.28033 12.2197C8.57322 12.5126 8.57322 12.9874 8.28033 13.2803L5.56066 16H20.25C20.6642 16 21 16.3358 21 16.75C21 17.1642 20.6642 17.5 20.25 17.5H5.56066L8.28033 20.2197C8.57322 20.5126 8.57322 20.9874 8.28033 21.2803C7.98744 21.5732 7.51256 21.5732 7.21967 21.2803L3.21967 17.2803C2.92678 16.9874 2.92678 16.5126 3.21967 16.2197L7.21967 12.2197C7.51256 11.9268 7.98744 11.9268 8.28033 12.2197Z" fill="currentColor"/>',Rd._name="arrow-left-right",Rd=et([lt("gds-icon-arrow-left-right")],Rd);var Bd=class extends rs{};Bd._regularSVG='<path d="M12 3.75V12M12 12V20.25M12 12H3.75M12 12H20.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Bd._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C12.4142 3 12.75 3.33579 12.75 3.75V11.25H20.25C20.6642 11.25 21 11.5858 21 12C21 12.4142 20.6642 12.75 20.25 12.75H12.75V20.25C12.75 20.6642 12.4142 21 12 21C11.5858 21 11.25 20.6642 11.25 20.25V12.75H3.75C3.33579 12.75 3 12.4142 3 12C3 11.5858 3.33579 11.25 3.75 11.25H11.25V3.75C11.25 3.33579 11.5858 3 12 3Z" fill="currentColor"/>',Bd._name="plus-large",Bd=et([lt("gds-icon-plus-large")],Bd);var Id=class extends rs{};let Ud,Zd,Gd,Yd,qd,Kd,Xd,Jd,Qd,eh,th;function nh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:oh((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||oh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:rh(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function rh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function oh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}Id._regularSVG='<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" fill="currentColor"/><path d="M20.25 13C20.8023 13 21.25 12.5523 21.25 12C21.25 11.4477 20.8023 11 20.25 11C19.6977 11 19.25 11.4477 19.25 12C19.25 12.5523 19.6977 13 20.25 13Z" fill="currentColor"/><path d="M3.75 13C4.30228 13 4.75 12.5523 4.75 12C4.75 11.4477 4.30228 11 3.75 11C3.19772 11 2.75 11.4477 2.75 12C2.75 12.5523 3.19772 13 3.75 13Z" fill="currentColor"/><path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.25 13C20.8023 13 21.25 12.5523 21.25 12C21.25 11.4477 20.8023 11 20.25 11C19.6977 11 19.25 11.4477 19.25 12C19.25 12.5523 19.6977 13 20.25 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 13C4.30228 13 4.75 12.5523 4.75 12C4.75 11.4477 4.30228 11 3.75 11C3.19772 11 2.75 11.4477 2.75 12C2.75 12.5523 3.19772 13 3.75 13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Id._solidSVG='<path d="M3.75 10.25C2.7835 10.25 2 11.0335 2 12C2 12.9665 2.7835 13.75 3.75 13.75C4.7165 13.75 5.5 12.9665 5.5 12C5.5 11.0335 4.7165 10.25 3.75 10.25Z" fill="currentColor"/><path d="M12 10.25C11.0335 10.25 10.25 11.0335 10.25 12C10.25 12.9665 11.0335 13.75 12 13.75C12.9665 13.75 13.75 12.9665 13.75 12C13.75 11.0335 12.9665 10.25 12 10.25Z" fill="currentColor"/><path d="M20.25 10.25C19.2835 10.25 18.5 11.0335 18.5 12C18.5 12.9665 19.2835 13.75 20.25 13.75C21.2165 13.75 22 12.9665 22 12C22 11.0335 21.2165 10.25 20.25 10.25Z" fill="currentColor"/>',Id._name="dot-grid-one-horizontal",Id=et([lt("gds-icon-dot-grid-one-horizontal")],Id),Zd=[Fe("gds-jit")];class GdsJit extends lit_element_r{static#e=(()=>[Gd,Ud]=nh(this,[],Zd,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-card variant="tertiary" padding="l"
        ><gds-flex
          ...
          ></gds-card> </gds-flex
      ></gds-card>
    `}static#t=(()=>Ud())()}function sh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:ah((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||ah(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:ih(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function ih(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function ah(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}qd=[Fe("gds-dashboard")];class dashboard_dashboard_element_CardExample extends lit_element_r{static#e=(()=>[Kd,Yd]=sh(this,[],qd,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`
    ...
    `}static#t=(()=>Yd())()}function lh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function c(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function d(e,t,r,o,s,i,l,d,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],w=t[3],x=!d;if(!x){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:dh((function(){return w(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=w,p||dh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var E=e,S=y.length-1;S>=0;S-=r?2:1){var A=y[S],T=r?y[S-1]:void 0,D={},F={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");c(t,"An initializer","be",!0),l.push(t)}).bind(null,D)};try{if(x)(m=c(A.call(T,E,F),"class decorators","return"))&&(E=m);else{var W,O;F.static=h,F.private=u,u?2===s?W=function(e){return v(e),_.value}:(s<4&&(W=a(_,"get",v)),3!==s&&(O=a(_,"set",v))):(W=function(e){return e[o]},(s<2||4===s)&&(O=function(e,t){e[o]=t}));var P=F.access={has:u?f.bind():function(e){return o in e}};if(W&&(P.get=W),O&&(P.set=O),E=A.call(T,g?{get:_.get,set:_.set}:_[$],F),g){if("object"==typeof E&&E)(m=c(E.get,"accessor.get"))&&(_.get=m),(m=c(E.set,"accessor.set"))&&(_.set=m),(m=c(E.init,"accessor.init"))&&C.push(m);else if(void 0!==E)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else c(E,(p?"field":"method")+" decorators","return")&&(p?C.push(E):_[$]=E)}}finally{D.v=!0}}return(p||g)&&d.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||x||(u?g?d.push(a(_,"get"),a(_,"set")):d.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),E}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],c=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,w=!!(8&f),x=0==(f&=7),_=v+"/"+w;if(!x&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}d(w?e:e.prototype,g,y,m?"#"+v:ch(v),f,o,w?i=i||[]:s=s||[],a,w,m,x,1===f,w&&m?c:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(d(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function ch(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function dh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}class AppElement extends lit_element_r{static#e=(()=>[Qd,th,Xd]=lh(this,[[Jd,1,"popoverOpen"],[eh,1,"currentView"]],[],0,void 0,lit_element_r).e)();static[(Jd=Pe(),eh=je(),"styles")]=(()=>ve`
    :host {
      --gds-test-color: red;
    }
  `)();createRenderRoot(){return this}#n=(()=>(Xd(this),Qd(this,!1)))();get popoverOpen(){return this.#n}set popoverOpen(e){this.#n=e}#r=(()=>th(this,"dashboard"))();get currentView(){return this.#r}set currentView(e){this.#r=e}connectedCallback(){super.connectedCallback(),this.addEventListener("view-change",this.handleViewChange),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){this.removeEventListener("view-change",this.handleViewChange),document.removeEventListener("keydown",this.handleKeyDown),super.disconnectedCallback()}handleViewChange(e){this.currentView=e.detail.view}handleKeyDown=e=>{if("\\"===e.key){const e=this.querySelector('[gds-element="gds-theme"]');if(e){const t=e.getAttribute("color-scheme");e.setAttribute("color-scheme","light"===t?"dark":"light")}}};render(){return ut`
