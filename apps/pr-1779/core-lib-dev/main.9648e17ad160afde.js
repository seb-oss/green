...
`,hn=class extends qt{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then((()=>dn.instance.apply(this,"gds-menu-heading")))}render(){return ee`<slot></slot>`}};hn.styles=un,hn=et([lt("gds-menu-heading")],hn);const gn=(e,...t)=>({strTag:!0,strings:e,values:t}),pn=(e,t,r)=>{let o=e[0];for(let i=1;i<e.length;i++)o+=t[r?r[i-1]:i-1],o+=e[i];return o},fn=e=>{return"string"!=typeof(t=e)&&"strTag"in t?pn(e.strings,e.values):e;var t};let mn=fn,bn=!1;const vn="lit-localize-status";class LocalizeController{constructor(e){this.__litLocalizeEventHandler=e=>{"ready"===e.detail.status&&this.host.requestUpdate()},this.host=e}hostConnected(){window.addEventListener(vn,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(vn,this.__litLocalizeEventHandler)}}const yn=e=>e.addController(new LocalizeController(e)),xn=()=>(e,t)=>(e.addInitializer(yn),e);class Deferred{constructor(){this.settled=!1,this.promise=new Promise(((e,t)=>{this._resolve=e,this._reject=t}))}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}const wn=[];for(let jp=0;jp<256;jp++)wn[jp]=(jp>>4&15).toString(16)+(15&jp).toString(16);function kn(e,t){return(t?"h":"s")+function(e){let t=0,r=8997,o=0,i=33826,s=0,a=40164,l=0,c=52210;for(let d=0;d<e.length;d++)r^=e.charCodeAt(d),t=435*r,o=435*i,s=435*a,l=435*c,s+=r<<8,l+=i<<8,o+=t>>>16,r=65535&t,s+=o>>>16,i=65535&o,c=l+(s>>>16)&65535,a=65535&s;return wn[c>>8]+wn[255&c]+wn[a>>8]+wn[255&a]+wn[i>>8]+wn[255&i]+wn[r>>8]+wn[255&r]}("string"==typeof e?e:e.join("\x1e"))}const Cn=new WeakMap,_n=new Map;function $n(e,t,r){if(e){const o=r?.id??function(e){const t="string"==typeof e?e:e.strings;let r=_n.get(t);void 0===r&&(r=kn(t,"string"!=typeof e&&!("strTag"in e)),_n.set(t,r));return r}(t),i=e[o];if(i){if("string"==typeof i)return i;if("strTag"in i)return pn(i.strings,t.values,i.values);{let e=Cn.get(i);return void 0===e&&(e=i.values,Cn.set(i,e)),{...i,values:e.map((e=>t.values[e]))}}}}return fn(t)}function Sn(e){window.dispatchEvent(new CustomEvent(vn,{detail:e}))}let En,Tn,Mn,An,jn,zn="",On=new Deferred;On.resolve();let Ln=0;const Vn=e=>(function(e){if(bn)throw new Error("lit-localize can only be configured once");mn=e,bn=!0}(((e,t)=>$n(jn,e,t))),zn=Tn=e.sourceLocale,Mn=new Set(e.targetLocales),Mn.add(e.sourceLocale),An=e.loadLocale,{getLocale:Dn,setLocale:Pn}),Dn=()=>zn,Pn=e=>{if(e===(En??zn))return On.promise;if(!Mn||!An)throw new Error("Internal error");if(!Mn.has(e))throw new Error("Invalid locale code");Ln++;const t=Ln;En=e,On.settled&&(On=new Deferred),Sn({status:"loading",loadingLocale:e});return(e===Tn?Promise.resolve({templates:void 0}):An(e)).then((r=>{Ln===t&&(zn=e,En=void 0,jn=r.templates,Sn({status:"ready",readyLocale:e}),On.resolve())}),(r=>{Ln===t&&(Sn({status:"error",errorLocale:e,errorMessage:r.toString()}),On.reject(r))})),On.promise},Hn=1,Wn=2,Nn=6,Fn=e=>(...t)=>({_$litDirective$:e,values:t});class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Rn=Fn(class extends directive_i{constructor(e){if(super(e),e.type!==Hn||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const r=e.element.classList;for(const o of this.st)o in t||(r.remove(o),this.st.delete(o));for(const o in t){const e=!!t[o];e===this.st.has(o)||this.nt?.has(o)||(e?(r.add(o),this.st.add(o)):(r.remove(o),this.st.delete(o)))}return re}});var In,Bn,Zn,Un=be`
  @layer base, reset, transitional-styles;
  @layer base {
    button {
      display: flex;
...
`,mr=class extends(pr(qt)){constructor(){super(...arguments),rt(this,gr,(()=>{this.dispatchEvent(new CustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0}))}))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",(e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this.click())})),this.addEventListener("click",nt(this,gr)),dn.instance.apply(this,"gds-option")}render(){return ht`<div><slot></slot></div>`}};gr=new WeakMap,mr.styles=[fr],mr=et([lt("gds-menu-item")],mr);var br=class extends qt{constructor(){super(...arguments),this.show=!1}render(){return ht``}};function vr(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{attributes:!0,childList:!0,subtree:!1,characterData:!0};return(t,r,o)=>{let i;const s=t.connectedCallback,a=t.disconnectedCallback;t.connectedCallback=function(){null==s||s.call(this);i=new MutationObserver(((e,t)=>{var r;null==(r=o.value)||r.call(this)})),i.observe(this,e)},t.disconnectedCallback=function(){null==a||a.call(this),i.disconnect()}}}function yr(e,t){const r=Je({waitUntilFirstUpdate:!1},t);return(t,o,i)=>{const{update:s}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach((t=>{var o;const s=t;if(e.has(s)){const t=e.get(s),a=this[s];t!==a&&(r.waitUntilFirstUpdate&&!this.hasUpdated||null==(o=i.value)||o.call(this,t,a))}})),s.call(this,e)}}}br.styles=be`
  ...
  `,et([Pe({type:Boolean,reflect:!0})],br.prototype,"show",2),br=et([lt("gds-backdrop")],br);const xr=["top","right","bottom","left"],wr=Math.min,kr=Math.max,Cr=Math.round,_r=Math.floor,$r=e=>({x:e,y:e}),Sr={left:"right",right:"left",bottom:"top",top:"bottom"},Er={start:"end",end:"start"};function Tr(e,t,r){return kr(e,wr(t,r))}function Mr(e,t){return"function"==typeof e?e(t):e}function Ar(e){return e.split("-")[0]}function jr(e){return e.split("-")[1]}function zr(e){return"x"===e?"y":"x"}function Or(e){return"y"===e?"height":"width"}function Lr(e){return["top","bottom"].includes(Ar(e))?"y":"x"}function Vr(e){return zr(Lr(e))}function Dr(e){return e.replace(/start|end/g,(e=>Er[e]))}function Pr(e){return e.replace(/left|right|bottom|top/g,(e=>Sr[e]))}function Hr(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Wr(e){const{x:t,y:r,width:o,height:i}=e;return{width:o,height:i,top:r,left:t,right:t+o,bottom:r+i,x:t,y:r}}function Nr(e,t,r){let{reference:o,floating:i}=e;const s=Lr(t),a=Vr(t),l=Or(a),c=Ar(t),d="y"===s,u=o.x+o.width/2-i.width/2,h=o.y+o.height/2-i.height/2,g=o[l]/2-i[l]/2;let p;switch(c){case"top":p={x:u,y:o.y-i.height};break;case"bottom":p={x:u,y:o.y+o.height};break;case"right":p={x:o.x+o.width,y:h};break;case"left":p={x:o.x-i.width,y:h};break;default:p={x:o.x,y:o.y}}switch(jr(t)){case"start":p[a]-=g*(r&&d?-1:1);break;case"end":p[a]+=g*(r&&d?-1:1)}return p}async function Fr(e,t){var r;void 0===t&&(t={});const{x:o,y:i,platform:s,rects:a,elements:l,strategy:c}=e,{boundary:d="clippingAncestors",rootBoundary:u="viewport",elementContext:h="floating",altBoundary:g=!1,padding:p=0}=Mr(t,e),f=Hr(p),m=l[g?"floating"===h?"reference":"floating":h],v=Wr(await s.getClippingRect({element:null==(r=await(null==s.isElement?void 0:s.isElement(m)))||r?m:m.contextElement||await(null==s.getDocumentElement?void 0:s.getDocumentElement(l.floating)),boundary:d,rootBoundary:u,strategy:c})),y="floating"===h?{x:o,y:i,width:a.floating.width,height:a.floating.height}:a.reference,x=await(null==s.getOffsetParent?void 0:s.getOffsetParent(l.floating)),w=await(null==s.isElement?void 0:s.isElement(x))&&await(null==s.getScale?void 0:s.getScale(x))||{x:1,y:1},C=Wr(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:y,offsetParent:x,strategy:c}):y);return{top:(v.top-C.top+f.top)/w.y,bottom:(C.bottom-v.bottom+f.bottom)/w.y,left:(v.left-C.left+f.left)/w.x,right:(C.right-v.right+f.right)/w.x}}function Rr(e,t){return{top:e.top-t.height,right:e.right-t.width,bottom:e.bottom-t.height,left:e.left-t.width}}function Ir(e){return xr.some((t=>e[t]>=0))}function Br(){return"undefined"!=typeof window}function Zr(e){return Yr(e)?(e.nodeName||"").toLowerCase():"#document"}function Ur(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Gr(e){var t;return null==(t=(Yr(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Yr(e){return!!Br()&&(e instanceof Node||e instanceof Ur(e).Node)}function qr(e){return!!Br()&&(e instanceof Element||e instanceof Ur(e).Element)}function Kr(e){return!!Br()&&(e instanceof HTMLElement||e instanceof Ur(e).HTMLElement)}function Xr(e){return!(!Br()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof Ur(e).ShadowRoot)}function Jr(e){const{overflow:t,overflowX:r,overflowY:o,display:i}=oo(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+r)&&!["inline","contents"].includes(i)}function Qr(e){return["table","td","th"].includes(Zr(e))}function eo(e){return[":popover-open",":modal"].some((t=>{try{return e.matches(t)}catch(i){return!1}}))}function to(e){const t=no(),r=qr(e)?oo(e):e;return"none"!==r.transform||"none"!==r.perspective||!!r.containerType&&"normal"!==r.containerType||!t&&!!r.backdropFilter&&"none"!==r.backdropFilter||!t&&!!r.filter&&"none"!==r.filter||["transform","perspective","filter"].some((e=>(r.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(r.contain||"").includes(e)))}function no(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function ro(e){return["html","body","#document"].includes(Zr(e))}function oo(e){return Ur(e).getComputedStyle(e)}function io(e){return qr(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function so(e){if("html"===Zr(e))return e;const t=e.assignedSlot||e.parentNode||Xr(e)&&e.host||Gr(e);return Xr(t)?t.host:t}function ao(e){const t=so(e);return ro(t)?e.ownerDocument?e.ownerDocument.body:e.body:Kr(t)&&Jr(t)?t:ao(t)}function lo(e,t,r){var o;void 0===t&&(t=[]),void 0===r&&(r=!0);const i=ao(e),s=i===(null==(o=e.ownerDocument)?void 0:o.body),a=Ur(i);if(s){const e=co(a);return t.concat(a,a.visualViewport||[],Jr(i)?i:[],e&&r?lo(e):[])}return t.concat(i,lo(i,[],r))}function co(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function uo(e){const t=oo(e);let r=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const i=Kr(e),s=i?e.offsetWidth:r,a=i?e.offsetHeight:o,l=Cr(r)!==s||Cr(o)!==a;return l&&(r=s,o=a),{width:r,height:o,$:l}}function ho(e){return qr(e)?e:e.contextElement}function go(e){const t=ho(e);if(!Kr(t))return $r(1);const r=t.getBoundingClientRect(),{width:o,height:i,$:s}=uo(t);let a=(s?Cr(r.width):r.width)/o,l=(s?Cr(r.height):r.height)/i;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const po=$r(0);function fo(e){const t=Ur(e);return no()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:po}function mo(e,t,r,o){void 0===t&&(t=!1),void 0===r&&(r=!1);const i=e.getBoundingClientRect(),s=ho(e);let a=$r(1);t&&(o?qr(o)&&(a=go(o)):a=go(e));const l=function(e,t,r){return void 0===t&&(t=!1),!(!r||t&&r!==Ur(e))&&t}(s,r,o)?fo(s):$r(0);let c=(i.left+l.x)/a.x,d=(i.top+l.y)/a.y,u=i.width/a.x,h=i.height/a.y;if(s){const e=Ur(s),t=o&&qr(o)?Ur(o):o;let r=e,i=co(r);for(;i&&o&&t!==r;){const e=go(i),t=i.getBoundingClientRect(),o=oo(i),s=t.left+(i.clientLeft+parseFloat(o.paddingLeft))*e.x,a=t.top+(i.clientTop+parseFloat(o.paddingTop))*e.y;c*=e.x,d*=e.y,u*=e.x,h*=e.y,c+=s,d+=a,r=Ur(i),i=co(r)}}return Wr({width:u,height:h,x:c,y:d})}function bo(e,t){const r=io(e).scrollLeft;return t?t.left+r:mo(Gr(e)).left+r}function vo(e,t,r){void 0===r&&(r=!1);const o=e.getBoundingClientRect();return{x:o.left+t.scrollLeft-(r?0:bo(e,o)),y:o.top+t.scrollTop}}function yo(e,t,r){let o;if("viewport"===t)o=function(e,t){const r=Ur(e),o=Gr(e),i=r.visualViewport;let s=o.clientWidth,a=o.clientHeight,l=0,c=0;if(i){s=i.width,a=i.height;const e=no();(!e||e&&"fixed"===t)&&(l=i.offsetLeft,c=i.offsetTop)}return{width:s,height:a,x:l,y:c}}(e,r);else if("document"===t)o=function(e){const t=Gr(e),r=io(e),o=e.ownerDocument.body,i=kr(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),s=kr(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let a=-r.scrollLeft+bo(e);const l=-r.scrollTop;return"rtl"===oo(o).direction&&(a+=kr(t.clientWidth,o.clientWidth)-i),{width:i,height:s,x:a,y:l}}(Gr(e));else if(qr(t))o=function(e,t){const r=mo(e,!0,"fixed"===t),o=r.top+e.clientTop,i=r.left+e.clientLeft,s=Kr(e)?go(e):$r(1);return{width:e.clientWidth*s.x,height:e.clientHeight*s.y,x:i*s.x,y:o*s.y}}(t,r);else{const r=fo(e);o={x:t.x-r.x,y:t.y-r.y,width:t.width,height:t.height}}return Wr(o)}function xo(e,t){const r=so(e);return!(r===t||!qr(r)||ro(r))&&("fixed"===oo(r).position||xo(r,t))}function wo(e,t,r){const o=Kr(t),i=Gr(t),s="fixed"===r,a=mo(e,!0,s,t);let l={scrollLeft:0,scrollTop:0};const c=$r(0);if(o||!o&&!s)if(("body"!==Zr(t)||Jr(i))&&(l=io(t)),o){const e=mo(t,!0,s,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&(c.x=bo(i));const d=!i||o||s?$r(0):vo(i,l);return{x:a.left+l.scrollLeft-c.x-d.x,y:a.top+l.scrollTop-c.y-d.y,width:a.width,height:a.height}}function ko(e){return"static"===oo(e).position}function Co(e,t){if(!Kr(e)||"fixed"===oo(e).position)return null;if(t)return t(e);let r=e.offsetParent;return Gr(e)===r&&(r=r.ownerDocument.body),r}function _o(e,t){const r=Ur(e);if(eo(e))return r;if(!Kr(e)){let t=so(e);for(;t&&!ro(t);){if(qr(t)&&!ko(t))return t;t=so(t)}return r}let o=Co(e,t);for(;o&&Qr(o)&&ko(o);)o=Co(o,t);return o&&ro(o)&&ko(o)&&!to(o)?r:o||function(e){let t=so(e);for(;Kr(t)&&!ro(t);){if(to(t))return t;if(eo(t))return null;t=so(t)}return null}(e)||r}const $o={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:r,offsetParent:o,strategy:i}=e;const s="fixed"===i,a=Gr(o),l=!!t&&eo(t.floating);if(o===a||l&&s)return r;let c={scrollLeft:0,scrollTop:0},d=$r(1);const u=$r(0),h=Kr(o);if((h||!h&&!s)&&(("body"!==Zr(o)||Jr(a))&&(c=io(o)),Kr(o))){const e=mo(o);d=go(o),u.x=e.x+o.clientLeft,u.y=e.y+o.clientTop}const g=!a||h||s?$r(0):vo(a,c,!0);return{width:r.width*d.x,height:r.height*d.y,x:r.x*d.x-c.scrollLeft*d.x+u.x+g.x,y:r.y*d.y-c.scrollTop*d.y+u.y+g.y}},getDocumentElement:Gr,getClippingRect:function(e){let{element:t,boundary:r,rootBoundary:o,strategy:i}=e;const s=[..."clippingAncestors"===r?eo(t)?[]:function(e,t){const r=t.get(e);if(r)return r;let o=lo(e,[],!1).filter((e=>qr(e)&&"body"!==Zr(e))),i=null;const s="fixed"===oo(e).position;let a=s?so(e):e;for(;qr(a)&&!ro(a);){const t=oo(a),r=to(a);r||"fixed"!==t.position||(i=null),(s?!r&&!i:!r&&"static"===t.position&&i&&["absolute","fixed"].includes(i.position)||Jr(a)&&!r&&xo(e,a))?o=o.filter((e=>e!==a)):i=t,a=so(a)}return t.set(e,o),o}(t,this._c):[].concat(r),o],a=s[0],l=s.reduce(((e,r)=>{const o=yo(t,r,i);return e.top=kr(o.top,e.top),e.right=wr(o.right,e.right),e.bottom=wr(o.bottom,e.bottom),e.left=kr(o.left,e.left),e}),yo(t,a,i));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:_o,getElementRects:async function(e){const t=this.getOffsetParent||_o,r=this.getDimensions,o=await r(e.floating);return{reference:wo(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:r}=uo(e);return{width:t,height:r}},getScale:go,isElement:qr,isRTL:function(e){return"rtl"===oo(e).direction}};function So(e,t,r,o){void 0===o&&(o={});const{ancestorScroll:s=!0,ancestorResize:a=!0,elementResize:l="function"==typeof ResizeObserver,layoutShift:c="function"==typeof IntersectionObserver,animationFrame:d=!1}=o,u=ho(e),h=s||a?[...u?lo(u):[],...lo(t)]:[];h.forEach((e=>{s&&e.addEventListener("scroll",r,{passive:!0}),a&&e.addEventListener("resize",r)}));const g=u&&c?function(e,t){let r,o=null;const s=Gr(e);function a(){var e;clearTimeout(r),null==(e=o)||e.disconnect(),o=null}return function l(c,d){void 0===c&&(c=!1),void 0===d&&(d=1),a();const{left:u,top:h,width:g,height:p}=e.getBoundingClientRect();if(c||t(),!g||!p)return;const f={rootMargin:-_r(h)+"px "+-_r(s.clientWidth-(u+g))+"px "+-_r(s.clientHeight-(h+p))+"px "+-_r(u)+"px",threshold:kr(0,wr(1,d))||1};let m=!0;function v(e){const t=e[0].intersectionRatio;if(t!==d){if(!m)return l();t?l(!1,t):r=setTimeout((()=>{l(!1,1e-7)}),1e3)}m=!1}try{o=new IntersectionObserver(v,{...f,root:s.ownerDocument})}catch(i){o=new IntersectionObserver(v,f)}o.observe(e)}(!0),a}(u,r):null;let p,f=-1,m=null;l&&(m=new ResizeObserver((e=>{let[o]=e;o&&o.target===u&&m&&(m.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame((()=>{var e;null==(e=m)||e.observe(t)}))),r()})),u&&!d&&m.observe(u),m.observe(t));let v=d?mo(e):null;return d&&function t(){const o=mo(e);!v||o.x===v.x&&o.y===v.y&&o.width===v.width&&o.height===v.height||r();v=o,p=requestAnimationFrame(t)}(),r(),()=>{var e;h.forEach((e=>{s&&e.removeEventListener("scroll",r),a&&e.removeEventListener("resize",r)})),null==g||g(),null==(e=m)||e.disconnect(),m=null,d&&cancelAnimationFrame(p)}}const Eo=Fr,To=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var r,o;const{x:i,y:s,placement:a,middlewareData:l}=t,c=await async function(e,t){const{placement:r,platform:o,elements:i}=e,s=await(null==o.isRTL?void 0:o.isRTL(i.floating)),a=Ar(r),l=jr(r),c="y"===Lr(r),d=["left","top"].includes(a)?-1:1,u=s&&c?-1:1,h=Mr(t,e);let{mainAxis:g,crossAxis:p,alignmentAxis:f}="number"==typeof h?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:h.mainAxis||0,crossAxis:h.crossAxis||0,alignmentAxis:h.alignmentAxis};return l&&"number"==typeof f&&(p="end"===l?-1*f:f),c?{x:p*u,y:g*d}:{x:g*d,y:p*u}}(t,e);return a===(null==(r=l.offset)?void 0:r.placement)&&null!=(o=l.arrow)&&o.alignmentOffset?{}:{x:i+c.x,y:s+c.y,data:{...c,placement:a}}}}},Mo=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:r,y:o,placement:i}=t,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:r}=e;return{x:t,y:r}}},...c}=Mr(e,t),d={x:r,y:o},u=await Fr(t,c),h=Lr(Ar(i)),g=zr(h);let p=d[g],f=d[h];if(s){const e="y"===g?"bottom":"right";p=Tr(p+u["y"===g?"top":"left"],p,p-u[e])}if(a){const e="y"===h?"bottom":"right";f=Tr(f+u["y"===h?"top":"left"],f,f-u[e])}const m=l.fn({...t,[g]:p,[h]:f});return{...m,data:{x:m.x-r,y:m.y-o,enabled:{[g]:s,[h]:a}}}}}},Ao=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var r,o;const{placement:i,middlewareData:s,rects:a,initialPlacement:l,platform:c,elements:d}=t,{mainAxis:u=!0,crossAxis:h=!0,fallbackPlacements:g,fallbackStrategy:p="bestFit",fallbackAxisSideDirection:f="none",flipAlignment:m=!0,...v}=Mr(e,t);if(null!=(r=s.arrow)&&r.alignmentOffset)return{};const y=Ar(i),x=Lr(l),w=Ar(l)===l,C=await(null==c.isRTL?void 0:c.isRTL(d.floating)),_=g||(w||!m?[Pr(l)]:function(e){const t=Pr(e);return[Dr(e),t,Dr(t)]}(l)),$="none"!==f;!g&&$&&_.push(...function(e,t,r,o){const i=jr(e);let s=function(e,t,r){const o=["left","right"],i=["right","left"],s=["top","bottom"],a=["bottom","top"];switch(e){case"top":case"bottom":return r?t?i:o:t?o:i;case"left":case"right":return t?s:a;default:return[]}}(Ar(e),"start"===r,o);return i&&(s=s.map((e=>e+"-"+i)),t&&(s=s.concat(s.map(Dr)))),s}(l,m,f,C));const S=[l,..._],E=await Fr(t,v),T=[];let A=(null==(o=s.flip)?void 0:o.overflows)||[];if(u&&T.push(E[y]),h){const e=function(e,t,r){void 0===r&&(r=!1);const o=jr(e),i=Vr(e),s=Or(i);let a="x"===i?o===(r?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[s]>t.floating[s]&&(a=Pr(a)),[a,Pr(a)]}(i,a,C);T.push(E[e[0]],E[e[1]])}if(A=[...A,{placement:i,overflows:T}],!T.every((e=>e<=0))){var j,O;const e=((null==(j=s.flip)?void 0:j.index)||0)+1,t=S[e];if(t)return{data:{index:e,overflows:A},reset:{placement:t}};let r=null==(O=A.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:O.placement;if(!r)switch(p){case"bestFit":{var V;const e=null==(V=A.filter((e=>{if($){const t=Lr(e.placement);return t===x||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:V[0];e&&(r=e);break}case"initialPlacement":r=l}if(i!==r)return{reset:{placement:r}}}return{}}}},jo=function(e){return void 0===e&&(e={}),{name:"hide",options:e,async fn(t){const{rects:r}=t,{strategy:o="referenceHidden",...i}=Mr(e,t);switch(o){case"referenceHidden":{const e=Rr(await Fr(t,{...i,elementContext:"reference"}),r.reference);return{data:{referenceHiddenOffsets:e,referenceHidden:Ir(e)}}}case"escaped":{const e=Rr(await Fr(t,{...i,altBoundary:!0}),r.floating);return{data:{escapedOffsets:e,escaped:Ir(e)}}}default:return{}}}}},zo=e=>({name:"arrow",options:e,async fn(t){const{x:r,y:o,placement:i,rects:s,platform:a,elements:l,middlewareData:c}=t,{element:d,padding:u=0}=Mr(e,t)||{};if(null==d)return{};const h=Hr(u),g={x:r,y:o},p=Vr(i),f=Or(p),m=await a.getDimensions(d),v="y"===p,y=v?"top":"left",x=v?"bottom":"right",w=v?"clientHeight":"clientWidth",C=s.reference[f]+s.reference[p]-g[p]-s.floating[f],_=g[p]-s.reference[p],$=await(null==a.getOffsetParent?void 0:a.getOffsetParent(d));let S=$?$[w]:0;S&&await(null==a.isElement?void 0:a.isElement($))||(S=l.floating[w]||s.floating[f]);const E=C/2-_/2,T=S/2-m[f]/2-1,A=wr(h[y],T),j=wr(h[x],T),O=A,V=S-m[f]-j,D=S/2-m[f]/2+E,P=Tr(O,D,V),W=!c.arrow&&null!=jr(i)&&D!==P&&s.reference[f]/2-(D<O?A:j)-m[f]/2<0,F=W?D<O?D-O:D-V:0;return{[p]:g[p]+F,data:{[p]:P,centerOffset:D-P-F,...W&&{alignmentOffset:F}},reset:W}}}),Oo=(e,t,r)=>{const o=new Map,i={platform:$o,...r},s={...i.platform,_c:o};return(async(e,t,r)=>{const{placement:o="bottom",strategy:i="absolute",middleware:s=[],platform:a}=r,l=s.filter(Boolean),c=await(null==a.isRTL?void 0:a.isRTL(t));let d=await a.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:h}=Nr(d,o,c),g=o,p={},f=0;for(let m=0;m<l.length;m++){const{name:r,fn:s}=l[m],{x:v,y,data:x,reset:w}=await s({x:u,y:h,initialPlacement:o,placement:g,strategy:i,middlewareData:p,rects:d,platform:a,elements:{reference:e,floating:t}});u=null!=v?v:u,h=null!=y?y:h,p={...p,[r]:{...p[r],...x}},w&&f<=50&&(f++,"object"==typeof w&&(w.placement&&(g=w.placement),w.rects&&(d=!0===w.rects?await a.getElementRects({reference:e,floating:t,strategy:i}):w.rects),({x:u,y:h}=Nr(d,g,c))),m=-1)}return{x:u,y:h,placement:g,strategy:i,middlewareData:p}})(e,t,{...i,platform:s})};var Lo,Vo,Do,Po,Ho,Wo,No,Fo,Ro,Io,Bo,Zo,Uo,Go,Yo,qo,Ko,Xo,Jo,Qo,ei,ti=be`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: contents;
...
`,ni=class extends qt{constructor(){super(...arguments),rt(this,Lo),rt(this,Ro),rt(this,Bo),rt(this,Uo),rt(this,Yo),this.open=!1,this.popupRole="dialog",this.label=void 0,this.placement="bottom-start",this.disableMobileStyles=!1,this.calcMinWidth=e=>`${e.offsetWidth}px`,this.calcMaxWidth=e=>"auto",this.calcMinHeight=e=>"auto",this.calcMaxHeight=e=>"500px",this.nonmodal=!1,this.floatingUIMiddleware=[To(8),Ao()],this._trigger=void 0,this._anchor=void 0,this._isVirtKbVisible=!1,rt(this,Do,void 0),rt(this,Po,!1),rt(this,Ho,void 0),rt(this,Wo,(()=>{this.open=!1,nt(this,No).call(this,"cancel")})),rt(this,No,(e=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:this.open,reason:e},bubbles:!1,composed:!1}))})),rt(this,Fo,(e=>{e.stopPropagation(),e.preventDefault(),this.open=!1,nt(this,No).call(this,"close"),setTimeout((()=>{var e;return null==(e=this._trigger)?void 0:e.focus()}),250)})),rt(this,Ko,(e=>{"ArrowDown"!==e.key&&"ArrowUp"!==e.key||(e.preventDefault(),this.open=!0,nt(this,No).call(this,"show")),"Escape"===e.key&&this.open&&nt(this,Wo).call(this)})),rt(this,Xo,(e=>{e.preventDefault(),this.open=!this.open,nt(this,No).call(this,this.open?"show":"close")})),rt(this,Jo,(()=>{var e;const t=null==(e=this._elDefaultSlot)?void 0:e.assignedElements()[0];this.updateComplete.then((()=>{null==t||t.focus()}))})),rt(this,Qo,(e=>{const t=e,r=this._elDialog;if((t.clientX>0||t.clientY>0)&&r&&this.open){const e=r.getBoundingClientRect();e.top<=t.clientY&&t.clientY<=e.top+e.height&&e.left<=t.clientX&&t.clientX<=e.left+e.width||(this.open=!1,nt(this,No).call(this,"close"))}}))}_handleTriggerRefChanged(){var e;null==(e=this.triggerRef)||e.then((e=>{e&&(this._trigger=e)}))}_handleAnchorRefChanged(){var e;null==(e=this.anchorRef)||e.then((e=>{e&&(this._anchor=e)}))}_handleTriggerChanged(){it(this,Ro,Io).call(this),it(this,Uo,Go).call(this)}_handleAnchorChanged(){it(this,Yo,qo).call(this)}connectedCallback(){super.connectedCallback(),dn.instance.apply(this,"gds-popover"),it(this,Ro,Io).call(this),this._handleOpenChange(),this.addEventListener("keydown",(e=>{"Escape"===e.key&&this.open&&(nt(this,Wo).call(this),e.stopPropagation(),e.preventDefault())})),this.addEventListener("focusin",(e=>{const t=e.target;"INPUT"===t.tagName||"TEXTAREA"===t.tagName?this._isVirtKbVisible=!0:this._isVirtKbVisible=!1})),this.addEventListener("blurin",(e=>{this._isVirtKbVisible=!1}))}disconnectedCallback(){super.disconnectedCallback(),it(this,Bo,Zo).call(this)}render(){return ht`<slot
        name="trigger"
        @slotchange=${it(this,Lo,Vo)}
      ></slot>
...
`,rs=class extends xi{constructor(){super(),rt(this,Vi),rt(this,Pi),rt(this,Bi),rt(this,Ui),rt(this,Yi),rt(this,Ki),rt(this,Ji),rt(this,es),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",this.trailSlotOccupied=!1,rt(this,Wi,(e=>["type","placeholder","required"].includes(e.name))),rt(this,Ni,(e=>{const t=e.target;this.value=t.value})),rt(this,Fi,(e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})),rt(this,Ri,(()=>{this.elInputAsync.then((e=>e.focus()))})),rt(this,Ii,(()=>{this.value=""}))}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return ht`${Ie(this.variant,[["default",()=>it(this,Vi,Di).call(this)],["floating-label",()=>it(this,Pi,Hi).call(this)]])}`}_getValidityAnchor(){return this.elInput}};Vi=new WeakSet,Di=function(){return ht`
      ...
      >
        ${it(this,Bi,Zi).call(this)} ${it(this,Ki,Xi).call(this)}
        <gds-flex gap="xs" align-items="center">
          ${it(this,Ji,Qi).call(this)} ${it(this,Ui,Gi).call(this)}
        </gds-flex>
      </gds-flex>
      ...
      ></gds-form-control-footer>
    `},Pi=new WeakSet,Hi=function(){return oe},Wi=new WeakMap,Ni=new WeakMap,Fi=new WeakMap,Ri=new WeakMap,Ii=new WeakMap,Bi=new WeakSet,Zi=function(){return ht` <slot name="lead"></slot> `},Ui=new WeakSet,Gi=function(){return ht`
    ...
    `},Ji=new WeakSet,Qi=function(){return this.clearable&&this.value.length>0?ht`
      ...
      `:oe},es=new WeakSet,ts=function(){return this.maxlength<Number.MAX_SAFE_INTEGER},rs.styles=[Yt,ns],et([Pe()],rs.prototype,"value",2),et([Pe()],rs.prototype,"label",2),et([Pe({attribute:"supporting-text"})],rs.prototype,"supportingText",2),et([Pe({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],rs.prototype,"showExtendedSupportingText",2),et([Pe({attribute:"disabled",type:Boolean,reflect:!0})],rs.prototype,"disabled",2),et([Pe({type:Boolean})],rs.prototype,"clearable",2),et([Pe({type:Number})],rs.prototype,"maxlength",2),et([Pe({type:String})],rs.prototype,"variant",2),et([Pe({type:String})],rs.prototype,"size",2),et([Re("input")],rs.prototype,"elInputAsync",2),et([Ne("input")],rs.prototype,"elInput",2),et([He()],rs.prototype,"trailSlotOccupied",2),rs=et([lt("gds-input"),xn()],rs);var os,is,ss,as,ls,cs,ds=be`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`,us=class extends qt{constructor(){super(...arguments),rt(this,os),rt(this,ls),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,rt(this,ss,(()=>ht`
    ...
    `},us.styles=[ds],et([Pe({type:Boolean,reflect:!0})],us.prototype,"showExtendedSupportingText",2),et([He()],us.prototype,"_hasExtendedSupportingText",2),et([Ne("#extended-supporting-text")],us.prototype,"_extendedSupportingText",2),us=et([lt("gds-form-control-header"),xn()],us);var hs,gs,ps=be`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`,As=class extends qt{constructor(){super(),rt(this,ws),rt(this,Cs),rt(this,$s),rt(this,Es),this.variant="information",this.size="default",this.disabled=!1,this.notification=!1,this.mainSlotOccupied=!1}render(){const e=this.disabled?"disabled":this.notification?this.variant:this.variant+"-badge",t=this.disabled?"disabled":this.notification?"primary":this.variant,r="small"===this.size||this.notification?"2xs":"xs",o=this.mainSlotOccupied?"small"===this.size||this.notification?"m":"l":"xs";return ht`<gds-flex
    ...
    >
      ${it(this,ws,ks).call(this)} ${it(this,Cs,_s).call(this)}
      ${it(this,Es,Ts).call(this)}
    </gds-flex>`}};ws=new WeakSet,ks=function(){if("small"!==this.size||!this.notification)return ht`<slot name="lead"></slot>`},Cs=new WeakSet,_s=function(){return ht`<slot @slotchange=${it(this,$s,Ss)}></slot>`},$s=new WeakSet,Ss=function(e){const t=e.target.assignedNodes({flatten:!0});this.mainSlotOccupied=t.length>0&&t.some((e=>{var t;return e.nodeType===Node.ELEMENT_NODE||e.nodeType===Node.TEXT_NODE&&""!==(null==(t=e.textContent)?void 0:t.trim())}))},Es=new WeakSet,Ts=function(){return ht`<slot name="trail"></slot>`},As.styles=[Yt,Ms],et([Pe()],As.prototype,"variant",2),et([Pe({type:String})],As.prototype,"size",2),et([Pe({attribute:"disabled",type:Boolean,reflect:!0})],As.prototype,"disabled",2),et([Pe({attribute:"notification",type:Boolean,reflect:!0})],As.prototype,"notification",2),et([He()],As.prototype,"mainSlotOccupied",2),As=et([lt("gds-badge")],As);var js=class extends lit_element_r{constructor(){super(...arguments),this.onmousedown=e=>{const t=e.target.getBoundingClientRect(),r=this._rippleEl;r&&(r.classList.remove("gds-ripple-effect"),this.style.setProperty("--gds-ripple-top",e.clientY-t.top+"px"),this.style.setProperty("--gds-ripple-left",e.clientX-t.left+"px"),setTimeout((()=>{r.classList.add("gds-ripple-effect")}),20))}}render(){return ee`<div></div>`}};js.styles=[Yt,me(":host {\n  --gds-ripple-motion-name: ripple;\n  --gds-ripple-motion: var(--gds-ripple-motion-name) 1.2s\n    cubic-bezier(0.46, 0.03, 0.52, 0.96) 0s 1 normal none running;\n  border-radius: var(--gds-space-max);\n  contain: strict;\n  display: flex;\n  height: 100%;\n  inset: 0;\n  overflow: hidden;\n  position: absolute;\n  width: 100%;\n}\n\ndiv {\n  background-color: currentColor;\n  border-radius: var(--gds-space-max);\n  display: flex;\n  height: 20px;\n  left: var(--gds-ripple-left, 50%);\n  margin-left: -10px;\n  margin-top: -10px;\n  opacity: 0;\n  pointer-events: none;\n  position: absolute;\n  top: var(--gds-ripple-top, 50%);\n  width: 20px;\n  will-change: transform;\n}\n\ndiv.gds-ripple-effect {\n  animation: var(--gds-ripple-motion);\n}\n\n@keyframes ripple {\n  from {\n    opacity: 0.5;\n    transform: scale(0);\n  }\n  to {\n    opacity: 0;\n    transform: scale(calc(3 * var(--mt-ripple-spread, 4)));\n  }\n}\n@media (prefers-reduced-motion: reduce) {\n  :host {\n    --gds-ripple-motion-name: none !important;\n  }\n}")],et([Ne("div")],js.prototype,"_rippleEl",2),js=et([lt("gds-ripple")],js);var zs=class extends qt{constructor(){super(...arguments),this.colorScheme="light",this.designVersion="2016"}connectedCallback(){super.connectedCallback(),dn.instance.apply(this,"gds-theme"),this._dynamicStylesController.inject("dark",me(`:host {${Ut}}`))}render(){return ht`<slot></slot>`}_onColorSchemeChange(){"dark"===this.colorScheme?this._dynamicStylesController.inject("dark",me(`:host { ${Ut}}`)):this._dynamicStylesController.inject("light",me(`:host { ${Gt}}`)),this.dispatchEvent(new CustomEvent("gds-color-scheme-changed",{detail:{colorScheme:this.colorScheme}}))}_onDesignVersionChange(){this.dispatchEvent(new CustomEvent("gds-design-version-changed",{detail:{designVersion:this.designVersion}}))}};zs.styles=be`
    :host {
      display: contents;
    }
  `,et([Pe({reflect:!0,attribute:"color-scheme"})],zs.prototype,"colorScheme",2),et([Pe({reflect:!0,attribute:"design-version"})],zs.prototype,"designVersion",2),et([yr("colorScheme")],zs.prototype,"_onColorSchemeChange",1),et([yr("designVersion")],zs.prototype,"_onDesignVersionChange",1),zs=et([lt("gds-theme")],zs);var Os=be`
  :host {
    --_c: 12;
...
`,Ls=class extends Xt{constructor(){super(),this.display="grid",this.width="100%"}render(){return ht`<slot></slot>`}};Ls.styles=[Yt,Os],et([Lt({property:"--_c",valueTemplate:e=>e})],Ls.prototype,"columns",2),et([Lt({styleTemplate:(e,t)=>{const r=t[0];return`--_gap-column: ${t[1]||r}; --_gap-row: ${r};`}})],Ls.prototype,"gap",2),et([Lt({property:"--_col-width",valueTemplate:e=>`${e}px`})],Ls.prototype,"auto-columns",2),Ls=et([lt("gds-grid")],Ls);var Vs,Ds,Ps=be`
  @layer core, link;
...
`,Hs=class extends qt{constructor(){super(),rt(this,Vs),this.href="",this.variant="default"}render(){const e={secondary:"secondary"===this.variant,hidden:"hidden"===this.variant};return rn`
      <a
        href=${wi(this.href)}
        target=${wi(this.target)}
        rel=${wi(this.rel||nt(this,Vs,Ds))}
    ...
    `}};Vs=new WeakSet,Ds=function(){return"_blank"===this.target?"noreferrer noopener":void 0},Hs.styles=[Yt,me(Ps)],Hs.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Pe()],Hs.prototype,"href",2),et([Pe()],Hs.prototype,"target",2),et([Pe()],Hs.prototype,"rel",2),et([Pe()],Hs.prototype,"download",2),et([Pe()],Hs.prototype,"variant",2),Hs=et([lt("gds-link")],Hs);var Ws=be`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`,Rs=class extends qt{applyVideoSettings(){this.videoElement&&(this.videoElement.src=this.src||"",this.videoElement.poster=this.poster||"",this.videoElement.muted=this.muted||!1,this.videoElement.autoplay=this.autoplay||!1,this.videoElement.loop=this.loop||!1,this.videoElement.playsInline=this.playsinline||!1)}render(){return ht`<video></video>`}firstUpdated(){this.applyVideoSettings()}};Rs.styles=[Yt,Fs],et([Lt({property:"aspect-ratio",valueTemplate:e=>e})],Rs.prototype,"aspect-ratio",2),et([Lt({property:"object-position",selector:"video",valueTemplate:e=>e})],Rs.prototype,"object-position",2),et([Lt({property:"inset",valueTemplate:e=>e})],Rs.prototype,"inset",2),et([Lt({property:"width",valueTemplate:e=>e})],Rs.prototype,"width",2),et([Lt({property:"height",valueTemplate:e=>e})],Rs.prototype,"height",2),et([Lt({property:"opacity",valueTemplate:e=>e})],Rs.prototype,"opacity",2),et([Lt({property:"object-fit",selector:"video",valueTemplate:e=>e})],Rs.prototype,"object-fit",2),et([Lt({property:"pointer-events",selector:"video",valueTemplate:e=>e})],Rs.prototype,"pointer-events",2),et([Lt({property:"border-radius",valueTemplate:e=>`var(--gds-space-${e})`})],Rs.prototype,"border-radius",2),et([Pe()],Rs.prototype,"src",2),et([Pe()],Rs.prototype,"poster",2),et([Pe({type:Boolean})],Rs.prototype,"muted",2),et([Pe({type:Boolean})],Rs.prototype,"playsinline",2),et([Pe({type:Boolean})],Rs.prototype,"autoplay",2),et([Pe({type:Boolean})],Rs.prototype,"loop",2),et([Ne("video")],Rs.prototype,"videoElement",2),Rs=et([lt("gds-video")],Rs);var Is,Bs,Zs,Us,Gs=be`
...
`,Ys=class extends qt{constructor(){super(),rt(this,Is),rt(this,Zs),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const e={button:!0,selected:this.selected,compact:this.compact},t=nt(this,Is,Bs)?en`a`:en`button`;return rn`
      <${t}
        class="${Rn(e)}"
        ?disabled="${this.disabled}"
        ...
        rel=${wi(nt(this,Is,Bs)?this.rel||nt(this,Zs,Us):void 0)}
    ...
    `}static#t=(()=>ga())()}var xa={fromAttribute:e=>new Date(e),toAttribute:e=>e.toISOString()},wa={fromAttribute:e=>e.split(",").map((e=>new Date(e.trim()))),toAttribute:e=>JSON.stringify(e.map((e=>e.toISOString())))};const ka=(e,t,r)=>{const o=new Map;for(let i=t;i<=r;i++)o.set(e[i],i);return o},Ca=Fn(class extends directive_i{constructor(e){if(super(e),e.type!==Wn)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let o;void 0===r?r=t:void 0!==t&&(o=t);const i=[],s=[];let a=0;for(const l of e)i[a]=o?o(l,a):a,s[a]=r(l,a),a++;return{values:s,keys:i}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,o]){const i=(e=>e._$AH)(e),{values:s,keys:a}=this.dt(t,r,o);if(!Array.isArray(i))return this.ut=a,s;const l=this.ut??=[],c=[];let d,u,h=0,g=i.length-1,p=0,f=s.length-1;for(;h<=g&&p<=f;)if(null===i[h])h++;else if(null===i[g])g--;else if(l[h]===a[p])c[p]=Qn(i[h],s[p]),h++,p++;else if(l[g]===a[f])c[f]=Qn(i[g],s[f]),g--,f--;else if(l[h]===a[f])c[f]=Qn(i[h],s[f]),Jn(e,c[f+1],i[h]),h++,f--;else if(l[g]===a[p])c[p]=Qn(i[g],s[p]),Jn(e,i[h],i[g]),g--,p++;else if(void 0===d&&(d=ka(a,p,f),u=ka(l,h,g)),d.has(l[h]))if(d.has(l[g])){const t=u.get(a[p]),r=void 0!==t?i[t]:null;if(null===r){const t=Jn(e,i[h]);Qn(t,s[p]),c[p]=t}else c[p]=Qn(r,s[p]),Jn(e,i[h],r),i[t]=null;p++}else tr(i[g]),g--;else tr(i[h]),h++;for(;p<=f;){const t=Jn(e,c[f+1]);Qn(t,s[p]),c[p++]=t}for(;h<=g;){const e=i[h++];null!==e&&tr(e)}return this.ut=a,((e,t=er)=>{e._$AH=t})(e,c),re}});class private_async_helpers_s{constructor(e){this.Y=e}disconnect(){this.Y=void 0}reconnect(e){this.Y=e}deref(){return this.Y}}class private_async_helpers_i{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){this.Z??=new Promise((e=>this.q=e))}resume(){this.q?.(),this.Z=this.q=void 0}}const _a=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,$a=1073741823;const Sa=Fn(class until_c extends async_directive_f{constructor(){super(...arguments),this._$Cwt=$a,this._$Cbt=[],this._$CK=new private_async_helpers_s(this),this._$CX=new private_async_helpers_i}render(...e){return e.find((e=>!_a(e)))??re}update(e,t){const r=this._$Cbt;let o=r.length;this._$Cbt=t;const i=this._$CK,s=this._$CX;this.isConnected||this.disconnected();for(let a=0;a<t.length&&!(a>this._$Cwt);a++){const e=t[a];if(!_a(e))return this._$Cwt=a,e;a<o&&e===r[a]||(this._$Cwt=$a,o=0,Promise.resolve(e).then((async t=>{for(;s.get();)await s.get();const r=i.deref();if(void 0!==r){const o=r._$Cbt.indexOf(e);o>-1&&o<r._$Cwt&&(r._$Cwt=o,r.setValue(t))}})))}return re}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}});function Ea(e){return Ea="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Ea(e)}function Ta(e,t){if(t.length<e)throw new TypeError(e+" argument"+(e>1?"s":"")+" required, but only "+t.length+" present")}function Ma(e){Ta(1,arguments);var t=Object.prototype.toString.call(e);return e instanceof Date||"object"===Ea(e)&&"[object Date]"===t?new Date(e.getTime()):"number"==typeof e||"[object Number]"===t?new Date(e):("string"!=typeof e&&"[object String]"!==t||"undefined"==typeof console||(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn((new Error).stack)),new Date(NaN))}function Aa(e){Ta(1,arguments);var t=Ma(e);return t.setHours(0,0,0,0),t}function ja(e,t){Ta(2,arguments);var r=Aa(e),o=Aa(t);return r.getTime()===o.getTime()}var za,Oa,La,Va,Da,Pa,Ha,Wa,Na,Fa,Ra,Ia,Ba,Za,Ua,Ga,Ya,qa,Ka,Xa,Ja,Qa,el,tl,nl,rl,ol,il,sl,al,ll,cl,dl,ul,hl,gl,pl=be`
  @layer base, reset;
      ...
      >
        ...
        >
          ${function*(e,t){const r="function"==typeof t;if(void 0!==e){let o=-1;for(const i of e)o>-1&&(yield r?t(o):t),o++,yield i}}(function*(e,t){if(void 0!==e){let r=0;for(const o of e)yield t(o,r++)}}(this._dateFormatLayout.layout,((e,t)=>ht`<gds-date-part-spinner
                  ...
                  aria-label=${it(this,Pa,Ha).call(this,e.name)}
      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${Ca(nt(this,dl,ul),(e=>e),(e=>ht`<gds-option value=${e}>${e}</gds-option>`))}
          </gds-dropdown>
          <gds-button
            @click=${nt(this,tl)}
        ...
        <div class="footer">
          ...
          ${Sa(it(this,Oa,La).call(this),oe)}
          <gds-button
            rank="tertiary"
            size="small"
            @click=${e=>{e.stopPropagation(),it(this,Va,Da).call(this,new Date)}}
          >
            ${mn("Today")}
          </gds-button>
        </div>
      </gds-popover> `}_getValidityAnchor(){return this._elSpinners[0]}_handleValueChange(){if(!this.value)return void ot(this,cl,{year:"yyyy",month:"mm",day:"dd"});const e=this.value;this._focusedMonth=e.getMonth(),this._focusedYear=e.getFullYear();const t=e.getFullYear().toString(),r=(e.getMonth()+1).toString().padStart(2,"0"),o=e.getDate().toString().padStart(2,"0");ot(this,cl,{year:t,month:r,day:o})}_handleOpenChange(){this.open&&(ot(this,za,this.value),this._elCalendar.then((e=>e.focus())))}};za=new WeakMap,Oa=new WeakSet,La=async function(){const e=await this.getFocusedDate();let t,r="";return e&&e>this.max?(r=mn("Last available date"),t=e=>{e.stopPropagation(),it(this,Va,Da).call(this,this.max)}):e&&e<this.min&&(r=mn("First available date"),t=e=>{e.stopPropagation(),it(this,Va,Da).call(this,this.min)}),ht`${ki(r.length>0,(()=>ht`<gds-button rank="tertiary" size="small" @click=${t}>
          ${r}
        </gds-button>`),(()=>oe))}`},Va=new WeakSet,Da=function(e){const t=new Date(e);this._elCalendar.then((e=>e.focusedDate=t)).then(nt(this,rl))},Pa=new WeakSet,Ha=function(e){return{year:mn("Year"),month:mn("Month"),day:mn("Day")}[e]},Wa=new WeakSet,Na=function(e){return{year:1900,month:1,day:1}[e]},Fa=new WeakSet,Ra=function(e){return{year:9999,month:12,day:31}[e]},Ia=new WeakSet,Ba=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value}}))},Za=new WeakSet,Ua=function(){this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value}}))},Ga=new WeakMap,Ya=new WeakMap,qa=new WeakMap,Ka=new WeakMap,Xa=new WeakMap,Ja=new WeakMap,Qa=new WeakMap,el=new WeakMap,tl=new WeakMap,nl=new WeakMap,rl=new WeakMap,ol=new WeakMap,il=new WeakMap,sl=new WeakSet,al=function(e){const t=e.replace(/[a-z0-9]/gi,"")[0],r=e.split(t),o=r.findIndex((e=>"y"===e)),i=r.findIndex((e=>"m"===e)),s=r.findIndex((e=>"d"===e));if(-1===o||-1===i||-1===s)throw new Error("Invalid date format for <gds-datepicker>");const a=[o,i,s].sort(((e,t)=>e-t)),l=a.map((e=>r[e])).map((e=>({token:e,name:"y"===e?"year":"m"===e?"month":"day"})));return{delimiter:t,layout:l}},ll=new WeakMap,cl=new WeakMap,dl=new WeakSet,ul=function(){var e;const t=this.min.getFullYear(),r=this.max.getFullYear(),o=nt(this,hl,gl),i=null==(e=this.value)?void 0:e.getFullYear();return{*[Symbol.iterator](){o&&(yield i);for(let e=t;e<=r;e++)yield e}}},hl=new WeakSet,gl=function(){return!!this.value&&(this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear())},fl.styles=[Yt,pl],fl.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Pe({converter:xa})],fl.prototype,"value",2),et([Pe({converter:xa})],fl.prototype,"min",2),et([Pe({converter:xa})],fl.prototype,"max",2),et([Pe({type:Boolean})],fl.prototype,"open",2),et([Pe()],fl.prototype,"label",2),et([Pe({type:Boolean,attribute:"show-week-numbers"})],fl.prototype,"showWeekNumbers",2),et([Pe()],fl.prototype,"size",2),et([Pe({type:Boolean,attribute:"hide-label"})],fl.prototype,"hideLabel",2),et([Pe()],fl.prototype,"dateformat",1),et([Pe({type:Boolean,attribute:"disabled-weekends"})],fl.prototype,"disabledWeekends",2),et([Pe({converter:wa,attribute:"disabled-dates"})],fl.prototype,"disabledDates",2),et([Re("#calendar-button")],fl.prototype,"test_calendarButton",2),et([He()],fl.prototype,"_focusedMonth",2),et([He()],fl.prototype,"_focusedYear",2),et([He()],fl.prototype,"_dateFormatLayout",2),et([Re("#calendar")],fl.prototype,"_elCalendar",2),et([Re("#calendar-button")],fl.prototype,"_elTrigger",2),et([Re("#field")],fl.prototype,"_elField",2),et([function(e){return(t,r)=>We(t,r,{get(){return(this.renderRoot??(Fe??=document.createDocumentFragment())).querySelectorAll(e)}})}("[role=spinbutton]")],fl.prototype,"_elSpinners",2),et([Ne(".input")],fl.prototype,"_elInput",2),et([yr("value")],fl.prototype,"_handleValueChange",1),et([yr("open")],fl.prototype,"_handleOpenChange",1),fl=et([lt("gds-datepicker"),xn()],fl);var ml,bl,vl,yl,xl,wl,kl,Cl,_l,$l,Sl,El,Tl,Ml,Al=be`
  @layer base, reset;
...
`,jl=class extends xi{constructor(){super(),rt(this,kl),rt(this,_l),rt(this,Sl),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,rt(this,ml,void 0),rt(this,bl,(e=>{const t=e.getBoundingClientRect(),r=window.innerHeight-t.bottom,o=t.top;let i=Math.min(o,this.maxHeight);return r>o&&(i=Math.min(r,this.maxHeight)),i-16+"px"})),rt(this,vl,(e=>{if(!e.currentTarget)return;const t=e.currentTarget;if(this.options.forEach((e=>e.hidden=!1)),!t.value)return;const r=this.options.filter((e=>!this.searchFilter(t.value,e)));r.forEach((e=>e.hidden=!0))})),rt(this,yl,(e=>{var t;null==(t=this._elListbox)||t.then((t=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void t.focus()}))})),rt(this,xl,(e=>{var t;if("Tab"===e.key&&this.searchable)return e.preventDefault(),void(null==(t=this._elSearchInput)||t.focus())})),rt(this,wl,(e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)})),rt(this,Tl,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)})),rt(this,Ml,(e=>{var t;"Tab"!==e.key||this.searchable||(e.preventDefault(),this.open=!1,null==(t=this._elTriggerBtn)||t.focus())})),yn(this)}get type(){return"gds-dropdown"}get options(){return nt(this,ml)?Array.from(nt(this,ml)).filter((e=>!e.hasAttribute("isplaceholder"))):[]}get placeholder(){if(nt(this,ml))return Array.from(nt(this,ml)).find((e=>e.hasAttribute("isplaceholder")))}get displayValue(){var e,t;let r;return r=Array.isArray(this.value)?this.value.length>2?mn(gn`${this.value.length} selected`):this.value.reduce(((e,t)=>{var r;return e+(null==(r=this.options.find((e=>e.value===t)))?void 0:r.innerHTML)+", "}),"").slice(0,-2):null==(e=this.options.find((e=>e.selected)))?void 0:e.innerHTML,r||(null==(t=this.placeholder)?void 0:t.innerHTML)||""}connectedCallback(){super.connectedCallback(),dn.instance.apply(this,"gds-dropdown"),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange()}))}render(){return ht`
      ...
      >
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){var e,t;this.requestUpdate(),ot(this,ml,this.querySelectorAll("[gds-element=gds-option]")),this.multiple?this._handleValueChange():void 0===this.value?this.placeholder?this.value=this.placeholder.value:this.value=null==(e=this.options[0])?void 0:e.value:this.placeholder||void 0!==this.options.find((e=>this.compareWith(e.value,this.value)))||(this.options[0]&&(this.options[0].selected=!0),this.value=null==(t=this.options[0])?void 0:t.value)}_handleValueChange(){this._elListbox.then((e=>{e&&(Array.isArray(this.value)?e.selection=this.value:e.selection=[this.value])}))}_onOpenChange(){var e;const t=this.open;null==(e=nt(this,ml))||e.forEach((e=>e.hidden=!t)),t?it(this,_l,$l).call(this):(it(this,Sl,El).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const r=this.options.find((e=>e.selected));this.updateComplete.then((()=>null==r?void 0:r.scrollIntoView())),this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:t},bubbles:!0,composed:!0}))}};ml=new WeakMap,bl=new WeakMap,vl=new WeakMap,yl=new WeakMap,xl=new WeakMap,wl=new WeakMap,kl=new WeakSet,Cl=function(){this._elListbox.then((e=>{var t;this.multiple?this.value=e.selection.map((e=>e.value)):(this.value=null==(t=e.selection[0])?void 0:t.value,this.open=!1,setTimeout((()=>{var e;return null==(e=this._elTriggerBtn)?void 0:e.focus()}),0)),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}))},_l=new WeakSet,$l=function(){this.addEventListener("blur",nt(this,Tl)),this.addEventListener("gds-blur",nt(this,Tl)),this.addEventListener("keydown",nt(this,Ml))},Sl=new WeakSet,El=function(){this.removeEventListener("blur",nt(this,Tl)),this.removeEventListener("gds-blur",nt(this,Tl)),this.removeEventListener("keydown",nt(this,Ml))},Tl=new WeakMap,Ml=new WeakMap,jl.styles=[Yt,Al],jl.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Pe()],jl.prototype,"label",2),et([Pe({type:Boolean,reflect:!0})],jl.prototype,"open",2),et([Pe({type:Boolean,reflect:!0})],jl.prototype,"searchable",2),et([Pe({type:Boolean,reflect:!0})],jl.prototype,"multiple",2),et([Pe()],jl.prototype,"compareWith",2),et([Pe()],jl.prototype,"searchFilter",2),et([Pe({type:Boolean,attribute:"sync-popover-width"})],jl.prototype,"syncPopoverWidth",2),et([Pe({type:Number,attribute:"max-height"})],jl.prototype,"maxHeight",2),et([Pe()],jl.prototype,"size",2),et([Pe({type:Boolean,attribute:"hide-label"})],jl.prototype,"hideLabel",2),et([Pe()],jl.prototype,"disableMobileStyles",2),et([Ne("#trigger")],jl.prototype,"_elTriggerBtn",2),et([Re("#listbox")],jl.prototype,"_elListbox",2),et([Ne("#searchinput")],jl.prototype,"_elSearchInput",2),et([vr({attributes:!0,childList:!0,subtree:!0,characterData:!0})],jl.prototype,"_handleLightDOMChange",1),et([yr("value")],jl.prototype,"_handleValueChange",1),et([yr("open")],jl.prototype,"_onOpenChange",1),jl=et([lt("gds-dropdown")],jl);var zl,Ol,Ll,Vl,Dl,Pl=be`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`,Hl=class extends qt{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,rt(this,zl,lr()),rt(this,Ol,(e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach((e=>{e!==t&&(e.selected=!1)}))),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))})),new Yn(this)}get navigableItems(){return this.visibleOptionElements}get options(){return nt(this,zl).value&&qn(nt(this,zl).value).assignedElements().filter((e=>!e.hasAttribute("isplaceholder")&&"gds-option"===e.gdsElementName))||[]}get visibleOptionElements(){return this.options.filter((e=>!e.hidden))}get visibleSelectedOptionElements(){return this.options.filter((e=>e.selected&&!e.hidden))}get selection(){return this.options.filter((e=>e.selected))}set selection(e){this.options.forEach((t=>{t.selected=e.some((e=>this.compareWith(e,t.value)))}))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),dn.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",nt(this,Ol))}focus(){var e;null==(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])||e.focus()}render(){return ht`<slot ${dr(nt(this,zl))}></slot>`}_rerenderOptions(){this.options.forEach((e=>{e.requestUpdate()}))}};zl=new WeakMap,Ol=new WeakMap,Hl.styles=Pl,et([Pe({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],Hl.prototype,"multiple",2),et([Pe()],Hl.prototype,"compareWith",2),et([yr("multiple")],Hl.prototype,"_rerenderOptions",1),Hl=et([lt("gds-listbox")],Hl);var Wl=class extends(pr(qt)){constructor(){super(),rt(this,Vl),rt(this,Ll,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",it(this,Vl,Dl)),this.addEventListener("keydown",(e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),it(this,Vl,Dl).call(this,e))}))}get hidden(){return nt(this,Ll)}set hidden(e){this.isPlaceholder||(ot(this,Ll,"true"===e||!0===e),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(ot(this,Ll,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then((()=>dn.instance.apply(this,"gds-option")))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(ot(this,Ll,!0),this.setAttribute("aria-hidden","true")):(ot(this,Ll,!1),this.setAttribute("aria-hidden","false"))}render(){var e;const t=null==(e=this.parentElement)?void 0:e.multiple,r=ht`
      <span class="checkbox ${Rn({checked:this.selected})}">
        ${this.selected?ht`<gds-icon-checkmark stroke="4"></gds-icon-checkmark>`:""}
      </span>
    `;return t||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),ht`<div>${ki(t,(()=>r))} <slot></slot></div>`}};Ll=new WeakMap,Vl=new WeakSet,Dl=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))},Wl.styles=[Yt,fr],et([Pe()],Wl.prototype,"value",2),et([Pe({attribute:"aria-hidden",reflect:!0})],Wl.prototype,"hidden",1),et([Pe({attribute:"aria-selected",reflect:!0})],Wl.prototype,"selected",2),et([Pe({type:Boolean,reflect:!0})],Wl.prototype,"isPlaceholder",2),et([yr("isplaceholder")],Wl.prototype,"_handlePlaceholderStatusChange",1),Wl=et([lt("gds-option")],Wl);var Nl=class extends ii{};Nl._regularSVG='<path d="M20 9L12 17L4 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Nl._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3.46967 8.46967C3.76256 8.17678 4.23744 8.17678 4.53033 8.46967L12 15.9393L19.4697 8.46967C19.7626 8.17678 20.2374 8.17678 20.5303 8.46967C20.8232 8.76256 20.8232 9.23744 20.5303 9.53033L12.5303 17.5303C12.3897 17.671 12.1989 17.75 12 17.75C11.8011 17.75 11.6103 17.671 11.4697 17.5303L3.46967 9.53033C3.17678 9.23744 3.17678 8.76256 3.46967 8.46967Z" fill="currentColor"/>',Nl._name="chevron-bottom",Nl=et([lt("gds-icon-chevron-bottom")],Nl);var Fl,Rl,Il,Bl,Zl,Ul,Gl,Yl,ql,Kl,Xl,Jl,Ql,ec,tc,nc,rc,oc,ic=class extends ii{};ic._regularSVG='<path d="M2.75 15.0938L9 20.25L21.25 3.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',ic._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M21.7426 2.99454C22.2979 3.40464 22.4157 4.18729 22.0056 4.74263L10.0056 20.9926C9.80433 21.2652 9.50107 21.4443 9.16524 21.4891C8.82942 21.5339 8.4898 21.4404 8.22417 21.2301L2.22417 16.4801C1.6829 16.0516 1.59149 15.2655 2.01999 14.7242C2.4485 14.1829 3.23466 14.0915 3.77593 14.52L8.76241 18.4677L19.9945 3.25753C20.4046 2.70218 21.1873 2.58444 21.7426 2.99454Z" fill="currentColor"/>',ic._name="checkmark",ic=et([lt("gds-icon-checkmark")],ic);var sc=class extends lit_element_r{constructor(){super(...arguments),rt(this,ql),rt(this,Xl),rt(this,Ql),rt(this,tc),rt(this,rc),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=it(this,Ql,ec).call(this,this.value,this.length),rt(this,Fl,""),rt(this,Rl,(()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=2===this.length?this.min:(new Date).getFullYear()-1),this.value=it(this,tc,nc).call(this,e+1),it(this,Xl,Jl).call(this)})),rt(this,Il,(()=>{let e=parseInt(this.value.toString());Number.isNaN(e)&&(e=2===this.length?this.max:(new Date).getFullYear()+1),this.value=it(this,tc,nc).call(this,e-1),it(this,Xl,Jl).call(this)})),rt(this,Bl,(e=>{e.stopPropagation(),e.preventDefault(),this.focus()})),rt(this,Zl,(()=>{it(this,rc,oc).call(this)})),rt(this,Ul,(()=>{""!==nt(this,Fl)&&(it(this,rc,oc).call(this),this.value=it(this,tc,nc).call(this,parseInt(this.value.toString())),it(this,Xl,Jl).call(this))})),rt(this,Gl,(e=>{e.stopPropagation(),e.preventDefault(),e.deltaY>0?nt(this,Il).call(this):nt(this,Rl).call(this)})),rt(this,Yl,(e=>{let t=!1;if("ArrowUp"===e.key)nt(this,Rl).call(this),t=!0;else if("ArrowDown"===e.key)nt(this,Il).call(this),t=!0;else{const r=parseInt(e.key);isNaN(r)||(nt(this,Fl).length<this.length&&(ot(this,Fl,nt(this,Fl)+r.toString()),this.value=parseInt(nt(this,Fl))),nt(this,Fl).length===this.length&&(this.value=it(this,tc,nc).call(this,this.value),it(this,rc,oc).call(this),it(this,ql,Kl).call(this),it(this,Xl,Jl).call(this)),t=!0)}t&&(e.preventDefault(),e.stopPropagation())}))}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",nt(this,Gl)),this.addEventListener("keydown",nt(this,Yl)),this.addEventListener("blur",nt(this,Ul)),this.addEventListener("focus",nt(this,Zl)),this.addEventListener("click",nt(this,Bl)),this.addEventListener("mousedown",nt(this,Bl))}focus(e){super.focus(e),nt(this,Zl).call(this)}render(){return ht`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=it(this,Ql,ec).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};function ac(e){if(null===e||!0===e||!1===e)return NaN;var t=Number(e);return isNaN(t)?t:t<0?Math.ceil(t):Math.floor(t)}function lc(e,t){Ta(2,arguments);var r=Ma(e),o=ac(t);return isNaN(o)?new Date(NaN):o?(r.setDate(r.getDate()+o),r):r}function cc(e,t){return Ta(2,arguments),lc(e,7*ac(t))}Fl=new WeakMap,Rl=new WeakMap,Il=new WeakMap,Bl=new WeakMap,Zl=new WeakMap,Ul=new WeakMap,Gl=new WeakMap,Yl=new WeakMap,ql=new WeakSet,Kl=function(){let e=this.nextElementSibling;for(;e;){if(e instanceof sc){e.focus();break}e=e.nextElementSibling}},Xl=new WeakSet,Jl=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))},Ql=new WeakSet,ec=function(e,t){return String(e).padStart(t,"0")},tc=new WeakSet,nc=function(e){return Math.max(this.min,Math.min(this.max,e))},rc=new WeakSet,oc=function(){ot(this,Fl,"")},sc.formAssociated=!0,et([Pe({type:Number})],sc.prototype,"value",2),et([Pe({type:Number})],sc.prototype,"length",2),et([Pe({type:Number,attribute:"aria-valuemin"})],sc.prototype,"min",2),et([Pe({type:Number,attribute:"aria-valuemax"})],sc.prototype,"max",2),et([He()],sc.prototype,"displayValue",2),et([yr("value")],sc.prototype,"_refreshDisplayValue",1),sc=et([lt("gds-date-part-spinner")],sc);var dc={};function uc(){return dc}function hc(e,t){var r,o,i,s,a,l,c,d;Ta(1,arguments);var u=uc(),h=ac(null!==(r=null!==(o=null!==(i=null!==(s=null==t?void 0:t.weekStartsOn)&&void 0!==s?s:null==t||null===(a=t.locale)||void 0===a||null===(l=a.options)||void 0===l?void 0:l.weekStartsOn)&&void 0!==i?i:u.weekStartsOn)&&void 0!==o?o:null===(c=u.locale)||void 0===c||null===(d=c.options)||void 0===d?void 0:d.weekStartsOn)&&void 0!==r?r:0);if(!(h>=0&&h<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var g=Ma(e),p=g.getDay(),f=(p<h?7:0)+p-h;return g.setDate(g.getDate()-f),g.setHours(0,0,0,0),g}function gc(e,t){var r;Ta(1,arguments);var o=e||{},i=Ma(o.start),s=Ma(o.end).getTime();if(!(i.getTime()<=s))throw new RangeError("Invalid interval");var a=[],l=i;l.setHours(0,0,0,0);var c=Number(null!==(r=null==t?void 0:t.step)&&void 0!==r?r:1);if(c<1||isNaN(c))throw new RangeError("`options.step` must be a number greater than 1");for(;l.getTime()<=s;)a.push(Ma(l)),l.setDate(l.getDate()+c),l.setHours(0,0,0,0);return a}function pc(e,t){const r=function(e){Ta(1,arguments);var t=Ma(e);return t.setDate(1),t.setHours(0,0,0,0),t}(e),o=function(e){Ta(1,arguments);var t=Ma(e),r=t.getMonth();return t.setFullYear(t.getFullYear(),r+1,0),t.setHours(23,59,59,999),t}(e),i=function(e,t){Ta(1,arguments);var r=e||{},o=Ma(r.start),i=Ma(r.end),s=i.getTime();if(!(o.getTime()<=s))throw new RangeError("Invalid interval");var a=hc(o,t),l=hc(i,t);a.setHours(15),l.setHours(15),s=l.getTime();for(var c=[],d=a;d.getTime()<=s;)d.setHours(0),c.push(Ma(d)),(d=cc(d,1)).setHours(15);return c}({start:r,end:o},{weekStartsOn:1});for(;i.length<6;)i.push(lc(i[i.length-1],7));return ee`${t(i.map((e=>({days:gc({start:e,end:lc(e,6)})}))))}`}function fc(e,t){var r,o,i,s,a,l,c,d;Ta(1,arguments);var u=uc(),h=ac(null!==(r=null!==(o=null!==(i=null!==(s=null==t?void 0:t.firstWeekContainsDate)&&void 0!==s?s:null==t||null===(a=t.locale)||void 0===a||null===(l=a.options)||void 0===l?void 0:l.firstWeekContainsDate)&&void 0!==i?i:u.firstWeekContainsDate)&&void 0!==o?o:null===(c=u.locale)||void 0===c||null===(d=c.options)||void 0===d?void 0:d.firstWeekContainsDate)&&void 0!==r?r:1),g=function(e,t){var r,o,i,s,a,l,c,d;Ta(1,arguments);var u=Ma(e),h=u.getFullYear(),g=uc(),p=ac(null!==(r=null!==(o=null!==(i=null!==(s=null==t?void 0:t.firstWeekContainsDate)&&void 0!==s?s:null==t||null===(a=t.locale)||void 0===a||null===(l=a.options)||void 0===l?void 0:l.firstWeekContainsDate)&&void 0!==i?i:g.firstWeekContainsDate)&&void 0!==o?o:null===(c=g.locale)||void 0===c||null===(d=c.options)||void 0===d?void 0:d.firstWeekContainsDate)&&void 0!==r?r:1);if(!(p>=1&&p<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var f=new Date(0);f.setFullYear(h+1,0,p),f.setHours(0,0,0,0);var m=hc(f,t),v=new Date(0);v.setFullYear(h,0,p),v.setHours(0,0,0,0);var y=hc(v,t);return u.getTime()>=m.getTime()?h+1:u.getTime()>=y.getTime()?h:h-1}(e,t),p=new Date(0);return p.setFullYear(g,0,h),p.setHours(0,0,0,0),hc(p,t)}function mc(e,t){Ta(2,arguments);var r=Ma(e),o=ac(t);if(isNaN(o))return new Date(NaN);if(!o)return r;var i=r.getDate(),s=new Date(r.getTime());return s.setMonth(r.getMonth()+o+1,0),i>=s.getDate()?s:(r.setFullYear(s.getFullYear(),s.getMonth(),i),r)}var bc,vc,yc,xc,wc=be`
  @layer base, reset;
...
`,kc=class extends qt{constructor(){super(...arguments),rt(this,bc),rt(this,yc),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=e=>e.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(e){const t=function(e){Ta(1,arguments);var t=Ma(e),r=t.getMonth();return t.setFullYear(t.getFullYear(),r+1,0),t.setHours(0,0,0,0),t}(new Date(this.focusedYear,e,1)),r=new Date(this.focusedDate);r.setDate(Math.min(this.focusedDate.getDate(),t.getDate())),r.setMonth(e),r.setHours(12,0,0,0),this.focusedDate=r}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(this.focusedDate.setFullYear(e))}getDateCell(e){var t;return null==(t=this.shadowRoot)?void 0:t.querySelector(`#dateCell-${e}`)}connectedCallback(){super.connectedCallback(),dn.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",it(this,yc,xc)),window.addEventListener("lit-localize-status",(e=>{"ready"===e.detail.status&&(this._currentLocale=e.detail.readyLocale)}))}focus(){var e;super.focus(),null==(e=this._elFocusedCell)||e.focus()}render(){const e=new Date;return ee`<table role="grid" aria-label="${wi(this.label)}">
      ...
      <tbody role="rowgroup">
        ${pc(this.focusedDate,(t=>ee`
            ${t.map((t=>ee`
                <tr role="row">
                  ${ki(this.showWeekNumbers,(()=>ee`<td class="week-number" scope="row">
                        ${function(e,t){Ta(1,arguments);var r=Ma(e),o=hc(r,t).getTime()-fc(r,t).getTime();return Math.round(o/6048e5)+1}(t.days[0])}
                      </td>`))}
                  ${t.days.map((t=>{const r=this.customizedDates&&this.customizedDates.find((e=>ja(e.date,t))),o=Je({color:"currentColor",disabled:Boolean(this.disabledDates&&this.disabledDates.some((e=>ja(e,t))))},r),i=!function(e,t){Ta(2,arguments);var r=Ma(e),o=Ma(t);return r.getFullYear()===o.getFullYear()&&r.getMonth()===o.getMonth()}(this.focusedDate,t),s=(t<this.min||t>this.max)&&!ja(t,this.min)&&!ja(t,this.max),a=0===t.getDay()||6===t.getDay(),l=o.disabled||i||s||this.disabledWeekends&&a;return this.hideExtraneousDays&&i?ee`<td inert></td>`:ee`
                          <td
                            role="${wi(l?void 0:"gridcell")}"
                            class="${Rn({"custom-date":Boolean(r),disabled:Boolean(l),today:ja(e,t)})}"
                            ?disabled=${l}
                            tabindex="${ja(this.focusedDate,t)?0:-1}"
                            aria-selected="${this.value&&ja(this.value,t)?"true":"false"}"
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=this.value)}};bc=new WeakSet,vc=function(e){const t=function(e,t){Ta(2,arguments);var r=Ma(e),o=ac(t);return r.setHours(o),r}(e,12);this.value=t,this.dispatchEvent(new CustomEvent("change",{detail:t,bubbles:!1,composed:!1}))},yc=new WeakSet,xc=function(e){var t;let r=!1,o=new Date(this.focusedDate);if("ArrowLeft"===e.key?(o=lc(this.focusedDate,-1),r=!0):"ArrowRight"===e.key?(o=lc(this.focusedDate,1),r=!0):"ArrowUp"===e.key?(o=lc(this.focusedDate,-7),r=!0):"ArrowDown"===e.key?(o=lc(this.focusedDate,7),r=!0):"Enter"===e.key||" "===e.key?((null==(t=this._elFocusedCell)?void 0:t.hasAttribute("disabled"))||it(this,bc,vc).call(this,this.focusedDate),r=!0):"Home"===e.key?(o=new Date(this.focusedYear,this.focusedMonth,1),r=!0):"End"===e.key?(o=new Date(this.focusedYear,this.focusedMonth+1,0),r=!0):"PageUp"===e.key?(o=function(e,t){return Ta(2,arguments),mc(e,-ac(t))}(this.focusedDate,1),r=!0):"PageDown"===e.key&&(o=mc(this.focusedDate,1),r=!0),o.getFullYear()>=this.min.getFullYear()&&o.getFullYear()<=this.max.getFullYear()){this.dispatchEvent(new CustomEvent("gds-date-focused",{detail:o,bubbles:!1,composed:!1,cancelable:!0}))&&(this.focusedDate=o)}r&&(e.preventDefault(),e.stopPropagation(),this.updateComplete.then((()=>{var e;null==(e=this._elFocusedCell)||e.focus()})))},kc.styles=[Yt,wc],kc.shadowRootOptions={mode:"open",delegatesFocus:!0},et([Pe()],kc.prototype,"value",2),et([Pe({type:Date})],kc.prototype,"min",2),et([Pe({type:Date})],kc.prototype,"max",2),et([Pe()],kc.prototype,"focusedDate",2),et([Pe({type:Boolean,attribute:"disabled-weekends"})],kc.prototype,"disabledWeekends",2),et([Pe({type:Array,attribute:"disabled-dates"})],kc.prototype,"disabledDates",2),et([Pe({type:Number})],kc.prototype,"focusedMonth",1),et([Pe({type:Number})],kc.prototype,"focusedYear",1),et([Pe({type:Boolean})],kc.prototype,"showWeekNumbers",2),et([Pe({type:Boolean})],kc.prototype,"hideExtraneousDays",2),et([Pe({type:Boolean})],kc.prototype,"hideDayNames",2),et([Pe({attribute:!1})],kc.prototype,"customizedDates",2),et([Pe()],kc.prototype,"label",2),et([Pe({attribute:!1})],kc.prototype,"dateLabelTemplate",2),et([He()],kc.prototype,"_currentLocale",2),et([Ne('td[tabindex="0"]')],kc.prototype,"_elFocusedCell",2),et([yr("value")],kc.prototype,"_valueChanged",1),kc=et([lt("gds-calendar"),xn()],kc);var Cc=class extends qt{connectedCallback(){super.connectedCallback(),this.form=this.closest("form")||void 0,this.form&&(this.formObserver=new MutationObserver((()=>{this.requestUpdate()})),this.formObserver.observe(this.form,{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.formObserver)||e.disconnect()}render(){var e;const t=Array.from((null==(e=this.form)?void 0:e.elements)||[]).filter((e=>e.invalid));return ki(t.length>0,(()=>ht`<gds-card level="3" border="4xs/negative" border-radius="2xs" padding="m" color="error-text">
          <gds-flex gap="s" level=="3" color="negative">
            <gds-container>
              <gds-icon-triangle-exclamation></gds-icon-triangle-exclamation>
            </gds-container>
            <gds-container >
            ${mn(gn`There are ${t.length} errors to correct before you can continue:`)}
            <ul>
              ${t.map((e=>ht`<li><a href @click=${t=>{t.preventDefault(),e.focus()}}>${e.label}</li>`))}
            </ul>
          </gds-container>
        <gds-flex>
      </gds-card>`))}};Cc.styles=be`
    :host {
      font-weight: 500;
    }
    ul {
  ...
  `,Cc=et([lt("gds-form-summary")],Cc);var _c,$c,Sc,Ec,Tc,Mc,Ac,jc,zc,Oc,Lc,Vc,Dc,Pc,Hc,Wc,Nc,Fc,Rc,Ic=be`
  #body {
    visibility: hidden;
    position: absolute;
    z-index: 1060;
...
`,Bc=class extends qt{constructor(){super(...arguments),rt(this,Ec),rt(this,Mc),rt(this,jc),rt(this,Oc),rt(this,Vc),rt(this,Pc),rt(this,Wc),rt(this,Fc),this.placement="bottom",this.overlappedBy=[],this.target=[],this.label="Coachmark",this.computeVisibility=(e,t,r)=>r,this.targetElement=void 0,this._isVisible=!1,this._preventClose=!1,rt(this,_c,lr()),rt(this,$c,lr()),rt(this,Sc,void 0)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",(()=>{setTimeout((()=>{it(this,Fc,Rc).call(this),it(this,Ec,Tc).call(this)}),400)})),document.addEventListener("keydown",(e=>{"Escape"===e.key&&this._isVisible&&it(this,Ec,Tc).call(this)}))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",it(this,Ec,Tc)),document.removeEventListener("keydown",(e=>{"Escape"===e.key&&this._isVisible&&it(this,Ec,Tc).call(this)}))}firstUpdated(){this.target.length>0&&(this.targetElement=it(this,Mc,Ac).call(this,this.target),it(this,Fc,Rc).call(this))}setPreventClose(e){this._preventClose=e}render(){return ht`${ki(this.target.length>0,(()=>ht`
        <div
          role="dialog"
          id="body"
          aria-label=${this.label}
      ...
      `),(()=>ht``))}`}};_c=new WeakMap,$c=new WeakMap,Sc=new WeakMap,Ec=new WeakSet,Tc=function(){var e,t;this._isVisible&&(this._isVisible=!1,null==(e=nt(this,_c).value)||e.remove(),null==(t=nt(this,Sc))||t.call(this),this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:this._isVisible,reason:"closed"},bubbles:!1,composed:!1})))},Mc=new WeakSet,Ac=function(e){let t,r=!1;for(const o of e)"shadowRoot"!==o?t?r&&t.shadowRoot?(t=t.shadowRoot.querySelector(o),r=!1):t=t.querySelector(o):t=document.querySelector(o):r=!0;return t},jc=new WeakSet,zc=function(e,t){if(e==t)return;const r=e.getBoundingClientRect(),o=t.getBoundingClientRect();return r.top<o.bottom&&r.bottom>o.top&&r.left<o.right&&r.right>o.left},Oc=new WeakSet,Lc=function(e){if(!e)return!1;for(const t of e){const e=document.querySelector(t);if(e&&"hidden"!==getComputedStyle(e).visibility&&it(this,jc,zc).call(this,this.targetElement,e))return!0}return!1},Vc=new WeakSet,Dc=function(e){const t=e.getBoundingClientRect(),r=window.innerHeight||document.documentElement.clientHeight,o=window.innerWidth||document.documentElement.clientWidth;return t.top+t.height<0||t.top>r||t.left+t.width<0||t.left>o},Pc=new WeakSet,Hc=async function(e,t,r){return Oo(e,t,{placement:this.placement,middleware:[To((()=>({mainAxis:16,alignmentAxis:16}))),{name:"detectOverflow",fn:async e=>({data:await Eo(e,{boundary:document.body,rootBoundary:"document",altBoundary:!0,padding:{top:167,left:20}})})},Mo({padding:16}),Ao(),jo(),zo({padding:16,element:r})]})},Wc=new WeakSet,Nc=function(){if(!this.targetElement)return!1;const e=it(this,Vc,Dc).call(this,this.targetElement),t=this.targetElement.checkVisibility(),r=0!==this.overlappedBy.length&&it(this,Oc,Lc).call(this,this.overlappedBy);return this.computeVisibility(this,this.targetElement,!r&&!e&&t)},Fc=new WeakSet,Rc=async function(){const e=this.targetElement,t=nt(this,_c).value,r=nt(this,$c).value;if(e&&t&&r)try{ot(this,Sc,So(e,t,(()=>{it(this,Pc,Hc).call(this,e,t,r).then((e=>{let{x:o,y:i,middlewareData:s,placement:a}=e;if(it(this,Wc,Nc).call(this)){if(this._isVisible=!0,Object.assign(t.style,{visibility:"visible",opacity:1,left:`${o}px`,top:`${i}px`}),s.arrow){const{x:e,y:t}=s.arrow;r.removeAttribute("class"),r.classList.add("arrow-"+a),Object.assign(r.style,{left:null!=e?`${e}px`:"",top:null!=t?`${t}px`:""})}}else this._isVisible=!1,Object.assign(t.style,{visibility:"hidden",opacity:0})}))})))}catch(o){console.warn("failed to render tooltips")}},Bc.styles=Ic,et([Pe()],Bc.prototype,"placement",2),et([Pe({attribute:!1})],Bc.prototype,"overlappedBy",2),et([Pe({attribute:!1})],Bc.prototype,"target",2),et([Pe()],Bc.prototype,"label",2),et([Pe({attribute:!1})],Bc.prototype,"computeVisibility",2),et([He()],Bc.prototype,"_isVisible",2),et([He()],Bc.prototype,"_preventClose",2),Bc=et([lt("gds-coachmark")],Bc);var Zc=be`
  .button {
...
`,Uc=class extends Li{connectedCallback(){super.connectedCallback(),this._dynamicStylesController.inject("FAB_styles",Zc)}};let Gc,Yc,qc,Kc,Xc,Jc,Qc,ed,td,nd,rd,od,id,sd,ad;function ld(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function cd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function dd(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}et([Lt({valueTemplate:e=>e,selector:'[part="_button"]'})],Uc.prototype,"position",2),et([Lt({valueTemplate:e=>e})],Uc.prototype,"transform",2),et([Lt({valueTemplate:e=>e,selector:'[part="_button"]'})],Uc.prototype,"inset",2),Uc=et([lt("gds-fab")],Uc);class FormValidationExample extends lit_element_r{static#e=(()=>[Yc,Gc]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:cd((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||cd(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:ld(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return dd(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("form-validation")],[],0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ht`<gds-card border="4xs/base300" padding="m" border-radius="s">
      <form>
        <gds-input
          required
          label="Name"
    ...
    </gds-card>`}static#t=(()=>Gc())()}function ud(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function hd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function gd(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class CalendarExample extends lit_element_r{static#e=(()=>({e:[Kc,Xc,Jc,Qc],c:[ed,qc]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:hd((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||hd(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:ud(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return gd(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("datepicker-example")],[[He(),1,"disabledWeekends"],[He(),1,"showWeekNumbers"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),Qc(this)}createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}#n=(()=>Kc(this,!1))();get disabledWeekends(){return this.#n}set disabledWeekends(e){this.#n=e}#r=(()=>(Xc(this),Jc(this,!1)))();get showWeekNumbers(){return this.#r}set showWeekNumbers(e){this.#r=e}render(){return ht` <div style="width:320px; margin: 8rem auto;">
    ...
    </div>`}static#t=(()=>td())()}function xd(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function wd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function kd(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}let Cd,_d,$d,Sd,Ed;class CardExample extends lit_element_r{static#e=(()=>[Cd,yd]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:wd((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||wd(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:xd(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return kd(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("gds-login")],[],0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ht`
    ...
    `}static#t=(()=>yd())()}function Td(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Md(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Ad(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class CardCarousel extends lit_element_r{static#e=(()=>[$d,_d]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Md((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Md(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Td(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Ad(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-card-carousel")],[],0,void 0,lit_element_r).c)();render(){return ht`
    <gds-card variant="copper-01" padding="s">
        ...
        `}static#t=(()=>_d())()}function jd(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function zd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Od(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class onboarding_onboarding_element_CardExample extends lit_element_r{static#e=(()=>[Ed,Sd]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:zd((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||zd(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:jd(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Od(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("gds-onboarding")],[],0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ht`<tp-card-carousel></tp-card-carousel>`}static#t=(()=>Sd())()}var Ld=be`
  :host {
    display: block;
  }
...
`,Zd=class extends ys{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return rn`<div part="mask"></div>
      <div part="content"><slot></slot></div>`}};let Ud,Gd;function Yd(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function qd(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Kd(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}Zd.styles=[Yt,Bd],et([Lt({selector:'[part="mask"]',valueTemplate:e=>{const[t]=e.split("/");return`linear-gradient(to ${t}, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0) 100%)`}})],Zd.prototype,"mask-image",2),et([Lt({valueTemplate:e=>e,selector:'[part="mask"]'})],Zd.prototype,"mask-size",2),et([Lt({valueTemplate:e=>e,selector:'[part="mask"]'})],Zd.prototype,"mask-repeat",2),et([Lt({valueTemplate:e=>e,selector:'[part="mask"]'})],Zd.prototype,"mask-position",2),et([Lt({selector:'[part="mask"]',valueTemplate:function(e){const[t,r]=e.split("/");return r?`color-mix(in srgb, var(--gds-color-${"l"+this.level}-background-${t}) ${100*parseFloat(r)}%, transparent 0%)`:`var(--gds-color-${"l"+this.level}-background-${t})`}})],Zd.prototype,"background-color",2),et([Lt({valueTemplate:e=>e,selector:'[part="mask"]'})],Zd.prototype,"backdrop-filter",2),Zd=et([lt("gds-mask")],Zd);class GdsJit extends lit_element_r{static#e=(()=>[Gd,Ud]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:qd((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||qd(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Yd(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Kd(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("gds-jit")],[],0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ht`
    ...
    >
      ...
      .stack[aria-expanded='true']{
        cursor: default;
        pointer-events: none;
        max-height: calc(calc(var(--gds-space-m, 0) * ${pu.length-1}) + calc(var(--todo-height, 0) * ${pu.length}));
      }
      ...
      .todo {
        height: 100%;
        width: 100%;
          z-index: calc(${pu.length} - var(--todo-index));
          pointer-events: none;
      ...
      <gds-flex flex-direction="column" gap="m">
          ...
          >
        </gds-flex>`}static#t=(()=>su())()}function ku(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Cu(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function _u(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TpSavingsOutside extends lit_element_r{static#e=(()=>[bu,mu]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Cu((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Cu(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:ku(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return _u(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-savings-outside")],[],0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ht` <gds-card variant="secondary" padding="l">
      <gds-flex flex-direction="column" gap="m">
    ...
    </gds-card>`}static#t=(()=>vu())()}function Tu(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Mu(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Au(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPAccounts extends lit_element_r{static#e=(()=>[wu,xu]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Mu((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Mu(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Tu(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Au(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-accounts")],[],0,void 0,lit_element_r).c)();render(){return ht`
      <tp-card>
        <!-- Header -->
    ...
    `}static#t=(()=>xu())()}const ju=r.p+"acne.af6eeff3cdaaa9e6.svg",zu=r.p+"ica.d0f84408050e18c8.svg",Ou=r.p+"swish.07852426f1267e02.svg";let Lu,Vu,Du,Pu,Hu,Wu,Nu,Fu,Ru,Iu,Bu,Zu,Uu,Gu,Yu,qu,Ku,Xu;function Ju(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Qu(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function eh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class GdsCarousel extends lit_element_r{static#e=(()=>[Vu,Lu]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Qu((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Qu(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Ju(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return eh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("gds-carousel-trans")],[],0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}renderIca(){return ht`<img src="${zu}" alt="ICA Logo" />`}renderSwish(){return ht`<img src="${Ou}" alt="Swish Logo" />`}renderAcne(){return ht`<img src="${ju}" alt="Acne Logo" />`}render(){return ht` <style>
        /* ::-webkit-scrollbar {
          display: none;
        } */
        .item-wrapper {
      ...
      </gds-card>`}static#t=(()=>Lu())()}function th(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function nh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function rh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPCards extends lit_element_r{static#e=(()=>[Pu,Du]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:nh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||nh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:th(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return rh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-cards")],[],0,void 0,lit_element_r).c)();render(){return ht`
      <tp-card>
        <!-- Header -->
    ...
    `}static#t=(()=>Du())()}function oh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function ih(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function sh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPTransactions extends lit_element_r{static#e=(()=>[Wu,Hu]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:ih((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||ih(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:oh(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return sh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-transactions")],[],0,void 0,lit_element_r).c)();render(){return ht`
      <tp-card>
        <!-- Header -->
    ...
    `}static#t=(()=>Hu())()}function ah(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function lh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function ch(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPCard extends lit_element_r{static#e=(()=>({e:[Fu,Ru,Iu,Bu,Zu,Uu],c:[Gu,Nu]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:lh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||lh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:ah(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return ch(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-card")],[[He(),1,"hideFooter"],[Pe({type:Boolean}),1,"wide"],[He(),1,"footerSlotOccupied"]],0,void 0,lit_element_r)))();#n=(()=>Fu(this,!1))();get hideFooter(){return this.#n}set hideFooter(e){this.#n=e}#r=(()=>(Ru(this),Iu(this,!1)))();get wide(){return this.#r}set wide(e){this.#r=e}#o=(()=>(Bu(this),Zu(this,!1)))();get footerSlotOccupied(){return this.#o}set footerSlotOccupied(e){this.#o=e}connectedCallback(){super.connectedCallback()}constructor(){super(),Uu(this)}render(){return ht`
    ...
    `}static#t=(()=>Yu())()}function gh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function ph(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function fh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class dashboard_dashboard_element_CardExample extends lit_element_r{static#e=(()=>[Xu,Ku]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:ph((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||ph(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:gh(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return fh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("gds-dashboard")],[],0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ht`
...
`,bh=class extends qt{querySelectorAll(e){return this.shadowRoot?this.shadowRoot.querySelectorAll(e):new NodeList}querySelector(e){return this.shadowRoot?this.shadowRoot.querySelector(e):null}get innerHTML(){var e;return(null==(e=this.shadowRoot)?void 0:e.innerHTML)||""}set innerHTML(e){this.shadowRoot&&(this.shadowRoot.innerHTML=e)}connectedCallback(){super.connectedCallback(),this._captureDOM()}_captureDOM(){this.shadowRoot&&0!==this.childNodes.length&&this.shadowRoot.replaceChildren(...Array.from(this.childNodes))}};let vh,yh,xh,wh,kh,Ch,_h,$h,Sh,Eh,Th,Mh,Ah,jh,zh,Oh;function Lh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Vh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Dh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}bh.styles=[Yt,gt,mh],et([vr()],bh.prototype,"_captureDOM",1),bh=et([lt("gds-rich-text")],bh);class PageHeader extends lit_element_r{static#e=(()=>({e:[yh,xh],c:[wh,vh]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Vh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Vh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Lh(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Dh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-page-header")],[[He(),1,"viewOptions"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),xh(this)}createRenderRoot(){return this}#n=(()=>yh(this,{hasAccounts:!1,hasSavings:!1,hasCards:!1}))();get viewOptions(){return this.#n}set viewOptions(e){this.#n=e}render(){return ht`
    ...
    `}#d(e){this.viewOptions=e,this.dispatchEvent(new CustomEvent("view-options-change",{detail:{view:e},bubbles:!0,composed:!0}))}static#t=(()=>vh())()}function Ph(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Hh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Wh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPStepBullet extends lit_element_r{static#e=(()=>({e:[Ch,_h],c:[$h,kh]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Hh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Hh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Ph(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Wh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-step-bullet")],[[Pe({type:Boolean}),1,"active"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),_h(this)}#n=(()=>Ch(this))();get active(){return this.#n}set active(e){this.#n=e}render(){return ht`
  <gds-container border-radius="max" width=${this.active?"16px":"6px"} height="6px" level="3" background="positive; hover:primary" cursor="pointer" transition="all 0.4s" transform="hover:scaleX(1.2)" ></gds-container>
    `}static#t=(()=>kh())()}function Nh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Fh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Rh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPAccountsModalCard extends lit_element_r{static#e=(()=>({e:[Eh,Th],c:[Mh,Sh]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Fh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Fh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Nh(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Rh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-accounts-card")],[[Pe({type:String}),1,"name"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),Th(this)}#n=(()=>Eh(this))();get name(){return this.#n}set name(e){this.#n=e}render(){return ht`
      <style>
        :host {
          display: contents;
        }
    ...
    `}static#t=(()=>Sh())()}function Ih(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Bh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Zh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPAccountsModal extends lit_element_r{static#e=(()=>({e:[jh,zh],c:[Oh,Ah]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Bh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Bh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Ih(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Zh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-accounts-modal")],[[He(),1,"isModalOpen"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),zh(this)}#n=(()=>jh(this,!1))();get isModalOpen(){return this.#n}set isModalOpen(e){this.#n=e}handleCardClick(){this.isModalOpen=!0}closeModal(){this.isModalOpen=!1}handleKeyDown(e){"Escape"===e.key&&(this.isModalOpen=!1)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.handleKeyDown.bind(this))}disconnectedCallback(){window.removeEventListener("keydown",this.handleKeyDown.bind(this)),super.disconnectedCallback()}render(){return ht`
      <style>
        :host {
          --steps: 3;
      ...
      ${this.isModalOpen?ht`
          ...
          `:oe}
    `}static#t=(()=>Ah())()}var Uh=class extends ii{};let Gh,Yh;function qh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Kh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Xh(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}Uh._regularSVG='<path d="M19.2618 3.75V7.75H15.2618M4.75 20.25V16.25H8.75M3.81383 13.0312C3.7717 12.6934 3.75 12.3492 3.75 12C3.75 7.44365 7.44365 3.75 12 3.75C14.6766 3.75 17.1111 5.02463 18.6322 7M20.1862 10.9688C20.2283 11.3066 20.25 11.6508 20.25 12C20.25 16.5563 16.5563 20.25 12 20.25C9.32342 20.25 6.88887 18.9754 5.36784 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Uh._solidSVG='<path d="M6.3448 17C7.73561 18.5332 9.77612 19.5 12 19.5C16.1421 19.5 19.5 16.1421 19.5 12C19.5 11.6819 19.4802 11.3687 19.4419 11.0616C19.3907 10.6505 19.6823 10.2758 20.0934 10.2245C20.5044 10.1733 20.8792 10.4649 20.9304 10.8759C20.9764 11.2445 21 11.6197 21 12C21 16.9706 16.9706 21 12 21C9.4791 21 7.1554 19.9626 5.5 18.2888V20.25C5.5 20.6642 5.16421 21 4.75 21C4.33579 21 4 20.6642 4 20.25V16.25C4 15.8358 4.33579 15.5 4.75 15.5H8.75C9.16421 15.5 9.5 15.8358 9.5 16.25C9.5 16.6642 9.16421 17 8.75 17H6.3448Z" fill="currentColor"/><path d="M4.55806 12.9384C4.60932 13.3495 4.31766 13.7242 3.90663 13.7755C3.4956 13.8267 3.12085 13.5351 3.06959 13.1241C3.02364 12.7555 3 12.3803 3 12C3 7.02944 7.02944 3 12 3C14.5269 3 16.8557 4.04238 18.5118 5.72322V3.75C18.5118 3.33579 18.8476 3 19.2618 3C19.6761 3 20.0118 3.33579 20.0118 3.75V7.75C20.0118 8.16421 19.6761 8.5 19.2618 8.5H15.2618C14.8476 8.5 14.5118 8.16421 14.5118 7.75C14.5118 7.33579 14.8476 7 15.2618 7H17.6552C16.2644 5.46681 14.2239 4.5 12 4.5C7.85786 4.5 4.5 7.85786 4.5 12C4.5 12.3181 4.51977 12.6313 4.55806 12.9384Z" fill="currentColor"/>',Uh._name="arrow-rotate-right-left",Uh=et([lt("gds-icon-arrow-rotate-right-left")],Uh);class TpQuicklinks extends lit_element_r{static#e=(()=>[Yh,Gh]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Kh((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Kh(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:qh(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Xh(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-quicklinks")],[],0,void 0,lit_element_r).c)();render(){return ht`
      <gds-grid
        columns="3"
        gap="m"
        level="2"
    ...
    `}static#t=(()=>Gh())()}var Jh=class extends ii{};Jh._regularSVG='<path d="M19.7181 14.5359C20.0626 13.7609 20.254 12.9028 20.254 12C20.254 8.54822 17.4558 5.75 14.004 5.75H10.004C9.93732 5.75 9.87088 5.75104 9.8047 5.75312C8.32457 3.97909 6.38818 3.75 5.75 3.75V7.4211C5.06066 8.06182 4.51621 8.85631 4.17124 9.75H1.75V14.25H4.17124C4.51621 15.1437 5.06066 15.9382 5.75 16.5789V20.25H10.25V18.25H13.75V20.25H18.25V16.5863C18.8686 16.0134 19.371 15.3168 19.7181 14.5359ZM19.7181 14.5359C20.085 14.9725 20.6351 15.25 21.25 15.25C22.3546 15.25 23.25 14.3546 23.25 13.25C23.25 12.777 23.0858 12.3424 22.8113 12M8 10.75H8.5M8.75 10.75C8.75 11.0261 8.52614 11.25 8.25 11.25C7.97386 11.25 7.75 11.0261 7.75 10.75C7.75 10.4739 7.97386 10.25 8.25 10.25C8.52614 10.25 8.75 10.4739 8.75 10.75Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Jh._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M5 3.75C5 3.33579 5.33579 3 5.75 3C6.47743 3 8.50198 3.24069 10.1403 5H14.004C17.87 5 21.004 8.13401 21.004 12C21.004 12.8135 20.8649 13.5957 20.6089 14.3235C20.7965 14.4358 21.0156 14.5 21.25 14.5C21.9404 14.5 22.5 13.9404 22.5 13.25C22.5 12.9537 22.3978 12.6832 22.2262 12.4691C21.9671 12.1459 22.0191 11.6739 22.3422 11.4148C22.6654 11.1557 23.1374 11.2077 23.3965 11.5309C23.7738 12.0016 24 12.6004 24 13.25C24 14.7688 22.7688 16 21.25 16C20.7839 16 20.3448 15.8838 19.9602 15.6792C19.6857 16.1227 19.3632 16.533 19 16.9031V20.25C19 20.6642 18.6642 21 18.25 21H13.75C13.3358 21 13 20.6642 13 20.25V19H11V20.25C11 20.6642 10.6642 21 10.25 21H5.75C5.33579 21 5 20.6642 5 20.25V16.8949C4.46134 16.3443 4.01257 15.7048 3.67782 15H1.75C1.33579 15 1 14.6642 1 14.25V9.75C1 9.33579 1.33579 9 1.75 9H3.67782C4.01257 8.29522 4.46134 7.65571 5 7.1051V3.75ZM8.25 12C8.94036 12 9.5 11.4404 9.5 10.75C9.5 10.0596 8.94036 9.5 8.25 9.5C7.55964 9.5 7 10.0596 7 10.75C7 11.4404 7.55964 12 8.25 12Z" fill="currentColor"/>',Jh._name="piggy-bank",Jh=et([lt("gds-icon-piggy-bank")],Jh);var Qh=class extends ii{};Qh._regularSVG='<path d="M21 18C21 18 19.666 19.5444 18.166 19.5444C16.666 19.5444 15.4594 18.115 13.9866 18.115C12.5138 18.115 11.6598 18.786 10.75 19.75M17 2.75L20.25 6L6 20.25H2.75V17L17 2.75Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Qh._solidSVG='<path d="M16.4697 2.21967C16.7626 1.92678 17.2374 1.92678 17.5303 2.21967L20.7803 5.46967C21.0732 5.76256 21.0732 6.23744 20.7803 6.53033L6.53033 20.7803C6.38968 20.921 6.19891 21 6 21H2.75C2.33579 21 2 20.6642 2 20.25V17C2 16.8011 2.07902 16.6103 2.21967 16.4697L16.4697 2.21967Z" fill="currentColor"/><path d="M21.4903 17.4324C21.1769 17.1618 20.7035 17.1963 20.4327 17.5095L20.4261 17.5168C20.4192 17.5246 20.4075 17.5374 20.3914 17.5547C20.3592 17.5892 20.3095 17.641 20.2446 17.7043C20.1139 17.8317 19.9261 18.0013 19.699 18.1696C19.2229 18.5224 18.675 18.7944 18.166 18.7944C17.6346 18.7944 17.124 18.5421 16.4177 18.1672L16.3494 18.131C15.7225 17.7975 14.9093 17.365 13.9866 17.365C12.2062 17.365 11.1671 18.2154 10.2046 19.2352C9.92027 19.5364 9.93398 20.0111 10.2352 20.2954C10.5364 20.5797 11.0111 20.566 11.2954 20.2648C12.1526 19.3567 12.8215 18.865 13.9866 18.865C14.5028 18.865 15.0037 19.1149 15.7145 19.4922L15.7677 19.5205C16.4011 19.8571 17.2241 20.2944 18.166 20.2944C19.1571 20.2944 20.0262 19.7942 20.5921 19.3748C20.886 19.157 21.1254 18.9405 21.2917 18.7783C21.3753 18.6968 21.4415 18.628 21.4881 18.578C21.5114 18.5531 21.5299 18.5328 21.5432 18.5179L21.5593 18.4997L21.5645 18.4939L21.5663 18.4918L21.5676 18.4903C21.5676 18.4903 21.5676 18.4903 21 18L21.5676 18.4903C21.8383 18.1768 21.8037 17.7032 21.4903 17.4324Z" fill="currentColor"/>',Qh._name="pencil-wave",Qh=et([lt("gds-icon-pencil-wave")],Qh);var eg=class extends ii{};let tg,ng,rg,og,ig,sg,ag,lg,cg,dg,ug,hg,gg,pg,fg,mg,bg,vg,yg,xg,wg,kg,Cg,_g;function $g(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Sg(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Eg(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}eg._regularSVG='<path d="M19.25 9.25V17.25M15.25 17.25V9.25M4.75 9.25V17.25M8.75 17.25V9.25M2.75 7.17308L12 2.5L21.25 7.17308V9.25H2.75V7.17308ZM2.75 20.25H21.25L20.25 17.25H3.75L2.75 20.25Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="round"/>',eg._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12.3382 1.83058C12.1255 1.72314 11.8745 1.72314 11.6618 1.83058L2.41181 6.50365C2.15926 6.63125 2.00001 6.89012 2.00001 7.17308V9.25C2.00001 9.66421 2.33579 10 2.75001 10H4.00001V16.5H3.75001C3.42718 16.5 3.14058 16.7066 3.03849 17.0128L2.03849 20.0128C1.96226 20.2415 2.00061 20.493 2.14157 20.6885C2.28254 20.8841 2.50892 21 2.75001 21H21.25C21.4911 21 21.7175 20.8841 21.8584 20.6885C21.9994 20.493 22.0378 20.2415 21.9615 20.0128L20.9615 17.0128C20.8594 16.7066 20.5728 16.5 20.25 16.5H20V10H21.25C21.6642 10 22 9.66421 22 9.25V7.17308C22 6.89012 21.8408 6.63125 21.5882 6.50365L12.3382 1.83058ZM16 10H18.5V16.5H16V10ZM8.00001 16.5H5.50001V10H8.00001V16.5ZM9.50001 16.5V10H14.5V16.5H9.50001Z" fill="currentColor"/>',eg._name="bank",eg=et([lt("gds-icon-bank")],eg);class TPStep extends lit_element_r{static#e=(()=>({e:[ng,rg,og,ig,sg,ag,lg,cg],c:[dg,tg]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Sg((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Sg(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:$g(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Eg(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-step")],[[Pe({type:String}),1,"name"],[Pe({type:String}),1,"title"],[Pe({type:String}),1,"description"],[Pe({type:String}),1,"label"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),cg(this)}#n=(()=>ng(this))();get name(){return this.#n}set name(e){this.#n=e}#r=(()=>(rg(this),og(this)))();get title(){return this.#r}set title(e){this.#r=e}#o=(()=>(ig(this),sg(this)))();get description(){return this.#o}set description(e){this.#o=e}#u=(()=>(ag(this),lg(this)))();get label(){return this.#u}set label(e){this.#u=e}render(){return ht`
      <style>
        :host {
          display: contents;
        }
    ...
    `}static#t=(()=>tg())()}function Tg(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Mg(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Ag(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPSteps extends lit_element_r{static#e=(()=>({e:[hg,gg],c:[pg,ug]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Mg((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Mg(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Tg(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Ag(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-steps")],[[Ne(".steps"),1,"stepsContainer"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),gg(this)}#n=(()=>hg(this))();get stepsContainer(){return this.#n}set stepsContainer(e){this.#n=e}firstUpdated(){this.addEventListeners()}addEventListeners(){this.shadowRoot.querySelectorAll("tp-step-bullet").forEach((e=>{e.addEventListener("click",this.handleBulletClick.bind(this))}))}handleBulletClick(e){const t=e.currentTarget,r=t.getAttribute("step"),o=this.shadowRoot.querySelector(`tp-step[name="${r}"]::part(step)`);o&&o.scrollIntoView({behavior:"smooth",block:"center"});this.shadowRoot.querySelectorAll("tp-step-bullet").forEach((e=>e.removeAttribute("active"))),t.setAttribute("active","")}render(){return ht`
      <style>
        :host {
          --steps: 4;
          --space: var(--gds-space-xl);
    ...
    `}static#t=(()=>ug())()}function jg(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function zg(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Og(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPCarouselPink extends lit_element_r{static#e=(()=>[mg,fg]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:zg((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||zg(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:jg(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Og(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-carousel-pink")],[],0,void 0,lit_element_r).c)();render(){return ht`
      <style>
        .carousel {
          display: flex;
          overflow-x: scroll;
    ...
    `}static#t=(()=>fg())()}function Lg(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Vg(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Dg(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class SavingsCalc extends lit_element_r{static#e=(()=>({e:[vg,yg,xg,wg,kg,Cg],c:[_g,bg]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Vg((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Vg(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Lg(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Dg(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-savings-calc")],[[He(),1,"amountPerMonth"],[He(),1,"years"],[He(),1,"total"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),Cg(this)}connectedCallback(){super.connectedCallback()}#n=(()=>vg(this,500))();get amountPerMonth(){return this.#n}set amountPerMonth(e){this.#n=e}#r=(()=>(yg(this),xg(this,5)))();get years(){return this.#r}set years(e){this.#r=e}#o=(()=>(wg(this),kg(this,"26 325")))();get total(){return this.#o}set total(e){this.#o=e}render(){return ht`<gds-card
      variant="secondary"
    ...
    </gds-card>`}static#t=(()=>bg())()}const Pg=ht` <svg
  width="368"
  height="32"
  viewBox="0 0 368 32"
  fill="none"
...
>
  ...
  <defs>
...
</svg>`;let Hg,Wg,Ng,Fg,Rg,Ig;function Bg(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Zg(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Ug(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPEmptyKonton extends lit_element_r{static#e=(()=>[Wg,Hg]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Zg((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Zg(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Bg(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Ug(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-empty-konton")],[],0,void 0,lit_element_r).c)();render(){return ht`
      <tp-card>
        <!-- Header -->
    ...
    `}static#t=(()=>Hg())()}function Gg(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Yg(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function qg(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class TPEmptyCard extends lit_element_r{static#e=(()=>({e:[Fg,Rg],c:[Ig,Ng]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Yg((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Yg(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Gg(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return qg(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-empty-card")],[[He(),1,"isVisible"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),Rg(this)}#n=(()=>Fg(this,!0))();get isVisible(){return this.#n}set isVisible(e){this.#n=e}handleCloseClick(){this.isVisible=!1}render(){return ht` <style>
      ...
      ${this.isVisible?ht`
          ...
          `:oe}`}static#t=(()=>Ng())()}var Kg=class extends ii{};Kg._regularSVG='<path d="M8.75 8.75L14.5694 14.5694M15.25 9.75V15.25H9.75M21.25 12C21.25 17.1086 17.1086 21.25 12 21.25C6.89137 21.25 2.75 17.1086 2.75 12C2.75 6.89137 6.89137 2.75 12 2.75C17.1086 2.75 21.25 6.89137 21.25 12Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Kg._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16 15.25C16 15.6642 15.6642 16 15.25 16H9.75C9.33579 16 9 15.6642 9 15.25C9 14.8358 9.33579 14.5 9.75 14.5H13.4393L8.21967 9.28033C7.92678 8.98744 7.92678 8.51256 8.21967 8.21967C8.51256 7.92678 8.98744 7.92678 9.28033 8.21967L14.5 13.4393V9.75C14.5 9.33579 14.8358 9 15.25 9C15.6642 9 16 9.33579 16 9.75V15.25Z" fill="currentColor"/>',Kg._name="arrow-right-down-circle",Kg=et([lt("gds-icon-arrow-right-down-circle")],Kg);var Xg=class extends ii{};Xg._regularSVG='<path d="M4 15L12 7L20 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',Xg._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.25C12.1989 6.25 12.3897 6.32902 12.5303 6.46967L20.5303 14.4697C20.8232 14.7626 20.8232 15.2374 20.5303 15.5303C20.2374 15.8232 19.7626 15.8232 19.4697 15.5303L12 8.06066L4.53033 15.5303C4.23744 15.8232 3.76256 15.8232 3.46967 15.5303C3.17678 15.2374 3.17678 14.7626 3.46967 14.4697L11.4697 6.46967C11.6103 6.32902 11.8011 6.25 12 6.25Z" fill="currentColor"/>',Xg._name="chevron-top",Xg=et([lt("gds-icon-chevron-top")],Xg);var Jg=class extends ii{};Jg._regularSVG='<path d="M6.86111 13.25H3.25L6.25 7.75H11.2292M6.86111 13.25L10.75 17.1389M6.86111 13.25L11.2292 7.75M10.75 17.1389V20.75L16.25 17.75V12.7708M10.75 17.1389L16.25 12.7708M16.25 12.7708C19.3333 9.94444 21.25 6.86111 21.25 2.75C17.1389 2.75 14.0556 4.66667 11.2292 7.75M4.80556 21.25H2.75V19.1944C2.75 18.0592 3.6703 17.1389 4.80556 17.1389C5.94081 17.1389 6.86111 18.0592 6.86111 19.1944C6.86111 20.3297 5.94081 21.25 4.80556 21.25Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>',Jg._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M15.5 14.3242L11.5 17.501V19.4866L15.5 17.3048V14.3242ZM10 17.4495L6.55045 14H3.25C2.9853 14 2.7402 13.8605 2.60508 13.6328C2.46995 13.4052 2.46482 13.1232 2.59158 12.8909L5.59158 7.39086C5.723 7.14992 5.97554 7 6.25 7H10.902C13.7571 3.96176 16.9703 2 21.25 2C21.6642 2 22 2.33579 22 2.75C22 7.02966 20.0382 10.2429 17 13.098V17.75C17 18.0245 16.8501 18.277 16.6091 18.4084L11.1091 21.4084C10.8768 21.5352 10.5948 21.53 10.3672 21.3949C10.1395 21.2598 10 21.0147 10 20.75V17.4495ZM6.499 12.5L9.67577 8.5H6.69522L4.51341 12.5H6.499ZM2 19.1944C2 17.645 3.25609 16.3889 4.80556 16.3889C6.35502 16.3889 7.61111 17.645 7.61111 19.1944C7.61111 20.7439 6.35502 22 4.80556 22H2.75C2.33579 22 2 21.6642 2 21.25V19.1944Z" fill="currentColor"/>',Jg._name="rocket",Jg=et([lt("gds-icon-rocket")],Jg);var Qg=class extends ii{};let ep,tp,np,rp,op,ip,sp,ap,lp,cp,dp,up,hp,gp,pp,fp,mp,bp,vp,yp,xp,wp;function kp(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Cp(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function _p(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}Qg._regularSVG='<path d="M3.75 9L3.27507 8.41953C3.10097 8.56198 3 8.77505 3 9H3.75ZM20.25 9H21C21 8.77505 20.899 8.56198 20.7249 8.41953L20.25 9ZM20.25 20.25V21C20.6642 21 21 20.6642 21 20.25H20.25ZM3.75 20.25H3C3 20.6642 3.33579 21 3.75 21V20.25ZM12 2.25L12.4749 1.66953C12.1987 1.44349 11.8013 1.44349 11.5251 1.66953L12 2.25ZM9.75 14.75V14C9.33579 14 9 14.3358 9 14.75H9.75ZM14.25 14.75H15C15 14.3358 14.6642 14 14.25 14V14.75ZM14.25 20.25H13.5C13.5 20.6642 13.8358 21 14.25 21V20.25ZM9.75 20.25V21C10.1642 21 10.5 20.6642 10.5 20.25H9.75ZM19.5 9V20.25H21V9H19.5ZM4.5 20.25V9H3V20.25H4.5ZM4.22493 9.58047L12.4749 2.83047L11.5251 1.66953L3.27507 8.41953L4.22493 9.58047ZM11.5251 2.83047L19.7751 9.58047L20.7249 8.41953L12.4749 1.66953L11.5251 2.83047ZM9.75 15.5H14.25V14H9.75V15.5ZM13.5 14.75V20.25H15V14.75H13.5ZM10.5 20.25V14.75H9V20.25H10.5ZM9.75 19.5H3.75V21H9.75V19.5ZM14.25 21H20.25V19.5H14.25V21Z" fill="currentColor"/>',Qg._solidSVG='<path d="M12.4749 1.66953C12.1987 1.44349 11.8013 1.44349 11.5251 1.66953L3.27507 8.41953C3.10097 8.56198 3 8.77505 3 9V20.25C3 20.6642 3.33579 21 3.75 21H9.25C9.66421 21 10 20.6642 10 20.25V15H14V20.25C14 20.6642 14.3358 21 14.75 21H20.25C20.6642 21 21 20.6642 21 20.25V9C21 8.77505 20.899 8.56198 20.7249 8.41953L12.4749 1.66953Z" fill="currentColor"/>',Qg._name="home-open",Qg=et([lt("gds-icon-home-open")],Qg);class TpExpenses extends lit_element_r{static#e=(()=>({e:[tp,np,rp,op,ip,sp,ap,lp,cp,dp,up,hp],c:[gp,ep]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Cp((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Cp(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:kp(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return _p(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-expenses")],[[He(),1,"activeCategory"],[He(),1,"isExpanded"],[He(),1,"label"],[He(),1,"amount"],[He(),1,"amountDiff"],[He(),1,"status"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),hp(this)}connectedCallback(){super.connectedCallback()}#n=(()=>tp(this,"N\xf6je"))();get activeCategory(){return this.#n}set activeCategory(e){this.#n=e}#r=(()=>(np(this),rp(this,!1)))();get isExpanded(){return this.#r}set isExpanded(e){this.#r=e}#o=(()=>(op(this),ip(this,"N\xf6je")))();get label(){return this.#o}set label(e){this.#o=e}#u=(()=>(sp(this),ap(this,"13 523,00")))();get amount(){return this.#u}set amount(e){this.#u=e}#h=(()=>(lp(this),cp(this,"\xd6kat")))();get amountDiff(){return this.#h}set amountDiff(e){this.#h=e}#g=(()=>(dp(this),up(this,"+3 567,00")))();get status(){return this.#g}set status(e){this.#g=e}expand(){this.isExpanded=!this.isExpanded}renderIcon(){return this.isExpanded?ht`<gds-icon-chevron-top></gds-icon-chevron-top>`:ht`<gds-icon-chevron-bottom></gds-icon-chevron-bottom>`}renderCategory(e,t,r,o){this.activeCategory=e,this.label=e,this.amount=t,this.amountDiff=r,this.status=o}render(){return ht`<tp-card>
  ...
  height: 100%;
    ...
    transition: transform 0.2s;
      ...
      <gds-flex margin="0 0 l 0" align-items="baseline" justify-content="space-between">
        <gds-flex place-items="center"gap="s"flex-direction="column"><span class="${"N\xf6je"===this.activeCategory?"active":""} Nöje"></span><gds-text><gds-theme color-scheme="light">
              <gds-button  @click="${()=>this.renderCategory("N\xf6je","13 523,00","\xd6kat","+3 567,00")}" rank="${"N\xf6je"===this.activeCategory?"primary":"secondary"}"
                ><gds-icon-rocket class=""></gds-icon-rocket></gds-button></gds-theme></gds-text></gds-flex>
                <gds-flex place-items="center"gap="s"flex-direction="column"><span class="${"Mat"===this.activeCategory?"active":""} Mat"></span><gds-text><gds-theme color-scheme="light">
              <gds-button  @click="${()=>this.renderCategory("Mat","11 000,00","\xd6kat","+500,00")}" rank="${"Mat"===this.activeCategory?"primary":"secondary"}"
                ><gds-icon-store class=""></gds-icon-store></gds-button></gds-theme></gds-text></gds-flex>
                <gds-flex place-items="center"gap="s"flex-direction="column"><span class="${"Boende"===this.activeCategory?"active":""} Boende"></span><gds-text><gds-theme color-scheme="light">
              <gds-button  @click="${()=>this.renderCategory("Boende","10 000,00","Minskat","-500,00")}" rank="${"Boende"===this.activeCategory?"primary":"secondary"}"
                ><gds-icon-home-open class=""></gds-icon-home-open></gds-button></gds-theme></gds-text></gds-flex>
                <gds-flex place-items="center"gap="s"flex-direction="column"><span class="${"Stuga"===this.activeCategory?"active":""} Stuga"></span><gds-text><gds-theme color-scheme="light">
              <gds-button  @click="${()=>this.renderCategory("Stuga","8 000,00","Minskat","-250,00")}" rank="${"Stuga"===this.activeCategory?"primary":"secondary"}"
                ><gds-icon-home-open class=""></gds-icon-home-open></gds-button></gds-theme></gds-text></gds-flex>
                <gds-flex place-items="center"gap="s"flex-direction="column"><span class="${"Livstil"===this.activeCategory?"active":""} Livstil"></span><gds-text><gds-theme color-scheme="light">
              <gds-button  @click="${()=>this.renderCategory("Livstil","4 000,00","\xd6kat","+5200,00")}" rank="${"Livstil"===this.activeCategory?"primary":"secondary"}"
    ...
    </tp-card>`}static#t=(()=>ep())()}function $p(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Sp(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Ep(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class ThemePage extends lit_element_r{static#e=(()=>({e:[fp,mp],c:[bp,pp]}=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Sp((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Sp(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:$p(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Ep(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[Le("tp-theme-page")],[[Ne("tp-page-header"),1,"pageHeader"]],0,void 0,lit_element_r)))();constructor(){super(...arguments),mp(this)}createRenderRoot(){return this}#n=(()=>fp(this))();get pageHeader(){return this.#n}set pageHeader(e){this.#n=e}connectedCallback(){super.connectedCallback()}render(){return ht`
        ...
        ${ki(this.pageHeader?.viewOptions.hasAccounts,(()=>ht`
          <gds-grid columns="1; m{12}" gap="l" padding="0 s; l{0 4xl}">
            ...
            <gds-flex
              ...
              gap="l"
            >
              ${ki(this.pageHeader?.viewOptions.hasCards,(()=>ht`<tp-cards></tp-cards>`),(()=>ht` 
    ...
    `}static#t=(()=>pp())()}function Tp(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Mp(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}function Ap(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}class AppElement extends lit_element_r{static#e=(()=>[vp,yp,xp,wp]=function(e,t,r,o,i,s){var a,l,c,d,u,h,g,p=Symbol.metadata||Symbol.for("Symbol.metadata"),f=Object.defineProperty,m=Object.create,v=[m(null),m(null)],y=t.length;function x(t,r,o){return function(i,s){r&&(s=i,i=e);for(var a=0;a<t.length;a++)s=t[a].apply(i,o?[s]:[]);return o?s:i}}function w(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function C(e,t,r,o,i,s,c,d,u,h,g){function p(e){if(!g(e))throw new TypeError("Attempted to access private element on non-instance")}var m=[].concat(t[0]),y=t[3],C=!c,_=1===i,$=3===i,S=4===i,E=2===i;function T(t,r,o){return function(i,s){return r&&(s=i,i=e),o&&o(i),A[t].call(i,s)}}if(!C){var A={},j=[],O=$?"get":S||_?"set":"value";if(u?(h||_?A={get:Mp((function(){return y(this)}),o,"get"),set:function(e){t[4](this,e)}}:A[O]=y,h||Mp(A[O],o,E?"":O)):h||(A=Object.getOwnPropertyDescriptor(e,o)),!h&&!u){if((l=v[+d][o])&&7!=(l^i))throw Error("Decorating two elements with the same name ("+A[O].name+") is not supported yet");v[+d][o]=i<3?1:i}}for(var V=e,D=m.length-1;D>=0;D-=r?2:1){var P=w(m[D],"A decorator","be",!0),W=r?m[D-1]:void 0,F={},B={kind:["field","accessor","method","getter","setter","class"][i],name:o,metadata:a,addInitializer:(function(e,t){if(e.v)throw new TypeError("attempted to call addInitializer after decoration was finished");w(t,"An initializer","be",!0),s.push(t)}).bind(null,F)};if(C)l=P.call(W,V,B),F.v=1,w(l,"class decorators","return")&&(V=l);else if(B.static=d,B.private=u,l=B.access={has:u?g.bind():function(e){return o in e}},S||(l.get=u?E?function(e){return p(e),A.value}:T("get",0,p):function(e){return e[o]}),E||$||(l.set=u?T("set",0,p):function(e,t){e[o]=t}),V=P.call(W,_?{get:A.get,set:A.set}:A[O],B),F.v=1,_){if("object"==typeof V&&V)(l=w(V.get,"accessor.get"))&&(A.get=l),(l=w(V.set,"accessor.set"))&&(A.set=l),(l=w(V.init,"accessor.init"))&&j.unshift(l);else if(void 0!==V)throw new TypeError("accessor decorators must return an object with get, set, or init properties or undefined")}else w(V,(h?"field":"method")+" decorators","return")&&(h?j.unshift(V):A[O]=V)}return i<2&&c.push(x(j,d,1),x(s,d,0)),h||C||(u?_?c.splice(-1,0,T("get",d),T("set",d)):c.push(E?A[O]:w.call.bind(A[O])):f(e,o,A)),V}function _(e){return f(e,p,{configurable:!0,enumerable:!0,value:a})}return void 0!==s&&(a=s[p]),a=m(a??null),u=[],h=function(e){e&&u.push(x(e))},g=function(t,o){for(var s=0;s<r.length;s++){var a=r[s],l=a[1],h=7&l;if((8&l)==t&&!h==o){var g=a[2],p=!!a[3],f=16&l;C(t?e:e.prototype,a,f,p?"#"+g:Tp(g),h,h<2?[]:t?d=d||[]:c=c||[],u,!!t,p,o,t&&p?function(t){return Ap(t)===e}:i)}}},g(8,0),g(0,0),g(8,1),g(0,1),h(c),h(d),l=u,y||_(e),{e:l,get c(){var r=[];return y&&[_(e=C(e,[t],o,e.name,5,r)),x(r,1)]}}}(this,[],[[Pe(),1,"popoverOpen"],[He(),1,"currentView"]],0,void 0,lit_element_r).e)();static styles=(()=>be`
    :host {
      --gds-test-color: red;
    }
  `)();createRenderRoot(){return this}#n=(()=>vp(this,!1))();get popoverOpen(){return this.#n}set popoverOpen(e){this.#n=e}#r=(()=>(yp(this),xp(this,"theme-page")))();get currentView(){return this.#r}set currentView(e){this.#r=e}connectedCallback(){super.connectedCallback(),this.addEventListener("view-change",this.handleViewChange),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){this.removeEventListener("view-change",this.handleViewChange),document.removeEventListener("keydown",this.handleKeyDown),super.disconnectedCallback()}handleViewChange(e){this.currentView=e.detail.view}handleKeyDown=(()=>(wp(this),e=>{if("\\"===e.key){const e=this.querySelector("html");if(e){const t=e.getAttribute("gds-theme");e.setAttribute("color-scheme","light"===t?"dark":"light")}}}))();render(){return ht`
      <gds-theme color-scheme="light">
