...
`,wi,Xc,hr=class extends Y{constructor(){super(...arguments),f(this,wi)}render(){return m`<div aria-live="polite">
    ...
    `];a([y({property:"box-shadow",valueTemplate:e=>`var(--gds-shadow-${e})`})],mr.prototype,"shadow",2);a([y({valueTemplate:e=>e,styleTemplate:function(e,t){return`
      ...
      `}})],mr.prototype,"variant",2);mr=a([k("gds-card")],mr);var Wh=z`
  :host {
    display: inline-block;
  }
...
`,Yh=Uh,$i,sg,tt=class extends Y{constructor(){super(),f(this,$i),this.href="",this.variant="default"}render(){const e={secondary:this.variant==="secondary",hidden:this.variant==="hidden"};return Xr`
      <a
        href=${ue(this.href)}
    ...
    `}};$i=new WeakSet;sg=function(){return this.target==="_blank"?"noreferrer noopener":void 0};tt.styles=[J,G(Yh)];tt.shadowRootOptions={mode:"open",delegatesFocus:!0};a([g()],tt.prototype,"href",2);a([g()],tt.prototype,"target",2);a([g()],tt.prototype,"rel",2);a([g()],tt.prototype,"download",2);a([g()],tt.prototype,"variant",2);tt=a([k("gds-link")],tt);var qh=z`
  :host {
    display: block;
    margin: 0;
    padding: 0;
        ...
        ${Fu(this.focusedDate,t=>ge`
            ${t.map(s=>ge`
                <tr role="row">
                  ...
                  ${s.days.map(r=>{const o=this.customizedDates&&this.customizedDates.find(h=>dt(h.date,r)),n=ds({color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(h=>dt(h,r)))},o),i=!Au(this.focusedDate,r),l=(r<this.min||r>this.max)&&!dt(r,this.min)&&!dt(r,this.max),d=r.getDay()===0||r.getDay()===6,p=n.disabled||i||l||this.disabledWeekends&&d;return this.hideExtraneousDays&&i?ge`<td inert></td>`:ge`
                          <td
                            role="${ue(p?void 0:"gridcell")}"
                            class="${Fe({"custom-date":!!o,disabled:!!p,today:dt(e,r)})}"
                            ?disabled=${p}
                            tabindex="${dt(this.focusedDate,r)?0:-1}"
                            aria-selected="${this.value&&dt(this.value,r)?"true":"false"}"
...
`,u2=h2,rt=class extends be{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return Xr`<div part="mask"></div>
      <div part="content"><slot></slot></div>`}};rt.styles=[J,u2];a([y({selector:'[part="mask"]',valueTemplate:e=>{const[t]=e.split("/");return`linear-gradient(to ${t}, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0) 100%)`}})],rt.prototype,"mask-image",2);a([y({valueTemplate:e=>e,selector:'[part="mask"]'})],rt.prototype,"mask-size",2);a([y({valueTemplate:e=>e,selector:'[part="mask"]'})],rt.prototype,"mask-repeat",2);a([y({valueTemplate:e=>e,selector:'[part="mask"]'})],rt.prototype,"mask-position",2);a([y({selector:'[part="mask"]',valueTemplate:function(e){const[t,s]=e.split("/");return s?`color-mix(in srgb, var(--gds-color-${"l"+this.level}-background-${t}) ${parseFloat(s)*100}%, transparent 0%)`:`var(--gds-color-${"l"+this.level}-background-${t})`}})],rt.prototype,"background-color",2);a([y({valueTemplate:e=>e,selector:'[part="mask"]'})],rt.prototype,"backdrop-filter",2);rt=a([k("gds-mask")],rt);var f2=Object.defineProperty,m2=Object.getOwnPropertyDescriptor,b2=(e,t,s,r)=>{for(var o=r>1?void 0:r?m2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&f2(t,s,o),o};let _d=class extends M{connectedCallback(){super.connectedCallback()}render(){return m`
  ...
  `;so([g({type:Number})],Gt.prototype,"value",2);so([g({type:Number})],Gt.prototype,"min",2);so([g({type:Number})],Gt.prototype,"max",2);so([g({type:Number})],Gt.prototype,"step",2);Gt=so([L("tp-slider")],Gt);var P2=Object.defineProperty,H2=Object.getOwnPropertyDescriptor,Kt=(e,t,s,r)=>{for(var o=r>1?void 0:r?H2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&P2(t,s,o),o};let bt=class extends M{constructor(){super(),this.heading="",this.step=1,this.min=0,this.max=100,this.value=Math.max(this.min,this.max/2)}render(){return m`<gds-flex flex-direction="column" gap="xs"
      ...
      ></tp-slider
    ></gds-flex>`}};Kt([g({type:String})],bt.prototype,"heading",2);Kt([g({type:Number})],bt.prototype,"step",2);Kt([g({type:Number})],bt.prototype,"min",2);Kt([g({type:Number})],bt.prototype,"max",2);Kt([g({type:Number})],bt.prototype,"value",2);Kt([g({type:Object})],bt.prototype,"formatter",2);bt=Kt([L("tp-slider-input")],bt);var F2=Object.defineProperty,j2=Object.getOwnPropertyDescriptor,ot=(e,t,s,r)=>{for(var o=r>1?void 0:r?j2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&F2(t,s,o),o};let vs=class extends M{constructor(){super(...arguments),this.amount=175e3,this.year=5,this.rate=6.95,this.tab="house",this.currencyFormatter=new Intl.NumberFormat("sv-SE",{style:"currency",currency:"SEK",maximumFractionDigits:0}),this.percentageFormatter=new Intl.NumberFormat("sv-SE",{style:"percent",maximumFractionDigits:2})}render(){const e=W2(this.amount,this.year,this.rate),t=this.currencyFormatter.format(e),s=this.currencyFormatter.format(e+135);return m`<gds-card>
