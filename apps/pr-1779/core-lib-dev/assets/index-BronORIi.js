...
`,X=[J(Eg),J(Ag),J(Lg),J(Og),J(Mg),J(Tg)];Sg.instance.injectGlobalStyles("root-tokens",F`
    :root,
...
`,Ng=Rg,Tn=class extends U{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then(()=>xe.instance.apply(this,"gds-menu-heading"))}render(){return ue`<slot></slot>`}};Tn.styles=Ng;Tn=a([k("gds-menu-heading")],Tn);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nt=()=>(e,t)=>(e.addInitializer(Fd),e);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Rd{constructor(){this.settled=!1,this.promise=new Promise((t,s)=>{this._resolve=t,this._reject=s})}resolve(t){this.settled=!0,this._resolve(t)}reject(t){this.settled=!0,this._reject(t)}}/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function fn(e){window.dispatchEvent(new CustomEvent(An,{detail:e}))}let To="",vn,Nd,Ao,On,Id,kt=new Rd;kt.resolve();let Gr=0;const th=e=>(Gg((t,s)=>Qg(Id,t,s)),To=Nd=e.sourceLocale,Ao=new Set(e.targetLocales),Ao.add(e.sourceLocale),On=e.loadLocale,{getLocale:sh,setLocale:rh}),sh=()=>To,rh=e=>{if(e===(vn??To))return kt.promise;if(!Ao||!On)throw new Error("Internal error");if(!Ao.has(e))throw new Error("Invalid locale code");Gr++;const t=Gr;return vn=e,kt.settled&&(kt=new Rd),fn({status:"loading",loadingLocale:e}),(e===Nd?Promise.resolve({templates:void 0}):On(e)).then(r=>{Gr===t&&(To=e,vn=void 0,Id=r.templates,fn({status:"ready",readyLocale:e}),kt.resolve())},r=>{Gr===t&&(fn({status:"error",errorLocale:e,errorMessage:r.toString()}),kt.reject(r))}),kt.promise};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Wa,kc,Kn,Xn,Jn,$c,ns=class extends U{constructor(){super(...arguments),f(this,Wa),f(this,Jn),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,f(this,Kn,()=>m`
    ...
    `};ns.styles=[cp];a([h({type:Boolean,reflect:!0})],ns.prototype,"showExtendedSupportingText",2);a([W()],ns.prototype,"_hasExtendedSupportingText",2);a([oe("#extended-supporting-text")],ns.prototype,"_extendedSupportingText",2);ns=a([k("gds-form-control-header"),Nt()],ns);var gp=F`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`,pp=hp,me=class extends A{constructor(){super(),this.display="flex"}render(){return m`<slot></slot>`}};me.styles=[X,pp];a([y({styleTemplate:(e,t)=>{const s=t[0],r=t[1]||s;return`gap: ${s} ${r};`},cacheOverrideKey:"flex"})],me.prototype,"gap",2);a([y({valueTemplate:e=>e})],me.prototype,"flex",2);a([y({valueTemplate:e=>e})],me.prototype,"align-self",2);a([y({valueTemplate:e=>e})],me.prototype,"align-items",2);a([y({valueTemplate:e=>e})],me.prototype,"align-content",2);a([y({valueTemplate:e=>e})],me.prototype,"justify-content",2);a([y({valueTemplate:e=>e})],me.prototype,"place-content",2);a([y({valueTemplate:e=>e})],me.prototype,"justify-items",2);a([y({valueTemplate:e=>e})],me.prototype,"justify-self",2);a([y({property:"flex-direction",valueTemplate:e=>e})],me.prototype,"flex-direction",2);a([y({property:"flex-wrap",valueTemplate:e=>e})],me.prototype,"flex-wrap",2);me=a([k("gds-flex")],me);var or=class extends A{constructor(){super(),this.variant="primary",this.padding="s; m{l}",this["border-radius"]="xs; m{s}",this["border-width"]="4xs"}render(){return m`<slot></slot>`}};or.styles=[X,F`
    ...
    `];a([y({property:"box-shadow",valueTemplate:e=>`var(--gds-shadow-${e})`})],or.prototype,"shadow",2);a([y({valueTemplate:e=>e,styleTemplate:function(e,t){return`
      ...
      `}})],or.prototype,"variant",2);or=a([k("gds-card")],or);var up=F`
  :host {
    display: inline-block;
  }
...
@media (prefers-reduced-motion: reduce) {
  ...
  `;a([h({reflect:!0,attribute:"color-scheme"})],jt.prototype,"colorScheme",2);a([h({reflect:!0,attribute:"design-version"})],jt.prototype,"designVersion",2);a([ne("colorScheme")],jt.prototype,"_onColorSchemeChange",1);a([ne("designVersion")],jt.prototype,"_onDesignVersionChange",1);jt=a([k("gds-theme")],jt);var mp=F`
  :host {
    --_c: 12;
...
`,bp=mp,is=class extends A{constructor(){super(),this.display="grid",this.width="100%"}render(){return m`<slot></slot>`}};is.styles=[X,bp];a([y({property:"--_c",valueTemplate:e=>e})],is.prototype,"columns",2);a([y({styleTemplate:(e,t)=>{const s=t[0];return`--_gap-column: ${t[1]||s}; --_gap-row: ${s};`}})],is.prototype,"gap",2);a([y({property:"--_col-width",valueTemplate:e=>`${e}px`})],is.prototype,"auto-columns",2);is=a([k("gds-grid")],is);var xp=F`
  @layer core, link;
...
`,yp=xp,ri,Oc,et=class extends U{constructor(){super(),f(this,ri),this.href="",this.variant="default"}render(){const e={secondary:this.variant==="secondary",hidden:this.variant==="hidden"};return Pr`
    ...
    `}};ri=new WeakSet;Oc=function(){return this.target==="_blank"?"noreferrer noopener":void 0};et.styles=[X,J(yp)];et.shadowRootOptions={mode:"open",delegatesFocus:!0};a([h()],et.prototype,"href",2);a([h()],et.prototype,"target",2);a([h()],et.prototype,"rel",2);a([h()],et.prototype,"download",2);a([h()],et.prototype,"variant",2);et=a([k("gds-link")],et);var wp=F`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`,tt=class extends U{constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return m`<button
    ...
    `}};Il=Pp([j("gds-header")],Il);var Fa={fromAttribute(e){return new Date(e)},toAttribute(e){return e.toISOString()}},Hp={fromAttribute(e){return e.split(",").map(t=>new Date(t.trim()))},toAttribute(e){return JSON.stringify(e.map(t=>t.toISOString()))}};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,$s,hi,Hc,ar,jo,pi,Wc,ui,jc,fi,Fc,Mt,qt,vi,Rc,mi,bi,xi,yi,wi,_i,Ci,ki,$i,Si,Fo,Mi,Ei,io,Ti,Ai,Ke,Oi,Nc,Na,Ic,Y=class extends Me{constructor(){super(...arguments),f(this,hi),f(this,ar),f(this,pi),f(this,ui),f(this,fi),f(this,Mt),f(this,vi),f(this,io),f(this,Oi),f(this,Na),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.label="",this.showWeekNumbers=!1,this.size="medium",this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=C(this,io,Ti).call(this,"y-m-d"),f(this,$s,void 0),f(this,mi,e=>{this._elTrigger.then(t=>{var s,r;((s=e.relatedTarget)==null?void 0:s.parentElement)!==e.target&&((r=document.getSelection())==null||r.removeAllRanges())})}),f(this,bi,e=>{this._elTrigger.then(t=>{var s,r;(s=document.getSelection())==null||s.removeAllRanges();const o=new Range;o.setStart(t.firstChild,0),o.setEnd(t.lastChild,4),(r=document.getSelection())==null||r.addRange(o)})}),f(this,xi,e=>{this._elField.then(t=>{var s;e.currentTarget===t&&(e.preventDefault(),(s=e.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),f(this,yi,e=>{this._elField.then(t=>{var s;if(e.currentTarget!==t)return;e.preventDefault();const r=(s=e.clipboardData)==null?void 0:s.getData("text/plain");if(!r)return;let o=new Date("-");const n="Invalid Date",i=r.split(this._dateFormatLayout.delimiter);if(i.length===3){const l=this._dateFormatLayout.layout,d=parseInt(i[l.findIndex(p=>p.token==="y")]),g=parseInt(i[l.findIndex(p=>p.token==="m")])-1,v=parseInt(i[l.findIndex(p=>p.token==="d")]);!isNaN(d)&&!isNaN(g)&&!isNaN(v)&&(o=new Date(`${d}-${g+1}-${v}`))}o.toString()===n&&(o=new Date(r),o.toString()===n)||(this.value=o,C(this,Mt,qt).call(this))})}),f(this,wi,e=>{var t;(t=this._elSpinners[0])==null||t.focus()}),f(this,_i,e=>{e.stopPropagation(),this.value=e.detail,this.open=!1,C(this,Mt,qt).call(this)}),f(this,Ci,e=>{var t;e.stopPropagation(),this._focusedMonth=(t=e.target)==null?void 0:t.value}),f(this,ki,e=>{var t;e.stopPropagation(),this._focusedYear=(t=e.target)==null?void 0:t.value}),f(this,$i,e=>{this._focusedMonth++,this._focusedMonth>11&&(this._focusedMonth=0,this._focusedYear++)}),f(this,Si,e=>{this._focusedMonth--,this._focusedMonth<0&&(this._focusedMonth=11,this._focusedYear--)}),f(this,Fo,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),C(this,vi,Rc).call(this)}),f(this,Mi,async e=>{if(e.target===e.currentTarget){if(this.open=e.detail.open,e.detail.reason==="close"){const t=(await this._elCalendar).value;!lt(t||new Date(0),c(this,$s)||new Date(0))&&(this.value=t,C(this,Mt,qt).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}e.detail.reason==="cancel"&&(this.value=c(this,$s))}}),f(this,Ei,e=>{const t=Array.from(this._elSpinners).findIndex(s=>s===e.target);if(e.key==="ArrowRight"){const s=this._elSpinners[t+1];s&&s.focus()}if(e.key==="ArrowLeft"){const s=this._elSpinners[t-1];s&&s.focus()}}),f(this,Ai,(e,t)=>{c(this,Ke)[t]=e;const s=new Date;s.setFullYear(parseInt(c(this,Ke).year)),s.setMonth(parseInt(c(this,Ke).month)-1),s.setDate(parseInt(c(this,Ke).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,C(this,Mt,qt).call(this))}),f(this,Ke,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map(e=>e.token).join(this._dateFormatLayout.delimiter)}set dateformat(e){this._dateFormatLayout=C(this,io,Ti).call(this,e)}async getFocusedDate(){if(this.open)return this._elCalendar.then(e=>e.focusedDate)}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(e){return this._elCalendar.then(t=>t.getDateCell(e))}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-datepicker")}render(){return m`${ae(this.label&&!this.hideLabel,()=>m`<label for="spinner-0" id="label">${this.label}</label>`)}
      ...
      >
        ...
        >
          ${Wp(jp(this._dateFormatLayout.layout,(e,t)=>m`<gds-date-part-spinner
                  ...
                  aria-valuemax=${C(this,fi,Fc).call(this,e.name)}
      ...
      >
        <div class="header">
          ...
          <gds-dropdown
            ...
            hide-label
          >
            ${Fp(c(this,Oi,Nc),e=>e,e=>m`<gds-option value=${e}>${e}</gds-option>`)}
          </gds-dropdown>
          <gds-button
            @click=${c(this,$i)}
...
`,hu=gu,Ro,Ia,Ui,Yc,ee=class extends U{constructor(){super(...arguments),f(this,Ro),f(this,Ui),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=e=>e.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(e){const t=tu(new Date(this.focusedYear,e,1)),s=new Date(this.focusedDate);s.setDate(Math.min(this.focusedDate.getDate(),t.getDate())),s.setMonth(e),s.setHours(12,0,0,0),this.focusedDate=s}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(this.focusedDate.setFullYear(e))}getDateCell(e){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector(`#dateCell-${e}`)}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",C(this,Ui,Yc)),window.addEventListener("lit-localize-status",e=>{e.detail.status==="ready"&&(this._currentLocale=e.detail.readyLocale)})}focus(){var e;super.focus(),(e=this._elFocusedCell)==null||e.focus()}render(){const e=new Date;return ue`<table role="grid" aria-label="${pe(this.label)}">
  ...
  `;Yi=a([k("gds-form-summary")],Yi);var pu=F`
  #body {
    visibility: hidden;
    position: absolute;
    z-index: 1060;
...
`,vu=fu,gr=class extends de{connectedCallback(){super.connectedCallback(),this._dynamicStylesController.inject("FAB_styles",vu)}};a([y({valueTemplate:e=>e,selector:'[part="_button"]'})],gr.prototype,"position",2);a([y({valueTemplate:e=>e})],gr.prototype,"transform",2);a([y({valueTemplate:e=>e,selector:'[part="_button"]'})],gr.prototype,"inset",2);gr=a([k("gds-fab")],gr);var mu=Object.defineProperty,bu=Object.getOwnPropertyDescriptor,xu=(e,t,s,r)=>{for(var o=r>1?void 0:r?bu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&mu(t,s,o),o};let Yl=class extends D{createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m`<gds-card border="4xs/base300" padding="m" border-radius="s">
    ...
    <gds-card variant="copper-01" padding="s">
        ...
        `}};Kl=Du([j("tp-card-carousel")],Kl);var zu=Object.defineProperty,Vu=Object.getOwnPropertyDescriptor,Pu=(e,t,s,r)=>{for(var o=r>1?void 0:r?Vu(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&zu(t,s,o),o};let Xl=class extends D{createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return m`<tp-card-carousel></tp-card-carousel>`}};Xl=Pu([j("gds-onboarding")],Xl);var Hu=F`
  :host {
    display: block;
  }
...
`,Fu=ju,st=class extends me{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return Pr`<div part="mask"></div>
    ...
    </gds-flex>`};u1=function(e){const s=e.target.assignedNodes({flatten:!0});this.mainSlotOccupied=s.length>0&&s.some(r=>{var o;return r.nodeType===Node.ELEMENT_NODE||r.nodeType===Node.TEXT_NODE&&((o=r.textContent)==null?void 0:o.trim())!==""})};Rr([W()],cs.prototype,"hideFooter",2);Rr([h({type:Boolean})],cs.prototype,"wide",2);Rr([W()],cs.prototype,"footerSlotOccupied",2);Rr([W()],cs.prototype,"mainSlotOccupied",2);cs=Rr([j("tp-card")],cs);var h2=Object.defineProperty,p2=Object.getOwnPropertyDescriptor,u2=(e,t,s,r)=>{for(var o=r>1?void 0:r?p2(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&h2(t,s,o),o};let rd=class extends D{connectedCallback(){super.connectedCallback()}render(){return m`<tp-card>
    ...
    `}};cd=W2([j("gds-dashboard")],cd);var j2=F`
  :host {
    font-size: var(--gds-text-size-body-m);
    line-height: var(--gds-text-line-height-body-m);
...
>
  ...
  height: 100%;
    ...
    ></slot>`}onShowChange(){console.log("show",this.show);const e=this.scrollHeight;this.show?(this.style.height=`${e}px`,this.style.opacity="1",this.style.marginBottom="var(--gds-space-3xl)",setTimeout(()=>{this.style.height="auto"},500)):(this.style.height="0",this.style.opacity="0",this.style.marginBottom="0")}};Or.styles=F`
    :host {
      display: block;
      transition: all 0.5s;
      overflow: hidden;
  ...
  `;Ja([h()],Or.prototype,"show",2);Ja([ne("show",{waitUntilFirstUpdate:!0}),Dc()],Or.prototype,"onShowChange",1);Or=Ja([j("tp-page-section")],Or);var bf=Object.defineProperty,xf=Object.getOwnPropertyDescriptor,ms=(e,t,s,r)=>{for(var o=r>1?void 0:r?xf(t,s):t,n=e.length-1,i;n>=0;n--)(i=e[n])&&(o=(r?i(t,s,o):i(o))||o);return r&&o&&bf(t,s,o),o};let Rt=class extends D{constructor(){super(...arguments),this.hasExternalAccounts=!1,this.hasAccounts=!1,this.hasCards=!1,this.hasSavings=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){var e,t,s;return m`
      <gds-flex flex-direction="column">
