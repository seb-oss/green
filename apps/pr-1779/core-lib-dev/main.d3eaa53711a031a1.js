...
`,hr=class extends qt{connectedCallback(){super.connectedCallback(),this.setAttribute("inert","true"),this.updateComplete.then((()=>dr.instance.apply(this,"gds-menu-heading")))}render(){return ee`<slot></slot>`}};hr.styles=cr,hr=et([lt("gds-menu-heading")],hr);const ur=(e,...t)=>({strTag:!0,strings:e,values:t}),pr=(e,t,r)=>{let o=e[0];for(let s=1;s<e.length;s++)o+=t[r?r[s-1]:s-1],o+=e[s];return o},gr=e=>{return"string"!=typeof(t=e)&&"strTag"in t?pr(e.strings,e.values):e;var t};let fr=gr,br=!1;const vr="lit-localize-status";class LocalizeController{constructor(e){this.__litLocalizeEventHandler=e=>{"ready"===e.detail.status&&this.host.requestUpdate()},this.host=e}hostConnected(){window.addEventListener(vr,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(vr,this.__litLocalizeEventHandler)}}const mr=e=>e.addController(new LocalizeController(e)),yr=()=>(e,t)=>(e.addInitializer(mr),e);class Deferred{constructor(){this.settled=!1,this.promise=new Promise(((e,t)=>{this._resolve=e,this._reject=t}))}resolve(e){this.settled=!0,this._resolve(e)}reject(e){this.settled=!0,this._reject(e)}}const xr=[];for(let lu=0;lu<256;lu++)xr[lu]=(lu>>4&15).toString(16)+(15&lu).toString(16);function wr(e,t){return(t?"h":"s")+function(e){let t=0,r=8997,o=0,s=33826,i=0,a=40164,l=0,d=52210;for(let c=0;c<e.length;c++)r^=e.charCodeAt(c),t=435*r,o=435*s,i=435*a,l=435*d,i+=r<<8,l+=s<<8,o+=t>>>16,r=65535&t,i+=o>>>16,s=65535&o,d=l+(i>>>16)&65535,a=65535&i;return xr[d>>8]+xr[255&d]+xr[a>>8]+xr[255&a]+xr[s>>8]+xr[255&s]+xr[r>>8]+xr[255&r]}("string"==typeof e?e:e.join("\x1e"))}const kr=new WeakMap,_r=new Map;function Cr(e,t,r){if(e){const o=r?.id??function(e){const t="string"==typeof e?e:e.strings;let r=_r.get(t);void 0===r&&(r=wr(t,"string"!=typeof e&&!("strTag"in e)),_r.set(t,r));return r}(t),s=e[o];if(s){if("string"==typeof s)return s;if("strTag"in s)return pr(s.strings,t.values,s.values);{let e=kr.get(s);return void 0===e&&(e=s.values,kr.set(s,e)),{...s,values:e.map((e=>t.values[e]))}}}}return gr(t)}function $r(e){window.dispatchEvent(new CustomEvent(vr,{detail:e}))}let Sr,Er,Ar,Tr,Mr,zr="",jr=new Deferred;jr.resolve();let Dr=0;const Or=e=>(function(e){if(br)throw new Error("lit-localize can only be configured once");fr=e,br=!0}(((e,t)=>Cr(Mr,e,t))),zr=Er=e.sourceLocale,Ar=new Set(e.targetLocales),Ar.add(e.sourceLocale),Tr=e.loadLocale,{getLocale:Lr,setLocale:Pr}),Lr=()=>zr,Pr=e=>{if(e===(Sr??zr))return jr.promise;if(!Ar||!Tr)throw new Error("Internal error");if(!Ar.has(e))throw new Error("Invalid locale code");Dr++;const t=Dr;Sr=e,jr.settled&&(jr=new Deferred),$r({status:"loading",loadingLocale:e});return(e===Er?Promise.resolve({templates:void 0}):Tr(e)).then((r=>{Dr===t&&(zr=e,Sr=void 0,Mr=r.templates,$r({status:"ready",readyLocale:e}),jr.resolve())}),(r=>{Dr===t&&($r({status:"error",errorLocale:e,errorMessage:r.toString()}),jr.reject(r))})),jr.promise},Wr=1,Vr=2,Hr=6,Nr=e=>(...t)=>({_$litDirective$:e,values:t});class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Rr=Nr(class extends directive_i{constructor(e){if(super(e),e.type!==Wr||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const r=e.element.classList;for(const o of this.st)o in t||(r.remove(o),this.st.delete(o));for(const o in t){const e=!!t[o];e===this.st.has(o)||this.nt?.has(o)||(e?(r.add(o),this.st.add(o)):(r.remove(o),this.st.delete(o)))}return ne}});var Fr,Br,Ir,Ur=ve`
  @layer base, reset, transitional-styles;
  @layer base {
    button {
      display: flex;
...
`,rs=class extends qt{constructor(){super(...arguments),nt(this,Oo),nt(this,Fo),nt(this,Io),nt(this,Zo),nt(this,Yo),this.open=!1,this.popupRole="dialog",this.label=void 0,this.placement="bottom-start",this.disableMobileStyles=!1,this.calcMinWidth=e=>`${e.offsetWidth}px`,this.calcMaxWidth=e=>"auto",this.calcMinHeight=e=>"auto",this.calcMaxHeight=e=>"500px",this.nonmodal=!1,this.floatingUIMiddleware=[Ao(8),Mo()],this._trigger=void 0,this._anchor=void 0,this._isVirtKbVisible=!1,nt(this,Po,void 0),nt(this,Wo,!1),nt(this,Vo,void 0),nt(this,Ho,(()=>{this.open=!1,rt(this,No).call(this,"cancel")})),nt(this,No,(e=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{open:this.open,reason:e},bubbles:!1,composed:!1}))})),nt(this,Ro,(e=>{e.stopPropagation(),e.preventDefault(),this.open=!1,rt(this,No).call(this,"close"),setTimeout((()=>{var e;return null==(e=this._trigger)?void 0:e.focus()}),250)})),nt(this,Ko,(e=>{"ArrowDown"!==e.key&&"ArrowUp"!==e.key||(e.preventDefault(),this.open=!0,rt(this,No).call(this,"show")),"Escape"===e.key&&this.open&&rt(this,Ho).call(this)})),nt(this,Xo,(e=>{e.preventDefault(),this.open=!this.open,rt(this,No).call(this,this.open?"show":"close")})),nt(this,Jo,(()=>{var e;const t=null==(e=this._elDefaultSlot)?void 0:e.assignedElements()[0];this.updateComplete.then((()=>{null==t||t.focus()}))})),nt(this,Qo,(e=>{const t=e,r=this._elDialog;if((t.clientX>0||t.clientY>0)&&r&&this.open){const e=r.getBoundingClientRect();e.top<=t.clientY&&t.clientY<=e.top+e.height&&e.left<=t.clientX&&t.clientX<=e.left+e.width||(this.open=!1,rt(this,No).call(this,"close"))}}))}_handleTriggerRefChanged(){var e;null==(e=this.triggerRef)||e.then((e=>{e&&(this._trigger=e)}))}_handleAnchorRefChanged(){var e;null==(e=this.anchorRef)||e.then((e=>{e&&(this._anchor=e)}))}_handleTriggerChanged(){st(this,Fo,Bo).call(this),st(this,Zo,Go).call(this)}_handleAnchorChanged(){st(this,Yo,qo).call(this)}connectedCallback(){super.connectedCallback(),dr.instance.apply(this,"gds-popover"),st(this,Fo,Bo).call(this),this._handleOpenChange(),this.addEventListener("keydown",(e=>{"Escape"===e.key&&this.open&&(rt(this,Ho).call(this),e.stopPropagation(),e.preventDefault())})),this.addEventListener("focusin",(e=>{const t=e.target;"INPUT"===t.tagName||"TEXTAREA"===t.tagName?this._isVirtKbVisible=!0:this._isVirtKbVisible=!1})),this.addEventListener("blurin",(e=>{this._isVirtKbVisible=!1}))}disconnectedCallback(){super.disconnectedCallback(),st(this,Io,Uo).call(this)}render(){return ut`<slot
      ...
      </div>`}_handleOpenChange(){const e=(this.nonmodal?rt(this,Vo):this._elDialog)||document;this.updateComplete.then((()=>{var t,r,o,s;null==(t=this._trigger)||t.setAttribute("aria-expanded",String(this.open)),this.open?(this.nonmodal?null==(o=this._elDialog)||o.setAttribute("open","true"):null==(r=this._elDialog)||r.showModal(),rt(this,Jo).call(this),requestAnimationFrame((()=>{rt(this,Vo)&&(rt(this,Vo).show=!0)})),setTimeout((()=>rt(this,Jo).call(this)),250),setTimeout((()=>e.addEventListener("click",rt(this,Qo))),0)):(null==(s=this._elDialog)||s.close(),e.removeEventListener("click",rt(this,Qo)),rt(this,Vo)&&(rt(this,Vo).show=!1))}))}_handleBackdropChange(){var e;const t=null==(e=this.parentElement)?void 0:e.getRootNode();this.backdrop&&t&&ot(this,Vo,t.querySelector(this.backdrop))}_handleMobileLayout(e){var t,r,o,s;ot(this,Wo,e),e&&!this.disableMobileStyles?(null==(t=rt(this,Po))||t.call(this),null==(r=this._elDialog)||r.style.removeProperty("left"),null==(o=this._elDialog)||o.style.removeProperty("top"),null==(s=this._elDialog)||s.style.removeProperty("minWidth"),this.updateComplete.then((()=>{var e;this.open&&(null==(e=this._elDialog)||e.showModal())}))):this.updateComplete.then((()=>{st(this,Yo,qo).call(this)}))}};Oo=new WeakSet,Lo=function(){this._elTriggerSlot&&this._elTriggerSlot.assignedElements()[0]&&(this._trigger=this._elTriggerSlot.assignedElements()[0],this._anchor=this._elTriggerSlot.assignedElements()[0])},Po=new WeakMap,Wo=new WeakMap,Vo=new WeakMap,Ho=new WeakMap,No=new WeakMap,Ro=new WeakMap,Fo=new WeakSet,Bo=function(){var e,t;null==(e=this._trigger)||e.addEventListener("keydown",rt(this,Ko)),null==(t=this._trigger)||t.addEventListener("click",rt(this,Xo))},Io=new WeakSet,Uo=function(){var e,t,r;null==(e=this._trigger)||e.removeEventListener("keydown",rt(this,Ko)),null==(t=this._trigger)||t.removeEventListener("click",rt(this,Xo)),null==(r=rt(this,Po))||r.call(this)},Zo=new WeakSet,Go=function(){var e;if(this._trigger){null==(e=this._trigger)||e.setAttribute("aria-expanded",String(this.open));const t=["A","BUTTON","INPUT","TEXTAREA"];this._trigger.nodeName.startsWith("GDS-")||t.includes(this._trigger.nodeName)||(this._trigger.setAttribute("tabindex","0"),this._trigger.setAttribute("role","button"));const r=this._trigger.nodeName.startsWith("GDS-")?"gds-aria-haspopup":"aria-haspopup";null===this._trigger.getAttribute(r)&&this._trigger.setAttribute(r,this.popupRole)}},Yo=new WeakSet,qo=function(){if(!this._anchor||!this._elDialog)return;const e=this._anchor,t=this._elDialog;e&&t&&(!rt(this,Wo)||this.disableMobileStyles)&&(rt(this,Po)&&rt(this,Po).call(this),ot(this,Po,So(e,t,(()=>{Object.assign(t.style,{minWidth:this.calcMinWidth(e),maxWidth:this.calcMaxWidth(e),minHeight:this.calcMinHeight(e),maxHeight:this.calcMaxHeight(e)}),Do(e,t,{placement:this.placement,middleware:this.floatingUIMiddleware,strategy:"fixed"}).then((e=>{let{x:r,y:o}=e;return Object.assign(t.style,{left:`${r}px`,top:`${o}px`})}))}))))},Ko=new WeakMap,Xo=new WeakMap,Jo=new WeakMap,Qo=new WeakMap,rs.styles=be(ts),et([We({type:Boolean,reflect:!0})],rs.prototype,"open",2),et([We({attribute:"popup-role"})],rs.prototype,"popupRole",2),et([We({attribute:!1})],rs.prototype,"triggerRef",2),et([We({attribute:!1})],rs.prototype,"anchorRef",2),et([We()],rs.prototype,"label",2),et([We()],rs.prototype,"placement",2),et([We({type:Boolean})],rs.prototype,"disableMobileStyles",2),et([We({attribute:!1})],rs.prototype,"calcMinWidth",2),et([We({attribute:!1})],rs.prototype,"calcMaxWidth",2),et([We({attribute:!1})],rs.prototype,"calcMinHeight",2),et([We({attribute:!1})],rs.prototype,"calcMaxHeight",2),et([We({type:Boolean})],rs.prototype,"nonmodal",2),et([We()],rs.prototype,"backdrop",2),et([We({attribute:!1})],rs.prototype,"floatingUIMiddleware",2),et([Ve()],rs.prototype,"_trigger",2),et([Ve()],rs.prototype,"_anchor",2),et([Ve()],rs.prototype,"_isVirtKbVisible",2),et([Ne("slot:not([name])")],rs.prototype,"_elDefaultSlot",2),et([Ne('slot[name="trigger"]')],rs.prototype,"_elTriggerSlot",2),et([Ne("dialog")],rs.prototype,"_elDialog",2),et([yn("triggerRef")],rs.prototype,"_handleTriggerRefChanged",1),et([yn("anchorRef")],rs.prototype,"_handleAnchorRefChanged",1),et([yn("_trigger")],rs.prototype,"_handleTriggerChanged",1),et([yn("_anchor")],rs.prototype,"_handleAnchorChanged",1),et([yn("open")],rs.prototype,"_handleOpenChange",1),et([yn("backdrop")],rs.prototype,"_handleBackdropChange",1),et([(es="(max-width: 576px)",(e,t,r)=>{const o=window.matchMedia(es),s=e.connectedCallback,i=e.disconnectedCallback;e.connectedCallback=function(){var e;null==s||s.call(this);const t=e=>{var t;null==(t=r.value)||t.call(this,e.matches)};o.addEventListener("change",t),this.disconnectedCallback=function(){null==i||i.call(this),o.removeEventListener("change",t)},null==(e=r.value)||e.call(this,o.matches)}})],rs.prototype,"_handleMobileLayout",1),rs=et([lt("gds-popover"),yr()],rs);class unsafe_html_e extends directive_i{constructor(e){if(super(e),this.it=oe,e.type!==Vr)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===oe||null==e)return this._t=void 0,this.it=e;if(e===ne)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}unsafe_html_e.directiveName="unsafeHTML",unsafe_html_e.resultType=1;const ns=Nr(unsafe_html_e);var os=ve`
  @layer icon;
...
`,ri=class extends ys{constructor(){super(),nt(this,Os),nt(this,Ps),nt(this,Bs),nt(this,Us),nt(this,Gs),nt(this,qs),nt(this,Xs),nt(this,Qs),this.value="",this.label="",this.supportingText="",this.showExtendedSupportingText=!1,this.disabled=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",this.trailSlotOccupied=!1,nt(this,Vs,(e=>["type","placeholder","required"].includes(e.name))),nt(this,Hs,(e=>{const t=e.target;this.value=t.value})),nt(this,Ns,(e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})),nt(this,Rs,(()=>{this.elInputAsync.then((e=>e.focus()))})),nt(this,Fs,(()=>{this.value=""}))}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}render(){return ut`${Be(this.variant,[["default",()=>st(this,Os,Ls).call(this)],["floating-label",()=>st(this,Ps,Ws).call(this)]])}`}_getValidityAnchor(){return this.elInput}};Os=new WeakSet,Ls=function(){return ut`
      ...
      ></gds-form-control-footer>
    `},Ps=new WeakSet,Ws=function(){return oe},Vs=new WeakMap,Hs=new WeakMap,Ns=new WeakMap,Rs=new WeakMap,Fs=new WeakMap,Bs=new WeakSet,Is=function(){return ut` <slot name="lead"></slot> `},Us=new WeakSet,Zs=function(){return ut`
    ...
    `},Xs=new WeakSet,Js=function(){return this.clearable&&this.value.length>0?ut`
      ...
      `:oe},Qs=new WeakSet,ei=function(){return this.maxlength<Number.MAX_SAFE_INTEGER},ri.styles=[Yt,ti],et([We()],ri.prototype,"value",2),et([We()],ri.prototype,"label",2),et([We({attribute:"supporting-text"})],ri.prototype,"supportingText",2),et([We({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],ri.prototype,"showExtendedSupportingText",2),et([We({attribute:"disabled",type:Boolean,reflect:!0})],ri.prototype,"disabled",2),et([We({type:Boolean})],ri.prototype,"clearable",2),et([We({type:Number})],ri.prototype,"maxlength",2),et([We({type:String})],ri.prototype,"variant",2),et([We({type:String})],ri.prototype,"size",2),et([Fe("input")],ri.prototype,"elInputAsync",2),et([Ne("input")],ri.prototype,"elInput",2),et([Ve()],ri.prototype,"trailSlotOccupied",2),ri=et([lt("gds-input"),yr()],ri);var ni,oi,si,ii,ai,li,di=ve`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`,ci=class extends qt{constructor(){super(...arguments),nt(this,ni),nt(this,ai),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,nt(this,si,(()=>ut`
    ...
    `},ci.styles=[di],et([We({type:Boolean,reflect:!0})],ci.prototype,"showExtendedSupportingText",2),et([Ve()],ci.prototype,"_hasExtendedSupportingText",2),et([Ne("#extended-supporting-text")],ci.prototype,"_extendedSupportingText",2),ci=et([lt("gds-form-control-header"),yr()],ci);var hi,ui,pi=ve`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`,Di=class extends Xt{constructor(){super(),this.display="grid",this.width="100%"}render(){return ut`<slot></slot>`}};Di.styles=[Yt,ji],et([Ot({property:"--_c",valueTemplate:e=>e})],Di.prototype,"columns",2),et([Ot({styleTemplate:(e,t)=>{const r=t[0];return`--_gap-column: ${t[1]||r}; --_gap-row: ${r};`}})],Di.prototype,"gap",2),et([Ot({property:"--_col-width",valueTemplate:e=>`${e}px`})],Di.prototype,"auto-columns",2),Di=et([lt("gds-grid")],Di);var Oi,Li,Pi=ve`
  @layer core, link;
...
`,Wi=class extends qt{constructor(){super(),nt(this,Oi),this.href="",this.variant="default"}render(){const e={secondary:"secondary"===this.variant};return nr`
      <a
        href=${xs(this.href)}
        target=${xs(this.target)}
        rel=${xs(this.rel||rt(this,Oi,Li))}
    ...
    `}};Oi=new WeakSet,Li=function(){return"_blank"===this.target?"noreferrer noopener":void 0},Wi.styles=[Yt,be(Pi)],Wi.shadowRootOptions={mode:"open",delegatesFocus:!0},et([We()],Wi.prototype,"href",2),et([We()],Wi.prototype,"target",2),et([We()],Wi.prototype,"rel",2),et([We()],Wi.prototype,"download",2),et([We()],Wi.prototype,"variant",2),Wi=et([lt("gds-link")],Wi);var Vi=ve`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`,Ta=class extends mi{constructor(){super(),this["mask-size"]="cover",this["mask-repeat"]="no-repeat",this["mask-position"]="center",this.position="relative",this.inset="0"}render(){return nr`<div part="mask"></div>
      <div part="content"><slot></slot></div>`}};Ta.styles=[Yt,Aa],et([Ot({selector:'[part="mask"]',valueTemplate:e=>{const[t]=e.split("/");return`linear-gradient(to ${t}, rgba(0, 0, 0, 1) 20%, rgba(0, 0, 0, 0) 100%)`}})],Ta.prototype,"mask-image",2),et([Ot({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"mask-size",2),et([Ot({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"mask-repeat",2),et([Ot({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"mask-position",2),et([Ot({selector:'[part="mask"]',valueTemplate:function(e){const[t,r]=e.split("/");return r?`color-mix(in srgb, var(--gds-color-${"l"+this.level}-background-${t}) ${100*parseFloat(r)}%, transparent 0%)`:`var(--gds-color-${"l"+this.level}-background-${t})`}})],Ta.prototype,"background-color",2),et([Ot({valueTemplate:e=>e,selector:'[part="mask"]'})],Ta.prototype,"backdrop-filter",2),Ta=et([lt("gds-mask")],Ta);const Ma=r.p+"image 23.295f27d8244d5f11.png";let za,ja;function Da(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:La((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||La(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Oa(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Oa(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function La(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}const Pa=[{img:Ma,heading:"Nu s\xe4nker vi bol\xe5ner\xe4ntan!",body:"Den 8 november s\xe4nker vi v\xe5ra bol\xe5ne\xad\xadr\xe4ntor f\xf6r flera bindnings\xad\xadtider. Den r\xf6rliga 3-m\xe5naders\xad\xadr\xe4ntan s\xe4nks med 0,50 procent\xadenheter.",button:"Read article"},{img:Ma,heading:"Nu s\xe4nker vi bol\xe5ner\xe4ntan!",body:"Den 8 november s\xe4nker vi v\xe5ra bol\xe5ne\xad\xadr\xe4ntor f\xf6r flera bindnings\xad\xadtider. Den r\xf6rliga 3-m\xe5naders\xad\xadr\xe4ntan s\xe4nks med 0,50 procent\xadenheter.",button:"Read article"},{img:Ma,heading:"Nu s\xe4nker vi bol\xe5ner\xe4ntan!",body:"Den 8 november s\xe4nker vi v\xe5ra bol\xe5ne\xad\xadr\xe4ntor f\xf6r flera bindnings\xad\xadtider. Den r\xf6rliga 3-m\xe5naders\xad\xadr\xe4ntan s\xe4nks med 0,50 procent\xadenheter.",button:"Read article"}];let Wa;ja=[Oe("tp-news-widget")];class TpNewsWidget extends lit_element_r{static#e=(()=>[Wa,za]=Da(this,[],ja,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut` <gds-theme>
      <gds-flex flex-direction="column" gap="l">
        <gds-text tag="h2" font-size="heading-m">${"Inspiration och annat"}</gds-text>
        <gds-grid columns="1; s{2} m{3}" gap="m">
          ${Pa.map((e=>ut`<gds-card
                border="4xs/primary"
                border-radius="xs"
                overflow="hidden"
                padding="0"
...
`,Dl=class extends ys{constructor(){super(...arguments),nt(this,Xa),nt(this,Qa),nt(this,tl),nt(this,nl),nt(this,sl),nt(this,al),nt(this,dl),nt(this,Cl),nt(this,Al),nt(this,Ml),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.open=!1,this.label="",this.showWeekNumbers=!1,this.size="medium",this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=(new Date).getMonth(),this._focusedYear=(new Date).getFullYear(),this._dateFormatLayout=st(this,Cl,$l).call(this,"y-m-d"),nt(this,Ka,void 0),nt(this,hl,(e=>{this._elTrigger.then((t=>{var r,o;(null==(r=e.relatedTarget)?void 0:r.parentElement)!==e.target&&(null==(o=document.getSelection())||o.removeAllRanges())}))})),nt(this,ul,(e=>{this._elTrigger.then((e=>{var t,r;null==(t=document.getSelection())||t.removeAllRanges();const o=new Range;o.setStart(e.firstChild,0),o.setEnd(e.lastChild,4),null==(r=document.getSelection())||r.addRange(o)}))})),nt(this,pl,(e=>{this._elField.then((t=>{var r;e.currentTarget===t&&(e.preventDefault(),null==(r=e.clipboardData)||r.setData("text/plain",this.displayValue))}))})),nt(this,gl,(e=>{this._elField.then((t=>{var r;if(e.currentTarget!==t)return;e.preventDefault();const o=null==(r=e.clipboardData)?void 0:r.getData("text/plain");if(!o)return;let s=new Date("-");const i="Invalid Date",a=o.split(this._dateFormatLayout.delimiter);if(3===a.length){const e=this._dateFormatLayout.layout,t=parseInt(a[e.findIndex((e=>"y"===e.token))]),r=parseInt(a[e.findIndex((e=>"m"===e.token))])-1,o=parseInt(a[e.findIndex((e=>"d"===e.token))]);isNaN(t)||isNaN(r)||isNaN(o)||(s=new Date(`${t}-${r+1}-${o}`))}s.toString()===i&&(s=new Date(o),s.toString()===i)||(this.value=s,st(this,al,ll).call(this))}))})),nt(this,fl,(e=>{var t;null==(t=this._elSpinners[0])||t.focus()})),nt(this,bl,(e=>{e.stopPropagation(),this.value=e.detail,this.open=!1,st(this,al,ll).call(this)})),nt(this,vl,(e=>{var t;e.stopPropagation(),this._focusedMonth=null==(t=e.target)?void 0:t.value})),nt(this,ml,(e=>{var t;e.stopPropagation(),this._focusedYear=null==(t=e.target)?void 0:t.value})),nt(this,yl,(e=>{this._focusedMonth++,this._focusedMonth>11&&(this._focusedMonth=0,this._focusedYear++)})),nt(this,xl,(e=>{this._focusedMonth--,this._focusedMonth<0&&(this._focusedMonth=11,this._focusedYear--)})),nt(this,wl,(async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),st(this,dl,cl).call(this)})),nt(this,kl,(async e=>{if(e.target===e.currentTarget){if(this.open=e.detail.open,"close"===e.detail.reason){const e=(await this._elCalendar).value;!qa(e||new Date(0),rt(this,Ka)||new Date(0))&&(this.value=e,st(this,al,ll).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}"cancel"===e.detail.reason&&(this.value=rt(this,Ka))}})),nt(this,_l,(e=>{const t=Array.from(this._elSpinners).findIndex((t=>t===e.target));if("ArrowRight"===e.key){const e=this._elSpinners[t+1];e&&e.focus()}if("ArrowLeft"===e.key){const e=this._elSpinners[t-1];e&&e.focus()}})),nt(this,Sl,((e,t)=>{rt(this,El)[t]=e;const r=new Date;r.setFullYear(parseInt(rt(this,El).year)),r.setMonth(parseInt(rt(this,El).month)-1),r.setDate(parseInt(rt(this,El).day)),r.setHours(12,0,0,0),"Invalid Date"!==r.toString()&&(this.value=r,st(this,al,ll).call(this))})),nt(this,El,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map((e=>e.token)).join(this._dateFormatLayout.delimiter)}set dateformat(e){this._dateFormatLayout=st(this,Cl,$l).call(this,e)}async getFocusedDate(){return this.open?this._elCalendar.then((e=>e.focusedDate)):void 0}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(e){return this._elCalendar.then((t=>t.getDateCell(e)))}connectedCallback(){super.connectedCallback(),dr.instance.apply(this,"gds-datepicker")}render(){return ut`${ws(this.label&&!this.hideLabel,(()=>ut`<label for="spinner-0" id="label">${this.label}</label>`))}
      ...
      >
        ...
        <div class="footer">
          ...
          ${r}
        </gds-button>`),(()=>oe))}`},Qa=new WeakSet,el=function(e){const t=new Date(e);this._elCalendar.then((e=>e.focusedDate=t)).then(rt(this,wl))},tl=new WeakSet,rl=function(e){return{year:fr("Year"),month:fr("Month"),day:fr("Day")}[e]},nl=new WeakSet,ol=function(e){return{year:1900,month:1,day:1}[e]},sl=new WeakSet,il=function(e){return{year:9999,month:12,day:31}[e]},al=new WeakSet,ll=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value}}))},dl=new WeakSet,cl=function(){this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value}}))},hl=new WeakMap,ul=new WeakMap,pl=new WeakMap,gl=new WeakMap,fl=new WeakMap,bl=new WeakMap,vl=new WeakMap,ml=new WeakMap,yl=new WeakMap,xl=new WeakMap,wl=new WeakMap,kl=new WeakMap,_l=new WeakMap,Cl=new WeakSet,$l=function(e){const t=e.replace(/[a-z0-9]/gi,"")[0],r=e.split(t),o=r.findIndex((e=>"y"===e)),s=r.findIndex((e=>"m"===e)),i=r.findIndex((e=>"d"===e));if(-1===o||-1===s||-1===i)throw new Error("Invalid date format for <gds-datepicker>");const a=[o,s,i].sort(((e,t)=>e-t)),l=a.map((e=>r[e])).map((e=>({token:e,name:"y"===e?"year":"m"===e?"month":"day"})));return{delimiter:t,layout:l}},Sl=new WeakMap,El=new WeakMap,Al=new WeakSet,Tl=function(){var e;const t=this.min.getFullYear(),r=this.max.getFullYear(),o=rt(this,Ml,zl),s=null==(e=this.value)?void 0:e.getFullYear();return{*[Symbol.iterator](){o&&(yield s);for(let e=t;e<=r;e++)yield e}}},Ml=new WeakSet,zl=function(){return!!this.value&&(this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear())},Dl.styles=[Yt,jl],Dl.shadowRootOptions={mode:"open",delegatesFocus:!0},et([We({converter:Va})],Dl.prototype,"value",2),et([We({converter:Va})],Dl.prototype,"min",2),et([We({converter:Va})],Dl.prototype,"max",2),et([We({type:Boolean})],Dl.prototype,"open",2),et([We()],Dl.prototype,"label",2),et([We({type:Boolean,attribute:"show-week-numbers"})],Dl.prototype,"showWeekNumbers",2),et([We()],Dl.prototype,"size",2),et([We({type:Boolean,attribute:"hide-label"})],Dl.prototype,"hideLabel",2),et([We()],Dl.prototype,"dateformat",1),et([We({type:Boolean,attribute:"disabled-weekends"})],Dl.prototype,"disabledWeekends",2),et([We({converter:Ha,attribute:"disabled-dates"})],Dl.prototype,"disabledDates",2),et([Fe("#calendar-button")],Dl.prototype,"test_calendarButton",2),et([Ve()],Dl.prototype,"_focusedMonth",2),et([Ve()],Dl.prototype,"_focusedYear",2),et([Ve()],Dl.prototype,"_dateFormatLayout",2),et([Fe("#calendar")],Dl.prototype,"_elCalendar",2),et([Fe("#calendar-button")],Dl.prototype,"_elTrigger",2),et([Fe("#field")],Dl.prototype,"_elField",2),et([function(e){return(t,r)=>He(t,r,{get(){return(this.renderRoot??(Re??=document.createDocumentFragment())).querySelectorAll(e)}})}("[role=spinbutton]")],Dl.prototype,"_elSpinners",2),et([Ne(".input")],Dl.prototype,"_elInput",2),et([yn("value")],Dl.prototype,"_handleValueChange",1),et([yn("open")],Dl.prototype,"_handleOpenChange",1),Dl=et([lt("gds-datepicker"),yr()],Dl);var Ol,Ll,Pl,Wl,Vl,Hl,Nl,Rl,Fl,Bl,Il,Ul,Zl,Gl,Yl=ve`
  @layer base, reset;
...
`,ql=class extends ys{constructor(){super(),nt(this,Nl),nt(this,Fl),nt(this,Il),this.label="",this.open=!1,this.searchable=!1,this.multiple=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.disableMobileStyles=!1,nt(this,Ol,void 0),nt(this,Ll,(e=>{const t=e.getBoundingClientRect(),r=window.innerHeight-t.bottom,o=t.top;let s=Math.min(o,this.maxHeight);return r>o&&(s=Math.min(r,this.maxHeight)),s-16+"px"})),nt(this,Pl,(e=>{if(!e.currentTarget)return;const t=e.currentTarget;if(this.options.forEach((e=>e.hidden=!1)),!t.value)return;const r=this.options.filter((e=>!this.searchFilter(t.value,e)));r.forEach((e=>e.hidden=!0))})),nt(this,Wl,(e=>{var t;null==(t=this._elListbox)||t.then((t=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void t.focus()}))})),nt(this,Vl,(e=>{var t;if("Tab"===e.key&&this.searchable)return e.preventDefault(),void(null==(t=this._elSearchInput)||t.focus())})),nt(this,Hl,(e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)})),nt(this,Zl,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(this.open=!1)})),nt(this,Gl,(e=>{var t;"Tab"!==e.key||this.searchable||(e.preventDefault(),this.open=!1,null==(t=this._elTriggerBtn)||t.focus())})),mr(this)}get type(){return"gds-dropdown"}get options(){return rt(this,Ol)?Array.from(rt(this,Ol)).filter((e=>!e.hasAttribute("isplaceholder"))):[]}get placeholder(){if(rt(this,Ol))return Array.from(rt(this,Ol)).find((e=>e.hasAttribute("isplaceholder")))}get displayValue(){var e,t;let r;return r=Array.isArray(this.value)?this.value.length>2?fr(ur`${this.value.length} selected`):this.value.reduce(((e,t)=>{var r;return e+(null==(r=this.options.find((e=>e.value===t)))?void 0:r.innerHTML)+", "}),"").slice(0,-2):null==(e=this.options.find((e=>e.selected)))?void 0:e.innerHTML,r||(null==(t=this.placeholder)?void 0:t.innerHTML)||""}connectedCallback(){super.connectedCallback(),dr.instance.apply(this,"gds-dropdown"),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange()}))}render(){return ut`
...
`,Nd=class extends qt{constructor(){super(...arguments),nt(this,Ld),nt(this,Wd),this.min=new Date((new Date).getFullYear()-10,0,1),this.max=new Date((new Date).getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=e=>e.toLocaleDateString(this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),this._currentLocale=navigator.language}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(e){const t=function(e){Za(1,arguments);var t=Ga(e),r=t.getMonth();return t.setFullYear(t.getFullYear(),r+1,0),t.setHours(0,0,0,0),t}(new Date(this.focusedYear,e,1)),r=new Date(this.focusedDate);r.setDate(Math.min(this.focusedDate.getDate(),t.getDate())),r.setMonth(e),r.setHours(12,0,0,0),this.focusedDate=r}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(e){this.focusedDate=new Date(this.focusedDate.setFullYear(e))}getDateCell(e){var t;return null==(t=this.shadowRoot)?void 0:t.querySelector(`#dateCell-${e}`)}connectedCallback(){super.connectedCallback(),dr.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",st(this,Wd,Vd)),window.addEventListener("lit-localize-status",(e=>{"ready"===e.detail.status&&(this._currentLocale=e.detail.readyLocale)}))}focus(){var e;super.focus(),null==(e=this._elFocusedCell)||e.focus()}render(){const e=new Date;return ee`<table role="grid" aria-label="${xs(this.label)}">
      ...
      <tbody role="rowgroup">
        ${jd(this.focusedDate,(t=>ee`
            ${t.map((t=>ee`
                <tr role="row">
                  ${ws(this.showWeekNumbers,(()=>ee`<td class="week-number" scope="row">
                        ${function(e,t){Za(1,arguments);var r=Ga(e),o=Md(r,t).getTime()-Dd(r,t).getTime();return Math.round(o/6048e5)+1}(t.days[0])}
                      </td>`))}
                  ${t.days.map((t=>{const r=this.customizedDates&&this.customizedDates.find((e=>qa(e.date,t))),o=Je({color:"currentColor",disabled:Boolean(this.disabledDates&&this.disabledDates.some((e=>qa(e,t))))},r),s=!function(e,t){Za(2,arguments);var r=Ga(e),o=Ga(t);return r.getFullYear()===o.getFullYear()&&r.getMonth()===o.getMonth()}(this.focusedDate,t),i=(t<this.min||t>this.max)&&!qa(t,this.min)&&!qa(t,this.max),a=0===t.getDay()||6===t.getDay(),l=o.disabled||s||i||this.disabledWeekends&&a;return this.hideExtraneousDays&&s?ee`<td inert></td>`:ee`
                          <td
                            ...
                            @click=${()=>l?null:st(this,Ld,Pd).call(this,t)}
    ...
    </table>`}_valueChanged(){this.value&&(this.focusedDate=this.value)}};Ld=new WeakSet,Pd=function(e){const t=function(e,t){Za(2,arguments);var r=Ga(e),o=$d(t);return r.setHours(o),r}(e,12);this.value=t,this.dispatchEvent(new CustomEvent("change",{detail:t,bubbles:!1,composed:!1}))},Wd=new WeakSet,Vd=function(e){var t;let r=!1,o=new Date(this.focusedDate);if("ArrowLeft"===e.key?(o=Sd(this.focusedDate,-1),r=!0):"ArrowRight"===e.key?(o=Sd(this.focusedDate,1),r=!0):"ArrowUp"===e.key?(o=Sd(this.focusedDate,-7),r=!0):"ArrowDown"===e.key?(o=Sd(this.focusedDate,7),r=!0):"Enter"===e.key||" "===e.key?((null==(t=this._elFocusedCell)?void 0:t.hasAttribute("disabled"))||st(this,Ld,Pd).call(this,this.focusedDate),r=!0):"Home"===e.key?(o=new Date(this.focusedYear,this.focusedMonth,1),r=!0):"End"===e.key?(o=new Date(this.focusedYear,this.focusedMonth+1,0),r=!0):"PageUp"===e.key?(o=function(e,t){return Za(2,arguments),Od(e,-$d(t))}(this.focusedDate,1),r=!0):"PageDown"===e.key&&(o=Od(this.focusedDate,1),r=!0),o.getFullYear()>=this.min.getFullYear()&&o.getFullYear()<=this.max.getFullYear()){this.dispatchEvent(new CustomEvent("gds-date-focused",{detail:o,bubbles:!1,composed:!1,cancelable:!0}))&&(this.focusedDate=o)}r&&(e.preventDefault(),e.stopPropagation(),this.updateComplete.then((()=>{var e;null==(e=this._elFocusedCell)||e.focus()})))},Nd.styles=[Yt,Hd],Nd.shadowRootOptions={mode:"open",delegatesFocus:!0},et([We()],Nd.prototype,"value",2),et([We({type:Date})],Nd.prototype,"min",2),et([We({type:Date})],Nd.prototype,"max",2),et([We()],Nd.prototype,"focusedDate",2),et([We({type:Boolean,attribute:"disabled-weekends"})],Nd.prototype,"disabledWeekends",2),et([We({type:Array,attribute:"disabled-dates"})],Nd.prototype,"disabledDates",2),et([We({type:Number})],Nd.prototype,"focusedMonth",1),et([We({type:Number})],Nd.prototype,"focusedYear",1),et([We({type:Boolean})],Nd.prototype,"showWeekNumbers",2),et([We({type:Boolean})],Nd.prototype,"hideExtraneousDays",2),et([We({type:Boolean})],Nd.prototype,"hideDayNames",2),et([We({attribute:!1})],Nd.prototype,"customizedDates",2),et([We()],Nd.prototype,"label",2),et([We({attribute:!1})],Nd.prototype,"dateLabelTemplate",2),et([Ve()],Nd.prototype,"_currentLocale",2),et([Ne('td[tabindex="0"]')],Nd.prototype,"_elFocusedCell",2),et([yn("value")],Nd.prototype,"_valueChanged",1),Nd=et([lt("gds-calendar"),yr()],Nd);var Rd=class extends qt{connectedCallback(){super.connectedCallback(),this.form=this.closest("form")||void 0,this.form&&(this.formObserver=new MutationObserver((()=>{this.requestUpdate()})),this.formObserver.observe(this.form,{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.formObserver)||e.disconnect()}render(){var e;const t=Array.from((null==(e=this.form)?void 0:e.elements)||[]).filter((e=>e.invalid));return ws(t.length>0,(()=>ut`<gds-card level="3" border="4xs/negative" border-radius="2xs" padding="m" color="error-text">
  ...
  `,Rd=et([lt("gds-form-summary")],Rd);var Fd,Bd,Id,Ud,Zd,Gd,Yd,qd,Kd,Xd,Jd,Qd,ec,tc,rc,nc,oc,sc,ic,ac=ve`
  #body {
    visibility: hidden;
    position: absolute;
    z-index: 1060;
...
`,cc=class extends Ds{connectedCallback(){super.connectedCallback(),this._dynamicStylesController.inject("FAB_styles",dc)}};let hc,uc,pc,gc,fc,bc,vc,mc,yc,xc,wc,kc,_c,Cc,$c,Sc,Ec,Ac,Tc,Mc;function zc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Dc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Dc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:jc(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function jc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Dc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}et([Ot({valueTemplate:e=>e,selector:'[part="_button"]'})],cc.prototype,"position",2),et([Ot({valueTemplate:e=>e})],cc.prototype,"transform",2),et([Ot({valueTemplate:e=>e,selector:'[part="_button"]'})],cc.prototype,"inset",2),cc=et([lt("gds-fab")],cc),uc=[Oe("form-validation")];class FormValidationExample extends lit_element_r{static#e=(()=>[pc,hc]=zc(this,[],uc,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`<gds-card border="4xs/base300" padding="m" border-radius="s">
      <form>
        <gds-input
          required
          label="Name"
    ...
    </gds-card>`}static#t=(()=>hc())()}function Oc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Pc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Pc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Lc(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Lc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Pc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}bc=[Oe("datepicker-example")];class CalendarExample extends lit_element_r{static#e=(()=>({e:[mc,xc,gc],c:[wc,fc]}=Oc(this,[[vc,1,"disabledWeekends"],[yc,1,"showWeekNumbers"]],bc,0,void 0,lit_element_r)))();[(vc=Ve(),yc=Ve(),"createRenderRoot")](){return this}connectedCallback(){super.connectedCallback()}#r=(()=>(gc(this),mc(this,!1)))();get disabledWeekends(){return this.#r}set disabledWeekends(e){this.#r=e}#n=(()=>xc(this,!1))();get showWeekNumbers(){return this.#n}set showWeekNumbers(e){this.#n=e}render(){return ut` <div style="width:320px; margin: 8rem auto;">
      ...
      <fieldset class="form-group" style="margin-top: 2rem">
        ...
        <label class="form-control"
          ...
          ><i
        ></i></label>
    </div>`}static#t=(()=>fc())()}function Wc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Hc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Hc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Vc(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Vc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Hc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}const Nc=`${(new Date).getFullYear()}-${(new Date).getMonth()+1}`;let Rc,Fc,Bc;Cc=[Oe("calendar-example")];class app_calendar_element_CalendarExample extends lit_element_r{static#e=(()=>({e:[Sc,Ac,Mc,kc],c:[Rc,_c]}=Wc(this,[[$c,1,"disabledWeekends"],[Ec,1,"showWeekNumbers"],[Tc,1,"showCustomizedDates"]],Cc,0,void 0,lit_element_r)))();[($c=Ve(),Ec=Ve(),Tc=Ve(),"createRenderRoot")](){return this}connectedCallback(){super.connectedCallback()}#r=(()=>(kc(this),Sc(this,!1)))();get disabledWeekends(){return this.#r}set disabledWeekends(e){this.#r=e}#n=(()=>Ac(this,!1))();get showWeekNumbers(){return this.#n}set showWeekNumbers(e){this.#n=e}#o=(()=>Mc(this,!1))();get showCustomizedDates(){return this.#o}set showCustomizedDates(e){this.#o=e}#s=(()=>[{date:new Date(`${Nc}-07`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${Nc}-12`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${Nc}-24`),indicator:"dot",color:"var(--intent-danger-background)"},{date:new Date(`${Nc}-21`),indicator:"dot",disabled:!0}])();render(){return ut` <div style="width:320px; margin: 8rem auto;">
    ...
    `}static#t=(()=>Fc())()}function Xc(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Qc((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Qc(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Jc(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Jc(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Qc(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}qc=[Oe("gds-onboarding")];class onboarding_onboarding_element_CardExample extends lit_element_r{static#e=(()=>[Kc,Yc]=Xc(this,[],qc,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut` <gds-flex gap="lg">
      ...
      <gds-card variant="tertiary" padding="l"
        ><gds-flex
          ...
          ></gds-card> </gds-flex
      ></gds-card>
    `}static#t=(()=>sh())()}function _h(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:$h((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||$h(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Ch(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Ch(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function $h(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}dh=[Oe("gds-accounts")];class GdsAccounts extends lit_element_r{static#e=(()=>[ch,lh]=_h(this,[],dh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-card>
    ...
    `}static#t=(()=>lh())()}function Sh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Ah((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Ah(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Eh(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Eh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Ah(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}uh=[Oe("tp-card")];class TPCard extends lit_element_r{static#e=(()=>[ph,hh]=Sh(this,[],uh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-card>
    ...
    `}static#t=(()=>hh())()}function Th(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:zh((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||zh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Mh(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Mh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function zh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}fh=[Oe("tp-list-item")];class common_list_item_TPCard extends lit_element_r{static#e=(()=>[bh,gh]=Th(this,[],fh,0,void 0,lit_element_r).c)();connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-flex gap="s">
        <gds-flex>
          <gds-flex
            level="3"
    ...
    `}static#t=(()=>gh())()}function jh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:Oh((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||Oh(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:Dh(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function Dh(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function Oh(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}mh=[Oe("gds-dashboard")];class dashboard_dashboard_element_CardExample extends lit_element_r{static#e=(()=>[yh,vh]=jh(this,[],mh,0,void 0,lit_element_r).c)();createRenderRoot(){return this}connectedCallback(){super.connectedCallback()}render(){return ut`
...
`,Ph=class extends qt{querySelectorAll(e){return this.shadowRoot?this.shadowRoot.querySelectorAll(e):new NodeList}querySelector(e){return this.shadowRoot?this.shadowRoot.querySelector(e):null}get innerHTML(){var e;return(null==(e=this.shadowRoot)?void 0:e.innerHTML)||""}set innerHTML(e){this.shadowRoot&&(this.shadowRoot.innerHTML=e)}connectedCallback(){super.connectedCallback(),this._captureDOM()}_captureDOM(){this.shadowRoot&&0!==this.childNodes.length&&this.shadowRoot.replaceChildren(...Array.from(this.childNodes))}};let Wh,Vh,Hh,Nh,Rh,Fh,Bh,Ih,Uh,Zh,Gh,Yh,qh,Kh,Xh,Jh;function Qh(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:tu((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||tu(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:eu(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function eu(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function tu(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}Ph.styles=[Yt,pt,Lh],et([mn()],Ph.prototype,"_captureDOM",1),Ph=et([lt("gds-rich-text")],Ph),Vh=[Oe("tp-page-header")];class PageHeader extends lit_element_r{static#e=(()=>[Hh,Wh]=Qh(this,[],Vh,0,void 0,lit_element_r).c)();createRenderRoot(){return this}render(){return ut`
    ...
    `}static#t=(()=>Wh())()}function ru(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:ou((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||ou(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:nu(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function nu(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function ou(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}Fh=[Oe("tp-theme-page")];class ThemePage extends lit_element_r{static#e=(()=>({e:[Ih,Zh,Nh],c:[Gh,Rh]}=ru(this,[[Bh,1,"hasAccounts"],[Uh,1,"hasSavings"]],Fh,0,void 0,lit_element_r)))();[(Bh=We({type:Boolean}),Uh=We({type:Boolean}),"createRenderRoot")](){return this}#r=(()=>(Nh(this),Ih(this,!0)))();get hasAccounts(){return this.#r}set hasAccounts(e){this.#r=e}#n=(()=>Zh(this,!0))();get hasSavings(){return this.#n}set hasSavings(e){this.#n=e}connectedCallback(){super.connectedCallback()}render(){return ut`
      <gds-flex gap="3xl" flex-direction="column">
        <tp-page-header style="flex:1"></tp-page-header>

        <!-- (Blue) Main dashboard section -->
        ${ws(this.hasAccounts,(()=>ut`
    ...
    `}static#t=(()=>Rh())()}function su(e,t,r,o,s,i){function a(e,t,r){return function(o,s){return r&&r(o),e[t].call(o,s)}}function l(e,t){for(var r=0;r<e.length;r++)e[r].call(t);return t}function d(e,t,r,o){if("function"!=typeof e&&(o||void 0!==e))throw new TypeError(t+" must "+(r||"be")+" a function"+(o?"":" or undefined"));return e}function c(e,t,r,o,s,i,l,c,h,u,p,g,f){function v(e){if(!f(e))throw new TypeError("Attempted to access private element on non-instance")}var m,y=t[0],x=t[3],w=!c;if(!w){r||Array.isArray(y)||(y=[y]);var _={},C=[],$=3===s?"get":4===s||g?"set":"value";u?(p||g?_={get:au((function(){return x(this)}),o,"get"),set:function(e){t[4](this,e)}}:_[$]=x,p||au(_[$],o,2===s?"":$)):p||(_=Object.getOwnPropertyDescriptor(e,o))}for(var S=e,E=y.length-1;E>=0;E-=r?2:1){var A=y[E],T=r?y[E-1]:void 0,j={},D={kind:["field","accessor","method","getter","setter","class"][s],name:o,metadata:i,addInitializer:(function(e,t){if(e.v)throw Error("attempted to call addInitializer after decoration was finished");d(t,"An initializer","be",!0),l.push(t)}).bind(null,j)};try{if(w)(m=d(A.call(T,S,D),"class decorators","return"))&&(S=m);else{var O,P;D.static=h,D.private=u,u?2===s?O=function(e){return v(e),_.value}:(s<4&&(O=a(_,"get",v)),3!==s&&(P=a(_,"set",v))):(O=function(e){return e[o]},(s<2||4===s)&&(P=function(e,t){e[o]=t}));var W=D.access={has:u?f.bind():function(e){return o in e}};if(O&&(W.get=O),P&&(W.set=P),S=A.call(T,g?{get:_.get,set:_.set}:_[$],D),g){if("object"==typeof S&&S)(m=d(S.get,"accessor.get"))&&(_.get=m),(m=d(S.set,"accessor.set"))&&(_.set=m),(m=d(S.init,"accessor.init"))&&C.push(m);else if(void 0!==S)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0")}else d(S,(p?"field":"method")+" decorators","return")&&(p?C.push(S):_[$]=S)}}finally{j.v=!0}}return(p||g)&&c.push((function(e,t){for(var r=C.length-1;r>=0;r--)t=C[r].call(e,t);return t})),p||w||(u?g?c.push(a(_,"get"),a(_,"set")):c.push(2===s?_[$]:a.call.bind(_[$])):Object.defineProperty(e,o,_)),S}function h(e,t){return Object.defineProperty(e,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:t})}if(arguments.length>=6)var u=i[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(u??null),g=function(e,t,r,o){var s,i,a=[],d=function(t){return function(e){if(Object(e)!==e)throw TypeError("right-hand side of 'in' should be an object, got "+(null!==e?typeof e:"null"));return e}(t)===e},h=new Map;function u(e){e&&a.push(l.bind(null,e))}for(var p=0;p<t.length;p++){var g=t[p];if(Array.isArray(g)){var f=g[1],v=g[2],m=g.length>3,y=16&f,x=!!(8&f),w=0==(f&=7),_=v+"/"+x;if(!w&&!m){var C=h.get(_);if(!0===C||3===C&&4!==f||4===C&&3!==f)throw Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+v);h.set(_,!(f>2)||f)}c(x?e:e.prototype,g,y,m?"#"+v:iu(v),f,o,x?i=i||[]:s=s||[],a,x,m,w,1===f,x&&m?d:r)}}return u(s),u(i),a}(e,t,s,p);return r.length||h(e,p),{e:g,get c(){var t=[];return r.length&&[h(c(e,[r],o,e.name,5,p,t),p),l.bind(null,t,e)]}}}function iu(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var o=r.call(e,t||"default");if("object"!=typeof o)return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(e,"string");return"symbol"==typeof t?t:t+""}function au(e,t,r){"symbol"==typeof t&&(t=(t=t.description)?"["+t+"]":"");try{Object.defineProperty(e,"name",{configurable:!0,value:r?r+" "+t:t})}catch(e){}return e}class AppElement extends lit_element_r{static#e=(()=>[Kh,Jh,Yh]=su(this,[[qh,1,"popoverOpen"],[Xh,1,"currentView"]],[],0,void 0,lit_element_r).e)();static[(qh=We(),Xh=Ve(),"styles")]=(()=>ve`
    :host {
      --gds-test-color: red;
    }
  `)();createRenderRoot(){return this}#r=(()=>(Yh(this),Kh(this,!1)))();get popoverOpen(){return this.#r}set popoverOpen(e){this.#r=e}#n=(()=>Jh(this,"theme-page"))();get currentView(){return this.#n}set currentView(e){this.#n=e}connectedCallback(){super.connectedCallback(),this.addEventListener("view-change",this.handleViewChange),document.addEventListener("keydown",this.handleKeyDown)}disconnectedCallback(){this.removeEventListener("view-change",this.handleViewChange),document.removeEventListener("keydown",this.handleKeyDown),super.disconnectedCallback()}handleViewChange(e){this.currentView=e.detail.view}handleKeyDown=e=>{if("\\"===e.key){const e=this.querySelector("html");if(e){const t=e.getAttribute("gds-theme");e.setAttribute("color-scheme","light"===t?"dark":"light")}}};render(){return ut`
