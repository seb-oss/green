import"./switch-BlgNpidM.js";import"./flex-BWZVaoBl.js";import{b as t}from"./iframe-BMtxp-Hq.js";import"./text-0hlLkItd.js";import"./divider-sWvAx5Me.js";import{a as x}from"./argTableProps-C7JeJWfg.js";import"./switch.component-jX8eMJZK.js";import"./checkmark.component-Cl3eXk-r.js";import"./icon.component-3-hgIY3p.js";import"./flex.component-CoUPMP16.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-DKvbGBO3.js";import"./default-typography.styles-45JrLuNk.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
