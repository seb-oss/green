/*! For license information please see src-lib-grouped-list-grouped-list-stories.264c5ed6.iframe.bundle.js.LICENSE.txt */
...
`;let i=class extends((0,a.lt)(o.j)){connectedCallback(){super.connectedCallback(),this.setAttribute("role","listitem")}render(){return l.qy`<slot></slot>`}};i.styles=[n.LU,d],i=(0,r.Cc)([(0,l.Y$)("gds-list-item")],i)},2737(e,t,s){s.d(t,{j:()=>i});var r=s(745),o=s(4367),l=s(7526),n=s(5073),a=s(6312),d=s(9443).AH`
  :host {
    display: flex;
