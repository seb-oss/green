import{i as w,n as f,N as _,J as C,b,h as i,E as O,g as E,K as z,d as W,P as B,L as F,Q as D}from"./iframe-CoeLk9uN.js";import{G as H}from"./badge.component-Dm1Dvvrv.js";import{I,a as L}from"./triangle-exclamation.component-CX8VIYxL.js";import{G as A}from"./card.component-CkicOUYk.js";const V=w`
...
`;var R=Object.defineProperty,J=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},x=(e,t,s,a)=>{for(var r=a>1?void 0:a?J(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&R(t,s,r),r},K=(e,t,s)=>t.has(e)||S("Cannot "+s),N=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Q=(e,t,s)=>(K(e,t,"access private method"),s),v,T;let d=class extends C{constructor(){super(...arguments),N(this,v)}_handleVisibilityChange(){var e;this.classList.toggle("visually-hidden",!this.errorMessage&&!((e=this.charCounter)!=null&&e[1]))}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return i`<div aria-live="polite">
...
`;var q=Object.defineProperty,U=Object.getOwnPropertyDescriptor,$=e=>{throw TypeError(e)},u=(e,t,s,a)=>{for(var r=a>1?void 0:a?U(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&q(t,s,r),r},G=(e,t,s)=>t.has(e)||$("Cannot "+s),p=(e,t,s)=>(G(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?$("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),k=(e,t,s)=>(G(e,t,"access private method"),s),c,P,m,y,g,M;let l=class extends C{constructor(){super(...arguments),h(this,c),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,h(this,m,()=>i`
    ...
    `}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",p(this,g))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",p(this,g))}};c=new WeakSet;P=function(e){this._hasExtendedSupportingText=e.target.assignedElements({flatten:!0}).length>0};m=new WeakMap;y=new WeakMap;g=new WeakMap;M=function(){return i`
      <div
      ...
      >
        <slot
          ...
          @slotchange=${k(this,c,P)}
        ></slot>
      </div>
    `};l.styles=[j];u([f({type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);u([z()],l.prototype,"_hasExtendedSupportingText",2);u([W("#extended-supporting-text")],l.prototype,"_extendedSupportingText",2);l=u([E("gds-form-control-header",{dependsOn:[D,A,L]}),F()],l);export{l as G,d as a};
