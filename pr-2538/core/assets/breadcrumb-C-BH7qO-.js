import{i as m,I as O,D as G,H as S,J as v,P as E,a as I,h as c,t as A,n as d,g as y,L as B,o as g,E as D}from"./iframe-DnK2EMdH.js";import{I as L}from"./chevron-left.component-Cg_i6NLy.js";import{G as M}from"./link-CpYoyxVE.js";import{G as k}from"./text-5tOrUS4g.js";const j=m`
...
`;var T=Object.defineProperty,W=Object.getOwnPropertyDescriptor,u=(t,e,s,n)=>{for(var r=n>1?void 0:n?W(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&T(e,s,r),r};let h=class extends O(G(S(v))){constructor(){super(...arguments),this.size="large",this.label=E("Breadcrumbs")}get breadcrumbItems(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumb]"))}handleSlotChange(){const t=this.breadcrumbItems;t.forEach((e,s)=>{s===t.length-2?e.setAttribute("return",""):e.removeAttribute("return")})}render(){return c`
    ...
    `}};h.styles=[A,j];u([d({type:String})],h.prototype,"size",2);u([d({type:String})],h.prototype,"label",2);h=u([y("gds-breadcrumbs",{dependsOn:[L]}),B()],h);h.define();const q=m`
  @layer base {
    :host {
      display: contents;
    }
...
`;var H=Object.defineProperty,J=Object.getOwnPropertyDescriptor,_=t=>{throw TypeError(t)},p=(t,e,s,n)=>{for(var r=n>1?void 0:n?J(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&H(e,s,r),r},b=(t,e,s)=>e.has(t)||_("Cannot "+s),R=(t,e,s)=>(b(t,e,"read from private field"),s?s.call(t):e.get(t)),X=(t,e,s)=>e.has(t)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),f=(t,e,s)=>(b(t,e,"access private method"),s),i,x,w,$,C,P,z;let a=class extends v{constructor(){super(...arguments),X(this,i),this.href="",this.label="",this.overflow=!1}render(){return c`
    ...
    `};a.styles=[q];p([d()],a.prototype,"href",2);p([d()],a.prototype,"target",2);p([d()],a.prototype,"rel",2);p([d()],a.prototype,"label",2);p([d({type:Boolean,reflect:!0})],a.prototype,"overflow",2);a=p([y("gds-breadcrumb",{dependsOn:[M,k]})],a);a.define();
