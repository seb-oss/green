import{i as C,n as p,J as k,a4 as x,a as b,h as w,g as $,Q as z,K as E,d as P,N as V,O as F}from"./iframe-DnK2EMdH.js";import{r as G}from"./resize-observer-B9k8v2TZ.js";import{s as W}from"./attribute-converters-CdI0trPX.js";import{I as H}from"./checkmark.component-CjXVrHxa.js";const B=C`
...
`;var D=Object.defineProperty,M=Object.getOwnPropertyDescriptor,v=(e,t,s,i)=>{for(var l=i>1?void 0:i?M(t,s):t,n=e.length-1,h;n>=0;n--)(h=e[n])&&(l=(i?h(t,s,l):h(l))||l);return i&&l&&D(t,s,l),l};let o=class extends k{constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),x.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return w`<gds-button
      class="btn"
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};o.styles=[B];v([p({reflect:!0,type:Boolean})],o.prototype,"selected",2);v([p()],o.prototype,"value",2);v([p({reflect:!0,type:String})],o.prototype,"size",2);o=v([$("gds-filter-chip",{dependsOn:[z,H]})],o);const T=C`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
