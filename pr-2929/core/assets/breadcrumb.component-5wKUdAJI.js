import{i as m,H as P,Q as G,I as S,z as v,E as A,a as B,h,v as E,n as d,g as y,y as I,A as D,o as g}from"./iframe-WmA5gf4D.js";import{l as M}from"./localized-decorator-vMX61SCO.js";import{I as k}from"./chevron-left.component-CzU1R2o_.js";import{G as L}from"./link-CbICuTwE.js";import{G as j}from"./text.component-O6HWmemq.js";const T=m`
...
`;var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,u=(t,e,s,n)=>{for(var r=n>1?void 0:n?q(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&W(e,s,r),r};let f=class extends P(G(S(v))){constructor(){super(...arguments),this.size="large",this.label=A("Breadcrumbs")}get breadcrumbItems(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumb]"))}handleSlotChange(){const t=this.breadcrumbItems;t.forEach((e,s)=>{s===t.length-2?e.setAttribute("return",""):e.removeAttribute("return")})}render(){return h`
      <nav
        role="navigation"
        aria-label=${this.label}
        class=${B({"size-small":this.size==="small"})}
      >
    ...
    `}};f.styles=[E,T];u([d({type:String})],f.prototype,"size",2);u([d({type:String})],f.prototype,"label",2);f=u([y("gds-breadcrumbs",{dependsOn:[k]}),I({labelledBy:"nav"}),M()],f);const F=m`
  @layer base {
    :host {
      display: contents;
    }
...
`;var H=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,_=t=>{throw TypeError(t)},c=(t,e,s,n)=>{for(var r=n>1?void 0:n?Q(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&H(e,s,r),r},b=(t,e,s)=>e.has(t)||_("Cannot "+s),R=(t,e,s)=>(b(t,e,"read from private field"),s?s.call(t):e.get(t)),X=(t,e,s)=>e.has(t)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),p=(t,e,s)=>(b(t,e,"access private method"),s),a,x,w,$,C,z,O;let i=class extends v{constructor(){super(...arguments),X(this,a),this.href="",this.label="",this.overflow=!1}render(){return h`
    ...
    `};i.styles=[F];c([d()],i.prototype,"href",2);c([d()],i.prototype,"target",2);c([d()],i.prototype,"rel",2);c([d()],i.prototype,"label",2);c([d({type:Boolean,reflect:!0})],i.prototype,"overflow",2);i=c([y("gds-breadcrumb",{dependsOn:[L,j]})],i);export{f as G,i as a};
