import{b as a}from"./iframe-Bezf6Gyf.js";import{a as p}from"./argTableProps-BQjuOeV1.js";import"./badge-FGWBjK09.js";import"./flex-BqOBLMZE.js";import"./divider-C0qXDsHZ.js";import"./circle-info-TbJBDokI.js";import"./circle-check-0X9WkbFa.js";import"./arrow-rotate-counter-clockwise.component-DscbJCmP.js";import"./minus-small-9FhJ5sm4.js";import"./rocket-D4U9viyu.js";import"./triangle-exclamation-gTYTbo5w.js";import"./preload-helper-PPVm8Dsz.js";import"./badge.component-BOQhX4Pv.js";import"./flex.component-9-nqFDSl.js";import"./circle-info.component-P7sG0vnt.js";import"./icon.component-DigpYCmp.js";import"./circle-check.component-laSlTDKu.js";import"./minus-small.component-DpXsF8e2.js";import"./rocket.component-BiJ8k9nq.js";import"./triangle-exclamation.component-BmwdVndm.js";const W={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...p("gds-badge")}},o={name:"Variants",render:e=>a`
    <gds-flex
  ...
  `},i={name:"Notification",parameters:{actions:{handles:["mouseover","mouseout"]}},play:async()=>{document.querySelectorAll("gds-badge[notification]").forEach(e=>{let d;const m=()=>{const c=e.textContent?.trim()||"",r=c.replace(/\D/g,"");if(r&&!isNaN(Number(r))){const f=parseInt(r,10);let l=0;d=window.setInterval(()=>{e.textContent=l.toString()+c.replace(/\d/g,""),l===f?clearInterval(d):l++},50)}},b=()=>{d&&(clearInterval(d),d=void 0)};e.addEventListener("mouseover",m),e.addEventListener("mouseout",b)})},render:e=>a`
    <gds-flex gap="xl" align-items="center">
      <gds-badge notification></gds-badge>
      <gds-badge notification>9</gds-badge>
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:`The \`gds-badge\` component includes a \`lead\` slot that allows for the addition of leading content, such as icons.
...
\`\`\``,...n.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  name: 'Trail',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...s.parameters?.docs?.source},description:{story:'`gds-badge` has a trail slot that can be used to add additional content to the badge.\n\n```html\n<gds-badge>\n <span slot="trail">...</span>\n</gds-badge>\n```',...s.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: 'Size',
  render: args => html\`
    <gds-flex gap="4xl">
      <gds-flex flex-direction="column" gap="xl">
  ...
  \`
}`,...g.parameters?.docs?.source},description:{story:`Defines the size of the badge.
...
\`\`\``,...g.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: 'Notification',
  parameters: {
    actions: {
  ...
  \`
}`,...i.parameters?.docs?.source},description:{story:'The `Notification` story demonstrates the use of the `gds-badge` component in notification mode.\nIn this mode, the badge acts as a notification indicator with only two possible variants: `positive` or `negative`.\n\nExample usage:\n\n```html\n<gds-flex gap="xl">\n  <gds-badge notification>...</gds-badge>\n  <gds-badge notification>...</gds-badge>\n</gds-flex>\n```\n\n@property {boolean} notification - Controls the notification mode of the badge.',...i.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  name: 'Rounded',
  parameters: {},
  render: args => html\`
    <gds-flex gap="xl" flex-direction="column">
  ...
  \`
}`,...t.parameters?.docs?.source},description:{story:'The `Rounded` story demonstrates the use of the `gds-badge` component with the `rounded` property.\n\nWhen set to `true`, the badge will have fully rounded corners.\n\nExample usage:\n\n```html\n<gds-badge rounded variant="information"> 01 </gds-badge>\n```\n\n@property {boolean} rounded - Controls the border radius of the badge.',...t.parameters?.docs?.description}}};const j=["Variants","Lead","Trail","Size","Notification","Rounded"];export{n as Lead,i as Notification,t as Rounded,g as Size,s as Trail,o as Variants,j as __namedExportsOrder,W as default};
