import{P,K as R,O as u,N as F,a6 as g,A as _,aa as G,i as M,v as D,n as r,f as W,$ as N,y as q,Q as U,I as L,H,a0 as K,d as E,h as p,o as a,E as X,g as Y,F as Q}from"./iframe-D3YvZi8A.js";import{l as J}from"./localized-decorator-C72_JSzS.js";import{r as Z}from"./query-async-CEiMUA1f.js";import{f as j,G as tt}from"./form-control-host.style-DcIzr-WU.js";import{G as et,a as st}from"./form-control-header.component-CPWBK8i9.js";import{G as it}from"./flex.component-BjS_6d1L.js";import{I as rt}from"./cross-small.component-C64iP4EE.js";import{c as ot}from"./textarea.component-jTql7Xpd.js";const at=P(class extends R{constructor(t){if(super(t),t.type!==u.PROPERTY&&t.type!==u.ATTRIBUTE&&t.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!F(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===g||e===_)return e;const o=t.element,n=t.name;if(t.type===u.PROPERTY){if(e===o[n])return g}else if(t.type===u.BOOLEAN_ATTRIBUTE){if(!!e===o.hasAttribute(n))return g}else if(t.type===u.ATTRIBUTE&&o.getAttribute(n)===e+"")return g;return G(t),e}}),nt=M`
