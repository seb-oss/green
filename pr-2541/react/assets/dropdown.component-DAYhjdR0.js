import{i as m,h as n,G as M,t as W,_ as t,n as d,g as x,b as p,c as u,r as O,d as o,E as fe,e as me}from"./tokens.style-fuy7eeYp.js";import{l as ce,m as D,s as He}from"./runtime-nRyYmvPb.js";import{a as Ie,e as X,w as C}from"./watch-Bh1rs_BK.js";import{G as Ve,o as Ne,a as je,b as qe}from"./button.component-DHRp28bg.js";import{w as pe,c as Re,b as he,d as Ke,a as ge,f as Ue,s as c,g as ue,p as Xe,h as xe,j as Ye,o as Je}from"./icon.component-Dg8vc5Fu.js";import{n as b}from"./when-BR7zwNJC.js";import{G as _e,o as Qe,f as Ze}from"./popover.component-CbPWVU4W.js";import{e as V}from"./class-map-fsG816o6.js";import{T as be,c as et}from"./transitional-styles-D6fusxej.js";import{I as tt}from"./triangle-exclamation.component-VVdMa9mc.js";import{I as st,a as it}from"./chevron-bottom.component-BOlb90iS.js";import{F as ot,o as at,e as rt,L as lt,u as nt,n as dt}from"./unwrap-slots-BFEpxIkN.js";import{I as we}from"./checkmark.component-BQOpCKam.js";import{I as ct}from"./cross-small.component-DNyGZBtm.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(e){return(s,i)=>Ie(s,i,{async get(){var l;return await this.updateComplete,((l=this.renderRoot)==null?void 0:l.querySelector(e))??null}})}const ht=m`
  :host {
    display: block;
...
`;var gt=ht;let a=class extends pe(Re(he(Ke(ge(Ue(M)))))){constructor(){super(...arguments),this.level="2"}render(){return n`<slot></slot>`}};a.styles=[W,gt];t([c()],a.prototype,"display",2);t([d()],a.prototype,"level",2);t([c(ue("content"))],a.prototype,"color",2);t([c(ue("background"))],a.prototype,"background",2);t([c({styleTemplate:function(e,s){const i=this,[l,r=i["border-style"]||"solid",g=i["border-color"]||"subtle-01"]=s,v=`var(--gds-sys-space-${l})`,Ge=Xe(g,"border",i.level);return`border: ${v} ${r} ${Ge};`}})],a.prototype,"border",2);t([c(ue("border"))],a.prototype,"border-color",2);t([c(xe)],a.prototype,"border-width",2);t([c()],a.prototype,"border-style",2);t([c(Ye)],a.prototype,"border-radius",2);t([c({valueTemplate:e=>`var(--gds-sys-shadow-${e}-01), var(--gds-sys-shadow-${e}-02)`})],a.prototype,"box-shadow",2);t([c()],a.prototype,"opacity",2);t([c()],a.prototype,"overflow",2);t([c()],a.prototype,"box-sizing",2);t([c()],a.prototype,"z-index",2);t([c({styleTemplate:(e,s)=>`font: var(--gds-sys-text-${s[0]});`})],a.prototype,"font",2);t([c({valueTemplate:e=>`var(--gds-sys-text-weight-${e})`})],a.prototype,"font-weight",2);t([c()],a.prototype,"text-align",2);t([c()],a.prototype,"text-wrap",2);t([c()],a.prototype,"overflow-wrap",2);t([c()],a.prototype,"white-space",2);t([c({...xe,styleTemplate:(e,s)=>{const i=s[0],l=s[1]||i;return`gap: ${i} ${l};`},cacheOverrideKey:"flex"})],a.prototype,"gap",2);t([c()],a.prototype,"align-items",2);t([c()],a.prototype,"align-content",2);t([c()],a.prototype,"justify-content",2);t([c()],a.prototype,"justify-items",2);t([c()],a.prototype,"flex-direction",2);t([c()],a.prototype,"flex-wrap",2);t([c()],a.prototype,"place-items",2);t([c()],a.prototype,"place-content",2);t([c()],a.prototype,"aspect-ratio",2);t([c()],a.prototype,"cursor",2);t([c()],a.prototype,"pointer-events",2);a=t([x("gds-div")],a);let I=class extends a{constructor(){super(),this.variant="primary",this.padding="m;m{xl}",this["border-radius"]="s",this.gap="m;m{l}"}render(){return n`<slot></slot>`}};I.styles=[W,m`
      :host {
        box-sizing: border-box;
    ...
    `];t([c({styleTemplate:function(e,s){let i,l,r;switch(s[0]){case"primary":i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-01)`,r="var(--gds-sys-color-content-neutral-01)";break;case"secondary":i="var(--gds-sys-color-border-subtle-01)",l=`var(--gds-sys-color-l${this.level}-neutral-02)`,r="var(--gds-sys-color-content-neutral-01)";break;case"tertiary":i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-02)`,r="var(--gds-sys-color-content-neutral-01)";break;case"neutral-01":i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-01)`,r="var(--gds-sys-color-content-neutral-01)";break;case"neutral-01-2":i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-01-2)`,r="var(--gds-sys-color-content-neutral-01)";break;case"neutral-02":i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-02)`,r="var(--gds-sys-color-content-neutral-01)";break;case"neutral-02-2":i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-02-2)`,r="var(--gds-sys-color-content-neutral-01)";break;case"brand-01":i="transparent",l=`var(--gds-sys-color-l${this.level}-brand-01)`,r="var(--gds-sys-color-content-inversed)";break;case"brand-02":i="transparent",l=`var(--gds-sys-color-l${this.level}-brand-02)`,r="var(--gds-sys-color-content-brand-02)";break;case"positive":case"negative":case"warning":case"information":case"notice":i=`var(--gds-sys-color-border-${s[0]}-02)`,l=`var(--gds-sys-color-l${this.level}-${s[0]}-01)`,r=`var(--gds-sys-color-content-${s[0]}-01)`;break;default:i="transparent",l=`var(--gds-sys-color-l${this.level}-neutral-01)`,r="var(--gds-sys-color-content-neutral-01)";break}return`
      --_border-color: ${i};
      --_background-color: ${l};
      --_color: ${r};
...
`;var bt=ut;let K=class extends a{render(){return n`<slot></slot>`}};K.styles=[W,bt];K=t([x("gds-flex")],K);const yt=m`
...
`;var vt=yt,k,ye,$e,ke,Se;let f=class extends pe(he(ge(M))){constructor(){super(...arguments),p(this,k),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=V({badge:!0,[this.variant]:!0,[this.size]:this.size==="small",notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return n`
      <div class="${e}">
        ${[u(this,k,$e).call(this),u(this,k,ke).call(this),u(this,k,Se).call(this)]}
      </div>
    `}};k=new WeakSet;ye=function(e,s){const l=e.target.assignedNodes({flatten:!0});this[s]=l.length>0&&l.some(r=>{var g;return r.nodeType===Node.ELEMENT_NODE||r.nodeType===Node.TEXT_NODE&&((g=r.textContent)==null?void 0:g.trim())!==""})};$e=function(){if(this.size!=="small"||!this.notification)return n`<slot
        name="lead"
        @slotchange=${e=>u(this,k,ye).call(this,e,"leadSlotOccupied")}
      ></slot>`};ke=function(){return n`<slot
      @slotchange=${e=>u(this,k,ye).call(this,e,"mainSlotOccupied")}
    ></slot>`};Se=function(){return n`<slot name="trail"></slot>`};f.styles=[W,vt];t([d()],f.prototype,"variant",2);t([d({type:String})],f.prototype,"size",2);t([d({attribute:"notification",type:Boolean,reflect:!0})],f.prototype,"notification",2);t([d({attribute:"rounded",type:Boolean,reflect:!0})],f.prototype,"rounded",2);t([O()],f.prototype,"mainSlotOccupied",2);t([O()],f.prototype,"leadSlotOccupied",2);f=t([x("gds-badge",{dependsOn:[K]})],f);const ft=e=>Ce({...e,type:"checkbox"}),jt=e=>Ce({...e,type:"radio"}),Ce=e=>{const{type:s,checked:i,indeterminate:l,disabled:r,invalid:g}=e;return n`
    <div class="rbcb ${V({"rbcb--checkbox":s==="checkbox","rbcb--radio":s==="radio","--checked":i,"--indeterminate":l,"--disabled":r,"--invalid":g})}">
      <div class="rbcb__perimeter"></div>
      <div class="rbcb__toggle">
        ${b(s==="checkbox",()=>n`
            ${b(l,()=>n`<gds-icon-minus-small
                  class="rbcb__icon"
                  stroke="4"
                ></gds-icon-minus-small>`,()=>b(i,()=>n`<gds-icon-checkmark
                      class="rbcb__icon"
                      stroke="4"
                    ></gds-icon-checkmark>`))}
          `)}
...
`;var xt=mt,A,S,Ee,Te,ze,Me,Oe;let y=class extends M{constructor(){super(),p(this,S),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,p(this,A,(e,s)=>{const l=s.target.assignedNodes({flatten:!0}),r=l.length>0&&l.some(g=>{var v;return g.nodeType===Node.ELEMENT_NODE||g.nodeType===Node.TEXT_NODE&&((v=g.textContent)==null?void 0:v.trim())!==""});e==="lead"?(this._leadSlotOccupied=r,this._leadHasBadge=r&&l.some(g=>{var v;return((v=g.getAttribute)==null?void 0:v.call(g,"gds-element"))==="gds-badge"})):e==="trail"?this._trailSlotOccupied=r:e==="action"&&(this._actionSlotOccupied=r)})}connectedCallback(){super.connectedCallback(),be.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return n`
      <div class="field ${V(e)}" part="_base">
        ${u(this,S,Ee).call(this)}
      </div>
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};A=new WeakMap;S=new WeakSet;Ee=function(){const e={right:!0,"as-flex":this.multiline&&(this._trailSlotOccupied||this._actionSlotOccupied)};return n`
      ${u(this,S,Te).call(this)} ${u(this,S,ze).call(this)}
      <div class="${V(e)}">
        ${u(this,S,Me).call(this)} ${u(this,S,Oe).call(this)}
      </div>
    `};Te=function(){return n` <slot
      name="lead"
      @slotchange=${e=>o(this,A).call(this,"lead",e)}
    ></slot>`};ze=function(){return n`<div
      class="main-slot-wrap ${V({multiline:this.multiline})}"
    >
      <slot
        @slotchange=${e=>o(this,A).call(this,"main",e)}
      ></slot>
    </div>`};Me=function(){return n`
      <slot
        name="action"
        @slotchange=${e=>o(this,A).call(this,"action",e)}
      ></slot>
    `};Oe=function(){return n`
      <slot
        name="trail"
        @slotchange=${e=>o(this,A).call(this,"trail",e)}
      ></slot>
    `};y.styles=[xt];t([d()],y.prototype,"size",2);t([d({type:Boolean})],y.prototype,"multiline",2);t([d({type:Boolean,reflect:!0})],y.prototype,"disabled",2);t([d({type:Boolean})],y.prototype,"invalid",2);t([X("slot:not([name])")],y.prototype,"_mainSlotElement",2);t([O()],y.prototype,"_leadSlotOccupied",2);t([O()],y.prototype,"_leadHasBadge",2);t([O()],y.prototype,"_trailSlotOccupied",2);t([O()],y.prototype,"_actionSlotOccupied",2);t([C("disabled")],y.prototype,"_handleDisabledChange",1);y=t([x("gds-field-base"),ce()],y);const _t=m`
...
`;var wt=_t,J,Le;let E=class extends M{constructor(){super(...arguments),p(this,J)}_handleVisibilityChange(){var e;this.classList.toggle("visually-hidden",!this.errorMessage&&!((e=this.charCounter)!=null&&e[1]))}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return n`<div aria-live="polite">
      <div class="error-message">
        <slot name="message"
          >${b(this.errorMessage,()=>n`
    ...
    </div>`}};J=new WeakSet;Le=function(){if(!this.charCounter||this.charCounter[1]===!1)return fe;const[e,s]=this.charCounter;return n`<gds-badge variant="${s}">${e}</gds-badge>`};E.styles=[wt];t([d({type:Array})],E.prototype,"charCounter",2);t([d()],E.prototype,"errorMessage",2);t([C("charCounter"),C("errorMessage")],E.prototype,"_handleVisibilityChange",1);E=t([x("gds-form-control-footer",{dependsOn:[f,tt]})],E);const $t=m`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var kt=$t,U,Be,Q,Z,N,We;let T=class extends M{constructor(){super(...arguments),p(this,U),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,p(this,Q,()=>n`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `};T.styles=[kt];t([d({type:Boolean,reflect:!0})],T.prototype,"showExtendedSupportingText",2);t([O()],T.prototype,"_hasExtendedSupportingText",2);t([X("#extended-supporting-text")],T.prototype,"_extendedSupportingText",2);T=t([x("gds-form-control-header",{dependsOn:[Ve,I,st]}),ce()],T);const St=m`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
    ...
    `),p(this,q,e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})}),p(this,oe,e=>{if(this.combobox){const i=e.getBoundingClientRect(),r=window.innerHeight-i.bottom,g=i.top;let v=Math.min(g,this.maxHeight);return r>g&&(v=Math.min(r,this.maxHeight)),`${v-16}px`}return`${Math.min(window.innerHeight,this.maxHeight)-16}px`}),p(this,w,(e,s)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:s,open:e},bubbles:!1,composed:!1})),p(this,ae,e=>{o(this,w).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),p(this,re,e=>{e.preventDefault(),e.stopPropagation(),this.value=void 0,this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),o(this,G).call(this),o(this,H).call(this)}),p(this,R,e=>{if(!e.currentTarget||(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}})))return;const i=e.currentTarget;if(this.options.forEach(r=>r.hidden=!1),!i.value)return;this.options.filter(r=>!this.searchFilter(i.value,r)).forEach(r=>r.hidden=!0)}),p(this,le,e=>{var s;(s=this._elListbox)==null||s.then(i=>{if(e.key==="ArrowDown"||e.key==="Tab"){e.preventDefault(),i.focus();return}})}),p(this,ne,e=>{var s;if(e.key==="Tab"&&this.searchable){e.preventDefault(),(s=this._elSearchInput)==null||s.focus();return}}),p(this,de,e=>{const s=this._elTriggerBtn;s&&(s.ariaActiveDescendantElement=e.target)}),p(this,G,()=>{this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))}),p(this,H,()=>{this.updateComplete.then(()=>this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))}),p(this,B,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&o(this,w).call(this,!1,"close")&&(this.open=!1)}),p(this,Y,e=>{var s;e.key==="Tab"&&!this.searchable&&o(this,w).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,(s=this._elTriggerBtn)==null||s.focus())})}get type(){return"gds-dropdown"}get options(){return o(this,$)?Array.from(o(this,$)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if(o(this,$))return Array.from(o(this,$)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){var s,i;let e;return Array.isArray(this.value)?e=this.value.slice(0,5).reduce((l,r)=>{var g;return l+((g=this.options.find(v=>v.value===r))==null?void 0:g.innerText)+", "},"").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):e=(s=this.options.find(l=>l.selected))==null?void 0:s.innerText,e||((i=this.placeholder)==null?void 0:i.innerText)||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",o(this,q)),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",o(this,q))}render(){return n`
      ...
      >
        ...
        >
          ...
          ${b(this.value&&this.multiple&&this.value.length>0,()=>n`<gds-badge
                rounded
              ...
              >`)}
          ${b(this.clearable&&this.value&&!this.disabled,()=>n`<gds-button
                id="clear-btn"
                rank="tertiary"
