...
`;let n=class extends r.o{render(){return a.qy`<slot></slot>`}};n.styles=[o.LU,l],n=(0,i.Cc)([(0,a.Y$)("gds-flex")],n)},6428:(e,t,s)=>{s.d(t,{o:()=>r});var i=s(6861),o=s(7526),a=s(3832);let r=class extends a.M{};r._regularSVG='<path d="M20 9L12 17L4 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',r._solidSVG='<path fill-rule="evenodd" clip-rule="evenodd" d="M3.46967 8.46967C3.76256 8.17678 4.23744 8.17678 4.53033 8.46967L12 15.9393L19.4697 8.46967C19.7626 8.17678 20.2374 8.17678 20.5303 8.46967C20.8232 8.76256 20.8232 9.23744 20.5303 9.53033L12.5303 17.5303C12.3897 17.671 12.1989 17.75 12 17.75C11.8011 17.75 11.6103 17.671 11.4697 17.5303L3.46967 9.53033C3.17678 9.23744 3.17678 8.76256 3.46967 8.46967Z" fill="currentColor"/>',r._name="chevron-bottom",r._width=24,r._height=24,r._viewBox="0 0 24 24",r=(0,i.Cc)([(0,o.Y$)("gds-icon-chevron-bottom")],r)},7617:(e,t,s)=>{s.d(t,{z:()=>d});var i=s(6861),o=s(9443),a=s(5073),r=s(9399),l=s(7526),n=s(8833);let d=class extends n.o{constructor(){super(),this.variant="primary",this.padding="m;m{xl}",this["border-radius"]="s",this.gap="m;m{l}"}render(){return l.qy`<slot></slot>`}};d.styles=[a.LU,o.AH`
    ...
    `],(0,i.Cc)([(0,r.F)({styleTemplate:function(e,t){let s,i,o;switch(t[0]){case"primary":case"neutral-01":default:s="transparent",i=`var(--gds-sys-color-l${this.level}-neutral-01)`,o="var(--gds-sys-color-content-neutral-01)";break;case"secondary":s="var(--gds-sys-color-border-subtle-01)",i=`var(--gds-sys-color-l${this.level}-neutral-02)`,o="var(--gds-sys-color-content-neutral-01)";break;case"tertiary":case"neutral-02":s="transparent",i=`var(--gds-sys-color-l${this.level}-neutral-02)`,o="var(--gds-sys-color-content-neutral-01)";break;case"neutral-01-2":s="transparent",i=`var(--gds-sys-color-l${this.level}-neutral-01-2)`,o="var(--gds-sys-color-content-neutral-01)";break;case"neutral-02-2":s="transparent",i=`var(--gds-sys-color-l${this.level}-neutral-02-2)`,o="var(--gds-sys-color-content-neutral-01)";break;case"brand-01":s="transparent",i=`var(--gds-sys-color-l${this.level}-brand-01)`,o="var(--gds-sys-color-content-inversed)";break;case"brand-02":s="transparent",i=`var(--gds-sys-color-l${this.level}-brand-02)`,o="var(--gds-sys-color-content-brand-02)";break;case"positive":case"negative":case"warning":case"information":case"notice":s=`var(--gds-sys-color-border-${t[0]}-02)`,i=`var(--gds-sys-color-l${this.level}-${t[0]}-01)`,o=`var(--gds-sys-color-content-${t[0]}-01)`}return`\n      --_border-color: ${s};\n      --_background-color: ${i};\n      --_color: ${o};\n      `}})],d.prototype,"variant",2),d=(0,i.Cc)([(0,l.Y$)("gds-card")],d)},7708:(e,t,s)=>{s.d(t,{V:()=>y});var i,o,a=s(6861),r=s(9443),l=s(4367),n=s(505),d=s(801),c=s(8745),p=s(8641),h=s(1374),g=s(7526),u=r.AH`
  @layer base, reset, transitional-styles;
  @layer base {
...
//# sourceMappingURL=2704.2c1271f1.iframe.bundle.js.map