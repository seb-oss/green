...
@status beta`}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},c={...t,name:"Card",render:i=>e`
  ...
  \`
}`,...(f=(g=a.parameters)==null?void 0:g.docs)==null?void 0:f.source},description:{story:"`gds-rich-text` can be used to wrap generic HTML content and apply typography styles.\nIt supports out of the box all heading styles from h1 to h6 based on the green design system typography styles.",...(v=(y=a.parameters)==null?void 0:y.docs)==null?void 0:v.description}}};var S,b,x,w,k;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Lists',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(x=(b=o.parameters)==null?void 0:b.docs)==null?void 0:x.source},description:{story:"`gds-rich-text` has built-in support for ordered and unordered lists.\nIt applies consistent spacing and typography styles to list items.",...(k=(w=o.parameters)==null?void 0:w.docs)==null?void 0:k.description}}};var E,q,T,A,C;n.parameters={...n.parameters,docs:{...(E=n.parameters)==null?void 0:E.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Details',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(T=(q=n.parameters)==null?void 0:q.docs)==null?void 0:T.source},description:{story:"`gds-rich-text` has built-in support for details html element.\n\nThe details element is a disclosure widget from HTML5 that can be used to hide or show additional content.",...(C=(A=n.parameters)==null?void 0:A.docs)==null?void 0:C.description}}};var L,M,H,I,D;s.parameters={...s.parameters,docs:{...(L=s.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Blockquote',
  render: args => html\`
    <gds-rich-text>
  ...
  \`
}`,...(H=(M=s.parameters)==null?void 0:M.docs)==null?void 0:H.source},description:{story:"`gds-rich-text` has built-in support blockquote element.",...(D=(I=s.parameters)==null?void 0:I.docs)==null?void 0:D.description}}};var F,P,R,j,N;r.parameters={...r.parameters,docs:{...(F=r.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Formatting',
  render: args => html\`
    <gds-rich-text>
...
\`\`\``,...(U=(V=d.parameters)==null?void 0:V.docs)==null?void 0:U.description}}};const le=["Card","Headings","Lists","Details","Blockquote","Formatting","Table","Basic"];export{d as Basic,s as Blockquote,c as Card,n as Details,r as Formatting,a as Headings,o as Lists,l as Table,le as __namedExportsOrder,re as default};
