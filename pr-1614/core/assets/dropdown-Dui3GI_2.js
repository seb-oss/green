import{n as l,g as H,h as g,G as U}from"./gds-element-RTlSuh_R.js";import{a as q}from"./query-p8xgzTDt.js";import{r as se}from"./query-async-MEroNOeJ.js";import{a as ie}from"./icon-jzQ8K1tO.js";import{n as S}from"./when-BxLAFfhK.js";import{t as re}from"./if-defined-OiR-h1RO.js";import{R as N}from"./class-map-BBGuaYF3.js";import{m as k,s as ae}from"./runtime-CMQcyTl6.js";import{w as E}from"./watch-tFciLXSI.js";import{o as oe}from"./observe-light-dom-CmJPHUQ4.js";import"./chevron-bottom-vJKcTK_L.js";import"./checkmark-Dmy_7y5A.js";import{K as ne,i as le}from"./ref-Bq52Xjdl.js";import{T as B}from"./transitional-styles-9whFD-yV.js";import{s as he,F as pe,L as de,u as ce}from"./menu-heading-CrrC9x42.js";import{t as Y}from"./tokens.style-DI3Y9gRF.js";import{i as J}from"./lit-element-BoQqPHl6.js";import"./popover-acoF-ckh.js";import"./backdrop-CljoM9rw.js";import{a as ue}from"./button-DkAXBv-k.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class fe{constructor(t){this.__litLocalizeEventHandler=s=>{s.detail.status==="ready"&&this.host.requestUpdate()},this.host=t}hostConnected(){window.addEventListener(V,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(V,this.__litLocalizeEventHandler)}}const ge=e=>e.addController(new fe(e)),ve=ge;var me=Object.defineProperty,be=Object.getOwnPropertyDescriptor,Q=e=>{throw TypeError(e)},b=(e,t,s,i)=>{for(var r=i>1?void 0:i?be(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(r=(i?p(t,s,r):p(r))||r);return i&&r&&me(t,s,r),r},F=(e,t,s)=>t.has(e)||Q("Cannot "+s),ye=(e,t,s)=>(F(e,t,"read from private field"),s?s.call(e):t.get(e)),I=(e,t,s)=>t.has(e)?Q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w=(e,t,s,i)=>(F(e,t,"write to private field"),t.set(e,s),s),R=(e,t,s)=>(F(e,t,"access private method"),s),f,C,A;let u=class extends pe(U){constructor(){super(),I(this,C),I(this,f,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",R(this,C,A)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),R(this,C,A).call(this,e))})}get hidden(){return ye(this,f)}set hidden(e){this.isPlaceholder||(w(this,f,e==="true"||e===!0),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(w(this,f,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then(()=>B.instance.apply(this,"gds-option"))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(w(this,f,!0),this.setAttribute("aria-hidden","true")):(w(this,f,!1),this.setAttribute("aria-hidden","false"))}render(){var s;const e=(s=this.parentElement)==null?void 0:s.multiple,t=g`
      <span class="checkbox ${N({checked:this.selected})}">
        ${this.selected?g`<gds-icon-checkmark stroke="4"></gds-icon-checkmark>`:""}
      </span>
    `;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),g`<div>${S(e,()=>t)} <slot></slot></div>`}};f=new WeakMap;C=new WeakSet;A=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))};u.styles=[Y,he];b([l()],u.prototype,"value",2);b([l({attribute:"aria-hidden",reflect:!0})],u.prototype,"hidden",1);b([l({attribute:"aria-selected",reflect:!0})],u.prototype,"selected",2);b([l({type:Boolean,reflect:!0})],u.prototype,"isPlaceholder",2);b([E("isplaceholder")],u.prototype,"_handlePlaceholderStatusChange",1);u=b([H("gds-option")],u);const _e=J`
...
`;var we=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,X=e=>{throw TypeError(e)},$=(e,t,s,i)=>{for(var r=i>1?void 0:i?xe(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(r=(i?p(t,s,r):p(r))||r);return i&&r&&we(t,s,r),r},Ce=(e,t,s)=>t.has(e)||X("Cannot "+s),x=(e,t,s)=>(Ce(e,t,"read from private field"),s?s.call(e):t.get(e)),K=(e,t,s)=>t.has(e)?X("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),y,M;let v=class extends U{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,K(this,y,le()),K(this,M,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!1}))}),new de(this)}get navigableItems(){return this.visibleOptionElements}get options(){return x(this,y).value?ce(x(this,y).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),B.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",x(this,M))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return g`<slot ${ne(x(this,y))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};y=new WeakMap;M=new WeakMap;v.styles=_e;$([l({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);$([l()],v.prototype,"compareWith",2);$([E("multiple")],v.prototype,"_rerenderOptions",1);v=$([H("gds-listbox")],v);const Ee=J`
  @layer base, reset;
