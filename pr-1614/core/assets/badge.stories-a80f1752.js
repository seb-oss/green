import{k as a}from"./lit-element-1d72f0ce.js";import"./badge-f5495a3d.js";import"./grid-9e401f80.js";import"./flex-bcd919b1.js";import"./divider-175a5512.js";import"./triangle-exclamation-da39395f.js";import"./arrow-rotate-counter-clockwise-4ea18ba0.js";import"./plus-small-c324d6e0.js";import"./rocket-39575822.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-01187a75.js";import"./container-89e950a3.js";import"./style-expression-property-26695edd.js";import"./watch-c4961afe.js";import"./icon-a640baec.js";import"./directive-dd518ee3.js";const ge={title:"Docs/Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A badge is a small status or notification indicator that can be used to display a message or status.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"]},o={name:"Variants",render:e=>a`
  ...
  `};var m,p,v;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  name: 'Variants',
  render: args => html\`
    <gds-flex
      flex-direction="column"
  ...
  \`
}`,...(v=(p=o.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var f,x,u,h,w;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: 'Lead',
  parameters: {
    controls: {
      include: []
