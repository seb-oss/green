import{g as n,G as c,h as o}from"./custom-element-scoping-CpYtbs9r.js";import{t as u}from"./tokens.style-RalixZsd.js";import{o as a}from"./observe-light-dom-CmJPHUQ4.js";import{d as h}from"./default-typography.styles-BOILWASB.js";import{i as d}from"./lit-element-C_s9q329.js";import"./divider-DkqSgEb0.js";import"./card-ZuYQL3Kq.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./style-expression-property-C6V8xdlu.js";import"./container-Z83N913X.js";const w=d`
  :host {
...
`;var D=Object.defineProperty,p=Object.getOwnPropertyDescriptor,l=(A,Q,t,C)=>{for(var g=C>1?void 0:C?p(Q,t):Q,E=A.length-1,e;E>=0;E--)(e=A[E])&&(g=(C?e(Q,t,g):e(g))||g);return C&&g&&D(Q,t,g),g};let B=class extends c{querySelectorAll(A){return this.shadowRoot?this.shadowRoot.querySelectorAll(A):new NodeList}querySelector(A){return this.shadowRoot?this.shadowRoot.querySelector(A):null}get innerHTML(){var A;return((A=this.shadowRoot)==null?void 0:A.innerHTML)||""}set innerHTML(A){this.shadowRoot&&(this.shadowRoot.innerHTML=A)}connectedCallback(){super.connectedCallback(),this._captureDOM()}_captureDOM(){!this.shadowRoot||this.childNodes.length===0||this.shadowRoot.replaceChildren(...Array.from(this.childNodes))}};B.styles=[u,h,w];l([a()],B.prototype,"_captureDOM",1);B=l([n("gds-rich-text")],B);const K={title:"Components/Rich Text",component:"gds-rich-text",tags:["autodocs"],parameters:{docs:{description:{component:`\`gds-rich-text\` can be used to wrap generic HTML content and apply typography styles.
...
@status beta`}}}},q={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},I={...q,name:"Rich Text",render:A=>o`
  ...
  `};var r,i,s;I.parameters={...I.parameters,docs:{...(r=I.parameters)==null?void 0:r.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Rich Text',
  render: args => html\`
    <gds-card variant="notice">
  ...
  \`
}`,...(s=(i=I.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const W=["Divider"];export{I as Divider,W as __namedExportsOrder,K as default};
