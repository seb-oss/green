import{o as r,x as t}from"./iframe-BEPLVs1y.js";import"./spinner-CyCY_QH2.js";import"./div-g77T-Jd3.js";import"./flex-D98huMmd.js";import"./text-CcYVKuCY.js";import"./card-CX0mu3ys.js";import"./divider-Dcz6iwNV.js";import{a as g}from"./argTableProps-TLk4yset.js";import"./spinner.component-C6V8OUb4.js";import"./localized-decorator-BmLDxFUn.js";import"./flex.component-BiPoVA2f.js";import"./default-typography.styles-D5_mwp4X.js";import"./card.component-COuxVN8N.js";import"./divider.component-CfcrnvNB.js";const C={title:"Components/Spinner",component:"gds-spinner",tags:["autodocs"],argTypes:{...g("gds-textarea")},parameters:{docs:{description:{component:`A spinner is an indeterminate progress indicator.
  ...
  `},M={name:"Fullscreen Mode",render:()=>t`
      <gds-div height="400px">
        <gds-spinner
          ...
          showLabel
          @click=${e=>{const s=e.target;s.fullscreen=!s.fullscreen}}
        ></gds-spinner>
      </gds-div>
    `},$={name:"Light & Dark Theme",render:(e,{context:s})=>{const i=n=>{const d=document.getElementById("theme-demo-container");d&&(d.getAttribute("color-scheme")==="dark"?(d.setAttribute("color-scheme","light"),n.target.textContent="Switch to Dark Theme"):(d.setAttribute("color-scheme","dark"),n.target.textContent="Switch to Light Theme"))};return t`
      <gds-theme
        id="theme-demo-container"
        color-scheme="light"
        .designVersion=${s.globals.style}
      >
    ...
    `}},W=["Playground","Sizes","LabelOptions","Cover","Fullscreen","ThemeModes"];export{S as Cover,M as Fullscreen,y as LabelOptions,T as Playground,k as Sizes,$ as ThemeModes,W as __namedExportsOrder,C as default};
