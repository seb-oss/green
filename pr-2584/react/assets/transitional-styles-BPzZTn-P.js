import{i as E,t as S,b as g,s as T,V as b,d as t,j as G}from"./tokens.style-tv1jT6kI.js";const j=`/* stylelint-disable max-nesting-depth */
...
}`;function en(){e.instance.register("gds-theme",nn.toString())}var d,c,h;const tn=()=>{en(),z(),F(),P(),q(),K(),N(),s(),J()},on=class C{constructor(){g(this,d,new Map),g(this,c,new Map),g(this,h,!T())}static get instance(){var o;return(o=globalThis.__gdsTransitionalStyles)!=null&&o[b]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[b]:new C}),globalThis.__gdsTransitionalStyles[b]}apply(o,r){if(!o.shadowRoot)return;const n=t(this,d).get(r);n&&(t(this,c).set(r,o),this.applyToElement(r,n))}applyToElement(o,r){var p,f;const n=t(this,c).get(o);if(!n||!n.shadowRoot)return;const m=()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",G(r)),n._isUsingTransitionalStyles=!0},y=()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()},v="[gds-element=gds-theme]";let a=n.getRootNode(),i=n.closest(v);for(;i===null&&a!==document;)i=(p=a.host)==null?void 0:p.closest(v),a=(f=a.host)==null?void 0:f.getRootNode();if(i){const l=i,w=()=>{l.designVersion==="2023"?y():m()};if(l.addEventListener("gds-design-version-changed",w),n.addEventListener("gds-element-disconnected",()=>l.removeEventListener("gds-design-version-changed",w)),l.designVersion==="2023"){y();return}}m()}register(o,r){let n=r;t(this,h)&&(n=`@layer reset {
