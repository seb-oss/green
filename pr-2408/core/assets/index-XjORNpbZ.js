...
`;var Ie=qe;let cs=class extends c{render(){return Q`<slot></slot>`}};cs.styles=[q,Ie];cs=r([L("gds-flex")],cs);const nt=e=>{Ss.define();const s=U("gds-button"),t={...e,class:e.className};return O.createElement(s,t)},at=e=>{Y.define();const s=U("gds-card"),t={...e,class:e.className};return O.createElement(s,t)},it=e=>{cs.define();const s=U("gds-flex"),t={...e,class:e.className};return O.createElement(s,t)},Oe=w`
  @layer defaults {
    a:link {
      color: currentColor;
