import"./text-27baff67.js";import"./card-74fb07b4.js";import"./flex-d3b390ad.js";import"./divider-3c4aac73.js";import{x as e}from"./lit-element-71e04f06.js";import"./gds-element-54cd6e2a.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-52086a88.js";import"./style-expression-property-89161d08.js";import"./watch-c4961afe.js";const $={title:"Docs/Content/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:`The \`gds-text\`
...
## Usage`}}}},U={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["headline-xl","headline-l","headline-m","headline-s","title-l","title-m","title-s","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...U,name:"Tags",render:t=>e`<gds-flex direction="column" gap="m">
  ...
  \`
}`,...(L=(f=a.parameters)==null?void 0:f.docs)==null?void 0:L.source}}};var D,S,H;n.parameters={...n.parameters,docs:{...(D=n.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Title',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="title-s">Title Small</gds-text>
  ...
  \`
}`,...(H=(S=n.parameters)==null?void 0:S.docs)==null?void 0:H.source}}};var w,P,T;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Detail',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="detail-xs">Detail Extra Small</gds-text>
  ...
  \`
}`,...(T=(P=l.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var M,q,v;r.parameters={...r.parameters,docs:{...(M=r.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="body-s">Body Small</gds-text>
  ...
  \`
}`,...(R=(j=d.parameters)==null?void 0:j.docs)==null?void 0:R.source},description:{story:"The `gds-text` component has a `lines` property that will clamp the text to the specified number of lines. It can be any number value.",...(O=(_=d.parameters)==null?void 0:_.docs)==null?void 0:O.description}}};const ee=["Card","Weight","Headline","Title","Detail","Body","Display","Preamble","Lines"];export{r as Body,s as Card,l as Detail,g as Display,a as Headline,d as Lines,o as Preamble,n as Title,i as Weight,ee as __namedExportsOrder,$ as default};
