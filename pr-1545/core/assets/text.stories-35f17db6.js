import"./text-80b8e402.js";import"./card-d33ce9d8.js";import"./flex-f41061bb.js";import"./divider-25d5ac4b.js";import{x as e}from"./lit-element-71e04f06.js";import"./gds-element-54cd6e2a.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-c63c5f55.js";import"./style-expression-property-89161d08.js";import"./watch-c4961afe.js";const $={title:"Docs/Content/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:"The `gds-text`\n\n## Usage"}}}},U={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["headline-l","headline-m","headline-s","title-l","title-m","title-s","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...U,name:"Tags",render:t=>e`<gds-flex direction="column" gap="m">
  ...
  \`
}`,...(T=(w=n.parameters)==null?void 0:w.docs)==null?void 0:T.source}}};var M,q,v;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="body-s">Body Small</gds-text>
  ...
  \`
}`,...(v=(q=g.parameters)==null?void 0:q.docs)==null?void 0:v.source}}};var B,k,X;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Display',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="display-s">Display Small</gds-text>
  ...
  \`
}`,...(X=(k=l.parameters)==null?void 0:k.docs)==null?void 0:X.source}}};var E,C,W;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Preamble',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="preamble-xs">Preamble Extra Small</gds-text>
