...
## Usage`}}}},_={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["heading-xl","heading-l","heading-m","heading-s","heading-xs","heading-2xs","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={..._,name:"Tags",render:t=>e`<gds-flex direction="column" gap="m">
    ...
    </gds-flex>`},a={..._,name:"Weight",render:t=>e`<gds-flex direction="column" gap="m">
...
}`,...(y=(h=a.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};var b,z,f,L,H;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'Heading',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text tag="h6" size="heading-2xs">H6: Heading 2XS</gds-text>
  ...
  \`
}`,...(E=(T=o.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var C,W,I,j,R;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Line Clamp',
  render: args => html\`
    <gds-flex direction="column" gap="2xl">
      <gds-flex direction="column" gap="m">
  ...
  \`
}`,...(I=(W=i.parameters)==null?void 0:W.docs)==null?void 0:I.source},description:{story:"The `gds-text` component has a `lines` property that will clamp the text to the specified number of lines. It can be any number value.",...(R=(j=i.parameters)==null?void 0:j.docs)==null?void 0:R.description}}};const $=["Card","Weight","Heading","Detail","Body","Display","Preamble","Lines"];export{n as Body,s as Card,g as Detail,r as Display,d as Heading,i as Lines,o as Preamble,a as Weight,$ as __namedExportsOrder,Z as default};
