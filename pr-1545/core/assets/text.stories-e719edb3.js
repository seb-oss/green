import"./text-99e6d382.js";import"./card-74fb07b4.js";import"./flex-d3b390ad.js";import"./divider-3c4aac73.js";import{x as e}from"./lit-element-71e04f06.js";import"./static-ecb8bd0e.js";import"./gds-element-54cd6e2a.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-52086a88.js";import"./style-expression-property-89161d08.js";import"./watch-c4961afe.js";const ee={title:"Docs/Content/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:`The \`gds-text\`
...
## Usage`}}}},U={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["headline-xl","headline-l","headline-m","headline-s","title-l","title-m","title-s","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...U,name:"Tags",render:t=>e`<gds-flex direction="column" gap="m">
...
}`,...(b=(y=i.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var z,f,L;a.parameters={...a.parameters,docs:{...(z=a.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: 'Headline',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="headline-s">Headline Small</gds-text>
  ...
  \`
}`,...(L=(f=a.parameters)==null?void 0:f.docs)==null?void 0:L.source}}};var D,S,H;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Title',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="title-s">Title Small</gds-text>
  ...
  \`
}`,...(H=(S=l.parameters)==null?void 0:S.docs)==null?void 0:H.source}}};var w,P,T;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Detail',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="detail-xs">Detail Extra Small</gds-text>
  ...
  \`
}`,...(T=(P=n.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var M,q,v;r.parameters={...r.parameters,docs:{...(M=r.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="body-s">Body Small</gds-text>
  ...
  \`
}`,...(v=(q=r.parameters)==null?void 0:q.docs)==null?void 0:v.source}}};var B,k,E;g.parameters={...g.parameters,docs:{...(B=g.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'Display',
  render: args => html\`
    <gds-flex direction="column" gap="m">
      <gds-text size="display-s">Display Small</gds-text>
  ...
  \`
}`,...(W=(C=o.parameters)==null?void 0:C.docs)==null?void 0:W.source}}};var I,j,R,_,O;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'Line Clamp',
  render: args => html\`
    <gds-flex direction="column" gap="2xl">
      <gds-flex direction="column" gap="m">
  ...
  \`
}`,...(R=(j=d.parameters)==null?void 0:j.docs)==null?void 0:R.source},description:{story:"The `gds-text` component has a `lines` property that will clamp the text to the specified number of lines. It can be any number value.",...(O=(_=d.parameters)==null?void 0:_.docs)==null?void 0:O.description}}};const te=["Card","Weight","Headline","Title","Detail","Body","Display","Preamble","Lines"];export{r as Body,s as Card,n as Detail,g as Display,a as Headline,d as Lines,o as Preamble,l as Title,i as Weight,te as __namedExportsOrder,ee as default};
