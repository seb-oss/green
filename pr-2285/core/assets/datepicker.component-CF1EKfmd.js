 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Yt(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let l=0;for(const u of t)a[l]=i?i(u,l):l,n[l]=s(u,l),l++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:l}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=l,n;const u=this.ut??(this.ut=[]),o=[];let k,M,d=0,b=a.length-1,m=0,C=n.length-1;for(;d<=b&&m<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(u[d]===l[m])o[m]=I(a[d],n[m]),d++,m++;else if(u[b]===l[C])o[C]=I(a[b],n[C]),b--,C--;else if(u[d]===l[C])o[C]=I(a[d],n[C]),N(t,o[C+1],a[d]),d++,C--;else if(u[b]===l[m])o[m]=I(a[b],n[m]),N(t,a[d],a[b]),b--,m++;else if(k===void 0&&(k=Ct(l,m,C),M=Ct(u,d,b)),k.has(u[d]))if(k.has(u[b])){const S=M.get(l[m]),J=S!==void 0?a[S]:null;if(J===null){const xt=N(t,a[d]);I(xt,n[m]),o[m]=xt}else o[m]=I(J,n[m]),N(t,a[d],J),a[S]=null;m++}else U(a[b]),b--;else U(a[d]),d++;for(;m<=C;){const S=N(t,o[C+1]);I(S,n[m]),o[m++]=S}for(;d<=b;){const S=a[d++];S!==null&&U(S)}return this.ut=l,Zt(t,o),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
