import{x as a}from"./iframe-DMh0atI0.js";import{a as O}from"./argTableProps-6tQZodaY.js";import"./badge-B8l11EFB.js";import"./flex-DoYRkPEC.js";import"./divider-TFNVXGhu.js";import"./triangle-exclamation-CkYeoh3e.js";import"./circle-check-sMSpt7Kh.js";import"./arrow-rotate-counter-clockwise.component-BTrlZqp9.js";import"./minus-small-CFCuESWW.js";import"./rocket-CngWkGYm.js";import"./preload-helper-Dp1pzeXC.js";import"./badge.component-RruVW_Sh.js";import"./flex.component-kRdrDpGQ.js";import"./divider.component-BV4gUR7l.js";import"./triangle-exclamation.component-qT7-A25j.js";import"./icon.component-BjRoIXiR.js";import"./circle-check.component-BvZgD1sy.js";import"./minus-small.component-8kzyaD-x.js";import"./rocket.component-BwGoa6CU.js";const le={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...O("gds-badge")}},o={name:"Variants",render:e=>a`
    <gds-flex
