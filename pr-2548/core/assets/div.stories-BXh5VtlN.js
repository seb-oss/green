import{x as j}from"./iframe-CKJEIZ91.js";import"./div-DQo1IUMN.js";import"./flex-CYf7Ph9x.js";import"./card-BvPAKQnM.js";import{a as B}from"./argTableProps-LsBxrl3H.js";import"./preload-helper-Dp1pzeXC.js";import"./flex.component-DabzLWEu.js";import"./card.component-CuNSZkmE.js";const I={title:"Components/Div",component:"gds-div",tags:["autodocs"],argTypes:{...B("gds-div")},parameters:{docs:{description:{component:"`gds-div` is a base element in the declarative layout system.\n\nDiv accepts all available style expression properties, and is also the base class for `gds-flex`, `gds-grid`, `gds-card` and `gds-text`"}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},s={...t,args:{background:"01",border:"2xs","border-radius":"m","border-color":"subtle-01",width:"4xl",height:"4xl"}},r={...t,render:S=>j`
