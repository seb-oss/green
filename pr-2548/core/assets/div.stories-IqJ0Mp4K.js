import{x as j}from"./iframe-BwDoi1Fm.js";import"./div-CvYFk-LT.js";import"./flex-C3XxBz7h.js";import"./card-VzCdd3kH.js";import{a as B}from"./argTableProps-Bb-AQooa.js";import"./preload-helper-Dp1pzeXC.js";import"./flex.component-CCTIOSPn.js";import"./card.component-MULgC75p.js";const I={title:"Components/Div",component:"gds-div",tags:["autodocs"],argTypes:{...B("gds-div")},parameters:{docs:{description:{component:"`gds-div` is a base element in the declarative layout system.\n\nDiv accepts all available style expression properties, and is also the base class for `gds-flex`, `gds-grid`, `gds-card` and `gds-text`"}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},s={...t,args:{background:"01",border:"2xs","border-radius":"m","border-color":"subtle-01",width:"4xl",height:"4xl"}},r={...t,render:S=>j`
