...
\`\`\``,...(ae=(te=p.parameters)==null?void 0:te.docs)==null?void 0:ae.description}}};var ne,re,ie,se,le;u.parameters={...u.parameters,docs:{...(ne=u.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  ...
  \`
}`,...(pe=(de=c.parameters)==null?void 0:de.docs)==null?void 0:pe.source},description:{story:"The `disabled` property can be set to disable the input field.\n\n**@property disabled** - Disables the input field.\n\n```html\n <gds-input disabled></gds-input>\n```",...(ce=(ue=c.parameters)==null?void 0:ue.docs)==null?void 0:ce.description}}};const Xe=["Default","Size","Lead","Trail","Length","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","Disabled"];export{l as Clearable,g as Default,c as Disabled,d as ExtendedSupportingText,r as Lead,s as Length,n as Size,u as StandardAttributes,o as SupportingText,i as Trail,p as Validation,Xe as __namedExportsOrder,Qe as default};
