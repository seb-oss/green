...
`;var Re=Ae,X,C,W,Ks,vs,bs;const Le=["aria-label","aria-haspopup","aria-expanded"],We=Te(Y);class b extends k{constructor(){super(...arguments),p(this,C),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",p(this,X,!1),p(this,vs,()=>{var t;const s=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];x(this,X,s.length===1&&(s[0].tagName.toLowerCase().startsWith("gds-icon")||s[0].getAttribute("name")==="icon")),this.requestUpdate()}),p(this,bs,s=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:s}),this.form&&!a(this,C,W)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}focus(s){var t;(t=this._getValidityAnchor())==null||t.focus(s)}click(){var s;(s=this._getValidityAnchor())==null||s.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),Hs.instance.apply(this,"gds-button")}render(){const s={button:!0,circle:a(this,X),icon:a(this,X),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,C,W)?Gs`a`:Gs`button`;return Ls`
      ...
      >
        ...
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}X=new WeakMap;C=new WeakSet;W=function(){return this.href.length>0};Ks=function(){return this.target==="_blank"?"noreferrer noopener":void 0};vs=new WeakMap;bs=new WeakMap;b.styles=[q,Re];b.shadowRootOptions={mode:"open",delegatesFocus:!0};r([g({type:Boolean,reflect:!0})],b.prototype,"disabled",2);r([i({selector:".button"})],b.prototype,"justify-content",2);r([g({reflect:!0})],b.prototype,"type",2);r([g({reflect:!0})],b.prototype,"rank",2);r([g({reflect:!0})],b.prototype,"variant",2);r([g({reflect:!0})],b.prototype,"size",2);r([g()],b.prototype,"label",2);r([g()],b.prototype,"href",2);r([g()],b.prototype,"target",2);r([g()],b.prototype,"rel",2);r([g()],b.prototype,"download",2);r([xs("slot:not([name])")],b.prototype,"_mainSlot",2);r([xs(".button")],b.prototype,"_button",2);r([me({attributes:!0,childList:!1,subtree:!1,characterData:!1})],b.prototype,"_attributeChanged",1);let Ss=class extends Zs($s(Bs(b))){};Ss=r([R("gds-button",{dependsOn:[Z]})],Ss);const je=w`
  :host {
    display: block;
    box-sizing: border-box;
    border-style: solid;
...
`;var Pe=je;let c=class extends Zs(De($s(Ve(Bs(ze(F)))))){constructor(){super(...arguments),this.level="2"}render(){return Y`<slot></slot>`}};c.styles=[q,Pe];r([i()],c.prototype,"display",2);r([g()],c.prototype,"level",2);r([i(gs("content"))],c.prototype,"color",2);r([i(gs("background"))],c.prototype,"background",2);r([i({styleTemplate:function(e,s){const t=this,[o,n=t["border-style"]||"solid",l=t["border-color"]||"subtle-01"]=s,d=`var(--gds-sys-space-${o})`,h=Js(l,"border",t.level);return`border: ${d} ${n} ${h};`}})],c.prototype,"border",2);r([i(gs("border"))],c.prototype,"border-color",2);r([i(J)],c.prototype,"border-width",2);r([i()],c.prototype,"border-style",2);r([i(Ge)],c.prototype,"border-radius",2);r([i({valueTemplate:e=>`var(--gds-sys-shadow-${e}-01), var(--gds-sys-shadow-${e}-02)`})],c.prototype,"box-shadow",2);r([i()],c.prototype,"opacity",2);r([i()],c.prototype,"overflow",2);r([i()],c.prototype,"box-sizing",2);r([i()],c.prototype,"z-index",2);r([i({styleTemplate:(e,s)=>`font: var(--gds-sys-text-${s[0]});`})],c.prototype,"font",2);r([i({valueTemplate:e=>`var(--gds-sys-text-weight-${e})`})],c.prototype,"font-weight",2);r([i()],c.prototype,"text-align",2);r([i()],c.prototype,"text-wrap",2);r([i()],c.prototype,"overflow-wrap",2);r([i()],c.prototype,"white-space",2);r([i({...J,styleTemplate:(e,s)=>{const t=s[0],o=s[1]||t;return`gap: ${t} ${o};`},cacheOverrideKey:"flex"})],c.prototype,"gap",2);r([i()],c.prototype,"align-items",2);r([i()],c.prototype,"align-content",2);r([i()],c.prototype,"justify-content",2);r([i()],c.prototype,"justify-items",2);r([i()],c.prototype,"flex-direction",2);r([i()],c.prototype,"flex-wrap",2);r([i()],c.prototype,"place-items",2);r([i()],c.prototype,"place-content",2);c=r([R("gds-div")],c);let K=class extends c{constructor(){super(),this.variant="primary",this.padding="m;m{l}",this["border-radius"]="s",this.gap="m;m{l}"}render(){return Y`<slot></slot>`}};K.styles=[q,w`
    ...
    `];r([i({styleTemplate:function(e,s){let t,o,n;switch(s[0]){case"primary":t="transparent",o=`var(--gds-sys-color-l${this.level}-neutral-01)`,n="var(--gds-sys-color-content-neutral-01)";break;case"secondary":t="var(--gds-sys-color-border-subtle-01)",o=`var(--gds-sys-color-l${this.level}-neutral-02)`,n="var(--gds-sys-color-content-neutral-01)";break;case"brand-01":t="transparent",o=`var(--gds-sys-color-l${this.level}-brand-01)`,n="var(--gds-sys-color-content-inversed)";break;case"brand-02":t="transparent",o=`var(--gds-sys-color-l${this.level}-brand-02)`,n="var(--gds-sys-color-content-brand-02)";break;case"positive":case"negative":case"warning":case"information":case"notice":t=`var(--gds-sys-color-border-${s[0]}-02)`,o=`var(--gds-sys-color-l${this.level}-${s[0]}-01)`,n=`var(--gds-sys-color-content-${s[0]}-01)`;break;default:t="transparent",o=`var(--gds-sys-color-l${this.level}-neutral-01)`,n="var(--gds-sys-color-content-neutral-01)";break}return`
      ...
      --_background-color: ${o};
      --_color: ${n};
      `}})],K.prototype,"variant",2);K=r([R("gds-card")],K);const Fe=w`
  @layer icon;
...
`;var Oe=Ie;let cs=class extends c{render(){return Y`<slot></slot>`}};cs.styles=[q,Oe];cs=r([R("gds-flex")],cs);const at=e=>{Ss.define();const s=N("gds-button"),t={...e,class:e.className};return O.createElement(s,t)},it=e=>{K.define();const s=N("gds-card"),t={...e,class:e.className};return O.createElement(s,t)},lt=e=>{cs.define();const s=N("gds-flex"),t={...e,class:e.className};return O.createElement(s,t)},Ne=w`
  @layer defaults {
    a:link {
      color: currentColor;
