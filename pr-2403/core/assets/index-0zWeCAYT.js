 ...
 */
  ...
  --gds-sys-text-family: SEB SansSerif, SEB SansSerif GDS;
  ...
  --gds-sys-text-heading-xl: 450 32px/44px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-heading-l: 450 28px/40px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-heading-m: 450 24px/32px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-heading-s: 450 20px/28px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-heading-xs: 450 16px/24px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-heading-2xs: 450 14px/20px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-detail-book-m: 450 16px/20px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-detail-book-s: 450 14px/18px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-detail-book-xs: 450 12px/16px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-detail-regular-m: 400 16px/20px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-detail-regular-s: 400 14px/18px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-detail-regular-xs: 400 12px/16px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-book-l: 450 20px/26px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-book-m: 450 16px/24px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-book-s: 450 14px/20px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-regular-l: 400 20px/26px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-regular-m: 400 16px/24px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-regular-s: 400 14px/20px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-italic-l: italic 400 20px/26px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-italic-m: italic 400 16px/24px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-body-italic-s: italic 400 14px/20px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-display-2xl: 450 82px/90px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-display-xl: 450 64px/72px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-display-l: 450 48px/56px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-display-m: 450 36px/44px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-display-s: 450 32px/40px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-preamble-2xl: 450 32px/40px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-preamble-xl: 450 28px/36px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-preamble-l: 450 24px/32px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-preamble-m: 450 20px/28px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-preamble-s: 450 18px/26px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-text-preamble-xs: 450 16px/24px SEB SansSerif, SEB SansSerif GDS;
  --gds-sys-space-0: 0px;
 ...
 */
  ...
  --gds-sys-shadow-xl-02: 0px 0px 0px 0px transparent;`;var pe={};const ds=typeof process<"u"&&pe!==void 0;var hs,is,ls,Es,es,qs,Is;function ye(){return ds?[]:document.adoptedStyleSheets||[]}const fe=class Os{constructor(){y(this,es),y(this,hs,!_s()),y(this,is,new Map),y(this,ls,new Map),y(this,Es,ye())}static get instance(){var s;return(s=globalThis.__gdsGlobalStylesRegistryScoped)!=null&&s[B]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[B]:new Os}),globalThis.__gdsGlobalStylesRegistryScoped[B]}injectGlobalStyles(s,t){if(a(this,hs)){const o=Array.isArray(t)?t.map(n=>n.toString()).join(""):t.toString();j(this,es,qs).call(this,s,o)}else t.styleSheet&&j(this,es,Is).call(this,s,t.styleSheet)}};hs=new WeakMap;is=new WeakMap;ls=new WeakMap;Es=new WeakMap;es=new WeakSet;qs=function(e,s){if(ds)return;let t=a(this,ls).get(e);t||(t=document.createElement("style"),a(this,ls).set(e,t)),t.textContent=s,document.head.appendChild(t)};Is=function(e,s){ds||(a(this,is).set(e,s),document.adoptedStyleSheets=[...a(this,Es),...Array.from(a(this,is).values())])};let he=fe;const q=[w`
    :host {
      ${S(Ps)}
      ${S(Fs)}
    }
...
`;var Ae=ze,J,E,W,Zs,bs,vs;const Le=["aria-label","aria-haspopup","aria-expanded"],Re=Be(Q);class u extends k{constructor(){super(...arguments),y(this,E),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",y(this,J,!1),y(this,bs,()=>{var t;const s=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];x(this,J,s.length===1&&(s[0].tagName.toLowerCase().startsWith("gds-icon")||s[0].getAttribute("name")==="icon")),this.requestUpdate()}),y(this,vs,s=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:s}),this.form&&!a(this,E,W)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),Ns.instance.apply(this,"gds-button")}focus(s){var t;(t=this._getValidityAnchor())==null||t.focus(s)}render(){const s={button:!0,circle:a(this,J),icon:a(this,J),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,E,W)?Ts`a`:Ts`button`;return Ls`
      <${t}
        class=${Qs(s)}
        type="${H(a(this,E,W)?void 0:this.type)}"
        ?disabled="${this.disabled}"
        aria-label=${this.label||As}
        href=${H(a(this,E,W)?this.href:void 0)}
        target=${H(a(this,E,W)?this.target:void 0)}
        rel=${H(a(this,E,W)?this.rel||a(this,E,Zs):void 0)}
        download=${H(a(this,E,W)?this.download:void 0)}
        part="_button"
        @click="${a(this,vs)}"
      ...
      >
        ...
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}J=new WeakMap;E=new WeakSet;W=function(){return this.href.length>0};Zs=function(){return this.target==="_blank"?"noreferrer noopener":void 0};bs=new WeakMap;vs=new WeakMap;u.styles=[q,Ae];u.shadowRootOptions={mode:"open",delegatesFocus:!0};r([g({type:Boolean,reflect:!0})],u.prototype,"disabled",2);r([i({selector:".button"})],u.prototype,"justify-content",2);r([g({reflect:!0})],u.prototype,"type",2);r([g({reflect:!0})],u.prototype,"rank",2);r([g({reflect:!0})],u.prototype,"variant",2);r([g({reflect:!0})],u.prototype,"size",2);r([g()],u.prototype,"label",2);r([g()],u.prototype,"href",2);r([g()],u.prototype,"target",2);r([g()],u.prototype,"rel",2);r([g()],u.prototype,"download",2);r([xs("slot:not([name])")],u.prototype,"_mainSlot",2);r([xs(".button")],u.prototype,"_button",2);r([me({attributes:!0,childList:!1,subtree:!1,characterData:!1})],u.prototype,"_attributeChanged",1);let ms=class extends Js($s(Bs(u))){};ms=r([L("gds-button",{dependsOn:[K]})],ms);const We=w`
  :host {
    display: block;
    box-sizing: border-box;
    border-style: solid;
...
`;var Fe=Pe;class G extends $s(Bs(F)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const t={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...t,"aria-label":this.label}:{...t,role:"presentation"}}get svgContent(){const s=this.constructor;return this.solid?s._solidSVG:s._regularSVG}applyStroke(s){return this.stroke?s.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):s}generateAttributesString(s){return Object.entries(s).filter(([t,o])=>o!==void 0).map(([t,o])=>`${t}="${o}"`).join(`
    ...
    `;return Ss`${ne(o)}`}}G.styles=[q,Fe];r([i({...m,property:"height",selector:"svg"})],G.prototype,"size",2);r([g({type:Boolean})],G.prototype,"solid",2);r([g({type:Number})],G.prototype,"stroke",2);r([g()],G.prototype,"level",2);r([i(gs("content"))],G.prototype,"color",2);r([g({type:String})],G.prototype,"label",2);G.define();const qe=w`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;var Ne=Ue;let T=class extends c{constructor(){super(...arguments),this.tag="span"}render(){const s=ee(encodeURI(this.tag));return Ls`<${s} tag><slot></slot></${s}>`}};T.styles=[q,Oe,Ne];r([g({type:String})],T.prototype,"tag",2);r([i({selector:"[tag]",styleTemplate:(e,s)=>`font: var(--gds-sys-text-${s[0]});`})],T.prototype,"font",2);r([i({selector:"[tag]",valueTemplate:e=>`var(--gds-sys-text-weight-${e})`})],T.prototype,"font-weight",2);r([i()],T.prototype,"text-transform",2);r([i({selector:"[tag]"})],T.prototype,"text-decoration",2);r([i({selector:"[tag]",styleTemplate:(e,s)=>`overflow: hidden;
      ...
      -webkit-box-orient: vertical;`})],T.prototype,"lines",2);T=r([L("gds-text")],T);let P=class extends F{constructor(){super(...arguments),this.colorScheme="light",this.designVersion="2023"}connectedCallback(){super.connectedCallback(),Ns.instance.apply(this,"gds-theme"),this._dynamicStylesController.inject("dark",S(`:host {${ss}}`))}render(){return Q`<slot></slot>`}_onColorSchemeChange(){switch(this.colorScheme){case"dark":this._dynamicStylesController.inject("color-scheme",S(`:host { ${ss}}`));break;case"light":this._dynamicStylesController.inject("color-scheme",S(`:host { ${fs}}`));break;case"auto":default:this._dynamicStylesController.inject("color-scheme",S(`:host { ${fs}} @media (prefers-color-scheme: dark) { :host { ${ss} } }`));break}this.dispatchCustomEvent("gds-color-scheme-changed",{detail:{colorScheme:this.colorScheme}})}_onDesignVersionChange(){this.dispatchCustomEvent("gds-design-version-changed",{detail:{designVersion:this.designVersion}})}};P.styles=[q,w`
      :host {
        display: contents;
        color: var(--gds-sys-color-content-neutral-01);
      }
