...
`;var ne=Object.defineProperty,se=Object.getOwnPropertyDescriptor,q=e=>{throw TypeError(e)},o=(e,t,r,i)=>{for(var n=i>1?void 0:i?se(t,r):t,m=e.length-1,x;m>=0;m--)(x=e[m])&&(n=(i?x(t,r,n):x(n))||n);return i&&n&&ne(t,r,n),n},y=(e,t,r)=>t.has(e)||q("Cannot "+r),L=(e,t,r)=>(y(e,t,"read from private field"),r?r.call(e):t.get(e)),S=(e,t,r)=>t.has(e)?q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),ie=(e,t,r,i)=>(y(e,t,"write to private field"),t.set(e,r),r),l=(e,t,r)=>(y(e,t,"access private method"),r),g,a,k,U,w;let s=class extends X{constructor(){super(...arguments),S(this,a),this.showLabel=!1,this.cover=!1,this.fullscreen=!1,this.size="default",this._isAnimating=!1,S(this,g,{overflow:"visible",overscrollBehavior:"auto"})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),l(this,a,k).call(this),this._isAnimating=!0,this.dispatchEvent(new CustomEvent("gds-spinner-shown")),te.instance.apply(this,"gds-spinner")}disconnectedCallback(){this.fullscreen&&l(this,a,w).call(this,!1),this._isAnimating=!1,this.dispatchEvent(new CustomEvent("gds-spinner-hidden")),super.disconnectedCallback()}updated(e){super.updated(e),e.has("label")&&l(this,a,k).call(this),e.has("fullscreen")&&l(this,a,w).call(this,this.fullscreen)}render(){return z`
...
- Light/dark theme support`}}}},h={args:{size:"md",label:"Loading...",showLabel:!0,cover:!1,fullscreen:!1},render:e=>d`
  ...
  `},c={name:"Fullscreen Mode",render:()=>d`
    ...
    `}};var C,T,_;h.parameters={...h.parameters,docs:{...(C=h.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    size: 'md',
    label: 'Loading...',
    showLabel: true,
...
}`,...(P=(N=b.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};const Me=["Playground","Sizes","LabelOptions","Cover","Fullscreen","ThemeModes"];export{f as Cover,c as Fullscreen,v as LabelOptions,h as Playground,u as Sizes,b as ThemeModes,Me as __namedExportsOrder,_e as default};
