...
`)),_2=function _2(t){return t};function pagination_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(pagination_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var pagination_component_GdsPagination=function(_withMarginProps){function GdsPagination(){var _this;return(0,classCallCheck.A)(this,GdsPagination),_this=function pagination_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,pagination_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsPagination,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsPagination_instances),_this.page=1,_this.rows=10,_this.total=0,_this.options=[5,10,25,50],_this.jump=!1,_this._isMobile=!1,_this}return(0,inherits.A)(GdsPagination,_withMarginProps),(0,createClass.A)(GdsPagination,[{key:"_handleMobile",value:function _handleMobile(matches){this._isMobile=matches}},{key:"render",value:function render(){return(0,custom_element_scoping.qy)(pagination_component_t||(pagination_component_t=_2`
      <div class="pages">${0}</div>
      ${0}
    `),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderNavigationControls_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderPageSizeMenu_fn).call(this))}}])}((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.lt)(gds_element.j))));_GdsPagination_instances=new WeakSet,pageCount_get=function pageCount_get(){return Math.ceil(this.total/this.rows)},getVisiblePages_fn=function getVisiblePages_fn(pageCount){if(pageCount<=7)return Array.from({length:pageCount},(function(_,i){return i+1}));var lastPage=pageCount,pages=[];return pages.push(1),this.page<=4?pages.push(2,3,4,5,"...",lastPage):this.page>=pageCount-3?pages.push("...",pageCount-4,pageCount-3,pageCount-2,pageCount-1,lastPage):pages.push("...",this.page-1,this.page,this.page+1,"...",lastPage),pages},renderPageButton_fn=function renderPageButton_fn(page){var _this2=this;if("..."===page)return(0,custom_element_scoping.qy)(pagination_component_t2||(pagination_component_t2=_2`
        <gds-button size="small" rank="tertiary" inert> ... </gds-button>
      `));var pageNum=page,isActive=this.page===pageNum;return(0,custom_element_scoping.qy)(pagination_component_t3||(pagination_component_t3=_2`
      <gds-button
        size="small"
        rank="${0}"
        @click=${0}
    ...
    `),isActive?"primary":"tertiary",(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsPagination_instances,handlePageChange_fn).call(_this2,pageNum)}),pageNum)},renderPageButtons_fn=function renderPageButtons_fn(){var _this3=this,pageCount=(0,chunk_QU3DSPNU.S7)(this,_GdsPagination_instances,pageCount_get),visiblePages=(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,getVisiblePages_fn).call(this,pageCount);return(0,custom_element_scoping.qy)(pagination_component_t4||(pagination_component_t4=_2` ${0} `),visiblePages.map((function(page){return(0,chunk_QU3DSPNU.jq)(_this3,_GdsPagination_instances,renderPageButton_fn).call(_this3,page)})))},renderJumpFirstButton_fn=function renderJumpFirstButton_fn(){var _this4=this;return(0,custom_element_scoping.qy)(pagination_component_t5||(pagination_component_t5=_2`
      <gds-button
        size="small"
        rank="secondary"
        ?disabled=${0}
    ...
    `),1===this.page,(function(){return(0,chunk_QU3DSPNU.jq)(_this4,_GdsPagination_instances,handlePageChange_fn).call(_this4,1)}))},renderPreviousButton_fn=function renderPreviousButton_fn(){var _this5=this;return(0,custom_element_scoping.qy)(pagination_component_t6||(pagination_component_t6=_2`
      <gds-button
        size="small"
        rank="secondary"
        ?disabled=${0}
    ...
    `),1===this.page,(function(){return(0,chunk_QU3DSPNU.jq)(_this5,_GdsPagination_instances,handlePageChange_fn).call(_this5,_this5.page-1)}))},renderNextButton_fn=function renderNextButton_fn(){var _this6=this,pageCount=(0,chunk_QU3DSPNU.S7)(this,_GdsPagination_instances,pageCount_get);return(0,custom_element_scoping.qy)(pagination_component_t7||(pagination_component_t7=_2`
      <gds-button
        size="small"
        rank="secondary"
        ?disabled=${0}
    ...
    `),this.page===pageCount,(function(){return(0,chunk_QU3DSPNU.jq)(_this6,_GdsPagination_instances,handlePageChange_fn).call(_this6,_this6.page+1)}))},renderJumpLastButton_fn=function renderJumpLastButton_fn(){var _this7=this,pageCount=(0,chunk_QU3DSPNU.S7)(this,_GdsPagination_instances,pageCount_get);return(0,custom_element_scoping.qy)(pagination_component_t8||(pagination_component_t8=_2`
      <gds-button
        size="small"
        rank="secondary"
        ?disabled=${0}
    ...
    `),this.page===pageCount,(function(){return(0,chunk_QU3DSPNU.jq)(_this7,_GdsPagination_instances,handlePageChange_fn).call(_this7,pageCount)}))},renderNavigationControls_fn=function renderNavigationControls_fn(){var _this8=this;return(0,custom_element_scoping.qy)(_t9||(_t9=_2`
      ${0}
      ${0} ${0}
      ${0}
      ${0}
    `),(0,when.z)(this.jump,(function(){return(0,chunk_QU3DSPNU.jq)(_this8,_GdsPagination_instances,renderJumpFirstButton_fn).call(_this8)})),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderPreviousButton_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderPageButtons_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderNextButton_fn).call(this),(0,when.z)(this.jump,(function(){return(0,chunk_QU3DSPNU.jq)(_this8,_GdsPagination_instances,renderJumpLastButton_fn).call(_this8)})))},renderPageSizeOption_fn=function renderPageSizeOption_fn(size){var isSelected=this.rows===size;return(0,custom_element_scoping.qy)(_t10||(_t10=_2`
      <gds-menu-item
        data-value=${0}
        class=${0}
      >
    ...
    `),size,(0,class_map.H)({selected:isSelected}),size)},renderPageSizeMenu_fn=function renderPageSizeMenu_fn(){var _this9=this;return this._isMobile?null:(0,custom_element_scoping.qy)(_t11||(_t11=_2`
      <gds-context-menu @gds-menu-item-click=${0}>
    ...
    `),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,handlePageSizeMenuClick_fn),this.rows,this.options.map((function(size){return(0,chunk_QU3DSPNU.jq)(_this9,_GdsPagination_instances,renderPageSizeOption_fn).call(_this9,size)})))},handlePageChange_fn=function handlePageChange_fn(newPage){this.dispatchEvent(new CustomEvent("gds-page-change",{detail:{page:newPage},bubbles:!0}))},handlePageSizeMenuClick_fn=function handlePageSizeMenuClick_fn(e){var item=e.target,limit=parseInt(item.dataset.value||"10");limit!==this.rows&&this.dispatchEvent(new CustomEvent("gds-rows-change",{detail:{rows:limit},bubbles:!0}))},pagination_component_GdsPagination.styles=[tokens_style.LU,PaginationStyles],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],pagination_component_GdsPagination.prototype,"page",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],pagination_component_GdsPagination.prototype,"rows",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],pagination_component_GdsPagination.prototype,"total",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],pagination_component_GdsPagination.prototype,"options",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],pagination_component_GdsPagination.prototype,"jump",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],pagination_component_GdsPagination.prototype,"_isMobile",2),(0,chunk_QU3DSPNU.Cc)([(0,watch_media_query.M)("(max-width: 768px)")],pagination_component_GdsPagination.prototype,"_handleMobile",1),pagination_component_GdsPagination=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-pagination",{dependsOn:[button_component.t,text_component_GdsText,dropdown_component.E,context_menu_component.Hx,menu_item_component.T,chevron_bottom_component.o,chevron_left_small_component.V,chevron_double_left_component.P,chevron_right_small_component.U,chevron_double_right_component.C]})],pagination_component_GdsPagination);var GdsPagination=function GdsPagination(props){pagination_component_GdsPagination.define();var JSXElement=(0,react.p)("gds-pagination"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsPagination.__docgenInfo={description:"",methods:[],displayName:"GdsPagination"};var backdrop_component_t,backdrop_component_t2,backdrop_component_=function _(t){return t};function backdrop_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(backdrop_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var backdrop_component_GdsBackdrop=function(_GdsElement){function GdsBackdrop(){var _this;return(0,classCallCheck.A)(this,GdsBackdrop),_this=function backdrop_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,backdrop_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsBackdrop,arguments),_this.show=!1,_this}return(0,inherits.A)(GdsBackdrop,_GdsElement),(0,createClass.A)(GdsBackdrop,[{key:"render",value:function render(){return(0,custom_element_scoping.qy)(backdrop_component_t||(backdrop_component_t=backdrop_component_``))}}])}(gds_element.j);backdrop_component_GdsBackdrop.styles=(0,lit.AH)(backdrop_component_t2||(backdrop_component_t2=backdrop_component_`
    :host {
      display: none;
      position: fixed;
      inset: 0;
...
`)),accountsFormats={"seb-account":function sebAccount(value){var _value$toString,account="string"==typeof value?value.replace(" ",""):null!=(_value$toString=null==value?void 0:value.toString())?_value$toString:"";return 11!==account.length?account:"".concat(account.slice(0,4)," ").concat(account.slice(4,6)," ").concat(account.slice(6,9)," ").concat(account.slice(9,11))}},convertValueToDate=function convertValueToDate(value){return"string"==typeof value?new Date(value):value},dateTimeFormats={dateOnlyNumbers:function dateOnlyNumbers(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"short"}).format(convertValueToDate(value))},dateLong:function dateLong(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"long"}).format(convertValueToDate(value))},dateLongWithWeekday:function dateLongWithWeekday(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"full"}).format(convertValueToDate(value))},dateShort:function dateShort(value,locale){var formatter=new Intl.DateTimeFormat(locale,{dateStyle:"medium"});return"sv-se"===(null==locale?void 0:locale.toLowerCase())?formatter.format(convertValueToDate(value)).replace(".",""):formatter.format(convertValueToDate(value))},dateShortWithWeekday:function dateShortWithWeekday(value,locale){var formatted=new Intl.DateTimeFormat(locale,{weekday:"short",year:"numeric",month:"short",day:"numeric"}).format(convertValueToDate(value));return"sv-se"===(null==locale?void 0:locale.toLowerCase())?formatted.replace(".",""):"en-gb"===(null==locale?void 0:locale.toLowerCase())?formatted.replace(",",""):formatted},timeShort:function timeShort(value,locale){return new Intl.DateTimeFormat(locale,{timeStyle:"short"}).format(convertValueToDate(value))},timeLong:function timeLong(value,locale){return new Intl.DateTimeFormat(locale,{timeStyle:"medium"}).format(convertValueToDate(value))},dateTimeLong:function dateTimeLong(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"long",timeStyle:"short"}).format(convertValueToDate(value))},dateTimeLongWithWeekday:function dateTimeLongWithWeekday(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"full",timeStyle:"short"}).format(convertValueToDate(value))},dateTimeShort:function dateTimeShort(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"medium",timeStyle:"short"}).format(convertValueToDate(value))}},numberFormats={decimalsAndThousands:function decimalsAndThousands(value,locale,currency){var options={maximumFractionDigits:2,minimumFractionDigits:2};return currency?new Intl.NumberFormat(locale,Object.assign({},options,{style:"currency",currency})).format(Number(value)):new Intl.NumberFormat(locale,options).format(Number(value))}},Styles=[tokens_style.LU,rbcb_toggle_style.A,TableStyles],Dependencies=[button_component.t,card_component.z,img_component_GdsImg,context_menu_component.Hx,menu_item_component.T,dropdown_component.E,input_component_GdsInput,pagination_component_GdsPagination,text_component_GdsText,badge_component.K,link_component_GdsLink,flex_component.o,copy_component.b,cross_small_component.r,minus_small_component.Z,magnifying_glass_component.l,sort_component.C,sort_down_component.W,sort_up_component.n,dot_grid_one_horizontal_component.z],table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),(0,chunk_QU3DSPNU.VK)(_this,_templateCache,new Map),_this.options=[5,10,20,50,100],_this.page=1,_this.rows=10,_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.searchable=!1,_this.settings=!1,_this.striped=!1,_this.nocache=!1,_this._isMobile=!1,_this.view={page:_this.page,rows:_this.rows,searchQuery:"",visibleColumns:new Set},_this.loaded=!0,_this.loading=!1,_this.rowsState=[],_this.total=0,_this.selected=new Set,_this.error=null,_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"_handleMobile",value:function _handleMobile(matches){this._isMobile=matches}},{key:"_onDataRenderKeyChange",value:function _onDataRenderKeyChange(){console.log("Data render key changed, reloading data..."),(0,chunk_QU3DSPNU.OV)(this,_cache,{}),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this)}},{key:"_onColumnsChange",value:function _onColumnsChange(){var _this$page,_this$rows;(0,chunk_QU3DSPNU.OV)(this,_cache,{}),this.view=Object.assign({},this.view,{page:Number(null!=(_this$page=this.page)?_this$page:1),rows:Number(null!=(_this$rows=this.rows)?_this$rows:10),visibleColumns:new Set(this.columns.map((function(col){return col.key})))})}},{key:"render",value:function render(){var _this2=this,classes=(0,defineProperty.A)({table:!0,plain:this.plain,striped:this.striped},this.density,this.density);return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
      <div class="${0}">
        ${0}
        ${0}
        ${0}
      </div>
    `),(0,class_map.H)(classes),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderHeaderControls_fn).call(this),(0,when.z)(this.error,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderErrorState_fn).call(_this2)}),(function(){return(0,when.z)(0===_this2.rowsState.length&&!_this2.loading,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderEmptyState_fn).call(_this2)}),(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderTable_fn).call(_this2)}))})),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderFooter_fn).call(this))}},{key:"clearSelection",value:function clearSelection(){(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,clearSelectionInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)}},{key:"selectAll",value:function selectAll(){(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,selectAllInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)}},{key:"setSelection",value:function setSelection(indices){var _this3=this,validIndices=indices.filter((function(i){return i>=0&&i<_this3.rowsState.length}));this.selected=new Set(validIndices),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this),this.requestUpdate()}},{key:"getSelection",value:function getSelection(){var _this4=this,indices=Array.from(this.selected);return{indices,data:indices.map((function(i){return _this4.rowsState[i]}))}}}])}(gds_element.j);_cache=new WeakMap,_cacheDuration=new WeakMap,_templateCache=new WeakMap,_GdsTable_instances=new WeakSet,hasSelection_get=function hasSelection_get(){return this.selected.size>0},isAllSelected_get=function isAllSelected_get(){return this.rowsState.length>0&&this.selected.size===this.rowsState.length},isPartialSelection_get=function isPartialSelection_get(){return(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get)&&!(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get)},getCacheKey_fn=function getCacheKey_fn(){return JSON.stringify({page:this.view.page,rows:this.view.rows,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery})},isCacheValid_fn=function isCacheValid_fn(entry){return Date.now()-entry.timestamp<(0,chunk_QU3DSPNU.S7)(this,_cacheDuration)},loadData_fn=function(){var _ref=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){var cacheKey,cachedData,response,_cacheKey;return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:if(this.data){_context.next=2;break}return _context.abrupt("return");case 2:if(this.nocache){_context.next=10;break}if(cacheKey=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,getCacheKey_fn).call(this),!(cachedData=(0,chunk_QU3DSPNU.S7)(this,_cache)[cacheKey])||!(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,isCacheValid_fn).call(this,cachedData)){_context.next=10;break}return this.rowsState=cachedData.rows,this.total=cachedData.total,this.loaded=!1,_context.abrupt("return");case 10:return this.loading=!0,this.error=null,_context.prev=12,_context.next=15,this.data({page:this.view.page,rows:this.view.rows,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery});case 15:response=_context.sent,this.nocache||(_cacheKey=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,getCacheKey_fn).call(this),(0,chunk_QU3DSPNU.S7)(this,_cache)[_cacheKey]={rows:response.rows,total:response.total,timestamp:Date.now()}),this.rowsState=response.rows,this.total=response.total,this.selected.clear(),this.loaded=!1,this.dispatchEvent(new CustomEvent("gds-table-data-loaded",{detail:response,bubbles:!0})),_context.next=28;break;case 24:_context.prev=24,_context.t0=_context.catch(12),this.error=_context.t0,this.dispatchEvent(new CustomEvent("gds-table-data-error",{detail:_context.t0,bubbles:!0}));case 28:return _context.prev=28,this.loading=!1,_context.finish(28);case 31:case"end":return _context.stop()}}),_callee,this,[[12,24,28,31]])})));return function loadData_fn(){return _ref.apply(this,arguments)}}(),getSlotContent_fn=function getSlotContent_fn(slot){var _privateGet$get;if(!slot)return null;if(!(0,chunk_QU3DSPNU.S7)(this,_templateCache).has(slot)){var template=this.querySelector('template[name="'.concat(slot,'"]'));(0,chunk_QU3DSPNU.S7)(this,_templateCache).set(slot,template)}return null==(_privateGet$get=(0,chunk_QU3DSPNU.S7)(this,_templateCache).get(slot))?void 0:_privateGet$get.content.cloneNode(!0)},_renderCell_fn=function renderCell_fn(config,row){var _this5=this;if(!config)return null;if(Array.isArray(config))return config.map((function(c){return(0,chunk_QU3DSPNU.jq)(_this5,_GdsTable_instances,_renderCell_fn).call(_this5,c,row)}));var resolve=function resolve(value){return"function"==typeof value?value(row):value};switch(config.type){case"badge":var variant=resolve(config.variant)||"information",size=resolve(config.size)||"small";return(0,custom_element_scoping.qy)(table_component_t2||(table_component_t2=table_component_2`
          <gds-badge size="${0}" variant="${0}">
            ${0}
          </gds-badge>
        `),size,variant,resolve(config.value));case"image":var src=resolve(config.src);if(!src)return null;var width=resolve(config.width)||"24px",height=resolve(config.height)||"24px",borderRadius=resolve(config["border-radius"])||"max",objectFit=resolve(config["object-fit"])||"cover",alt=resolve(config.alt)||"";return(0,custom_element_scoping.qy)(table_component_t3||(table_component_t3=table_component_2`
          <gds-img
            src="${0}"
            alt="${0}"
            width="${0}"
          ...
          ></gds-img>
        `),src,alt,width,height,borderRadius,objectFit);case"button":var _size=resolve(config.size),_variant=resolve(config.variant),rank=resolve(config.rank),label=resolve(config.label),template=resolve(config.template),content=[label,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,getSlotContent_fn).call(this,template)];return(0,custom_element_scoping.qy)(table_component_t4||(table_component_t4=table_component_2`
          <gds-button
            size="${0}"
            variant="${0}"
            rank="${0}"
        ...
        `),_size||"small",_variant||"neutral",rank||"secondary",(function(e){e.stopPropagation(),config.onClick(row)}),content);case"link":var href=resolve(config.href);if(!href)return null;var _label=resolve(config.label),target=resolve(config.target),download=resolve(config.download),_template=resolve(config.template),_content=[_label,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,getSlotContent_fn).call(this,_template)];return(0,custom_element_scoping.qy)(table_component_t5||(table_component_t5=table_component_2`
          <gds-link
            href=${0}
            target=${0}
            .download=${0}
        ...
        `),(0,if_defined.J)(href),(0,if_defined.J)(target),download,_content);case"context-menu":var items=config.items;return(0,custom_element_scoping.qy)(table_component_t6||(table_component_t6=table_component_2`
          <gds-context-menu>
        ...
        `),items.map((function(item){var label=resolve(item.label);return(0,custom_element_scoping.qy)(table_component_t7||(table_component_t7=table_component_2`
                <gds-menu-item @click="${0}">
                  ${0}
                </gds-menu-item>
              `),(function(){return item.onClick(row)}),label)})));case"formatted-number":var value=resolve(config.value);return(0,numberFormats[config.format||"decimalsAndThousands"])(value,config.locale,config.currency);case"formatted-account":var _value=resolve(config.value);return(0,accountsFormats[config.format||"seb-account"])(_value);case"formatted-date":var _value2=resolve(config.value);return(0,dateTimeFormats[config.format||"dateLong"])(_value2,config.locale);default:return null}},renderCellContent_fn=function renderCellContent_fn(row,column){var _privateMethod$call,cell=column.cell,value=null!=(_privateMethod$call=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,_renderCell_fn).call(this,null==cell?void 0:cell.value,row))?_privateMethod$call:row[column.key],processedValue=column.justify?(0,custom_element_scoping.qy)(table_component_t8||(table_component_t8=table_component_2`<span>${0}</span>`),value):value,isResponsive=this._isMobile&&this.responsive,mobileLabel=isResponsive?(0,custom_element_scoping.qy)(table_component_t9||(table_component_t9=table_component_2`<span class="column-label" aria-hidden="true"
          >${0}:</span
        >`),column.label):null,ariaLabel=isResponsive?"".concat(column.label,": "):"";return(0,custom_element_scoping.qy)(table_component_t10||(table_component_t10=table_component_2`
      <div class="cell-content" aria-label="${0}">
        ${0}
      </div>
    `),ariaLabel,[mobileLabel,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,_renderCell_fn).call(this,null==cell?void 0:cell.lead,row),processedValue,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,_renderCell_fn).call(this,null==cell?void 0:cell.trail,row)])},renderSortIcon_fn=function renderSortIcon_fn(column){var isSorted=this.view.sortColumn===column.key,sortDirection=this.view.sortDirection;return isSorted?"asc"===sortDirection?(0,custom_element_scoping.qy)(table_component_t11||(table_component_t11=table_component_2`<gds-icon-sort-up size="m"></gds-icon-sort-up>`)):(0,custom_element_scoping.qy)(_t12||(_t12=table_component_2`<gds-icon-sort-down size="m"></gds-icon-sort-down>`)):(0,custom_element_scoping.qy)(_t13||(_t13=table_component_2`<gds-icon-sort-up size="m"></gds-icon-sort-up>`))},hasHeaderContent_fn=function hasHeaderContent_fn(){return this.searchable||this.settings||this.querySelector('[slot="header-lead"]')||this.querySelector('[slot="header-trail"]')},renderHeaderControls_fn=function renderHeaderControls_fn(){var _this6=this;return this.plain||!(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,hasHeaderContent_fn).call(this)?null:(0,custom_element_scoping.qy)(_t14||(_t14=table_component_2`
      <div class="header">
        <div class="lead">
          ${0}
    ...
    `),(0,when.z)(this.searchable,(function(){return(0,custom_element_scoping.qy)(_t15||(_t15=table_component_2`
              <gds-input
                type="text"
                size="small"
                plain
            ...
            `),_this6.view.searchQuery,(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleSearch_fn),(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleSearchClear_fn))})),(0,when.z)(this.settings,(function(){return(0,custom_element_scoping.qy)(_t16||(_t16=table_component_2`
              <gds-dropdown
                multiple
                plain
                size="small"
            ...
            `),Array.from(_this6.view.visibleColumns),(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleColumnVisibility_fn),_this6.columns.map((function(column){return(0,custom_element_scoping.qy)(_t17||(_t17=table_component_2`
                    <gds-option
                      value=${0}
                      ?selected=${0}
                    >
                  ...
                  `),column.key,_this6.view.visibleColumns.has(column.key),column.label)})))})))},renderColumnHeader_fn=function renderColumnHeader_fn(column){var _this7=this,isSorted=this.view.sortColumn===column.key,sortDirection=this.view.sortDirection,classes=(0,class_map.H)((0,defineProperty.A)((0,defineProperty.A)({sortable:!!column.sortable,sorted:isSorted,"sort-asc":isSorted&&"asc"===sortDirection,"sort-desc":isSorted&&"desc"===sortDirection},"align-".concat(column.align),!!column.align),"justify-".concat(column.justify),!!column.justify));return(0,custom_element_scoping.qy)(_t18||(_t18=table_component_2`
      <th
        class=${0}
        @click=${0}
      >
        <div class="column-header">
          <span class="column-label">${0}</span>
          ${0}
        </div>
      </th>
    `),classes,column.sortable?function(){return(0,chunk_QU3DSPNU.jq)(_this7,_GdsTable_instances,handleSort_fn).call(_this7,column.key)}:null,column.label,(0,when.z)(column.sortable,(function(){return(0,custom_element_scoping.qy)(_t19||(_t19=table_component_2`
              <span class="sort-icon">${0}</span>
            `),(0,chunk_QU3DSPNU.jq)(_this7,_GdsTable_instances,renderSortIcon_fn).call(_this7,column))})))},renderActionsHeader_fn=function renderActionsHeader_fn(){if(!this.actions||"function"==typeof this.actions)return null;var label=this.actions.label||"Actions",classes=(0,class_map.H)((0,defineProperty.A)((0,defineProperty.A)({actions:!0},"align-".concat(this.actions.align),!!this.actions.align),"justify-".concat(this.actions.justify),!!this.actions.justify));return(0,custom_element_scoping.qy)(_t20||(_t20=table_component_2`
      <th class="${0}">
        <div class="column-header">
          <div class="column-label">${0}</div>
        </div>
      </th>
    `),classes,label)},renderSelectableHeader_fn=function renderSelectableHeader_fn(){var _this8=this;return this.selectable?(0,custom_element_scoping.qy)(_t21||(_t21=table_component_2`
      <th class="checkbox-cell">
        ${0}
      </th>
    `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCheckbox_fn).call(this,{checked:(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get),indeterminate:(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isPartialSelection_get),ariaLabel:"Select all rows",onToggle:function onToggle(){return(0,chunk_QU3DSPNU.jq)(_this8,_GdsTable_instances,handleSelectAll_fn).call(_this8,{})}})):null},renderColumnHeaders_fn=function renderColumnHeaders_fn(){var _this9=this;return this.columns.filter((function(column){return _this9.view.visibleColumns.has(column.key)})).map((function(column){return(0,chunk_QU3DSPNU.jq)(_this9,_GdsTable_instances,renderColumnHeader_fn).call(_this9,column)}))},renderTableHeader_fn=function renderTableHeader_fn(){return(0,custom_element_scoping.qy)(_t22||(_t22=table_component_2`
      <thead>
        <tr>
          ${0}
        </tr>
      </thead>
    `),[(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderSelectableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderColumnHeaders_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderActionsHeader_fn).call(this)])},renderTableCell_fn=function renderTableCell_fn(row,column){var classes=(0,class_map.H)((0,defineProperty.A)((0,defineProperty.A)((0,defineProperty.A)({},"align-".concat(column.align),!!column.align),"justify-".concat(column.justify),!!column.justify),"wrap",Boolean(column.width))),style=o({"--cell-width":column.width});return(0,custom_element_scoping.qy)(_t23||(_t23=table_component_2`
      <td style=${0} class=${0}>
        ${0}
      </td>
    `),style,classes,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCellContent_fn).call(this,row,column))},renderSelectableCell_fn=function renderSelectableCell_fn(index){var _this10=this;return this.selectable?(0,custom_element_scoping.qy)(_t24||(_t24=table_component_2`
      <td class="checkbox-cell" data-label="Select">
        ${0}
      </td>
    `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCheckbox_fn).call(this,{checked:this.selected.has(index),indeterminate:!1,ariaLabel:"Select row ".concat(index+1),onToggle:function onToggle(){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,handleRowSelect_fn).call(_this10,index,{detail:{checked:!_this10.selected.has(index)}})}})):null},renderRowCells_fn=function renderRowCells_fn(row){var _this11=this;return this.columns.filter((function(column){return _this11.view.visibleColumns.has(column.key)})).map((function(column){return(0,chunk_QU3DSPNU.jq)(_this11,_GdsTable_instances,renderTableCell_fn).call(_this11,row,column)}))},renderActionsCell_fn=function renderActionsCell_fn(row,index){if(!this.actions)return null;if("function"==typeof this.actions)return(0,custom_element_scoping.qy)(_t25||(_t25=table_component_2`
        <td class="actions-cell" data-label="Actions">
          <div class="cell-content">${0}</div>
        </td>
      `),this.actions(row,index));var content=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,_renderCell_fn).call(this,this.actions.cell,row),classes=(0,class_map.H)((0,defineProperty.A)((0,defineProperty.A)({"actions-cell":!0},"align-".concat(this.actions.align),!!this.actions.align),"justify-".concat(this.actions.justify),!!this.actions.justify));return(0,custom_element_scoping.qy)(_t26||(_t26=table_component_2`
      <td class="${0}" data-label="Actions">
        <div class="cell-content">${0}</div>
      </td>
    `),classes,content)},renderTableRow_fn=function renderTableRow_fn(row,index){return(0,custom_element_scoping.qy)(_t27||(_t27=table_component_2`
      <tr
        class=${0}
      >
        ${0}
      </tr>
    `),(0,class_map.H)({selected:this.selected.has(index),loading:this.loading}),[(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderSelectableCell_fn).call(this,index),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderRowCells_fn).call(this,row),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderActionsCell_fn).call(this,row,index)])},renderCheckbox_fn=function renderCheckbox_fn(_ref2){var checked=_ref2.checked,_ref2$indeterminate=_ref2.indeterminate,indeterminate=void 0!==_ref2$indeterminate&&_ref2$indeterminate,_ref2$disabled=_ref2.disabled,disabled=void 0!==_ref2$disabled&&_ref2$disabled,ariaLabel=_ref2.ariaLabel,onToggle=_ref2.onToggle,toggle=function toggle(e){e.stopPropagation(),disabled||onToggle()};return(0,custom_element_scoping.qy)(_t28||(_t28=table_component_2`
      <div
        class="rbcb-wrapper"
        role="checkbox"
        aria-checked=${0}
    ...
    `),indeterminate?"mixed":checked?"true":"false",ariaLabel,toggle,(function onKey(e){" "!==e.key&&"Enter"!==e.key||(e.preventDefault(),toggle(e))}),checked,indeterminate,disabled,toggle,rbcb_toggle_template.o({checked,indeterminate,disabled,invalid:!1}))},renderSkeletonCell_fn=function renderSkeletonCell_fn(){return(0,custom_element_scoping.qy)(_t29||(_t29=table_component_2`
      <div class="cell-content">
        <span class="skeleton skeleton-text"></span>
      </div>
    `))},renderSkeletonRow_fn=function renderSkeletonRow_fn(index){var _this12=this;return(0,custom_element_scoping.qy)(_t30||(_t30=table_component_2`
      <tr class="skeleton-row">
        ${0}
        ${0}
        ${0}
      </tr>
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t31||(_t31=table_component_2`
            <td class="checkbox-cell">
              <span class="skeleton skeleton-checkbox"></span>
            </td>
          `))})),this.columns.filter((function(column){return _this12.view.visibleColumns.has(column.key)})).map((function(){return(0,custom_element_scoping.qy)(_t32||(_t32=table_component_2` <td>${0}</td> `),(0,chunk_QU3DSPNU.jq)(_this12,_GdsTable_instances,renderSkeletonCell_fn).call(_this12))})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t33||(_t33=table_component_2`
            <td class="actions-cell">
              <div class="cell-content">
                <span class="skeleton skeleton-action"></span>
              </div>
            </td>
          `))})))},renderTableBody_fn=function renderTableBody_fn(){var _this13=this;if(this.loading&&this.loaded){var skeletonRows=Array.from({length:this.view.rows},(function(_,i){return(0,chunk_QU3DSPNU.jq)(_this13,_GdsTable_instances,renderSkeletonRow_fn).call(_this13,i)}));return(0,custom_element_scoping.qy)(_t34||(_t34=table_component_2`<tbody>
        ${0}
      </tbody>`),skeletonRows)}return(0,custom_element_scoping.qy)(_t35||(_t35=table_component_2`
      <tbody>
        ${0}
      </tbody>
    `),this.rowsState.map((function(row,index){return(0,chunk_QU3DSPNU.jq)(_this13,_GdsTable_instances,renderTableRow_fn).call(_this13,row,index)})))},renderTable_fn=function renderTable_fn(){var CLASSES=(0,class_map.H)({responsive:this.responsive,data:!0});return(0,custom_element_scoping.qy)(_t36||(_t36=table_component_2`
      <div class=${0}>
        <table>
          ${0} ${0}
        </table>
      </div>
    `),CLASSES,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableBody_fn).call(this))},renderErrorState_fn=function renderErrorState_fn(){var _this14=this;return(0,custom_element_scoping.qy)(_t37||(_t37=table_component_2`
      <gds-card justify-content="center" align-items="flex-start">
        <gds-text tag="p">Error loading data</gds-text>
        <gds-button size="small" @click=${0}>
          Retry
        </gds-button>
      </gds-card>
    `),(function(){return(0,chunk_QU3DSPNU.jq)(_this14,_GdsTable_instances,loadData_fn).call(_this14)}))},renderEmptyState_fn=function renderEmptyState_fn(){var hasSearch=this.view.searchQuery.length>0;return(0,custom_element_scoping.qy)(_t38||(_t38=table_component_2`
    ...
    `),hasSearch?"No results found":"No data available",hasSearch?(0,custom_element_scoping.qy)(_t39||(_t39=table_component_2`
                <gds-text tag="p" font="detail-book-s">
                  No results for "${0}"
                </gds-text>
              `),this.view.searchQuery):"",hasSearch?(0,custom_element_scoping.qy)(_t40||(_t40=table_component_2`
              <gds-button size="small" @click=${0}>
                Clear search
              </gds-button>
            `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn)):"")},renderFooter_fn=function renderFooter_fn(){var _this15=this;return this.plain||this.total<1?null:(0,custom_element_scoping.qy)(_t41||(_t41=table_component_2`
      <div class="footer">
        <div class="lead">
    ...
    `),(0,when.z)(this.selectable&&(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get),(function(){return(0,custom_element_scoping.qy)(_t42||(_t42=table_component_2`
              ...
              `),_this15.selected.size,_this15.rowsState.length,_this15.clearSelection)}),(function(){return(0,custom_element_scoping.qy)(_t43||(_t43=table_component_2`
                <span>
                  Showing ${0} to
                  ${0} of
                  ${0} entries
                </span>
              `),(_this15.view.page-1)*_this15.view.rows+1,Math.min(_this15.view.page*_this15.view.rows,_this15.total),_this15.total)})),this.view.page,this.view.rows,this.options,this.total,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,table_component_handlePageChange_fn),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handlePageSizeChange_fn))},handleSearch_fn=function(){var _ref3=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee2(e){var input;return regenerator_default().wrap((function _callee2$(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:return input=e.target,this.view=Object.assign({},this.view,{searchQuery:input.value,page:1}),_context2.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context2.stop()}}),_callee2,this)})));return function handleSearch_fn(_x){return _ref3.apply(this,arguments)}}(),handleSearchClear_fn=function(){var _ref4=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee3(){return regenerator_default().wrap((function _callee3$(_context3){for(;;)switch(_context3.prev=_context3.next){case 0:return this.view=Object.assign({},this.view,{searchQuery:"",page:1}),_context3.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context3.stop()}}),_callee3,this)})));return function handleSearchClear_fn(){return _ref4.apply(this,arguments)}}(),handleSort_fn=function(){var _ref5=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee4(columnKey){return regenerator_default().wrap((function _callee4$(_context4){for(;;)switch(_context4.prev=_context4.next){case 0:return this.view=Object.assign({},this.view,{sortColumn:columnKey,sortDirection:this.view.sortColumn===columnKey&&"asc"===this.view.sortDirection?"desc":"asc",page:1}),_context4.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context4.stop()}}),_callee4,this)})));return function handleSort_fn(_x2){return _ref5.apply(this,arguments)}}(),table_component_handlePageChange_fn=function(){var _ref6=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee5(e){return regenerator_default().wrap((function _callee5$(_context5){for(;;)switch(_context5.prev=_context5.next){case 0:return this.view=Object.assign({},this.view,{page:e.detail.page}),_context5.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context5.stop()}}),_callee5,this)})));return function handlePageChange_fn(_x3){return _ref6.apply(this,arguments)}}(),handlePageSizeChange_fn=function(){var _ref7=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee6(e){return regenerator_default().wrap((function _callee6$(_context6){for(;;)switch(_context6.prev=_context6.next){case 0:return this.view=Object.assign({},this.view,{rows:e.detail.rows,page:1}),_context6.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context6.stop()}}),_callee6,this)})));return function handlePageSizeChange_fn(_x4){return _ref7.apply(this,arguments)}}(),handleColumnVisibility_fn=function handleColumnVisibility_fn(e){var selectedColumns=e.detail.value;this.view=Object.assign({},this.view,{visibleColumns:new Set(selectedColumns)}),this.requestUpdate()},handleSelectAll_fn=function handleSelectAll_fn(e){(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get)?(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,clearSelectionInternal_fn).call(this):(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,selectAllInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)},handleRowSelect_fn=function handleRowSelect_fn(index,e){e.detail.checked?this.selected.add(index):this.selected.delete(index),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this),this.requestUpdate()},selectAllInternal_fn=function selectAllInternal_fn(){this.selected=new Set(this.rowsState.map((function(_,i){return i}))),this.requestUpdate()},clearSelectionInternal_fn=function clearSelectionInternal_fn(){this.selected.clear(),this.requestUpdate()},emitSelectionChange_fn=function emitSelectionChange_fn(){var _this16=this;this.dispatchEvent(new CustomEvent("gds-table-selection",{detail:{selectedIndices:Array.from(this.selected),selectedData:Array.from(this.selected).map((function(i){return _this16.rowsState[i]})),count:this.selected.size},bubbles:!0}))},table_component_GdsTable.styles=Styles,(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],table_component_GdsTable.prototype,"options",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],table_component_GdsTable.prototype,"page",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],table_component_GdsTable.prototype,"rows",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],table_component_GdsTable.prototype,"columns",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"data",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],table_component_GdsTable.prototype,"density",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"selectable",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"responsive",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"plain",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"searchable",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"settings",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"striped",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"actions",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"nocache",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"dataLoadKey",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"_isMobile",2),(0,chunk_QU3DSPNU.Cc)([(0,watch_media_query.M)("(max-width: 768px)")],table_component_GdsTable.prototype,"_handleMobile",1),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"view",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"loaded",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"loading",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"rowsState",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"total",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"selected",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"error",2),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("dataRenderKey"),(0,watch.w)("data")],table_component_GdsTable.prototype,"_onDataRenderKeyChange",1),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("columns")],table_component_GdsTable.prototype,"_onColumnsChange",1),table_component_GdsTable=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-table",{dependsOn:Dependencies})],table_component_GdsTable);var GdsTable=function GdsTable(props){table_component_GdsTable.define();var JSXElement=(0,react.p)("gds-table"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsTable.__docgenInfo={description:"",methods:[],displayName:"GdsTable"};var GdsText=function GdsText(props){text_component_GdsText.define();var JSXElement=(0,react.p)("gds-text"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsText.__docgenInfo={description:"",methods:[],displayName:"GdsText"};var GdsTextarea=function GdsTextarea(props){textarea_component_GdsTextarea.define();var JSXElement=(0,react.p)("gds-textarea"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsTextarea.__docgenInfo={description:"",methods:[],displayName:"GdsTextarea"};var video_styles_t,video_component_t,theme=__webpack_require__("./dist/libs/core/src/generated/react/theme/index.js"),video_styles_default=(0,lit.AH)(video_styles_t||(video_styles_t=(function _(t){return t})`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`)),card_pattern_01_component_=function _(t){return t};function card_pattern_01_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_pattern_01_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_pattern_01_component_GdsCardPattern01=function(_withSizeXProps){function GdsCardPattern01(){var _this;return(0,classCallCheck.A)(this,GdsCardPattern01),_this=function card_pattern_01_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_pattern_01_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardPattern01,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardPattern01_instances),_this.title="",_this.excerpt="",_this.label="",_this.variant="neutral-01",_this.outlined=!1,_this.tag="h2",_this.ratio="landscape",_this.category="",_this.date="",_this.dateFormat="dateTimeLong",_this.locale="en-GB",_this}return(0,inherits.A)(GdsCardPattern01,_withSizeXProps),(0,createClass.A)(GdsCardPattern01,[{key:"render",value:function render(){var _this2=this;return(0,when.z)(this.href,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsCardPattern01_instances,renderLinkedCard_fn).call(_this2)}),(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsCardPattern01_instances,renderStaticCard_fn).call(_this2)}))}}])}((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(withLinkProps(withImageProps(gds_element.j))))));_GdsCardPattern01_instances=new WeakSet,hasFooterContent_fn=function hasFooterContent_fn(){return arguments.length>0&&void 0!==arguments[0]&&arguments[0]&&this.label||this.querySelector('[slot="footer"]')},getVariant_fn=function getVariant_fn(){return"neutral-02"===this.variant?this.outlined?"secondary":"tertiary":"primary"},getClasses_fn=function getClasses_fn(type){return(0,class_map.H)((0,defineProperty.A)((0,defineProperty.A)((0,defineProperty.A)({card:!0,outlined:this.outlined},"card-".concat(type),!!type),"variant-".concat(this.variant),!0),"ratio-".concat(this.ratio),!0))},renderLinkedCard_fn=function renderLinkedCard_fn(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t||(card_pattern_01_component_t=card_pattern_01_component_`
    ...
    `),(0,if_defined.J)(this.href),(0,if_defined.J)(this.target),(0,if_defined.J)(this.rel),(0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,getVariant_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,getClasses_fn).call(this,"linked"),(0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,renderCardContent_fn).call(this))},renderLinkedFooter_fn=function renderLinkedFooter_fn(){var _this3=this;return(0,when.z)((0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,hasFooterContent_fn).call(this,!0),(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t2||(card_pattern_01_component_t2=card_pattern_01_component_`
        <gds-flex
          font="detail-book-m"
          align-items="center"
          gap="s"
      ...
      `),(0,when.z)(_this3.label,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t3||(card_pattern_01_component_t3=card_pattern_01_component_`
                <gds-link href=${0}>
                  <gds-icon-chain-link slot="lead"></gds-icon-chain-link>
                  ${0}
                </gds-link>
              `),(0,if_defined.J)(_this3.href),_this3.label)})))}))},renderStaticCard_fn=function renderStaticCard_fn(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t4||(card_pattern_01_component_t4=card_pattern_01_component_`
      <gds-card
        padding="0"
        gap="0"
        variant=${0}
    ...
    `),(0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,getVariant_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,getClasses_fn).call(this,"static"),(0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,renderCardContent_fn).call(this))},renderStaticFooter_fn=function renderStaticFooter_fn(){return(0,when.z)((0,chunk_QU3DSPNU.jq)(this,_GdsCardPattern01_instances,hasFooterContent_fn).call(this),(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t5||(card_pattern_01_component_t5=card_pattern_01_component_`
        <gds-flex font="detail-book-m" align-items="center" gap="s">
          <slot name="footer"></slot>
        </gds-flex>
      `))}))},renderCardContent_fn=function renderCardContent_fn(){var _this4=this;return(0,custom_element_scoping.qy)(card_pattern_01_component_t6||(card_pattern_01_component_t6=card_pattern_01_component_`
      ${0}
    ...
    `),(0,when.z)(this.src,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t7||(card_pattern_01_component_t7=card_pattern_01_component_`
        ...
        `),(0,if_defined.J)(_this4.src),(0,if_defined.J)(_this4.srcset),(0,if_defined.J)(_this4.sizes),"square"===_this4.ratio?"1/1":"16/9",(0,if_defined.J)(_this4.loading),(0,if_defined.J)(_this4.decoding),(0,if_defined.J)(_this4.alt))})),(0,when.z)(!this.src,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t8||(card_pattern_01_component_t8=card_pattern_01_component_`<slot name="header"></slot>`))})),(0,when.z)(this.title||this.excerpt,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t9||(card_pattern_01_component_t9=card_pattern_01_component_`
            <gds-flex flex-direction="column" gap="xs">
              ${0}
              ${0}
              ${0}
            </gds-flex>
          `),(0,when.z)(_this4.category||_this4.date,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t10||(card_pattern_01_component_t10=card_pattern_01_component_`
                  <gds-flex gap="s" align-items="center" flex-wrap="wrap">
                    ${0}
                    ${0}
                  </gds-flex>
                `),(0,when.z)(_this4.category,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t11||(card_pattern_01_component_t11=card_pattern_01_component_` <gds-text tag="p" font="detail-book-s">
                          ${0}
                        </gds-text>`),_this4.category)})),(0,when.z)(_this4.date,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t12||(card_pattern_01_component_t12=card_pattern_01_component_`
                        <gds-formatted-date
                          .value=${0}
                          .locale=${0}
                          .format=${0}
                          ...
                          color="neutral-02"
                        ></gds-formatted-date>
                      `),_this4.date,_this4.locale,_this4.dateFormat)})))})),(0,when.z)(_this4.title,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t13||(card_pattern_01_component_t13=card_pattern_01_component_`
                  <gds-text tag=${0} font="heading-s">
                    ${0}
                  </gds-text>
                `),(0,if_defined.J)(_this4.tag),_this4.title)})),(0,when.z)(_this4.excerpt,(function(){return(0,custom_element_scoping.qy)(card_pattern_01_component_t14||(card_pattern_01_component_t14=card_pattern_01_component_`
                  <gds-text tag="p" lines="3" font="body-regular-m">
                    ${0}
                  </gds-text>
                `),_this4.excerpt)})))})),(0,when.z)(this.href,(function(){return(0,chunk_QU3DSPNU.jq)(_this4,_GdsCardPattern01_instances,renderLinkedFooter_fn).call(_this4)}),(function(){return(0,chunk_QU3DSPNU.jq)(_this4,_GdsCardPattern01_instances,renderStaticFooter_fn).call(_this4)})))},card_pattern_01_component_GdsCardPattern01.styles=[tokens_style.LU,card_pattern_01_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"title",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"excerpt",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"label",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"variant",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"outlined",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"tag",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1,attribute:"aspect-ratio"})],card_pattern_01_component_GdsCardPattern01.prototype,"ratio",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"category",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"date",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1,attribute:"date-format"})],card_pattern_01_component_GdsCardPattern01.prototype,"dateFormat",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_pattern_01_component_GdsCardPattern01.prototype,"locale",2),card_pattern_01_component_GdsCardPattern01=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-card-pattern-01",{dependsOn:[card_component.z,card_linked_component_GdsCardLinked,img_component_GdsImg,text_component_GdsText,flex_component.o,formatted_date_component_GdsFormattedDate,chain_link_component.l]})],card_pattern_01_component_GdsCardPattern01);var GdsCardPattern01=function GdsCardPattern01(props){card_pattern_01_component_GdsCardPattern01.define();var JSXElement=(0,react.p)("gds-card-pattern-01"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCardPattern01.__docgenInfo={description:"",methods:[],displayName:"GdsCardPattern01"};var GdsFormControlFooter=function GdsFormControlFooter(props){form_control_footer_component.V.define();var JSXElement=(0,react.p)("gds-form-control-footer"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsFormControlFooter.__docgenInfo={description:"",methods:[],displayName:"GdsFormControlFooter"};var GdsFormControlHeader=function GdsFormControlHeader(props){form_control_header_component.$.define();var JSXElement=(0,react.p)("gds-form-control-header"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsFormControlHeader.__docgenInfo={description:"",methods:[],displayName:"GdsFormControlHeader"};var option_component=__webpack_require__("./dist/libs/core/src/primitives/listbox/option.component.js"),GdsOption=function GdsOption(props){option_component.Y.define();var JSXElement=(0,react.p)("gds-option"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsOption.__docgenInfo={description:"",methods:[],displayName:"GdsOption"};var menu_heading_component=__webpack_require__("./dist/libs/core/src/primitives/menu/menu-heading.component.js"),GdsMenuHeading=function GdsMenuHeading(props){menu_heading_component.A.define();var JSXElement=(0,react.p)("gds-menu-heading"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsMenuHeading.__docgenInfo={description:"",methods:[],displayName:"GdsMenuHeading"};var GdsMenuItem=function GdsMenuItem(props){menu_item_component.T.define();var JSXElement=(0,react.p)("gds-menu-item"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsMenuItem.__docgenInfo={description:"",methods:[],displayName:"GdsMenuItem"};var breadcrumb_styles_t,breadcrumb_component_t,breadcrumb_component_t2,breadcrumb_component_t3,breadcrumb_component_t4,breadcrumb_component_t5,_GdsBreadcrumb_instances,breadcrumb_component_defaultRel_get,renderContents_fn,renderMainContent_fn,renderOverflowMenu_fn,renderItem_fn,renderCurrent_fn,breadcrumb_styles_default=(0,lit.AH)(breadcrumb_styles_t||(breadcrumb_styles_t=(function _(t){return t})`
  @layer base {
    :host {
      display: contents;
    }
