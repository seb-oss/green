import{l as z}from"./runtime-CNluP0A8.js";import{n as h,r as v}from"./Reflect-DJ7r0WLU.js";import{a as k}from"./query-p8xgzTDt.js";import{e as y}from"./class-map-CXsQwv0r.js";import{G as $,h as c,g as E}from"./gds-element-DTROifYq.js";import{T as B}from"./transitional-styles-UDysEBZS.js";import{w as T}from"./watch-tFciLXSI.js";import{i as m}from"./lit-element-Bx14lxc-.js";const D=m`
  @layer base, a11y;
...
`;var G=Object.defineProperty,A=Object.getOwnPropertyDescriptor,b=s=>{throw TypeError(s)},o=(s,e,t,n)=>{for(var i=n>1?void 0:n?A(e,t):e,l=s.length-1,r;l>=0;l--)(r=s[l])&&(i=(n?r(e,t,i):r(i))||i);return n&&i&&G(e,t,i),i},x=(s,e,t)=>e.has(s)||b("Cannot "+t),u=(s,e,t)=>(x(s,e,"read from private field"),t?t.call(s):e.get(s)),f=(s,e,t)=>e.has(s)?b("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(s):e.set(s,t),g=(s,e,t)=>(x(s,e,"access private method"),t),p,d,_,S,w,O,C;let a=class extends ${constructor(){super(),f(this,d),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,f(this,p,(s,e)=>{const n=e.target.assignedNodes({flatten:!0}),i=n.length>0&&n.some(l=>{var r;return l.nodeType===Node.ELEMENT_NODE||l.nodeType===Node.TEXT_NODE&&((r=l.textContent)==null?void 0:r.trim())!==""});s==="lead"?(this._leadSlotOccupied=i,this._leadHasBadge=i&&n.some(l=>{var r;return((r=l.getAttribute)==null?void 0:r.call(l,"gds-element"))==="gds-badge"})):s==="trail"?this._trailSlotOccupied=i:s==="action"&&(this._actionSlotOccupied=i)})}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-field-base")}render(){const s={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return c`
    ...
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};p=new WeakMap;d=new WeakSet;_=function(){const s={right:!0,"as-flex":this.multiline&&(this._trailSlotOccupied||this._actionSlotOccupied)};return c`
      ${g(this,d,S).call(this)} ${g(this,d,w).call(this)}
      <div class="${y(s)}">
        ${g(this,d,O).call(this)} ${g(this,d,C).call(this)}
      </div>
    ...
    `};C=function(){return c`
      ...
      ></slot>
    `};a.styles=[D];o([h()],a.prototype,"size",2);o([h({type:Boolean})],a.prototype,"multiline",2);o([h({type:Boolean,reflect:!0})],a.prototype,"disabled",2);o([h({type:Boolean})],a.prototype,"invalid",2);o([k("slot:not([name])")],a.prototype,"_mainSlotElement",2);o([v()],a.prototype,"_leadSlotOccupied",2);o([v()],a.prototype,"_leadHasBadge",2);o([v()],a.prototype,"_trailSlotOccupied",2);o([v()],a.prototype,"_actionSlotOccupied",2);o([T("disabled")],a.prototype,"_handleDisabledChange",1);a=o([E("gds-field-base"),z()],a);const j=m`
  * {
    box-sizing: border-box;
  }
