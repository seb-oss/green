 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class be{constructor(t){this.__litLocalizeEventHandler=s=>{s.detail.status==="ready"&&this.host.requestUpdate()},this.host=t}hostConnected(){window.addEventListener(I,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(I,this.__litLocalizeEventHandler)}}const me=e=>e.addController(new be(e)),ye=me;function _e(e={attributes:!0,childList:!0,subtree:!1,characterData:!0}){return(t,s,a)=>{let i;const r=t.connectedCallback,l=t.disconnectedCallback;t.connectedCallback=function(){r==null||r.call(this);const ie=(We,Te)=>{var V;(V=a.value)==null||V.call(this)};i=new MutationObserver(ie),i.observe(this,e)},t.disconnectedCallback=function(){l==null||l.call(this),i.disconnect()}}}var we=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,X=e=>{throw TypeError(e)},m=(e,t,s,a)=>{for(var i=a>1?void 0:a?xe(t,s):t,r=e.length-1,l;r>=0;r--)(l=e[r])&&(i=(a?l(t,s,i):l(i))||i);return a&&i&&we(t,s,i),i},F=(e,t,s)=>t.has(e)||X("Cannot "+s),Ce=(e,t,s)=>(F(e,t,"read from private field"),s?s.call(e):t.get(e)),K=(e,t,s)=>t.has(e)?X("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w=(e,t,s,a)=>(F(e,t,"write to private field"),t.set(e,s),s),N=(e,t,s)=>(F(e,t,"access private method"),s),u,C,A;let p=class extends ue(U){constructor(){super(),K(this,C),K(this,u,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",N(this,C,A)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),N(this,C,A).call(this,e))})}get hidden(){return Ce(this,u)}set hidden(e){this.isPlaceholder||(w(this,u,e==="true"||e===!0),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(w(this,u,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then(()=>H.instance.apply(this,"gds-option"))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(w(this,u,!0),this.setAttribute("aria-hidden","true")):(w(this,u,!1),this.setAttribute("aria-hidden","false"))}render(){var s;const e=(s=this.parentElement)==null?void 0:s.multiple,t=f`
