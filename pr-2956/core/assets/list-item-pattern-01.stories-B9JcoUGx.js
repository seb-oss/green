import{b as s}from"./iframe-BZB1ZMZ5.js";import{a as p}from"./argTableProps-CQPXCoz8.js";import{G as u}from"./list-item-pattern-01.component-DSNjONok.js";import"./cloudy-sun-CG_35R_w.js";import"./text-6BCG1VP7.js";import"./link-CXmdZwYB.js";import"./flex-CliBYqiP.js";import"./list-item-DHLykoKe.js";import"./card-CObLJzKC.js";import"./avatar-CQwYVoIc.js";import"./preload-helper-PPVm8Dsz.js";import"./flex.component-CKb5Hk-C.js";import"./checkmark.component-C_8jVxxe.js";import"./icon.component-CyX0clEP.js";import"./chevron-right.component-CkhL9CeE.js";import"./minus-small.component-BJYqONZU.js";import"./text.component-DbGV4K93.js";import"./default-typography.styles-CEzl3z22.js";import"./rbcb-toggle.template-DZhajOnW.js";import"./resize-observer-CfkbZofs.js";import"./props-link-BO-CgsBh.js";import"./cloudy-sun.component-DjtXGk9C.js";import"./card.component-C8OyAyzL.js";import"./avatar.component-C3MFjNfz.js";import"./people-profile.component-f1crmEq3.js";u.define();const t=e=>Array.from({length:e},(h,c)=>({label:`Item ${c+1}`,value:`Value ${c+1}`})),G={title:"Patterns/List Item Pattern 01",component:"gds-list-item-pattern-01",tags:["autodocs"],argTypes:{...p("gds-list-item-pattern-01")},parameters:{docs:{description:{component:"A list container (`gds-list-pattern-01`) holding one or more row items\n(`gds-list-item-pattern-01`). Together they render a semantic `gds-list`\nwith configurable row slots:\n\n- **Lead**: shows a checkbox when `selectable` is set on the item.\n- **Main**: renders columns from `items`, or falls back to the default slot.\n- **Trail**: shows a chevron link when `href` is set on the item, or accepts custom content via the `trail` slot.\n\nThe row supports three main states:\n- **Selectable**: shows a checkbox in the lead and allows toggling the `checked` state.\n- **Navigational**: shows a chevron in the trail and applies a hover state to the entire row.\n- **Default**: no checkbox or chevron, used for simple lists or when custom content is projected in the lead/trail."}}}},n={render:()=>s`
