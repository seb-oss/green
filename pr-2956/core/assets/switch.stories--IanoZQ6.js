import"./switch-CFied9Av.js";import"./flex-CliBYqiP.js";import{b as t}from"./iframe-BZB1ZMZ5.js";import"./text-6BCG1VP7.js";import"./divider-eOu_iu2f.js";import{a as x}from"./argTableProps-CQPXCoz8.js";import"./switch.component-BlDLy9nL.js";import"./checkmark.component-C_8jVxxe.js";import"./icon.component-CyX0clEP.js";import"./flex.component-CKb5Hk-C.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-DbGV4K93.js";import"./default-typography.styles-CEzl3z22.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
