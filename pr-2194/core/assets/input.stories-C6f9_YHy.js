import{x as a}from"./lit-element-Bx14lxc-.js";import"./input-CM-xivH7.js";import"./badge-Ba3Uj0ZK.js";import"./flex-DDs2ZYgf.js";import"./divider-DaXurB6Y.js";import"./credit-card-D-MC1hsT.js";import"./magnifying-glass-CYygC-9t.js";import"./people-profile-CMV-qiOP.js";import{a as ge}from"./argTableProps-Dcd5mVWL.js";import"./input.component-DdGC9A_2.js";import"./runtime-BL31MtW8.js";import"./localized-decorator-DtmrKsyB.js";import"./custom-element-scoping-CNGU1oQ0.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./query-async-MEroNOeJ.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./form-control-host.style-tmPF1Pqn.js";import"./class-map-CXsQwv0r.js";import"./directive-CF8sV3Lr.js";import"./transitional-styles-lz-XxrEG.js";import"./tokens.style-DQsNuKSy.js";import"./watch-tFciLXSI.js";import"./form-control-header.component-BWWeqOW8.js";import"./badge.component-ShI0WekJ.js";import"./declarative-layout-mixins-D1Y0gyd7.js";import"./flex.component-CkL0ce-t.js";import"./div.component-laA26zwj.js";import"./triangle-exclamation.component-Boc6TMtU.js";import"./icon-BNiJwJst.js";import"./button.component-DJjKhf3Z.js";import"./static-B8S6DEnV.js";import"./observe-light-dom-CmJPHUQ4.js";import"./card.component-McCzQM22.js";import"./cross-large.component-CK7gJC5Z.js";import"./credit-card.component-BMTQvktZ.js";import"./magnifying-glass.component-CfqzcD8u.js";import"./people-profile.component-Co8LPvuF.js";import"./custom-elements-CGsGITjC.js";const et={title:"Components/Input",component:"gds-input",parameters:{layout:"centered",docs:{description:{component:`Input are used to let the user enter text or numbers in a form.
...
@status beta`}}},tags:["autodocs"],argTypes:{...ge("gds-input"),value:{control:"text"},variant:{options:["default"],control:{type:"select"}},size:{options:["large","small"],control:{type:"select"}},invalid:{control:"boolean"}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label",variant:"default",size:"large",supportingText:"Label support text.",innerHTML:'<gds-icon-people-profile slot="lead"></gds-icon-people-profile>'}},g={...t,name:"Default"},n={...t,name:"Size",render:()=>a`
  ...
  ...DefaultParams,
  name: 'Default'
}`,...(b=(x=g.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var f,h,v,L,y;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <gds-flex width="800px" gap="4xl" align-items="flex-start">
  ...
  \`
}`,...(A=($=s.parameters)==null?void 0:$.docs)==null?void 0:A.source},description:{story:'The `length` property can be set to a number to limit the number of characters that can be entered into the input field.<br> A badge will be displayed, updating as the input approaches the character limit.\n\n**@property maxLength** - The maximum number of characters that can be entered into the input field.\n\n```html\n <gds-input maxLength="20"></gds-input>\n```',...(k=(V=s.parameters)==null?void 0:V.docs)==null?void 0:k.description}}};var U,M,R,_,j;l.parameters={...l.parameters,docs:{...(U=l.parameters)==null?void 0:U.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Clearable',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...(R=(M=l.parameters)==null?void 0:M.docs)==null?void 0:R.source},description:{story:'When the `clearable` property is set, a clear button is added, allowing users to quickly clear the text.\n\n@property clearable - Enables the clear button for the input field.\n\n```html\n <gds-input label="Label text" value="Clear this text" clearable></gds-input>\n```',...(j=(_=l.parameters)==null?void 0:_.docs)==null?void 0:j.description}}};var F,G,H,O,W;o.parameters={...o.parameters,docs:{...(F=o.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...DefaultParams,
...
\`\`\``,...(ae=(te=p.parameters)==null?void 0:te.docs)==null?void 0:ae.description}}};var ne,re,ie,se,le;u.parameters={...u.parameters,docs:{...(ne=u.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  ...
  \`
}`,...(pe=(de=c.parameters)==null?void 0:de.docs)==null?void 0:pe.source},description:{story:"The `disabled` property can be set to disable the input field.\n\n**@property disabled** - Disables the input field.\n\n```html\n <gds-input disabled></gds-input>\n```",...(ce=(ue=c.parameters)==null?void 0:ue.docs)==null?void 0:ce.description}}};const tt=["Default","Size","Lead","Trail","Length","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","Disabled"];export{l as Clearable,g as Default,c as Disabled,d as ExtendedSupportingText,r as Lead,s as Length,n as Size,u as StandardAttributes,o as SupportingText,i as Trail,p as Validation,tt as __namedExportsOrder,et as default};
