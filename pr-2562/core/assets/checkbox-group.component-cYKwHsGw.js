import{i as $,t as A,ah as L,n as l,d as w,a8 as f,a9 as G,b as B,h as g,g as E,U as W,Q as H,S as U,a0 as J,a as N}from"./iframe-7i7lbGMR.js";import{G as q}from"./toggle-control-base.component-DvhX2w8P.js";import{c as Q}from"./rbcb-toggle.template-DReyLblG.js";import{I as R}from"./checkmark.component-DoaxbUyx.js";import{I as X}from"./minus-small.component-CVqD6PmA.js";import{l as K}from"./localized-decorator-Cvbd25nG.js";import{G as Y,a as Z}from"./form-control-header.component-BZqLtI-j.js";const j=$`
  :host {
    cursor: pointer;
  }
...
`;var ee=Object.defineProperty,te=Object.getOwnPropertyDescriptor,O=e=>{throw TypeError(e)},h=(e,t,s,c)=>{for(var r=c>1?void 0:c?te(t,s):t,p=e.length-1,u;p>=0;p--)(u=e[p])&&(r=(c?u(t,s,r):u(r))||r);return c&&r&&ee(t,s,r),r},se=(e,t,s)=>t.has(e)||O("Cannot "+s),re=(e,t,s)=>t.has(e)?O("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),_=(e,t,s)=>(se(e,t,"access private method"),s),x,S,m;let n=class extends G{constructor(){super(...arguments),re(this,x),this.label="",this.supportingText="",this.checked=!1,this.indeterminate=!1,this.disabled=!1}get value(){return this._internalValue||""}set value(e){this._internalValue=e}_handleIndeterminateChange(){this.indeterminate&&(this.checked=!1)}focus(e){this._elCheckbox.focus(e)}render(){return g`
        ...
        <gds-toggle-control-base type="checkbox" @click=${_(this,x,S)}>
