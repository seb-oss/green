import{u as s,j as e,M as r}from"./iframe-7i7lbGMR.js";import{S as i}from"./Mermaid-d5PrieEe.js";function o(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"What's what?"}),`
...
`,e.jsxs(n.p,{children:["The CSS ",e.jsx(n.code,{children:"font-family"})," property is inherited though shadow DOM boundaries, so the components will render whichever font is used in the parent document."]})]})}function h(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{h as default};
