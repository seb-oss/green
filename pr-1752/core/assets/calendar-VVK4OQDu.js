...
`;function ie(t,e){const a=Q(t),r=q(t),o=J({start:a,end:r},{weekStartsOn:1});for(;o.length<6;)o.push(k(o[o.length-1],7));return m`${e(o.map(s=>({days:V({start:s,end:k(s,6)})})))}`}var le=Object.defineProperty,ue=Object.getOwnPropertyDescriptor,E=t=>{throw TypeError(t)},v=(t,e,a,r)=>{for(var o=r>1?void 0:r?ue(e,a):e,s=t.length-1,i;s>=0;s--)(i=t[s])&&(o=(r?i(e,a,o):i(o))||o);return r&&o&&le(e,a,o),o},de=(t,e,a)=>e.has(t)||E("Cannot "+a),ce=(t,e,a)=>e.has(t)?E("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),S=(t,e,a)=>(de(t,e,"access private method"),a),x,Y,H;let u=class extends L{constructor(){super(...arguments),ce(this,x),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.focusedDate=new Date,this.disabledWeekends=!1,this.showWeekNumbers=!1,this.hideExtraneousDays=!1,this.hideDayNames=!1,this.dateLabelTemplate=t=>t.toDateString()}get focusedMonth(){return this.focusedDate.getMonth()}set focusedMonth(t){const e=ae(new Date(this.focusedYear,t,1)),a=new Date(this.focusedDate);a.setDate(Math.min(this.focusedDate.getDate(),e.getDate())),a.setMonth(t),a.setHours(12,0,0,0),this.focusedDate=a}get focusedYear(){return this.focusedDate.getFullYear()}set focusedYear(t){this.focusedDate=new Date(this.focusedDate.setFullYear(t))}getDateCell(t){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector(`#dateCell-${t}`)}connectedCallback(){super.connectedCallback(),z.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",S(this,x,H))}focus(){var t;super.focus(),(t=this._elFocusedCell)==null||t.focus()}render(){const t=new Date;return m`<table role="grid" aria-label="${T(this.label)}">
                ...
                <tr role="row">
                  ...
                  ${a.days.map(r=>{const o=this.customizedDates&&this.customizedDates.find(h=>y(h.date,r)),s={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(h=>y(h,r))),...o},i=!re(this.focusedDate,r),d=(r<this.min||r>this.max)&&!y(r,this.min)&&!y(r,this.max),l=r.getDay()===0||r.getDay()===6,n=s.disabled||i||d||this.disabledWeekends&&l;return this.hideExtraneousDays&&i?m`<td inert></td>`:m`
                          <td
                            ...
                            class="${P({"custom-date":!!o,disabled:!!n,today:y(t,r)})}"
                            ?disabled=${n}
