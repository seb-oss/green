import{i as N,K as L,U as A,J as D,A as W,h,b as $,H as p,t as R,n as g,d as J,z as _,a as T,g as F,I as q}from"./iframe-DgNp3mwL.js";import{l as H}from"./localized-decorator-ckdeBXEz.js";import{w as K,G as Q}from"./popover.component-QEbtTl1y.js";import{a as U,G as V}from"./context-menu.component-DNX2r5No.js";import{a as X}from"./dropdown.component-oOMG_fH6.js";import{I as Y}from"./chevron-bottom.component-B_wQxvc_.js";import{I as Z,a as tt,b as et,c as st}from"./chevron-right-small.component-7JJlRVlA.js";import{I as nt}from"./chevron-right.component-CtGMXxlI.js";import{G as it}from"./input.component-BeZC6vL0.js";import{G as ot}from"./text-B-3Z4cwU.js";const at=N`
  :host {
    display: flex;
    align-items: center;
...
`;var rt=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,x=t=>{throw TypeError(t)},d=(t,s,n,c)=>{for(var l=c>1?void 0:c?lt(s,n):s,m=t.length-1,b;m>=0;m--)(b=t[m])&&(l=(c?b(s,n,l):b(l))||l);return c&&l&&rt(s,n,l),l},y=(t,s,n)=>s.has(t)||x("Cannot "+n),i=(t,s,n)=>(y(t,s,"read from private field"),n?n.call(t):s.get(t)),pt=(t,s,n)=>s.has(t)?x("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,n),o=(t,s,n)=>(y(t,s,"access private method"),n),e,f,a,P,w,G,z,C,I,k,M,S,O,j,u,B,E,v;const ct={compact:{button:"small",font:"detail-book-s",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-book-s",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-book-m",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let r=class extends L(A(D(W))){constructor(){super(...arguments),pt(this,e),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(t){this._isMobile=t}render(){return h`
      <gds-flex
        align-items="center"
    ...
    `};G=function(){const t=i(this,e,f),s=o(this,e,P).call(this,t);return h`${s.map(n=>o(this,e,w).call(this,n))}`};z=function(){return h`
      <gds-button
        size="${i(this,e,a).button}"
        rank="secondary"
    ...
    `};M=function(){return h`
      <gds-flex
        ...
        flex="1"
      >
        ${[$(this.jump,()=>o(this,e,z).call(this)),o(this,e,C).call(this)]}
