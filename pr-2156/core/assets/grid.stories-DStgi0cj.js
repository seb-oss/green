import"./grid-DkO2ID6E.js";import"./card-B_guFLiB.js";import"./flex-CpfrK_nr.js";import"./container-CgElhiYo.js";import{x as n}from"./lit-element-Bx14lxc-.js";import{a as w}from"./argTableProps-D2daUV57.js";import"./grid.component-CjWMIa_u.js";import"./tokens.style-CfX8-1wa.js";import"./custom-element-scoping-CNGU1oQ0.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./declarative-layout-mixins-dHcexrGz.js";import"./div.component-TOxNJhjo.js";import"./card.component-CvmYXsVs.js";import"./flex.component-BoXEzmcd.js";import"./container.component-DktkxbQ2.js";import"./custom-elements-DLvrWdDx.js";const F={title:"Components/Grid",component:"gds-grid",tags:["autodocs"],parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/grid)\n\nThe `gds-grid` is a custom element that provides a flexible grid system. It uses CSS grid layout to arrange its child elements into columns. This component is highly customizable and responsive, allowing you to specify the number of `columns`, `gap`, `padding`, and fluidity for different devices with automated column size based on the content using the `auto-columns` attribute."}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{...w("gds-grid")},args:{gap:"m",padding:"0",columns:"4",innerHTML:`
  ...
  `},s={...d,name:"Breakpoints + Auto Columns",render:i=>n`
    <!-- prettier-ignore -->
  ...
  `},r={...d,name:"Auto Columns",render:i=>n`
    <!-- prettier-ignore -->
  ...
  `};var a,c,g;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(g=(c=t.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var o,l,h,x,m;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <!-- prettier-ignore -->
    <gds-grid
  ...
  \`
}`,...(p=(f=s.parameters)==null?void 0:f.docs)==null?void 0:p.source},description:{story:"This example shows a grid with `4` columns on all breakpoints desktop, tablet, and on mobile. It also has a gap of `2xl` on all breakpoints. The padding is `l` on all breakpoints. As well as `auto-columns` attribute is set to `100` which will make the columns to be `~100px` wide.",...(v=(b=s.parameters)==null?void 0:b.docs)==null?void 0:v.description}}};var C,y,L,j,O;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Auto Columns',
  render: args => html\`
    <!-- prettier-ignore -->
  ...
  \`
}`,...(L=(y=r.parameters)==null?void 0:y.docs)==null?void 0:L.source},description:{story:`Auto Columns, while optional, remove the need for breakpoints, adapting to content for a more flexible and responsive grid.
...
The \`auto-columns\` attribute is set to \`240\` which will make the columns to be \`240px\` no matter the screen/container size.`,...(O=(j=r.parameters)==null?void 0:j.docs)==null?void 0:O.description}}};const H=["Basic","Usage","AllBreakpoints","AutoColumns"];export{s as AllBreakpoints,r as AutoColumns,t as Basic,e as Usage,H as __namedExportsOrder,F as default};
