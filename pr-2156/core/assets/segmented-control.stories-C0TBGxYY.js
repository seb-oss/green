import{x as o}from"./lit-element-Bx14lxc-.js";import{a as P}from"./argTableProps-B7dy_h24.js";import"./segmented-control-_3vsR5B9.js";import{a as z}from"./segmented-control.component-D3NBSmmu.js";import"./custom-elements-CwyN2uSY.js";import"./runtime-BL31MtW8.js";import"./localized-decorator-DtmrKsyB.js";import"./gds-element-DKcDvDP5.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./tokens.style-D2aGGh9l.js";import"./transitional-styles-CoR4Wsds.js";import"./resize-observer-B9k8v2TZ.js";import"./watch-tFciLXSI.js";import"./declarative-layout-mixins-BN2gVja9.js";import"./chevron-right.component-BMqF4r7c.js";import"./icon-we9-yP8K.js";import"./directive-CF8sV3Lr.js";z.define();const N={title:"Components/Segmented control",component:"gds-segmented-control",subcomponents:{GdsSegment:"gds-segment"},parameters:{layout:"centered",docs:{description:{component:`[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/segmented-control)
&nbsp;|&nbsp;
...
<gds-segment value="3">Item 3</gds-segment>`,value:"1"}},t={...g},e={...g,render:r=>o`
  ...
  render: args => html\`
    ...
    <div style="margin-top: 1rem">Selected: <span id="sel">2</span></div>
  \`
}`,...(c=(i=e.parameters)==null?void 0:i.docs)==null?void 0:c.source},description:{story:"The `gds-segmented-control` element has a value-property that corresponds to the value of the selected segment.\nEach segment also needs to have a unique value-property set so thateach can be distinguished.",...(u=(p=e.parameters)==null?void 0:p.docs)==null?void 0:u.description}}};var h,v,f,b,S;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-segmented-control size="small" value="2">
      <gds-segment value="1">First</gds-segment>
  ...
  \`
}`,...(f=(v=s.parameters)==null?void 0:v.docs)==null?void 0:f.source},description:{story:"There is a small and a medium version which can be configured using the `size` attribute.",...(S=(b=s.parameters)==null?void 0:b.docs)==null?void 0:S.description}}};var w,y,x,T,F;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <div style="width:90vw; max-width: 556px;">
      <gds-segmented-control value="1">
