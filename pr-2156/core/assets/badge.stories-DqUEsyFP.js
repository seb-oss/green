import{x as a}from"./lit-element-Bx14lxc-.js";import{a as X}from"./argTableProps-pd-0RJ4V.js";import"./badge-ER5nTCpt.js";import"./grid-Dkc3CuPK.js";import"./flex-DKnWyAMO.js";import"./divider-C7E7KWEU.js";import"./triangle-exclamation-BWDSEdZi.js";import"./circle-check-BH84ECq5.js";import"./plus-small-Be0ZIGak.js";import"./minus-small-CYLdMQSb.js";import"./rocket-De5xkrut.js";import"./custom-elements-CEDeE0jQ.js";import"./badge.component-DCnrhWru.js";import"./gds-element-DKcDvDP5.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./tokens.style-DY0D4SO1.js";import"./declarative-layout-mixins-D-CzJZ0x.js";import"./flex.component-Cewv73M2.js";import"./div.component-CeZvfGos.js";import"./grid.component-CRXj-1t7.js";import"./divider.component-BnPXVo-K.js";import"./triangle-exclamation.component-xSG8ZCIA.js";import"./icon-CP_Srf2y.js";import"./unsafe-html-CYO4avEf.js";import"./directive-CF8sV3Lr.js";import"./arrow-rotate-counter-clockwise.component-my-yZbdj.js";import"./circle-check.component-BdJA44PB.js";import"./plus-small.component-DeTMPLEu.js";import"./rocket.component-BNVVgBPF.js";const De={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...X("gds-badge")}},r={name:"Variants",render:e=>a`
    <gds-flex
  ...
  `};var p,v,f;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: 'Variants',
  render: args => html\`
    <gds-flex
      flex-direction="column"
  ...
  \`
}`,...(f=(v=r.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};var x,u,h,z,w;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: 'Lead',
  parameters: {
    controls: {
      include: []
