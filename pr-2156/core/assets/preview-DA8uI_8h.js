...
`;let Z=class extends Se(D){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),ke.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return ee`<button
    ...
    >
      <slot></slot>
    </button>`}};Z.styles=[...G,_($t)];o([g({type:Boolean,reflect:!0})],Z.prototype,"selected",2);o([g()],Z.prototype,"value",2);o([g({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);Z=o([$("gds-segment")],Z);const zt=`@layer base {
  :host {
    background-color: var(--gds-sys-color-l3-background-secondary);
