import{i as te,x as D}from"./lit-element-Bx14lxc-.js";import{n as f,G as se,h as y,g as ae}from"./gds-element-DKcDvDP5.js";import{a as L}from"./query-p8xgzTDt.js";import{e as I}from"./class-map-CXsQwv0r.js";import{t as re}from"./tokens.style-D2aGGh9l.js";import{w as oe}from"./watch-tFciLXSI.js";import{a as le,b as de,w as me}from"./declarative-layout-mixins-BN2gVja9.js";import{G as pe}from"./button.component-C0KIyaju.js";import"./text-3f5won4W.js";import"./card-Cp_K9ny0.js";import"./flex-CTVghvzD.js";import"./link-DqWX7khj.js";import"./rich-text-DgIfti48.js";import"./chevron-top-DfqTbY76.js";import"./chevron-bottom-DVA9EvCt.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./static-B8S6DEnV.js";import"./transitional-styles-CoR4Wsds.js";import"./observe-light-dom-CmJPHUQ4.js";import"./div.component-DizA2S2f.js";import"./card.component-Dm8qdRBQ.js";import"./flex.component-JSp73F_P.js";import"./link.component-V5diW3IA.js";import"./chevron-top.component-DbElc78A.js";import"./icon-Drs8NKfA.js";import"./unsafe-html-CYO4avEf.js";import"./chevron-bottom.component-imN5PE_K.js";const ge=te`
  :host {
    display: contents;
  }
...
`;var ye=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,ie=e=>{throw TypeError(e)},o=(e,t,s,i)=>{for(var a=i>1?void 0:i?xe(t,s):t,l=e.length-1,d;l>=0;l--)(d=e[l])&&(a=(i?d(t,s,a):d(a))||a);return i&&a&&ye(t,s,a),a},fe=(e,t,s)=>t.has(e)||ie("Cannot "+s),r=(e,t,s)=>(fe(e,t,"read from private field"),s?s.call(e):t.get(e)),m=(e,t,s)=>t.has(e)?ie("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),b,S,z,w,_,k,C;let n=class extends le(de(me(se))){constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",m(this,b,()=>{this.open=!this.open,r(this,w).call(this)}),m(this,S,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),r(this,b).call(this))}),m(this,z,()=>{!this.open||!this.name||document.querySelectorAll('[gds-element="gds-details"]').forEach(e=>{var t;if(e!==this&&e.name===this.name){const s=e;s.open=!1,r(t=s,w).call(t)}})}),m(this,w,()=>{this.dispatchCustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open})}),m(this,_,()=>y`
      <div
        class="summary"
        part="summary"
        role="button"
    ...
    `)}__handleOpenChange(){r(this,z).call(this)}render(){return y`
      ...
      >
        ${r(this,_).call(this)} ${r(this,C).call(this)}
      </div>
    `}};b=new WeakMap;S=new WeakMap;z=new WeakMap;w=new WeakMap;_=new WeakMap;k=new WeakMap;C=new WeakMap;n.styles=[re,ue];o([f({type:String})],n.prototype,"summary",2);o([f({type:String})],n.prototype,"name",2);o([f({type:Boolean,reflect:!0})],n.prototype,"open",2);o([f({type:String})],n.prototype,"size",2);o([L(".content")],n.prototype,"_content",2);o([L('slot[name="summary-icon-open"]')],n.prototype,"_openIconSlot",2);o([L('slot[name="summary-icon-closed"]')],n.prototype,"_closedIconSlot",2);o([oe("open")],n.prototype,"__handleOpenChange",1);n=o([ae("gds-details",{dependsOn:[pe,x]})],n);n.define();const Je={title:"Components/Details",component:"gds-details",tags:["autodocs"],argTypes:{summary:{description:"The text displayed in the details header",control:"text",table:{type:{summary:"string"},defaultValue:{summary:"Summary"}}},name:{description:"Groups detailss together. Detailss with the same name will close each other when opened",control:"text",table:{type:{summary:"string"},defaultValue:{summary:""}}},open:{description:"Controls if the details is expanded",control:"boolean",table:{type:{summary:"boolean"}}},size:{description:"Controls the size of the details",control:{type:"select",options:["large","small"]},table:{type:{summary:'"large" | "small"'},defaultValue:{summary:"large"}}}},parameters:{docs:{description:{component:`The details component is a collapsible section that helps organize and hide content until needed.
