import{l as A}from"./runtime-CNluP0A8.js";import{n as c,G as T,h as d,g as w,r as V}from"./gds-element-DKcDvDP5.js";import{a as H}from"./query-p8xgzTDt.js";import{e as k}from"./class-map-CXsQwv0r.js";import{G as K,a as q}from"./form-control-header.component-B8f4uQpt.js";import{t as R}from"./tokens.style-D2aGGh9l.js";import{w as F}from"./watch-tFciLXSI.js";import{w as U,b as X,a as J}from"./declarative-layout-mixins-BN2gVja9.js";import{a as N}from"./button.component-C0KIyaju.js";import{i as v}from"./lit-element-Bx14lxc-.js";import{n as _}from"./when-BR7zwNJC.js";const Q=v`
  @layer base, a11y;
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,j=e=>{throw TypeError(e)},b=(e,t,s,i)=>{for(var r=i>1?void 0:i?de(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(r=(i?l(t,s,r):l(r))||r);return i&&r&&le(t,s,r),r},ce=(e,t,s)=>t.has(e)||j("Cannot "+s),$=(e,t,s)=>(ce(e,t,"read from private field"),s?s.call(e):t.get(e)),S=(e,t,s)=>t.has(e)?j("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),x,m;let p=class extends T{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,S(this,x,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchStandardEvent("input",{bubbles:!0}))}),S(this,m,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchStandardEvent("input",{bubbles:!0}))}),this.addEventListener("keydown",$(this,m)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",$(this,x))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}render(){return d`
    ...
    `}};x=new WeakMap;m=new WeakMap;p.styles=[ee,ne];b([c()],p.prototype,"label",2);b([c({attribute:"supporting-text"})],p.prototype,"supportingText",2);b([c()],p.prototype,"value",2);b([c({type:Boolean,reflect:!0})],p.prototype,"checked",2);b([c({type:Boolean,reflect:!0})],p.prototype,"disabled",2);b([c({type:Boolean})],p.prototype,"invalid",2);b([V()],p.prototype,"_isFocused",2);p=b([w("gds-radio",{dependsOn:[u]})],p);export{p as G,E as a,u as b,we as c,ee as r};
