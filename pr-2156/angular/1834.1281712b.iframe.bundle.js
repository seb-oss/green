...
`;var _GdsFormControlFooter_instances,renderRemainingCharsBadge_fn;let GdsFormControlFooter=class extends gds_element.j{constructor(){super(...arguments),(0,chunk_QU3DSPNU.VK)(this,_GdsFormControlFooter_instances)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter)}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return custom_element_scoping.qy`<div aria-live="polite">
    ...
    </div>`}};_GdsFormControlFooter_instances=new WeakSet,renderRemainingCharsBadge_fn=function(remaining){let variant;return variant=remaining<0?"negative":remaining<20?"warning":"positive",custom_element_scoping.qy`<gds-badge variant="${variant}">${remaining}</gds-badge>`},GdsFormControlFooter.styles=[form_control_footer_styles_styles],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],GdsFormControlFooter.prototype,"charCounter",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],GdsFormControlFooter.prototype,"errorMessage",2),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("charCounter"),(0,watch.w)("errorMessage")],GdsFormControlFooter.prototype,"_handleVisibilityChange",1),GdsFormControlFooter=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-form-control-footer",{dependsOn:[GdsBadge,triangle_exclamation_component.f]})],GdsFormControlFooter);var button_component=__webpack_require__("./dist/libs/core/src/components/button/button.component.js"),style_expression_property=__webpack_require__("./dist/libs/core/src/utils/decorators/style-expression-property.js"),div_component=__webpack_require__("./dist/libs/core/src/components/div/div.component.js");let GdsCard=class extends div_component.o{constructor(){super(),this.variant="primary",this.padding="s;m{l}",this["border-radius"]="xs;m{s}",this.gap="s;m{l}"}render(){return custom_element_scoping.qy`<slot></slot>`}};GdsCard.styles=[tokens_style.LU,lit.AH`
      :host {
        box-sizing: border-box;
    ...
    `],(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({property:"box-shadow",valueTemplate:v=>`var(--gds-sys-shadow-${v})`})],GdsCard.prototype,"shadow",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({styleTemplate:function(_prop,v){return`\n      --_border-color: var(--gds-sys-color-l${this.level}-background-${v});\n      --_background-color: var(--gds-sys-color-l${this.level}-background-${v});\n      --_color: var(--gds-sys-color-l${this.level}-content-${v});\n      `}})],GdsCard.prototype,"variant",2),GdsCard=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-card")],GdsCard);var circle_info_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/circle-info.component.js");const form_control_header_styles_styles=lit.AH`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var _GdsFormControlHeader_instances,handleExtSupTxtSlotChange_fn,_renderExtSupTxtButton,_handleExtSupTxtBtnClick,renderExtSupTxt_fn;let GdsFormControlHeader=class extends gds_element.j{constructor(){super(...arguments),(0,chunk_QU3DSPNU.VK)(this,_GdsFormControlHeader_instances),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,(0,chunk_QU3DSPNU.VK)(this,_renderExtSupTxtButton,(()=>custom_element_scoping.qy`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
    ...
    `}};_GdsFormControlHeader_instances=new WeakSet,handleExtSupTxtSlotChange_fn=function(e){this._hasExtendedSupportingText=e.target.assignedElements({flatten:!0}).length>0},_renderExtSupTxtButton=new WeakMap,_handleExtSupTxtBtnClick=new WeakMap,renderExtSupTxt_fn=function(){return custom_element_scoping.qy`
      <div
...
`}}]);
//# sourceMappingURL=1834.1281712b.iframe.bundle.js.map