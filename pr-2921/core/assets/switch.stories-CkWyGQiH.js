import"./switch-8JuZk1mX.js";import"./flex-BFKK5gCD.js";import{b as t}from"./iframe-B6b8lEsx.js";import"./text-Cc9E1CGj.js";import"./divider-BX5qFjI6.js";import{a as x}from"./argTableProps-CTt8uGct.js";import"./switch.component-tQ2ezZOF.js";import"./checkmark.component-Bun1NvTE.js";import"./icon.component-CrZLhLIc.js";import"./flex.component-DiatQJPJ.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-Dg68zOIe.js";import"./default-typography.styles-CnqW_myG.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
