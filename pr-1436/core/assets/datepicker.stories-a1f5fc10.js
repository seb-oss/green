        ...
        ${Ta(this.focusedDate,t=>W`
            ${t.map(a=>W`
                <tr>
                  ...
                  ${a.days.map(s=>{const n={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(i=>R(i,s))),...this.customizedDates&&this.customizedDates.find(i=>R(i.date,s))},r=!Oa(this.focusedDate,s)||s<this.min||s>this.max,o=s.getDay()===0||s.getDay()===6,l=(n.disabled||this.disabledWeekends&&o)&&r;return W`
                      <td
