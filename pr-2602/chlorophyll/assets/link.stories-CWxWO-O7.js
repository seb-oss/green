import"./blocks--uo8Vprr.js";import"./iframe-D06iXPVv.js";const a={title:"Components/Links",tags:["autodocs"],parameters:{componentIds:["component-inlinelinks"]}},t={render:n=>`
    <a href="#">Normal link</a>    
    <a href="https://www.seb.se" class="link-history">
      Go to seb.se
    </a>
    <a>Disabled link</a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},o={render:n=>`
  ...
  </a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},s={render:()=>`
  <a href="#" class="link gds-link-arrow" aria-label="External link">
  ...
  </a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},l={render:()=>`
    ...
    <a href="#" class="button ghost">Ghost link button</a>`,decorators:[n=>`<div style="display:flex;flex-direction: column;gap:1rem;">${n()}</div>`]},d=["Links","Link","LinkWithIcon","LinkWithArrow","LinkAsButton"];export{o as Link,l as LinkAsButton,s as LinkWithArrow,r as LinkWithIcon,t as Links,d as __namedExportsOrder,a as default};
