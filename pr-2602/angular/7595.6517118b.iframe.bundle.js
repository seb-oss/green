"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[7595],{27595:(t,e,s)=>{s.d(e,{t:()=>q});var o=s(26861),r=s(39443),i=s(14367),a=s(3578),n=s(14652),l=s(90505),c=s(90911),d=s(93539),g=s(77526),p=s(15073),v=r.AH`
  :host {
...
`;let u=class extends d.j{constructor(){super(...arguments),this.onmousedown=t=>{this.triggerRipple(t.clientX,t.clientY)}}render(){return r.qy`<div></div>`}triggerRipple(t,e){const s=this._rippleEl,o=this.getBoundingClientRect(),r=void 0!==t?t-o.left:o.width/2,i=void 0!==e?e-o.top:o.height/2;s&&(s.classList.remove("gds-ripple-effect"),this.style.setProperty("--gds-ripple-top",`${i}px`),this.style.setProperty("--gds-ripple-left",`${r}px`),setTimeout(()=>{s.classList.add("gds-ripple-effect")},20))}};u.styles=[p.LU,v],(0,o.Cc)([(0,i.P)("div")],u.prototype,"_rippleEl",2),u=(0,o.Cc)([(0,g.Y$)("gds-ripple")],u);var y=s(64457),h=s(50685),b=s(49399),m=s(34469),f=s(89295);class k extends m.WL{constructor(t){if(super(t),t.type!==m.OA.ELEMENT)throw new Error("The `forwardAttributes` directive must be used in element bindings")}render(t){return f.s6}update(t,[e]){const s=t.element,o=t.options?.host;Array.from(o.attributes).forEach(t=>{e(t)&&s.setAttribute(t.name.replace("gds-",""),t.value)})}}const x=(0,m.u$)(k),w=new WeakMap;var S,C,M,_,V,E,T,z=s(64987),L=s(68558),$=r.AH`
