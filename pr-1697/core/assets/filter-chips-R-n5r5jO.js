import{n as h,a as x,g as w,G as P,h as C,r as k}from"./gds-element-DjAhZX8m.js";import{a as G}from"./query-p8xgzTDt.js";import{e as $}from"./class-map-Bz98xO8-.js";import{a as W}from"./button-DQeaK1p3.js";import{r as F}from"./resize-observer-B9k8v2TZ.js";import{w as T}from"./watch-tFciLXSI.js";import{s as H}from"./attribute-converters-CdI0trPX.js";import{r as z}from"./query-async-MEroNOeJ.js";import{T as g}from"./transitional-styles-xlKQ3pQf.js";import"./checkmark-DIyhF3AJ.js";import{i as S}from"./lit-element-C_s9q329.js";const D=S`
...
`;var M=Object.defineProperty,V=Object.getOwnPropertyDescriptor,f=(e,t,s,r)=>{for(var l=r>1?void 0:r?V(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(l=(r?n(t,s,l):n(l))||l);return r&&l&&M(t,s,l),l};let p=class extends P{constructor(){super(...arguments),this.selected=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),g.instance.apply(this,"gds-filter-chip"),this._button.then(e=>{g.instance.apply(e,"gds-button")})}render(){const e={"btn-p":!this.selected};return C`<gds-button
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};p.styles=[D];f([h({reflect:!0,type:Boolean})],p.prototype,"selected",2);f([h()],p.prototype,"value",2);f([z(x("gds-button"))],p.prototype,"_button",2);p=f([w("gds-filter-chip")],p);const B=S`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
