import{n as l,g as H,h as g,G as N}from"./gds-element-DjAhZX8m.js";import{a as R}from"./query-p8xgzTDt.js";import{r as se}from"./query-async-MEroNOeJ.js";import{o as ie}from"./icon-CGYi4oOO.js";import{n as S}from"./when-BR7zwNJC.js";import{o as re}from"./if-defined-Ct9lF4W9.js";import{e as K}from"./class-map-Bz98xO8-.js";import{m as k,s as ae}from"./runtime-CMQcyTl6.js";import{w as E}from"./watch-tFciLXSI.js";import{o as oe,a as ne}from"./button-DQeaK1p3.js";import"./chevron-bottom-CGxvb78d.js";import"./checkmark-DIyhF3AJ.js";import{n as le,e as he}from"./ref-D_ho-JAG.js";import{T as B}from"./transitional-styles-xlKQ3pQf.js";import{s as pe,F as de,L as ce,u as ue}from"./menu-heading-ByeIJItC.js";import{t as Y}from"./tokens.style-B_4vLAFn.js";import{i as J}from"./lit-element-C_s9q329.js";import"./popover-CLEfKD6h.js";import"./backdrop-Bu3skj6N.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class fe{constructor(t){this.__litLocalizeEventHandler=s=>{s.detail.status==="ready"&&this.host.requestUpdate()},this.host=t}hostConnected(){window.addEventListener(V,this.__litLocalizeEventHandler)}hostDisconnected(){window.removeEventListener(V,this.__litLocalizeEventHandler)}}const ge=e=>e.addController(new fe(e)),ve=ge;var be=Object.defineProperty,me=Object.getOwnPropertyDescriptor,Q=e=>{throw TypeError(e)},m=(e,t,s,i)=>{for(var r=i>1?void 0:i?me(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(r=(i?p(t,s,r):p(r))||r);return i&&r&&be(t,s,r),r},F=(e,t,s)=>t.has(e)||Q("Cannot "+s),ye=(e,t,s)=>(F(e,t,"read from private field"),s?s.call(e):t.get(e)),I=(e,t,s)=>t.has(e)?Q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w=(e,t,s,i)=>(F(e,t,"write to private field"),t.set(e,s),s),U=(e,t,s)=>(F(e,t,"access private method"),s),f,C,A;let u=class extends de(N){constructor(){super(),I(this,C),I(this,f,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",U(this,C,A)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),U(this,C,A).call(this,e))})}get hidden(){return ye(this,f)}set hidden(e){this.isPlaceholder||(w(this,f,e==="true"||e===!0),this.setAttribute("aria-hidden",e.toString()))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.isPlaceholder&&(w(this,f,!0),this.setAttribute("aria-hidden","true")),this.updateComplete.then(()=>B.instance.apply(this,"gds-option"))}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?(w(this,f,!0),this.setAttribute("aria-hidden","true")):(w(this,f,!1),this.setAttribute("aria-hidden","false"))}render(){var s;const e=(s=this.parentElement)==null?void 0:s.multiple,t=g`
      <span class="checkbox ${K({checked:this.selected})}">
        ${this.selected?g`<gds-icon-checkmark stroke="4"></gds-icon-checkmark>`:""}
      </span>
    `;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),g`<div>${S(e,()=>t)} <slot></slot></div>`}};f=new WeakMap;C=new WeakSet;A=function(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}}))};u.styles=[Y,pe];m([l()],u.prototype,"value",2);m([l({attribute:"aria-hidden",reflect:!0})],u.prototype,"hidden",1);m([l({attribute:"aria-selected",reflect:!0})],u.prototype,"selected",2);m([l({type:Boolean,reflect:!0})],u.prototype,"isPlaceholder",2);m([E("isplaceholder")],u.prototype,"_handlePlaceholderStatusChange",1);u=m([H("gds-option")],u);const _e=J`
