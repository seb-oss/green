import{m as P}from"./runtime-CMQcyTl6.js";import{n as u,r as G,g as y,G as w,h as o}from"./gds-element-DjAhZX8m.js";import{n as g}from"./when-BR7zwNJC.js";import{i as E}from"./lit-element-C_s9q329.js";import"./button-BKEHoiqg.js";import"./triangle-exclamation-D8aXgUcH.js";import"./card-DPV51UTY.js";import"./badge-BOd5zLMj.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const U=(e,t,s)=>{for(const a of t)if(a[0]===e)return(0,a[1])();return s==null?void 0:s()},M=E`
...
`;var B=Object.defineProperty,D=Object.getOwnPropertyDescriptor,z=e=>{throw TypeError(e)},m=(e,t,s,a)=>{for(var r=a>1?void 0:a?D(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&B(t,s,r),r},A=(e,t,s)=>t.has(e)||z("Cannot "+s),H=(e,t,s)=>t.has(e)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),N=(e,t,s)=>(A(e,t,"access private method"),s),v,O;let l=class extends w{constructor(){super(...arguments),H(this,v)}render(){return o`<div aria-live="polite">
    ...
    </div>`}};v=new WeakSet;O=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",o`<gds-badge variant="${t}">${e}</gds-badge>`};l.styles=[k];m([u({type:Number})],l.prototype,"charCounter",2);m([u()],l.prototype,"validationMessage",2);l=m([y("gds-form-control-footer")],l);export{U as r};
