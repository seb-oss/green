import{m as u,l as Ot}from"./runtime-CNluP0A8.js";import{T as Q,i as Vt,E as St}from"./lit-element-Bx14lxc-.js";import{n as m,r as H,G as Rt,h as w,g as Ft}from"./gds-element-DKcDvDP5.js";import{e as qt,a as yt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Yt,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as I,r as N,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as E}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-B89ZvrSV.js";import{G as te}from"./dropdown.component-D_ByRN5P.js";import{G as ee}from"./flex.component-C2WvVTnp.js";import{f as se}from"./form-control-host.style-al3WWrdw.js";import{t as ae}from"./tokens.style-Bfj-148u.js";import{T as ie}from"./transitional-styles-Be9e-Il_.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as $t,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as oe,b as re,d as le}from"./declarative-layout-mixins-DHam8wVT.js";import{G as he,i as de}from"./calendar.component-D4ZEwt3X.js";import{I as pe,a as ce}from"./calender-add.component-CslBRhin.js";import{I as ue,a as ge}from"./chevron-right.component-ChTxT53E.js";import{G as fe}from"./popover.component-C_taiQpZ.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Yt(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let h=0;for(const c of t)a[h]=i?i(c,h):h,n[h]=s(c,h),h++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:h}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=h,n;const c=this.ut??(this.ut=[]),o=[];let C,M,d=0,b=a.length-1,v=0,k=n.length-1;for(;d<=b&&v<=k;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(c[d]===h[v])o[v]=I(a[d],n[v]),d++,v++;else if(c[b]===h[k])o[k]=I(a[b],n[k]),b--,k--;else if(c[d]===h[k])o[k]=I(a[d],n[k]),N(t,o[k+1],a[d]),d++,k--;else if(c[b]===h[v])o[v]=I(a[b],n[v]),N(t,a[d],a[b]),b--,v++;else if(C===void 0&&(C=kt(h,v,k),M=kt(c,d,b)),C.has(c[d]))if(C.has(c[b])){const S=M.get(h[v]),J=S!==void 0?a[S]:null;if(J===null){const xt=N(t,a[d]);I(xt,n[v]),o[v]=xt}else o[v]=I(J,n[v]),N(t,a[d],J),a[S]=null;v++}else U(a[b]),b--;else U(a[d]),d++;for(;v<=k;){const S=N(t,o[k+1]);I(S,n[v]),o[v++]=S}for(;d<=b;){const S=a[d++];S!==null&&U(S)}return this.ut=h,Zt(t,o),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
