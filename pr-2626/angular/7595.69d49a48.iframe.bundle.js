"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[7595],{27595(t,e,o){o.d(e,{t:()=>q});var s=o(26861),r=o(39443),i=o(14367),a=o(3578),n=o(14652),l=o(90505),c=o(90911),d=o(93539),g=o(77526),p=o(15073),v=r.AH`
  :host {
...
`;const A=["aria-label","aria-haspopup","aria-expanded"],Z=(U=g.qy,(t,...e)=>{let o=x.get(t);return o||(o=t.map(t=>t.replace(/\n[\s]+</gm,"<")),o.raw=t.raw,x.set(t,o)),U(o,...e)});var U;class F extends L.S{constructor(){super(...arguments),(0,s.VK)(this,C),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.wrapped=!1,this.href="",(0,s.VK)(this,S,!1),(0,s.VK)(this,V,()=>{const t=this._mainSlot?.assignedElements()??[];(0,s.OV)(this,S,1===t.length&&(t[0].tagName.toLowerCase().startsWith("gds-icon")||"icon"===t[0].getAttribute("name"))),this.requestUpdate()}),(0,s.VK)(this,E,t=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:t}),this.form&&!(0,s.S7)(this,C,M)&&("submit"===this.type?this.form.requestSubmit():"reset"===this.type&&this.form.reset())}),(0,s.VK)(this,z,t=>{if(!(this.disabled||"Space"!==t.code&&"Enter"!==t.key||t.repeat)){const t=this._ripple;t&&t.triggerRipple()}})}focus(t){this._getValidityAnchor()?.focus(t)}click(){this._getValidityAnchor()?.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),y.n.instance.apply(this,"gds-button")}render(){const t={button:!0,circle:(0,s.S7)(this,S),icon:(0,s.S7)(this,S),xs:"xs"===this.size,small:"small"===this.size,large:"large"===this.size,brand:"brand"===this.variant,positive:"positive"===this.variant,negative:"negative"===this.variant,notice:"notice"===this.variant,warning:"warning"===this.variant,primary:"primary"===this.rank,secondary:"secondary"===this.rank,tertiary:"tertiary"===this.rank,wrapped:this.wrapped},e=(0,s.S7)(this,C,M)?c.eu`a`:c.eu`button`;return c.qy`
      <${e}
        class=${(0,a.H)(t)}
