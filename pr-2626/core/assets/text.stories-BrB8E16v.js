import"./text-CxkV9x__.js";import"./card-CodVnfxr.js";import"./div-Bz0AoQ7M.js";import"./flex-CPn0VONo.js";import"./divider-CSlYMEqM.js";import{x as e}from"./iframe-Bc4_q3Ov.js";import{a as s}from"./argTableProps-C310ZLIx.js";import"./default-typography.styles-BU0xi_Uu.js";import"./card.component-CaiialMi.js";import"./flex.component-Cl6lWm1u.js";import"./divider.component-DAWKwFDF.js";const p={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...s("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified."}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},f={...d,name:"Font",render:t=>e`<gds-flex flex-direction="column" gap="m">
