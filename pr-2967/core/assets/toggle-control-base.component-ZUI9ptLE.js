import{l as d}from"./localized-decorator-FDbxBv96.js";import{i as c,v as g,n as p,z as u,a as v,h as b,g as f}from"./iframe-DVOBMRBC.js";const x=c`
  @layer base, a11y;
...
`;var m=Object.defineProperty,y=Object.getOwnPropertyDescriptor,i=(s,o,l,r)=>{for(var t=r>1?void 0:r?y(o,l):o,a=s.length-1,n;a>=0;a--)(n=s[a])&&(t=(r?n(o,l,t):n(t))||t);return r&&t&&m(o,l,t),t};let e=class extends u{constructor(){super(),this.label="",this.supportingText=""}render(){const s={label:!0,"has-supporting-text":!!this.supportingText};return b`
    ...
    `}};e.styles=[g,x];i([p()],e.prototype,"label",2);i([p({attribute:"supporting-text"})],e.prototype,"supportingText",2);e=i([f("gds-toggle-control-base"),d()],e);export{e as G};
