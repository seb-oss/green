...
`;var A=Object.defineProperty,L=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},y=(e,t,s,r)=>{for(var a=r>1?void 0:r?L(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(a=(r?n(t,s,a):n(a))||a);return r&&a&&A(t,s,a),a},N=(e,t,s)=>t.has(e)||S("Cannot "+s),R=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),j=(e,t,s)=>(N(e,t,"access private method"),s),x,b;let l=class extends _{constructor(){super(...arguments),R(this,x)}updated(e){super.updated(e),(e.has("validationMessage")||e.has("charCounter"))&&this.classList.toggle("visually-hidden",!this.validationMessage)}connectedCallback(){super.connectedCallback(),!this.validationMessage&&!this.charCounter&&this.classList.add("visually-hidden")}render(){return o`<div aria-live="polite">
    ...
    </div>`}};x=new WeakSet;b=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",o`<gds-badge variant="${t}">${e}</gds-badge>`};l.styles=[H];y([m({type:Number})],l.prototype,"charCounter",2);y([m()],l.prototype,"validationMessage",2);l=y([w("gds-form-control-footer",{dependsOn:[O,k]})],l);const q=E`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,C=e=>{throw TypeError(e)},h=(e,t,s,r)=>{for(var a=r>1?void 0:r?K(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(a=(r?n(t,s,a):n(a))||a);return r&&a&&J(t,s,a),a},T=(e,t,s)=>t.has(e)||C("Cannot "+s),f=(e,t,s)=>(T(e,t,"read from private field"),s?s.call(e):t.get(e)),g=(e,t,s)=>t.has(e)?C("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),$=(e,t,s)=>(T(e,t,"access private method"),s),p,G,v,u,z;let d=class extends _{constructor(){super(...arguments),g(this,p),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,g(this,v,()=>o`
      <gds-button
        size="small"
        rank="tertiary"
        margin="-xs 0"
