import{m as T,s as he}from"./runtime-BL31MtW8.js";import{l as pe}from"./localized-decorator-DtmrKsyB.js";import{n,h as c,g as z,G as J}from"./custom-element-scoping-CNGU1oQ0.js";import{a as Q}from"./query-p8xgzTDt.js";import{r as de}from"./query-async-MEroNOeJ.js";import{o as ce}from"./if-defined-CVqwUuaf.js";import{o as ue}from"./icon-1rFpnFmF.js";import{n as _}from"./when-BR7zwNJC.js";import{o as ge,f as fe}from"./floating-ui.dom-BmFOYU71.js";import{f as ve,G as me}from"./form-control-host.style-tmPF1Pqn.js";import{G as be,a as ye}from"./form-control-header.component-DXo0ZI5V.js";import{n as _e,e as we}from"./ref-R0wBYijq.js";import{T as X}from"./transitional-styles-lz-XxrEG.js";import{s as xe,F as $e,L as Ce,u as Ee}from"./unwrap-slots-C4xryOWd.js";import{w as L}from"./watch-tFciLXSI.js";import{i as Z}from"./lit-element-Bx14lxc-.js";import{e as ke}from"./class-map-CXsQwv0r.js";import{I as j}from"./checkmark.component-CrrBmXGM.js";import{t as ee}from"./tokens.style-DQsNuKSy.js";import{o as Me}from"./observe-light-dom-CmJPHUQ4.js";import{a as Se}from"./button.component-CAws_hxG.js";import{I as Le}from"./chevron-bottom.component-DzNg7GNq.js";import{G as te}from"./popover.component-CpXVgFzi.js";const Oe=Z`
    ...
    `),d(this,F,e=>{if(this.combobox){const s=e.getBoundingClientRect(),i=window.innerHeight-s.bottom,h=s.top;let p=Math.min(h,this.maxHeight);return i>h&&(p=Math.min(i,this.maxHeight)),`${p-16}px`}return`${Math.min(window.innerHeight,this.maxHeight)-16}px`}),d(this,g,(e,t)=>this.dispatchEvent(new CustomEvent("gds-ui-state",{detail:{reason:t,open:e},bubbles:!1,composed:!1,cancelable:!0}))),d(this,G,e=>{o(this,g).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)}),d(this,k,e=>{if(!e.currentTarget||(e.stopPropagation(),!this.dispatchEvent(new CustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value},cancelable:!0}))))return;const s=e.currentTarget;if(this.options.forEach(i=>i.hidden=!1),!s.value)return;this.options.filter(i=>!this.searchFilter(s.value,i)).forEach(i=>i.hidden=!0)}),d(this,H,e=>{var t;(t=this._elListbox)==null||t.then(s=>{if(e.key==="ArrowDown"||e.key==="Tab"){e.preventDefault(),s.focus();return}})}),d(this,I,e=>{var t;if(e.key==="Tab"&&this.searchable){e.preventDefault(),(t=this._elSearchInput)==null||t.focus();return}}),d(this,V,e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)}),d(this,M,()=>{this.updateComplete.then(()=>this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}),d(this,S,()=>{this.updateComplete.then(()=>this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})))}),d(this,b,e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&o(this,g).call(this,!1,"close")&&(this.open=!1)}),d(this,W,e=>{var t;e.key==="Tab"&&!this.searchable&&o(this,g).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,(t=this._elTriggerBtn)==null||t.focus())})}get type(){return"gds-dropdown"}get options(){return o(this,f)?Array.from(o(this,f)).filter(e=>!e.hasAttribute("isplaceholder")):[]}get placeholder(){if(o(this,f))return Array.from(o(this,f)).find(e=>e.hasAttribute("isplaceholder"))}get displayValue(){var t,s;let e;return Array.isArray(this.value)?this.value.length>2?e=T(he`${this.value.length} selected`):e=this.value.reduce((a,i)=>{var h;return a+((h=this.options.find(p=>p.value===i))==null?void 0:h.innerHTML)+", "},"").slice(0,-2):e=(t=this.options.find(a=>a.selected))==null?void 0:t.innerHTML,e||((s=this.placeholder)==null?void 0:s.innerHTML)||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()})}render(){return c`
      ...
      ${_(C(this,m,re).call(this),()=>c`
          <gds-form-control-footer
            class="size-${this.size}"
            .validationMessage=${this.invalid?this.validationMessage||this.errorMessage:void 0}
          >
            ${""}
