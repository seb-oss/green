...
`;var _handleSlotChange,_renderFieldContents,renderFieldContents_fn,_renderSlotLead,renderSlotLead_fn,_renderSlotMain,renderSlotMain_fn,_renderSlotAction,renderSlotAction_fn,_renderSlotTrail,renderSlotTrail_fn;let GdsFieldBase=class extends gds_element.j{constructor(){super(),(0,chunk_QTSIPXV3.VK)(this,_renderFieldContents),(0,chunk_QTSIPXV3.VK)(this,_renderSlotLead),(0,chunk_QTSIPXV3.VK)(this,_renderSlotMain),(0,chunk_QTSIPXV3.VK)(this,_renderSlotAction),(0,chunk_QTSIPXV3.VK)(this,_renderSlotTrail),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,(0,chunk_QTSIPXV3.VK)(this,_handleSlotChange,((slotName,event)=>{const assignedNodes=event.target.assignedNodes({flatten:!0}),slotOccupied=assignedNodes.length>0&&assignedNodes.some((node=>node.nodeType===Node.ELEMENT_NODE||node.nodeType===Node.TEXT_NODE&&""!==node.textContent?.trim()));"lead"===slotName?this._leadSlotOccupied=slotOccupied:"trail"===slotName?this._trailSlotOccupied=slotOccupied:"action"===slotName&&(this._actionSlotOccupied=slotOccupied)}))}connectedCallback(){super.connectedCallback(),transitional_styles.n.instance.apply(this,"gds-field-base")}render(){const classes={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:"small"===this.size};return custom_element_scoping.qy`
    ...
    `},_renderSlotLead=new WeakSet,renderSlotLead_fn=function(){return custom_element_scoping.qy` <slot
      name="lead"
...
`;var _renderRemainingCharsBadge,renderRemainingCharsBadge_fn;let GdsFormControlFooter=class extends gds_element.j{constructor(){super(...arguments),(0,chunk_QTSIPXV3.VK)(this,_renderRemainingCharsBadge)}updated(changedProperties){super.updated(changedProperties),(changedProperties.has("errorMessage")||changedProperties.has("charCounter"))&&this.classList.toggle("visually-hidden",!this.errorMessage)}connectedCallback(){super.connectedCallback(),this.errorMessage||this.charCounter||this.classList.add("visually-hidden")}render(){return custom_element_scoping.qy`<div aria-live="polite">
    ...
    </div>`}};_renderRemainingCharsBadge=new WeakSet,renderRemainingCharsBadge_fn=function(remaining){let variant;return variant=remaining<0?"negative":remaining<20?"warning":"positive",custom_element_scoping.qy`<gds-badge variant="${variant}">${remaining}</gds-badge>`},GdsFormControlFooter.styles=[form_control_footer_styles_styles],(0,chunk_QTSIPXV3.Cc)([(0,decorators.MZ)({type:Number})],GdsFormControlFooter.prototype,"charCounter",2),(0,chunk_QTSIPXV3.Cc)([(0,decorators.MZ)()],GdsFormControlFooter.prototype,"errorMessage",2),GdsFormControlFooter=(0,chunk_QTSIPXV3.Cc)([(0,custom_element_scoping.Y$)("gds-form-control-footer",{dependsOn:[GdsBadge,triangle_exclamation_component.f]})],GdsFormControlFooter);var button_component=__webpack_require__("./dist/libs/core/src/components/button/button.component.js"),style_expression_property=__webpack_require__("./dist/libs/core/src/utils/decorators/style-expression-property.js"),div_component=__webpack_require__("./dist/libs/core/src/components/div/div.component.js");let GdsCard=class extends div_component.o{constructor(){super(),this.variant="primary",this.padding="s;m{l}",this["border-radius"]="xs;m{s}",this.gap="s;m{l}"}render(){return custom_element_scoping.qy`<slot></slot>`}};GdsCard.styles=[tokens_style.LU,lit.AH`
      :host {
        box-sizing: border-box;
...
`}}]);
//# sourceMappingURL=1834.d30665a0.iframe.bundle.js.map