import{m as E,s as de,l as ce}from"./runtime-CNluP0A8.js";import{i as Q,E as ue}from"./lit-element-Bx14lxc-.js";import{n}from"./Reflect-DJ7r0WLU.js";import{a as Z}from"./query-p8xgzTDt.js";import{r as ge}from"./query-async-MEroNOeJ.js";import{o as fe}from"./if-defined-CVqwUuaf.js";import{o as me}from"./unsafe-html-CYO4avEf.js";import{n as u}from"./when-BR7zwNJC.js";import{o as be,f as ve}from"./floating-ui.dom-BmFOYU71.js";import{f as ye,G as _e}from"./form-control-host.style-Z45atS9J.js";import{G as xe,a as we}from"./form-control-header.component-QU28g8aK.js";import{n as $e,e as Ce}from"./ref-R0wBYijq.js";import{h as c,g as q,G as j}from"./gds-element-DTROifYq.js";import{a as Ee,T as ee}from"./transitional-styles-BXm5gnRS.js";import{s as ke,F as Se,L as Me,u as Te}from"./unwrap-slots-CufDiWNZ.js";import{w as W}from"./watch-tFciLXSI.js";import{I as te}from"./checkmark.component-CddocQY8.js";import{c as We}from"./rbcb-toggle.template-DqXF-ZkM.js";import{t as se}from"./tokens.style-CA5ADGwW.js";import{o as Le}from"./observe-light-dom-CmJPHUQ4.js";import{w as Oe,b as Ae,d as Pe}from"./declarative-layout-mixins-DFPXvh_g.js";import{a as De}from"./button.component-DdwPuP64.js";import{I as Be}from"./chevron-bottom.component-DgyIWO1Z.js";import{I as Fe}from"./cross-small.component-BS14rjKa.js";import{G as ie}from"./popover.component-mbng-_MZ.js";const Ge=Q`
...
`;var ze=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,oe=e=>{throw TypeError(e)},_=(e,t,s,l)=>{for(var i=l>1?void 0:l?Ie(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&ze(t,s,i),i},R=(e,t,s)=>t.has(e)||oe("Cannot "+s),K=(e,t,s)=>(R(e,t,"read from private field"),s?s.call(e):t.get(e)),N=(e,t,s)=>t.has(e)?oe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),He=(e,t,s,l)=>(R(e,t,"write to private field"),t.set(e,s),s),X=(e,t,s)=>(R(e,t,"access private method"),s),x,M,A;let g=class extends Se(j){constructor(){super(),N(this,M),N(this,x,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",X(this,M,A)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),X(this,M,A).call(this,e))})}get hidden(){return K(this,x)}set hidden(e){const t=e.toString();He(this,x,t==="true"),K(this,x)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),ee.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){var t;const e=(t=this.parentElement)==null?void 0:t.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),c`<div class="item">
      ${u(e,()=>We({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};x=new WeakMap;M=new WeakSet;A=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};g.styles=[se,Ee,ke];_([n()],g.prototype,"value",2);_([n({type:Boolean,reflect:!0})],g.prototype,"hidden",1);_([n({attribute:"aria-selected",reflect:!0})],g.prototype,"selected",2);_([n({type:Boolean,reflect:!0})],g.prototype,"isPlaceholder",2);_([W("isPlaceholder")],g.prototype,"_handlePlaceholderStatusChange",1);g=_([q("gds-option",{dependsOn:[te]})],g);var Ve=Object.defineProperty,qe=Object.getOwnPropertyDescriptor,ae=e=>{throw TypeError(e)},L=(e,t,s,l)=>{for(var i=l>1?void 0:l?qe(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&Ve(t,s,i),i},Re=(e,t,s)=>t.has(e)||ae("Cannot "+s),k=(e,t,s)=>(Re(e,t,"read from private field"),s?s.call(e):t.get(e)),Y=(e,t,s)=>t.has(e)?ae("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w,P;let b=class extends j{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,Y(this,w,Ce()),Y(this,P,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new Me(this)}get navigableItems(){return this.visibleOptionElements}get options(){return k(this,w).value?Te(k(this,w).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),ee.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",k(this,P))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return c`<slot ${$e(k(this,w))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};w=new WeakMap;P=new WeakMap;b.styles=Ge;L([n({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],b.prototype,"multiple",2);L([n()],b.prototype,"compareWith",2);L([W("multiple")],b.prototype,"_rerenderOptions",1);b=L([q("gds-listbox",{dependsOn:[g]})],b);const Ue=Q`
  @layer base, reset;
