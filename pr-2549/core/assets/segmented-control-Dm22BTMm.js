import{i as O,U as $,A as P,Y as W,h as V,t as B,n as g,g as I,J as T,K as G,H as z,d as S,z as M,a2 as D}from"./iframe-a2ZbZpP3.js";import{l as N}from"./localized-decorator-Bmo7rl4w.js";import{r as R}from"./resize-observer-B9k8v2TZ.js";import{I as A}from"./chevron-left.component-DAjV6hni.js";import{I as X}from"./chevron-right.component-DSzuvTau.js";const F=O`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var H=Object.defineProperty,J=Object.getOwnPropertyDescriptor,m=(e,t,s,i)=>{for(var r=i>1?void 0:i?J(t,s):t,a=e.length-1,h;a>=0;a--)(h=e[a])&&(r=(i?h(t,s,r):h(r))||r);return i&&r&&H(t,s,r),r};let u=class extends $(P){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),W.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return V`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};u.styles=[...B,F];m([g({type:Boolean,reflect:!0})],u.prototype,"selected",2);m([g()],u.prototype,"value",2);m([g({type:Boolean,reflect:!0})],u.prototype,"disabled",2);u=m([I("gds-segment")],u);const K=O`
  @layer base {
    :host {
