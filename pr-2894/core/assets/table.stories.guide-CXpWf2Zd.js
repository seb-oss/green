import{u as o,j as e,M as l}from"./iframe-rbfndJAH.js";import"./preload-helper-PPVm8Dsz.js";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Components/Table/Developer Guide"}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#virtualization",children:"Virtualization"})}),`
...
`})}),`
`,e.jsx(n.h3,{id:"state-search",children:"State (Search)"}),`
`,e.jsxs(n.p,{children:["The table exposes a public ",e.jsx(n.code,{children:"state"}),` object for external state management.
Right now it contains `,e.jsx(n.code,{children:"searchQuery"})," and is designed to be extended."]}),`
`,e.jsxs(n.p,{children:["Use ",e.jsx(n.code,{children:"setState()"})," to update search from outside:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`const table = document.querySelector('gds-table')
table.setState({ searchQuery: 'active users' })
`})}),`
`,e.jsxs(n.p,{children:["Listen to ",e.jsx(n.code,{children:"gds-state-change"})," to sync parent/store state when users type:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`table.addEventListener('gds-state-change', (e) => {
  const { searchQuery } = e.detail.state
  // dispatch to store / sync app state
})
`})}),`
`,e.jsx(n.p,{children:"Read current state anytime:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`const current = table.getState()
`})}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"virtualization",children:"Virtualization"}),`
`,e.jsxs(n.p,{children:["Keep these two rules when using ",e.jsx(n.code,{children:"virtualized"}),":"]}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["Use a ",e.jsx(n.strong,{children:"stable unique row id"})," for every row (and expanded child row). Duplicate IDs can cause DOM reuse collisions and visible flicker."]}),`
`,e.jsxs(n.li,{children:["Keep async expansion behavior ",e.jsx(n.strong,{children:"deterministic"})," in stress/debug scenarios (avoid having delays), so row measurement and re-render timing stay predictable."]}),`
`]}),`
`,e.jsx(n.hr,{}),`
