import{b as h,d as l,i as u}from"./declarative-layout-mixins-DbXOEhQt.js";var r;class m{constructor(t){h(this,r,s=>{const o=s.target;if(!this.host.navigableItems.includes(o))return;let n=!1;if(s.key==="ArrowDown"){const e=this.host.navigableItems.indexOf(o)+1;this.host.navigableItems[e]?.focus(),n=!0}else if(s.key==="ArrowUp"){const e=this.host.navigableItems.indexOf(o)-1;this.host.navigableItems[e]?.focus(),n=!0}else if(s.key==="Home")this.host.navigableItems[0]?.focus(),n=!0;else if(s.key==="End")this.host.navigableItems[this.host.navigableItems.length-1]?.focus(),n=!0;else{const e=s.key.toLowerCase();if(e.length!==1)return;const a=e>="a"&&e<="z",d=e>="0"&&e<="9";(a||d)&&(this.host.navigableItems.find(c=>c.textContent?.trim().toLowerCase()?.startsWith(e))?.focus(),n=!0)}n&&(s.preventDefault(),s.stopPropagation())}),(this.host=t).addController(this)}hostConnected(){this.host.addEventListener("keydown",l(this,r))}hostDisconnected(){this.host.removeEventListener("keydown",l(this,r))}}r=new WeakMap;function f(i){let t=i;for(;t.assignedElements().length>0&&t.assignedElements()[0].nodeName==="SLOT";)t=t.assignedElements()[0];return t}const y=i=>{class t extends i{focus(o){this.setAttribute("tabindex","0"),super.focus(o)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",o=>{this.setAttribute("tabindex","-1"),this.dispatchEvent(new FocusEvent("gds-blur",{bubbles:!1,composed:!0,relatedTarget:o.relatedTarget}))}),this.addEventListener("focus",o=>{this.dispatchEvent(new FocusEvent("gds-focus",{bubbles:!1,composed:!0,relatedTarget:o.relatedTarget}))})}}return t},g=u`
  @layer base, reset;
...
`;var x=g;export{y as F,m as L,x as o,f as u};
