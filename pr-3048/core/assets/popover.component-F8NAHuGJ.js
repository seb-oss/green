import{a8 as V,i as H,n as r,C as T,l as A,$ as b,a as K,D as I,B as U,T as G,e as F,H as z,h as X}from"./iframe-CrCFIEgk.js";import{l as Y}from"./localized-decorator-BeH7Pw7b.js";import{o as q,s as Q,a as J,c as Z}from"./floating-ui.dom-DPpwG6Py.js";import{I as j}from"./cross-small.component-CXIfSSzK.js";function tt(t){return(e,o,n)=>{if(V)return;const l=window.matchMedia(t),d=e.connectedCallback,y=e.disconnectedCallback;e.connectedCallback=function(){d?.call(this);const W=O=>{n.value?.call(this,O.matches)};l.addEventListener("change",W),this.disconnectedCallback=function(){y?.call(this),l.removeEventListener("change",W)},n.value?.call(this,l.matches)}}}const et=H`
