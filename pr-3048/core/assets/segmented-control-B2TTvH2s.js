import{i as z,R as W,B as $,T as B,h as P,y as L,n as g,a as V,J as E,z as D,H as O,l as S,C as T,$ as G,D as R}from"./iframe-CrCFIEgk.js";import{l as N}from"./localized-decorator-BeH7Pw7b.js";import{r as X}from"./resize-observer-CfkbZofs.js";import{I as A}from"./chevron-left.component-DDNNy6D_.js";import{I as F}from"./chevron-right.component-C_xfnKts.js";const H=z`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var J=Object.defineProperty,j=Object.getOwnPropertyDescriptor,m=(t,e,s,r)=>{for(var i=r>1?void 0:r?j(e,s):e,a=t.length-1,h;a>=0;a--)(h=t[a])&&(i=(r?h(e,s,i):h(i))||i);return r&&i&&J(e,s,i),i};let p=class extends W($){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return P`<button
