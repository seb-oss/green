import{m as c,l as Ot}from"./runtime-CNluP0A8.js";import{T as tt,i as Rt,E as Ft}from"./lit-element-Bx14lxc-.js";import{n as m,r as Z}from"./Reflect-DJ7r0WLU.js";import{e as Ht,a as $t}from"./query-p8xgzTDt.js";import{r as J}from"./query-async-MEroNOeJ.js";import{e as Yt,i as qt,t as Kt}from"./directive-CF8sV3Lr.js";import{p as Xt,v as I,r as N,M as Q,m as Ut,i as Zt}from"./directive-helpers-BF33kFuJ.js";import{f as Jt}from"./ref-R0wBYijq.js";import{n as E}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-qvVtjlow.js";import{G as te}from"./dropdown.component-_vS9ivuW.js";import{G as ee}from"./flex.component-Epeze9ko.js";import{G as se,h as w,g as Wt}from"./gds-element-DTROifYq.js";import{f as ae}from"./form-control-host.style-BAeDnTMc.js";import{t as ie}from"./tokens.style-CJKwYBen.js";import{T as ne}from"./transitional-styles-BfqUw7Aj.js";import{w as bt}from"./watch-tFciLXSI.js";import{d as wt,a as re}from"./attribute-converters-CdI0trPX.js";import{w as oe,b as le,d as he}from"./declarative-layout-mixins-DFPXvh_g.js";import{G as de,i as ue}from"./calendar.component-XqTDQmB4.js";import{I as ce,a as pe}from"./calender-add.component-1JUcZ9gO.js";import{I as ge,a as fe}from"./chevron-right.component-Cs1IvQXA.js";import{G as me}from"./popover.component-CJKfdbo4.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},be=Yt(class extends qt{constructor(t){if(super(t),t.type!==Kt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let h=0;for(const p of t)a[h]=i?i(p,h):h,n[h]=s(p,h),h++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Xt(t),{values:n,keys:h}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=h,n;const p=this.ut??(this.ut=[]),r=[];let k,D,d=0,b=a.length-1,v=0,C=n.length-1;for(;d<=b&&v<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(p[d]===h[v])r[v]=I(a[d],n[v]),d++,v++;else if(p[b]===h[C])r[C]=I(a[b],n[C]),b--,C--;else if(p[d]===h[C])r[C]=I(a[d],n[C]),N(t,r[C+1],a[d]),d++,C--;else if(p[b]===h[v])r[v]=I(a[b],n[v]),N(t,a[d],a[b]),b--,v++;else if(k===void 0&&(k=Dt(h,v,C),D=Dt(p,d,b)),k.has(p[d]))if(k.has(p[b])){const S=D.get(h[v]),j=S!==void 0?a[S]:null;if(j===null){const kt=N(t,a[d]);I(kt,n[v]),r[v]=kt}else r[v]=I(j,n[v]),N(t,a[d],j),a[S]=null;v++}else Q(a[b]),b--;else Q(a[d]),d++;for(;v<=C;){const S=N(t,r[C+1]);I(S,n[v]),r[v++]=S}for(;d<=b;){const S=a[d++];S!==null&&Q(S)}return this.ut=h,Ut(t,r),tt}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
