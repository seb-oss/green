...
\`\`\``,...(ue=(ce=x.parameters)==null?void 0:ce.docs)==null?void 0:ue.description}}};var me,fe,be,he,ve;c.parameters={...c.parameters,docs:{...(me=c.parameters)==null?void 0:me.docs,source:{originalSource:`{
  ...
  \`
}`,...(we=(ye=u.parameters)==null?void 0:ye.docs)==null?void 0:we.source},description:{story:"The `disabled` property can be set to disable the textarea field.\n\n**@property disabled** - Disables the textarea field.\n\n```html\n <gds-textarea disabled></gds-textarea>\n```",...(ze=(Se=u.parameters)==null?void 0:Se.docs)==null?void 0:ze.description}}};const gt=["Default","Lead","Trail","Length","Rows","Resize","Size","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","Disabled"];export{i as Clearable,m as Default,u as Disabled,p as ExtendedSupportingText,r as Lead,n as Length,d as Resize,l as Rows,o as Size,c as StandardAttributes,g as SupportingText,s as Trail,x as Validation,gt as __namedExportsOrder,it as default};
