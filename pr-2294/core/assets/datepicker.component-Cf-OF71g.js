import{m as c,l as Ot}from"./runtime-CNluP0A8.js";import{T as Q,i as Vt,E as St}from"./lit-element-Bx14lxc-.js";import{n as m,r as X}from"./Reflect-DJ7r0WLU.js";import{e as Rt,a as yt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as Ht,t as qt}from"./directive-CF8sV3Lr.js";import{p as Kt,v as I,r as A,M as U,m as Xt,i as Zt}from"./directive-helpers-BF33kFuJ.js";import{f as Jt}from"./ref-R0wBYijq.js";import{n as E}from"./when-BR7zwNJC.js";import{a as Ut,G as jt}from"./button.component-CLPWbXlB.js";import{G as Qt}from"./dropdown.component-DkQ9ahlc.js";import{G as te}from"./flex.component-CHYyV8f-.js";import{G as ee,h as w,g as Yt}from"./gds-element-DJNCW3iR.js";import{f as se}from"./form-control-host.style-ClrCrq8A.js";import{t as ae}from"./tokens.style-iX6aIK9m.js";import{T as ie}from"./transitional-styles-DRTvhbpp.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as $t,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as re,b as oe,d as le}from"./declarative-layout-mixins-CquYcIh8.js";import{G as he,i as de}from"./calendar.component-BVX2B9aI.js";import{I as ue,a as pe}from"./calender-add.component-DPB7W6y3.js";import{I as ce,a as ge}from"./chevron-right.component-DhYbfXgM.js";import{G as fe}from"./popover.component-BTUjX2CI.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends Ht{constructor(t){if(super(t),t.type!==qt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let h=0;for(const p of t)a[h]=i?i(p,h):h,n[h]=s(p,h),h++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Kt(t),{values:n,keys:h}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=h,n;const p=this.ut??(this.ut=[]),r=[];let k,M,d=0,b=a.length-1,v=0,C=n.length-1;for(;d<=b&&v<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(p[d]===h[v])r[v]=I(a[d],n[v]),d++,v++;else if(p[b]===h[C])r[C]=I(a[b],n[C]),b--,C--;else if(p[d]===h[C])r[C]=I(a[d],n[C]),A(t,r[C+1],a[d]),d++,C--;else if(p[b]===h[v])r[v]=I(a[b],n[v]),A(t,a[d],a[b]),b--,v++;else if(k===void 0&&(k=Ct(h,v,C),M=Ct(p,d,b)),k.has(p[d]))if(k.has(p[b])){const S=M.get(h[v]),J=S!==void 0?a[S]:null;if(J===null){const xt=A(t,a[d]);I(xt,n[v]),r[v]=xt}else r[v]=I(J,n[v]),A(t,a[d],J),a[S]=null;v++}else U(a[b]),b--;else U(a[d]),d++;for(;v<=C;){const S=A(t,r[C+1]);I(S,n[v]),r[v++]=S}for(;d<=b;){const S=a[d++];S!==null&&U(S)}return this.ut=h,Xt(t,r),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Se=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,Pt=t=>{throw TypeError(t)},l=(t,e,s,i)=>{for(var a=i>1?void 0:i?Fe(e,s):e,n=t.length-1,h;n>=0;n--)(h=t[n])&&(a=(i?h(e,s,a):h(a))||a);return i&&a&&Se(e,s,a),a},wt=(t,e,s)=>e.has(t)||Pt("Cannot "+s),g=(t,e,s)=>(wt(t,e,"read from private field"),s?s.call(t):e.get(t)),y=(t,e,s)=>e.has(t)?Pt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),j=(t,e,s,i)=>(wt(t,e,"write to private field"),e.set(t,s),s),f=(t,e,s)=>(wt(t,e,"access private method"),s),B,u,Tt,Nt,q,At,zt,it,P,N,Lt,nt,rt,ot,lt,ht,dt,ut,pt,ct,K,gt,ft,mt,vt,Y,Bt,Gt;let o=class extends Ut{constructor(){super(),y(this,u),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.clearable=!1,this.hideTodayButton=!1,this.utcHours=12,this.disabledWeekends=!1,this.showExtendedSupportingText=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=f(this,u,mt).call(this,"y-m-d"),y(this,B),y(this,Lt,t=>{this._elTrigger.then(e=>{var i,a;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((a=document.getSelection())==null||a.removeAllRanges())})}),y(this,nt,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),y(this,rt,t=>{this._elFieldAsync.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),y(this,ot,t=>{this._elFieldAsync.then(e=>{var h;if(t.currentTarget!==e)return;t.preventDefault();const s=(h=t.clipboardData)==null?void 0:h.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const p=this._dateFormatLayout.layout,r=parseInt(n[p.findIndex(d=>d.token==="y")]),k=parseInt(n[p.findIndex(d=>d.token==="m")])-1,M=parseInt(n[p.findIndex(d=>d.token==="d")]);!isNaN(r)&&!isNaN(k)&&!isNaN(M)&&(i=new Date(`${r}-${k+1}-${M}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,f(this,u,P).call(this))})}),y(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),y(this,ht,t=>{t.stopPropagation(),this.value=new Date(t.detail),this.open=!1,f(this,u,P).call(this),f(this,u,N).call(this)}),y(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),y(this,ut,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),y(this,pt,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),y(this,ct,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),y(this,K,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=new Date((await this._elCalendar).focusedDate),this.requestUpdate(),f(this,u,N).call(this)}),y(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;if(!e){this.value=void 0,f(this,u,P).call(this);return}!de(e||new Date(0),g(this,B)||new Date(0))&&(this.value=new Date(e),f(this,u,P).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=g(this,B),f(this,u,N).call(this))}}),y(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),y(this,vt,(t,e)=>{g(this,Y)[e]=t;const s=new Date;s.setFullYear(parseInt(g(this,Y).year)),s.setMonth(parseInt(g(this,Y).month)-1),s.setDate(parseInt(g(this,Y).day)),s.setUTCHours(this.utcHours,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,f(this,u,P).call(this),f(this,u,N).call(this))}),y(this,Y,{year:"yyyy",month:"mm",day:"dd"}),D.define()}get type(){return"gds-datepicker"}get value(){return super.value}set value(t){super.value=t}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=f(this,u,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),ie.instance.apply(this,"gds-datepicker")}focus(t){var e;(e=this._getValidityAnchor())==null||e.focus(t)}render(){return w`
    ...
    `}_getValidityAnchor(){return this._elSpinners[0]}_handleValueChange(){if(this.value===""&&(this.value=void 0),!this.value){j(this,Y,{year:"yyyy",month:"mm",day:"dd"});return}const t=this.value;this._focusedMonth=t.getMonth(),this._focusedYear=t.getFullYear();const e=t.getFullYear().toString(),s=(t.getMonth()+1).toString().padStart(2,"0"),i=t.getDate().toString().padStart(2,"0");j(this,Y,{year:e,month:s,day:i})}_handleOpenChange(){this.open&&(j(this,B,this.value),this._elCalendar.then(t=>t.focus()))}};B=new WeakMap;u=new WeakSet;Tt=function(){return!this.plain};Nt=async function(){const t=await this.getFocusedDate();let e="",s;return t&&t>this.max?(e=c("Last available date"),s=i=>{i.stopPropagation(),f(this,u,q).call(this,this.max)}):t&&t<this.min&&(e=c("First available date"),s=i=>{i.stopPropagation(),f(this,u,q).call(this,this.min)}),w`${E(e.length>0,()=>w`<gds-button rank="tertiary" size="small" @click=${s}>
          ${e}
        </gds-button>`,()=>St)}`};q=function(t){const e=new Date(t);this._elCalendar.then(s=>s.focusedDate=e).then(g(this,K))};At=function(t){return`${{year:c("Year"),month:c("Month"),day:c("Day")}[t]} ${this.label}`};zt=function(t){return{year:1900,month:1,day:1}[t]};it=function(t){return{year:9999,month:12,day:31}[t]};P=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("change",{bubbles:!0,composed:!0}))};N=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))};Lt=new WeakMap;nt=new WeakMap;rt=new WeakMap;ot=new WeakMap;lt=new WeakMap;ht=new WeakMap;dt=new WeakMap;ut=new WeakMap;pt=new WeakMap;ct=new WeakMap;K=new WeakMap;gt=new WeakMap;ft=new WeakMap;mt=function(t){const e=t.replace(/[a-z0-9]/gi,"")[0],s=t.split(e),i=s.findIndex(r=>r==="y"),a=s.findIndex(r=>r==="m"),n=s.findIndex(r=>r==="d");if(i===-1||a===-1||n===-1)throw new Error("Invalid date format for <gds-datepicker>");const p=[i,a,n].sort((r,k)=>r-k).map(r=>s[r]).map(r=>({token:r,name:r==="y"?"year":r==="m"?"month":"day"}));return{delimiter:e,layout:p}};vt=new WeakMap;Y=new WeakMap;Bt=function(){var a;const t=this.min.getFullYear(),e=this.max.getFullYear(),s=g(this,u,Gt),i=(a=this.value)==null?void 0:a.getFullYear();return{*[Symbol.iterator](){s&&(yield i);for(let n=t;n<=e;n++)yield n}}};Gt=function(){return this.value?this.value.getFullYear()<this.min.getFullYear()||this.value.getFullYear()>this.max.getFullYear():!1};o.styles=[ae,se,De];l([m({converter:$t})],o.prototype,"value",1);l([m({converter:$t})],o.prototype,"min",2);l([m({converter:$t})],o.prototype,"max",2);l([m({type:Boolean})],o.prototype,"open",2);l([m({attribute:"supporting-text"})],o.prototype,"supportingText",2);l([m({type:String})],o.prototype,"size",2);l([m({type:Boolean})],o.prototype,"plain",2);l([m({type:Boolean,attribute:"show-week-numbers"})],o.prototype,"showWeekNumbers",2);l([m({type:Boolean,attribute:"hide-label"})],o.prototype,"hideLabel",2);l([m({type:Boolean,attribute:"clearable"})],o.prototype,"clearable",2);l([m({type:Boolean,attribute:"hide-today-button"})],o.prototype,"hideTodayButton",2);l([m({type:Number,attribute:"utc-hours"})],o.prototype,"utcHours",2);l([m()],o.prototype,"dateformat",1);l([m({type:Boolean,attribute:"disabled-weekends"})],o.prototype,"disabledWeekends",2);l([m({converter:ne,attribute:"disabled-dates"})],o.prototype,"disabledDates",2);l([m({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],o.prototype,"showExtendedSupportingText",2);l([Z("#calendar-button")],o.prototype,"test_calendarButton",2);l([yt("#clear-button")],o.prototype,"test_clearButton",2);l([yt("#today-button")],o.prototype,"test_todayButton",2);l([X()],o.prototype,"_focusedMonth",2);l([X()],o.prototype,"_focusedYear",2);l([X()],o.prototype,"_dateFormatLayout",2);l([Z("#calendar")],o.prototype,"_elCalendar",2);l([Z("#calendar-button")],o.prototype,"_elTrigger",2);l([Z("#field")],o.prototype,"_elFieldAsync",2);l([ve("[role=spinbutton]")],o.prototype,"_elSpinners",2);l([yt("#field")],o.prototype,"_elField",2);l([_t("value")],o.prototype,"_handleValueChange",1);l([_t("open")],o.prototype,"_handleOpenChange",1);o=l([Ot()],o);let Dt=class extends re(oe(le(o))){};Dt=l([Yt("gds-datepicker",{dependsOn:[te,jt,Qt,he,fe,ue,pe,ce,ge]})],Dt);export{Dt as G,Ce as m};
