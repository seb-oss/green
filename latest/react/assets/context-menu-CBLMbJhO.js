import{R as _}from"./iframe-D23TSDUQ.js";import{o as x}from"./create-component-CPRSibq9.js";import{b as o,d as t,h as i,G as g,_ as n,g as m,i as L,l as A,e as $,c as T,t as H,n as l,a as M}from"./tokens.style-CGeTXhoz.js";import{m as I,l as S}from"./runtime-nRyYmvPb.js";import{e as B,w as N,a as O}from"./watch-D4TsY_hu.js";import{n as R}from"./when-BR7zwNJC.js";import{F as W,o as z,L as F,u as P}from"./unwrap-slots-BQ6ud1l4.js";import{T as b,r as D}from"./transitional-styles-CJmub25o.js";import{e as U,n as q}from"./ref-BNxl2HBz.js";import{b as K,d as j}from"./icon.component-BU7316WH.js";import{G as J}from"./button.component-CfMYFj4D.js";import{I as E}from"./dot-grid-one-horizontal.component-vj9QhoNy.js";import{a as Q,G as V}from"./popover.component-DBd5zO9l.js";var f;let r=class extends W(g){constructor(){super(...arguments),o(this,f,()=>{this.dispatchCustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0})})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this.click())}),this.addEventListener("click",t(this,f)),b.instance.apply(this,"gds-option")}render(){return i`<div class="item"><slot></slot></div>`}};f=new WeakMap;r.styles=[z];r=n([m("gds-menu-item")],r);var d;let y=class extends g{constructor(){super(),o(this,d,U()),new F(this)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),b.instance.apply(this,"gds-listbox")}get navigableItems(){return t(this,d).value?P(t(this,d).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-menu-item")||[]:[]}focus(){var e;(e=this.navigableItems[0])==null||e.focus()}render(){return i`<slot ${q(t(this,d))}></slot>`}};d=new WeakMap;y=n([m("gds-menu",{dependsOn:[r]})],y);E.define();const X=L`
