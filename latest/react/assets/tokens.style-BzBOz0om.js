 ...
 */
  ...
  --gds-sys-color-state-warning-06: #8f530a 16%;`,Pt=`/**
 * Do not edit directly, this file was auto-generated.
 */
  ...
  --gds-sys-shadow-2xl-02: 0px 0px 0px 0px transparent;`;var Is={};const Le=typeof process<"u"&&Is!==void 0;var ye,F,Q,Ee,Pe,Dt,De,Rt,Re,Gt;function js(){return Le?[]:[...document.adoptedStyleSheets]}const Ns=class Ut{constructor(){x(this,Pe),x(this,De),x(this,Re),x(this,ye,!Tt()),x(this,F,new Map),x(this,Q,new Map),x(this,Ee,js())}static get instance(){var e;return(e=globalThis.__gdsGlobalStylesRegistryScoped)!=null&&e[H]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[H]:new Ut}),globalThis.__gdsGlobalStylesRegistryScoped[H]}injectGlobalStyles(e,t){if(y(this,ye)){const s=Array.isArray(t)?t.map(r=>r.toString()).join(""):t.toString();T(this,Pe,Dt).call(this,e,s)}else t.styleSheet&&T(this,De,Rt).call(this,e,t.styleSheet)}clearGlobalStyles(e){if(y(this,ye)){const t=y(this,Q).get(e);t&&t.parentNode&&(t.parentNode.removeChild(t),y(this,Q).delete(e))}else T(this,Re,Gt).call(this,e)}};ye=new WeakMap;F=new WeakMap;Q=new WeakMap;Ee=new WeakMap;Pe=new WeakSet;Dt=function(n,e){if(Le)return;let t=y(this,Q).get(n);t||(t=document.createElement("style"),y(this,Q).set(n,t)),t.textContent=e,document.head.appendChild(t)};De=new WeakSet;Rt=function(n,e){Le||(y(this,F).set(n,e),document.adoptedStyleSheets=[...y(this,Ee),...Array.from(y(this,F).values())])};Re=new WeakSet;Gt=function(n){y(this,F).has(n)&&(y(this,F).delete(n),document.adoptedStyleSheets=[...y(this,Ee),...Array.from(y(this,F).values())])};let Hs=Ns;const Js=[Et`
    :host {
      ${D(Ot)}
      ${D(Pt)}
    }
  ...
  `);export{$ as A,K as E,be as G,H as V,_t as _,Zs as a,x as b,T as c,y as d,I as e,D as f,Fs as g,qs as h,Et as i,zs as j,mt as k,ws as l,Le as m,Bt as n,Tt as o,Ps as r,St as s,Js as t};
