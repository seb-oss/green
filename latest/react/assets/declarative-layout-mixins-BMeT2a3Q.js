 ...
 */
  ...
  --gds-sys-color-state-warning-06: #f19e38 20%;`,vt=`/**
 * Do not edit directly, this file was auto-generated.
 */
  ...
  --gds-sys-color-state-warning-06: #8f530a 16%;`,Ot=`/**
 * Do not edit directly, this file was auto-generated.
 */
  ...
  --gds-sys-shadow-2xl-02: 0px 0px 0px 0px transparent;`,z="-349207";class Ve{static get instance(){return globalThis.__gdsElementLookupTable?.[z]||(globalThis.__gdsElementLookupTable={...globalThis.__gdsElementLookupTable,[z]:new Map}),globalThis.__gdsElementLookupTable[z]}}const an=(s,e)=>function(t){var n;return n=class extends t{constructor(){super(...arguments),this.gdsElementName=s}static define(){if(n.isDefined)return;const a=globalThis.GDS_DISABLE_VERSIONED_ELEMENTS?s:s+z;customElements.get(a)||(n.isDefined=!0,Ve.instance.set(s,a),customElements.define(a,n),e?.dependsOn&&e.dependsOn.forEach(c=>c.define()))}},n.isDefined=!1,n},_t=new WeakMap;function Ns(s,...e){let t=_t.get(s);return t||(t=bt(s),t.raw=bt(s.raw),_t.set(s,t)),[t,...e]}const bt=s=>s.map(e=>{for(const[t,n]of Ve.instance.entries())e=e.replace(new RegExp(`${t}(?![-a-z])`,"mg"),n);return e});function Hs(s){return(e,...t)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return s(e,...t);const[n,...r]=Ns(e,...t);return s(n,...r)}}const ln=Hs(ks);function cn(s,e=!1){return Ve.instance.get(s)??s+(e?z:"")}var G,me,N,ve,V,U,I,_e,Oe,Dt,K,ie,De,Rt;class Ls{constructor(e){B(this,Oe),B(this,K),B(this,De),B(this,G,!Gt()),B(this,me,!1),B(this,N,[]),B(this,ve,[]),B(this,V,new Map),B(this,U,new Map),B(this,I,[]),B(this,_e,[]),this.host=e,this.host.addController(this)}hostConnected(){D(this,De,Rt).call(this)}has(e){return p(this,G)?p(this,U).has(e):p(this,V).has(e)}inject(e,t){D(this,Oe,Dt).call(this,e,t),D(this,K,ie).call(this)}clear(e){p(this,G)?this.host.updateComplete.then(()=>{p(this,U).get(e)?.remove(),p(this,U).delete(e)}):p(this,V).delete(e),D(this,K,ie).call(this)}clearAll(){p(this,G)?this.host.updateComplete.then(()=>{p(this,U).forEach(e=>e.remove()),p(this,I).forEach(e=>e.remove()),p(this,U).clear(),L(this,I,[])}):this.host.shadowRoot&&(this.host.shadowRoot.adoptedStyleSheets=[],p(this,V).clear(),L(this,N,[]))}clearInitial(){p(this,G)?this.host.updateComplete.then(()=>{p(this,I).forEach(e=>e.remove()),L(this,I,[])}):L(this,N,[]),D(this,K,ie).call(this)}restoreInitial(){p(this,G)?p(this,_e).forEach(e=>{p(this,I).push(e.cloneNode(!0))}):L(this,N,[...p(this,ve)]),D(this,K,ie).call(this)}}G=new WeakMap;me=new WeakMap;N=new WeakMap;ve=new WeakMap;V=new WeakMap;U=new WeakMap;I=new WeakMap;_e=new WeakMap;Oe=new WeakSet;Dt=function(s,e){if(p(this,G)){let t=p(this,U).get(s);t||(t=document.createElement("style"),p(this,U).set(s,t)),t.textContent=e.cssText}else{if(!this.host.shadowRoot||!e.styleSheet)return;p(this,V).set(s,e.styleSheet)}};K=new WeakSet;ie=function(){if(p(this,G))this.host.updateComplete.then(()=>{this.host.shadowRoot&&(this.host.shadowRoot.querySelectorAll("style").forEach(s=>{s.remove()}),p(this,I).forEach(s=>{this.host.shadowRoot?.appendChild(s)}),p(this,U).forEach(s=>{this.host.shadowRoot?.appendChild(s)}))});else{if(!this.host.shadowRoot)return;this.host.shadowRoot.adoptedStyleSheets=[...p(this,N),...Array.from(p(this,V).values())]}};De=new WeakSet;Rt=function(){p(this,me)||(p(this,G)?this.host.updateComplete.then(()=>{this.host.shadowRoot&&this.host.shadowRoot.querySelectorAll("style").forEach(s=>{p(this,I).push(s),p(this,_e).push(s.cloneNode(!0))})}):this.host.shadowRoot&&p(this,N).length===0&&(L(this,N,[...this.host.shadowRoot.adoptedStyleSheets||[]]),L(this,ve,[...p(this,N)])),L(this,me,!0))};function Gt(){try{return new CSSStyleSheet,!0}catch{return!1}}var Ws={};const Ze=typeof process<"u"&&Ws!==void 0;var ye,Z,ee,xe,Re,Ut,Ge,jt,Ue,It;function zs(){return Ze?[]:[...document.adoptedStyleSheets]}const qs=class Nt{constructor(){B(this,Re),B(this,Ge),B(this,Ue),B(this,ye,!Gt()),B(this,Z,new Map),B(this,ee,new Map),B(this,xe,zs())}static get instance(){return globalThis.__gdsGlobalStylesRegistryScoped?.[z]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[z]:new Nt}),globalThis.__gdsGlobalStylesRegistryScoped[z]}injectGlobalStyles(e,t){if(p(this,ye)){const n=Array.isArray(t)?t.map(r=>r.toString()).join(""):t.toString();D(this,Re,Ut).call(this,e,n)}else t.styleSheet&&D(this,Ge,jt).call(this,e,t.styleSheet)}clearGlobalStyles(e){if(p(this,ye)){const t=p(this,ee).get(e);t&&t.parentNode&&(t.parentNode.removeChild(t),p(this,ee).delete(e))}else D(this,Ue,It).call(this,e)}};ye=new WeakMap;Z=new WeakMap;ee=new WeakMap;xe=new WeakMap;Re=new WeakSet;Ut=function(s,e){if(Ze)return;let t=p(this,ee).get(s);t||(t=document.createElement("style"),p(this,ee).set(s,t)),t.textContent=e,document.head.appendChild(t)};Ge=new WeakSet;jt=function(s,e){Ze||(p(this,Z).set(s,e),document.adoptedStyleSheets=[...p(this,xe),...Array.from(p(this,Z).values())])};Ue=new WeakSet;It=function(s){p(this,Z).has(s)&&(p(this,Z).delete(s),document.adoptedStyleSheets=[...p(this,xe),...Array.from(p(this,Z).values())])};let Fs=qs;const dn=[Bt`
    :host {
      ${R(Pt)}
      ${R(Ot)}
    }
  `];Fs.instance.injectGlobalStyles("root-tokens",Bt`
    :root {
      ${R(Pt)}
      ${R(Ot)}
    }
