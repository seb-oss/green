import{l as q,A as S,i as R,G as B,t as U,_ as s,g as D,m as O,n as i,b,e as $,d as a,h as P}from"./tokens.style-BXOjG97O.js";import{e as _,w as I}from"./watch-Bh1rs_BK.js";import{e as H}from"./class-map-Cly5oK8d.js";import{n as j}from"./when-BR7zwNJC.js";import{e as X,i as K,t as Y,s as J,w as Q,b as Z,d as tt}from"./icon.component-D-KSF2uV.js";import{T as et}from"./transitional-styles-BuelKE2F.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z=Symbol.for(""),rt=o=>{if((o==null?void 0:o.r)===z)return o==null?void 0:o._$litStatic$},wt=o=>({_$litStatic$:o,r:z}),L=(o,...t)=>({_$litStatic$:t.reduce((r,e,l)=>r+(c=>{if(c._$litStatic$!==void 0)return c._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${c}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(e)+o[l+1],o[0]),r:z}),F=new Map,ot=o=>(t,...r)=>{const e=r.length;let l,c;const g=[],y=[];let x,u=0,m=!1;for(;u<e;){for(x=t[u];u<e&&(c=r[u],(l=rt(c))!==void 0);)x+=l+t[++u],m=!0;u!==e&&y.push(c),g.push(x),u++}if(u===e&&g.push(t[e]),m){const A=g.join("$$lit$$");(t=F.get(A))===void 0&&(g.raw=g,F.set(A,t=g)),r=y}return o(t,...r)},st=ot(q);/**
 * @license
...
`;var gt=dt,k,v,h,E,N,V,M,C;const pt=["aria-label","aria-haspopup","aria-expanded"],ut=[...pt,"gds-tabindex"],vt=ct(P);class n extends p{constructor(){super(...arguments),b(this,v),b(this,E),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.wrapped=!1,this.href="",b(this,k,!1),b(this,V,()=>{var r;const t=((r=this._mainSlot)==null?void 0:r.assignedElements())??[];$(this,k,t.length===1&&(t[0].tagName.toLowerCase().startsWith("gds-icon")||t[0].getAttribute("name")==="icon")),this.requestUpdate()}),b(this,M,t=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:t}),this.form&&!a(this,v,h)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())}),b(this,C,t=>{if(!this.disabled&&(t.code==="Space"||t.key==="Enter")&&!t.repeat){const r=this._ripple;r&&r.triggerRipple()}})}focus(t){var r;(r=this._getValidityAnchor())==null||r.focus(t)}click(){var t;(t=this._getValidityAnchor())==null||t.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),et.instance.apply(this,"gds-button")}render(){const t={button:!0,circle:a(this,k),icon:a(this,k),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary",wrapped:this.wrapped},r=a(this,v,h)?L`a`:L`button`;return st`
      <${r}
        ...
        rel=${f(a(this,v,h)?this.rel||a(this,E,N):void 0)}
      ...
      `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}k=new WeakMap;v=new WeakSet;h=function(){return this.href.length>0};E=new WeakSet;N=function(){return this.target==="_blank"?"noreferrer noopener":void 0};V=new WeakMap;M=new WeakMap;C=new WeakMap;n.styles=[U,gt];n.shadowRootOptions={mode:"open",delegatesFocus:!0};s([i({type:Boolean,reflect:!0})],n.prototype,"disabled",2);s([J({selector:".button"})],n.prototype,"justify-content",2);s([i({reflect:!0})],n.prototype,"type",2);s([i({reflect:!0})],n.prototype,"rank",2);s([i({reflect:!0})],n.prototype,"variant",2);s([i({reflect:!0})],n.prototype,"size",2);s([i()],n.prototype,"label",2);s([i({attribute:"wrapped",type:Boolean,reflect:!0})],n.prototype,"wrapped",2);s([i()],n.prototype,"href",2);s([i()],n.prototype,"target",2);s([i()],n.prototype,"rel",2);s([i()],n.prototype,"download",2);s([_("slot:not([name])")],n.prototype,"_mainSlot",2);s([_(".button")],n.prototype,"_button",2);s([_("gds-ripple")],n.prototype,"_ripple",2);s([nt({attributes:!0,childList:!1,subtree:!1,characterData:!1})],n.prototype,"_attributeChanged",1);let W=class extends Q(Z(tt(n))){};W=s([D("gds-button",{dependsOn:[w]})],W);export{W as G,p as a,f as b,nt as o,wt as s,st as u};
