import{i as p,b as f,d as g}from"./tokens.style-BXOjG97O.js";const x=r=>{class s extends r{focus(o){this.setAttribute("tabindex","0"),super.focus(o)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",o=>{this.setAttribute("tabindex","-1"),this.dispatchEvent(new FocusEvent("gds-blur",{bubbles:!1,composed:!0,relatedTarget:o.relatedTarget}))}),this.addEventListener("focus",o=>{this.dispatchEvent(new FocusEvent("gds-focus",{bubbles:!1,composed:!0,relatedTarget:o.relatedTarget}))})}}return s},m=p`
  @layer base, reset;
