import{R as _}from"./iframe-CQUnwiD8.js";import{o as x}from"./create-component-CPRSibq9.js";import{b as a,d as t,h as i,G as m,_ as n,g,i as L,l as A,e as $,c as T,t as H,n as l,a as M}from"./tokens.style-B9dm16Su.js";import{m as I,l as S}from"./runtime-nRyYmvPb.js";import{e as N,w as O}from"./watch-Bh1rs_BK.js";import{n as R}from"./when-BR7zwNJC.js";import{F as W,o as z,L as B,u as P}from"./unwrap-slots-B0NuvAPR.js";import{T as b,r as D}from"./transitional-styles-DrHEwaoE.js";import{e as F,n as U}from"./ref-DJiapoSF.js";import{b as q,d as K}from"./icon.component-Buf0R8yE.js";import{G as j}from"./button.component-1bcRdqQh.js";import{I as E}from"./dot-grid-one-horizontal.component-uhOf-2kd.js";import{a as J,G as Q}from"./popover.component-45HW-Jtg.js";var f;let r=class extends W(m){constructor(){super(...arguments),a(this,f,()=>{this.dispatchCustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0})})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this.click())}),this.addEventListener("click",t(this,f)),b.instance.apply(this,"gds-option")}render(){return i`<div class="item"><slot></slot></div>`}};f=new WeakMap;r.styles=[z];r=n([g("gds-menu-item")],r);var d;let y=class extends m{constructor(){super(),a(this,d,F()),new B(this)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),b.instance.apply(this,"gds-listbox")}get navigableItems(){return t(this,d).value?P(t(this,d).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-menu-item")||[]:[]}focus(){var e;(e=this.navigableItems[0])==null||e.focus()}render(){return i`<slot ${U(t(this,d))}></slot>`}};d=new WeakMap;y=n([g("gds-menu",{dependsOn:[r]})],y);E.define();const V=L`
