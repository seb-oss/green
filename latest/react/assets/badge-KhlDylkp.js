import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as r}from"./iframe-CQUnwiD8.js";function u({children:o,badgeType:s,isCloseable:i,closeText:l,customColor:a,customBackgroundColor:t,...d}){const[c,p]=r.useState(!1),[m,n]=r.useState("");return r.useEffect(()=>{s&&n(s),(a||t)&&n("")},[s,a,t]),c?null:e.jsxs("span",{...d,className:`gds-badge ${m}`,style:{color:a,backgroundColor:t},children:[e.jsx("strong",{children:o}),i&&e.jsxs("button",{type:"button",className:"close",onClick:()=>p(!0),children:[l,e.jsx("i",{})]})]})}u.__docgenInfo={description:`Renders a badge component.
