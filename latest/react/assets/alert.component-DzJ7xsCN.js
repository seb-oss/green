import{i as H,G as V,b as l,c as t,d as i,e as a,E as b,h as p,a as M,t as F,_ as n,n as g,r as k,g as P}from"./tokens.style-D4lFYefr.js";import{m as A,l as j}from"./runtime-nRyYmvPb.js";import{e as G}from"./class-map-BVMhR7fk.js";import{e as Y,n as K}from"./unwrap-slots-CqMazVGL.js";import{s as T,u as U,G as q}from"./button.component-Ca3e7BWO.js";import{b as J}from"./dropdown.component-CfeySOOk.js";import{I as Q}from"./circle-check.component-BiTyJxrx.js";import{I as X}from"./chevron-bottom.component-Bp6Qq6hq.js";import{I as Z}from"./cross-small.component-CGcWdhHq.js";import{I as ss}from"./triangle-exclamation.component-ESlKmdNh.js";const ts=H`
  :host {
...
`;var es=ts,f,m,w,c,h,o,u,x,s,$,_,E,S,W,v,y,D,L,I,O,R,z,B,N;const is={positive:{icon:"circle-check",card:"positive"},warning:{icon:"circle-info",card:"warning"},negative:{icon:"triangle-exclamation",card:"negative"},information:{icon:"circle-info",card:"information"},notice:{icon:"circle-info",card:"notice"}},as=300,rs=100;let r=class extends V{constructor(){super(),l(this,s),this.variant="information",this.label="",this.role="alert",this.dismissible=!1,this.timeout=0,this.buttonLabel="",this._progress=100,this._isClosing=!1,this._cardHidden=!1,l(this,f),l(this,m),l(this,w,Y()),l(this,c),l(this,h,!1),l(this,o,0),l(this,u,0),l(this,x,{hostConnected:()=>{this.timeout>0&&t(this,s,$).call(this)},hostDisconnected:()=>{t(this,s,_).call(this),t(this,s,v).call(this)}}),this.addController(i(this,x))}updated(e){e.has("timeout")&&(t(this,s,_).call(this),t(this,s,v).call(this),a(this,o,Math.max(0,this.timeout)),this._progress=100,this.timeout>0&&t(this,s,$).call(this))}render(){if(this._cardHidden)return b;const e={dismissing:this._isClosing,dismissible:this.dismissible,"has-action":this.buttonLabel,timeout:this.timeout>0};return p`
      <gds-card
        ${K(i(this,w))}
        role=${this.role}
    ...
    `};B=function(){return this.dismissible?p`
          <gds-button
            class="close"
            .variant=${this.variant}
            rank="secondary"
        ...
        `:b};N=function(){return this.timeout>0?p`
          <div
        ...
        `:b};r.styles=[F,es];n([g({type:String,reflect:!0})],r.prototype,"variant",2);n([g({type:String})],r.prototype,"label",2);n([g({type:String,reflect:!0})],r.prototype,"role",2);n([g({type:Boolean})],r.prototype,"dismissible",2);n([g({type:Number})],r.prototype,"timeout",2);n([g({type:String,attribute:"button-label"})],r.prototype,"buttonLabel",2);n([k()],r.prototype,"_progress",2);n([k()],r.prototype,"_isClosing",2);n([k()],r.prototype,"_cardHidden",2);r=n([P("gds-alert",{dependsOn:[q,J,Q,ss,X,Z]}),j()],r);export{r as G};
