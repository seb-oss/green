import{i as k,h as S,G as z,t as C,_ as i,n as u,g as V,b as l,d as r,e as m,c as O,r as W}from"./tokens.style-CkoTFl38.js";import{m as x,l as E}from"./runtime-nRyYmvPb.js";import{e as w,w as L}from"./watch-Bh1rs_BK.js";import{r as T}from"./resize-observer-B9k8v2TZ.js";import{w as $,a as P,b as G}from"./icon.component-BFT0EKpX.js";import{I as N,a as R}from"./chevron-right.component-CbY_cQDV.js";import{T as B}from"./transitional-styles-CxdZzTaj.js";const X=k`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var D=j,d,p,I,b,f,v,h,g,y,_;const F=(e,t)=>{let s;return()=>{clearTimeout(s),s=setTimeout(e,t)}};let n=class extends P($(G(z))){constructor(){super(...arguments),l(this,p),this.size="medium",l(this,d),this._showPrevButton=!1,this._showNextButton=!1,this.intersectionObserver=null,l(this,b,()=>{const e=this.segments.filter((t,s,a)=>{var o;return((o=a[s+1])==null?void 0:o.isVisible)&&!t.isVisible})[0];e&&(this._elTrack.scrollLeft-=e.offsetWidth)}),l(this,f,()=>{const e=this.segments.filter((t,s,a)=>{var o;return((o=a[s-1])==null?void 0:o.isVisible)&&!t.isVisible}).reverse()[0];e&&(this._elTrack.scrollLeft+=e.offsetWidth)}),l(this,v,()=>{this.segments.every(e=>!e.isVisible)||(this._showPrevButton=!this.segments[0].isVisible,this._showNextButton=!this.segments[this.segments.length-1].isVisible)}),l(this,h,F(r(this,v),50)),l(this,g,()=>{const e=this.segments.find(t=>t.selected);if(e){const t=e.offsetWidth,s=e.offsetLeft;this._elIndicator.style.transform=`translateX(${s}px)`,this._elIndicator.style.width=`${t}px`}else this._elIndicator.style.transform="translateX(-100%)",this._elIndicator.style.width="0px"}),l(this,y,e=>{const t=this.segments.find(s=>s===e.target||s.contains(e.target));t&&(this.segments.forEach(s=>s.selected=!1),t.selected=!0,m(this,d,t.value),r(this,g).call(this),this.dispatchCustomEvent("change",{detail:{segment:t},bubbles:!0,composed:!0}))}),l(this,_,()=>{r(this,d)&&this.updateComplete.then(()=>{const e=this.segments.find(t=>t.value===r(this,d));e&&(this.segments.forEach(t=>t.selected=!1),e.selected=!0,e.scrollIntoView({block:"nearest",inline:"nearest"}))})})}get value(){return r(this,d)}set value(e){m(this,d,e),r(this,_).call(this)}get segments(){return this._elSlot?this._elSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented-control"),this.updateComplete.then(()=>{this._elTrack.addEventListener("scroll",()=>{r(this,h).call(this)})})}render(){return S`<button
      ...
      </button>`}_recalculateMinWidth(){this.updateComplete.then(()=>{r(this,h).call(this),r(this,g).call(this)})}};d=new WeakMap;p=new WeakSet;I=function(){var t,s;const e=(t=this.segments.find(a=>a.selected))==null?void 0:t.value;e&&m(this,d,e),(s=this.intersectionObserver)==null||s.disconnect(),this.intersectionObserver=new IntersectionObserver(a=>{a.forEach(o=>{const M=o.target;M._isVisible=o.intersectionRatio>.99,r(this,h).call(this)})},{root:this._elTrack,threshold:[0,.01,.5,.99,1]}),this.segments.forEach(a=>{var o;(o=this.intersectionObserver)==null||o.observe(a)})};b=new WeakMap;f=new WeakMap;v=new WeakMap;h=new WeakMap;g=new WeakMap;y=new WeakMap;_=new WeakMap;n.styles=[C,D];i([u({reflect:!0})],n.prototype,"size",2);i([u()],n.prototype,"value",1);i([w("slot")],n.prototype,"_elSlot",2);i([w("#indicator")],n.prototype,"_elIndicator",2);i([w("#track")],n.prototype,"_elTrack",2);i([W()],n.prototype,"_showPrevButton",2);i([W()],n.prototype,"_showNextButton",2);i([T(),L("value")],n.prototype,"_recalculateMinWidth",1);n=i([V("gds-segmented-control",{dependsOn:[c,N,R]}),E()],n);export{n as G,c as a};
