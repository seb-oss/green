const e={title:"Components/Pagination",tags:["autodocs"],parameters:{componentIds:["component-pagination"]},argTypes:{size:{control:"select",options:["","small"]}}},s={render:a=>`
    <nav class="gds-pagination ${a.size}" role="navigation" aria-label="Pagination">
    <ul class="gds-reset">
      <li>
  ...
  </nav>`},l=["Pagination"];export{s as Pagination,l as __namedExportsOrder,e as default};
