const e=t=>`
    <section class="gds-in-page-wizard-step-card gds-card${t.isCompleted?" completed":""}${t.isStarted?" active":""}">
      ...
      ${t.isStarted?`<div class="gds-in-page-wizard-step-card__content">${t.content}</div>
          ...
          `:t.isCompleted?`<div class="gds-in-page-wizard-step-card__content">${t.content}</div>
            ...
            `:""}
    </section>`,s={title:"Components/In-page Wizard",tags:["autodocs"],parameters:{componentIds:["component-inpagewizard"]},argTypes:{isCompleted:{control:"boolean"},isStarted:{control:"boolean"},stepText:{control:"text"},title:{control:"text"},content:{control:"text"}}},i={render:t=>e(t),name:"In-page Wizard Step Card",args:{isCompleted:!0,isStarted:!1,stepText:"Step 1 of 6",title:"Title",content:'<ul class="gds-list"><li>Sub title</li><li>Sub section text</li><li>Sub title</li><li>Sub section text</li><li>Sub title</li><li>Sub section text</li></ul>'}},a={render:t=>e(t),name:"Completed step",args:{isCompleted:!0,isStarted:!1,stepText:"Step 1 of 6",title:"Title",content:'<ul class="gds-list"><li>Sub title</li><li>Sub section text</li><li>Sub title</li><li>Sub section text</li></ul>'}},l={render:t=>e(t),name:"Current step (active)",args:{isCompleted:!1,isStarted:!0,stepText:"Step 2 of 6",title:"Title",content:`<div class="gds-form-group">
        ...
        <div class="gds-form-group">
          ...
          <span class="gds-form-info">Lorem ipsum very long description of input and what should be entered</span>
          <input id="inputInvalid" class="gds-input" type="text" />
        </div>`}},d={render:t=>e(t),name:"Not started step",args:{isCompleted:!1,isStarted:!1,stepText:"Step 3 of 6",title:"Title",content:'<ul class="gds-list"><li>Sub title</li><li>Sub section text</li><li>Sub title</li><li>Sub section text</li></ul>'}},o=["InPageWizardStepCard","CompletedStep","CurrentStep","NotStartedStep"];export{a as CompletedStep,l as CurrentStep,i as InPageWizardStepCard,d as NotStartedStep,o as __namedExportsOrder,s as default};
