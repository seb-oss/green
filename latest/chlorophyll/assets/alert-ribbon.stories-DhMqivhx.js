...
`,name:"Alert ribbon",args:{variant:"",heading:"Can contain a heading.",content:"Body text starts on the same row as heading. A link (optional) always ends the message, stand alone or",link:"part of the sentence.",button:!1,primaryButton:"",closeButton:!1,isCloseable:!0,closeText:"Close this"}};var o,e,s,a,r;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: args => \`
...
}`,...(s=(e=n.parameters)==null?void 0:e.docs)==null?void 0:s.source},description:{story:`[Source code](https://github.com/seb-oss/green/tree/main/libs/chlorophyll/scss/components/alert-ribbon)
&nbsp;|&nbsp;
[Usage guidelines](https://designlibrary.sebgroup.com/components/component-alertribbon)

An alert ribbon is a message used to inform the user about the state of a system, page or function. Icons and color indicate the type and urgency of the information within the message. Note that 'closeButton' will be depricated and replaced by 'isCloseable'.`,...(r=(a=n.parameters)==null?void 0:a.docs)==null?void 0:r.description}}};const l=["AlertRibbon"];export{n as AlertRibbon,l as __namedExportsOrder,i as default};
