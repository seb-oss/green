...
We recommend adding just the parts from Bootstrap that you need, you can read more about it in the `,e.jsx(s.a,{href:"https://github.com/seb-oss/bootstrap/wiki/Don't-want-to-load-all-of-bootstrap%3F",rel:"nofollow",children:"@sebgroup/bootstrap wiki"}),"."]}),`
...
`})}),`
`,e.jsxs(s.p,{children:["It will then only be available to that specific component. Note that when you use ",e.jsx(s.code,{children:"@use"}),", it doesn't matter how many components you add it to, it will just be added once when bundled by webpack."]})]})}function l(o={}){const{wrapper:s}={...n(),...o.components};return s?e.jsx(s,{...o,children:e.jsx(t,{...o})}):t(o)}export{l as default};
