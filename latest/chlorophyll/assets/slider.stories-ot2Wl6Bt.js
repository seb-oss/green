const g={title:"Components/Slider",tags:["autodocs"],parameters:{componentIds:["component-slider"]},argTypes:{unit:{control:"text"},showMinMax:{control:"boolean"}}},s={render:e=>`
  ...
  `,name:"Slider with unit label",args:{unit:"kr"}};var d,l,r,a,n;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => \`
  <div class="gds-form-group">
    <div class="gds-slider-label-container">
        <label for="gds-slider" id="gds-slider-label">Slider label text in one line</label>
...
}`,...(u=(o=i.parameters)==null?void 0:o.docs)==null?void 0:u.source}}};const p=["Slider","SliderWithUnitLabel"];export{s as Slider,i as SliderWithUnitLabel,p as __namedExportsOrder,g as default};
