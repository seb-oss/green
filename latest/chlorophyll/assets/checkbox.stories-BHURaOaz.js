const C={title:"Components/Checkbox",tags:["autodocs"],parameters:{componentIds:["component-checkbox"]},argTypes:{validation:{control:"select",options:["","is-valid","is-invalid"]},disabled:{control:"boolean"},checked:{control:"boolean"},indeterminate:{control:"boolean"},text:{control:"text"}}},n={render:s=>`<label class="gds-form-control">
  <input id="canvas-checkbox" type="checkbox" class="${s.validation}"  ${s.disabled?"disabled":""} ${s.checked?"checked":""} />
  <span>${s.text}</span>
  <i></i>
</label>`,args:{text:"Click me!",disabled:!1,checked:!1,indeterminate:!1},parameters:{}},a={render:()=>`<div class="gds-form-group">
...
</div>`},i={render:()=>`<div class="gds-form-group">
  ...
  `,name:"HorizontalValidation",parameters:{}};var r,d,c;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:`{
  ...
  parameters: {}
}`,...(c=(d=n.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};var p,t,b;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
...
}`,...(b=(t=a.parameters)==null?void 0:t.docs)==null?void 0:b.source}}};var g,u,f;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`<div class="gds-form-group">
      <fieldset aria-describedby="checkboxGroupHelp">
        <legend class="sr-only">Hidden checkbox group legend</legend>
        <div>
  ...
  \`
}`,...(f=(u=i.parameters)==null?void 0:u.docs)==null?void 0:f.source}}};var m,v,h;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => \`
    <div class="gds-form-group">
      <fieldset aria-describedby="checkboxGroupHelp">
        <legend>Visible checkbox group legend</legend>
  ...
  parameters: {}
}`,...(h=(v=o.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var k,x,y,q,H;e.parameters={...e.parameters,docs:{...(k=e.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
    <div class="gds-form-group was-validated">
      <fieldset aria-describedby="checkboxGroupHelp">
        <legend>Checkbox group</legend>
...
[Usage guidelines](https://designlibrary.sebgroup.com/components/component-checkbox)`,...(H=(q=e.parameters)==null?void 0:q.docs)==null?void 0:H.description}}};var G,w,V;l.parameters={...l.parameters,docs:{...(G=l.parameters)==null?void 0:G.docs,source:{originalSource:`{
  ...
  parameters: {}
}`,...(V=(w=l.parameters)==null?void 0:w.docs)==null?void 0:V.source}}};const I=["Checkbox","Invalid","Group","HorizontalGroup","Validation","HorizontalValidation"];export{n as Checkbox,i as Group,o as HorizontalGroup,l as HorizontalValidation,a as Invalid,e as Validation,I as __namedExportsOrder,C as default};
