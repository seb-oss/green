const $={title:"Components/Links",tags:["autodocs"],parameters:{componentIds:["component-inlinelinks"]}},i={render:e=>`
  ...
  <a href="#" class="gds-link link-arrow" aria-label="External link">
    ...
    <a href="#" class="gds-button ghost-dark">Ghost link button</a>`,decorators:[e=>`<div style="display:flex;flex-direction: column;gap:1rem;">${e()}</div>`]};var t,o,l;i.parameters={...i.parameters,docs:{...(t=i.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: args => \`
    <a href="#" class="gds-link">Normal link</a>    
    <a href="https://www.seb.se" class="gds-link">
      Go to seb.se
...
}`,...(l=(o=i.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};var d,c,h,p,m;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => \`
  <a href="#" class="gds-link link-underline" aria-label="Link Label">
    Basic inline with underline
  </a>\`
}`,...(h=(c=n.parameters)==null?void 0:c.docs)==null?void 0:h.source},description:{story:"Basic link when you want to apply `underline` style by adding the class `link-underline`.",...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.description}}};var k,u,g,y,v;a.parameters={...a.parameters,docs:{...(k=a.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => \`
  <a href="#" class="gds-link link-icon" aria-label="Link Label">
    <svg viewBox="0 0 12 17" aria-hidden="true">
      <path d="M11.56 4.06 8.936 1.436a1.5 1.5 0 0 0-1.059-.44H1.5C.672 1 0 1.672 0 2.5v13A1.5 1.5 0 0 0 1.5 17h9a1.5 1.5 0 0 0 1.5-1.5V5.122c0-.397-.16-.781-.44-1.063ZM10.377 5H8V2.622L10.378 5ZM1.5 15.5v-13h5v3.25c0 .416.334.75.75.75h3.25v9h-9Z" />
  ...
  decorators: [story => \`<div style="display:flex;flex-direction: column;gap:1rem;">\${story()}</div>\`]
}`,...(g=(u=a.parameters)==null?void 0:u.docs)==null?void 0:g.source},description:{story:"Optional icon position on the left or the right, width and height should not be specified since they are set in the CSS, including the space between the icon and the text.",...(v=(y=a.parameters)==null?void 0:y.docs)==null?void 0:v.description}}};var b,f,x,w,L;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => \`
  <a href="#" class="gds-link link-arrow" aria-label="External link">
    Link with arrow
    <svg
  ...
  decorators: [story => \`<div style="display:flex;flex-direction: column;gap:1rem;">\${story()}</div>\`]
}`,...(x=(f=r.parameters)==null?void 0:f.docs)==null?void 0:x.source},description:{story:"The animated link with arrow used new color as base which is the `--gds-sys-color-text-primary` and same applies for the `visited` state which is `--gds-sys-color-text-primary`.",...(L=(w=r.parameters)==null?void 0:w.docs)==null?void 0:L.description}}};var B,S,Z,A,V;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => \`
    <a href="#" class="gds-button tertiary" style={{ marginBottom: '16px' }}>Link button</a>  
    <a href="#" class="gds-button primary" style={{ marginBottom: '16px' }}>Primary link button</a>  
    <a href="#" class="gds-button secondary" style={{ marginBottom: '16px' }}>Secondary link button</a>  
  ...
  decorators: [story => \`<div style="display:flex;flex-direction: column;gap:1rem;">\${story()}</div>\`]
}`,...(Z=(S=s.parameters)==null?void 0:S.docs)==null?void 0:Z.source},description:{story:"Sometimes you want to use links but style them as buttons, just add the class `button` and optionally a variant like `primary` or `ghost` and voilà - now you've got a link which looks and behaves like a button!",...(V=(A=s.parameters)==null?void 0:A.docs)==null?void 0:V.description}}};const I=["Links","Link","LinkWithIcon","LinkWithArrow","LinkAsButton"];export{n as Link,s as LinkAsButton,r as LinkWithArrow,a as LinkWithIcon,i as Links,I as __namedExportsOrder,$ as default};
