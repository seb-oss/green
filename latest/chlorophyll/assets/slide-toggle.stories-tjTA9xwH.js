const h={title:"Components/Slide Toggle",tags:["autodocs"],parameters:{componentIds:["component-slidetoggle"]},argTypes:{label:{control:"text"},checked:{control:"boolean"}}},t={render:e=>`
  ...
  <button role="switch" aria-checked="${e.checked}" aria-labelledby="slide-toggle-label-1"></button>
  <span id="slide-toggle-label-1">${e.label}</span>
  </div>`,args:{label:"Toggle me",checked:!1}};var s,n,o,l,i;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: args => \`
  <div class="d-flex align-items-center">
...
}`,...(o=(n=t.parameters)==null?void 0:n.docs)==null?void 0:o.source},description:{story:`The slide toggle is a representation of a physical switch that allows users to turn things on or off.
...
}`,...(d=(c=a.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};const g=["SlideToggle","LabelRight"];export{a as LabelRight,t as SlideToggle,g as __namedExportsOrder,h as default};
