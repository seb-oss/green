const n={title:"Components/Pagination",tags:["autodocs"],parameters:{componentIds:["component-pagination"]},argTypes:{size:{control:"select",options:["","small"]}}},a={render:i=>`
    <nav class="gds-pagination ${i.size}" role="navigation" aria-label="Pagination">
    <ul class="gds-reset">
      <li>
  ...
  </nav>`};var e,s,l;a.parameters={...a.parameters,docs:{...(e=a.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: args => \`
...
}`,...(l=(s=a.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};const r=["Pagination"];export{a as Pagination,r as __namedExportsOrder,n as default};
