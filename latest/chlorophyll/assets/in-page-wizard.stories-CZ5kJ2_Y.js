    ...
    <section class="gds-in-page-wizard-step-card gds-card${e.isCompleted?" completed":""}${e.isStarted?" active":""}">
      ...
      ${e.isStarted?`<div class="gds-in-page-wizard-step-card__content">${e.content}</div>
        ...
        <div class="gds-form-group">
          ...
          <span class="gds-form-info">Lorem ipsum very long description of input and what should be entered</span>
          <input id="inputInvalid" class="gds-input" type="text" />
        </div>`}},a={render:e=>n(e),name:"Not started step",args:{isCompleted:!1,isStarted:!1,stepText:"Step 3 of 6",title:"Title",content:'<ul class="gds-list"><li>Sub title</li><li>Sub section text</li><li>Sub title</li><li>Sub section text</li></ul>'}};var l,r,o,d,p;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
}`,...(o=(r=t.parameters)==null?void 0:r.docs)==null?void 0:o.source},description:{story:"Presents a sequence that leads the user through well-defined steps within a page.",...(p=(d=t.parameters)==null?void 0:d.docs)==null?void 0:p.description}}};var c,u,g,m,b;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args => Template(args),
  name: 'Completed step',
  args: {
    isCompleted: true,
...
}`,...(g=(u=s.parameters)==null?void 0:u.docs)==null?void 0:g.source},description:{story:"A completed step has a green check mark icon and an Edit-button which allows the user to change previously entered information.",...(b=(m=s.parameters)==null?void 0:m.docs)==null?void 0:b.description}}};var S,f,h,v,x;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: args => Template(args),
...
}`,...(h=(f=i.parameters)==null?void 0:f.docs)==null?void 0:h.source},description:{story:"The current step is the one the user is currently interacting with.",...(x=(v=i.parameters)==null?void 0:v.docs)==null?void 0:x.description}}};var _,w,C,T,y;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => Template(args),
