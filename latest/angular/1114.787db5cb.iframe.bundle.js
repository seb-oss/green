...
`;const j=["aria-label","aria-haspopup","aria-expanded","gds-tabindex"],Z=(L=p.qy,(t,...e)=>{let o=C.get(t);return o||(o=t.map((t=>t.replace(/\n[\s]+</gm,"<"))),o.raw=t.raw,C.set(t,o)),L(o,...e)});var L;let P=class extends z.S{constructor(){super(...arguments),(0,r.VK)(this,M),(0,r.VK)(this,_),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.wrapped=!1,this.href="",(0,r.VK)(this,S,!1),(0,r.VK)(this,A,(()=>{const t=this._mainSlot?.assignedElements()??[];(0,r.OV)(this,S,1===t.length&&(t[0].tagName.toLowerCase().startsWith("gds-icon")||"icon"===t[0].getAttribute("name"))),this.requestUpdate()})),(0,r.VK)(this,V,(t=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:t}),this.form&&!(0,r.S7)(this,M,$)&&("submit"===this.type?this.form.requestSubmit():"reset"===this.type&&this.form.reset())})),(0,r.VK)(this,E,(t=>{if(!(this.disabled||"Space"!==t.code&&"Enter"!==t.key||t.repeat)){const t=this._ripple;t&&t.triggerRipple()}}))}focus(t){this._getValidityAnchor()?.focus(t)}click(){this._getValidityAnchor()?.click()}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),h.n.instance.apply(this,"gds-button")}render(){const t={button:!0,circle:(0,r.S7)(this,S),icon:(0,r.S7)(this,S),xs:"xs"===this.size,small:"small"===this.size,large:"large"===this.size,brand:"brand"===this.variant,positive:"positive"===this.variant,negative:"negative"===this.variant,notice:"notice"===this.variant,warning:"warning"===this.variant,primary:"primary"===this.rank,secondary:"secondary"===this.rank,tertiary:"tertiary"===this.rank,wrapped:this.wrapped},e=(0,r.S7)(this,M,$)?c.eu`a`:c.eu`button`;return c.qy`
      <${e}
        class=${(0,n.H)(t)}
        type="${(0,a.J)((0,r.S7)(this,M,$)?void 0:this.type)}"
        ?disabled="${this.disabled}"
        aria-label=${this.label||s.s6}
        href=${(0,a.J)((0,r.S7)(this,M,$)?this.href:void 0)}
        target=${(0,a.J)((0,r.S7)(this,M,$)?this.target:void 0)}
        rel=${(0,a.J)((0,r.S7)(this,M,$)?this.rel||(0,r.S7)(this,_,F):void 0)}
        download=${(0,a.J)((0,r.S7)(this,M,$)?this.download:void 0)}
        part="_button"
        @click="${(0,r.S7)(this,V)}"
