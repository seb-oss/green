"use strict";(self.webpackChunkgreen=self.webpackChunkgreen||[]).push([[2704],{30801(e,t,s){s.d(t,{K:()=>f});var i,o,a,r,l,n,d,c,p=s(30745),h=s(14367),g=s(3578),u=s(93539),b=s(77526),y=s(15073),v=s(64987),m=s(46312),x=s(39443).AH`
...
`;let f=class extends((0,v.Q8)((0,v.TM)((0,v.lt)(u.j)))){constructor(){super(...arguments),(0,p.VK)(this,i),(0,p.VK)(this,a),(0,p.VK)(this,l),(0,p.VK)(this,d),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const e=(0,g.H)({badge:!0,[this.variant]:!0,[this.size]:"small"===this.size,notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return b.qy`
    ...
    ></slot>`},d=new WeakSet,c=function(){return b.qy`<slot name="trail"></slot>`},f.styles=[y.LU,x],(0,p.Cc)([(0,h.MZ)()],f.prototype,"variant",2),(0,p.Cc)([(0,h.MZ)({type:String})],f.prototype,"size",2),(0,p.Cc)([(0,h.MZ)({attribute:"notification",type:Boolean,reflect:!0})],f.prototype,"notification",2),(0,p.Cc)([(0,h.MZ)({attribute:"rounded",type:Boolean,reflect:!0})],f.prototype,"rounded",2),(0,p.Cc)([(0,h.wk)()],f.prototype,"mainSlotOccupied",2),(0,p.Cc)([(0,h.wk)()],f.prototype,"leadSlotOccupied",2),f=(0,p.Cc)([(0,b.Y$)("gds-badge",{dependsOn:[m.o]})],f)},97617(e,t,s){s.d(t,{z:()=>d});var i=s(30745),o=s(39443),a=s(15073),r=s(49399),l=s(77526),n=s(58833);let d=class extends n.o{constructor(){super(),this.variant="primary",this.padding="m;m{xl}",this["border-radius"]="s",this.gap="m;m{l}"}render(){return l.qy`<slot></slot>`}};d.styles=[a.LU,o.AH`
      :host {
        box-sizing: border-box;
...
`;let le=class extends te.S{constructor(){super(...arguments),(0,r.VK)(this,E),(0,r.VK)(this,H),(0,r.VK)(this,Y),(0,r.VK)(this,U),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,(0,r.VK)(this,M,void 0),(0,r.VK)(this,T,(()=>x.qy`
    ...
    `)),(0,r.VK)(this,q,(e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})})),(0,r.VK)(this,L,(e=>{if(this.combobox){const t=e.getBoundingClientRect(),s=window.innerHeight-t.bottom,i=t.top;let o=Math.min(i,this.maxHeight);return s>i&&(o=Math.min(s,this.maxHeight)),o-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"})),(0,r.VK)(this,W,((e,t)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:t,open:e},bubbles:!1,composed:!1}))),(0,r.VK)(this,A,(e=>{(0,r.S7)(this,W).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)})),(0,r.VK)(this,O,(e=>{e.preventDefault(),e.stopPropagation(),this.value=void 0,this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),(0,r.S7)(this,D).call(this),(0,r.S7)(this,P).call(this)})),(0,r.VK)(this,Z,(e=>{if(!e.currentTarget)return;if(e.stopPropagation(),!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}}))return;const t=e.currentTarget;this.options.forEach((e=>e.hidden=!1)),t.value&&this.options.filter((e=>!this.searchFilter(t.value,e))).forEach((e=>e.hidden=!0))})),(0,r.VK)(this,K,(e=>{this._elListbox?.then((t=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void t.focus()}))})),(0,r.VK)(this,F,(e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()})),(0,r.VK)(this,j,(e=>{const t=this._elTriggerBtn;t&&(t.ariaActiveDescendantElement=e.target)})),(0,r.VK)(this,D,(()=>{this.updateComplete.then((()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})))})),(0,r.VK)(this,P,(()=>{this.updateComplete.then((()=>this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})))})),(0,r.VK)(this,I,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,r.S7)(this,W).call(this,!1,"close")&&(this.open=!1)})),(0,r.VK)(this,Q,(e=>{"Tab"===e.key&&!this.searchable&&(0,r.S7)(this,W).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}))}get type(){return"gds-dropdown"}get options(){return(0,r.S7)(this,M)?Array.from((0,r.S7)(this,M)).filter((e=>!e.hasAttribute("isplaceholder"))):[]}get placeholder(){if((0,r.S7)(this,M))return Array.from((0,r.S7)(this,M)).find((e=>e.hasAttribute("isplaceholder")))}get displayValue(){let e;return e=Array.isArray(this.value)?this.value.slice(0,5).reduce(((e,t)=>e+this.options.find((e=>e.value===t))?.innerText+", "),"").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):this.options.find((e=>e.selected))?.innerText,e||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",(0,r.S7)(this,q)),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()}))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",(0,r.S7)(this,q))}render(){return x.qy`
      ...
      <gds-popover
        ...
        .floatingUIMiddleware=${this.combobox?[(0,g.cY)(8),(0,g.UU)()]:ae.E.DefaultMiddleware}
      ...
      ${(0,h.z)((0,r.jq)(this,E,z).call(this),(()=>x.qy`
        ...
        `))}
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){this.requestUpdate(),(0,r.OV)(this,M,this.querySelectorAll("[gds-element=gds-option]")),this.multiple||(void 0===this.value?this.placeholder?this.value=this.placeholder.value:this.value=this.options[0]?.value:this.combobox||this.placeholder||void 0!==this.options.find((e=>this.compareWith(e.value,this.value)))||(this.options[0]&&(this.options[0].selected=!0),this.value=this.options[0]?.value)),this._handleValueChange()}_handleValueChange(){this._elListbox.then((e=>{e&&(Array.isArray(this.value)?e.selection=this.value:e.selection=[this.value])}))}_handleOpenChange(){var e=this;const t=this.open;this.options.forEach((e=>e.hidden=!t)),t?(0,r.jq)(this,Y,N).call(this):((0,r.jq)(this,U,G).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const s=this.options.find((e=>e.selected));requestAnimationFrame((0,a.A)((function*(){yield e.updateComplete,s?.scrollIntoView({block:"center"})})))}};M=new WeakMap,E=new WeakSet,z=function(){return!this.plain},T=new WeakMap,V=new WeakMap,q=new WeakMap,L=new WeakMap,W=new WeakMap,A=new WeakMap,O=new WeakMap,Z=new WeakMap,K=new WeakMap,F=new WeakMap,j=new WeakMap,H=new WeakSet,B=function(){this._elListbox.then((e=>{this.multiple?this.value=e.selection.map((e=>e.value)):(this.value=e.selection[0]?.value,(0,r.S7)(this,W).call(this,!1,"close")&&(this.open=!1,setTimeout((()=>this._elTriggerBtn?.focus()),0))),(0,r.S7)(this,D).call(this),(0,r.S7)(this,P).call(this)}))},D=new WeakMap,P=new WeakMap,Y=new WeakSet,N=function(){this.addEventListener("blur",(0,r.S7)(this,I)),this.addEventListener("gds-blur",(0,r.S7)(this,I)),this.addEventListener("keydown",(0,r.S7)(this,Q))},U=new WeakSet,G=function(){this.removeEventListener("blur",(0,r.S7)(this,I)),this.removeEventListener("gds-blur",(0,r.S7)(this,I)),this.removeEventListener("keydown",(0,r.S7)(this,Q))},I=new WeakMap,Q=new WeakMap,le.styles=[J.LU,R.A,re],(0,r.Cc)([(0,d.MZ)({attribute:"supporting-text"})],le.prototype,"supportingText",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,reflect:!0})],le.prototype,"open",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,reflect:!0})],le.prototype,"searchable",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,reflect:!0})],le.prototype,"multiple",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,reflect:!0})],le.prototype,"clearable",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,reflect:!0})],le.prototype,"combobox",2),(0,r.Cc)([(0,d.MZ)()],le.prototype,"compareWith",2),(0,r.Cc)([(0,d.MZ)()],le.prototype,"searchFilter",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,attribute:"sync-popover-width"})],le.prototype,"syncPopoverWidth",2),(0,r.Cc)([(0,d.MZ)({type:Number,attribute:"max-height"})],le.prototype,"maxHeight",2),(0,r.Cc)([(0,d.MZ)({reflect:!0})],le.prototype,"size",2),(0,r.Cc)([(0,d.MZ)({type:Boolean,attribute:"hide-label"})],le.prototype,"hideLabel",2),(0,r.Cc)([(0,d.MZ)({type:Boolean})],le.prototype,"plain",2),(0,r.Cc)([(0,d.MZ)({type:Boolean})],le.prototype,"disableMobileStyles",2),(0,r.Cc)([(0,d.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],le.prototype,"showExtendedSupportingText",2),(0,r.Cc)([(0,d.P)("#trigger")],le.prototype,"_elTriggerBtn",2),(0,r.Cc)([(0,d.nJ)("#listbox")],le.prototype,"_elListbox",2),(0,r.Cc)([(0,d.P)("#searchinput")],le.prototype,"_elSearchInput",2),(0,r.Cc)([(0,X.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],le.prototype,"_handleLightDOMChange",1),(0,r.Cc)([(0,w.w)("value")],le.prototype,"_handleValueChange",1),(0,r.Cc)([(0,w.w)("open")],le.prototype,"_handleOpenChange",1),le=(0,r.Cc)([(0,l.cc)()],le);let ne=class extends((0,ee.Q8)((0,ee.TM)((0,ee.lt)(le)))){};ne=(0,r.Cc)([(0,x.Y$)("gds-dropdown",{dependsOn:[y.$,b.V,u.w,S,ae.E,se.V,ie.o,oe.r]})],ne)},46312(e,t,s){s.d(t,{o:()=>n});var i=s(30745),o=s(15073),a=s(77526),r=s(58833),l=s(39443).AH`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;let b=class extends p.j{constructor(){super(...arguments),(0,a.VK)(this,i)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter?.[1])}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return g.qy`<div aria-live="polite">
    ...
    </div>`}};i=new WeakSet,o=function(){if(!this.charCounter||!1===this.charCounter[1])return r.s6;const[e,t]=this.charCounter;return g.qy`<gds-badge variant="${t}">${e}</gds-badge>`},b.styles=[u],(0,a.Cc)([(0,l.MZ)({type:Array})],b.prototype,"charCounter",2),(0,a.Cc)([(0,l.MZ)()],b.prototype,"errorMessage",2),(0,a.Cc)([(0,h.w)("charCounter"),(0,h.w)("errorMessage")],b.prototype,"_handleVisibilityChange",1),b=(0,a.Cc)([(0,g.Y$)("gds-form-control-footer",{dependsOn:[d.K,c.f]})],b)},52655(e,t,s){s.d(t,{$:()=>f});var i,o,a,r,l,n,d,c=s(30745),p=s(16743),h=s(14367),g=s(90505),u=s(27595),b=s(97617),y=s(84464),v=s(93539),m=s(77526),x=s(39443).AH`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`},58057(e,t,s){s.d(t,{U:()=>l,o:()=>r}),s(30745);var i=s(3578),o=s(90505),a=s(77526);const r=e=>n({...e,type:"checkbox"}),l=e=>n({...e,type:"radio"}),n=e=>{const{type:t,checked:s,indeterminate:r,disabled:l,invalid:n}=e,d={"rbcb--checkbox":"checkbox"===t,"rbcb--radio":"radio"===t,"--checked":s,"--indeterminate":r,"--disabled":l,"--invalid":n};return a.qy`
  ...
  `}}}]);
//# sourceMappingURL=2704.566f88d2.iframe.bundle.js.map