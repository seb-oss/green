import{i as J,E as j,ak as ce,n,a7 as W,I as ee,a1 as te,d as u,h as c,g as R,f as se,T as ue,Z as ge,S as fe,Q as be,a8 as ve,N as E,a5 as me,o as ye,A as _e}from"./iframe-BPg3AppR.js";import{l as xe}from"./localized-decorator-CtQHvQkq.js";import{r as we}from"./query-async-D3XfJ3tf.js";import{o as $e}from"./icon.component-DSJcapvS.js";import{o as Ce,f as Ee}from"./floating-ui.dom-Ceeo7fpE.js";import{f as ke,G as Se}from"./form-control-host.style-c9aVajVA.js";import{G as Me,a as Le}from"./form-control-header.component-DAcZ9E_c.js";import{n as Te,e as We}from"./ref-ClV2uvL_.js";import{s as Oe,F as Ae,L as Pe,u as Be}from"./unwrap-slots-BzwgULRp.js";import{I as ie}from"./checkmark.component-CfnQDcnT.js";import{c as De}from"./rbcb-toggle.template-CJF3SZ-u.js";import{I as Fe}from"./chevron-bottom.component-C9ykL0Yt.js";import{I as ze}from"./cross-small.component-D5yJeKuY.js";import{G as ae}from"./popover.component-CoiVQxlw.js";const Ie=J`
...
`;var Ge=Object.defineProperty,He=Object.getOwnPropertyDescriptor,oe=e=>{throw TypeError(e)},_=(e,t,s,l)=>{for(var i=l>1?void 0:l?He(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&Ge(t,s,i),i},N=(e,t,s)=>t.has(e)||oe("Cannot "+s),K=(e,t,s)=>(N(e,t,"read from private field"),s?s.call(e):t.get(e)),Q=(e,t,s)=>t.has(e)?oe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Ve=(e,t,s,l)=>(N(e,t,"write to private field"),t.set(e,s),s),X=(e,t,s)=>(N(e,t,"access private method"),s),x,M,P;let g=class extends Ae(ee){constructor(){super(),Q(this,M),Q(this,x,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",X(this,M,P)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),X(this,M,P).call(this,e))})}get hidden(){return K(this,x)}set hidden(e){const t=e.toString();Ve(this,x,t==="true"),K(this,x)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),te.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){var t;const e=(t=this.parentElement)==null?void 0:t.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),c`<div class="item">
      ${u(e,()=>De({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};x=new WeakMap;M=new WeakSet;P=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};g.styles=[j,ce,Oe];_([n()],g.prototype,"value",2);_([n({type:Boolean,reflect:!0})],g.prototype,"hidden",1);_([n({attribute:"aria-selected",reflect:!0})],g.prototype,"selected",2);_([n({type:Boolean,reflect:!0})],g.prototype,"isPlaceholder",2);_([W("isPlaceholder")],g.prototype,"_handlePlaceholderStatusChange",1);g=_([R("gds-option",{dependsOn:[ie]})],g);var qe=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,re=e=>{throw TypeError(e)},O=(e,t,s,l)=>{for(var i=l>1?void 0:l?Re(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&qe(t,s,i),i},Ne=(e,t,s)=>t.has(e)||re("Cannot "+s),k=(e,t,s)=>(Ne(e,t,"read from private field"),s?s.call(e):t.get(e)),Y=(e,t,s)=>t.has(e)?re("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w,B;let v=class extends ee{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,Y(this,w,We()),Y(this,B,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new Pe(this)}get navigableItems(){return this.visibleOptionElements}get options(){return k(this,w).value?Be(k(this,w).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),te.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",k(this,B))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return c`<slot ${Te(k(this,w))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};w=new WeakMap;B=new WeakMap;v.styles=Ie;O([n({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);O([n()],v.prototype,"compareWith",2);O([W("multiple")],v.prototype,"_rerenderOptions",1);v=O([R("gds-listbox",{dependsOn:[g]})],v);const Ue=J`
  @layer base, reset;
...
`;var Ke=Object.defineProperty,Qe=Object.getOwnPropertyDescriptor,le=e=>{throw TypeError(e)},r=(e,t,s,l)=>{for(var i=l>1?void 0:l?Qe(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&Ke(t,s,i),i},U=(e,t,s)=>t.has(e)||le("Cannot "+s),a=(e,t,s)=>(U(e,t,"read from private field"),t.get(e)),d=(e,t,s)=>t.has(e)?le("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Xe=(e,t,s,l)=>(U(e,t,"write to private field"),t.set(e,s),s),S=(e,t,s)=>(U(e,t,"access private method"),s),b,m,ne,D,F,L,z,f,I,G,T,H,V,q,he,$,C,de,pe,y,A;let o=class extends ve{constructor(){super(...arguments),d(this,m),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,d(this,b),d(this,D,()=>{var e;return c`
      <input
        id="trigger"
        role="combobox"
      ...
      >
        ...
        >
          ...
          ${u(this.value&&this.multiple&&this.value.length>0,()=>c`<gds-badge
                ...
                slot="lead"
                aria-label=${E(me`${this.value.length} options selected`)}
              >
