import{i as m,Q as P,Z as G,S,I as v,N as A,a as E,h,E as I,n as d,g as y,A as B,o as g}from"./iframe-BPg3AppR.js";import{l as D}from"./localized-decorator-CtQHvQkq.js";import{I as M}from"./chevron-left.component-DN3qOHO_.js";import{G as k}from"./link-DBZ6oTsk.js";import{G as L}from"./text.component-DiBI4Sow.js";const j=m`
...
`;var T=Object.defineProperty,W=Object.getOwnPropertyDescriptor,u=(t,e,s,n)=>{for(var r=n>1?void 0:n?W(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&T(e,s,r),r};let f=class extends P(G(S(v))){constructor(){super(...arguments),this.size="large",this.label=A("Breadcrumbs")}get breadcrumbItems(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumb]"))}handleSlotChange(){const t=this.breadcrumbItems;t.forEach((e,s)=>{s===t.length-2?e.setAttribute("return",""):e.removeAttribute("return")})}render(){return h`
    ...
    `}};f.styles=[I,j];u([d({type:String})],f.prototype,"size",2);u([d({type:String})],f.prototype,"label",2);f=u([y("gds-breadcrumbs",{dependsOn:[M]}),D()],f);const q=m`
  @layer base {
    :host {
      display: contents;
    }
...
`;var N=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,_=t=>{throw TypeError(t)},c=(t,e,s,n)=>{for(var r=n>1?void 0:n?Q(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&N(e,s,r),r},b=(t,e,s)=>e.has(t)||_("Cannot "+s),R=(t,e,s)=>(b(t,e,"read from private field"),s?s.call(t):e.get(t)),X=(t,e,s)=>e.has(t)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),p=(t,e,s)=>(b(t,e,"access private method"),s),a,x,w,$,C,z,O;let i=class extends v{constructor(){super(...arguments),X(this,a),this.href="",this.label="",this.overflow=!1}render(){return h`
