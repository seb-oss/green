import{i,o as r,h as c,y as u,a as g}from"./iframe-rjCVMJaw.js";import{w as v}from"./props-link-CCjwpShH.js";import{G as b}from"./card.component-BOkO518I.js";const p=i`
  :host {
    display: contents;
    --_border: transparent;
...
`;var y=Object.getOwnPropertyDescriptor,f=(e,a,d,n)=>{for(var o=n>1?void 0:n?y(a,d):a,t=e.length-1,l;t>=0;t--)(l=e[t])&&(o=l(o)||o);return o};let s=class extends v(b){render(){return c`<a
    ...
    >
      <slot></slot>
    </a>`}};s.styles=[u,p];s.styleExpressionBaseSelector="a";s=f([g("gds-card-linked")],s);export{s as G};
