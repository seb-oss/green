import{e as Ot,Y as Ft,V as Vt,X as Rt,al as Ht,am as E,an as A,ao as j,af as tt,ap as Ut,aq as Xt,n as m,H as q,a6 as _t,I as Kt,h as w,g as Yt,i as Zt,E as qt,f as $t,Z as Jt,S as Qt,Q as jt,a7 as te,a1 as ee,d as I,N as c,A as Wt,O as se}from"./iframe-CxIvAeSU.js";import{l as ae}from"./localized-decorator-DNY9EYMk.js";import{r as J}from"./query-async-DrnwsTTM.js";import{f as ie}from"./ref-BLOJk1FP.js";import{a as ne}from"./dropdown.component-DQ8q-lOo.js";import{G as oe}from"./flex.component-DlMPiiPD.js";import{f as re}from"./form-control-host.style-B6UKthmo.js";import{d as bt,a as le}from"./attribute-converters-CdI0trPX.js";import{i as he,l as de,G as ue}from"./calendar.component-CPu2CVRy.js";import{I as ce,a as pe}from"./calender-add.component-Cj2FdJaw.js";import{I as ge}from"./chevron-left.component-BZo4jixp.js";import{I as fe}from"./chevron-right.component-L69HLUZF.js";import{G as me}from"./popover.component-wiVNdHq7.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},be=Ft(class extends Vt{constructor(t){if(super(t),t.type!==Rt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let h=0;for(const g of t)a[h]=i?i(g,h):h,n[h]=s(g,h),h++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:h}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=h,n;const g=this.ut??(this.ut=[]),o=[];let k,D,d=0,b=a.length-1,v=0,C=n.length-1;for(;d<=b&&v<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(g[d]===h[v])o[v]=E(a[d],n[v]),d++,v++;else if(g[b]===h[C])o[C]=E(a[b],n[C]),b--,C--;else if(g[d]===h[C])o[C]=E(a[d],n[C]),A(t,o[C+1],a[d]),d++,C--;else if(g[b]===h[v])o[v]=E(a[b],n[v]),A(t,a[d],a[b]),b--,v++;else if(k===void 0&&(k=kt(h,v,C),D=kt(g,d,b)),k.has(g[d]))if(k.has(g[b])){const F=D.get(h[v]),Q=F!==void 0?a[F]:null;if(Q===null){const Ct=A(t,a[d]);E(Ct,n[v]),o[v]=Ct}else o[v]=E(Q,n[v]),A(t,a[d],Q),a[F]=null;v++}else j(a[b]),b--;else j(a[d]),d++;for(;v<=C;){const F=A(t,o[C+1]);E(F,n[v]),o[v++]=F}for(;d<=b;){const F=a[d++];F!==null&&j(F)}return this.ut=h,Ut(t,o),tt}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
          ...
          ${I(this.clearable||!this.hideTodayButton,()=>w`
              ...
              >
                ${I(this.clearable,()=>w` <gds-button
                      ...
                      rank="tertiary"
                      size="small"
                      @click=${t=>{t.stopPropagation(),this.value=void 0,this.open=!1,f(this,u,P).call(this),f(this,u,N).call(this)}}
