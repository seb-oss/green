import{m as K}from"./runtime-BL31MtW8.js";import{l as B}from"./localized-decorator-DtmrKsyB.js";import{n as g,r as f,g as z,G as k,h as n}from"./custom-element-scoping-BEGY3AqQ.js";import{a as F}from"./query-p8xgzTDt.js";import{n as b}from"./when-BR7zwNJC.js";import{i as P}from"./lit-element-C_s9q329.js";import"./button-DMqiAWPO.js";import"./triangle-exclamation-BVOOPWQa.js";import"./card-BihnooJR.js";import"./badge-Dc9DlXiN.js";import{e as W}from"./class-map-Bz98xO8-.js";import{T as Q}from"./transitional-styles-iv5lM2WH.js";import{w as U}from"./watch-tFciLXSI.js";const V=P`
...
`;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,N=e=>{throw TypeError(e)},m=(e,t,s,a)=>{for(var i=a>1?void 0:a?Z(t,s):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(t,s,i):o(i))||i);return a&&i&&Y(t,s,i),i},A=(e,t,s)=>t.has(e)||N("Cannot "+s),D=(e,t,s)=>(A(e,t,"read from private field"),s?s.call(e):t.get(e)),y=(e,t,s)=>t.has(e)?N("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),H=(e,t,s)=>(A(e,t,"access private method"),s),x,L,S,w,I;let h=class extends k{constructor(){super(...arguments),y(this,x),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,y(this,S,()=>n`
      <gds-button
        size="small"
        rank="tertiary"
    ...
    `};h.styles=[V];m([g({type:Boolean,reflect:!0})],h.prototype,"showExtendedSupportingText",2);m([f()],h.prototype,"_hasExtendedSupportingText",2);m([F("#extended-supporting-text")],h.prototype,"_extendedSupportingText",2);h=m([z("gds-form-control-header"),B()],h);const ee=P`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`;var te=Object.defineProperty,se=Object.getOwnPropertyDescriptor,R=e=>{throw TypeError(e)},M=(e,t,s,a)=>{for(var i=a>1?void 0:a?se(t,s):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(t,s,i):o(i))||i);return a&&i&&te(t,s,i),i},ie=(e,t,s)=>t.has(e)||R("Cannot "+s),ae=(e,t,s)=>t.has(e)?R("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),re=(e,t,s)=>(ie(e,t,"access private method"),s),$,X;let u=class extends k{constructor(){super(...arguments),ae(this,$)}render(){return n`<div aria-live="polite">
      ...
      <div class="char-counter">
        ${b(Number.isInteger(this.charCounter),()=>re(this,$,X).call(this,this.charCounter))}
      </div>
    </div>`}};$=new WeakSet;X=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",n`<gds-badge variant="${t}">${e}</gds-badge>`};u.styles=[ee];M([g({type:Number})],u.prototype,"charCounter",2);M([g()],u.prototype,"validationMessage",2);u=M([z("gds-form-control-footer")],u);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*oe(e,t){if(e!==void 0){let s=0;for(const a of e)yield t(a,s++)}}const ne=P`
  @layer base, a11y;
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,j=e=>{throw TypeError(e)},c=(e,t,s,a)=>{for(var i=a>1?void 0:a?de(t,s):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(i=(a?o(t,s,i):o(i))||i);return a&&i&&le(t,s,i),i},q=(e,t,s)=>t.has(e)||j("Cannot "+s),_=(e,t,s)=>(q(e,t,"read from private field"),s?s.call(e):t.get(e)),G=(e,t,s)=>t.has(e)?j("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),p=(e,t,s)=>(q(e,t,"access private method"),s),v,d,J,E,C,T,O;let l=class extends k{constructor(){super(),G(this,d),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,G(this,v,(e,t)=>{const a=t.target.assignedNodes({flatten:!0}),i=a.length>0&&a.some(r=>{var o;return r.nodeType===Node.ELEMENT_NODE||r.nodeType===Node.TEXT_NODE&&((o=r.textContent)==null?void 0:o.trim())!==""});e==="lead"?this._leadSlotOccupied=i:e==="trail"?this._trailSlotOccupied=i:e==="action"&&(this._actionSlotOccupied=i)})}connectedCallback(){super.connectedCallback(),Q.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return n`
    ...
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};v=new WeakMap;d=new WeakSet;J=function(){if(this.multiline&&(this._trailSlotOccupied||this._actionSlotOccupied))return n`
        ${p(this,d,E).call(this)} ${p(this,d,C).call(this)}
        <div class="right">
          ${p(this,d,T).call(this)} ${p(this,d,O).call(this)}
        </div>
      `;{const e=[p(this,d,E).call(this),p(this,d,C).call(this),p(this,d,T).call(this),p(this,d,O).call(this)];return n`${oe(e,t=>t)}`}};E=function(){return n` <slot
      name="lead"
    ...
    `};O=function(){return n`
      ...
      ></slot>
    `};l.styles=[ne];c([g()],l.prototype,"size",2);c([g({type:Boolean})],l.prototype,"multiline",2);c([g({type:Boolean,reflect:!0})],l.prototype,"disabled",2);c([g({type:Boolean})],l.prototype,"invalid",2);c([F("slot:not([name])")],l.prototype,"_mainSlotElement",2);c([f()],l.prototype,"_leadSlotOccupied",2);c([f()],l.prototype,"_trailSlotOccupied",2);c([f()],l.prototype,"_actionSlotOccupied",2);c([U("disabled")],l.prototype,"_handleDisabledChange",1);l=c([z("gds-field-base"),B()],l);export{oe as o};
