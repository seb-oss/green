import"./switch-DZt7Lg_0.js";import"./flex-ChElhYVR.js";import{b as t}from"./iframe-CmdnQHuO.js";import"./text-J1vwm1g2.js";import"./divider-CKVh6RnL.js";import{a as x}from"./argTableProps-Bge85YhE.js";import"./switch.component-0kYYmE9r.js";import"./checkmark.component-Dx67h-R0.js";import"./icon.component-BDbxIjt6.js";import"./flex.component-CpauUpKG.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-BZq6AN_3.js";import"./default-typography.styles-CIIttSSp.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
