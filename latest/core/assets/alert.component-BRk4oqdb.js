import{i as U,t as q,n as f,z as A,A as J,E as w,a as G,h as v,B as O,C as S,D as Q,H as W,g as X,I as Z}from"./iframe-BOjKxah_.js";import{l as j}from"./localized-decorator-D8E2PHaz.js";import{n as ss,e as ts}from"./ref-BzhVq2i1.js";import{G as es}from"./card.component-DlSMeA2J.js";import{I as is}from"./circle-check.component-DmLbX8Gu.js";import{I as as,a as rs}from"./triangle-exclamation.component-vDur_dV0.js";import{I as os}from"./cross-small.component-DWQCjJp8.js";const ns=U`
  :host {
...
`;var ls=Object.defineProperty,cs=Object.getOwnPropertyDescriptor,z=s=>{throw TypeError(s)},c=(s,t,r,h)=>{for(var m=h>1?void 0:h?cs(t,r):t,C=s.length-1,k;C>=0;C--)(k=s[C])&&(m=(h?k(t,r,m):k(m))||m);return h&&m&&ls(t,r,m),m},E=(s,t,r)=>t.has(s)||z("Cannot "+r),a=(s,t,r)=>(E(s,t,"read from private field"),r?r.call(s):t.get(s)),d=(s,t,r)=>t.has(s)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(s):t.set(s,r),o=(s,t,r,h)=>(E(s,t,"write to private field"),t.set(s,r),r),i=(s,t,r)=>(E(s,t,"access private method"),r),y,u,I,p,g,l,_,M,e,T,x,B,L,P,b,$,R,H,D,N,V,F,Y,K;const ds={positive:{icon:"circle-check",card:"positive"},warning:{icon:"circle-info",card:"warning"},negative:{icon:"triangle-exclamation",card:"negative"},information:{icon:"circle-info",card:"information"},notice:{icon:"circle-info",card:"notice"}},hs=300,ps=100;let n=class extends J{constructor(){super(),d(this,e),this.variant="information",this.label="",this.role="alert",this.dismissible=!1,this.timeout=0,this.buttonLabel="",this._progress=100,this._isClosing=!1,this._cardHidden=!1,d(this,y),d(this,u),d(this,I,ts()),d(this,p),d(this,g,!1),d(this,l,0),d(this,_,0),d(this,M,{hostConnected:()=>{this.timeout>0&&i(this,e,T).call(this)},hostDisconnected:()=>{i(this,e,x).call(this),i(this,e,b).call(this)}}),this.addController(a(this,M))}updated(s){s.has("timeout")&&(i(this,e,x).call(this),i(this,e,b).call(this),o(this,l,Math.max(0,this.timeout)),this._progress=100,this.timeout>0&&i(this,e,T).call(this))}render(){if(this._cardHidden)return w;const s={dismissing:this._isClosing,dismissible:this.dismissible,"has-action":this.buttonLabel,timeout:this.timeout>0};return v`
    ...
    `};Y=function(){return this.dismissible?v`
        ...
        `:w};n.styles=[q,ns];c([f({type:String,reflect:!0})],n.prototype,"variant",2);c([f({type:String})],n.prototype,"label",2);c([f({type:String,reflect:!0})],n.prototype,"role",2);c([f({type:Boolean})],n.prototype,"dismissible",2);c([f({type:Number})],n.prototype,"timeout",2);c([f({type:String,attribute:"button-label"})],n.prototype,"buttonLabel",2);c([A()],n.prototype,"_progress",2);c([A()],n.prototype,"_isClosing",2);c([A()],n.prototype,"_cardHidden",2);n=c([X("gds-alert",{dependsOn:[Z,es,is,as,rs,os]}),j()],n);export{n as G};
