import{i as U,s as V,a as u}from"./lit-element-2a5e401f.js";import{n as d,g as J,h as o}from"./gds-element-90c5f05b.js";import{a as K}from"./query-b9d3c2af.js";import{r as P}from"./query-async-1ff18261.js";import{m as D}from"./until-87c9e354.js";import{n as c}from"./when-cf7256a5.js";import{m as H}from"./lit-localize-87611c26.js";import{c as L}from"./constrain-slots-08d8606c.js";import{w as Q}from"./watch-c4961afe.js";import{G as Z,f as Y}from"./form-control-341856bb.js";import{t as ee}from"./tokens.style-681e2422.js";/**
 * @license
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};C=new WeakSet;X=function(){return o`
    ...
    `};w=new WeakSet;N=function(){return this.clearable&&this.value.length>0?o`
      ...
      `:u};k=new WeakSet;O=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};$=new WeakSet;G=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="error":e<20?t="warning":t="success",o`<gds-badge variant="${t}">${e}</gds-badge>`};S=new WeakSet;F=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?o`
          <gds-button
            size="small"
            variant="tertiary"
