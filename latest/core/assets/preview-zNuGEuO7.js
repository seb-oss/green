 ...
 */
  ...
  --gds-sys-color-l3-states-negative-pressed: #ee8375 20%;`,Xe=`/**
 * Do not edit directly, this file was auto-generated.
 */
...
`;var Ss={};const Me=typeof process<"u"&&Ss!==void 0;var be,se,te,ze,ge,Ze,fe,Ke;function _s(){return Me?[]:document.adoptedStyleSheets||[]}const ws=class Ye{constructor(){b(this,ge),b(this,fe),b(this,be,!$e()),b(this,se,new Map),b(this,te,new Map),b(this,ze,_s())}static get instance(){return globalThis.__gdsGlobalStylesRegistry||(globalThis.__gdsGlobalStylesRegistry=new Ye),globalThis.__gdsGlobalStylesRegistry}injectGlobalStyles(e,t){if(i(this,be)){const n=Array.isArray(t)?t.map(r=>r.toString()).join(""):t.toString();z(this,ge,Ze).call(this,e,n)}else t.styleSheet&&z(this,fe,Ke).call(this,e,t.styleSheet)}};be=new WeakMap;se=new WeakMap;te=new WeakMap;ze=new WeakMap;ge=new WeakSet;Ze=function(s,e){if(Me)return;let t=i(this,te).get(s);t||(t=document.createElement("style"),i(this,te).set(s,t)),t.textContent=e,document.head.appendChild(t)};fe=new WeakSet;Ke=function(s,e){Me||(i(this,se).set(s,e),document.adoptedStyleSheets=[...i(this,ze),...Array.from(i(this,se).values())])};let Cs=ws;const X=[q`
    :host {
      ${v(Ue)}
      ${v(He)}
    }
  ...
  `);const $s={0:"0px","2xs":"320px",xs:"425px",s:"768px",m:"1024px",l:"1280px",xl:"1440px","2xl":"2560px","3xl":"3840px","4xl":"4320px","5xl":"6016px","6xl":"7680px"},Ms=/^([<|>]=?)?([0-9a-z]+)/,Qe=["{","}",";",":",","],Pe=[" ","/n"];function zs(s=""){const e=[];let t="";for(let n=0;n<s.length;n++){const r=s[n];if(Pe.includes(r)||(t+=r),Qe.includes(r)){e.push(t.slice(0,-1)),e.push(r),t="";continue}if(Pe.includes(r)||n===s.length-1){e.push(t),t="";continue}}return e.filter(n=>n!=="")}function Ts(s){const e=[];let t={breakpoint:"-",values:[]};const n=()=>({sel:"",values:[]});let r=n();for(const l of s){if(!Qe.includes(l)){r.values.push(l);continue}if(l==="{"&&(t={breakpoint:r.values.join(","),values:[]},r=n()),l===";"&&(e.length===0&&e.push(t),r.values.length>0&&(t.values.push(r),r=n())),l===":"){const g=r.values.pop()??"";r.sel=g}t&&l==="}"&&(t.values.push(r),r=n(),e.push(t))}return r.values.length>0&&t.values.push(r),e.length===0&&e.push(t),e}function Es(s){return s.split(",").map(t=>{const n=t.trim().match(Ms);if(!n)throw new Error(`Invalid breakpoint specifier: ${t}`);return{condition:n[1],value:n[2]}})}function js(s,e,t,n=l=>l,r=(l,g)=>`${l}: ${g.join(" ")};`){let l="";for(const g of t){const O=`@media ${(g.breakpoint==="-"?[{condition:">=",value:"0"}]:Es(g.breakpoint)).map(f=>{var h;return`(${(h=f.condition)!=null&&h.includes("<")?"max-width":"min-width"}: ${$s[f.value]??f.value})`}).join(" and ")} {${g.values.map(f=>{let h=s;f.sel.length>0&&(h=s===":host"?`:host(:${f.sel})`:`${s}:${f.sel}`);const w=r(e,f.values.map(n));return f.sel==="hover"?`@media (hover: hover) {${h}{${w}}}`:`${h}{${w}}`}).join("")}}`;l+=O}return l}const ae=new Map;function a(s){return(e,t)=>{const n=(s==null?void 0:s.property)??String(t),r=s==null?void 0:s.valueTemplate,l=s==null?void 0:s.styleTemplate,g=(s==null?void 0:s.cacheOverrideKey)??"0";y({attribute:s==null?void 0:s.attribute,noAccessor:!0})(e,t),Object.defineProperty(e,t,{get:function(){return this["__"+String(t)]},set:async function(c){if(!c)return;this["__"+String(t)]=c,await this.updateComplete;const m=(s==null?void 0:s.selector)??this.constructor.styleExpressionBaseSelector,O=this.level??"0",f=m+n+c+O+g;if(ae.has(f)){this._dynamicStylesController.inject(`sep_${String(t)}`,ae.get(f));return}const h=Ts(zs(c)),w=js(m,n,h,r==null?void 0:r.bind(this),l==null?void 0:l.bind(this)),I=v(w);ae.set(f,I),this._dynamicStylesController.inject(`sep_${String(t)}`,I)}})}}function es(s,e,t){if(s==="transparent"||s==="currentColor"||s==="inherit")return s;const[n,r]=s.split("/"),l=`var(--gds-sys-color-l${t}-${e}-${n})`;return r?`color-mix(in srgb, ${l} ${parseFloat(r)*100}%, transparent 0%)`:l}function re(s){return{valueTemplate:function(e){return es(e,s,this.level)}}}const F={valueTemplate:s=>`var(--gds-sys-space-${s}, 0)`},x={valueTemplate:s=>`var(--gds-sys-space-${Ls(s)}, ${s})`},ie={valueTemplate:s=>{const t=(s.startsWith("-")?"neg":"pos")=="pos"?`var(--gds-sys-space-${s})`:`calc(var(--gds-sys-space-${s.substring(1)}) * -1)`;return s==="auto"?"auto":t},styleTemplate:(s,e)=>{const t=c=>c==="auto"?"auto":`${c}`,n=t(e[0]),r=e.length>1?t(e[1]):n,l=e.length>2?t(e[2]):n,g=e.length>3?t(e[3]):r;return`${s}: ${n} ${r} ${l} ${g};`}};function Ls(s){return s.replace(/[^a-zA-Z0-9-]/g,"")}function Te(s){class e extends s{}return o([a(x)],e.prototype,"width",2),o([a(x)],e.prototype,"min-width",2),o([a(x)],e.prototype,"max-width",2),o([a(x)],e.prototype,"inline-size",2),o([a(x)],e.prototype,"min-inline-size",2),o([a(x)],e.prototype,"max-inline-size",2),e}function Os(s){class e extends s{}return o([a(x)],e.prototype,"height",2),o([a(x)],e.prototype,"min-height",2),o([a(x)],e.prototype,"max-height",2),o([a(x)],e.prototype,"block-size",2),o([a(x)],e.prototype,"min-block-size",2),o([a(x)],e.prototype,"max-block-size",2),e}function Ee(s){class e extends s{}return o([a(ie)],e.prototype,"margin",2),o([a(ie)],e.prototype,"margin-inline",2),o([a(ie)],e.prototype,"margin-block",2),e}function As(s){class e extends s{}return o([a(F)],e.prototype,"padding",2),o([a(F)],e.prototype,"padding-inline",2),o([a(F)],e.prototype,"padding-block",2),e}function je(s){class e extends s{}return o([a()],e.prototype,"align-self",2),o([a()],e.prototype,"justify-self",2),o([a()],e.prototype,"place-self",2),o([a()],e.prototype,"grid-column",2),o([a()],e.prototype,"grid-row",2),o([a()],e.prototype,"grid-area",2),o([a()],e.prototype,"flex",2),o([a()],e.prototype,"order",2),e}function Ds(s){class e extends s{}return o([a()],e.prototype,"position",2),o([a()],e.prototype,"transform",2),o([a()],e.prototype,"inset",2),e}const Vs=q`
  :host {
    display: block;
...
`;var Rs=Vs;let d=class extends Te(Os(Ee(As(je(Ds(R)))))){constructor(){super(...arguments),this.level="2"}render(){return ne`<slot></slot>`}};d.styles=[X,Rs];o([a()],d.prototype,"display",2);o([y()],d.prototype,"level",2);o([a(re("content"))],d.prototype,"color",2);o([a(re("background"))],d.prototype,"background",2);o([a({styleTemplate:function(s,e){const t=this,[n,r=t["border-style"]||"solid",l=t["border-color"]||"primary"]=e,g=`var(--gds-sys-space-${n})`,c=es(l,"border",t.level);return`border: ${g} ${r} ${c};`}})],d.prototype,"border",2);o([a(re("border"))],d.prototype,"border-color",2);o([a(F)],d.prototype,"border-width",2);o([a()],d.prototype,"border-style",2);o([a(F)],d.prototype,"border-radius",2);o([a({valueTemplate:s=>`var(--gds-sys-shadow-${s})`})],d.prototype,"box-shadow",2);o([a()],d.prototype,"opacity",2);o([a()],d.prototype,"overflow",2);o([a()],d.prototype,"box-sizing",2);o([a()],d.prototype,"z-index",2);o([a({styleTemplate:(s,e)=>{const t=e[0],n=`font-size: var(--gds-sys-text-size-${t});`,r=`line-height: var(--gds-sys-text-line-height-${t});`;return n+r}})],d.prototype,"font-size",2);o([a({valueTemplate:s=>`var(--gds-sys-text-weight-${s})`})],d.prototype,"font-weight",2);o([a()],d.prototype,"text-align",2);o([a()],d.prototype,"text-wrap",2);o([a()],d.prototype,"overflow-wrap",2);o([a()],d.prototype,"white-space",2);o([a({...F,styleTemplate:(s,e)=>{const t=e[0],n=e[1]||t;return`gap: ${t} ${n};`},cacheOverrideKey:"flex"})],d.prototype,"gap",2);o([a()],d.prototype,"align-items",2);o([a()],d.prototype,"align-content",2);o([a()],d.prototype,"justify-content",2);o([a()],d.prototype,"justify-items",2);o([a()],d.prototype,"flex-direction",2);o([a()],d.prototype,"flex-wrap",2);o([a()],d.prototype,"place-items",2);o([a()],d.prototype,"place-content",2);d=o([N("gds-div")],d);var H,Z,pe;const Ws=class ss{constructor(){b(this,H,new Map),b(this,Z,new Map),b(this,pe,!$e())}static get instance(){var e;return(e=globalThis.__gdsTransitionalStyles)!=null&&e[P]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[P]:new ss}),globalThis.__gdsTransitionalStyles[P]}apply(e,t){if(!e.shadowRoot)return;const n=i(this,H).get(t);n&&(i(this,Z).set(t,e),this.applyToElement(t,n))}applyToElement(e,t){var O,f;const n=i(this,Z).get(e);if(!n||!n.shadowRoot)return;const r=()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",v(t)),n._isUsingTransitionalStyles=!0},l=()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()},g="[gds-element=gds-theme]";let c=n.getRootNode(),m=n.closest(g);for(;m===null&&c!==document;)m=(O=c.host)==null?void 0:O.closest(g),c=(f=c.host)==null?void 0:f.getRootNode();if(m){const h=m,w=()=>{h.designVersion==="2023"?l():r()};if(h.addEventListener("gds-design-version-changed",w),n.addEventListener("gds-element-disconnected",()=>h.removeEventListener("gds-design-version-changed",w)),h.designVersion==="2023"){l();return}}r()}register(e,t){let n=t;i(this,pe)&&(n=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${t}`),i(this,H).set(e,n),this.applyToElement(e,n)}};H=new WeakMap;Z=new WeakMap;pe=new WeakMap;let Le=Ws;function Oe(s,e){const t={waitUntilFirstUpdate:!1,...e};return(n,r,l)=>{const{update:g}=n,c=Array.isArray(s)?s:[s];n.update=function(m){c.forEach(O=>{var h;const f=O;if(m.has(f)){const w=m.get(f),I=this[f];w!==I&&(!t.waitUntilFirstUpdate||this.hasUpdated)&&((h=l.value)==null||h.call(this,w,I))}}),g.call(this,m)}}}const Ps=q`
  @layer icon;
...
`;let D=class extends Te(R){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),Le.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return ne`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};D.styles=[...X,v(Ns)];o([y({type:Boolean,reflect:!0})],D.prototype,"selected",2);o([y()],D.prototype,"value",2);o([y({type:Boolean,reflect:!0})],D.prototype,"disabled",2);D=o([N("gds-segment")],D);const Is=`@layer base {
  :host {
...
`;var A,he,ts,ue,ye,me,J,K,xe,ve;const Bs=(s,e)=>{let t;return()=>{clearTimeout(t),t=setTimeout(s,e)}};let S=class extends je(Te(Ee(R))){constructor(){super(...arguments),b(this,he),this.size="medium",b(this,A,void 0),this._showPrevButton=!1,this._showNextButton=!1,this.intersectionObserver=null,b(this,ue,()=>{const e=this.segments.filter((t,n,r)=>{var l;return((l=r[n+1])==null?void 0:l.isVisible)&&!t.isVisible})[0];e&&(this._elTrack.scrollLeft-=e.offsetWidth)}),b(this,ye,()=>{const e=this.segments.filter((t,n,r)=>{var l;return((l=r[n-1])==null?void 0:l.isVisible)&&!t.isVisible}).reverse()[0];e&&(this._elTrack.scrollLeft+=e.offsetWidth)}),b(this,me,()=>{this.segments.every(e=>!e.isVisible)||(this._showPrevButton=!this.segments[0].isVisible,this._showNextButton=!this.segments[this.segments.length-1].isVisible)}),b(this,J,Bs(i(this,me),50)),b(this,K,()=>{const e=this.segments.find(t=>t.selected);if(e){const t=e.offsetWidth,n=e.offsetLeft;this._elIndicator.style.transform=`translateX(${n}px)`,this._elIndicator.style.width=`${t}px`}else this._elIndicator.style.transform="translateX(-100%)",this._elIndicator.style.width="0px"}),b(this,xe,e=>{const t=this.segments.find(n=>n===e.target||n.contains(e.target));t&&(this.segments.forEach(n=>n.selected=!1),t.selected=!0,_(this,A,t.value),i(this,K).call(this),this.dispatchCustomEvent("change",{detail:{segment:t},bubbles:!0,composed:!0}))}),b(this,ve,()=>{i(this,A)&&this.updateComplete.then(()=>{const e=this.segments.find(t=>t.value===i(this,A));e&&(this.segments.forEach(t=>t.selected=!1),e.selected=!0,this._elTrack.scrollLeft=e.offsetLeft)})})}get value(){return i(this,A)}set value(e){_(this,A,e),i(this,ve).call(this)}get segments(){return this._elSlot?this._elSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),Le.instance.apply(this,"gds-segmented-control"),this.updateComplete.then(()=>{this._elTrack.addEventListener("scroll",()=>{i(this,J).call(this)})})}render(){return ne`<button
      ...
      </button>`}_recalculateMinWidth(){this.updateComplete.then(()=>{i(this,J).call(this),i(this,K).call(this)})}};A=new WeakMap;he=new WeakSet;ts=function(){var e,t;const s=(e=this.segments.find(n=>n.selected))==null?void 0:e.value;s&&_(this,A,s),(t=this.intersectionObserver)==null||t.disconnect(),this.intersectionObserver=new IntersectionObserver(n=>{n.forEach(r=>{const l=r.target;l._isVisible=r.intersectionRatio>.99,i(this,J).call(this)})},{root:this._elTrack,threshold:[0,.01,.5,.99,1]}),this.segments.forEach(n=>{var r;(r=this.intersectionObserver)==null||r.observe(n)})};ue=new WeakMap;ye=new WeakMap;me=new WeakMap;J=new WeakMap;K=new WeakMap;xe=new WeakMap;ve=new WeakMap;S.styles=[X,v(Is)];o([y({reflect:!0})],S.prototype,"size",2);o([y()],S.prototype,"value",1);o([_e("slot")],S.prototype,"_elSlot",2);o([_e("#indicator")],S.prototype,"_elIndicator",2);o([_e("#track")],S.prototype,"_elTrack",2);o([Se()],S.prototype,"_showPrevButton",2);o([Se()],S.prototype,"_showNextButton",2);o([Fs(),Oe("value")],S.prototype,"_recalculateMinWidth",1);S=o([N("gds-segmented-control",{dependsOn:[D,j,L]}),fs()],S);let V=class extends R{constructor(){super(...arguments),this.colorScheme="light",this.designVersion="2016"}connectedCallback(){super.connectedCallback(),Le.instance.apply(this,"gds-theme"),this._dynamicStylesController.inject("dark",v(`:host {${ce}}`))}render(){return ne`<slot></slot>`}_onColorSchemeChange(){this.colorScheme==="dark"?this._dynamicStylesController.inject("color-scheme",v(`:host { ${ce}}`)):this._dynamicStylesController.inject("color-scheme",v(`:host { ${Xe}}`)),this.dispatchCustomEvent("gds-color-scheme-changed",{detail:{colorScheme:this.colorScheme}})}_onDesignVersionChange(){this.dispatchCustomEvent("gds-design-version-changed",{detail:{designVersion:this.designVersion}})}};V.styles=[X,q`
      :host {
        display: contents;
      }
    `];o([y({reflect:!0,attribute:"color-scheme"})],V.prototype,"colorScheme",2);o([y({reflect:!0,attribute:"design-version"})],V.prototype,"designVersion",2);o([Oe("colorScheme")],V.prototype,"_onColorSchemeChange",1);o([Oe("designVersion")],V.prototype,"_onDesignVersionChange",1);V=o([N("gds-theme")],V);const Js=s=>{d.define();const e=oe("gds-div"),t={...s,class:s.className};return U.createElement(e,t)},qs=s=>{S.define();const e=oe("gds-segmented-control"),t={...s,class:s.className};return U.createElement(e,t)},Us=s=>{V.define();const e=oe("gds-theme"),t={...s,class:s.className};return U.createElement(e,t)},Ge=s=>{D.define();const e=oe("gds-segment"),t={...s,class:s.className};return U.createElement(e,t)};function Xs(s){const e=Ie.modules.find(t=>t.declarations.find(n=>n.tagName===s));return e.exports.map(t=>({name:t.declaration.name,path:e.path.replace(/src\//,"@sebgroup/green-core/")}))}const Hs=s=>{const{of:e}=s,[t,n]=U.useState("web"),r=as(e||"meta"),l=Xs(r.preparedMeta.component),g=Object.keys({...r.preparedMeta.subcomponents});return M.createElement(Us,{designVersion:"2023"},M.createElement(Js,{margin:"0 0 2xl 0"},M.createElement("h2",null,"Import"),M.createElement(qs,{"max-width":"500px",value:t,onChange:c=>n(c.target.value)},M.createElement(Ge,{value:"web"},"Web component (Angular and others)"),M.createElement(Ge,{value:"react"},"React JSX")),l.filter(c=>c.name!=="*").map(c=>M.createElement("div",{key:c.name},t==="web"?M.createElement(Ae,{language:"javascript",dark:!0,code:`import { ${c.name} } from '@sebgroup/green-core/pure'
${c.name}.define()

// or, from direct path:
import { ${c.name} } from '${c.path}'
${c.name}.define()`}):M.createElement(Ae,{language:"javascript",dark:!0,code:`// Use as JSX element(s) in React
import { ${c.name}${g.length>0?g.map(m=>`, ${m}`):""} } from '@sebgroup/green-core/react'`})))))};function Fe(s){const e={blockquote:"blockquote",em:"em",h2:"h2",p:"p",strong:"strong",...Be(),...s.components};return p.jsxs(p.Fragment,{children:[p.jsx(is,{isTemplate:!0}),`
`,p.jsx(ls,{}),`
`,p.jsx(ds,{}),`
`,p.jsx(cs,{}),`
`,p.jsx(Hs,{}),`
