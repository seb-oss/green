import{i as z,a9 as I,Z as N,a2 as T,aj as Y,I as X,d as q,A,a as K,o as G,N as D,h as M,ak as R,n as g,f as L,a7 as F,g as U,O as j,G as V}from"./iframe-CsT9moiw.js";import{l as Z}from"./localized-decorator-CHDsyZqF.js";import{G as H}from"./card.component-l6leA0Xm.js";import{G as J}from"./flex.component-DByS7Bd2.js";import{I as Q}from"./cross-large.component-DHYPn8s8.js";const tt=z`
              ...
              <slot name="dialog">
                <gds-flex justify-content="space-between" padding="xl xl s xl">
                  ...
                  <gds-button
                    ...
                    size="small"
                    label=${D("Close")}
                    @click=${()=>s(this,p).call(this,"btn-close")}
                  >
                ...
                <gds-div
                  ...
                  flex="1"
                  padding="s xl"
                  overflow=${G(this.scrollable)?"auto":A}
                >
                  <slot></slot>
                </gds-div>
                <gds-flex
                ...
                >
                  <slot name="footer">
                    <gds-button
                      value="cancel"
                      @click=${()=>s(this,p).call(this,"btn-cancel")}
                      rank="secondary"
                      >${D("Cancel")}</gds-button
                    >
                    <gds-button
                      value="ok"
                      @click=${()=>s(this,p).call(this,"btn-ok")}
                    >
                      Ok
                    </gds-button>
                  </slot>
