import{b as a}from"./iframe-CsT9moiw.js";import"./input-4pYwEqnJ.js";import"./badge-CIrLJTTC.js";import"./flex-BGpOyHJY.js";import"./divider-DZPfj6YF.js";import"./credit-card-CEnZQ9wM.js";import"./magnifying-glass-C0YSeHQz.js";import"./people-profile-BA37p8Rf.js";import{a as ye}from"./argTableProps-A5yy1ZV7.js";import"./preload-helper-Dp1pzeXC.js";import"./input.component-QWwAgPp6.js";import"./localized-decorator-CHDsyZqF.js";import"./query-async-DTsUub8W.js";import"./form-control-host.style-Blx6QSWg.js";import"./form-control-header.component-1yNw0pfW.js";import"./badge.component-B0SXmL5O.js";import"./flex.component-DByS7Bd2.js";import"./triangle-exclamation.component-CswFTZZr.js";import"./icon.component-DVm-kf_1.js";import"./card.component-l6leA0Xm.js";import"./cross-small.component-CQJ2s4d-.js";import"./textarea.component-C7rXnKla.js";import"./resize-observer-B9k8v2TZ.js";import"./divider.component-CL3aSvme.js";import"./credit-card.component-DC4i4FX_.js";import"./magnifying-glass.component-DpoltKTY.js";import"./people-profile.component-D9HKQCYk.js";const Je={title:"Components/Input",component:"gds-input",parameters:{layout:"centered",docs:{description:{component:"An input lets users enter and edit text or numerical values in forms."}}},tags:["autodocs"],argTypes:{...ye("gds-input"),value:{control:"text"},variant:{options:["default"],control:{type:"select"}},size:{options:["large","small"],control:{type:"select"}},invalid:{control:"boolean"}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{label:"Label",variant:"default",size:"large",supportingText:"Label support text.",innerHTML:'<gds-icon-people-profile slot="lead"></gds-icon-people-profile>'}},x={...t,name:"Default"},r={...t,name:"Size",render:()=>a`
  ...
  ...DefaultParams,
  name: 'Default'
}`,...(h=(f=x.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var v,y,L,S,w;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <gds-flex width="800px" gap="4xl" align-items="flex-start">
  ...
  \`
}`,...(D=(E=i.parameters)==null?void 0:E.docs)==null?void 0:D.source},description:{story:'**@slot lead** - Slot for an icon or other content to be placed at the beginning of the input field.\n\n```html\n <gds-input label="Lead Icon">\n   <gds-icon-magnifying-glass slot="lead"></gds-icon-magnifying-glass>\n</gds-input>```',...(k=(C=i.parameters)==null?void 0:C.docs)==null?void 0:k.description}}};var z,I,P,q,N;s.parameters={...s.parameters,docs:{...(z=s.parameters)==null?void 0:z.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Slot: Trail',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...(V=($=o.parameters)==null?void 0:$.docs)==null?void 0:V.source},description:{story:'The `length` property can be set to a number to limit the number of characters that can be entered into the input field.<br> A badge will be displayed, updating as the input approaches the character limit.\n\n**@property maxLength** - The maximum number of characters that can be entered into the input field.\n\n```html\n <gds-input maxLength="20"></gds-input>\n```',...(G=(U=o.parameters)==null?void 0:U.docs)==null?void 0:G.description}}};var F,B,M,R,H;l.parameters={...l.parameters,docs:{...(F=l.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Clearable',
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="320px">
  ...
  \`
}`,...(M=(B=l.parameters)==null?void 0:B.docs)==null?void 0:M.source},description:{story:'When the `clearable` property is set, a clear button is added, allowing users to quickly clear the text.\n\n@property clearable - Enables the clear button for the input field.\n\n```html\n <gds-input label="Label text" value="Clear this text" clearable></gds-input>\n```',...(H=(R=l.parameters)==null?void 0:R.docs)==null?void 0:H.description}}};var W,_,j,O,J;d.parameters={...d.parameters,docs:{...(W=d.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(j=(_=d.parameters)==null?void 0:_.docs)==null?void 0:j.source},description:{story:'The `supporting-text` property can be set to a string to provide additional information about the input field.\n\n**@property supporting-text** - Additional information about the input field.\n\n```html\n  <gds-input label="Label text" supporting-text="Supporting text"></gds-input>\n```',...(J=(O=d.parameters)==null?void 0:O.docs)==null?void 0:J.description}}};var K,Q,X,Y,Z;p.parameters={...p.parameters,docs:{...(K=p.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...DefaultParams,
...
\`\`\``,...(re=(ne=u.parameters)==null?void 0:ne.docs)==null?void 0:re.description}}};var ie,se,oe,le,de;c.parameters={...c.parameters,docs:{...(ie=c.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  ...
  \`
}`,...(oe=(se=c.parameters)==null?void 0:se.docs)==null?void 0:oe.source},description:{story:`Most standard attributes are supported, and will be forwarded to the internal input element.
...
differ from the displayed value.`,...(de=(le=c.parameters)==null?void 0:le.docs)==null?void 0:de.description}}};var pe,ue,ce,ge,me;g.parameters={...g.parameters,docs:{...(pe=g.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex gap="xl">
  ...
  \`
}`,...(fe=(be=m.parameters)==null?void 0:be.docs)==null?void 0:fe.source},description:{story:"The `charCounterCallback` property can be used to customize the character counter badge.\n\nCheck the [story source](https://github.com/seb-oss/green/blob/main/libs/core/src/components/input/input.stories.ts) to see the full code for this example, as Storybook strips away property assignments in the code examples.",...(ve=(he=m.parameters)==null?void 0:he.docs)==null?void 0:ve.description}}};const Ke=["Default","Size","Lead","Trail","Length","Clearable","SupportingText","ExtendedSupportingText","Validation","StandardAttributes","Disabled","CustomCounterBadge"];export{l as Clearable,m as CustomCounterBadge,x as Default,g as Disabled,p as ExtendedSupportingText,i as Lead,o as Length,r as Size,c as StandardAttributes,d as SupportingText,s as Trail,u as Validation,Ke as __namedExportsOrder,Je as default};
