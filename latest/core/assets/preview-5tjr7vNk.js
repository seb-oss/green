...
`;let Z=class extends we(D){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),xe.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return Q`<button
    ...
    >
      <slot></slot>
    </button>`}};Z.styles=[...W,_(Et)];o([p({type:Boolean,reflect:!0})],Z.prototype,"selected",2);o([p()],Z.prototype,"value",2);o([p({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);Z=o([$("gds-segment")],Z);const Mt=`@layer base {
  :host {
    background-color: var(--gds-sys-color-l3-background-secondary);
...
`;var jt=Lt;let O=class extends d{constructor(){super(...arguments),this.tag="span"}render(){const e=Rs(encodeURI(this.tag));return ps`<${e} tag><slot></slot></${e}>`}};O.styles=[W,Vt,jt];o([p({type:String})],O.prototype,"tag",2);o([i({selector:"[tag]",styleTemplate:(s,e)=>{const t=e[0],n=`font-size: var(--gds-sys-text-size-${t});`,r=`line-height: var(--gds-sys-text-line-height-${t});`;return n+r}})],O.prototype,"font-size",2);o([i({selector:"[tag]",valueTemplate:s=>`var(--gds-sys-text-weight-${s})`})],O.prototype,"font-weight",2);o([i()],O.prototype,"text-transform",2);o([i({selector:"[tag]"})],O.prototype,"text-decoration",2);o([i({selector:"[tag]",styleTemplate:(s,e)=>`overflow: hidden;
      text-overflow: ellipsis;
      display: -webkit-box;
