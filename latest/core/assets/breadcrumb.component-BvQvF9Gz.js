import{i as m,S as P,$ as G,T as S,J as v,O as E,a as A,h,t as B,n as d,g as y,o as g,E as I}from"./iframe-Dz9p1f8e.js";import{l as D}from"./localized-decorator-VO--eyaN.js";import{I as M}from"./chevron-left.component-BeTKPYk2.js";import{G as k}from"./link-Bw3baVXp.js";import{G as L}from"./text-Bzg5QSx2.js";const T=m`
...
`;var j=Object.defineProperty,W=Object.getOwnPropertyDescriptor,u=(t,e,s,n)=>{for(var r=n>1?void 0:n?W(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&j(e,s,r),r};let f=class extends P(G(S(v))){constructor(){super(...arguments),this.size="large",this.label=E("Breadcrumbs")}get breadcrumbItems(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumb]"))}handleSlotChange(){const t=this.breadcrumbItems;t.forEach((e,s)=>{s===t.length-2?e.setAttribute("return",""):e.removeAttribute("return")})}render(){return h`
      <nav
        role="navigation"
    ...
    `}};f.styles=[B,T];u([d({type:String})],f.prototype,"size",2);u([d({type:String})],f.prototype,"label",2);f=u([y("gds-breadcrumbs",{dependsOn:[M]}),D()],f);const q=m`
  @layer base {
    :host {
      display: contents;
    }
...
`;var J=Object.defineProperty,R=Object.getOwnPropertyDescriptor,_=t=>{throw TypeError(t)},c=(t,e,s,n)=>{for(var r=n>1?void 0:n?R(e,s):e,l=t.length-1,o;l>=0;l--)(o=t[l])&&(r=(n?o(e,s,r):o(r))||r);return n&&r&&J(e,s,r),r},b=(t,e,s)=>e.has(t)||_("Cannot "+s),X=(t,e,s)=>(b(t,e,"read from private field"),s?s.call(t):e.get(t)),F=(t,e,s)=>e.has(t)?_("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),p=(t,e,s)=>(b(t,e,"access private method"),s),a,x,w,$,C,O,z;let i=class extends v{constructor(){super(...arguments),F(this,a),this.href="",this.label="",this.overflow=!1}render(){return h`
