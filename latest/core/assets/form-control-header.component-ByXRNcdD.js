import{i as w,n as f,a2 as _,A as C,b,h as i,E as O,g as E,z as P,d as W,H as B,I as F}from"./iframe-BOjKxah_.js";import{G as H}from"./badge.component-BY_WjR5L.js";import{I,a as A}from"./triangle-exclamation.component-vDur_dV0.js";import{l as D}from"./localized-decorator-D8E2PHaz.js";import{G as L}from"./card.component-DlSMeA2J.js";const V=w`
...
`;var R=Object.defineProperty,j=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},x=(e,t,s,a)=>{for(var r=a>1?void 0:a?j(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&R(t,s,r),r},q=(e,t,s)=>t.has(e)||S("Cannot "+s),J=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),K=(e,t,s)=>(q(e,t,"access private method"),s),v,T;let d=class extends C{constructor(){super(...arguments),J(this,v)}_handleVisibilityChange(){var e;this.classList.toggle("visually-hidden",!this.errorMessage&&!((e=this.charCounter)!=null&&e[1]))}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return i`<div aria-live="polite">
...
`;var Q=Object.defineProperty,U=Object.getOwnPropertyDescriptor,$=e=>{throw TypeError(e)},u=(e,t,s,a)=>{for(var r=a>1?void 0:a?U(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&Q(t,s,r),r},G=(e,t,s)=>t.has(e)||$("Cannot "+s),p=(e,t,s)=>(G(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?$("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),k=(e,t,s)=>(G(e,t,"access private method"),s),c,z,m,y,g,M;let l=class extends C{constructor(){super(...arguments),h(this,c),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,h(this,m,()=>i`
    ...
    `};l.styles=[N];u([f({type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);u([P()],l.prototype,"_hasExtendedSupportingText",2);u([W("#extended-supporting-text")],l.prototype,"_extendedSupportingText",2);l=u([E("gds-form-control-header",{dependsOn:[F,L,A]}),D()],l);export{l as G,d as a};
