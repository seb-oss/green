import{i as $,t as A,aj as B,n as i,d as w,a6 as x,a7 as G,b as W,h as g,g as E,U as H,S as U,T as J,$ as N,a as O}from"./iframe-5Lm7tces.js";import{G as q}from"./toggle-control-base.component-DgIC3AxH.js";import{c as R}from"./rbcb-toggle.template-CCu8OBQ9.js";import{I as X}from"./checkmark.component-3jlRh9y4.js";import{I as K}from"./minus-small.component-Cs3ahbsh.js";import{l as Q}from"./localized-decorator-BtCNmkdo.js";import{G as Y,a as Z}from"./form-control-header.component-BAo3pxK9.js";const j=$`
  :host {
    cursor: pointer;
  }
...
`;var oe=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,z=e=>{throw TypeError(e)},o=(e,t,s,c)=>{for(var a=c>1?void 0:c?ie(t,s):t,p=e.length-1,u;p>=0;p--)(u=e[p])&&(a=(c?u(t,s,a):u(a))||a);return c&&a&&oe(t,s,a),a},T=(e,t,s)=>t.has(e)||z("Cannot "+s),f=(e,t,s)=>(T(e,t,"read from private field"),s?s.call(e):t.get(e)),k=(e,t,s)=>t.has(e)?z("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),d=(e,t,s)=>(T(e,t,"access private method"),s),v,n,P,V,F,I,m,L,D;let r=class extends G{constructor(){super(...arguments),k(this,n),this.size="large",this.direction="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,k(this,v,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){f(this,v).call(this)}focus(){var e;(e=this.checkboxes[0])==null||e.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",f(this,v))}render(){const e={"checkbox-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return g`<div
    ...
    </div>`}_syncOnDOMChange(){f(this,v).call(this),d(this,n,m).call(this)}};v=new WeakMap;n=new WeakSet;P=function(){return[d(this,n,V).call(this),d(this,n,F).call(this),d(this,n,D).call(this)].map(t=>g`${t}`)};V=function(){if(this.label)return g`<gds-form-control-header
