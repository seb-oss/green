import"./switch-yOAbsxn6.js";import"./flex-DWB72lsx.js";import{b as t}from"./iframe-WQFYoQO9.js";import"./text-DgucYaSW.js";import"./divider-BA5Mrn3x.js";import{a as B}from"./argTableProps-BVau8RXv.js";import"./switch.component-DITnoaYv.js";import"./checkmark.component-PnTpgWTX.js";import"./icon.component--QCp8uFS.js";import"./flex.component-IAhzQliM.js";import"./preload-helper-Dp1pzeXC.js";import"./text.component-jcC2vn4E.js";import"./default-typography.styles-DF4gMSGd.js";const K={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...B("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},n={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
...
}`,...(D=(P=c.parameters)==null?void 0:P.docs)==null?void 0:D.source}}};const Q=["Switch","States","ControlPlacement","JustifyContent","Size","Events"];export{l as ControlPlacement,c as Events,a as JustifyContent,i as Size,d as States,n as Switch,Q as __namedExportsOrder,K as default};
