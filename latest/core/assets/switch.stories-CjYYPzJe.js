import"./switch-D3zftz_z.js";import"./flex-DNTtcIva.js";import{b as t}from"./iframe-BQBiNmH_.js";import"./text-BQP2q-4d.js";import"./divider-BnhyRnPs.js";import{a as x}from"./argTableProps-C2COD3R6.js";import"./switch.component-CwuGDmSg.js";import"./checkmark.component-CvIaKaXd.js";import"./icon.component-Cz_pvx9c.js";import"./flex.component-D_j--owZ.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-Ddv93aOT.js";import"./default-typography.styles-CY-dADHx.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
