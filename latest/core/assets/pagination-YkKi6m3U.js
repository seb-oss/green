import{i as E,T as L,$ as D,S as W,J as A,E as R,h as c,b as v,O as p,t as T,n as g,d as J,I as _,a as F,g as q,Q}from"./iframe-5Lm7tces.js";import{l as V}from"./localized-decorator-BtCNmkdo.js";import{w as X,G as Y}from"./popover.component-DCru0COF.js";import{a as H,G as K}from"./context-menu.component-B4_VjvTW.js";import{a as U}from"./dropdown.component-4HA-RhFd.js";import{I as Z}from"./chevron-bottom.component-94SivROE.js";import{I as tt,a as et,b as st,c as nt}from"./chevron-right-small.component-BZMvL1Lg.js";import{I as it}from"./chevron-right.component-Cq1kZ2-r.js";import{G as ot}from"./input.component-DxwS5kiU.js";import{G as at}from"./text-BYkRAgbf.js";const rt=E`
  :host {
    display: flex;
    align-items: center;
...
`;var lt=Object.defineProperty,pt=Object.getOwnPropertyDescriptor,y=t=>{throw TypeError(t)},h=(t,s,n,d)=>{for(var l=d>1?void 0:d?pt(s,n):s,m=t.length-1,b;m>=0;m--)(b=t[m])&&(l=(d?b(s,n,l):b(l))||l);return d&&l&&lt(s,n,l),l},x=(t,s,n)=>s.has(t)||y("Cannot "+n),i=(t,s,n)=>(x(t,s,"read from private field"),n?n.call(t):s.get(t)),ht=(t,s,n)=>s.has(t)?y("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,n),o=(t,s,n)=>(x(t,s,"access private method"),n),e,u,a,P,w,G,C,I,k,z,M,O,S,B,f,j,N,$;const dt={compact:{button:"small",font:"detail-book-s",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-book-s",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-book-m",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let r=class extends L(D(W(A))){constructor(){super(...arguments),ht(this,e),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(t){this._isMobile=t}render(){return i(this,e,u)<=1?R:c`
      <gds-flex
        align-items="center"
