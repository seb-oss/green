import{u as o,j as e,M as r}from"./iframe-5Lm7tces.js";import"./preload-helper-Dp1pzeXC.js";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Components/Table/Developer Guide"}),`
...
\`
`})}),`
`,e.jsx(n.h3,{id:"sticky-actions",children:"Sticky Actions"}),`
`,e.jsxs(n.p,{children:["Set ",e.jsx(n.code,{children:"sticky: true"})," on the actions configuration to pin the actions column to the right edge during horizontal scrolling. This ensures action buttons remain accessible when the table overflows horizontally."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`const actions: Types.Actions = {
  label: 'Actions',
  justify: 'end',
  sticky: true,
...
`})}),`
`,e.jsx(n.p,{children:"The sticky column automatically adjusts its z-index and alignment. Both the header cell and body cells become sticky, staying visible as the user scrolls."}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsxs(n.p,{children:["The actions column uses ",e.jsx(n.code,{children:"tfoot:actions"}),"."]}),`
