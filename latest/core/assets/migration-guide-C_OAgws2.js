import{u as r,j as e,M as i}from"./iframe-Dz9p1f8e.js";import"./preload-helper-Dp1pzeXC.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guides/Migration guides"}),`
...
`,e.jsx(n.h2,{id:"automated-migrations",children:"Automated migrations"}),`
`,e.jsxs(n.p,{children:["Many migrations can be automated using the ",e.jsx(n.code,{children:"green-core-context migrate"}),` command. This will detect and apply code changes for supported automated migrations.
Check out the `,e.jsx(n.a,{href:"/docs/guides-green-context-cli--docs",children:"Context CLI documentation"})," for more details on how to use the migration engine."]}),`
