...
`;var ze=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,he=e=>{throw TypeError(e)},i=(e,t,o,c)=>{for(var l=c>1?void 0:c?Oe(t,o):t,C=e.length-1,M;C>=0;C--)(M=e[C])&&(l=(c?M(t,o,l):M(l))||l);return c&&l&&ze(t,o,l),l},k=(e,t,o)=>t.has(e)||he("Cannot "+o),S=(e,t,o)=>(k(e,t,"read from private field"),t.get(e)),E=(e,t,o)=>t.has(e)?he("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),qe=(e,t,o,c)=>(k(e,t,"write to private field"),t.set(e,o),o),p=(e,t,o)=>(k(e,t,"access private method"),o),y,w,s,ve,be,xe,fe,ye,Se;let n=class extends De{constructor(){super(...arguments),E(this,s),this.supportingText="",this.size="large",E(this,y,!1),E(this,w,e=>{e.stopPropagation(),p(this,s,ve).call(this),this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})}get value(){return this._internalValue}set value(e){S(this,y)||qe(this,y,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){var e;return((e=this.selectElement)==null?void 0:e.multiple)??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}render(){const e={multiple:this.multiple};return u`
...
Setting value or selected props on the select element will not work as expected.`}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},d={...a,name:"Select",args:{label:"Label text",supportingText:"Supporting text",value:"organic-chemistry",innerHTML:`
  ...
  `};var _,D,A,z,O;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
    label: 'Label text',
...
<br>It is set by adding an icon component to the 'lead' slot.`,...(H=(N=g.parameters)==null?void 0:N.docs)==null?void 0:H.description}}};var B,W,J,j,F;h.parameters={...h.parameters,docs:{...(B=h.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
