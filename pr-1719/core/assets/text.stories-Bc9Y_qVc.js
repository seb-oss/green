import"./text-C_oJEcfN.js";import"./card-ZuYQL3Kq.js";import"./container-Z83N913X.js";import"./flex-DOOC34tY.js";import"./divider-DkqSgEb0.js";import{x as e}from"./lit-element-C_s9q329.js";import"./custom-element-scoping-CpYtbs9r.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./class-map-Bz98xO8-.js";import"./directive-CF8sV3Lr.js";import"./static-_ukc2i0J.js";import"./tokens.style-RalixZsd.js";import"./style-expression-property-C6V8xdlu.js";const me={title:"Components/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:`The \`gds-text\`
...
## Usage`}}}},m={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["heading-xl","heading-l","heading-m","heading-s","heading-xs","heading-2xs","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...m,name:"Tags",render:t=>e`<gds-flex flex-direction="column" gap="2xl">
...
}`,...(z=(b=r.parameters)==null?void 0:b.docs)==null?void 0:z.source}}};var L,v,H,D,w;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: 'Heading',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text tag="h6">H6: Heading 2XS</gds-text>
  ...
  \`
}`,...(k=(P=a.parameters)==null?void 0:P.docs)==null?void 0:k.source}}};var C,T,M;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text font-size="body-s">Body Small</gds-text>
  ...
  \`
}`,...(R=(I=n.parameters)==null?void 0:I.docs)==null?void 0:R.source},description:{story:"The `gds-text` component has a `lines` property that will clamp the text to the specified number of lines. It can be any number value.",...(_=(j=n.parameters)==null?void 0:j.docs)==null?void 0:_.description}}};var A,F,Y,G,J;o.parameters={...o.parameters,docs:{...(A=o.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'Color',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-theme color-scheme="dark">
  ...
  \`
}`,...(Y=(F=o.parameters)==null?void 0:F.docs)==null?void 0:Y.source},description:{story:'The `gds-text` component has a `color` property that will change the text color based on the specified color token.\n\ne.g. `<gds-text level="1" color="primary"></gds-text>`',...(J=(G=o.parameters)==null?void 0:G.docs)==null?void 0:J.description}}};var K,N,Q,V,Z;i.parameters={...i.parameters,docs:{...(K=i.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Decoration',
  render: args => html\`<gds-flex flex-direction="column" gap="m">
      <gds-text text-underline-offset="0.2lh" text-decoration="underline">
...
}`,...(Q=(N=i.parameters)==null?void 0:N.docs)==null?void 0:Q.source},description:{story:'`gds-text` component has a `text-decoration` property that will change the text decoration based on the css values such as `underline`, `overline`, `line-through`, `underline dotted`, `{COLOR} wavy underline` etc.\n\nAlso supports offset for the underline with `text-underline-offset` property.\n\ne.g.\n\n```html\n<gds-text\n   text-underline-offset="0.2lh"\n   text-decoration="currentcolor wavy underline"\n >\n   Wavy Underline\n </gds-text>\n```',...(Z=(V=i.parameters)==null?void 0:V.docs)==null?void 0:Z.description}}};const ce=["Card","Weight","Heading","Detail","Body","Display","Preamble","Lines","Color","Decoration"];export{l as Body,s as Card,o as Color,i as Decoration,a as Detail,g as Display,d as Heading,n as Lines,x as Preamble,r as Weight,ce as __namedExportsOrder,me as default};
