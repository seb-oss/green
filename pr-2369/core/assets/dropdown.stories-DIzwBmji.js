...
field, and it also supports both single and multiple selection.`}}},tags:["autodocs"],argTypes:{...ho("gds-dropdown")}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{options:{control:{type:"array"}}},args:{innerHTML:`
  ...
  \`
}`,...(M=(B=a.parameters)==null?void 0:B.docs)==null?void 0:M.source},description:{story:"The Dropdown is available in two sizes: `small` and `medium`. `medium` is the default.",...(F=(R=a.parameters)==null?void 0:R.docs)==null?void 0:F.description}}};var q,G,H,L,O;r.parameters={...r.parameters,docs:{...(q=r.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-dropdown label="Select tech" hide-label>
      <gds-option value="">Select tech</gds-option>
  ...
  \`
}`,...(H=(G=r.parameters)==null?void 0:G.docs)==null?void 0:H.source},description:{story:`A common use case for the small version is in constrained areas, such as table cells. In those cases,
...
screen readers.`,...(O=(L=r.parameters)==null?void 0:L.docs)==null?void 0:O.description}}};var z,Q,U,$,Y;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  ...DefaultParams,
  render: args => html\`
    <gds-dropdown label="Select tech">
      <gds-option value="" isplaceholder>This is a placeholder</gds-option>
