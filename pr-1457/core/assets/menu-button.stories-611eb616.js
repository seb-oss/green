...
`;var K=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,n=(t,e,s,p)=>{for(var i=p>1?void 0:p?Q(e,s):e,h=t.length-1,v;h>=0;h--)(v=t[h])&&(i=(p?v(e,s,i):v(i))||i);return p&&i&&K(e,s,i),i},V=(t,e,s)=>{if(!e.has(t))throw TypeError("Cannot "+s)},l=(t,e,s)=>(V(t,e,"read from private field"),s?s.call(t):e.get(t)),w=(t,e,s)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,s)},a,d,y,G;let o=class extends W{constructor(){super(),w(this,a),w(this,y),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1,U(this)}render(){const t={button:!0,selected:this.selected,compact:this.compact},e=l(this,a,d)?_`a`:_`button`;return H`
    ...
    `}};a=new WeakSet;d=function(){return this.href.length>0};y=new WeakSet;G=function(){return this.target==="_blank"?"noreferrer noopener":void 0};o.styles=[I,A(J)];o.shadowRootOptions={mode:"open",delegatesFocus:!0};n([r({type:Boolean,reflect:!0})],o.prototype,"disabled",2);n([r()],o.prototype,"label",2);n([r()],o.prototype,"href",2);n([r()],o.prototype,"target",2);n([r()],o.prototype,"rel",2);n([r()],o.prototype,"download",2);n([r({type:Boolean,reflect:!0})],o.prototype,"compact",2);n([r({type:Boolean,reflect:!0})],o.prototype,"selected",2);o=n([M("gds-menu-button")],o);const me={title:"Components/Menu button",component:"gds-menu-button",parameters:{layout:"centered"},tags:["autodocs"]},f={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerHTML:`<gds-icon-magnifying-glass slot="lead"></gds-icon-magnifying-glass>
