...
`;var A=Object.defineProperty,F=Object.getOwnPropertyDescriptor,s=(o,e,r,c)=>{for(var a=c>1?void 0:c?F(e,r):e,b=o.length-1,f;b>=0;b--)(f=o[b])&&(a=(c?f(e,r,a):f(a))||a);return c&&a&&A(e,r,a),a},H=(o,e,r)=>{if(!e.has(o))throw TypeError("Cannot "+r)},l=(o,e,r)=>(H(o,e,"read from private field"),r?r.call(o):e.get(o)),_=(o,e,r)=>{if(e.has(o))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(o):e.set(o,r)},i,d,h,D;let t=class extends G{constructor(){super(),_(this,i),_(this,h),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1,T(this)}render(){const o={button:!0,selected:this.selected,compact:this.compact},e=l(this,i,d)?v`a`:v`button`;return R`
      <${e}
        class="${M(o)}"
...
}`,...(B=(E=m.parameters)==null?void 0:E.docs)==null?void 0:B.source}}};const oe=["Basic","Selected_state","Examples"];export{p as Basic,m as Examples,u as Selected_state,oe as __namedExportsOrder,ee as default};
