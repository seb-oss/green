...
`;var qe=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,$=(e,t,a,o)=>{for(var r=o>1?void 0:o?Ve(t,a):t,n=e.length-1,l;n>=0;n--)(l=e[n])&&(r=(o?l(t,a,r):l(r))||r);return o&&r&&qe(t,a,r),r};let L=class extends me{constructor(){super(),this.label="",this.supportingText=""}connectedCallback(){super.connectedCallback(),De.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,"has-supporting-text":!!this.supportingText};return x`
    ...
    `}};R=new WeakMap;S=new WeakMap;p.styles=[A,Fe];u([d()],p.prototype,"label",2);u([d({attribute:"supporting-text"})],p.prototype,"supportingText",2);u([d()],p.prototype,"value",2);u([d({type:Boolean,reflect:!0})],p.prototype,"checked",2);u([d({type:Boolean,reflect:!0})],p.prototype,"disabled",2);u([d({type:Boolean})],p.prototype,"invalid",2);u([Ce()],p.prototype,"_isFocused",2);u([G("disabled")],p.prototype,"_handleDisabledChange",1);p=u([D("gds-radio")],p);const He=C`
  :host {
...
`;var Ne=Object.defineProperty,je=Object.getOwnPropertyDescriptor,_e=e=>{throw TypeError(e)},c=(e,t,a,o)=>{for(var r=o>1?void 0:o?je(t,a):t,n=e.length-1,l;n>=0;n--)(l=e[n])&&(r=(o?l(t,a,r):l(r))||r);return o&&r&&Ne(t,a,r),r},Ke=(e,t,a)=>t.has(e)||_e("Cannot "+a),Ue=(e,t,a)=>t.has(e)?_e("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),i=(e,t,a)=>(Ke(e,t,"access private method"),a),s,z,we,T,Le,Ee,k,Re,Se,ze,ke;let g=class extends Pe{constructor(){super(...arguments),Ue(this,s),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),i(this,s,z).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{i(this,s,z).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return x`<div
    ...
    >
    </gds-form-control-footer>`};g.styles=[A,He];c([d()],g.prototype,"size",2);c([d()],g.prototype,"direction",2);c([d({attribute:"supporting-text"})],g.prototype,"supportingText",2);c([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],g.prototype,"showExtendedSupportingText",2);c([Ae(".content")],g.prototype,"_contentElement",2);c([G("value")],g.prototype,"_handleValueChange",1);c([G("invalid")],g.prototype,"_syncRadioStates",1);g=c([ve()],g);let F=class extends Ge($e(Te(g))){};F=c([D("gds-radio-group")],F);const Rt={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],argTypes:{...Oe("gds-radio-group")},parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},h={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},m={...h,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
  ...
  `};var I,q,V,M,B;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Radio',
  args: {
...
}`,...(V=(q=m.parameters)==null?void 0:q.docs)==null?void 0:V.source},description:{story:`Radio buttons allow users to select a single option from a list of two or more mutually exclusive options.<br />
...
Interactive example with supporting texts:`,...(B=(M=m.parameters)==null?void 0:M.docs)==null?void 0:B.description}}};var W,H,N,j,K;v.parameters={...v.parameters,docs:{...(W=v.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Validation',
  render: () => html\`
    <form method="dialog">
  ...
  \`
}`,...(N=(H=v.parameters)==null?void 0:H.docs)==null?void 0:N.source},description:{story:`Radio groups support validation using Green Core's [form validation API](/docs/components-form-validation-documentation--docs).
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...(K=(j=v.parameters)==null?void 0:j.docs)==null?void 0:K.description}}};var U,X,J;E.parameters={...E.parameters,docs:{...(U=E.parameters)==null?void 0:U.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(J=(X=E.parameters)==null?void 0:X.docs)==null?void 0:J.source}}};var Q,Y,Z,ee,te;f.parameters={...f.parameters,docs:{...(Q=f.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(Z=(Y=f.parameters)==null?void 0:Y.docs)==null?void 0:Z.source},description:{story:`Disabled radio buttons cannot be interacted with and appear visually muted.

In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(te=(ee=f.parameters)==null?void 0:ee.docs)==null?void 0:te.description}}};var ae,oe,re,se,ie;y.parameters={...y.parameters,docs:{...(ae=y.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(re=(oe=y.parameters)==null?void 0:oe.docs)==null?void 0:re.source},description:{story:`Radio buttons support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the radio group and applies to all radio buttons within.`,...(ie=(se=y.parameters)==null?void 0:se.docs)==null?void 0:ie.description}}};var de,ne,le,pe,ge;_.parameters={..._.parameters,docs:{...(de=_.parameters)==null?void 0:de.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(le=(ne=_.parameters)==null?void 0:ne.docs)==null?void 0:le.source},description:{story:`Radio buttons can be arranged in two directions:
...
Choose the direction based on available space and number of options.`,...(ge=(pe=_.parameters)==null?void 0:pe.docs)==null?void 0:ge.description}}};var ue,ce,xe,he,be;w.parameters={...w.parameters,docs:{...(ue=w.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(xe=(ce=w.parameters)==null?void 0:ce.docs)==null?void 0:xe.source},description:{story:`While radio groups can be created without a label, it's recommended to always provide one for clarity and accessibility.
The label helps users understand what the options are for.

In certain cases when space is limited, the group label can be omitted.`,...(be=(he=w.parameters)==null?void 0:he.docs)==null?void 0:be.description}}};const St=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{_ as Direction,f as Disabled,E as DosAndDonts,w as GroupLabel,m as RadioButton,y as Size,v as Validation,St as __namedExportsOrder,Rt as default};
