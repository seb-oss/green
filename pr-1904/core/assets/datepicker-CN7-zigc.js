...
`;var ce=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,Ft=t=>{throw TypeError(t)},I=(t,e,a,i)=>{for(var s=i>1?void 0:i?pe(e,a):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(s=(i?o(e,a,s):o(s))||s);return i&&s&&ce(e,a,s),s},$t=(t,e,a)=>e.has(t)||Ft("Cannot "+a),_=(t,e,a)=>($t(t,e,"read from private field"),a?a.call(t):e.get(t)),S=(t,e,a)=>e.has(t)?Ft("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),Yt=(t,e,a,i)=>($t(t,e,"write to private field"),e.set(t,a),a),w=(t,e,a)=>($t(t,e,"access private method"),a),Y,O,V,R,B,tt,et,at,y,Wt,A,st,T,G;let M=class extends Vt{constructor(){super(...arguments),S(this,y),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=w(this,y,st).call(this,this.value,this.length),S(this,Y,""),S(this,O,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=w(this,y,T).call(this,t+1),w(this,y,A).call(this)}),S(this,V,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=w(this,y,T).call(this,t-1),w(this,y,A).call(this)}),S(this,R,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),S(this,B,()=>{w(this,y,G).call(this)}),S(this,tt,()=>{_(this,Y)!==""&&(w(this,y,G).call(this),this.value=w(this,y,T).call(this,parseInt(this.value.toString())),w(this,y,A).call(this))}),S(this,et,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?_(this,V).call(this):_(this,O).call(this)}),S(this,at,t=>{let e=!1;if(t.key==="ArrowUp")_(this,O).call(this),e=!0;else if(t.key==="ArrowDown")_(this,V).call(this),e=!0;else{const a=parseInt(t.key);isNaN(a)||(_(this,Y).length<this.length&&(Yt(this,Y,_(this,Y)+a.toString()),this.value=parseInt(_(this,Y))),_(this,Y).length===this.length&&(this.value=w(this,y,T).call(this,this.value),w(this,y,G).call(this),w(this,y,Wt).call(this),w(this,y,A).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",_(this,et)),this.addEventListener("keydown",_(this,at)),this.addEventListener("blur",_(this,tt)),this.addEventListener("focus",_(this,B)),this.addEventListener("click",_(this,R)),this.addEventListener("mousedown",_(this,R))}focus(t){super.focus(t),_(this,B).call(this)}render(){return W`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=w(this,y,st).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};Y=new WeakMap;O=new WeakMap;V=new WeakMap;R=new WeakMap;B=new WeakMap;tt=new WeakMap;et=new WeakMap;at=new WeakMap;y=new WeakSet;Wt=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof M){t.focus();break}t=t.nextElementSibling}};A=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))};st=function(t,e){return String(t).padStart(e,"0")};T=function(t){return Math.max(this.min,Math.min(this.max,t))};G=function(){Yt(this,Y,"")};M.formAssociated=!0;I([b({type:Number})],M.prototype,"value",2);I([b({type:Number})],M.prototype,"length",2);I([b({type:Number,attribute:"aria-valuemin"})],M.prototype,"min",2);I([b({type:Number,attribute:"aria-valuemax"})],M.prototype,"max",2);I([X()],M.prototype,"displayValue",2);I([_t("value")],M.prototype,"_refreshDisplayValue",1);M=I([Dt("gds-date-part-spinner")],M);var ue=Object.defineProperty,ge=Object.getOwnPropertyDescriptor,Et=t=>{throw TypeError(t)},g=(t,e,a,i)=>{for(var s=i>1?void 0:i?ge(e,a):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(s=(i?o(e,a,s):o(s))||s);return i&&s&&ue(e,a,s),s},bt=(t,e,a)=>e.has(t)||Et("Cannot "+a),p=(t,e,a)=>(bt(t,e,"read from private field"),a?a.call(t):e.get(t)),v=(t,e,a)=>e.has(t)?Et("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),U=(t,e,a,i)=>(bt(t,e,"write to private field"),e.set(t,a),a),m=(t,e,a)=>(bt(t,e,"access private method"),a),L,u,It,q,Nt,Pt,it,N,z,At,nt,rt,ot,lt,ht,dt,ct,pt,ut,K,gt,ft,mt,vt,F,Tt,Lt;let h=class extends te{constructor(){super(...arguments),v(this,u),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.showWeekNumbers=!1,this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=m(this,u,mt).call(this,"y-m-d"),v(this,L),v(this,At,t=>{this._elTrigger.then(e=>{var i,s;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((s=document.getSelection())==null||s.removeAllRanges())})}),v(this,nt,t=>{this._elTrigger.then(e=>{var i,s;(i=document.getSelection())==null||i.removeAllRanges();const a=new Range;a.setStart(e.firstChild,0),a.setEnd(e.lastChild,4),(s=document.getSelection())==null||s.addRange(a)})}),v(this,rt,t=>{this._elField.then(e=>{var a;t.currentTarget===e&&(t.preventDefault(),(a=t.clipboardData)==null||a.setData("text/plain",this.displayValue))})}),v(this,ot,t=>{this._elField.then(e=>{var o;if(t.currentTarget!==e)return;t.preventDefault();const a=(o=t.clipboardData)==null?void 0:o.getData("text/plain");if(!a)return;let i=new Date("-");const s="Invalid Date",n=a.split(this._dateFormatLayout.delimiter);if(n.length===3){const d=this._dateFormatLayout.layout,r=parseInt(n[d.findIndex(l=>l.token==="y")]),k=parseInt(n[d.findIndex(l=>l.token==="m")])-1,C=parseInt(n[d.findIndex(l=>l.token==="d")]);!isNaN(r)&&!isNaN(k)&&!isNaN(C)&&(i=new Date(`${r}-${k+1}-${C}`))}i.toString()===s&&(i=new Date(a),i.toString()===s)||(this.value=i,m(this,u,N).call(this))})}),v(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),v(this,ht,t=>{t.stopPropagation(),this.value=t.detail,this.open=!1,m(this,u,N).call(this),m(this,u,z).call(this)}),v(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),v(this,ct,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),v(this,pt,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),v(this,ut,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),v(this,K,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),m(this,u,z).call(this)}),v(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;!ee(e||new Date(0),p(this,L)||new Date(0))&&(this.value=e,m(this,u,N).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=p(this,L),m(this,u,z).call(this))}}),v(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(a=>a===t.target);if(t.key==="ArrowRight"){const a=this._elSpinners[e+1];a&&a.focus()}if(t.key==="ArrowLeft"){const a=this._elSpinners[e-1];a&&a.focus()}}),v(this,vt,(t,e)=>{p(this,F)[e]=t;const a=new Date;a.setFullYear(parseInt(p(this,F).year)),a.setMonth(parseInt(p(this,F).month)-1),a.setDate(parseInt(p(this,F).day)),a.setHours(12,0,0,0),a.toString()!=="Invalid Date"&&(this.value=a,m(this,u,N).call(this),m(this,u,z).call(this))}),v(this,F,{year:"yyyy",month:"mm",day:"dd"})}get type(){return"gds-datepicker"}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=m(this,u,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elInput.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),jt.instance.apply(this,"gds-datepicker")}render(){return W`
