import{u as o,j as e,M as i}from"./iframe-VsbkeGCl.js";function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Guides/MCP for coding agents"}),`
...
`,e.jsxs(n.p,{children:["If the MCP server is unavailable for some reason, you can also access the same context via the ",e.jsx(n.a,{href:"./context-cli.mdx",children:"Green Context CLI"}),". The CLI provides the same information but without the need for an active MCP server connection."]}),`
