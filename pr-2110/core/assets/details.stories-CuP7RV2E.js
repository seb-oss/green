...
`;var ye=Object.defineProperty,fe=Object.getOwnPropertyDescriptor,ne=e=>{throw TypeError(e)},o=(e,t,s,n)=>{for(var a=n>1?void 0:n?fe(t,s):t,l=e.length-1,d;l>=0;l--)(d=e[l])&&(a=(n?d(t,s,a):d(a))||a);return n&&a&&ye(t,s,a),a},xe=(e,t,s)=>t.has(e)||ne("Cannot "+s),r=(e,t,s)=>(xe(e,t,"read from private field"),s?s.call(e):t.get(e)),m=(e,t,s)=>t.has(e)?ne("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w,D,S,b,z,_,L;let i=class extends le(de(me(se))){constructor(){super(...arguments),this.summary="",this.name="",this.open=!1,this.size="large",m(this,w,()=>{this.open=!this.open,r(this,b).call(this)}),m(this,D,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),r(this,w).call(this))}),m(this,S,()=>{!this.open||!this.name||document.querySelectorAll('[gds-element="gds-details"]').forEach(e=>{var t;if(e!==this&&e.name===this.name){const s=e;s.open=!1,r(t=s,b).call(t)}})}),m(this,b,()=>{this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.open}))}),m(this,z,()=>y`
      <div
        class="summary"
        part="summary"
        role="button"
