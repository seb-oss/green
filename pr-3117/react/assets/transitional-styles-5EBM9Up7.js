import{i as M,t as N,b as l,F as z,V as b,c as t,d as y,z as k}from"./declarative-layout-mixins-CREGehwS.js";const _=`/* stylelint-disable max-nesting-depth */
/**
...
@layer transitional-styles {
  ...
  @layer _base {
    ...
    :host(:not([variant=ghost])) .button:focus:not(:focus-visible) {
      box-shadow: none;
      outline: 0;
    }
    :host(:not([variant=ghost])) .button:focus, :host(:not([variant=ghost])) .button:focus-visible {
      outline-color: var(--gds-sys-color-focus-outline);
      outline-style: solid;
      outline-width: 0.125rem;
      outline-offset: 0.125rem;
...
}`;function c(){o.instance.register("gds-button",_.toString())}const B=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  :host {
...
}`;function $(){o.instance.register("gds-menu-heading",B.toString())}const G=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
`;function w(){o.instance.register("gds-option",G.toString()+R.cssText)}const F=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`,q="gds-menu-listbox";function L(){o.instance.register(q,F.toString())}const I=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function v(){o.instance.register("gds-popover",I.toString())}const A=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function W(){o.instance.register("gds-context-menu",A.toString()),v(),L(),w(),$(),c()}const U=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function H(){o.instance.register("gds-calendar",U.toString())}const O=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function C(){o.instance.register("gds-field-base",O.toString())}const V=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function T(){o.instance.register("gds-dropdown",V.toString()),w(),$(),v(),c(),C()}const D=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function E(){const i=D.toString()+N.reduce((e,r)=>e+r.cssText,"");o.instance.register("gds-datepicker",i.toString()),T(),v(),H()}const j=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {
    .btn-p {
...
}`;function X(){o.instance.register("gds-filter-chip",j.toString()),c()}const Y=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {}
  @layer _overrides {}
}`;function J(){o.instance.register("gds-filter-chips",Y.toString()),X()}const P=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  :host {
    display: block;
...
}`;function Q(){o.instance.register("gds-grouped-list",P.toString())}function Z(){c(),C()}const K=`/* stylelint-disable max-nesting-depth */
/**
 * Assert that a map is in ascending order
 * @mixin assert-ascending
 * @param {Map} $map - The map to check
...
}`;function nn(){o.instance.register("gds-segmented",K.toString())}const rn=`@layer base, reset, transitional-styles;
...
`;function en(){o.instance.register("gds-segmented-control",rn.toString()),nn()}const on=`/**
...
}`;function an(){o.instance.register("gds-theme",on.toString())}var d,p,u,h,g,f;const ln=()=>{an(),T(),W(),E(),Q(),en(),J(),c(),Z()},tn=class S{constructor(){l(this,g),l(this,d,new Map),l(this,p,new Map),l(this,u,new Map),l(this,h,!z())}static get instance(){return globalThis.__gdsTransitionalStyles?.[b]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[b]:new S}),globalThis.__gdsTransitionalStyles[b]}apply(e,r){if(!e.shadowRoot)return;const n=t(this,d).get(r);n&&(t(this,p).set(r,e),this.applyToElement(r,n))}applyScoped(e,r,n){if(!e.shadowRoot)return;const a=t(this,d).get(r);a&&(t(this,u).set(r,{element:e,injectKey:n}),this.applyScopedToElement(r,a))}applyScopedToElement(e,r){const n=t(this,u).get(e);if(!n||!n.element.shadowRoot)return;const{element:a,injectKey:s}=n;y(this,g,f).call(this,a,()=>a._dynamicStylesController.inject(s,k(r)),()=>a._dynamicStylesController.clear(s))}applyToElement(e,r){const n=t(this,p).get(e);!n||!n.shadowRoot||y(this,g,f).call(this,n,()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",k(r)),n._isUsingTransitionalStyles=!0},()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()})}register(e,r){let n=r;t(this,h)&&(n=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${r}`),t(this,d).set(e,n),this.applyToElement(e,n),this.applyScopedToElement(e,n)}};d=new WeakMap;p=new WeakMap;u=new WeakMap;h=new WeakMap;g=new WeakSet;f=function(i,e,r){const n="[gds-element=gds-theme]";let a=i.getRootNode(),s=i.closest(n);for(;s===null&&a!==document;)s=a.host?.closest(n),a=a.host?.getRootNode();if(s){const m=s,x=()=>{m.designVersion==="2023"?r():e()};if(m.addEventListener("gds-design-version-changed",x),i.addEventListener("gds-element-disconnected",()=>m.removeEventListener("gds-design-version-changed",x)),m.designVersion==="2023"){r();return}}e()};let o=tn;export{q as M,o as T,v as a,J as b,R as c,ln as r};
