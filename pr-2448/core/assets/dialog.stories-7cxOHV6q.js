...
**Important:** Make sure to still use the \`heading\` property, as it is used to give the dialog an accessible name.`,...(gt=(ct=b.parameters)==null?void 0:ct.docs)==null?void 0:gt.description}}};const qo=["Default","SlideOut","Scrollable","CustomButtons","Events","CustomDialog"];export{y as CustomButtons,b as CustomDialog,h as Default,v as Events,f as Scrollable,u as SlideOut,qo as __namedExportsOrder,Ro as default};
