import"./text-Cxwrifbo.js";import"./card-DA-6s8XK.js";import"./div-DViJhSDE.js";import"./flex-Z67iOcFC.js";import"./divider-DaQ0l-z9.js";import{x as e}from"./iframe-DMVDZK-F.js";import{a as s}from"./argTableProps-DMeyZ76X.js";import"./default-typography.styles-DHRsuzkw.js";import"./card.component-B2BzVFUU.js";import"./flex.component-EdCVezaM.js";import"./divider.component-BWCjoVDN.js";const p={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...s("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified."}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},f={...d,name:"Font",render:t=>e`<gds-flex flex-direction="column" gap="m">
