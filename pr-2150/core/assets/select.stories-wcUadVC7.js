import{i as Te,x as r}from"./lit-element-Bx14lxc-.js";import{a as ze}from"./argTableProps-BkF-Ot9d.js";import{l as Ie}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as w,h as l,g as qe}from"./custom-element-scoping-b4c89-hi.js";import{a as we}from"./query-p8xgzTDt.js";import{e as Oe}from"./class-map-CXsQwv0r.js";import{n as A}from"./when-BR7zwNJC.js";import{f as Pe,G as $e}from"./form-control-host.style-B9O882Nq.js";import{G as Ve,a as Ge}from"./form-control-header.component-c8kTl1sa.js";import{t as Ne}from"./tokens.style-C9bLefPj.js";import{o as Re}from"./observe-light-dom-CmJPHUQ4.js";import{w as Fe}from"./watch-tFciLXSI.js";import{d as Be,w as He,b as je}from"./declarative-layout-mixins-CxeMR8ZJ.js";import{a as We}from"./button.component-DJEDQUDh.js";import{I as Je}from"./chevron-bottom.component-BR3ifSUU.js";import"./flex-B8AQUA7n.js";import"./square-grid-circle-jCiz4M9w.js";import"./rocket-COMAHln6.js";import"./sun-BBEXhPXd.js";import"./brand-green-n8bXJGfH.js";import"./custom-elements-CtXoy-2_.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./transitional-styles-BOwn52Fb.js";import"./badge.component-lHGwzMdV.js";import"./flex.component-BDILfbvS.js";import"./div.component-Diofk0s1.js";import"./triangle-exclamation.component-D_ZmLszF.js";import"./icon-Bm2mwQqA.js";import"./card.component-ESUepO5H.js";import"./if-defined-CVqwUuaf.js";import"./static-B8S6DEnV.js";const Ue=Te`
...
`;var Qe=Object.defineProperty,Xe=Object.getOwnPropertyDescriptor,Ce=e=>{throw TypeError(e)},s=(e,t,o,u)=>{for(var p=u>1?void 0:u?Xe(t,o):t,k=e.length-1,L;k>=0;k--)(L=e[k])&&(p=(u?L(t,o,p):L(p))||p);return u&&p&&Qe(t,o,p),p},D=(e,t,o)=>t.has(e)||Ce("Cannot "+o),C=(e,t,o)=>(D(e,t,"read from private field"),t.get(e)),M=(e,t,o)=>t.has(e)?Ce("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),Ke=(e,t,o,u)=>(D(e,t,"write to private field"),t.set(e,o),o),d=(e,t,o)=>(D(e,t,"access private method"),o),S,i,Ee,E,ke,Le,Me,_e,De,Ae;let n=class extends We{constructor(){super(...arguments),M(this,i),this.supportingText="",this.showExtendedSupportingText=!1,this.size="large",this.plain=!1,M(this,S,!1),M(this,E,e=>{e.stopPropagation(),d(this,i,ke).call(this),requestAnimationFrame(()=>{this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})})}get value(){return this._internalValue}set value(e){C(this,S)||Ke(this,S,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){var e;return((e=this.selectElement)==null?void 0:e.multiple)??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}render(){const e={multiple:this.multiple};return this.selectElement&&(this.selectElement.disabled=this.disabled),l`
      ${A(!this.plain,()=>l`<gds-form-control-header
      ...
      <gds-field-base
        ...
        class=${Oe(e)}
      >
        ${d(this,i,Le).call(this)}
      </gds-field-base>

      ${A(d(this,i,Ee).call(this),()=>l`<gds-form-control-footer
            class="size-${this.size}"
            .validationMessage=${this.invalid&&(this.errorMessage||this.validationMessage)}
          ></gds-form-control-footer>`)}
    `}_captureDOM(){if(!this.shadowRoot||this.childNodes.length===0||!this._elSelectContainer)return;const e=Array.from(this.children).filter(t=>t.nodeName==="SELECT").map(t=>{const o=t.cloneNode(!0);return o.addEventListener("change",C(this,E)),o.addEventListener("input",C(this,E)),o.setAttribute("aria-describedby","supporting-text extended-supporting-text sub-label message"),o.ariaLabel=this.label,o.setAttribute("id","select"),o.disabled=this.disabled,o.className="native-control",C(this,S)?o.value=this.value:this.value=o.value,o});this._elSelectContainer.replaceChildren(...e)}formResetCallback(){if(this.selectElement)if(this.selectElement.multiple)Array.from(this.selectElement.options).forEach(e=>{e.selected=!1}),this.value=[];else{const e=this.selectElement.options[0];e&&(this.value=e.value,this.selectElement.value=e.value)}}_getValidityAnchor(){return this.selectElement}_handleValueChange(){if(this.selectElement){if(this.multiple){const e=this.value||[];Array.from(this.selectElement.options).forEach(t=>{t.selected=e.includes(t.value)})}else this.selectElement.value=this.value;this.requestUpdate()}}};S=new WeakMap;i=new WeakSet;Ee=function(){return!this.plain&&this.invalid};E=new WeakMap;ke=function(){if(this.selectElement)if(this.multiple){const e=Array.from(this.selectElement.selectedOptions);this.value=e.map(t=>t.value)}else this.value=this.selectElement.value};Le=function(){return[d(this,i,Me).call(this),d(this,i,De).call(this),d(this,i,_e).call(this),d(this,i,Ae).call(this)].map(t=>l`${t}`)};Me=function(){return l`<slot name="lead" slot="lead"></slot>`};_e=function(){if(!this.multiple)return l`<label id="placeholder" class="native-control"
        >${this.displayValue}</label
      >`};De=function(){return l`<div class="select-container"></div>`};Ae=function(){if(!this.multiple)return l` <gds-icon-chevron-bottom></gds-icon-chevron-bottom> `};n.styles=[Ne,Pe,Ue];s([w({attribute:"supporting-text"})],n.prototype,"supportingText",2);s([w({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],n.prototype,"showExtendedSupportingText",2);s([w({type:String})],n.prototype,"size",2);s([w({type:Boolean})],n.prototype,"plain",2);s([we("select")],n.prototype,"selectElement",2);s([w()],n.prototype,"value",1);s([we(".select-container")],n.prototype,"_elSelectContainer",2);s([Re({childList:!0,subtree:!0,attributes:!0,characterData:!0})],n.prototype,"_captureDOM",1);s([Fe("value")],n.prototype,"_handleValueChange",1);n=s([Ie()],n);let _=class extends Be(He(je(n))){};_=s([qe("gds-select",{dependsOn:[Ve,Ge,$e,Je]})],_);_.define();const Tt={title:"Components/Select",component:"gds-select",tags:["autodocs"],argTypes:{...ze("gds-select")},parameters:{docs:{description:{component:`\`gds-select\` is a wrapper component for the native select element.
...
Setting value or selected props on the select element will not work as expected.`}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},c={...a,name:"Select",args:{label:"Label text",supportingText:"Supporting text",value:"",innerHTML:`
  ...
  `},b={...a,name:"Extended Supporting Text",render:()=>r`
    <gds-flex
      gap="xl"
      align-items="center"
  ...
  `};var T,z,I,q,O;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
    label: 'Label text',
...
}`,...(I=(z=c.parameters)==null?void 0:z.docs)==null?void 0:I.source},description:{story:"Basic example showing the select component with a label, supporting text and a lead icon.\nThe wrapped `<select>` element is making use of `<optgroup>` elements to group the options.",...(O=(q=c.parameters)==null?void 0:q.docs)==null?void 0:O.description}}};var P,$,V,G,N;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Options',
  render: () => html\`
    <gds-flex>
...
<br>It is set by adding an icon component to the 'lead' slot.`,...(j=(H=g.parameters)==null?void 0:H.docs)==null?void 0:j.description}}};var W,J,U,Q,X;h.parameters={...h.parameters,docs:{...(W=h.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...
  \`
}`,...(fe=(xe=y.parameters)==null?void 0:xe.docs)==null?void 0:fe.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(Se=(ye=y.parameters)==null?void 0:ye.docs)==null?void 0:Se.description}}};const zt=["Default","Option","Lead","Disabled","Validation","ExtendedSupportingText","Size","Multiple","SelectSize"];export{c as Default,h as Disabled,b as ExtendedSupportingText,g as Lead,f as Multiple,m as Option,y as SelectSize,x as Size,v as Validation,zt as __namedExportsOrder,Tt as default};
