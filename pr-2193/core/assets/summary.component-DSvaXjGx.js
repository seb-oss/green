import{m as v,s as x}from"./runtime-BL31MtW8.js";import{i as $,E as C}from"./lit-element-Bx14lxc-.js";import{n as b,G,h as c,g as k}from"./custom-element-scoping-CNGU1oQ0.js";import{r as E}from"./query-async-MEroNOeJ.js";import{m as M}from"./datepicker.component-lm9IhnAC.js";import{n as u}from"./when-BR7zwNJC.js";import{t as O}from"./tokens.style-DQsNuKSy.js";import{G as A}from"./button.component-DdDd8Lgo.js";import{G as B}from"./card.component-a_DdskCg.js";import{G as I}from"./div.component-COo6-rOq.js";import{G as S}from"./flex.component-DXi-h7Ch.js";import{I as T}from"./arrow-up.component-CpuW_oY-.js";const D=$`
  :host {
    display: contents;
  }
  ul {
...
`;var F=Object.defineProperty,P=Object.getOwnPropertyDescriptor,_=e=>{throw TypeError(e)},p=(e,r,o,t)=>{for(var s=t>1?void 0:t?P(r,o):r,n=e.length-1,m;n>=0;n--)(m=e[n])&&(s=(t?m(r,o,s):m(s))||s);return t&&s&&F(r,o,s),s},f=(e,r,o)=>r.has(e)||_("Cannot "+o),d=(e,r,o)=>(f(e,r,"read from private field"),r.get(e)),g=(e,r,o)=>r.has(e)?_("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,o),y=(e,r,o,t)=>(f(e,r,"write to private field"),r.set(e,o),o),R=(e,r,o)=>(f(e,r,"access private method"),o),a,l,h,w;let i=class extends G{constructor(){super(...arguments),g(this,h),this.hideErrors=!1,this.reactive=!1,g(this,a),g(this,l)}connectedCallback(){super.connectedCallback(),y(this,a,this.closest("form")||void 0),d(this,a)&&this.reactive&&(y(this,l,new MutationObserver(()=>{this.refresh()})),d(this,l).observe(d(this,a),{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=d(this,l))==null||e.disconnect()}refresh(){this.requestUpdate()}render(){var o;const e=Array.from(((o=d(this,a))==null?void 0:o.elements)||[]),r=e.filter(t=>t.ariaInvalid==="true"||t.invalid);return u(r.length>0,()=>c`<gds-card
          id="root"
          role="navigation"
        ...
        ></gds-icon-arrow-up>`};i.styles=[O,D];p([b({type:Boolean})],i.prototype,"hideErrors",2);p([b({type:Boolean})],i.prototype,"reactive",2);p([E("#root")],i.prototype,"_elRoot",2);i=p([k("gds-form-summary",{dependsOn:[B,S,I,A,T]})],i);export{i as G};
