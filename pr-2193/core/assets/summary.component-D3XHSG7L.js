import{m as y,s as G}from"./runtime-BL31MtW8.js";import{i as k,E}from"./lit-element-Bx14lxc-.js";import{n as x,G as M,h as p,g as O}from"./custom-element-scoping-CNGU1oQ0.js";import{r as A}from"./query-async-MEroNOeJ.js";import{m as B}from"./datepicker.component-BbuSIMvz.js";import{n as _}from"./when-BR7zwNJC.js";import{t as F}from"./tokens.style-DQsNuKSy.js";import{G as I}from"./button.component-DdDd8Lgo.js";import{G as S}from"./card.component-a_DdskCg.js";import{G as T}from"./div.component-COo6-rOq.js";import{G as D}from"./flex.component-DXi-h7Ch.js";import{I as P}from"./arrow-up.component-CpuW_oY-.js";const R=k`
  :host {
    display: contents;
  }
  ul {
...
`;var W=Object.defineProperty,z=Object.getOwnPropertyDescriptor,C=e=>{throw TypeError(e)},g=(e,r,t,s)=>{for(var o=s>1?void 0:s?z(r,t):r,h=e.length-1,m;h>=0;h--)(m=e[h])&&(o=(s?m(r,t,o):m(o))||o);return s&&o&&W(r,t,o),o},v=(e,r,t)=>r.has(e)||C("Cannot "+t),d=(e,r,t)=>(v(e,r,"read from private field"),r.get(e)),f=(e,r,t)=>r.has(e)?C("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),w=(e,r,t,s)=>(v(e,r,"write to private field"),r.set(e,t),t),l=(e,r,t)=>(v(e,r,"access private method"),t),a,c,i,b,u,$;let n=class extends M{constructor(){super(...arguments),f(this,i),this.hideErrors=!1,this.reactive=!1,f(this,a),f(this,c)}get errorCount(){return l(this,i,u).call(this).length}connectedCallback(){super.connectedCallback(),w(this,a,this.closest("form")||void 0),d(this,a)&&this.reactive&&(w(this,c,new MutationObserver(()=>{this.refresh()})),d(this,c).observe(d(this,a),{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=d(this,c))==null||e.disconnect()}refresh(){this.requestUpdate()}render(){const e=l(this,i,b).call(this),r=l(this,i,u).call(this);return _(r.length>0,()=>p`<gds-card
        ...
        ></gds-icon-arrow-up>`};n.styles=[F,R];g([x({type:Boolean})],n.prototype,"hideErrors",2);g([x({type:Boolean})],n.prototype,"reactive",2);g([A("#root")],n.prototype,"_elRoot",2);n=g([O("gds-form-summary",{dependsOn:[S,D,T,I,P]})],n);export{n as G};
