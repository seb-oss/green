import{i as E,C as D,T as A,L as W,D as F,A as R,J as l,d as v,h as c,B as T,n as g,l as J,E as _,a as q,K,F as Q,e as V}from"./iframe-COLb4ZzD.js";import{l as X}from"./localized-decorator-BLqr1dCP.js";import{w as Y,G as H}from"./popover.component-BVGOrar0.js";import{a as U,G as Z}from"./context-menu.component-BwXL7qZW.js";import{a as tt}from"./dropdown.component-DnK2pFaU.js";import{I as et}from"./chevron-bottom.component-H7Ym6kt1.js";import{I as st,a as nt,b as it,c as ot}from"./chevron-right-small.component-BKL3pvGh.js";import{I as at}from"./chevron-right.component-BRI5QkbG.js";import{G as rt}from"./input.component-DAdz_5qh.js";import{G as lt}from"./text.component-BR0EV8AF.js";const pt=E`
  :host {
    display: flex;
    align-items: center;
...
`;var ht=Object.defineProperty,ct=Object.getOwnPropertyDescriptor,P=t=>{throw TypeError(t)},h=(t,s,n,d)=>{for(var p=d>1?void 0:d?ct(s,n):s,m=t.length-1,b;m>=0;m--)(b=t[m])&&(p=(d?b(s,n,p):b(p))||p);return d&&p&&ht(s,n,p),p},w=(t,s,n)=>s.has(t)||P("Cannot "+n),i=(t,s,n)=>(w(t,s,"read from private field"),n?n.call(t):s.get(t)),dt=(t,s,n)=>s.has(t)?P("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,n),o=(t,s,n)=>(w(t,s,"access private method"),n),e,u,a,G,C,z,k,x,y,I,M,S,B,O,j,f,N,L,$;const gt={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let r=class extends D(A(W(F))){constructor(){super(...arguments),dt(this,e),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.simple=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(t){this._isMobile=t}render(){const s=i(this,e,u)>1,n=o(this,e,O).call(this);return!s&&!n?R:c`
    ...
    `};z=function(){const t=i(this,e,u),s=o(this,e,G).call(this,t);return c`${s.map(n=>o(this,e,C).call(this,n))}`};k=function(){return c`
      <gds-button
        size="${i(this,e,a).button}"
        rank="secondary"
    ...
    `};y=function(){const t=i(this,e,u);return c`
      <gds-button
        size="${i(this,e,a).button}"
        rank="secondary"
    ...
    `};M=function(){return c`
      <gds-flex
        ...
        flex="1"
      >
        ${[v(this.jump,()=>o(this,e,k).call(this)),o(this,e,x).call(this)]}
        <gds-flex gap="4xs" align-items="center">
          ${o(this,e,z).call(this)}
        </gds-flex>
        ${[o(this,e,y).call(this),v(this.jump,()=>o(this,e,I).call(this))]}
      </gds-flex>
    `};S=function(){return c`
      <gds-flex
        gap="${i(this,e,a).navGap}"
    ...
    `};f=function(t){this.dispatchCustomEvent("gds-page-change",{detail:{page:t},bubbles:!0})};N=function(t){const s=t.target,n=parseInt(s.dataset.value||"10");n!==this.rows&&this.dispatchCustomEvent("gds-rows-change",{detail:{rows:n},bubbles:!0})};L=function(t){if(this._jumpPopoverOpen=t.detail.open,t.detail.open){const n=t.target.querySelector('[gds-element="gds-input"]');n&&requestAnimationFrame(()=>{n.focus()})}};$=function(t){const n=t.target.closest('[gds-element="gds-input"]');if(n){const d=parseInt(n.value,10);if(d&&d>=1&&d<=i(this,e,u)){o(this,e,f).call(this,d);const p=n.closest('[gds-element="gds-popover"]');p&&(p.open=!1)}}};r.styles=[T,pt];h([g({type:Number})],r.prototype,"page",2);h([g({type:Number})],r.prototype,"rows",2);h([g({type:Number})],r.prototype,"total",2);h([g({type:Array})],r.prototype,"options",2);h([g({type:Boolean})],r.prototype,"jump",2);h([g({attribute:"hide-options",type:Boolean,reflect:!1})],r.prototype,"hideOptions",2);h([g({type:Boolean,reflect:!1})],r.prototype,"simple",2);h([g({reflect:!1})],r.prototype,"density",2);h([g()],r.prototype,"label",2);h([J("#page-input")],r.prototype,"_elInput",2);h([_()],r.prototype,"_isMobile",2);h([_()],r.prototype,"_jumpPopoverOpen",2);h([Y("(max-width: 768px)")],r.prototype,"_handleMobile",1);r=h([X(),q("gds-pagination",{dependsOn:[K,H,lt,rt,tt,U,Z,et,st,nt,at,it,ot]}),Q({labelledBy:"nav",describedBy:"nav"})],r);r.define();export{r as G};
