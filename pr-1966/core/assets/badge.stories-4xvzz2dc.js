...
\`\`\``,...(w=(z=n.parameters)==null?void 0:z.docs)==null?void 0:w.description}}};var k,y,S,N,D;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Trail',
  parameters: {
    controls: {
      include: []
  ...
  \`
}`,...(S=(y=s.parameters)==null?void 0:y.docs)==null?void 0:S.source},description:{story:'`gds-badge` has a trail slot that can be used to add additional content to the badge.\n\n```html\n<gds-badge>\n <span slot="trail">...</span>\n</gds-badge>\n```',...(D=(N=s.parameters)==null?void 0:N.docs)==null?void 0:D.description}}};var I,E,C,L,T;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  name: 'Size',
  render: args => html\`
    <gds-flex gap="4xl">
      <gds-flex flex-direction="column" gap="xl">
  ...
  \`
}`,...(C=(E=i.parameters)==null?void 0:E.docs)==null?void 0:C.source},description:{story:`Defines the size of the badge.
...
\`\`\``,...(T=(L=i.parameters)==null?void 0:L.docs)==null?void 0:T.description}}};var V,R,A,W,P;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Disabled',
  render: args => html\`
    <gds-flex gap="xl">
      <gds-badge variant="positive" disabled>
  ...
  \`
}`,...(O=(F=o.parameters)==null?void 0:F.docs)==null?void 0:O.source},description:{story:'The `Rounded` story demonstrates the use of the `gds-badge` component with the `rounded` property.\n\nWhen set to `true`, the badge will have fully rounded corners.\n\nExample usage:\n\n```html\n<gds-badge rounded variant="information"> 01 </gds-badge>\n```\n\n@property {boolean} rounded - Controls the border radius of the badge.',...(H=(G=o.parameters)==null?void 0:G.docs)==null?void 0:H.description}}};const pe=["Variants","Lead","Trail","Size","Disabled","Notification","Rounded"];export{g as Disabled,n as Lead,t as Notification,o as Rounded,i as Size,s as Trail,r as Variants,pe as __namedExportsOrder,ve as default};
