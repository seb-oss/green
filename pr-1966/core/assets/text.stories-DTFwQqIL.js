import"./text-Cgi58Y8C.js";import"./card-XYWeLbaC.js";import"./container-Ba5_m4-t.js";import"./flex-BtOfIcEJ.js";import"./divider-CuBdOV_o.js";import{x as e}from"./lit-element-C_s9q329.js";import{a as $}from"./argTableProps-CRZ90g52.js";import"./custom-element-scoping-BEGY3AqQ.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./static-_ukc2i0J.js";import"./tokens.style-CFvqdzpw.js";import"./declarative-layout-mixins-C8_oSfbi.js";import"./div-jP6TZIqu.js";import"./default-typography.styles-Bl0hQgz1.js";import"./custom-elements-C6Z1Jhti.js";const ue={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...$("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified.\n\n@beta"}}}},m={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["heading-xl","heading-l","heading-m","heading-s","heading-xs","heading-2xs","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...m,name:"Tags",render:t=>e`<gds-flex flex-direction="column" gap="2xl">
...
}`,...(z=(b=r.parameters)==null?void 0:b.docs)==null?void 0:z.source}}};var v,H,L,w,C;d.parameters={...d.parameters,docs:{...(v=d.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: 'Heading',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text tag="h6">H6: heading-2xs</gds-text>
  ...
  \`
}`,...(S=(k=a.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var T,q,P;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: 'Body',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-text font-size="body-s">body-s</gds-text>
...
}`,...(X=(V=i.parameters)==null?void 0:V.docs)==null?void 0:X.source},description:{story:'`gds-text` component has a `text-decoration` property that will change the text decoration based on the css values such as `underline`, `overline`, `line-through`, `underline dotted`, `{COLOR} wavy underline` etc.\n\n\ne.g.\n\n```html\n<gds-text\n   text-decoration="currentcolor wavy underline"\n >\n   Wavy Underline\n </gds-text>\n```',...(Z=(Y=i.parameters)==null?void 0:Y.docs)==null?void 0:Z.description}}};const fe=["Card","Weight","Heading","Detail","Body","Display","Preamble","Lines","Color","Decoration"];export{l as Body,s as Card,o as Color,i as Decoration,a as Detail,g as Display,d as Heading,n as Lines,x as Preamble,r as Weight,fe as __namedExportsOrder,ue as default};
