import{x as r,E as u}from"./lit-element-C_s9q329.js";import"./button-sFwDD1rU.js";import"./grid-DnpW-hvt.js";import"./text-QmVmjP2N.js";import"./divider-Cv1vu9fV.js";import"./flex-jeV3HU4h.js";import"./credit-card-DA7hXAAg.js";import"./arrow-up-B7QiMbQU.js";import"./arrow-down-BlXBzdzP.js";import"./arrow-right-B_2xDbEI.js";import"./custom-element-scoping-BEGY3AqQ.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./class-map-Bz98xO8-.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./tokens.style-CFvqdzpw.js";import"./transitional-styles-gKBkOdeg.js";import"./observe-light-dom-CmJPHUQ4.js";import"./runtime-CMQcyTl6.js";import"./watch-tFciLXSI.js";import"./style-expression-property-w7JDbrjA.js";import"./container-PwjDxieS.js";import"./default-typography.styles-Bl0hQgz1.js";import"./icon-DYBgint3.js";const _t={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:`A button serve as an interactive element that enables users to perform an action or make
...
A good rule of thumb is to use only one primary action in each context.`}}},tags:["autodocs"]},n={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","positive","negative"],control:{type:"select"}},size:{options:["small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}},args:{innerText:"Button"}},l={...n},e={...n,name:"Ranks and variants",parameters:{...n.parameters,controls:{include:[]}},render:t=>r`
...
}`,...(b=(m=n.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var v,f,h;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(h=(f=l.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var x,y,k,$,w;e.parameters={...e.parameters,docs:{...(x=e.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(k=(y=e.parameters)==null?void 0:y.docs)==null?void 0:k.source},description:{story:`Buttons can have different ranks and variants. The rank defines the visual importance of the button,
while the variant defines the intent of the button.`,...(w=($=e.parameters)==null?void 0:$.docs)==null?void 0:w.description}}};var P,z,T,S,D;a.parameters={...a.parameters,docs:{...(P=a.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...(T=(z=a.parameters)==null?void 0:z.docs)==null?void 0:T.source},description:{story:"Buttons can be small, medium or large. The default size is medium.",...(D=(S=a.parameters)==null?void 0:S.docs)==null?void 0:D.description}}};var A,B,L,_,I;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...DefaultParams,
...
keep the button clickable and then show an error message instead.`,...(C=(X=d.parameters)==null?void 0:X.docs)==null?void 0:C.description}}};var j,q,F,G,H;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...(F=(q=i.parameters)==null?void 0:q.docs)==null?void 0:F.source},description:{story:"A link styled as a button.",...(H=(G=i.parameters)==null?void 0:G.docs)==null?void 0:H.description}}};var J,K,Q,Y,Z;c.parameters={...c.parameters,docs:{...(J=c.parameters)==null?void 0:J.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
  ...
  \`
}`,...(Q=(K=c.parameters)==null?void 0:K.docs)==null?void 0:Q.source},description:{story:"Text content will get truncated if it does not fit.",...(Z=(Y=c.parameters)==null?void 0:Y.docs)==null?void 0:Z.description}}};var tt,nt,rt,et,at;g.parameters={...g.parameters,docs:{...(tt=g.parameters)==null?void 0:tt.docs,source:{originalSource:`{
  ...DefaultParams,
  parameters: {
    ...DefaultParams.parameters,
    controls: {
