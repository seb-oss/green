import{i as Ce,x as r}from"./lit-element-C_s9q329.js";import{l as Me}from"./localized-decorator-iufJoRiP.js";import"./runtime-CMQcyTl6.js";import{n as L,g as Ee,h as u}from"./custom-element-scoping-BEGY3AqQ.js";import{a as he}from"./query-p8xgzTDt.js";import{e as Le}from"./class-map-Bz98xO8-.js";import{t as ke}from"./tokens.style-CFvqdzpw.js";import{o as _e}from"./observe-light-dom-CmJPHUQ4.js";import{w as Ae}from"./watch-tFciLXSI.js";import{d as De,w as ze,b as Oe}from"./declarative-layout-mixins-DZOZCYEp.js";import{a as qe}from"./button-D2kPj2EJ.js";import"./field-base-CGgk6Pps.js";import"./chevron-bottom-CcRSBbmu.js";import"./flex-baHQsfJg.js";import"./square-grid-circle-CohIYq56.js";import"./rocket-aQtI4YJ4.js";import"./sun-olOpdRBa.js";import"./brand-green-DaDklR0q.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./style-expression-property-w7JDbrjA.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./transitional-styles-gKBkOdeg.js";import"./triangle-exclamation-BVOOPWQa.js";import"./icon-DYBgint3.js";import"./card-CqKrRvik.js";import"./div-CwAlVl-X.js";import"./badge-CsbjNzl8.js";const Ie=Ce`
...
`;var Pe=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,ve=e=>{throw TypeError(e)},n=(e,t,o,c)=>{for(var l=c>1?void 0:c?Te(t,o):t,C=e.length-1,M;C>=0;C--)(M=e[C])&&(l=(c?M(t,o,l):M(l))||l);return c&&l&&Pe(t,o,l),l},k=(e,t,o)=>t.has(e)||ve("Cannot "+o),S=(e,t,o)=>(k(e,t,"read from private field"),t.get(e)),E=(e,t,o)=>t.has(e)?ve("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),Ve=(e,t,o,c)=>(k(e,t,"write to private field"),t.set(e,o),o),p=(e,t,o)=>(k(e,t,"access private method"),o),y,w,i,be,xe,fe,ye,Se,we;let s=class extends qe{constructor(){super(...arguments),E(this,i),this.supportingText="",this.size="large",E(this,y,!1),E(this,w,e=>{e.stopPropagation(),p(this,i,be).call(this),requestAnimationFrame(()=>{this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})})}get value(){return this._internalValue}set value(e){S(this,y)||Ve(this,y,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){var e;return((e=this.selectElement)==null?void 0:e.multiple)??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}render(){const e={multiple:this.multiple};return u`
...
Setting value or selected props on the select element will not work as expected.`}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},d={...a,name:"Select",args:{label:"Label text",supportingText:"Supporting text",value:"organic-chemistry",innerHTML:`
  ...
  `};var A,D,z,O,q;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Select',
  args: {
    label: 'Label text',
...
}`,...(z=(D=d.parameters)==null?void 0:D.docs)==null?void 0:z.source},description:{story:"Basic example showing the select component with a label, supporting text and a lead icon.\nThe wrapped `<select>` element is making use of `<optgroup>` elements to group the options.",...(q=(O=d.parameters)==null?void 0:O.docs)==null?void 0:q.description}}};var I,P,T,V,$;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Options',
  render: () => html\`
    <gds-flex>
...
<br>It is set by adding an icon component to the 'lead' slot.`,...(B=(H=g.parameters)==null?void 0:H.docs)==null?void 0:B.description}}};var W,F,J,j,U;h.parameters={...h.parameters,docs:{...(W=h.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <gds-flex>
  ...
  \`
}`,...(de=(ce=f.parameters)==null?void 0:ce.docs)==null?void 0:de.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(ge=(me=f.parameters)==null?void 0:me.docs)==null?void 0:ge.description}}};const ht=["Default","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{d as Default,h as Disabled,g as Lead,x as Multiple,m as Option,f as SelectSize,b as Size,v as Validation,ht as __namedExportsOrder,gt as default};
