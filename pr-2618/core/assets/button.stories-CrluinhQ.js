import{x as r,E as n}from"./iframe-Dp9IHT7M.js";import"./text-DBbTD983.js";import"./divider-DNfVJICO.js";import"./flex-BwWHANmJ.js";import"./credit-card-CNgvO40U.js";import"./arrow-left-CbbKeHYQ.js";import"./chevron-top-BKwhgqGi.js";import"./arrow-up-BO9B4X7C.js";import"./arrow-down-BDiEkKtu.js";import"./arrow-right-RYpGXRRZ.js";import{a as d}from"./argTableProps-R5F9VmLh.js";import"./default-typography.styles-C-XkYi72.js";import"./divider.component-Chx4EO26.js";import"./flex.component-_Iuoz229.js";import"./credit-card.component-CSkpEAUa.js";import"./icon.component-BLFwunDp.js";import"./arrow-left.component-DoCXL9Ug.js";import"./chevron-top.component-D7JlTzLS.js";import"./arrow-up.component-B9zyVFT2.js";import"./arrow-down.component-CUDujbVO.js";import"./arrow-right.component-B-0zskSm.js";const N={title:"Components/Button",component:"gds-button",parameters:{layout:"centered",docs:{description:{component:"A button can be tapped or clicked to perform an action."}}},tags:["autodocs"],argTypes:{...d("gds-button"),rank:{options:["primary","secondary","tertiary"],control:{type:"select"}},variant:{options:["neutral","brand","positive","negative"],control:{type:"select"}},size:{options:["xs","small","medium","large"],control:{type:"select"}},target:{options:["_self","_blank","_parent","_top"],control:{type:"select"}},rel:{control:{type:"text"}},download:{control:{type:"text"}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{innerText:"Button"}},j={...e},S={...e,name:"Ranks and variants",parameters:{...e.parameters,controls:{include:[]}},render:t=>r`
  ...
  `},B={...e,name:"Using icons in button",parameters:{...e.parameters,controls:{include:["rank","variant","size"]}},render:t=>r`
    <gds-flex gap="l">
      <gds-button
        .rank=${t.rank}
        .variant=${t.variant}
  ...
  `},A={...e,name:"Icon button",parameters:{...e.parameters,controls:{include:["rank","variant"]}},render:t=>r`
    <gds-flex gap="l" align-items="center">
      <gds-button
        .rank=${t.rank}
        .variant=${t.variant}
  ...
  `},L={...e,parameters:{...e.parameters,controls:{include:[]}},render:()=>r`
    <gds-flex gap="l">
  ...
  `},W={...e,parameters:{...e.parameters,controls:{include:[]}},render:()=>r`
    <gds-button
  ...
  `},D={...e,name:"Next & Previous",parameters:{...e.parameters,controls:{include:[]}},render:()=>r`
  ...
  `},R=["DefaultParams","Basic","RanksAndVariants","Sizes","WithIcon","IconButton","Disabled","Link","Wrapping","Aria","NextPrevious"];export{W as Aria,j as Basic,e as DefaultParams,L as Disabled,A as IconButton,_ as Link,D as NextPrevious,S as RanksAndVariants,T as Sizes,B as WithIcon,I as Wrapping,R as __namedExportsOrder,N as default};
