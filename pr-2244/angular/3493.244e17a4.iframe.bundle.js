...
`;let GdsFormControlFooter=class extends gds_element.j{constructor(){super(...arguments),(0,chunk_QTSIPXV3.VK)(this,_renderRemainingCharsBadge)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter)}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return custom_element_scoping.qy`<div aria-live="polite">
    ...
    </div>`}};_renderRemainingCharsBadge=new WeakSet,renderRemainingCharsBadge_fn=function(remaining){let variant;return variant=remaining<0?"negative":remaining<20?"warning":"positive",custom_element_scoping.qy`<gds-badge variant="${variant}">${remaining}</gds-badge>`},GdsFormControlFooter.styles=[form_control_footer_styles_default],(0,chunk_QTSIPXV3.Cc)([(0,decorators.MZ)({type:Number})],GdsFormControlFooter.prototype,"charCounter",2),(0,chunk_QTSIPXV3.Cc)([(0,decorators.MZ)()],GdsFormControlFooter.prototype,"errorMessage",2),(0,chunk_QTSIPXV3.Cc)([(0,watch.w)("charCounter"),(0,watch.w)("errorMessage")],GdsFormControlFooter.prototype,"_handleVisibilityChange",1),GdsFormControlFooter=(0,chunk_QTSIPXV3.Cc)([(0,custom_element_scoping.Y$)("gds-form-control-footer",{dependsOn:[GdsBadge,triangle_exclamation_component.f]})],GdsFormControlFooter);var button_component=__webpack_require__("./dist/libs/core/src/components/button/button.component.js"),style_expression_property=__webpack_require__("./dist/libs/core/src/utils/decorators/style-expression-property.js"),div_component=__webpack_require__("./dist/libs/core/src/components/div/div.component.js");let GdsCard=class extends div_component.o{constructor(){super(),this.variant="primary",this.padding="s;m{l}",this["border-radius"]="xs;m{s}",this.gap="s;m{l}"}render(){return custom_element_scoping.qy`<slot></slot>`}};GdsCard.styles=[tokens_style.LU,lit.AH`
      :host {
        box-sizing: border-box;
...
`;let GdsFormControlHeader=class extends gds_element.j{constructor(){super(...arguments),(0,chunk_QTSIPXV3.VK)(this,_handleExtSupTxtSlotChange),(0,chunk_QTSIPXV3.VK)(this,_renderExtSupTxt),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,(0,chunk_QTSIPXV3.VK)(this,_renderExtSupTxtButton,(()=>custom_element_scoping.qy`
    ...
    `},GdsFormControlHeader.styles=[form_control_header_styles_default],(0,chunk_QTSIPXV3.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],GdsFormControlHeader.prototype,"showExtendedSupportingText",2),(0,chunk_QTSIPXV3.Cc)([(0,decorators.wk)()],GdsFormControlHeader.prototype,"_hasExtendedSupportingText",2),(0,chunk_QTSIPXV3.Cc)([(0,decorators.P)("#extended-supporting-text")],GdsFormControlHeader.prototype,"_extendedSupportingText",2),GdsFormControlHeader=(0,chunk_QTSIPXV3.Cc)([(0,custom_element_scoping.Y$)("gds-form-control-header",{dependsOn:[button_component.t,GdsCard,circle_info_component.w]}),(0,lit_localize.cc)()],GdsFormControlHeader);var ref=__webpack_require__("./node_modules/lit/directives/ref.js"),listbox_kb_nav_controller=__webpack_require__("./dist/libs/core/src/utils/controllers/listbox-kb-nav-controller.js"),unwrap_slots=__webpack_require__("./dist/libs/core/src/utils/helpers/unwrap-slots.js");var listbox_styles_default=lit.AH`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
      display: flex;
...
`}}]);
//# sourceMappingURL=3493.244e17a4.iframe.bundle.js.map