import{n as i,G as b,g as y}from"./gds-element-DKcDvDP5.js";import{e as m}from"./class-map-CXsQwv0r.js";import{o as p}from"./if-defined-CVqwUuaf.js";import{i as f,u as _}from"./static-B8S6DEnV.js";import{t as w}from"./tokens.style-Kn_onYIX.js";import{w as x,d as k}from"./declarative-layout-mixins-DHam8wVT.js";import{i as $}from"./lit-element-Bx14lxc-.js";const z=$`
...
`;var C=Object.defineProperty,G=Object.getOwnPropertyDescriptor,v=t=>{throw TypeError(t)},s=(t,e,r,c)=>{for(var n=c>1?void 0:c?G(e,r):e,h=t.length-1,g;h>=0;h--)(g=t[h])&&(n=(c?g(e,r,n):g(n))||n);return c&&n&&C(e,r,n),n},P=(t,e,r)=>e.has(t)||v("Cannot "+r),l=(t,e,r)=>(P(t,e,"read from private field"),r?r.call(t):e.get(t)),B=(t,e,r)=>e.has(t)?v("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),a,d,u;let o=class extends x(k(b)){constructor(){super(),B(this,a),this.disabled=!1,this.label="",this.href="",this.compact=!1,this.selected=!1}render(){const t={button:!0,selected:this.selected,compact:this.compact},e=l(this,a,d)?f`a`:f`button`;return _`
      <${e}
        class="${m(t)}"
