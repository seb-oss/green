...
`;var co=Object.defineProperty,go=Object.getOwnPropertyDescriptor,g=(e,r,t,o)=>{for(var s=o>1?void 0:o?go(r,t):r,c=e.length-1,d;c>=0;c--)(d=e[c])&&(s=(o?d(r,t,s):d(s))||s);return o&&s&&co(r,t,s),s};const po=["aria-label","aria-haspopup","aria-expanded"],vo=io(j);var b,p,y,F,x,w;const _=class _ extends v{constructor(){super(...arguments);m(this,p);m(this,b);m(this,x);m(this,w);this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",h(this,b,!1),h(this,x,()=>{var o;const t=((o=this._mainSlot)==null?void 0:o.assignedElements())??[];h(this,b,t.length===1&&(t[0].tagName.toLowerCase().startsWith("gds-icon")||t[0].getAttribute("name")==="icon")),this.requestUpdate()}),h(this,w,t=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:t}),this.form&&!i(this,p,y)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),W.instance.apply(this,"gds-button")}focus(t){var o;(o=this._getValidityAnchor())==null||o.focus(t)}render(){const t={button:!0,circle:i(this,b),icon:i(this,b),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},o=i(this,p,y)?M`a`:M`button`;return B`
      ...
      >
        ...
        ${R(!this._isUsingTransitionalStyles,()=>vo`<gds-ripple part="_ripple"></gds-ripple>`)}
        </${o}>
