import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{u as t}from"./index-BM0h8gKO.js";import"./chunk-HLWAVYOI-BobXdXmk.js";import{af as r}from"./index-CFnZUvXY.js";import"./iframe-CU1H7gdu.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D-8MO0q_.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function o(n){const s={a:"a",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Concepts/Tokens"}),`
...
`,"Green uses a three-level color system, which you can read more about under ",e.jsx(s.a,{href:"/docs/style-colors--docs",children:"Style/Colors"})]}),`
`,e.jsxs(s.li,{children:["Text",e.jsx(s.br,{}),`
`,"Text tokens include font sizes, line heights, and font weights. Read more under ",e.jsx(s.a,{href:"/docs/style-typography--docs",children:"Style/Typography"})]}),`
`,e.jsxs(s.li,{children:["Sizes",e.jsx(s.br,{}),`
`,"Size tokens define the spacing values used for paddings, margins, gaps and other spaces in the design. Read more under ",e.jsx(s.a,{href:"/docs/style-size--docs",children:"Style/Size"})]}),`
...
simplified way of using the tokens. You can read more on this under `,e.jsx(s.a,{href:"/docs/style-colors--docs",children:"Style/Colors"}),"."]}),`
...
`,e.jsx("gds-theme",{"design-version":"2023",children:e.jsx("div",{style:{backgroundColor:"var(--gds-sys-color-l2-background-01)",color:"var(--gds-sys-color-content-01)",padding:"var(--gds-sys-space-l)"},children:"Hello world"})}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-html",children:`<gds-theme design-version="2023">
  <div style="background-color: var(--gds-sys-color-l2-background-01); color: var(--gds-sys-color-content-01); padding: var(--gds-sys-space-l);">
    Hello world
  </div>
</gds-theme>
`})}),`
`,e.jsxs(s.p,{children:["Try inspecting this example in Chrome DevTools, and change the value of the ",e.jsx(s.code,{children:"color-scheme"})," attribute in the ",e.jsx(s.code,{children:"<gds-theme>"})," element to ",e.jsx(s.code,{children:"dark"})," to see what happens to the color variables."]})]})}function y(n={}){const{wrapper:s}={...t(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(o,{...n})}):o(n)}export{y as default};
