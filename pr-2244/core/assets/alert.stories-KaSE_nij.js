import{n as m,r as L,G as bt,h as c,g as wt,a as E}from"./gds-element-DKcDvDP5.js";import{l as _t,m as ct}from"./runtime-CNluP0A8.js";import{i as xt,E as _}from"./lit-element-Bx14lxc-.js";import{e as dt}from"./class-map-CXsQwv0r.js";import{n as At,e as kt}from"./ref-R0wBYijq.js";import{u as Ct,s as S}from"./static-B8S6DEnV.js";import{t as It}from"./tokens.style-BebDwfJu.js";import{G as Dt}from"./button.component-Z1JTKrRD.js";import{G as Tt}from"./card.component-9S1PasTR.js";import{I as $t}from"./circle-check.component-C_fsC0T9.js";import{I as Lt,a as Mt}from"./triangle-exclamation.component-D9tEDG-O.js";import{I as Pt}from"./cross-small.component-x-OZTsvY.js";import"./card-Cyd-1AEK.js";import"./button-DohE5iAC.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./directive-helpers-BF33kFuJ.js";import"./query-p8xgzTDt.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./transitional-styles-qrfc5e8h.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-DHam8wVT.js";import"./watch-tFciLXSI.js";import"./div.component-DV4jT0Ib.js";import"./icon-mP8di1xV.js";import"./unsafe-html-CYO4avEf.js";const Et=xt`
  :host {
...
`;var St=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,mt=t=>{throw TypeError(t)},n=(t,e,r,g)=>{for(var l=g>1?void 0:g?Ht(e,r):e,C=t.length-1,I;C>=0;C--)(I=t[C])&&(l=(g?I(e,r,l):I(l))||l);return g&&l&&St(e,r,l),l},M=(t,e,r)=>e.has(t)||mt("Cannot "+r),d=(t,e,r)=>(M(t,e,"read from private field"),r?r.call(t):e.get(t)),p=(t,e,r)=>e.has(t)?mt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),x=(t,e,r,g)=>(M(t,e,"write to private field"),e.set(t,r),r),a=(t,e,r)=>(M(t,e,"access private method"),r),b,w,D,T,s,$,A,k,gt,pt,P,ut,ht,ft,vt,yt;const Bt={positive:{icon:"circle-check",card:"positive"},warning:{icon:"triangle-exclamation",card:"warning"},negative:{icon:"triangle-exclamation",card:"negative"},information:{icon:"circle-info",card:"information"},notice:{icon:"circle-info",card:"notice"}},Gt=300,Nt=100;let i=class extends bt{constructor(){super(),p(this,s),this.variant="information",this.label="",this.role="alert",this.dismissible=!1,this.timeout=0,this.buttonLabel="",this._progress=100,this._isClosing=!1,this._cardHidden=!1,p(this,b),p(this,w),p(this,D,kt()),p(this,T,{hostConnected:()=>{this.timeout>0&&a(this,s,$).call(this)},hostDisconnected:()=>a(this,s,A).call(this)}),this.addController(d(this,T))}updated(t){t.has("timeout")&&(a(this,s,A).call(this),this.timeout>0&&a(this,s,$).call(this))}render(){if(this._cardHidden)return _;const t={dismissing:this._isClosing,dismissible:this.dismissible,"has-action":this.buttonLabel,timeout:this.timeout>0};return c`
    ...
    `}};b=new WeakMap;w=new WeakMap;D=new WeakMap;T=new WeakMap;s=new WeakSet;$=function(){const t=Date.now();this._progress=100,x(this,w,window.setInterval(()=>{const e=Date.now()-t;this._progress=Math.max(0,(this.timeout-e)/this.timeout*100)},Nt)),x(this,b,window.setTimeout(()=>a(this,s,k).call(this,"timeout"),this.timeout))};A=function(){clearTimeout(d(this,b)),clearInterval(d(this,w)),x(this,b,x(this,w,void 0))};k=async function(t){this._isClosing=!0,a(this,s,A).call(this),await this.updateComplete,this.dispatchCustomEvent("gds-close",{detail:{source:t},bubbles:!0,composed:!0}),await new Promise(e=>setTimeout(e,Gt)),this._cardHidden=!0};gt=function(t){this.dispatchCustomEvent("gds-action",{detail:{source:"button",event:t},bubbles:!0,composed:!0})};pt=function(t){t.key==="Escape"&&this.dismissible&&(t.preventDefault(),a(this,s,k).call(this,"escape"))};P=function(){return Bt[this.variant]};ut=function(){const t=`gds-icon-${d(this,s,P).icon}`;return c`${Ct`<${S(E(t))} class="icon" solid aria-hidden="true" size="24px"></${S(E(t))}>`}`};ht=function(){return c`<div class="message">
    ...
    `};vt=function(){return this.dismissible?c`
        ...
        `:_};i.styles=[It,Et];n([m({type:String,reflect:!0})],i.prototype,"variant",2);n([m({type:String})],i.prototype,"label",2);n([m({type:String,reflect:!0})],i.prototype,"role",2);n([m({type:Boolean})],i.prototype,"dismissible",2);n([m({type:Number})],i.prototype,"timeout",2);n([m({type:String,attribute:"button-label"})],i.prototype,"buttonLabel",2);n([L()],i.prototype,"_progress",2);n([L()],i.prototype,"_isClosing",2);n([L()],i.prototype,"_cardHidden",2);i=n([wt("gds-alert",{dependsOn:[Dt,Tt,$t,Lt,Mt,Pt]}),_t()],i);i.define();const ge={title:"Components/Alert",component:"gds-alert",tags:["autodocs"],argTypes:{variant:{control:"select",options:["information","notice","positive","warning","negative"]},role:{control:"select",options:["alert","status"]}},parameters:{docs:{description:{component:"Alert is a message used to inform or update the user about the state of a system, page or function. Icons and color indicate the type and urgency of the information within the message."}}}},o={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{variant:"information",role:"alert",dismissible:!0,timeout:0,buttonLabel:"",innerHTML:`<strong>Information</strong> Body text starts on the same row as heading.
