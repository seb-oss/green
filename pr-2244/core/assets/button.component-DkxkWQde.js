...
`;var co=Object.defineProperty,go=Object.getOwnPropertyDescriptor,g=(e,r,t,o)=>{for(var s=o>1?void 0:o?go(r,t):r,c=e.length-1,d;c>=0;c--)(d=e[c])&&(s=(o?d(r,t,s):d(s))||s);return o&&s&&co(r,t,s),s};const po=["aria-label","aria-haspopup","aria-expanded"],vo=io(B);var b,p,y,F,x,w;const _=class _ extends v{constructor(){super(...arguments);m(this,p);m(this,b);m(this,x);m(this,w);this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",h(this,b,!1),h(this,x,()=>{var o;const t=((o=this._mainSlot)==null?void 0:o.assignedElements())??[];h(this,b,t.length===1&&(t[0].tagName.toLowerCase().startsWith("gds-icon")||t[0].getAttribute("name")==="icon")),this.requestUpdate()}),h(this,w,t=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:t}),this.form&&!i(this,p,y)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),W.instance.apply(this,"gds-button")}focus(t){var o;(o=this._getValidityAnchor())==null||o.focus(t)}render(){const t={button:!0,circle:i(this,b),icon:i(this,b),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},o=i(this,p,y)?M`a`:M`button`;return R`
      <${o}
        class=${j(t)}
        ...
        part="_button"
        @click="${i(this,w)}"
        ${eo(s=>s.name.startsWith("gds-aria")||s.name==="gds-role"||po.includes(s.name))}
      >
        <slot name="lead"></slot>
        <slot @slotchange=${i(this,x)}></slot>
        <slot name="trail"></slot>
        ${U(!this._isUsingTransitionalStyles,()=>vo`<gds-ripple part="_ripple"></gds-ripple>`)}
        </${o}>
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}};b=new WeakMap,p=new WeakSet,y=function(){return this.href.length>0},F=function(){return this.target==="_blank"?"noreferrer noopener":void 0},x=new WeakMap,w=new WeakMap,_.styles=[T,lo],_.shadowRootOptions={mode:"open",delegatesFocus:!0};let l=_;g([n({type:Boolean,reflect:!0})],l.prototype,"disabled",2);g([I({selector:".button"})],l.prototype,"justify-content",2);g([n({reflect:!0})],l.prototype,"type",2);g([n({reflect:!0})],l.prototype,"rank",2);g([n({reflect:!0})],l.prototype,"variant",2);g([n({reflect:!0})],l.prototype,"size",2);g([n()],l.prototype,"label",2);g([n()],l.prototype,"href",2);g([n()],l.prototype,"target",2);g([n()],l.prototype,"rel",2);g([n()],l.prototype,"download",2);g([V("slot:not([name])")],l.prototype,"_mainSlot",2);g([V(".button")],l.prototype,"_button",2);g([G({attributes:!0,childList:!1,subtree:!1,characterData:!1})],l.prototype,"_attributeChanged",1);let P=class extends N(X(Y(l))){};P=g([S("gds-button",{dependsOn:[k]})],P);export{P as G,v as a};
