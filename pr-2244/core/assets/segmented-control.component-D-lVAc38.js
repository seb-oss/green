import{m as O,l as T}from"./runtime-CNluP0A8.js";import{h as z,n as g,G as $,g as P,r as W}from"./gds-element-DKcDvDP5.js";import{a as S}from"./query-p8xgzTDt.js";import{t as V}from"./tokens.style-Kn_onYIX.js";import{T as B}from"./transitional-styles-DNXVuSY2.js";import{r as G}from"./resize-observer-B9k8v2TZ.js";import{w as D}from"./watch-tFciLXSI.js";import{w as M,d as N,b as R}from"./declarative-layout-mixins-DHam8wVT.js";import{I as X,a as A}from"./chevron-right.component-DkroQAC_.js";import{i as E}from"./lit-element-Bx14lxc-.js";const F=E`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var j=Object.defineProperty,q=Object.getOwnPropertyDescriptor,m=(e,t,s,i)=>{for(var r=i>1?void 0:i?q(t,s):t,a=e.length-1,h;a>=0;a--)(h=e[a])&&(r=(i?h(t,s,r):h(r))||r);return i&&r&&j(t,s,r),r};let p=class extends M($){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return z`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};p.styles=[...V,F];m([g({type:Boolean,reflect:!0})],p.prototype,"selected",2);m([g()],p.prototype,"value",2);m([g({type:Boolean,reflect:!0})],p.prototype,"disabled",2);p=m([P("gds-segment")],p);const H=E`
  @layer base {
    :host {
