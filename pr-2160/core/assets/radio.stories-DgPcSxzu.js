import{i as D,x as b}from"./lit-element-Bx14lxc-.js";import{n,G as me,h as x,g as G,r as ke}from"./custom-element-scoping-b4c89-hi.js";import{l as be}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{e as ve}from"./class-map-CXsQwv0r.js";import{t as fe}from"./tokens.style-OWC-W9l-.js";import{T as De}from"./transitional-styles-Ckr_5-pT.js";import{w as A}from"./watch-tFciLXSI.js";import{a as Ge}from"./query-p8xgzTDt.js";import{G as Ae,a as $e}from"./form-control-header.component-BHPTElKC.js";import{d as Te,b as Pe,w as Oe}from"./declarative-layout-mixins-BgWwoHZ-.js";import{a as Fe}from"./button.component-DxfU86xO.js";import"./flex-DvFpiQV2.js";import"./card-G_rzxrp_.js";import"./text-wRgsyUTH.js";import"./divider-D6m2TtUd.js";import"./circle-check-DteqX2Hj.js";import"./cross-small-Ba6K-R9r.js";import{a as Ie}from"./argTableProps-CtZfnZSz.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./when-BR7zwNJC.js";import"./badge.component-BbHeY5MQ.js";import"./flex.component-CYboTd6A.js";import"./div.component-DlGsFHOd.js";import"./triangle-exclamation.component-7Z9_MCa_.js";import"./icon-BISRwovF.js";import"./card.component-BkDO6s2X.js";import"./if-defined-CVqwUuaf.js";import"./static-B8S6DEnV.js";import"./observe-light-dom-CmJPHUQ4.js";import"./text.component-CLfG34IB.js";import"./cross-small.component-CbU4_NWn.js";import"./custom-elements-D9QAhuhQ.js";const qe=D`
  @layer base, a11y;
...
`;var Ke=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,we=e=>{throw TypeError(e)},c=(e,t,a,o)=>{for(var s=o>1?void 0:o?Ue(t,a):t,l=e.length-1,p;l>=0;l--)(p=e[l])&&(s=(o?p(t,a,s):p(s))||s);return o&&s&&Ke(t,a,s),s},Xe=(e,t,a)=>t.has(e)||we("Cannot "+a),Je=(e,t,a)=>t.has(e)?we("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),i=(e,t,a)=>(Xe(e,t,"access private method"),a),r,z,_e,T,Ee,Le,C,Re,Se,ze,Ce;let g=class extends Fe{constructor(){super(...arguments),Je(this,r),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),i(this,r,z).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{i(this,r,z).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return x`<div
    ...
    >
    ...
    </div>`}};r=new WeakSet;z=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))};_e=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(a=>a.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(a=>a.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};T=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))};Ee=function(e){const t=e.target;t.hasAttribute("value")&&(this.value=t.value,this._syncRadioStates(),i(this,r,T).call(this))};Le=function(e){if(!this._isConnected)return;const t=this.radios.filter(o=>!o.hasAttribute("disabled"));if(t.length===0)return;let a=t.findIndex(o=>document.activeElement===o);switch(a===-1&&(a=t.findIndex(o=>o.checked),a===-1&&(a=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const o=(a+1)%t.length;i(this,r,C).call(this,t[o]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const o=(a-1+t.length)%t.length;i(this,r,C).call(this,t[o]);break}default:return}};C=function(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),i(this,r,T).call(this))};Re=function(){return[i(this,r,Se).call(this),i(this,r,ze).call(this),i(this,r,Ce).call(this)].map(t=>x`${t}`)};Se=function(){if(this.label)return x` <gds-form-control-header
      ...
      @focus=${i(this,r,_e)}
    >
      <slot @gds-radio-change=${i(this,r,Ee)}></slot>
...
In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};var te,ae,oe,se,re;w.parameters={...w.parameters,docs:{...(te=w.parameters)==null?void 0:te.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
...
The size can be set on the radio group and applies to all radio buttons within.`,...(re=(se=w.parameters)==null?void 0:se.docs)==null?void 0:re.description}}};var ie,de,ne,le,pe;_.parameters={..._.parameters,docs:{...(ie=_.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
