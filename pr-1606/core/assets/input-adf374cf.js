...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};f=new WeakSet;R=function(){return l`
      ...
      >
        ...
        >
          ...
          <gds-flex gap="xs" align-items="center"> ${r(this,W,j).call(this)} ${r(this,k,G).call(this)} </gds-flex>
        </gds-flex>
    ...
    `};m=new WeakSet;D=function(){return c};v=new WeakMap;b=new WeakMap;y=new WeakMap;_=new WeakMap;w=new WeakMap;S=new WeakMap;$=new WeakSet;F=function(){return l` <slot name="lead"></slot> `};k=new WeakSet;G=function(){return l` <slot name="trail" gds-allow="gds-badge" @slotchange=${r(this,E,L)}></slot> `};E=new WeakSet;L=function(e){const n=e.target.assignedNodes({flatten:!0});this.trailSlotOccupied=n.length>0&&n.some(h=>{var o;return h.nodeType===Node.ELEMENT_NODE||h.nodeType===Node.TEXT_NODE&&((o=h.textContent)==null?void 0:o.trim())!==""})};z=new WeakSet;P=function(){return l`
      <input
        @input=${p(this,b)}
        @change=${p(this,y)}
