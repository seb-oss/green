import{i as U,h as V,D as u}from"./lit-element-1d72f0ce.js";import{n as d,g as J,h as o}from"./gds-element-86064462.js";import{a as K}from"./query-b9d3c2af.js";import{r as F}from"./query-async-1ff18261.js";import{b as P}from"./until-27bb1490.js";import{n as c}from"./when-748fcf30.js";import{m as H}from"./runtime-c06dc943.js";import{c as L}from"./constrain-slots-08d8606c.js";import{w as Q}from"./watch-c4961afe.js";import{G as Z,f as Y}from"./form-control-e1f3f4f4.js";import{t as ee}from"./tokens.style-b5b8efd2.js";/**
 * @license
...
`).length||1).toString();e==null||e.style.setProperty("--_lines",t.toString())})}};C=new WeakSet;X=function(){return o`
      ...
      <div class="foot">
        <div>${c(this.invalid,()=>o`<span class="error-text">${this.validationMessage}</span>`)}</div>
    ...
    `};W=new WeakSet;j=function(){return o`
      ...
      <div class="foot">
        ${n(this,x,M).call(this)} ${c(l(this,k,O),()=>n(this,$,G).call(this))}
        ${P(n(this,S,D).call(this),u)}
      </div>
    ...
    `};_=new WeakSet;I=function(){return o`
      <textarea
        ...
        ${Y(l(this,g))}
      ></textarea>
    `};x=new WeakSet;M=function(){return o` <div class="supporting-text" id="supporting-text">${this.supportingText}</div> `};y=new WeakSet;R=function(){return o`
      <div
    ...
    `};w=new WeakSet;N=function(){return this.clearable&&this.value.length>0?o`
        <gds-button size="small" variant="tertiary" label="${H("Clear input")}" @click=${l(this,z)}>
          <gds-icon-cross-small />
        </gds-button>
      `:u};k=new WeakSet;O=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};$=new WeakSet;G=function(){const e=this.maxlength-this.value.length;let t;return e<0?t="error":e<20?t="warning":t="success",o`<gds-badge variant="${t}">${e}</gds-badge>`};S=new WeakSet;D=async function(){return this.elExtendedSupportingTextSlot.then(e=>e&&e.assignedElements().length>0?o`
          <gds-button
            size="small"
            variant="tertiary"
