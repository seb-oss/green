import"./text-283a1198.js";import"./card-dcd6ce07.js";import"./container-89e950a3.js";import"./flex-bcd919b1.js";import"./divider-175a5512.js";import{k as e}from"./lit-element-1d72f0ce.js";import"./static-c0094392.js";import"./gds-element-86064462.js";import"./_commonjsHelpers-725317a4.js";import"./tokens.style-01187a75.js";import"./style-expression-property-26695edd.js";import"./watch-c4961afe.js";const ne={title:"Docs/Content/Text",component:"gds-text",tags:["autodocs"],parameters:{docs:{description:{component:`The \`gds-text\`
...
## Usage`}}}},G={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},argTypes:{size:{options:["heading-xl","heading-l","heading-m","heading-s","heading-xs","heading-2xs","detail-m","detail-s","detail-xs","body-l","body-m","body-s","display-2xl","display-xl","display-l","display-m","display-s ","preamble-2xl","preamble-xl","preamble-l","preamble-m","preamble-s","preamble-xs"],control:{type:"select"}},tag:{options:["h1","h2","h3","h4","h5","h6","p","span","em","mark","strong"],control:{type:"select"}},wrap:{options:["balance","nowrap","pretty","wrap"],control:{type:"select"}},length:{control:{type:"number"}},min:{control:{type:"number"}},align:{options:["left","center","right","justify"],control:{type:"select"}},font:{control:{type:"string"}}}},s={...G,name:"Tags",render:t=>e`<gds-flex flex-direction="column" gap="2xl">
  ...
  \`
}`,...(E=(X=g.parameters)==null?void 0:X.docs)==null?void 0:E.source}}};var W,I,j,R,_;a.parameters={...a.parameters,docs:{...(W=a.parameters)==null?void 0:W.docs,source:{originalSource:`{
  name: 'Line Clamp',
  render: args => html\`
    <gds-flex flex-direction="column" gap="2xl">
      <gds-flex flex-direction="column" gap="m">
  ...
  \`
}`,...(j=(I=a.parameters)==null?void 0:I.docs)==null?void 0:j.source},description:{story:"The `gds-text` component has a `lines` property that will clamp the text to the specified number of lines. It can be any number value.",...(_=(R=a.parameters)==null?void 0:R.docs)==null?void 0:_.description}}};var F,O,U,Y,A;n.parameters={...n.parameters,docs:{...(F=n.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: 'Color',
  render: args => html\`
    <gds-flex flex-direction="column" gap="m">
      <gds-theme color-scheme="dark">
  ...
  \`
}`,...(U=(O=n.parameters)==null?void 0:O.docs)==null?void 0:U.source},description:{story:'The `gds-text` component has a `color` property that will change the text color based on the specified color token.\n\ne.g. `<gds-text level="1" color="primary"></gds-text>`',...(A=(Y=n.parameters)==null?void 0:Y.docs)==null?void 0:A.description}}};const ie=["Card","Weight","Heading","Detail","Body","Display","Preamble","Lines","Color"];export{r as Body,s as Card,n as Color,o as Detail,l as Display,d as Heading,a as Lines,g as Preamble,i as Weight,ie as __namedExportsOrder,ne as default};
