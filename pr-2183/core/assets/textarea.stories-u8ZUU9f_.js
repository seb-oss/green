...
\`\`\``,...(ce=(pe=p.parameters)==null?void 0:pe.docs)==null?void 0:ce.description}}};var ue,me,fe,be,he;c.parameters={...c.parameters,docs:{...(ue=c.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  ...
  \`
}`,...(fe=(me=c.parameters)==null?void 0:me.docs)==null?void 0:fe.source},description:{story:"The `disabled` property can be set to disable the textarea field.\n\n**@property disabled** - Disables the textarea field.\n\n```html\n <gds-textarea disabled></gds-textarea>\n```",...(he=(be=c.parameters)==null?void 0:be.docs)==null?void 0:he.description}}};const ot=["Default","Lead","Trail","Length","Rows","Resize","Size","Clearable","SupportingText","ExtendedSupportingText","Validation","Disabled"];export{i as Clearable,u as Default,c as Disabled,x as ExtendedSupportingText,r as Lead,n as Length,d as Resize,l as Rows,o as Size,g as SupportingText,s as Trail,p as Validation,ot as __namedExportsOrder,dt as default};
