import"./text-C6LcoToK.js";import"./card-CjhXGhfo.js";import"./div-Iog5VETL.js";import"./flex-DPZcif6m.js";import"./divider-DYNcmBhD.js";import{x as e}from"./iframe-2dTGah3T.js";import{a as s}from"./argTableProps-6Us_o-XZ.js";import"./default-typography.styles-CtFv1FM2.js";import"./card.component-AWBCNw0n.js";import"./flex.component-CB55hL76.js";import"./divider.component-fl_WTs9i.js";const p={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...s("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified."}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},f={...d,name:"Font",render:t=>e`<gds-flex flex-direction="column" gap="m">
