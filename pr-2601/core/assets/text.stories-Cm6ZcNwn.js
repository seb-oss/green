import"./text-Bi4GUguR.js";import"./card-CThgPxvs.js";import"./div-Cq-4BE8p.js";import"./flex-BVlaU2K7.js";import"./divider-53e88BJg.js";import{x as e}from"./iframe-CvkrKpPT.js";import{a as s}from"./argTableProps-CK-y38vv.js";import"./default-typography.styles-Y5hFK-zl.js";import"./card.component-Ba_9DfXW.js";import"./flex.component-3WlUjBhB.js";import"./divider.component-B9P63FmF.js";const p={title:"Components/Text",component:"gds-text",tags:["autodocs"],argTypes:{...s("gds-text")},parameters:{docs:{description:{component:"`gds-text` extends `gds-div` and adds the ability to set an internal tag name, such as `h1`, `h2`, etc. It also adds line clamping and text decoration properties.\n\nStyle expression properties apply to the outer element unless otherwise specified."}}}},d={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},f={...d,name:"Font",render:t=>e`<gds-flex flex-direction="column" gap="m">
