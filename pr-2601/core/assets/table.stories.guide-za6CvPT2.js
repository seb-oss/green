import{u as s,j as e,M as r}from"./iframe-C8zps3Hr.js";function o(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Components/Table/Developer Guide"}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#actions-column",children:"Actions Column"})}),`
...
`,e.jsxs(n.p,{children:["Import the ",e.jsx(n.code,{children:"Slot"})," function from the table component:"]}),`
...
|---|---|---|
| `,e.jsx(n.code,{children:"value"})," | ",e.jsx(n.code,{children:"unknown"}),` | The fallback display value (also used for sorting and search) |
| `,e.jsx(n.code,{children:"slots"})," | ",e.jsx(n.code,{children:"string[]"}),` | Ordered array of slot IDs that define the cell layout |
| `,e.jsx(n.code,{children:"key"})," | ",e.jsx(n.code,{children:"string \\| number"})," | Optional custom row key (defaults to ",e.jsx(n.code,{children:"row.id"})," or row index) |"]}),`
`,e.jsxs(n.p,{children:["The special slot ID ",e.jsx(n.code,{children:"'value'"})," renders the plain text value inline. All other IDs create named ",e.jsx(n.code,{children:"<slot>"})," elements."]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`{columnKey}:{rowKey}:{slotId}
`})}),`
...
`]}),`
`,e.jsx(n.h3,{id:"step-1-normalize-row-data",children:"Step 1: Normalize Row Data"}),`
`,e.jsxs(n.p,{children:["Wrap cell values that need rich content with ",e.jsx(n.code,{children:"Slot()"}),":"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`const normalizeRow = (row: any) => ({
  ...row,
...
`})}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"actions-column",children:"Actions Column"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"actions"})," property defines an actions column rendered as the last cell of each row."]}),`
`,e.jsx(n.h3,{id:"configuration",children:"Configuration"}),`
`,e.jsx(n.p,{children:"When passed as an object, it configures the column header. Action content is provided through slots:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`const actions: Types.Actions = {
  label: 'Actions',
  justify: 'end',
}
`})}),`
`,e.jsx(n.h3,{id:"action-slot-content",children:"Action Slot Content"}),`
`,e.jsxs(n.p,{children:["The actions column uses ",e.jsx(n.code,{children:"actions:{rowKey}:main"})," as its slot name:"]}),`
...
\`
`})}),`
`,e.jsx(n.h3,{id:"actions-as-a-render-function",children:"Actions as a Render Function"}),`
`,e.jsx(n.p,{children:"Alternatively, pass a function that returns a template for each row. This skips the slot system entirely:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`const actions = (row, index) => html\`
...
`,e.jsx(n.p,{children:"The table is a web component that works across all frameworks. The key pattern is the same everywhere:"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsx(n.li,{children:"Configure columns and data provider"}),`
`,e.jsxs(n.li,{children:["Normalize rows with ",e.jsx(n.code,{children:"Slot()"})]}),`
`,e.jsxs(n.li,{children:["On ",e.jsx(n.code,{children:"gds-table-data-loaded"}),", render slot content into the table element"]}),`
`]}),`
`,e.jsx(n.p,{children:"Below are full working examples for each framework."}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:e.jsx("strong",{children:"Lit"})}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { LitElement, html } from 'lit'
...
`})})]}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:e.jsx("strong",{children:"React"})}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import React, { useRef, useCallback, useMemo } from 'react'
...
`})}),e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note"}),": When using web components in React, object and function properties must be set via refs or with stable references (",e.jsx(n.code,{children:"useMemo"}),"). The ",e.jsx(n.code,{children:"gds-table-data-loaded"})," event maps to ",e.jsx(n.code,{children:"onGdsTableDataLoaded"})," in React's synthetic event system, or you can use ",e.jsx(n.code,{children:"addEventListener"})," via the ref. Slot content is rendered with Lit's ",e.jsx(n.code,{children:"render()"})," into the table element's light DOM."]}),`
`]})]}),`
`,e.jsxs("details",{children:[e.jsx("summary",{children:e.jsx("strong",{children:"Angular"})}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`// user-table.component.ts
...
`})}),e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note"}),": The ",e.jsx(n.code,{children:"CUSTOM_ELEMENTS_SCHEMA"})," allows Angular to recognize custom element tags. Property bindings like ",e.jsx(n.code,{children:"[columns]"})," and ",e.jsx(n.code,{children:"[data]"})," set JavaScript properties directly on the web component. Lit's ",e.jsx(n.code,{children:"render()"})," is used in the data-loaded handler to populate the table's light DOM with slot content."]}),`
`]})]}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"complete-example",children:"Complete Example"}),`
`,e.jsx(n.p,{children:"A full example with row normalization, slot content, and table configuration:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-typescript",children:`import { html, render } from 'lit'
import { createRef, ref } from 'lit/directives/ref.js'
...
`,e.jsxs(n.p,{children:[`| Slot Name | Purpose |
|---|---|
| `,e.jsx(n.code,{children:"header-lead"}),` | Content at the start of the table header bar (after search input) |
| `,e.jsx(n.code,{children:"header-trail"}),` | Content at the end of the table header bar (before settings dropdown) |
| `,e.jsx(n.code,{children:"error"}),` | Custom error state when data loading fails |
| `,e.jsx(n.code,{children:"empty"}),` | Custom empty state when no data exists |
| `,e.jsx(n.code,{children:"no-results"})," | Custom empty state when search returns nothing |"]}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx(n.p,{children:"For complete API documentation, see the main Table component documentation."}),`
`,e.jsx(n.hr,{}),`
...
`})}),`
`,e.jsxs(n.h4,{id:"2-add-row-normalization-with-slot",children:["2. Add Row Normalization with ",e.jsx(n.code,{children:"Slot()"})]}),`
...
`,e.jsxs(n.p,{children:["Call ",e.jsx(n.code,{children:"normalizeRow"})," on each row in your data provider response:"]}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-diff",children:`- // Old: actions config
- const actions = {
-   label: 'Actions',
-   justify: 'end',
-   cell: {
...
`,e.jsxs(n.li,{children:["[ ] Remove ",e.jsx(n.code,{children:"cell"})," from ",e.jsx(n.code,{children:"actions"})," configuration"]}),`
...
`,e.jsxs(n.li,{children:["[ ] Create a ",e.jsx(n.code,{children:"normalizeRow"})," function wrapping values with ",e.jsx(n.code,{children:"Slot()"})]}),`
`,e.jsxs(n.li,{children:["[ ] Update data provider to call ",e.jsx(n.code,{children:"normalizeRow"})," on each row"]}),`
...
`]})]})}function l(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{l as default};
