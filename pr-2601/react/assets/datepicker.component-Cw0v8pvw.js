import{i as Be,x as S,t as Ae,_ as i,n as p,r as j,g as ke,G as He,b as m,c as h,T as ie,d,e as A,h as D,E as Pe}from"./tokens.style-Dh2WjNZp.js";import{l as Ge,m as g}from"./runtime-nRyYmvPb.js";import{a as at,e as te,w as se}from"./watch-Bh1rs_BK.js";import{f as nt,r as ae,c as rt,G as it}from"./dropdown.component-B7rg589j.js";import{e as Re,i as ot,t as lt,w as dt,b as ht,a as ut}from"./icon.component-CHfinurX.js";import{p as ct,v as E,s as H,M as re,m as pt,f as gt,i as ft}from"./unwrap-slots-BBWdPB-O.js";import{n as C}from"./when-BR7zwNJC.js";import{b as We,G as yt,a as mt}from"./button.component-DsVomMzB.js";import{d as Ce,a as bt}from"./attribute-converters-CdI0trPX.js";import{e as Ne}from"./class-map-D9tumyRl.js";import{T as Ve}from"./transitional-styles-D918RGK5.js";import{I as vt,a as _t}from"./calender-add.component-CQ1hpqOn.js";import{I as wt,a as $t}from"./chevron-right.component-Cli21h0E.js";import{G as xt}from"./popover.component-Cxf8jmC5.js";/**
 * @license
        ...
        ${Ht(this.focusedDate,t=>S`
            ${t.map(s=>S`
                <tr role="row">
                  ...
                  ${s.days.map(a=>{const n=this.customizedDates&&this.customizedDates.find(c=>I(c.date,a)),r={color:"currentColor",disabled:!!(this.disabledDates&&this.disabledDates.some(c=>I(c,a))),...n},l=!Et(this.focusedDate,a),u=(a<this.min||a>this.max)&&!I(a,this.min)&&!I(a,this.max),o=a.getDay()===0||a.getDay()===6,y=r.disabled||u||this.disabledWeekends&&o;return this.hideExtraneousDays&&l?S`<td inert></td>`:S`
                          <td
                            role="${We(y?void 0:"gridcell")}"
                            class="${Ne({small:this.size==="small","custom-date":!!n,disabled:!!y,today:I(e,a),"outside-month":l})}"
                            ?disabled=${y}
