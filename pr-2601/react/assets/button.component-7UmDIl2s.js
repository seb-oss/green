import{x as q,E as C,i as B,t as W,_ as s,g as R,G as U,f as O,b as y,e as $,d as a,n as i,h as P}from"./tokens.style-Dp2XwTV3.js";import{e as _,w as H}from"./watch-Bh1rs_BK.js";import{e as I}from"./class-map-Dr5fwlhy.js";import{n as N}from"./when-BR7zwNJC.js";import{e as j,i as X,t as K,w as Y,b as J,a as Q,s as Z}from"./icon.component-BptfTWHR.js";import{T as tt}from"./transitional-styles-BzXdk8PM.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const S=Symbol.for(""),et=o=>{if((o==null?void 0:o.r)===S)return o==null?void 0:o._$litStatic$},ft=o=>({_$litStatic$:o,r:S}),A=(o,...t)=>({_$litStatic$:t.reduce(((r,e,l)=>r+(c=>{if(c._$litStatic$!==void 0)return c._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${c}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(e)+o[l+1]),o[0]),r:S}),L=new Map,rt=o=>(t,...r)=>{const e=r.length;let l,c;const g=[],w=[];let x,v=0,b=!1;for(;v<e;){for(x=t[v];v<e&&(c=r[v],(l=et(c))!==void 0);)x+=l+t[++v],b=!0;v!==e&&w.push(c),g.push(x),v++}if(v===e&&g.push(t[e]),b){const z=g.join("$$lit$$");(t=L.get(z))===void 0&&(g.raw=g,L.set(z,t=g)),r=w}return o(t,...r)},ot=rt(q);/**
 * @license
