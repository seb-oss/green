const l={title:"Components/Breadcrumb",tags:["autodocs"],parameters:{componentIds:["component-Breadcrumb"]}},s={render:()=>`
    <ul class="breadcrumb">
      <li><a href="">Cart</a></li>
      <li class="icon">
    ...
    `},i=["Breadcrumb"];export{s as Breadcrumb,i as __namedExportsOrder,l as default};
