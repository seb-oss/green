import{i as D,x as b}from"./lit-element-Bx14lxc-.js";import{n,G as me,h as x,g as G,r as ke}from"./custom-element-scoping-b4c89-hi.js";import{l as be}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{e as ve}from"./class-map-CXsQwv0r.js";import{t as fe}from"./tokens.style-C9bLefPj.js";import{T as De}from"./transitional-styles-Cduvqqe2.js";import{w as A}from"./watch-tFciLXSI.js";import{a as Ge}from"./query-p8xgzTDt.js";import{G as Ae,a as $e}from"./form-control-header.component-DMsFyVsc.js";import{d as Te,b as Pe,w as Oe}from"./declarative-layout-mixins-CxeMR8ZJ.js";import{a as Fe}from"./button.component-B-lvYzve.js";import"./flex-B8AQUA7n.js";import"./card-BDIWjU2T.js";import"./text-BgDT2iSM.js";import"./divider-D1z2XdRH.js";import"./circle-check-zSh7hvRz.js";import"./cross-small-m1kD15_t.js";import{a as Ie}from"./argTableProps-DFzn0q_u.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./when-BR7zwNJC.js";import"./badge.component-lHGwzMdV.js";import"./flex.component-BDILfbvS.js";import"./div.component-Diofk0s1.js";import"./triangle-exclamation.component-D_ZmLszF.js";import"./icon-Bm2mwQqA.js";import"./card.component-ESUepO5H.js";import"./if-defined-CVqwUuaf.js";import"./static-B8S6DEnV.js";import"./observe-light-dom-CmJPHUQ4.js";import"./text.component-CmSKS74a.js";import"./cross-small.component-zD4U0QzL.js";import"./custom-elements-BSsv1IF5.js";const qe=D`
  @layer base, a11y;
...
`;var Ve=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,$=(e,t,a,o)=>{for(var r=o>1?void 0:o?Me(t,a):t,l=e.length-1,p;l>=0;l--)(p=e[l])&&(r=(o?p(t,a,r):p(r))||r);return o&&r&&Ve(t,a,r),r};let m=class extends me{constructor(){super(),this.label="",this.supportingText=""}connectedCallback(){super.connectedCallback(),De.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,"has-supporting-text":!!this.supportingText};return x`
...
`;var Ke=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,we=e=>{throw TypeError(e)},c=(e,t,a,o)=>{for(var r=o>1?void 0:o?Ue(t,a):t,l=e.length-1,p;l>=0;l--)(p=e[l])&&(r=(o?p(t,a,r):p(r))||r);return o&&r&&Ke(t,a,r),r},Xe=(e,t,a)=>t.has(e)||we("Cannot "+a),Je=(e,t,a)=>t.has(e)?we("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),i=(e,t,a)=>(Xe(e,t,"access private method"),a),s,z,_e,T,Ee,Le,C,Re,Se,ze,Ce;let g=class extends Fe{constructor(){super(...arguments),Je(this,s),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),i(this,s,z).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{i(this,s,z).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return x`<div
    ...
    >
    ...
    </div>`}};s=new WeakSet;z=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))};_e=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(a=>a.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(a=>a.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};T=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))};Ee=function(e){const t=e.target;t.hasAttribute("value")&&(this.value=t.value,this._syncRadioStates(),i(this,s,T).call(this))};Le=function(e){if(!this._isConnected)return;const t=this.radios.filter(o=>!o.hasAttribute("disabled"));if(t.length===0)return;let a=t.findIndex(o=>document.activeElement===o);switch(a===-1&&(a=t.findIndex(o=>o.checked),a===-1&&(a=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const o=(a+1)%t.length;i(this,s,C).call(this,t[o]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const o=(a-1+t.length)%t.length;i(this,s,C).call(this,t[o]);break}default:return}};C=function(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),i(this,s,T).call(this))};Re=function(){return[i(this,s,Se).call(this),i(this,s,ze).call(this),i(this,s,Ce).call(this)].map(t=>x`${t}`)};Se=function(){if(this.label)return x` <gds-form-control-header
      ...
      @focus=${i(this,s,_e)}
    >
      <slot @gds-radio-change=${i(this,s,Ee)}></slot>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},h={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},v={...h,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
  ...
  `},L={...h,name:"Do's and dont's",render:()=>b`
    <gds-flex gap="xl">
  ...
  `},E={...h,name:"Radio group label",render:()=>b`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...(j=(N=f.parameters)==null?void 0:N.docs)==null?void 0:j.description}}};var K,U,X;L.parameters={...L.parameters,docs:{...(K=L.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(X=(U=L.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};var J,Q,Y,Z,ee;y.parameters={...y.parameters,docs:{...(J=y.parameters)==null?void 0:J.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <div class="radio-group">
...
In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};var te,ae,oe,re,se;w.parameters={...w.parameters,docs:{...(te=w.parameters)==null?void 0:te.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(oe=(ae=w.parameters)==null?void 0:ae.docs)==null?void 0:oe.source},description:{story:`Radio buttons support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the radio group and applies to all radio buttons within.`,...(se=(re=w.parameters)==null?void 0:re.docs)==null?void 0:se.description}}};var ie,de,ne,le,pe;_.parameters={..._.parameters,docs:{...(ie=_.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
...
Choose the direction based on available space and number of options.`,...(pe=(le=_.parameters)==null?void 0:le.docs)==null?void 0:pe.description}}};var ge,ue,ce,xe,he;E.parameters={...E.parameters,docs:{...(ge=E.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(ce=(ue=E.parameters)==null?void 0:ue.docs)==null?void 0:ce.source},description:{story:`While radio groups can be created without a label, it's recommended to always provide one for clarity and accessibility.
The label helps users understand what the options are for.

In certain cases when space is limited, the group label can be omitted.`,...(he=(xe=E.parameters)==null?void 0:xe.docs)==null?void 0:he.description}}};const At=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{_ as Direction,y as Disabled,L as DosAndDonts,E as GroupLabel,v as RadioButton,w as Size,f as Validation,At as __namedExportsOrder,Gt as default};
