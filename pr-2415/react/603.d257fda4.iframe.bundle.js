...
`)),card_linked_component_=function _(t){return t};function card_linked_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_linked_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_linked_component_GdsCardLinked=function(_withSizeXProps){function GdsCardLinked(){var _this;return(0,classCallCheck.A)(this,GdsCardLinked),_this=function card_linked_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_linked_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardLinked,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardLinked_instances),_this.title="",_this.excerpt="",_this.label="",(0,chunk_QU3DSPNU.VK)(_this,card_linked_component_Parts,{Header:function Header(){var Slot=null!==_this.querySelector('[slot="header"]'),Image=!!_this.src&&!Slot;return Image||Slot?(0,custom_element_scoping.qy)(card_linked_component_t||(card_linked_component_t=card_linked_component_`
      ...
      `),Image?(0,custom_element_scoping.qy)(card_linked_component_t2||(card_linked_component_t2=card_linked_component_`
              ...
              `),(0,if_defined.J)(_this.src)):(0,custom_element_scoping.qy)(card_linked_component_t3||(card_linked_component_t3=card_linked_component_`<slot name="header"></slot>`))):lit.s6},Article:function Article(){return _this.title||_this.excerpt?(0,custom_element_scoping.qy)(card_linked_component_t4||(card_linked_component_t4=card_linked_component_`
        <article class="article">
          ${0}
          ${0}
        </article>
      `),_this.title&&(0,custom_element_scoping.qy)(card_linked_component_t5||(card_linked_component_t5=card_linked_component_`
            <h2 class="title">
              <gds-text font="heading-s">${0}</gds-text>
            </h2>
          `),_this.title),_this.excerpt&&(0,custom_element_scoping.qy)(card_linked_component_t6||(card_linked_component_t6=card_linked_component_`
            <div class="excerpt">
              <gds-text font="body-regular-m" lines="3"
                >${0}</gds-text
              >
            </div>
          `),_this.excerpt)):lit.s6},Footer:function Footer(){return null!==_this.querySelector('[slot="footer"]')||_this.href?(0,custom_element_scoping.qy)(card_linked_component_t7||(card_linked_component_t7=card_linked_component_`
      ...
      `),_this.label):lit.s6},Main:function Main(parts){return(0,custom_element_scoping.qy)(card_linked_component_t8||(card_linked_component_t8=card_linked_component_`
      <main class="main">${0}</main>
    `),parts)},Core:function Core(){var _privateGet=(0,chunk_QU3DSPNU.S7)(_this,card_linked_component_Parts),Header=_privateGet.Header,Article=_privateGet.Article,Footer=_privateGet.Footer,Main=_privateGet.Main;return[Header(),Main([Article(),Footer()])]}}),_this}return(0,inherits.A)(GdsCardLinked,_withSizeXProps),(0,createClass.A)(GdsCardLinked,[{key:"render",value:function render(){return(0,custom_element_scoping.qy)(card_linked_component_t9||(card_linked_component_t9=card_linked_component_`
      <a
        href=${0}
        target=${0}
        rel=${0}
...
//# sourceMappingURL=603.d257fda4.iframe.bundle.js.map