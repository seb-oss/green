...
`)),card_interactive_component_=function _(t){return t};function card_interactive_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_interactive_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_interactive_component_GdsCardInteractive=function(_GdsElement){function GdsCardInteractive(){var _this;return(0,classCallCheck.A)(this,GdsCardInteractive),_this=function card_interactive_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_interactive_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardInteractive,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardInteractive_instances),_this.title="",_this.type="linked",_this.layout="contained",_this.media="landscape",(0,chunk_QU3DSPNU.VK)(_this,_Variants,{Linked:{Wrapper:function Wrapper(content){return(0,custom_element_scoping.qy)(card_interactive_component_t||(card_interactive_component_t=card_interactive_component_`
      ...
      `),(0,if_defined.J)(_this.href),(0,if_defined.J)(_this.target),(0,if_defined.J)(_this.rel||(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,defaultRel_get)),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,classes_get)),content)},Content:function Content(){return(0,custom_element_scoping.qy)(card_interactive_component_t2||(card_interactive_component_t2=card_interactive_component_`${0}`),(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,contentParts_get))}},Standard:{Content:function Content(){return(0,custom_element_scoping.qy)(card_interactive_component_t3||(card_interactive_component_t3=card_interactive_component_`<div class=${0}>
          ${0}
        </div> `),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,classes_get)),(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,contentParts_get))}}}),(0,chunk_QU3DSPNU.VK)(_this,_Parts,{Header:function Header(){var hasHeaderContent=null!==_this.querySelector('[slot="header"]');return(0,custom_element_scoping.qy)(_t4||(_t4=card_interactive_component_`
        <header class="header">
          ${0}
      ...
      `),(0,when.z)(_this.src&&!hasHeaderContent,(function(){return(0,custom_element_scoping.qy)(_t5||(_t5=card_interactive_component_`
              <img
                ...
                height="100%"
              ></img>
            `),(0,if_defined.J)(_this.src))})))},Footer:function Footer(){var footerContent=[],hasFooterContent=null!==_this.querySelector('[slot="footer"]');return"linked"===_this.type&&_this.prompt&&footerContent.push((0,custom_element_scoping.qy)(_t6||(_t6=card_interactive_component_`
...
//# sourceMappingURL=970.8e66336a.iframe.bundle.js.map