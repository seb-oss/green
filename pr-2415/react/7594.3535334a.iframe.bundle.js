...
`)),card_dynamic_component_=function _(t){return t};function card_dynamic_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_dynamic_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_dynamic_component_GdsCardDynamic=function(_withSizeXProps){function GdsCardDynamic(){var _this;return(0,classCallCheck.A)(this,GdsCardDynamic),_this=function card_dynamic_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_dynamic_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardDynamic,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardDynamic_instances),(0,chunk_QU3DSPNU.VK)(_this,_Compose,createComposer(_this)),_this.rank="neutral",_this.title="",_this.excerpt="",_this.label="",(0,chunk_QU3DSPNU.VK)(_this,_Parts,{Root:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({className:function className(){return(0,chunk_QU3DSPNU.S7)(_this,_GdsCardDynamic_instances,classes_get)},parts:{Header:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({slot:"header",wrap:!0,conditions:{Image:function Image(){return!!_this.src}},templates:{Image:function Image(){return(0,custom_element_scoping.qy)(card_dynamic_component_t||(card_dynamic_component_t=card_dynamic_component_`
            ...
            `),(0,if_defined.J)(_this.src))}}}),Main:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({wrap:!0,parts:{Article:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({wrap:!0,conditions:{Title:function Title(){return!!_this.title},Excerpt:function Excerpt(){return!!_this.excerpt}},templates:{Title:function Title(){return(0,custom_element_scoping.qy)(card_dynamic_component_t2||(card_dynamic_component_t2=card_dynamic_component_`
                ...
                `),_this.excerpt)}}}),Footer:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({slot:"footer",wrap:!0,conditions:{Label:function Label(){return!!_this.label}},templates:{Label:function Label(){return(0,custom_element_scoping.qy)(card_dynamic_component_t4||(card_dynamic_component_t4=card_dynamic_component_`
                  <gds-link href=${0}>
...
//# sourceMappingURL=7594.3535334a.iframe.bundle.js.map