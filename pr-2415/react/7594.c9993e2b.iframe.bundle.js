...
`)),breadcrumbs_component_=function _(t){return t};function breadcrumbs_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(breadcrumbs_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var breadcrumbs_component_GdsBreadcrumbs=function(_withLayoutChildProps){function GdsBreadcrumbs(){var _this;return(0,classCallCheck.A)(this,GdsBreadcrumbs),(_this=function breadcrumbs_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,breadcrumbs_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsBreadcrumbs,arguments)).size="large",_this.label=(0,lit_localize.ab)("Breadcrumbs"),_this}return(0,inherits.A)(GdsBreadcrumbs,_withLayoutChildProps),(0,createClass.A)(GdsBreadcrumbs,[{key:"breadcrumbItems",get:function get(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumb]"))}},{key:"handleSlotChange",value:function handleSlotChange(){var items=this.breadcrumbItems;items.forEach((function(item,index){index===items.length-2?item.setAttribute("return",""):item.removeAttribute("return")}))}},{key:"render",value:function render(){return(0,custom_element_scoping.qy)(breadcrumbs_component_t||(breadcrumbs_component_t=breadcrumbs_component_`
    ...
    `),this.label,(0,class_map.H)({"size-small":"small"===this.size}),this.handleSlotChange)}}])}((0,declarative_layout_mixins.lt)((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)(gds_element.j))));breadcrumbs_component_GdsBreadcrumbs.styles=[tokens_style.LU,breadcrumbs_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:String})],breadcrumbs_component_GdsBreadcrumbs.prototype,"size",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:String})],breadcrumbs_component_GdsBreadcrumbs.prototype,"label",2),breadcrumbs_component_GdsBreadcrumbs=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-breadcrumbs",{dependsOn:[chevron_left_component.g]}),(0,lit_localize.cc)()],breadcrumbs_component_GdsBreadcrumbs);var GdsBreadcrumbs=function GdsBreadcrumbs(props){breadcrumbs_component_GdsBreadcrumbs.define();var JSXElement=(0,react.p)("gds-breadcrumbs"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsBreadcrumbs.__docgenInfo={description:"",methods:[],displayName:"GdsBreadcrumbs"};var button_component=__webpack_require__("./dist/libs/core/src/components/button/button.component.js"),GdsButton=function GdsButton(props){button_component.t.define();var JSXElement=(0,react.p)("gds-button"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsButton.__docgenInfo={description:"",methods:[],displayName:"GdsButton"};var calendar_component=__webpack_require__("./dist/libs/core/src/components/calendar/calendar.component.js"),GdsCalendar=function GdsCalendar(props){calendar_component.x.define();var JSXElement=(0,react.p)("gds-calendar"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCalendar.__docgenInfo={description:"",methods:[],displayName:"GdsCalendar"};var card_component=__webpack_require__("./dist/libs/core/src/components/card/card.component.js"),GdsCard=function GdsCard(props){card_component.z.define();var JSXElement=(0,react.p)("gds-card"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCard.__docgenInfo={description:"",methods:[],displayName:"GdsCard"};var part_composer_t,_t2,_t3,_t4,defineProperty=__webpack_require__("./node_modules/@babel/runtime/helpers/esm/defineProperty.js"),if_defined=__webpack_require__("./node_modules/lit/directives/if-defined.js"),slicedToArray=__webpack_require__("./node_modules/@babel/runtime/helpers/esm/slicedToArray.js"),strip_white_space=__webpack_require__("./dist/libs/core/src/utils/helpers/strip-white-space.js"),_2=function _2(t){return t},strippedHTML=(0,strip_white_space.C)(lit.qy),isValidContent=function isValidContent(content){return content!==lit.s6&&null!=content},createComposer=function createComposer(host){var wrapContent=function wrapContent(content,config,name){if(config.wrapper)return config.wrapper(content);if(config.className||config.wrap){console.log("Classes:",config.className);var classes=Object.assign({},"function"==typeof config.className?config.className():config.className||{},config.wrap?(0,defineProperty.A)({},"part-".concat(name.toLowerCase()),!0):{});return strippedHTML(part_composer_t||(part_composer_t=_2`<div class=${0}>${0}</div>`),(0,class_map.H)(classes),content)}return content},createPart=function createPart(config){var name=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"root";return{config,render:function render(){if(config.parts){var renderedParts=Object.entries(config.parts).map((function(_ref2){var _ref3=(0,slicedToArray.A)(_ref2,2),childName=_ref3[0],childPart=_ref3[1];return createPart(childPart.config,childName).render()})).filter(isValidContent);if(renderedParts.length)return wrapContent(strippedHTML(_t2||(_t2=_2`${0}`),renderedParts),config,name)}if(config.slot&&host.querySelector('[slot="'.concat(config.slot,'"]'))){var content=strippedHTML(_t3||(_t3=_2`<slot name="${0}"></slot>`),config.slot);return wrapContent(content,config,name)}if(config.conditions&&config.templates){var validContent=Object.entries(config.conditions).filter((function(_ref4){var _ref5=(0,slicedToArray.A)(_ref4,2);_ref5[0];return(0,_ref5[1])()})).map((function(_ref6){var _config$templates,_config$templates$key,key=(0,slicedToArray.A)(_ref6,1)[0];return null==(_config$templates=config.templates)||null==(_config$templates$key=_config$templates[key])?void 0:_config$templates$key.call(_config$templates)})).filter(isValidContent);if(validContent.length)return wrapContent(strippedHTML(_t4||(_t4=_2`${0}`),validContent),config,name)}return lit.s6}}};return{Part:function Part(config){return createPart(config)}}},flex_component=__webpack_require__("./dist/libs/core/src/components/flex/flex.component.js"),chain_link_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chain-link.component.js");chain_link_component.l.define();var img_styles_t,img_component_t,style_expression_property=__webpack_require__("./dist/libs/core/src/utils/decorators/style-expression-property.js"),img_styles_default=(0,lit.AH)(img_styles_t||(img_styles_t=(function _(t){return t})`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
`)),card_dynamic_component_=function _(t){return t};function card_dynamic_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_dynamic_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_dynamic_component_GdsCardDynamic=function(_withSizeXProps){function GdsCardDynamic(){var _this;return(0,classCallCheck.A)(this,GdsCardDynamic),_this=function card_dynamic_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_dynamic_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardDynamic,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardDynamic_instances),(0,chunk_QU3DSPNU.VK)(_this,_Compose,createComposer(_this)),_this.rank="neutral",_this.title="",_this.excerpt="",_this.label="",_this.media="landscape",(0,chunk_QU3DSPNU.VK)(_this,_Parts,{Root:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({className:function className(){return(0,chunk_QU3DSPNU.S7)(_this,_GdsCardDynamic_instances,classes_get)},parts:{Header:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({slot:"header",wrap:!0,conditions:{Image:function Image(){return!!_this.src}},templates:{Image:function Image(){return(0,custom_element_scoping.qy)(card_dynamic_component_t||(card_dynamic_component_t=card_dynamic_component_`
              <gds-img
                src=${0}
                width="100%"
                height="100%"
                ...
                aspect-ratio=${0}
              ></gds-img>
            `),(0,if_defined.J)(_this.src),"square"===_this.media?"1/1":"16/9")}}}),Main:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({wrap:!0,parts:{Article:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({wrap:!0,conditions:{Title:function Title(){return!!_this.title},Excerpt:function Excerpt(){return!!_this.excerpt}},templates:{Title:function Title(){return(0,custom_element_scoping.qy)(card_dynamic_component_t2||(card_dynamic_component_t2=card_dynamic_component_`
                  <gds-text tag="h2" font="heading-s"> ${0} </gds-text>
                `),_this.title)},Excerpt:function Excerpt(){return(0,custom_element_scoping.qy)(card_dynamic_component_t3||(card_dynamic_component_t3=card_dynamic_component_`
                  <gds-text tag="p" lines="3" font="body-regular-m">
                    ${0}
                  </gds-text>
                `),_this.excerpt)}}}),Footer:(0,chunk_QU3DSPNU.S7)(_this,_Compose).Part({slot:"footer",wrap:!0,conditions:{Link:function Link(){return!!_this.label&&!!_this.href}},templates:{Link:function Link(){return(0,custom_element_scoping.qy)(card_dynamic_component_t4||(card_dynamic_component_t4=card_dynamic_component_`
                  <gds-link href=${0}>
                    <gds-icon-chain-link slot="lead"></gds-icon-chain-link>
                    ${0}
                  </gds-link>
                `),(0,if_defined.J)(_this.href),_this.label)}}})}})}})}),_this}return(0,inherits.A)(GdsCardDynamic,_withSizeXProps),(0,createClass.A)(GdsCardDynamic,[{key:"render",value:function render(){return(0,chunk_QU3DSPNU.S7)(this,_Parts).Root.render()}}])}((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(gds_element.j))));_Compose=new WeakMap,_GdsCardDynamic_instances=new WeakSet,classes_get=function classes_get(){return(0,defineProperty.A)((0,defineProperty.A)({card:!0,"card-dynamic":!0},"rank-".concat(this.rank),!0),"media-".concat(this.media),!0)},_Parts=new WeakMap,card_dynamic_component_GdsCardDynamic.styles=[tokens_style.LU,card_dynamic_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!0})],card_dynamic_component_GdsCardDynamic.prototype,"rank",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"title",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"excerpt",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"label",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"href",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"target",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"rel",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"src",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],card_dynamic_component_GdsCardDynamic.prototype,"media",2),card_dynamic_component_GdsCardDynamic=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-card-dynamic",{dependsOn:[card_component.z,img_component_GdsImg,text_component_GdsText,flex_component.o,chain_link_component.l]})],card_dynamic_component_GdsCardDynamic);var GdsCardDynamic=function GdsCardDynamic(props){card_dynamic_component_GdsCardDynamic.define();var JSXElement=(0,react.p)("gds-card-dynamic"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCardDynamic.__docgenInfo={description:"",methods:[],displayName:"GdsCardDynamic"};var card_interactive_styles_t,card_interactive_component_t,card_interactive_component_t2,card_interactive_component_t3,card_interactive_component_t4,_t5,_t6,_t7,_t8,_t9,_t10,_t11,_t12,_GdsCardInteractive_instances,defaultRel_get,card_interactive_component_classes_get,contentParts_get,_Variants,card_interactive_component_Parts,when=__webpack_require__("./node_modules/lit-html/directives/when.js"),card_interactive_styles_default=(0,lit.AH)(card_interactive_styles_t||(card_interactive_styles_t=(function _(t){return t})`
  @layer base, types, layout, motion;
  @layer base {
    :host {
      display: inline-block;
...
`)),card_interactive_component_=function _(t){return t};function card_interactive_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_interactive_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_interactive_component_GdsCardInteractive=function(_GdsElement){function GdsCardInteractive(){var _this;return(0,classCallCheck.A)(this,GdsCardInteractive),_this=function card_interactive_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_interactive_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardInteractive,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardInteractive_instances),_this.title="",_this.type="linked",_this.layout="contained",_this.media="landscape",(0,chunk_QU3DSPNU.VK)(_this,_Variants,{Linked:{Wrapper:function Wrapper(content){return(0,custom_element_scoping.qy)(card_interactive_component_t||(card_interactive_component_t=card_interactive_component_`
        <a
          href=${0}
          target=${0}
          rel=${0}
      ...
      `),(0,if_defined.J)(_this.href),(0,if_defined.J)(_this.target),(0,if_defined.J)(_this.rel||(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,defaultRel_get)),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,card_interactive_component_classes_get)),content)},Content:function Content(){var _privateGet=(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,contentParts_get),_privateGet2=(0,slicedToArray.A)(_privateGet,3),header=_privateGet2[0],main=_privateGet2[1],footer=_privateGet2[2];return(0,custom_element_scoping.qy)(card_interactive_component_t2||(card_interactive_component_t2=card_interactive_component_`
          ${0}
          <div class="content">${0} ${0}</div>
        `),header,main,footer)}},Standard:{Content:function Content(){var _privateGet3=(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,contentParts_get),_privateGet4=(0,slicedToArray.A)(_privateGet3,3),header=_privateGet4[0],main=_privateGet4[1],footer=_privateGet4[2];return(0,custom_element_scoping.qy)(card_interactive_component_t3||(card_interactive_component_t3=card_interactive_component_`
          <div class=${0}>
            ${0}
            <div class="content">${0} ${0}</div>
          </div>
        `),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,card_interactive_component_classes_get)),header,main,footer)}}}),(0,chunk_QU3DSPNU.VK)(_this,card_interactive_component_Parts,{Header:function Header(){var hasHeaderContent=null!==_this.querySelector('[slot="header"]');return _this.src||hasHeaderContent?(0,custom_element_scoping.qy)(card_interactive_component_t4||(card_interactive_component_t4=card_interactive_component_`
        <header class="header">
          ${0}
          <slot name="header"></slot>
        </header>
      `),(0,when.z)(_this.src&&!hasHeaderContent,(function(){return(0,custom_element_scoping.qy)(_t5||(_t5=card_interactive_component_`
              <gds-img
                src=${0}
                object-fit="cover"
                object-position="center"
                ...
                height="100%"
              ></gds-img>
            `),(0,if_defined.J)(_this.src))}))):lit.s6},Footer:function Footer(){var footerContent=[],hasFooterContent=null!==_this.querySelector('[slot="footer"]');return"linked"===_this.type&&!_this.href||!_this.prompt&&!hasFooterContent?lit.s6:("linked"===_this.type&&_this.prompt&&footerContent.push((0,custom_element_scoping.qy)(_t6||(_t6=card_interactive_component_`
        ...
        `),_this.prompt)),"dynamic"===_this.type&&_this.prompt&&!hasFooterContent&&footerContent.push((0,custom_element_scoping.qy)(_t7||(_t7=card_interactive_component_`
          <a
            href=${0}
            target=${0}
            rel=${0}
          ...
          >
            <gds-icon-chain-link></gds-icon-chain-link>
            <gds-text class="prompt">${0}</gds-text>
          </a>
        `),(0,if_defined.J)(_this.href),(0,if_defined.J)(_this.target),(0,if_defined.J)(_this.rel||(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,defaultRel_get)),_this.prompt)),"dynamic"===_this.type&&hasFooterContent?footerContent.push((0,custom_element_scoping.qy)(_t8||(_t8=card_interactive_component_`<slot name="footer"></slot>`))):footerContent.push((0,custom_element_scoping.qy)(_t9||(_t9=card_interactive_component_`<slot name="footer"></slot>`))),(0,custom_element_scoping.qy)(_t10||(_t10=card_interactive_component_`<footer class="footer">${0}</footer>`),footerContent))},Main:function Main(){return(0,custom_element_scoping.qy)(_t11||(_t11=card_interactive_component_`
      <main class="main">
        <gds-text font="heading-s">${0}</gds-text>
        ${0}
        <slot></slot>
      </main>
    `),_this.title,(0,when.z)(_this.excerpt,(function(){return(0,custom_element_scoping.qy)(_t12||(_t12=card_interactive_component_`
            <gds-text font="body-regular-m" lines="3">${0}</gds-text>
          `),_this.excerpt)})))}}),_this}return(0,inherits.A)(GdsCardInteractive,_GdsElement),(0,createClass.A)(GdsCardInteractive,[{key:"render",value:function render(){if("linked"==this.type){var content=(0,chunk_QU3DSPNU.S7)(this,_Variants).Linked.Content();return(0,chunk_QU3DSPNU.S7)(this,_Variants).Linked.Wrapper(content)}return(0,chunk_QU3DSPNU.S7)(this,_Variants).Standard.Content()}}])}(gds_element.j);_GdsCardInteractive_instances=new WeakSet,defaultRel_get=function defaultRel_get(){return"_blank"===this.target?"noreferrer noopener":void 0},card_interactive_component_classes_get=function classes_get(){return(0,defineProperty.A)((0,defineProperty.A)((0,defineProperty.A)((0,defineProperty.A)({card:!0},"type-".concat(this.type),!0),"layout-".concat(this.layout),!0),"media",!!this.src),"media-".concat(this.media),!0)},contentParts_get=function contentParts_get(){return[(0,chunk_QU3DSPNU.S7)(this,card_interactive_component_Parts).Header(),(0,chunk_QU3DSPNU.S7)(this,card_interactive_component_Parts).Main(),(0,chunk_QU3DSPNU.S7)(this,card_interactive_component_Parts).Footer()]},_Variants=new WeakMap,card_interactive_component_Parts=new WeakMap,card_interactive_component_GdsCardInteractive.styles=[tokens_style.LU,card_interactive_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"title",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"excerpt",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"prompt",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"type",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"layout",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"media",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"src",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"href",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"target",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_interactive_component_GdsCardInteractive.prototype,"rel",2),card_interactive_component_GdsCardInteractive=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-card-interactive",{dependsOn:[card_component.z,img_component_GdsImg,text_component_GdsText,flex_component.o,chain_link_component.l]})],card_interactive_component_GdsCardInteractive);var GdsCardInteractive=function GdsCardInteractive(props){card_interactive_component_GdsCardInteractive.define();var JSXElement=(0,react.p)("gds-card-interactive"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCardInteractive.__docgenInfo={description:"",methods:[],displayName:"GdsCardInteractive"};var card_linked_styles_t,card_linked_component_t,card_linked_component_t2,card_linked_component_t3,card_linked_component_t4,card_linked_component_t5,card_linked_component_t6,card_linked_component_t7,card_linked_component_t8,card_linked_component_t9,card_linked_component_t10,card_linked_component_t11,_GdsCardLinked_instances,card_linked_component_defaultRel_get,card_linked_component_classes_get,slot_get,render_get,card_linked_component_Parts,card_linked_styles_default=(0,lit.AH)(card_linked_styles_t||(card_linked_styles_t=(function _(t){return t})`
  @layer base, types, layout, motion;
  @layer base {
    :host {
      display: inline-block;
...
`)),card_linked_component_=function _(t){return t};function card_linked_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_linked_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_linked_component_GdsCardLinked=function(_withSizeXProps){function GdsCardLinked(){var _this;return(0,classCallCheck.A)(this,GdsCardLinked),_this=function card_linked_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_linked_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardLinked,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardLinked_instances),_this.title="",_this.excerpt="",_this.label="",(0,chunk_QU3DSPNU.VK)(_this,card_linked_component_Parts,{Header:{Image:function Image(){return(0,custom_element_scoping.qy)(card_linked_component_t||(card_linked_component_t=card_linked_component_`
        <gds-img
          src=${0}
          width="100%"
          height="100%"
          ...
          border-radius="xs"
        ></gds-img>
      `),(0,if_defined.J)(_this.src))},Slot:function Slot(){return(0,chunk_QU3DSPNU.S7)(_this,_GdsCardLinked_instances,slot_get).call(_this,"header")&&(0,custom_element_scoping.qy)(card_linked_component_t2||(card_linked_component_t2=card_linked_component_`<slot name="header"></slot>`))},Element:function Element(content){return(0,custom_element_scoping.qy)(card_linked_component_t3||(card_linked_component_t3=card_linked_component_`
        <header class="header">${0}</header>
      `),content)},render:function render(){var _privateGet$Header=(0,chunk_QU3DSPNU.S7)(_this,card_linked_component_Parts).Header,Image=_privateGet$Header.Image,Slot=_privateGet$Header.Slot,Element=_privateGet$Header.Element;return Slot()?Element(Slot()):_this.src?Element(Image()):lit.s6}},Article:{Title:function Title(){return _this.title&&(0,custom_element_scoping.qy)(card_linked_component_t4||(card_linked_component_t4=card_linked_component_` <gds-text tag="h2" font="heading-s">${0}</gds-text> `),_this.title)},Excerpt:function Excerpt(){return _this.excerpt&&(0,custom_element_scoping.qy)(card_linked_component_t5||(card_linked_component_t5=card_linked_component_`
          <gds-text font="body-regular-m" lines="3">${0}</gds-text>
        `),_this.excerpt)},Element:function Element(content){return(0,custom_element_scoping.qy)(card_linked_component_t6||(card_linked_component_t6=card_linked_component_`
        <article class="article">${0}</article>
      `),content)},render:function render(){var _privateGet$Article=(0,chunk_QU3DSPNU.S7)(_this,card_linked_component_Parts).Article,Title=_privateGet$Article.Title,Excerpt=_privateGet$Article.Excerpt,Element=_privateGet$Article.Element;return _this.title||_this.excerpt?Element([Title(),Excerpt()]):lit.s6}},Footer:{Link:function Link(){return _this.label&&(0,custom_element_scoping.qy)(card_linked_component_t7||(card_linked_component_t7=card_linked_component_`
          <gds-link href="#">
            <gds-icon-chain-link slot="lead"></gds-icon-chain-link>
            ${0}
          </gds-link>
        `),_this.label)},Slot:function Slot(){return(0,chunk_QU3DSPNU.S7)(_this,_GdsCardLinked_instances,slot_get).call(_this,"footer")&&(0,custom_element_scoping.qy)(card_linked_component_t8||(card_linked_component_t8=card_linked_component_`<slot name="footer"></slot>`))},Element:function Element(content){return(0,custom_element_scoping.qy)(card_linked_component_t9||(card_linked_component_t9=card_linked_component_`
        <footer class="footer" inert>${0}</footer>
      `),content)},render:function render(){var _privateGet$Footer=(0,chunk_QU3DSPNU.S7)(_this,card_linked_component_Parts).Footer,Link=_privateGet$Footer.Link,Slot=_privateGet$Footer.Slot,Element=_privateGet$Footer.Element,content=[Link(),Slot()].filter(Boolean);return content.length?Element(content):lit.s6}},Main:function Main(parts){return(0,custom_element_scoping.qy)(card_linked_component_t10||(card_linked_component_t10=card_linked_component_`
      <main class="main">${0}</main>
    `),parts)},Core:function Core(){var _privateGet=(0,chunk_QU3DSPNU.S7)(_this,card_linked_component_Parts),Header=_privateGet.Header,Article=_privateGet.Article,Footer=_privateGet.Footer,Main=_privateGet.Main,_privateGet2=(0,chunk_QU3DSPNU.S7)(_this,_GdsCardLinked_instances,render_get),Single=_privateGet2.Single,Group=_privateGet2.Group;return[Single(Header),Main(Group([Article,Footer]))]}}),_this}return(0,inherits.A)(GdsCardLinked,_withSizeXProps),(0,createClass.A)(GdsCardLinked,[{key:"render",value:function render(){return this.href?(0,custom_element_scoping.qy)(card_linked_component_t11||(card_linked_component_t11=card_linked_component_`
      <a
        href=${0}
        target=${0}
        rel=${0}
    ...
    `),(0,if_defined.J)(this.href),(0,if_defined.J)(this.target),(0,if_defined.J)(this.rel||(0,chunk_QU3DSPNU.S7)(this,_GdsCardLinked_instances,card_linked_component_defaultRel_get)),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(this,_GdsCardLinked_instances,card_linked_component_classes_get)),(0,chunk_QU3DSPNU.S7)(this,card_linked_component_Parts).Core()):(0,chunk_QU3DSPNU.S7)(this,card_linked_component_Parts).Core()}}])}((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(gds_element.j))));_GdsCardLinked_instances=new WeakSet,card_linked_component_defaultRel_get=function defaultRel_get(){return"_blank"===this.target?"noreferrer noopener":void 0},card_linked_component_classes_get=function classes_get(){return{card:!0,"has-excerpt":!!this.excerpt}},slot_get=function slot_get(){var _this2=this;return function(slot){return null!==_this2.querySelector('[slot="'.concat(slot,'"]'))}},render_get=function render_get(){return{Single:function Single(part){return part.render()},Group:function Group(parts){return parts.map((function(part){return part.render()}))}}},card_linked_component_Parts=new WeakMap,card_linked_component_GdsCardLinked.styles=[tokens_style.LU,card_linked_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"title",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"excerpt",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"label",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"href",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"target",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"rel",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_linked_component_GdsCardLinked.prototype,"src",2),card_linked_component_GdsCardLinked=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-card-linked",{dependsOn:[card_component.z,img_component_GdsImg,text_component_GdsText,flex_component.o,chain_link_component.l]})],card_linked_component_GdsCardLinked);var GdsCardLinked=function GdsCardLinked(props){card_linked_component_GdsCardLinked.define();var JSXElement=(0,react.p)("gds-card-linked"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCardLinked.__docgenInfo={description:"",methods:[],displayName:"GdsCardLinked"};var toggle_control_base_styles_t,toggle_control_base_component_t,toggle_control_base_styles_default=(0,lit.AH)(toggle_control_base_styles_t||(toggle_control_base_styles_t=(function _(t){return t})`
  @layer base, a11y;
...
//# sourceMappingURL=7594.c9993e2b.iframe.bundle.js.map