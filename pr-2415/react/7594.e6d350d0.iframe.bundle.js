...
`)),card_dynamic_component_=function _(t){return t};function card_dynamic_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_dynamic_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_dynamic_component_GdsCardDynamic=function(_withSizeXProps){function GdsCardDynamic(){var _this;return(0,classCallCheck.A)(this,GdsCardDynamic),_this=function card_dynamic_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_dynamic_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardDynamic,arguments),(0,chunk_QU3DSPNU.VK)(_this,_compose,function createComposer(host){return{createPart:function createPart(config){return{render:function render(){var conditions=config.conditions,templates=config.templates,wrapper=config.wrapper;if(conditions&&templates){var validContent=Object.keys(conditions).filter((function(key){var _conditions$key;return null==(_conditions$key=conditions[key])?void 0:_conditions$key.call(conditions)})).map((function(key){var _templates$key;return null==(_templates$key=templates[key])?void 0:_templates$key.call(templates)})).filter(Boolean);if(validContent.length)return wrapper?wrapper((0,lit.qy)(part_composer_t||(part_composer_t=part_composer_`${0}`),validContent)):validContent}if(config.slot&&host.querySelector('[slot="'.concat(config.slot,'"]'))){var slotContent=(0,lit.qy)(_t2||(_t2=part_composer_`<slot name="${0}"></slot>`),config.slot);return wrapper?wrapper(slotContent):slotContent}return lit.s6}}},Core:function Core(parts){var rendered=Object.values(parts).map((function(part){return part.render()})).filter((function(content){return content!==lit.s6}));return rendered.length?(0,lit.qy)(_t3||(_t3=part_composer_`${0}`),rendered):lit.s6}}}(_this)),_this.title="",_this.excerpt="",_this.label="",(0,chunk_QU3DSPNU.VK)(_this,_Parts,{Header:(0,chunk_QU3DSPNU.S7)(_this,_compose).createPart({slot:"header",conditions:{Image:function Image(){return!!_this.src}},templates:{Image:function Image(){return(0,custom_element_scoping.qy)(card_dynamic_component_t||(card_dynamic_component_t=card_dynamic_component_`
          <gds-img
            ...
            border-radius="xs"
          ></gds-img>
        `),(0,if_defined.J)(_this.src))}},wrapper:function wrapper(content){return(0,custom_element_scoping.qy)(card_dynamic_component_t2||(card_dynamic_component_t2=card_dynamic_component_`<header class="header">${0}</header>`),content)}}),Article:(0,chunk_QU3DSPNU.S7)(_this,_compose).createPart({conditions:{Title:function Title(){return!!_this.title},Excerpt:function Excerpt(){return!!_this.excerpt}},templates:{Title:function Title(){return(0,custom_element_scoping.qy)(card_dynamic_component_t3||(card_dynamic_component_t3=card_dynamic_component_`<gds-text tag="h2" font="heading-s">${0}</gds-text>`),_this.title)},Excerpt:function Excerpt(){return(0,custom_element_scoping.qy)(_t4||(_t4=card_dynamic_component_`<gds-text font="body-regular-m" lines="3"
            >${0}</gds-text
          >`),_this.excerpt)}},wrapper:function wrapper(content){return(0,custom_element_scoping.qy)(_t5||(_t5=card_dynamic_component_`
        <article class="article">${0}</article>
      `),content)}}),Footer:(0,chunk_QU3DSPNU.S7)(_this,_compose).createPart({slot:"footer",conditions:{Label:function Label(){return!!_this.label}},templates:{Label:function Label(){return(0,custom_element_scoping.qy)(_t6||(_t6=card_dynamic_component_`
        ...
        `),_this.label)}}})}),_this}return(0,inherits.A)(GdsCardDynamic,_withSizeXProps),(0,createClass.A)(GdsCardDynamic,[{key:"render",value:function render(){var content=(0,chunk_QU3DSPNU.S7)(this,_compose).Core((0,chunk_QU3DSPNU.S7)(this,_Parts));return content===lit.s6?lit.s6:(0,custom_element_scoping.qy)(_t7||(_t7=card_dynamic_component_`
      <a href=${0} target=${0}>
        ${0}
      </a>
    `),(0,if_defined.J)(this.href),(0,if_defined.J)(this.target),content)}}])}((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(gds_element.j))));_compose=new WeakMap,_Parts=new WeakMap,card_dynamic_component_GdsCardDynamic.styles=[tokens_style.LU,card_dynamic_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"title",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"excerpt",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"label",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"href",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"target",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"rel",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],card_dynamic_component_GdsCardDynamic.prototype,"src",2),card_dynamic_component_GdsCardDynamic=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-card-dynamic",{dependsOn:[card_component.z,img_component_GdsImg,text_component_GdsText,flex_component.o,chain_link_component.l]})],card_dynamic_component_GdsCardDynamic);var GdsCardDynamic=function GdsCardDynamic(props){card_dynamic_component_GdsCardDynamic.define();var JSXElement=(0,react.p)("gds-card-dynamic"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsCardDynamic.__docgenInfo={description:"",methods:[],displayName:"GdsCardDynamic"};var card_interactive_styles_t,card_interactive_component_t,card_interactive_component_t2,card_interactive_component_t3,card_interactive_component_t4,card_interactive_component_t5,card_interactive_component_t6,card_interactive_component_t7,_t8,_t9,_t10,_t11,_t12,_GdsCardInteractive_instances,defaultRel_get,classes_get,contentParts_get,_Variants,card_interactive_component_Parts,defineProperty=__webpack_require__("./node_modules/@babel/runtime/helpers/esm/defineProperty.js"),slicedToArray=__webpack_require__("./node_modules/@babel/runtime/helpers/esm/slicedToArray.js"),when=__webpack_require__("./node_modules/lit-html/directives/when.js"),card_interactive_styles_default=(0,lit.AH)(card_interactive_styles_t||(card_interactive_styles_t=(function _(t){return t})`
  @layer base, types, layout, motion;
  @layer base {
    :host {
      display: inline-block;
...
`)),card_interactive_component_=function _(t){return t};function card_interactive_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(card_interactive_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var card_interactive_component_GdsCardInteractive=function(_GdsElement){function GdsCardInteractive(){var _this;return(0,classCallCheck.A)(this,GdsCardInteractive),_this=function card_interactive_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,card_interactive_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCardInteractive,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsCardInteractive_instances),_this.title="",_this.type="linked",_this.layout="contained",_this.media="landscape",(0,chunk_QU3DSPNU.VK)(_this,_Variants,{Linked:{Wrapper:function Wrapper(content){return(0,custom_element_scoping.qy)(card_interactive_component_t||(card_interactive_component_t=card_interactive_component_`
      ...
      `),(0,if_defined.J)(_this.href),(0,if_defined.J)(_this.target),(0,if_defined.J)(_this.rel||(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,defaultRel_get)),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,classes_get)),content)},Content:function Content(){var _privateGet=(0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,contentParts_get),_privateGet2=(0,slicedToArray.A)(_privateGet,3),header=_privateGet2[0],main=_privateGet2[1],footer=_privateGet2[2];return(0,custom_element_scoping.qy)(card_interactive_component_t2||(card_interactive_component_t2=card_interactive_component_`
          ${0}
        ...
        `),(0,class_map.H)((0,chunk_QU3DSPNU.S7)(_this,_GdsCardInteractive_instances,classes_get)),header,main,footer)}}}),(0,chunk_QU3DSPNU.VK)(_this,card_interactive_component_Parts,{Header:function Header(){var hasHeaderContent=null!==_this.querySelector('[slot="header"]');return _this.src||hasHeaderContent?(0,custom_element_scoping.qy)(card_interactive_component_t4||(card_interactive_component_t4=card_interactive_component_`
        <header class="header">
          ${0}
          <slot name="header"></slot>
        </header>
      `),(0,when.z)(_this.src&&!hasHeaderContent,(function(){return(0,custom_element_scoping.qy)(card_interactive_component_t5||(card_interactive_component_t5=card_interactive_component_`
              <gds-img
                src=${0}
                object-fit="cover"
                object-position="center"
                ...
                height="100%"
              ></gds-img>
            `),(0,if_defined.J)(_this.src))}))):lit.s6},Footer:function Footer(){var footerContent=[],hasFooterContent=null!==_this.querySelector('[slot="footer"]');return"linked"===_this.type&&!_this.href||!_this.prompt&&!hasFooterContent?lit.s6:("linked"===_this.type&&_this.prompt&&footerContent.push((0,custom_element_scoping.qy)(card_interactive_component_t6||(card_interactive_component_t6=card_interactive_component_`
        ...
        `),_this.prompt)),"dynamic"===_this.type&&_this.prompt&&!hasFooterContent&&footerContent.push((0,custom_element_scoping.qy)(card_interactive_component_t7||(card_interactive_component_t7=card_interactive_component_`
          <a
            href=${0}
            target=${0}
            rel=${0}
...
//# sourceMappingURL=7594.e6d350d0.iframe.bundle.js.map