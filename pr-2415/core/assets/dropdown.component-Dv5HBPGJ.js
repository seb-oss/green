import{m as $,s as pe,l as de}from"./runtime-CNluP0A8.js";import{i as Q,E as ce}from"./lit-element-Bx14lxc-.js";import{n}from"./Reflect-DJ7r0WLU.js";import{a as X}from"./query-p8xgzTDt.js";import{r as ue}from"./query-async-MEroNOeJ.js";import{o as ge}from"./if-defined-CVqwUuaf.js";import{o as fe}from"./unsafe-html-CYO4avEf.js";import{n as u}from"./when-BR7zwNJC.js";import{o as me,f as ve}from"./floating-ui.dom-BmFOYU71.js";import{f as be,G as ye}from"./form-control-host.style-CFUqb7hn.js";import{G as _e,a as xe}from"./form-control-header.component-Dx3cb-yD.js";import{n as we,e as $e}from"./ref-R0wBYijq.js";import{h as c,g as q,G as Z}from"./gds-element-DTROifYq.js";import{a as Ce,T as j}from"./transitional-styles-BfqUw7Aj.js";import{s as Ee,F as ke,L as Se,u as Me}from"./unwrap-slots-CufDiWNZ.js";import{w as W}from"./watch-tFciLXSI.js";import{I as ee}from"./checkmark.component-BsK1aQGf.js";import{c as Te}from"./rbcb-toggle.template-DqXF-ZkM.js";import{t as te}from"./tokens.style-CJKwYBen.js";import{o as We}from"./observe-light-dom-CmJPHUQ4.js";import{a as Oe}from"./button.component-DJxD_RWV.js";import{I as Le}from"./chevron-bottom.component-BkwoUB-k.js";import{I as Ae}from"./cross-small.component-D5Wdub0G.js";import{G as se}from"./popover.component-CAPS34J0.js";const Pe=Q`
...
`;var De=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,ie=e=>{throw TypeError(e)},_=(e,t,s,r)=>{for(var i=r>1?void 0:r?Be(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(r?p(t,s,i):p(i))||i);return r&&i&&De(t,s,i),i},R=(e,t,s)=>t.has(e)||ie("Cannot "+s),K=(e,t,s)=>(R(e,t,"read from private field"),s?s.call(e):t.get(e)),N=(e,t,s)=>t.has(e)?ie("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Fe=(e,t,s,r)=>(R(e,t,"write to private field"),t.set(e,s),s),Y=(e,t,s)=>(R(e,t,"access private method"),s),x,k,A;let g=class extends ke(Z){constructor(){super(),N(this,k),N(this,x,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",Y(this,k,A)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),Y(this,k,A).call(this,e))})}get hidden(){return K(this,x)}set hidden(e){const t=e.toString();Fe(this,x,t==="true"),K(this,x)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),j.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){var t;const e=(t=this.parentElement)==null?void 0:t.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),c`<div class="item">
      ${u(e,()=>Te({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};x=new WeakMap;k=new WeakSet;A=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};g.styles=[te,Ce,Ee];_([n()],g.prototype,"value",2);_([n({type:Boolean,reflect:!0})],g.prototype,"hidden",1);_([n({attribute:"aria-selected",reflect:!0})],g.prototype,"selected",2);_([n({type:Boolean,reflect:!0})],g.prototype,"isPlaceholder",2);_([W("isPlaceholder")],g.prototype,"_handlePlaceholderStatusChange",1);g=_([q("gds-option",{dependsOn:[ee]})],g);var Ge=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,oe=e=>{throw TypeError(e)},O=(e,t,s,r)=>{for(var i=r>1?void 0:r?Ie(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(r?p(t,s,i):p(i))||i);return r&&i&&Ge(t,s,i),i},ze=(e,t,s)=>t.has(e)||oe("Cannot "+s),C=(e,t,s)=>(ze(e,t,"read from private field"),s?s.call(e):t.get(e)),J=(e,t,s)=>t.has(e)?oe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w,P;let v=class extends Z{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,J(this,w,$e()),J(this,P,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new Se(this)}get navigableItems(){return this.visibleOptionElements}get options(){return C(this,w).value?Me(C(this,w).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),j.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",C(this,P))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return c`<slot ${we(C(this,w))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};w=new WeakMap;P=new WeakMap;v.styles=Pe;O([n({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);O([n()],v.prototype,"compareWith",2);O([W("multiple")],v.prototype,"_rerenderOptions",1);v=O([q("gds-listbox",{dependsOn:[g]})],v);const He=Q`
  @layer base, reset;
