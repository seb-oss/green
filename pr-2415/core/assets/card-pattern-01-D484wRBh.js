import{o as c}from"./if-defined-CVqwUuaf.js";import{n}from"./when-BR7zwNJC.js";import{h as a,g as w,G as P}from"./gds-element-DTROifYq.js";import{t as G}from"./tokens.style-CA5ADGwW.js";import{w as k,b,d as L}from"./declarative-layout-mixins-DFPXvh_g.js";import{n as f}from"./Reflect-DJ7r0WLU.js";import{e as O}from"./class-map-CXsQwv0r.js";import{w as S,G as E}from"./img.component-CkVz56S0.js";import{w as F}from"./props-link-CDn2X3ta.js";import{G as I}from"./card-linked.component-BYXCmrtc.js";import{G as j}from"./card.component-DgPbllnK.js";import{G as z}from"./flex.component-DjV-SouM.js";import{I as M}from"./chain-link-C-k7husB.js";import{G as q}from"./text-BmaBdEcP.js";import{i as D}from"./lit-element-Bx14lxc-.js";var T=Object.defineProperty,p=(e,t,r,l)=>{for(var s=void 0,d=e.length-1,h;d>=0;d--)(h=e[d])&&(s=h(t,r,s)||s);return s&&T(t,r,s),s};function W(e){class t extends e{constructor(){super(...arguments),this.title="",this.excerpt="",this.label="",this.variant="neutral-01",this.outlined=!1,this.ratio="landscape"}classes(l){const s={card:!0,[`card-${l}`]:!!l,outlined:this.outlined,[`variant-${this.variant}`]:!0,[`ratio-${this.ratio}`]:!0};return O(s)}}return p([f({reflect:!1})],t.prototype,"title"),p([f({reflect:!1})],t.prototype,"excerpt"),p([f({reflect:!1})],t.prototype,"label"),p([f({reflect:!1})],t.prototype,"variant"),p([f({type:Boolean,reflect:!1})],t.prototype,"outlined"),p([f({reflect:!1,attribute:"aspect-ratio"})],t.prototype,"ratio"),t}const A=D`
  :host {
...
`;var B=Object.defineProperty,V=Object.getOwnPropertyDescriptor,v=e=>{throw TypeError(e)},X=(e,t,r,l)=>{for(var s=l>1?void 0:l?V(t,r):t,d=e.length-1,h;d>=0;d--)(h=e[d])&&(s=(l?h(t,r,s):h(s))||s);return l&&s&&B(t,r,s),s},H=(e,t,r)=>t.has(e)||v("Cannot "+r),J=(e,t,r)=>t.has(e)?v("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),o=(e,t,r)=>(H(e,t,"access private method"),r),i,u,m,$,_,y,C,x;let g=class extends k(b(L(F(S(W(P)))))){constructor(){super(...arguments),J(this,i)}render(){return n(this.href,()=>o(this,i,$).call(this),()=>o(this,i,y).call(this))}};i=new WeakSet;u=function(e=!1){return e&&this.label||this.querySelector('[slot="footer"]')};m=function(){switch(this.variant){case"neutral-02":return this.outlined?"secondary":"tertiary";case"neutral-01":default:return"primary"}};$=function(){return a`
    ...
    `};C=function(){return n(o(this,i,u).call(this),()=>a`
