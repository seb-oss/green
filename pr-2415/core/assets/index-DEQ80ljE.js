...
`;var Oe=Ie;let cs=class extends c{render(){return Y`<slot></slot>`}};cs.styles=[q,Oe];cs=r([R("gds-flex")],cs);const at=e=>{Ss.define();const s=N("gds-button"),t={...e,class:e.className};return O.createElement(s,t)},it=e=>{K.define();const s=N("gds-card"),t={...e,class:e.className};return O.createElement(s,t)},Ne=w`
  @layer defaults {
    a:link {
      color: currentColor;
