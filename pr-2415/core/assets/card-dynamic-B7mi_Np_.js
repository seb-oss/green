import{o as n}from"./if-defined-CVqwUuaf.js";import{h,g,G as w}from"./gds-element-DTROifYq.js";import{w as v,B as P,c as _}from"./props-card-DATtUvuf.js";import{t as u}from"./tokens.style-CyN6927s.js";import{w as C,a as x,b as G}from"./declarative-layout-mixins-DLWGR3wk.js";import{w as y,G as k}from"./img.component-BmDz7Qit.js";import{w as $}from"./link-CQz4l2c8.js";import{G as E}from"./card.component-Bj1-hO0L.js";import{G as I}from"./flex.component-DFHyXBrb.js";import{I as L}from"./chain-link-DK2clEwB.js";import{G as O}from"./text-B8Tp-ee7.js";var M=Object.defineProperty,T=Object.getOwnPropertyDescriptor,f=t=>{throw TypeError(t)},z=(t,s,e,o)=>{for(var r=o>1?void 0:o?T(s,e):s,d=t.length-1,c;d>=0;d--)(c=t[d])&&(r=(o?c(s,e,r):c(r))||r);return o&&r&&M(s,e,r),r},D=(t,s,e)=>s.has(t)||f("Cannot "+e),i=(t,s,e)=>(D(t,s,"read from private field"),e?e.call(t):s.get(t)),l=(t,s,e)=>s.has(t)?f("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,e),a,m;let p=class extends C(x(G($(y(v(w)))))){constructor(){super(...arguments),l(this,a,_(this)),l(this,m,{Root:i(this,a).Part({className:()=>this.classes("dynamic"),parts:{Header:i(this,a).Part({slot:"header",wrap:!0,conditions:{Image:()=>!!this.src},templates:{Image:()=>h`
              <gds-img
                src=${n(this.src)}
            ...
            `}}),Main:i(this,a).Part({wrap:!0,parts:{Article:i(this,a).Part({wrap:!0,conditions:{Title:()=>!!this.title,Excerpt:()=>!!this.excerpt},templates:{Title:()=>h`
                ...
                `}})}})}})})}render(){return i(this,m).Root.render()}};a=new WeakMap;m=new WeakMap;p.styles=[u,P];p=z([g("gds-card-dynamic",{dependsOn:[E,k,O,I,L]})],p);p.define();
