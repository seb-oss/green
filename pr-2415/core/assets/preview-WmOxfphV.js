...
import { ${b.name}${T.length>0?T.map(K=>`, ${K}`):""} } from '@sebgroup/green-core/react'`})))))},Le=()=>{const t=J("story"),e=t.story.title.replace("Components/","").trim().toLowerCase(),a=`https://seb.io/component/${t.story.componentId.replace("components-","").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"").replace(/-+/g,"-").replace(/^-|-$/g,"")}`;return i.createElement(Z,{designVersion:"2023"},i.createElement(be,{margin:"0 0 2xl 0","flex-direction":"column; s{row}","justify-content":"space-between","align-items":"flex-start; s{center}",padding:"l l l xl",gap:"l"},i.createElement(ue,{"align-items":"center",gap:"m"},i.createElement(me,{size:"xl"}),i.createElement(he,null,"View ",e," on seb.io")),i.createElement(pe,{href:a,target:"_blank",rel:"noopener noreferrer",rank:"secondary"},"Open documentation",i.createElement(ge,{slot:"trail"}))))};function D(t){const e={blockquote:"blockquote",em:"em",h2:"h2",p:"p",strong:"strong",...R(),...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(se,{isTemplate:!0}),`
`,n.jsx(te,{}),`
`,n.jsx(ae,{}),`
`,n.jsx(re,{}),`
`,n.jsx(Le,{}),`
