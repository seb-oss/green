...
`;var R=Object.defineProperty,q=Object.getOwnPropertyDescriptor,k=e=>{throw TypeError(e)},l=(e,s,a,t)=>{for(var r=t>1?void 0:t?q(s,a):s,m=e.length-1,o;m>=0;m--)(o=e[m])&&(r=(t?o(s,a,r):o(r))||r);return t&&r&&R(s,a,r),r},z=(e,s,a)=>s.has(e)||k("Cannot "+a),d=(e,s,a)=>(z(e,s,"read from private field"),a?a.call(e):s.get(e)),g=(e,s,a)=>s.has(e)?k("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,a),c,v,C,x;let i=class extends I(M(T(P))){constructor(){super(...arguments),g(this,v),g(this,c,F(this)),this.rank="neutral",this.title="",this.excerpt="",this.label="",g(this,x,{Root:d(this,c).Part({className:()=>d(this,v,C),parts:{Header:d(this,c).Part({slot:"header",wrap:!0,conditions:{Image:()=>!!this.src},templates:{Image:()=>u`
              <gds-img
                src=${w(this.src)}
                width="100%"
                height="100%"
