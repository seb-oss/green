...
`;var ke=Object.defineProperty,Ce=Object.getOwnPropertyDescriptor,Q=t=>{throw TypeError(t)},Le=(t,e,r,c)=>{for(var n=c>1?void 0:c?Ce(e,r):e,l=t.length-1,u;l>=0;l--)(u=t[l])&&(n=(c?u(e,r,n):u(n))||n);return c&&n&&ke(e,r,n),n},je=(t,e,r)=>e.has(t)||Q("Cannot "+r),Se=(t,e,r)=>e.has(t)?Q("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),d=(t,e,r)=>(je(t,e,"access private method"),r),a,L,j,Y,Z,ee,te,S;let C=class extends ue(me(fe(be(de(ve(ge)))))){constructor(){super(...arguments),Se(this,a)}render(){return o(this.href,()=>d(this,a,Y).call(this),()=>d(this,a,ee).call(this))}};a=new WeakSet;L=function(t=!1){return t&&this.label||this.querySelector('[slot="footer"]')};j=function(){switch(this.variant){case"neutral-02":return this.outlined?"secondary":"tertiary";case"neutral-01":default:return"primary"}};Y=function(){return i`
      <gds-card-linked
        padding="0"
        gap="0"
        href=${s(this.href)}
...
<gds-theme color-scheme="dark">
  <gds-card-pattern-01
    ...
    label="Learn More"
  ></gds-card-pattern-01>
</gds-theme>`,language:"html",type:"code"}}}};var M,D,z;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    href: '#',
    title: 'Card Title',
    excerpt: 'Card description with label in footer.',
...
}`,...(z=(D=m.parameters)==null?void 0:D.docs)==null?void 0:z.source}}};var N,$,T;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{3}" gap="xl">
      <!-- Basic Card -->
      <gds-card-pattern-01
...
}`,...(T=($=f.parameters)==null?void 0:$.docs)==null?void 0:T.source}}};var _,A,P;x.parameters={...x.parameters,docs:{...(_=x.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{3}" gap="xl">
      <gds-card-pattern-01
        title="Landscape image"
...
}`,...(P=(A=x.parameters)==null?void 0:A.docs)==null?void 0:P.source}}};var F,I,E;b.parameters={...b.parameters,docs:{...(F=b.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{3}" gap="xl">
      <!-- Custom heading level -->
      <gds-card-pattern-01
...
}`,...(E=(I=b.parameters)==null?void 0:I.docs)==null?void 0:E.source}}};var W,V,O;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{3}" gap="xl">
      <!-- Default Link Footer -->
      <gds-card-pattern-01
...
}`,...(O=(V=y.parameters)==null?void 0:V.docs)==null?void 0:O.source}}};var q,B,H;v.parameters={...v.parameters,docs:{...(q=v.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{3}" gap="xl">
      <!-- Multiple Actions -->
      <gds-card-pattern-01
...
}`,...(H=(B=v.parameters)==null?void 0:B.docs)==null?void 0:H.source}}};var G,R,U;w.parameters={...w.parameters,docs:{...(G=w.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{3}" gap="xl">
      <gds-card-pattern-01
        title="Neutral 01"
...
}`,...(U=(R=w.parameters)==null?void 0:R.docs)==null?void 0:U.source}}};var X,J,K;k.parameters={...k.parameters,docs:{...(X=k.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => html\`
    <gds-grid columns="1; m{2}" padding="xl">
      <gds-theme color-scheme="light">
        <gds-flex
...
}`,...(K=(J=k.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const ut=["Default","Header","Image","Content","Footer","Actions","Variant","Theme"];export{v as Actions,b as Content,m as Default,y as Footer,f as Header,x as Image,k as Theme,w as Variant,ut as __namedExportsOrder,ht as default};
