...
`;var Oe=Ie;let ds=class extends c{render(){return Q`<slot></slot>`}};ds.styles=[q,Oe];ds=r([R("gds-flex")],ds);const it=e=>{ms.define();const s=N("gds-button"),t={...e,class:e.className};return O.createElement(s,t)},lt=e=>{Y.define();const s=N("gds-card"),t={...e,class:e.className};return O.createElement(s,t)},Ne=w`
  @layer defaults {
    a:link {
      color: currentColor;
