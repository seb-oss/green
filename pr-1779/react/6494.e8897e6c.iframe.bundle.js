...
`)),GdsCalendar=function(_GdsElement){function GdsCalendar(){var _this;return(0,classCallCheck.A)(this,GdsCalendar),_this=function chunk_BBYPKWGK_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,chunk_BBYPKWGK_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsCalendar,arguments),(0,chunk_SEHSDSX2.VK)(_this,_setSelectedDate),(0,chunk_SEHSDSX2.VK)(_this,chunk_BBYPKWGK_handleKeyDown),_this.min=new Date((new Date).getFullYear()-10,0,1),_this.max=new Date((new Date).getFullYear()+10,0,1),_this.focusedDate=new Date,_this.disabledWeekends=!1,_this.showWeekNumbers=!1,_this.hideExtraneousDays=!1,_this.hideDayNames=!1,_this.dateLabelTemplate=function(date){return date.toLocaleDateString(_this._currentLocale,{weekday:"long",year:"numeric",month:"long",day:"numeric"})},_this._currentLocale=navigator.language,_this}return(0,inherits.A)(GdsCalendar,_GdsElement),(0,createClass.A)(GdsCalendar,[{key:"focusedMonth",get:function get(){return this.focusedDate.getMonth()},set:function set(month){var lastOfSelectedMonth=(0,lastDayOfMonth.A)(new Date(this.focusedYear,month,1)),newFocusedDate=new Date(this.focusedDate);newFocusedDate.setDate(Math.min(this.focusedDate.getDate(),lastOfSelectedMonth.getDate())),newFocusedDate.setMonth(month),newFocusedDate.setHours(12,0,0,0),this.focusedDate=newFocusedDate}},{key:"focusedYear",get:function get(){return this.focusedDate.getFullYear()},set:function set(year){this.focusedDate=new Date(this.focusedDate.setFullYear(year))}},{key:"getDateCell",value:function getDateCell(dayNumber){var _a;return null==(_a=this.shadowRoot)?void 0:_a.querySelector("#dateCell-".concat(dayNumber))}},{key:"connectedCallback",value:function connectedCallback(){var _this2=this;chunk_BBYPKWGK_superPropGet(GdsCalendar,"connectedCallback",this,3)([]),chunk_3PL54UIC.nD.instance.apply(this,"gds-calendar"),this.addEventListener("keydown",(0,chunk_SEHSDSX2.jq)(this,chunk_BBYPKWGK_handleKeyDown,handleKeyDown_fn)),window.addEventListener("lit-localize-status",(function(e){"ready"===e.detail.status&&(_this2._currentLocale=e.detail.readyLocale)}))}},{key:"focus",value:function focus(){var _a;chunk_BBYPKWGK_superPropGet(GdsCalendar,"focus",this,3)([]),null==(_a=this._elFocusedCell)||_a.focus()}},{key:"render",value:function render(){var _this3=this,currentDate=new Date;return(0,lit.qy)(chunk_BBYPKWGK_t2||(chunk_BBYPKWGK_t2=chunk_BBYPKWGK_`<table role="grid" aria-label="${0}">
      ${0}
      <tbody role="rowgroup">
        ${0}
      </tbody>
    </table>`),(0,if_defined.J)(this.label),(0,when.z)(!this.hideDayNames,(function(){return(0,lit.qy)(chunk_BBYPKWGK_t3||(chunk_BBYPKWGK_t3=chunk_BBYPKWGK_`<thead role="rowgroup">
            <tr role="row">
              ${0}
              <th>${0}</th>
              <th>${0}</th>
          ...
          </thead>`),(0,when.z)(_this3.showWeekNumbers,(function(){return(0,lit.qy)(chunk_BBYPKWGK_t4||(chunk_BBYPKWGK_t4=chunk_BBYPKWGK_`<th></th>`))})),(0,lit_localize.ab)("Mon"),(0,lit_localize.ab)("Tue"),(0,lit_localize.ab)("Wed"),(0,lit_localize.ab)("Thu"),(0,lit_localize.ab)("Fri"),(0,lit_localize.ab)("Sat"),(0,lit_localize.ab)("Sun"))})),function renderMonthGridView(date,template){for(var monthStart=(0,startOfMonth.A)(date),monthEnd=(0,endOfMonth.A)(date),weeks=(0,eachWeekOfInterval.A)({start:monthStart,end:monthEnd},{weekStartsOn:1});weeks.length<6;)weeks.push((0,addDays.A)(weeks[weeks.length-1],7));return(0,lit.qy)(chunk_DI23R63U_t||(chunk_DI23R63U_t=chunk_DI23R63U_`${0}`),template(weeks.map((function(weekStartDay){return{days:(0,eachDayOfInterval.A)({start:weekStartDay,end:(0,addDays.A)(weekStartDay,6)})}}))))}(this.focusedDate,(function(weeks){return(0,lit.qy)(chunk_BBYPKWGK_t5||(chunk_BBYPKWGK_t5=chunk_BBYPKWGK_`
            ${0}
          `),weeks.map((function(week){return(0,lit.qy)(chunk_BBYPKWGK_t6||(chunk_BBYPKWGK_t6=chunk_BBYPKWGK_`
                <tr role="row">
                  ${0}
                  ${0}
                </tr>
              `),(0,when.z)(_this3.showWeekNumbers,(function(){return(0,lit.qy)(chunk_BBYPKWGK_t7||(chunk_BBYPKWGK_t7=chunk_BBYPKWGK_`<td class="week-number" scope="row">
                        ${0}
                      </td>`),(0,getWeek.A)(week.days[0]))})),week.days.map((function(day){var customization=_this3.customizedDates&&_this3.customizedDates.find((function(d){return(0,isSameDay.A)(d.date,day)})),displayOptions=(0,chunk_SEHSDSX2.IA)({color:"currentColor",disabled:Boolean(_this3.disabledDates&&_this3.disabledDates.some((function(d){return(0,isSameDay.A)(d,day)})))},customization),isOutsideCurrentMonth=!(0,isSameMonth.A)(_this3.focusedDate,day),isOutsideMinMax=(day<_this3.min||day>_this3.max)&&!(0,isSameDay.A)(day,_this3.min)&&!(0,isSameDay.A)(day,_this3.max),isWeekend=0===day.getDay()||6===day.getDay(),isDisabled=displayOptions.disabled||isOutsideCurrentMonth||isOutsideMinMax||_this3.disabledWeekends&&isWeekend;return _this3.hideExtraneousDays&&isOutsideCurrentMonth?(0,lit.qy)(chunk_BBYPKWGK_t8||(chunk_BBYPKWGK_t8=chunk_BBYPKWGK_`<td inert></td>`)):(0,lit.qy)(chunk_BBYPKWGK_t9||(chunk_BBYPKWGK_t9=chunk_BBYPKWGK_`
                          <td
                            role="${0}"
                            class="${0}"
                            ?disabled=${0}
