import{j as e}from"./jsx-runtime-CvWbQyLU.js";import{u as t}from"./index-BpDO1N5i.js";import"./chunk-HLWAVYOI-COkbJHAe.js";import{ae as r}from"./index-CiveacCO.js";import"./iframe-8RsaIPPk.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function o(s){const n={a:"a",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Concepts/Tokens"}),`
...
that use them.`}),`
`,e.jsxs(n.p,{children:["Tokens are  commonly reffered to as ",e.jsx("em",{children:"variables"}),`, and these terms
...
`,e.jsxs(n.p,{children:["By default, tokens are registered on the ",e.jsx(n.code,{children:":host"}),` selector of every component, so in order to access them, the element you are styling
...
`})}),`
`,e.jsxs(n.p,{children:["Try inspecting this example in Chrome DevTool, and change the value of the ",e.jsx(n.code,{children:"color-scheme"})," attribute in the ",e.jsx(n.code,{children:"<gds-theme>"})," element to ",e.jsx(n.code,{children:"dark"})," to see what happens to the color variables."]})]})}function y(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{y as default};
