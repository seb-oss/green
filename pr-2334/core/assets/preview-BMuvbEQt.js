 ...
 */
  ...
  --gds-sys-shadow-xl-02: 0px 0px 0px 0px transparent;`;var Us={};const Se=typeof process<"u"&&Us!==void 0;var Ve,ye,me,qe,de,us,hs;function Xs(){return Se?[]:document.adoptedStyleSheets||[]}const Zs=class ys{constructor(){p(this,de),p(this,Ve,!Je()),p(this,ye,new Map),p(this,me,new Map),p(this,qe,Xs())}static get instance(){var e;return(e=globalThis.__gdsGlobalStylesRegistryScoped)!=null&&e[j]||(globalThis.__gdsGlobalStylesRegistryScoped={...globalThis.__gdsGlobalStylesRegistryScoped,[j]:new ys}),globalThis.__gdsGlobalStylesRegistryScoped[j]}injectGlobalStyles(e,t){if(a(this,Ve)){const o=Array.isArray(t)?t.map(n=>n.toString()).join(""):t.toString();F(this,de,us).call(this,e,o)}else t.styleSheet&&F(this,de,hs).call(this,e,t.styleSheet)}};Ve=new WeakMap;ye=new WeakMap;me=new WeakMap;qe=new WeakMap;de=new WeakSet;us=function(s,e){if(Se)return;let t=a(this,me).get(s);t||(t=document.createElement("style"),a(this,me).set(s,t)),t.textContent=e,document.head.appendChild(t)};hs=function(s,e){Se||(a(this,ye).set(s,e),document.adoptedStyleSheets=[...a(this,qe),...Array.from(a(this,ye).values())])};let Ks=Zs;const R=[w`
    :host {
      ${M(fs)}
      ${M(bs)}
    }
...
`;var ht=ut,ae,z,X,Ss,Ge,Le;const yt=["aria-label","aria-haspopup","aria-expanded"],mt=dt(ee);class y extends D{constructor(){super(...arguments),p(this,z),this.disabled=!1,this.rank="primary",this.variant="neutral",this.size="medium",this.label="",this.href="",p(this,ae,!1),p(this,Ge,()=>{var t;const e=((t=this._mainSlot)==null?void 0:t.assignedElements())??[];k(this,ae,e.length===1&&(e[0].tagName.toLowerCase().startsWith("gds-icon")||e[0].getAttribute("name")==="icon")),this.requestUpdate()}),p(this,Le,e=>{this.dispatchCustomEvent("gds-click",{bubbles:!0,composed:!0,detail:e}),this.form&&!a(this,z,X)&&(this.type==="submit"?this.form.requestSubmit():this.type==="reset"&&this.form.reset())})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),ke.instance.apply(this,"gds-button")}focus(e){var t;(t=this._getValidityAnchor())==null||t.focus(e)}render(){const e={button:!0,circle:a(this,ae),icon:a(this,ae),xs:this.size==="xs",small:this.size==="small",large:this.size==="large",brand:this.variant==="brand",positive:this.variant==="positive",negative:this.variant==="negative",notice:this.variant==="notice",warning:this.variant==="warning",primary:this.rank==="primary",secondary:this.rank==="secondary",tertiary:this.rank==="tertiary"},t=a(this,z,X)?Xe`a`:Xe`button`;return ls`
      <${t}
        class=${As(e)}
      ...
      >
        <slot name="lead"></slot>
        <slot @slotchange=${a(this,Ge)}></slot>
        <slot name="trail"></slot>
        ${Bs(!this._isUsingTransitionalStyles,()=>mt`<gds-ripple part="_ripple"></gds-ripple>`)}
        </${t}>
        `}_getValidityAnchor(){return this._button}_attributeChanged(){this.requestUpdate()}}ae=new WeakMap;z=new WeakSet;X=function(){return this.href.length>0};Ss=function(){return this.target==="_blank"?"noreferrer noopener":void 0};Ge=new WeakMap;Le=new WeakMap;y.styles=[R,ht];y.shadowRootOptions={mode:"open",delegatesFocus:!0};r([g({type:Boolean,reflect:!0})],y.prototype,"disabled",2);r([i({selector:".button"})],y.prototype,"justify-content",2);r([g({reflect:!0})],y.prototype,"type",2);r([g({reflect:!0})],y.prototype,"rank",2);r([g({reflect:!0})],y.prototype,"variant",2);r([g({reflect:!0})],y.prototype,"size",2);r([g()],y.prototype,"label",2);r([g()],y.prototype,"href",2);r([g()],y.prototype,"target",2);r([g()],y.prototype,"rel",2);r([g()],y.prototype,"download",2);r([te("slot:not([name])")],y.prototype,"_mainSlot",2);r([te(".button")],y.prototype,"_button",2);r([st({attributes:!0,childList:!1,subtree:!1,characterData:!1})],y.prototype,"_attributeChanged",1);let je=class extends Ce(Ee($e(y))){};je=r([C("gds-button",{dependsOn:[le]})],je);const vt=w`
  :host {
    display: block;
    box-sizing: border-box;
    border-style: solid;
...
`;var kt=St;class $ extends Ee($e(B)){constructor(){super(...arguments),this.solid=!1,this.level="2",this.label=""}get svgAttributes(){const t={fill:"none",xmlns:"http://www.w3.org/2000/svg",viewBox:this.constructor._viewBox,part:"icon"};return this.label?{...t,"aria-label":this.label}:{...t,role:"presentation"}}get svgContent(){const e=this.constructor;return this.solid?e._solidSVG:e._regularSVG}applyStroke(e){return this.stroke?e.replace(/<(path|rect|circle|ellipse|line|polyline|polygon)/g,`<$1 stroke-width="${this.stroke}"`):e}generateAttributesString(e){return Object.entries(e).filter(([t,o])=>o!==void 0).map(([t,o])=>`${t}="${o}"`).join(`
    ...
    `;return xe`${js(o)}`}}$.styles=[R,kt];r([i({..._,property:"height",selector:"svg"})],$.prototype,"size",2);r([g({type:Boolean})],$.prototype,"solid",2);r([g({type:Number})],$.prototype,"stroke",2);r([g()],$.prototype,"level",2);r([i(we("content"))],$.prototype,"color",2);r([g({type:String})],$.prototype,"label",2);$.define();const _t=w`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;var Tt=Mt;let K=class extends Ce(B){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),ke.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return ee`<button
...
`;var Vt=Dt,Z,Oe,ks,Ae,Be,Re,ie,pe,We,Fe;const zt=(s,e)=>{let t;return()=>{clearTimeout(t),t=setTimeout(s,e)}};let E=class extends $e(Ce(Ee(B))){constructor(){super(...arguments),p(this,Oe),this.size="medium",p(this,Z),this._showPrevButton=!1,this._showNextButton=!1,this.intersectionObserver=null,p(this,Ae,()=>{const e=this.segments.filter((t,o,n)=>{var l;return((l=n[o+1])==null?void 0:l.isVisible)&&!t.isVisible})[0];e&&(this._elTrack.scrollLeft-=e.offsetWidth)}),p(this,Be,()=>{const e=this.segments.filter((t,o,n)=>{var l;return((l=n[o-1])==null?void 0:l.isVisible)&&!t.isVisible}).reverse()[0];e&&(this._elTrack.scrollLeft+=e.offsetWidth)}),p(this,Re,()=>{this.segments.every(e=>!e.isVisible)||(this._showPrevButton=!this.segments[0].isVisible,this._showNextButton=!this.segments[this.segments.length-1].isVisible)}),p(this,ie,zt(a(this,Re),50)),p(this,pe,()=>{const e=this.segments.find(t=>t.selected);if(e){const t=e.offsetWidth,o=e.offsetLeft;this._elIndicator.style.transform=`translateX(${o}px)`,this._elIndicator.style.width=`${t}px`}else this._elIndicator.style.transform="translateX(-100%)",this._elIndicator.style.width="0px"}),p(this,We,e=>{const t=this.segments.find(o=>o===e.target||o.contains(e.target));t&&(this.segments.forEach(o=>o.selected=!1),t.selected=!0,k(this,Z,t.value),a(this,pe).call(this),this.dispatchCustomEvent("change",{detail:{segment:t},bubbles:!0,composed:!0}))}),p(this,Fe,()=>{a(this,Z)&&this.updateComplete.then(()=>{const e=this.segments.find(t=>t.value===a(this,Z));e&&(this.segments.forEach(t=>t.selected=!1),e.selected=!0,this._elTrack.scrollLeft=e.offsetLeft)})})}get value(){return a(this,Z)}set value(e){k(this,Z,e),a(this,Fe).call(this)}get segments(){return this._elSlot?this._elSlot.assignedElements():[]}connectedCallback(){super.connectedCallback(),ke.instance.apply(this,"gds-segmented-control"),this.updateComplete.then(()=>{this._elTrack.addEventListener("scroll",()=>{a(this,ie).call(this)})})}render(){return ee`<button
      ...
      </button>`}_recalculateMinWidth(){this.updateComplete.then(()=>{a(this,ie).call(this),a(this,pe).call(this)})}};Z=new WeakMap;Oe=new WeakSet;ks=function(){var e,t;const s=(e=this.segments.find(o=>o.selected))==null?void 0:e.value;s&&k(this,Z,s),(t=this.intersectionObserver)==null||t.disconnect(),this.intersectionObserver=new IntersectionObserver(o=>{o.forEach(n=>{const l=n.target;l._isVisible=n.intersectionRatio>.99,a(this,ie).call(this)})},{root:this._elTrack,threshold:[0,.01,.5,.99,1]}),this.segments.forEach(o=>{var n;(n=this.intersectionObserver)==null||n.observe(o)})};Ae=new WeakMap;Be=new WeakMap;Re=new WeakMap;ie=new WeakMap;pe=new WeakMap;We=new WeakMap;Fe=new WeakMap;E.styles=[R,Vt];r([g({reflect:!0})],E.prototype,"size",2);r([g()],E.prototype,"value",1);r([te("slot")],E.prototype,"_elSlot",2);r([te("#indicator")],E.prototype,"_elIndicator",2);r([te("#track")],E.prototype,"_elTrack",2);r([Pe()],E.prototype,"_showPrevButton",2);r([Pe()],E.prototype,"_showNextButton",2);r([$t(),_e("value")],E.prototype,"_recalculateMinWidth",1);E=r([C("gds-segmented-control",{dependsOn:[K,N,J]}),Gs()],E);const Gt=w`
  @layer defaults {
    a:link {
      color: currentColor;
