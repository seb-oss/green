...
@beta`}}}},a={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{heading:"Dialog heading",innerHTML:'<gds-button slot="trigger">Open Dialog</gds-button>This is the content of the dialog. You can add any content here, including other components. You can also add buttons to the footer of the dialog by using the slot="footer" attribute on the button. You can also use the slot="footer" attribute to add buttons to the footer of the dialog. The dialog will automatically close when the user clicks outside of it or presses the Escape key. You can also close the dialog programmatically by calling the close() method on the dialog element. The dialog will also emit a gds-close event when it is closed, which you can listen to if you want to perform some action when the dialog is closed.',variant:"default",size:"m",position:"initial"}},t={...a},e={...a,args:{...a.args,variant:"slide-out"}},o={...a,render:()=>C`<gds-button
    ...
    >
      ...
      >
    </gds-dialog>`};var n,i,l,d,r;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`{
  ...DefaultParams
}`,...(l=(i=t.parameters)==null?void 0:i.docs)==null?void 0:l.source},description:{story:`The easiest way to set up a dialog is to put a button in the trigger slot. This will
automatically open the dialog when the button is clicked.`,...(r=(d=t.parameters)==null?void 0:d.docs)==null?void 0:r.description}}};var c,g,u,h,m;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  ...DefaultParams,
  args: {
    ...DefaultParams.args,
    variant: 'slide-out'
  }
}`,...(u=(g=e.parameters)==null?void 0:g.docs)==null?void 0:u.source},description:{story:"You can set the `variant` attribute to `slide-out` to make the dialog slide in from the right.",...(m=(h=e.parameters)==null?void 0:h.docs)==null?void 0:m.description}}};var p,b,y,f,w;o.parameters={...o.parameters,docs:{...(p=o.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...DefaultParams,
