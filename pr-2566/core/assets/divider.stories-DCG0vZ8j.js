import"./divider-kkUssttS.js";import"./flex-AsELAJlj.js";import"./card-lbjjOHp9.js";import{x as d}from"./iframe-BQQroKqS.js";import{a as r}from"./argTableProps-198TiHdR.js";import"./divider.component-Bnqsg4JN.js";import"./flex.component-7T4du4Zy.js";import"./card.component-CqlmFwU6.js";const n={title:"Components/Divider",component:"gds-divider",tags:["autodocs"],argTypes:{...r("gds-divider")},parameters:{docs:{description:{component:`Divider creates visual and semantic separation between content.
...
> Divider should not be used as a border for a container. In that case, use the border property of the container instead.`}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},f={...e,name:"Divider",render:i=>d` <gds-divider color="" size="2xl"></gds-divider>`},v={...e,name:"Color",render:i=>d` <gds-flex flex-direction="column" gap="xl">
    ...
    </gds-flex>`},m={...e,name:"Opacity",render:i=>d` <gds-flex flex-direction="column" gap="xl">
      <gds-card>
        <gds-flex flex-direction="column">
    ...
    </gds-flex>`},p={...e,name:"Size",render:i=>d` <gds-flex flex-direction="column" gap="xl">
      <gds-card>
        <gds-flex flex-direction="column">
    ...
    </gds-flex>`},u=["Divider","Color","Opacity","Size"];export{v as Color,f as Divider,m as Opacity,p as Size,u as __namedExportsOrder,n as default};
