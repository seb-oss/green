import{n as l,r as D}from"./Reflect-DJ7r0WLU.js";import{G as O,h as f,g as E}from"./gds-element-DTROifYq.js";import{G as P}from"./toggle-control-base.component-246dLh24.js";import{c as L}from"./transitional-styles-Dla2R8BH.js";import{r as B}from"./rbcb-toggle.template-DqXF-ZkM.js";import{i as k}from"./lit-element-Bx14lxc-.js";import{l as I}from"./runtime-CNluP0A8.js";import{a as W}from"./query-p8xgzTDt.js";import{e as V}from"./class-map-CXsQwv0r.js";import{G as H,a as K}from"./form-control-header.component-BhoEwHL8.js";import{t as q}from"./tokens.style-DeseHqaM.js";import{w as _}from"./watch-tFciLXSI.js";import{d as U,b as X,w as J}from"./declarative-layout-mixins-C4FFYA_h.js";import{a as N}from"./button.component-DF5WqZLY.js";const Q=k`
  :host {
    cursor: pointer;
  }
...
`;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,A=t=>{throw TypeError(t)},c=(t,e,s,i)=>{for(var r=i>1?void 0:i?Z(e,s):e,p=t.length-1,u;p>=0;p--)(u=t[p])&&(r=(i?u(e,s,r):u(r))||r);return i&&r&&Y(e,s,r),r},j=(t,e,s)=>e.has(t)||A("Cannot "+s),v=(t,e,s)=>(j(t,e,"read from private field"),s?s.call(t):e.get(t)),C=(t,e,s)=>e.has(t)?A("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),g,b;let n=class extends O{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,C(this,g,t=>{this.disabled||!this.value||!this.label||(t.preventDefault(),this.checked=!0,this.focus(),this.dispatchStandardEvent("input",{bubbles:!0}))}),C(this,b,t=>{this.disabled||(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this.checked=!0,this.dispatchStandardEvent("input",{bubbles:!0}))}),this.addEventListener("keydown",v(this,b)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",v(this,g))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.setAttribute("aria-description",this.errorMessage?this.errorMessage:""),this.toggleAttribute("aria-invalid",this.invalid)}updated(t){super.updated(t),(t.has("checked")||t.has("disabled")||t.has("invalid"))&&this._updateAriaState()}render(){return f`
    ...
    `}};g=new WeakMap;b=new WeakMap;n.styles=[L,Q];c([l()],n.prototype,"label",2);c([l({attribute:"supporting-text"})],n.prototype,"supportingText",2);c([l()],n.prototype,"value",2);c([l({type:Boolean,reflect:!0})],n.prototype,"checked",2);c([l({type:Boolean,reflect:!0})],n.prototype,"disabled",2);c([l({type:Boolean})],n.prototype,"invalid",2);c([l({type:String})],n.prototype,"errorMessage",2);c([D()],n.prototype,"_isFocused",2);n=c([E("gds-radio",{dependsOn:[P]})],n);const tt=k`
  :host {
    /* Font Sizes */
...
`;var et=Object.defineProperty,st=Object.getOwnPropertyDescriptor,S=t=>{throw TypeError(t)},h=(t,e,s,i)=>{for(var r=i>1?void 0:i?st(e,s):e,p=t.length-1,u;p>=0;p--)(u=t[p])&&(r=(i?u(e,s,r):u(r))||r);return i&&r&&et(e,s,r),r},it=(t,e,s)=>e.has(t)||S("Cannot "+s),rt=(t,e,s)=>e.has(t)?S("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),a=(t,e,s)=>(it(t,e,"access private method"),s),o,m,$,y,R,z,x,G,F,T,M;let d=class extends N{constructor(){super(...arguments),rt(this,o),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),a(this,o,m).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}focus(t){var e;(e=this._getValidityAnchor())==null||e.focus(t)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{a(this,o,m).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(t=>{t.checked=t.value===this.value,t.size=this.size,t.invalid=this.invalid,t.errorMessage=this.errorMessage})}render(){const t={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return f`<div
    ...
    </div>`}};o=new WeakSet;m=function(){if(!this._contentElement||!this._isConnected)return;const t=this.radios.find(e=>e.checked);t?(t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(e=>!e.checked).forEach(e=>e.setAttribute("tabindex","-1"))};$=function(){if(!this._contentElement||!this._isConnected)return;const t=this.radios.find(s=>s.checked),e=t||this.radios[0];e&&(e.focus(),t||(this.radios.forEach(s=>s.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};y=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("change",{composed:!0,bubbles:!0})),this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))};R=function(t){t.stopPropagation();const e=t.target;this.value=e.value,this._syncRadioStates(),a(this,o,y).call(this)};z=function(t){if(!this._isConnected)return;const e=this.radios.filter(i=>!i.disabled);if(e.length===0)return;let s=e.findIndex(i=>document.activeElement===i);switch(s===-1&&(s=e.findIndex(i=>i.checked),s===-1&&(s=0)),t.key){case"ArrowDown":case"ArrowRight":{t.preventDefault();const i=(s+1)%e.length;a(this,o,x).call(this,e[i]);break}case"ArrowUp":case"ArrowLeft":{t.preventDefault();const i=(s-1+e.length)%e.length;a(this,o,x).call(this,e[i]);break}default:return}};x=function(t){!this._contentElement||!this._isConnected||(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),t.checked=!0,t.focus(),this.value=t.value,this._syncRadioStates(),a(this,o,y).call(this))};G=function(){return[a(this,o,F).call(this),a(this,o,T).call(this),a(this,o,M).call(this)].map(e=>f`${e}`)};F=function(){if(this.label)return f` <gds-form-control-header
    ...
    >
    </gds-form-control-footer>`};d.styles=[q,tt];h([l()],d.prototype,"size",2);h([l()],d.prototype,"direction",2);h([l({attribute:"supporting-text"})],d.prototype,"supportingText",2);h([l({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],d.prototype,"showExtendedSupportingText",2);h([W(".content")],d.prototype,"_contentElement",2);h([_("value")],d.prototype,"_handleValueChange",1);h([_("invalid"),_("errorMessage")],d.prototype,"_syncRadioStates",1);d=h([I()],d);let w=class extends U(X(J(d))){};w=h([E("gds-radio-group",{dependsOn:[H,K]})],w);export{n as G,w as a};
