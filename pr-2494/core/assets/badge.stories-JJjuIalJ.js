import{x as a}from"./iframe-DVJINxuy.js";import{a as O}from"./argTableProps-Ci0H9-Cm.js";import"./badge-BrhtgD7Y.js";import"./flex-CBlLvrfN.js";import"./divider-BS_MC11P.js";import"./triangle-exclamation-DtMrEyIt.js";import"./circle-check-Cb3E5hme.js";import"./arrow-rotate-counter-clockwise.component-C0cjcYo9.js";import"./minus-small-CPPx3QUi.js";import"./rocket-BckAAwpv.js";import"./preload-helper-Dp1pzeXC.js";import"./badge.component-Bvsdu2QU.js";import"./flex.component-BsWdKKZp.js";import"./divider.component-BwvKLI_z.js";import"./triangle-exclamation.component-DRuxnoO8.js";import"./icon-Doc_EbFR.js";import"./circle-check.component-Dh5Sl1hj.js";import"./minus-small.component-CvbcXsbL.js";import"./rocket.component-DdvtJHle.js";const le={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...O("gds-badge")}},o={name:"Variants",render:e=>a`
    <gds-flex
