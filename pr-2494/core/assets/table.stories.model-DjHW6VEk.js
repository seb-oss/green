import{u as l,j as e,M as a}from"./iframe-56TAW9-d.js";import"./preload-helper-Dp1pzeXC.js";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(a,{title:"Components/Table/Developer Guide"}),`
...
`})}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Template definition"})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<!-- Used as icon button -->
...
`,e.jsx(n.p,{children:"For complete API documentation, see the main Table component documentation."})]})}function i(t={}){const{wrapper:n}={...l(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{i as default};
