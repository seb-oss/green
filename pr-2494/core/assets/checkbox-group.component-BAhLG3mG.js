import{n as l}from"./Reflect-DJ7r0WLU.js";import{a as $}from"./query-p8xgzTDt.js";import{n as A}from"./when-BR7zwNJC.js";import{G as L}from"./toggle-control-base.component-246dLh24.js";import{h as g,g as w}from"./gds-element-DTROifYq.js";import{a as B}from"./transitional-styles-COH6eQFN.js";import{c as W}from"./rbcb-toggle.template-DqXF-ZkM.js";import{t as H}from"./tokens.style-DeseHqaM.js";import{w as m}from"./watch-tFciLXSI.js";import{a as G}from"./button.component-B2qFYAKM.js";import{I as J}from"./checkmark.component-B7EWT7bF.js";import{I as N}from"./minus-small.component-Cqp98pLU.js";import{i as E}from"./lit-element-Bx14lxc-.js";import{l as U}from"./runtime-CNluP0A8.js";import{e as q}from"./class-map-CXsQwv0r.js";import{G as R,a as X}from"./form-control-header.component-CA5Ib0P7.js";import{o as K}from"./observe-light-dom-CmJPHUQ4.js";import{d as Q,b as Y,w as Z}from"./declarative-layout-mixins-C4FFYA_h.js";const j=E`
  :host {
    cursor: pointer;
  }
...
`;var ee=Object.defineProperty,te=Object.getOwnPropertyDescriptor,O=e=>{throw TypeError(e)},p=(e,t,s,c)=>{for(var o=c>1?void 0:c?te(t,s):t,h=e.length-1,u;h>=0;h--)(u=e[h])&&(o=(c?u(t,s,o):u(o))||o);return c&&o&&ee(t,s,o),o},se=(e,t,s)=>t.has(e)||O("Cannot "+s),oe=(e,t,s)=>t.has(e)?O("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),b=(e,t,s)=>(se(e,t,"access private method"),s),v,M,_;let n=class extends G{constructor(){super(...arguments),oe(this,v),this.label="",this.supportingText="",this.checked=!1,this.indeterminate=!1,this.disabled=!1}get value(){return this._internalValue||""}set value(e){this._internalValue=e}_handleIndeterminateChange(){this.indeterminate&&(this.checked=!1)}focus(e){this._elCheckbox.focus(e)}render(){return g`
    ...
    `}_getValidityAnchor(){return this._elCheckbox}formResetCallback(){this.checked=!1}};v=new WeakSet;M=function(e){this.disabled||e.target instanceof HTMLLabelElement||(this.indeterminate?this.indeterminate=!1:this.checked=!this.checked,b(this,v,_).call(this))};_=function(){this.dispatchStandardEvent("change",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})};n.styles=[H,B,j];p([l()],n.prototype,"label",2);p([l({attribute:"supporting-text"})],n.prototype,"supportingText",2);p([l({type:Boolean})],n.prototype,"checked",2);p([l({type:Boolean,reflect:!0})],n.prototype,"indeterminate",2);p([l({type:Boolean,reflect:!0})],n.prototype,"disabled",2);p([$('input[type="checkbox"]')],n.prototype,"_elCheckbox",2);p([m("indeterminate")],n.prototype,"_handleIndeterminateChange",1);n=p([w("gds-checkbox",{dependsOn:[L,J,N]})],n);const re=E`
  :host {
    /* Font Sizes */
...
`;var ae=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},a=(e,t,s,c)=>{for(var o=c>1?void 0:c?ie(t,s):t,h=e.length-1,u;h>=0;h--)(u=e[h])&&(o=(c?u(t,s,o):u(o))||o);return c&&o&&ae(t,s,o),o},z=(e,t,s)=>t.has(e)||S("Cannot "+s),x=(e,t,s)=>(z(e,t,"read from private field"),s?s.call(e):t.get(e)),k=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),d=(e,t,s)=>(z(e,t,"access private method"),s),f,i,T,P,V,F,y,I,D;let r=class extends G{constructor(){super(...arguments),k(this,i),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,k(this,f,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){x(this,f).call(this)}focus(){var e;(e=this.checkboxes[0])==null||e.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",x(this,f))}render(){const e={"checkbox-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return g`<div
      ...
      aria-invalid=${this.invalid}
    >
      ${d(this,i,T).call(this)}
    </div>`}_syncOnDOMChange(){x(this,f).call(this),d(this,i,y).call(this)}};f=new WeakMap;i=new WeakSet;T=function(){return[d(this,i,P).call(this),d(this,i,V).call(this),d(this,i,D).call(this)].map(t=>g`${t}`)};P=function(){if(this.label)return g`<gds-form-control-header class="size-${this.size}">
    ...
    >
    </gds-form-control-footer>`};r.styles=[re];a([l()],r.prototype,"size",2);a([l()],r.prototype,"direction",2);a([l({attribute:"supporting-text"})],r.prototype,"supportingText",2);a([l({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],r.prototype,"showExtendedSupportingText",2);a([l({type:Array})],r.prototype,"value",1);a([$("#checkboxgroup")],r.prototype,"_elCheckboxGroup",2);a([m("value",{waitUntilFirstUpdate:!0})],r.prototype,"_handleValueChange",1);a([m("invalid"),m("errorMessage")],r.prototype,"_handleGroupInvalidChange",1);a([K({attributes:!0,childList:!0,subtree:!0,characterData:!0})],r.prototype,"_syncOnDOMChange",1);r=a([U()],r);let C=class extends Q(Y(Z(r))){};C=a([w("gds-checkbox-group",{dependsOn:[R,X]})],C);export{n as G,C as a};
