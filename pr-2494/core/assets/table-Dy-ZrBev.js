import{n as c,r as v}from"./Reflect-DJ7r0WLU.js";import{e as S}from"./class-map-CXsQwv0r.js";import{n as g}from"./when-BR7zwNJC.js";import{G as z,h as r,g as _}from"./gds-element-DTROifYq.js";import{t as j}from"./tokens.style-CA5ADGwW.js";import{G as M}from"./button.component-jWIOpC9g.js";import{G as pe}from"./card.component-DgPbllnK.js";import{G as B}from"./dropdown.component-D7FNft71.js";import{I as ge}from"./cross-small.component-BS14rjKa.js";import{I as be}from"./magnifying-glass.component-U0Z7YZT0.js";import{I as ue,a as ye,b as fe,c as ve,d as me,e as Se,f as we}from"./sort.component-DkCP_pJk.js";import{G as xe}from"./input-t17hjOpz.js";import{i as P}from"./lit-element-Bx14lxc-.js";import{a as $e,G as Ce}from"./context-menu-CDIXMzW3.js";import{I as ke}from"./chevron-bottom.component-DgyIWO1Z.js";import{G as H}from"./text-BmaBdEcP.js";import{a as ze}from"./transitional-styles-CbHKJeDE.js";import{c as _e}from"./rbcb-toggle.template-DqXF-ZkM.js";import{I as Pe}from"./checkmark.component-CddocQY8.js";import{I as Re}from"./minus-small.component-DOCzMU52.js";var De=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,w=(e,t,s,o)=>{for(var i=o>1?void 0:o?Ie(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(i=(o?p(t,s,i):p(i))||i);return o&&i&&De(t,s,i),i};let u=class extends z{constructor(){super(...arguments),this.page=1,this.pageSize=10,this.total=0,this.pageSizes=[5,10,25,50]}get pageCount(){return Math.ceil(this.total/this.pageSize)}getVisiblePages(e){if(e<=7)return Array.from({length:e},(o,i)=>i+1);const t=e;let s=[];return this.page<=4?(s=[2,3,4,5],[1,...s,"...",t]):this.page>=e-3?(s=[e-4,e-3,e-2,e-1],[1,"...",...s,t]):(s=[this.page-1,this.page,this.page+1],[1,"...",...s,"...",t])}render(){const e=this.pageCount,t=this.getVisiblePages(e);return r`
      <div class="pagination">
        ...
        ${t.map(s=>r`
            ${s==="..."?r`<gds-button size="small" rank="tertiary" width="40px" inert
                  >...</gds-button
                >`:r`
                  <gds-button
                    size="small"
    ...
    `];w([c({type:Number})],u.prototype,"page",2);w([c({type:Number})],u.prototype,"pageSize",2);w([c({type:Number})],u.prototype,"total",2);w([c({type:Array})],u.prototype,"pageSizes",2);u=w([_("gds-pagination",{dependsOn:[M,H,B,$e,Ce,ke,ue,ye,fe,ve]})],u);var Ge=Object.defineProperty,Ee=Object.getOwnPropertyDescriptor,x=(e,t,s,o)=>{for(var i=o>1?void 0:o?Ee(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(i=(o?p(t,s,i):p(i))||i);return o&&i&&Ge(t,s,i),i};let y=class extends z{constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaLabel=""}render(){return r`
      <div
    ...
    `];x([c({type:Boolean})],y.prototype,"checked",2);x([c({type:Boolean})],y.prototype,"indeterminate",2);x([c({type:Boolean})],y.prototype,"disabled",2);x([c()],y.prototype,"ariaLabel",2);y=x([_("gds-table-row-selector",{dependsOn:[Pe,Re]})],y);const Ae=P`
  /* Host & Container */
  :host {
    display: block;
...
`;var Oe=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,Q=e=>{throw TypeError(e)},h=(e,t,s,o)=>{for(var i=o>1?void 0:o?Te(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(i=(o?p(t,s,i):p(i))||i);return o&&i&&Oe(t,s,i),i},U=(e,t,s)=>t.has(e)||Q("Cannot "+s),b=(e,t,s)=>(U(e,t,"read from private field"),s?s.call(e):t.get(e)),k=(e,t,s)=>t.has(e)?Q("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),l=(e,t,s)=>(U(e,t,"access private method"),s),$,R,a,D,C,q,L,K,f,N,V,W,F,J,X,Y,Z,ee,te,se,ae,ie,le,re,ne,oe,de,ce,I,G,m;let d=class extends z{constructor(){super(...arguments),k(this,a),k(this,$,{}),k(this,R,5*60*1e3),this.columns=[],this.density="comfortable",this.selectable=!1,this.responsive=!1,this.plain=!1,this.tableState={page:1,pageSize:10,searchQuery:"",visibleColumns:new Set},this.loading=!1,this.data=[],this.totalRows=0,this.selectedRows=new Set,this.error=null,this.slots={}}async connectedCallback(){super.connectedCallback(),this.tableState.visibleColumns=new Set(this.columns.map(e=>e.key)),await l(this,a,f).call(this)}render(){return r`
    ...
    `};F=function(e){const t=this.tableState.sortColumn===e.key,s=this.tableState.sortDirection;return r`
      <th
    ...
    `};J=function(){return r`
      <thead>
        <tr>
          ...
          ${g(this.actions,()=>r`<th class="column-header actions">
                <div class="column-label">Actions</div>
              </th>`)}
        </tr>
      </thead>
    `};X=function(e,t,s){return r`
      <td
        data-label=${s.label}
    ...
    `};ee=function(){const e=S({responsive:this.responsive,data:!0});return r`
      <div class=${e}>
        <table>
          ${l(this,a,J).call(this)} ${l(this,a,Z).call(this)}
        </table>
      </div>
    `};te=function(){return r`
      <gds-card
        variant="negative"
        justify-content="center"
    ...
    `};se=function(){return this.plain?null:r`
      <div class="footer">
        <div class="lead">
          <slot name="footer-lead">
            ${g(this.selectable&&b(this,a,D),()=>r`
