import{x as a}from"./iframe-CoDlFn-2.js";import{a as O}from"./argTableProps-BDhkytx5.js";import"./badge-lG0ERARG.js";import"./flex-VSgv6Llp.js";import"./divider-C5PIv4OH.js";import"./triangle-exclamation-DBmWoBJQ.js";import"./circle-check-CPZoMQeg.js";import"./arrow-rotate-counter-clockwise.component-T31CFINQ.js";import"./minus-small-BiW3_Tk7.js";import"./rocket-Bh-erAUV.js";import"./preload-helper-Dp1pzeXC.js";import"./badge.component-dWWg2vfr.js";import"./flex.component-DQTWXpNE.js";import"./divider.component-B5Pg49cK.js";import"./triangle-exclamation.component-BcmZDyBE.js";import"./icon.component-B25M09sZ.js";import"./circle-check.component-DMlef4DZ.js";import"./minus-small.component-DbIoxMC_.js";import"./rocket.component-Binjp-_b.js";const le={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...O("gds-badge")}},o={name:"Variants",render:e=>a`
    <gds-flex
