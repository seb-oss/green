import{m as H,l as K}from"./runtime-CNluP0A8.js";import{n,r as S}from"./Reflect-DJ7r0WLU.js";import{a as A}from"./query-p8xgzTDt.js";import{e as I}from"./class-map-CXsQwv0r.js";import{o as U,s as G,a as z,c as F}from"./floating-ui.dom-BmFOYU71.js";import{G as X,h as Y,g as q}from"./gds-element-DTROifYq.js";import{T as Q}from"./transitional-styles-CbHKJeDE.js";import{w as _}from"./watch-tFciLXSI.js";import{i as J}from"./tokens.style-CA5ADGwW.js";import{I as Z}from"./cross-small.component-BS14rjKa.js";import{i as j}from"./lit-element-Bx14lxc-.js";function tt(t){return(e,s,l)=>{if(J)return;const r=window.matchMedia(t),h=e.connectedCallback,p=e.disconnectedCallback;e.connectedCallback=function(){var R;h==null||h.call(this);const P=B=>{var L;(L=l.value)==null||L.call(this,B.matches)};r.addEventListener("change",P),this.disconnectedCallback=function(){p==null||p.call(this),r.removeEventListener("change",P)},(R=l.value)==null||R.call(this,r.matches)}}}const et=j`
