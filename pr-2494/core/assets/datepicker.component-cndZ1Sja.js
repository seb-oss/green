import{e as Vt,S as Ft,O as Ot,Q as Rt,al as Ht,am as E,an as N,ao as j,ag as tt,ap as Kt,aq as Ut,n as m,z as Z,a2 as _t,A as Xt,h as w,g as Yt,i as Jt,t as Zt,d as $t,U as qt,L as Qt,K as jt,a3 as te,Y as ee,b as I,H as c,E as Wt,I as se,J as ae}from"./iframe-CW7H6oKK.js";import{r as q}from"./query-async-0qDLg8LN.js";import{f as ie}from"./ref-Z9QpQxYT.js";import{a as ne}from"./dropdown.component-BgCqj2k3.js";import{G as oe}from"./flex.component-D4Uxf4uK.js";import{f as re}from"./form-control-host.style-QexHsHmG.js";import{d as bt,a as le}from"./attribute-converters-CdI0trPX.js";import{i as he,G as de}from"./calendar.component-CSBK3xAm.js";import{I as ue,a as ce}from"./calender-add.component-CHrzBUZ8.js";import{I as pe}from"./chevron-left.component-DtiNh9EO.js";import{I as ge}from"./chevron-right.component-DBRO8Gtz.js";import{G as fe}from"./popover.component-DBB2x27A.js";/**
 * @license
...
`;var Se=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,Tt=t=>{throw TypeError(t)},l=(t,e,s,i)=>{for(var a=i>1?void 0:i?Fe(e,s):e,n=t.length-1,h;n>=0;n--)(h=t[n])&&(a=(i?h(e,s,a):h(a))||a);return i&&a&&Se(e,s,a),a},xt=(t,e,s)=>e.has(t)||Tt("Cannot "+s),g=(t,e,s)=>(xt(t,e,"read from private field"),s?s.call(t):e.get(t)),y=(t,e,s)=>e.has(t)?Tt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),G=(t,e,s,i)=>(xt(t,e,"write to private field"),e.set(t,s),s),f=(t,e,s)=>(xt(t,e,"access private method"),s),U,B,u,At,Nt,X,zt,Lt,nt,P,A,ot,rt,lt,ht,dt,ut,ct,pt,gt,J,ft,mt,vt,yt,Y,Bt,Gt;let r=class extends te{constructor(){super(),y(this,u),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.clearable=!1,this.hideTodayButton=!1,y(this,U,12),this.disabledWeekends=!1,this.showExtendedSupportingText=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=f(this,u,vt).call(this,"y-m-d"),y(this,B),y(this,ot,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),y(this,rt,t=>{this._elFieldAsync.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),y(this,lt,t=>{this._elFieldAsync.then(e=>{var h;if(t.currentTarget!==e)return;t.preventDefault();const s=(h=t.clipboardData)==null?void 0:h.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const p=this._dateFormatLayout.layout,o=parseInt(n[p.findIndex(d=>d.token==="y")]),k=parseInt(n[p.findIndex(d=>d.token==="m")])-1,M=parseInt(n[p.findIndex(d=>d.token==="d")]);!isNaN(o)&&!isNaN(k)&&!isNaN(M)&&(i=new Date(`${o}-${k+1}-${M}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,f(this,u,P).call(this))})}),y(this,ht,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),y(this,dt,t=>{t.stopPropagation();const e=new Date(t.detail);e.setUTCHours(this.utcHours,0,0,0),this.value=e,this.open=!1,f(this,u,P).call(this),f(this,u,A).call(this)}),y(this,ut,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),y(this,ct,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),y(this,pt,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),y(this,gt,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),y(this,J,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=new Date((await this._elCalendar).focusedDate),this.requestUpdate(),f(this,u,A).call(this)}),y(this,ft,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;if(!e){this.value=void 0,f(this,u,P).call(this);return}!he(e||new Date(0),g(this,B)||new Date(0))&&(this.value=new Date(e),f(this,u,P).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=g(this,B),f(this,u,A).call(this))}}),y(this,mt,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),y(this,yt,(t,e)=>{g(this,Y)[e]=t;const s=new Date;s.setFullYear(parseInt(g(this,Y).year)),s.setMonth(parseInt(g(this,Y).month)-1),s.setDate(parseInt(g(this,Y).day)),s.setUTCHours(this.utcHours,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,f(this,u,P).call(this),f(this,u,A).call(this))}),y(this,Y,{year:"yyyy",month:"mm",day:"dd"}),D.define()}get type(){return"gds-datepicker"}get value(){return super.value}set value(t){super.value=t}get utcHours(){return g(this,U)}set utcHours(t){var e;G(this,U,t),(e=this._internalValue)==null||e.setUTCHours(t,0,0,0)}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=f(this,u,vt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),ee.instance.apply(this,"gds-datepicker")}focus(t){var e;(e=this._getValidityAnchor())==null||e.focus(t)}render(){return w`
      ...
      ${I(f(this,u,At).call(this),()=>w`<gds-form-control-footer
            class="size-${this.size}"
          ...
          ${I(this.clearable||!this.hideTodayButton,()=>w`
              ...
              >
                ${I(this.clearable,()=>w` <gds-button
                      ...
                      rank="tertiary"
                      size="small"
                      @click=${t=>{t.stopPropagation(),this.value=void 0,this.open=!1,f(this,u,A).call(this),f(this,u,P).call(this)}}
                      aria-label=${c("Clear selected date")}
                    >
                      ${c("Clear")}
                    </gds-button>`)}
                ${Ce(f(this,u,Nt).call(this),Wt)}
