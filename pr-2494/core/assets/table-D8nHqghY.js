import{S as Ht,O as Qt,Q as qt,ag as Ut,i as H,ah as Ft,U as Vt,Z as Yt,ai as Kt,A as et,b as f,a as w,o as T,H as Z,E as Xt,h as n,aj as Jt,n as p,d as st,a3 as Zt,g as at,I as te,J as it,G as ee,t as se,af as ae,z as x}from"./iframe-Cgb25FAf.js";import{w as ie}from"./popover.component-DQkEdnnK.js";import{a as oe}from"./dropdown.component-0WCxDO54.js";import"./menu-heading.component-ln6gUQQo.js";import{a as re,G as ne}from"./context-menu.component-jVaNmdpC.js";import"./alert.component-COpvfxHj.js";import{G as le}from"./badge.component-Dx4xkmTl.js";import"./blur.component-Ct6HmhL3.js";import"./breadcrumb.component-C9tlDyKU.js";import"./calendar.component-C6pcIAOp.js";import{G as ot}from"./card.component-BjI6ZEIh.js";import"./card-linked.component-BGRGRslC.js";import"./checkbox-group.component-C5DdEH-k.js";import"./coachmark.component-BU0Zluhf.js";import"./datepicker.component-3sFx-COx.js";import{G as rt}from"./flex.component-CH7tS1-m.js";import{I as de,a as ce,b as he,c as pe,d as ge}from"./zoom-out.component-BLasvQsS.js";import"./divider.component-DjLCKmSB.js";import"./signal.component-CtgXTEWN.js";import"./filter-chips.component-AlaqGaJj.js";import"./summary.component-BHApxdlA.js";import"./grouped-list.component-CiK3I07R.js";import"./icon-CPEuORr1.js";import"./arrow-down.component-CIV10i97.js";import"./arrow-left.component-DqvRcgrK.js";import"./arrow-right.component-BZ4FbuID.js";import"./arrow-rotate-counter-clockwise.component-CtkKhwhG.js";import"./arrow-up.component-e_Jlf31d.js";import"./sun.component-DLBTx_e6.js";import"./star.component-DSp6kgj7.js";import"./bubbles.component-DzKTpciC.js";import"./calender-add.component-d2CNZpw5.js";import"./chain-link-1plG_xKm.js";import"./checkmark.component-9vQhuob0.js";import"./chevron-bottom.component-D-8hYKjb.js";import"./chevron-right-small.component-Rdyr3xgc.js";import"./chevron-left.component-CP32mCJ8.js";import"./chevron-right.component-CRASMOch.js";import"./chevron-top.component-lfRdB_iR.js";import"./circle-check.component-D3df7EKn.js";import"./triangle-exclamation.component-CpG5Du5g.js";import"./circles-three.component-d3hFo1Ex.js";import"./cloudy-sun.component-YU9Gcx7r.js";import"./credit-card.component-DXFfibcJ.js";import{I as ue}from"./cross-small.component-CWVAfpD7.js";import{I as ye}from"./dot-grid-one-horizontal-BZLGlsQV.js";import"./folder.component-BckSp6no.js";import{I as me}from"./magnifying-glass.component-CE5VTtCk.js";import{I as ve}from"./minus-small.component-BZCwRd3E.js";import"./people-profile.component-BAevj7aS.js";import"./push.component-DnnHuDtv.js";import"./rocket.component-oP5VLHT7.js";import"./square-grid-circle.component-DUEi-B7a.js";import{G as fe}from"./img.component-CkH-bWYO.js";import{G as be}from"./input-D-ihfcZY.js";import{G as we}from"./link.component-ezlxo-VL.js";import"./mask.component-CqaJxRVy.js";import"./menu-button.component-CbUHBlzc.js";import{G as xe}from"./pagination-3vlH-dd2.js";import"./radio-group.component-BRIoZ0jt.js";import"./rich-text.component-CkK0mPrZ.js";import"./segmented-control.component-BP5B8c8Y.js";import"./sensitive-number.component-Cau-2JF7.js";import"./sensitive-date.component-DwH-67ij.js";import"./sensitive-account.component-B93embZN.js";import"./select.component-COW_twVR.js";import"./spinner.component-B79hU7EP.js";import{G as ke}from"./text-8IpRrfg8.js";import"./textarea.component-C91Glwyr.js";import"./video.component-B0JKtDaA.js";import"./card-pattern-01.component-nT1B8Vx7.js";import{c as $e}from"./rbcb-toggle.template--9Lf0hOp.js";import{d as _e}from"./formatted-date.component-DHtNkJQd.js";import{a as Se}from"./formatted-account-D5e9vC_7.js";import{n as Ce}from"./formatted-number-CRjIfNMc.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const nt="important",ze=" !"+nt,Ee=Ht(class extends Qt{constructor(t){var e;if(super(t),t.type!==qt.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,s)=>{const i=t[s];return i==null?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:s}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?s.removeProperty(i):s[i]=null);for(const i in e){const r=e[i];if(r!=null){this.ft.add(i);const l=typeof r=="string"&&r.endsWith(ze);i.includes("-")||l?s.setProperty(i,l?r.slice(0,-11):r,l?nt:""):s[i]=r}}return Ut}}),je=H`
...
`,Be=[se,ae,We],Oe=[it,ot,fe,re,ne,oe,be,xe,ke,le,we,rt,ce,ue,ve,me,he,pe,ge,ye];var Le=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,ct=t=>{throw TypeError(t)},c=(t,e,s,i)=>{for(var r=i>1?void 0:i?Re(e,s):e,l=t.length-1,h;l>=0;l--)(h=t[l])&&(r=(i?h(e,s,r):h(r))||r);return i&&r&&Le(e,s,r),r},ht=(t,e,s)=>e.has(t)||ct("Cannot "+s),y=(t,e,s)=>(ht(t,e,"read from private field"),s?s.call(t):e.get(t)),D=(t,e,s)=>e.has(t)?ct("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),o=(t,e,s)=>(ht(t,e,"access private method"),s),I,U,G,a,F,P,pt,R,gt,k,N,_,ut,yt,mt,vt,ft,bt,wt,xt,kt,$t,_t,St,Ct,zt,V,Et,jt,Gt,Dt,At,Mt,Tt,It,Y,Pt,Wt,Bt,Ot,Lt,Rt,K,X,S;let d=class extends et{constructor(){super(...arguments),D(this,a),D(this,I,{}),D(this,U,300*1e3),D(this,G,new Map),this.options=[5,10,20,50,100],this.page=1,this.rows=10,this.columns=[],this.density="comfortable",this.selectable=!1,this.responsive=!1,this.plain=!1,this.searchable=!1,this.settings=!1,this.striped=!1,this.nocache=!1,this._isMobile=!1,this.view={page:this.page,rows:this.rows,searchQuery:"",visibleColumns:new Set},this.loaded=!0,this.loading=!1,this.rowsState=[],this.total=0,this.selected=new Set,this.error=null}_handleMobile(t){this._isMobile=t}async connectedCallback(){super.connectedCallback(),this.view={...this.view,page:Number(this.page??1),rows:Number(this.rows??10),visibleColumns:new Set(this.columns.map(t=>t.key))},await o(this,a,k).call(this)}render(){const t={table:!0,plain:this.plain,striped:this.striped,[this.density]:this.density};return n`
      <div class="${w(t)}">
        ${o(this,a,vt).call(this)}
        ${f(this.error,()=>o(this,a,At).call(this),()=>f(this.rowsState.length===0&&!this.loading,()=>o(this,a,Mt).call(this),()=>o(this,a,Dt).call(this)))}
        ${o(this,a,Tt).call(this)}
      </div>
    `}clearSelection(){o(this,a,X).call(this),o(this,a,S).call(this)}selectAll(){o(this,a,K).call(this),o(this,a,S).call(this)}setSelection(t){const e=t.filter(s=>s>=0&&s<this.rowsState.length);this.selected=new Set(e),o(this,a,S).call(this),this.requestUpdate()}getSelection(){const t=Array.from(this.selected);return{indices:t,data:t.map(e=>this.rowsState[e])}}};I=new WeakMap;U=new WeakMap;G=new WeakMap;a=new WeakSet;F=function(){return this.selected.size>0};P=function(){return this.rowsState.length>0&&this.selected.size===this.rowsState.length};pt=function(){return y(this,a,F)&&!y(this,a,P)};R=function(){return JSON.stringify({page:this.view.page,rows:this.view.rows,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery})};gt=function(t){return Date.now()-t.timestamp<y(this,U)};k=async function(){if(this.data){if(!this.nocache){const t=o(this,a,R).call(this),e=y(this,I)[t];if(e&&o(this,a,gt).call(this,e)){this.rowsState=e.rows,this.total=e.total,this.loaded=!1;return}}this.loading=!0,this.error=null;try{const t=await this.data({page:this.view.page,rows:this.view.rows,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery});if(!this.nocache){const e=o(this,a,R).call(this);y(this,I)[e]={rows:t.rows,total:t.total,timestamp:Date.now()}}this.rowsState=t.rows,this.total=t.total,this.selected.clear(),this.loaded=!1,this.dispatchEvent(new CustomEvent("gds-table-data-loaded",{detail:t,bubbles:!0}))}catch(t){this.error=t,this.dispatchEvent(new CustomEvent("gds-table-data-error",{detail:t,bubbles:!0}))}finally{this.loading=!1}}};N=function(t){var e;if(!t)return null;if(!y(this,G).has(t)){const s=this.querySelector(`template[name="${t}"]`);y(this,G).set(t,s)}return(e=y(this,G).get(t))==null?void 0:e.content.cloneNode(!0)};_=function(t,e){if(!t)return null;if(Array.isArray(t))return t.map(i=>o(this,a,_).call(this,i,e));const s=i=>typeof i=="function"?i(e):i;switch(t.type){case"badge":{const i=s(t.variant)||"information",r=s(t.size)||"small";return n`
          <gds-badge size="${r}" variant="${i}">
            ${s(t.value)}
          </gds-badge>
        `}case"image":{const i=s(t.src);if(!i)return null;const r=s(t.width)||"24px",l=s(t.height)||"24px",h=s(t["border-radius"])||"max",g=s(t["object-fit"])||"cover",C=s(t.alt)||"";return n`
          <gds-img
            src="${i}"
            alt="${C}"
            width="${r}"
          ...
          ></gds-img>
        `}case"button":{const i=s(t.size),r=s(t.variant),l=s(t.rank),h=s(t.label),g=s(t.template),C=o(this,a,N).call(this,g);return n`
          <gds-button
            size="${i||"small"}"
            variant="${r||"neutral"}"
            rank="${l||"secondary"}"
        ...
        `}case"link":{const i=s(t.href);if(!i)return null;const r=s(t.label),l=s(t.target),h=s(t.download),g=s(t.template),C=o(this,a,N).call(this,g),J=[r,C];return n`
          <gds-link
            href=${T(i)}
            target=${T(l)}
            .download=${h}
        ...
        `}case"formatted-number":{const i=s(t.value),r=Ce[t.format||"decimalsAndThousands"];return r(i,t.locale,t.currency)}case"formatted-account":{const i=s(t.value),r=Se[t.format||"seb-account"];return r(i)}case"formatted-date":{const i=s(t.value),r=_e[t.format||"dateLong"];return r(i,t.locale)}default:return null}};ut=function(t,e){const{cell:s}=e,i=o(this,a,_).call(this,s==null?void 0:s.value,t)??t[e.key],r=e.justify?n`<span>${i}</span>`:i,l=this._isMobile&&this.responsive,h=l?n`<span class="column-label" aria-hidden="true"
          >${e.label}:</span
        >`:null,g=l?`${e.label}: `:"";return n`
      <div class="cell-content" aria-label="${g}">
        ${[h,o(this,a,_).call(this,s==null?void 0:s.lead,t),r,o(this,a,_).call(this,s==null?void 0:s.trail,t)]}
      </div>
    `};yt=function(t){const e=this.view.sortColumn===t.key,s=this.view.sortDirection;return e?s==="asc"?n`<gds-icon-sort-up size="m"></gds-icon-sort-up>`:n`<gds-icon-sort-down size="m"></gds-icon-sort-down>`:n`<gds-icon-sort-up size="m"></gds-icon-sort-up>`};mt=function(){return this.searchable||this.settings||this.querySelector('[slot="header-lead"]')||this.querySelector('[slot="header-trail"]')};vt=function(){return this.plain||!o(this,a,mt).call(this)?null:n`
      <div class="header">
        <div class="lead">
          ${f(this.searchable,()=>n`
              <gds-input
    ...
    `};ft=function(t){const e=this.view.sortColumn===t.key,s=this.view.sortDirection,i=w({sortable:!!t.sortable,sorted:e,"sort-asc":e&&s==="asc","sort-desc":e&&s==="desc",[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify});return n`
      <th
        class=${i}
        @click=${t.sortable?()=>o(this,a,Pt).call(this,t.key):null}
      >
        <div class="column-header">
          <span class="column-label">${t.label}</span>
          ${f(t.sortable,()=>n`
              <span class="sort-icon">${o(this,a,yt).call(this,t)}</span>
            `)}
        </div>
      </th>
    ...
    `};wt=function(){return this.selectable?n`
      <th class="checkbox-cell">
        ${o(this,a,V).call(this,{checked:y(this,a,P),indeterminate:y(this,a,pt),ariaLabel:"Select all rows",onToggle:()=>o(this,a,Lt).call(this,{})})}
      </th>
    `:null};xt=function(){return this.columns.filter(t=>this.view.visibleColumns.has(t.key)).map(t=>o(this,a,ft).call(this,t))};kt=function(){return n`
      <thead>
        <tr>
    ...
    `};_t=function(t){return this.selectable?n`
      <td class="checkbox-cell" data-label="Select">
        ${o(this,a,V).call(this,{checked:this.selected.has(t),indeterminate:!1,ariaLabel:`Select row ${t+1}`,onToggle:()=>o(this,a,Rt).call(this,t,{detail:{checked:!this.selected.has(t)}})})}
      </td>
    ...
    `};V=function({checked:t,indeterminate:e=!1,disabled:s=!1,ariaLabel:i,onToggle:r}){const l=g=>{g.stopPropagation(),!s&&r()};return n`
      <div
        class="rbcb-wrapper"
        role="checkbox"
    ...
    `};Gt=function(){if(this.loading&&this.loaded){const t=Array.from({length:this.view.rows},(e,s)=>o(this,a,jt).call(this,s));return n`<tbody>
        ${t}
      </tbody>`}return n`
      <tbody>
    ...
    `};Dt=function(){const t=w({responsive:this.responsive,data:!0});return n`
      <div class=${t}>
        <table>
          ${o(this,a,kt).call(this)} ${o(this,a,Gt).call(this)}
        </table>
      </div>
    ...
    `};Mt=function(){const t=this.view.searchQuery.length>0;return n`
      <gds-card justify-content="space-between" align-items="flex-start">
        ...
        ${t?n`
              <gds-button size="small" @click=${o(this,a,Y)}>
                Clear search
              </gds-button>
            `:""}
      </gds-card>
