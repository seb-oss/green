import{i as O,Y as $,A as P,$ as W,h as V,t as B,n as g,g as I,K as T,L as G,H as z,d as S,z as L,a4 as D,I as N}from"./iframe-DY2A4jpf.js";import{r as R}from"./resize-observer-B9k8v2TZ.js";import{I as A}from"./chevron-left.component-z47B9Dz4.js";import{I as X}from"./chevron-right.component-BgbLWKj7.js";const F=O`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var H=Object.defineProperty,K=Object.getOwnPropertyDescriptor,v=(e,t,s,i)=>{for(var r=i>1?void 0:i?K(t,s):t,a=e.length-1,h;a>=0;a--)(h=e[a])&&(r=(i?h(t,s,r):h(r))||r);return i&&r&&H(t,s,r),r};let u=class extends $(P){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),W.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return V`<button
    ...
    >
      <slot></slot>
    </button>`}};u.styles=[...B,F];v([g({type:Boolean,reflect:!0})],u.prototype,"selected",2);v([g()],u.prototype,"value",2);v([g({type:Boolean,reflect:!0})],u.prototype,"disabled",2);u=v([I("gds-segment")],u);const Y=O`
  @layer base {
    :host {
