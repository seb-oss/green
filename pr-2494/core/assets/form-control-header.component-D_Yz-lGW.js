import{i as w,E as P}from"./lit-element-Bx14lxc-.js";import{n as y,r as z}from"./Reflect-DJ7r0WLU.js";import{n as C}from"./when-BR7zwNJC.js";import{G as W}from"./badge.component-DLw689zn.js";import{I as B,a as F}from"./triangle-exclamation.component-DxeFxi9C.js";import{G as b,h as i,g as E}from"./gds-element-DTROifYq.js";import{w as _}from"./watch-tFciLXSI.js";import{l as D,m as H}from"./runtime-CNluP0A8.js";import{a as I}from"./query-p8xgzTDt.js";import{G as A}from"./button.component-C2sgS_dm.js";import{G as L}from"./card.component-BxcB0340.js";const V=w`
...
`;var R=Object.defineProperty,j=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},x=(e,t,s,a)=>{for(var r=a>1?void 0:a?j(t,s):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(r=(a?o(t,s,r):o(r))||r);return a&&r&&R(t,s,r),r},q=(e,t,s)=>t.has(e)||S("Cannot "+s),J=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),K=(e,t,s)=>(q(e,t,"access private method"),s),v,T;let d=class extends b{constructor(){super(...arguments),J(this,v)}_handleVisibilityChange(){var e;this.classList.toggle("visually-hidden",!this.errorMessage&&!((e=this.charCounter)!=null&&e[1]))}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return i`<div aria-live="polite">
