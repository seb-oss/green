import{i as Z,t as j,af as ce,n,a2 as T,A as ee,Y as te,b as u,h as c,g as R,d as se,N as ue,U as ge,L as fe,K as be,a3 as ve,o as me,H as E,a1 as ye,E as _e,ac as xe,I as we}from"./iframe-r7XMIE4J.js";import{r as $e}from"./query-async-lJHlyKSe.js";import{o as Ce,f as Ee}from"./floating-ui.dom-B1INwmQZ.js";import{f as ke,G as Me}from"./form-control-host.style-B7GKWRMf.js";import{G as Se,a as Le}from"./form-control-header.component-DaAg-LUB.js";import{n as We,e as Te}from"./ref-DJdAQIzE.js";import{s as Oe,F as Ae,L as Pe,u as De}from"./unwrap-slots-D22TuX6z.js";import{I as ie}from"./checkmark.component-BlXnxEUS.js";import{c as Be}from"./rbcb-toggle.template-CySK5B1I.js";import{I as Fe}from"./chevron-bottom.component-C-zV_t0u.js";import{I as ze}from"./cross-small.component-Cpsdrirn.js";import{G as ae}from"./popover.component-BnZn75IU.js";const Ie=Z`
...
`;var Ge=Object.defineProperty,He=Object.getOwnPropertyDescriptor,oe=e=>{throw TypeError(e)},_=(e,t,s,l)=>{for(var i=l>1?void 0:l?He(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&Ge(t,s,i),i},U=(e,t,s)=>t.has(e)||oe("Cannot "+s),N=(e,t,s)=>(U(e,t,"read from private field"),s?s.call(e):t.get(e)),Y=(e,t,s)=>t.has(e)?oe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Ve=(e,t,s,l)=>(U(e,t,"write to private field"),t.set(e,s),s),X=(e,t,s)=>(U(e,t,"access private method"),s),x,S,P;let g=class extends Ae(ee){constructor(){super(),Y(this,S),Y(this,x,!1),this.selected=!1,this.isPlaceholder=!1,this.addEventListener("click",X(this,S,P)),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),X(this,S,P).call(this,e))})}get hidden(){return N(this,x)}set hidden(e){const t=e.toString();Ve(this,x,t==="true"),N(this,x)?this.setAttribute("inert",""):this.removeAttribute("inert")}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.updateComplete.then(()=>{this.isPlaceholder&&(this.hidden=!0),te.instance.apply(this,"gds-option")})}get parentElement(){return super.parentElement}_handlePlaceholderStatusChange(){this.isPlaceholder?this.hidden=!0:this.hidden=!1}render(){var t;const e=(t=this.parentElement)==null?void 0:t.multiple;return e||(this.selected?this.setAttribute("highlighted",""):this.removeAttribute("highlighted")),c`<div class="item">
      ${u(e,()=>Be({checked:this.selected,indeterminate:!1,disabled:!1,invalid:!1}))} <slot></slot>
    </div>`}};x=new WeakMap;S=new WeakSet;P=function(e){e.stopPropagation(),this.dispatchCustomEvent("gds-select",{bubbles:!0,composed:!0,detail:{value:this.value}})};g.styles=[j,ce,Oe];_([n()],g.prototype,"value",2);_([n({type:Boolean,reflect:!0})],g.prototype,"hidden",1);_([n({attribute:"aria-selected",reflect:!0})],g.prototype,"selected",2);_([n({type:Boolean,reflect:!0})],g.prototype,"isPlaceholder",2);_([T("isPlaceholder")],g.prototype,"_handlePlaceholderStatusChange",1);g=_([R("gds-option",{dependsOn:[ie]})],g);var qe=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,re=e=>{throw TypeError(e)},O=(e,t,s,l)=>{for(var i=l>1?void 0:l?Re(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&qe(t,s,i),i},Ue=(e,t,s)=>t.has(e)||re("Cannot "+s),k=(e,t,s)=>(Ue(e,t,"read from private field"),s?s.call(e):t.get(e)),J=(e,t,s)=>t.has(e)?re("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),w,D;let v=class extends ee{constructor(){super(),this.multiple=!1,this.compareWith=(e,t)=>e===t,J(this,w,Te()),J(this,D,e=>{const t=e.target;this.multiple?t.selected=!t.selected:(t.selected=!0,Array.from(this.options).forEach(s=>{s!==t&&(s.selected=!1)})),this.ariaActiveDescendantElement=t,this.dispatchCustomEvent("change",{bubbles:!1,composed:!1})}),new Pe(this)}get navigableItems(){return this.visibleOptionElements}get options(){return k(this,w).value?De(k(this,w).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-option")||[]:[]}get visibleOptionElements(){return this.options.filter(e=>!e.hidden)}get visibleSelectedOptionElements(){return this.options.filter(e=>e.selected&&!e.hidden)}get selection(){return this.options.filter(e=>e.selected)}set selection(e){this.options.forEach(t=>{t.selected=e.some(s=>this.compareWith(s,t.value))})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox"),te.instance.apply(this,"gds-listbox"),this.addEventListener("gds-select",k(this,D))}focus(){var e;(e=this.visibleSelectedOptionElements[0]||this.visibleOptionElements[0])==null||e.focus()}render(){return c`<slot ${We(k(this,w))}></slot>`}_rerenderOptions(){this.options.forEach(e=>{e.requestUpdate()})}};w=new WeakMap;D=new WeakMap;v.styles=Ie;O([n({type:Boolean,reflect:!0,attribute:"aria-multiselectable",converter:{fromAttribute:Boolean,toAttribute:e=>e.toString()}})],v.prototype,"multiple",2);O([n()],v.prototype,"compareWith",2);O([T("multiple")],v.prototype,"_rerenderOptions",1);v=O([R("gds-listbox",{dependsOn:[g]})],v);const Ke=Z`
  @layer base, reset;
...
`;var Ne=Object.defineProperty,Ye=Object.getOwnPropertyDescriptor,le=e=>{throw TypeError(e)},r=(e,t,s,l)=>{for(var i=l>1?void 0:l?Ye(t,s):t,h=e.length-1,p;h>=0;h--)(p=e[h])&&(i=(l?p(t,s,i):p(i))||i);return l&&i&&Ne(t,s,i),i},K=(e,t,s)=>t.has(e)||le("Cannot "+s),a=(e,t,s)=>(K(e,t,"read from private field"),t.get(e)),d=(e,t,s)=>t.has(e)?le("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Xe=(e,t,s,l)=>(K(e,t,"write to private field"),t.set(e,s),s),M=(e,t,s)=>(K(e,t,"access private method"),s),b,m,ne,B,F,L,z,f,I,G,W,H,V,q,he,$,C,de,pe,y,A;let o=class extends ve{constructor(){super(...arguments),d(this,m),this.supportingText="",this.open=!1,this.searchable=!1,this.multiple=!1,this.clearable=!1,this.combobox=!1,this.compareWith=(e,t)=>e===t,this.searchFilter=(e,t)=>t.innerHTML.toLowerCase().includes(e.toLowerCase()),this.syncPopoverWidth=!1,this.maxHeight=500,this.size="medium",this.hideLabel=!1,this.plain=!1,this.disableMobileStyles=!1,this.showExtendedSupportingText=!1,d(this,b),d(this,B,()=>{var e;return c`
      <input
        id="trigger"
        role="combobox"
