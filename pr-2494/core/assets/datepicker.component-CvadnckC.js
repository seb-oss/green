import{m as p,l as Ot}from"./runtime-CNluP0A8.js";import{T as tt,i as Rt,E as Ft}from"./lit-element-Bx14lxc-.js";import{n as m,r as Z}from"./Reflect-DJ7r0WLU.js";import{e as Ht,a as _t}from"./query-p8xgzTDt.js";import{r as J}from"./query-async-MEroNOeJ.js";import{e as Yt,i as qt,t as Kt}from"./directive-CF8sV3Lr.js";import{p as Xt,v as E,r as N,M as Q,m as Ut,i as Zt}from"./directive-helpers-BF33kFuJ.js";import{f as Jt}from"./ref-R0wBYijq.js";import{n as I}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-D-n6FD2-.js";import{G as te}from"./dropdown.component-CXYdru9b.js";import{G as ee}from"./flex.component-BYRotL8F.js";import{G as se,h as w,g as Wt}from"./gds-element-DTROifYq.js";import{f as ae}from"./form-control-host.style-CZYByobw.js";import{t as ie}from"./tokens.style-CQAfIFlK.js";import{T as ne}from"./transitional-styles-UDysEBZS.js";import{w as $t}from"./watch-tFciLXSI.js";import{d as bt,a as re}from"./attribute-converters-CdI0trPX.js";import{w as oe,b as le,d as he}from"./declarative-layout-mixins-C4FFYA_h.js";import{G as de,i as ue}from"./calendar.component-Cn-KsV9B.js";import{I as pe,a as ce}from"./calender-add.component-CkVhoyuE.js";import{I as ge}from"./chevron-left.component-BZOFTbc9.js";import{I as fe}from"./chevron-right.component-BzjFbutM.js";import{G as me}from"./popover.component-D6JhbD8X.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},be=Yt(class extends qt{constructor(t){if(super(t),t.type!==Kt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let h=0;for(const c of t)a[h]=i?i(c,h):h,n[h]=s(c,h),h++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Xt(t),{values:n,keys:h}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=h,n;const c=this.ut??(this.ut=[]),r=[];let k,M,d=0,b=a.length-1,v=0,C=n.length-1;for(;d<=b&&v<=C;)if(a[d]===null)d++;else if(a[b]===null)b--;else if(c[d]===h[v])r[v]=E(a[d],n[v]),d++,v++;else if(c[b]===h[C])r[C]=E(a[b],n[C]),b--,C--;else if(c[d]===h[C])r[C]=E(a[d],n[C]),N(t,r[C+1],a[d]),d++,C--;else if(c[b]===h[v])r[v]=E(a[b],n[v]),N(t,a[d],a[b]),b--,v++;else if(k===void 0&&(k=kt(h,v,C),M=kt(c,d,b)),k.has(c[d]))if(k.has(c[b])){const S=M.get(h[v]),j=S!==void 0?a[S]:null;if(j===null){const Ct=N(t,a[d]);E(Ct,n[v]),r[v]=Ct}else r[v]=E(j,n[v]),N(t,a[d],j),a[S]=null;v++}else Q(a[b]),b--;else Q(a[d]),d++;for(;v<=C;){const S=N(t,r[C+1]);E(S,n[v]),r[v++]=S}for(;d<=b;){const S=a[d++];S!==null&&Q(S)}return this.ut=h,Ut(t,r),tt}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mt=t=>!Zt(t)&&typeof t.then=="function",Dt=1073741823;class Ce extends Jt{constructor(){super(...arguments),this._$Cwt=Dt,this._$Cbt=[],this._$CK=new we(this),this._$CX=new xe}render(...e){return e.find(s=>!Mt(s))??tt}update(e,s){const i=this._$Cbt;let a=i.length;this._$Cbt=s;const n=this._$CK,h=this._$CX;this.isConnected||this.disconnected();for(let c=0;c<s.length&&!(c>this._$Cwt);c++){const r=s[c];if(!Mt(r))return this._$Cwt=c,r;c<a&&r===i[c]||(this._$Cwt=Dt,a=0,Promise.resolve(r).then(async k=>{for(;h.get();)await h.get();const M=n.deref();if(M!==void 0){const d=M._$Cbt.indexOf(r);d>-1&&d<M._$Cwt&&(M._$Cwt=d,M.setValue(k))}}))}return tt}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const ke=Yt(Ce);var Me=Object.defineProperty,De=Object.getOwnPropertyDescriptor,It=t=>{throw TypeError(t)},P=(t,e,s,i)=>{for(var a=i>1?void 0:i?De(e,s):e,n=t.length-1,h;n>=0;n--)(h=t[n])&&(a=(i?h(e,s,a):h(a))||a);return i&&a&&Me(e,s,a),a},wt=(t,e,s)=>e.has(t)||It("Cannot "+s),_=(t,e,s)=>(wt(t,e,"read from private field"),s?s.call(t):e.get(t)),F=(t,e,s)=>e.has(t)?It("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),Et=(t,e,s,i)=>(wt(t,e,"write to private field"),e.set(t,s),s),x=(t,e,s)=>(wt(t,e,"access private method"),s),W,V,O,R,H,et,st,at,$,Tt,z,it,L,q;let D=class extends se{constructor(){super(...arguments),F(this,$),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=x(this,$,it).call(this,this.value,this.length),F(this,W,""),F(this,V,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=x(this,$,L).call(this,t+1),x(this,$,z).call(this)}),F(this,O,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=x(this,$,L).call(this,t-1),x(this,$,z).call(this)}),F(this,R,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),F(this,H,()=>{x(this,$,q).call(this)}),F(this,et,()=>{_(this,W)!==""&&(x(this,$,q).call(this),this.value=x(this,$,L).call(this,parseInt(this.value.toString())),x(this,$,z).call(this))}),F(this,st,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?_(this,O).call(this):_(this,V).call(this)}),F(this,at,t=>{let e=!1;if(t.key==="ArrowUp")_(this,V).call(this),e=!0;else if(t.key==="ArrowDown")_(this,O).call(this),e=!0;else{const s=parseInt(t.key);isNaN(s)||(_(this,W).length<this.length&&(Et(this,W,_(this,W)+s.toString()),this.value=parseInt(_(this,W))),_(this,W).length===this.length&&(this.value=x(this,$,L).call(this,this.value),x(this,$,q).call(this),x(this,$,Tt).call(this),x(this,$,z).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",_(this,st)),this.addEventListener("keydown",_(this,at)),this.addEventListener("blur",_(this,et)),this.addEventListener("focus",_(this,H)),this.addEventListener("click",_(this,R)),this.addEventListener("mousedown",_(this,R))}focus(t){super.focus(t),_(this,H).call(this)}render(){return w`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=x(this,$,it).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};W=new WeakMap;V=new WeakMap;O=new WeakMap;R=new WeakMap;H=new WeakMap;et=new WeakMap;st=new WeakMap;at=new WeakMap;$=new WeakSet;Tt=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof D){t.focus();break}t=t.nextElementSibling}};z=function(){this.dispatchCustomEvent("change",{detail:{value:this.value.toString()}})};it=function(t,e){return String(t).padStart(e,"0")};L=function(t){return Math.max(this.min,Math.min(this.max,t))};q=function(){Et(this,W,"")};D.formAssociated=!0;P([m({type:Number})],D.prototype,"value",2);P([m({type:Number})],D.prototype,"length",2);P([m({type:Number,attribute:"aria-valuemin"})],D.prototype,"min",2);P([m({type:Number,attribute:"aria-valuemax"})],D.prototype,"max",2);P([Z()],D.prototype,"displayValue",2);P([$t("value")],D.prototype,"_refreshDisplayValue",1);D=P([Wt("gds-date-part-spinner")],D);const Se=Rt`
  @layer base, reset;
        ...
        <gds-div overflow="auto">
          ...
          >
            ...
            <gds-dropdown
              ...
              hide-label
            >
              ${be(g(this,u,Gt),t=>t,t=>w`<gds-option value=${t}>${t}</gds-option>`)}
            </gds-dropdown>
            <gds-button
              @click=${g(this,ct)}
