import{m as b,s as G}from"./runtime-CNluP0A8.js";import{i as k,E}from"./lit-element-Bx14lxc-.js";import{n as x}from"./Reflect-DJ7r0WLU.js";import{r as S}from"./query-async-MEroNOeJ.js";import{m as M}from"./datepicker.component-BC2VDONu.js";import{n as _}from"./when-BR7zwNJC.js";import{G as O,h as p,g as A}from"./gds-element-DTROifYq.js";import{t as F}from"./tokens.style-CQAfIFlK.js";import{G as B}from"./button.component-D-n6FD2-.js";import{G as I}from"./card.component-eDIV52nF.js";import{G as R}from"./div.component-D6IvvHfw.js";import{G as T}from"./flex.component-BYRotL8F.js";import{I as D}from"./arrow-up.component-wkZ6j9H5.js";const P=k`
  :host {
    display: contents;
  }
  ul {
...
`;var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,C=e=>{throw TypeError(e)},g=(e,r,t,s)=>{for(var o=s>1?void 0:s?q(r,t):r,m=e.length-1,h;m>=0;m--)(h=e[m])&&(o=(s?h(r,t,o):h(o))||o);return s&&o&&W(r,t,o),o},v=(e,r,t)=>r.has(e)||C("Cannot "+t),d=(e,r,t)=>(v(e,r,"read from private field"),r.get(e)),f=(e,r,t)=>r.has(e)?C("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),w=(e,r,t,s)=>(v(e,r,"write to private field"),r.set(e,t),t),l=(e,r,t)=>(v(e,r,"access private method"),t),a,c,i,y,u,$;let n=class extends O{constructor(){super(...arguments),f(this,i),this.hideErrors=!1,this.reactive=!1,f(this,a),f(this,c)}get errorCount(){return l(this,i,u).call(this).length}focus(e){this._elRoot.then(r=>{const t=r.querySelector('[gds-element="gds-button"]');t&&t.focus(e)})}connectedCallback(){super.connectedCallback(),w(this,a,this.closest("form")||void 0),d(this,a)&&this.reactive&&(w(this,c,new MutationObserver(()=>{this.refresh()})),d(this,c).observe(d(this,a),{attributes:!0,subtree:!0}))}disconnectedCallback(){var e;super.disconnectedCallback(),(e=d(this,c))==null||e.disconnect()}refresh(){this.requestUpdate()}render(){const e=l(this,i,y).call(this),r=l(this,i,u).call(this);return _(r.length>0,()=>p`<gds-card
        ...
        </gds-card>`)}};a=new WeakMap;c=new WeakMap;i=new WeakSet;y=function(){var e;return Array.from(((e=d(this,a))==null?void 0:e.elements)||[]).filter(r=>r.gdsElementName!=="gds-checkbox")};u=function(){return l(this,i,y).call(this).filter(e=>e.ariaInvalid==="true"||e.invalid)};$=async function(e){const r=(await this._elRoot).getBoundingClientRect().top;return e.getBoundingClientRect().top<r?p`<gds-icon-arrow-up></gds-icon-arrow-up>`:p`<gds-icon-arrow-up
          style="transform: rotate(180deg)"
        ></gds-icon-arrow-up>`};n.styles=[F,P];g([x({type:Boolean})],n.prototype,"hideErrors",2);g([x({type:Boolean})],n.prototype,"reactive",2);g([S("#root")],n.prototype,"_elRoot",2);n=g([A("gds-form-summary",{dependsOn:[I,T,R,B,D]})],n);export{n as G};
