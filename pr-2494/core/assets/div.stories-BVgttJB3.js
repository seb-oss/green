import{x as j}from"./iframe-DyW__FZF.js";import"./div-DWFV66k2.js";import"./flex-CGZZO7Lb.js";import"./card-BTBxvP8R.js";import{a as B}from"./argTableProps-CpdL1r2q.js";import"./preload-helper-Dp1pzeXC.js";import"./flex.component-6U2HR6bt.js";import"./card.component-D_EhMNoA.js";const I={title:"Components/Div",component:"gds-div",tags:["autodocs"],argTypes:{...B("gds-div")},parameters:{docs:{description:{component:"`gds-div` is a base element in the declarative layout system.\n\nDiv accepts all available style expression properties, and is also the base class for `gds-flex`, `gds-grid`, `gds-card` and `gds-text`"}}}},t={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},s={...t,args:{background:"01",border:"2xs","border-radius":"m","border-color":"subtle-01",width:"4xl",height:"4xl"}},r={...t,render:S=>j`
