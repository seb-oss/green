import{$ as k,h,A as C,g as E,L as M,K as D,H as T,b as S,t as W,n as v,d as I,a4 as z,I as B,J as R}from"./iframe-DY2A4jpf.js";import{s as F,F as H,L as N,u as q}from"./unwrap-slots-Ww67ib0d.js";import{n as K,e as U}from"./ref-BBzhowOZ.js";import{I as J}from"./dot-grid-one-horizontal-CTux_s6B.js";import{a as Q,G as V}from"./popover.component-Wm19tyIx.js";import"./menu-heading.component-CqF3IA7w.js";var X=Object.getOwnPropertyDescriptor,P=e=>{throw TypeError(e)},Y=(e,t,s,n)=>{for(var a=n>1?void 0:n?X(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(a)||a);return a},Z=(e,t,s)=>t.has(e)||P("Cannot "+s),j=(e,t,s)=>(Z(e,t,"read from private field"),s?s.call(e):t.get(e)),ee=(e,t,s)=>t.has(e)?P("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),f;let g=class extends H(C){constructor(){super(...arguments),ee(this,f,()=>{this.dispatchCustomEvent("gds-menu-item-click",{bubbles:!0,composed:!0})})}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menuitem"),this.addEventListener("keydown",e=>{e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),this.click())}),this.addEventListener("click",j(this,f)),k.instance.apply(this,"gds-option")}render(){return h`<div class="item"><slot></slot></div>`}};f=new WeakMap;g.styles=[F];g=Y([E("gds-menu-item")],g);var te=Object.getOwnPropertyDescriptor,x=e=>{throw TypeError(e)},se=(e,t,s,n)=>{for(var a=n>1?void 0:n?te(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=i(a)||a);return a},ae=(e,t,s)=>t.has(e)||x("Cannot "+s),_=(e,t,s)=>(ae(e,t,"read from private field"),s?s.call(e):t.get(e)),ne=(e,t,s)=>t.has(e)?x("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),u;let y=class extends C{constructor(){super(),ne(this,u,U()),new N(this)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu"),k.instance.apply(this,"gds-listbox")}get navigableItems(){return _(this,u).value?q(_(this,u).value).assignedElements().filter(e=>!e.hasAttribute("isplaceholder")&&e.gdsElementName==="gds-menu-item")||[]:[]}focus(){var e;(e=this.navigableItems[0])==null||e.focus()}render(){return h`<slot ${K(_(this,u))}></slot>`}};u=new WeakMap;y=se([E("gds-menu",{dependsOn:[g]})],y);var re=Object.defineProperty,oe=Object.getOwnPropertyDescriptor,A=e=>{throw TypeError(e)},d=(e,t,s,n)=>{for(var a=n>1?void 0:n?oe(t,s):t,r=e.length-1,i;r>=0;r--)(i=e[r])&&(a=(n?i(t,s,a):i(a))||a);return n&&a&&re(t,s,a),a},L=(e,t,s)=>t.has(e)||A("Cannot "+s),l=(e,t,s)=>(L(e,t,"read from private field"),s?s.call(e):t.get(e)),c=(e,t,s)=>t.has(e)?A("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),O=(e,t,s,n)=>(L(e,t,"write to private field"),t.set(e,s),s),ie=(e,t,s)=>(L(e,t,"access private method"),s),p,w,m,b,$,G;let o=class extends M(D(C)){constructor(){super(...arguments),c(this,$),this.open=!1,this.buttonLabel=T("Open context menu"),this.showLabel=!1,this.label="",this.placement="bottom-start",c(this,p),c(this,w,()=>{var t;l(this,p)||O(this,p,((t=this.shadowRoot)==null?void 0:t.querySelector("#trigger"))??void 0);const e=l(this,p);e&&!e.hasAttribute("data-gds-context-menu-trigger")&&(e.setAttribute("data-gds-context-menu-trigger","true"),e.addEventListener("click",()=>{this.open=!this.open}),e.addEventListener("keydown",s=>{(s.key==="ArrowDown"||s.key==="Enter"||s.key===" ")&&(s.preventDefault(),this.open=!0)}),Q(e,this.open,"menu"))}),c(this,m,()=>{const e=this._elTriggerSlot.assignedNodes({flatten:!0}).find(t=>t instanceof HTMLElement);e&&O(this,p,e),l(this,w).call(this)}),c(this,b,()=>h`<gds-popover
      id="menu"
      autofocus
      .open=${this.open}
