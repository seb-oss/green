import{ar as r,n as p,as as H,at as g,au as S,i as v,av as L,aw as Z,ax as G,ay as u,az as $,aA as f,aB as C,f as x,aC as j,aD as D,aE as B,o as m,E as X,D as z,aF as I,X as R,aG as T,R as e,aH as W,aI as s,aJ as N,aK as l,aL as y,aM as _,aN as w,u as P,j as d,M as A}from"./iframe-C2q7SHgj.js";import"./preload-helper-Dp1pzeXC.js";function F(t){var a;class n extends t{constructor(){super(...arguments),H(this,a)}get rel(){return g(this,a)?g(this,a):this.target==="_blank"?"noreferrer noopener":void 0}set rel(M){S(this,a,M)}}return a=new WeakMap,r([p()],n.prototype,"href",2),r([p()],n.prototype,"target",2),r([p()],n.prototype,"rel",1),r([p({type:String})],n.prototype,"download",2),n}const J=v`
  :host {
    --_c: 12;
...
`;var Q=K,h,V;let c=class extends j(D(B(F(I)))){constructor(){super(...arguments),H(this,h),this.label=""}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none")}render(){return z`
      <a
        ...
        download=${m(this.download===!0?"":this.download)}
