import{S as Kt,O as Xt,Q as Zt,al as Jt,i as V,ao as te,Y as ee,a0 as se,ap as ae,A as it,b as _,a as w,o as j,H as p,E as ie,h as l,aq as re,n as u,d as rt,a4 as R,g as ot,I as lt,J as nt,G as oe,t as le,af as ne,s as de,V as ce,z as x}from"./iframe-DyQnbBmV.js";import{w as he}from"./popover.component-CS0EfORc.js";import{a as pe}from"./dropdown.component-BjQ3b5EE.js";import"./menu-heading.component-tHLTF0zX.js";import{a as ue,G as ge}from"./context-menu.component-BssI0Fog.js";import"./alert.component-Cd0L2vaN.js";import{G as me}from"./badge.component-B8xQr0iJ.js";import"./blur.component-CSS6-pBY.js";import"./breadcrumb.component-ClomjS6n.js";import"./calendar.component-CiPFZUJI.js";import{G as dt}from"./card.component-CrS5JGOg.js";import"./card-linked.component-B4xhUGbn.js";import"./checkbox-group.component-_BqZEYVH.js";import"./coachmark.component-bqtCq1vz.js";import"./datepicker.component-BLWAy00x.js";import{G as ct}from"./flex.component-Q4-gstfs.js";import{I as be,a as ye,b as ve,c as fe,d as _e}from"./zoom-out.component-Cw30E99s.js";import"./divider.component-DRZ1OZ-e.js";import"./signal.component-8f0dQnWC.js";import"./filter-chips.component-nAtoSUyq.js";import"./summary.component-DU7O6lSi.js";import"./grouped-list.component-Cd7gS2oj.js";import"./icon.component-B2i-4XQ5.js";import"./arrow-down.component-BrnesnuJ.js";import"./arrow-left.component-Dtj7tOQQ.js";import"./arrow-right.component-CjgX2aqn.js";import"./arrow-rotate-counter-clockwise.component-ul2Y04OU.js";import"./arrow-up.component-CO2GKKvN.js";import"./sun.component-BSEhuNfy.js";import"./star.component-DwdQLNvg.js";import"./bubbles.component-CPgauIGc.js";import"./calender-add.component-DBamkt8g.js";import"./chain-link-CFFY3VO4.js";import"./checkmark.component-Jwofbkkq.js";import"./chevron-bottom.component-WWqQZQte.js";import"./chevron-right-small.component-CVxWiXJR.js";import"./chevron-left.component-dMTtq2gN.js";import"./chevron-right.component-D8oO0yD8.js";import"./chevron-top.component-cthJKGl-.js";import"./circle-check.component-Bqy3CZIJ.js";import"./triangle-exclamation.component-Y7cwv8lB.js";import"./circles-three.component-DdxAR2RE.js";import"./cloudy-sun.component-M0UAoqWm.js";import"./credit-card.component-D0HFg6aU.js";import{I as we}from"./cross-small.component-D-YZIqIE.js";import{I as xe}from"./dot-grid-one-horizontal-OHsuHh8J.js";import"./folder.component-CRuaRV7Y.js";import{I as ke}from"./magnifying-glass.component-B6ouk59J.js";import{I as $e}from"./minus-small.component-CvO-wd4j.js";import"./people-profile.component-C7sCzVLa.js";import"./push.component--WOeM6ZB.js";import"./rocket.component-B-it_fmO.js";import"./square-grid-circle.component-DQRi0XQ0.js";import{G as Se}from"./img.component-DmMj5Njz.js";import{G as Ce}from"./input.component-B5qg3sdS.js";import{G as Ee}from"./link.component-B5EN6sU_.js";import"./mask.component-CzwszKAj.js";import"./menu-button.component-ThSvBIYS.js";import{G as ze}from"./pagination-CFYX8jqM.js";import"./radio-group.component-CnMGggsc.js";import"./rich-text.component-C1B7m63J.js";import"./segmented-control-DLHjLM27.js";import"./sensitive-number.component-D40ruqDj.js";import"./sensitive-date.component-PJhDma4A.js";import"./sensitive-account.component-CzyB1WFf.js";import"./select.component-iWlrhLiE.js";import"./spinner.component-Bz42pXmE.js";import{G as Ae}from"./text-CjR9-kUm.js";import"./textarea.component-DMjJlbJI.js";import"./video.component-EMbjnFHq.js";import"./card-pattern-01.component-BXQ2n6pu.js";import{c as Ie}from"./rbcb-toggle.template-Bj318MYo.js";import{d as Le}from"./formatted-date.component-DOEoORPx.js";import{a as Te}from"./formatted-account-B84URGzx.js";import{n as De}from"./formatted-number-B1qTEEYT.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ht="important",Ge=" !"+ht,Me=Kt(class extends Xt{constructor(t){var e;if(super(t),t.type!==Zt.ATTRIBUTE||t.name!=="style"||((e=t.strings)==null?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,s)=>{const i=t[s];return i==null?e:e+`${s=s.includes("-")?s:s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(t,[e]){const{style:s}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(const i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?s.removeProperty(i):s[i]=null);for(const i in e){const o=e[i];if(o!=null){this.ft.add(i);const n=typeof o=="string"&&o.endsWith(Ge);i.includes("-")||n?s.setProperty(i,n?o.slice(0,-11):o,n?ht:""):s[i]=o}}return Jt}}),Oe=V`
...
`,W=new Set;function Ne(){te.instance.injectGlobalStyles("dialog-scroll-lock",V`
      .gds-scroll-lock body {
        padding-right: var(--gds-scroll-lock-size) !important;
        overflow: hidden !important;
      }
    `)}function je(t){if(W.add(t),!document.documentElement.classList.contains("gds-scroll-lock")){const e=Re()+Pe();let s=getComputedStyle(document.documentElement).scrollbarGutter;(!s||s==="auto")&&(s="stable"),e<2&&(s=""),document.documentElement.style.setProperty("--gds-scroll-lock-gutter",s),document.documentElement.classList.add("gds-scroll-lock"),document.documentElement.style.setProperty("--gds-scroll-lock-size",`${e}px`)}}function st(t){W.delete(t),W.size===0&&(document.documentElement.classList.remove("gds-scroll-lock"),document.documentElement.style.removeProperty("--gds-scroll-lock-size"))}function Re(){const t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}function Pe(){const t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}var We=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,pt=t=>{throw TypeError(t)},f=(t,e,s,i)=>{for(var o=i>1?void 0:i?Be(e,s):e,n=t.length-1,h;n>=0;n--)(h=t[n])&&(o=(i?h(e,s,o):h(o))||o);return i&&o&&We(e,s,o),o},F=(t,e,s)=>e.has(t)||pt("Cannot "+s),b=(t,e,s)=>(F(t,e,"read from private field"),s?s.call(t):e.get(t)),v=(t,e,s)=>e.has(t)?pt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),I=(t,e,s,i)=>(F(t,e,"write to private field"),e.set(t,s),s),He=(t,e,s)=>(F(t,e,"access private method"),s),$,L,B,M,H,O,q,ut,U,T;Ne();let y=class extends ee(se(ae(it))){constructor(){super(...arguments),v(this,q),this.open=!1,this.variant="default",this.placement="initial",this.scrollable=!1,v(this,$),v(this,L,!1),v(this,B,t=>{let s=t.target.returnValue;if(s!=="prop-change"){if(s=s||"native-close",!b(this,M).call(this,s))return;this.close(s);return}this.close(s)}),v(this,M,t=>b(this,O).call(this,t)?(this.dispatchCustomEvent("gds-close",{detail:t}),!0):!1),v(this,H,t=>b(this,O).call(this,t)?(this.dispatchCustomEvent("gds-show",{detail:t}),!0):!1),v(this,O,t=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason:t,open:this.open}})),v(this,U,t=>{this.show("slotted-trigger")}),v(this,T,t=>{const e=t,s=this._elDialog;if((e.clientX>0||e.clientY>0)&&e.target===this&&s&&this.open){const o=s.getBoundingClientRect(),n=o.top<=e.clientY&&e.clientY<=o.top+o.height&&o.left<=e.clientX&&e.clientX<=o.left+o.width,h="click-outside";!n&&!b(this,L)&&b(this,M).call(this,h)&&this.close(h)}I(this,L,!1)})}show(t){this.open=!0,t&&b(this,H).call(this,t)}close(t){I(this,$,t),this.open=!1}disconnectedCallback(){super.disconnectedCallback(),st(this)}render(){return l`<slot
        name="trigger"
        @slotchange=${He(this,q,ut)}
      ></slot>
            ...
            >
              <slot name="dialog">
                ...
                <gds-div
                  id="content"
                  flex="1"
                  overflow=${j(this.scrollable)?"auto":ie}
                >
                  <slot></slot>
                </gds-div>
                <gds-flex
...
`,Qe=[le,ne,qe],Ve=[nt,dt,Se,ue,ge,pe,Ce,ze,Ae,me,Ee,ct,ye,we,$e,ke,ve,fe,_e,xe],Fe={compact:{button:"small",input:"small",dropdown:"small",badge:"small"},comfortable:{button:"small",input:"small",dropdown:"small",badge:"small"},spacious:{button:"medium",input:"large",dropdown:"medium",badge:"default"}};var Ue=Object.defineProperty,Ye=Object.getOwnPropertyDescriptor,gt=t=>{throw TypeError(t)},c=(t,e,s,i)=>{for(var o=i>1?void 0:i?Ye(e,s):e,n=t.length-1,h;n>=0;n--)(h=t[n])&&(o=(i?h(e,s,o):h(o))||o);return i&&o&&Ue(e,s,o),o},Y=(t,e,s)=>e.has(t)||gt("Cannot "+s),m=(t,e,s)=>(Y(t,e,"read from private field"),s?s.call(t):e.get(t)),G=(t,e,s)=>e.has(t)?gt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),at=(t,e,s,i)=>(Y(t,e,"write to private field"),e.set(t,s),s),r=(t,e,s)=>(Y(t,e,"access private method"),s),S,K,D,a,C,mt,P,bt,Q,yt,k,N,E,vt,ft,_t,wt,xt,kt,$t,St,Ct,Et,zt,At,It,Lt,X,Tt,Dt,Gt,Mt,Ot,Nt,jt,Rt,Z,Pt,Wt,Bt,Ht,qt,Qt,J,tt,z,Vt,Ft,Ut;let d=class extends it{constructor(){super(...arguments),G(this,a),G(this,S,{}),G(this,K,300*1e3),G(this,D,new Map),this.options=[5,10,20,50,100],this.page=1,this.rows=10,this.columns=[],this.density="comfortable",this.selectable=!1,this.responsive=!1,this.plain=!1,this.searchable=!1,this.settings=!1,this.striped=!1,this.nocache=!1,this.variant="secondary",this._isMobile=!1,this._view={page:this.page,rows:this.rows,searchQuery:"",visibleColumns:new Set},this._loaded=!0,this._loading=!1,this._rowsState=[],this._total=0,this._selected=new Set,this._error=null}_handleMobile(t){this._isMobile=t}_onDataChange(){at(this,S,{}),r(this,a,k).call(this)}_onColumnsChange(){at(this,S,{}),this._view={...this._view,page:Number(this.page??1),rows:Number(this.rows??10),visibleColumns:new Set(this.columns.filter(t=>t.visible!==!1).map(t=>t.key))}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{r(this,a,Vt).call(this)})}render(){const t={table:!0,plain:this.plain,striped:this.striped,[this.density]:this.density};return l`
    ...
    `};Et=function(t,e){const s=w({[`align-${e.align}`]:!!e.align,[`justify-${e.justify}`]:!!e.justify,wrap:!!e.width}),i=Me({"--cell-width":e.width});return l`
      <td style=${i} class=${s}>
