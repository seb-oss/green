import{n as h,r as f}from"./Reflect-DJ7r0WLU.js";import{e as S}from"./class-map-CXsQwv0r.js";import{n as g}from"./when-BR7zwNJC.js";import{G as _,h as l,g as z}from"./gds-element-DTROifYq.js";import{t as j}from"./tokens.style-CA5ADGwW.js";import{G as L}from"./button.component-jWIOpC9g.js";import{G as be}from"./card.component-DgPbllnK.js";import{G as M}from"./dropdown.component-D7FNft71.js";import{I as ue}from"./cross-small.component-BS14rjKa.js";import{I as ye}from"./magnifying-glass.component-U0Z7YZT0.js";import{I as fe,a as ve,b as me,c as Se,d as we,e as xe,f as ke}from"./sort.component-DkCP_pJk.js";import{G as $e}from"./input-t17hjOpz.js";import{i as P}from"./lit-element-Bx14lxc-.js";import{a as Ce,G as _e}from"./context-menu-CDIXMzW3.js";import{I as ze}from"./chevron-bottom.component-DgyIWO1Z.js";import{G as B}from"./text-BmaBdEcP.js";import{a as Pe}from"./transitional-styles-CbHKJeDE.js";import{c as Re}from"./rbcb-toggle.template-DqXF-ZkM.js";import{I as De}from"./checkmark.component-CddocQY8.js";import{I as Ie}from"./minus-small.component-DOCzMU52.js";var Ge=Object.defineProperty,Ee=Object.getOwnPropertyDescriptor,w=(e,t,s,d)=>{for(var n=d>1?void 0:d?Ee(t,s):t,o=e.length-1,p;o>=0;o--)(p=e[o])&&(n=(d?p(t,s,n):p(n))||n);return d&&n&&Ge(t,s,n),n};let u=class extends _{constructor(){super(...arguments),this.page=1,this.pageSize=10,this.total=0,this.pageSizes=[5,10,25,50]}get pageCount(){return Math.ceil(this.total/this.pageSize)}getVisiblePages(e){if(e<=7)return Array.from({length:e},(d,n)=>n+1);const t=e;let s=[];return this.page<=4?(s=[2,3,4,5],[1,...s,"...",t]):this.page>=e-3?(s=[e-4,e-3,e-2,e-1],[1,"...",...s,t]):(s=[this.page-1,this.page,this.page+1],[1,"...",...s,"...",t])}render(){const e=this.pageCount,t=this.getVisiblePages(e);return l`
    ...
    `];w([h({type:Number})],u.prototype,"page",2);w([h({type:Number})],u.prototype,"pageSize",2);w([h({type:Number})],u.prototype,"total",2);w([h({type:Array})],u.prototype,"pageSizes",2);u=w([z("gds-pagination",{dependsOn:[L,B,M,Ce,_e,ze,fe,ve,me,Se]})],u);var Ae=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,x=(e,t,s,d)=>{for(var n=d>1?void 0:d?Oe(t,s):t,o=e.length-1,p;o>=0;o--)(p=e[o])&&(n=(d?p(t,s,n):p(n))||n);return d&&n&&Ae(t,s,n),n};let y=class extends _{constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.disabled=!1,this.ariaLabel=""}render(){return l`
      <div
    ...
    `];x([h({type:Boolean})],y.prototype,"checked",2);x([h({type:Boolean})],y.prototype,"indeterminate",2);x([h({type:Boolean})],y.prototype,"disabled",2);x([h()],y.prototype,"ariaLabel",2);y=x([z("gds-table-row-selector",{dependsOn:[De,Ie]})],y);const Te=P`
  /* Host & Container */
  :host {
    display: block;
...
`;var je=Object.defineProperty,Le=Object.getOwnPropertyDescriptor,H=e=>{throw TypeError(e)},c=(e,t,s,d)=>{for(var n=d>1?void 0:d?Le(t,s):t,o=e.length-1,p;o>=0;o--)(p=e[o])&&(n=(d?p(t,s,n):p(n))||n);return d&&n&&je(t,s,n),n},Q=(e,t,s)=>t.has(e)||H("Cannot "+s),b=(e,t,s)=>(Q(e,t,"read from private field"),s?s.call(e):t.get(e)),C=(e,t,s)=>t.has(e)?H("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),i=(e,t,s)=>(Q(e,t,"access private method"),s),k,R,a,D,$,U,q,V,v,K,N,W,F,J,X,Y,Z,ee,te,se,ae,ie,le,ne,oe,re,de,ce,he,pe,I,G,m;let r=class extends _{constructor(){super(...arguments),C(this,a),C(this,k,{}),C(this,R,5*60*1e3),this.columns=[],this.density="comfortable",this.selectable=!1,this.responsive=!1,this.plain=!1,this.tableState={page:1,pageSize:10,searchQuery:"",visibleColumns:new Set},this.initialLoad=!0,this.loading=!1,this.data=[],this.totalRows=0,this.selectedRows=new Set,this.error=null,this.slots={}}async connectedCallback(){super.connectedCallback(),this.tableState.visibleColumns=new Set(this.columns.map(e=>e.key)),await i(this,a,v).call(this)}render(){return l`
    ...
    `};se=function(){const e=S({responsive:this.responsive,data:!0});return l`
      <div class=${e}>
        <table>
    ...
    `};ae=function(){return l`
      ...
      >
        ...
        <gds-button @click=${()=>i(this,a,v).call(this)} variant="negative">
          Retry
        </gds-button>
      </gds-card>
    ...
    `};le=async function(e){const t=e.target;this.tableState={...this.tableState,searchQuery:t.value,page:1},await i(this,a,v).call(this)};ne=async function(){this.tableState={...this.tableState,searchQuery:"",page:1},await i(this,a,v).call(this)};oe=async function(e){this.tableState={...this.tableState,sortColumn:e,sortDirection:this.tableState.sortColumn===e&&this.tableState.sortDirection==="asc"?"desc":"asc",page:1},await i(this,a,v).call(this)};re=async function(e){this.tableState={...this.tableState,page:e.detail.page},await i(this,a,v).call(this)};de=async function(e){this.tableState={...this.tableState,pageSize:e.detail.pageSize,page:1},await i(this,a,v).call(this)};ce=function(e){const t=e.detail.value;this.tableState={...this.tableState,visibleColumns:new Set(t)},this.requestUpdate()};he=function(e){b(this,a,$)?i(this,a,G).call(this):i(this,a,I).call(this),i(this,a,m).call(this)};pe=function(e,t){t.detail.checked?this.selectedRows.add(e):this.selectedRows.delete(e),i(this,a,m).call(this),this.requestUpdate()};I=function(){this.selectedRows=new Set(this.data.map((e,t)=>t)),this.requestUpdate()};G=function(){this.selectedRows.clear(),this.requestUpdate()};m=function(){this.dispatchEvent(new CustomEvent("selection-change",{detail:{selectedIndices:Array.from(this.selectedRows),selectedData:Array.from(this.selectedRows).map(e=>this.data[e]),count:this.selectedRows.size},bubbles:!0}))};r.styles=[j,Te];c([h({type:String})],r.prototype,"subtitle",2);c([h({type:Array})],r.prototype,"columns",2);c([h()],r.prototype,"dataProvider",2);c([h({reflect:!1})],r.prototype,"density",2);c([h({type:Boolean,reflect:!1})],r.prototype,"selectable",2);c([h({type:Boolean,reflect:!1})],r.prototype,"responsive",2);c([h({type:Boolean})],r.prototype,"plain",2);c([h()],r.prototype,"actions",2);c([f()],r.prototype,"tableState",2);c([f()],r.prototype,"initialLoad",2);c([f()],r.prototype,"loading",2);c([f()],r.prototype,"data",2);c([f()],r.prototype,"totalRows",2);c([f()],r.prototype,"selectedRows",2);c([f()],r.prototype,"error",2);c([f()],r.prototype,"slots",2);r=c([z("gds-table",{dependsOn:[y,L,$e,be,B,M,u,ye,we,xe,ke,ue]})],r);r.define();export{u as G};
