import{x as a}from"./iframe-BaRCEa-L.js";import{a as O}from"./argTableProps-DS4HVk-C.js";import"./badge-CX5dHsGF.js";import"./flex-QseP4vIw.js";import"./divider-DWA8cafv.js";import"./triangle-exclamation-BtP4pUIZ.js";import"./circle-check-CM_1eIih.js";import"./arrow-rotate-counter-clockwise.component-BmebWABn.js";import"./minus-small-CniDGn2Z.js";import"./rocket-DNgTuvpC.js";import"./preload-helper-Dp1pzeXC.js";import"./badge.component-BKCuHPTU.js";import"./flex.component-BLJGN402.js";import"./divider.component-ByR8zuoA.js";import"./triangle-exclamation.component-DmvS0uhg.js";import"./icon-DNGZW9LP.js";import"./circle-check.component-DxG0SasW.js";import"./minus-small.component-CDbOrRi_.js";import"./rocket.component-CEpKpLuP.js";const le={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A compact visual indicator for status, counts and notifications.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs"],argTypes:{...O("gds-badge")}},o={name:"Variants",render:e=>a`
    <gds-flex
