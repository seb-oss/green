import{i as B,x as y,t as R,n as v,z as I,d as A,a2 as j,A as P,Y as G,o as N,a as T,b as M,H as D,g as K,I as U}from"./iframe-HnSwFImm.js";function S(t){"@babel/helpers - typeof";return S=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},S(t)}function b(t){if(t===null||t===!0||t===!1)return NaN;var e=Number(t);return isNaN(e)?e:e<0?Math.ceil(e):Math.floor(e)}function f(t,e){if(e.length<t)throw new TypeError(t+" argument"+(t>1?"s":"")+" required, but only "+e.length+" present")}function h(t){f(1,arguments);var e=Object.prototype.toString.call(t);return t instanceof Date||S(t)==="object"&&e==="[object Date]"?new Date(t.getTime()):typeof t=="number"||e==="[object Number]"?new Date(t):((typeof t=="string"||e==="[object String]")&&typeof console<"u"&&(console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://github.com/date-fns/date-fns/blob/master/docs/upgradeGuide.md#string-arguments"),console.warn(new Error().stack)),new Date(NaN))}function k(t,e){f(2,arguments);var s=h(t),a=b(e);return isNaN(a)?new Date(NaN):(a&&s.setDate(s.getDate()+a),s)}function E(t,e){f(2,arguments);var s=h(t),a=b(e);if(isNaN(a))return new Date(NaN);if(!a)return s;var o=s.getDate(),r=new Date(s.getTime());r.setMonth(s.getMonth()+a+1,0);var i=r.getDate();return o>=i?r:(s.setFullYear(r.getFullYear(),r.getMonth(),o),s)}var q={};function C(){return q}function x(t,e){var s,a,o,r,i,u,l,n;f(1,arguments);var m=C(),g=b((s=(a=(o=(r=e==null?void 0:e.weekStartsOn)!==null&&r!==void 0?r:e==null||(i=e.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.weekStartsOn)!==null&&o!==void 0?o:m.weekStartsOn)!==null&&a!==void 0?a:(l=m.locale)===null||l===void 0||(n=l.options)===null||n===void 0?void 0:n.weekStartsOn)!==null&&s!==void 0?s:0);if(!(g>=0&&g<=6))throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");var p=h(t),O=p.getDay(),_=(O<g?7:0)+O-g;return p.setDate(p.getDate()-_),p.setHours(0,0,0,0),p}function F(t){f(1,arguments);var e=h(t);return e.setHours(0,0,0,0),e}function V(t,e){f(2,arguments);var s=b(e),a=s*7;return k(t,a)}function w(t,e){f(2,arguments);var s=F(t),a=F(e);return s.getTime()===a.getTime()}function J(t){f(1,arguments);var e=h(t),s=e.getMonth();return e.setFullYear(e.getFullYear(),s+1,0),e.setHours(23,59,59,999),e}function Q(t,e){var s;f(1,arguments);var a=t||{},o=h(a.start),r=h(a.end),i=r.getTime();if(!(o.getTime()<=i))throw new RangeError("Invalid interval");var u=[],l=o;l.setHours(0,0,0,0);var n=Number((s=void 0)!==null&&s!==void 0?s:1);if(n<1||isNaN(n))throw new RangeError("`options.step` must be a number greater than 1");for(;l.getTime()<=i;)u.push(h(l)),l.setDate(l.getDate()+n),l.setHours(0,0,0,0);return u}function X(t,e){f(1,arguments);var s=t||{},a=h(s.start),o=h(s.end),r=o.getTime();if(!(a.getTime()<=r))throw new RangeError("Invalid interval");var i=x(a,e),u=x(o,e);i.setHours(15),u.setHours(15),r=u.getTime();for(var l=[],n=i;n.getTime()<=r;)n.setHours(0),l.push(h(n)),n=V(n,1),n.setHours(15);return l}function Z(t){f(1,arguments);var e=h(t);return e.setDate(1),e.setHours(0,0,0,0),e}function ee(t,e){var s,a,o,r,i,u;f(1,arguments);var l=h(t),n=l.getFullYear(),m=C(),g=b((s=(a=(o=(r=void 0)!==null&&r!==void 0?r:void 0)!==null&&o!==void 0?o:m.firstWeekContainsDate)!==null&&a!==void 0?a:(i=m.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&s!==void 0?s:1);if(!(g>=1&&g<=7))throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");var p=new Date(0);p.setFullYear(n+1,0,g),p.setHours(0,0,0,0);var O=x(p,e),_=new Date(0);_.setFullYear(n,0,g),_.setHours(0,0,0,0);var z=x(_,e);return l.getTime()>=O.getTime()?n+1:l.getTime()>=z.getTime()?n:n-1}function te(t,e){var s,a,o,r,i,u;f(1,arguments);var l=C(),n=b((s=(a=(o=(r=void 0)!==null&&r!==void 0?r:void 0)!==null&&o!==void 0?o:l.firstWeekContainsDate)!==null&&a!==void 0?a:(i=l.locale)===null||i===void 0||(u=i.options)===null||u===void 0?void 0:u.firstWeekContainsDate)!==null&&s!==void 0?s:1),m=ee(t,e),g=new Date(0);g.setFullYear(m,0,n),g.setHours(0,0,0,0);var p=x(g,e);return p}var se=6048e5;function ae(t,e){f(1,arguments);var s=h(t),a=x(s,e).getTime()-te(s,e).getTime();return Math.round(a/se)+1}function re(t){f(1,arguments);var e=h(t),s=e.getMonth();return e.setFullYear(e.getFullYear(),s+1,0),e.setHours(0,0,0,0),e}function oe(t,e){f(2,arguments);var s=h(t),a=h(e);return s.getFullYear()===a.getFullYear()&&s.getMonth()===a.getMonth()}function ne(t,e){f(2,arguments);var s=h(t),a=b(e);return s.setHours(a),s}function ie(t,e){f(2,arguments);var s=b(e);return E(t,-s)}const le=B`
  @layer base, reset;
