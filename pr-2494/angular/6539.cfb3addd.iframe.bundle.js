...
`,Hs={"seb-account":e=>{const t="string"==typeof e?e.replace(" ",""):e?.toString()??"";return 11!==t.length?t:`${t.slice(0,4)} ${t.slice(4,6)} ${t.slice(6,9)} ${t.slice(9,11)}`}},vs=e=>"string"==typeof e?new Date(e):e,ks={dateOnlyNumbers:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"short"}).format(vs(e)),dateLong:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"long"}).format(vs(e)),dateLongWithWeekday:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"full"}).format(vs(e)),dateShort:(e,t)=>{const r=new Intl.DateTimeFormat(t,{dateStyle:"medium"});return"sv-se"===t?.toLowerCase()?r.format(vs(e)).replace(".",""):r.format(vs(e))},dateShortWithWeekday:(e,t)=>{const r=new Intl.DateTimeFormat(t,{weekday:"short",year:"numeric",month:"short",day:"numeric"}).format(vs(e));return"sv-se"===t?.toLowerCase()?r.replace(".",""):"en-gb"===t?.toLowerCase()?r.replace(",",""):r},timeShort:(e,t)=>new Intl.DateTimeFormat(t,{timeStyle:"short"}).format(vs(e)),timeLong:(e,t)=>new Intl.DateTimeFormat(t,{timeStyle:"medium"}).format(vs(e)),dateTimeLong:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"long",timeStyle:"short"}).format(vs(e)),dateTimeLongWithWeekday:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"full",timeStyle:"short"}).format(vs(e)),dateTimeShort:(e,t)=>new Intl.DateTimeFormat(t,{dateStyle:"medium",timeStyle:"short"}).format(vs(e))},ws={decimalsAndThousands:(e,t,r,o)=>{const s={maximumFractionDigits:o??2,minimumFractionDigits:o??2};return r?new Intl.NumberFormat(t,{...s,style:"currency",currency:r}).format(Number(e)):new Intl.NumberFormat(t,s).format(Number(e))}},bs=[V.LU,I.A,_s],Zs=[k.t,y.z,jt,ge.Hx,Nr.T,ot.E,fr,go,Fr,l.K,wr,je.o,gs,Xt.r,O,ms,Ls,Vs,fs,Ms.z],ys={compact:{button:"small",input:"small",dropdown:"small",badge:"small"},comfortable:{button:"small",input:"small",dropdown:"small",badge:"small"},spacious:{button:"medium",input:"large",dropdown:"medium",badge:"default"}};var xs,Ss,$s,Gs,js,Es,Bs,qs,Ns,Is,Ys,zs,As,Ts,Rs,Os,Ws,Ps,Fs,Ds,Ks,Us,Js,Qs,Xs,en,tn,rn,on,sn,nn,ln,an,cn,Cn,dn,hn,un,pn,gn,Mn,mn,Vn,fn,Ln,_n;let Hn=class extends c.j{constructor(){super(...arguments),(0,s.VK)(this,Gs),(0,s.VK)(this,xs,{}),(0,s.VK)(this,Ss,3e5),(0,s.VK)(this,$s,new Map),this.options=[5,10,20,50,100],this.page=1,this.rows=10,this.columns=[],this.density="comfortable",this.selectable=!1,this.responsive=!1,this.plain=!1,this.searchable=!1,this.settings=!1,this.striped=!1,this.nocache=!1,this.variant="secondary",this._isMobile=!1,this._view={page:this.page,rows:this.rows,searchQuery:"",visibleColumns:new Set},this._loaded=!0,this._loading=!1,this._rowsState=[],this._total=0,this._selected=new Set,this._error=null}_handleMobile(e){this._isMobile=e}_onDataChange(){(0,s.OV)(this,xs,{}),(0,s.jq)(this,Gs,Ys).call(this)}_onColumnsChange(){(0,s.OV)(this,xs,{}),this._view={...this._view,page:Number(this.page??1),rows:Number(this.rows??10),visibleColumns:new Set(this.columns.map(e=>e.key))}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{const e=this.shadowRoot?.querySelector(".data");if(e){const t=()=>{const{scrollTop:t,scrollLeft:r,scrollWidth:o,clientWidth:s}=e;t>0?e.classList.add("scrolled"):e.classList.remove("scrolled");const n=o-s;r<=0?(e.classList.add("scrolled-x-start"),e.classList.remove("scrolled-x-middle","scrolled-x-end")):r>=n-1?(e.classList.add("scrolled-x-end"),e.classList.remove("scrolled-x-start","scrolled-x-middle")):(e.classList.add("scrolled-x-middle"),e.classList.remove("scrolled-x-start","scrolled-x-end"))};e.addEventListener("scroll",t),t()}})}render(){const e={table:!0,plain:this.plain,striped:this.striped,[this.density]:this.density};return C.qy`
    ...
    `},ln=function(){const e=(0,m.H)({responsive:this.responsive,data:!0,[`variant-${this.variant}`]:!0}),t=`${(0,g.ab)("Data table with")} ${this._total} ${(0,g.ab)("rows")}`;return C.qy`
...
//# sourceMappingURL=6539.cfb3addd.iframe.bundle.js.map