...
`;let GdsBadge=class extends((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(gds_element.j)))){constructor(){super(...arguments),(0,chunk_QU3DSPNU.VK)(this,_GdsBadge_instances),this.variant="information",this.size="default",this.notification=!1,this.rounded=!1,this.mainSlotOccupied=!1,this.leadSlotOccupied=!1}render(){const classes=(0,class_map.H)({badge:!0,[this.variant]:!0,[this.size]:"small"===this.size,notification:this.notification,"with-content":this.notification&&this.mainSlotOccupied,rounded:this.rounded});return custom_element_scoping.qy`
      <div class="${classes}">
    ...
    `)),(0,chunk_QU3DSPNU.VK)(this,_handleBlur,(e=>{this.open||this.dispatchCustomEvent("gds-blur",{detail:{relatedTarget:e.relatedTarget},bubbles:!1,composed:!0})})),(0,chunk_QU3DSPNU.VK)(this,_calcMaxHeight,(trigger=>{if(this.combobox){const triggerRect=trigger.getBoundingClientRect(),bottomSpace=window.innerHeight-triggerRect.bottom,topSpace=triggerRect.top;let height2=Math.min(topSpace,this.maxHeight);return bottomSpace>topSpace&&(height2=Math.min(bottomSpace,this.maxHeight)),height2-16+"px"}return Math.min(window.innerHeight,this.maxHeight)-16+"px"})),(0,chunk_QU3DSPNU.VK)(this,_dispatchUISateEvent,((toState,reason)=>this.dispatchCustomEvent("gds-ui-state",{detail:{reason,open:toState},bubbles:!1,composed:!1}))),(0,chunk_QU3DSPNU.VK)(this,_handlePopoverStateChange,(e=>{(0,chunk_QU3DSPNU.S7)(this,_dispatchUISateEvent).call(this,e.detail.open,e.detail.reason)&&(this.open=e.detail.open)})),(0,chunk_QU3DSPNU.VK)(this,_handleClearButton,(e=>{e.preventDefault(),e.stopPropagation(),this.value=void 0,this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),(0,chunk_QU3DSPNU.S7)(this,_dispatchInputEvent).call(this),(0,chunk_QU3DSPNU.S7)(this,_dispatchChangeEvent).call(this)})),(0,chunk_QU3DSPNU.VK)(this,_handleSearchFieldInput,(e=>{if(!e.currentTarget)return;e.stopPropagation();if(!this.dispatchCustomEvent("gds-filter-input",{detail:{value:e.currentTarget.value}}))return;const input=e.currentTarget;if(this.options.forEach((o=>o.hidden=!1)),!input.value)return;this.options.filter((o=>!this.searchFilter(input.value,o))).forEach((o=>o.hidden=!0))})),(0,chunk_QU3DSPNU.VK)(this,_handleSearchFieldKeyDown,(e=>{this._elListbox?.then((listbox=>{if("ArrowDown"===e.key||"Tab"===e.key)return e.preventDefault(),void listbox.focus()}))})),(0,chunk_QU3DSPNU.VK)(this,_handleListboxKeyDown,(e=>{if("Tab"===e.key&&this.searchable)return e.preventDefault(),void this._elSearchInput?.focus()})),(0,chunk_QU3DSPNU.VK)(this,_handleOptionFocusChange,(e=>{const triggerButton=this._elTriggerBtn;triggerButton&&(triggerButton.ariaActiveDescendantElement=e.target)})),(0,chunk_QU3DSPNU.VK)(this,_dispatchInputEvent,(()=>{this.updateComplete.then((()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})))})),(0,chunk_QU3DSPNU.VK)(this,_dispatchChangeEvent,(()=>{this.updateComplete.then((()=>this.dispatchCustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0})))})),(0,chunk_QU3DSPNU.VK)(this,_blurCloseListener,(e=>{e instanceof FocusEvent&&e.relatedTarget&&!this.contains(e.relatedTarget)&&(0,chunk_QU3DSPNU.S7)(this,_dispatchUISateEvent).call(this,!1,"close")&&(this.open=!1)})),(0,chunk_QU3DSPNU.VK)(this,_tabCloseListener,(e=>{"Tab"===e.key&&!this.searchable&&(0,chunk_QU3DSPNU.S7)(this,_dispatchUISateEvent).call(this,!1,"close")&&(e.preventDefault(),this.open=!1,this._elTriggerBtn?.focus())}))}get type(){return"gds-dropdown"}get options(){return(0,chunk_QU3DSPNU.S7)(this,_optionElements)?Array.from((0,chunk_QU3DSPNU.S7)(this,_optionElements)).filter((o=>!o.hasAttribute("isplaceholder"))):[]}get placeholder(){if((0,chunk_QU3DSPNU.S7)(this,_optionElements))return Array.from((0,chunk_QU3DSPNU.S7)(this,_optionElements)).find((o=>o.hasAttribute("isplaceholder")))}get displayValue(){let displayValue;return displayValue=Array.isArray(this.value)?this.value.slice(0,5).reduce(((acc,cur)=>acc+this.options.find((v=>v.value===cur))?.innerText+", "),"").slice(0,-2).replace(/(.{25})(.*)/,"$1..."):this.options.find((v=>v.selected))?.innerText,displayValue||this.placeholder?.innerText||""}focus(){this._getValidityAnchor().focus()}test_getFieldElement(){return this.shadowRoot?.querySelector("#field")}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",(0,chunk_QU3DSPNU.S7)(this,_handleBlur)),this.updateComplete.then((()=>{this._handleLightDOMChange(),this._handleValueChange(),this._handleOpenChange()}))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("blur",(0,chunk_QU3DSPNU.S7)(this,_handleBlur))}render(){return custom_element_scoping.qy`
      ...
      >
        ...
        <gds-listbox
          ...
          @change="${(0,chunk_QU3DSPNU.jq)(this,_Dropdown_instances,handleSelectionChange_fn)}"
      ...
      ${(0,when.z)((0,chunk_QU3DSPNU.jq)(this,_Dropdown_instances,shouldShowFooter_fn).call(this),(()=>custom_element_scoping.qy`
          ...
          >
            ...
            <slot id="message" name="message" slot="message">
              <gds-icon-triangle-exclamation
                solid
              ></gds-icon-triangle-exclamation>
              ${this.invalid?this.errorMessage:lit.s6}
            </slot>
          </gds-form-control-footer>
        `))}
    `}_getValidityAnchor(){return this._elTriggerBtn}_handleLightDOMChange(){this.requestUpdate(),(0,chunk_QU3DSPNU.OV)(this,_optionElements,this.querySelectorAll("[gds-element=gds-option]")),this.multiple?this._handleValueChange():void 0===this.value?this.placeholder?this.value=this.placeholder.value:this.value=this.options[0]?.value:this.combobox||this.placeholder||void 0!==this.options.find((o=>this.compareWith(o.value,this.value)))||(this.options[0]&&(this.options[0].selected=!0),this.value=this.options[0]?.value)}_handleValueChange(){this._elListbox.then((listbox=>{listbox&&(Array.isArray(this.value)?listbox.selection=this.value:listbox.selection=[this.value])}))}_handleOpenChange(){var _this=this;const open=this.open;this.options.forEach((o=>o.hidden=!open)),open?(0,chunk_QU3DSPNU.jq)(this,_Dropdown_instances,registerAutoCloseListener_fn).call(this):((0,chunk_QU3DSPNU.jq)(this,_Dropdown_instances,unregisterAutoCloseListener_fn).call(this),this._elSearchInput&&(this._elSearchInput.value=""));const selectedOption=this.options.find((option=>option.selected));requestAnimationFrame((0,asyncToGenerator.A)((function*(){yield _this.updateComplete,selectedOption?.scrollIntoView({block:"center"})})))}};_optionElements=new WeakMap,_Dropdown_instances=new WeakSet,shouldShowFooter_fn=function(){return!this.plain},_renderCombobox=new WeakMap,_renderTriggerButton=new WeakMap,_handleBlur=new WeakMap,_calcMaxHeight=new WeakMap,_dispatchUISateEvent=new WeakMap,_handlePopoverStateChange=new WeakMap,_handleClearButton=new WeakMap,_handleSearchFieldInput=new WeakMap,_handleSearchFieldKeyDown=new WeakMap,_handleListboxKeyDown=new WeakMap,_handleOptionFocusChange=new WeakMap,handleSelectionChange_fn=function(){this._elListbox.then((listbox=>{this.multiple?this.value=listbox.selection.map((s=>s.value)):(this.value=listbox.selection[0]?.value,(0,chunk_QU3DSPNU.S7)(this,_dispatchUISateEvent).call(this,!1,"close")&&(this.open=!1,setTimeout((()=>this._elTriggerBtn?.focus()),0))),(0,chunk_QU3DSPNU.S7)(this,_dispatchInputEvent).call(this),(0,chunk_QU3DSPNU.S7)(this,_dispatchChangeEvent).call(this)}))},_dispatchInputEvent=new WeakMap,_dispatchChangeEvent=new WeakMap,registerAutoCloseListener_fn=function(){this.addEventListener("blur",(0,chunk_QU3DSPNU.S7)(this,_blurCloseListener)),this.addEventListener("gds-blur",(0,chunk_QU3DSPNU.S7)(this,_blurCloseListener)),this.addEventListener("keydown",(0,chunk_QU3DSPNU.S7)(this,_tabCloseListener))},unregisterAutoCloseListener_fn=function(){this.removeEventListener("blur",(0,chunk_QU3DSPNU.S7)(this,_blurCloseListener)),this.removeEventListener("gds-blur",(0,chunk_QU3DSPNU.S7)(this,_blurCloseListener)),this.removeEventListener("keydown",(0,chunk_QU3DSPNU.S7)(this,_tabCloseListener))},_blurCloseListener=new WeakMap,_tabCloseListener=new WeakMap,Dropdown.styles=[tokens_style.LU,form_control_host_style.A,dropdown_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({attribute:"supporting-text"})],Dropdown.prototype,"supportingText",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],Dropdown.prototype,"open",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],Dropdown.prototype,"searchable",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],Dropdown.prototype,"multiple",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],Dropdown.prototype,"clearable",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],Dropdown.prototype,"combobox",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],Dropdown.prototype,"compareWith",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],Dropdown.prototype,"searchFilter",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,attribute:"sync-popover-width"})],Dropdown.prototype,"syncPopoverWidth",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number,attribute:"max-height"})],Dropdown.prototype,"maxHeight",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!0})],Dropdown.prototype,"size",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,attribute:"hide-label"})],Dropdown.prototype,"hideLabel",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],Dropdown.prototype,"plain",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],Dropdown.prototype,"disableMobileStyles",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],Dropdown.prototype,"showExtendedSupportingText",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.P)("#trigger")],Dropdown.prototype,"_elTriggerBtn",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.nJ)("#listbox")],Dropdown.prototype,"_elListbox",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.P)("#searchinput")],Dropdown.prototype,"_elSearchInput",2),(0,chunk_QU3DSPNU.Cc)([(0,observe_light_dom.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],Dropdown.prototype,"_handleLightDOMChange",1),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("value")],Dropdown.prototype,"_handleValueChange",1),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("open")],Dropdown.prototype,"_handleOpenChange",1),Dropdown=(0,chunk_QU3DSPNU.Cc)([(0,lit_localize.cc)()],Dropdown);let GdsDropdown=class extends((0,declarative_layout_mixins.Q8)((0,declarative_layout_mixins.TM)((0,declarative_layout_mixins.lt)(Dropdown)))){};GdsDropdown=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-dropdown",{dependsOn:[form_control_header_component.$,form_control_footer_component.V,field_base_component.w,GdsListbox,popover_component.E,checkmark_component.V,chevron_bottom_component.o,cross_small_component.r]})],GdsDropdown)},"./dist/libs/core/src/components/flex/flex.component.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{o:()=>GdsFlex});var chunk_QU3DSPNU=__webpack_require__("./dist/libs/core/src/chunks/chunk.QU3DSPNU.js"),tokens_style=__webpack_require__("./dist/libs/core/src/tokens.style.js"),custom_element_scoping=__webpack_require__("./dist/libs/core/src/utils/helpers/custom-element-scoping.js"),div_component=__webpack_require__("./dist/libs/core/src/components/div/div.component.js");var flex_styles_default=__webpack_require__("./node_modules/lit/index.js").AH`
  :host {
    display: flex;
    box-sizing: border-box;
    border-style: solid;
...
`;let GdsFieldBase=class extends gds_element.j{constructor(){super(),(0,chunk_QU3DSPNU.VK)(this,_GdsFieldBase_instances),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._leadHasBadge=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,(0,chunk_QU3DSPNU.VK)(this,_handleSlotChange,((slotName,event)=>{const assignedNodes=event.target.assignedNodes({flatten:!0}),slotOccupied=assignedNodes.length>0&&assignedNodes.some((node=>node.nodeType===Node.ELEMENT_NODE||node.nodeType===Node.TEXT_NODE&&""!==node.textContent?.trim()));"lead"===slotName?(this._leadSlotOccupied=slotOccupied,this._leadHasBadge=slotOccupied&&assignedNodes.some((node=>"gds-badge"===node.getAttribute?.("gds-element")))):"trail"===slotName?this._trailSlotOccupied=slotOccupied:"action"===slotName&&(this._actionSlotOccupied=slotOccupied)}))}connectedCallback(){super.connectedCallback(),transitional_styles.n.instance.apply(this,"gds-field-base")}render(){const classes={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"lead-has-badge":this._leadHasBadge,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:"small"===this.size};return custom_element_scoping.qy`
    ...
    `},renderSlotTrail_fn=function(){return custom_element_scoping.qy`
      ...
      ></slot>
    `},GdsFieldBase.styles=[field_base_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],GdsFieldBase.prototype,"size",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],GdsFieldBase.prototype,"multiline",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],GdsFieldBase.prototype,"disabled",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],GdsFieldBase.prototype,"invalid",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.P)("slot:not([name])")],GdsFieldBase.prototype,"_mainSlotElement",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],GdsFieldBase.prototype,"_leadSlotOccupied",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],GdsFieldBase.prototype,"_leadHasBadge",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],GdsFieldBase.prototype,"_trailSlotOccupied",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],GdsFieldBase.prototype,"_actionSlotOccupied",2),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("disabled")],GdsFieldBase.prototype,"_handleDisabledChange",1),GdsFieldBase=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-field-base"),(0,lit_localize.cc)()],GdsFieldBase)},"./dist/libs/core/src/primitives/form-control-footer/form-control-footer.component.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{V:()=>GdsFormControlFooter});var chunk_QU3DSPNU=__webpack_require__("./dist/libs/core/src/chunks/chunk.QU3DSPNU.js"),lit=__webpack_require__("./node_modules/lit/index.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js"),when=__webpack_require__("./node_modules/lit-html/directives/when.js"),badge_component=__webpack_require__("./dist/libs/core/src/components/badge/badge.component.js"),triangle_exclamation_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/triangle-exclamation.component.js"),gds_element=__webpack_require__("./dist/libs/core/src/gds-element.js"),watch=__webpack_require__("./dist/libs/core/src/utils/decorators/watch.js"),custom_element_scoping=__webpack_require__("./dist/libs/core/src/utils/helpers/custom-element-scoping.js");var _GdsFormControlFooter_instances,renderRemainingCharsBadge_fn,form_control_footer_styles_default=lit.AH`
  @layer base, reset, transitional-styles;
  @layer base {
...
`;let GdsFormControlFooter=class extends gds_element.j{constructor(){super(...arguments),(0,chunk_QU3DSPNU.VK)(this,_GdsFormControlFooter_instances)}_handleVisibilityChange(){this.classList.toggle("visually-hidden",!this.errorMessage&&!this.charCounter?.[1])}connectedCallback(){super.connectedCallback(),this._handleVisibilityChange()}render(){return custom_element_scoping.qy`<div aria-live="polite">
      ...
      <div class="char-counter" aria-hidden="true">
        ${(0,chunk_QU3DSPNU.jq)(this,_GdsFormControlFooter_instances,renderRemainingCharsBadge_fn).call(this)}
      </div>
    </div>`}};_GdsFormControlFooter_instances=new WeakSet,renderRemainingCharsBadge_fn=function(){if(!this.charCounter||!1===this.charCounter[1])return lit.s6;const[remaining,variant]=this.charCounter;return custom_element_scoping.qy`<gds-badge variant="${variant}">${remaining}</gds-badge>`},GdsFormControlFooter.styles=[form_control_footer_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],GdsFormControlFooter.prototype,"charCounter",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],GdsFormControlFooter.prototype,"errorMessage",2),(0,chunk_QU3DSPNU.Cc)([(0,watch.w)("charCounter"),(0,watch.w)("errorMessage")],GdsFormControlFooter.prototype,"_handleVisibilityChange",1),GdsFormControlFooter=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-form-control-footer",{dependsOn:[badge_component.K,triangle_exclamation_component.f]})],GdsFormControlFooter)},"./dist/libs/core/src/primitives/form-control-header/form-control-header.component.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{$:()=>GdsFormControlHeader});var chunk_QU3DSPNU=__webpack_require__("./dist/libs/core/src/chunks/chunk.QU3DSPNU.js"),lit_localize=__webpack_require__("./node_modules/@lit/localize/lit-localize.js"),decorators=__webpack_require__("./node_modules/lit/decorators.js"),when=__webpack_require__("./node_modules/lit-html/directives/when.js"),button_component=__webpack_require__("./dist/libs/core/src/components/button/button.component.js"),card_component=__webpack_require__("./dist/libs/core/src/components/card/card.component.js"),circle_info_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/circle-info.component.js"),gds_element=__webpack_require__("./dist/libs/core/src/gds-element.js"),custom_element_scoping=__webpack_require__("./dist/libs/core/src/utils/helpers/custom-element-scoping.js");var _GdsFormControlHeader_instances,handleExtSupTxtSlotChange_fn,_renderExtSupTxtButton,_handleExtSupTxtBtnClick,_handleResize,renderExtSupTxt_fn,form_control_header_styles_default=__webpack_require__("./node_modules/lit/index.js").AH`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`},"./dist/libs/core/src/shared-styles/rbcb-toggle.template.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{U:()=>radioToggle,o:()=>checkboxToggle});__webpack_require__("./dist/libs/core/src/chunks/chunk.QU3DSPNU.js");var lit_directives_class_map_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/lit/directives/class-map.js"),lit_directives_when_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__("./node_modules/lit-html/directives/when.js"),_scoping_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__("./dist/libs/core/src/utils/helpers/custom-element-scoping.js");const checkboxToggle=props=>template({...props,type:"checkbox"}),radioToggle=props=>template({...props,type:"radio"}),template=props=>{const{type,checked,indeterminate,disabled,invalid}=props,modifiers={"rbcb--checkbox":"checkbox"===type,"rbcb--radio":"radio"===type,"--checked":checked,"--indeterminate":indeterminate,"--disabled":disabled,"--invalid":invalid};return _scoping_js__WEBPACK_IMPORTED_MODULE_2__.qy`
  ...
  `}}}]);
//# sourceMappingURL=2704.cccbc4aa.iframe.bundle.js.map