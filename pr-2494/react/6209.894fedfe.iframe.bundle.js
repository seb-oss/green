/*! For license information please see 6209.894fedfe.iframe.bundle.js.LICENSE.txt */
...
`)),_2=function _2(t){return t};function pagination_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(pagination_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var pagination_component_GdsPagination=function(_GdsElement){function GdsPagination(){var _this;return(0,classCallCheck.A)(this,GdsPagination),_this=function pagination_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,pagination_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsPagination,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsPagination_instances),_this.page=1,_this.rows=10,_this.total=0,_this.options=[5,10,25,50],_this.jump=!1,_this}return(0,inherits.A)(GdsPagination,_GdsElement),(0,createClass.A)(GdsPagination,[{key:"render",value:function render(){return(0,custom_element_scoping.qy)(pagination_component_t||(pagination_component_t=_2`
      <div class="pages">${0}</div>
      ${0}
    `),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderNavigationControls_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,renderPageSizeMenu_fn).call(this))}}])}(gds_element.j);_GdsPagination_instances=new WeakSet,pageCount_get=function pageCount_get(){return Math.ceil(this.total/this.rows)},getVisiblePages_fn=function getVisiblePages_fn(pageCount){if(pageCount<=7)return Array.from({length:pageCount},(function(_,i){return i+1}));var lastPage=pageCount,pages=[];return pages.push(1),this.page<=4?pages.push(2,3,4,5,"...",lastPage):this.page>=pageCount-3?pages.push("...",pageCount-4,pageCount-3,pageCount-2,pageCount-1,lastPage):pages.push("...",this.page-1,this.page,this.page+1,"...",lastPage),pages},renderPageButton_fn=function renderPageButton_fn(page){var _this2=this;if("..."===page)return(0,custom_element_scoping.qy)(pagination_component_t2||(pagination_component_t2=_2`
    ...
    `),size,(0,class_map.H)({selected:isSelected}),size)},renderPageSizeMenu_fn=function renderPageSizeMenu_fn(){var _this9=this;return(0,custom_element_scoping.qy)(_t11||(_t11=_2`
...
//# sourceMappingURL=6209.894fedfe.iframe.bundle.js.map