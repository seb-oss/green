import{i as E,t as S,b as g,s as T,V as b,d as t,j as G}from"./tokens.style-BS_aEW-k.js";const j=`/* stylelint-disable max-nesting-depth */
...
}`;function s(){e.instance.register("gds-button",j.toString())}var H=E`
  .rbcb {
...
`;const M=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  :host {
...
}`;function k(){e.instance.register("gds-listbox",A.toString()),e.instance.register("gds-option",V.toString()+H.cssText),e.instance.register("gds-menu-heading",M.toString())}const L=`/* stylelint-disable max-nesting-depth */
/* stylelint-enable max-nesting-depth */
/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
...
}`;function u(){e.instance.register("gds-popover",L.toString())}const $=`/* stylelint-disable max-nesting-depth */
/* stylelint-enable max-nesting-depth */
/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
...
}`;function F(){e.instance.register("gds-context-menu",$.toString()),u(),k(),s()}const R=`/* stylelint-disable max-nesting-depth */
/* stylelint-enable max-nesting-depth */
/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
...
}`;function W(){e.instance.register("gds-calendar",R.toString())}const B=`/* stylelint-disable max-nesting-depth */
/* stylelint-enable max-nesting-depth */
/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
...
}`;function x(){e.instance.register("gds-field-base",B.toString())}function z(){k(),u(),s(),x()}const I=`/* stylelint-disable max-nesting-depth */
/* stylelint-enable max-nesting-depth */
/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
...
}`;function P(){const _=I.toString()+S.reduce((o,r)=>o+r.cssText,"");e.instance.register("gds-datepicker",_.toString()),z(),u(),W()}const U=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {
    .btn-p {
...
}`;function Z(){e.instance.register("gds-filter-chip",U.toString()),s()}const D=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  @layer _base {}
  @layer _overrides {}
}`;function N(){e.instance.register("gds-filter-chips",D.toString()),Z()}const X=`@layer base, reset, transitional-styles;
@layer transitional-styles {
  @layer _base, _overrides;
  :host {
    display: block;
...
}`;function q(){e.instance.register("gds-grouped-list",X.toString())}function J(){s(),x()}const O=`/* stylelint-disable max-nesting-depth */
/* stylelint-enable max-nesting-depth */
/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
...
}`;function Q(){e.instance.register("gds-segmented",O.toString())}const Y=`@layer base, reset, transitional-styles;
...
`;function K(){e.instance.register("gds-segmented-control",Y.toString()),Q()}const nn=`/**
 * Calculate the luminance for a color.
 * See https://www.w3.org/TR/WCAG20-TECHS/G17.html#G17-tests
 */
/**
...
}`;function en(){e.instance.register("gds-theme",nn.toString())}var d,c,h;const tn=()=>{en(),z(),F(),P(),q(),K(),N(),s(),J()},on=class C{constructor(){g(this,d,new Map),g(this,c,new Map),g(this,h,!T())}static get instance(){var o;return(o=globalThis.__gdsTransitionalStyles)!=null&&o[b]||(globalThis.__gdsTransitionalStyles={...globalThis.__gdsTransitionalStyles,[b]:new C}),globalThis.__gdsTransitionalStyles[b]}apply(o,r){if(!o.shadowRoot)return;const n=t(this,d).get(r);n&&(t(this,c).set(r,o),this.applyToElement(r,n))}applyToElement(o,r){var p,f;const n=t(this,c).get(o);if(!n||!n.shadowRoot)return;const m=()=>{n._dynamicStylesController.clearInitial(),n._dynamicStylesController.inject("t-styles",G(r)),n._isUsingTransitionalStyles=!0},v=()=>{n._isUsingTransitionalStyles=!1,n._dynamicStylesController.clear("t-styles"),n._dynamicStylesController.restoreInitial()},y="[gds-element=gds-theme]";let a=n.getRootNode(),i=n.closest(y);for(;i===null&&a!==document;)i=(p=a.host)==null?void 0:p.closest(y),a=(f=a.host)==null?void 0:f.getRootNode();if(i){const l=i,w=()=>{l.designVersion==="2023"?v():m()};if(l.addEventListener("gds-design-version-changed",w),n.addEventListener("gds-element-disconnected",()=>l.removeEventListener("gds-design-version-changed",w)),l.designVersion==="2023"){v();return}}m()}register(o,r){let n=r;t(this,h)&&(n=`@layer reset {
        *:not(style, [gds-element]) {
          all: revert;
        }
      }
      ${r}`),t(this,d).set(o,n),this.applyToElement(o,n)}};d=new WeakMap;c=new WeakMap;h=new WeakMap;let e=on;export{e as T,N as a,u as b,H as c,tn as r};
