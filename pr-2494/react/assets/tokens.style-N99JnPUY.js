 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=globalThis;class oe extends X{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t;const e=super.createRenderRoot();return(t=this.renderOptions).renderBefore??(t.renderBefore=e.firstChild),e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Es(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return Y}}var ut;oe._$litElement$=!0,oe.finalized=!0,(ut=q.litElementHydrateSupport)==null||ut.call(q,{LitElement:oe});const Me=q.litElementPolyfillSupport;Me==null||Me({LitElement:oe});(q.litElementVersions??(q.litElementVersions=[])).push("4.2.1");const L="-e0f7ed";class Re{static get instance(){var e;return(e=globalThis.__gdsElementLookupTable)!=null&&e[L]||(globalThis.__gdsElementLookupTable={...globalThis.__gdsElementLookupTable,[L]:new Map}),globalThis.__gdsElementLookupTable[L]}}const js=(r,e)=>function(t){var s;return s=class extends t{constructor(){super(...arguments),this.gdsElementName=r}static define(){if(s.isDefined)return;const c=globalThis.GDS_DISABLE_VERSIONED_ELEMENTS?r:r+L;customElements.get(c)||(s.isDefined=!0,Re.instance.set(r,c),customElements.define(c,s),e!=null&&e.dependsOn&&e.dependsOn.forEach(l=>l.define()))}},s.isDefined=!1,s},it=new WeakMap;function ws(r,...e){let t=it.get(r);return t||(t=at(r),t.raw=at(r.raw),it.set(r,t)),[t,...e]}const at=r=>r.map(e=>{for(const[t,s]of Re.instance.entries())e=e.replace(new RegExp(`${t}(?![-a-z])`,"mg"),s);return e});function xs(r){return(e,...t)=>{if(globalThis.GDS_DISABLE_VERSIONED_ELEMENTS)return r(e,...t);const[s,...n]=ws(e,...t);return r(s,...n)}}const Hs=xs(gs);function Ns(r,e=!1){return Re.instance.get(r)??r+(e?L:"")}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
