...
`)),rich_text_styles_default=(0,lit.AH)(rich_text_styles_t||(rich_text_styles_t=(function _(t){return t})`
  :host {
    font: var(--gds-sys-text-body-regular-m);
...
`)),text_component_=function _(t){return t};function text_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(text_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var text_component_GdsText=function(_GdsDiv){function GdsText(){var _this;return(0,classCallCheck.A)(this,GdsText),(_this=function text_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,text_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsText,arguments)).tag="span",_this}return(0,inherits.A)(GdsText,_GdsDiv),(0,createClass.A)(GdsText,[{key:"render",value:function render(){var TAG=(0,static_html.Bk)(encodeURI(this.tag));return(0,static_html.qy)(text_component_t||(text_component_t=text_component_`<${0} tag><slot></slot></${0}>`),TAG,TAG)}}])}(div_component.o);text_component_GdsText.styles=[tokens_style.LU,defaultStyles,text_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:String})],text_component_GdsText.prototype,"tag",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]",styleTemplate:function styleTemplate(_prop,values){var size=values[0];return"font: var(--gds-sys-text-".concat(size,");")}})],text_component_GdsText.prototype,"font",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]",valueTemplate:function valueTemplate(v){return"var(--gds-sys-text-weight-".concat(v,")")}})],text_component_GdsText.prototype,"font-weight",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)()],text_component_GdsText.prototype,"text-transform",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]"})],text_component_GdsText.prototype,"text-decoration",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]",styleTemplate:function styleTemplate(_prop,values){return"overflow: hidden;\n      text-overflow: ellipsis;\n      display: -webkit-box;\n      -webkit-line-clamp: ".concat(values[0],";\n      -webkit-box-orient: vertical;")}})],text_component_GdsText.prototype,"lines",2),text_component_GdsText=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-text")],text_component_GdsText);var pagination_component_t,pagination_component_t2,pagination_component_t3,pagination_component_t4,pagination_component_t5,pagination_component_t6,pagination_component_t7,pagination_component_t8,_t9,_t10,_t11,_2=function _2(t){return t};function pagination_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(pagination_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var GdsPagination=function(_GdsElement){function GdsPagination(){var _this;return(0,classCallCheck.A)(this,GdsPagination),(_this=function pagination_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,pagination_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsPagination,arguments)).page=1,_this.pageSize=10,_this.total=0,_this.pageSizes=[5,10,25,50],_this}return(0,inherits.A)(GdsPagination,_GdsElement),(0,createClass.A)(GdsPagination,[{key:"pageCount",get:function get(){return Math.ceil(this.total/this.pageSize)}},{key:"getVisiblePages",value:function getVisiblePages(pageCount){if(pageCount<=7)return Array.from({length:pageCount},(function(_,i){return i+1}));var lastPage=pageCount,middlePages=[];return this.page<=4?(middlePages=[2,3,4,5],[1].concat((0,toConsumableArray.A)(middlePages),["...",lastPage])):this.page>=pageCount-3?(middlePages=[pageCount-4,pageCount-3,pageCount-2,pageCount-1],[1,"..."].concat((0,toConsumableArray.A)(middlePages),[lastPage])):(middlePages=[this.page-1,this.page,this.page+1],[1,"..."].concat((0,toConsumableArray.A)(middlePages),["...",lastPage]))}},{key:"renderEllipsisButton",value:function renderEllipsisButton(isFirst,pageCount){var _this2=this,targetPage=isFirst?Math.max(1,this.page-3):Math.min(pageCount,this.page+3),icon=isFirst?(0,custom_element_scoping.qy)(pagination_component_t||(pagination_component_t=_2`<gds-icon-chevron-double-left
          size="m"
        ></gds-icon-chevron-double-left>`)):(0,custom_element_scoping.qy)(pagination_component_t2||(pagination_component_t2=_2`<gds-icon-chevron-double-right
          size="m"
        ></gds-icon-chevron-double-right>`));return(0,custom_element_scoping.qy)(pagination_component_t3||(pagination_component_t3=_2`
      <gds-button
        size="small"
        rank="tertiary"
        class="ellipsis"
    ...
    `),(function(){return _this2.handlePageChange(targetPage)}),icon)}},{key:"render",value:function render(){var _this3=this,pageCount=this.pageCount,visiblePages=this.getVisiblePages(pageCount);return(0,custom_element_scoping.qy)(pagination_component_t4||(pagination_component_t4=_2`
    ...
    `),1===this.page,(function(){return _this3.handlePageChange(1)}),1===this.page,(function(){return _this3.handlePageChange(_this3.page-1)}),visiblePages.map((function(p,index){return(0,custom_element_scoping.qy)(pagination_component_t5||(pagination_component_t5=_2`
            ${0}
          `),"..."===p?_this3.renderEllipsisButton(1===index,pageCount):(0,custom_element_scoping.qy)(pagination_component_t6||(pagination_component_t6=_2`
                  <gds-button
                    size="small"
                    rank="${0}"
                    @click=${0}
                ...
                `),_this3.page===p?"primary":"tertiary",(function(){return _this3.handlePageChange(p)}),p))})),visiblePages.map((function(p){return(0,custom_element_scoping.qy)(pagination_component_t7||(pagination_component_t7=_2`
            ${0}
          `),"..."===p?(0,custom_element_scoping.qy)(pagination_component_t8||(pagination_component_t8=_2`<gds-button size="small" rank="tertiary" width="40px" inert
                  >...</gds-button
                >`)):(0,custom_element_scoping.qy)(_t9||(_t9=_2`
                  <gds-button
                    size="small"
                    rank="${0}"
                    @click=${0}
                ...
                `),_this3.page===p?"primary":"tertiary",(function(){return _this3.handlePageChange(p)}),p))})),this.page===pageCount,(function(){return _this3.handlePageChange(_this3.page+1)}),this.page===pageCount,(function(){return _this3.handlePageChange(pageCount)}),this.handlePageSizeMenuClick,this.pageSize,this.pageSizes.map((function(size){return(0,custom_element_scoping.qy)(_t10||(_t10=_2`
              <gds-menu-item
                data-value=${0}
                class=${0}
              >
            ...
            `),size,(0,class_map.H)({selected:_this3.pageSize===size}),size)})))}},{key:"handlePageChange",value:function handlePageChange(newPage){this.dispatchEvent(new CustomEvent("page-change",{detail:{page:newPage},bubbles:!0}))}},{key:"handlePageSizeMenuClick",value:function handlePageSizeMenuClick(e){var menuItem=e.target,newPageSize=parseInt(menuItem.dataset.value||"10");newPageSize!==this.pageSize&&this.dispatchEvent(new CustomEvent("page-size-change",{detail:{pageSize:newPageSize},bubbles:!0}))}}])}(gds_element.j);GdsPagination.styles=[(0,lit.AH)(_t11||(_t11=_2`
      :host {
        display: flex;
        align-items: center;
    ...
    `))],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],GdsPagination.prototype,"page",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],GdsPagination.prototype,"pageSize",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Number})],GdsPagination.prototype,"total",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],GdsPagination.prototype,"pageSizes",2),GdsPagination=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-pagination",{dependsOn:[button_component.t,text_component_GdsText,dropdown_component.E,context_menu_component.Hx,menu_item_component.T,chevron_bottom_component.o,chevron_left_small_component.V,chevron_double_left_component.P,chevron_right_small_component.U,chevron_double_right_component.C]})],GdsPagination);var table_checkbox_t,table_checkbox_t2,copy_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/copy.component.js"),dot_grid_one_horizontal_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/dot-grid-one-horizontal.component.js"),magnifying_glass_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/magnifying-glass.component.js"),sort_down_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/sort-down.component.js"),sort_up_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/sort-up.component.js"),sort_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/sort.component.js"),table_checkbox_=function _(t){return t};function table_checkbox_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_checkbox_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var GdsTableCheckbox=function(_GdsElement){function GdsTableCheckbox(){var _this;return(0,classCallCheck.A)(this,GdsTableCheckbox),(_this=function table_checkbox_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_checkbox_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTableCheckbox,arguments)).checked=!1,_this.indeterminate=!1,_this.disabled=!1,_this.ariaLabel="",_this}return(0,inherits.A)(GdsTableCheckbox,_GdsElement),(0,createClass.A)(GdsTableCheckbox,[{key:"focus",value:function focus(options){var _this$_input;null==(_this$_input=this._input)||_this$_input.focus(options)}},{key:"render",value:function render(){return(0,custom_element_scoping.qy)(table_checkbox_t||(table_checkbox_t=table_checkbox_`
      <input
        type="checkbox"
        ?checked=${0}
        ?disabled=${0}
        ...
        @keydown=${0}
      />
      <div class="table-checkbox" @click=${0}>
        ${0}
      </div>
    `),this.checked,this.disabled,this.ariaLabel,this.handleChange,this.handleKeydown,this.handleClick,(0,rbcb_toggle_template.o)({checked:this.checked,indeterminate:this.indeterminate,disabled:this.disabled,invalid:!1}))}},{key:"handleClick",value:function handleClick(e){e.stopPropagation(),this.disabled||this._input.click()}},{key:"handleChange",value:function handleChange(){this.dispatchEvent(new CustomEvent("selector-change",{detail:{checked:this._input.checked},bubbles:!0}))}},{key:"handleKeydown",value:function handleKeydown(e){" "===e.key&&e.stopPropagation()}}])}(gds_element.j);GdsTableCheckbox.styles=[tokens_style.LU,rbcb_toggle_style.A,(0,lit.AH)(table_checkbox_t2||(table_checkbox_t2=table_checkbox_`
      :host {
        display: contents;
      }
...
`)),Dependencies=[GdsTableCheckbox,button_component.t,card_component.z,divider_component_GdsDivider,img_component_GdsImg,context_menu_component.Hx,menu_item_component.T,dropdown_component.E,input_component_GdsInput,GdsPagination,text_component_GdsText,badge_component.K,link_component_GdsLink,flex_component.o,copy_component.b,cross_small_component.r,magnifying_glass_component.l,sort_component.C,sort_down_component.W,sort_up_component.n,dot_grid_one_horizontal_component.z],table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function table_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),_this.pageSizes=[5,10,20,50,100],_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.view={page:1,pageSize:10,searchQuery:"",visibleColumns:new Set},_this.loaded=!0,_this.loading=!1,_this.data=[],_this.total=0,_this.selected=new Set,_this.error=null,_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"connectedCallback",value:(_connectedCallback=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return table_component_superPropGet(GdsTable,"connectedCallback",this,3)([]),this.view.visibleColumns=new Set(this.columns.map((function(col){return col.key}))),_context.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context.stop()}}),_callee,this)}))),function connectedCallback(){return _connectedCallback.apply(this,arguments)})},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
      <div class="table ${0}">
        ${0}
        ${0}
        ${0}
      </div>
    `),this.density,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderHeaderControls_fn).call(this),(0,when.z)(this.error,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderErrorState_fn).call(_this2)}),(function(){return(0,when.z)(0===_this2.data.length&&!_this2.loading,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderEmptyState_fn).call(_this2)}),(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderTable_fn).call(_this2)}))})),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderFooter_fn).call(this))}},{key:"clearSelection",value:function clearSelection(){(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,clearSelectionInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)}},{key:"selectAll",value:function selectAll(){(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,selectAllInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)}},{key:"setSelection",value:function setSelection(indices){var _this3=this,validIndices=indices.filter((function(i){return i>=0&&i<_this3.data.length}));this.selected=new Set(validIndices),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this),this.requestUpdate()}},{key:"getSelection",value:function getSelection(){var _this4=this,indices=Array.from(this.selected);return{indices,data:indices.map((function(i){return _this4.data[i]}))}}}]);var _connectedCallback}(gds_element.j);_cache=new WeakMap,_cacheDuration=new WeakMap,_GdsTable_instances=new WeakSet,hasSelection_get=function hasSelection_get(){return this.selected.size>0},isAllSelected_get=function isAllSelected_get(){return this.data.length>0&&this.selected.size===this.data.length},isPartialSelection_get=function isPartialSelection_get(){return(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get)&&!(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get)},getCacheKey_fn=function getCacheKey_fn(){return JSON.stringify({page:this.view.page,pageSize:this.view.pageSize,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery})},isCacheValid_fn=function isCacheValid_fn(entry){return Date.now()-entry.timestamp<(0,chunk_QU3DSPNU.S7)(this,_cacheDuration)},loadData_fn=function(){var _ref=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee2(){var cacheKey,cachedData,response;return regenerator_default().wrap((function _callee2$(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:if(this.dataProvider){_context2.next=2;break}return _context2.abrupt("return");case 2:if(cacheKey=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,getCacheKey_fn).call(this),!(cachedData=(0,chunk_QU3DSPNU.S7)(this,_cache)[cacheKey])||!(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,isCacheValid_fn).call(this,cachedData)){_context2.next=9;break}return this.data=cachedData.data,this.total=cachedData.total,this.loaded=!1,_context2.abrupt("return");case 9:return this.loading=!0,this.error=null,_context2.prev=11,_context2.next=14,this.dataProvider({page:this.view.page,pageSize:this.view.pageSize,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery});case 14:response=_context2.sent,(0,chunk_QU3DSPNU.S7)(this,_cache)[cacheKey]={data:response.data,total:response.total,timestamp:Date.now()},this.data=response.data,this.total=response.total,this.selected.clear(),this.loaded=!1,this.dispatchEvent(new CustomEvent("gds-table-data-loaded",{detail:response,bubbles:!0})),_context2.next=27;break;case 23:_context2.prev=23,_context2.t0=_context2.catch(11),this.error=_context2.t0,this.dispatchEvent(new CustomEvent("gds-table-data-error",{detail:_context2.t0,bubbles:!0}));case 27:return _context2.prev=27,this.loading=!1,_context2.finish(27);case 30:case"end":return _context2.stop()}}),_callee2,this,[[11,23,27,30]])})));return function loadData_fn(){return _ref.apply(this,arguments)}}(),renderCell_fn=function renderCell_fn(config,row){if(!config)return null;var resolve=function resolve(value){return"function"==typeof value?value(row):value};switch(config.type){case"badge":var variant=resolve(config.variant)||"information",size=resolve(config.size)||"small";return(0,custom_element_scoping.qy)(table_component_t2||(table_component_t2=table_component_2`
          <gds-badge size="${0}" variant="${0}">
            ${0}
          </gds-badge>
        `),size,variant,resolve(config.value));case"avatar":var src=resolve(config.src);if(!src)return null;var _size=config.size||"24px";return(0,custom_element_scoping.qy)(table_component_t3||(table_component_t3=table_component_2`
          <gds-img
            src="${0}"
            alt="${0}"
            width="${0}"
            ...
            object-fit="cover"
          ></gds-img>
        `),src,resolve(config.alt)||"",_size,_size);case"copy-button":var valueToCopy=String(resolve(config.value)||""),_size2=resolve(config.size)||"small";return(0,custom_element_scoping.qy)(table_component_t4||(table_component_t4=table_component_2`
          <gds-button
            size="${0}"
            rank="tertiary"
            @click="${0}"
        ...
        `),_size3,rank,_variant,(function(e){e.stopPropagation(),config.onClick(row)}),label);case"action-buttons":var buttons=config.buttons;return(0,custom_element_scoping.qy)(table_component_t6||(table_component_t6=table_component_2`
          <div style="display: flex; gap: var(--gds-sys-space-xs);">
            ${0}
          </div>
        `),buttons.map((function(btn){var label=resolve(btn.label),size=btn.size||"small",rank=btn.rank||"secondary",variant=btn.variant||"neutral";return(0,custom_element_scoping.qy)(table_component_t7||(table_component_t7=table_component_2`
                <gds-button
                  size="${0}"
                  rank="${0}"
                  variant="${0}"
              ...
              `),size,rank,variant,(function(e){e.stopPropagation(),btn.onClick(row)}),label)})));case"action-link":var href=resolve(config.href),_label=resolve(config.label),target=config.target||"_self";return(0,custom_element_scoping.qy)(table_component_t8||(table_component_t8=table_component_2`
          <gds-link .href="${0}" target="${0}"> ${0} </gds-link>
        `),href,target,_label);case"action-menu":var items=config.items;return(0,custom_element_scoping.qy)(table_component_t9||(table_component_t9=table_component_2`
          <gds-context-menu>
        ...
        `),items.map((function(item){var label=resolve(item.label);return(0,custom_element_scoping.qy)(table_component_t10||(table_component_t10=table_component_2`
                ${0}
                <gds-menu-item @click="${0}">
                  ${0}
                </gds-menu-item>
              `),item.divider?(0,custom_element_scoping.qy)(table_component_t11||(table_component_t11=table_component_2`<gds-divider></gds-divider>`)):"",(function(){return item.onClick(row)}),label)})));default:return null}},renderCellContent_fn=function renderCellContent_fn(row,column){var cell=column.cell,lead=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCell_fn).call(this,null==cell?void 0:cell.lead,row),value=null!=cell&&cell.value?(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCell_fn).call(this,cell.value,row):row[column.key],trail=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCell_fn).call(this,null==cell?void 0:cell.trail,row);return(0,custom_element_scoping.qy)(_t12||(_t12=table_component_2`
      <div class="cell-content">
        ${0}
        <span class="cell-value">${0}</span>
        ${0}
      </div>
    `),lead&&(0,custom_element_scoping.qy)(_t13||(_t13=table_component_2`<span class="cell-lead">${0}</span>`),lead),value,trail&&(0,custom_element_scoping.qy)(_t14||(_t14=table_component_2`<span class="cell-trail">${0}</span>`),trail))},renderSortIcon_fn=function renderSortIcon_fn(column){var isSorted=this.view.sortColumn===column.key,sortDirection=this.view.sortDirection;return isSorted?"asc"===sortDirection?(0,custom_element_scoping.qy)(_t15||(_t15=table_component_2`<gds-icon-sort-up size="m"></gds-icon-sort-up>`)):(0,custom_element_scoping.qy)(_t16||(_t16=table_component_2`<gds-icon-sort-down size="m"></gds-icon-sort-down>`)):(0,custom_element_scoping.qy)(_t17||(_t17=table_component_2`<gds-icon-sort-up size="m"></gds-icon-sort-up>`))},renderHeaderControls_fn=function renderHeaderControls_fn(){var _this5=this;return this.plain?null:(0,custom_element_scoping.qy)(_t18||(_t18=table_component_2`
      <div class="header">
        <div class="lead">
          <gds-input
            type="text"
    ...
    `),this.view.searchQuery,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearch_fn),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn),Array.from(this.view.visibleColumns),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleColumnVisibility_fn),this.columns.map((function(column){return(0,custom_element_scoping.qy)(_t19||(_t19=table_component_2`
              ...
              `),column.key,_this5.view.visibleColumns.has(column.key),column.label)})))},renderColumnHeader_fn=function renderColumnHeader_fn(column){var _this6=this,isSorted=this.view.sortColumn===column.key,sortDirection=this.view.sortDirection;return(0,custom_element_scoping.qy)(_t20||(_t20=table_component_2`
      <th
        class=${0}
        @click=${0}
      >
    ...
    `),(0,class_map.H)({sortable:!!column.sortable,sorted:isSorted,"sort-asc":isSorted&&"asc"===sortDirection,"sort-desc":isSorted&&"desc"===sortDirection,"text-right":"right"===column.align,"space-between":!0===column.justify}),column.sortable?function(){return(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleSort_fn).call(_this6,column.key)}:null,column.label,(0,when.z)(column.sortable,(function(){return(0,custom_element_scoping.qy)(_t21||(_t21=table_component_2`
              <span class="sort-icon">${0}</span>
            `),(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,renderSortIcon_fn).call(_this6,column))})))},renderTableHeader_fn=function renderTableHeader_fn(){var _this7=this;return(0,custom_element_scoping.qy)(_t22||(_t22=table_component_2`
      <thead>
        <tr>
          ${0}
          ${0}
    ...
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t23||(_t23=table_component_2`
            ...
            `),(0,chunk_QU3DSPNU.S7)(_this7,_GdsTable_instances,isAllSelected_get),(0,chunk_QU3DSPNU.S7)(_this7,_GdsTable_instances,isPartialSelection_get),(0,chunk_QU3DSPNU.jq)(_this7,_GdsTable_instances,handleSelectAll_fn))})),this.columns.filter((function(column){return _this7.view.visibleColumns.has(column.key)})).map((function(column){return(0,chunk_QU3DSPNU.jq)(_this7,_GdsTable_instances,renderColumnHeader_fn).call(_this7,column)})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t24||(_t24=table_component_2`<th class="column-header actions">
                ${0}
              </th>`),"object"===(0,esm_typeof.A)(_this7.actions)&&_this7.actions.label?(0,custom_element_scoping.qy)(_t25||(_t25=table_component_2`<div class="column-label">${0}</div>`),_this7.actions.label):(0,custom_element_scoping.qy)(_t26||(_t26=table_component_2`<div class="column-label">Actions</div>`)))})))},renderTableCell_fn=function renderTableCell_fn(row,column){return(0,custom_element_scoping.qy)(_t27||(_t27=table_component_2`
      <td
        data-label=${0}
        class=${0}
      >
    ...
    `),column.label,(0,class_map.H)({"text-right":"right"===column.align,"space-between":!0===column.justify}),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCellContent_fn).call(this,row,column))},renderTableRow_fn=function renderTableRow_fn(row,index){var _this8=this;return(0,custom_element_scoping.qy)(_t28||(_t28=table_component_2`
      <tr
        class=${0}
      >
        ${0}
    ...
    `),(0,class_map.H)({selected:this.selected.has(index),loading:this.loading}),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t29||(_t29=table_component_2`
          ...
          `),_this8.selected.has(index),index+1,(function(e){return(0,chunk_QU3DSPNU.jq)(_this8,_GdsTable_instances,handleRowSelect_fn).call(_this8,index,e)}))})),this.columns.filter((function(column){return _this8.view.visibleColumns.has(column.key)})).map((function(column){return(0,chunk_QU3DSPNU.jq)(_this8,_GdsTable_instances,renderTableCell_fn).call(_this8,row,column)})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t30||(_t30=table_component_2`
            <td class="actions-cell" data-label="Actions">
              <div class="cell-content">
                ${0}
              </div>
            </td>
          `),"function"==typeof _this8.actions?_this8.actions(row,index):(0,chunk_QU3DSPNU.jq)(_this8,_GdsTable_instances,renderCell_fn).call(_this8,_this8.actions.cell,row))})))},renderSkeletonCell_fn=function renderSkeletonCell_fn(){return(0,custom_element_scoping.qy)(_t31||(_t31=table_component_2`
      <div class="cell-content">
        <span class="skeleton skeleton-text"></span>
      </div>
    `))},renderSkeletonRow_fn=function renderSkeletonRow_fn(index){var _this9=this;return(0,custom_element_scoping.qy)(_t32||(_t32=table_component_2`
      <tr class="skeleton-row">
        ${0}
        ${0}
        ${0}
      </tr>
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t33||(_t33=table_component_2`
            <td class="checkbox-cell">
              <span class="skeleton skeleton-checkbox"></span>
            </td>
          `))})),this.columns.filter((function(column){return _this9.view.visibleColumns.has(column.key)})).map((function(){return(0,custom_element_scoping.qy)(_t34||(_t34=table_component_2` <td>${0}</td> `),(0,chunk_QU3DSPNU.jq)(_this9,_GdsTable_instances,renderSkeletonCell_fn).call(_this9))})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t35||(_t35=table_component_2`
            <td class="actions-cell">
              <div class="cell-content">
                <span class="skeleton skeleton-action"></span>
              </div>
            </td>
          `))})))},renderTableBody_fn=function renderTableBody_fn(){var _this10=this;if(this.loading&&this.loaded){var skeletonRows=Array.from({length:this.view.pageSize},(function(_,i){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderSkeletonRow_fn).call(_this10,i)}));return(0,custom_element_scoping.qy)(_t36||(_t36=table_component_2`<tbody>
        ${0}
      </tbody>`),skeletonRows)}return(0,custom_element_scoping.qy)(_t37||(_t37=table_component_2`
      <tbody>
        ${0}
      </tbody>
    `),this.data.map((function(row,index){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderTableRow_fn).call(_this10,row,index)})))},renderTable_fn=function renderTable_fn(){var CLASSES=(0,class_map.H)({responsive:this.responsive,data:!0});return(0,custom_element_scoping.qy)(_t38||(_t38=table_component_2`
      <div class=${0}>
        <table>
          ${0} ${0}
        </table>
      </div>
    `),CLASSES,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableBody_fn).call(this))},renderErrorState_fn=function renderErrorState_fn(){var _this11=this;return(0,custom_element_scoping.qy)(_t39||(_t39=table_component_2`
    ...
    `),(function(){return(0,chunk_QU3DSPNU.jq)(_this11,_GdsTable_instances,loadData_fn).call(_this11)}))},renderEmptyState_fn=function renderEmptyState_fn(){var hasSearch=this.view.searchQuery.length>0;return(0,custom_element_scoping.qy)(_t40||(_t40=table_component_2`
    ...
    `),hasSearch?"No results found":"No data available",hasSearch?(0,custom_element_scoping.qy)(_t41||(_t41=table_component_2`
                <gds-text
                  tag="p"
                  font="detail-book-s"
                  color="var(--gds-sys-color-content-neutral-02)"
              ...
              `),this.view.searchQuery):"",hasSearch?(0,custom_element_scoping.qy)(_t42||(_t42=table_component_2`
              <gds-button size="small" @click=${0}>
                Clear search
              </gds-button>
            `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn)):"")},renderFooter_fn=function renderFooter_fn(){var _this12=this;return this.plain?null:(0,custom_element_scoping.qy)(_t43||(_t43=table_component_2`
      <div class="footer">
        <div class="lead">
    ...
    `),(0,when.z)(this.selectable&&(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get),(function(){return(0,custom_element_scoping.qy)(_t44||(_t44=table_component_2`
              ...
              `),_this12.selected.size,_this12.data.length,_this12.clearSelection)}),(function(){return(0,custom_element_scoping.qy)(_t45||(_t45=table_component_2`
                <span>
                  <!-- Showing ${0} to
                  ${0}
                  of ${0} entries -->
              ...
              `),(_this12.view.page-1)*_this12.view.pageSize+1,Math.min(_this12.view.page*_this12.view.pageSize,_this12.total),_this12.total,(_this12.view.page-1)*_this12.view.pageSize+1,Math.min(_this12.view.page*_this12.view.pageSize,_this12.total),_this12.total)})),this.view.page,this.view.pageSize,this.total,this.pageSizes,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handlePageChange_fn),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handlePageSizeChange_fn))},handleSearch_fn=function(){var _ref3=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee4(e){var input;return regenerator_default().wrap((function _callee4$(_context4){for(;;)switch(_context4.prev=_context4.next){case 0:return input=e.target,this.view=Object.assign({},this.view,{searchQuery:input.value,page:1}),_context4.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context4.stop()}}),_callee4,this)})));return function handleSearch_fn(_x2){return _ref3.apply(this,arguments)}}(),handleSearchClear_fn=function(){var _ref4=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee5(){return regenerator_default().wrap((function _callee5$(_context5){for(;;)switch(_context5.prev=_context5.next){case 0:return this.view=Object.assign({},this.view,{searchQuery:"",page:1}),_context5.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context5.stop()}}),_callee5,this)})));return function handleSearchClear_fn(){return _ref4.apply(this,arguments)}}(),handleSort_fn=function(){var _ref5=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee6(columnKey){return regenerator_default().wrap((function _callee6$(_context6){for(;;)switch(_context6.prev=_context6.next){case 0:return this.view=Object.assign({},this.view,{sortColumn:columnKey,sortDirection:this.view.sortColumn===columnKey&&"asc"===this.view.sortDirection?"desc":"asc",page:1}),_context6.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context6.stop()}}),_callee6,this)})));return function handleSort_fn(_x3){return _ref5.apply(this,arguments)}}(),handlePageChange_fn=function(){var _ref6=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee7(e){return regenerator_default().wrap((function _callee7$(_context7){for(;;)switch(_context7.prev=_context7.next){case 0:return this.view=Object.assign({},this.view,{page:e.detail.page}),_context7.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context7.stop()}}),_callee7,this)})));return function handlePageChange_fn(_x4){return _ref6.apply(this,arguments)}}(),handlePageSizeChange_fn=function(){var _ref7=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee8(e){return regenerator_default().wrap((function _callee8$(_context8){for(;;)switch(_context8.prev=_context8.next){case 0:return this.view=Object.assign({},this.view,{pageSize:e.detail.pageSize,page:1}),_context8.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context8.stop()}}),_callee8,this)})));return function handlePageSizeChange_fn(_x5){return _ref7.apply(this,arguments)}}(),handleColumnVisibility_fn=function handleColumnVisibility_fn(e){var selectedColumns=e.detail.value;this.view=Object.assign({},this.view,{visibleColumns:new Set(selectedColumns)}),this.requestUpdate()},handleSelectAll_fn=function handleSelectAll_fn(e){(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get)?(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,clearSelectionInternal_fn).call(this):(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,selectAllInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)},handleRowSelect_fn=function handleRowSelect_fn(index,e){e.detail.checked?this.selected.add(index):this.selected.delete(index),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this),this.requestUpdate()},selectAllInternal_fn=function selectAllInternal_fn(){this.selected=new Set(this.data.map((function(_,i){return i}))),this.requestUpdate()},clearSelectionInternal_fn=function clearSelectionInternal_fn(){this.selected.clear(),this.requestUpdate()},emitSelectionChange_fn=function emitSelectionChange_fn(){var _this13=this;this.dispatchEvent(new CustomEvent("gds-table-selection",{detail:{selectedIndices:Array.from(this.selected),selectedData:Array.from(this.selected).map((function(i){return _this13.data[i]})),count:this.selected.size},bubbles:!0}))},table_component_GdsTable.styles=[tokens_style.LU,TableStyles],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],table_component_GdsTable.prototype,"pageSizes",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],table_component_GdsTable.prototype,"columns",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"dataProvider",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],table_component_GdsTable.prototype,"density",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"selectable",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"responsive",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],table_component_GdsTable.prototype,"plain",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"actions",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"view",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"loaded",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"loading",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"data",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"total",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"selected",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"error",2),table_component_GdsTable=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-table",{dependsOn:Dependencies})],table_component_GdsTable);var GdsTable=function GdsTable(props){table_component_GdsTable.define();var JSXElement=(0,react.p)("gds-table"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsTable.__docgenInfo={description:"",methods:[],displayName:"GdsTable"};var GdsText=function GdsText(props){text_component_GdsText.define();var JSXElement=(0,react.p)("gds-text"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsText.__docgenInfo={description:"",methods:[],displayName:"GdsText"};var GdsTextarea=function GdsTextarea(props){textarea_component_GdsTextarea.define();var JSXElement=(0,react.p)("gds-textarea"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsTextarea.__docgenInfo={description:"",methods:[],displayName:"GdsTextarea"};var video_styles_t,video_component_t,theme=__webpack_require__("./dist/libs/core/src/generated/react/theme/index.js"),video_styles_default=(0,lit.AH)(video_styles_t||(video_styles_t=(function _(t){return t})`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
//# sourceMappingURL=7828.0607ddc9.iframe.bundle.js.map