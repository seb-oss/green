...
`)),spinner_component_=function _(t){return t};function spinner_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(spinner_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function spinner_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var spinner_component_GdsSpinner=function(_withMarginProps){function GdsSpinner(){var _this;return(0,classCallCheck.A)(this,GdsSpinner),_this=function spinner_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,spinner_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsSpinner,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsSpinner_instances),_this.label=(0,lit_localize.ab)("Loading..."),_this.labelPosition="bottom",_this.showLabel=!1,_this.cover=!1,_this.fullscreen=!1,_this.size="md",_this._isAnimating=!1,(0,chunk_QU3DSPNU.VK)(_this,_originalStyles,{overflow:"visible",overscrollBehavior:"auto"}),_this}return(0,inherits.A)(GdsSpinner,_withMarginProps),(0,createClass.A)(GdsSpinner,[{key:"connectedCallback",value:function connectedCallback(){spinner_component_superPropGet(GdsSpinner,"connectedCallback",this,3)([]),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchCustomEvent("gds-spinner-connected")}},{key:"disconnectedCallback",value:function disconnectedCallback(){spinner_component_superPropGet(GdsSpinner,"disconnectedCallback",this,3)([]),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1,spinner_component_superPropGet(GdsSpinner,"disconnectedCallback",this,3)([])}},{key:"_updateAriaLabel",value:function _updateAriaLabel(){this.setAttribute("aria-label",this.label)}},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(spinner_component_t||(spinner_component_t=spinner_component_`
  ...
  `),config.size||"small",config.rank||"secondary",config.variant||"neutral",(function(e){e.stopPropagation(),config.onClick(row)}),resolve(config.label,row))},"action-buttons":function actionButtons(config,row){return(0,lit.qy)(table_cell_t5||(table_cell_t5=table_cell_`
    <div style="display: flex; gap: var(--gds-sys-space-xs);">
      ${0}
    </div>
  `),config.buttons.map((function(btn){return(0,lit.qy)(table_cell_t6||(table_cell_t6=table_cell_`
          <gds-button
            size="${0}"
            rank="${0}"
            variant="${0}"
        ...
        `),btn.size||"small",btn.rank||"secondary",btn.variant||"neutral",(function(e){e.stopPropagation(),btn.onClick(row)}),resolve(btn.label,row))})))},"action-link":function actionLink(config,row){return(0,lit.qy)(table_cell_t7||(table_cell_t7=table_cell_`
    <gds-link
      .href="${0}"
      target="${0}"
    >
  ...
  `),resolve(config.href,row),config.target||"_self",resolve(config.label,row))},"action-menu":function actionMenu(config,row){return(0,lit.qy)(table_cell_t8||(table_cell_t8=table_cell_`
    <gds-context-menu>
      <gds-button slot="trigger" size="small" rank="tertiary"> ••• </gds-button>
      ${0}
    </gds-context-menu>
  `),config.items.map((function(item){return(0,lit.qy)(_t9||(_t9=table_cell_`
          ${0}
          <gds-menu-item
            variant="${0}"
            @click="${0}"
        ...
        `),item.divider?(0,lit.qy)(_t10||(_t10=table_cell_`<gds-divider></gds-divider>`)):"",item.variant||"",(function(){return item.onClick(row)}),resolve(item.label,row))})))}},Cell=function Cell(config,row){if(!config)return null;var renderer=cellRenderers[config.type];return renderer?renderer(config,row):null},menu_item_component=__webpack_require__("./dist/libs/core/src/primitives/menu/menu-item.component.js"),chevron_double_left_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-double-left.component.js"),chevron_double_right_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-double-right.component.js"),chevron_left_small_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-left-small.component.js"),chevron_right_small_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-right-small.component.js"),text_styles_default=(0,lit.AH)(text_styles_t||(text_styles_t=(function _(t){return t})`
  :host {
    display: block;
  }
...
`)),table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function table_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.tableState={page:1,pageSize:10,searchQuery:"",visibleColumns:new Set},_this.initialLoad=!0,_this.loading=!1,_this.data=[],_this.totalRows=0,_this.selectedRows=new Set,_this.error=null,_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"connectedCallback",value:(_connectedCallback=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return table_component_superPropGet(GdsTable,"connectedCallback",this,3)([]),this.tableState.visibleColumns=new Set(this.columns.map((function(col){return col.key}))),_context.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context.stop()}}),_callee,this)}))),function connectedCallback(){return _connectedCallback.apply(this,arguments)})},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
    ...
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t13||(_t13=table_component_2`
    ...
    `),(0,class_map.H)({selected:this.selectedRows.has(index),loading:this.loading}),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t19||(_t19=table_component_2`
          ...
          `),"function"==typeof _this8.actions?_this8.actions(row,index):Cell(_this8.actions.cell,row))})))},renderSkeletonCell_fn=function renderSkeletonCell_fn(){return(0,custom_element_scoping.qy)(_t21||(_t21=table_component_2`
      <div class="cell-content">
        <span class="skeleton skeleton-text"></span>
      </div>
    `))},renderSkeletonRow_fn=function renderSkeletonRow_fn(index){var _this9=this;return(0,custom_element_scoping.qy)(_t22||(_t22=table_component_2`
    ...
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t23||(_t23=table_component_2`
          ...
          `))})),this.columns.filter((function(column){return _this9.tableState.visibleColumns.has(column.key)})).map((function(){return(0,custom_element_scoping.qy)(_t24||(_t24=table_component_2` <td>${0}</td> `),(0,chunk_QU3DSPNU.jq)(_this9,_GdsTable_instances,renderSkeletonCell_fn).call(_this9))})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t25||(_t25=table_component_2`
            <td class="actions-cell">
              <div class="cell-content">
                <span class="skeleton skeleton-action"></span>
              </div>
            </td>
          `))})))},renderTableBody_fn=function renderTableBody_fn(){var _this10=this;if(this.loading&&this.initialLoad){var skeletonRows=Array.from({length:this.tableState.pageSize},(function(_,i){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderSkeletonRow_fn).call(_this10,i)}));return(0,custom_element_scoping.qy)(_t26||(_t26=table_component_2`<tbody>
        ${0}
      </tbody>`),skeletonRows)}return(0,custom_element_scoping.qy)(_t27||(_t27=table_component_2`
      <tbody>
        ${0}
      </tbody>
    `),this.data.map((function(row,index){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderTableRow_fn).call(_this10,row,index)})))},renderTable_fn=function renderTable_fn(){var CLASSES=(0,class_map.H)({responsive:this.responsive,data:!0});return(0,custom_element_scoping.qy)(_t28||(_t28=table_component_2`
      <div class=${0}>
        <table>
          ${0} ${0}
        </table>
      </div>
    `),CLASSES,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableBody_fn).call(this))},renderErrorState_fn=function renderErrorState_fn(){var _this11=this;return(0,custom_element_scoping.qy)(_t29||(_t29=table_component_2`
    ...
    `),(function(){return(0,chunk_QU3DSPNU.jq)(_this11,_GdsTable_instances,loadData_fn).call(_this11)}))},renderEmptyState_fn=function renderEmptyState_fn(){var hasSearch=this.tableState.searchQuery.length>0;return(0,custom_element_scoping.qy)(_t30||(_t30=table_component_2`
    ...
    `),hasSearch?"No results found":"No data available",hasSearch?(0,custom_element_scoping.qy)(_t31||(_t31=table_component_2`
                <gds-text
                  tag="p"
                  font="detail-book-s"
                  color="var(--gds-sys-color-content-neutral-02)"
              ...
              `),this.tableState.searchQuery):"",hasSearch?(0,custom_element_scoping.qy)(_t32||(_t32=table_component_2`
              <gds-button size="small" @click=${0}>
                Clear search
              </gds-button>
            `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn)):"")},renderFooter_fn=function renderFooter_fn(){var _this12=this;return this.plain?null:(0,custom_element_scoping.qy)(_t33||(_t33=table_component_2`
      <div class="footer">
        <div class="lead">
    ...
    `),(0,when.z)(this.selectable&&(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get),(function(){return(0,custom_element_scoping.qy)(_t34||(_t34=table_component_2`
              ...
              `),_this12.selectedRows.size,_this12.data.length,_this12.clearSelection)}),(function(){return(0,custom_element_scoping.qy)(_t35||(_t35=table_component_2`
                <span>
                  Showing
                  ${0}
                  to
...
//# sourceMappingURL=496.fd2b4185.iframe.bundle.js.map