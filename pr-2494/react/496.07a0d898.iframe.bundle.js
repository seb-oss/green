...
`)),spinner_component_=function _(t){return t};function spinner_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(spinner_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function spinner_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var spinner_component_GdsSpinner=function(_withMarginProps){function GdsSpinner(){var _this;return(0,classCallCheck.A)(this,GdsSpinner),_this=function spinner_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,spinner_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsSpinner,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsSpinner_instances),_this.label=(0,lit_localize.ab)("Loading..."),_this.labelPosition="bottom",_this.showLabel=!1,_this.cover=!1,_this.fullscreen=!1,_this.size="md",_this._isAnimating=!1,(0,chunk_QU3DSPNU.VK)(_this,_originalStyles,{overflow:"visible",overscrollBehavior:"auto"}),_this}return(0,inherits.A)(GdsSpinner,_withMarginProps),(0,createClass.A)(GdsSpinner,[{key:"connectedCallback",value:function connectedCallback(){spinner_component_superPropGet(GdsSpinner,"connectedCallback",this,3)([]),this.setAttribute("role","status"),this.setAttribute("aria-live","polite"),this._isAnimating=!0,this.dispatchCustomEvent("gds-spinner-connected")}},{key:"disconnectedCallback",value:function disconnectedCallback(){spinner_component_superPropGet(GdsSpinner,"disconnectedCallback",this,3)([]),this.fullscreen&&(this.fullscreen=!1,this._toggleRootStyles()),this._isAnimating=!1,spinner_component_superPropGet(GdsSpinner,"disconnectedCallback",this,3)([])}},{key:"_updateAriaLabel",value:function _updateAriaLabel(){this.setAttribute("aria-label",this.label)}},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(spinner_component_t||(spinner_component_t=spinner_component_`
    ...
    `),size,variant,resolve(config.value,row))},avatar:function avatar(config,row){var src=resolve(config.src,row);if(!src)return null;var size=config.size||"24px";return(0,lit.qy)(table_cell_t2||(table_cell_t2=table_cell_`
      ...
      ></gds-img>
    `),src,resolve(config.alt,row)||"",size,size)},"copy-button":function copyButton(config,row){var valueToCopy=String(resolve(config.value,row)||""),size=resolve(config.size,row)||"small";return(0,lit.qy)(table_cell_t3||(table_cell_t3=table_cell_`
      <gds-button
        size="${0}"
        rank="tertiary"
        @click="${0}"
    ...
    `),size,function(){var _ref=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(e){return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return e.stopPropagation(),_context.next=3,navigator.clipboard.writeText(valueToCopy);case 3:case"end":return _context.stop()}}),_callee)})));return function(_x){return _ref.apply(this,arguments)}}())},"action-menu":function actionMenu(config,row){return(0,lit.qy)(table_cell_t4||(table_cell_t4=table_cell_`
    <gds-context-menu>
  ...
  `),config.items.map((function(item,idx){return(0,lit.qy)(table_cell_t5||(table_cell_t5=table_cell_`
          ${0}
          <gds-menu-item
            variant="${0}"
            @click="${0}"
        ...
        `),item.divider?(0,lit.qy)(table_cell_t6||(table_cell_t6=table_cell_`<gds-divider></gds-divider>`)):"",item.variant||"",(function(){return item.onClick(row)}),resolve(item.label,row))})))},"action-buttons":function actionButtons(config,row){return(0,lit.qy)(table_cell_t7||(table_cell_t7=table_cell_`
    <div style="display: flex; gap: 4px;">
      ${0}
    </div>
  `),config.buttons.map((function(btn){return(0,lit.qy)(table_cell_t8||(table_cell_t8=table_cell_`
          <gds-button
            size="small"
            rank="tertiary"
            variant="${0}"
        ...
        `),btn.variant||"neutral",(function(e){e.stopPropagation(),btn.onClick(row)}))})))},"action-link":function actionLink(config,row){return(0,lit.qy)(_t9||(_t9=table_cell_`
    <gds-link
      href="${0}"
      target="${0}"
    >
  ...
  `),resolve(config.href,row),config.target||"_self",resolve(config.label,row))},"formatted-number":function formattedNumber(config,row){var value=resolve(config.value,row);return(0,numberFormats[config.format||"decimalsAndThousands"])(value,config.locale,config.currency)},"formatted-account":function formattedAccount(config,row){var value=resolve(config.value,row);return(0,accountsFormats[config.format||"seb-account"])(value)},"formatted-date":function formattedDate(config,row){var value=resolve(config.value,row);return(0,dateTimeFormats[config.format||"dateLong"])(value,config.locale)}},Cell=function Cell(config,row){if(!config)return null;var renderer=cellRenderers[config.type];return renderer?renderer(config,row):null},menu_item_component=__webpack_require__("./dist/libs/core/src/primitives/menu/menu-item.component.js"),chevron_double_left_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-double-left.component.js"),chevron_double_right_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-double-right.component.js"),chevron_left_small_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-left-small.component.js"),chevron_right_small_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-right-small.component.js"),text_styles_default=(0,lit.AH)(text_styles_t||(text_styles_t=(function _(t){return t})`
  :host {
    display: block;
  }
...
`)),table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function table_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.actionsLabel="Actions",_this.tableState={page:1,pageSize:10,searchQuery:"",visibleColumns:new Set},_this.initialLoad=!0,_this.loading=!1,_this.data=[],_this.totalRows=0,_this.selectedRows=new Set,_this.error=null,_this.slots={},_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"connectedCallback",value:(_connectedCallback=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return table_component_superPropGet(GdsTable,"connectedCallback",this,3)([]),this.tableState.visibleColumns=new Set(this.columns.map((function(col){return col.key}))),_context.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context.stop()}}),_callee,this)}))),function connectedCallback(){return _connectedCallback.apply(this,arguments)})},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
    ...
    `),(0,when.z)(this.title||this.subtitle,(function(){return(0,custom_element_scoping.qy)(table_component_t9||(table_component_t9=table_component_2`
            <div class="header-meta">
              ${0}
              ${0}
            </div>
          `),(0,when.z)(_this5.title,(function(){return(0,custom_element_scoping.qy)(_t10||(_t10=table_component_2`
                  <gds-text tag="h2" font="heading-m">${0}</gds-text>
                `),_this5.title)})),(0,when.z)(_this5.subtitle,(function(){return(0,custom_element_scoping.qy)(_t11||(_t11=table_component_2`
                  <gds-text tag="p" font="detail-book-s"
                    >${0}</gds-text
                  >
                `),_this5.subtitle)})))})),this.tableState.searchQuery,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearch_fn),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn),Array.from(this.tableState.visibleColumns),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleColumnVisibility_fn),this.columns.map((function(column){return(0,custom_element_scoping.qy)(_t12||(_t12=table_component_2`
                  <gds-option
                    value=${0}
                    ?selected=${0}
                  >
    ...
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t16||(_t16=table_component_2`
    ...
    `),(0,class_map.H)({selected:this.selectedRows.has(index),loading:this.loading}),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t21||(_t21=table_component_2`
          ...
          `),_this8.actions(row,index))})))},renderSkeletonCell_fn=function renderSkeletonCell_fn(){return(0,custom_element_scoping.qy)(_t23||(_t23=table_component_2`
      <div class="cell-content">
        <span class="skeleton skeleton-text"></span>
      </div>
    `))},renderSkeletonRow_fn=function renderSkeletonRow_fn(index){var _this9=this;return(0,custom_element_scoping.qy)(_t24||(_t24=table_component_2`
      <tr class="skeleton-row">
        ${0}
        ${0}
        ${0}
      </tr>
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t25||(_t25=table_component_2`
            <td class="checkbox-cell">
              <span class="skeleton skeleton-checkbox"></span>
            </td>
          `))})),this.columns.filter((function(column){return _this9.tableState.visibleColumns.has(column.key)})).map((function(){return(0,custom_element_scoping.qy)(_t26||(_t26=table_component_2` <td>${0}</td> `),(0,chunk_QU3DSPNU.jq)(_this9,_GdsTable_instances,renderSkeletonCell_fn).call(_this9))})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t27||(_t27=table_component_2`
            <td class="actions-cell">
              <div class="cell-content">
                <span class="skeleton skeleton-action"></span>
              </div>
            </td>
          `))})))},renderTableBody_fn=function renderTableBody_fn(){var _this10=this;if(this.loading&&this.initialLoad){var skeletonRows=Array.from({length:this.tableState.pageSize},(function(_,i){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderSkeletonRow_fn).call(_this10,i)}));return(0,custom_element_scoping.qy)(_t28||(_t28=table_component_2`<tbody>
        ${0}
      </tbody>`),skeletonRows)}return(0,custom_element_scoping.qy)(_t29||(_t29=table_component_2`
      <tbody>
        ${0}
      </tbody>
    `),this.data.map((function(row,index){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderTableRow_fn).call(_this10,row,index)})))},renderTable_fn=function renderTable_fn(){var CLASSES=(0,class_map.H)({responsive:this.responsive,data:!0});return(0,custom_element_scoping.qy)(_t30||(_t30=table_component_2`
      <div class=${0}>
        <table>
          ${0} ${0}
        </table>
      </div>
    `),CLASSES,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableBody_fn).call(this))},renderErrorState_fn=function renderErrorState_fn(){var _this11=this;return(0,custom_element_scoping.qy)(_t31||(_t31=table_component_2`
      <gds-card
        variant="negative"
        justify-content="center"
      ...
      >
        ...
        <gds-button @click=${0} variant="negative">
          Retry
        </gds-button>
      </gds-card>
    `),(function(){return(0,chunk_QU3DSPNU.jq)(_this11,_GdsTable_instances,loadData_fn).call(_this11)}))},renderFooter_fn=function renderFooter_fn(){var _this12=this;return this.plain?null:(0,custom_element_scoping.qy)(_t32||(_t32=table_component_2`
      <div class="footer">
        <div class="lead">
    ...
    `),(0,when.z)(this.selectable&&(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get),(function(){return(0,custom_element_scoping.qy)(_t33||(_t33=table_component_2`
              ...
              `),_this12.selectedRows.size,_this12.data.length,_this12.clearSelection)}),(function(){return(0,custom_element_scoping.qy)(_t34||(_t34=table_component_2`
                <span>
                  Showing
                  ${0}
                  to
              ...
              `),(_this12.tableState.page-1)*_this12.tableState.pageSize+1,Math.min(_this12.tableState.page*_this12.tableState.pageSize,_this12.totalRows),_this12.totalRows)})),this.tableState.page,this.tableState.pageSize,this.totalRows,[5,10,20,50,100],(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handlePageChange_fn),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handlePageSizeChange_fn))},handleSearch_fn=function(){var _ref2=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee3(e){var input;return regenerator_default().wrap((function _callee3$(_context3){for(;;)switch(_context3.prev=_context3.next){case 0:return input=e.target,this.tableState=Object.assign({},this.tableState,{searchQuery:input.value,page:1}),_context3.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context3.stop()}}),_callee3,this)})));return function handleSearch_fn(_x){return _ref2.apply(this,arguments)}}(),handleSearchClear_fn=function(){var _ref3=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee4(){return regenerator_default().wrap((function _callee4$(_context4){for(;;)switch(_context4.prev=_context4.next){case 0:return this.tableState=Object.assign({},this.tableState,{searchQuery:"",page:1}),_context4.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context4.stop()}}),_callee4,this)})));return function handleSearchClear_fn(){return _ref3.apply(this,arguments)}}(),handleSort_fn=function(){var _ref4=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee5(columnKey){return regenerator_default().wrap((function _callee5$(_context5){for(;;)switch(_context5.prev=_context5.next){case 0:return this.tableState=Object.assign({},this.tableState,{sortColumn:columnKey,sortDirection:this.tableState.sortColumn===columnKey&&"asc"===this.tableState.sortDirection?"desc":"asc",page:1}),_context5.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context5.stop()}}),_callee5,this)})));return function handleSort_fn(_x2){return _ref4.apply(this,arguments)}}(),handlePageChange_fn=function(){var _ref5=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee6(e){return regenerator_default().wrap((function _callee6$(_context6){for(;;)switch(_context6.prev=_context6.next){case 0:return this.tableState=Object.assign({},this.tableState,{page:e.detail.page}),_context6.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context6.stop()}}),_callee6,this)})));return function handlePageChange_fn(_x3){return _ref5.apply(this,arguments)}}(),handlePageSizeChange_fn=function(){var _ref6=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee7(e){return regenerator_default().wrap((function _callee7$(_context7){for(;;)switch(_context7.prev=_context7.next){case 0:return this.tableState=Object.assign({},this.tableState,{pageSize:e.detail.pageSize,page:1}),_context7.next=3,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 3:case"end":return _context7.stop()}}),_callee7,this)})));return function handlePageSizeChange_fn(_x4){return _ref6.apply(this,arguments)}}(),handleColumnVisibility_fn=function handleColumnVisibility_fn(e){var selectedColumns=e.detail.value;this.tableState=Object.assign({},this.tableState,{visibleColumns:new Set(selectedColumns)}),this.requestUpdate()},handleSelectAll_fn=function handleSelectAll_fn(e){(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get)?(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,clearSelectionInternal_fn).call(this):(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,selectAllInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)},handleRowSelect_fn=function handleRowSelect_fn(index,e){e.detail.checked?this.selectedRows.add(index):this.selectedRows.delete(index),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this),this.requestUpdate()},selectAllInternal_fn=function selectAllInternal_fn(){this.selectedRows=new Set(this.data.map((function(_,i){return i}))),this.requestUpdate()},clearSelectionInternal_fn=function clearSelectionInternal_fn(){this.selectedRows.clear(),this.requestUpdate()},emitSelectionChange_fn=function emitSelectionChange_fn(){var _this13=this;this.dispatchEvent(new CustomEvent("gds-table-selection",{detail:{selectedIndices:Array.from(this.selectedRows),selectedData:Array.from(this.selectedRows).map((function(i){return _this13.data[i]})),count:this.selectedRows.size},bubbles:!0}))},table_component_GdsTable.styles=[tokens_style.LU,table_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:String,reflect:!1})],table_component_GdsTable.prototype,"subtitle",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Array})],table_component_GdsTable.prototype,"columns",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"dataProvider",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({reflect:!1})],table_component_GdsTable.prototype,"density",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"selectable",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!1})],table_component_GdsTable.prototype,"responsive",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean})],table_component_GdsTable.prototype,"plain",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],table_component_GdsTable.prototype,"actions",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:String})],table_component_GdsTable.prototype,"actionsLabel",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"tableState",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"initialLoad",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"loading",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"data",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"totalRows",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"selectedRows",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"error",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.wk)()],table_component_GdsTable.prototype,"slots",2),table_component_GdsTable=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-table",{dependsOn:[GdsTableCheckbox,button_component.t,input_component_GdsInput,card_component.z,text_component_GdsText,dropdown_component.E,GdsPagination,magnifying_glass_component.l,sort_component.C,sort_up_component.n,sort_down_component.W,cross_small_component.r,copy_component.b]})],table_component_GdsTable);var GdsTable=function GdsTable(props){table_component_GdsTable.define();var JSXElement=(0,react.p)("gds-table"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsTable.__docgenInfo={description:"",methods:[],displayName:"GdsTable"};var GdsText=function GdsText(props){text_component_GdsText.define();var JSXElement=(0,react.p)("gds-text"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsText.__docgenInfo={description:"",methods:[],displayName:"GdsText"};var GdsTextarea=function GdsTextarea(props){textarea_component_GdsTextarea.define();var JSXElement=(0,react.p)("gds-textarea"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsTextarea.__docgenInfo={description:"",methods:[],displayName:"GdsTextarea"};var video_styles_t,video_component_t,theme=__webpack_require__("./dist/libs/core/src/generated/react/theme/index.js"),video_styles_default=(0,lit.AH)(video_styles_t||(video_styles_t=(function _(t){return t})`
  :host {
    display: block;
    margin: 0;
    padding: 0;
...
//# sourceMappingURL=496.07a0d898.iframe.bundle.js.map