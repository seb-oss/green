...
`)),_2=function _2(t){return t};function pagination_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(pagination_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var pagination_component_GdsPagination=function(_GdsElement){function GdsPagination(){var _this;return(0,classCallCheck.A)(this,GdsPagination),_this=function pagination_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,pagination_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsPagination,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsPagination_instances),_this.page=1,_this.rows=10,_this.total=0,_this.options=[5,10,25,50],_this.jump=!1,_this}return(0,inherits.A)(GdsPagination,_GdsElement),(0,createClass.A)(GdsPagination,[{key:"render",value:function render(){var _this2=this,pageCount=(0,chunk_QU3DSPNU.S7)(this,_GdsPagination_instances,pageCount_get),visiblePages=(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,getVisiblePages_fn).call(this,pageCount);return(0,custom_element_scoping.qy)(pagination_component_t||(pagination_component_t=_2`
    ...
    `),(0,when.z)(this.jump,(function(){return(0,custom_element_scoping.qy)(pagination_component_t2||(pagination_component_t2=_2`
            <gds-button
              size="small"
              rank="secondary"
              ?disabled=${0}
          ...
          `),1===_this2.page,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsPagination_instances,handlePageChange_fn).call(_this2,1)}))})),1===this.page,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsPagination_instances,handlePageChange_fn).call(_this2,_this2.page-1)}),visiblePages.map((function(p){return(0,custom_element_scoping.qy)(pagination_component_t3||(pagination_component_t3=_2`
            ${0}
          `),"..."===p?(0,custom_element_scoping.qy)(pagination_component_t4||(pagination_component_t4=_2`<gds-button
                  size="small"
                  rank="tertiary"
                  width="40px"
                  inert
                >
                  ...
                </gds-button>`)):(0,custom_element_scoping.qy)(pagination_component_t5||(pagination_component_t5=_2`
                  <gds-button
                    size="small"
                    rank="${0}"
                    @click=${0}
                ...
                `),_this2.page===p?"primary":"tertiary",(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsPagination_instances,handlePageChange_fn).call(_this2,p)}),p))})),this.page===pageCount,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsPagination_instances,handlePageChange_fn).call(_this2,_this2.page+1)}),(0,when.z)(this.jump,(function(){return(0,custom_element_scoping.qy)(pagination_component_t6||(pagination_component_t6=_2`
            <gds-button
              rank="secondary"
              size="small"
              ?disabled=${0}
          ...
          `),_this2.page===pageCount,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsPagination_instances,handlePageChange_fn).call(_this2,pageCount)}))})),(0,chunk_QU3DSPNU.jq)(this,_GdsPagination_instances,handlePageSizeMenuClick_fn),this.rows,this.options.map((function(size){return(0,custom_element_scoping.qy)(pagination_component_t7||(pagination_component_t7=_2`
            <gds-menu-item
              data-value=${0}
              class=${0}
            >
...
`)),accountsFormats={"seb-account":function sebAccount(value){var _value$toString,account="string"==typeof value?value.replace(" ",""):null!=(_value$toString=null==value?void 0:value.toString())?_value$toString:"";return 11!==account.length?account:"".concat(account.slice(0,4)," ").concat(account.slice(4,6)," ").concat(account.slice(6,9)," ").concat(account.slice(9,11))}},convertValueToDate=function convertValueToDate(value){return"string"==typeof value?new Date(value):value},dateTimeFormats={dateOnlyNumbers:function dateOnlyNumbers(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"short"}).format(convertValueToDate(value))},dateLong:function dateLong(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"long"}).format(convertValueToDate(value))},dateLongWithWeekday:function dateLongWithWeekday(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"full"}).format(convertValueToDate(value))},dateShort:function dateShort(value,locale){var formatter=new Intl.DateTimeFormat(locale,{dateStyle:"medium"});return"sv-se"===(null==locale?void 0:locale.toLowerCase())?formatter.format(convertValueToDate(value)).replace(".",""):formatter.format(convertValueToDate(value))},dateShortWithWeekday:function dateShortWithWeekday(value,locale){var formatted=new Intl.DateTimeFormat(locale,{weekday:"short",year:"numeric",month:"short",day:"numeric"}).format(convertValueToDate(value));return"sv-se"===(null==locale?void 0:locale.toLowerCase())?formatted.replace(".",""):"en-gb"===(null==locale?void 0:locale.toLowerCase())?formatted.replace(",",""):formatted},timeShort:function timeShort(value,locale){return new Intl.DateTimeFormat(locale,{timeStyle:"short"}).format(convertValueToDate(value))},timeLong:function timeLong(value,locale){return new Intl.DateTimeFormat(locale,{timeStyle:"medium"}).format(convertValueToDate(value))}},numberFormats={decimalsAndThousands:function decimalsAndThousands(value,locale,currency){var options={maximumFractionDigits:2,minimumFractionDigits:2};return currency?new Intl.NumberFormat(locale,Object.assign({},options,{style:"currency",currency})).format(Number(value)):new Intl.NumberFormat(locale,options).format(Number(value))}},Styles=[tokens_style.LU,rbcb_toggle_style.A,TableStyles],Dependencies=[button_component.t,card_component.z,divider_component_GdsDivider,img_component_GdsImg,context_menu_component.Hx,menu_item_component.T,dropdown_component.E,input_component_GdsInput,pagination_component_GdsPagination,text_component_GdsText,badge_component.K,link_component_GdsLink,flex_component.o,copy_component.b,cross_small_component.r,minus_small_component.Z,magnifying_glass_component.l,sort_component.C,sort_down_component.W,sort_up_component.n,dot_grid_one_horizontal_component.z],table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function table_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),_this.options=[5,10,20,50,100],_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.view={page:1,rows:10,searchQuery:"",visibleColumns:new Set},_this.loaded=!0,_this.loading=!1,_this.rows=[],_this.total=0,_this.selected=new Set,_this.error=null,_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"connectedCallback",value:(_connectedCallback=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return table_component_superPropGet(GdsTable,"connectedCallback",this,3)([]),this.view.visibleColumns=new Set(this.columns.map((function(col){return col.key}))),_context.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context.stop()}}),_callee,this)}))),function connectedCallback(){return _connectedCallback.apply(this,arguments)})},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
    ...
    `),this.density,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderHeaderControls_fn).call(this),(0,when.z)(this.error,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderErrorState_fn).call(_this2)}),(function(){return(0,when.z)(0===_this2.rows.length&&!_this2.loading,(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderEmptyState_fn).call(_this2)}),(function(){return(0,chunk_QU3DSPNU.jq)(_this2,_GdsTable_instances,renderTable_fn).call(_this2)}))})),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderFooter_fn).call(this))}},{key:"clearSelection",value:function clearSelection(){(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,clearSelectionInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)}},{key:"selectAll",value:function selectAll(){(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,selectAllInternal_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this)}},{key:"setSelection",value:function setSelection(indices){var _this3=this,validIndices=indices.filter((function(i){return i>=0&&i<_this3.rows.length}));this.selected=new Set(validIndices),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,emitSelectionChange_fn).call(this),this.requestUpdate()}},{key:"getSelection",value:function getSelection(){var _this4=this,indices=Array.from(this.selected);return{indices,data:indices.map((function(i){return _this4.rows[i]}))}}}]);var _connectedCallback}(gds_element.j);_cache=new WeakMap,_cacheDuration=new WeakMap,_GdsTable_instances=new WeakSet,hasSelection_get=function hasSelection_get(){return this.selected.size>0},isAllSelected_get=function isAllSelected_get(){return this.rows.length>0&&this.selected.size===this.rows.length},isPartialSelection_get=function isPartialSelection_get(){return(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get)&&!(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,isAllSelected_get)},getCacheKey_fn=function getCacheKey_fn(){return JSON.stringify({page:this.view.page,rows:this.view.rows,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery})},isCacheValid_fn=function isCacheValid_fn(entry){return Date.now()-entry.timestamp<(0,chunk_QU3DSPNU.S7)(this,_cacheDuration)},loadData_fn=function(){var _ref=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee2(){var cacheKey,cachedData,response;return regenerator_default().wrap((function _callee2$(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:if(this.data){_context2.next=2;break}return _context2.abrupt("return");case 2:if(cacheKey=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,getCacheKey_fn).call(this),!(cachedData=(0,chunk_QU3DSPNU.S7)(this,_cache)[cacheKey])||!(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,isCacheValid_fn).call(this,cachedData)){_context2.next=9;break}return this.rows=cachedData.rows,this.total=cachedData.total,this.loaded=!1,_context2.abrupt("return");case 9:return this.loading=!0,this.error=null,_context2.prev=11,_context2.next=14,this.data({page:this.view.page,rows:this.view.rows,sortColumn:this.view.sortColumn,sortDirection:this.view.sortDirection,searchQuery:this.view.searchQuery});case 14:response=_context2.sent,(0,chunk_QU3DSPNU.S7)(this,_cache)[cacheKey]={rows:response.rows,total:response.total,timestamp:Date.now()},this.rows=response.rows,this.total=response.total,this.selected.clear(),this.loaded=!1,this.dispatchEvent(new CustomEvent("gds-table-data-loaded",{detail:response,bubbles:!0})),_context2.next=27;break;case 23:_context2.prev=23,_context2.t0=_context2.catch(11),this.error=_context2.t0,this.dispatchEvent(new CustomEvent("gds-table-data-error",{detail:_context2.t0,bubbles:!0}));case 27:return _context2.prev=27,this.loading=!1,_context2.finish(27);case 30:case"end":return _context2.stop()}}),_callee2,this,[[11,23,27,30]])})));return function loadData_fn(){return _ref.apply(this,arguments)}}(),renderCell_fn=function renderCell_fn(config,row){if(!config)return null;var resolve=function resolve(value){return"function"==typeof value?value(row):value};switch(config.type){case"badge":var variant=resolve(config.variant)||"information",size=resolve(config.size)||"small";return(0,custom_element_scoping.qy)(table_component_t2||(table_component_t2=table_component_2`
        ...
        `),_size3,rank,_variant,(function(e){e.stopPropagation(),config.onClick(row)}),label);case"action-buttons":return config.buttons.map((function(btn){var label=resolve(btn.label),size=btn.size||"small",rank=btn.rank||"secondary",variant=btn.variant||"neutral";return(0,custom_element_scoping.qy)(table_component_t6||(table_component_t6=table_component_2`
            <gds-button
              size="${0}"
              rank="${0}"
              variant="${0}"
          ...
          `),size,rank,variant,(function(e){e.stopPropagation(),btn.onClick(row)}),label)}));case"action-link":var href=resolve(config.href),_label=resolve(config.label),target=config.target||"_self";return(0,custom_element_scoping.qy)(table_component_t7||(table_component_t7=table_component_2`
          <gds-link .href="${0}" target="${0}"> ${0} </gds-link>
        `),href,target,_label);case"input":return(0,custom_element_scoping.qy)(table_component_t8||(table_component_t8=table_component_2` <gds-input size="small" width="100%" plain></gds-input> `));case"dropdown":return(0,custom_element_scoping.qy)(_t9||(_t9=table_component_2`
          <gds-dropdown plain size="small" width="100%">
            <gds-option>Hello</gds-option>
          </gds-dropdown>
        `));case"action-menu":var items=config.items;return(0,custom_element_scoping.qy)(_t10||(_t10=table_component_2`
          <gds-context-menu>
        ...
        `),items.map((function(item){var label=resolve(item.label);return(0,custom_element_scoping.qy)(_t11||(_t11=table_component_2`
                ${0}
                <gds-menu-item @click="${0}">
                  ${0}
                </gds-menu-item>
              `),item.divider?(0,custom_element_scoping.qy)(_t12||(_t12=table_component_2`<gds-divider></gds-divider>`)):"",(function(){return item.onClick(row)}),label)})));default:return null}},renderCellContent_fn=function renderCellContent_fn(row,column){var cell=column.cell,lead=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCell_fn).call(this,null==cell?void 0:cell.lead,row),value=null!=cell&&cell.value?(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCell_fn).call(this,cell.value,row):row[column.key],trail=(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderCell_fn).call(this,null==cell?void 0:cell.trail,row);return(0,custom_element_scoping.qy)(_t13||(_t13=table_component_2`
      <div class="cell-content">
        ${0}
        <span class="cell-value">${0}</span>
        ${0}
      </div>
    `),lead&&(0,custom_element_scoping.qy)(_t14||(_t14=table_component_2`<span class="cell-lead">${0}</span>`),lead),value,trail&&(0,custom_element_scoping.qy)(_t15||(_t15=table_component_2`<span class="cell-trail">${0}</span>`),trail))},renderSortIcon_fn=function renderSortIcon_fn(column){var isSorted=this.view.sortColumn===column.key,sortDirection=this.view.sortDirection;return isSorted?"asc"===sortDirection?(0,custom_element_scoping.qy)(_t16||(_t16=table_component_2`<gds-icon-sort-up size="m"></gds-icon-sort-up>`)):(0,custom_element_scoping.qy)(_t17||(_t17=table_component_2`<gds-icon-sort-down size="m"></gds-icon-sort-down>`)):(0,custom_element_scoping.qy)(_t18||(_t18=table_component_2`<gds-icon-sort-up size="m"></gds-icon-sort-up>`))},renderHeaderControls_fn=function renderHeaderControls_fn(){var _this5=this;return this.plain?null:(0,custom_element_scoping.qy)(_t19||(_t19=table_component_2`
      <div class="header">
        <div class="lead">
          <gds-input
            type="text"
    ...
    `),this.view.searchQuery,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearch_fn),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn),Array.from(this.view.visibleColumns),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleColumnVisibility_fn),this.columns.map((function(column){return(0,custom_element_scoping.qy)(_t20||(_t20=table_component_2`
              ...
              `),column.key,_this5.view.visibleColumns.has(column.key),column.label)})))},renderColumnHeader_fn=function renderColumnHeader_fn(column){var _this6=this,isSorted=this.view.sortColumn===column.key,sortDirection=this.view.sortDirection;return(0,custom_element_scoping.qy)(_t21||(_t21=table_component_2`
      <th
        class=${0}
        @click=${0}
      >
    ...
    `),(0,class_map.H)({sortable:!!column.sortable,sorted:isSorted,"sort-asc":isSorted&&"asc"===sortDirection,"sort-desc":isSorted&&"desc"===sortDirection,"text-right":"right"===column.align,"space-between":!0===column.justify}),column.sortable?function(){return(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleSort_fn).call(_this6,column.key)}:null,column.label,(0,when.z)(column.sortable,(function(){return(0,custom_element_scoping.qy)(_t22||(_t22=table_component_2`
            ...
            `),(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,renderSortIcon_fn).call(_this6,column))})))},renderTableHeader_fn=function renderTableHeader_fn(){var _this7=this;return(0,custom_element_scoping.qy)(_t23||(_t23=table_component_2`
      <thead>
        <tr>
          ${0}
          ${0}
    ...
    `),(0,class_map.H)({selected:this.selected.has(index),loading:this.loading}),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t30||(_t30=table_component_2`
          ...
          `),"function"==typeof _this8.actions?_this8.actions(row,index):(0,chunk_QU3DSPNU.jq)(_this8,_GdsTable_instances,renderCell_fn).call(_this8,_this8.actions.cell,row))})))},renderCheckbox_fn=function renderCheckbox_fn(_ref3){var checked=_ref3.checked,_ref3$indeterminate=_ref3.indeterminate,indeterminate=void 0!==_ref3$indeterminate&&_ref3$indeterminate,_ref3$disabled=_ref3.disabled,disabled=void 0!==_ref3$disabled&&_ref3$disabled,ariaLabel=_ref3.ariaLabel,onToggle=_ref3.onToggle,toggle=function toggle(e){e.stopPropagation(),disabled||onToggle()};return(0,custom_element_scoping.qy)(_t32||(_t32=table_component_2`
      <div
        class="rbcb-wrapper"
        role="checkbox"
        aria-checked=${0}
    ...
    `))},renderSkeletonRow_fn=function renderSkeletonRow_fn(index){var _this9=this;return(0,custom_element_scoping.qy)(_t34||(_t34=table_component_2`
      <tr class="skeleton-row">
        ${0}
        ${0}
        ${0}
      </tr>
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t35||(_t35=table_component_2`
            <td class="checkbox-cell">
              <span class="skeleton skeleton-checkbox"></span>
            </td>
          `))})),this.columns.filter((function(column){return _this9.view.visibleColumns.has(column.key)})).map((function(){return(0,custom_element_scoping.qy)(_t36||(_t36=table_component_2` <td>${0}</td> `),(0,chunk_QU3DSPNU.jq)(_this9,_GdsTable_instances,renderSkeletonCell_fn).call(_this9))})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t37||(_t37=table_component_2`
            <td class="actions-cell">
              <div class="cell-content">
                <span class="skeleton skeleton-action"></span>
              </div>
            </td>
          `))})))},renderTableBody_fn=function renderTableBody_fn(){var _this10=this;if(this.loading&&this.loaded){var skeletonRows=Array.from({length:this.view.rows},(function(_,i){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderSkeletonRow_fn).call(_this10,i)}));return(0,custom_element_scoping.qy)(_t38||(_t38=table_component_2`<tbody>
        ${0}
      </tbody>`),skeletonRows)}return(0,custom_element_scoping.qy)(_t39||(_t39=table_component_2`
      <tbody>
        ${0}
      </tbody>
    `),this.rows.map((function(row,index){return(0,chunk_QU3DSPNU.jq)(_this10,_GdsTable_instances,renderTableRow_fn).call(_this10,row,index)})))},renderTable_fn=function renderTable_fn(){var CLASSES=(0,class_map.H)({responsive:this.responsive,data:!0});return(0,custom_element_scoping.qy)(_t40||(_t40=table_component_2`
      <div class=${0}>
        <table>
          ${0} ${0}
        </table>
      </div>
    `),CLASSES,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableBody_fn).call(this))},renderErrorState_fn=function renderErrorState_fn(){var _this11=this;return(0,custom_element_scoping.qy)(_t41||(_t41=table_component_2`
    ...
    `),(function(){return(0,chunk_QU3DSPNU.jq)(_this11,_GdsTable_instances,loadData_fn).call(_this11)}))},renderEmptyState_fn=function renderEmptyState_fn(){var hasSearch=this.view.searchQuery.length>0;return(0,custom_element_scoping.qy)(_t42||(_t42=table_component_2`
    ...
    `),hasSearch?"No results found":"No data available",hasSearch?(0,custom_element_scoping.qy)(_t43||(_t43=table_component_2`
                <gds-text
                  tag="p"
                  font="detail-book-s"
                  color="var(--gds-sys-color-content-neutral-02)"
              ...
              `),this.view.searchQuery):"",hasSearch?(0,custom_element_scoping.qy)(_t44||(_t44=table_component_2`
              <gds-button size="small" @click=${0}>
                Clear search
              </gds-button>
            `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn)):"")},renderFooter_fn=function renderFooter_fn(){var _this12=this;return this.plain||this.total<1?null:(0,custom_element_scoping.qy)(_t45||(_t45=table_component_2`
      <div class="footer">
        <div class="lead">
    ...
    `),(0,when.z)(this.selectable&&(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get),(function(){return(0,custom_element_scoping.qy)(_t46||(_t46=table_component_2`
...
//# sourceMappingURL=1832.3fa1fdd8.iframe.bundle.js.map