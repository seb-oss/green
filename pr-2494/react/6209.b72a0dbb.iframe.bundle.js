/*! For license information please see 6209.b72a0dbb.iframe.bundle.js.LICENSE.txt */
...
`)),accountsFormats={"seb-account":function sebAccount(value){var _value$toString,account="string"==typeof value?value.replace(" ",""):null!=(_value$toString=null==value?void 0:value.toString())?_value$toString:"";return 11!==account.length?account:"".concat(account.slice(0,4)," ").concat(account.slice(4,6)," ").concat(account.slice(6,9)," ").concat(account.slice(9,11))}},convertValueToDate=function convertValueToDate(value){return"string"==typeof value?new Date(value):value},dateTimeFormats={dateOnlyNumbers:function dateOnlyNumbers(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"short"}).format(convertValueToDate(value))},dateLong:function dateLong(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"long"}).format(convertValueToDate(value))},dateLongWithWeekday:function dateLongWithWeekday(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"full"}).format(convertValueToDate(value))},dateShort:function dateShort(value,locale){var formatter=new Intl.DateTimeFormat(locale,{dateStyle:"medium"});return"sv-se"===(null==locale?void 0:locale.toLowerCase())?formatter.format(convertValueToDate(value)).replace(".",""):formatter.format(convertValueToDate(value))},dateShortWithWeekday:function dateShortWithWeekday(value,locale){var formatted=new Intl.DateTimeFormat(locale,{weekday:"short",year:"numeric",month:"short",day:"numeric"}).format(convertValueToDate(value));return"sv-se"===(null==locale?void 0:locale.toLowerCase())?formatted.replace(".",""):"en-gb"===(null==locale?void 0:locale.toLowerCase())?formatted.replace(",",""):formatted},timeShort:function timeShort(value,locale){return new Intl.DateTimeFormat(locale,{timeStyle:"short"}).format(convertValueToDate(value))},timeLong:function timeLong(value,locale){return new Intl.DateTimeFormat(locale,{timeStyle:"medium"}).format(convertValueToDate(value))},dateTimeLong:function dateTimeLong(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"long",timeStyle:"short"}).format(convertValueToDate(value))},dateTimeLongWithWeekday:function dateTimeLongWithWeekday(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"full",timeStyle:"short"}).format(convertValueToDate(value))},dateTimeShort:function dateTimeShort(value,locale){return new Intl.DateTimeFormat(locale,{dateStyle:"medium",timeStyle:"short"}).format(convertValueToDate(value))}},numberFormats={decimalsAndThousands:function decimalsAndThousands(value,locale,currency){var options={maximumFractionDigits:2,minimumFractionDigits:2};return currency?new Intl.NumberFormat(locale,Object.assign({},options,{style:"currency",currency})).format(Number(value)):new Intl.NumberFormat(locale,options).format(Number(value))}},Styles=[tokens_style.LU,rbcb_toggle_style.A,TableStyles],Dependencies=[button_component.t,card_component.z,img_component_GdsImg,context_menu_component.Hx,menu_item_component.T,dropdown_component.E,input_component_GdsInput,pagination_component_GdsPagination,text_component_GdsText,badge_component.K,link_component_GdsLink,flex_component.o,copy_component.b,cross_small_component.r,minus_small_component.Z,magnifying_glass_component.l,sort_component.C,sort_down_component.W,sort_up_component.n,dot_grid_one_horizontal_component.z],table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function table_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),(0,chunk_QU3DSPNU.VK)(_this,_templateCache,new Map),_this.options=[5,10,20,50,100],_this.page=1,_this.rows=10,_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.searchable=!1,_this.settings=!1,_this.striped=!1,_this.nocache=!1,_this.view={page:_this.page,rows:_this.rows,searchQuery:"",visibleColumns:new Set},_this.loaded=!0,_this.loading=!1,_this.rowsState=[],_this.total=0,_this.selected=new Set,_this.error=null,_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"connectedCallback",value:(_connectedCallback=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){var _this$page,_this$rows;return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return table_component_superPropGet(GdsTable,"connectedCallback",this,3)([]),this.view=Object.assign({},this.view,{page:Number(null!=(_this$page=this.page)?_this$page:1),rows:Number(null!=(_this$rows=this.rows)?_this$rows:10),visibleColumns:new Set(this.columns.map((function(col){return col.key})))}),_context.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context.stop()}}),_callee,this)}))),function connectedCallback(){return _connectedCallback.apply(this,arguments)})},{key:"render",value:function render(){var _this2=this,classes=(0,defineProperty.A)({table:!0,plain:this.plain,striped:this.striped},this.density,this.density);return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
    ...
    `),(0,when.z)(this.searchable,(function(){return(0,custom_element_scoping.qy)(_t14||(_t14=table_component_2`
              <gds-input
                type="text"
                size="small"
                plain
            ...
            `),_this6.view.searchQuery,(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleSearch_fn),(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleSearchClear_fn))})),(0,when.z)(this.settings,(function(){return(0,custom_element_scoping.qy)(_t15||(_t15=table_component_2`
              <gds-dropdown
                multiple
                plain
                size="small"
            ...
            `),Array.from(_this6.view.visibleColumns),(0,chunk_QU3DSPNU.jq)(_this6,_GdsTable_instances,handleColumnVisibility_fn),_this6.columns.map((function(column){return(0,custom_element_scoping.qy)(_t16||(_t16=table_component_2`
                    <gds-option
                      value=${0}
                      ?selected=${0}
                    >
    ...
    `))},renderSkeletonRow_fn=function renderSkeletonRow_fn(index){var _this12=this;return(0,custom_element_scoping.qy)(_t29||(_t29=table_component_2`
      <tr class="skeleton-row">
        ${0}
        ${0}
        ${0}
      </tr>
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t30||(_t30=table_component_2`
            <td class="checkbox-cell">
              <span class="skeleton skeleton-checkbox"></span>
            </td>
          `))})),this.columns.filter((function(column){return _this12.view.visibleColumns.has(column.key)})).map((function(){return(0,custom_element_scoping.qy)(_t31||(_t31=table_component_2` <td>${0}</td> `),(0,chunk_QU3DSPNU.jq)(_this12,_GdsTable_instances,renderSkeletonCell_fn).call(_this12))})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t32||(_t32=table_component_2`
        ...
        ${0}
      </tbody>`),skeletonRows)}return(0,custom_element_scoping.qy)(_t34||(_t34=table_component_2`
      <tbody>
        ${0}
      </tbody>
    `),this.rowsState.map((function(row,index){return(0,chunk_QU3DSPNU.jq)(_this13,_GdsTable_instances,renderTableRow_fn).call(_this13,row,index)})))},renderTable_fn=function renderTable_fn(){var CLASSES=(0,class_map.H)({responsive:this.responsive,data:!0});return(0,custom_element_scoping.qy)(_t35||(_t35=table_component_2`
      <div class=${0}>
        <table>
          ${0} ${0}
        </table>
      </div>
    `),CLASSES,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableHeader_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,renderTableBody_fn).call(this))},renderErrorState_fn=function renderErrorState_fn(){var _this14=this;return(0,custom_element_scoping.qy)(_t36||(_t36=table_component_2`
    ...
    `),(function(){return(0,chunk_QU3DSPNU.jq)(_this14,_GdsTable_instances,loadData_fn).call(_this14)}))},renderEmptyState_fn=function renderEmptyState_fn(){var hasSearch=this.view.searchQuery.length>0;return(0,custom_element_scoping.qy)(_t37||(_t37=table_component_2`
    ...
    `),hasSearch?"No results found":"No data available",hasSearch?(0,custom_element_scoping.qy)(_t38||(_t38=table_component_2`
                <gds-text tag="p" font="detail-book-s">
                  No results for "${0}"
                </gds-text>
              `),this.view.searchQuery):"",hasSearch?(0,custom_element_scoping.qy)(_t39||(_t39=table_component_2`
              <gds-button size="small" @click=${0}>
                Clear search
              </gds-button>
            `),(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,handleSearchClear_fn)):"")},renderFooter_fn=function renderFooter_fn(){var _this15=this;return this.plain||this.total<1?null:(0,custom_element_scoping.qy)(_t40||(_t40=table_component_2`
      <div class="footer">
        <div class="lead">
    ...
    `),(0,when.z)(this.selectable&&(0,chunk_QU3DSPNU.S7)(this,_GdsTable_instances,hasSelection_get),(function(){return(0,custom_element_scoping.qy)(_t41||(_t41=table_component_2`
...
//# sourceMappingURL=6209.b72a0dbb.iframe.bundle.js.map