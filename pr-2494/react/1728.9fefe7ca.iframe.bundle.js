...
`)),text_component_=function _(t){return t};function text_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(text_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var text_component_GdsText=function(_GdsDiv){function GdsText(){var _this;return(0,classCallCheck.A)(this,GdsText),(_this=function text_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,text_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsText,arguments)).tag="span",_this}return(0,inherits.A)(GdsText,_GdsDiv),(0,createClass.A)(GdsText,[{key:"render",value:function render(){var TAG=(0,static_html.Bk)(encodeURI(this.tag));return(0,static_html.qy)(text_component_t||(text_component_t=text_component_`<${0} tag><slot></slot></${0}>`),TAG,TAG)}}])}(div_component.o);text_component_GdsText.styles=[tokens_style.LU,defaultStyles,text_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:String})],text_component_GdsText.prototype,"tag",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]",styleTemplate:function styleTemplate(_prop,values){var size=values[0];return"font: var(--gds-sys-text-".concat(size,");")}})],text_component_GdsText.prototype,"font",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]",valueTemplate:function valueTemplate(v){return"var(--gds-sys-text-weight-".concat(v,")")}})],text_component_GdsText.prototype,"font-weight",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)()],text_component_GdsText.prototype,"text-transform",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]"})],text_component_GdsText.prototype,"text-decoration",2),(0,chunk_QU3DSPNU.Cc)([(0,style_expression_property.F)({selector:"[tag]",styleTemplate:function styleTemplate(_prop,values){return"overflow: hidden;\n      text-overflow: ellipsis;\n      display: -webkit-box;\n      -webkit-line-clamp: ".concat(values[0],";\n      -webkit-box-orient: vertical;")}})],text_component_GdsText.prototype,"lines",2),text_component_GdsText=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-text")],text_component_GdsText);var pagination_component_t,pagination_component_t2,pagination_component_t3,pagination_component_t4,pagination_component_t5,pagination_component_t6,menu_item_component=__webpack_require__("./dist/libs/core/src/primitives/menu/menu-item.component.js"),chevron_double_left_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-double-left.component.js"),chevron_double_right_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-double-right.component.js"),chevron_left_small_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-left-small.component.js"),chevron_right_small_component=__webpack_require__("./dist/libs/core/src/components/icon/icons/chevron-right-small.component.js"),_2=function _2(t){return t};function pagination_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(pagination_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var GdsPagination=function(_GdsElement){function GdsPagination(){var _this;return(0,classCallCheck.A)(this,GdsPagination),(_this=function pagination_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,pagination_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsPagination,arguments)).page=1,_this.pageSize=10,_this.total=0,_this.pageSizes=[5,10,25,50],_this}return(0,inherits.A)(GdsPagination,_GdsElement),(0,createClass.A)(GdsPagination,[{key:"pageCount",get:function get(){return Math.ceil(this.total/this.pageSize)}},{key:"getVisiblePages",value:function getVisiblePages(pageCount){if(pageCount<=7)return Array.from({length:pageCount},(function(_,i){return i+1}));var lastPage=pageCount,middlePages=[];return this.page<=4?(middlePages=[2,3,4,5],[1].concat((0,toConsumableArray.A)(middlePages),["...",lastPage])):this.page>=pageCount-3?(middlePages=[pageCount-4,pageCount-3,pageCount-2,pageCount-1],[1,"..."].concat((0,toConsumableArray.A)(middlePages),[lastPage])):(middlePages=[this.page-1,this.page,this.page+1],[1,"..."].concat((0,toConsumableArray.A)(middlePages),["...",lastPage]))}},{key:"render",value:function render(){var _this2=this,pageCount=this.pageCount,visiblePages=this.getVisiblePages(pageCount);return(0,custom_element_scoping.qy)(pagination_component_t||(pagination_component_t=_2`
    ...
    `),size,variant,resolve(config.value,row))},image:function image(config,row){var src=resolve(config.src,row);return src?(0,lit.qy)(table_cell_t2||(table_cell_t2=table_cell_`
      <gds-img
        ...
        loading="${0}"
      ></gds-img>
    `),src,resolve(config.alt,row)||"",resolve(config.width,row)||"",resolve(config.height,row)||"",resolve(config["border-radius"],row)||"",resolve(config["object-fit"],row)||"",resolve(config["object-position"],row)||"",resolve(config.loading,row)||"lazy"):null},"copy-button":function copyButton(config,row){var valueToCopy=String(resolve(config.value,row)||""),size=resolve(config.size,row)||"small";return(0,lit.qy)(table_cell_t3||(table_cell_t3=table_cell_`
      <gds-button
        size="${0}"
        rank="tertiary"
        @click="${0}"
    ...
    `),this.handleClick,this.indeterminate?"mixed":this.checked.toString(),this.ariaLabel,this.handleKeydown,(0,rbcb_toggle_template.o)({checked:this.checked,indeterminate:this.indeterminate,disabled:this.disabled,invalid:!1}))}},{key:"handleClick",value:function handleClick(e){e.stopPropagation(),this.disabled||this.dispatchEvent(new CustomEvent("selector-change",{detail:{checked:!this.checked},bubbles:!0}))}},{key:"handleKeydown",value:function handleKeydown(e){" "!==e.key&&"Enter"!==e.key||(e.preventDefault(),this.handleClick(e))}}])}(gds_element.j);GdsTableCheckbox.styles=[tokens_style.LU,rbcb_toggle_style.A,(0,lit.AH)(table_checkbox_t2||(table_checkbox_t2=table_checkbox_`
      :host {
        display: contents;
      }
...
`)),table_component_2=function _2(t){return t};function table_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(table_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}function table_component_superPropGet(t,o,e,r){var p=(0,get.A)((0,getPrototypeOf.A)(1&r?t.prototype:t),o,e);return 2&r&&"function"==typeof p?function(t){return p.apply(e,t)}:p}var table_component_GdsTable=function(_GdsElement){function GdsTable(){var _this;return(0,classCallCheck.A)(this,GdsTable),_this=function table_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,table_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsTable,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsTable_instances),(0,chunk_QU3DSPNU.VK)(_this,_cache,{}),(0,chunk_QU3DSPNU.VK)(_this,_cacheDuration,3e5),_this.columns=[],_this.density="comfortable",_this.selectable=!1,_this.responsive=!1,_this.plain=!1,_this.tableState={page:1,pageSize:10,searchQuery:"",visibleColumns:new Set},_this.initialLoad=!0,_this.loading=!1,_this.data=[],_this.totalRows=0,_this.selectedRows=new Set,_this.error=null,_this.slots={},_this}return(0,inherits.A)(GdsTable,_GdsElement),(0,createClass.A)(GdsTable,[{key:"connectedCallback",value:(_connectedCallback=(0,asyncToGenerator.A)(regenerator_default().mark((function _callee(){return regenerator_default().wrap((function _callee$(_context){for(;;)switch(_context.prev=_context.next){case 0:return table_component_superPropGet(GdsTable,"connectedCallback",this,3)([]),this.tableState.visibleColumns=new Set(this.columns.map((function(col){return col.key}))),_context.next=4,(0,chunk_QU3DSPNU.jq)(this,_GdsTable_instances,loadData_fn).call(this);case 4:case"end":return _context.stop()}}),_callee,this)}))),function connectedCallback(){return _connectedCallback.apply(this,arguments)})},{key:"render",value:function render(){var _this2=this;return(0,custom_element_scoping.qy)(table_component_t||(table_component_t=table_component_2`
    ...
    `),(0,when.z)(this.selectable,(function(){return(0,custom_element_scoping.qy)(_t16||(_t16=table_component_2`
            ...
            `),(0,chunk_QU3DSPNU.S7)(_this7,_GdsTable_instances,isAllSelected_get),(0,chunk_QU3DSPNU.S7)(_this7,_GdsTable_instances,isPartialSelection_get),(0,chunk_QU3DSPNU.jq)(_this7,_GdsTable_instances,handleSelectAll_fn))})),this.columns.filter((function(column){return _this7.tableState.visibleColumns.has(column.key)})).map((function(column){return(0,chunk_QU3DSPNU.jq)(_this7,_GdsTable_instances,renderColumnHeader_fn).call(_this7,column)})),(0,when.z)(this.actions,(function(){return(0,custom_element_scoping.qy)(_t17||(_t17=table_component_2`<th class="column-header actions">
              ...
              </th>`))})))},renderTableCell_fn=function renderTableCell_fn(row,rowIndex,column){return(0,custom_element_scoping.qy)(_t18||(_t18=table_component_2`
      <td
        data-label=${0}
        class=${0}
      >
...
//# sourceMappingURL=1728.9fefe7ca.iframe.bundle.js.map