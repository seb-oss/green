...
`;var X=Object.defineProperty,V=Object.getOwnPropertyDescriptor,w=t=>{throw TypeError(t)},i=(t,e,a,p)=>{for(var n=p>1?void 0:p?V(e,a):e,u=t.length-1,g;u>=0;u--)(g=t[u])&&(n=(p?g(e,a,n):g(n))||n);return p&&n&&X(e,a,n),n},C=(t,e,a)=>e.has(t)||w("Cannot "+a),l=(t,e,a)=>(C(t,e,"read from private field"),a?a.call(t):e.get(t)),o=(t,e,a)=>e.has(t)?w("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,a),h=(t,e,a)=>(C(t,e,"access private method"),a),r,$,k,m,f,b,v,_,x,E,T,A,S,M,R;let s=class extends D{constructor(){super(),o(this,r),this._defaultRows=4,this.rows=4,this.supportingText="",this.clearable=!1,this.resizable="auto",this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",o(this,m,t=>["type","placeholder","required"].includes(t.name)),o(this,f,t=>{const e=t.target;this.value=e.value}),o(this,b,t=>{const e=t.target;this.value=e.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),o(this,v,t=>{requestAnimationFrame(()=>{this._setAutoHeight()})}),o(this,_,()=>{this.elTextareaAsync.then(t=>t.focus())}),o(this,x,()=>{this.value="",this.rows=this._defaultRows,this.elTextareaAsync.then(t=>{t.style.height="",t.style.setProperty("--_lines",this._defaultRows.toString())}),this.dispatchEvent(new Event("gds-input-cleared",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}),this.value=""}test_getClearButton(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("#clear-button")}test_getFieldElement(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("#field")}connectedCallback(){super.connectedCallback(),this._setAutoHeight()}disconnectedCallback(){super.disconnectedCallback()}render(){return d`${P(this.variant,[["default",()=>h(this,r,$).call(this)],["floating-label",()=>h(this,r,k).call(this)]])}`}_getValidityAnchor(){return this.elTextarea}_setAutoHeight(){this.elTextareaAsync.then(t=>{if(t.value==="")this.rows=this._defaultRows,t.style.height="";else{const e=getComputedStyle(t),a=parseFloat(e.lineHeight),p=t.scrollHeight,n=Math.ceil(p/a);this.rows=Math.max(this._defaultRows,n)}t.style.setProperty("--_lines",this.rows.toString())})}};r=new WeakSet;$=function(){var t;return d`
      ...
      <gds-form-control-footer
        .charCounter=${l(this,r,R)&&this.maxlength-(((t=this.value)==null?void 0:t.length)||0)}
        .validationMessage=${this.invalid&&(this.errorMessage||this.validationMessage)}
      ></gds-form-control-footer>
    `};k=function(){return y};m=new WeakMap;f=new WeakMap;b=new WeakMap;v=new WeakMap;_=new WeakMap;x=new WeakMap;E=function(){return[h(this,r,T).call(this),h(this,r,S).call(this),h(this,r,M).call(this),h(this,r,A).call(this)].map(e=>d`${e}`)};T=function(){return d`<slot slot="lead" name="lead"></slot>`};A=function(){return d`<slot slot="trail" name="trail"></slot>`};S=function(){return d`
      <textarea
        @input=${l(this,f)}
        @change=${l(this,b)}
        @paste=${l(this,v)}
