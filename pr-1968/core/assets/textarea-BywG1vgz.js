...
`;var X=Object.defineProperty,V=Object.getOwnPropertyDescriptor,w=t=>{throw TypeError(t)},i=(t,e,s,p)=>{for(var n=p>1?void 0:p?V(e,s):e,u=t.length-1,g;u>=0;u--)(g=t[u])&&(n=(p?g(e,s,n):g(n))||n);return p&&n&&X(e,s,n),n},$=(t,e,s)=>e.has(t)||w("Cannot "+s),o=(t,e,s)=>($(t,e,"read from private field"),s?s.call(t):e.get(t)),l=(t,e,s)=>e.has(t)?w("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),h=(t,e,s)=>($(t,e,"access private method"),s),r,C,E,m,f,v,b,_,x,S,T,z,A,k,M;let a=class extends D{constructor(){super(),l(this,r),this._defaultRows=4,this.rows=4,this.supportingText="",this.clearable=!1,this.resizable="auto",this.maxlength=Number.MAX_SAFE_INTEGER,this.variant="default",this.size="large",l(this,m,t=>["type","placeholder","required"].includes(t.name)),l(this,f,t=>{const e=t.target;this.value=e.value}),l(this,v,t=>{const e=t.target;this.value=e.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),l(this,b,t=>{requestAnimationFrame(()=>{this._setAutoHeight()})}),l(this,_,()=>{this.elTextareaAsync.then(t=>t.focus())}),l(this,x,()=>{this.value="",this.rows=this._defaultRows,this.elTextareaAsync.then(t=>{t.style.height="",t.style.setProperty("--_lines",this._defaultRows.toString())}),this.dispatchEvent(new Event("gds-input-cleared",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}),this.value=""}test_getClearButton(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("#clear-button")}test_getFieldElement(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("#field")}connectedCallback(){super.connectedCallback(),this._setAutoHeight()}disconnectedCallback(){super.disconnectedCallback()}render(){return d`${P(this.variant,[["default",()=>h(this,r,C).call(this)],["floating-label",()=>h(this,r,E).call(this)]])}`}_getValidityAnchor(){return this.elTextarea}_setAutoHeight(){this.elTextareaAsync.then(t=>{if(t.value==="")this.rows=this._defaultRows,t.style.height="";else{const e=getComputedStyle(t),s=parseFloat(e.lineHeight),p=t.scrollHeight,n=Math.ceil(p/s);this.rows=Math.max(this._defaultRows,n)}t.style.setProperty("--_lines",this.rows.toString())})}};r=new WeakSet;C=function(){var t;return d`
      ...
      <gds-form-control-footer
        lass="size-${this.size}"
        .charCounter=${o(this,r,M)&&this.maxlength-(((t=this.value)==null?void 0:t.length)||0)}
        .validationMessage=${this.invalid&&(this.errorMessage||this.validationMessage)}
      ></gds-form-control-footer>
    `};E=function(){return y};m=new WeakMap;f=new WeakMap;v=new WeakMap;b=new WeakMap;_=new WeakMap;x=new WeakMap;S=function(){return[h(this,r,T).call(this),h(this,r,A).call(this),h(this,r,k).call(this),h(this,r,z).call(this)].map(e=>d`${e}`)};T=function(){return d`<slot slot="lead" name="lead"></slot>`};z=function(){return d`<slot slot="trail" name="trail"></slot>`};A=function(){return d`
      <textarea
        @input=${o(this,f)}
        @change=${o(this,v)}
        @paste=${o(this,b)}
        ...
        ${I(o(this,m))}
      ></textarea>
    `};k=function(){var t;return this.clearable&&(((t=this.value)==null?void 0:t.length)||0)>0?d`
        <gds-button
          size="small"
          rank="tertiary"
