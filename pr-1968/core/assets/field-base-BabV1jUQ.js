import{m as K}from"./runtime-CMQcyTl6.js";import{l as P}from"./localized-decorator-iufJoRiP.js";import{n as p,r as f,g as E,G as C,h as n}from"./custom-element-scoping-BEGY3AqQ.js";import{a as M}from"./query-p8xgzTDt.js";import{n as b}from"./when-BR7zwNJC.js";import{i as T}from"./lit-element-C_s9q329.js";import"./button-DX0_HimP.js";import"./triangle-exclamation-BZzuw6qS.js";import"./card-stRHUTua.js";import"./badge-R9tjKr0S.js";import{e as D}from"./class-map-Bz98xO8-.js";import{T as Q}from"./transitional-styles-gKBkOdeg.js";import{w as U}from"./watch-tFciLXSI.js";/**
 * @license
...
`;var Z=Object.defineProperty,ee=Object.getOwnPropertyDescriptor,G=e=>{throw TypeError(e)},m=(e,t,s,i)=>{for(var a=i>1?void 0:i?ee(t,s):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&Z(t,s,a),a},B=(e,t,s)=>t.has(e)||G("Cannot "+s),z=(e,t,s)=>(B(e,t,"read from private field"),s?s.call(e):t.get(e)),y=(e,t,s)=>t.has(e)?G("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),F=(e,t,s)=>(B(e,t,"access private method"),s),x,W,w,S,N;let g=class extends C{constructor(){super(...arguments),y(this,x),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,y(this,w,()=>n`
      <gds-button
        size="small"
        rank="tertiary"
    ...
    `}};x=new WeakSet;W=function(e){this._hasExtendedSupportingText=e.target.assignedElements({flatten:!0}).length>0};w=new WeakMap;S=new WeakMap;N=function(){return n`
      ...
      >
        <slot
          ...
          @slotchange=${F(this,x,W)}
        ></slot>
      </div>
    `};g.styles=[Y];m([p({type:Boolean,reflect:!0})],g.prototype,"showExtendedSupportingText",2);m([f()],g.prototype,"_hasExtendedSupportingText",2);m([M("#extended-supporting-text")],g.prototype,"_extendedSupportingText",2);g=m([E("gds-form-control-header"),P()],g);const te=T`
  @layer base, reset, transitional-styles;
  @layer base {
    :host > *:not(style) {
      display: flex;
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,L=e=>{throw TypeError(e)},d=(e,t,s,i)=>{for(var a=i>1?void 0:i?de(t,s):t,r=e.length-1,o;r>=0;r--)(o=e[r])&&(a=(i?o(t,s,a):o(a))||a);return i&&a&&le(t,s,a),a},I=(e,t,s)=>t.has(e)||L("Cannot "+s),_=(e,t,s)=>(I(e,t,"read from private field"),s?s.call(e):t.get(e)),k=(e,t,s)=>t.has(e)?L("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),v=(e,t,s)=>(I(e,t,"access private method"),s),h,c,R,X,j,q,J;let l=class extends C{constructor(){super(),k(this,c),this.size="large",this.multiline=!1,this.disabled=!1,this.invalid=!1,this._leadSlotOccupied=!1,this._trailSlotOccupied=!1,this._actionSlotOccupied=!1,k(this,h,(e,t)=>{const i=t.target.assignedNodes({flatten:!0}),a=i.length>0&&i.some(r=>{var o;return r.nodeType===Node.ELEMENT_NODE||r.nodeType===Node.TEXT_NODE&&((o=r.textContent)==null?void 0:o.trim())!==""});e==="lead"?this._leadSlotOccupied=a:e==="trail"?this._trailSlotOccupied=a:e==="action"&&(this._actionSlotOccupied=a)})}connectedCallback(){super.connectedCallback(),Q.instance.apply(this,"gds-field-base")}render(){const e={invalid:this.invalid??!1,multiline:this.multiline,disabled:this.disabled,"lead-slot-occupied":this._leadSlotOccupied,"trail-slot-occupied":this._trailSlotOccupied,"action-slot-occupied":this._actionSlotOccupied,small:this.size==="small"};return n`
      <div class="field ${D(e)}" part="_base">
        ${v(this,c,R).call(this)}
      </div>
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};h=new WeakMap;c=new WeakSet;R=function(){const e=[v(this,c,X).call(this),v(this,c,j).call(this),v(this,c,q).call(this),v(this,c,J).call(this)];return n`${V(e,t=>t)}`};X=function(){return n` <slot
      name="lead"
    ...
    `};J=function(){return n`
      ...
      ></slot>
    `};l.styles=[ne];d([p()],l.prototype,"size",2);d([p({type:Boolean})],l.prototype,"multiline",2);d([p({type:Boolean,reflect:!0})],l.prototype,"disabled",2);d([p({type:Boolean})],l.prototype,"invalid",2);d([M("slot:not([name])")],l.prototype,"_mainSlotElement",2);d([f()],l.prototype,"_leadSlotOccupied",2);d([f()],l.prototype,"_trailSlotOccupied",2);d([f()],l.prototype,"_actionSlotOccupied",2);d([U("disabled")],l.prototype,"_handleDisabledChange",1);l=d([E("gds-field-base"),P()],l);export{V as o};
