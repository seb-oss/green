import{J as c,h as n,g as p,i as b,t as v,n as u,a3 as y,b as m}from"./iframe-CmrrH2XL.js";var h=Object.getOwnPropertyDescriptor,f=(a,e,d,t)=>{for(var s=t>1?void 0:t?h(e,d):e,r=a.length-1,l;r>=0;r--)(l=a[r])&&(s=l(s)||s);return s};let i=class extends c{connectedCallback(){super.connectedCallback(),this.setAttribute("role","listitem")}render(){return n`<slot></slot>`}};i=f([p("gds-list-item")],i);const _=b`
  .gds-list-heading {
