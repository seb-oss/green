import{P,K as R,O as u,N as F,a6 as g,A as v,aa as G,i as M,v as D,n as a,f as W,$ as N,y as q,Q as U,I as L,H,a0 as K,d as A,h as p,o as n,E as X,g as Y,F as Q}from"./iframe-CpjcSp7s.js";import{l as J}from"./localized-decorator-CUVVsq7O.js";import{r as Z}from"./query-async-DMF2tz-5.js";import{f as j,G as tt}from"./form-control-host.style-C_nUrNfd.js";import{G as et,a as st}from"./form-control-header.component-BuVEEWrT.js";import{G as it}from"./flex.component-CnkVJOKX.js";import{I as rt}from"./cross-small.component-ChWg9c64.js";import{c as at}from"./textarea.component-DMzBGUak.js";const ot=P(class extends R{constructor(t){if(super(t),t.type!==u.PROPERTY&&t.type!==u.ATTRIBUTE&&t.type!==u.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!F(t))throw Error("`live` bindings can only contain a single expression")}render(t){return t}update(t,[e]){if(e===g||e===v)return e;const r=t.element,o=t.name;if(t.type===u.PROPERTY){if(e===r[o])return g}else if(t.type===u.BOOLEAN_ATTRIBUTE){if(!!e===r.hasAttribute(o))return g}else if(t.type===u.ATTRIBUTE&&r.getAttribute(o)===e+"")return g;return G(t),e}}),nt=M`
