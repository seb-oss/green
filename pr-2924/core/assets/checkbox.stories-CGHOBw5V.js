import{b as t}from"./iframe-CpjcSp7s.js";import"./checkbox-group-sU6QctpQ.js";import"./flex-CNHAusAk.js";import"./card-B9OAE7QZ.js";import"./text-B0Bqnfyh.js";import"./divider-r6z13NdT.js";import"./circle-check-7Zkf17F_.js";import"./cross-small-qr0SoNES.js";import"./minus-small-DZbE1Bcn.js";import{a as i}from"./argTableProps-BrYLyXkV.js";import"./preload-helper-PPVm8Dsz.js";import"./checkbox-group.component-BMvj3gBu.js";import"./toggle-control-base.component-BV3Jp_ds.js";import"./localized-decorator-CUVVsq7O.js";import"./rbcb-toggle.template-BpEfzWja.js";import"./checkmark.component-Db_WiPI6.js";import"./icon.component-NDpiI65s.js";import"./minus-small.component-xW5hMUUM.js";import"./form-control-header.component-BuVEEWrT.js";import"./badge.component-Cpn7k4dq.js";import"./flex.component-CnkVJOKX.js";import"./triangle-exclamation.component-BeUO_W1e.js";import"./card.component-DAevxUL8.js";import"./circle-info.component-CgfQJWYV.js";import"./text.component-Dl99GF_F.js";import"./default-typography.styles-DV_y9Hng.js";import"./circle-check.component-kve8SJZp.js";import"./cross-small.component-ChWg9c64.js";const H={title:"Components/Checkbox",component:"gds-checkbox-group",subcomponents:{GdsCheckbox:"gds-checkbox"},tags:["autodocs"],argTypes:{...i("gds-checkbox-group")},parameters:{docs:{description:{component:`A checkbox is a form element that allows users to select one or multiple options.<br/>
...
If you click on 'submit' first on the example below it will validate the checkbox group and show the error message.`,...s.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
...
In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...a.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  ...
  \`
}`,...n.parameters?.docs?.source},description:{story:`Checkboxes support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the checkbox group and applies to all checkboxes within.`,...n.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="checkbox-group">
...
Choose the direction based on available space and number of options.`,...r.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...c.parameters?.docs?.source},description:{story:`While checkbox groups can be created without a label, it's recommended to always provide one for clarity and accessibility.
The label helps users understand what the options are for.

In certain cases when space is limited, the group label can be omitted.`,...c.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Indeterminate',
  render: () => html\`
    <gds-checkbox label="Select all" value="1" indeterminate></gds-checkbox>
  \`
}`,...l.parameters?.docs?.source},description:{story:`The indeterminate state is used when a checkbox represents a group of sub-options with mixed selected states.
...
- Bulk actions where the selection applies to only some items in a group`,...l.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...d.parameters?.docs?.source},description:{story:`Sometimes you need a single checkbox where the checkbox group label should be visually hidden but still accessible to screen readers.
...
- Opting into newsletters or marketing communications`,...d.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  ...DefaultParams,
  render: () => html\`
    <gds-flex flex-direction="column" gap="xl" width="500px">
      <gds-flex flex-direction="column" gap="m">
  ...
  \`
}`,...p.parameters?.docs?.source},description:{story:"Demonstrates how `gds-aria-labelledby` and `gds-aria-describedby` are\nforwarded for both `gds-checkbox` and `gds-checkbox-group`.",...p.parameters?.docs?.description}}};const _=["CheckboxButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel","Indeterminate","SingleCheckbox","ARIAForwarding"];export{p as ARIAForwarding,o as CheckboxButton,r as Direction,a as Disabled,g as DosAndDonts,c as GroupLabel,l as Indeterminate,d as SingleCheckbox,n as Size,s as Validation,_ as __namedExportsOrder,H as default};
