import"./switch-BUFaxSVY.js";import"./flex-CNHAusAk.js";import{b as t}from"./iframe-CpjcSp7s.js";import"./text-B0Bqnfyh.js";import"./divider-r6z13NdT.js";import{a as x}from"./argTableProps-BrYLyXkV.js";import"./switch.component-CZl57ZLp.js";import"./checkmark.component-Db_WiPI6.js";import"./icon.component-NDpiI65s.js";import"./flex.component-CnkVJOKX.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-Dl99GF_F.js";import"./default-typography.styles-DV_y9Hng.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
