...
`;let a=class extends i.o{connectedCallback(){super.connectedCallback(),this.setAttribute("role","list")}render(){return o.qy`<slot></slot>`}};a.styles=[n.LU,l],a=(0,s.Cc)([(0,o.Y$)("gds-list")],a)},3095(e,t,r){"use strict";r.d(t,{F:()=>i}),r(745);var s=r(6506),o=r(7593),n=r(9633);const i=e=>{o.F.define();const t=(0,n.pI)("gds-alert"),r={...e,class:e.className,ref:e.ref};return(0,s.createElement)(t,r)};i.displayName="GdsAlert"},2022(e,t,r){"use strict";r.d(t,{o:()=>i}),r(745);var s=r(6506),o=r(8833),n=r(9633);const i=e=>{o.o.define();const t=(0,n.pI)("gds-div"),r={...e,class:e.className,ref:e.ref};return(0,s.createElement)(t,r)};i.displayName="GdsDiv"},8369(e,t,r){"use strict";r.r(t),r.d(t,{GdsAlert:()=>s.F,GdsAvatar:()=>H,GdsAvatarGroup:()=>jC,GdsBackdrop:()=>xo,GdsBadge:()=>Z,GdsBlur:()=>$,GdsBreadcrumb:()=>UC,GdsBreadcrumbs:()=>B,GdsButton:()=>W,GdsCalendar:()=>Y,GdsCard:()=>T,GdsCardLinked:()=>O,GdsCardPattern01:()=>dC,GdsCheckbox:()=>pe,GdsCheckboxGroup:()=>gh,GdsCoachmark:()=>Be,GdsContextMenu:()=>We,GdsDatepicker:()=>Ye,GdsDetails:()=>tt,GdsDialog:()=>Lt,GdsDiv:()=>Ht.o,GdsDivider:()=>St,GdsDropdown:()=>jt,GdsFab:()=>Nt,GdsFilterChip:()=>Mh,GdsFilterChips:()=>qt,GdsFlex:()=>Bt,GdsFormSummary:()=>ir,GdsFormattedAccount:()=>vh,GdsFormattedDate:()=>yh,GdsFormattedNumber:()=>wh,GdsGrid:()=>cr,GdsGroupedList:()=>Cr,GdsIconDetails:()=>fh,GdsImg:()=>gr,GdsInput:()=>ps,GdsLink:()=>Ms,GdsList:()=>ks,GdsListItem:()=>Lh,GdsListItemPattern01:()=>$C,GdsMask:()=>bs,GdsMenuButton:()=>Ss,GdsMenuHeading:()=>g_,GdsMenuItem:()=>h_,GdsOption:()=>m_,GdsPagination:()=>Lo,GdsPopover:()=>Zo,GdsRadio:()=>Go,GdsRadioGroup:()=>Uh,GdsRichText:()=>Bo,GdsSegment:()=>Jh,GdsSegmentedControl:()=>en,GdsSelect:()=>vn,GdsSensitiveAccount:()=>Xh,GdsSensitiveDate:()=>tp,GdsSensitiveNumber:()=>sp,GdsSignal:()=>_n,GdsSpinner:()=>Sn,GdsSwitch:()=>Un,GdsTab:()=>op,GdsTabPanel:()=>np,GdsTable:()=>zc,GdsTabs:()=>$d,GdsText:()=>Nd,GdsTextarea:()=>Gd,GdsTheme:()=>jd.G,GdsVideo:()=>Bd,IconAi:()=>lp,IconAirplaneUp:()=>cp,IconArchive:()=>Cp,IconArrow:()=>au,IconArrowBottomTop:()=>pp,IconArrowBoxLeft:()=>mp,IconArrowBoxLeftAlt:()=>gp,IconArrowBoxRight:()=>Vp,IconArrowDown:()=>vp,IconArrowInbox:()=>bp,IconArrowLeft:()=>Hp,IconArrowLeftRight:()=>wp,IconArrowOutOfBox:()=>Zp,IconArrowRight:()=>qp,IconArrowRightCircle:()=>Ip,IconArrowRightDownCircle:()=>Np,IconArrowRightUpCircle:()=>jp,IconArrowRotateClockwise:()=>zp,IconArrowRotateCounterClockwise:()=>Ap,IconArrowRotateLeftRight:()=>Kp,IconArrowRotateRightLeft:()=>Rp,IconArrowShareLeft:()=>Dp,IconArrowShareRight:()=>Fp,IconArrowSplit:()=>Jp,IconArrowUp:()=>Qp,IconArrowWallDown:()=>eu,IconArrowWallLeft:()=>ru,IconArrowWallRight:()=>ou,IconArrowWallUp:()=>iu,IconArrowsRepeatRight:()=>du,IconAsterisk:()=>hu,IconAt:()=>uu,IconBack:()=>fu,IconBackward:()=>Mu,IconBag:()=>ku,IconBank:()=>yu,IconBanknote:()=>Lu,IconBanknote2:()=>_u,IconBarcode:()=>xu,IconBarsThree:()=>Su,IconBarsTwo:()=>$u,IconBasket:()=>Gu,IconBatteryLoading:()=>Eu,IconBell:()=>Bu,IconBlock:()=>Wu,IconBook:()=>Yu,IconBookmark:()=>Qu,IconBookmarkCheck:()=>Tu,IconBookmarkDelete:()=>Pu,IconBookmarkPlus:()=>Ou,IconBookmarkRemove:()=>Uu,IconBooks:()=>eg,IconBrandAppStore:()=>rg,IconBrandAppleMusic:()=>og,IconBrandBankid:()=>ig,IconBrandChrome:()=>ag,IconBrandFacebook:()=>dg,IconBrandFigma:()=>hg,IconBrandFirefox:()=>ug,IconBrandGithub:()=>fg,IconBrandGreen:()=>Mg,IconBrandInstagram:()=>kg,IconBrandLinkedin:()=>yg,IconBrandPlayStore:()=>_g,IconBrandRssFeed:()=>Lg,IconBrandSeb:()=>xg,IconBrandSpotify:()=>Sg,IconBrandStorybook:()=>$g,IconBrandSwishWord:()=>Gg,IconBrandX:()=>Eg,IconBrush:()=>Bg,IconBubbleAnnotation:()=>Wg,IconBubbles:()=>Yg,IconBuildings:()=>Tg,IconBulletList:()=>Pg,IconCalculator:()=>Og,IconCalendar:()=>ef,IconCalendarCheck:()=>Ug,IconCalendarRepeat:()=>Qg,IconCalenderAdd:()=>rf,IconCall:()=>of,IconCar:()=>lf,IconCarussel:()=>cf,IconChainLink:()=>hf,IconChainLinkBroken:()=>Cf,IconChartTwo:()=>uf,IconChecklist:()=>ff,IconCheckmark:()=>mf,IconChevronBottom:()=>Mf,IconChevronDoubleDown:()=>kf,IconChevronDoubleLeft:()=>vf,IconChevronDoubleRight:()=>yf,IconChevronDoubleUp:()=>_f,IconChevronDownSmall:()=>Lf,IconChevronGrabberVertical:()=>xf,IconChevronGrabberVerticalReversed:()=>Hf,IconChevronLeft:()=>Sf,IconChevronLeftSmall:()=>Zf,IconChevronRight:()=>$f,IconChevronRightSmall:()=>If,IconChevronTop:()=>jf,IconChevronTopSmall:()=>Gf,IconCircleBan:()=>qf,IconCircleCheck:()=>zf,IconCircleDots:()=>Af,IconCircleInfo:()=>Kf,IconCircleMinus:()=>Rf,IconCirclePlaceholderOn:()=>Df,IconCirclePlus:()=>Ff,IconCircleQuestionmark:()=>Jf,IconCircleX:()=>Xf,IconCirclesThree:()=>tm,IconClock:()=>sm,IconCloudDownload:()=>nm,IconCloudUpload:()=>lm,IconCloudySun:()=>cm,IconCode:()=>pm,IconCodeBrackets:()=>Cm,IconCompassRound:()=>gm,IconCookies:()=>mm,IconCopy:()=>Mm,IconCreditCard:()=>ym,IconCreditCardAdd:()=>km,IconCrossLarge:()=>bm,IconCrossSmall:()=>_m,IconCupHot:()=>Lm,IconCursor:()=>xm,IconDevices:()=>Sm,IconDirection:()=>$m,IconDollar:()=>Gm,IconDotGridOneHorizontal:()=>jm,IconDotGridOneVertical:()=>qm,IconDotGridThree:()=>zm,IconDotGridTwo:()=>Am,IconEmail:()=>Km,IconEmojiAngry:()=>Rm,IconEmojiNeutral:()=>Dm,IconEmojiSad:()=>Fm,IconEmojiSmile:()=>Jm,IconEmojiSmiley:()=>Xm,IconEuro:()=>tM,IconExpand:()=>sM,IconEyeOpen:()=>nM,IconEyeSlash:()=>lM,IconFashion:()=>cM,IconFastForward:()=>CM,IconFileBend:()=>pM,IconFileChart:()=>gM,IconFileText:()=>mM,IconFiles:()=>VM,IconFilter:()=>vM,IconFlag:()=>bM,IconFloppyDisk:()=>wM,IconFocus:()=>HM,IconFolder:()=>IM,IconFolderAddRight:()=>ZM,IconFullscreen:()=>NM,IconGift:()=>jM,IconGlobus:()=>qM,IconGraduateCap:()=>zM,IconGreenPower:()=>AM,IconGroup:()=>KM,IconGrowth:()=>RM,IconHeadphones:()=>DM,IconHeart:()=>JM,IconHeartBeat:()=>FM,IconHistory:()=>XM,IconHomeEnergyOne:()=>tV,IconHomeEnergyTwo:()=>sV,IconHomeOpen:()=>nV,IconHomeRoof:()=>lV,IconHorizontalAlignmentBottom:()=>cV,IconHourglass:()=>CV,IconImages:()=>pV,IconInboxEmpty:()=>gV,IconIndustry:()=>mV,IconJpg:()=>VV,IconKey:()=>vV,IconKnifeSpoon:()=>bV,IconLab:()=>wV,IconLaw:()=>HV,IconLeisure:()=>ZV,IconLightBulbSimple:()=>IV,IconLightning:()=>NV,IconLineChartFour:()=>jV,IconLineChartOne:()=>qV,IconLineChartThree:()=>zV,IconLineChartTwo:()=>AV,IconLock:()=>KV,IconMacbookAir:()=>RV,IconMagnifyingGlass:()=>PV,IconMapPin:()=>OV,IconMegaphone:()=>UV,IconMenuSidebar:()=>QV,IconMicOff:()=>ek,IconMicOn:()=>rk,IconMinimize:()=>ok,IconMinusLarge:()=>ik,IconMinusSmall:()=>lk,IconMoneyHand:()=>ck,IconMoneybag:()=>Ck,IconMoon:()=>pk,IconMute:()=>gk,IconNewspaper:()=>mk,IconOffice:()=>Vk,IconPageAdd:()=>vk,IconPaperPlaneTopRight:()=>bk,IconPaperclip:()=>wk,IconPause:()=>Hk,IconPdf:()=>Zk,IconPencilSign:()=>Ik,IconPencilSparkle:()=>Nk,IconPencilWave:()=>jk,IconPension:()=>qk,IconPeople:()=>Qk,IconPeopleA11y:()=>zk,IconPeopleAdd:()=>Ak,IconPeopleAdded:()=>Kk,IconPeopleCircle:()=>Rk,IconPeopleCopy:()=>Dk,IconPeopleProfile:()=>Ok,IconPeopleRemove:()=>Uk,IconPercent:()=>ev,IconPhone:()=>rv,IconPieChart:()=>ov,IconPiggyBank:()=>iv,IconPin:()=>av,IconPinch:()=>dv,IconPlay:()=>uv,IconPlayCircle:()=>hv,IconPlusLarge:()=>fv,IconPlusSmall:()=>Mv,IconPng:()=>kv,IconPoop:()=>yv,IconPostcard:()=>_v,IconPound:()=>Lv,IconPower:()=>Sv,IconPowerPlant:()=>xv,IconPrinter:()=>$v,IconPush:()=>Gv,IconQrCode:()=>Ev,IconRainy:()=>Bv,IconRaisingHand:()=>Wv,IconReadingList:()=>Yv,IconReceiptBill:()=>Tv,IconReceiptionBell:()=>Pv,IconRecord:()=>Ov,IconRefund:()=>Uv,IconRobot:()=>Qv,IconRocket:()=>ey,IconRunShortcut:()=>ry,IconSafari:()=>oy,IconSchool:()=>iy,IconScissors:()=>ay,IconSearchMenu:()=>dy,IconSettingsGear:()=>hy,IconSettingsSliderHor:()=>uy,IconSettingsSliderVer:()=>fy,IconShapes:()=>My,IconShare:()=>ky,IconShield:()=>Ly,IconShieldChecked:()=>yy,IconShieldCrossed:()=>_y,IconShoppingBag:()=>xy,IconSignature:()=>Sy,IconSmartwatch:()=>$y,IconSolar:()=>Gy,IconSort:()=>Ay,IconSortAscending:()=>Ey,IconSortDescending:()=>By,IconSortDown:()=>zy,IconSortUp:()=>Wy,IconSquareArrowTopRight:()=>Ky,IconSquareBehindSquare:()=>Ry,IconSquareGridCircle:()=>Dy,IconSquarePlaceholder:()=>Fy,IconStar:()=>Jy,IconStore:()=>Xy,IconSun:()=>tb,IconSunsetArrowDown:()=>sb,IconTag:()=>nb,IconTargetArrow:()=>lb,IconTelevision:()=>cb,IconTennis:()=>Cb,IconTextEdit:()=>pb,IconThermostat:()=>gb,IconThumbsDown:()=>mb,IconThumbsUp:()=>Vb,IconTicket:()=>vb,IconTradingViewCandles:()=>bb,IconTrashCan:()=>wb,IconTree:()=>Hb,IconTrendingFive:()=>Zb,IconTrendingFour:()=>Ib,IconTrendingOne:()=>Nb,IconTrendingThree:()=>jb,IconTrendingTwo:()=>qb,IconTriangleExclamation:()=>zb,IconTruck:()=>Ab,IconUmbrellaSecurity:()=>Kb,IconUnlocked:()=>Rb,IconVolumeFull:()=>Db,IconVolumeHalf:()=>Fb,IconVolumeOff:()=>Jb,IconWallet:()=>Xb,IconWarningSign:()=>t_,IconWifiFull:()=>s_,IconYoutube:()=>n_,IconZap:()=>l_,IconZoomIn:()=>c_,IconZoomOut:()=>C_});var s=r(3095),o=r(745),n=r(6506),i=r(4367),l=r(3578),a=r(4652),c=r(3539),d=r(7526),C=r(5073),h=r(9399),p=r(4508),u=r(4987),g=r(3832);let f=class extends g.M{};f._regularSVG='<path d="M15.75 6.5C15.75 8.57107 14.0711 10.25 12 10.25C9.92893 10.25 8.25 8.57107 8.25 6.5C8.25 4.42893 9.92893 2.75 12 2.75C14.0711 2.75 15.75 4.42893 15.75 6.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M12 13.25C7.8098 13.25 4.86894 16.3254 4.5 20.25H19.5C19.1311 16.3254 16.1902 13.25 12 13.25Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/>',f._solidSVG='<path d="M12 2C9.51472 2 7.5 4.01472 7.5 6.5C7.5 8.98528 9.51472 11 12 11C14.4853 11 16.5 8.98528 16.5 6.5C16.5 4.01472 14.4853 2 12 2Z" fill="currentColor"/><path d="M12 12.5C7.38412 12.5 4.15473 15.9097 3.7533 20.1798C3.73354 20.39 3.80328 20.5988 3.94541 20.7549C4.08754 20.911 4.28888 21 4.5 21H19.5C19.7111 21 19.9125 20.911 20.0546 20.7549C20.1967 20.5988 20.2665 20.39 20.2467 20.1798C19.8453 15.9097 16.6159 12.5 12 12.5Z" fill="currentColor"/>',f._name="people-profile",f._width=24,f._height=24,f._viewBox="0 0 24 24",f=(0,o.Cc)([(0,d.Y$)("gds-icon-people-profile")],f);var m,M,V,k,v,y,b=r(9443),_=b.AH`
...
`;var As,Ys,Ks,Ts,Rs,Ps,Ds,Os,Fs,Us,Js,Qs,Xs,eo,to,ro,so,oo,no,io,lo,ao,co,Co,ho,po,uo,go,fo,mo,Mo,Vo,ko,vo,yo,bo;const _o={compact:{button:"small",font:"detail-s-book",gap:"xl",navGap:"xs",input:"small",inputWidth:"140px",inputPadding:"m"},comfortable:{button:"small",font:"detail-s-book",gap:"2xl",navGap:"s",input:"small",inputWidth:"140px",inputPadding:"m"},spacious:{button:"medium",font:"detail-m-book",gap:"2xl",navGap:"s",input:"large",inputWidth:"200px",inputPadding:"xl"}};let wo=class extends((0,u.TM)((0,u.Q8)((0,u.lt)(c.j)))){constructor(){super(...arguments),(0,o.VK)(this,As),(0,o.VK)(this,Ks),(0,o.VK)(this,Rs),(0,o.VK)(this,Ds),(0,o.VK)(this,Fs),(0,o.VK)(this,Js),(0,o.VK)(this,Xs),(0,o.VK)(this,to),(0,o.VK)(this,so),(0,o.VK)(this,no),(0,o.VK)(this,lo),(0,o.VK)(this,co),(0,o.VK)(this,ho),(0,o.VK)(this,uo),(0,o.VK)(this,fo),(0,o.VK)(this,Mo),(0,o.VK)(this,ko),(0,o.VK)(this,yo),this.page=1,this.rows=10,this.total=0,this.options=[5,10,25,50],this.jump=!1,this.hideOptions=!1,this.simple=!1,this.density="comfortable",this.label="",this._isMobile=!1,this._jumpPopoverOpen=!1}_handleMobile(e){this._isMobile=e}render(){const e=(0,o.S7)(this,As,Ys)>1,t=(0,o.jq)(this,ho,po).call(this);return e||t?d.qy`
...
`;let Ao=class extends((0,u.Q8)(c.j)){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),zo.n.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return d.qy`<button
    ...
    >
      <slot></slot>
    </button>`}};Ao.styles=[...C.LU,Wo],(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Ao.prototype,"selected",2),(0,o.Cc)([(0,i.MZ)()],Ao.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],Ao.prototype,"disabled",2),Ao=(0,o.Cc)([(0,d.Y$)("gds-segment")],Ao);var Yo,Ko,To,Ro,Po,Do,Oo,Fo,Uo,Jo,Qo=b.AH`
  @layer base {
    :host {
...
`;var $n,Nn,Gn,jn,En,qn,Bn,zn,Wn,An,Yn,Kn,Tn,Rn,Pn,Dn;let On=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,$n),(0,o.VK)(this,Gn),(0,o.VK)(this,En),(0,o.VK)(this,Bn),(0,o.VK)(this,An),(0,o.VK)(this,Tn),(0,o.VK)(this,Pn),this.checked=!1,this.controlPlacement="end",this.size="large",this["justify-content"]="flex-start",(0,o.VK)(this,Wn,()=>{this.checked=this._input.checked,(0,o.jq)(this,Pn,Dn).call(this),(0,o.jq)(this,An,Yn).call(this)}),(0,o.VK)(this,Kn,e=>{this.disabled||"Enter"===e.key&&(e.preventDefault(),this._input.click())})}get value(){return this._internalValue||"on"}set value(e){this._internalValue=e}_getValidityAnchor(){return this._input}formResetCallback(){this.checked=!1,this._internalValue=void 0}focus(e){this._input?.focus(e)}render(){const e={switch:!0,checked:this.checked,disabled:this.disabled,"control-start":"start"===this.controlPlacement,small:"small"===this.size};return d.qy`
...
`,di=[C.LU,Q.A,ci],Ci=[z.t,K.z,Zt,ur,ze.Hx,$s.T,Gt.E,hs,wo,Rt,x.K,ms,ot.o,si,Ns.o,ri,ti,ei,Wr.r,se,ni,ai,ii,li,oi.z],hi={compact:{input:"small",dropdown:"small"},comfortable:{input:"small",dropdown:"small"},spacious:{input:"large",dropdown:"medium"}};var pi,ui,gi,fi,mi,Mi,Vi,ki,vi,yi,bi,_i,wi,Li,Hi,xi,Zi,Si,Ii,$i,Ni,Gi,ji,Ei,qi,Bi,zi,Wi,Ai,Yi,Ki,Ti,Ri,Pi,Di,Oi,Fi,Ui,Ji,Qi,Xi,el,tl,rl,sl,ol,nl,il,ll,al,cl,dl,Cl,hl,pl,ul,gl,fl,ml,Ml,Vl,kl,vl,yl,bl,_l,wl,Ll,Hl,xl,Zl,Sl,Il,$l,Nl,Gl,jl,El,ql,Bl,zl,Wl,Al,Yl,Kl,Tl,Rl,Pl,Dl,Ol,Fl,Ul,Jl,Ql,Xl,ea,ta,ra,sa,oa,na,ia,la,aa,ca,da,Ca,ha,pa,ua,ga,fa,ma,Ma,Va,ka,va,ya,ba,_a,wa,La,Ha,xa,Za,Sa,Ia,$a,Na,Ga,ja,Ea,qa,Ba,za,Wa,Aa,Ya,Ka,Ta,Ra,Pa,Da,Oa,Fa,Ua,Ja,Qa,Xa,ec,tc,rc,sc,oc,nc,ic,lc,ac,cc,dc,Cc,hc,pc,uc,gc,fc,mc,Mc,Vc,kc,vc,yc,bc,_c,wc,Lc,Hc,xc,Zc,Sc,Ic,$c,Nc,Gc,jc,Ec,qc;Symbol.toPrimitive;let Bc=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,gi),(0,o.VK)(this,mi),(0,o.VK)(this,Vi),(0,o.VK)(this,vi),(0,o.VK)(this,xi),(0,o.VK)(this,Si),(0,o.VK)(this,$i),(0,o.VK)(this,Gi),(0,o.VK)(this,Ei),(0,o.VK)(this,Bi),(0,o.VK)(this,Wi),(0,o.VK)(this,Yi),(0,o.VK)(this,Ti),(0,o.VK)(this,Pi),(0,o.VK)(this,Oi),(0,o.VK)(this,Ui),(0,o.VK)(this,Qi),(0,o.VK)(this,el),(0,o.VK)(this,rl),(0,o.VK)(this,ol),(0,o.VK)(this,il),(0,o.VK)(this,al),(0,o.VK)(this,dl),(0,o.VK)(this,hl),(0,o.VK)(this,ul),(0,o.VK)(this,fl),(0,o.VK)(this,Ml),(0,o.VK)(this,kl),(0,o.VK)(this,yl),(0,o.VK)(this,_l),(0,o.VK)(this,Ll),(0,o.VK)(this,xl),(0,o.VK)(this,Sl),(0,o.VK)(this,$l),(0,o.VK)(this,Gl),(0,o.VK)(this,El),(0,o.VK)(this,Bl),(0,o.VK)(this,Wl),(0,o.VK)(this,Yl),(0,o.VK)(this,Tl),(0,o.VK)(this,Pl),(0,o.VK)(this,Ol),(0,o.VK)(this,Ul),(0,o.VK)(this,Ql),(0,o.VK)(this,ea),(0,o.VK)(this,ra),(0,o.VK)(this,oa),(0,o.VK)(this,ia),(0,o.VK)(this,aa),(0,o.VK)(this,da),(0,o.VK)(this,ha),(0,o.VK)(this,ua),(0,o.VK)(this,fa),(0,o.VK)(this,Ma),(0,o.VK)(this,ka),(0,o.VK)(this,ya),(0,o.VK)(this,_a),(0,o.VK)(this,La),(0,o.VK)(this,xa),(0,o.VK)(this,Sa),(0,o.VK)(this,$a),(0,o.VK)(this,Ga),(0,o.VK)(this,Ea),(0,o.VK)(this,Ba),(0,o.VK)(this,Wa),(0,o.VK)(this,Ya),(0,o.VK)(this,Ta),(0,o.VK)(this,Pa),(0,o.VK)(this,Oa),(0,o.VK)(this,Ua),(0,o.VK)(this,Qa),(0,o.VK)(this,ec),(0,o.VK)(this,rc),(0,o.VK)(this,oc),(0,o.VK)(this,ic),(0,o.VK)(this,ac),(0,o.VK)(this,dc),(0,o.VK)(this,hc),(0,o.VK)(this,uc),(0,o.VK)(this,fc),(0,o.VK)(this,Mc),(0,o.VK)(this,kc),(0,o.VK)(this,yc),(0,o.VK)(this,_c),(0,o.VK)(this,Lc),(0,o.VK)(this,xc),(0,o.VK)(this,Sc),(0,o.VK)(this,$c),(0,o.VK)(this,Gc),(0,o.VK)(this,Ec),(0,o.VK)(this,pi,{}),(0,o.VK)(this,ui,3e5),this.headlineTag="h2",this.options=[5,10,20,50,100],this.page=1,this.rows=10,this.columns=[],this.density="comfortable",this.selectable=!1,this.disableSelectAll=!1,this.responsive=!1,this.plain=!1,this.searchable=!1,this.settings=!1,this.striped=!1,this.nocache=!1,this.variant="neutral-02-outlined",this._isMobile=!1,this._view={page:this.page,rows:this.rows,searchQuery:"",visibleColumns:new Set},this._loaded=!0,this._loading=!1,this._rowsState=[],this._total=0,this._selected=new Set,this._expanded=new Set,this._expanding=new Set,this._completingExpansion=new Set,this._expandedRowsCache=new Map,this._expandedFullContentResolved=new Set,this._error=null,(0,o.VK)(this,bi,new Map),(0,o.VK)(this,_i,140),(0,o.VK)(this,wi,100),(0,o.VK)(this,Li,new Set),(0,o.VK)(this,Hi,!1)}_handleMobile(e){this._isMobile=e}_onDataChange(){(0,o.OV)(this,pi,{}),(0,o.jq)(this,Ui,Ji).call(this)}_onPageChange(){this._view={...this._view,page:Number(this.page??1)},(0,o.jq)(this,Ui,Ji).call(this)}_onRowsChange(){this._view={...this._view,rows:Number(this.rows??10),page:1},(0,o.jq)(this,Ui,Ji).call(this)}_onColumnsChange(){(0,o.OV)(this,pi,{}),this._view={...this._view,page:Number(this.page??1),rows:Number(this.rows??10),visibleColumns:new Set(this.columns.filter(e=>!1!==e.visible).map(e=>e.key))}}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{(0,o.jq)(this,$c,Nc).call(this),(0,o.jq)(this,rl,sl).call(this),(0,o.jq)(this,Yl,Kl).call(this)})}_handleLightDOMSlotsChange(){(0,o.jq)(this,Qi,Xi).call(this)}updated(e){super.updated(e),(0,o.jq)(this,rl,sl).call(this)}render(){const e={table:!0,plain:this.plain,striped:this.striped,[this.density]:this.density};return d.qy`
      <div class="${(0,l.H)(e)}">
        ${[(0,o.jq)(this,Qa,Xa).call(this),(0,o.jq)(this,Ml,Vl).call(this),(0,F.z)(this._error,()=>(0,o.jq)(this,Pa,Da).call(this),()=>(0,F.z)(0===this._rowsState.length&&!this._loading,()=>(0,o.jq)(this,Oa,Fa).call(this),()=>(0,o.jq)(this,Ta,Ra).call(this))),(0,o.jq)(this,Ua,Ja).call(this)]}
      </div>
    `}clearSelection(){(0,o.jq)(this,xc,Zc).call(this),(0,o.jq)(this,Sc,Ic).call(this)}selectAll(){(0,o.jq)(this,Lc,Hc).call(this),(0,o.jq)(this,Sc,Ic).call(this)}setSelection(e){const t=e.filter(e=>e>=0&&e<this._rowsState.length);this._selected=new Set(t),(0,o.jq)(this,Sc,Ic).call(this),this.requestUpdate()}getSelection(){const e=Array.from(this._selected);return{indices:e,data:e.map(e=>this._rowsState[e])}}expandRow(e){var t=this;return(0,Ne.A)(function*(){return(0,o.jq)(t,_c,wc).call(t,e,!0)})()}collapseRow(e){return(0,o.jq)(this,_c,wc).call(this,e,!1),!0}toggleRowExpansion(e,t){var r=this;return(0,Ne.A)(function*(){if(e<0||e>=r._rowsState.length)return!1;const s=!r._expanded.has(e);return(0,o.jq)(r,_c,wc).call(r,e,s,t)})()}getExpandedIndices(){return Array.from(this._expanded)}};pi=new WeakMap,ui=new WeakMap,gi=new WeakSet,fi=function(){return this.responsive&&this._isMobile},mi=new WeakSet,Mi=function(){return!(0,o.S7)(this,gi,fi)&&(0,o.S7)(this,Gi,ji).length>0},Vi=new WeakSet,ki=function(){return this.selectable&&!(0,o.S7)(this,gi,fi)},vi=new WeakSet,yi=function(){return hi[this.density]},bi=new WeakMap,_i=new WeakMap,wi=new WeakMap,Li=new WeakMap,Hi=new WeakMap,xi=new WeakSet,Zi=function(){return this._selected.size>0},Si=new WeakSet,Ii=function(){return this._rowsState.length>0&&this._selected.size===this._rowsState.length},$i=new WeakSet,Ni=function(){return(0,o.S7)(this,xi,Zi)&&!(0,o.S7)(this,Si,Ii)},Gi=new WeakSet,ji=function(){return this._rowsState.map((e,t)=>(0,o.jq)(this,Tl,Rl).call(this,e,t)?t:-1).filter(e=>-1!==e)},Ei=new WeakSet,qi=function(){const e=(0,o.S7)(this,Gi,ji);return e.length>0&&e.every(e=>this._expanded.has(e))},Bi=new WeakSet,zi=function(){return JSON.stringify({page:this._view.page,rows:this._view.rows,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection,searchQuery:this._view.searchQuery})},Wi=new WeakSet,Ai=function(e){const t=(0,o.S7)(this,bi).get(e);void 0!==t&&(window.clearTimeout(t),(0,o.S7)(this,bi).delete(e))},Yi=new WeakSet,Ki=function(e){if((0,o.jq)(this,Wi,Ai).call(this,e),this._expanding.has(e)){const t=new Set(this._expanding);t.delete(e),this._expanding=t}if(this._completingExpansion.has(e)){const t=new Set(this._completingExpansion);t.delete(e),this._completingExpansion=t}},Ti=new WeakSet,Ri=function(){(0,o.S7)(this,bi).forEach(e=>window.clearTimeout(e)),(0,o.S7)(this,bi).clear(),this._expanding.clear(),this._completingExpansion.clear()},Pi=new WeakSet,Di=function(e){(0,o.jq)(this,Wi,Ai).call(this,e);const t=new Set(this._completingExpansion);t.add(e),this._completingExpansion=t,this.requestUpdate();const r=window.setTimeout(()=>{(0,o.jq)(this,Yi,Ki).call(this,e),this.requestUpdate()},(0,o.S7)(this,_i));(0,o.S7)(this,bi).set(e,r)},Oi=new WeakSet,Fi=function(e){return Date.now()-e.timestamp<(0,o.S7)(this,ui)},Ui=new WeakSet,Ji=function(){var e=(0,Ne.A)(function*(){if(this.data){if(!this.nocache){const e=(0,o.jq)(this,Bi,zi).call(this),t=(0,o.S7)(this,pi)[e];if(t&&(0,o.jq)(this,Oi,Fi).call(this,t))return this._rowsState=t.rows,this._total=t.total,this._expanded.clear(),(0,o.jq)(this,Ti,Ri).call(this),this._expandedRowsCache.clear(),this._expandedFullContentResolved.clear(),this._loaded=!1,void this.dispatchCustomEvent("gds-table-data-loaded",{detail:{rows:t.rows,total:t.total,page:this._view.page,rowsPerPage:this._view.rows,searchQuery:this._view.searchQuery,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection},bubbles:!0})}this._loading=!0,this._error=null;try{const e=yield this.data({page:this._view.page,rows:this._view.rows,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection,searchQuery:this._view.searchQuery});if(!this.nocache){const t=(0,o.jq)(this,Bi,zi).call(this);(0,o.S7)(this,pi)[t]={rows:e.rows,total:e.total,timestamp:Date.now()}}this._rowsState=e.rows,this._total=e.total,this._selected.clear(),this._expanded.clear(),(0,o.jq)(this,Ti,Ri).call(this),this._expandedRowsCache.clear(),this._expandedFullContentResolved.clear(),this._loaded=!1,this.dispatchCustomEvent("gds-table-data-loaded",{detail:{...e,page:this._view.page,rowsPerPage:this._view.rows,searchQuery:this._view.searchQuery,sortColumn:this._view.sortColumn,sortDirection:this._view.sortDirection},bubbles:!0})}catch(e){this._error=e,this.dispatchCustomEvent("gds-table-data-error",{detail:e,bubbles:!0})}finally{this._loading=!1}}});return function(){return e.apply(this,arguments)}}(),Qi=new WeakSet,Xi=function(){(0,o.S7)(this,Hi)||((0,o.OV)(this,Hi,!0),queueMicrotask(()=>{(0,o.OV)(this,Hi,!1),(0,o.jq)(this,Yl,Kl).call(this)}))},el=new WeakSet,tl=function(){const e=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),t=e.filter(e=>"left"===e.sticky),r=e.filter(e=>"right"===e.sticky);return{lastLeft:t.length?t[t.length-1].key:null,lastRight:r.length?r[0].key:null}},rl=new WeakSet,sl=function(){const e=this.shadowRoot;if(!e)return;const t=Array.from(e.querySelectorAll("thead th.sticky-left")),r=Array.from(e.querySelectorAll("thead th.sticky-right")),s=e.querySelector("thead th.expander-cell"),o=e.querySelector("thead th.checkbox-cell");if(!t.length&&!r.length)return;e.querySelectorAll("[data-col-key]").forEach(e=>{e.style.left="",e.style.right=""});let n=(s?.offsetWidth??0)+(o?.offsetWidth??0);for(const r of t){const t=r.dataset.colKey,s=`${n}px`;r.style.left=s,n+=r.offsetWidth,t&&e.querySelectorAll(`[data-col-key="${t}"]`).forEach(e=>e.style.left=s)}let i=0;for(const t of[...r].reverse()){const r=t.dataset.colKey,s=`${i}px`;t.style.right=s,i+=t.offsetWidth,r&&e.querySelectorAll(`[data-col-key="${r}"]`).forEach(e=>e.style.right=s)}},ol=new WeakSet,nl=function(e,t,r){if("string"==typeof r||"number"==typeof r)return r;const s=e?.id;return"string"==typeof s||"number"==typeof s?s:t+1},il=new WeakSet,ll=function(e){return d.qy`<span class="cell-wrapped-content">${e}</span>`},al=new WeakSet,cl=function(e){return d.qy`<span class="column-label" aria-hidden="true">
      ${e.label}:
    ...
    `},yl=new WeakSet,bl=function(){return(0,o.S7)(this,Vi,ki)?d.qy`
      <th class="checkbox-cell">
        <div class="cell-center">
          ${(0,o.jq)(this,Ga,ja).call(this,{checked:(0,o.S7)(this,Si,Ii),indeterminate:(0,o.S7)(this,$i,Ni),ariaLabel:(0,N.ab)("Select all rows"),onToggle:()=>(0,o.jq)(this,hc,pc).call(this,{}),skip:this.disableSelectAll})}
        </div>
      </th>
    `:null},_l=new WeakSet,wl=function(){if(!(0,o.S7)(this,mi,Mi))return null;const e=(0,o.S7)(this,Ei,qi),t=e?(0,N.ab)("Collapse all rows"):(0,N.ab)("Expand all rows");return d.qy`
    ...
    `},Ll=new WeakSet,Hl=function(e){return"subRows"in e?e.subRows:e?.children},xl=new WeakSet,Zl=function(e){if("fullContent"in e)return e.fullContent},Sl=new WeakSet,Il=function(e,t){return this._expandedRowsCache.get(t)??[]},$l=new WeakSet,Nl=function(e){return"function"==typeof(0,o.jq)(this,Ll,Hl).call(this,e)},Gl=new WeakSet,jl=function(e){return"function"==typeof(0,o.jq)(this,xl,Zl).call(this,e)},El=new WeakSet,ql=function(e,t){const r=(0,o.jq)(this,Sl,Il).call(this,e,t).length||1,s=Number(e.subRowCount);return!Number.isFinite(s)||s<=0?r:Math.floor(s)},Bl=new WeakSet,zl=function(e,t){const r=String((0,o.jq)(this,ol,nl).call(this,e,t));return(0,o.S7)(this,Li).has(r)},Wl=new WeakSet,Al=function(e,t){return(0,o.jq)(this,Bl,zl).call(this,e,t)},Yl=new WeakSet,Kl=function(){const e=new Set;this.querySelectorAll('[slot^="expand:"][slot$=":full"]').forEach(t=>{const r=t.getAttribute("slot");if(!r)return;if(!r.startsWith("expand:")||!r.endsWith(":full"))return;const s=r.slice(7,-5);s&&e.add(s)}),(e.size!==(0,o.S7)(this,Li).size||[...e].some(e=>!(0,o.S7)(this,Li).has(e)))&&((0,o.OV)(this,Li,e),this.requestUpdate())},Tl=new WeakSet,Rl=function(e,t){return!(0,o.S7)(this,gi,fi)&&("boolean"==typeof e.isExpandable?e.isExpandable:!!(0,o.jq)(this,$l,Nl).call(this,e)||!!(0,o.jq)(this,Gl,jl).call(this,e)||(0,o.jq)(this,Sl,Il).call(this,e,t).length>0||(0,o.jq)(this,Wl,Al).call(this,e,t))},Pl=new WeakSet,Dl=function(e,t){return`row-expand-group-${String((0,o.jq)(this,ol,nl).call(this,e,t)).replace(/[^a-zA-Z0-9_-]/g,"-")}`},Ol=new WeakSet,Fl=function(){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).length+((0,o.S7)(this,mi,Mi)?1:0)+((0,o.S7)(this,Vi,ki)?1:0)},Ul=new WeakSet,Jl=function(){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(e=>(0,o.jq)(this,kl,vl).call(this,e))},Ql=new WeakSet,Xl=function(){return d.qy`
      <thead>
        <tr>
          ${[(0,o.jq)(this,_l,wl).call(this),(0,o.jq)(this,yl,bl).call(this),(0,o.jq)(this,Ul,Jl).call(this)]}
        </tr>
      </thead>
    `},ea=new WeakSet,ta=function(e,t,r){const{lastLeft:s,lastRight:n}=(0,o.jq)(this,el,tl).call(this),i=(0,l.H)({[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify,wrap:Boolean(t.width),"sticky-left":"left"===t.sticky,"sticky-right":"right"===t.sticky,"sticky-left-last":"left"===t.sticky&&t.key===s,"sticky-right-last":"right"===t.sticky&&t.key===n}),c=(0,Xn.W)({"--cell-width":t.width});return d.qy`
      <td
        style=${c}
        class=${i}
    ...
    `},ra=new WeakSet,sa=function(e,t){if(!(0,o.S7)(this,mi,Mi))return null;if(!(0,o.jq)(this,Tl,Rl).call(this,e,t))return d.qy`<td class="expander-cell"></td>`;const r=this._expanded.has(t),s=(0,o.jq)(this,Pl,Dl).call(this,e,t),n=r?e.collapseLabel||(0,N.ab)("Collapse row"):e.expandLabel||(0,N.ab)("Expand row");return d.qy`
    ...
    `},oa=new WeakSet,na=function(e){if(!(0,o.S7)(this,Vi,ki))return null;const t=`${(0,N.ab)("Select row")} ${e+1}`;return d.qy`
    ...
    `},ia=new WeakSet,la=function(e,t){return this.columns.filter(e=>this._view.visibleColumns.has(e.key)).map(r=>(0,o.jq)(this,ea,ta).call(this,e,r,t))},aa=new WeakSet,ca=function(e,t,r){const s=(0,o.jq)(this,ol,nl).call(this,e,t);return d.qy`
      <tr
    ...
    `},ha=new WeakSet,pa=function(e,t,r,s=!1){const n=(0,o.jq)(this,El,ql).call(this,e,t);return Array.from({length:n},(i,l)=>(0,o.jq)(this,da,Ca).call(this,e,t,r,l,n,s))},ua=new WeakSet,ga=function(e,t=!1){const r=(0,l.H)({"expanded-row":!0,full:!0,"expanded-group-end":!0,"skeleton-leave":t});return d.qy`
    ...
    `},Wa=new WeakSet,Aa=function(){if(this._loading&&this._loaded){const e=Array.from({length:this._view.rows},(e,t)=>(0,o.jq)(this,Ba,za).call(this,t));return d.qy`<tbody aria-busy="true" aria-live="polite">
      ...
      <tbody aria-live="polite">
        ${(0,Qn.u)(this._rowsState,(e,t)=>(0,o.jq)(this,ol,nl).call(this,e,t),(e,t)=>(0,Jn.a)([e,this._selected.has(t),this._expanded.has(t),this._expanding.has(t),this._completingExpansion.has(t),this._expandedRowsCache.get(t),this._expandedFullContentResolved.has(t)],()=>(0,o.jq)(this,$a,Na).call(this,e,t)))}
      </tbody>
    `},Ya=new WeakSet,Ka=function(){if(!this.tfoot||(0,o.S7)(this,gi,fi))return null;const e=this.tfoot.label,t=this.columns.filter(e=>this._view.visibleColumns.has(e.key)),r=(0,l.H)({tablefoot:!0,sticky:Boolean(this.tfoot.sticky)});return d.qy`
      <tfoot class=${r}>
        <tr>
          ${(0,F.z)((0,o.S7)(this,mi,Mi),()=>d.qy`<td class="expander-cell"></td>`)}
          ${(0,F.z)((0,o.S7)(this,Vi,ki),()=>d.qy`<td class="checkbox-cell"></td>`)}
          ${t.map((t,r)=>{const{lastLeft:s,lastRight:n}=(0,o.jq)(this,el,tl).call(this),i=(0,l.H)({"tablefoot-cell":!0,"tablefoot-label-cell":0===r,[`align-${t.align}`]:!!t.align,[`justify-${t.justify}`]:!!t.justify,wrap:Boolean(t.width),"sticky-left":"left"===t.sticky,"sticky-right":"right"===t.sticky,"sticky-left-last":"left"===t.sticky&&t.key===s,"sticky-right-last":"right"===t.sticky&&t.key===n}),c=(0,Xn.W)({"--cell-width":t.width});return 0===r&&e?d.qy`
                <th
                  scope="row"
                  class=${i}
                  style=${c}
    ...
    `},Ta=new WeakSet,Ra=function(){const e=(0,l.H)({responsive:this.responsive,data:!0,"is-expandable":(0,o.S7)(this,mi,Mi),"is-selectable":(0,o.S7)(this,Vi,ki),"has-tfoot":Boolean(this.tfoot)&&!(0,o.S7)(this,gi,fi),"has-sticky-left":this.columns.some(e=>"left"===e.sticky),"has-sticky-right":this.columns.some(e=>"right"===e.sticky),"has-sticky":this.columns.some(e=>"left"===e.sticky||"right"===e.sticky),"no-mask":(0,o.S7)(this,mi,Mi)||(0,o.S7)(this,Vi,ki)||this.columns.some(e=>"left"===e.sticky||"right"===e.sticky),[`variant-${this.variant}`]:!0,loading:this._loading,loaded:!this._loading&&!this._loaded}),t=`${this.summary?this.summary+", ":""}${(0,N.ab)("Data table with")} ${this._total} ${(0,N.ab)("rows")}`;return d.qy`
      <gds-card
      ...
      <gds-card variant="neutral-02-outlined" border-radius="m">
        <slot name="error">
          ...
          <gds-button
            ...
            @click=${()=>(0,o.jq)(this,Ui,Ji).call(this)}
          >
            ${(0,N.ab)("Retry")}
          </gds-button>
        </slot>
    ...
    `},Qa=new WeakSet,Xa=function(){if(this.headline||this.summary)return d.qy`
      ...
      `},ec=new WeakSet,tc=function(){var e=(0,Ne.A)(function*(e){const t=e.target;this._view={...this._view,searchQuery:t.value,page:1},yield(0,o.jq)(this,Ui,Ji).call(this)});return function(t){return e.apply(this,arguments)}}(),rc=new WeakSet,sc=function(){var e=(0,Ne.A)(function*(){this._view={...this._view,searchQuery:"",page:1},yield(0,o.jq)(this,Ui,Ji).call(this)});return function(){return e.apply(this,arguments)}}(),oc=new WeakSet,nc=function(){var e=(0,Ne.A)(function*(e){const t=this._view.sortColumn===e&&"asc"===this._view.sortDirection?"desc":"asc";this._view={...this._view,sortColumn:e,sortDirection:t,page:1},this.dispatchCustomEvent("gds-sort-change",{detail:{sortColumn:e,sortDirection:t},bubbles:!0}),yield(0,o.jq)(this,Ui,Ji).call(this)});return function(t){return e.apply(this,arguments)}}(),ic=new WeakSet,lc=function(){var e=(0,Ne.A)(function*(e){this._view={...this._view,page:e.detail.page},this.dispatchCustomEvent("gds-page-change",{detail:e.detail,bubbles:!0}),yield(0,o.jq)(this,Ui,Ji).call(this)});return function(t){return e.apply(this,arguments)}}(),ac=new WeakSet,cc=function(){var e=(0,Ne.A)(function*(e){this._view={...this._view,rows:e.detail.rows,page:1},this.dispatchCustomEvent("gds-rows-change",{detail:e.detail,bubbles:!0}),yield(0,o.jq)(this,Ui,Ji).call(this)});return function(t){return e.apply(this,arguments)}}(),dc=new WeakSet,Cc=function(e){const t=e.detail.value;this._view={...this._view,visibleColumns:new Set(t)},this.requestUpdate()},hc=new WeakSet,pc=function(e){(0,o.S7)(this,Si,Ii)?(0,o.jq)(this,xc,Zc).call(this):(0,o.jq)(this,Lc,Hc).call(this),(0,o.jq)(this,Sc,Ic).call(this)},uc=new WeakSet,gc=function(e,t){t.detail.checked?this._selected.add(e):this._selected.delete(e),(0,o.jq)(this,Sc,Ic).call(this),this.requestUpdate()},fc=new WeakSet,mc=function(e,t){this.toggleRowExpansion(t,e)},Mc=new WeakSet,Vc=function(){var e=(0,Ne.A)(function*(){const e=(0,o.S7)(this,Gi,ji);(0,o.S7)(this,Ei,qi)?(e.forEach(e=>this._expanded.delete(e)),this.requestUpdate()):yield Promise.all(e.map(e=>(0,o.jq)(this,_c,wc).call(this,e,!0)))});return function(){return e.apply(this,arguments)}}(),kc=new WeakSet,vc=function(e,t,r){this.dispatchCustomEvent("gds-table-expand-change",{detail:{index:t,row:e,expanded:r,expandedIndices:Array.from(this._expanded)},bubbles:!0})},yc=new WeakSet,bc=function(){var e=(0,Ne.A)(function*(e,t){const r=(0,o.jq)(this,Ll,Hl).call(this,e),s=(0,o.jq)(this,xl,Zl).call(this,e),n="function"==typeof r,i="function"==typeof s;if(!n&&!i)return;const l=n?r():void 0,a=i?s():void 0,c=Boolean(l||a);let d,C=!1,h=!1;c&&(d=window.setTimeout(()=>{if(!this._expanded.has(t))return;const e=new Set(this._expanding);e.add(t),this._expanding=e,h=!0,this.requestUpdate()},(0,o.S7)(this,wi)));try{if(l){const e=yield l,r=Array.isArray(e)?e:[],s=new Map(this._expandedRowsCache);s.set(t,r),this._expandedRowsCache=s}if(a){yield a;const e=new Set(this._expandedFullContentResolved);e.add(t),this._expandedFullContentResolved=e}C=!0}catch{if(l){const e=new Map(this._expandedRowsCache);e.set(t,[]),this._expandedRowsCache=e}}finally{void 0!==d&&window.clearTimeout(d),c&&C&&h?(0,o.jq)(this,Pi,Di).call(this,t):(0,o.jq)(this,Yi,Ki).call(this,t),this.requestUpdate()}});return function(t,r){return e.apply(this,arguments)}}(),_c=new WeakSet,wc=function(){var e=(0,Ne.A)(function*(e,t,r){if(e<0||e>=this._rowsState.length)return!1;const s=r??this._rowsState[e];if(!s)return!1;const n=(0,o.jq)(this,Tl,Rl).call(this,s,e);return!(t&&!n)&&(t===this._expanded.has(e)||(t?(this._expanded.add(e),(0,o.jq)(this,kc,vc).call(this,s,e,!0),this.requestUpdate(),yield(0,o.jq)(this,yc,bc).call(this,s,e)):((0,o.jq)(this,Yi,Ki).call(this,e),this._expanded.delete(e),(0,o.jq)(this,kc,vc).call(this,s,e,!1)),this.requestUpdate()),!0)});return function(t,r,s){return e.apply(this,arguments)}}(),Lc=new WeakSet,Hc=function(){this._selected=new Set(this._rowsState.map((e,t)=>t)),this.requestUpdate()},xc=new WeakSet,Zc=function(){this._selected.clear(),this.requestUpdate()},Sc=new WeakSet,Ic=function(){this.dispatchCustomEvent("gds-table-selection",{detail:{selectedIndices:Array.from(this._selected),selectedData:Array.from(this._selected).map(e=>this._rowsState[e]),count:this._selected.size},bubbles:!0})},$c=new WeakSet,Nc=function(){const e=this.shadowRoot?.querySelector(".data");if(!e)return;const t=()=>{(0,o.jq)(this,Gc,jc).call(this,e),(0,o.jq)(this,Ec,qc).call(this,e)};e.addEventListener("scroll",t);const r=new ResizeObserver(()=>t());r.observe(e);const s=e.querySelector("table");s&&r.observe(s),t()},Gc=new WeakSet,jc=function(e){const{scrollTop:t,scrollHeight:r,clientHeight:s}=e,o=r-s;t>0?e.classList.add("scrolled"):e.classList.remove("scrolled"),t<o-1?e.classList.add("scrolled-bottom"):e.classList.remove("scrolled-bottom")},Ec=new WeakSet,qc=function(e){const{scrollLeft:t,scrollWidth:r,clientWidth:s}=e,o=r-s;r>s?e.classList.add("overflows-x"):e.classList.remove("overflows-x"),t<=0?(e.classList.add("scrolled-x-start"),e.classList.remove("scrolled-x-middle","scrolled-x-end")):t>=o-1?(e.classList.add("scrolled-x-end"),e.classList.remove("scrolled-x-start","scrolled-x-middle")):(e.classList.add("scrolled-x-middle"),e.classList.remove("scrolled-x-start","scrolled-x-end"))},Bc.styles=di,(0,o.Cc)([(0,i.MZ)()],Bc.prototype,"headline",2),(0,o.Cc)([(0,i.MZ)({attribute:"headline-tag",type:String,reflect:!0})],Bc.prototype,"headlineTag",2),(0,o.Cc)([(0,i.MZ)()],Bc.prototype,"summary",2),(0,o.Cc)([(0,i.MZ)({attribute:"search-label",type:String})],Bc.prototype,"searchLabel",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Bc.prototype,"options",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Bc.prototype,"page",2),(0,o.Cc)([(0,i.MZ)({type:Number})],Bc.prototype,"rows",2),(0,o.Cc)([(0,i.MZ)({type:Array})],Bc.prototype,"columns",2),(0,o.Cc)([(0,i.MZ)()],Bc.prototype,"data",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],Bc.prototype,"density",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"selectable",2),(0,o.Cc)([(0,i.MZ)({attribute:"disable-select-all",type:Boolean,reflect:!1})],Bc.prototype,"disableSelectAll",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"responsive",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"plain",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"searchable",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"settings",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"striped",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!1})],Bc.prototype,"nocache",2),(0,o.Cc)([(0,i.MZ)({type:Object})],Bc.prototype,"tfoot",2),(0,o.Cc)([(0,i.MZ)()],Bc.prototype,"dataLoadKey",2),(0,o.Cc)([(0,h.F)({...p.Sc,property:"--_table-height",selector:".data"})],Bc.prototype,"height",2),(0,o.Cc)([(0,i.MZ)()],Bc.prototype,"variant",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_isMobile",2),(0,o.Cc)([(0,Is.M)("(max-width: 768px)")],Bc.prototype,"_handleMobile",1),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_view",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_loaded",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_loading",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_rowsState",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_total",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_selected",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_expanded",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_expanding",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_completingExpansion",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_expandedRowsCache",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_expandedFullContentResolved",2),(0,o.Cc)([(0,i.wk)()],Bc.prototype,"_error",2),(0,o.Cc)([(0,ee.w)("dataLoadKey"),(0,ee.w)("data")],Bc.prototype,"_onDataChange",1),(0,o.Cc)([(0,ee.w)("page",{waitUntilFirstUpdate:!0})],Bc.prototype,"_onPageChange",1),(0,o.Cc)([(0,ee.w)("rows",{waitUntilFirstUpdate:!0})],Bc.prototype,"_onRowsChange",1),(0,o.Cc)([(0,ee.w)("columns")],Bc.prototype,"_onColumnsChange",1),(0,o.Cc)([(0,jo.L)({childList:!0,attributes:!0,attributeFilter:["slot"],attributeOldValue:!0})],Bc.prototype,"_handleLightDOMSlotsChange",1),Bc=(0,o.Cc)([(0,N.cc)(),(0,d.Y$)("gds-table",{dependsOn:Ci}),(0,G.J)({labelledBy:"table",describedBy:"table"})],Bc);const zc=e=>{Bc.define();const t=(0,L.pI)("gds-table"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};zc.displayName="GdsTable";var Wc,Ac,Yc,Kc,Tc,Rc=b.AH`
  @layer base {
    :host {
      display: block;
      outline: none;
...
`;let cC=class extends((0,u.Q8)((0,u.TM)((0,u.lt)(R(hr(c.j)))))){constructor(){super(...arguments),(0,o.VK)(this,Td),(0,o.VK)(this,Pd),(0,o.VK)(this,Od),(0,o.VK)(this,Ud),(0,o.VK)(this,Qd),(0,o.VK)(this,eC),(0,o.VK)(this,rC),(0,o.VK)(this,oC),(0,o.VK)(this,iC),this.title="",this.excerpt="",this.label="",this.variant="neutral-01",this.tag="h2",this.ratio="landscape",this.category="",this.date="",this.dateFormat="dateTimeLong",this.locale="en-GB"}render(){return(0,F.z)(this.href,()=>(0,o.jq)(this,Qd,Xd).call(this),()=>(0,o.jq)(this,rC,sC).call(this))}};Td=new WeakSet,Rd=function(e=!1){return e&&this.label||this.querySelector('[slot="footer"]')},Pd=new WeakSet,Dd=function(e){return(0,l.H)({card:!0,[`card-${e}`]:!!e,[`variant-${this.variant}`]:!0,[`ratio-${this.ratio}`]:!0})},Od=new WeakSet,Fd=function(){return!!this.querySelector('[slot="media"]')},Ud=new WeakSet,Jd=function(){return this.src?d.qy`
      ...
      `:(0,o.jq)(this,Od,Fd).call(this)?d.qy`
        <gds-flex
          padding="xs xs 0 xs"
          flex="1"
          aspect-ratio=${"square"===this.ratio?"1/1":"16/9"}
      ...
      `:null},Qd=new WeakSet,Xd=function(){return d.qy`
      <gds-card-linked
        padding="0"
        gap="0"
        href=${(0,a.J)(this.href)}
        ...
        rel=${(0,a.J)(this.rel)}
        variant=${this.variant}
        class=${(0,o.jq)(this,Pd,Dd).call(this,"linked")}
      >
        ${(0,o.jq)(this,iC,lC).call(this)}
      </gds-card-linked>
    `},eC=new WeakSet,tC=function(){return(0,F.z)((0,o.jq)(this,Td,Rd).call(this,!0),()=>d.qy`
        <gds-flex
          font="detail-m-book"
          align-items="center"
          gap="s"
      ...
      <gds-card
        ...
        gap="0"
        variant=${this.variant}
        class=${(0,o.jq)(this,Pd,Dd).call(this,"static")}
      >
        ${(0,o.jq)(this,iC,lC).call(this)}
      </gds-card>
    `},oC=new WeakSet,nC=function(){return(0,F.z)((0,o.jq)(this,Td,Rd).call(this),()=>d.qy`
      ...
      <gds-flex flex-direction="column" gap="xl" padding="xl">
        ${(0,F.z)(!this.src&&!(0,o.jq)(this,Od,Fd).call(this),()=>d.qy`<slot name="header"></slot>`)}
        ${(0,F.z)(this.title||this.excerpt,()=>d.qy`
          ...
          `)}
        ${(0,F.z)(this.href,()=>(0,o.jq)(this,eC,tC).call(this),()=>(0,o.jq)(this,oC,nC).call(this))}
      </gds-flex>
    `},cC.styles=[C.LU,aC],(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"title",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"excerpt",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"variant",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"tag",2),(0,o.Cc)([(0,i.MZ)({reflect:!1,attribute:"aspect-ratio"})],cC.prototype,"ratio",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"category",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"date",2),(0,o.Cc)([(0,i.MZ)({reflect:!1,attribute:"date-format"})],cC.prototype,"dateFormat",2),(0,o.Cc)([(0,i.MZ)({reflect:!1})],cC.prototype,"locale",2),cC=(0,o.Cc)([(0,d.Y$)("gds-card-pattern-01",{dependsOn:[K.z,D,ur,Rt,ot.o,Yd,Kd]})],cC);const dC=e=>{cC.define();const t=(0,L.pI)("gds-card-pattern-01"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};dC.displayName="GdsCardPattern01";var CC,hC,pC,uC,gC,fC,mC,MC,VC,kC,vC,yC,bC,_C,wC,LC,HC,xC,ZC=r(6511),SC=b.AH`
  :host {
    display: flex;
    align-items: center;
    gap: var(--gds-sys-space-s);
...
`;let IC=class extends(R(ZC.s)){constructor(){super(...arguments),(0,o.VK)(this,CC),(0,o.VK)(this,pC),(0,o.VK)(this,gC),(0,o.VK)(this,mC),(0,o.VK)(this,VC),(0,o.VK)(this,vC),(0,o.VK)(this,bC),(0,o.VK)(this,wC),(0,o.VK)(this,HC),this._isWrapped=!1,this._hasLead=!1,this.label="",this.selectable=!1,this.checked=!1,this.indeterminate=!1,this.disabled=!1,this._hasTrailContent=!1}_checkWrap(){const e=this._itemsContainer;if(!e)return;const t=Array.from(e.children);if(t.length<2)return void(this._isWrapped=!1);const r=t[0].getBoundingClientRect().top;this._isWrapped=t.some(e=>e.getBoundingClientRect().top>r)}render(){return d.qy`${(0,o.jq)(this,HC,xC).call(this)}`}};CC=new WeakSet,hC=function(){return!!this.href},pC=new WeakSet,uC=function(){const e=e=>{e.stopPropagation(),this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))};return d.qy`
      <div
        class="rbcb-wrapper"
        role="checkbox"
    ...
    `},VC=new WeakSet,kC=function(e){const t=e.target;this._hasLead=t.assignedElements().length>0},vC=new WeakSet,yC=function(e){const t=e.target;this._hasTrailContent=t.assignedElements().length>0||(0,o.S7)(this,CC,hC)},bC=new WeakSet,_C=function(){if(this.items&&this.items.length>0){const e=this.items.length>=3?"wrap":"nowrap",t=this.items.length>=2&&!this._isWrapped;return d.qy`
        ...
        <slot></slot>
      `}return d.qy`<slot name="lead" @slotchange=${(0,o.jq)(this,VC,kC)}></slot
      ...
      >
    `},HC=new WeakSet,xC=function(){if((0,o.S7)(this,CC,hC)&&this.selectable)return d.qy`
        ...
        <gds-button
          ...
          ><gds-icon-chevron-right></gds-icon-chevron-right
        ></gds-button>
      `;if((0,o.S7)(this,CC,hC)){const e=(0,l.H)({"has-lead":this._hasLead});return d.qy`
...
`;let FC=class extends c.j{constructor(){super(...arguments),(0,o.VK)(this,EC),(0,o.VK)(this,BC),(0,o.VK)(this,WC),(0,o.VK)(this,YC),(0,o.VK)(this,TC),(0,o.VK)(this,PC),this.href="",this.label="",this.overflow=!1}render(){return d.qy`
    ...
    `},FC.styles=[OC],(0,o.Cc)([(0,i.MZ)()],FC.prototype,"href",2),(0,o.Cc)([(0,i.MZ)()],FC.prototype,"target",2),(0,o.Cc)([(0,i.MZ)()],FC.prototype,"rel",2),(0,o.Cc)([(0,i.MZ)()],FC.prototype,"label",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,reflect:!0})],FC.prototype,"overflow",2),FC=(0,o.Cc)([(0,d.Y$)("gds-breadcrumb",{dependsOn:[ms,Rt]})],FC);const UC=e=>{FC.define();const t=(0,L.pI)("gds-breadcrumb"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};UC.displayName="GdsBreadcrumb";const JC=b.AH`
  :host {
    /* Font Sizes */
...
`;var QC,XC,eh,th,rh,sh,oh,nh,ih,lh,ah,ch,dh,Ch,hh;let ph=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,XC),(0,o.VK)(this,th),(0,o.VK)(this,sh),(0,o.VK)(this,nh),(0,o.VK)(this,lh),(0,o.VK)(this,ch),(0,o.VK)(this,Ch),this.size="large",this.flexDirection="column",this.hideLabel=!1,this.supportingText="",this.showExtendedSupportingText=!1,(0,o.VK)(this,QC,()=>{this.checkboxes.forEach(e=>{e.invalid=this.invalid,e.errorMessage=this.errorMessage})})}get value(){return this._internalValue||[]}set value(e){this._internalValue=e}get checkboxes(){return Array.from(this.querySelectorAll("[gds-element=gds-checkbox]"))}_getValidityAnchor(){return this._elCheckboxGroup}_handleValueChange(){this.checkboxes.forEach(e=>{e.checked=this.value.includes(e.value)||!1})}_handleGroupInvalidChange(){(0,o.S7)(this,QC).call(this)}focus(){this.checkboxes[0]?.focus()}connectedCallback(){super.connectedCallback(),this.addEventListener("gds-validity-state",(0,o.S7)(this,QC))}render(){const e={"checkbox-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
    ...
    >
      ...
      .errorMessage=${this.invalid?this.errorMessage:void 0}
    >
    </gds-form-control-footer>`},ph.styles=[JC],(0,o.Cc)([(0,i.MZ)()],ph.prototype,"size",2),(0,o.Cc)([(0,i.MZ)({attribute:"flex-direction"})],ph.prototype,"flexDirection",2),(0,o.Cc)([(0,i.MZ)({type:Boolean,attribute:"hide-label"})],ph.prototype,"hideLabel",2),(0,o.Cc)([(0,i.MZ)({attribute:"supporting-text"})],ph.prototype,"supportingText",2),(0,o.Cc)([(0,i.MZ)({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],ph.prototype,"showExtendedSupportingText",2),(0,o.Cc)([(0,i.MZ)({type:Array})],ph.prototype,"value",1),(0,o.Cc)([(0,i.P)("#checkboxgroup")],ph.prototype,"_elCheckboxGroup",2),(0,o.Cc)([(0,ee.w)("value",{waitUntilFirstUpdate:!0})],ph.prototype,"_handleValueChange",1),(0,o.Cc)([(0,ee.w)("invalid"),(0,ee.w)("errorMessage")],ph.prototype,"_handleGroupInvalidChange",1),(0,o.Cc)([(0,jo.L)({attributes:!0,childList:!0,subtree:!0,characterData:!0})],ph.prototype,"_syncOnDOMChange",1),ph=(0,o.Cc)([(0,G.J)({labelledBy:"#checkboxgroup",describedBy:"#checkboxgroup",errorMessage:"#checkboxgroup"}),(0,N.cc)()],ph);let uh=class extends((0,u.lt)((0,u.TM)((0,u.Q8)(ph)))){};uh=(0,o.Cc)([(0,d.Y$)("gds-checkbox-group",{dependsOn:[Br.$,qr.V]})],uh);const gh=e=>{uh.define();const t=(0,L.pI)("gds-checkbox-group"),r=(0,n.useRef)(null),s=e.ref||r;(0,L.j_)(s,e.value,e.defaultValue,e.onChange,e.onInput);const{onChange:o,onInput:i,ref:l,...a}=e,c={...a,class:e.className,ref:s};return(0,n.createElement)(t,c)};gh.displayName="GdsCheckboxGroup";const fh=e=>{Te.define();const t=(0,L.pI)("gds-icon-details"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};fh.displayName="GdsIconDetails";var mh=r(1912);const Mh=e=>{mh.x.define();const t=(0,L.pI)("gds-filter-chip"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};Mh.displayName="GdsFilterChip";const Vh={"seb-account":e=>{const t="string"==typeof e?e.replace(" ",""):e?.toString()??"";return 11!==t.length?t:`${t.slice(0,4)} ${t.slice(4,6)} ${t.slice(6,9)} ${t.slice(9,11)}`}};let kh=class extends zd{constructor(){super(...arguments),this.format="seb-account"}get formattedValue(){return Vh[this.format](this.account)}firstUpdated(e){super.firstUpdated(e),!this.account&&this.textContent&&(this.account=this.textContent)}};(0,o.Cc)([(0,i.MZ)()],kh.prototype,"account",2),(0,o.Cc)([(0,i.MZ)({type:String})],kh.prototype,"format",2),kh=(0,o.Cc)([(0,d.Y$)("gds-formatted-account")],kh);const vh=e=>{kh.define();const t=(0,L.pI)("gds-formatted-account"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};vh.displayName="GdsFormattedAccount";const yh=e=>{Yd.define();const t=(0,L.pI)("gds-formatted-date"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};yh.displayName="GdsFormattedDate";const bh={decimalsAndThousands:(e,t,r,s)=>{const o={maximumFractionDigits:s??2,minimumFractionDigits:s??2};return r?new Intl.NumberFormat(t,{...o,style:"currency",currency:r}).format(Number(e)):new Intl.NumberFormat(t,o).format(Number(e))}};let _h=class extends zd{constructor(){super(...arguments),this.format="decimalsAndThousands"}get formattedValue(){return bh[this.format](this.value,this.locale,this.currency,this.decimals)}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};(0,o.Cc)([(0,i.MZ)({attribute:!1})],_h.prototype,"value",2),(0,o.Cc)([(0,i.MZ)({type:String})],_h.prototype,"locale",2),(0,o.Cc)([(0,i.MZ)({type:String})],_h.prototype,"currency",2),(0,o.Cc)([(0,i.MZ)({type:Number})],_h.prototype,"decimals",2),(0,o.Cc)([(0,i.MZ)({type:String})],_h.prototype,"format",2),_h=(0,o.Cc)([(0,d.Y$)("gds-formatted-number")],_h);const wh=e=>{_h.define();const t=(0,L.pI)("gds-formatted-number"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};wh.displayName="GdsFormattedNumber";const Lh=e=>{ZC.s.define();const t=(0,L.pI)("gds-list-item"),r={...e,class:e.className,ref:e.ref};return(0,n.createElement)(t,r)};Lh.displayName="GdsListItem";const Hh=b.AH`
  :host {
    /* Font Sizes */
    --_font-label: var(--gds-sys-text-detail-m-book);
    --_font-supporting-text: var(--gds-sys-text-detail-s-regular);
...
`;var xh,Zh,Sh,Ih,$h,Nh,Gh,jh,Eh,qh,Bh,zh,Wh,Ah,Yh,Kh,Th,Rh,Ph,Dh;let Oh=class extends te.S{constructor(){super(...arguments),(0,o.VK)(this,xh),(0,o.VK)(this,Sh),(0,o.VK)(this,$h),(0,o.VK)(this,Gh),(0,o.VK)(this,Eh),(0,o.VK)(this,Bh),(0,o.VK)(this,Wh),(0,o.VK)(this,Yh),(0,o.VK)(this,Th),(0,o.VK)(this,Ph),this.size="large",this.flexDirection="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),(0,o.jq)(this,xh,Zh).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}focus(e){this._getValidityAnchor()?.focus(e)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{(0,o.jq)(this,xh,Zh).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid,e.errorMessage=this.errorMessage})}render(){const e={"radio-group":!0,"direction-row":"row"===this.flexDirection,"direction-column":"column"===this.flexDirection};return d.qy`<div
      role="radiogroup"
      id="radiogroup"
      class=${(0,l.H)(e)}
      aria-labelledby="group-label"
      ...
      aria-invalid=${this.invalid}
    >
      ${(0,o.jq)(this,Wh,Ah).call(this)}
    </div>`}};xh=new WeakSet,Zh=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(e=>e.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(e=>!e.checked).forEach(e=>e.setAttribute("tabindex","-1"))},Sh=new WeakSet,Ih=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(e=>e.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))},$h=new WeakSet,Nh=function(){this.updateComplete.then(()=>this.dispatchStandardEvent("change",{composed:!0,bubbles:!0})),this.updateComplete.then(()=>this.dispatchStandardEvent("input",{bubbles:!0,composed:!0}))},Gh=new WeakSet,jh=function(e){e.stopPropagation();const t=e.target;this.value=t.value,this._syncRadioStates(),(0,o.jq)(this,$h,Nh).call(this)},Eh=new WeakSet,qh=function(e){if(!this._isConnected)return;const t=this.radios.filter(e=>!e.disabled);if(0===t.length)return;let r=t.findIndex(e=>document.activeElement===e);switch(-1===r&&(r=t.findIndex(e=>e.checked),-1===r&&(r=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const s=(r+1)%t.length;(0,o.jq)(this,Bh,zh).call(this,t[s]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const s=(r-1+t.length)%t.length;(0,o.jq)(this,Bh,zh).call(this,t[s]);break}default:return}},Bh=new WeakSet,zh=function(e){this._contentElement&&this._isConnected&&(this.radios.forEach(e=>e.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),(0,o.jq)(this,$h,Nh).call(this))},Wh=new WeakSet,Ah=function(){return[(0,o.jq)(this,Yh,Kh).call(this),(0,o.jq)(this,Th,Rh).call(this),(0,o.jq)(this,Ph,Dh).call(this)].map(e=>d.qy`${e}`)},Yh=new WeakSet,Kh=function(){if(this.label)return d.qy` <gds-form-control-header
        class="size-${this.size}"
        .showExtendedSupportingText="${this.showExtendedSupportingText}"
      >
        <label id="group-label" slot="label">${this.label}</label>
...
//# sourceMappingURL=5636.286e5826.iframe.bundle.js.map