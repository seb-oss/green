import{i as h,b as u,d as l}from"./declarative-layout-mixins-Dzvp5_5O.js";const m=i=>{class t extends i{focus(o){this.setAttribute("tabindex","0"),super.focus(o)}connectedCallback(){super.connectedCallback(),this.addEventListener("blur",o=>{this.setAttribute("tabindex","-1"),this.dispatchEvent(new FocusEvent("gds-blur",{bubbles:!1,composed:!0,relatedTarget:o.relatedTarget}))}),this.addEventListener("focus",o=>{this.dispatchEvent(new FocusEvent("gds-focus",{bubbles:!1,composed:!0,relatedTarget:o.relatedTarget}))})}}return t},g=h`
  @layer base, reset;
