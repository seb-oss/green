import{a as t,b as s,h as e}from"./iframe-CWB-UUgA.js";const m=c=>a({...c,type:"checkbox"}),k=c=>a({...c,type:"radio"}),a=c=>{const{type:i,checked:o,indeterminate:r,disabled:d,invalid:b}=c;return e`
