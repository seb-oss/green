import{m as B}from"./runtime-BL31MtW8.js";import{l as G}from"./localized-decorator-DtmrKsyB.js";import{n as c,h,g as O}from"./custom-element-scoping-b4c89-hi.js";import{a as R}from"./query-p8xgzTDt.js";import{r as H}from"./query-async-MEroNOeJ.js";import{n as x}from"./when-BR7zwNJC.js";import{i as W,E as z}from"./lit-element-Bx14lxc-.js";import{f as q,G as N}from"./form-control-host.style-AD7-Ao8w.js";import{G as I,a as L}from"./form-control-header.component-J3bdQqXQ.js";import{t as U}from"./tokens.style-C9bLefPj.js";import{w as S}from"./watch-tFciLXSI.js";import{r as D}from"./resize-observer-B9k8v2TZ.js";import{s as X,d as V,w as J,b as K}from"./declarative-layout-mixins-p82vEmD5.js";import{a as Q,G as Y,f as Z}from"./button.component-BssCmS92.js";import{I as j}from"./cross-large.component-BYEseUaL.js";const ee=W`
  textarea {
...
`;var te=Object.defineProperty,se=Object.getOwnPropertyDescriptor,$=e=>{throw TypeError(e)},a=(e,t,s,n)=>{for(var o=n>1?void 0:n?se(t,s):t,u=e.length-1,g;u>=0;u--)(g=e[u])&&(o=(n?g(t,s,o):g(o))||o);return n&&o&&te(t,s,o),o},T=(e,t,s)=>t.has(e)||$("Cannot "+s),l=(e,t,s)=>(T(e,t,"read from private field"),s?s.call(e):t.get(e)),d=(e,t,s)=>t.has(e)?$("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),p=(e,t,s)=>(T(e,t,"access private method"),s),r,A,m,_,w,v,f,y,E,P,M,k,F,b;let i=class extends Q{constructor(){super(),d(this,r),this._defaultRows=4,this.rows=4,this.supportingText="",this.clearable=!1,this.resizable="auto",this.maxlength=Number.MAX_SAFE_INTEGER,this.size="large",this.plain=!1,this._handleSlotChange=()=>{requestAnimationFrame(()=>{this._handleResize()})},d(this,m,e=>["type","placeholder","required"].includes(e.name)),d(this,_,e=>{const t=e.target;this.value=t.value}),d(this,w,e=>{const t=e.target;this.value=t.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}),d(this,v,e=>{requestAnimationFrame(()=>{this._setAutoHeight()})}),d(this,f,()=>{this.elTextareaAsync.then(e=>e.focus())}),d(this,y,()=>{this.value="",this.elTextareaAsync.then(e=>{if(this.resizable==="manual")e.style.height="";else if(this.resizable==="false"){const t=this._initialRows??this._defaultRows;this.rows=t,e.style.setProperty("--_lines",t.toString())}else{const t=this._initialRows??this._defaultRows;this.rows=t,e.style.setProperty("--_lines",t.toString()),e.style.height=""}}),this.dispatchEvent(new Event("gds-input-cleared",{bubbles:!0,composed:!0})),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}),this.value=""}test_getClearButton(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("#clear-button")}test_getFieldElement(){var e;return(e=this.shadowRoot)==null?void 0:e.querySelector("#field")}_handleResize(){this.fieldBase&&Promise.resolve().then(()=>{var s;const e=(s=this.fieldBase)==null?void 0:s.shadowRoot;if(!e)return;const t=e.querySelector(".right");if(t){const n=t.getBoundingClientRect();this.elTextarea.style.setProperty("--padding-inline-end",`${n.width}px`)}else this.elTextarea.style.removeProperty("--padding-inline-end")})}connectedCallback(){super.connectedCallback(),this.hasAttribute("rows")&&(this._initialRows=this.rows),this._setAutoHeight(),this.addEventListener("slotchange",this._handleSlotChange)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("slotchange",this._handleSlotChange)}render(){return h`
    ...
    `};F=function(){var e;return this.clearable&&(((e=this.value)==null?void 0:e.length)||0)>0?h`
      ...
      `:z};b=function(){return this.maxlength<Number.MAX_SAFE_INTEGER};i.styles=[U,q,ee];a([X({valueTemplate:e=>e,selector:"textarea",styleTemplate:(e,t)=>`min-height: calc(1lh * ${t[0]});`})],i.prototype,"rows",2);a([c({attribute:"supporting-text"})],i.prototype,"supportingText",2);a([c({type:Boolean})],i.prototype,"clearable",2);a([c({type:String})],i.prototype,"resizable",2);a([c({type:Number})],i.prototype,"maxlength",2);a([c({type:String})],i.prototype,"size",2);a([c({type:Boolean})],i.prototype,"plain",2);a([H("textarea")],i.prototype,"elTextareaAsync",2);a([R("textarea")],i.prototype,"elTextarea",2);a([R("gds-field-base")],i.prototype,"fieldBase",2);a([D()],i.prototype,"_handleResize",1);a([S("value")],i.prototype,"_setAutoHeight",1);a([S("rows")],i.prototype,"_handleRowsChange",1);i=a([G()],i);let C=class extends V(J(K(i))){};C=a([O("gds-textarea",{dependsOn:[I,L,Y,N,j]})],C);export{C as G};
