import{l as S}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as l,G as T,h as p,g as y,r as j}from"./custom-element-scoping-b4c89-hi.js";import{a as V}from"./query-p8xgzTDt.js";import{e as w}from"./class-map-CXsQwv0r.js";import{G as H,a as K}from"./form-control-header.component-DE15buoc.js";import{t as R}from"./tokens.style-C9bLefPj.js";import{w as k}from"./watch-tFciLXSI.js";import{d as q,b as U,w as X}from"./declarative-layout-mixins-C09DP4OO.js";import{a as J}from"./button.component-CJG_iMlt.js";import{i as v}from"./lit-element-Bx14lxc-.js";import{n as N}from"./when-BR7zwNJC.js";const Q=v`
  @layer base, a11y;
...
`;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,C=(e,t,i,s)=>{for(var r=s>1?void 0:s?Z(t,i):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(r=(s?d(t,i,r):d(r))||r);return s&&r&&Y(t,i,r),r};let u=class extends T{constructor(){super(),this.label="",this.supportingText=""}render(){const e={label:!0,"has-supporting-text":!!this.supportingText};return p`
      <div class="container">
    ...
    `}};u.styles=[R,Q];C([l()],u.prototype,"label",2);C([l({attribute:"supporting-text"})],u.prototype,"supportingText",2);u=C([y("gds-toggle-control-base"),S()],u);const ee=v`
  .rbcb {
...
`,ke=e=>D({...e,type:"checkbox"}),te=e=>D({...e,type:"radio"}),D=e=>{const{type:t,checked:i,disabled:s,invalid:r}=e;return p`
    <div class="rbcb ${w({"rbcb--checkbox":t==="checkbox","rbcb--radio":t==="radio","--checked":i,"--disabled":s,"--invalid":r})}">
      ...
      <div class="rbcb__toggle">
        ${N(t==="checkbox"&&i,()=>p`<gds-icon-checkmark
              class="rbcb__icon"
              stroke="4"
            ></gds-icon-checkmark>`)}
      </div>
...
`;var se=Object.defineProperty,re=Object.getOwnPropertyDescriptor,F=e=>{throw TypeError(e)},g=(e,t,i,s)=>{for(var r=s>1?void 0:s?re(t,i):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(r=(s?d(t,i,r):d(r))||r);return s&&r&&se(t,i,r),r},oe=(e,t,i)=>t.has(e)||F("Cannot "+i),ae=(e,t,i)=>t.has(e)?F("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,i),a=(e,t,i)=>(oe(e,t,"access private method"),i),o,_,G,E,O,P,f,L,M,B,I;let c=class extends J{constructor(){super(...arguments),ae(this,o),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),a(this,o,_).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{a(this,o,_).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return p`<div
    ...
    </div>`}};o=new WeakSet;_=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))};G=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(i=>i.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(i=>i.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};E=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))};O=function(e){const t=e.target;t.hasAttribute("value")&&(this.value=t.value,this._syncRadioStates(),a(this,o,E).call(this))};P=function(e){if(!this._isConnected)return;const t=this.radios.filter(s=>!s.hasAttribute("disabled"));if(t.length===0)return;let i=t.findIndex(s=>document.activeElement===s);switch(i===-1&&(i=t.findIndex(s=>s.checked),i===-1&&(i=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const s=(i+1)%t.length;a(this,o,f).call(this,t[s]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const s=(i-1+t.length)%t.length;a(this,o,f).call(this,t[s]);break}default:return}};f=function(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),a(this,o,E).call(this))};L=function(){return[a(this,o,M).call(this),a(this,o,B).call(this),a(this,o,I).call(this)].map(t=>p`${t}`)};M=function(){if(this.label)return p` <gds-form-control-header
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,W=e=>{throw TypeError(e)},b=(e,t,i,s)=>{for(var r=s>1?void 0:s?de(t,i):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(r=(s?d(t,i,r):d(r))||r);return s&&r&&le(t,i,r),r},ce=(e,t,i)=>t.has(e)||W("Cannot "+i),$=(e,t,i)=>(ce(e,t,"read from private field"),i?i.call(e):t.get(e)),A=(e,t,i)=>t.has(e)?W("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,i),x,m;let h=class extends T{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,A(this,x,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchEvent(new Event("gds-radio-change",{bubbles:!0})))}),A(this,m,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchEvent(new Event("gds-radio-change",{bubbles:!0})))}),this.addEventListener("keydown",$(this,m)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",$(this,x))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}render(){return p`
    ...
    `}};x=new WeakMap;m=new WeakMap;h.styles=[ee,ne];b([l()],h.prototype,"label",2);b([l({attribute:"supporting-text"})],h.prototype,"supportingText",2);b([l()],h.prototype,"value",2);b([l({type:Boolean,reflect:!0})],h.prototype,"checked",2);b([l({type:Boolean,reflect:!0})],h.prototype,"disabled",2);b([l({type:Boolean})],h.prototype,"invalid",2);b([j()],h.prototype,"_isFocused",2);b([k("disabled")],h.prototype,"_handleDisabledChange",1);h=b([y("gds-radio",{dependsOn:[u]})],h);export{h as G,z as a,u as b,ke as c,ee as r};
