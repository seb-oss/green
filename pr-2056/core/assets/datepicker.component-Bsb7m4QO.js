import{m as u}from"./runtime-BL31MtW8.js";import{l as Vt}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Ot,E as Dt}from"./lit-element-Bx14lxc-.js";import{n as $,r as H,G as Rt,h as C,g as St}from"./custom-element-scoping-b4c89-hi.js";import{e as Bt,a as qt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{f as Kt,o as Xt}from"./form-control-host.style-AD7-Ao8w.js";import{e as Ft,i as Ht,t as Zt}from"./directive-CF8sV3Lr.js";import{p as Jt,v as I,r as N,M as U,m as Ut,i as jt}from"./directive-helpers-BF33kFuJ.js";import{f as Qt}from"./ref-R0wBYijq.js";import{n as z}from"./when-BR7zwNJC.js";import{a as te,G as ee}from"./button.component-BssCmS92.js";import{G as se}from"./dropdown.component-BMsBpo6S.js";import{G as ae}from"./flex.component-Ce9CKV12.js";import{t as ie}from"./tokens.style-C9bLefPj.js";import{T as ne}from"./transitional-styles-BOwn52Fb.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as yt,a as re}from"./attribute-converters-CdI0trPX.js";import{w as oe,b as le,d as he}from"./declarative-layout-mixins-p82vEmD5.js";import{G as de,i as ce}from"./calendar.component-d7E8WzBr.js";import{I as pe,a as ue}from"./calender-add.component-BLLrnMIY.js";import{a as ge,I as fe}from"./chevron-right.component-DJR0jIYA.js";import{G as me}from"./popover.component-C8buB0L0.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends Ht{constructor(t){if(super(t),t.type!==Zt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let o=0;for(const c of t)a[o]=i?i(c,o):o,n[o]=s(c,o),o++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Jt(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=o,n;const c=this.ut??(this.ut=[]),r=[];let k,M,l=0,b=a.length-1,m=0,x=n.length-1;for(;l<=b&&m<=x;)if(a[l]===null)l++;else if(a[b]===null)b--;else if(c[l]===o[m])r[m]=I(a[l],n[m]),l++,m++;else if(c[b]===o[x])r[x]=I(a[b],n[x]),b--,x--;else if(c[l]===o[x])r[x]=I(a[l],n[x]),N(t,r[x+1],a[l]),l++,x--;else if(c[b]===o[m])r[m]=I(a[b],n[m]),N(t,a[l],a[b]),b--,m++;else if(k===void 0&&(k=xt(o,m,x),M=xt(c,l,b)),k.has(c[l]))if(k.has(c[b])){const S=M.get(o[m]),J=S!==void 0?a[S]:null;if(J===null){const wt=N(t,a[l]);I(wt,n[m]),r[m]=wt}else r[m]=I(J,n[m]),N(t,a[l],J),a[S]=null;m++}else U(a[b]),b--;else U(a[l]),l++;for(;m<=x;){const S=N(t,r[x+1]);I(S,n[m]),r[m++]=S}for(;l<=b;){const S=a[l++];S!==null&&U(S)}return this.ut=o,Ut(t,r),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Se=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,Et=t=>{throw TypeError(t)},d=(t,e,s,i)=>{for(var a=i>1?void 0:i?Fe(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&Se(e,s,a),a},bt=(t,e,s)=>e.has(t)||Et("Cannot "+s),g=(t,e,s)=>(bt(t,e,"read from private field"),s?s.call(t):e.get(t)),v=(t,e,s)=>e.has(t)?Et("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),j=(t,e,s,i)=>(bt(t,e,"write to private field"),e.set(t,s),s),f=(t,e,s)=>(bt(t,e,"access private method"),s),T,p,Pt,Nt,K,zt,At,it,P,G,Lt,nt,rt,ot,lt,ht,dt,ct,pt,ut,X,gt,ft,mt,vt,Y,Tt,Gt;let h=class extends te{constructor(){super(),v(this,p),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.disabledWeekends=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=f(this,p,mt).call(this,"y-m-d"),v(this,T),v(this,Lt,t=>{this._elTrigger.then(e=>{var i,a;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((a=document.getSelection())==null||a.removeAllRanges())})}),v(this,nt,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),v(this,rt,t=>{this._elFieldAsync.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),v(this,ot,t=>{this._elFieldAsync.then(e=>{var o;if(t.currentTarget!==e)return;t.preventDefault();const s=(o=t.clipboardData)==null?void 0:o.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const c=this._dateFormatLayout.layout,r=parseInt(n[c.findIndex(l=>l.token==="y")]),k=parseInt(n[c.findIndex(l=>l.token==="m")])-1,M=parseInt(n[c.findIndex(l=>l.token==="d")]);!isNaN(r)&&!isNaN(k)&&!isNaN(M)&&(i=new Date(`${r}-${k+1}-${M}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,f(this,p,P).call(this))})}),v(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),v(this,ht,t=>{t.stopPropagation(),this.value=t.detail,this.open=!1,f(this,p,P).call(this),f(this,p,G).call(this)}),v(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),v(this,ct,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),v(this,pt,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),v(this,ut,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),v(this,X,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),f(this,p,G).call(this)}),v(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;!ce(e||new Date(0),g(this,T)||new Date(0))&&(this.value=e,f(this,p,P).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=g(this,T),f(this,p,G).call(this))}}),v(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),v(this,vt,(t,e)=>{g(this,Y)[e]=t;const s=new Date;s.setFullYear(parseInt(g(this,Y).year)),s.setMonth(parseInt(g(this,Y).month)-1),s.setDate(parseInt(g(this,Y).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,f(this,p,P).call(this),f(this,p,G).call(this))}),v(this,Y,{year:"yyyy",month:"mm",day:"dd"}),D.define()}get type(){return"gds-datepicker"}get value(){return this._internalValue}set value(t){this._internalValue=t}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=f(this,p,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),ne.instance.apply(this,"gds-datepicker")}render(){return C`
