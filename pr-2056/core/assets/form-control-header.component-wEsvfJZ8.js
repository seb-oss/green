import{n as m,G as y,h as o,g as w,r as O}from"./custom-element-scoping-b4c89-hi.js";import{n as c}from"./when-BR7zwNJC.js";import{G as P}from"./badge.component-i9Jy7NXq.js";import{a as M,I as B}from"./triangle-exclamation.component-COu7_UVq.js";import{i as E}from"./lit-element-Bx14lxc-.js";import{m as F}from"./runtime-BL31MtW8.js";import{l as W}from"./localized-decorator-DtmrKsyB.js";import{a as k}from"./query-p8xgzTDt.js";import{G as I}from"./button.component-C2-FBkbF.js";import{G as D}from"./card.component-B5590vme.js";const H=E`
...
`;var A=Object.defineProperty,N=Object.getOwnPropertyDescriptor,S=e=>{throw TypeError(e)},f=(e,t,s,a)=>{for(var r=a>1?void 0:a?N(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&A(t,s,r),r},R=(e,t,s)=>t.has(e)||S("Cannot "+s),j=(e,t,s)=>t.has(e)?S("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),q=(e,t,s)=>(R(e,t,"access private method"),s),x,T;let l=class extends y{constructor(){super(...arguments),j(this,x)}render(){return o`<div aria-live="polite">
    ...
    </div>`}};x=new WeakSet;T=function(e){let t;return e<0?t="negative":e<20?t="warning":t="positive",o`<gds-badge variant="${t}">${e}</gds-badge>`};l.styles=[H];f([m({type:Number})],l.prototype,"charCounter",2);f([m()],l.prototype,"validationMessage",2);l=f([w("gds-form-control-footer",{dependsOn:[P,M]})],l);const J=E`
  @layer base, reset, transitional-styles;
  @layer base {
    #label-row {
      display: flex;
...
`;var K=Object.defineProperty,L=Object.getOwnPropertyDescriptor,$=e=>{throw TypeError(e)},g=(e,t,s,a)=>{for(var r=a>1?void 0:a?L(t,s):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(r=(a?n(t,s,r):n(r))||r);return a&&r&&K(t,s,r),r},b=(e,t,s)=>t.has(e)||$("Cannot "+s),_=(e,t,s)=>(b(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?$("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),C=(e,t,s)=>(b(e,t,"access private method"),s),p,G,v,u,z;let d=class extends y{constructor(){super(...arguments),h(this,p),this.showExtendedSupportingText=!1,this._hasExtendedSupportingText=!1,h(this,v,()=>o`
    ...
    `),h(this,u,()=>{var e;this.showExtendedSupportingText=!this.showExtendedSupportingText,(e=this._extendedSupportingText)==null||e.style.setProperty("--_max-height",this.showExtendedSupportingText?`${this._extendedSupportingText.scrollHeight}px`:"0"),this.dispatchEvent(new CustomEvent("gds-ui-state",{bubbles:!0,composed:!0,detail:this.showExtendedSupportingText}))})}render(){return o`
      <div id="label-row">
        ...
        ${c(this._hasExtendedSupportingText,_(this,v))}
      </div>
