import{m as u}from"./runtime-BL31MtW8.js";import{l as Vt}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Ot,E as Dt}from"./lit-element-Bx14lxc-.js";import{n as _,r as H,G as Rt,h as C,g as St}from"./custom-element-scoping-b4c89-hi.js";import{e as Bt,a as qt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as E,r as N,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as z}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-D9i3kx96.js";import{G as te}from"./dropdown.component-CXwltSt-.js";import{G as ee}from"./flex.component-BfiuBC5x.js";import{f as se}from"./form-control-host.style-D8gynaCX.js";import{t as ae}from"./tokens.style-C9bLefPj.js";import{T as ie}from"./transitional-styles-Cduvqqe2.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as yt,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as re,b as oe,d as le}from"./declarative-layout-mixins-C09DP4OO.js";import{G as he,i as de}from"./calendar.component-Dnka_0gT.js";import{I as pe,a as ce}from"./calender-add.component-CKqMopEb.js";import{a as ue,I as ge}from"./chevron-right.component-CjDInRvL.js";import{G as fe}from"./popover.component-BIhYOQZu.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function*ye(t,e){if(t!==void 0){let s=0;for(const i of t)yield e(i,s++)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let o=0;for(const p of t)a[o]=i?i(p,o):o,n[o]=s(p,o),o++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=o,n;const p=this.ut??(this.ut=[]),r=[];let k,M,l=0,b=a.length-1,m=0,x=n.length-1;for(;l<=b&&m<=x;)if(a[l]===null)l++;else if(a[b]===null)b--;else if(p[l]===o[m])r[m]=E(a[l],n[m]),l++,m++;else if(p[b]===o[x])r[x]=E(a[b],n[x]),b--,x--;else if(p[l]===o[x])r[x]=E(a[l],n[x]),N(t,r[x+1],a[l]),l++,x--;else if(p[b]===o[m])r[m]=E(a[b],n[m]),N(t,a[l],a[b]),b--,m++;else if(k===void 0&&(k=xt(o,m,x),M=xt(p,l,b)),k.has(p[l]))if(k.has(p[b])){const S=M.get(o[m]),J=S!==void 0?a[S]:null;if(J===null){const wt=N(t,a[l]);E(wt,n[m]),r[m]=wt}else r[m]=E(J,n[m]),N(t,a[l],J),a[S]=null;m++}else U(a[b]),b--;else U(a[l]),l++;for(;m<=x;){const S=N(t,r[x+1]);E(S,n[m]),r[m++]=S}for(;l<=b;){const S=a[l++];S!==null&&U(S)}return this.ut=o,Zt(t,r),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=t=>!Jt(t)&&typeof t.then=="function",kt=1073741823;class xe extends Ut{constructor(){super(...arguments),this._$Cwt=kt,this._$Cbt=[],this._$CK=new be(this),this._$CX=new we}render(...e){return e.find(s=>!Ct(s))??Q}update(e,s){const i=this._$Cbt;let a=i.length;this._$Cbt=s;const n=this._$CK,o=this._$CX;this.isConnected||this.disconnected();for(let p=0;p<s.length&&!(p>this._$Cwt);p++){const r=s[p];if(!Ct(r))return this._$Cwt=p,r;p<a&&r===i[p]||(this._$Cwt=kt,a=0,Promise.resolve(r).then(async k=>{for(;o.get();)await o.get();const M=n.deref();if(M!==void 0){const l=M._$Cbt.indexOf(r);l>-1&&l<M._$Cwt&&(M._$Cwt=l,M.setValue(k))}}))}return Q}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}const Ce=Ft(xe);var ke=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,Yt=t=>{throw TypeError(t)},I=(t,e,s,i)=>{for(var a=i>1?void 0:i?Me(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&ke(e,s,a),a},$t=(t,e,s)=>e.has(t)||Yt("Cannot "+s),y=(t,e,s)=>($t(t,e,"read from private field"),s?s.call(t):e.get(t)),F=(t,e,s)=>e.has(t)?Yt("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),Wt=(t,e,s,i)=>($t(t,e,"write to private field"),e.set(t,s),s),w=(t,e,s)=>($t(t,e,"access private method"),s),W,V,O,R,B,tt,et,st,$,Et,A,at,T,q;let D=class extends Rt{constructor(){super(...arguments),F(this,$),this.value=0,this.length=2,this.min=0,this.max=Number.MAX_SAFE_INTEGER,this.displayValue=w(this,$,at).call(this,this.value,this.length),F(this,W,""),F(this,V,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.min:new Date().getFullYear()-1),this.value=w(this,$,T).call(this,t+1),w(this,$,A).call(this)}),F(this,O,()=>{let t=parseInt(this.value.toString());Number.isNaN(t)&&(t=this.length===2?this.max:new Date().getFullYear()+1),this.value=w(this,$,T).call(this,t-1),w(this,$,A).call(this)}),F(this,R,t=>{t.stopPropagation(),t.preventDefault(),this.focus()}),F(this,B,()=>{w(this,$,q).call(this)}),F(this,tt,()=>{y(this,W)!==""&&(w(this,$,q).call(this),this.value=w(this,$,T).call(this,parseInt(this.value.toString())),w(this,$,A).call(this))}),F(this,et,t=>{t.stopPropagation(),t.preventDefault(),t.deltaY>0?y(this,O).call(this):y(this,V).call(this)}),F(this,st,t=>{let e=!1;if(t.key==="ArrowUp")y(this,V).call(this),e=!0;else if(t.key==="ArrowDown")y(this,O).call(this),e=!0;else{const s=parseInt(t.key);isNaN(s)||(y(this,W).length<this.length&&(Wt(this,W,y(this,W)+s.toString()),this.value=parseInt(y(this,W))),y(this,W).length===this.length&&(this.value=w(this,$,T).call(this,this.value),w(this,$,q).call(this),w(this,$,Et).call(this),w(this,$,A).call(this)),e=!0)}e&&(t.preventDefault(),t.stopPropagation())})}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setAttribute("role","spinbutton"),this.setAttribute("tabindex","0"),this.addEventListener("wheel",y(this,et)),this.addEventListener("keydown",y(this,st)),this.addEventListener("blur",y(this,tt)),this.addEventListener("focus",y(this,B)),this.addEventListener("click",y(this,R)),this.addEventListener("mousedown",y(this,R))}focus(t){super.focus(t),y(this,B).call(this)}render(){return C`${this.displayValue}`}_refreshDisplayValue(){this.displayValue=w(this,$,at).call(this,this.value,this.length),this.setAttribute("aria-valuetext",this.value.toString())}};W=new WeakMap;V=new WeakMap;O=new WeakMap;R=new WeakMap;B=new WeakMap;tt=new WeakMap;et=new WeakMap;st=new WeakMap;$=new WeakSet;Et=function(){let t=this.nextElementSibling;for(;t;){if(t instanceof D){t.focus();break}t=t.nextElementSibling}};A=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value.toString()}}))};at=function(t,e){return String(t).padStart(e,"0")};T=function(t){return Math.max(this.min,Math.min(this.max,t))};q=function(){Wt(this,W,"")};D.formAssociated=!0;I([_({type:Number})],D.prototype,"value",2);I([_({type:Number})],D.prototype,"length",2);I([_({type:Number,attribute:"aria-valuemin"})],D.prototype,"min",2);I([_({type:Number,attribute:"aria-valuemax"})],D.prototype,"max",2);I([H()],D.prototype,"displayValue",2);I([_t("value")],D.prototype,"_refreshDisplayValue",1);D=I([St("gds-date-part-spinner")],D);const De=Ot`
  @layer base, reset;
...
`;var Se=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,It=t=>{throw TypeError(t)},d=(t,e,s,i)=>{for(var a=i>1?void 0:i?Fe(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&Se(e,s,a),a},bt=(t,e,s)=>e.has(t)||It("Cannot "+s),g=(t,e,s)=>(bt(t,e,"read from private field"),s?s.call(t):e.get(t)),v=(t,e,s)=>e.has(t)?It("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),j=(t,e,s,i)=>(bt(t,e,"write to private field"),e.set(t,s),s),f=(t,e,s)=>(bt(t,e,"access private method"),s),L,c,Pt,Nt,K,zt,At,it,P,G,Tt,nt,rt,ot,lt,ht,dt,pt,ct,ut,X,gt,ft,mt,vt,Y,Lt,Gt;let h=class extends jt{constructor(){super(),v(this,c),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.disabledWeekends=!1,this.showExtendedSupportingText=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=f(this,c,mt).call(this,"y-m-d"),v(this,L),v(this,Tt,t=>{this._elTrigger.then(e=>{var i,a;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((a=document.getSelection())==null||a.removeAllRanges())})}),v(this,nt,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),v(this,rt,t=>{this._elFieldAsync.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),v(this,ot,t=>{this._elFieldAsync.then(e=>{var o;if(t.currentTarget!==e)return;t.preventDefault();const s=(o=t.clipboardData)==null?void 0:o.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const p=this._dateFormatLayout.layout,r=parseInt(n[p.findIndex(l=>l.token==="y")]),k=parseInt(n[p.findIndex(l=>l.token==="m")])-1,M=parseInt(n[p.findIndex(l=>l.token==="d")]);!isNaN(r)&&!isNaN(k)&&!isNaN(M)&&(i=new Date(`${r}-${k+1}-${M}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,f(this,c,P).call(this))})}),v(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),v(this,ht,t=>{t.stopPropagation(),this.value=t.detail,this.open=!1,f(this,c,P).call(this),f(this,c,G).call(this)}),v(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),v(this,pt,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),v(this,ct,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),v(this,ut,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),v(this,X,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),f(this,c,G).call(this)}),v(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;!de(e||new Date(0),g(this,L)||new Date(0))&&(this.value=e,f(this,c,P).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=g(this,L),f(this,c,G).call(this))}}),v(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),v(this,vt,(t,e)=>{g(this,Y)[e]=t;const s=new Date;s.setFullYear(parseInt(g(this,Y).year)),s.setMonth(parseInt(g(this,Y).month)-1),s.setDate(parseInt(g(this,Y).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,f(this,c,P).call(this),f(this,c,G).call(this))}),v(this,Y,{year:"yyyy",month:"mm",day:"dd"}),D.define()}get type(){return"gds-datepicker"}get value(){return this._internalValue}set value(t){this._internalValue=t}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=f(this,c,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),ie.instance.apply(this,"gds-datepicker")}render(){return C`
      ...
      >
        <div class="spinners">
          ${_e(ye(this._dateFormatLayout.layout,(t,e)=>C`<gds-date-part-spinner
                  id="spinner-${e}"
