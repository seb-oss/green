import{l as A}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as l,G as S,h,g as m,r as j}from"./custom-element-scoping-b4c89-hi.js";import{a as V}from"./query-p8xgzTDt.js";import{e as w}from"./class-map-CXsQwv0r.js";import{G as H,a as K}from"./form-control-header.component-CNP7Go6G.js";import{t as T}from"./tokens.style-OWC-W9l-.js";import{w as R}from"./watch-tFciLXSI.js";import{d as q,b as U,w as X}from"./declarative-layout-mixins-DCzV-Sjo.js";import{a as J}from"./button.component-CWMlsVhI.js";import{i as v}from"./lit-element-Bx14lxc-.js";import{n as N}from"./when-BR7zwNJC.js";const Q=v`
  @layer base, a11y;
...
`;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,k=(e,t,s,i)=>{for(var r=i>1?void 0:i?Z(t,s):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(r=(i?d(t,s,r):d(r))||r);return i&&r&&Y(t,s,r),r};let u=class extends S{constructor(){super(),this.label="",this.supportingText=""}render(){const e={label:!0,"has-supporting-text":!!this.supportingText};return h`
    ...
    `}};u.styles=[T,Q];k([l()],u.prototype,"label",2);k([l({attribute:"supporting-text"})],u.prototype,"supportingText",2);u=k([m("gds-toggle-control-base"),A()],u);const ee=v`
  .rbcb {
...
`;var le=Object.defineProperty,de=Object.getOwnPropertyDescriptor,W=e=>{throw TypeError(e)},b=(e,t,s,i)=>{for(var r=i>1?void 0:i?de(t,s):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(r=(i?d(t,s,r):d(r))||r);return i&&r&&le(t,s,r),r},ce=(e,t,s)=>t.has(e)||W("Cannot "+s),z=(e,t,s)=>(ce(e,t,"read from private field"),s?s.call(e):t.get(e)),$=(e,t,s)=>t.has(e)?W("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),y,x;let p=class extends S{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,$(this,y,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchEvent(new Event("gds-radio-change",{bubbles:!0})))}),$(this,x,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchEvent(new Event("gds-radio-change",{bubbles:!0})))}),this.addEventListener("keydown",z(this,x)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",z(this,y))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}render(){return h`
    ...
    `}};y=new WeakMap;x=new WeakMap;p.styles=[ee,ne];b([l()],p.prototype,"label",2);b([l({attribute:"supporting-text"})],p.prototype,"supportingText",2);b([l()],p.prototype,"value",2);b([l({type:Boolean,reflect:!0})],p.prototype,"checked",2);b([l({type:Boolean,reflect:!0})],p.prototype,"disabled",2);b([l({type:Boolean})],p.prototype,"invalid",2);b([j()],p.prototype,"_isFocused",2);p=b([m("gds-radio",{dependsOn:[u]})],p);export{p as G,E as a,u as b,ke as c,ee as r};
