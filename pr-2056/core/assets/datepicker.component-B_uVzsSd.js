import{m as u}from"./runtime-BL31MtW8.js";import{l as Vt}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Ot,E as Dt}from"./lit-element-Bx14lxc-.js";import{n as y,r as H,G as Rt,h as k,g as St}from"./custom-element-scoping-b4c89-hi.js";import{e as Bt,a as qt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as E,r as N,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as z}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-JH9MBQut.js";import{G as te}from"./dropdown.component-D7iXqyWm.js";import{G as ee}from"./flex.component-BAUFwSAu.js";import{f as se}from"./form-control-host.style-GwSQv2RY.js";import{t as ae}from"./tokens.style-OWC-W9l-.js";import{T as ie}from"./transitional-styles-Ckr_5-pT.js";import{w as yt}from"./watch-tFciLXSI.js";import{d as _t,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as re,b as oe,d as le}from"./declarative-layout-mixins-DCzV-Sjo.js";import{G as he,i as de}from"./calendar.component-Drn5DnlM.js";import{I as pe,a as ce}from"./calender-add.component-CEPU4Wof.js";import{a as ue,I as ge}from"./chevron-right.component-BWYpY4aM.js";import{G as fe}from"./popover.component-C26SUBPV.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let o=0;for(const p of t)a[o]=i?i(p,o):o,n[o]=s(p,o),o++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=o,n;const p=this.ut??(this.ut=[]),r=[];let C,M,l=0,b=a.length-1,m=0,x=n.length-1;for(;l<=b&&m<=x;)if(a[l]===null)l++;else if(a[b]===null)b--;else if(p[l]===o[m])r[m]=E(a[l],n[m]),l++,m++;else if(p[b]===o[x])r[x]=E(a[b],n[x]),b--,x--;else if(p[l]===o[x])r[x]=E(a[l],n[x]),N(t,r[x+1],a[l]),l++,x--;else if(p[b]===o[m])r[m]=E(a[b],n[m]),N(t,a[l],a[b]),b--,m++;else if(C===void 0&&(C=xt(o,m,x),M=xt(p,l,b)),C.has(p[l]))if(C.has(p[b])){const S=M.get(o[m]),J=S!==void 0?a[S]:null;if(J===null){const wt=N(t,a[l]);E(wt,n[m]),r[m]=wt}else r[m]=E(J,n[m]),N(t,a[l],J),a[S]=null;m++}else U(a[b]),b--;else U(a[l]),l++;for(;m<=x;){const S=N(t,r[x+1]);E(S,n[m]),r[m++]=S}for(;l<=b;){const S=a[l++];S!==null&&U(S)}return this.ut=o,Zt(t,r),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Se=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,It=t=>{throw TypeError(t)},d=(t,e,s,i)=>{for(var a=i>1?void 0:i?Fe(e,s):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(i?o(e,s,a):o(a))||a);return i&&a&&Se(e,s,a),a},bt=(t,e,s)=>e.has(t)||It("Cannot "+s),g=(t,e,s)=>(bt(t,e,"read from private field"),s?s.call(t):e.get(t)),v=(t,e,s)=>e.has(t)?It("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,s),j=(t,e,s,i)=>(bt(t,e,"write to private field"),e.set(t,s),s),f=(t,e,s)=>(bt(t,e,"access private method"),s),L,c,Pt,Nt,K,zt,At,it,P,G,Tt,nt,rt,ot,lt,ht,dt,pt,ct,ut,X,gt,ft,mt,vt,Y,Lt,Gt;let h=class extends jt{constructor(){super(),v(this,c),this.min=new Date(new Date().getFullYear()-10,0,1),this.max=new Date(new Date().getFullYear()+10,0,1),this.open=!1,this.supportingText="",this.size="large",this.plain=!1,this.showWeekNumbers=!1,this.hideLabel=!1,this.disabledWeekends=!1,this.showExtendedSupportingText=!1,this._focusedMonth=new Date().getMonth(),this._focusedYear=new Date().getFullYear(),this._dateFormatLayout=f(this,c,mt).call(this,"y-m-d"),v(this,L),v(this,Tt,t=>{this._elTrigger.then(e=>{var i,a;((i=t.relatedTarget)==null?void 0:i.parentElement)!==t.target&&((a=document.getSelection())==null||a.removeAllRanges())})}),v(this,nt,t=>{this._elTrigger.then(e=>{var i,a;(i=document.getSelection())==null||i.removeAllRanges();const s=new Range;s.setStart(e.firstChild,0),s.setEnd(e.lastChild,4),(a=document.getSelection())==null||a.addRange(s)})}),v(this,rt,t=>{this._elFieldAsync.then(e=>{var s;t.currentTarget===e&&(t.preventDefault(),(s=t.clipboardData)==null||s.setData("text/plain",this.displayValue))})}),v(this,ot,t=>{this._elFieldAsync.then(e=>{var o;if(t.currentTarget!==e)return;t.preventDefault();const s=(o=t.clipboardData)==null?void 0:o.getData("text/plain");if(!s)return;let i=new Date("-");const a="Invalid Date",n=s.split(this._dateFormatLayout.delimiter);if(n.length===3){const p=this._dateFormatLayout.layout,r=parseInt(n[p.findIndex(l=>l.token==="y")]),C=parseInt(n[p.findIndex(l=>l.token==="m")])-1,M=parseInt(n[p.findIndex(l=>l.token==="d")]);!isNaN(r)&&!isNaN(C)&&!isNaN(M)&&(i=new Date(`${r}-${C+1}-${M}`))}i.toString()===a&&(i=new Date(s),i.toString()===a)||(this.value=i,f(this,c,P).call(this))})}),v(this,lt,t=>{var e;(e=this._elSpinners[0])==null||e.focus()}),v(this,ht,t=>{t.stopPropagation(),this.value=t.detail,this.open=!1,f(this,c,P).call(this),f(this,c,G).call(this)}),v(this,dt,t=>{var e;t.stopPropagation(),this._focusedMonth=(e=t.target)==null?void 0:e.value}),v(this,pt,t=>{var e;t.stopPropagation(),this._focusedYear=(e=t.target)==null?void 0:e.value}),v(this,ct,t=>{this._focusedMonth<11?this._focusedMonth++:this._focusedMonth==11&&this._focusedYear!=this.max.getFullYear()&&(this._focusedMonth=0,this._focusedYear++)}),v(this,ut,t=>{this._focusedMonth>0?this._focusedMonth--:this._focusedMonth==0&&this._focusedYear!=this.min.getFullYear()&&(this._focusedMonth=11,this._focusedYear--)}),v(this,X,async()=>{this._focusedMonth=(await this._elCalendar).focusedMonth,this._focusedYear=(await this._elCalendar).focusedYear,this.value=(await this._elCalendar).focusedDate,this.requestUpdate(),f(this,c,G).call(this)}),v(this,gt,async t=>{if(t.target===t.currentTarget){if(this.open=t.detail.open,t.detail.reason==="close"){const e=(await this._elCalendar).value;!de(e||new Date(0),g(this,L)||new Date(0))&&(this.value=e,f(this,c,P).call(this)),this.value&&(this._focusedMonth=this.value.getMonth(),this._focusedYear=this.value.getFullYear())}t.detail.reason==="cancel"&&(this.value=g(this,L),f(this,c,G).call(this))}}),v(this,ft,t=>{const e=Array.from(this._elSpinners).findIndex(s=>s===t.target);if(t.key==="ArrowRight"){const s=this._elSpinners[e+1];s&&s.focus()}if(t.key==="ArrowLeft"){const s=this._elSpinners[e-1];s&&s.focus()}}),v(this,vt,(t,e)=>{g(this,Y)[e]=t;const s=new Date;s.setFullYear(parseInt(g(this,Y).year)),s.setMonth(parseInt(g(this,Y).month)-1),s.setDate(parseInt(g(this,Y).day)),s.setHours(12,0,0,0),s.toString()!=="Invalid Date"&&(this.value=s,f(this,c,P).call(this),f(this,c,G).call(this))}),v(this,Y,{year:"yyyy",month:"mm",day:"dd"}),D.define()}get type(){return"gds-datepicker"}get value(){return this._internalValue}set value(t){this._internalValue=t}get dateformat(){return this._dateFormatLayout.layout.map(t=>t.token).join(this._dateFormatLayout.delimiter)}set dateformat(t){this._dateFormatLayout=f(this,c,mt).call(this,t)}async getFocusedDate(){if(this.open)return this._elCalendar.then(t=>t.focusedDate)}get displayValue(){return this._elField.innerText.replace(/\s+/g,"")}async test_getDateCell(t){return this._elCalendar.then(e=>e.getDateCell(t))}connectedCallback(){super.connectedCallback(),ie.instance.apply(this,"gds-datepicker")}render(){return k`
      ...
      >
        <div class="spinners">
          ${ye(_e(this._dateFormatLayout.layout,(t,e)=>k`<gds-date-part-spinner
                  id="spinner-${e}"
        ...
        <gds-button
          ...
          .disabled=${this.disabled}
        >
          ${z(this.size==="small",()=>k`<gds-icon-calender-add
                height="16"
                stroke="2"
      ...
      ${z(f(this,c,Pt).call(this),()=>k`<gds-form-control-footer class="size-${this.size}">
            ${""}
        ...
        <gds-div overflow="auto">
          ...
          >
            ...
            <gds-dropdown
              ...
              hide-label
            >
              ${$e(g(this,c,Lt),t=>t,t=>k`<gds-option value=${t}>${t}</gds-option>`)}
            </gds-dropdown>
            <gds-button
              @click=${g(this,ct)}
