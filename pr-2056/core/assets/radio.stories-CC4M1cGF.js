import{x as t}from"./lit-element-Bx14lxc-.js";import{G as _,a as F}from"./radio.component-J4S0UEJB.js";import"./flex-DUiJx2Io.js";import"./card-C9GWk8PO.js";import"./text-CqlRMvaX.js";import"./divider-C5ocN-lS.js";import"./circle-check-DRuvlmes.js";import"./cross-small-Cc2_mHhK.js";import{a as U}from"./argTableProps-Cex0TM_f.js";import"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import"./custom-element-scoping-b4c89-hi.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./query-p8xgzTDt.js";import"./class-map-CXsQwv0r.js";import"./directive-CF8sV3Lr.js";import"./form-control-header.component-BoHTZZCB.js";import"./when-BR7zwNJC.js";import"./badge.component-Bw2zMn80.js";import"./tokens.style-C9bLefPj.js";import"./declarative-layout-mixins-p82vEmD5.js";import"./flex.component-Ce9CKV12.js";import"./div.component-CQRQJUd6.js";import"./triangle-exclamation.component-D4O2mkPJ.js";import"./icon-TXeUf8MR.js";import"./button.component-BAB_L2n5.js";import"./if-defined-CVqwUuaf.js";import"./static-B8S6DEnV.js";import"./transitional-styles-BOwn52Fb.js";import"./observe-light-dom-CmJPHUQ4.js";import"./watch-tFciLXSI.js";import"./card.component-DypAPF8x.js";import"./text.component-BX6-mZRL.js";import"./divider.component-CNIvVuww.js";import"./circle-check.component-p8RU473K.js";import"./cross-small.component-DGKi69Og.js";import"./custom-elements-Mp_c0Q3o.js";_.define();F.define();const Pe={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],argTypes:{...U("gds-radio-group")},parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},e={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},a={...e,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
  ...
  `},i={...e,name:"Do's and dont's",render:()=>t`
    <gds-flex gap="xl">
  ...
  `},n={...e,name:"Radio group label",render:()=>t`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...(h=(v=o.parameters)==null?void 0:v.docs)==null?void 0:h.description}}};var L,R,E;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(E=(R=i.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};var w,S,y,G,D;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(y=(S=r.parameters)==null?void 0:S.docs)==null?void 0:y.source},description:{story:`Disabled radio buttons cannot be interacted with and appear visually muted.

In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(D=(G=r.parameters)==null?void 0:G.docs)==null?void 0:D.description}}};var z,P,T,k,q;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(T=(P=d.parameters)==null?void 0:P.docs)==null?void 0:T.source},description:{story:`Radio buttons support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the radio group and applies to all radio buttons within.`,...(q=(k=d.parameters)==null?void 0:k.docs)==null?void 0:q.description}}};var O,I,C,V,A;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(C=(I=s.parameters)==null?void 0:I.docs)==null?void 0:C.source},description:{story:`Radio buttons can be arranged in two directions:
...
Choose the direction based on available space and number of options.`,...(A=(V=s.parameters)==null?void 0:V.docs)==null?void 0:A.description}}};var N,$,H,B,M;n.parameters={...n.parameters,docs:{...(N=n.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(H=($=n.parameters)==null?void 0:$.docs)==null?void 0:H.source},description:{story:`While radio groups can be created without a label, it's recommended to always provide one for clarity and accessibility.
The label helps users understand what the options are for.

In certain cases when space is limited, the group label can be omitted.`,...(M=(B=n.parameters)==null?void 0:B.docs)==null?void 0:M.description}}};const Te=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{s as Direction,r as Disabled,i as DosAndDonts,n as GroupLabel,a as RadioButton,d as Size,o as Validation,Te as __namedExportsOrder,Pe as default};
