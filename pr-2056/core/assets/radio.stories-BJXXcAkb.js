import{i as ue,x as m}from"./lit-element-C_s9q329.js";import{n as l,r as Le,g as ce,G as Ee,h}from"./custom-element-scoping-BEGY3AqQ.js";import{t as Re}from"./tokens.style-CFvqdzpw.js";import{w as k}from"./watch-tFciLXSI.js";import"./selection-field-label-VkzbDOYN.js";import{l as Se}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{a as ze}from"./query-p8xgzTDt.js";import{e as ke}from"./class-map-Bz98xO8-.js";import{d as Ce,b as De,w as Ae}from"./declarative-layout-mixins-Cg5fmtre.js";import{a as Ge}from"./button-DMqiAWPO.js";import"./form-control-footer-31u3ZPFB.js";import"./flex-tnFv_7np.js";import"./card-BihnooJR.js";import"./text-DQ_oI5A1.js";import"./divider-Dm4d-5N4.js";import"./circle-check-DzwSpRnk.js";import"./cross-small-CIJy4RQ0.js";import{a as $e}from"./argTableProps-Cn5_EusD.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./transitional-styles-iv5lM2WH.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./observe-light-dom-CmJPHUQ4.js";import"./triangle-exclamation-BVOOPWQa.js";import"./icon-DYBgint3.js";import"./badge-Dc9DlXiN.js";import"./div-Cnle9s5w.js";import"./custom-elements-CqwNVvZ1.js";const Te=ue`
...
`;var Pe=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,xe=e=>{throw TypeError(e)},p=(e,t,a,o)=>{for(var r=o>1?void 0:o?Oe(t,a):t,u=e.length-1,c;u>=0;u--)(c=e[u])&&(r=(o?c(t,a,r):c(r))||r);return o&&r&&Pe(t,a,r),r},Fe=(e,t,a)=>t.has(e)||xe("Cannot "+a),D=(e,t,a)=>(Fe(e,t,"read from private field"),a?a.call(e):t.get(e)),A=(e,t,a)=>t.has(e)?xe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),E,R;let d=class extends Ee{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,A(this,E,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchEvent(new Event("gds-radio-change",{bubbles:!0})))}),A(this,R,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchEvent(new Event("gds-radio-change",{bubbles:!0})))}),this.addEventListener("keydown",D(this,R)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",D(this,E))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}render(){return h`
    ...
    `}};E=new WeakMap;R=new WeakMap;d.styles=[Re,Te];p([l()],d.prototype,"label",2);p([l({attribute:"supporting-text"})],d.prototype,"supportingText",2);p([l()],d.prototype,"value",2);p([l({type:Boolean,reflect:!0})],d.prototype,"checked",2);p([l({type:Boolean,reflect:!0})],d.prototype,"disabled",2);p([l({type:Boolean})],d.prototype,"invalid",2);p([Le()],d.prototype,"_isFocused",2);p([k("disabled")],d.prototype,"_handleDisabledChange",1);d=p([ce("gds-radio")],d);const Ie=ue`
  :host {
...
`;var qe=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,me=e=>{throw TypeError(e)},g=(e,t,a,o)=>{for(var r=o>1?void 0:o?Ve(t,a):t,u=e.length-1,c;u>=0;u--)(c=e[u])&&(r=(o?c(t,a,r):c(r))||r);return o&&r&&qe(t,a,r),r},Me=(e,t,a)=>t.has(e)||me("Cannot "+a),Be=(e,t,a)=>t.has(e)?me("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),i=(e,t,a)=>(Me(e,t,"access private method"),a),s,S,he,C,be,ve,z,fe,ye,we,_e;let n=class extends Ge{constructor(){super(...arguments),Be(this,s),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),i(this,s,S).call(this)}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{i(this,s,S).call(this)}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return h`<div
    ...
    </div>`}};s=new WeakSet;S=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))};he=function(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(a=>a.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(a=>a.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))};C=function(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))};be=function(e){const t=e.target;t.hasAttribute("value")&&(this.value=t.value,this._syncRadioStates(),i(this,s,C).call(this))};ve=function(e){if(!this._isConnected)return;const t=this.radios.filter(o=>!o.hasAttribute("disabled"));if(t.length===0)return;let a=t.findIndex(o=>document.activeElement===o);switch(a===-1&&(a=t.findIndex(o=>o.checked),a===-1&&(a=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const o=(a+1)%t.length;i(this,s,z).call(this,t[o]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const o=(a-1+t.length)%t.length;i(this,s,z).call(this,t[o]);break}default:return}};z=function(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),i(this,s,C).call(this))};fe=function(){return[i(this,s,ye).call(this),i(this,s,we).call(this),i(this,s,_e).call(this)].map(t=>h`${t}`)};ye=function(){if(this.label)return h` <gds-form-control-header class="size-${this.size}">
    ...
    >
    </gds-form-control-footer>`};n.styles=[Ie];g([l()],n.prototype,"size",2);g([l()],n.prototype,"direction",2);g([l({attribute:"supporting-text"})],n.prototype,"supportingText",2);g([l({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],n.prototype,"showExtendedSupportingText",2);g([ze(".content")],n.prototype,"_contentElement",2);g([k("value")],n.prototype,"_handleValueChange",1);g([k("invalid")],n.prototype,"_syncRadioStates",1);n=g([Se()],n);let G=class extends Ce(De(Ae(n))){};G=g([ce("gds-radio-group")],G);const yt={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],argTypes:{...$e("gds-radio-group")},parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
In certain cases when space is limited, the group label can be omitted.`,...(ge=(pe=_.parameters)==null?void 0:pe.docs)==null?void 0:ge.description}}};const wt=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{w as Direction,f as Disabled,L as DosAndDonts,_ as GroupLabel,b as RadioButton,y as Size,v as Validation,wt as __namedExportsOrder,yt as default};
