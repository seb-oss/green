import{m as u}from"./runtime-BL31MtW8.js";import{l as Vt}from"./localized-decorator-DtmrKsyB.js";import{T as Q,i as Ot,E as Dt}from"./lit-element-Bx14lxc-.js";import{n as $,r as H,G as Rt,h as C,g as St}from"./custom-element-scoping-b4c89-hi.js";import{e as Bt,a as qt}from"./query-p8xgzTDt.js";import{r as Z}from"./query-async-MEroNOeJ.js";import{e as Ft,i as Kt,t as Xt}from"./directive-CF8sV3Lr.js";import{p as Ht,v as I,r as N,M as U,m as Zt,i as Jt}from"./directive-helpers-BF33kFuJ.js";import{f as Ut}from"./ref-R0wBYijq.js";import{n as z}from"./when-BR7zwNJC.js";import{a as jt,G as Qt}from"./button.component-CJG_iMlt.js";import{G as te}from"./dropdown.component-BDcFs8F5.js";import{G as ee}from"./flex.component-BfiuBC5x.js";import{f as se}from"./form-control-host.style-B9O882Nq.js";import{t as ae}from"./tokens.style-C9bLefPj.js";import{T as ie}from"./transitional-styles-BOwn52Fb.js";import{w as _t}from"./watch-tFciLXSI.js";import{d as yt,a as ne}from"./attribute-converters-CdI0trPX.js";import{w as re,b as oe,d as le}from"./declarative-layout-mixins-C09DP4OO.js";import{G as he,i as de}from"./calendar.component-d7E8WzBr.js";import{I as ce,a as pe}from"./calender-add.component-CKqMopEb.js";import{a as ue,I as ge}from"./chevron-right.component-CjDInRvL.js";import{G as fe}from"./popover.component-C4nh7ZG2.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=(t,e,s)=>{const i=new Map;for(let a=e;a<=s;a++)i.set(t[a],a);return i},$e=Ft(class extends Kt{constructor(t){if(super(t),t.type!==Xt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,s){let i;s===void 0?s=e:e!==void 0&&(i=e);const a=[],n=[];let o=0;for(const c of t)a[o]=i?i(c,o):o,n[o]=s(c,o),o++;return{values:n,keys:a}}render(t,e,s){return this.dt(t,e,s).values}update(t,[e,s,i]){const a=Ht(t),{values:n,keys:o}=this.dt(e,s,i);if(!Array.isArray(a))return this.ut=o,n;const c=this.ut??(this.ut=[]),r=[];let k,M,l=0,b=a.length-1,m=0,x=n.length-1;for(;l<=b&&m<=x;)if(a[l]===null)l++;else if(a[b]===null)b--;else if(c[l]===o[m])r[m]=I(a[l],n[m]),l++,m++;else if(c[b]===o[x])r[x]=I(a[b],n[x]),b--,x--;else if(c[l]===o[x])r[x]=I(a[l],n[x]),N(t,r[x+1],a[l]),l++,x--;else if(c[b]===o[m])r[m]=I(a[b],n[m]),N(t,a[l],a[b]),b--,m++;else if(k===void 0&&(k=xt(o,m,x),M=xt(c,l,b)),k.has(c[l]))if(k.has(c[b])){const S=M.get(o[m]),J=S!==void 0?a[S]:null;if(J===null){const wt=N(t,a[l]);I(wt,n[m]),r[m]=wt}else r[m]=I(J,n[m]),N(t,a[l],J),a[S]=null;m++}else U(a[b]),b--;else U(a[l]),l++;for(;m<=x;){const S=N(t,r[x+1]);I(S,n[m]),r[m++]=S}for(;l<=b;){const S=a[l++];S!==null&&U(S)}return this.ut=o,Zt(t,r),Q}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
