import{i as I,x as N}from"./lit-element-71e04f06.js";import{n as g,r as q,g as J,G as K,h as y}from"./gds-element-54cd6e2a.js";import{a as Q,c as X,o as Y,d as Z,s as j,f as tt,h as et,b as it}from"./floating-ui.dom-373c8bf6.js";import{n as W,e as R}from"./ref-ff2f01fc.js";import{n as ot}from"./when-cf7256a5.js";import"./_commonjsHelpers-725317a4.js";import"./directive-helpers-9aabd8ef.js";import"./directive-12249aa5.js";const at=I`
  #body {
    visibility: hidden;
    position: absolute;
    z-index: 1060;
...
`;var rt=Object.defineProperty,st=Object.getOwnPropertyDescriptor,l=(i,t,e,o)=>{for(var s=o>1?void 0:o?st(t,e):t,c=i.length-1,p;c>=0;c--)(p=i[c])&&(s=(o?p(t,e,s):p(s))||s);return o&&s&&rt(t,e,s),s},E=(i,t,e)=>{if(!t.has(i))throw TypeError("Cannot "+e)},d=(i,t,e)=>(E(i,t,"read from private field"),e?e.call(i):t.get(i)),r=(i,t,e)=>{if(t.has(i))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(i):t.set(i,e)},nt=(i,t,e,o)=>(E(i,t,"write to private field"),o?o.call(i,e):t.set(i,e),e),a=(i,t,e)=>(E(i,t,"access private method"),e),f,b,v,h,u,k,z,C,A,x,G,O,H,V,U,B,F,w,_;let n=class extends K{constructor(){super(...arguments),r(this,h),r(this,k),r(this,C),r(this,x),r(this,O),r(this,V),r(this,B),r(this,w),this.placement="bottom",this.overlappedBy=[],this.target=[],this.label="Coachmark",this.computeVisibility=(i,t,e)=>e,this.targetElement=void 0,this._isVisible=!1,this._preventClose=!1,r(this,f,R()),r(this,b,R()),r(this,v,void 0)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",()=>{setTimeout(()=>{a(this,w,_).call(this),a(this,h,u).call(this)},400)}),document.addEventListener("keydown",i=>{i.key==="Escape"&&this._isVisible&&a(this,h,u).call(this)})}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",a(this,h,u)),document.removeEventListener("keydown",i=>{i.key==="Escape"&&this._isVisible&&a(this,h,u).call(this)})}firstUpdated(){this.target.length>0&&(this.targetElement=a(this,k,z).call(this,this.target),a(this,w,_).call(this))}setPreventClose(i){this._preventClose=i}render(){return y`${ot(this.target.length>0,()=>y`
        <div
          role="dialog"
          id="body"
...
@status beta`}}},tags:["autodocs"]},lt={parameters:{docs:{source:{format:!0,type:"dynamic"}}}},m={...lt,render:()=>N`
  ...
  `};var $,P,M,D,L;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  render: () => html\`
    <div style="height: 200px">
      <p>
  ...
  \`
}`,...(M=(P=m.parameters)==null?void 0:P.docs)==null?void 0:M.source},description:{story:"Because this is the default story that also renders at the top of the page, the\ncoachmark will be shown in the first panel only, since the `#targetElement` selector\nwill match the first element in the DOM.",...(L=(D=m.parameters)==null?void 0:D.docs)==null?void 0:L.description}}};const bt=["Basic"];export{m as Basic,bt as __namedExportsOrder,wt as default};
