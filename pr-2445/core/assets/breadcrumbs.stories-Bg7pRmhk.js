...
\`\`\``}}}},m={render:()=>e`
  ...
  `},t={name:"Accessible Label",render:I=>e`
  ...
  \`
}`,...(i=(g=m.parameters)==null?void 0:g.docs)==null?void 0:i.source}}};var a,c,b,l,u;s.parameters={...s.parameters,docs:{...(a=s.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => html\`
    <gds-breadcrumbs>
      <gds-breadcrumbs-item href="/">
        <gds-icon-home-open slot="lead"></gds-icon-home-open>
  ...
  \`
}`,...(b=(c=s.parameters)==null?void 0:c.docs)==null?void 0:b.source},description:{story:`This example shows how to use icons alongside text in the breadcrumbs links.
...
For more information on lead and trail icon, please refer to the [Link documentation](https://storybook.seb.io/latest/core/?path=/docs/components-link--docs).`,...(u=(l=s.parameters)==null?void 0:l.docs)==null?void 0:u.description}}};var p,f,h,x,k;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => html\`
    <gds-flex flex-direction="column" gap="4xl">
      <gds-flex flex-direction="column" gap="m">
        <gds-flex align-items="center" gap="m">
  ...
  \`
}`,...(C=(S=d.parameters)==null?void 0:S.docs)==null?void 0:C.source},description:{story:`Mobile optimization is built into the breadcrumbs component. <br/>
On mobile devices, the breadcrumbs will show the previous page instead of the full path. <br/>
This is done to save space and make navigation easier on smaller screens.`,...(v=(y=d.parameters)==null?void 0:y.docs)==null?void 0:v.description}}};var H,D,z,A,P;n.parameters={...n.parameters,docs:{...(H=n.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => html\`
    <gds-flex flex-direction="column" gap="4xl">
      <gds-breadcrumbs>
        <gds-breadcrumbs-item href="/home">
...
\`\`\``,...(P=(A=n.parameters)==null?void 0:A.docs)==null?void 0:P.description}}};var T,L,M,O,E;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...
  \`
}`,...(M=(L=t.parameters)==null?void 0:L.docs)==null?void 0:M.source},description:{story:`The breadcrumbs component supports customizing the accessibility label. <br/>
...
\`\`\``,...(E=(O=t.parameters)==null?void 0:O.docs)==null?void 0:E.description}}};const He=["Simple","WithIcon","Size","Mobile","Overflow","Label"];export{t as Label,d as Mobile,n as Overflow,m as Simple,r as Size,s as WithIcon,He as __namedExportsOrder,ve as default};
