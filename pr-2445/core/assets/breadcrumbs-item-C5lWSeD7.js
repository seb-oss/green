...
`;var W=Object.defineProperty,q=Object.getOwnPropertyDescriptor,u=(t,e,r,a)=>{for(var s=a>1?void 0:a?q(e,r):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(s=(a?d(e,r,s):d(s))||s);return a&&s&&W(e,r,s),s};let f=class extends B(D(M(v))){constructor(){super(...arguments),this.size="large",this.label=I("Breadcrumbs")}get breadcrumbItems(){return Array.from(this.querySelectorAll("[gds-element=gds-breadcrumbs-item]"))}handleSlotChange(){const t=this.breadcrumbItems;t.forEach((e,r)=>{r===t.length-2?e.setAttribute("return",""):e.removeAttribute("return")})}render(){return h`
      <nav
        role="navigation"
...
`;var F=Object.defineProperty,H=Object.getOwnPropertyDescriptor,w=t=>{throw TypeError(t)},p=(t,e,r,a)=>{for(var s=a>1?void 0:a?H(e,r):e,l=t.length-1,d;l>=0;l--)(d=t[l])&&(s=(a?d(e,r,s):d(s))||s);return a&&s&&F(e,r,s),s},x=(t,e,r)=>e.has(t)||w("Cannot "+r),J=(t,e,r)=>(x(t,e,"read from private field"),r?r.call(t):e.get(t)),K=(t,e,r)=>e.has(t)?w("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),c=(t,e,r)=>(x(t,e,"access private method"),r),i,$,C,z,O,P,G,S;let n=class extends v{constructor(){super(...arguments),K(this,i),this.href="",this.label="",this.overflow=!1}render(){return h`
      <div
        role="listitem"
    ...
    `}};i=new WeakSet;$=function(){return this.target==="_blank"?"noreferrer noopener":void 0};C=function(){return[c(this,i,z).call(this),c(this,i,O).call(this)].map(e=>h`${e}`)};z=function(){return this.overflow?c(this,i,P).call(this):this.href?c(this,i,G).call(this):c(this,i,S).call(this)};O=function(){return!this.href&&!this.overflow?b:h`<span class="separator" aria-hidden="true">/</span>`};P=function(){return h`<slot></slot>`};G=function(){return h`
      <gds-link
        href=${m(this.href)}
