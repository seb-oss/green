...
`)),breadcrumbs_item_component_=function _(t){return t};function breadcrumbs_item_component_isNativeReflectConstruct(){try{var t=!Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],(function(){})))}catch(t){}return(breadcrumbs_item_component_isNativeReflectConstruct=function _isNativeReflectConstruct(){return!!t})()}var breadcrumbs_item_component_GdsBreadcrumbsItem=function(_GdsElement){function GdsBreadcrumbsItem(){var _this;return(0,classCallCheck.A)(this,GdsBreadcrumbsItem),_this=function breadcrumbs_item_component_callSuper(t,o,e){return o=(0,getPrototypeOf.A)(o),(0,possibleConstructorReturn.A)(t,breadcrumbs_item_component_isNativeReflectConstruct()?Reflect.construct(o,e||[],(0,getPrototypeOf.A)(t).constructor):o.apply(t,e))}(this,GdsBreadcrumbsItem,arguments),(0,chunk_QU3DSPNU.VK)(_this,_GdsBreadcrumbsItem_instances),_this.href="",_this.label="",_this.overflow=!1,_this}return(0,inherits.A)(GdsBreadcrumbsItem,_GdsElement),(0,createClass.A)(GdsBreadcrumbsItem,[{key:"render",value:function render(){return(0,custom_element_scoping.qy)(breadcrumbs_item_component_t||(breadcrumbs_item_component_t=breadcrumbs_item_component_`
      <li aria-current=${0}>
        ${0}
      </li>
    `),(0,if_defined.J)(this.href?void 0:"page"),(0,chunk_QU3DSPNU.jq)(this,_GdsBreadcrumbsItem_instances,renderContents_fn).call(this))}}])}(gds_element.j);_GdsBreadcrumbsItem_instances=new WeakSet,breadcrumbs_item_component_defaultRel_get=function defaultRel_get(){return"_blank"===this.target?"noreferrer noopener":void 0},renderContents_fn=function renderContents_fn(){return[(0,chunk_QU3DSPNU.jq)(this,_GdsBreadcrumbsItem_instances,renderMainContent_fn).call(this),(0,chunk_QU3DSPNU.jq)(this,_GdsBreadcrumbsItem_instances,renderSeparator_fn).call(this)].map((function(element){return(0,custom_element_scoping.qy)(breadcrumbs_item_component_t2||(breadcrumbs_item_component_t2=breadcrumbs_item_component_`${0}`),element)}))},renderMainContent_fn=function renderMainContent_fn(){return this.overflow?(0,chunk_QU3DSPNU.jq)(this,_GdsBreadcrumbsItem_instances,renderOverflowMenu_fn).call(this):this.href?(0,chunk_QU3DSPNU.jq)(this,_GdsBreadcrumbsItem_instances,renderItem_fn).call(this):(0,chunk_QU3DSPNU.jq)(this,_GdsBreadcrumbsItem_instances,renderCurrent_fn).call(this)},renderSeparator_fn=function renderSeparator_fn(){return this.href||this.overflow?(0,custom_element_scoping.qy)(breadcrumbs_item_component_t3||(breadcrumbs_item_component_t3=breadcrumbs_item_component_`<span class="separator" aria-hidden="true">/</span>`)):lit.s6},renderOverflowMenu_fn=function renderOverflowMenu_fn(){return(0,custom_element_scoping.qy)(breadcrumbs_item_component_t4||(breadcrumbs_item_component_t4=breadcrumbs_item_component_`<slot></slot>`))},renderItem_fn=function renderItem_fn(){return(0,custom_element_scoping.qy)(breadcrumbs_item_component_t5||(breadcrumbs_item_component_t5=breadcrumbs_item_component_`
      <gds-link
        href=${0}
        target=${0}
        rel=${0}
    ...
    `),(0,if_defined.J)(this.href),(0,if_defined.J)(this.target),(0,if_defined.J)(this.rel||(0,chunk_QU3DSPNU.S7)(this,_GdsBreadcrumbsItem_instances,breadcrumbs_item_component_defaultRel_get)),(0,if_defined.J)(this.download),this.label||lit.s6)},renderCurrent_fn=function renderCurrent_fn(){return(0,custom_element_scoping.qy)(breadcrumbs_item_component_t6||(breadcrumbs_item_component_t6=breadcrumbs_item_component_`
      <gds-text color="neutral-02" font-weight="regular">
        <slot></slot>
      </gds-text>
    `))},breadcrumbs_item_component_GdsBreadcrumbsItem.styles=[breadcrumbs_item_styles_default],(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],breadcrumbs_item_component_GdsBreadcrumbsItem.prototype,"href",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],breadcrumbs_item_component_GdsBreadcrumbsItem.prototype,"target",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],breadcrumbs_item_component_GdsBreadcrumbsItem.prototype,"rel",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],breadcrumbs_item_component_GdsBreadcrumbsItem.prototype,"label",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)()],breadcrumbs_item_component_GdsBreadcrumbsItem.prototype,"download",2),(0,chunk_QU3DSPNU.Cc)([(0,decorators.MZ)({type:Boolean,reflect:!0})],breadcrumbs_item_component_GdsBreadcrumbsItem.prototype,"overflow",2),breadcrumbs_item_component_GdsBreadcrumbsItem=(0,chunk_QU3DSPNU.Cc)([(0,custom_element_scoping.Y$)("gds-breadcrumbs-item",{dependsOn:[link_component_GdsLink,text_component_GdsText,chevron_right_component.V]}),(0,lit_localize.cc)()],breadcrumbs_item_component_GdsBreadcrumbsItem);var GdsBreadcrumbsItem=function GdsBreadcrumbsItem(props){breadcrumbs_item_component_GdsBreadcrumbsItem.define();var JSXElement=(0,react.p)("gds-breadcrumbs-item"),propsWithClass=Object.assign({},props,{class:props.className});return(0,node_modules_react.createElement)(JSXElement,propsWithClass)};GdsBreadcrumbsItem.__docgenInfo={description:"",methods:[],displayName:"GdsBreadcrumbsItem"};var checkbox_group_styles_t,checkbox_group_component_t,checkbox_group_component_t2,checkbox_group_component_t3,checkbox_group_component_t4,checkbox_group_component_t5,_syncCheckboxes,_CheckboxGroup_instances,renderCheckboxGroupContents_fn,renderFieldControlHeader_fn,renderCheckboxes_fn,handleCheckboxChange_fn,computeValue_fn,dispatchInputEvent_fn,renderFieldControlFooter_fn,checkbox_group_styles_styles=(0,lit.AH)(checkbox_group_styles_t||(checkbox_group_styles_t=(function _(t){return t})`
  :host {
    /* Font Sizes */
...
//# sourceMappingURL=7084.cf765fe9.iframe.bundle.js.map