import{i as S,x as D}from"./lit-element-C_s9q329.js";import{n as a,g as v,G as O,h as x,r as k}from"./custom-element-scoping-BEGY3AqQ.js";import{e as z}from"./class-map-Bz98xO8-.js";import{t as L}from"./tokens.style-CFvqdzpw.js";import{l as P}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{T as A}from"./transitional-styles-iv5lM2WH.js";import{w as G}from"./watch-tFciLXSI.js";import{a as j}from"./button-DMqiAWPO.js";import"./form-control-footer-31u3ZPFB.js";import"./flex-tnFv_7np.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./query-p8xgzTDt.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-Cg5fmtre.js";import"./triangle-exclamation-BVOOPWQa.js";import"./icon-DYBgint3.js";import"./card-BihnooJR.js";import"./div-Cnle9s5w.js";import"./badge-Dc9DlXiN.js";const C=S`
...
`;var F=Object.defineProperty,M=Object.getOwnPropertyDescriptor,c=(e,o,r,s)=>{for(var t=s>1?void 0:s?M(o,r):o,i=e.length-1,l;i>=0;i--)(l=e[i])&&(t=(s?l(o,r,t):l(t))||t);return s&&t&&F(o,r,t),t};let d=class extends O{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),A.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small"};return x`
    ...
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};d.styles=[L,B];c([a()],d.prototype,"label",2);c([a({attribute:"supporting-text"})],d.prototype,"supportingText",2);c([a()],d.prototype,"type",2);c([a()],d.prototype,"size",2);c([a({type:Boolean,reflect:!0})],d.prototype,"disabled",2);c([a({type:Boolean})],d.prototype,"invalid",2);c([G("disabled")],d.prototype,"_handleDisabledChange",1);d=c([v("gds-selection-field-label"),P()],d);var q=Object.defineProperty,H=Object.getOwnPropertyDescriptor,u=(e,o,r,s)=>{for(var t=s>1?void 0:s?H(o,r):o,i=e.length-1,l;i>=0;i--)(l=e[i])&&(t=(s?l(o,r,t):l(t))||t);return s&&t&&q(o,r,t),t};let n=class extends O{constructor(){super(...arguments),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this._isFocused=!1}_handleClick(){this.disabled||(this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0})))}_handleKeyDown(e){this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._handleClick())}render(){const e={radio:!0,checked:this.checked,disabled:this.disabled,focused:this._isFocused};return x`
    ...
    `}};p.styles=[C];g([a()],p.prototype,"label",2);g([a()],p.prototype,"name",2);g([a()],p.prototype,"size",2);g([a({attribute:"supporting-text"})],p.prototype,"supportingText",2);g([a({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],p.prototype,"showExtendedSupportingText",2);g([k()],p.prototype,"_validityAnchor",2);p=g([v("gds-radio-group")],p);const he={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"]},T={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},b={...T,name:"radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},h={...T,name:"States",render:()=>D`
...
}`,...(y=(f=b.parameters)==null?void 0:f.docs)==null?void 0:y.source},description:{story:"TODO: Add documentation",...(w=(_=b.parameters)==null?void 0:_.docs)==null?void 0:w.description}}};var $,E,R;h.parameters={...h.parameters,docs:{...($=h.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'States',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(R=(E=h.parameters)==null?void 0:E.docs)==null?void 0:R.source}}};const xe=["RadioButton","States"];export{b as RadioButton,h as States,xe as __namedExportsOrder,he as default};
