...
`;var be=Object.defineProperty,he=Object.getOwnPropertyDescriptor,g=(e,t,o,a)=>{for(var r=a>1?void 0:a?he(t,o):t,s=e.length-1,d;s>=0;s--)(d=e[s])&&(r=(a?d(t,o,r):d(r))||r);return a&&r&&be(t,o,r),r};let n=class extends Z{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),ue.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small","has-supporting-text":!!this.supportingText};return u`
    ...
    >
    </gds-form-control-footer>`};l.styles=[oe];c([i()],l.prototype,"label",2);c([i()],l.prototype,"name",2);c([i()],l.prototype,"size",2);c([i({attribute:"supporting-text"})],l.prototype,"supportingText",2);c([i({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);c([ge(".content")],l.prototype,"_contentElement",2);c([re("value")],l.prototype,"_handleValueChange",1);l=c([S("gds-radio-group")],l);const We={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"]},b={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},m={...b,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},y={...b,name:"States",render:()=>v`
  ...
  `},w={...b,name:"No Label on group",render:()=>v`
    <div class="radio-group">
      <gds-radio-group>
        <span slot="extended-supporting-text">
          Extended supporting text for the group
