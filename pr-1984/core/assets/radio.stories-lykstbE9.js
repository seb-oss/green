...
`;var he=Object.defineProperty,be=Object.getOwnPropertyDescriptor,c=(e,t,r,o)=>{for(var a=o>1?void 0:o?be(t,r):t,i=e.length-1,d;i>=0;i--)(d=e[i])&&(a=(o?d(t,r,a):d(a))||a);return o&&a&&he(t,r,a),a};let l=class extends ee{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),ue.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small","has-supporting-text":!!this.supportingText};return g`
    ...
    >
    </gds-form-control-footer>`};n.styles=[re];u([s()],n.prototype,"label",2);u([s()],n.prototype,"name",2);u([s()],n.prototype,"size",2);u([s({attribute:"supporting-text"})],n.prototype,"supportingText",2);u([s({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],n.prototype,"showExtendedSupportingText",2);u([ge(".content")],n.prototype,"_contentElement",2);u([z("value")],n.prototype,"_handleValueChange",1);u([z("size")],n.prototype,"_handleSizeChange",1);n=u([S("gds-radio-group")],n);const Qe={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"]},h={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},m={...h,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
  ...
  `};var $,k,C,D,T;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Radio',
  args: {
    label: 'Label',
...
}`,...(C=(k=m.parameters)==null?void 0:k.docs)==null?void 0:C.source},description:{story:"TODO: Add documentation",...(T=(D=m.parameters)==null?void 0:D.docs)==null?void 0:T.description}}};var G,O,P;y.parameters={...y.parameters,docs:{...(G=y.parameters)==null?void 0:G.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'States',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(P=(O=y.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var A,F,V,B,j;f.parameters={...f.parameters,docs:{...(A=f.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Validation',
  render: () => html\`
    <div class="radio-group">
