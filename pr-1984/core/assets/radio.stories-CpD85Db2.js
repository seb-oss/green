import{i as z,x as h}from"./lit-element-C_s9q329.js";import{n as r,g as C,G as ce,h as u,r as Le}from"./custom-element-scoping-BEGY3AqQ.js";import{t as xe}from"./tokens.style-CFvqdzpw.js";import{w as k}from"./watch-tFciLXSI.js";import{l as he}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{e as be}from"./class-map-Bz98xO8-.js";import{T as Ee}from"./transitional-styles-iv5lM2WH.js";import{a as Re}from"./query-p8xgzTDt.js";import{a as Se}from"./button-DMqiAWPO.js";import"./form-control-footer-31u3ZPFB.js";import"./flex-tnFv_7np.js";import"./card-BihnooJR.js";import"./text-DQ_oI5A1.js";import"./divider-Dm4d-5N4.js";import"./circle-check-DzwSpRnk.js";import"./cross-small-CIJy4RQ0.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-Cg5fmtre.js";import"./triangle-exclamation-BVOOPWQa.js";import"./icon-DYBgint3.js";import"./badge-Dc9DlXiN.js";import"./div-Cnle9s5w.js";const ze=z`
...
`;var ke=Object.defineProperty,De=Object.getOwnPropertyDescriptor,D=(e,t,a,o)=>{for(var s=o>1?void 0:o?De(t,a):t,i=e.length-1,d;i>=0;i--)(d=e[i])&&(s=(o?d(t,a,s):d(s))||s);return o&&s&&ke(t,a,s),s};let w=class extends ce{constructor(){super(),this.label="",this.supportingText=""}connectedCallback(){super.connectedCallback(),Ee.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,"has-supporting-text":!!this.supportingText};return u`
    ...
    `}};w.styles=[xe,Ce];D([r()],w.prototype,"label",2);D([r({attribute:"supporting-text"})],w.prototype,"supportingText",2);w=D([C("gds-selection-field-label"),he()],w);var Ae=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,me=e=>{throw TypeError(e)},p=(e,t,a,o)=>{for(var s=o>1?void 0:o?Ge(t,a):t,i=e.length-1,d;i>=0;i--)(d=e[i])&&(s=(o?d(t,a,s):d(s))||s);return o&&s&&Ae(t,a,s),s},$e=(e,t,a)=>t.has(e)||me("Cannot "+a),A=(e,t,a)=>($e(e,t,"read from private field"),a?a.call(e):t.get(e)),G=(e,t,a)=>t.has(e)?me("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),R,S;let n=class extends ce{constructor(){super(),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.invalid=!1,this._isFocused=!1,G(this,R,e=>{this.disabled||!this.value||!this.label||(e.preventDefault(),this.checked=!0,this.focus(),this.dispatchEvent(new Event("change",{bubbles:!0})))}),G(this,S,e=>{this.disabled||(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0})))}),this.addEventListener("keydown",A(this,S)),this.addEventListener("focus",()=>this._isFocused=!0),this.addEventListener("blur",()=>this._isFocused=!1)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio"),this._updateAriaState(),this.addEventListener("click",A(this,R))}_updateAriaState(){this.setAttribute("aria-checked",this.checked.toString()),this.setAttribute("aria-disabled",this.disabled.toString()),this.setAttribute("tabindex",this.disabled?"-1":"0"),this.toggleAttribute("aria-invalid",this.invalid)}updated(e){super.updated(e),(e.has("checked")||e.has("disabled")||e.has("invalid"))&&this._updateAriaState()}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}render(){return u`
    ...
    `}};R=new WeakMap;S=new WeakMap;n.styles=[xe,ze];p([r()],n.prototype,"label",2);p([r({attribute:"supporting-text"})],n.prototype,"supportingText",2);p([r()],n.prototype,"value",2);p([r({type:Boolean,reflect:!0})],n.prototype,"checked",2);p([r({type:Boolean,reflect:!0})],n.prototype,"disabled",2);p([r({type:Boolean})],n.prototype,"invalid",2);p([Le()],n.prototype,"_isFocused",2);p([k("disabled")],n.prototype,"_handleDisabledChange",1);n=p([C("gds-radio")],n);const Te=z`
  :host {
...
`;var Oe=Object.defineProperty,Pe=Object.getOwnPropertyDescriptor,ve=e=>{throw TypeError(e)},g=(e,t,a,o)=>{for(var s=o>1?void 0:o?Pe(t,a):t,i=e.length-1,d;i>=0;i--)(d=e[i])&&(s=(o?d(t,a,s):d(s))||s);return o&&s&&Oe(t,a,s),s},Fe=(e,t,a)=>t.has(e)||ve("Cannot "+a),Ie=(e,t,a)=>t.has(e)?ve("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),E=(e,t,a)=>(Fe(e,t,"access private method"),a),x,fe,ye,_e,we;let l=class extends Se{constructor(){super(...arguments),Ie(this,x),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1,this._isConnected=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radiogroup"),this._isConnected=!0,this.updateComplete.then(()=>{this._syncRadioStates(),this._initializeFocusable()}),this.addEventListener("invalid",this._syncRadioStates)}disconnectedCallback(){super.disconnectedCallback(),this._isConnected=!1,this.removeEventListener("invalid",this._syncRadioStates)}_getValidityAnchor(){return this._contentElement}_initializeFocusable(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(t=>t.checked);e?(e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")):this._contentElement.setAttribute("tabindex","0"),this.radios.filter(t=>!t.checked).forEach(t=>t.setAttribute("tabindex","-1"))}_handleValueChange(){this._isConnected&&(this._syncRadioStates(),this.updateComplete.then(()=>{this._initializeFocusable()}))}_syncRadioStates(){this._isConnected&&this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}_handleFocus(){if(!this._contentElement||!this._isConnected)return;const e=this.radios.find(a=>a.checked),t=e||this.radios[0];t&&(t.focus(),e||(this.radios.forEach(a=>a.setAttribute("tabindex","-1")),t.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1")))}_dispatchChangeEvents(){this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))}_handleRadioChange(e){const t=e.target;t.hasAttribute("value")&&(this.value=t.value,this._syncRadioStates(),this._dispatchChangeEvents())}_handleKeyDown(e){if(!this._isConnected)return;const t=this.radios.filter(o=>!o.hasAttribute("disabled"));if(t.length===0)return;let a=t.findIndex(o=>document.activeElement===o);switch(a===-1&&(a=t.findIndex(o=>o.checked),a===-1&&(a=0)),e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault();const o=(a+1)%t.length;this._focusAndSelectRadio(t[o]);break}case"ArrowUp":case"ArrowLeft":{e.preventDefault();const o=(a-1+t.length)%t.length;this._focusAndSelectRadio(t[o]);break}default:return}}_focusAndSelectRadio(e){!this._contentElement||!this._isConnected||(this.radios.forEach(t=>t.setAttribute("tabindex","-1")),e.setAttribute("tabindex","0"),this._contentElement.setAttribute("tabindex","-1"),e.checked=!0,e.focus(),this.value=e.value,this._syncRadioStates(),this._dispatchChangeEvents())}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return u`<div class=${be(e)}>
      ${E(this,x,fe).call(this)}
        ...
        ></slot>
      </gds-form-control-header>`};_e=function(){return u` <div
      class="content"
      @keydown=${this._handleKeyDown}
      @focus=${this._handleFocus}
    >
      <slot @change=${this._handleRadioChange}></slot>
    </div>`};we=function(){return u` <gds-form-control-footer
      class="size-${this.size}"
      .validationMessage=${this.invalid&&(this.errorMessage||this.validationMessage)}
    >
    </gds-form-control-footer>`};l.styles=[Te];g([r()],l.prototype,"size",2);g([r()],l.prototype,"direction",2);g([r({attribute:"supporting-text"})],l.prototype,"supportingText",2);g([r({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);g([Re(".content")],l.prototype,"_contentElement",2);g([k("value")],l.prototype,"_handleValueChange",1);g([k("invalid")],l.prototype,"_syncRadioStates",1);l=g([he()],l);let $=class extends l{};$=g([C("gds-radio-group")],$);const ct={title:"Components/Radio",component:"gds-radio-group",subcomponents:{GdsRadio:"gds-radio"},tags:["autodocs"],parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},c={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},b={...c,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},m={...c,name:"Validation",render:()=>h`
    <form method="dialog">
  ...
  `},L={...c,name:"Do's and dont's",render:()=>h`
    <gds-flex gap="xl">
  ...
  `},_={...c,name:"Radio group label",render:()=>h`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
  ...
  `};var T,O,P,F,I;b.parameters={...b.parameters,docs:{...(T=b.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Radio',
  args: {
    label: 'Label',
...
}`,...(P=(O=b.parameters)==null?void 0:O.docs)==null?void 0:P.source},description:{story:`Radio buttons allow users to select a single option from a list of two or more mutually exclusive options.<br />
...
Interactive example with supporting texts:`,...(I=(F=b.parameters)==null?void 0:F.docs)==null?void 0:I.description}}};var q,V,M,B,W;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Validation',
  render: () => html\`
    <form method="dialog">
  ...
  \`
}`,...(M=(V=m.parameters)==null?void 0:V.docs)==null?void 0:M.source},description:{story:`Radio groups support validation using Green Core's [form validation API](/docs/components-form-validation-documentation--docs).
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...(W=(B=m.parameters)==null?void 0:B.docs)==null?void 0:W.description}}};var H,N,K;L.parameters={...L.parameters,docs:{...(H=L.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(K=(N=L.parameters)==null?void 0:N.docs)==null?void 0:K.source}}};var j,U,J,Q,X;v.parameters={...v.parameters,docs:{...(j=v.parameters)==null?void 0:j.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(J=(U=v.parameters)==null?void 0:U.docs)==null?void 0:J.source},description:{story:`Disabled radio buttons cannot be interacted with and appear visually muted.

In general, this state should never be used. Instead, aim to explain to the user why the choice is wrong in an error message and make sure they understand how to correct it.`,...(X=(Q=v.parameters)==null?void 0:Q.docs)==null?void 0:X.description}}};var Y,Z,ee,te,ae;f.parameters={...f.parameters,docs:{...(Y=f.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Size',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(ee=(Z=f.parameters)==null?void 0:Z.docs)==null?void 0:ee.source},description:{story:`Radio buttons support two sizes:
- Large (default): Standard size for most use cases
- Small: Compact size for space-constrained layouts

The size can be set on the radio group and applies to all radio buttons within.`,...(ae=(te=f.parameters)==null?void 0:te.docs)==null?void 0:ae.description}}};var oe,se,re,ie,de;y.parameters={...y.parameters,docs:{...(oe=y.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(re=(se=y.parameters)==null?void 0:se.docs)==null?void 0:re.source},description:{story:`Radio buttons can be arranged in two directions:
...
Choose the direction based on available space and number of options.`,...(de=(ie=y.parameters)==null?void 0:ie.docs)==null?void 0:de.description}}};var ne,le,pe,ge,ue;_.parameters={..._.parameters,docs:{...(ne=_.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(pe=(le=_.parameters)==null?void 0:le.docs)==null?void 0:pe.source},description:{story:`While radio groups can be created without a label, it's recommended to always provide one for clarity and accessibility.
The label helps users understand what the options are for.

In certain cases when space is limited, the group label can be omitted.`,...(ue=(ge=_.parameters)==null?void 0:ge.docs)==null?void 0:ue.description}}};const xt=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{y as Direction,v as Disabled,L as DosAndDonts,_ as GroupLabel,b as RadioButton,f as Size,m as Validation,xt as __namedExportsOrder,ct as default};
