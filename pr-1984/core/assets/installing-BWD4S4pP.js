import{j as e}from"./jsx-runtime-mu6TRHON.js";import{u as t}from"./index-DgJ83LvK.js";import"./chunk-HLWAVYOI-Dg1O9iWy.js";import{ae as s}from"./index-D_NibOU2.js";import"./iframe-B5WhtBGC.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-Df9so8jS.js";import"./index-DxKRhftL.js";import"./index-DrFu-skq.js";function o(r){const n={code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Get started"}),`
...
`,e.jsx(n.p,{children:"If you also need to use Angular animations, you need to use a special version of the provider. This is because Angular animations also use a custom renderer. So we need a bit of specialized initialization to make sure both the Green Core renderer and the Angular animations renderer can coexist."}),`
...
`})}),`
`,e.jsxs(n.p,{children:["Then you can just use ",e.jsx(n.code,{children:"<Button />"})," like a regular React component."]})]})}function x(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}export{x as default};
