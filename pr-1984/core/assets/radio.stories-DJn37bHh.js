...
`;var je=Object.defineProperty,He=Object.getOwnPropertyDescriptor,m=(e,t,o,r)=>{for(var a=r>1?void 0:r?He(t,o):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&je(t,o,a),a};let p=class extends De{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),Ve.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small","has-supporting-text":!!this.supportingText};return b`
    ...
    >
    </gds-form-control-footer>`};d.styles=[Te];g([s()],d.prototype,"size",2);g([s()],d.prototype,"direction",2);g([s({attribute:"supporting-text"})],d.prototype,"supportingText",2);g([s({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],d.prototype,"showExtendedSupportingText",2);g([Be(".content")],d.prototype,"_contentElement",2);g([$("value")],d.prototype,"_handleValueChange",1);g([$("size")],d.prototype,"_handleSizeChange",1);g([$("invalid")],d.prototype,"_syncRadioStates",1);d=g([Ge()],d);let G=class extends d{};G=g([D("gds-radio-group")],G);const _t={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"],parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
to fit different space requirements.`}}}},u={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},v={...u,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
  ...
  `};var T,P,q,O,A;v.parameters={...v.parameters,docs:{...(T=v.parameters)==null?void 0:T.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Radio',
  args: {
    label: 'Label',
...
}`,...(q=(P=v.parameters)==null?void 0:P.docs)==null?void 0:q.source},description:{story:`Radio buttons allow users to select a single option from a list of two or more mutually exclusive options.<br />
...
\`\`\``,...(A=(O=v.parameters)==null?void 0:O.docs)==null?void 0:A.description}}};var M,F,V,B,I;f.parameters={...f.parameters,docs:{...(M=f.parameters)==null?void 0:M.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'States',
  render: () => html\`
    <div class="radio-group">
...
- With supporting text: Additional context below the label`,...(I=(B=f.parameters)==null?void 0:B.docs)==null?void 0:I.description}}};var W,j,H,K,U;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Validation',
  render: () => html\`
    <form class="radio-group">
...
The size can be set on the radio group and applies to all radio buttons within.`,...(ve=(he=S.parameters)==null?void 0:he.docs)==null?void 0:ve.description}}};var fe,ye,Re,we,Le;_.parameters={..._.parameters,docs:{...(fe=_.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Direction',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(Re=(ye=_.parameters)==null?void 0:ye.docs)==null?void 0:Re.source},description:{story:`Radio buttons can be arranged in two directions:
...
Choose the direction based on available space and number of options.`,...(Le=(we=_.parameters)==null?void 0:we.docs)==null?void 0:Le.description}}};var Ee,Se,_e,ze,ke;z.parameters={...z.parameters,docs:{...(Ee=z.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  ...DefaultParams,
