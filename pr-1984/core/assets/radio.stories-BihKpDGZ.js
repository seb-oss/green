...
`;var Be=Object.defineProperty,He=Object.getOwnPropertyDescriptor,G=(e,t,o,r)=>{for(var a=r>1?void 0:r?He(t,o):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&Be(t,o,a),a};let _=class extends De{constructor(){super(),this.label="",this.supportingText=""}connectedCallback(){super.connectedCallback(),Fe.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,"has-supporting-text":!!this.supportingText};return x`
    ...
    `}};l.styles=[Ce,We];c([d()],l.prototype,"label",2);c([d({attribute:"supporting-text"})],l.prototype,"supportingText",2);c([d()],l.prototype,"value",2);c([d({type:Boolean,reflect:!0})],l.prototype,"checked",2);c([d({type:Boolean,reflect:!0})],l.prototype,"disabled",2);c([d({type:Boolean})],l.prototype,"invalid",2);c([Me()],l.prototype,"_isFocused",2);c([k("disabled")],l.prototype,"_handleDisabledChange",1);l=c([C("gds-radio")],l);const Je=D`
  :host {
...
`;var Ne=Object.defineProperty,Qe=Object.getOwnPropertyDescriptor,$e=e=>{throw TypeError(e)},p=(e,t,o,r)=>{for(var a=r>1?void 0:r?Qe(t,o):t,s=e.length-1,n;s>=0;s--)(n=e[s])&&(a=(r?n(t,o,a):n(a))||a);return r&&a&&Ne(t,o,a),a},Xe=(e,t,o)=>t.has(e)||$e("Cannot "+o),Ye=(e,t,o)=>t.has(e)?$e("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),z=(e,t,o)=>(Xe(e,t,"access private method"),o),b,Ae,qe,Oe,Pe;let i=class extends Ie{constructor(){super(...arguments),Ye(this,b),this.size="large",this.direction="column",this.supportingText="",this.showExtendedSupportingText=!1}get radios(){return Array.from(this.querySelectorAll("[gds-element=gds-radio]"))}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radiogroup"),this.updateComplete.then(()=>{this._syncRadioStates(),this._initializeFocusable()}),this.addEventListener("invalid",this._syncRadioStates)}_initializeFocusable(){this._contentElement.setAttribute("tabindex","0"),this.radios.forEach(e=>{e.setAttribute("tabindex","-1")})}_getValidityAnchor(){return this._contentElement}_handleValueChange(){this._syncRadioStates()}_handleSizeChange(){this.radios.forEach(e=>{e.size=this.size})}_syncRadioStates(){this.radios.forEach(e=>{e.checked=e.value===this.value,e.size=this.size,e.invalid=this.invalid})}_handleFocus(){const t=this.radios.find(o=>o.checked)||this.radios[0];t&&t.focus()}_handleRadioChange(e){const t=e.target;if(t.hasAttribute("value")){const o=t.value;this.value=o,this._syncRadioStates(),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))}}_handleKeyDown(e){const t=this.radios.filter(s=>!s.hasAttribute("disabled"));if(t.length===0)return;let o=t.findIndex(s=>s.checked||document.activeElement===s);o===-1&&(o=0);let r;switch(e.key){case"ArrowDown":case"ArrowRight":{e.preventDefault(),r=(o+1)%t.length;break}case"ArrowUp":case"ArrowLeft":{e.preventDefault(),r=(o-1+t.length)%t.length;break}case"Tab":return;default:return}const a=t[r];a.checked=!0,a.focus(),this.value=a.value,this._syncRadioStates(),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0})),this.dispatchEvent(new Event("input",{bubbles:!0}))}render(){const e={"radio-group":!0,"direction-row":this.direction==="row","direction-column":this.direction==="column"};return x`<div class=${Te(e)}>
    ...
    >
    </gds-form-control-footer>`};i.styles=[Je];p([d()],i.prototype,"size",2);p([d()],i.prototype,"direction",2);p([d({attribute:"supporting-text"})],i.prototype,"supportingText",2);p([d({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],i.prototype,"showExtendedSupportingText",2);p([Ve(".content")],i.prototype,"_contentElement",2);p([k("value")],i.prototype,"_handleValueChange",1);p([k("size")],i.prototype,"_handleSizeChange",1);p([k("invalid")],i.prototype,"_syncRadioStates",1);i=p([Ge()],i);let T=class extends i{};T=p([C("gds-radio-group")],T);const zt={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"],parameters:{docs:{description:{component:`Radio buttons are form controls that allow users to select a single option from a set of mutually exclusive choices.<br/>
...
to fit different space requirements.`}}}},g={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},m={...g,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},h={...g,name:"States",render:()=>u`
  ...
  `},f={...g,name:"Missing Label",render:()=>u`
    <gds-flex gap="xl">
  ...
  `},y={...g,name:"Single Radio",render:()=>u`
    <div class="radio-group">
      <gds-radio-group>
  ...
  `},S={...g,name:"Radio group label",render:()=>u`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
