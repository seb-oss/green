...
`;var Ke=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,h=(t,e,o,r)=>{for(var a=r>1?void 0:r?Ue(e,o):e,i=t.length-1,d;i>=0;i--)(d=t[i])&&(a=(r?d(e,o,a):d(a))||a);return r&&a&&Ke(e,o,a),a};let p=class extends Ge{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),Be.instance.apply(this,"gds-selection-field-label")}render(){const t={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small","has-supporting-text":!!this.supportingText};return b`
    ...
    >
    </gds-form-control-footer>`};n.styles=[Pe];g([s()],n.prototype,"size",2);g([s()],n.prototype,"direction",2);g([s({attribute:"supporting-text"})],n.prototype,"supportingText",2);g([s({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],n.prototype,"showExtendedSupportingText",2);g([We(".content")],n.prototype,"_contentElement",2);g([D("value")],n.prototype,"_handleValueChange",1);g([D("required")],n.prototype,"_handleRequiredChange",1);g([D("size")],n.prototype,"_handleSizeChange",1);n=g([qe()],n);let q=class extends n{};q=g([G("gds-radio-group")],q);const kt={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"]},u={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},v={...u,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
  ...
  `};var P,M,O,V,A;v.parameters={...v.parameters,docs:{...(P=v.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Radio',
  args: {
    label: 'Label',
...
}`,...(O=(M=v.parameters)==null?void 0:M.docs)==null?void 0:O.source},description:{story:`Radio buttons allow users to select a single option from a list of two or more mutually exclusive options.<br />
