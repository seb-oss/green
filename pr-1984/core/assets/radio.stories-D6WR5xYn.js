import{i as C,x as h}from"./lit-element-C_s9q329.js";import{n as d,g as D,G as he,h as x,r as Ce}from"./custom-element-scoping-BEGY3AqQ.js";import{t as me}from"./tokens.style-CFvqdzpw.js";import{w as A}from"./watch-tFciLXSI.js";import{l as ve}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{e as fe}from"./class-map-Bz98xO8-.js";import{T as De}from"./transitional-styles-iv5lM2WH.js";import{a as Ae}from"./query-p8xgzTDt.js";import{a as Ge}from"./button-DMqiAWPO.js";import"./form-control-footer-31u3ZPFB.js";import"./flex-tnFv_7np.js";import"./card-BihnooJR.js";import"./text-DQ_oI5A1.js";import"./divider-Dm4d-5N4.js";import"./circle-check-DzwSpRnk.js";import"./cross-small-CIJy4RQ0.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-Cg5fmtre.js";import"./triangle-exclamation-BVOOPWQa.js";import"./icon-DYBgint3.js";import"./badge-Dc9DlXiN.js";import"./div-Cnle9s5w.js";const $e=C`
...
`;var Oe=Object.defineProperty,Pe=Object.getOwnPropertyDescriptor,G=(e,t,a,o)=>{for(var r=o>1?void 0:o?Pe(t,a):t,n=e.length-1,l;n>=0;n--)(l=e[n])&&(r=(o?l(t,a,r):l(r))||r);return o&&r&&Oe(t,a,r),r};let L=class extends he{constructor(){super(),this.label="",this.supportingText=""}connectedCallback(){super.connectedCallback(),De.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,"has-supporting-text":!!this.supportingText};return x`
    ...
    `}};R=new WeakMap;S=new WeakMap;p.styles=[me,$e];u([d()],p.prototype,"label",2);u([d({attribute:"supporting-text"})],p.prototype,"supportingText",2);u([d()],p.prototype,"value",2);u([d({type:Boolean,reflect:!0})],p.prototype,"checked",2);u([d({type:Boolean,reflect:!0})],p.prototype,"disabled",2);u([d({type:Boolean})],p.prototype,"invalid",2);u([Ce()],p.prototype,"_isFocused",2);u([A("disabled")],p.prototype,"_handleDisabledChange",1);p=u([D("gds-radio")],p);const Ve=C`
  :host {
...
Groups support vertical and horizontal layouts, and can be sized to fit different space requirements.`}}}},b={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},m={...b,name:"Radio",args:{label:"Pick an option",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},v={...b,name:"Validation",render:()=>h`
    <form method="dialog">
  ...
  `},E={...b,name:"Do's and dont's",render:()=>h`
    <gds-flex gap="xl">
  ...
  `},w={...b,name:"Radio group label",render:()=>h`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
...
If you click on 'submit' first on the example below it will validate the radio group and show the error message.`,...(j=(N=v.parameters)==null?void 0:N.docs)==null?void 0:j.description}}};var K,U,J;E.parameters={...E.parameters,docs:{...(K=E.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...DefaultParams,
  ...
  \`
}`,...(J=(U=E.parameters)==null?void 0:U.docs)==null?void 0:J.source}}};var Q,X,Y,Z,ee;f.parameters={...f.parameters,docs:{...(Q=f.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'Disabled',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(Y=(X=f.parameters)==null?void 0:X.docs)==null?void 0:Y.source},description:{story:`Disabled radio buttons cannot be interacted with and appear visually muted.
...
Choose the direction based on available space and number of options.`,...(pe=(le=_.parameters)==null?void 0:le.docs)==null?void 0:pe.description}}};var ge,ue,ce,xe,be;w.parameters={...w.parameters,docs:{...(ge=w.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  ...DefaultParams,
...
In certain cases when space is limited, the group label can be omitted.`,...(be=(xe=w.parameters)==null?void 0:xe.docs)==null?void 0:be.description}}};const yt=["RadioButton","Validation","DosAndDonts","Disabled","Size","Direction","GroupLabel"];export{_ as Direction,f as Disabled,E as DosAndDonts,w as GroupLabel,m as RadioButton,y as Size,v as Validation,yt as __namedExportsOrder,ft as default};
