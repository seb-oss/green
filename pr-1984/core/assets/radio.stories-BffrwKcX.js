...
`;var F=Object.defineProperty,M=Object.getOwnPropertyDescriptor,c=(e,o,r,s)=>{for(var t=s>1?void 0:s?M(o,r):o,i=e.length-1,l;i>=0;i--)(l=e[i])&&(t=(s?l(o,r,t):l(t))||t);return s&&t&&F(o,r,t),t};let d=class extends k{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),A.instance.apply(this,"gds-selection-field-label")}render(){const e={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small","has-supporting-text":!!this.supportingText};return x`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},h={...C,name:"States",render:()=>D`
  ...
  `};var m,f,y,_,w;b.parameters={...b.parameters,docs:{...(m=b.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'radio',
  args: {
    label: 'Label',
...
}`,...(y=(f=b.parameters)==null?void 0:f.docs)==null?void 0:y.source},description:{story:"TODO: Add documentation",...(w=(_=b.parameters)==null?void 0:_.docs)==null?void 0:w.description}}};var $,R,E;h.parameters={...h.parameters,docs:{...($=h.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...DefaultParams,
  name: 'States',
  render: () => html\`
    <div class="radio-group">
  ...
  \`
}`,...(E=(R=h.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};const xe=["RadioButton","States"];export{b as RadioButton,h as States,xe as __namedExportsOrder,he as default};
