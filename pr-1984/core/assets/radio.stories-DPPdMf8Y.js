...
`;var He=Object.defineProperty,Ke=Object.getOwnPropertyDescriptor,h=(t,e,o,r)=>{for(var a=r>1?void 0:r?Ke(e,o):e,i=t.length-1,d;i>=0;i--)(d=t[i])&&(a=(r?d(e,o,a):d(a))||a);return r&&a&&He(e,o,a),a};let p=class extends $e{constructor(){super(),this.label="",this.supportingText="",this.type="radio",this.size="large",this.disabled=!1,this.invalid=!1}connectedCallback(){super.connectedCallback(),Ie.instance.apply(this,"gds-selection-field-label")}render(){const t={"selection-field-label":!0,[`type-${this.type}`]:!0,invalid:this.invalid,disabled:this.disabled,small:this.size==="small","has-supporting-text":!!this.supportingText};return b`
    ...
    `}_handleDisabledChange(){this.disabled?this.setAttribute("inert",""):this.removeAttribute("inert")}};p.styles=[Te,je];h([s()],p.prototype,"label",2);h([s({attribute:"supporting-text"})],p.prototype,"supportingText",2);h([s()],p.prototype,"type",2);h([s()],p.prototype,"size",2);h([s({type:Boolean,reflect:!0})],p.prototype,"disabled",2);h([s({type:Boolean})],p.prototype,"invalid",2);h([D("disabled")],p.prototype,"_handleDisabledChange",1);p=h([T("gds-selection-field-label"),Fe()],p);var Ue=Object.defineProperty,Je=Object.getOwnPropertyDescriptor,c=(t,e,o,r)=>{for(var a=r>1?void 0:r?Je(e,o):e,i=t.length-1,d;i>=0;i--)(d=t[i])&&(a=(r?d(e,o,a):d(a))||a);return r&&a&&Ue(e,o,a),a};let n=class extends $e{constructor(){super(...arguments),this.label="",this.supportingText="",this.value="",this.checked=!1,this.disabled=!1,this.size="large",this.invalid=!1,this._isFocused=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","radio")}_handleClick(){this.disabled||(this.checked=!0,this.focus(),this.dispatchEvent(new Event("change",{bubbles:!0})))}_handleKeyDown(t){this.disabled||(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this._handleClick())}focus(){var e;const t=(e=this.renderRoot)==null?void 0:e.querySelector(".radio");t&&t.focus()}render(){const t={radio:!0,checked:this.checked,disabled:this.disabled,focused:this._isFocused,invalid:this.invalid};return b`
    ...
    >
    </gds-form-control-footer>`};l.styles=[Ge];x([s()],l.prototype,"size",2);x([s()],l.prototype,"direction",2);x([s({attribute:"supporting-text"})],l.prototype,"supportingText",2);x([s({attribute:"show-extended-supporting-text",type:Boolean,reflect:!0})],l.prototype,"showExtendedSupportingText",2);x([Be(".content")],l.prototype,"_contentElement",2);x([D("value")],l.prototype,"_handleValueChange",1);x([D("required")],l.prototype,"_handleRequiredChange",1);x([D("size")],l.prototype,"_handleSizeChange",1);l=x([T("gds-radio-group")],l);const _t={title:"Components/Radio",component:"gds-radio-group",tags:["autodocs"]},g={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0},args:{label:"Label",supportingText:"Label support text."}}},m={...g,name:"Radio",args:{label:"Label",supportingText:"Label support text.",innerHTML:`
    ...
    <gds-radio label="Radio Option 3" supporting-text="Supporting text" value="3"></gds-radio>`}},f={...g,name:"States",render:()=>u`
  ...
  `},R={...g,name:"Missing Label",render:()=>u`
    <gds-flex gap="xl">
  ...
  `},w={...g,name:"Single Radio",render:()=>u`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio value="1" label="Missing value"></gds-radio>
      </gds-radio-group>
    </div>
  `},L={...g,name:"Required",render:()=>u`
    <div class="radio-group">
      <gds-radio-group
        label="Group Label"
        supporting-text="Support text for the group"
  ...
  `},z={...g,name:"Radio group label",render:()=>u`
    <div class="radio-group">
      <gds-radio-group>
        <gds-radio label="Radio Label" value="1"></gds-radio>
        <gds-radio label="Radio Label" value="2"></gds-radio>
