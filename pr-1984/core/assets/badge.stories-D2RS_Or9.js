import{x as a}from"./lit-element-C_s9q329.js";import{a as X}from"./argTableProps-CiH_NZ5J.js";import"./badge-Dc9DlXiN.js";import"./grid-Cf24TEIC.js";import"./flex-tnFv_7np.js";import"./divider-Dm4d-5N4.js";import"./triangle-exclamation-BVOOPWQa.js";import"./circle-check-DzwSpRnk.js";import"./plus-small-DRI9IPrg.js";import"./arrow-rotate-counter-clockwise-BV6OspXz.js";import"./rocket-aQtI4YJ4.js";import"./custom-elements-H2Z9lZ7y.js";import"./custom-element-scoping-BEGY3AqQ.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./tokens.style-CFvqdzpw.js";import"./declarative-layout-mixins-Cg5fmtre.js";import"./div-Cnle9s5w.js";import"./icon-DYBgint3.js";import"./directive-CF8sV3Lr.js";const fe={title:"Components/Badge",component:"gds-badge",parameters:{layout:"centered",docs:{description:{component:'A badge is a small status or notification indicator that can be used to display a message or status.\n\nFeatures:\n- **Variants**: The badge supports multiple variants including `information`, `notice`, `positive`, `warning`, and `negative`, allowing for different contextual uses.\n- **Slots**: The badge includes a `lead` slot for adding leading content such as icons, enhancing the visual representation.\n- **Disabled State**: The badge can be disabled, making it non-interactive and visually indicating its disabled state.\n- **Size Control**: The badge size can be controlled via the `size` property, with options for `default` and `small`.\n\nExample usage:\n\n```html\n<gds-badge variant="positive">\n  <gds-icon-rocket slot="lead"></gds-icon-rocket>\n  Launch\n</gds-badge>\n```'}}},tags:["autodocs","beta"],argTypes:{...X("gds-badge")}},r={name:"Variants",render:e=>a`
    <gds-flex
