import{i as Ce,x as r}from"./lit-element-C_s9q329.js";import{a as Me}from"./argTableProps-BVO9mVp8.js";import{l as Ee}from"./localized-decorator-DtmrKsyB.js";import"./runtime-BL31MtW8.js";import{n as L,g as Le,h as u}from"./custom-element-scoping-BEGY3AqQ.js";import{a as he}from"./query-p8xgzTDt.js";import{e as ke}from"./class-map-Bz98xO8-.js";import{t as _e}from"./tokens.style-CFvqdzpw.js";import{o as Ae}from"./observe-light-dom-CmJPHUQ4.js";import{w as De}from"./watch-tFciLXSI.js";import{d as ze,w as Oe,b as qe}from"./declarative-layout-mixins-Cg5fmtre.js";import{a as Ie}from"./button-DMqiAWPO.js";import"./form-control-footer-31u3ZPFB.js";import"./field-base-C22S51EM.js";import"./chevron-bottom-CcRSBbmu.js";import"./flex-tnFv_7np.js";import"./square-grid-circle-CohIYq56.js";import"./rocket-aQtI4YJ4.js";import"./sun-olOpdRBa.js";import"./brand-green-DaDklR0q.js";import"./custom-elements-Duo0B5nu.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./if-defined-Ct9lF4W9.js";import"./when-BR7zwNJC.js";import"./static-_ukc2i0J.js";import"./transitional-styles-iv5lM2WH.js";import"./triangle-exclamation-BVOOPWQa.js";import"./icon-DYBgint3.js";import"./card-BihnooJR.js";import"./div-Cnle9s5w.js";import"./badge-Dc9DlXiN.js";const Pe=Ce`
...
`;var Te=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,ve=e=>{throw TypeError(e)},n=(e,t,o,c)=>{for(var l=c>1?void 0:c?Ve(t,o):t,C=e.length-1,M;C>=0;C--)(M=e[C])&&(l=(c?M(t,o,l):M(l))||l);return c&&l&&Te(t,o,l),l},k=(e,t,o)=>t.has(e)||ve("Cannot "+o),S=(e,t,o)=>(k(e,t,"read from private field"),t.get(e)),E=(e,t,o)=>t.has(e)?ve("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),$e=(e,t,o,c)=>(k(e,t,"write to private field"),t.set(e,o),o),p=(e,t,o)=>(k(e,t,"access private method"),o),y,w,i,be,xe,fe,ye,Se,we;let s=class extends Ie{constructor(){super(...arguments),E(this,i),this.supportingText="",this.size="large",E(this,y,!1),E(this,w,e=>{e.stopPropagation(),p(this,i,be).call(this),requestAnimationFrame(()=>{this.dispatchEvent(new CustomEvent("input",{detail:{value:this.value},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("change",{detail:{value:this.value},bubbles:!0,composed:!0}))})})}get value(){return this._internalValue}set value(e){S(this,y)||$e(this,y,!0),this._internalValue=e}get displayValue(){return this.selectElement?Array.from(this.selectElement.selectedOptions).map(e=>e.text).join(", "):""}get multiple(){var e;return((e=this.selectElement)==null?void 0:e.multiple)??!1}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._captureDOM(),this._handleValueChange()})}render(){const e={multiple:this.multiple};return u`
...
<br>It is set by adding an icon component to the 'lead' slot.`,...(B=(H=g.parameters)==null?void 0:H.docs)==null?void 0:B.description}}};var F,W,J,j,U;h.parameters={...h.parameters,docs:{...(F=h.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...
  \`
}`,...(de=(ce=f.parameters)==null?void 0:ce.docs)==null?void 0:de.source},description:{story:'The native `<select size="...">` to not be confused with property `size` <br> it is the native attribute that sets the number of visible options in a select element.\n\n```html\n <gds-select>\n <select multiple size="14">\n   ...\n </select>\n</gds-select>\n```',...(ge=(me=f.parameters)==null?void 0:me.docs)==null?void 0:ge.description}}};const xt=["Default","Option","Lead","Disabled","Validation","Size","Multiple","SelectSize"];export{d as Default,h as Disabled,g as Lead,x as Multiple,m as Option,f as SelectSize,b as Size,v as Validation,xt as __namedExportsOrder,bt as default};
