import{m as O,l as T}from"./runtime-CNluP0A8.js";import{n as g,r as z}from"./Reflect-BIo-zK4X.js";import{a as S}from"./query-p8xgzTDt.js";import{h as $,G as P,g as W}from"./gds-element-4C_whPou.js";import{t as V}from"./tokens.style-Boei6TBQ.js";import{T as B}from"./transitional-styles-BwDo8TOz.js";import{r as G}from"./resize-observer-B9k8v2TZ.js";import{w as D}from"./watch-tFciLXSI.js";import{w as M,d as N,b as R}from"./declarative-layout-mixins-TUy19cvx.js";import{I as X,a as A}from"./chevron-right.component-JvVZHklL.js";import{i as E}from"./lit-element-DurN2HL2.js";const F=E`
  @layer base {
    :host {
      display: flex;
      z-index: 1;
...
`;var j=Object.defineProperty,q=Object.getOwnPropertyDescriptor,m=(e,t,s,i)=>{for(var r=i>1?void 0:i?q(t,s):t,a=e.length-1,p;a>=0;a--)(p=e[a])&&(r=(i?p(t,s,r):p(r))||r);return i&&r&&j(t,s,r),r};let h=class extends M(P){constructor(){super(...arguments),this.selected=!1,this.disabled=!1,this._isVisible=!0}get isVisible(){return this._isVisible}connectedCallback(){super.connectedCallback(),B.instance.apply(this,"gds-segmented"),this.setAttribute("role","listitem")}render(){return $`<button
      aria-current=${String(this.selected)}
      ?disabled="${this.disabled}"
    >
      <slot></slot>
    </button>`}};h.styles=[...V,F];m([g({type:Boolean,reflect:!0})],h.prototype,"selected",2);m([g()],h.prototype,"value",2);m([g({type:Boolean,reflect:!0})],h.prototype,"disabled",2);h=m([W("gds-segment")],h);const H=E`
  @layer base {
    :host {
