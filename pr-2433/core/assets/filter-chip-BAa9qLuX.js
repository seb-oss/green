import{n as h,r as k}from"./Reflect-BIo-zK4X.js";import{a as G}from"./query-p8xgzTDt.js";import{e as C}from"./class-map-Cyfzw29o.js";import{r as x}from"./resize-observer-B9k8v2TZ.js";import{w as z}from"./watch-tFciLXSI.js";import{s as E}from"./attribute-converters-CdI0trPX.js";import{G as P,h as w,g as b}from"./gds-element-4C_whPou.js";import{G as W,a as F}from"./button.component-as79-sbl.js";import{i as $}from"./lit-element-DurN2HL2.js";import{T as V}from"./transitional-styles-BwDo8TOz.js";import{I as H}from"./checkmark.component-04BrZPGG.js";const T=$`
...
`;var B=Object.defineProperty,D=Object.getOwnPropertyDescriptor,f=(e,t,s,i)=>{for(var l=i>1?void 0:i?D(t,s):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(l=(i?p(t,s,l):p(l))||l);return i&&l&&B(t,s,l),l};let o=class extends P{constructor(){super(...arguments),this.selected=!1,this.size="large"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),V.instance.apply(this,"gds-filter-chip")}render(){const e={"btn-p":!this.selected};return w`<gds-button
      class="btn"
    ...
    >
      ...
      <gds-icon-checkmark
        ...
        class="icon"
      ></gds-icon-checkmark>
    </gds-button>`}};o.styles=[T];f([h({reflect:!0,type:Boolean})],o.prototype,"selected",2);f([h()],o.prototype,"value",2);f([h({reflect:!0,type:String})],o.prototype,"size",2);o=f([b("gds-filter-chip",{dependsOn:[W,H]})],o);const M=$`
  @layer base, reset, transitional-styles;
  @layer base {
    :host {
