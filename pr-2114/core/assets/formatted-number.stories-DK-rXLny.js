import{x as i}from"./lit-element-Bx14lxc-.js";import{a as $}from"./argTableProps-kBo4WfMr.js";import{n as d,g as h}from"./custom-element-scoping-b4c89-hi.js";import{G as _}from"./formatted-text-CXGohUQ8.js";import"./flex-DTBzRj2-.js";const D={decimalsAndThousands:(e,t,a)=>{const n=Number(e),r={};return!isNaN(n)&&n%1!==0&&(r.minimumFractionDigits=2,r.maximumFractionDigits=2),a?new Intl.NumberFormat(t,{...r,style:"currency",currency:a}).format(n):new Intl.NumberFormat(t,r).format(n)}};var S=Object.defineProperty,C=Object.getOwnPropertyDescriptor,c=(e,t,a,n)=>{for(var r=n>1?void 0:n?C(t,a):t,u=e.length-1,l;u>=0;u--)(l=e[u])&&(r=(n?l(t,a,r):l(r))||r);return n&&r&&S(t,a,r),r};let s=class extends _{constructor(){super(...arguments),this.format="decimalsAndThousands"}get formattedValue(){return D[this.format](this.value,this.locale,this.currency)}firstUpdated(e){super.firstUpdated(e),!this.value&&this.textContent&&(this.value=this.textContent)}};c([d({attribute:!1})],s.prototype,"value",2);c([d({type:String})],s.prototype,"locale",2);c([d({type:String})],s.prototype,"currency",2);c([d({type:String})],s.prototype,"format",2);s=c([h("gds-formatted-number")],s);s.define();const F={title:"Components/Formatted Text/Number",component:"gds-formatted-number",tags:["autodocs"],argTypes:{...$("gds-formatted-number"),currency:{type:"string"}},parameters:{docs:{description:{component:"[Source code](https://github.com/seb-oss/green/tree/main/libs/core/src/components/formatted-text/number)\n\n`gds-formatted-number` extends `gds-text` and formats the number to the desired format.\n\n@beta"}}}},v={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}},args:{locale:"sv-SE",value:1234.5}},o={...v,name:"Default",render:e=>i`<gds-flex gap="m" flex-direction="column">
    ...
    >`},P=["SEK","EUR"],m={...v,name:"Currencies",render:e=>i`<gds-flex flex-direction="column" gap="m">
      ${P.map(t=>i`<gds-flex gap="l" justify-content="space-between">
              <gds-text>${t}:</gds-text>
              <gds-formatted-number
                .value=${e.value}
                .locale=${e.locale}
