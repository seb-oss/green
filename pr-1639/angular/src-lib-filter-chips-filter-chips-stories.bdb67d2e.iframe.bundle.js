...
`,GdsFilterChip=class extends chunk_SMVGDFVL.j{constructor(){super(...arguments),this.selected=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","none"),chunk_2GQQ2MGP.nD.instance.apply(this,"gds-filter-chip"),this._button.then((btn=>{chunk_2GQQ2MGP.nD.instance.apply(btn,"gds-button")}))}render(){const btnClasses={"btn-p":!this.selected};return chunk_PBRH3UPJ.qy`<gds-button
      class="btn"
      size="small"
