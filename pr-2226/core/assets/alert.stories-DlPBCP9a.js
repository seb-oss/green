import{n as l,r as C,G as ue,h as t,g as pe}from"./gds-element-KHa0AloG.js";import{i as he,E as c}from"./lit-element-Bx14lxc-.js";import{e as be}from"./class-map-CXsQwv0r.js";import{e as fe,n as ve}from"./ref-R0wBYijq.js";import{u as ye,s as A}from"./static-B8S6DEnV.js";import{G as xe}from"./button.component-BHtocGTN.js";import{G as _e}from"./card.component-C21NCPsO.js";import"./checkmark-D-0ZEcKl.js";import"./circle-info-BgbDYey7.js";import"./cross-small-j7P_yAOc.js";import"./button-nPQff-yp.js";import{t as we}from"./tokens.style-DC2Hb-2P.js";import"./card-d-tVEDXR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./directive-CF8sV3Lr.js";import"./directive-helpers-BF33kFuJ.js";import"./query-p8xgzTDt.js";import"./if-defined-CVqwUuaf.js";import"./when-BR7zwNJC.js";import"./transitional-styles-D9AB5Uac.js";import"./observe-light-dom-CmJPHUQ4.js";import"./declarative-layout-mixins-V-x3wfiD.js";import"./watch-tFciLXSI.js";import"./div.component-BLZX0vzk.js";import"./checkmark.component-BgKvBts3.js";import"./icon-BDCl8D0g.js";import"./circle-info.component-CF6nkNJx.js";import"./cross-small.component-D1Ljw-03.js";const ke=he`
  :host {
    display: block;
...
`;var Te=Object.defineProperty,Se=Object.getOwnPropertyDescriptor,o=(e,a,m,d)=>{for(var n=d>1?void 0:d?Se(a,m):a,T=e.length-1,S;T>=0;T--)(S=e[T])&&(n=(d?S(a,m,n):S(n))||n);return d&&n&&Te(a,m,n),n};const Ce={positive:{icon:"checkmark",card:"positive",label:"Positive alert"},warning:{icon:"triangle-exclamation",card:"warning",label:"Warning alert"},negative:{icon:"triangle-exclamation",card:"negative",label:"Negative alert"},information:{icon:"circle-info",card:"information",label:"Information alert"},notice:{icon:"circle-info",card:"information",label:"Notice alert"}},Ae=300,Ie=100;let s=class extends ue{constructor(){super(),this.variant="information",this.role="alert",this.dismissible=!1,this.timeOut=0,this.buttonText="",this.dismissLabel="Dismiss alert",this.timerLabel="Auto-dismiss timer",this._progress=100,this._isClosing=!1,this._cardHidden=!1,this._alertRef=fe(),this._timerController={hostConnected:()=>{this.timeOut>0&&this._startTimer()},hostDisconnected:()=>this._clearTimers()},this.addController(this._timerController)}updated(e){e.has("timeOut")&&(this._clearTimers(),this.timeOut>0&&this._startTimer())}_startTimer(){const e=Date.now();this._progress=100,this._progressIntervalId=window.setInterval(()=>{const a=Date.now()-e;this._progress=Math.max(0,(this.timeOut-a)/this.timeOut*100)},Ie),this._timeoutId=window.setTimeout(()=>this._dismiss("timeout"),this.timeOut)}_clearTimers(){clearTimeout(this._timeoutId),clearInterval(this._progressIntervalId),this._timeoutId=this._progressIntervalId=void 0}async _dismiss(e){this._isClosing=!0,this._clearTimers(),await this.updateComplete,await new Promise(a=>setTimeout(a,Ae)),this.dispatchEvent(new CustomEvent("close",{detail:{source:e},bubbles:!0,composed:!0})),this._cardHidden=!0}_onButtonClick(e){this.dispatchEvent(new CustomEvent("action",{detail:{source:"button",event:e},bubbles:!0,composed:!0}))}_handleKeyDown(e){e.key==="Escape"&&this.dismissible&&(e.preventDefault(),this._dismiss("escape"))}get _config(){return Ce[this.variant]}_renderIcon(){const e=`gds-icon-${this._config.icon}`;return t`<span class="icon" role="presentation">
      ${ye`<${A(e)} aria-hidden="true"></${A(e)}>`}
    ...
    `}};s.styles=[we,ke];o([l({type:String,reflect:!0})],s.prototype,"variant",2);o([l({type:String,reflect:!0})],s.prototype,"role",2);o([l({type:Boolean})],s.prototype,"dismissible",2);o([l({type:Number,attribute:"time-out"})],s.prototype,"timeOut",2);o([l({type:String,attribute:"button-text"})],s.prototype,"buttonText",2);o([l({type:String,attribute:"dismiss-label"})],s.prototype,"dismissLabel",2);o([l({type:String,attribute:"timer-label"})],s.prototype,"timerLabel",2);o([C()],s.prototype,"_progress",2);o([C()],s.prototype,"_isClosing",2);o([C()],s.prototype,"_cardHidden",2);s=o([pe("gds-alert",{dependsOn:[xe,_e]})],s);s.define();const it={title:"Components/Alert",component:"gds-alert",tags:["autodocs"],argTypes:{variant:{control:"select",options:["information","notice","positive","warning","negative"]},role:{control:"select",options:["alert","status"],description:'ARIA role. Use "alert" for critical, "status" for less important.'},dismissible:{control:"boolean",description:"Shows close button when enabled."},timeOut:{control:"number"},buttonText:{control:"text",name:"Button Text (CTA)"},dismissLabel:{control:"text",name:"Dismiss Button Label",description:"Accessible label for the close button (for i18n)."},timerLabel:{control:"text",name:"Timer Bar Label",description:"Accessible label for the timer bar (for i18n)."}}},$e=(e,a)=>{var m;return t`
  <gds-alert
    variant="${e.variant}"
    role="${e.role}"
...
`},i=(e,a)=>({args:e,parameters:{content:a},render:$e}),r=i({variant:"information",role:"alert",dismissible:!1,timeOut:0,buttonText:""},t`<strong>Information</strong> Body text starts on the same row as heading.
    A link (optional) always ends the message.`),g=i({...r.args,variant:"information"},r.parameters.content),u=i({...r.args,variant:"notice"},t`<strong>Notice</strong> Body text with link or additional context.`),p=i({...r.args,variant:"positive"},t`<strong>Positive</strong> Feedback message with optional CTA.`),h=i({...r.args,variant:"warning"},t`<strong>Warning</strong> Important information to consider.`),b=i({...r.args,variant:"negative"},t`<strong>Negative</strong> Error message requiring user attention.`),f=i({...r.args,variant:"information",dismissible:!0,buttonText:"Take Action"},t`<strong>Actionable</strong> Alert with a button for quick user
    interaction.`),v=i({...r.args,variant:"information",dismissible:!0},t`<strong>Dismissible</strong> User can dismiss this alert.`),y=i({...r.args,variant:"positive",timeOut:3e3},t`<strong>Auto Dismiss</strong> This alert disappears automatically after a
    delay.`),x=i({variant:"information",role:"alert",dismissible:!0,buttonText:"Learn More"},t`<strong>Rich Content</strong> Includes <a href="#">a link</a>,
    <em>emphasis</em>, and <code>code</code>.`),_=i({variant:"warning",role:"alert",dismissible:!0},t`<strong>Complex Content</strong> Demonstrates how layout adjusts with
    long or wrapped content in alerts.`),w=i({variant:"positive",role:"alert",dismissible:!0},t`<strong>Keyboard Accessible</strong> Press Escape to dismiss, or use
    keyboard to interact with the alert.`),k=i({variant:"warning",role:"alert",dismissible:!0,timeOut:5e3,buttonText:"Åtgärda",dismissLabel:"Stäng varning",timerLabel:"Denna varning stängs automatiskt"},t`<strong>Internationella etiketter</strong> Detta är en varning med
