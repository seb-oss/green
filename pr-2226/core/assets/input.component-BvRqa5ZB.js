import{m as A}from"./runtime-BL31MtW8.js";import{l as B}from"./localized-decorator-DtmrKsyB.js";import{n as r,h as l,g as M}from"./gds-element-KHa0AloG.js";import{a as T}from"./query-p8xgzTDt.js";import{r as O}from"./query-async-MEroNOeJ.js";import{o as n}from"./if-defined-CVqwUuaf.js";import{n as $}from"./when-BR7zwNJC.js";import{i as P,E as x}from"./lit-element-Bx14lxc-.js";import{f as N,G as W}from"./form-control-host.style-DPq0AOcs.js";import{G as R,a as q}from"./form-control-header.component-DkLe8Wnh.js";import{t as L}from"./tokens.style-DC2Hb-2P.js";import{a as X,b as D,w as H}from"./declarative-layout-mixins-V-x3wfiD.js";import{a as V,G as J}from"./button.component-BHtocGTN.js";import{G as K}from"./flex.component-BLop41Mq.js";import{I as Q}from"./cross-large.component-CFZerQV1.js";const U=P``;var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,C=t=>{throw TypeError(t)},o=(t,s,i,c)=>{for(var p=c>1?void 0:c?Z(s,i):s,m=t.length-1,f;m>=0;m--)(f=t[m])&&(p=(c?f(s,i,p):f(p))||p);return c&&p&&Y(s,i,p),p},w=(t,s,i)=>s.has(t)||C("Cannot "+i),d=(t,s,i)=>(w(t,s,"read from private field"),i?i.call(t):s.get(t)),u=(t,s,i)=>s.has(t)?C("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(t):s.set(t,i),h=(t,s,i)=>(w(t,s,"access private method"),i),a,E,y,v,g,b,S,z,k,G,I,F;let e=class extends V{constructor(){super(),u(this,a),this.supportingText="",this.showExtendedSupportingText=!1,this.clearable=!1,this.maxlength=Number.MAX_SAFE_INTEGER,this.size="large",this.plain=!1,this.type="text",this.autocapitalize="off",this.autofocus=!1,this.spellcheck=!0,u(this,y,t=>{const s=t.target;this.value=s.value}),u(this,v,t=>{const s=t.target;this.value=s.value,this.dispatchStandardEvent("change",{bubbles:!0,composed:!0})}),u(this,g,()=>{this.elInputAsync.then(t=>t.focus())}),u(this,b,()=>{this.value="",this.dispatchCustomEvent("gds-input-cleared",{bubbles:!0,composed:!0}),this.dispatchStandardEvent("input",{bubbles:!0,composed:!0})}),this.value=""}test_getClearButton(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("#clear-button")}test_getFieldElement(){var t;return(t=this.shadowRoot)==null?void 0:t.querySelector("#field")}render(){return l`
