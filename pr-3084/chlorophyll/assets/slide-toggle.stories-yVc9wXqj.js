const s={title:"Components/Slide Toggle",tags:["autodocs"],parameters:{componentIds:["component-slidetoggle"]},argTypes:{label:{control:"text"},checked:{control:"boolean"}}},t={render:e=>`
  ...
  <button role="switch" aria-checked="${e.checked}" aria-labelledby="slide-toggle-label-1"></button>
  <span id="slide-toggle-label-1">${e.label}</span>
  </div>`,args:{label:"Toggle me",checked:!1}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: args => \`
  <div class="d-flex align-items-center">
...
}`,...t.parameters?.docs?.source},description:{story:`The slide toggle is a representation of a physical switch that allows users to turn things on or off.
...
}`,...a.parameters?.docs?.source}}};const n=["SlideToggle","LabelRight"];export{a as LabelRight,t as SlideToggle,n as __namedExportsOrder,s as default};
