...
- `yarn storybook@latest automigrate --config-dir libs/angular/.storybook --renderer @storybook/angular`

- `yarn storybook@latest automigrate --config-dir libs/angular-charts/.storybook --renderer @storybook/angular`
