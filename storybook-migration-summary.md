...
- `yarn storybook@latest automigrate --config-dir .storybook`

- `yarn storybook@latest automigrate --config-dir libs/angular/.storybook`

- `yarn storybook@latest automigrate --config-dir libs/angular-charts/.storybook`

- `yarn storybook@latest automigrate --config-dir libs/chlorophyll/.storybook`

- `yarn storybook@latest automigrate --config-dir libs/core/.storybook`

- `yarn storybook@latest automigrate --config-dir libs/react/.storybook`

- `yarn storybook@latest automigrate --config-dir libs/react-charts/.storybook`
