import"./switch-D9JprJyR.js";import"./flex-azlKYDTV.js";import{b as t}from"./iframe-CNiEufxD.js";import"./text-Dxqvlw4M.js";import"./divider-7tjmq4ky.js";import{a as x}from"./argTableProps-qOcvBZf0.js";import"./switch.component-uiqZJT-C.js";import"./checkmark.component-t0TIfQ9Z.js";import"./icon.component-CzdCEeUu.js";import"./flex.component-BMIxndx4.js";import"./preload-helper-PPVm8Dsz.js";import"./text.component-DnBQEB4R.js";import"./default-typography.styles-owR9B58u.js";const D={title:"Components/Switch",component:"gds-switch",tags:["autodocs"],argTypes:{...x("gds-switch"),controlPlacement:{options:["end","start"],control:{type:"select"}},justifyContent:{options:["flex-start","space-between","flex-end"],control:{type:"select"}}},parameters:{docs:{description:{component:"A switch control for binary on/off choices with support for size, direction, disabled state, and emitted state-change events."}}}},s={parameters:{docs:{source:{format:!0,type:"dynamic"}},controls:{expanded:!0}}},i={...s,name:"Switch",parameters:{docs:{description:{story:"Basic switch example. Use controls to change label, checked, disabled, size, and control placement."}}},args:{label:"Alerts",checked:!1,disabled:!1,size:"large",controlPlacement:"end",justifyContent:"flex-start"},render:e=>t`
    <gds-switch
      label=${e.label}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
